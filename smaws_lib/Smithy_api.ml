module Types = struct
  ...
  type long = CoreTypes.Int64.t [@@deriving show, eq]
  type primitive_long = CoreTypes.Int64.t [@@deriving show, eq]
  ...
  type primitive_boolean = bool [@@deriving show, eq]
  type char_ = int [@@deriving show, eq]
  type bigint = CoreTypes.BigInt.t [@@deriving show, eq]
  type bigdecimal = CoreTypes.BigDecimal.t [@@deriving show, eq]
...
module Json_serializers = struct
  ...
  let primitive_long_to_yojson = Json.SerializeHelpers.long_to_yojson
  ...
  let primitive_boolean_to_yojson = Json.SerializeHelpers.bool_to_yojson
  let char__to_yojson = Json.SerializeHelpers.int_to_yojson
  let bigint_to_yojson = Json.SerializeHelpers.big_int_to_yojson
  let bigdecimal_to_yojson = Json.SerializeHelpers.big_decimal_to_yojson
...
module Query_serializers = struct
  ...
  let long_to_query = Protocols_impl.AwsQuery.Serialize.long_field
  let primitive_long_to_query = Protocols_impl.AwsQuery.Serialize.long_field
  let bigint_to_query = Protocols_impl.AwsQuery.Serialize.big_int_field
  let bigdecimal_to_query = Protocols_impl.AwsQuery.Serialize.big_decimal_field
  ...
  let primitive_boolean_to_query = Protocols_impl.AwsQuery.Serialize.bool_field
...
module Query_deserializers = struct
  ...
  let long_of_xml i = CoreTypes.Int64.of_string (Xml.Parse.Read.data i)
  let primitive_long_of_xml i = CoreTypes.Int64.of_string (Xml.Parse.Read.data i)
  let bigint_of_xml i = CoreTypes.BigInt.of_string (Xml.Parse.Read.data i)
  let bigdecimal_of_xml i = CoreTypes.BigDecimal.of_string (Xml.Parse.Read.data i)
  ...
  let primitive_boolean_of_xml i = bool_of_string (Xml.Parse.Read.data i)
...
module Json_deserializers = struct
  ...
  let primitive_long_of_yojson = Json.DeserializeHelpers.long_of_yojson
  ...
  let primitive_boolean_of_yojson = Json.DeserializeHelpers.bool_of_yojson
  let char__of_yojson = Json.DeserializeHelpers.int_of_yojson
  let bigint_of_yojson = Json.DeserializeHelpers.big_int_of_yojson
  let bigdecimal_of_yojson = Json.DeserializeHelpers.big_decimal_of_yojson
