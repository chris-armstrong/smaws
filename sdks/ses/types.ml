...
type nonrec tls_policy = Optional [@ocaml.doc ""] | Require [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec invocation_type = RequestResponse [@ocaml.doc ""] | Event [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec sns_action_encoding = Base64 [@ocaml.doc ""] | UTF8 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec receipt_filter_policy = Allow [@ocaml.doc ""] | Block [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec identity_type = Domain [@ocaml.doc ""] | EmailAddress [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec create_custom_verification_email_template_request = {
  ...
  from_email_address : from_address;
      [@ocaml.doc "The email address that the custom verification email is sent from.\n"]
  template_name : template_name; [@ocaml.doc "The name of the custom verification email template.\n"]
}
