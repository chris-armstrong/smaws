...
let organization_not_found_exception_to_yojson
  (x : organization_not_found_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let mail_domain_not_found_exception_to_yojson
  (x : mail_domain_not_found_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
let invalid_configuration_exception_to_yojson
  (x : invalid_configuration_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
  ...
  assoc_to_yojson
    [("AutoDeclineConflictingRequests",
       (option_to_yojson boolean__to_yojson
          x.auto_decline_conflicting_requests));
...
let resource_type_to_yojson (x : resource_type) =
  match x with | EQUIPMENT -> `String "EQUIPMENT" | ROOM -> `String "ROOM"
...
let mobile_device_access_rule_effect_to_yojson
  (x : mobile_device_access_rule_effect) =
  match x with | DENY -> `String "DENY" | ALLOW -> `String "ALLOW"
let device_type_to_yojson = string_to_yojson
let device_type_list_to_yojson tree =
  list_to_yojson device_type_to_yojson tree
let device_model_to_yojson = string_to_yojson
let device_model_list_to_yojson tree =
  list_to_yojson device_model_to_yojson tree
...
let device_user_agent_list_to_yojson tree =
  list_to_yojson device_user_agent_to_yojson tree
let update_mobile_device_access_rule_request_to_yojson
  (x : update_mobile_device_access_rule_request) =
  assoc_to_yojson
    [("NotDeviceUserAgents",
       (option_to_yojson device_user_agent_list_to_yojson
          x.not_device_user_agents));
    ("DeviceUserAgents",
      (option_to_yojson device_user_agent_list_to_yojson x.device_user_agents));
    ("NotDeviceOperatingSystems",
      (option_to_yojson device_operating_system_list_to_yojson
         x.not_device_operating_systems));
    ("DeviceOperatingSystems",
      (option_to_yojson device_operating_system_list_to_yojson
         x.device_operating_systems));
    ("NotDeviceModels",
    ...
    ("Description",
      (option_to_yojson mobile_device_access_rule_description_to_yojson
         x.description));
...
let access_effect_to_yojson (x : access_effect) =
  match x with | DENY -> `String "DENY" | ALLOW -> `String "ALLOW"
let target_users_to_yojson tree =
  list_to_yojson entity_identifier_to_yojson tree
let impersonation_rule_to_yojson (x : impersonation_rule) =
  assoc_to_yojson
    ...
    ("Description",
      (option_to_yojson impersonation_rule_description_to_yojson
         x.description));
...
let impersonation_rule_list_to_yojson tree =
  list_to_yojson impersonation_rule_to_yojson tree
let update_impersonation_role_request_to_yojson
  (x : update_impersonation_role_request) =
  assoc_to_yojson
    [("Rules", (Some (impersonation_rule_list_to_yojson x.rules)));
    ("Description",
      (option_to_yojson impersonation_role_description_to_yojson
         x.description));
...
let update_availability_configuration_request_to_yojson
  ...
  assoc_to_yojson
    [("LambdaProvider",
       (option_to_yojson lambda_availability_provider_to_yojson
          x.lambda_provider));
    ("EwsProvider",
...
let test_availability_configuration_request_to_yojson
  (x : test_availability_configuration_request) =
  assoc_to_yojson
    [("LambdaProvider",
       (option_to_yojson lambda_availability_provider_to_yojson
          x.lambda_provider));
...
let start_mailbox_export_job_response_to_yojson
  (x : start_mailbox_export_job_response) =
  assoc_to_yojson
...
let start_mailbox_export_job_request_to_yojson
  (x : start_mailbox_export_job_request) =
  assoc_to_yojson
...
let folder_configurations_to_yojson tree =
  list_to_yojson folder_configuration_to_yojson tree
...
let permission_type_to_yojson (x : permission_type) =
  ...
  | FULL_ACCESS -> `String "FULL_ACCESS"
let permission_values_to_yojson tree =
  list_to_yojson permission_type_to_yojson tree
let put_mailbox_permissions_request_to_yojson
  (x : put_mailbox_permissions_request) =
  assoc_to_yojson
    [("PermissionValues",
...
let actions_list_to_yojson tree =
  list_to_yojson access_control_rule_action_to_yojson tree
let user_id_list_to_yojson tree =
  list_to_yojson work_mail_identifier_to_yojson tree
let impersonation_role_id_list_to_yojson tree =
  list_to_yojson impersonation_role_id_to_yojson tree
let put_access_control_rule_request_to_yojson
  (x : put_access_control_rule_request) =
  assoc_to_yojson
    [("NotImpersonationRoleIds",
       (option_to_yojson impersonation_role_id_list_to_yojson
          x.not_impersonation_role_ids));
    ("ImpersonationRoleIds",
      (option_to_yojson impersonation_role_id_list_to_yojson
         x.impersonation_role_ids));
    ("OrganizationId", (Some (organization_id_to_yojson x.organization_id)));
...
let delegate_to_yojson (x : delegate) =
  assoc_to_yojson
    [("Type", (Some (member_type_to_yojson x.type_)));
    ("Id", (Some (string__to_yojson x.id)))]
let resource_delegates_to_yojson tree =
  list_to_yojson delegate_to_yojson tree
let list_resource_delegates_response_to_yojson
  (x : list_resource_delegates_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Delegates",
      (option_to_yojson resource_delegates_to_yojson x.delegates))]
let list_resource_delegates_request_to_yojson
  (x : list_resource_delegates_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("ResourceId", (Some (entity_identifier_to_yojson x.resource_id)));
...
let organization_summaries_to_yojson tree =
  list_to_yojson organization_summary_to_yojson tree
let list_organizations_response_to_yojson (x : list_organizations_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("OrganizationSummaries",
      (option_to_yojson organization_summaries_to_yojson
         x.organization_summaries))]
...
let mobile_device_access_rule_to_yojson (x : mobile_device_access_rule) =
  assoc_to_yojson
    ...
    ("MobileDeviceAccessRuleId",
      (option_to_yojson mobile_device_access_rule_id_to_yojson
         x.mobile_device_access_rule_id))]
...
let list_mobile_device_access_rules_request_to_yojson
  (x : list_mobile_device_access_rules_request) =
  assoc_to_yojson
    [("OrganizationId", (Some (organization_id_to_yojson x.organization_id)))]
let mobile_device_access_override_to_yojson
  (x : mobile_device_access_override) =
  assoc_to_yojson
    [("DateModified", (option_to_yojson timestamp_to_yojson x.date_modified));
    ("DateCreated", (option_to_yojson timestamp_to_yojson x.date_created));
    ("Description",
...
let list_mobile_device_access_overrides_response_to_yojson
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Overrides",
      (option_to_yojson mobile_device_access_overrides_list_to_yojson
         x.overrides))]
...
let mail_domain_summary_to_yojson (x : mail_domain_summary) =
  assoc_to_yojson
    ...
    ("DomainName", (option_to_yojson domain_name_to_yojson x.domain_name))]
let mail_domains_to_yojson tree =
  list_to_yojson mail_domain_summary_to_yojson tree
...
let impersonation_role_to_yojson (x : impersonation_role) =
  assoc_to_yojson
    ...
    ("ImpersonationRoleId",
      (option_to_yojson impersonation_role_id_to_yojson
         x.impersonation_role_id))]
let impersonation_role_list_to_yojson tree =
  list_to_yojson impersonation_role_to_yojson tree
let list_impersonation_roles_response_to_yojson
  (x : list_impersonation_roles_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Roles", (option_to_yojson impersonation_role_list_to_yojson x.roles))]
let list_impersonation_roles_request_to_yojson
  (x : list_impersonation_roles_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("OrganizationId", (Some (organization_id_to_yojson x.organization_id)))]
...
let availability_provider_type_to_yojson (x : availability_provider_type) =
  match x with | LAMBDA -> `String "LAMBDA" | EWS -> `String "EWS"
let redacted_ews_availability_provider_to_yojson
  (x : redacted_ews_availability_provider) =
  assoc_to_yojson
    [("EwsUsername",
  ...
  assoc_to_yojson
    ...
    ("LambdaProvider",
      (option_to_yojson lambda_availability_provider_to_yojson
         x.lambda_provider));
    ("EwsProvider",
      (option_to_yojson redacted_ews_availability_provider_to_yojson
         x.ews_provider));
    ("ProviderType",
...
let list_availability_configurations_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AvailabilityConfigurations",
      (option_to_yojson availability_configuration_list_to_yojson
         x.availability_configurations))]
...
let access_control_rule_to_yojson (x : access_control_rule) =
  assoc_to_yojson
    ...
    ("IpRanges", (option_to_yojson ip_range_list_to_yojson x.ip_ranges));
    ("Description",
      (option_to_yojson access_control_rule_description_to_yojson
         x.description));
    ("Effect",
...
let access_control_rules_list_to_yojson tree =
  list_to_yojson access_control_rule_to_yojson tree
let list_access_control_rules_response_to_yojson
  (x : list_access_control_rules_response) =
  assoc_to_yojson
    [("Rules",
...
let mobile_device_access_matched_rule_to_yojson
  (x : mobile_device_access_matched_rule) =
  assoc_to_yojson
    [("Name",
       (option_to_yojson mobile_device_access_rule_name_to_yojson x.name));
    ("MobileDeviceAccessRuleId",
...
let get_mobile_device_access_effect_response_to_yojson
  ...
  assoc_to_yojson
    [("MatchedRules",
       (option_to_yojson mobile_device_access_matched_rule_list_to_yojson
          x.matched_rules));
    ("Effect",
      (option_to_yojson mobile_device_access_rule_effect_to_yojson x.effect_))]
let get_mobile_device_access_effect_request_to_yojson
  (x : get_mobile_device_access_effect_request) =
  assoc_to_yojson
    [("DeviceUserAgent",
       (option_to_yojson device_user_agent_to_yojson x.device_user_agent));
    ("DeviceOperatingSystem",
      (option_to_yojson device_operating_system_to_yojson
...
let dns_record_verification_status_to_yojson
  (x : dns_record_verification_status) =
  match x with
  | FAILED -> `String "FAILED"
...
let get_mail_domain_response_to_yojson (x : get_mail_domain_response) =
  assoc_to_yojson
    [("DkimVerificationStatus",
       (option_to_yojson dns_record_verification_status_to_yojson
          x.dkim_verification_status));
    ("OwnershipVerificationStatus",
      (option_to_yojson dns_record_verification_status_to_yojson
         x.ownership_verification_status));
...
let impersonation_matched_rule_to_yojson (x : impersonation_matched_rule) =
  assoc_to_yojson
    [("Name", (option_to_yojson impersonation_rule_name_to_yojson x.name));
    ("ImpersonationRuleId",
      (option_to_yojson impersonation_rule_id_to_yojson
         x.impersonation_rule_id))]
...
let get_impersonation_role_effect_response_to_yojson
  (x : get_impersonation_role_effect_response) =
  assoc_to_yojson
    [("MatchedRules",
       (option_to_yojson impersonation_matched_rule_list_to_yojson
          x.matched_rules));
    ("Effect", (option_to_yojson access_effect_to_yojson x.effect_));
    ("Type", (option_to_yojson impersonation_role_type_to_yojson x.type_))]
let get_impersonation_role_effect_request_to_yojson
  (x : get_impersonation_role_effect_request) =
  assoc_to_yojson
...
let get_impersonation_role_response_to_yojson
  (x : get_impersonation_role_response) =
  assoc_to_yojson
    [("DateModified", (option_to_yojson timestamp_to_yojson x.date_modified));
    ("DateCreated", (option_to_yojson timestamp_to_yojson x.date_created));
...
let get_impersonation_role_request_to_yojson
  (x : get_impersonation_role_request) =
  assoc_to_yojson
    [("ImpersonationRoleId",
       (Some (impersonation_role_id_to_yojson x.impersonation_role_id)));
    ("OrganizationId", (Some (organization_id_to_yojson x.organization_id)))]
let get_default_retention_policy_response_to_yojson
  (x : get_default_retention_policy_response) =
  assoc_to_yojson
    [("FolderConfigurations",
       (option_to_yojson folder_configurations_to_yojson
          x.folder_configurations));
...
let get_default_retention_policy_request_to_yojson
  (x : get_default_retention_policy_request) =
  assoc_to_yojson
    [("OrganizationId", (Some (organization_id_to_yojson x.organization_id)))]
...
let get_access_control_effect_response_to_yojson
  (x : get_access_control_effect_response) =
  assoc_to_yojson
    [("MatchedRules",
       (option_to_yojson access_control_rule_name_list_to_yojson
          x.matched_rules));
    ("Effect",
      (option_to_yojson access_control_rule_effect_to_yojson x.effect_))]
let ip_address_to_yojson = string_to_yojson
let get_access_control_effect_request_to_yojson
  (x : get_access_control_effect_request) =
  assoc_to_yojson
    [("ImpersonationRoleId",
       (option_to_yojson impersonation_role_id_to_yojson
          x.impersonation_role_id));
...
let describe_user_response_to_yojson (x : describe_user_response) =
  assoc_to_yojson
    ...
    ("MailboxDeprovisionedDate",
      (option_to_yojson timestamp_to_yojson x.mailbox_deprovisioned_date));
    ("MailboxProvisionedDate",
      (option_to_yojson timestamp_to_yojson x.mailbox_provisioned_date));
    ("DisabledDate", (option_to_yojson timestamp_to_yojson x.disabled_date));
    ("EnabledDate", (option_to_yojson timestamp_to_yojson x.enabled_date));
    ("UserRole", (option_to_yojson user_role_to_yojson x.user_role));
    ("State", (option_to_yojson entity_state_to_yojson x.state));
...
let describe_organization_response_to_yojson
  (x : describe_organization_response) =
  assoc_to_yojson
    ...
    ("ErrorMessage", (option_to_yojson string__to_yojson x.error_message));
    ("CompletedDate",
      (option_to_yojson timestamp_to_yojson x.completed_date));
    ("DefaultMailDomain",
...
let describe_mailbox_export_job_request_to_yojson
  (x : describe_mailbox_export_job_request) =
  assoc_to_yojson
    [("OrganizationId", (Some (organization_id_to_yojson x.organization_id)));
...
let describe_inbound_dmarc_settings_response_to_yojson
  ...
  assoc_to_yojson
    [("Enforced", (option_to_yojson boolean__to_yojson x.enforced))]
...
let create_impersonation_role_response_to_yojson
  (x : create_impersonation_role_response) =
  assoc_to_yojson
    [("ImpersonationRoleId",
       (option_to_yojson impersonation_role_id_to_yojson
          x.impersonation_role_id))]
let create_impersonation_role_request_to_yojson
  (x : create_impersonation_role_request) =
  assoc_to_yojson
    [("Rules", (Some (impersonation_rule_list_to_yojson x.rules)));
    ("Description",
      (option_to_yojson impersonation_role_description_to_yojson
...
let assume_impersonation_role_response_to_yojson
  (x : assume_impersonation_role_response) =
  assoc_to_yojson
...
let assume_impersonation_role_request_to_yojson
  (x : assume_impersonation_role_request) =
  assoc_to_yojson
    [("ImpersonationRoleId",
       (Some (impersonation_role_id_to_yojson x.impersonation_role_id)));
    ("OrganizationId", (Some (organization_id_to_yojson x.organization_id)))]
