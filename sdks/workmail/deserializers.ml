  ...
  ({
     scopes =
       option_of_yojson
         ...
         _list path;
     expires_time = option_of_yojson (value_for_key timestamp__of_yojson "ExpiresTime") _list path;
     date_last_used =
       option_of_yojson (value_for_key timestamp__of_yojson "DateLastUsed") _list path;
...
let describe_user_response_of_yojson tree path =
  ...
  ({
     ...
     mailbox_deprovisioned_date =
       option_of_yojson (value_for_key timestamp__of_yojson "MailboxDeprovisionedDate") _list path;
     mailbox_provisioned_date =
       option_of_yojson (value_for_key timestamp__of_yojson "MailboxProvisionedDate") _list path;
     disabled_date = option_of_yojson (value_for_key timestamp__of_yojson "DisabledDate") _list path;
     enabled_date = option_of_yojson (value_for_key timestamp__of_yojson "EnabledDate") _list path;
     user_role = option_of_yojson (value_for_key user_role_of_yojson "UserRole") _list path;
     state = option_of_yojson (value_for_key entity_state_of_yojson "State") _list path;
...
let describe_organization_response_of_yojson tree path =
  ...
  ({
     ...
     error_message = option_of_yojson (value_for_key string__of_yojson "ErrorMessage") _list path;
     completed_date =
       option_of_yojson (value_for_key timestamp__of_yojson "CompletedDate") _list path;
     default_mail_domain =
