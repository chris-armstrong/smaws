...
let update_user_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_user_response = () in _res
  ...
  let _res : update_user_request =
    {
      ...
      telephone =
        (option_of_yojson
           (value_for_key user_attribute_of_yojson "Telephone") _list path);
      initials =
      ...
      first_name =
        (option_of_yojson
           (value_for_key user_attribute_of_yojson "FirstName") _list path);
      display_name =
        (option_of_yojson
...
let update_resource_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_resource_response = () in _res
...
let update_primary_email_address_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_primary_email_address_response = () in _res
...
let update_mobile_device_access_rule_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_mobile_device_access_rule_response = () in _res
  ...
  let _res : update_mobile_device_access_rule_request =
    {
      ...
      not_device_models =
        (option_of_yojson
           (value_for_key device_model_list_of_yojson "NotDeviceModels")
           _list path);
      device_models =
        (option_of_yojson
      ...
      device_types =
        (option_of_yojson
           (value_for_key device_type_list_of_yojson "DeviceTypes") _list
           path);
      effect_ =
...
let update_mailbox_quota_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_mailbox_quota_response = () in _res
...
let update_impersonation_role_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_impersonation_role_response = () in _res
  ...
  let _res : impersonation_rule =
    {
      ...
      target_users =
        (option_of_yojson
           (value_for_key target_users_of_yojson "TargetUsers") _list path);
      ...
      name =
        (option_of_yojson
           (value_for_key impersonation_rule_name_of_yojson "Name") _list
           path);
...
let update_group_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_group_response = () in _res
...
let update_default_mail_domain_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_default_mail_domain_response = () in _res
...
let update_default_mail_domain_request_of_yojson tree path =
  ...
  let _res : update_default_mail_domain_request =
    {
      domain_name =
        (value_for_key work_mail_domain_name_of_yojson "DomainName" _list
           path);
      organization_id =
        (value_for_key organization_id_of_yojson "OrganizationId" _list path)
    } in
...
let update_availability_configuration_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_availability_configuration_response = () in _res
...
let lambda_availability_provider_of_yojson tree path =
  ...
  let _res : lambda_availability_provider =
    {
      lambda_arn =
        (value_for_key lambda_arn_of_yojson "LambdaArn" _list path)
    } in
  _res
...
let reset_password_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : reset_password_response = () in _res
...
let register_to_work_mail_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : register_to_work_mail_response = () in _res
...
let register_mail_domain_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : register_mail_domain_response = () in _res
...
let put_retention_policy_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : put_retention_policy_response = () in _res
...
let put_mobile_device_access_override_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : put_mobile_device_access_override_response = () in _res
...
let put_mailbox_permissions_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : put_mailbox_permissions_response = () in _res
...
let put_inbound_dmarc_settings_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : put_inbound_dmarc_settings_response = () in _res
...
let put_email_monitoring_configuration_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : put_email_monitoring_configuration_response = () in _res
...
let put_access_control_rule_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : put_access_control_rule_response = () in _res
  ...
  let _res : user =
    {
      disabled_date =
        (option_of_yojson (value_for_key timestamp__of_yojson "DisabledDate")
           _list path);
      enabled_date =
        (option_of_yojson (value_for_key timestamp__of_yojson "EnabledDate")
           _list path);
      user_role =
        (option_of_yojson (value_for_key user_role_of_yojson "UserRole")
           _list path);
      state =
        (option_of_yojson (value_for_key entity_state_of_yojson "State")
           _list path);
      display_name =
  ...
  let _res : list_resources_filters =
    {
      ...
      primary_email_prefix =
        (option_of_yojson
           (value_for_key string__of_yojson "PrimaryEmailPrefix") _list path);
      name_prefix =
        (option_of_yojson (value_for_key string__of_yojson "NamePrefix")
           _list path)
    } in
  _res
  ...
  let _res : list_resource_delegates_response =
    {
      ...
      delegates =
        (option_of_yojson
           (value_for_key resource_delegates_of_yojson "Delegates") _list
           path)
    } in
  _res
...
let organization_summary_of_yojson tree path =
  ...
  let _res : organization_summary =
    {
      state =
        (option_of_yojson (value_for_key string__of_yojson "State") _list
           path);
      error_message =
...
let mobile_device_access_rule_of_yojson tree path =
  ...
  let _res : mobile_device_access_rule =
    {
      date_modified =
        (option_of_yojson (value_for_key timestamp__of_yojson "DateModified")
           _list path);
      date_created =
  ...
  let _res : mobile_device_access_override =
    {
      ...
      effect_ =
        (option_of_yojson
           ...
           _list path);
      device_id =
        (option_of_yojson (value_for_key device_id_of_yojson "DeviceId")
           _list path);
      user_id =
        (option_of_yojson
           (value_for_key work_mail_identifier_of_yojson "UserId") _list path)
  ...
  let _res : list_mail_domains_response =
    {
      ...
      mail_domains =
        (option_of_yojson
           (value_for_key mail_domains_of_yojson "MailDomains") _list path)
    } in
  _res
  ...
  let _res : mailbox_export_job =
    {
      ...
      estimated_progress =
        (option_of_yojson
           (value_for_key percentage_of_yojson "EstimatedProgress") _list
           path);
      s3_path =
  ...
  let _res : impersonation_role =
    {
      ...
      type_ =
        (option_of_yojson
           (value_for_key impersonation_role_type_of_yojson "Type") _list
           path);
      name =
        (option_of_yojson
           (value_for_key impersonation_role_name_of_yojson "Name") _list
           path);
      impersonation_role_id =
        (option_of_yojson
  ...
  let _res : group_identifier =
    {
      ...
      group_id =
        (option_of_yojson
           (value_for_key work_mail_identifier_of_yojson "GroupId") _list
           path)
    } in
  _res
  ...
  let _res : list_groups_for_entity_response =
    {
      ...
      groups =
        (option_of_yojson
           (value_for_key group_identifiers_of_yojson "Groups") _list path)
    } in
  _res
  ...
  let _res : list_groups_response =
    {
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      groups =
        (option_of_yojson (value_for_key groups_of_yojson "Groups") _list
           path)
    } in
  _res
  ...
  let _res : access_control_rule =
    {
      ...
      effect_ =
        (option_of_yojson
           (value_for_key access_control_rule_effect_of_yojson "Effect")
           _list path);
      name =
        (option_of_yojson
  ...
  let _res : get_mobile_device_access_effect_request =
    {
      device_user_agent =
        (option_of_yojson
           (value_for_key device_user_agent_of_yojson "DeviceUserAgent")
           _list path);
      ...
      device_model =
        (option_of_yojson
           (value_for_key device_model_of_yojson "DeviceModel") _list path);
      device_type =
  ...
  let _res : get_mailbox_details_response =
    {
      mailbox_size =
        (option_of_yojson
           (value_for_key mailbox_size_of_yojson "MailboxSize") _list path);
      mailbox_quota =
        (option_of_yojson
           (value_for_key mailbox_quota_of_yojson "MailboxQuota") _list path)
    } in
  ...
  let _res : get_access_control_effect_request =
    {
      ...
      action =
        (value_for_key access_control_rule_action_of_yojson "Action" _list
           path);
      ip_address =
        (value_for_key ip_address_of_yojson "IpAddress" _list path);
      organization_id =
        (value_for_key organization_id_of_yojson "OrganizationId" _list path)
    } in
  _res
let disassociate_member_from_group_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : disassociate_member_from_group_response = () in _res
...
let disassociate_delegate_from_resource_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : disassociate_delegate_from_resource_response = () in _res
  ...
  let _res : describe_user_response =
    {
      ...
      mailbox_deprovisioned_date =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "MailboxDeprovisionedDate")
           _list path);
      mailbox_provisioned_date =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "MailboxProvisionedDate")
           _list path);
      disabled_date =
        (option_of_yojson (value_for_key timestamp__of_yojson "DisabledDate")
           _list path);
  ...
  let _res : describe_organization_response =
    {
      ...
      ar_n =
        (option_of_yojson
           (value_for_key amazon_resource_name_of_yojson "ARN") _list path);
      error_message =
        (option_of_yojson (value_for_key string__of_yojson "ErrorMessage")
           _list path);
      completed_date =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "CompletedDate") _list path);
      default_mail_domain =
        (option_of_yojson
...
let deregister_mail_domain_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : deregister_mail_domain_response = () in _res
...
let deregister_from_work_mail_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : deregister_from_work_mail_response = () in _res
...
let delete_user_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_user_response = () in _res
...
let delete_retention_policy_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_retention_policy_response = () in _res
...
let delete_resource_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_resource_response = () in _res
...
let delete_mobile_device_access_rule_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_mobile_device_access_rule_response = () in _res
...
let delete_mobile_device_access_override_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_mobile_device_access_override_response = () in _res
...
let delete_mailbox_permissions_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_mailbox_permissions_response = () in _res
...
let delete_impersonation_role_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_impersonation_role_response = () in _res
...
let delete_group_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_group_response = () in _res
...
let delete_email_monitoring_configuration_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_email_monitoring_configuration_response = () in _res
...
let delete_availability_configuration_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_availability_configuration_response = () in _res
...
let delete_alias_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_alias_response = () in _res
...
let delete_access_control_rule_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : delete_access_control_rule_response = () in _res
...
let create_availability_configuration_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : create_availability_configuration_response = () in _res
...
let create_alias_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : create_alias_response = () in _res
...
let cancel_mailbox_export_job_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : cancel_mailbox_export_job_response = () in _res
...
let associate_member_to_group_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : associate_member_to_group_response = () in _res
...
let associate_delegate_to_resource_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : associate_delegate_to_resource_response = () in _res
