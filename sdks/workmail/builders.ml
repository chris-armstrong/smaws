...
let make_update_user_request
  ?identity_provider_user_id:(identity_provider_user_id_ :
                               identity_provider_user_id_for_update option)
  ?office:(office_ : user_attribute option)
  ?country:(country_ : user_attribute option)
  ?department:(department_ : user_attribute option)
  ?zip_code:(zip_code_ : user_attribute option)
  ?company:(company_ : user_attribute option)
  ?city:(city_ : user_attribute option)
  ?job_title:(job_title_ : user_attribute option)
  ?street:(street_ : user_attribute option)
  ?telephone:(telephone_ : user_attribute option)
  ?initials:(initials_ : user_attribute option)
  ...
  ?role:(role_ : user_role option) ~user_id:(user_id_ : entity_identifier)
...
let make_update_mobile_device_access_rule_request
  ...
  ?not_device_operating_systems:(not_device_operating_systems_ :
                                  device_operating_system_list option)
...
let make_update_mailbox_quota_request
  ~mailbox_quota:(mailbox_quota_ : mailbox_quota)
...
let make_update_impersonation_role_request
  ...
  ~type_:(type__ : impersonation_role_type)
...
let make_ews_availability_provider ~ews_password:(ews_password_ : password)
  ~ews_username:(ews_username_ : external_user_name)
  ~ews_endpoint:(ews_endpoint_ : url) () =
  ({
...
let make_start_mailbox_export_job_response
...
let make_reset_password_request ~password:(password_ : password)
  ~user_id:(user_id_ : work_mail_identifier)
  ~organization_id:(organization_id_ : organization_id) () =
  ({
     password = password_;
     user_id = user_id_;
...
let make_put_mobile_device_access_override_request
  ?description:(description_ : mobile_device_access_rule_description option)
  ~effect_:(effect__ : mobile_device_access_rule_effect)
  ~device_id:(device_id_ : device_id) ~user_id:(user_id_ : entity_identifier)
  ~organization_id:(organization_id_ : organization_id) () =
  ({
     description = description_;
     effect_ = effect__;
...
let make_put_mailbox_permissions_request
  ...
  ~grantee_id:(grantee_id_ : entity_identifier)
  ~entity_id:(entity_id_ : entity_identifier)
  ~organization_id:(organization_id_ : organization_id) () =
  ({
...
let make_personal_access_token_configuration
  ?lifetime_in_days:(lifetime_in_days_ :
                      personal_access_token_lifetime_in_days option)
...
let make_put_access_control_rule_request
  ?not_impersonation_role_ids:(not_impersonation_role_ids_ :
                                impersonation_role_id_list option)
  ...
  ?not_actions:(not_actions_ : actions_list option)
  ?actions:(actions_ : actions_list option)
  ...
  ~effect_:(effect__ : access_control_rule_effect)
...
let make_user
  ?identity_provider_identity_store_id:(identity_provider_identity_store_id_
                                         ...
                                         identity_provider_identity_store_id
                                           option)
  ?identity_provider_user_id:(identity_provider_user_id_ :
                               identity_provider_user_id option)
...
let make_list_users_filters
  ?identity_provider_user_id_prefix:(identity_provider_user_id_prefix_ :
                                      identity_provider_user_id_prefix option)
  ?state:(state_ : entity_state option)
...
let make_resource ?description:(description_ : resource_description option)
  ...
  ?email:(email_ : email_address option)
  ?id:(id_ : work_mail_identifier option) () =
  ({
     description = description_;
     disabled_date = disabled_date_;
...
let make_personal_access_token_summary
  ...
  ?personal_access_token_id:(personal_access_token_id_ :
                              personal_access_token_id option)
  () =
  ({
     scopes = scopes_;
...
let make_list_personal_access_tokens_response
  ?personal_access_token_summaries:(personal_access_token_summaries_ :
                                     personal_access_token_summary_list
                                       option)
  ?next_token:(next_token_ : next_token option) () =
  ({
     personal_access_token_summaries = personal_access_token_summaries_;
...
let make_list_personal_access_tokens_request
  ?max_results:(max_results_ : max_results option)
  ?next_token:(next_token_ : next_token option)
  ?user_id:(user_id_ : entity_identifier option)
  ~organization_id:(organization_id_ : organization_id) () =
  ({
     max_results = max_results_;
     next_token = next_token_;
...
let make_mobile_device_access_rule
  ...
  ?mobile_device_access_rule_id:(mobile_device_access_rule_id_ :
                                  mobile_device_access_rule_id option)
  () =
  ({
...
let make_permission
  ...
  ~grantee_id:(grantee_id_ : work_mail_identifier) () =
  ({
     permission_values = permission_values_;
...
let make_list_mailbox_export_jobs_response
  ?next_token:(next_token_ : next_token option) ?jobs:(jobs_ : jobs option)
  () =
...
let make_impersonation_role
  ...
  ?name:(name_ : impersonation_role_name option)
  ?impersonation_role_id:(impersonation_role_id_ :
                           impersonation_role_id option)
  () =
  ({
     date_modified = date_modified_;
     date_created = date_created_;
...
let make_list_groups_for_entity_filters
  ?group_name_prefix:(group_name_prefix_ : string_ option) () =
...
let make_group ?disabled_date:(disabled_date_ : timestamp option)
  ?enabled_date:(enabled_date_ : timestamp option)
  ?state:(state_ : entity_state option) ?name:(name_ : group_name option)
  ?email:(email_ : email_address option)
  ?id:(id_ : work_mail_identifier option) () =
  ({
     disabled_date = disabled_date_;
...
let make_member ?disabled_date:(disabled_date_ : timestamp option)
  ...
  ?name:(name_ : string_ option) ?id:(id_ : string_ option) () =
  ({
     disabled_date = disabled_date_;
     enabled_date = enabled_date_;
     state = state_;
...
let make_list_availability_configurations_response
  ...
  ?availability_configurations:(availability_configurations_ :
                                 availability_configuration_list option)
  () =
  ({
     next_token = next_token_;
     availability_configurations = availability_configurations_
...
let make_list_access_control_rules_response
  ?rules:(rules_ : access_control_rules_list option) () =
...
let make_get_mobile_device_access_effect_response
  ?matched_rules:(matched_rules_ :
                   mobile_device_access_matched_rule_list option)
  ?effect_:(effect__ : mobile_device_access_rule_effect option) () =
...
let make_get_mobile_device_access_effect_request
  ...
  ?device_operating_system:(device_operating_system_ :
                             device_operating_system option)
...
let make_dns_record ?value:(value_ : string_ option)
  ?hostname:(hostname_ : string_ option) ?type_:(type__ : string_ option) ()
...
let make_get_mail_domain_response
  ...
  ?is_test_domain:(is_test_domain_ : boolean_ option)
...
let make_get_default_retention_policy_response
  ?folder_configurations:(folder_configurations_ :
                           folder_configurations option)
  ?description:(description_ : string_ option)
  ?name:(name_ : short_string option) ?id:(id_ : short_string option) () =
  ({
     folder_configurations = folder_configurations_;
     description = description_;
     name = name_;
...
let make_get_access_control_effect_request
  ...
  ~ip_address:(ip_address_ : ip_address)
  ~organization_id:(organization_id_ : organization_id) () =
  ({
     impersonation_role_id = impersonation_role_id_;
     user_id = user_id_;
...
let make_describe_organization_response
  ...
  ?ar_n:(ar_n_ : amazon_resource_name option)
  ?error_message:(error_message_ : string_ option)
  ...
  ?state:(state_ : string_ option) ?alias:(alias_ : organization_name option)
  ?organization_id:(organization_id_ : organization_id option) () =
  ({
...
let make_describe_inbound_dmarc_settings_response
  ?enforced:(enforced_ : boolean_ option) () =
...
let make_create_user_request
  ...
  ?last_name:(last_name_ : user_attribute option)
  ?first_name:(first_name_ : user_attribute option)
  ?role:(role_ : user_role option) ?password:(password_ : password option)
  ~display_name:(display_name_ : user_attribute) ~name:(name_ : user_name)
  ~organization_id:(organization_id_ : organization_id) () =
  ({
     identity_provider_user_id = identity_provider_user_id_;
     hidden_from_global_address_list = hidden_from_global_address_list_;
...
let make_create_resource_response
  ?resource_id:(resource_id_ : resource_id option) () =
...
let make_create_resource_request
  ?hidden_from_global_address_list:(hidden_from_global_address_list_ :
                                     boolean_ option)
  ?description:(description_ : resource_description option)
  ~type_:(type__ : resource_type) ~name:(name_ : resource_name)
  ~organization_id:(organization_id_ : organization_id) () =
  ({
     hidden_from_global_address_list = hidden_from_global_address_list_;
     description = description_;
...
let make_create_organization_request
  ...
  ?kms_key_arn:(kms_key_arn_ : kms_key_arn option)
  ?domains:(domains_ : domains option)
  ?client_token:(client_token_ : idempotency_client_token option)
