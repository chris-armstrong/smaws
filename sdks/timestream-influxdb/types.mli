...
type nonrec deployment_type = WITH_MULTIAZ_STANDBY [@ocaml.doc ""] | SINGLE_AZ [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec failover_mode = NO_FAILOVER [@ocaml.doc ""] | AUTOMATIC [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec tracing_type = DISABLED [@ocaml.doc ""] | JAEGER [@ocaml.doc ""] | LOG [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec log_level = ERROR [@ocaml.doc ""] | INFO [@ocaml.doc ""] | DEBUG [@ocaml.doc ""]
[@@ocaml.doc ""]
