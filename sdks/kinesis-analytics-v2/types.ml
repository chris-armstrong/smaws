...
type nonrec zeppelin_monitoring_configuration_description = {
  log_level : log_level option;
      [@ocaml.doc "Describes the verbosity of the CloudWatch Logs for an application.\n"]
}
[@@ocaml.doc
  "The monitoring configuration for Apache Zeppelin within a Managed Service for Apache Flink \
   Studio notebook.\n"]

type nonrec zeppelin_monitoring_configuration = {
  log_level : log_level; [@ocaml.doc "The verbosity of the CloudWatch Logs for an application.\n"]
}
[@@ocaml.doc
  "Describes configuration parameters for Amazon CloudWatch logging for a Managed Service for \
   Apache Flink Studio notebook. For more information about CloudWatch logging, see \
...
[@@ocaml.doc
  "Updates to the configuration of the Glue Data Catalog that you use for SQL queries that you \
...
type nonrec catalog_configuration_update = {
  glue_data_catalog_configuration_update : glue_data_catalog_configuration_update;
      [@ocaml.doc
        "Updates to the configuration parameters for the default Amazon Glue database. You use \
         this database for SQL queries that you write in a Managed Service for Apache Flink Studio \
         notebook.\n"]
}
[@@ocaml.doc
  "Updates to the configuration parameters for the default Amazon Glue database. You use this \
   database for SQL queries that you write in a Managed Service for Apache Flink Studio notebook.\n"]
...
type nonrec s3_content_base_location_update = {
  base_path_update : base_path option; [@ocaml.doc "The updated S3 bucket path.\n"]
...
[@@ocaml.doc
  "Updates to the configuration information required to deploy an Amazon Data Analytics Studio \
   notebook as an application with durable state.\n"]

type nonrec artifact_type = DEPENDENCY_JAR [@ocaml.doc ""] | UDF [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec s3_content_location = {
  object_version : object_version option;
      [@ocaml.doc "The version of the object containing the application code.\n"]
  file_key : file_key; [@ocaml.doc "The file key for the object containing the application code.\n"]
  bucket_ar_n : bucket_ar_n;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) for the S3 bucket containing the application code.\n"]
}
[@@ocaml.doc
  "For a Managed Service for Apache Flink application provides a description of an Amazon S3 \
   object, including the Amazon Resource Name (ARN) of the S3 bucket, the name of the Amazon S3 \
   object that contains the data, and the version number of the Amazon S3 object that contains the \
   data. \n"]
...
type nonrec maven_reference = {
  ...
  artifact_id : maven_artifact_id; [@ocaml.doc "The artifact ID of the Maven reference.\n"]
  group_id : maven_group_id; [@ocaml.doc "The group ID of the Maven reference.\n"]
}
[@@ocaml.doc
...
type nonrec custom_artifact_configuration = {
  maven_reference : maven_reference option;
      [@ocaml.doc "The parameters required to fully specify a Maven reference.\n"]
  s3_content_location : s3_content_location option; [@ocaml.doc ""]
  artifact_type : artifact_type;
      [@ocaml.doc
        " [UDF] stands for user-defined functions. This type of artifact must be in an S3 bucket. \
         A [DEPENDENCY_JAR] can be in either Maven or an S3 bucket.\n"]
}
[@@ocaml.doc
  "Specifies dependency JARs, as well as JAR files that contain user-defined functions (UDF).\n"]

type nonrec custom_artifacts_configuration_list = custom_artifact_configuration list
[@@ocaml.doc ""]

type nonrec zeppelin_application_configuration_update = {
  custom_artifacts_configuration_update : custom_artifacts_configuration_list option;
      [@ocaml.doc
  ...
  catalog_configuration_update : catalog_configuration_update option;
      [@ocaml.doc
        "Updates to the configuration of the Amazon Glue Data Catalog that is associated with the \
...
[@@ocaml.doc "Updates to the configuration of Managed Service for Apache Flink Studio notebook.\n"]

type nonrec glue_data_catalog_configuration_description = {
  database_ar_n : database_ar_n; [@ocaml.doc "The Amazon Resource Name (ARN) of the database.\n"]
}
[@@ocaml.doc
...
[@@ocaml.doc
  "The configuration parameters for the default Amazon Glue database. You use this database for \
   Apache Flink SQL queries and table API transforms that you write in a Managed Service for \
   Apache Flink Studio notebook.\n"]

type nonrec s3_content_base_location_description = {
  base_path : base_path option; [@ocaml.doc "The base path for the S3 bucket.\n"]
  bucket_ar_n : bucket_ar_n; [@ocaml.doc "The Amazon Resource Name (ARN) of the S3 bucket.\n"]
}
[@@ocaml.doc "The description of the S3 base location that holds the application.\n"]
...
type nonrec custom_artifact_configuration_description = {
  maven_reference_description : maven_reference option;
      [@ocaml.doc "The parameters that are required to specify a Maven dependency.\n"]
...
[@@ocaml.doc "Specifies a dependency JAR or a JAR of user-defined functions.\n"]
...
type nonrec zeppelin_application_configuration_description = {
  custom_artifacts_configuration_description :
    custom_artifacts_configuration_description_list option;
      [@ocaml.doc "Custom artifacts are dependency JARs and user-defined functions (UDF).\n"]
  deploy_as_application_configuration_description :
    deploy_as_application_configuration_description option;
      [@ocaml.doc
        "The parameters required to deploy a Managed Service for Apache Flink Studio notebook as \
         an application with durable state.\n"]
  catalog_configuration_description : catalog_configuration_description option;
      [@ocaml.doc
        "The Amazon Glue Data Catalog that is associated with the Managed Service for Apache Flink \
         Studio notebook.\n"]
...
[@@ocaml.doc "The configuration of a Managed Service for Apache Flink Studio notebook.\n"]
...
type nonrec catalog_configuration = {
  glue_data_catalog_configuration : glue_data_catalog_configuration;
      [@ocaml.doc
        "The configuration parameters for the default Amazon Glue database. You use this database \
         for Apache Flink SQL queries and table API transforms that you write in a Managed Service \
...
type nonrec zeppelin_application_configuration = {
  ...
  deploy_as_application_configuration : deploy_as_application_configuration option;
      [@ocaml.doc
        "The information required to deploy a Managed Service for Apache Flink Studio notebook as \
         an application with durable state.\n"]
...
type nonrec vpc_configuration = {
  ...
  subnet_ids : subnet_ids;
      [@ocaml.doc
        "The array of \
         {{:https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Subnet.html}Subnet} IDs \
  ...
  subnet_id_updates : subnet_ids option;
      [@ocaml.doc
        "Describes updates to the array of \
         {{:https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Subnet.html}Subnet} IDs \
         used by the VPC configuration.\n"]
  vpc_configuration_id : id; [@ocaml.doc "Describes an update to the ID of the VPC configuration.\n"]
}
[@@ocaml.doc "Describes updates to the VPC configuration used by the application.\n"]

type nonrec vpc_configuration_updates = vpc_configuration_update list [@@ocaml.doc ""]
...
type nonrec vpc_configuration_descriptions = vpc_configuration_description list [@@ocaml.doc ""]

type nonrec url_type = ZEPPELIN_UI_URL [@ocaml.doc ""] | FLINK_DASHBOARD_URL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, an object that contains the Amazon Resource \
   Name (ARN) of the Amazon Lambda function that is used to preprocess records in the stream.\n"]
...
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, provides the configuration information \
   about an input processor. Currently, the only input processor available is \
...
type nonrec record_format_type = CSV [@ocaml.doc ""] | JSON [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec record_row_path = string [@@ocaml.doc ""]

type nonrec json_mapping_parameters = {
  record_row_path : record_row_path;
      [@ocaml.doc "The path to the top-level parent that contains the records.\n"]
}
[@@ocaml.doc
...
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, provides additional mapping information \
   when the record format uses delimiters, such as CSV. For example, the following sample records \
...
type nonrec record_format = {
  ...
  record_format_type : record_format_type; [@ocaml.doc "The type of record format.\n"]
}
[@@ocaml.doc
...
type nonrec source_schema = {
  record_columns : record_columns; [@ocaml.doc "A list of [RecordColumn] objects. \n"]
  record_encoding : record_encoding option;
      [@ocaml.doc
        "Specifies the encoding of the records in the streaming source. For example, UTF-8.\n"]
  record_format : record_format;
      [@ocaml.doc "Specifies the format of the records on the streaming source.\n"]
}
[@@ocaml.doc
  ...
  input_starting_position : input_starting_position option;
      [@ocaml.doc
        ...
        \       {-   [TRIM_HORIZON] - Start reading at the last untrimmed record in the stream, \
         which is the oldest record available in the stream. This option is not available for an \
...
[@@ocaml.doc "Describes the point at which the application reads from the streaming source.\n"]
...
type nonrec input_description = {
  ...
  name_prefix : in_app_stream_name option; [@ocaml.doc "The in-application name prefix.\n"]
  input_id : id option;
      [@ocaml.doc
...
[@@ocaml.doc
  "For an SQL-based Kinesis Data Analytics application's output, describes the Kinesis data stream \
...
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application's output, describes the Kinesis Data \
   Firehose delivery stream that is configured as its destination.\n"]
...
type nonrec lambda_output_description = {
  role_ar_n : role_ar_n option;
      [@ocaml.doc
        ...
        \   "]
  resource_ar_n : resource_ar_n;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the destination Lambda function.\n"]
}
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application's output, describes the Amazon Lambda \
   function that is configured as its destination. \n"]

type nonrec destination_schema = {
  record_format_type : record_format_type;
      [@ocaml.doc "Specifies the format of the records on the output stream.\n"]
}
[@@ocaml.doc
...
type nonrec output_description = {
  destination_schema : destination_schema option;
      [@ocaml.doc "The data format used for writing data to the destination.\n"]
  ...
  name : in_app_stream_name option;
      [@ocaml.doc "The name of the in-application stream that is configured as output.\n"]
  output_id : id option; [@ocaml.doc "A unique identifier for the output configuration.\n"]
}
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, describes the application output \
   configuration, which includes the in-application stream name and the destination where the \
   stream data is written. The destination can be a Kinesis data stream or a Kinesis Data Firehose \
   delivery stream. \n"]
...
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, provides the bucket name and object key \
   name that stores the reference data.\n"]
...
type nonrec reference_data_source_descriptions = reference_data_source_description list
[@@ocaml.doc ""]
...
type nonrec code_content_type = ZIPFILE [@ocaml.doc ""] | PLAINTEXT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
[@@ocaml.doc "Describes the location of an application's code stored in an S3 bucket.\n"]
...
type nonrec code_content_description = {
  ...
  code_m_d5 : code_m_d5 option;
      [@ocaml.doc "The checksum that can be used to validate zip-format code.\n"]
...
type nonrec application_code_configuration_description = {
  code_content_description : code_content_description option;
      [@ocaml.doc "Describes details about the location and format of the application code.\n"]
  code_content_type : code_content_type;
      [@ocaml.doc "Specifies whether the code content is in text or zip format.\n"]
}
...
type nonrec run_configuration_description = {
  flink_run_configuration_description : flink_run_configuration option; [@ocaml.doc ""]
  application_restore_configuration_description : application_restore_configuration option;
      [@ocaml.doc "Describes the restore behavior of a restarting application.\n"]
}
[@@ocaml.doc
...
type nonrec monitoring_configuration_description = {
  ...
  metrics_level : metrics_level option;
      [@ocaml.doc "Describes the granularity of the CloudWatch Logs for an application.\n"]
  configuration_type : configuration_type option;
      [@ocaml.doc
        "Describes whether to use the default CloudWatch logging configuration for an application.\n"]
}
[@@ocaml.doc "Describes configuration parameters for CloudWatch logging for an application.\n"]
  ...
  current_parallelism : parallelism option;
      [@ocaml.doc
        "Describes the current number of parallel tasks that a Managed Service for Apache Flink \
         application can perform. If [AutoScalingEnabled] is set to True, Managed Service for \
         Apache Flink can increase this value in response to application load. The service can \
         increase this value up to the maximum parallelism, which is [ParalellismPerKPU] times the \
         maximum KPUs for the application. The maximum KPUs for an application is 32 by default, \
         and can be increased by requesting a limit increase. If application load is reduced, the \
  ...
  parallelism : parallelism option;
      [@ocaml.doc
        "Describes the initial number of parallel tasks that a Managed Service for Apache Flink \
         application can perform. If [AutoScalingEnabled] is set to True, then Managed Service for \
...
type nonrec property_group = {
  property_map : property_map;
      [@ocaml.doc "Describes the value of an application execution property key-value pair.\n"]
  property_group_id : id;
      [@ocaml.doc "Describes the key of an application execution property key-value pair.\n"]
}
...
[@@ocaml.doc "Describes the execution properties for an Apache Flink runtime.\n"]
...
type nonrec application_configuration_description = {
  ...
  flink_application_configuration_description : flink_application_configuration_description option;
      [@ocaml.doc "The details about a Managed Service for Apache Flink application.\n"]
  run_configuration_description : run_configuration_description option;
      [@ocaml.doc
        "The details about the starting properties for a Managed Service for Apache Flink \
         application.\n"]
...
type nonrec cloud_watch_logging_option_descriptions = cloud_watch_logging_option_description list
[@@ocaml.doc ""]
...
[@@ocaml.doc "The details of the maintenance configuration for the application.\n"]

type nonrec conditional_token = string [@@ocaml.doc ""]

type nonrec application_mode = INTERACTIVE [@ocaml.doc ""] | STREAMING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec application_detail = {
  application_mode : application_mode option;
      [@ocaml.doc
        "To create a Managed Service for Apache Flink Studio notebook, you must set the mode to \
         [INTERACTIVE]. However, for a Managed Service for Apache Flink application, the mode is \
         optional.\n"]
  application_version_rolled_back_to : application_version_id option;
      [@ocaml.doc "The version to which you want to roll back the application.\n"]
  ...
  cloud_watch_logging_option_descriptions : cloud_watch_logging_option_descriptions option;
      [@ocaml.doc "Describes the application Amazon CloudWatch logging options.\n"]
  ...
  last_update_timestamp : timestamp option;
      [@ocaml.doc "The current timestamp when the application was last updated.\n"]
  ...
  application_status : application_status; [@ocaml.doc "The status of the application.\n"]
  ...
  application_ar_n : resource_ar_n; [@ocaml.doc "The ARN of the application.\n"]
}
[@@ocaml.doc
...
type nonrec input_processing_configuration_update = {
  input_lambda_processor_update : input_lambda_processor_update;
      [@ocaml.doc "Provides update information for an [InputLambdaProcessor].\n"]
}
[@@ocaml.doc
...
type nonrec kinesis_streams_input_update = {
  resource_arn_update : resource_ar_n;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the input Kinesis data stream to read.\n"]
}
[@@ocaml.doc
...
type nonrec kinesis_firehose_input_update = {
  resource_arn_update : resource_ar_n;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the input delivery stream to read.\n"]
}
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, when updating application input \
   configuration, provides information about a Kinesis Data Firehose delivery stream as the \
   streaming source.\n"]
...
type nonrec input_update = {
  ...
  input_id : id; [@ocaml.doc "The input ID of the application input to be updated.\n"]
}
[@@ocaml.doc
...
[@@ocaml.doc
  "When you update a SQL-based Kinesis Data Analytics application's output configuration using the \
   [UpdateApplication] operation, provides information about a Kinesis data stream that is \
   configured as the destination.\n"]

type nonrec kinesis_firehose_output_update = {
  resource_arn_update : resource_ar_n;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the delivery stream to write to. \n"]
}
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, when updating an output configuration using \
   the [UpdateApplication] operation, provides information about a Kinesis Data Firehose delivery \
...
[@@ocaml.doc
  "When you update an SQL-based Kinesis Data Analytics application's output configuration using \
   the [UpdateApplication] operation, provides information about an Amazon Lambda function that is \
   configured as the destination.\n"]

type nonrec output_update = {
  destination_schema_update : destination_schema option;
      [@ocaml.doc "Describes the data format when records are written to the destination. \n"]
  lambda_output_update : lambda_output_update option;
      [@ocaml.doc "Describes an Amazon Lambda function as the destination for the output.\n"]
  ...
  kinesis_streams_output_update : kinesis_streams_output_update option;
      [@ocaml.doc "Describes a Kinesis data stream as the destination for the output.\n"]
  ...
  output_id : id;
      [@ocaml.doc "Identifies the specific output configuration that you want to update.\n"]
}
[@@ocaml.doc
...
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, describes the Amazon S3 bucket name and \
   object key name for an in-application reference table. \n"]
...
type nonrec reference_data_source_update = {
  ...
  table_name_update : in_app_table_name option;
      [@ocaml.doc "The in-application table name that is created by this update.\n"]
  reference_id : id;
      [@ocaml.doc
...
[@@ocaml.doc
  "When you update a reference data source configuration for a SQL-based Kinesis Data Analytics \
   application, this object provides all the updated values (such as the source bucket name and \
   object key name), the in-application table name that is created, and updated mapping \
   information that maps the data in the Amazon S3 object to the in-application reference table \
   that is created.\n"]

type nonrec reference_data_source_updates = reference_data_source_update list [@@ocaml.doc ""]
...
type nonrec s3_content_location_update = {
  object_version_update : object_version option;
      [@ocaml.doc "The new version of the object containing the application code.\n"]
  file_key_update : file_key option;
      [@ocaml.doc "The new file key for the object containing the application code.\n"]
  bucket_arn_update : bucket_ar_n option;
      [@ocaml.doc
        "The new Amazon Resource Name (ARN) for the S3 bucket containing the application code.\n"]
}
[@@ocaml.doc "Describes an update for the Amazon S3 code content location for an application.\n"]

type nonrec code_content_update = {
  s3_content_location_update : s3_content_location_update option;
      [@ocaml.doc "Describes an update to the location of code for an application.\n"]
  zip_file_content_update : zip_file_content option;
      [@ocaml.doc "Describes an update to the zipped code for an application.\n"]
  ...
  configuration_type_update : configuration_type option;
      [@ocaml.doc
        "Describes updates to whether the application uses the default checkpointing behavior of \
         Managed Service for Apache Flink. You must set this property to [CUSTOM] in order to set \
...
type nonrec monitoring_configuration_update = {
  log_level_update : log_level option;
      [@ocaml.doc "Describes updates to the verbosity of the CloudWatch Logs for an application.\n"]
  ...
  configuration_type_update : configuration_type option;
      [@ocaml.doc
        "Describes updates to whether to use the default CloudWatch logging configuration for an \
         application. You must set this property to [CUSTOM] in order to set the [LogLevel] or \
  ...
  auto_scaling_enabled_update : boolean_object option;
      [@ocaml.doc
        "Describes updates to whether the Managed Service for Apache Flink service can increase \
         the parallelism of a Managed Service for Apache Flink application in response to \
  ...
  parallelism_update : parallelism option;
      [@ocaml.doc
        "Describes updates to the initial number of parallel tasks an application can perform. If \
         [AutoScalingEnabled] is set to True, then Managed Service for Apache Flink can increase \
         the [CurrentParallelism] value in response to application load. The service can increase \
         [CurrentParallelism] up to the maximum parallelism, which is [ParalellismPerKPU] times \
         the maximum KPUs for the application. The maximum KPUs for an application is 32 by \
         default, and can be increased by requesting a limit increase. If application load is \
         reduced, the service will reduce [CurrentParallelism] down to the [Parallelism] setting.\n"]
  configuration_type_update : configuration_type option;
      [@ocaml.doc
        "Describes updates to whether the application uses the default parallelism for the Managed \
         Service for Apache Flink service, or if a custom parallelism is used. You must set this \
...
type nonrec application_snapshot_configuration_update = {
  snapshots_enabled_update : boolean_object;
      [@ocaml.doc "Describes updates to whether snapshots are enabled for an application.\n"]
}
[@@ocaml.doc
...
type nonrec application_configuration_update = {
  ...
  application_code_configuration_update : application_code_configuration_update option;
      [@ocaml.doc "Describes updates to an application's code configuration.\n"]
...
type nonrec run_configuration_update = {
  application_restore_configuration : application_restore_configuration option;
      [@ocaml.doc "Describes updates to the restore behavior of a restarting application.\n"]
  flink_run_configuration : flink_run_configuration option;
      [@ocaml.doc
        "Describes the starting parameters for a Managed Service for Apache Flink application.\n"]
}
[@@ocaml.doc
  "Describes the updates to the starting parameters for a Managed Service for Apache Flink \
   application.\n"]
...
type nonrec cloud_watch_logging_option_updates = cloud_watch_logging_option_update list
[@@ocaml.doc ""]
...
type nonrec update_application_request = {
  ...
  conditional_token : conditional_token option;
      [@ocaml.doc
        "A value you use to implement strong concurrency for application updates. You must provide \
         the [CurrentApplicationVersionId] or the [ConditionalToken]. You get the application's \
  ...
  cloud_watch_logging_option_updates : cloud_watch_logging_option_updates option;
      [@ocaml.doc
        "Describes application Amazon CloudWatch logging option updates. You can only update \
         ...
         option, use [AddApplicationCloudWatchLoggingOption].\n"]
  run_configuration_update : run_configuration_update option;
      [@ocaml.doc "Describes updates to the application's starting parameters.\n"]
  ...
  current_application_version_id : application_version_id option;
      [@ocaml.doc
        "The current application version ID. You must provide the [CurrentApplicationVersionId] or \
  ...
  application_name : application_name; [@ocaml.doc "The name of the application to update.\n"]
}
[@@ocaml.doc ""]
...
type nonrec update_application_maintenance_configuration_response = {
  application_maintenance_configuration_description :
    application_maintenance_configuration_description option;
      [@ocaml.doc "The application maintenance configuration description after the update.\n"]
...
[@@ocaml.doc "Describes the updated maintenance configuration for the application.\n"]
...
type nonrec update_application_maintenance_configuration_request = {
  application_maintenance_configuration_update : application_maintenance_configuration_update;
      [@ocaml.doc "Describes the application maintenance configuration update.\n"]
...
[@@ocaml.doc "Specified application can't be found.\n"]

type nonrec resource_in_use_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The application is not available for this operation.\n"]

type nonrec invalid_argument_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The specified input parameter value is not valid.\n"]

type nonrec concurrent_modification_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  "Exception thrown as a result of concurrent modifications to an application. This error can be \
   the result of attempting to modify an application without using the current application ID.\n"]

type nonrec limit_exceeded_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The number of allowed resources has been exceeded.\n"]

type nonrec invalid_request_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The request JSON is not valid for the operation.\n"]

type nonrec invalid_application_configuration_exception = {
  message : error_message option; [@ocaml.doc ""]
}
[@@ocaml.doc "The user-provided application configuration is not valid.\n"]

type nonrec code_validation_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
...
type nonrec untag_resource_request = {
  tag_keys : tag_keys;
      [@ocaml.doc "A list of keys of tags to remove from the specified application.\n"]
...
type nonrec tag = {
  value : tag_value option; [@ocaml.doc "The value of the key-value tag. The value is optional.\n"]
  key : tag_key; [@ocaml.doc "The key of the key-value tag.\n"]
}
[@@ocaml.doc
  "A key-value pair (the value is optional) that you can define and assign to Amazon resources. If \
   ...
   The maximum number of user-defined application tags is 50. For more information, see \
...
type nonrec tag_resource_request = {
  tags : tags; [@ocaml.doc "The key-value tags to assign to the application.\n"]
  resource_ar_n : kinesis_analytics_ar_n;
  ...
  force : boolean_object option;
      [@ocaml.doc
        ...
        \     The application must be in the [STARTING], [UPDATING], [STOPPING], [AUTOSCALING], or \
         [RUNNING] status. \n\
        \     "]
  application_name : application_name; [@ocaml.doc "The name of the running application to stop.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, describes a processor that is used to \
   preprocess the records in the stream before being processed by your application code. \
   Currently, the only input processor available is {{:https://docs.aws.amazon.com/lambda/}Amazon \
   Lambda}.\n"]

type nonrec kinesis_streams_input = {
  resource_ar_n : resource_ar_n; [@ocaml.doc "The ARN of the input Kinesis data stream to read.\n"]
}
[@@ocaml.doc
  " Identifies a Kinesis data stream as the streaming source. You provide the stream's Amazon \
   Resource Name (ARN).\n"]
...
type nonrec input = {
  input_schema : source_schema;
      [@ocaml.doc
        ...
        \ "]
  input_parallelism : input_parallelism option;
      [@ocaml.doc "Describes the number of in-application streams to create. \n"]
  ...
  input_processing_configuration : input_processing_configuration option;
      [@ocaml.doc
        "The [InputProcessingConfiguration] for the input. An input processor transforms records \
...
type nonrec kinesis_streams_output = {
  resource_ar_n : resource_ar_n;
      [@ocaml.doc "The ARN of the destination Kinesis data stream to write to.\n"]
}
[@@ocaml.doc
...
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, when configuring application output, \
   identifies a Kinesis Data Firehose delivery stream as the destination. You provide the stream \
...
[@@ocaml.doc
  "When you configure a SQL-based Kinesis Data Analytics application's output, identifies an \
   Amazon Lambda function as the destination. You provide the function Amazon Resource Name (ARN) \
...
type nonrec output = {
  ...
  kinesis_firehose_output : kinesis_firehose_output option;
      [@ocaml.doc "Identifies a Kinesis Data Firehose delivery stream as the destination.\n"]
  kinesis_streams_output : kinesis_streams_output option;
      [@ocaml.doc "Identifies a Kinesis data stream as the destination.\n"]
  name : in_app_stream_name; [@ocaml.doc "The name of the in-application stream.\n"]
}
[@@ocaml.doc
  " Describes a SQL-based Kinesis Data Analytics application's output configuration, in which you \
   ...
   data to be written. The destination can be a Kinesis data stream or a Kinesis Data Firehose \
   delivery stream. \n\n\
  \ \n\
  \ "]
...
type nonrec s3_reference_data_source = {
  file_key : file_key option; [@ocaml.doc "The object key name containing the reference data.\n"]
  bucket_ar_n : bucket_ar_n option; [@ocaml.doc "The Amazon Resource Name (ARN) of the S3 bucket.\n"]
}
[@@ocaml.doc
  "For a SQL-based Kinesis Data Analytics application, identifies the Amazon S3 bucket and object \
   that contains the reference data.\n\n\
  \ A SQL-based Kinesis Data Analytics application loads reference data only once. If the data \
...
type nonrec reference_data_source = {
  ...
  s3_reference_data_source : s3_reference_data_source option;
      [@ocaml.doc
        "Identifies the S3 bucket and object that contains the reference data. A SQL-based Kinesis \
         Data Analytics application loads reference data only once. If the data changes, you call \
         the [UpdateApplication] operation to trigger reloading of data into your application. \n"]
  table_name : in_app_table_name; [@ocaml.doc "The name of the in-application table to create.\n"]
}
[@@ocaml.doc
...
type nonrec sql_application_configuration = {
  reference_data_sources : reference_data_sources option;
      [@ocaml.doc
        "The array of [ReferenceDataSource] objects describing the reference data sources used by \
         the application.\n"]
...
type nonrec snapshot_details = {
  ...
  application_version_id : application_version_id;
      [@ocaml.doc "The current application version ID when the snapshot was created.\n"]
  snapshot_status : snapshot_status; [@ocaml.doc "The status of the application snapshot.\n"]
  snapshot_name : snapshot_name; [@ocaml.doc "The identifier for the application snapshot.\n"]
}
[@@ocaml.doc "Provides details about a snapshot of application state.\n"]
...
type nonrec s3_configuration = {
  file_key : file_key; [@ocaml.doc "The name of the object that contains the data.\n"]
  bucket_ar_n : bucket_ar_n; [@ocaml.doc "The ARN of the S3 bucket that contains the data.\n"]
}
[@@ocaml.doc
...
[@@ocaml.doc
  "Discovery failed to get a record from the streaming source because of the Kinesis Streams \
   [ProvisionedThroughputExceededException]. For more information, see \
   {{:http://docs.aws.amazon.com/kinesis/latest/APIReference/API_GetRecords.html}GetRecords} in \
...
type nonrec parallelism_configuration = {
  ...
  parallelism_per_kp_u : parallelism_per_kp_u option;
      [@ocaml.doc
        "Describes the number of parallel tasks that a Managed Service for Apache Flink \
         ...
         more information about KPUs, see \
         {{:http://aws.amazon.com/kinesis/data-analytics/pricing/}Amazon Managed Service for \
  ...
  configuration_type : configuration_type;
      [@ocaml.doc
        "Describes whether the application uses the default parallelism for the Managed Service \
         for Apache Flink service. You must set this property to [CUSTOM] in order to change your \
...
[@@ocaml.doc
  "Describes configuration parameters for Amazon CloudWatch logging for an application. For more \
   information about CloudWatch logging, see \
   {{:https://docs.aws.amazon.com/kinesisanalytics/latest/java/monitoring-overview.html}Monitoring}.\n"]

type nonrec list_tags_for_resource_response = {
  tags : tags option; [@ocaml.doc "The key-value tags assigned to the application.\n"]
}
[@@ocaml.doc ""]
...
type nonrec application_summary = {
  application_mode : application_mode option;
      [@ocaml.doc
        "For a Managed Service for Apache Flink application, the mode is [STREAMING]. For a \
         Managed Service for Apache Flink Studio notebook, it is [INTERACTIVE].\n"]
  runtime_environment : runtime_environment;
      [@ocaml.doc "The runtime environment for the application.\n"]
  application_version_id : application_version_id;
  ...
  next_token : application_name option;
      [@ocaml.doc
        "The pagination token for the next set of results, or [null] if there are no additional \
         results. Pass this token into a subsequent command to retrieve the next set of items For \
         more information about pagination, see \
         {{:https://docs.aws.amazon.com/cli/latest/userguide/pagination.html}Using the Amazon \
  ...
  next_token : application_name option;
      [@ocaml.doc
        "If a previous command returned a pagination token, pass it into this value to retrieve \
         the next set of results. For more information about pagination, see \
         {{:https://docs.aws.amazon.com/cli/latest/userguide/pagination.html}Using the Amazon \
         Command Line Interface's Pagination Options}.\n"]
...
type nonrec application_version_summaries = application_version_summary list [@@ocaml.doc ""]
  ...
  next_token : next_token option;
      [@ocaml.doc
        "The pagination token for the next set of results, or [null] if there are no additional \
         ...
         of this operation. For more information about pagination, see \
         {{:https://docs.aws.amazon.com/cli/latest/userguide/pagination.html}Using the Amazon \
         Command Line Interface's Pagination Options}.\n"]
  application_version_summaries : application_version_summaries option;
      [@ocaml.doc
        "A list of the application versions and the associated configuration summaries. The list \
         includes application versions that were rolled back.\n\n\
...
type nonrec list_application_versions_request = {
  next_token : next_token option;
      [@ocaml.doc
        "If a previous invocation of this operation returned a pagination token, pass it into this \
         value to retrieve the next set of results. For more information about pagination, see \
         {{:https://docs.aws.amazon.com/cli/latest/userguide/pagination.html}Using the Amazon \
         Command Line Interface's Pagination Options}.\n"]
  limit : list_application_versions_input_limit option;
      [@ocaml.doc "The maximum number of versions to list in this invocation of the operation.\n"]
  application_name : application_name;
      [@ocaml.doc "The name of the application for which you want to list all versions.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_application_snapshots_request = {
  next_token : next_token option;
      [@ocaml.doc
        "Use this parameter if you receive a [NextToken] response in a previous request that \
  ...
  application_name : application_name; [@ocaml.doc "The name of an existing application.\n"]
}
[@@ocaml.doc ""]
...
type nonrec discover_input_schema_response = {
  raw_input_records : raw_input_records option;
      [@ocaml.doc "The raw stream data that was sampled to infer the schema.\n"]
  processed_input_records : processed_input_records option;
      [@ocaml.doc
  ...
  input_schema : source_schema option;
      [@ocaml.doc
        "The schema inferred from the streaming source. It identifies the format of the data in \
...
type nonrec discover_input_schema_request = {
  input_processing_configuration : input_processing_configuration option;
      [@ocaml.doc
        "The [InputProcessingConfiguration] to use to preprocess the records before discovering \
         the schema of the records.\n"]
  s3_configuration : s3_configuration option;
      [@ocaml.doc "Specify this parameter to discover a schema from data in an Amazon S3 object.\n"]
  input_starting_position_configuration : input_starting_position_configuration option;
      [@ocaml.doc
  ...
  service_execution_role : role_ar_n;
      [@ocaml.doc "The ARN of the role that is used to access the streaming source.\n"]
...
type nonrec describe_application_version_request = {
  application_version_id : application_version_id;
      [@ocaml.doc "The ID of the application version for which you want to get the description.\n"]
  application_name : application_name;
      [@ocaml.doc
...
type nonrec describe_application_snapshot_response = {
  snapshot_details : snapshot_details;
      [@ocaml.doc "An object containing information about the application snapshot.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_application_vpc_configuration_response = {
  ...
  application_ar_n : resource_ar_n option;
      [@ocaml.doc "The ARN of the Managed Service for Apache Flink application.\n"]
}
[@@ocaml.doc ""]
  ...
  conditional_token : conditional_token option;
      [@ocaml.doc
        "A value you use to implement strong concurrency for application updates. You must provide \
         ...
         current [ConditionalToken] using [DescribeApplication]. For better concurrency support, \
         use the [ConditionalToken] parameter instead of [CurrentApplicationVersionId].\n"]
  vpc_configuration_id : id; [@ocaml.doc "The ID of the VPC configuration to delete.\n"]
  current_application_version_id : application_version_id option;
      [@ocaml.doc
        "The current application version ID. You must provide the [CurrentApplicationVersionId] or \
         the [ConditionalToken]. You can retrieve the application version ID using \
  ...
  snapshot_creation_timestamp : timestamp;
      [@ocaml.doc
        "The creation timestamp of the application snapshot to delete. You can retrieve this value \
         using or .\n"]
  snapshot_name : snapshot_name; [@ocaml.doc "The identifier for the snapshot delete.\n"]
  application_name : application_name; [@ocaml.doc "The name of an existing application.\n"]
}
[@@ocaml.doc ""]
  ...
  reference_id : id;
      [@ocaml.doc
        "The ID of the reference data source. When you add a reference data source to your \
         application using the [AddApplicationReferenceDataSource], Kinesis Data Analytics assigns \
         an ID. You can use the [DescribeApplication] operation to get the reference ID. \n"]
  current_application_version_id : application_version_id;
      [@ocaml.doc
        "The current application version. You can use the [DescribeApplication] operation to get \
...
type nonrec delete_application_output_request = {
  output_id : id;
      [@ocaml.doc
        "The ID of the configuration to delete. Each output configuration that is added to the \
         application (either when the application is created or later) using the \
  ...
  current_application_version_id : application_version_id;
      [@ocaml.doc
        "The application version. You can use the [DescribeApplication] operation to get the \
...
type nonrec delete_application_cloud_watch_logging_option_request = {
  ...
  cloud_watch_logging_option_id : id;
      [@ocaml.doc
        "The [CloudWatchLoggingOptionId] of the Amazon CloudWatch logging option to delete. You \
         can get the [CloudWatchLoggingOptionId] by using the [DescribeApplication] operation. \n"]
  current_application_version_id : application_version_id option;
      [@ocaml.doc
        "The version ID of the application. You must provide the [CurrentApplicationVersionId] or \
         the [ConditionalToken]. You can retrieve the application version ID using \
         [DescribeApplication]. For better concurrency support, use the [ConditionalToken] \
         parameter instead of [CurrentApplicationVersionId].\n"]
  application_name : application_name; [@ocaml.doc "The application name.\n"]
...
type nonrec delete_application_request = {
  create_timestamp : timestamp;
      [@ocaml.doc "Use the [DescribeApplication] operation to get this value.\n"]
...
type nonrec create_application_snapshot_request = {
  snapshot_name : snapshot_name; [@ocaml.doc "An identifier for the application snapshot.\n"]
  application_name : application_name; [@ocaml.doc "The name of an existing application\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_application_presigned_url_response = {
  authorized_url : authorized_url option; [@ocaml.doc "The URL of the extension.\n"]
}
[@@ocaml.doc ""]

type nonrec create_application_presigned_url_request = {
  session_expiration_duration_in_seconds : session_expiration_duration_in_seconds option;
      [@ocaml.doc "The duration in seconds for which the returned URL will be valid.\n"]
  url_type : url_type;
      [@ocaml.doc
...
type nonrec create_application_response = {
  application_detail : application_detail;
      [@ocaml.doc
        "In response to your [CreateApplication] request, Managed Service for Apache Flink returns \
...
type nonrec environment_properties = {
  property_groups : property_groups; [@ocaml.doc "Describes the execution property groups.\n"]
}
[@@ocaml.doc "Describes execution properties for a Managed Service for Apache Flink application.\n"]

type nonrec code_content = {
  s3_content_location : s3_content_location option;
      [@ocaml.doc "Information about the Amazon S3 bucket that contains the application code.\n"]
  zip_file_content : zip_file_content option;
      [@ocaml.doc "The zip-format code for a Managed Service for Apache Flink application.\n"]
  text_content : text_content option;
      [@ocaml.doc "The text-format code for a Managed Service for Apache Flink application.\n"]
}
[@@ocaml.doc
...
type nonrec application_code_configuration = {
  code_content_type : code_content_type;
      [@ocaml.doc "Specifies whether the code content is in text or zip format.\n"]
  code_content : code_content option; [@ocaml.doc "The location and type of the application code.\n"]
}
[@@ocaml.doc "Describes code configuration for an application.\n"]
...
type nonrec cloud_watch_logging_option = {
  log_stream_ar_n : log_stream_ar_n;
      [@ocaml.doc "The ARN of the CloudWatch log to receive application messages.\n"]
}
[@@ocaml.doc
  "Provides a description of Amazon CloudWatch logging options, including the log stream Amazon \
   Resource Name (ARN). \n"]

type nonrec cloud_watch_logging_options = cloud_watch_logging_option list [@@ocaml.doc ""]

type nonrec create_application_request = {
  application_mode : application_mode option;
      [@ocaml.doc
        "Use the [STREAMING] mode to create a Managed Service for Apache Flink application. To \
         create a Managed Service for Apache Flink Studio notebook, use the [INTERACTIVE] mode.\n"]
  tags : tags option;
      [@ocaml.doc
        "A list of one or more tags to assign to the application. A tag is a key-value pair that \
         identifies an application. Note that the maximum number of application tags includes \
  ...
  application_name : application_name;
      [@ocaml.doc "The name of your application (for example, [sample-app]).\n"]
}
[@@ocaml.doc ""]
...
type nonrec add_application_vpc_configuration_response = {
  ...
  application_version_id : application_version_id option;
      [@ocaml.doc
        "Provides the current application version. Managed Service for Apache Flink updates the \
         ApplicationVersionId each time you update the application.\n"]
  application_ar_n : resource_ar_n option; [@ocaml.doc "The ARN of the application.\n"]
}
[@@ocaml.doc ""]
...
type nonrec add_application_vpc_configuration_request = {
  conditional_token : conditional_token option;
      [@ocaml.doc
        "A value you use to implement strong concurrency for application updates. You must provide \
         the [ApplicationVersionID] or the [ConditionalToken]. You get the application's current \
  ...
  current_application_version_id : application_version_id option;
      [@ocaml.doc
        "The version of the application to which you want to add the VPC configuration. You must \
         provide the [CurrentApplicationVersionId] or the [ConditionalToken]. You can use the \
...
type nonrec add_application_reference_data_source_response = {
  reference_data_source_descriptions : reference_data_source_descriptions option;
      [@ocaml.doc "Describes reference data sources configured for the application. \n"]
  application_version_id : application_version_id option;
      [@ocaml.doc
...
type nonrec add_application_reference_data_source_request = {
  ...
  current_application_version_id : application_version_id;
      [@ocaml.doc
        "The version of the application for which you are adding the reference data source. You \
         can use the [DescribeApplication] operation to get the current application version. If \
         the version specified is not the current version, the [ConcurrentModificationException] \
         is returned.\n"]
  application_name : application_name; [@ocaml.doc "The name of an existing application.\n"]
}
[@@ocaml.doc ""]
  ...
  output : output;
      [@ocaml.doc
        "An array of objects, each describing one output configuration. In the output \
         ...
         a Kinesis data stream, a Kinesis Data Firehose delivery stream, or an Amazon Lambda \
...
type nonrec add_application_input_processing_configuration_request = {
  input_processing_configuration : input_processing_configuration;
      [@ocaml.doc "The [InputProcessingConfiguration] to add to the application.\n"]
  input_id : id;
      [@ocaml.doc
        "The ID of the input configuration to add the input processing configuration to. You can \
         get a list of the input IDs for an application using the [DescribeApplication] operation.\n"]
  current_application_version_id : application_version_id;
      [@ocaml.doc
...
type nonrec add_application_input_request = {
  ...
  current_application_version_id : application_version_id;
      [@ocaml.doc
        "The current version of your application. You must provide the [ApplicationVersionID] or \
         the [ConditionalToken].You can use the [DescribeApplication] operation to find the \
  ...
  application_version_id : application_version_id option;
      [@ocaml.doc
        "The new version ID of the SQL-based Kinesis Data Analytics application. Kinesis Data \
         Analytics updates the [ApplicationVersionId] each time you change the CloudWatch logging \
         options. \n"]
  application_ar_n : resource_ar_n option; [@ocaml.doc "The application's ARN.\n"]
}
[@@ocaml.doc ""]
...
type nonrec add_application_cloud_watch_logging_option_request = {
  ...
  cloud_watch_logging_option : cloud_watch_logging_option;
      [@ocaml.doc "Provides the Amazon CloudWatch log stream Amazon Resource Name (ARN). \n"]
  current_application_version_id : application_version_id option;
      [@ocaml.doc
        "The version ID of the SQL-based Kinesis Data Analytics application. You must provide the \
         ...
         [ConditionalToken] parameter instead of [CurrentApplicationVersionId].\n"]
  application_name : application_name; [@ocaml.doc "The Kinesis Data Analytics application name.\n"]
}
[@@ocaml.doc ""]
