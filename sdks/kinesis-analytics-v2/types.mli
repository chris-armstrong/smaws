...
type nonrec record_format_type = JSON [@ocaml.doc ""] | CSV [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec code_content_type = PLAINTEXT [@ocaml.doc ""] | ZIPFILE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec key_type = AWS_OWNED_KEY [@ocaml.doc ""] | CUSTOMER_MANAGED_KEY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec artifact_type = UDF [@ocaml.doc ""] | DEPENDENCY_JAR [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec configuration_type = DEFAULT [@ocaml.doc ""] | CUSTOM [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec application_mode = STREAMING [@ocaml.doc ""] | INTERACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec url_type = FLINK_DASHBOARD_URL [@ocaml.doc ""] | ZEPPELIN_UI_URL [@ocaml.doc ""]
[@@ocaml.doc ""]
