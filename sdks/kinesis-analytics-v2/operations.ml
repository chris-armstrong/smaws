...
module AddApplicationCloudWatchLoggingOption =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidApplicationConfigurationException") ->
            `InvalidApplicationConfigurationException
              (Json_deserializers.invalid_application_configuration_exception_of_yojson
                 tree path)
        | (_, "InvalidArgumentException") ->
            `InvalidArgumentException
              (Json_deserializers.invalid_argument_exception_of_yojson tree
                 path)
    ...
    let request context
      ...
      let input =
        Json_serializers.add_application_cloud_watch_logging_option_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.AddApplicationCloudWatchLoggingOption"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.add_application_cloud_watch_logging_option_response_of_yojson
        ~error_deserializer
  end
module AddApplicationInput =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "CodeValidationException") ->
            `CodeValidationException
              (Json_deserializers.code_validation_exception_of_yojson tree
                 path)
        | (_, "ConcurrentModificationException") ->
            `ConcurrentModificationException
              (Json_deserializers.concurrent_modification_exception_of_yojson
    ...
    let request context (request : add_application_input_request) =
      let input =
        Json_serializers.add_application_input_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.AddApplicationInput" ~service
        ~context ~input
...
module AddApplicationInputProcessingConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.add_application_input_processing_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.AddApplicationInputProcessingConfiguration"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.add_application_input_processing_configuration_response_of_yojson
        ~error_deserializer
  end
module AddApplicationOutput =
  struct
    ...
    let request context (request : add_application_output_request) =
      let input =
        Json_serializers.add_application_output_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.AddApplicationOutput" ~service
        ~context ~input
...
module AddApplicationReferenceDataSource =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.add_application_reference_data_source_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.AddApplicationReferenceDataSource"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.add_application_reference_data_source_response_of_yojson
        ~error_deserializer
  end
module AddApplicationVpcConfiguration =
  struct
    ...
    let request context (request : add_application_vpc_configuration_request)
      =
      let input =
        Json_serializers.add_application_vpc_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateApplication =
  struct
    ...
    let request context (request : create_application_request) =
      let input =
        Json_serializers.create_application_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.CreateApplication" ~service
        ~context ~input
...
module CreateApplicationPresignedUrl =
  struct
    ...
    let request context (request : create_application_presigned_url_request)
      =
      let input =
        Json_serializers.create_application_presigned_url_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateApplicationSnapshot =
  struct
    ...
    let request context (request : create_application_snapshot_request) =
      let input =
        Json_serializers.create_application_snapshot_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteApplication =
  struct
    ...
    let request context (request : delete_application_request) =
      let input =
        Json_serializers.delete_application_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.DeleteApplication" ~service
        ~context ~input
...
module DeleteApplicationCloudWatchLoggingOption =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.delete_application_cloud_watch_logging_option_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.DeleteApplicationCloudWatchLoggingOption"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_application_cloud_watch_logging_option_response_of_yojson
        ~error_deserializer
  end
module DeleteApplicationInputProcessingConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.delete_application_input_processing_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.DeleteApplicationInputProcessingConfiguration"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_application_input_processing_configuration_response_of_yojson
        ~error_deserializer
  end
module DeleteApplicationOutput =
  struct
    ...
    let request context (request : delete_application_output_request) =
      let input =
        Json_serializers.delete_application_output_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteApplicationReferenceDataSource =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.delete_application_reference_data_source_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.DeleteApplicationReferenceDataSource"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_application_reference_data_source_response_of_yojson
        ~error_deserializer
  end
module DeleteApplicationSnapshot =
  struct
    ...
    let request context (request : delete_application_snapshot_request) =
      let input =
        Json_serializers.delete_application_snapshot_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteApplicationVpcConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.delete_application_vpc_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.DeleteApplicationVpcConfiguration"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_application_vpc_configuration_response_of_yojson
        ~error_deserializer
  end
module DescribeApplication =
  struct
    ...
    let request context (request : describe_application_request) =
      let input =
        Json_serializers.describe_application_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.DescribeApplication" ~service
        ~context ~input
...
module DescribeApplicationOperation =
  struct
    ...
    let request context (request : describe_application_operation_request) =
      let input =
        Json_serializers.describe_application_operation_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.DescribeApplicationOperation"
        ~service ~context ~input
...
module DescribeApplicationSnapshot =
  struct
    ...
    let request context (request : describe_application_snapshot_request) =
      let input =
        Json_serializers.describe_application_snapshot_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeApplicationVersion =
  struct
    ...
    let request context (request : describe_application_version_request) =
      let input =
        Json_serializers.describe_application_version_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DiscoverInputSchema =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ResourceProvisionedThroughputExceededException") ->
            `ResourceProvisionedThroughputExceededException
              (Json_deserializers.resource_provisioned_throughput_exceeded_exception_of_yojson
                 tree path)
        | (_, "ServiceUnavailableException") ->
            `ServiceUnavailableException
              (Json_deserializers.service_unavailable_exception_of_yojson
                 tree path)
        | (_, "UnableToDetectSchemaException") ->
            `UnableToDetectSchemaException
              (Json_deserializers.unable_to_detect_schema_exception_of_yojson
                 tree path)
        | (_, "UnsupportedOperationException") ->
            `UnsupportedOperationException
              (Json_deserializers.unsupported_operation_exception_of_yojson
    ...
    let request context (request : discover_input_schema_request) =
      let input =
        Json_serializers.discover_input_schema_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.DiscoverInputSchema" ~service
        ~context ~input
...
module ListApplicationOperations =
  struct
    ...
    let request context (request : list_application_operations_request) =
      let input =
        Json_serializers.list_application_operations_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.ListApplicationOperations"
        ~service ~context ~input
...
module ListApplicationSnapshots =
  struct
    ...
    let request context (request : list_application_snapshots_request) =
      let input =
        Json_serializers.list_application_snapshots_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListApplicationVersions =
  struct
    ...
    let request context (request : list_application_versions_request) =
      let input =
        Json_serializers.list_application_versions_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListApplications =
  struct
    ...
    let request context (request : list_applications_request) =
      let input =
        Json_serializers.list_applications_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.ListApplications" ~service
        ~context ~input
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.ListTagsForResource" ~service
        ~context ~input
...
module RollbackApplication =
  struct
    ...
    let request context (request : rollback_application_request) =
      let input =
        Json_serializers.rollback_application_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.RollbackApplication" ~service
        ~context ~input
...
module StartApplication =
  struct
    ...
    let request context (request : start_application_request) =
      let input =
        Json_serializers.start_application_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.StartApplication" ~service
        ~context ~input
...
module StopApplication =
  struct
    ...
    let request context (request : stop_application_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.StopApplication" ~service
        ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.TagResource" ~service ~context
        ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.UntagResource" ~service
        ~context ~input
...
module UpdateApplication =
  struct
    ...
    let request context (request : update_application_request) =
      let input =
        Json_serializers.update_application_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.UpdateApplication" ~service
        ~context ~input
...
module UpdateApplicationMaintenanceConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.update_application_maintenance_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"KinesisAnalytics_20180523.UpdateApplicationMaintenanceConfiguration"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.update_application_maintenance_configuration_response_of_yojson
        ~error_deserializer
  end