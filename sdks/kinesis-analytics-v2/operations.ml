  ...
  struct
    ...
    let request context (request : add_application_input_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"KinesisAnalytics_20180523AddApplicationInput" ~service
...
module DeleteApplicationOutput =
  struct
    ...
    let request context (request : delete_application_output_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_application_output_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : describe_application_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"KinesisAnalytics_20180523DescribeApplication" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : discover_input_schema_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"KinesisAnalytics_20180523DiscoverInputSchema" ~service
          ~config:context.config ~http:context.http ~input
...
module ListApplicationSnapshots =
  struct
    ...
    let request context (request : list_application_snapshots_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_application_snapshots_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module ListApplicationVersions =
  struct
    ...
    let request context (request : list_application_versions_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_application_versions_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"KinesisAnalytics_20180523ListTagsForResource" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : rollback_application_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"KinesisAnalytics_20180523RollbackApplication" ~service
          ~config:context.config ~http:context.http ~input
...
module StopApplication =
  struct
    ...
    let request context (request : stop_application_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.stop_application_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
