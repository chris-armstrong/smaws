...
let s3_content_base_location_update_of_yojson tree path =
  ...
  ({
     base_path_update =
       option_of_yojson (value_for_key base_path_of_yojson "BasePathUpdate") _list path;
     bucket_arn_update =
       option_of_yojson (value_for_key bucket_ar_n_of_yojson "BucketARNUpdate") _list path;
   }
...
let deploy_as_application_configuration_update_of_yojson tree path =
  ...
  ({
     s3_content_location_update =
       option_of_yojson
         (value_for_key s3_content_base_location_update_of_yojson "S3ContentLocationUpdate")
         _list path;
   }
...
let s3_content_location_of_yojson tree path =
  ...
  ({
     object_version =
       option_of_yojson (value_for_key object_version_of_yojson "ObjectVersion") _list path;
...
let custom_artifact_configuration_of_yojson tree path =
  ...
  ({
     maven_reference =
       option_of_yojson (value_for_key maven_reference_of_yojson "MavenReference") _list path;
     s3_content_location =
       option_of_yojson (value_for_key s3_content_location_of_yojson "S3ContentLocation") _list path;
...
let zeppelin_application_configuration_update_of_yojson tree path =
  ...
  ({
     ...
     catalog_configuration_update =
       option_of_yojson
         (value_for_key catalog_configuration_update_of_yojson "CatalogConfigurationUpdate")
         _list path;
...
let deploy_as_application_configuration_description_of_yojson tree path =
  ...
  ({
     s3_content_location_description =
       value_for_key s3_content_base_location_description_of_yojson "S3ContentLocationDescription"
         _list path;
   }
...
let custom_artifact_configuration_description_of_yojson tree path =
  ...
  ({
     maven_reference_description =
       option_of_yojson
         (value_for_key maven_reference_of_yojson "MavenReferenceDescription")
         _list path;
     s3_content_location_description =
       option_of_yojson
         (value_for_key s3_content_location_of_yojson "S3ContentLocationDescription")
         _list path;
     artifact_type =
...
let custom_artifacts_configuration_description_list_of_yojson tree path =
  list_of_yojson custom_artifact_configuration_description_of_yojson tree path
...
let zeppelin_application_configuration_description_of_yojson tree path =
  ...
  ({
     custom_artifacts_configuration_description =
       option_of_yojson
         (value_for_key custom_artifacts_configuration_description_list_of_yojson
            "CustomArtifactsConfigurationDescription")
         _list path;
     deploy_as_application_configuration_description =
       option_of_yojson
         (value_for_key deploy_as_application_configuration_description_of_yojson
...
let catalog_configuration_of_yojson tree path =
  ...
  ({
     glue_data_catalog_configuration =
       value_for_key glue_data_catalog_configuration_of_yojson "GlueDataCatalogConfiguration" _list
         path;
   }
...
let deploy_as_application_configuration_of_yojson tree path =
  ...
  ({
     s3_content_location =
       value_for_key s3_content_base_location_of_yojson "S3ContentLocation" _list path;
   }
...
let zeppelin_application_configuration_of_yojson tree path =
  ...
  ({
     custom_artifacts_configuration =
       option_of_yojson
         (value_for_key custom_artifacts_configuration_list_of_yojson "CustomArtifactsConfiguration")
         _list path;
     deploy_as_application_configuration =
       option_of_yojson
     ...
     monitoring_configuration =
       option_of_yojson
         (value_for_key zeppelin_monitoring_configuration_of_yojson "MonitoringConfiguration")
         _list path;
   }
...
let vpc_configurations_of_yojson tree path = list_of_yojson vpc_configuration_of_yojson tree path
...
let vpc_configuration_update_of_yojson tree path =
  ...
  ({
     security_group_id_updates =
       option_of_yojson
         (value_for_key security_group_ids_of_yojson "SecurityGroupIdUpdates")
         _list path;
     subnet_id_updates =
       option_of_yojson (value_for_key subnet_ids_of_yojson "SubnetIdUpdates") _list path;
...
let in_app_stream_names_of_yojson tree path = list_of_yojson in_app_stream_name_of_yojson tree path
...
let csv_mapping_parameters_of_yojson tree path =
  ...
  ({
     record_column_delimiter =
       value_for_key record_column_delimiter_of_yojson "RecordColumnDelimiter" _list path;
     record_row_delimiter =
       value_for_key record_row_delimiter_of_yojson "RecordRowDelimiter" _list path;
   }
...
let mapping_parameters_of_yojson tree path =
  ...
  ({
     csv_mapping_parameters =
       option_of_yojson
         (value_for_key csv_mapping_parameters_of_yojson "CSVMappingParameters")
         _list path;
     json_mapping_parameters =
       option_of_yojson
         (value_for_key json_mapping_parameters_of_yojson "JSONMappingParameters")
         _list path;
   }
    : mapping_parameters)
...
let record_format_of_yojson tree path =
  ...
  ({
     mapping_parameters =
       option_of_yojson (value_for_key mapping_parameters_of_yojson "MappingParameters") _list path;
...
let record_columns_of_yojson tree path = list_of_yojson record_column_of_yojson tree path
...
let source_schema_of_yojson tree path =
  ...
  ({
     ...
     record_encoding =
       option_of_yojson (value_for_key record_encoding_of_yojson "RecordEncoding") _list path;
...
let input_starting_position_of_yojson (tree : t) path =
  (let _list = assoc_of_yojson tree path in
   (match tree with
    ...
    | `String "NOW" -> NOW
    | `String value ->
        raise (deserialize_unknown_enum_value_error path "InputStartingPosition" value)
...
let input_starting_position_configuration_of_yojson tree path =
  ...
  ({
     input_starting_position =
       option_of_yojson
         (value_for_key input_starting_position_of_yojson "InputStartingPosition")
         _list path;
   }
  ...
  ({
     input_starting_position_configuration =
       option_of_yojson
         ...
         _list path;
     input_parallelism =
       option_of_yojson (value_for_key input_parallelism_of_yojson "InputParallelism") _list path;
     input_schema =
       option_of_yojson (value_for_key source_schema_of_yojson "InputSchema") _list path;
     kinesis_firehose_input_description =
       option_of_yojson
     ...
     kinesis_streams_input_description =
       option_of_yojson
         (value_for_key kinesis_streams_input_description_of_yojson "KinesisStreamsInputDescription")
         _list path;
     input_processing_configuration_description =
       option_of_yojson
         ...
         _list path;
     in_app_stream_names =
       option_of_yojson (value_for_key in_app_stream_names_of_yojson "InAppStreamNames") _list path;
     name_prefix =
       option_of_yojson (value_for_key in_app_stream_name_of_yojson "NamePrefix") _list path;
     input_id = option_of_yojson (value_for_key id_of_yojson "InputId") _list path;
   }
    : input_description)

let input_descriptions_of_yojson tree path = list_of_yojson input_description_of_yojson tree path
...
let output_description_of_yojson tree path =
  ...
  ({
     destination_schema =
       option_of_yojson (value_for_key destination_schema_of_yojson "DestinationSchema") _list path;
     lambda_output_description =
       option_of_yojson
         (value_for_key lambda_output_description_of_yojson "LambdaOutputDescription")
         _list path;
     kinesis_firehose_output_description =
       option_of_yojson
...
let output_descriptions_of_yojson tree path = list_of_yojson output_description_of_yojson tree path
...
let s3_reference_data_source_description_of_yojson tree path =
  ...
  ({
     reference_role_ar_n =
       option_of_yojson (value_for_key role_ar_n_of_yojson "ReferenceRoleARN") _list path;
     file_key = value_for_key file_key_of_yojson "FileKey" _list path;
     bucket_ar_n = value_for_key bucket_ar_n_of_yojson "BucketARN" _list path;
   }
...
let reference_data_source_description_of_yojson tree path =
  ...
  ({
     reference_schema =
       option_of_yojson (value_for_key source_schema_of_yojson "ReferenceSchema") _list path;
     s3_reference_data_source_description =
  ...
  ({
     ...
     output_descriptions =
       option_of_yojson
         ...
         _list path;
     input_descriptions =
       option_of_yojson (value_for_key input_descriptions_of_yojson "InputDescriptions") _list path;
   }
...
let application_code_configuration_description_of_yojson tree path =
  ...
  ({
     code_content_description =
       option_of_yojson
         (value_for_key code_content_description_of_yojson "CodeContentDescription")
         _list path;
...
let application_restore_type_of_yojson (tree : t) path =
  (let _list = assoc_of_yojson tree path in
   (match tree with
    ...
    | `String value ->
        raise (deserialize_unknown_enum_value_error path "ApplicationRestoreType" value)
...
let application_restore_configuration_of_yojson tree path =
  ...
  ({
     snapshot_name =
       option_of_yojson (value_for_key snapshot_name_of_yojson "SnapshotName") _list path;
     application_restore_type =
       value_for_key application_restore_type_of_yojson "ApplicationRestoreType" _list path;
   }
...
let flink_run_configuration_of_yojson tree path =
  ...
  ({
     allow_non_restored_state =
       option_of_yojson (value_for_key boolean_object_of_yojson "AllowNonRestoredState") _list path;
   }
...
let run_configuration_description_of_yojson tree path =
  ...
  ({
     flink_run_configuration_description =
       option_of_yojson
         (value_for_key flink_run_configuration_of_yojson "FlinkRunConfigurationDescription")
         _list path;
...
let checkpoint_configuration_description_of_yojson tree path =
  ...
  ({
     min_pause_between_checkpoints =
       option_of_yojson
         (value_for_key min_pause_between_checkpoints_of_yojson "MinPauseBetweenCheckpoints")
         _list path;
     checkpoint_interval =
       option_of_yojson
     ...
     checkpointing_enabled =
       option_of_yojson (value_for_key boolean_object_of_yojson "CheckpointingEnabled") _list path;
     configuration_type =
       option_of_yojson (value_for_key configuration_type_of_yojson "ConfigurationType") _list path;
   }
...
let monitoring_configuration_description_of_yojson tree path =
  ...
  ({
     log_level = option_of_yojson (value_for_key log_level_of_yojson "LogLevel") _list path;
     metrics_level =
       option_of_yojson (value_for_key metrics_level_of_yojson "MetricsLevel") _list path;
     configuration_type =
       option_of_yojson (value_for_key configuration_type_of_yojson "ConfigurationType") _list path;
   }
    : monitoring_configuration_description)
...
let parallelism_configuration_description_of_yojson tree path =
  ...
  ({
     auto_scaling_enabled =
       option_of_yojson (value_for_key boolean_object_of_yojson "AutoScalingEnabled") _list path;
     current_parallelism =
       option_of_yojson (value_for_key parallelism_of_yojson "CurrentParallelism") _list path;
...
let property_groups_of_yojson tree path = list_of_yojson property_group_of_yojson tree path
...
let environment_property_descriptions_of_yojson tree path =
  ...
  ({
     property_group_descriptions =
       option_of_yojson
         (value_for_key property_groups_of_yojson "PropertyGroupDescriptions")
         _list path;
   }
...
let application_configuration_description_of_yojson tree path =
  ...
  ({
     ...
     vpc_configuration_descriptions =
       option_of_yojson
         (value_for_key vpc_configuration_descriptions_of_yojson "VpcConfigurationDescriptions")
         _list path;
     application_system_rollback_configuration_description =
       option_of_yojson
         (value_for_key application_system_rollback_configuration_description_of_yojson
            "ApplicationSystemRollbackConfigurationDescription")
         _list path;
     application_snapshot_configuration_description =
       option_of_yojson
         (value_for_key application_snapshot_configuration_description_of_yojson
     ...
     flink_application_configuration_description =
       option_of_yojson
         (value_for_key flink_application_configuration_description_of_yojson
            "FlinkApplicationConfigurationDescription")
         _list path;
     run_configuration_description =
       option_of_yojson
         (value_for_key run_configuration_description_of_yojson "RunConfigurationDescription")
         _list path;
     application_code_configuration_description =
       option_of_yojson
...
let cloud_watch_logging_option_description_of_yojson tree path =
  ...
  ({
     ...
     cloud_watch_logging_option_id =
       option_of_yojson (value_for_key id_of_yojson "CloudWatchLoggingOptionId") _list path;
   }
...
let application_detail_of_yojson tree path =
  ...
  ({
     application_mode =
       option_of_yojson (value_for_key application_mode_of_yojson "ApplicationMode") _list path;
     application_version_rolled_back_to =
       option_of_yojson
         (value_for_key application_version_id_of_yojson "ApplicationVersionRolledBackTo")
         _list path;
     conditional_token =
       option_of_yojson (value_for_key conditional_token_of_yojson "ConditionalToken") _list path;
     application_version_create_timestamp =
       option_of_yojson
         (value_for_key timestamp__of_yojson "ApplicationVersionCreateTimestamp")
         _list path;
     application_version_rolled_back_from =
       option_of_yojson
         (value_for_key application_version_id_of_yojson "ApplicationVersionRolledBackFrom")
         _list path;
     application_version_updated_from =
       option_of_yojson
         (value_for_key application_version_id_of_yojson "ApplicationVersionUpdatedFrom")
         _list path;
     application_maintenance_configuration_description =
       option_of_yojson
         (value_for_key application_maintenance_configuration_description_of_yojson
     ...
     last_update_timestamp =
       option_of_yojson (value_for_key timestamp__of_yojson "LastUpdateTimestamp") _list path;
     create_timestamp =
       option_of_yojson (value_for_key timestamp__of_yojson "CreateTimestamp") _list path;
     application_version_id =
       value_for_key application_version_id_of_yojson "ApplicationVersionId" _list path;
     application_status = value_for_key application_status_of_yojson "ApplicationStatus" _list path;
     service_execution_role =
       option_of_yojson (value_for_key role_ar_n_of_yojson "ServiceExecutionRole") _list path;
     runtime_environment =
       value_for_key runtime_environment_of_yojson "RuntimeEnvironment" _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
     application_description =
       option_of_yojson
         (value_for_key application_description_of_yojson "ApplicationDescription")
         _list path;
...
let input_processing_configuration_update_of_yojson tree path =
  ...
  ({
     input_lambda_processor_update =
       value_for_key input_lambda_processor_update_of_yojson "InputLambdaProcessorUpdate" _list path;
   }
...
let input_schema_update_of_yojson tree path =
  ...
  ({
     record_column_updates =
       option_of_yojson (value_for_key record_columns_of_yojson "RecordColumnUpdates") _list path;
     record_encoding_update =
       option_of_yojson (value_for_key record_encoding_of_yojson "RecordEncodingUpdate") _list path;
     record_format_update =
       option_of_yojson (value_for_key record_format_of_yojson "RecordFormatUpdate") _list path;
   }
    : input_schema_update)
...
let input_update_of_yojson tree path =
  ...
  ({
     input_parallelism_update =
       option_of_yojson
         (value_for_key input_parallelism_update_of_yojson "InputParallelismUpdate")
         _list path;
     input_schema_update =
       option_of_yojson (value_for_key input_schema_update_of_yojson "InputSchemaUpdate") _list path;
     kinesis_firehose_input_update =
       option_of_yojson
         (value_for_key kinesis_firehose_input_update_of_yojson "KinesisFirehoseInputUpdate")
         _list path;
     kinesis_streams_input_update =
       option_of_yojson
         (value_for_key kinesis_streams_input_update_of_yojson "KinesisStreamsInputUpdate")
         _list path;
     input_processing_configuration_update =
       option_of_yojson
         ...
         _list path;
     name_prefix_update =
       option_of_yojson (value_for_key in_app_stream_name_of_yojson "NamePrefixUpdate") _list path;
     input_id = value_for_key id_of_yojson "InputId" _list path;
   }
    : input_update)

let input_updates_of_yojson tree path = list_of_yojson input_update_of_yojson tree path
...
let output_update_of_yojson tree path =
  ...
  ({
     destination_schema_update =
       option_of_yojson
         (value_for_key destination_schema_of_yojson "DestinationSchemaUpdate")
         _list path;
     lambda_output_update =
       option_of_yojson
     ...
     kinesis_firehose_output_update =
       option_of_yojson
         (value_for_key kinesis_firehose_output_update_of_yojson "KinesisFirehoseOutputUpdate")
         _list path;
     kinesis_streams_output_update =
       option_of_yojson
         (value_for_key kinesis_streams_output_update_of_yojson "KinesisStreamsOutputUpdate")
         _list path;
     name_update =
       option_of_yojson (value_for_key in_app_stream_name_of_yojson "NameUpdate") _list path;
     output_id = value_for_key id_of_yojson "OutputId" _list path;
   }
    : output_update)

let output_updates_of_yojson tree path = list_of_yojson output_update_of_yojson tree path

let s3_reference_data_source_update_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     file_key_update =
       option_of_yojson (value_for_key file_key_of_yojson "FileKeyUpdate") _list path;
     bucket_arn_update =
       option_of_yojson (value_for_key bucket_ar_n_of_yojson "BucketARNUpdate") _list path;
   }
...
let reference_data_source_update_of_yojson tree path =
  ...
  ({
     reference_schema_update =
       option_of_yojson (value_for_key source_schema_of_yojson "ReferenceSchemaUpdate") _list path;
     s3_reference_data_source_update =
       option_of_yojson
         (value_for_key s3_reference_data_source_update_of_yojson "S3ReferenceDataSourceUpdate")
         _list path;
     table_name_update =
       option_of_yojson (value_for_key in_app_table_name_of_yojson "TableNameUpdate") _list path;
     reference_id = value_for_key id_of_yojson "ReferenceId" _list path;
   }
...
let sql_application_configuration_update_of_yojson tree path =
  ...
  ({
     reference_data_source_updates =
       option_of_yojson
         (value_for_key reference_data_source_updates_of_yojson "ReferenceDataSourceUpdates")
         _list path;
     output_updates =
       option_of_yojson (value_for_key output_updates_of_yojson "OutputUpdates") _list path;
     input_updates =
       option_of_yojson (value_for_key input_updates_of_yojson "InputUpdates") _list path;
   }
...
let s3_content_location_update_of_yojson tree path =
  ...
  ({
     object_version_update =
       option_of_yojson (value_for_key object_version_of_yojson "ObjectVersionUpdate") _list path;
     file_key_update =
       option_of_yojson (value_for_key file_key_of_yojson "FileKeyUpdate") _list path;
     bucket_arn_update =
       option_of_yojson (value_for_key bucket_ar_n_of_yojson "BucketARNUpdate") _list path;
...
let code_content_update_of_yojson tree path =
  ...
  ({
     s3_content_location_update =
       option_of_yojson
         (value_for_key s3_content_location_update_of_yojson "S3ContentLocationUpdate")
         _list path;
     zip_file_content_update =
       option_of_yojson (value_for_key zip_file_content_of_yojson "ZipFileContentUpdate") _list path;
     text_content_update =
       option_of_yojson (value_for_key text_content_of_yojson "TextContentUpdate") _list path;
   }
    : code_content_update)
...
let application_code_configuration_update_of_yojson tree path =
  ...
  ({
     code_content_update =
       option_of_yojson (value_for_key code_content_update_of_yojson "CodeContentUpdate") _list path;
...
let checkpoint_configuration_update_of_yojson tree path =
  ...
  ({
     min_pause_between_checkpoints_update =
       option_of_yojson
         (value_for_key min_pause_between_checkpoints_of_yojson "MinPauseBetweenCheckpointsUpdate")
         _list path;
     checkpoint_interval_update =
       option_of_yojson
         (value_for_key checkpoint_interval_of_yojson "CheckpointIntervalUpdate")
         _list path;
     checkpointing_enabled_update =
       option_of_yojson
         (value_for_key boolean_object_of_yojson "CheckpointingEnabledUpdate")
         _list path;
     configuration_type_update =
       option_of_yojson
         (value_for_key configuration_type_of_yojson "ConfigurationTypeUpdate")
         _list path;
   }
...
let monitoring_configuration_update_of_yojson tree path =
  ...
  ({
     log_level_update =
       option_of_yojson (value_for_key log_level_of_yojson "LogLevelUpdate") _list path;
     metrics_level_update =
       option_of_yojson (value_for_key metrics_level_of_yojson "MetricsLevelUpdate") _list path;
     configuration_type_update =
       option_of_yojson
         (value_for_key configuration_type_of_yojson "ConfigurationTypeUpdate")
         _list path;
...
let parallelism_configuration_update_of_yojson tree path =
  ...
  ({
     ...
     parallelism_per_kpu_update =
       option_of_yojson
         (value_for_key parallelism_per_kp_u_of_yojson "ParallelismPerKPUUpdate")
         _list path;
     parallelism_update =
       option_of_yojson (value_for_key parallelism_of_yojson "ParallelismUpdate") _list path;
     configuration_type_update =
       option_of_yojson
         (value_for_key configuration_type_of_yojson "ConfigurationTypeUpdate")
         _list path;
...
let flink_application_configuration_update_of_yojson tree path =
  ...
  ({
     parallelism_configuration_update =
       option_of_yojson
         (value_for_key parallelism_configuration_update_of_yojson "ParallelismConfigurationUpdate")
         _list path;
     monitoring_configuration_update =
       option_of_yojson
         (value_for_key monitoring_configuration_update_of_yojson "MonitoringConfigurationUpdate")
         _list path;
     checkpoint_configuration_update =
       option_of_yojson
         (value_for_key checkpoint_configuration_update_of_yojson "CheckpointConfigurationUpdate")
         _list path;
   }
...
let application_snapshot_configuration_update_of_yojson tree path =
  ...
  ({
     snapshots_enabled_update =
       value_for_key boolean_object_of_yojson "SnapshotsEnabledUpdate" _list path;
   }
...
let application_system_rollback_configuration_update_of_yojson tree path =
  ...
  ({
     rollback_enabled_update =
       value_for_key boolean_object_of_yojson "RollbackEnabledUpdate" _list path;
   }
...
let application_configuration_update_of_yojson tree path =
  ...
  ({
     ...
     vpc_configuration_updates =
       option_of_yojson
         (value_for_key vpc_configuration_updates_of_yojson "VpcConfigurationUpdates")
         _list path;
     application_system_rollback_configuration_update =
       option_of_yojson
         (value_for_key application_system_rollback_configuration_update_of_yojson
     ...
     environment_property_updates =
       option_of_yojson
         (value_for_key environment_property_updates_of_yojson "EnvironmentPropertyUpdates")
         _list path;
     flink_application_configuration_update =
       option_of_yojson
...
let run_configuration_update_of_yojson tree path =
  ...
  ({
     ...
     flink_run_configuration =
       option_of_yojson
         (value_for_key flink_run_configuration_of_yojson "FlinkRunConfiguration")
         _list path;
   }
...
let cloud_watch_logging_option_update_of_yojson tree path =
  ...
  ({
     log_stream_arn_update =
       option_of_yojson (value_for_key log_stream_ar_n_of_yojson "LogStreamARNUpdate") _list path;
     cloud_watch_logging_option_id =
...
let update_application_request_of_yojson tree path =
  ...
  ({
     runtime_environment_update =
       option_of_yojson
         (value_for_key runtime_environment_of_yojson "RuntimeEnvironmentUpdate")
         _list path;
     conditional_token =
       option_of_yojson (value_for_key conditional_token_of_yojson "ConditionalToken") _list path;
     ...
     run_configuration_update =
       option_of_yojson
         (value_for_key run_configuration_update_of_yojson "RunConfigurationUpdate")
         _list path;
     service_execution_role_update =
       option_of_yojson (value_for_key role_ar_n_of_yojson "ServiceExecutionRoleUpdate") _list path;
     application_configuration_update =
       option_of_yojson
         (value_for_key application_configuration_update_of_yojson "ApplicationConfigurationUpdate")
         _list path;
     current_application_version_id =
       option_of_yojson
         (value_for_key application_version_id_of_yojson "CurrentApplicationVersionId")
         _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
   }
  ...
  ({
     application_maintenance_configuration_description =
       option_of_yojson
         ...
         _list path;
     application_ar_n =
       option_of_yojson (value_for_key resource_ar_n_of_yojson "ApplicationARN") _list path;
   }
...
let raw_input_records_of_yojson tree path = list_of_yojson raw_input_record_of_yojson tree path
...
let unable_to_detect_schema_exception_of_yojson tree path =
  ...
  ({
     processed_input_records =
       option_of_yojson
         (value_for_key processed_input_records_of_yojson "ProcessedInputRecords")
         _list path;
     raw_input_records =
       option_of_yojson (value_for_key raw_input_records_of_yojson "RawInputRecords") _list path;
     message = option_of_yojson (value_for_key error_message_of_yojson "Message") _list path;
   }
...
let run_configuration_of_yojson tree path =
  ...
  ({
     ...
     sql_run_configurations =
       option_of_yojson
         (value_for_key sql_run_configurations_of_yojson "SqlRunConfigurations")
         _list path;
     flink_run_configuration =
       option_of_yojson
         (value_for_key flink_run_configuration_of_yojson "FlinkRunConfiguration")
...
let start_application_request_of_yojson tree path =
  ...
  ({
     run_configuration =
       option_of_yojson (value_for_key run_configuration_of_yojson "RunConfiguration") _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
   }
...
let input_processing_configuration_of_yojson tree path =
  ...
  ({
     input_lambda_processor =
       value_for_key input_lambda_processor_of_yojson "InputLambdaProcessor" _list path;
   }
...
let input_of_yojson tree path =
  ...
  ({
     ...
     kinesis_firehose_input =
       option_of_yojson
         (value_for_key kinesis_firehose_input_of_yojson "KinesisFirehoseInput")
         _list path;
     kinesis_streams_input =
       option_of_yojson
         (value_for_key kinesis_streams_input_of_yojson "KinesisStreamsInput")
         _list path;
     input_processing_configuration =
       option_of_yojson
         (value_for_key input_processing_configuration_of_yojson "InputProcessingConfiguration")
         _list path;
...
let output_of_yojson tree path =
  ...
  ({
     ...
     lambda_output =
       option_of_yojson (value_for_key lambda_output_of_yojson "LambdaOutput") _list path;
     kinesis_firehose_output =
       option_of_yojson
         (value_for_key kinesis_firehose_output_of_yojson "KinesisFirehoseOutput")
         _list path;
     kinesis_streams_output =
       option_of_yojson
         (value_for_key kinesis_streams_output_of_yojson "KinesisStreamsOutput")
         _list path;
...
let reference_data_source_of_yojson tree path =
  ...
  ({
     ...
     s3_reference_data_source =
       option_of_yojson
         (value_for_key s3_reference_data_source_of_yojson "S3ReferenceDataSource")
         _list path;
     table_name = value_for_key in_app_table_name_of_yojson "TableName" _list path;
   }
...
let sql_application_configuration_of_yojson tree path =
  ...
  ({
     reference_data_sources =
       option_of_yojson
         (value_for_key reference_data_sources_of_yojson "ReferenceDataSources")
         _list path;
...
let snapshot_details_of_yojson tree path =
  ...
  ({
     ...
     snapshot_creation_timestamp =
       option_of_yojson (value_for_key timestamp__of_yojson "SnapshotCreationTimestamp") _list path;
     application_version_id =
       value_for_key application_version_id_of_yojson "ApplicationVersionId" _list path;
...
let snapshot_summaries_of_yojson tree path = list_of_yojson snapshot_details_of_yojson tree path
...
let rollback_application_request_of_yojson tree path =
  ...
  ({
     current_application_version_id =
       value_for_key application_version_id_of_yojson "CurrentApplicationVersionId" _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
   }
...
let error_info_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     error_string = option_of_yojson (value_for_key error_string_of_yojson "ErrorString") _list path;
   }
    : error_info)
...
let operation_failure_details_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     error_info = option_of_yojson (value_for_key error_info_of_yojson "ErrorInfo") _list path;
     rollback_operation_id =
       option_of_yojson (value_for_key operation_id_of_yojson "RollbackOperationId") _list path;
   }
...
let list_applications_response_of_yojson tree path =
  ...
  ({
     ...
     application_summaries =
       value_for_key application_summaries_of_yojson "ApplicationSummaries" _list path;
   }
...
let list_applications_request_of_yojson tree path =
  ...
  ({
     next_token = option_of_yojson (value_for_key application_name_of_yojson "NextToken") _list path;
     limit =
       option_of_yojson (value_for_key list_applications_input_limit_of_yojson "Limit") _list path;
   }
...
let list_application_versions_response_of_yojson tree path =
  ...
  ({
     ...
     application_version_summaries =
       option_of_yojson
         (value_for_key application_version_summaries_of_yojson "ApplicationVersionSummaries")
         _list path;
   }
...
let list_application_versions_request_of_yojson tree path =
  ...
  ({
     ...
     limit =
       option_of_yojson
         (value_for_key list_application_versions_input_limit_of_yojson "Limit")
         _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
   }
...
let list_application_snapshots_response_of_yojson tree path =
  ...
  ({
     next_token = option_of_yojson (value_for_key next_token_of_yojson "NextToken") _list path;
     snapshot_summaries =
       option_of_yojson (value_for_key snapshot_summaries_of_yojson "SnapshotSummaries") _list path;
   }
...
let list_application_snapshots_request_of_yojson tree path =
  ...
  ({
     next_token = option_of_yojson (value_for_key next_token_of_yojson "NextToken") _list path;
     limit =
       option_of_yojson (value_for_key list_snapshots_input_limit_of_yojson "Limit") _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
   }
...
let list_application_operations_response_of_yojson tree path =
  ...
  ({
     ...
     application_operation_info_list =
       option_of_yojson
         (value_for_key application_operation_info_list_of_yojson "ApplicationOperationInfoList")
         _list path;
   }
...
let list_application_operations_request_of_yojson tree path =
  ...
  ({
     ...
     limit =
       option_of_yojson
         (value_for_key list_application_operations_input_limit_of_yojson "Limit")
         _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
   }
...
let describe_application_version_response_of_yojson tree path =
  ...
  ({
     application_version_detail =
       option_of_yojson
         (value_for_key application_detail_of_yojson "ApplicationVersionDetail")
         _list path;
   }
...
let application_version_change_details_of_yojson tree path =
  ...
  ({
     application_version_updated_to =
       value_for_key application_version_id_of_yojson "ApplicationVersionUpdatedTo" _list path;
     application_version_updated_from =
       value_for_key application_version_id_of_yojson "ApplicationVersionUpdatedFrom" _list path;
   }
...
let application_operation_info_details_of_yojson tree path =
  ...
  ({
     operation_failure_details =
       option_of_yojson
         (value_for_key operation_failure_details_of_yojson "OperationFailureDetails")
         _list path;
     application_version_change_details =
       option_of_yojson
         ...
         _list path;
     operation_status = value_for_key operation_status_of_yojson "OperationStatus" _list path;
...
let delete_application_snapshot_request_of_yojson tree path =
  ...
  ({
     snapshot_creation_timestamp =
       value_for_key timestamp__of_yojson "SnapshotCreationTimestamp" _list path;
     snapshot_name = value_for_key snapshot_name_of_yojson "SnapshotName" _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
   }
...
let delete_application_input_processing_configuration_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     application_version_id =
       option_of_yojson
...
let delete_application_input_processing_configuration_request_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     input_id = value_for_key id_of_yojson "InputId" _list path;
     current_application_version_id =
...
let delete_application_cloud_watch_logging_option_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     operation_id = option_of_yojson (value_for_key operation_id_of_yojson "OperationId") _list path;
     cloud_watch_logging_option_descriptions =
...
let create_application_presigned_url_response_of_yojson tree path =
  ...
  ({
     authorized_url =
       option_of_yojson (value_for_key authorized_url_of_yojson "AuthorizedUrl") _list path;
   }
...
let flink_application_configuration_of_yojson tree path =
  ...
  ({
     parallelism_configuration =
       option_of_yojson
         (value_for_key parallelism_configuration_of_yojson "ParallelismConfiguration")
         _list path;
     monitoring_configuration =
       option_of_yojson
     ...
     checkpoint_configuration =
       option_of_yojson
         (value_for_key checkpoint_configuration_of_yojson "CheckpointConfiguration")
         _list path;
   }
...
let code_content_of_yojson tree path =
  ...
  ({
     s3_content_location =
       option_of_yojson (value_for_key s3_content_location_of_yojson "S3ContentLocation") _list path;
     zip_file_content =
       option_of_yojson (value_for_key zip_file_content_of_yojson "ZipFileContent") _list path;
     text_content = option_of_yojson (value_for_key text_content_of_yojson "TextContent") _list path;
   }
    : code_content)
  ...
  ({
     zeppelin_application_configuration =
       option_of_yojson
         ...
         _list path;
     vpc_configurations =
       option_of_yojson (value_for_key vpc_configurations_of_yojson "VpcConfigurations") _list path;
     application_system_rollback_configuration =
       option_of_yojson
     ...
     application_code_configuration =
       option_of_yojson
         (value_for_key application_code_configuration_of_yojson "ApplicationCodeConfiguration")
         _list path;
     environment_properties =
       option_of_yojson
         (value_for_key environment_properties_of_yojson "EnvironmentProperties")
         _list path;
     flink_application_configuration =
       option_of_yojson
         (value_for_key flink_application_configuration_of_yojson "FlinkApplicationConfiguration")
         _list path;
     sql_application_configuration =
       option_of_yojson
         (value_for_key sql_application_configuration_of_yojson "SqlApplicationConfiguration")
         _list path;
   }
...
let create_application_request_of_yojson tree path =
  ...
  ({
     ...
     application_configuration =
       option_of_yojson
         (value_for_key application_configuration_of_yojson "ApplicationConfiguration")
         _list path;
     service_execution_role = value_for_key role_ar_n_of_yojson "ServiceExecutionRole" _list path;
     runtime_environment =
       value_for_key runtime_environment_of_yojson "RuntimeEnvironment" _list path;
...
let add_application_reference_data_source_request_of_yojson tree path =
  ...
  ({
     reference_data_source =
       value_for_key reference_data_source_of_yojson "ReferenceDataSource" _list path;
     current_application_version_id =
       value_for_key application_version_id_of_yojson "CurrentApplicationVersionId" _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
   }
...
let add_application_input_processing_configuration_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     input_processing_configuration_description =
       option_of_yojson
...
let add_application_input_processing_configuration_request_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     input_processing_configuration =
       value_for_key input_processing_configuration_of_yojson "InputProcessingConfiguration" _list
         path;
     input_id = value_for_key id_of_yojson "InputId" _list path;
     current_application_version_id =
       value_for_key application_version_id_of_yojson "CurrentApplicationVersionId" _list path;
...
let add_application_cloud_watch_logging_option_request_of_yojson tree path =
  ...
  ({
     conditional_token =
       option_of_yojson (value_for_key conditional_token_of_yojson "ConditionalToken") _list path;
     cloud_watch_logging_option =
       value_for_key cloud_watch_logging_option_of_yojson "CloudWatchLoggingOption" _list path;
     current_application_version_id =
       option_of_yojson
         (value_for_key application_version_id_of_yojson "CurrentApplicationVersionId")
         _list path;
