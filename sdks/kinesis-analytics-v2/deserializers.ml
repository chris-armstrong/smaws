...
let zeppelin_monitoring_configuration_description_of_yojson tree path =
  ...
  let _res : zeppelin_monitoring_configuration_description =
    {
      log_level =
        (option_of_yojson (value_for_key log_level_of_yojson "LogLevel")
           _list path)
    } in
  _res
let zeppelin_monitoring_configuration_of_yojson tree path =
  ...
  let _res : zeppelin_monitoring_configuration =
    { log_level = (value_for_key log_level_of_yojson "LogLevel" _list path) } in
  _res
  ...
  let _res : s3_content_base_location_update =
    {
      base_path_update =
        (option_of_yojson
           (value_for_key base_path_of_yojson "BasePathUpdate") _list path);
      bucket_arn_update =
        (option_of_yojson
  ...
  let _res : s3_content_location =
    {
      object_version =
        (option_of_yojson
           (value_for_key object_version_of_yojson "ObjectVersion") _list
           path);
  ...
  let _res : maven_reference =
    {
      ...
      group_id =
        (value_for_key maven_group_id_of_yojson "GroupId" _list path)
    } in
  _res
  ...
  let _res : zeppelin_application_configuration_update =
    {
      ...
      deploy_as_application_configuration_update =
        (option_of_yojson
           (value_for_key
              deploy_as_application_configuration_update_of_yojson
...
let s3_content_base_location_description_of_yojson tree path =
  ...
  let _res : s3_content_base_location_description =
    {
      base_path =
        (option_of_yojson (value_for_key base_path_of_yojson "BasePath")
           _list path);
      bucket_ar_n =
        (value_for_key bucket_ar_n_of_yojson "BucketARN" _list path)
    } in
  ...
  let _res : zeppelin_application_configuration_description =
    {
      ...
      monitoring_configuration_description =
        (value_for_key
           zeppelin_monitoring_configuration_description_of_yojson
  ...
  let _res : input_description =
    {
      ...
      input_processing_configuration_description =
        (option_of_yojson
           (value_for_key
              input_processing_configuration_description_of_yojson
  ...
  let _res : code_content_description =
    {
      ...
      code_size =
        (option_of_yojson (value_for_key code_size_of_yojson "CodeSize")
           _list path);
      code_m_d5 =
      ...
      text_content =
        (option_of_yojson
           (value_for_key text_content_of_yojson "TextContent") _list path)
    } in
  _res
  ...
  let _res : parallelism_configuration_description =
    {
      auto_scaling_enabled =
        (option_of_yojson
           (value_for_key boolean_object_of_yojson "AutoScalingEnabled")
           _list path);
      current_parallelism =
        (option_of_yojson
  ...
  let _res : application_configuration_description =
    {
      ...
      application_code_configuration_description =
        (option_of_yojson
           (value_for_key
              application_code_configuration_description_of_yojson
  ...
  let _res : cloud_watch_logging_option_description =
    {
      ...
      cloud_watch_logging_option_id =
        (option_of_yojson
           (value_for_key id_of_yojson "CloudWatchLoggingOptionId") _list
           path)
    } in
  _res
  ...
  let _res : application_detail =
    {
      ...
      runtime_environment =
        (value_for_key runtime_environment_of_yojson "RuntimeEnvironment"
           _list path);
      application_name =
        (value_for_key application_name_of_yojson "ApplicationName" _list
           path);
  ...
  let _res : reference_data_source_update =
    {
      ...
      table_name_update =
        (option_of_yojson
           (value_for_key in_app_table_name_of_yojson "TableNameUpdate")
           _list path);
      reference_id = (value_for_key id_of_yojson "ReferenceId" _list path)
    } in
  _res
  ...
  let _res : sql_application_configuration_update =
    {
      ...
      output_updates =
        (option_of_yojson
           (value_for_key output_updates_of_yojson "OutputUpdates") _list
           path);
      input_updates =
        (option_of_yojson
  ...
  let _res : application_snapshot_configuration_update =
    {
      snapshots_enabled_update =
        (value_for_key boolean_object_of_yojson "SnapshotsEnabledUpdate"
           _list path)
    } in
  _res
  ...
  let _res : update_application_maintenance_configuration_response =
    {
      ...
      application_ar_n =
        (option_of_yojson
           (value_for_key resource_ar_n_of_yojson "ApplicationARN") _list
           path)
    } in
  _res
  ...
  let _res : unable_to_detect_schema_exception =
    {
      ...
      raw_input_records =
        (option_of_yojson
           (value_for_key raw_input_records_of_yojson "RawInputRecords")
           _list path);
      message =
        (option_of_yojson (value_for_key error_message_of_yojson "Message")
           _list path)
  ...
  let _res : input_processing_configuration =
    {
      input_lambda_processor =
        (value_for_key input_lambda_processor_of_yojson
           "InputLambdaProcessor" _list path)
    } in
  _res
  ...
  let _res : sql_application_configuration =
    {
      ...
      outputs =
        (option_of_yojson (value_for_key outputs_of_yojson "Outputs") _list
           path);
      inputs =
        (option_of_yojson (value_for_key inputs_of_yojson "Inputs") _list
           path)
    } in
  _res
...
let describe_application_snapshot_response_of_yojson tree path =
  ...
  let _res : describe_application_snapshot_response =
    {
      snapshot_details =
        (value_for_key snapshot_details_of_yojson "SnapshotDetails" _list
           path)
    } in
  _res
  ...
  let _res : create_application_presigned_url_response =
    {
      authorized_url =
        (option_of_yojson
           (value_for_key authorized_url_of_yojson "AuthorizedUrl") _list
           path)
    } in
  _res
  ...
  let _res : application_code_configuration =
    {
      ...
      code_content =
        (option_of_yojson
           (value_for_key code_content_of_yojson "CodeContent") _list path)
    } in
  _res
