...
type nonrec auto_update = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec selection_status = NOT_SELECTED [@ocaml.doc ""] | SELECTED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec text_type = PRINTED [@ocaml.doc ""] | HANDWRITING [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec create_adapter_request = {
  ...
  adapter_name : adapter_name; [@ocaml.doc "The name to be assigned to the adapter being created.\n"]
}
[@@ocaml.doc ""]
