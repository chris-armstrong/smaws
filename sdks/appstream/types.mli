...
type nonrec permission = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec theme_state = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec preferred_protocol = UDP [@ocaml.doc ""] | TCP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec screen_image_format = JPEG [@ocaml.doc ""] | PNG [@ocaml.doc ""]
[@@ocaml.doc
...
type nonrec stream_view = DESKTOP [@ocaml.doc ""] | APP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec app_visibility = ASSOCIATED [@ocaml.doc ""] | ALL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec update_entitlement_request = {
  attributes : entitlement_attribute_list option;
...
type nonrec latest_appstream_agent_version = FALSE [@ocaml.doc ""] | TRUE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec dynamic_app_providers_enabled = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec image_shared_with_others = FALSE [@ocaml.doc ""] | TRUE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec image_type = BYOL [@ocaml.doc ""] | NATIVE [@ocaml.doc ""] | CUSTOM [@ocaml.doc ""]
...
type nonrec describe_images_request = {
  ...
  names : string_list option; [@ocaml.doc "The names of the public or private images to describe.\n"]
}
[@@ocaml.doc ""]
...
type nonrec admin_app_license_usage_record = {
  ...
  user_arn : string_; [@ocaml.doc "The ARN of the user who used the license-included application.\n"]
}
...
type nonrec packaging_type = APPSTREAM2 [@ocaml.doc ""] | CUSTOM [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec app_block_state = ACTIVE [@ocaml.doc ""] | INACTIVE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec message_action = RESEND [@ocaml.doc ""] | SUPPRESS [@ocaml.doc ""] [@@ocaml.doc ""]
