...
type nonrec resource_type = JAR [@ocaml.doc ""] | FILE [@ocaml.doc ""] | ARCHIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec principal_type = USER [@ocaml.doc ""] | ROLE [@ocaml.doc ""] | GROUP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec configuration_object = {
  ...
  max_value : config_value_string option; [@ocaml.doc "A maximum allowed value for the parameter.\n"]
}
[@@ocaml.doc
...
type nonrec logical = AND [@ocaml.doc ""] | ANY [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec iceberg_null_order = NULLS_FIRST [@ocaml.doc ""] | NULLS_LAST [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec iceberg_sort_direction = ASC [@ocaml.doc ""] | DESC [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec last_refresh_type = FULL [@ocaml.doc ""] | INCREMENTAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec source_control_details = {
  provider : source_control_provider option;
      [@ocaml.doc "The provider for the remote repository.\n"]
...
type nonrec execution_class = FLEX [@ocaml.doc ""] | STANDARD [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec ddb_export_type = Ddb [@ocaml.doc ""] | S3 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec update_catalog_behavior = UPDATE_IN_DATABASE [@ocaml.doc ""] | LOG [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec dq_results_publishing_options = {
  evaluation_context : generic_limited_string option;
      [@ocaml.doc "The context of the evaluation.\n"]
...
type nonrec delta_target_compression_type = UNCOMPRESSED [@ocaml.doc ""] | SNAPPY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec dq_transform_output = PrimaryInput [@ocaml.doc ""] | EvaluationResults [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec filter_logical_operator = AND [@ocaml.doc ""] | OR [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec filter_value_type = COLUMNEXTRACTED [@ocaml.doc ""] | CONSTANT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec union_type = ALL [@ocaml.doc ""] | DISTINCT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type mappings = mapping list [@@ocaml.doc ""]
...
type nonrec compression_type = GZIP [@ocaml.doc ""] | BZIP2 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec job_mode = SCRIPT [@ocaml.doc ""] | VISUAL [@ocaml.doc ""] | NOTEBOOK [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec crawler_lineage_settings = ENABLE [@ocaml.doc ""] | DISABLE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec update_behavior = LOG [@ocaml.doc ""] | UPDATE_IN_DATABASE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec jdbc_metadata_entry = COMMENTS [@ocaml.doc ""] | RAWTYPES [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec update_asset_response = {
  ...
  updated_at : updated_at option; [@ocaml.doc "The timestamp at which the asset was last updated.\n"]
}
[@@ocaml.doc ""]
...
type nonrec dq_composite_rule_evaluation_method = COLUMN [@ocaml.doc ""] | ROW [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec resource_action = UPDATE [@ocaml.doc ""] | CREATE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec sort = ASCENDING [@ocaml.doc ""] | DESCENDING [@ocaml.doc ""] [@@ocaml.doc ""]
...
type search_filter_clause_list = search_filter_clause list [@@ocaml.doc ""]

and search_filter_clause =
...
type nonrec search_sort_order = ASCENDING [@ocaml.doc ""] | DESCENDING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec http_method = GET [@ocaml.doc ""] | POST [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec content_type = APPLICATION_JSON [@ocaml.doc ""] | URL_ENCODED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec enable_hybrid_values = TRUE [@ocaml.doc ""] | FALSE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec inclusion_annotation_value = INCLUDE [@ocaml.doc ""] | EXCLUDE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec session_type = LIVY [@ocaml.doc ""] | SPARK_CONNECT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec registry_status = AVAILABLE [@ocaml.doc ""] | DELETING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec sort_direction_type = DESCENDING [@ocaml.doc ""] | ASCENDING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec materialized_view_refresh_type = FULL [@ocaml.doc ""] | INCREMENTAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec data_quality_result_description = {
  result_id : hash_string option;
      [@ocaml.doc "The unique result ID for this data quality result.\n"]
  data_source : data_source option;
...
type nonrec data_operation = READ [@ocaml.doc ""] | WRITE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec node_type = CRAWLER [@ocaml.doc ""] | JOB [@ocaml.doc ""] | TRIGGER [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec workflow_run_statistics = {
  total_actions : integer_value option;
      [@ocaml.doc "Total number of Actions in the workflow run.\n"]
...
type nonrec get_triggers_request = {
  ...
  max_results : orchestration_page_size200 option; [@ocaml.doc "The maximum size of the response.\n"]
}
[@@ocaml.doc ""]
...
type nonrec configuration_source = CATALOG [@ocaml.doc ""] | TABLE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec data_quality_encryption_mode = DISABLED [@ocaml.doc ""] | SSEKMS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec job_bookmarks_encryption_mode = DISABLED [@ocaml.doc ""] | CSEKMS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec cloud_watch_encryption_mode = DISABLED [@ocaml.doc ""] | SSEKMS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec data_format = AVRO [@ocaml.doc ""] | JSON [@ocaml.doc ""] | PROTOBUF [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  data_format : data_format option;
      [@ocaml.doc
        "The data format of the schema definition. Currently [AVRO], [JSON] and [PROTOBUF] are \
         supported.\n"]
  status : schema_version_status option; [@ocaml.doc "The status of the schema version.\n"]
  created_time : created_timestamp option; [@ocaml.doc "The date and time the schema was created.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_schema_response = {
  ...
  updated_time : updated_timestamp option; [@ocaml.doc "The date and time the schema was updated.\n"]
}
[@@ocaml.doc ""]
...
type nonrec language = PYTHON [@ocaml.doc ""] | SCALA [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec get_plan_request = {
  mapping : mapping_list;
      [@ocaml.doc "The list of mappings from a source table to target tables.\n"]
...
type nonrec database_attributes = NAME [@ocaml.doc ""] | TARGET_DATABASE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec glue_resource_type = JOB [@ocaml.doc ""] | SESSION [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec execution_status = FAILED [@ocaml.doc ""] | STARTED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec setting_source = CATALOG [@ocaml.doc ""] | TABLE [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec schedule_type = CRON [@ocaml.doc ""] | AUTO [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec computation_type = FULL [@ocaml.doc ""] | INCREMENTAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec compute_environment_configuration = {
  name : compute_environment_name;
      [@ocaml.doc "A name for the compute environment configuration.\n"]
...
type nonrec create_dev_endpoint_response = {
  endpoint_name : generic_string option;
      [@ocaml.doc "The name assigned to the new [DevEndpoint].\n"]
...
type nonrec batch_stop_job_run_request = {
  job_name : name_string;
      [@ocaml.doc "The name of the job definition for which to stop job runs.\n"]
...
type nonrec batch_get_workflows_response = {
  ...
  missing_workflows : workflow_names option; [@ocaml.doc "A list of names of workflows not found.\n"]
}
[@@ocaml.doc ""]
...
type nonrec batch_get_iterable_forms_response = {
  items : iterable_form_item_list option;
      [@ocaml.doc "The list of retrieved iterable form items.\n"]
...
type nonrec partition_error = {
  partition_values : value_string_list option;
      [@ocaml.doc "The values that define the partition.\n"]
