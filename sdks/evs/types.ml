...
type nonrec instance_type = I7I_METAL_24XL [@ocaml.doc ""] | I4I_METAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec tag_resource_request = {
  ...
  resource_arn : arn; [@ocaml.doc "The Amazon Resource Name (ARN) of the resource to add tags to.\n"]
}
[@@ocaml.doc ""]
