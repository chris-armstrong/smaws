...
type nonrec update_parallel_data_response = {
  ...
  name : resource_name option; [@ocaml.doc "The name of the parallel data resource being updated.\n"]
}
[@@ocaml.doc ""]
...
type nonrec parallel_data_format = TMX [@ocaml.doc ""] | CSV [@ocaml.doc ""] | TSV [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec formality = INFORMAL [@ocaml.doc ""] | FORMAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec directionality = MULTI [@ocaml.doc ""] | UNI [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec start_text_translation_job_request = {
  ...
  job_name : job_name option; [@ocaml.doc "The name of the batch translation job to be performed.\n"]
}
[@@ocaml.doc ""]
