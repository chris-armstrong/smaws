...
type nonrec validate_state_machine_definition_diagnostic_list =
  validate_state_machine_definition_diagnostic list[@@ocaml.doc ""]
...
type nonrec list_state_machines_output =
  ...
  state_machines: state_machine_list [@ocaml.doc ""]}[@@ocaml.doc ""]
...
val make_create_activity_input :
  ?encryption_configuration:encryption_configuration ->
    ?tags:tag_list -> name:name -> unit -> create_activity_input(** {1:operations Operations} *)
