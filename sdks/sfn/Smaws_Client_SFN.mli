...
sig
  val error_to_string :
    ...
    | `TooManyTags of too_many_tags ] -> string
  val request :
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `ConflictException of conflict_exception  | `InvalidArn of invalid_arn 
...
sig
  val error_to_string :
    ...
    | `InvalidArn of invalid_arn ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `KmsThrottlingException of kms_throttling_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error | `InvalidArn of invalid_arn 
    | `ResourceNotFound of resource_not_found ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `TaskTimedOut of task_timed_out ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
