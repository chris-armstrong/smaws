...
let validate_state_machine_definition_diagnostic_to_yojson
  ...
  assoc_to_yojson
    [("location",
       (option_to_yojson validate_state_machine_definition_location_to_yojson
          x.location));
    ("message",
...
let update_state_machine_output_to_yojson (x : update_state_machine_output) =
  assoc_to_yojson
    ...
    ("updateDate", (Some (timestamp__to_yojson x.update_date)))]
...
let log_destination_to_yojson (x : log_destination) =
  assoc_to_yojson
    [("cloudWatchLogsLogGroup",
       (option_to_yojson cloud_watch_logs_log_group_to_yojson
          x.cloud_watch_logs_log_group))]
let log_destination_list_to_yojson tree =
  list_to_yojson log_destination_to_yojson tree
let logging_configuration_to_yojson (x : logging_configuration) =
  assoc_to_yojson
    ...
    ("includeExecutionData",
      (option_to_yojson include_execution_data_to_yojson
...
let update_state_machine_alias_input_to_yojson
  (x : update_state_machine_alias_input) =
  assoc_to_yojson
    [("routingConfiguration",
       (option_to_yojson routing_configuration_list_to_yojson
          x.routing_configuration));
    ("description",
...
let update_map_run_input_to_yojson (x : update_map_run_input) =
  assoc_to_yojson
    [("toleratedFailureCount",
       (option_to_yojson tolerated_failure_count_to_yojson
          x.tolerated_failure_count));
    ("toleratedFailurePercentage",
      (option_to_yojson tolerated_failure_percentage_to_yojson
...
let history_event_execution_data_details_to_yojson
  (x : history_event_execution_data_details) =
  assoc_to_yojson
...
let task_start_failed_event_details_to_yojson
  (x : task_start_failed_event_details) =
  assoc_to_yojson
    [("cause", (option_to_yojson sensitive_cause_to_yojson x.cause));
    ("error", (option_to_yojson sensitive_error_to_yojson x.error));
    ("resource", (Some (name_to_yojson x.resource)));
...
let task_credentials_to_yojson (x : task_credentials) =
  assoc_to_yojson
    [("roleArn", (option_to_yojson long_arn_to_yojson x.role_arn))]
...
let stop_execution_output_to_yojson (x : stop_execution_output) =
  assoc_to_yojson [("stopDate", (Some (timestamp__to_yojson x.stop_date)))]
...
let state_machine_version_list_item_to_yojson
  (x : state_machine_version_list_item) =
  assoc_to_yojson
...
let state_machine_type_not_supported_to_yojson
  (x : state_machine_type_not_supported) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let state_machine_list_item_to_yojson (x : state_machine_list_item) =
  assoc_to_yojson
    ...
    ("stateMachineArn", (Some (arn_to_yojson x.state_machine_arn)))]
let state_machine_list_to_yojson tree =
  list_to_yojson state_machine_list_item_to_yojson tree
...
let state_machine_alias_list_item_to_yojson
  (x : state_machine_alias_list_item) =
  assoc_to_yojson
    [("creationDate", (Some (timestamp__to_yojson x.creation_date)));
    ("stateMachineAliasArn",
...
let cloud_watch_events_execution_data_details_to_yojson
  ...
  assoc_to_yojson
    [("included", (option_to_yojson included_details_to_yojson x.included))]
...
let billing_details_to_yojson (x : billing_details) =
  assoc_to_yojson
    [("billedDurationInMilliseconds",
       (option_to_yojson billed_duration_to_yojson
          x.billed_duration_in_milliseconds));
    ("billedMemoryUsedInMB",
      (option_to_yojson billed_memory_used_to_yojson
         x.billed_memory_used_in_m_b))]
let start_sync_execution_output_to_yojson (x : start_sync_execution_output) =
  assoc_to_yojson
    ...
    ("outputDetails",
      (option_to_yojson cloud_watch_events_execution_data_details_to_yojson
         x.output_details));
    ("output", (option_to_yojson sensitive_data_to_yojson x.output));
    ("inputDetails",
      (option_to_yojson cloud_watch_events_execution_data_details_to_yojson
    ...
    ("stopDate", (Some (timestamp__to_yojson x.stop_date)));
    ("startDate", (Some (timestamp__to_yojson x.start_date)));
...
let redrive_execution_output_to_yojson (x : redrive_execution_output) =
  assoc_to_yojson
    [("redriveDate", (Some (timestamp__to_yojson x.redrive_date)))]
...
let publish_state_machine_version_output_to_yojson
  (x : publish_state_machine_version_output) =
  assoc_to_yojson
    [("stateMachineVersionArn",
       (Some (arn_to_yojson x.state_machine_version_arn)));
    ("creationDate", (Some (timestamp__to_yojson x.creation_date)))]
let publish_state_machine_version_input_to_yojson
  (x : publish_state_machine_version_input) =
  assoc_to_yojson
    [("description",
...
let map_state_started_event_details_to_yojson
  (x : map_state_started_event_details) =
  assoc_to_yojson
    [("length", (option_to_yojson unsigned_integer_to_yojson x.length))]
...
let map_run_started_event_details_to_yojson
  (x : map_run_started_event_details) =
  assoc_to_yojson
...
let map_run_list_item_to_yojson (x : map_run_list_item) =
  assoc_to_yojson
    [("stopDate", (option_to_yojson timestamp__to_yojson x.stop_date));
    ("startDate", (Some (timestamp__to_yojson x.start_date)));
    ("stateMachineArn", (Some (arn_to_yojson x.state_machine_arn)));
    ("mapRunArn", (Some (long_arn_to_yojson x.map_run_arn)));
    ("executionArn", (Some (arn_to_yojson x.execution_arn)))]
let map_run_list_to_yojson tree =
  list_to_yojson map_run_list_item_to_yojson tree
...
let execution_list_item_to_yojson (x : execution_list_item) =
  assoc_to_yojson
    [("redriveDate", (option_to_yojson timestamp__to_yojson x.redrive_date));
    ("redriveCount",
      (option_to_yojson redrive_count_to_yojson x.redrive_count));
    ("stateMachineAliasArn",
    ...
    ("stateMachineArn", (Some (arn_to_yojson x.state_machine_arn)));
    ("executionArn", (Some (arn_to_yojson x.execution_arn)))]
let execution_list_to_yojson tree =
  list_to_yojson execution_list_item_to_yojson tree
...
let activity_list_to_yojson tree =
  list_to_yojson activity_list_item_to_yojson tree
...
let activity_failed_event_details_to_yojson
  (x : activity_failed_event_details) =
  assoc_to_yojson
    [("cause", (option_to_yojson sensitive_cause_to_yojson x.cause));
    ("error", (option_to_yojson sensitive_error_to_yojson x.error))]
...
let activity_started_event_details_to_yojson
  (x : activity_started_event_details) =
  assoc_to_yojson
    [("workerName", (option_to_yojson identity_to_yojson x.worker_name))]
...
let execution_failed_event_details_to_yojson
  (x : execution_failed_event_details) =
  assoc_to_yojson
    [("cause", (option_to_yojson sensitive_cause_to_yojson x.cause));
    ("error", (option_to_yojson sensitive_error_to_yojson x.error))]
let execution_started_event_details_to_yojson
  (x : execution_started_event_details) =
  assoc_to_yojson
    [("stateMachineVersionArn",
       (option_to_yojson arn_to_yojson x.state_machine_version_arn));
    ("stateMachineAliasArn",
...
let execution_aborted_event_details_to_yojson
  (x : execution_aborted_event_details) =
  assoc_to_yojson
    [("cause", (option_to_yojson sensitive_cause_to_yojson x.cause));
    ("error", (option_to_yojson sensitive_error_to_yojson x.error))]
...
let history_event_to_yojson (x : history_event) =
  assoc_to_yojson
    ...
    ("mapRunStartedEventDetails",
      (option_to_yojson map_run_started_event_details_to_yojson
         x.map_run_started_event_details));
    ("stateExitedEventDetails",
      (option_to_yojson state_exited_event_details_to_yojson
         x.state_exited_event_details));
    ("stateEnteredEventDetails",
      (option_to_yojson state_entered_event_details_to_yojson
         x.state_entered_event_details));
    ...
    ("lambdaFunctionScheduleFailedEventDetails",
      (option_to_yojson
         lambda_function_schedule_failed_event_details_to_yojson
         x.lambda_function_schedule_failed_event_details));
    ...
    ("mapIterationAbortedEventDetails",
      (option_to_yojson map_iteration_event_details_to_yojson
         x.map_iteration_aborted_event_details));
    ("mapIterationFailedEventDetails",
      (option_to_yojson map_iteration_event_details_to_yojson
         x.map_iteration_failed_event_details));
    ("mapIterationSucceededEventDetails",
      (option_to_yojson map_iteration_event_details_to_yojson
         x.map_iteration_succeeded_event_details));
    ("mapIterationStartedEventDetails",
      (option_to_yojson map_iteration_event_details_to_yojson
         x.map_iteration_started_event_details));
    ("mapStateStartedEventDetails",
      (option_to_yojson map_state_started_event_details_to_yojson
         x.map_state_started_event_details));
    ...
    ("executionAbortedEventDetails",
      (option_to_yojson execution_aborted_event_details_to_yojson
         x.execution_aborted_event_details));
    ("executionSucceededEventDetails",
      (option_to_yojson execution_succeeded_event_details_to_yojson
         x.execution_succeeded_event_details));
    ("executionStartedEventDetails",
      (option_to_yojson execution_started_event_details_to_yojson
         x.execution_started_event_details));
    ("executionFailedEventDetails",
      (option_to_yojson execution_failed_event_details_to_yojson
         x.execution_failed_event_details));
    ("taskTimedOutEventDetails",
      (option_to_yojson task_timed_out_event_details_to_yojson
         x.task_timed_out_event_details));
    ("taskSucceededEventDetails",
      (option_to_yojson task_succeeded_event_details_to_yojson
         x.task_succeeded_event_details));
    ("taskSubmittedEventDetails",
      (option_to_yojson task_submitted_event_details_to_yojson
         x.task_submitted_event_details));
    ("taskSubmitFailedEventDetails",
      (option_to_yojson task_submit_failed_event_details_to_yojson
         x.task_submit_failed_event_details));
    ("taskStartedEventDetails",
      (option_to_yojson task_started_event_details_to_yojson
         x.task_started_event_details));
    ("taskStartFailedEventDetails",
      (option_to_yojson task_start_failed_event_details_to_yojson
         x.task_start_failed_event_details));
    ("taskScheduledEventDetails",
      (option_to_yojson task_scheduled_event_details_to_yojson
         x.task_scheduled_event_details));
    ("taskFailedEventDetails",
      (option_to_yojson task_failed_event_details_to_yojson
         x.task_failed_event_details));
    ...
    ("activityStartedEventDetails",
      (option_to_yojson activity_started_event_details_to_yojson
         x.activity_started_event_details));
    ...
    ("activityFailedEventDetails",
      (option_to_yojson activity_failed_event_details_to_yojson
         x.activity_failed_event_details));
    ("previousEventId",
    ...
    ("timestamp", (Some (timestamp__to_yojson x.timestamp_)))]
...
let get_execution_history_input_to_yojson (x : get_execution_history_input) =
  assoc_to_yojson
    [("includeExecutionData",
       (option_to_yojson
          include_execution_data_get_execution_history_to_yojson
          x.include_execution_data));
    ("nextToken", (option_to_yojson page_token_to_yojson x.next_token));
    ("reverseOrder",
...
let activity_worker_limit_exceeded_to_yojson
  (x : activity_worker_limit_exceeded) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let describe_state_machine_alias_output_to_yojson
  ...
  assoc_to_yojson
    [("updateDate", (option_to_yojson timestamp__to_yojson x.update_date));
    ("creationDate", (option_to_yojson timestamp__to_yojson x.creation_date));
    ("routingConfiguration",
      (option_to_yojson routing_configuration_list_to_yojson
         x.routing_configuration));
    ("description",
...
let describe_state_machine_alias_input_to_yojson
  (x : describe_state_machine_alias_input) =
  assoc_to_yojson
    [("stateMachineAliasArn",
       (Some (arn_to_yojson x.state_machine_alias_arn)))]
let describe_map_run_output_to_yojson (x : describe_map_run_output) =
  assoc_to_yojson
    ...
    ("toleratedFailurePercentage",
      (Some
         (tolerated_failure_percentage_to_yojson
            x.tolerated_failure_percentage)));
...
let create_state_machine_alias_output_to_yojson
  (x : create_state_machine_alias_output) =
  assoc_to_yojson
    [("creationDate", (Some (timestamp__to_yojson x.creation_date)));
    ("stateMachineAliasArn",
      (Some (arn_to_yojson x.state_machine_alias_arn)))]
...
let create_state_machine_alias_input_to_yojson
  (x : create_state_machine_alias_input) =
  assoc_to_yojson
    [("routingConfiguration",
