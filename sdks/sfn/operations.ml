  ...
  struct
    ...
    let request context (request : create_activity_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.CreateActivity" ~service ~context
        ~input
...
module CreateStateMachine =
  struct
    ...
    let request context (request : create_state_machine_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.CreateStateMachine" ~service ~context
        ~input
...
module CreateStateMachineAlias =
  struct
    ...
    let request context (request : create_state_machine_alias_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.CreateStateMachineAlias" ~service
        ~context ~input
...
module DeleteActivity =
  struct
    ...
    let request context (request : delete_activity_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.DeleteActivity" ~service ~context
        ~input
...
module DeleteStateMachine =
  struct
    ...
    let request context (request : delete_state_machine_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.DeleteStateMachine" ~service ~context
        ~input
...
module DeleteStateMachineAlias =
  struct
    ...
    let request context (request : delete_state_machine_alias_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.DeleteStateMachineAlias" ~service
        ~context ~input
...
module DeleteStateMachineVersion =
  struct
    ...
    let request context (request : delete_state_machine_version_input) =
      let input =
        Json_serializers.delete_state_machine_version_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.DeleteStateMachineVersion" ~service
        ~context ~input
...
module DescribeActivity =
  struct
    ...
    let request context (request : describe_activity_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.DescribeActivity" ~service ~context
        ~input
...
module DescribeExecution =
  struct
    ...
    let request context (request : describe_execution_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.DescribeExecution" ~service ~context
        ~input
...
module DescribeMapRun =
  struct
    ...
    let request context (request : describe_map_run_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.DescribeMapRun" ~service ~context
        ~input
...
module DescribeStateMachine =
  struct
    ...
    let request context (request : describe_state_machine_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.DescribeStateMachine" ~service ~context
        ~input
...
module DescribeStateMachineAlias =
  struct
    ...
    let request context (request : describe_state_machine_alias_input) =
      let input =
        Json_serializers.describe_state_machine_alias_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.DescribeStateMachineAlias" ~service
        ~context ~input
...
module GetActivityTask =
  struct
    ...
    let request context (request : get_activity_task_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.GetActivityTask" ~service ~context
        ~input
...
module GetExecutionHistory =
  struct
    ...
    let request context (request : get_execution_history_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.GetExecutionHistory" ~service ~context
        ~input
...
module ListActivities =
  struct
    ...
    let request context (request : list_activities_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.ListActivities" ~service ~context
        ~input
...
module ListExecutions =
  struct
    ...
    let request context (request : list_executions_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.ListExecutions" ~service ~context
        ~input
...
module ListMapRuns =
  struct
    ...
    let request context (request : list_map_runs_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.ListMapRuns" ~service ~context ~input
...
module ListStateMachineAliases =
  struct
    ...
    let request context (request : list_state_machine_aliases_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.ListStateMachineAliases" ~service
        ~context ~input
...
module ListStateMachineVersions =
  struct
    ...
    let request context (request : list_state_machine_versions_input) =
      let input =
        Json_serializers.list_state_machine_versions_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.ListStateMachineVersions" ~service
        ~context ~input
...
module ListStateMachines =
  struct
    ...
    let request context (request : list_state_machines_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.ListStateMachines" ~service ~context
        ~input
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.ListTagsForResource" ~service ~context
        ~input
    ...
    let request context (request : publish_state_machine_version_input) =
      let input =
        Json_serializers.publish_state_machine_version_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.PublishStateMachineVersion" ~service
        ~context ~input
...
module RedriveExecution =
  struct
    ...
    let request context (request : redrive_execution_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.RedriveExecution" ~service ~context
        ~input
...
module SendTaskFailure =
  struct
    ...
    let request context (request : send_task_failure_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.SendTaskFailure" ~service ~context
        ~input
...
module SendTaskHeartbeat =
  struct
    ...
    let request context (request : send_task_heartbeat_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.SendTaskHeartbeat" ~service ~context
        ~input
...
module SendTaskSuccess =
  struct
    ...
    let request context (request : send_task_success_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.SendTaskSuccess" ~service ~context
        ~input
...
module StartExecution =
  struct
    ...
    let request context (request : start_execution_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.StartExecution" ~service ~context
        ~input
...
module StartSyncExecution =
  struct
    ...
    let request context (request : start_sync_execution_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.StartSyncExecution" ~service ~context
        ~input
...
module StopExecution =
  struct
    ...
    let request context (request : stop_execution_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.StopExecution" ~service ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.TagResource" ~service ~context ~input
...
module TestState =
  struct
    ...
    let request context (request : test_state_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.TestState" ~service ~context ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.UntagResource" ~service ~context ~input
...
module UpdateMapRun =
  struct
    ...
    let request context (request : update_map_run_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.UpdateMapRun" ~service ~context ~input
...
module UpdateStateMachine =
  struct
    ...
    let request context (request : update_state_machine_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.UpdateStateMachine" ~service ~context
        ~input
...
module UpdateStateMachineAlias =
  struct
    ...
    let request context (request : update_state_machine_alias_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSStepFunctions.UpdateStateMachineAlias" ~service
        ~context ~input
