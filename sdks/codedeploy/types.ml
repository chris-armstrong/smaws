...
type nonrec outdated_instances_strategy = Ignore [@ocaml.doc ""] | Update [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec deployment_type = BLUE_GREEN [@ocaml.doc ""] | IN_PLACE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec instance_action = KEEP_ALIVE [@ocaml.doc ""] | TERMINATE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec target_label = GREEN [@ocaml.doc ""] | BLUE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec stop_status = SUCCEEDED [@ocaml.doc ""] | PENDING [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec remove_tags_from_on_premises_instances_input = {
  ...
  tags : tag_list; [@ocaml.doc "The tag key-value pairs to remove from the on-premises instances.\n"]
}
...
type nonrec registration_status = Deregistered [@ocaml.doc ""] | Registered [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec instance_type = GREEN [@ocaml.doc ""] | BLUE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec deployment_wait_type = TERMINATION_WAIT [@ocaml.doc ""] | READY_WAIT [@ocaml.doc ""]
[@@ocaml.doc ""]
