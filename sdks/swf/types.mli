...
type nonrec registration_status = REGISTERED [@ocaml.doc ""] | DEPRECATED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec continue_as_new_workflow_execution_decision_attributes = {
  ...
  lambda_role : arn option; [@ocaml.doc "The IAM role to attach to the new (continued) execution.\n"]
}
[@@ocaml.doc
...
type nonrec execution_status = OPEN [@ocaml.doc ""] | CLOSED [@ocaml.doc ""] [@@ocaml.doc ""]
