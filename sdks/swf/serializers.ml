...
let workflow_type_info_list_to_yojson tree =
  list_to_yojson workflow_type_info_to_yojson tree
...
let task_list_to_yojson (x : task_list) =
...
let workflow_execution_timeout_type_to_yojson
  (x : workflow_execution_timeout_type) =
...
let workflow_execution_terminated_cause_to_yojson
  (x : workflow_execution_terminated_cause) =
  match x with
...
let workflow_execution_terminated_event_attributes_to_yojson
  ...
  assoc_to_yojson
    [("cause",
       (option_to_yojson workflow_execution_terminated_cause_to_yojson
          x.cause));
    ("childPolicy", (Some (child_policy_to_yojson x.child_policy)));
...
let workflow_execution_started_event_attributes_to_yojson
  ...
  assoc_to_yojson
    ...
    ("parentWorkflowExecution",
      (option_to_yojson workflow_execution_to_yojson
         x.parent_workflow_execution));
    ("continuedExecutionRunId",
      (option_to_yojson workflow_run_id_optional_to_yojson
         x.continued_execution_run_id));
    ...
    ("taskStartToCloseTimeout",
      (option_to_yojson duration_in_seconds_optional_to_yojson
         x.task_start_to_close_timeout));
    ("executionStartToCloseTimeout",
      (option_to_yojson duration_in_seconds_optional_to_yojson
         x.execution_start_to_close_timeout));
...
let workflow_execution_open_counts_to_yojson
  (x : workflow_execution_open_counts) =
  assoc_to_yojson
    [("openLambdaFunctions",
...
let workflow_execution_info_to_yojson (x : workflow_execution_info) =
  assoc_to_yojson
    ...
    ("startTimestamp", (Some (timestamp__to_yojson x.start_timestamp)));
    ("workflowType", (Some (workflow_type_to_yojson x.workflow_type)));
...
let workflow_execution_configuration_to_yojson
  (x : workflow_execution_configuration) =
  assoc_to_yojson
    [("lambdaRole", (option_to_yojson arn_to_yojson x.lambda_role));
    ("childPolicy", (Some (child_policy_to_yojson x.child_policy)));
    ("taskPriority",
    ...
    ("executionStartToCloseTimeout",
      (Some
         (duration_in_seconds_to_yojson x.execution_start_to_close_timeout)));
    ("taskStartToCloseTimeout",
...
let workflow_execution_detail_to_yojson (x : workflow_execution_detail) =
  assoc_to_yojson
    ...
    ("executionConfiguration",
      (Some
         (workflow_execution_configuration_to_yojson
            x.execution_configuration)));
    ("executionInfo",
...
let workflow_execution_cancel_requested_event_attributes_to_yojson
  ...
  assoc_to_yojson
    [("cause",
       (option_to_yojson workflow_execution_cancel_requested_cause_to_yojson
          x.cause));
    ("externalInitiatedEventId",
      (option_to_yojson event_id_to_yojson x.external_initiated_event_id));
    ("externalWorkflowExecution",
...
let resource_tag_key_list_to_yojson tree =
  list_to_yojson resource_tag_key_to_yojson tree
...
let operation_not_permitted_fault_to_yojson
  (x : operation_not_permitted_fault) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let undeprecate_workflow_type_input_to_yojson
  (x : undeprecate_workflow_type_input) =
  assoc_to_yojson
    [("workflowType", (Some (workflow_type_to_yojson x.workflow_type)));
...
let undeprecate_activity_type_input_to_yojson
  (x : undeprecate_activity_type_input) =
  assoc_to_yojson
...
let timer_started_event_attributes_to_yojson
  (x : timer_started_event_attributes) =
  assoc_to_yojson
    [("decisionTaskCompletedEventId",
       (Some (event_id_to_yojson x.decision_task_completed_event_id)));
    ("startToFireTimeout",
...
let timer_canceled_event_attributes_to_yojson
  (x : timer_canceled_event_attributes) =
  assoc_to_yojson
    [("decisionTaskCompletedEventId",
       (Some (event_id_to_yojson x.decision_task_completed_event_id)));
    ("startedEventId", (Some (event_id_to_yojson x.started_event_id)));
...
let terminate_workflow_execution_input_to_yojson
  (x : terminate_workflow_execution_input) =
  assoc_to_yojson
    [("childPolicy",
...
let resource_tag_list_to_yojson tree =
  list_to_yojson resource_tag_to_yojson tree
...
let tag_filter_to_yojson (x : tag_filter) =
  assoc_to_yojson [("tag", (Some (tag_to_yojson x.tag)))]
let start_workflow_execution_input_to_yojson
  (x : start_workflow_execution_input) =
  assoc_to_yojson
    [("lambdaRole", (option_to_yojson arn_to_yojson x.lambda_role));
...
let run_to_yojson (x : run) =
  assoc_to_yojson
    [("runId", (option_to_yojson workflow_run_id_to_yojson x.run_id))]
...
let start_timer_decision_attributes_to_yojson
  (x : start_timer_decision_attributes) =
  assoc_to_yojson
    [("startToFireTimeout",
       (Some (duration_in_seconds_to_yojson x.start_to_fire_timeout)));
    ("control", (option_to_yojson data_to_yojson x.control));
...
let start_lambda_function_failed_cause_to_yojson
  (x : start_lambda_function_failed_cause) =
...
let signal_workflow_execution_input_to_yojson
  (x : signal_workflow_execution_input) =
  assoc_to_yojson
    [("input", (option_to_yojson data_to_yojson x.input));
    ("signalName", (Some (signal_name_to_yojson x.signal_name)));
    ("runId", (option_to_yojson workflow_run_id_optional_to_yojson x.run_id));
...
let schedule_activity_task_decision_attributes_to_yojson
  ...
  assoc_to_yojson
    ...
    ("startToCloseTimeout",
      (option_to_yojson duration_in_seconds_optional_to_yojson
         x.start_to_close_timeout));
    ("scheduleToStartTimeout",
      (option_to_yojson duration_in_seconds_optional_to_yojson
         x.schedule_to_start_timeout));
    ("taskPriority",
      (option_to_yojson task_priority_to_yojson x.task_priority));
    ("taskList", (option_to_yojson task_list_to_yojson x.task_list));
    ("scheduleToCloseTimeout",
      (option_to_yojson duration_in_seconds_optional_to_yojson
         x.schedule_to_close_timeout));
    ("input", (option_to_yojson data_to_yojson x.input));
    ("control", (option_to_yojson data_to_yojson x.control));
...
let decision_to_yojson (x : decision) =
  assoc_to_yojson
    [("scheduleLambdaFunctionDecisionAttributes",
       (option_to_yojson
          schedule_lambda_function_decision_attributes_to_yojson
          x.schedule_lambda_function_decision_attributes));
    ("startChildWorkflowExecutionDecisionAttributes",
      (option_to_yojson
         start_child_workflow_execution_decision_attributes_to_yojson
         x.start_child_workflow_execution_decision_attributes));
    ("requestCancelExternalWorkflowExecutionDecisionAttributes",
      (option_to_yojson
         request_cancel_external_workflow_execution_decision_attributes_to_yojson
         x.request_cancel_external_workflow_execution_decision_attributes));
    ("signalExternalWorkflowExecutionDecisionAttributes",
      (option_to_yojson
         signal_external_workflow_execution_decision_attributes_to_yojson
         x.signal_external_workflow_execution_decision_attributes));
    ("cancelTimerDecisionAttributes",
      (option_to_yojson cancel_timer_decision_attributes_to_yojson
         x.cancel_timer_decision_attributes));
    ("startTimerDecisionAttributes",
      (option_to_yojson start_timer_decision_attributes_to_yojson
         x.start_timer_decision_attributes));
    ...
    ("continueAsNewWorkflowExecutionDecisionAttributes",
      (option_to_yojson
         continue_as_new_workflow_execution_decision_attributes_to_yojson
         x.continue_as_new_workflow_execution_decision_attributes));
    ("cancelWorkflowExecutionDecisionAttributes",
      (option_to_yojson
         cancel_workflow_execution_decision_attributes_to_yojson
         x.cancel_workflow_execution_decision_attributes));
    ...
    ("completeWorkflowExecutionDecisionAttributes",
      (option_to_yojson
         complete_workflow_execution_decision_attributes_to_yojson
         x.complete_workflow_execution_decision_attributes));
    ("requestCancelActivityTaskDecisionAttributes",
      (option_to_yojson
         request_cancel_activity_task_decision_attributes_to_yojson
         x.request_cancel_activity_task_decision_attributes));
...
let respond_decision_task_completed_input_to_yojson
  (x : respond_decision_task_completed_input) =
  assoc_to_yojson
...
let respond_activity_task_failed_input_to_yojson
  (x : respond_activity_task_failed_input) =
  assoc_to_yojson
    [("details", (option_to_yojson data_to_yojson x.details));
    ("reason", (option_to_yojson failure_reason_to_yojson x.reason));
    ("taskToken", (Some (task_token_to_yojson x.task_token)))]
let respond_activity_task_completed_input_to_yojson
  (x : respond_activity_task_completed_input) =
  assoc_to_yojson
    [("result", (option_to_yojson data_to_yojson x.result));
    ("taskToken", (Some (task_token_to_yojson x.task_token)))]
let respond_activity_task_canceled_input_to_yojson
  (x : respond_activity_task_canceled_input) =
  assoc_to_yojson
    [("details", (option_to_yojson data_to_yojson x.details));
    ("taskToken", (Some (task_token_to_yojson x.task_token)))]
let request_cancel_workflow_execution_input_to_yojson
  (x : request_cancel_workflow_execution_input) =
  assoc_to_yojson
    [("runId",
...
let register_domain_input_to_yojson (x : register_domain_input) =
  assoc_to_yojson
    ...
    ("workflowExecutionRetentionPeriodInDays",
      (Some
         (duration_in_days_to_yojson
            x.workflow_execution_retention_period_in_days)));
    ("description", (option_to_yojson description_to_yojson x.description));
...
let register_activity_type_input_to_yojson (x : register_activity_type_input)
  ...
  assoc_to_yojson
    ...
    ("defaultTaskHeartbeatTimeout",
      (option_to_yojson duration_in_seconds_optional_to_yojson
         x.default_task_heartbeat_timeout));
    ("defaultTaskStartToCloseTimeout",
      (option_to_yojson duration_in_seconds_optional_to_yojson
         x.default_task_start_to_close_timeout));
    ("description", (option_to_yojson description_to_yojson x.description));
...
let activity_task_status_to_yojson (x : activity_task_status) =
  assoc_to_yojson
    [("cancelRequested", (Some (canceled_to_yojson x.cancel_requested)))]
let limited_data_to_yojson = string_to_yojson
let record_activity_task_heartbeat_input_to_yojson
  (x : record_activity_task_heartbeat_input) =
  assoc_to_yojson
...
let fail_workflow_execution_failed_cause_to_yojson
  (x : fail_workflow_execution_failed_cause) =
  match x with
  | OPERATION_NOT_PERMITTED -> `String "OPERATION_NOT_PERMITTED"
  | UNHANDLED_DECISION -> `String "UNHANDLED_DECISION"
...
let cancel_workflow_execution_failed_cause_to_yojson
  (x : cancel_workflow_execution_failed_cause) =
  match x with
  | OPERATION_NOT_PERMITTED -> `String "OPERATION_NOT_PERMITTED"
  | UNHANDLED_DECISION -> `String "UNHANDLED_DECISION"
...
let continue_as_new_workflow_execution_failed_event_attributes_to_yojson
  ...
  assoc_to_yojson
    ...
    ("cause",
      (Some
         (continue_as_new_workflow_execution_failed_cause_to_yojson x.cause)))]
...
let activity_task_canceled_event_attributes_to_yojson
  ...
  assoc_to_yojson
    [("latestCancelRequestedEventId",
       (option_to_yojson event_id_to_yojson
          x.latest_cancel_requested_event_id));
    ("startedEventId", (Some (event_id_to_yojson x.started_event_id)));
    ("scheduledEventId", (Some (event_id_to_yojson x.scheduled_event_id)));
    ("details", (option_to_yojson data_to_yojson x.details))]
...
let signal_external_workflow_execution_failed_event_attributes_to_yojson
  ...
  assoc_to_yojson
    ...
    ("cause",
      (Some
         (signal_external_workflow_execution_failed_cause_to_yojson x.cause)));
    ("runId", (option_to_yojson workflow_run_id_optional_to_yojson x.run_id));
    ("workflowId", (Some (workflow_id_to_yojson x.workflow_id)))]
...
let request_cancel_external_workflow_execution_failed_event_attributes_to_yojson
  ...
  assoc_to_yojson
    ...
    ("cause",
      (Some
         (request_cancel_external_workflow_execution_failed_cause_to_yojson
            x.cause)));
    ("runId", (option_to_yojson workflow_run_id_optional_to_yojson x.run_id));
    ("workflowId", (Some (workflow_id_to_yojson x.workflow_id)))]
let schedule_activity_task_failed_cause_to_yojson
  (x : schedule_activity_task_failed_cause) =
  match x with
  | OPERATION_NOT_PERMITTED -> `String "OPERATION_NOT_PERMITTED"
...
let lambda_function_timed_out_event_attributes_to_yojson
  ...
  assoc_to_yojson
    [("timeoutType",
       (option_to_yojson lambda_function_timeout_type_to_yojson
          x.timeout_type));
    ("startedEventId", (Some (event_id_to_yojson x.started_event_id)));
    ("scheduledEventId", (Some (event_id_to_yojson x.scheduled_event_id)))]
let schedule_lambda_function_failed_cause_to_yojson
  (x : schedule_lambda_function_failed_cause) =
  match x with
...
let history_event_to_yojson (x : history_event) =
  assoc_to_yojson
    [("startLambdaFunctionFailedEventAttributes",
       (option_to_yojson
          start_lambda_function_failed_event_attributes_to_yojson
          x.start_lambda_function_failed_event_attributes));
    ("scheduleLambdaFunctionFailedEventAttributes",
      (option_to_yojson
         schedule_lambda_function_failed_event_attributes_to_yojson
         x.schedule_lambda_function_failed_event_attributes));
    ...
    ("startChildWorkflowExecutionFailedEventAttributes",
      (option_to_yojson
         start_child_workflow_execution_failed_event_attributes_to_yojson
         x.start_child_workflow_execution_failed_event_attributes));
    ...
    ("requestCancelActivityTaskFailedEventAttributes",
      (option_to_yojson
         request_cancel_activity_task_failed_event_attributes_to_yojson
         x.request_cancel_activity_task_failed_event_attributes));
    ("scheduleActivityTaskFailedEventAttributes",
      (option_to_yojson
         schedule_activity_task_failed_event_attributes_to_yojson
         x.schedule_activity_task_failed_event_attributes));
    ...
    ("externalWorkflowExecutionCancelRequestedEventAttributes",
      (option_to_yojson
         external_workflow_execution_cancel_requested_event_attributes_to_yojson
         x.external_workflow_execution_cancel_requested_event_attributes));
    ("signalExternalWorkflowExecutionFailedEventAttributes",
      (option_to_yojson
         signal_external_workflow_execution_failed_event_attributes_to_yojson
         x.signal_external_workflow_execution_failed_event_attributes));
    ("externalWorkflowExecutionSignaledEventAttributes",
      (option_to_yojson
         external_workflow_execution_signaled_event_attributes_to_yojson
         x.external_workflow_execution_signaled_event_attributes));
    ("signalExternalWorkflowExecutionInitiatedEventAttributes",
      (option_to_yojson
         signal_external_workflow_execution_initiated_event_attributes_to_yojson
         x.signal_external_workflow_execution_initiated_event_attributes));
    ("childWorkflowExecutionTerminatedEventAttributes",
      (option_to_yojson
         child_workflow_execution_terminated_event_attributes_to_yojson
         x.child_workflow_execution_terminated_event_attributes));
    ("childWorkflowExecutionCanceledEventAttributes",
      (option_to_yojson
         child_workflow_execution_canceled_event_attributes_to_yojson
         x.child_workflow_execution_canceled_event_attributes));
    ("childWorkflowExecutionTimedOutEventAttributes",
      (option_to_yojson
         child_workflow_execution_timed_out_event_attributes_to_yojson
         x.child_workflow_execution_timed_out_event_attributes));
    ("childWorkflowExecutionFailedEventAttributes",
      (option_to_yojson
         child_workflow_execution_failed_event_attributes_to_yojson
         x.child_workflow_execution_failed_event_attributes));
    ("childWorkflowExecutionCompletedEventAttributes",
      (option_to_yojson
         child_workflow_execution_completed_event_attributes_to_yojson
         x.child_workflow_execution_completed_event_attributes));
    ("childWorkflowExecutionStartedEventAttributes",
      (option_to_yojson
         child_workflow_execution_started_event_attributes_to_yojson
         x.child_workflow_execution_started_event_attributes));
    ("startChildWorkflowExecutionInitiatedEventAttributes",
      (option_to_yojson
         start_child_workflow_execution_initiated_event_attributes_to_yojson
         x.start_child_workflow_execution_initiated_event_attributes));
    ("timerCanceledEventAttributes",
      (option_to_yojson timer_canceled_event_attributes_to_yojson
         x.timer_canceled_event_attributes));
    ("timerFiredEventAttributes",
      (option_to_yojson timer_fired_event_attributes_to_yojson
         x.timer_fired_event_attributes));
    ("timerStartedEventAttributes",
      (option_to_yojson timer_started_event_attributes_to_yojson
         x.timer_started_event_attributes));
    ...
    ("workflowExecutionSignaledEventAttributes",
      (option_to_yojson
         workflow_execution_signaled_event_attributes_to_yojson
         x.workflow_execution_signaled_event_attributes));
    ("activityTaskCancelRequestedEventAttributes",
      (option_to_yojson
         activity_task_cancel_requested_event_attributes_to_yojson
         x.activity_task_cancel_requested_event_attributes));
    ...
    ("workflowExecutionCancelRequestedEventAttributes",
      (option_to_yojson
         workflow_execution_cancel_requested_event_attributes_to_yojson
         x.workflow_execution_cancel_requested_event_attributes));
    ("workflowExecutionTerminatedEventAttributes",
      (option_to_yojson
         workflow_execution_terminated_event_attributes_to_yojson
         x.workflow_execution_terminated_event_attributes));
    ("continueAsNewWorkflowExecutionFailedEventAttributes",
      (option_to_yojson
         continue_as_new_workflow_execution_failed_event_attributes_to_yojson
         x.continue_as_new_workflow_execution_failed_event_attributes));
    ("workflowExecutionContinuedAsNewEventAttributes",
      (option_to_yojson
         workflow_execution_continued_as_new_event_attributes_to_yojson
         x.workflow_execution_continued_as_new_event_attributes));
    ("cancelWorkflowExecutionFailedEventAttributes",
      (option_to_yojson
         cancel_workflow_execution_failed_event_attributes_to_yojson
         x.cancel_workflow_execution_failed_event_attributes));
    ("workflowExecutionCanceledEventAttributes",
      (option_to_yojson
         workflow_execution_canceled_event_attributes_to_yojson
         x.workflow_execution_canceled_event_attributes));
    ("workflowExecutionTimedOutEventAttributes",
      (option_to_yojson
         workflow_execution_timed_out_event_attributes_to_yojson
         x.workflow_execution_timed_out_event_attributes));
    ("failWorkflowExecutionFailedEventAttributes",
      (option_to_yojson
         fail_workflow_execution_failed_event_attributes_to_yojson
         x.fail_workflow_execution_failed_event_attributes));
    ...
    ("completeWorkflowExecutionFailedEventAttributes",
      (option_to_yojson
         complete_workflow_execution_failed_event_attributes_to_yojson
         x.complete_workflow_execution_failed_event_attributes));
    ("workflowExecutionCompletedEventAttributes",
      (option_to_yojson
         workflow_execution_completed_event_attributes_to_yojson
         x.workflow_execution_completed_event_attributes));
    ...
    ("eventTimestamp", (Some (timestamp__to_yojson x.event_timestamp)))]
let history_event_list_to_yojson tree =
  list_to_yojson history_event_to_yojson tree
...
let poll_for_decision_task_input_to_yojson (x : poll_for_decision_task_input)
  ...
  assoc_to_yojson
    [("startAtPreviousStartedEvent",
       (option_to_yojson start_at_previous_started_event_to_yojson
          x.start_at_previous_started_event));
    ("reverseOrder",
...
let execution_time_filter_to_yojson (x : execution_time_filter) =
  assoc_to_yojson
    [("latestDate", (option_to_yojson timestamp__to_yojson x.latest_date));
    ("oldestDate", (Some (timestamp__to_yojson x.oldest_date)))]
let list_open_workflow_executions_input_to_yojson
  (x : list_open_workflow_executions_input) =
  assoc_to_yojson
    [("executionFilter",
       (option_to_yojson workflow_execution_filter_to_yojson
          x.execution_filter));
    ("reverseOrder",
      (option_to_yojson reverse_order_to_yojson x.reverse_order));
    ("maximumPageSize",
...
let domain_info_to_yojson (x : domain_info) =
  assoc_to_yojson
    ...
    ("status", (Some (registration_status_to_yojson x.status)));
    ("name", (Some (domain_name_to_yojson x.name)))]
let domain_info_list_to_yojson tree =
  list_to_yojson domain_info_to_yojson tree
...
let list_closed_workflow_executions_input_to_yojson
  (x : list_closed_workflow_executions_input) =
  assoc_to_yojson
    [("reverseOrder",
       (option_to_yojson reverse_order_to_yojson x.reverse_order));
    ("maximumPageSize",
...
let activity_type_info_to_yojson (x : activity_type_info) =
  assoc_to_yojson
    ...
    ("status", (Some (registration_status_to_yojson x.status)));
    ("activityType", (Some (activity_type_to_yojson x.activity_type)))]
let activity_type_info_list_to_yojson tree =
  list_to_yojson activity_type_info_to_yojson tree
...
let get_workflow_execution_history_input_to_yojson
  (x : get_workflow_execution_history_input) =
  assoc_to_yojson
    [("reverseOrder",
       (option_to_yojson reverse_order_to_yojson x.reverse_order));
    ("maximumPageSize",
...
let describe_workflow_execution_input_to_yojson
  (x : describe_workflow_execution_input) =
  assoc_to_yojson
    [("execution", (Some (workflow_execution_to_yojson x.execution)));
    ("domain", (Some (domain_name_to_yojson x.domain)))]
...
let deprecate_workflow_type_input_to_yojson
  (x : deprecate_workflow_type_input) =
  assoc_to_yojson
    [("workflowType", (Some (workflow_type_to_yojson x.workflow_type)));
    ("domain", (Some (domain_name_to_yojson x.domain)))]
...
let deprecate_activity_type_input_to_yojson
  (x : deprecate_activity_type_input) =
  assoc_to_yojson
    [("activityType", (Some (activity_type_to_yojson x.activity_type)));
    ("domain", (Some (domain_name_to_yojson x.domain)))]
...
let count_pending_decision_tasks_input_to_yojson
  (x : count_pending_decision_tasks_input) =
  assoc_to_yojson
    [("taskList", (Some (task_list_to_yojson x.task_list)));
    ("domain", (Some (domain_name_to_yojson x.domain)))]
let count_pending_activity_tasks_input_to_yojson
  (x : count_pending_activity_tasks_input) =
  assoc_to_yojson
    [("taskList", (Some (task_list_to_yojson x.task_list)));
    ("domain", (Some (domain_name_to_yojson x.domain)))]
let count_open_workflow_executions_input_to_yojson
  (x : count_open_workflow_executions_input) =
  assoc_to_yojson
    [("executionFilter",
       (option_to_yojson workflow_execution_filter_to_yojson
          x.execution_filter));
...
let count_closed_workflow_executions_input_to_yojson
  (x : count_closed_workflow_executions_input) =
  assoc_to_yojson
    [("closeStatusFilter",
       (option_to_yojson close_status_filter_to_yojson x.close_status_filter));
    ("tagFilter", (option_to_yojson tag_filter_to_yojson x.tag_filter));
