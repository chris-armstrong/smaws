...
module CountPendingActivityTasks =
  struct
    ...
    let request context (request : count_pending_activity_tasks_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.count_pending_activity_tasks_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CountPendingDecisionTasks =
  struct
    ...
    let request context (request : count_pending_decision_tasks_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.count_pending_decision_tasks_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribeWorkflowExecution =
  struct
    ...
    let request context (request : describe_workflow_execution_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_workflow_execution_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
    ...
    let request context (request : list_domains_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ...
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Json_deserializers.domain_infos_of_yojson
          ~error_deserializer
  end
...
module RespondActivityTaskFailed =
  struct
    ...
    let request context (request : respond_activity_task_failed_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.respond_activity_task_failed_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : signal_workflow_execution_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"SimpleWorkflowServiceSignalWorkflowExecution" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
  ...
  struct
    ...
    let request context (request : start_workflow_execution_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"SimpleWorkflowServiceStartWorkflowExecution" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Json_deserializers.run_of_yojson
          ~error_deserializer
  end
module TagResource =
  struct
...
module TerminateWorkflowExecution =
  struct
    ...
    let request context (request : terminate_workflow_execution_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.terminate_workflow_execution_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : undeprecate_activity_type_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"SimpleWorkflowServiceUndeprecateActivityType" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
module UndeprecateDomain =
  struct
    ...
    let request context (request : undeprecate_domain_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.undeprecate_domain_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : undeprecate_workflow_type_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"SimpleWorkflowServiceUndeprecateWorkflowType" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
