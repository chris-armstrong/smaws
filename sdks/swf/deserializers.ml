...
let workflow_type_info_of_yojson tree path =
  ...
  ({
     deprecation_date =
       option_of_yojson (value_for_key timestamp__of_yojson "deprecationDate") _list path;
...
let workflow_execution_info_of_yojson tree path =
  ...
  ({
     ...
     close_timestamp =
       option_of_yojson (value_for_key timestamp__of_yojson "closeTimestamp") _list path;
