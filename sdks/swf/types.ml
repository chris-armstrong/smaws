...
type nonrec registration_status = DEPRECATED [@ocaml.doc ""] | REGISTERED [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  deprecation_date : timestamp option;
      [@ocaml.doc
        "If the type is in deprecated state, then it is set to the date when the type was \
         deprecated.\n"]
  creation_date : timestamp; [@ocaml.doc "The date when this type was registered.\n"]
  description : description option;
      [@ocaml.doc "The description of the type registered through [RegisterWorkflowType].\n"]
  status : registration_status; [@ocaml.doc "The current status of the workflow type.\n"]
  workflow_type : workflow_type; [@ocaml.doc "The workflow type this information is about.\n"]
}
[@@ocaml.doc "Contains information about a workflow type.\n"]
  ...
  next_page_token : page_token option;
      [@ocaml.doc
        ...
        \ The configured [maximumPageSize] determines how many results can be returned in a single \
         call.\n\
        \ "]
  type_infos : workflow_type_info_list; [@ocaml.doc "The list of workflow type information.\n"]
}
[@@ocaml.doc "Contains a paginated list of information structures about workflow types.\n"]

type nonrec version_optional = string [@@ocaml.doc ""]

type nonrec workflow_type_filter = {
  version : version_optional option; [@ocaml.doc "Version of the workflow type.\n"]
  name : name; [@ocaml.doc " Name of the workflow type.\n"]
}
[@@ocaml.doc
  "Used to filter workflow execution query results by type. Each parameter, if specified, defines \
   a rule that must be satisfied by each returned result.\n"]

type nonrec duration_in_seconds_optional = string [@@ocaml.doc ""]

type nonrec task_list = { name : name [@ocaml.doc "The name of the task list.\n"] }
[@@ocaml.doc "Represents a task list.\n"]
...
type nonrec workflow_type_configuration = {
  ...
  default_child_policy : child_policy option;
      [@ocaml.doc
        " The default policy to use for the child workflow executions when a workflow execution of \
         this type is terminated, by calling the [TerminateWorkflowExecution] action explicitly or \
         due to an expired timeout. This default can be overridden when starting a workflow \
        ...
        \            \n\
        \             }\n\
        \        {-   [REQUEST_CANCEL] \226\128\147 A request to cancel is attempted for each \
         child execution by recording a [WorkflowExecutionCancelRequested] event in its history. \
         It is up to the decider to take appropriate actions when it receives an execution history \
         with this event.\n\
        \            \n\
        \             }\n\
        \        {-   [ABANDON] \226\128\147 No action is taken. The child executions continue to \
         run.\n\
        \            \n\
        \             }\n\
        \        }\n\
  ...
  default_task_priority : task_priority option;
      [@ocaml.doc
        " The default task priority, specified when registering the workflow type, for all \
         decision tasks of this workflow type. This default can be overridden when starting a \
  ...
  default_task_list : task_list option;
      [@ocaml.doc
        " The default task list, specified when registering the workflow type, for decisions tasks \
         scheduled for workflow executions of this type. This default can be overridden when \
         starting a workflow execution using the [StartWorkflowExecution] action or the \
         [StartChildWorkflowExecution] [Decision].\n"]
  default_execution_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        " The default maximum duration, specified when registering the workflow type, for \
         executions of this workflow type. This default can be overridden when starting a workflow \
         execution using the [StartWorkflowExecution] action or the [StartChildWorkflowExecution] \
         [Decision].\n\n\
  ...
  default_task_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        " The default maximum duration, specified when registering the workflow type, that a \
         decision task for executions of this workflow type might take before returning completion \
         or failure. If the task doesn'tdo close in the specified time then the task is \
         automatically timed out and rescheduled. If the decider eventually reports a completion \
...
type nonrec workflow_type_detail = {
  ...
  type_info : workflow_type_info;
      [@ocaml.doc
        ...
        \ The status of the workflow type (returned in the WorkflowTypeInfo structure) can be one \
         of the following.\n\
        \ \n\
        \  {ul\n\
        \        {-   [REGISTERED] \226\128\147 The type is registered and available. Workers \
         supporting this type should be running.\n\
        \            \n\
        \             }\n\
        \        {-   [DEPRECATED] \226\128\147 The type was deprecated using \
         [DeprecateWorkflowType], but is still in use. You should keep workers supporting this \
         type running. You cannot create new workflow executions of this type.\n\
        \            \n\
        \             }\n\
        \        }\n\
        \  "]
...
type nonrec workflow_execution_timeout_type = START_TO_CLOSE [@ocaml.doc ""] [@@ocaml.doc ""]
...
[@@ocaml.doc "Provides the details of the [WorkflowExecutionTimedOut] event.\n"]
  ...
  cause : workflow_execution_terminated_cause option;
      [@ocaml.doc
        "If set, indicates that the workflow execution was automatically terminated, and specifies \
         the cause. This happens if the parent workflow execution times out or is terminated and \
         the child policy is set to terminate child executions.\n"]
  child_policy : child_policy;
      [@ocaml.doc
        "The policy used for the child workflow executions of this workflow execution.\n\n\
        \ The supported child policies are:\n\
        ...
        \        }\n\
        \  "]
  details : data option; [@ocaml.doc "The details provided for the termination.\n"]
  reason : terminate_reason option; [@ocaml.doc "The reason provided for the termination.\n"]
}
[@@ocaml.doc "Provides the details of the [WorkflowExecutionTerminated] event.\n"]
...
type nonrec workflow_execution = {
  run_id : workflow_run_id;
      [@ocaml.doc "A system-generated unique identifier for the workflow execution.\n"]
  workflow_id : workflow_id;
      [@ocaml.doc "The user defined identifier associated with the workflow execution.\n"]
}
  ...
  continued_execution_run_id : workflow_run_id_optional option;
      [@ocaml.doc
        "If this workflow execution was started due to a [ContinueAsNewWorkflowExecution] \
         decision, then it contains the [runId] of the previous workflow execution that was closed \
  ...
  tag_list : tag_list option;
      [@ocaml.doc
        "The list of tags associated with this workflow execution. An execution can have up to 5 \
         tags.\n"]
  workflow_type : workflow_type; [@ocaml.doc "The workflow type of this execution.\n"]
  task_priority : task_priority option;
      [@ocaml.doc "The priority of the decision tasks in the workflow execution.\n"]
  task_list : task_list;
      [@ocaml.doc
  ...
  execution_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \ The duration is specified in seconds, an integer greater than or equal to [0]. You can \
         use [NONE] to specify unlimited duration.\n\
        \ "]
  input : data option; [@ocaml.doc "The input provided to the workflow execution.\n"]
}
[@@ocaml.doc "Provides details of [WorkflowExecutionStarted] event.\n"]
  ...
  external_initiated_event_id : event_id option;
      [@ocaml.doc
        "The ID of the [SignalExternalWorkflowExecutionInitiated] event corresponding to the \
         ...
         this ID can be found in the history of the source workflow execution. This information \
         can be useful for diagnosing problems by tracing back the chain of events leading up to \
         this event. This field is set only if the signal was initiated by another workflow \
         execution.\n"]
...
[@@ocaml.doc "Provides the details of the [WorkflowExecutionSignaled] event.\n"]
...
type nonrec workflow_execution_open_counts = {
  ...
  open_child_workflow_executions : count;
      [@ocaml.doc "The count of child workflow executions whose status is [OPEN].\n"]
  open_timers : count;
      [@ocaml.doc
        "The count of timers started by this workflow execution that have not fired yet.\n"]
  open_decision_tasks : open_decision_tasks_count;
      [@ocaml.doc
        "The count of decision tasks whose status is OPEN. A workflow execution can have at most \
         one open decision task.\n"]
  open_activity_tasks : count; [@ocaml.doc "The count of activity tasks whose status is [OPEN].\n"]
}
[@@ocaml.doc
  "Contains the counts of open tasks, child workflow executions and timers for a workflow execution.\n"]

type nonrec execution_status = CLOSED [@ocaml.doc ""] | OPEN [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec workflow_execution_info = {
  cancel_requested : canceled option;
      [@ocaml.doc "Set to true if a cancellation is requested for this workflow execution.\n"]
  tag_list : tag_list option;
      [@ocaml.doc
        "The list of tags associated with the workflow execution. Tags can be used to identify and \
         list workflow executions of interest through the visibility APIs. A workflow execution \
  ...
  close_status : close_status option;
      [@ocaml.doc
        ...
        \           \n\
        \            }\n\
        \       {-   [CANCELED] \226\128\147 the execution was canceled.Cancellation allows the \
        ...
        \           \n\
        \            }\n\
        \       {-   [TIMED_OUT] \226\128\147 the execution did not complete in the alloted time \
         and was automatically timed out.\n\
        \           \n\
        \            }\n\
        \       {-   [CONTINUED_AS_NEW] \226\128\147 the execution is logically continued. This \
         means the current execution was completed and a new execution was started to carry on the \
         workflow.\n\
        \           \n\
        \            }\n\
        \       }\n\
        \  "]
  execution_status : execution_status; [@ocaml.doc "The current status of the execution.\n"]
  close_timestamp : timestamp option;
      [@ocaml.doc
        "The time when the workflow execution was closed. Set only if the execution status is \
         CLOSED.\n"]
  start_timestamp : timestamp; [@ocaml.doc "The time when the execution was started.\n"]
  workflow_type : workflow_type; [@ocaml.doc "The type of the workflow execution.\n"]
  execution : workflow_execution; [@ocaml.doc "The workflow execution this information is about.\n"]
}
[@@ocaml.doc "Contains information about a workflow execution.\n"]

type nonrec workflow_execution_info_list = workflow_execution_info list [@@ocaml.doc ""]
...
[@@ocaml.doc "Contains a paginated list of information about workflow executions.\n"]

type nonrec workflow_execution_filter = {
  workflow_id : workflow_id;
      [@ocaml.doc "The workflowId to pass of match the criteria of this filter.\n"]
}
[@@ocaml.doc "Used to filter the workflow executions in visibility APIs by their [workflowId].\n"]
...
type nonrec workflow_execution_failed_event_attributes = {
  ...
  reason : failure_reason option; [@ocaml.doc "The descriptive reason provided for the failure.\n"]
}
[@@ocaml.doc "Provides the details of the [WorkflowExecutionFailed] event.\n"]

type nonrec duration_in_seconds = string [@@ocaml.doc ""]

type nonrec workflow_execution_configuration = {
  lambda_role : arn option; [@ocaml.doc "The IAM role attached to the child workflow execution.\n"]
  child_policy : child_policy;
      [@ocaml.doc
        "The policy to use for the child workflow executions if this workflow execution is \
         terminated, by calling the [TerminateWorkflowExecution] action explicitly or due to an \
...
[@@ocaml.doc
  "The configuration settings for a workflow execution including timeout values, tasklist etc. \
   These configuration settings are determined from the defaults specified when registering the \
   workflow type and those specified when starting the workflow execution.\n"]
  ...
  latest_execution_context : data option;
      [@ocaml.doc
        "The latest executionContext provided by the decider for this workflow execution. A \
         decider can provide an executionContext (a free-form string) when closing a decision task \
         using [RespondDecisionTaskCompleted].\n"]
  latest_activity_task_timestamp : timestamp option;
      [@ocaml.doc
        "The time when the last activity task was scheduled for this workflow execution. You can \
         use this information to determine if the workflow has not made progress for an unusually \
         long period of time and might require a corrective action.\n"]
  open_counts : workflow_execution_open_counts;
      [@ocaml.doc
        "The number of tasks for this workflow execution. This includes open and closed tasks of \
         all types.\n"]
...
[@@ocaml.doc "Contains details about a workflow execution.\n"]
...
type nonrec workflow_execution_count = {
  truncated : truncated option;
      [@ocaml.doc
        "If set to true, indicates that the actual count was more than the maximum supported by \
         this API and the count returned is the truncated value.\n"]
...
type nonrec workflow_execution_continued_as_new_event_attributes = {
  lambda_role : arn option;
      [@ocaml.doc "The IAM role to attach to the new (continued) workflow execution.\n"]
  workflow_type : workflow_type; [@ocaml.doc "The workflow type of this execution.\n"]
  tag_list : tag_list option;
      [@ocaml.doc "The list of tags associated with the new workflow execution.\n"]
  child_policy : child_policy;
      [@ocaml.doc
  ...
  input : data option; [@ocaml.doc "The input provided to the new workflow execution.\n"]
}
[@@ocaml.doc "Provides the details of the [WorkflowExecutionContinuedAsNew] event.\n"]
...
[@@ocaml.doc "Provides the details of the [WorkflowExecutionCanceled] event.\n"]

type nonrec workflow_execution_cancel_requested_cause = CHILD_POLICY_APPLIED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec workflow_execution_cancel_requested_event_attributes = {
  ...
  external_workflow_execution : workflow_execution option;
      [@ocaml.doc "The external workflow execution for which the cancellation was requested.\n"]
}
[@@ocaml.doc "Provides the details of the [WorkflowExecutionCancelRequested] event.\n"]

type nonrec error_message = string [@@ocaml.doc ""]

type nonrec workflow_execution_already_started_fault = {
  message : error_message option;
      [@ocaml.doc "A description that may help with diagnosing the cause of the fault.\n"]
}
[@@ocaml.doc
...
type nonrec untag_resource_input = {
  ...
  resource_arn : arn; [@ocaml.doc "The Amazon Resource Name (ARN) for the Amazon SWF domain.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "Returned when the named resource cannot be found with in the scope of this operation (region or \
   domain). This could happen if the named resource was never created or is no longer available \
   for this operation.\n"]
...
[@@ocaml.doc "Returned when the caller doesn't have sufficient permissions to invoke the action.\n"]
...
[@@ocaml.doc
  "Returned by any operation if a system imposed limitation has been reached. To address this \
   fault you should either clean up unused resources or increase the limit by contacting AWS.\n"]
...
type nonrec undeprecate_workflow_type_input = {
  ...
  domain : domain_name; [@ocaml.doc "The name of the domain of the deprecated workflow type.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "Returned if the type already exists in the specified domain. You may get this fault if you are \
   registering a type that is either already registered or deprecated, or if you undeprecate a \
   type that is currently registered.\n"]

type nonrec undeprecate_domain_input = {
  name : domain_name; [@ocaml.doc "The name of the domain of the deprecated workflow type.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "Returned if the domain already exists. You may get this fault if you are registering a domain \
   that is either already registered or deprecated, or if you undeprecate a domain that is \
...
type nonrec undeprecate_activity_type_input = {
  activity_type : activity_type; [@ocaml.doc "The activity type to undeprecate.\n"]
  domain : domain_name; [@ocaml.doc "The name of the domain of the deprecated activity type.\n"]
}
[@@ocaml.doc ""]

type nonrec type_not_deprecated_fault = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "Returned when the resource type has not been deprecated.\n"]

type nonrec type_deprecated_fault = {
  message : error_message option;
      [@ocaml.doc "A description that may help with diagnosing the cause of the fault.\n"]
}
[@@ocaml.doc "Returned when the specified activity or workflow type was already deprecated.\n"]

type nonrec too_many_tags_fault = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "You've exceeded the number of tags allowed for a domain.\n"]
...
type nonrec timer_started_event_attributes = {
  ...
  timer_id : timer_id; [@ocaml.doc "The unique ID of the timer that was started.\n"]
}
[@@ocaml.doc "Provides the details of the [TimerStarted] event.\n"]
  ...
  started_event_id : event_id;
      [@ocaml.doc
        "The ID of the [TimerStarted] event that was recorded when this timer was started. This \
         information can be useful for diagnosing problems by tracing back the chain of events \
         leading up to this event.\n"]
  timer_id : timer_id; [@ocaml.doc "The unique ID of the timer that was canceled.\n"]
}
[@@ocaml.doc " Provides the details of the [TimerCanceled] event. \n"]
  ...
  child_policy : child_policy option;
      [@ocaml.doc
        ...
        \    A child policy for this workflow execution must be specified either as a default for \
         the workflow type or through this parameter. If neither this parameter is set nor a \
         default child policy was specified at registration time then a fault is returned.\n\
        \    \n\
        \     "]
  details : data option; [@ocaml.doc " Details for terminating the workflow execution.\n"]
  reason : terminate_reason option;
      [@ocaml.doc " A descriptive reason for terminating the workflow execution.\n"]
  run_id : workflow_run_id_optional option;
      [@ocaml.doc "The runId of the workflow execution to terminate.\n"]
  workflow_id : workflow_id; [@ocaml.doc "The workflowId of the workflow execution to terminate.\n"]
  domain : domain_name; [@ocaml.doc "The domain of the workflow execution to terminate.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "Used to filter the workflow executions in visibility APIs based on a tag.\n"]
  ...
  task_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \   A task start-to-close timeout for this workflow execution must be specified either as \
         a default for the workflow type or through this parameter. If neither this parameter is \
         set nor a default task start-to-close timeout was specified at registration time then a \
         fault is returned.\n\
        \   \n\
        \    "]
  tag_list : tag_list option;
      [@ocaml.doc
        "The list of tags to associate with the workflow execution. You can specify a maximum of 5 \
         tags. You can list workflow executions with a specific tag by calling \
  ...
  execution_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \ The duration is specified in seconds; an integer greater than or equal to [0]. Exceeding \
         this limit causes the workflow execution to time out. Unlike some of the other timeout \
         parameters in Amazon SWF, you cannot specify a value of \"NONE\" for this timeout; there \
         is a one-year max limit on the time that a workflow execution can run.\n\
        \ \n\
        \   An execution start-to-close timeout must be specified either through this parameter or \
         as a default when the workflow type is registered. If neither this parameter nor a \
  ...
  task_priority : task_priority option;
      [@ocaml.doc
        "The task priority to use for this workflow execution. This overrides any default priority \
         ...
         task priority for the workflow type is used. Valid values are integers that range from \
  ...
  task_list : task_list option;
      [@ocaml.doc
        ...
        \    The specified string must not contain a [:] (colon), [/] (slash), [|] (vertical bar), \
         or any control characters ([\\u0000-\\u001f] | [\\u007f-\\u009f]). Also, it must {i not} \
         be the literal string [arn].\n\
        \    "]
  workflow_type : workflow_type; [@ocaml.doc "The type of the workflow to start.\n"]
  workflow_id : workflow_id;
      [@ocaml.doc
        "The user defined identifier associated with the workflow execution. You can use this to \
         ...
         identifier if a workflow execution is logically a {i restart} of a previous execution. \
        ...
        \ The specified string must not contain a [:] (colon), [/] (slash), [|] (vertical bar), or \
         any control characters ([\\u0000-\\u001f] | [\\u007f-\\u009f]). Also, it must {i not} be \
...
type nonrec default_undefined_fault = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  ...
  \ \n\
  \   If these parameters aren't set and no default parameters were defined in the workflow type, \
  ...
  cause : start_timer_failed_cause;
      [@ocaml.doc
        ...
        \  If [cause] is set to [OPERATION_NOT_PERMITTED], the decision failed because it lacked \
         ...
         {{:https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html}Using IAM \
         to Manage Access to Amazon SWF Workflows} in the {i Amazon SWF Developer Guide}.\n\
        \  \n\
        \   "]
  timer_id : timer_id;
      [@ocaml.doc "The timerId provided in the [StartTimer] decision that failed.\n"]
}
...
type nonrec start_lambda_function_failed_cause = ASSUME_ROLE_FAILED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec start_lambda_function_failed_event_attributes = {
  message : cause_message option;
      [@ocaml.doc "A description that can help diagnose the cause of the fault.\n"]
  ...
  scheduled_event_id : event_id option;
      [@ocaml.doc
        "The ID of the [ActivityTaskScheduled] event that was recorded when this activity task was \
         scheduled. To help diagnose issues, use this information to trace back the chain of \
         events leading up to this event.\n"]
}
[@@ocaml.doc
...
type nonrec start_child_workflow_execution_initiated_event_attributes = {
  lambda_role : arn option; [@ocaml.doc "The IAM role to attach to the child workflow execution.\n"]
  tag_list : tag_list option;
      [@ocaml.doc "The list of tags to associated with the child workflow execution.\n"]
  task_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
  ...
  execution_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \ The duration is specified in seconds, an integer greater than or equal to [0]. You can \
         use [NONE] to specify unlimited duration.\n\
        \ "]
  input : data option; [@ocaml.doc "The inputs provided to the child workflow execution.\n"]
  control : data option;
      [@ocaml.doc
  ...
  workflow_id : workflow_id; [@ocaml.doc "The [workflowId] of the child workflow execution.\n"]
}
[@@ocaml.doc "Provides the details of the [StartChildWorkflowExecutionInitiated] event.\n"]
  ...
  cause : start_child_workflow_execution_failed_cause;
      [@ocaml.doc
        ...
        \  When [cause] is set to [OPERATION_NOT_PERMITTED], the decision fails because it lacks \
         ...
         IAM to Manage Access to Amazon SWF Workflows} in the {i Amazon SWF Developer Guide}.\n\
        \  \n\
        \   "]
  workflow_type : workflow_type;
      [@ocaml.doc
...
[@@ocaml.doc "Provides the details of the [StartChildWorkflowExecutionFailed] event.\n"]

type nonrec start_child_workflow_execution_decision_attributes = {
  lambda_role : arn option; [@ocaml.doc "The IAM role attached to the child workflow execution.\n"]
  tag_list : tag_list option;
      [@ocaml.doc
        "The list of tags to associate with the child workflow execution. A maximum of 5 tags can \
         be specified. You can list workflow executions with a specific tag by calling \
         [ListOpenWorkflowExecutions] or [ListClosedWorkflowExecutions] and specifying a \
         [TagFilter].\n"]
  child_policy : child_policy option;
      [@ocaml.doc
  ...
  execution_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \   An execution start-to-close timeout for this workflow execution must be specified \
         ...
         parameter is set nor a default execution start-to-close timeout was specified at \
         registration time then a fault is returned.\n\
        \   \n\
        \    "]
  input : data option; [@ocaml.doc "The input to be provided to the workflow execution.\n"]
  control : data option;
      [@ocaml.doc
        "The data attached to the event that can be used by the decider in subsequent workflow \
  ...
  workflow_id : workflow_id;
      [@ocaml.doc
        ...
        \ The specified string must not contain a [:] (colon), [/] (slash), [|] (vertical bar), or \
         ...
         the literal string [arn].\n\
        \ "]
  workflow_type : workflow_type; [@ocaml.doc " The type of the workflow execution to be started.\n"]
}
[@@ocaml.doc
  ...
  \             \n\
  \              {ul\n\
  \                    {-   [tagList.member.N] \226\128\147 The key is \"swf:tagList.N\" where N \
   is the tag number from 0 to 4, inclusive.\n\
  \                        \n\
  \                         }\n\
  \                    {-   [taskList] \226\128\147 String constraint. The key is \
   [swf:taskList.name].\n\
  \                        \n\
  \                         }\n\
  \                    {-   [workflowType.name] \226\128\147 String constraint. The key is \
   [swf:workflowType.name].\n\
  \                        \n\
  \                         }\n\
  \                    {-   [workflowType.version] \226\128\147 String constraint. The key is \
  ...
  input : data option;
      [@ocaml.doc
        "Data to attach to the [WorkflowExecutionSignaled] event in the target workflow \
         execution's history.\n"]
  signal_name : signal_name;
      [@ocaml.doc "The name of the signal. This name must be meaningful to the target workflow.\n"]
  run_id : workflow_run_id_optional option;
      [@ocaml.doc "The runId of the workflow execution to signal.\n"]
  workflow_id : workflow_id; [@ocaml.doc "The workflowId of the workflow execution to signal.\n"]
  domain : domain_name;
      [@ocaml.doc "The name of the domain containing the workflow execution to signal.\n"]
}
[@@ocaml.doc ""]
...
type nonrec schedule_activity_task_decision_attributes = {
  heartbeat_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        "If set, specifies the maximum time before which a worker processing a task of this type \
         must report progress by calling [RecordActivityTaskHeartbeat]. If the timeout is \
         exceeded, the activity task is automatically timed out. If the worker subsequently \
         attempts to record a heartbeat or returns a result, it is ignored. This overrides the \
  ...
  start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        "If set, specifies the maximum duration a worker may take to process this activity task. \
         This overrides the default start-to-close timeout specified when registering the activity \
  ...
  schedule_to_start_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        " If set, specifies the maximum duration the activity task can wait to be assigned to a \
         worker. This overrides the default schedule-to-start timeout specified when registering \
        ...
        \   A schedule-to-start timeout for this activity task must be specified either as a \
         default for the activity type or through this field. If neither this field is set nor a \
         default schedule-to-start timeout was specified at registration time then a fault is \
         returned.\n\
        \   \n\
        \    "]
  task_priority : task_priority option;
      [@ocaml.doc
        " If set, specifies the priority with which the activity task is to be assigned to a \
         worker. This overrides the defaultTaskPriority specified when registering the activity \
         type using [RegisterActivityType]. Valid values are integers that range from Java's \
  ...
  task_list : task_list option;
      [@ocaml.doc
        "If set, specifies the name of the task list in which to schedule the activity task. If \
         not specified, the [defaultTaskList] registered with the activity type is used.\n\n\
        \  A task list for this activity task must be specified either as a default for the \
         activity type or through this field. If neither this field is set nor a default task list \
  ...
  schedule_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \   A schedule-to-close timeout for this activity task must be specified either as a \
         default for the activity type or through this field. If neither this field is set nor a \
         default schedule-to-close timeout was specified at registration time then a fault is \
         returned.\n\
        \   \n\
        \    "]
  input : data option; [@ocaml.doc "The input provided to the activity task.\n"]
  control : data option;
      [@ocaml.doc
        "Data attached to the event that can be used by the decider in subsequent workflow tasks. \
         This data isn't sent to the activity.\n"]
  activity_id : activity_id;
      [@ocaml.doc
        ...
        \ The specified string must not contain a [:] (colon), [/] (slash), [|] (vertical bar), or \
         ...
         the literal string [arn].\n\
        \ "]
  activity_type : activity_type; [@ocaml.doc " The type of the activity task to schedule.\n"]
}
[@@ocaml.doc
  ...
  \             \n\
  \              {ul\n\
  \                    {-   [activityType.name] \226\128\147 String constraint. The key is \
   [swf:activityType.name].\n\
  \                        \n\
  \                         }\n\
  \                    {-   [activityType.version] \226\128\147 String constraint. The key is \
...
type nonrec request_cancel_activity_task_decision_attributes = {
  activity_id : activity_id; [@ocaml.doc "The [activityId] of the activity task to be canceled.\n"]
}
[@@ocaml.doc
...
type nonrec fail_workflow_execution_decision_attributes = {
  ...
  reason : failure_reason option;
      [@ocaml.doc "A descriptive reason for the failure that may help in diagnostics.\n"]
}
[@@ocaml.doc
...
type nonrec continue_as_new_workflow_execution_decision_attributes = {
  ...
  workflow_type_version : version option; [@ocaml.doc "The version of the workflow to start.\n"]
  tag_list : tag_list option;
      [@ocaml.doc
  ...
  task_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \   A task start-to-close timeout for the new workflow execution must be specified either \
         ...
         is set nor a default task start-to-close timeout was specified at registration time then \
         a fault is returned.\n\
        \   \n\
        \    "]
  task_priority : task_priority option;
  ...
  execution_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \ \n\
        \   An execution start-to-close timeout for this workflow execution must be specified \
         either as a default for the workflow type or through this field. If neither this field is \
         set nor a default execution start-to-close timeout was specified at registration time \
...
type nonrec signal_external_workflow_execution_decision_attributes = {
  ...
  input : data option;
      [@ocaml.doc
        " The input data to be provided with the signal. The target workflow execution uses the \
         signal name and input data to process the signal.\n"]
  signal_name : signal_name;
      [@ocaml.doc
  ...
  workflow_id : workflow_id;
      [@ocaml.doc " The [workflowId] of the workflow execution to be signaled.\n"]
}
[@@ocaml.doc
  ...
  control : data option;
      [@ocaml.doc
        "The data attached to the event that can be used by the decider in subsequent workflow \
         tasks.\n"]
  run_id : workflow_run_id_optional option;
      [@ocaml.doc "The [runId] of the external workflow execution to cancel.\n"]
  workflow_id : workflow_id;
      [@ocaml.doc " The [workflowId] of the external workflow execution to cancel.\n"]
}
[@@ocaml.doc
  ...
  start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        "The timeout value, in seconds, after which the Lambda function is considered to be failed \
         once it has started. This can be any integer from 1-900 (1s-15m).\n\n\
        \ If no value is supplied, then a default value of 900s is assumed.\n\
        \ "]
  input : function_input option;
      [@ocaml.doc "The optional input data to be supplied to the Lambda function.\n"]
  control : data option;
      [@ocaml.doc
        "The data attached to the event that the decider can use in subsequent workflow tasks. \
         This data isn't sent to the Lambda task.\n"]
  name : function_name; [@ocaml.doc "The name, or ARN, of the Lambda function to schedule.\n"]
  id : function_id;
      [@ocaml.doc "A string that identifies the Lambda function execution in the event history.\n"]
}
[@@ocaml.doc
...
type nonrec decision = {
  ...
  start_child_workflow_execution_decision_attributes :
    start_child_workflow_execution_decision_attributes option;
      [@ocaml.doc
        "Provides the details of the [StartChildWorkflowExecution] decision. It isn't set for \
         other decision types.\n"]
  request_cancel_external_workflow_execution_decision_attributes :
    request_cancel_external_workflow_execution_decision_attributes option;
      [@ocaml.doc
        "Provides the details of the [RequestCancelExternalWorkflowExecution] decision. It isn't \
  ...
  schedule_activity_task_decision_attributes : schedule_activity_task_decision_attributes option;
      [@ocaml.doc
        "Provides the details of the [ScheduleActivityTask] decision. It isn't set for other \
         decision types.\n"]
  decision_type : decision_type; [@ocaml.doc "Specifies the type of the decision.\n"]
}
[@@ocaml.doc
  "Specifies a decision made by the decider. A decision can be one of these types:\n\n\
  \ {ul\n\
  \       {-   [CancelTimer] \226\128\147 Cancels a previously started timer and records a \
   [TimerCanceled] event in the history.\n\
  \           \n\
  \            }\n\
  \       {-   [CancelWorkflowExecution] \226\128\147 Closes the workflow execution and records a \
   [WorkflowExecutionCanceled] event in the history.\n\
  \           \n\
  \            }\n\
  \       {-   [CompleteWorkflowExecution] \226\128\147 Closes the workflow execution and records \
   a [WorkflowExecutionCompleted] event in the history .\n\
  \           \n\
  \            }\n\
  \       {-   [ContinueAsNewWorkflowExecution] \226\128\147 Closes the workflow execution and \
   starts a new workflow execution of the same type using the same workflow ID and a unique run \
   Id. A [WorkflowExecutionContinuedAsNew] event is recorded in the history.\n\
  \           \n\
  \            }\n\
  \       {-   [FailWorkflowExecution] \226\128\147 Closes the workflow execution and records a \
   [WorkflowExecutionFailed] event in the history.\n\
  \           \n\
  \            }\n\
  \       {-   [RecordMarker] \226\128\147 Records a [MarkerRecorded] event in the history. \
   Markers can be used for adding custom information in the history for instance to let deciders \
   know that they don't need to look at the history beyond the marker event.\n\
  \           \n\
  \            }\n\
  \       {-   [RequestCancelActivityTask] \226\128\147 Attempts to cancel a previously scheduled \
   activity task. If the activity task was scheduled but has not been assigned to a worker, then \
   it is canceled. If the activity task was already assigned to a worker, then the worker is \
   informed that cancellation has been requested in the response to [RecordActivityTaskHeartbeat].\n\
  \           \n\
  \            }\n\
  \       {-   [RequestCancelExternalWorkflowExecution] \226\128\147 Requests that a request be \
  ...
  \           \n\
  \            }\n\
  \       {-   [SignalExternalWorkflowExecution] \226\128\147 Requests a signal to be delivered to \
   the specified external workflow execution and records a \
   [SignalExternalWorkflowExecutionInitiated] event in the history.\n\
  \           \n\
  \            }\n\
  \       {-   [StartChildWorkflowExecution] \226\128\147 Requests that a child workflow execution \
   be started and records a [StartChildWorkflowExecutionInitiated] event in the history. The child \
   workflow execution is a separate workflow execution with its own history.\n\
  \           \n\
  \            }\n\
  \       {-   [StartTimer] \226\128\147 Starts a timer for this workflow execution and records a \
   [TimerStarted] event in the history. This timer fires after the specified delay and record a \
   [TimerFired] event.\n\
  \           \n\
  \            }\n\
  \       }\n\
  ...
  \    If you grant permission to use [RespondDecisionTaskCompleted], you can use IAM policies to \
   express permissions for the list of decisions returned by this action as if they were members \
   of the API. Treating decisions as a pseudo API maintains a uniform conceptual model and helps \
  ...
  \             {-  The ordering of decisions should follow a logical flow. Some decisions might \
   not make sense in the current context of the workflow execution and therefore fails.\n\
  \                 \n\
  \                  }\n\
  ...
  \   \n\
  \    {ul\n\
  \          {-   [ScheduleActivityTaskFailed] \226\128\147 A [ScheduleActivityTask] decision \
   failed. This could happen if the activity type specified in the decision isn't registered, is \
   in a deprecated state, or the decision isn't properly configured.\n\
  \              \n\
  \               }\n\
  \          {-   [RequestCancelActivityTaskFailed] \226\128\147 A [RequestCancelActivityTask] \
   decision failed. This could happen if there is no open activity task with the specified \
   activityId.\n\
  \              \n\
  \               }\n\
  \          {-   [StartTimerFailed] \226\128\147 A [StartTimer] decision failed. This could \
   happen if there is another open timer with the same timerId.\n\
  \              \n\
  \               }\n\
  \          {-   [CancelTimerFailed] \226\128\147 A [CancelTimer] decision failed. This could \
   happen if there is no open timer with the specified timerId.\n\
  \              \n\
  \               }\n\
  \          {-   [StartChildWorkflowExecutionFailed] \226\128\147 A [StartChildWorkflowExecution] \
   decision failed. This could happen if the workflow type specified isn't registered, is \
   deprecated, or the decision isn't properly configured.\n\
  \              \n\
  \               }\n\
  \          {-   [SignalExternalWorkflowExecutionFailed] \226\128\147 A \
   [SignalExternalWorkflowExecution] decision failed. This could happen if the [workflowID] \
   specified in the decision was incorrect.\n\
  \              \n\
  \               }\n\
  \          {-   [RequestCancelExternalWorkflowExecutionFailed] \226\128\147 A \
   [RequestCancelExternalWorkflowExecution] decision failed. This could happen if the [workflowID] \
   specified in the decision was incorrect.\n\
  \              \n\
  \               }\n\
  \          {-   [CancelWorkflowExecutionFailed] \226\128\147 A [CancelWorkflowExecution] \
   decision failed. This could happen if there is an unhandled decision task pending in the \
   workflow execution.\n\
  \              \n\
  \               }\n\
  \          {-   [CompleteWorkflowExecutionFailed] \226\128\147 A [CompleteWorkflowExecution] \
   decision failed. This could happen if there is an unhandled decision task pending in the \
   workflow execution.\n\
  \              \n\
  \               }\n\
  \          {-   [ContinueAsNewWorkflowExecutionFailed] \226\128\147 A \
   [ContinueAsNewWorkflowExecution] decision failed. This could happen if there is an unhandled \
   decision task pending in the workflow execution or the ContinueAsNewWorkflowExecution decision \
   was not configured correctly.\n\
  \              \n\
  \               }\n\
  \          {-   [FailWorkflowExecutionFailed] \226\128\147 A [FailWorkflowExecution] decision \
   failed. This could happen if there is an unhandled decision task pending in the workflow \
   execution.\n\
  \              \n\
  \               }\n\
  \          }\n\
  \   The preceding error events might occur due to an error in the decider logic, which might put \
   the workflow execution in an unstable state The cause field in the event structure for the \
  ...
  \     A workflow execution may be closed by the decider by returning one of the following \
   ...
   [FailWorkflowExecution], [CancelWorkflowExecution] and [ContinueAsNewWorkflowExecution]. An \
   [UnhandledDecision] fault is returned if a workflow closing decision is specified and a signal \
   or activity event had been added to the history while the decision task was being performed by \
   the decider. Unlike the above situations which are logic issues, this fault is always possible \
   because of race conditions in a distributed system. The right action here is to call \
   [RespondDecisionTaskCompleted] without any decisions. This would result in another decision \
   task with these new events included in the history. The decider should handle the new events \
...
type nonrec respond_decision_task_completed_input = {
  task_list_schedule_to_start_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        "Specifies a timeout (in seconds) for the task list override. When this parameter is \
         ...
         list is not started within the timeout, the decision task will time out. Amazon SWF will \
         revert the override and schedule a new decision task to the original task list.\n\n\
  ...
  task_list : task_list option;
      [@ocaml.doc
        "The task list to use for the future decision tasks of this workflow execution. This list \
         overrides the original task list you specified while starting the workflow execution. \n"]
  ...
  task_token : task_token;
      [@ocaml.doc
        ...
        \   [taskToken] is generated by the service and should be treated as an opaque value. If \
         the task is passed to another process, its [taskToken] must also be passed. This enables \
...
type nonrec respond_activity_task_failed_input = {
  details : data option; [@ocaml.doc " Detailed information about the failure.\n"]
  reason : failure_reason option;
...
type nonrec request_cancel_workflow_execution_input = {
  ...
  workflow_id : workflow_id; [@ocaml.doc "The workflowId of the workflow execution to cancel.\n"]
  domain : domain_name;
      [@ocaml.doc "The name of the domain containing the workflow execution to cancel.\n"]
}
[@@ocaml.doc ""]
...
type nonrec register_workflow_type_input = {
  ...
  default_task_priority : task_priority option;
      [@ocaml.doc
        "The default task priority to assign to the workflow type. If not assigned, then [0] is \
         used. Valid values are integers that range from Java's [Integer.MIN_VALUE] (-2147483648) \
  ...
  default_task_list : task_list option;
      [@ocaml.doc
        "If set, specifies the default task list to use for scheduling decision tasks for \
         executions of this workflow type. This default is used only if a task list isn't provided \
         when starting the execution through the [StartWorkflowExecution] Action or \
         [StartChildWorkflowExecution] [Decision].\n"]
  default_execution_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        "If set, specifies the default maximum duration for executions of this workflow type. You \
         can override this default when starting an execution through the [StartWorkflowExecution] \
        ...
        \ The duration is specified in seconds; an integer greater than or equal to 0. Unlike some \
         ...
         workflow execution can run. Exceeding this limit always causes the workflow execution to \
         time out.\n\
        \ "]
  default_task_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \ The duration is specified in seconds, an integer greater than or equal to [0]. You can \
         use [NONE] to specify unlimited duration.\n\
        \ "]
  description : description option; [@ocaml.doc "Textual description of the workflow type.\n"]
  version : version;
      [@ocaml.doc
        "The version of the workflow type.\n\n\
        \  The workflow type consists of the name and version, the combination of which must be \
         unique within the domain. To get a list of all currently registered workflow types, use \
         the [ListWorkflowTypes] action.\n\
        \  \n\
        \    The specified string must not contain a [:] (colon), [/] (slash), [|] (vertical bar), \
         or any control characters ([\\u0000-\\u001f] | [\\u007f-\\u009f]). Also, it must {i not} \
         be the literal string [arn].\n\
  ...
  name : name;
      [@ocaml.doc
        ...
        \ "]
  domain : domain_name;
      [@ocaml.doc "The name of the domain in which to register the workflow type.\n"]
}
[@@ocaml.doc ""]
...
type nonrec register_domain_input = {
  ...
  workflow_execution_retention_period_in_days : duration_in_days;
      [@ocaml.doc
        ...
        \ If you pass the value [NONE] or [0] (zero), then the workflow execution history isn't \
         retained. As soon as the workflow execution completes, the execution record and its \
         history are deleted.\n\
        \ \n\
        \  The maximum workflow execution retention period is 90 days. For more information about \
         Amazon SWF service limits, see: \
        ...
        \  "]
  description : description option; [@ocaml.doc "A text description of the domain.\n"]
  name : domain_name;
      [@ocaml.doc
        "Name of the domain to register. The name must be unique in the region that the domain is \
         registered in.\n\n\
        \ The specified string must not start or end with whitespace. It must not contain a [:] \
         (colon), [/] (slash), [|] (vertical bar), or any control characters ([\\u0000-\\u001f] | \
         [\\u007f-\\u009f]). Also, it must {i not} be the literal string [arn].\n\
...
type nonrec register_activity_type_input = {
  ...
  default_task_schedule_to_start_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        "If set, specifies the default maximum duration that a task of this activity type can wait \
         before being assigned to a worker. This default can be overridden when scheduling an \
  ...
  default_task_priority : task_priority option;
      [@ocaml.doc
        "The default task priority to assign to the activity type. If not assigned, then [0] is \
         used. Valid values are integers that range from Java's [Integer.MIN_VALUE] (-2147483648) \
         to [Integer.MAX_VALUE] (2147483647). Higher numbers indicate higher priority.\n\n\
        \ For more information about setting task priority, see \
         {{:https://docs.aws.amazon.com/amazonswf/latest/developerguide/programming-priority.html}Setting \
  ...
  default_task_heartbeat_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        "If set, specifies the default maximum time before which a worker processing a task of \
         this type must report progress by calling [RecordActivityTaskHeartbeat]. If the timeout \
         is exceeded, the activity task is automatically timed out. This default can be overridden \
         when scheduling an activity task using the [ScheduleActivityTask] [Decision]. If the \
         activity worker subsequently attempts to record a heartbeat or returns a result, the \
         activity worker receives an [UnknownResource] fault. In this case, Amazon SWF no longer \
         considers the activity task to be valid; the activity worker should clean up the activity \
         task.\n\n\
        \ The duration is specified in seconds, an integer greater than or equal to [0]. You can \
         use [NONE] to specify unlimited duration.\n\
        \ "]
  default_task_start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        "If set, specifies the default maximum duration that a worker can take to process tasks of \
         this activity type. This default can be overridden when scheduling an activity task using \
         the [ScheduleActivityTask] [Decision].\n\n\
        \ The duration is specified in seconds, an integer greater than or equal to [0]. You can \
         use [NONE] to specify unlimited duration.\n\
        \ "]
  description : description option; [@ocaml.doc "A textual description of the activity type.\n"]
  version : version;
      [@ocaml.doc
  ...
  name : name;
      [@ocaml.doc
        ...
        \ "]
  domain : domain_name;
      [@ocaml.doc "The name of the domain in which this activity is to be registered.\n"]
}
[@@ocaml.doc ""]
...
type nonrec record_activity_task_heartbeat_input = {
  details : limited_data option;
      [@ocaml.doc "If specified, contains details about the progress of the task.\n"]
  task_token : task_token;
      [@ocaml.doc
        "The [taskToken] of the [ActivityTask].\n\n\
        \   [taskToken] is generated by the service and should be treated as an opaque value. If \
...
[@@ocaml.doc "Provides the details of the [CompleteWorkflowExecutionFailed] event.\n"]
...
[@@ocaml.doc "Provides the details of the [FailWorkflowExecutionFailed] event.\n"]
...
[@@ocaml.doc "Provides the details of the [CancelWorkflowExecutionFailed] event.\n"]
...
[@@ocaml.doc "Provides the details of the [ContinueAsNewWorkflowExecutionFailed] event.\n"]
...
type nonrec decision_task_scheduled_event_attributes = {
  ...
  task_priority : task_priority option;
      [@ocaml.doc
        ...
        \ "]
  task_list : task_list;
      [@ocaml.doc "The name of the task list in which the decision task was scheduled.\n"]
}
  ...
  scheduled_event_id : event_id;
      [@ocaml.doc
        "The ID of the [DecisionTaskScheduled] event that was recorded when this decision task was \
         scheduled. This information can be useful for diagnosing problems by tracing back the \
         chain of events leading up to this event.\n"]
  execution_context : data option; [@ocaml.doc "User defined context for the workflow execution.\n"]
}
...
type nonrec decision_task_timed_out_event_attributes = {
  ...
  timeout_type : decision_task_timeout_type;
      [@ocaml.doc "The type of timeout that expired before the decision task could be completed.\n"]
}
...
type nonrec activity_task_scheduled_event_attributes = {
  ...
  decision_task_completed_event_id : event_id;
      [@ocaml.doc
        "The ID of the [DecisionTaskCompleted] event corresponding to the decision that resulted \
         in the scheduling of this activity task. This information can be useful for diagnosing \
  ...
  task_priority : task_priority option;
      [@ocaml.doc
        ...
        \  "]
  task_list : task_list;
      [@ocaml.doc "The task list in which the activity task has been scheduled.\n"]
  start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc "The maximum amount of time a worker may take to process the activity task.\n"]
  schedule_to_close_timeout : duration_in_seconds_optional option;
  ...
  control : data option;
      [@ocaml.doc
        "Data attached to the event that can be used by the decider in subsequent workflow tasks. \
         This data isn't sent to the activity.\n"]
  input : data option; [@ocaml.doc "The input provided to the activity task.\n"]
  activity_id : activity_id; [@ocaml.doc "The unique ID of the activity task.\n"]
  activity_type : activity_type; [@ocaml.doc "The type of the activity task.\n"]
}
[@@ocaml.doc "Provides the details of the [ActivityTaskScheduled] event.\n"]
  ...
  scheduled_event_id : event_id;
      [@ocaml.doc
        "The ID of the [ActivityTaskScheduled] event that was recorded when this activity task was \
         ...
         chain of events leading up to this event.\n"]
  details : data option; [@ocaml.doc "The details of the failure.\n"]
  reason : failure_reason option; [@ocaml.doc "The reason provided for the failure.\n"]
}
...
[@@ocaml.doc "Provides the details of the [ActivityTaskCancelRequested] event.\n"]
...
[@@ocaml.doc "Provides the details of the [MarkerRecorded] event.\n"]

type nonrec record_marker_failed_cause = OPERATION_NOT_PERMITTED [@ocaml.doc ""] [@@ocaml.doc ""]
...
[@@ocaml.doc "Provides the details of the [RecordMarkerFailed] event.\n"]
...
[@@ocaml.doc "Provides the details of the [ChildWorkflowExecutionStarted] event.\n"]
...
[@@ocaml.doc "Provides the details of the [ChildWorkflowExecutionCompleted] event.\n"]
  ...
  initiated_event_id : event_id;
      [@ocaml.doc
        "The ID of the [StartChildWorkflowExecutionInitiated] event corresponding to the \
         ...
         information can be useful for diagnosing problems by tracing back the chain of events \
         leading up to this event.\n"]
  details : data option; [@ocaml.doc "The details of the failure (if provided).\n"]
  reason : failure_reason option; [@ocaml.doc "The reason for the failure (if provided).\n"]
  workflow_type : workflow_type; [@ocaml.doc "The type of the child workflow execution.\n"]
  workflow_execution : workflow_execution; [@ocaml.doc "The child workflow execution that failed.\n"]
}
[@@ocaml.doc "Provides the details of the [ChildWorkflowExecutionFailed] event.\n"]
  ...
  initiated_event_id : event_id;
      [@ocaml.doc
        "The ID of the [StartChildWorkflowExecutionInitiated] event corresponding to the \
         ...
         leading up to this event.\n"]
  timeout_type : workflow_execution_timeout_type;
      [@ocaml.doc "The type of the timeout that caused the child workflow execution to time out.\n"]
  workflow_type : workflow_type; [@ocaml.doc "The type of the child workflow execution.\n"]
  workflow_execution : workflow_execution;
      [@ocaml.doc "The child workflow execution that timed out.\n"]
}
[@@ocaml.doc "Provides the details of the [ChildWorkflowExecutionTimedOut] event.\n"]
  ...
  initiated_event_id : event_id;
      [@ocaml.doc
        "The ID of the [StartChildWorkflowExecutionInitiated] event corresponding to the \
         ...
         information can be useful for diagnosing problems by tracing back the chain of events \
         leading up to this event.\n"]
  details : data option; [@ocaml.doc "Details of the cancellation (if provided).\n"]
  workflow_type : workflow_type; [@ocaml.doc "The type of the child workflow execution.\n"]
  workflow_execution : workflow_execution;
      [@ocaml.doc "The child workflow execution that was canceled.\n"]
}
[@@ocaml.doc "Provide details of the [ChildWorkflowExecutionCanceled] event.\n"]
...
[@@ocaml.doc "Provides the details of the [ChildWorkflowExecutionTerminated] event.\n"]
...
type nonrec signal_external_workflow_execution_initiated_event_attributes = {
  ...
  run_id : workflow_run_id_optional option;
      [@ocaml.doc "The [runId] of the external workflow execution to send the signal to.\n"]
  workflow_id : workflow_id; [@ocaml.doc "The [workflowId] of the external workflow execution.\n"]
}
[@@ocaml.doc "Provides the details of the [SignalExternalWorkflowExecutionInitiated] event.\n"]

type nonrec external_workflow_execution_signaled_event_attributes = {
  initiated_event_id : event_id;
      [@ocaml.doc
        "The ID of the [SignalExternalWorkflowExecutionInitiated] event corresponding to the \
         [SignalExternalWorkflowExecution] decision to request this signal. This information can \
         be useful for diagnosing problems by tracing back the chain of events leading up to this \
         event.\n"]
  workflow_execution : workflow_execution;
      [@ocaml.doc "The external workflow execution that the signal was delivered to.\n"]
}
[@@ocaml.doc "Provides the details of the [ExternalWorkflowExecutionSignaled] event.\n"]
...
[@@ocaml.doc "Provides the details of the [SignalExternalWorkflowExecutionFailed] event.\n"]
...
[@@ocaml.doc "Provides the details of the [ExternalWorkflowExecutionCancelRequested] event.\n"]
  ...
  decision_task_completed_event_id : event_id;
      [@ocaml.doc
        "The ID of the [DecisionTaskCompleted] event corresponding to the decision task that \
         ...
         request. This information can be useful for diagnosing problems by tracing back the chain \
         of events leading up to this event.\n"]
  run_id : workflow_run_id_optional option;
      [@ocaml.doc "The [runId] of the external workflow execution to be canceled.\n"]
  workflow_id : workflow_id;
      [@ocaml.doc "The [workflowId] of the external workflow execution to be canceled.\n"]
}
[@@ocaml.doc
...
[@@ocaml.doc "Provides the details of the [RequestCancelExternalWorkflowExecutionFailed] event.\n"]
...
type nonrec schedule_activity_task_failed_event_attributes = {
  ...
  cause : schedule_activity_task_failed_cause;
      [@ocaml.doc
        ...
        \   "]
  activity_id : activity_id;
      [@ocaml.doc "The activityId provided in the [ScheduleActivityTask] decision that failed.\n"]
  activity_type : activity_type;
      [@ocaml.doc
        "The activity type provided in the [ScheduleActivityTask] decision that failed.\n"]
}
[@@ocaml.doc "Provides the details of the [ScheduleActivityTaskFailed] event.\n"]
...
[@@ocaml.doc "Provides the details of the [RequestCancelActivityTaskFailed] event.\n"]
...
type nonrec cancel_timer_failed_event_attributes = {
  ...
  cause : cancel_timer_failed_cause;
      [@ocaml.doc
        ...
        \   "]
  timer_id : timer_id;
      [@ocaml.doc "The timerId provided in the [CancelTimer] decision that failed.\n"]
}
  ...
  decision_task_completed_event_id : event_id;
      [@ocaml.doc
        "The ID of the [LambdaFunctionCompleted] event corresponding to the decision that resulted \
         ...
         back the chain of events leading up to this event.\n"]
  start_to_close_timeout : duration_in_seconds_optional option;
      [@ocaml.doc "The maximum amount of time a worker can take to process the Lambda task.\n"]
  input : function_input option; [@ocaml.doc "The input provided to the Lambda task.\n"]
  control : data option;
      [@ocaml.doc
  ...
  started_event_id : event_id;
      [@ocaml.doc
        "The ID of the [LambdaFunctionStarted] event recorded when this activity task started. To \
         help diagnose issues, use this information to trace back the chain of events leading up \
         to this event.\n"]
  scheduled_event_id : event_id;
      [@ocaml.doc
...
type nonrec lambda_function_timeout_type = START_TO_CLOSE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec schedule_lambda_function_failed_event_attributes = {
  decision_task_completed_event_id : event_id;
      [@ocaml.doc
        "The ID of the [LambdaFunctionCompleted] event corresponding to the decision that resulted \
         in scheduling this Lambda task. To help diagnose issues, use this information to trace \
         back the chain of events leading up to this event.\n"]
  ...
  name : function_name; [@ocaml.doc "The name of the Lambda function.\n"]
  id : function_id;
      [@ocaml.doc "The ID provided in the [ScheduleLambdaFunction] decision that failed. \n"]
}
[@@ocaml.doc
...
type nonrec history_event = {
  ...
  event_timestamp : timestamp; [@ocaml.doc "The date and time when the event occurred.\n"]
}
[@@ocaml.doc
  "Event within a workflow execution. A history event can be one of these types:\n\n\
  \ {ul\n\
  \       {-   [ActivityTaskCancelRequested] \226\128\147 A [RequestCancelActivityTask] decision \
  ...
  \           \n\
  \            }\n\
  \       {-   [ActivityTaskCompleted] \226\128\147 An activity worker successfully completed an \
   activity task by calling [RespondActivityTaskCompleted].\n\
  \           \n\
  \            }\n\
  \       {-   [ActivityTaskFailed] \226\128\147 An activity worker failed an activity task by \
  ...
  \           \n\
  \            }\n\
  \       {-   [ActivityTaskStarted] \226\128\147 The scheduled activity task was dispatched to a \
   worker.\n\
  \           \n\
  \            }\n\
  ...
  \           \n\
  \            }\n\
  \       {-   [CancelTimerFailed] \226\128\147 Failed to process CancelTimer decision. This \
   happens when the decision isn't configured properly, for example no timer exists with the \
   specified timer Id.\n\
  \           \n\
  \            }\n\
  \       {-   [CancelWorkflowExecutionFailed] \226\128\147 A request to cancel a workflow \
   execution failed.\n\
  \           \n\
  \            }\n\
  \       {-   [ChildWorkflowExecutionCanceled] \226\128\147 A child workflow execution, started \
   by this workflow execution, was canceled and closed.\n\
  \           \n\
  \            }\n\
  \       {-   [ChildWorkflowExecutionCompleted] \226\128\147 A child workflow execution, started \
   by this workflow execution, completed successfully and was closed.\n\
  \           \n\
  \            }\n\
  \       {-   [ChildWorkflowExecutionFailed] \226\128\147 A child workflow execution, started by \
   this workflow execution, failed to complete successfully and was closed.\n\
  \           \n\
  \            }\n\
  \       {-   [ChildWorkflowExecutionStarted] \226\128\147 A child workflow execution was \
   successfully started.\n\
  \           \n\
  \            }\n\
  \       {-   [ChildWorkflowExecutionTerminated] \226\128\147 A child workflow execution, started \
   by this workflow execution, was terminated.\n\
  \           \n\
  \            }\n\
  \       {-   [ChildWorkflowExecutionTimedOut] \226\128\147 A child workflow execution, started \
   by this workflow execution, timed out and was closed.\n\
  \           \n\
  \            }\n\
  \       {-   [CompleteWorkflowExecutionFailed] \226\128\147 The workflow execution failed to \
   complete.\n\
  \           \n\
  \            }\n\
  \       {-   [ContinueAsNewWorkflowExecutionFailed] \226\128\147 The workflow execution failed \
   to complete after being continued as a new workflow execution.\n\
  \           \n\
  \            }\n\
  \       {-   [DecisionTaskCompleted] \226\128\147 The decider successfully completed a decision \
   task by calling [RespondDecisionTaskCompleted].\n\
  \           \n\
  \            }\n\
  \       {-   [DecisionTaskScheduled] \226\128\147 A decision task was scheduled for the workflow \
   execution.\n\
  \           \n\
  \            }\n\
  ...
  \           \n\
  \            }\n\
  \       {-   [ExternalWorkflowExecutionCancelRequested] \226\128\147 Request to cancel an \
   external workflow execution was successfully delivered to the target execution.\n\
  \           \n\
  \            }\n\
  \       {-   [ExternalWorkflowExecutionSignaled] \226\128\147 A signal, requested by this \
   workflow execution, was successfully delivered to the target external workflow execution.\n\
  \           \n\
  \            }\n\
  \       {-   [FailWorkflowExecutionFailed] \226\128\147 A request to mark a workflow execution \
   as failed, itself failed.\n\
  \           \n\
  \            }\n\
  \       {-   [MarkerRecorded] \226\128\147 A marker was recorded in the workflow history as the \
  ...
  \           \n\
  \            }\n\
  \       {-   [RequestCancelActivityTaskFailed] \226\128\147 Failed to process \
   RequestCancelActivityTask decision. This happens when the decision isn't configured properly.\n\
  \           \n\
  \            }\n\
  \       {-   [RequestCancelExternalWorkflowExecutionFailed] \226\128\147 Request to cancel an \
   external workflow execution failed.\n\
  \           \n\
  \            }\n\
  \       {-   [RequestCancelExternalWorkflowExecutionInitiated] \226\128\147 A request was made \
   to request the cancellation of an external workflow execution.\n\
  \           \n\
  \            }\n\
  \       {-   [ScheduleActivityTaskFailed] \226\128\147 Failed to process ScheduleActivityTask \
   decision. This happens when the decision isn't configured properly, for example the activity \
   type specified isn't registered.\n\
  \           \n\
  \            }\n\
  \       {-   [SignalExternalWorkflowExecutionFailed] \226\128\147 The request to signal an \
   external workflow execution failed.\n\
  \           \n\
  \            }\n\
  \       {-   [SignalExternalWorkflowExecutionInitiated] \226\128\147 A request to signal an \
  ...
  \           \n\
  \            }\n\
  \       {-   [StartChildWorkflowExecutionFailed] \226\128\147 Failed to process \
   StartChildWorkflowExecution decision. This happens when the decision isn't configured properly, \
   for example the workflow type specified isn't registered.\n\
  \           \n\
  \            }\n\
  \       {-   [StartChildWorkflowExecutionInitiated] \226\128\147 A request was made to start a \
   child workflow execution.\n\
  \           \n\
  \            }\n\
  \       {-   [StartTimerFailed] \226\128\147 Failed to process StartTimer decision. This happens \
   when the decision isn't configured properly, for example a timer already exists with the \
   specified timer Id.\n\
  \           \n\
  \            }\n\
  \       {-   [TimerCanceled] \226\128\147 A timer, previously started for this workflow \
   execution, was successfully canceled.\n\
  \           \n\
  \            }\n\
  \       {-   [TimerFired] \226\128\147 A timer, previously started for this workflow execution, \
   fired.\n\
  \           \n\
  \            }\n\
  \       {-   [TimerStarted] \226\128\147 A timer was started for the workflow execution due to a \
   [StartTimer] decision.\n\
  \           \n\
  \            }\n\
  \       {-   [WorkflowExecutionCancelRequested] \226\128\147 A request to cancel this workflow \
   execution was made.\n\
  \           \n\
  \            }\n\
  \       {-   [WorkflowExecutionCanceled] \226\128\147 The workflow execution was successfully \
   canceled and closed.\n\
  \           \n\
  \            }\n\
  \       {-   [WorkflowExecutionCompleted] \226\128\147 The workflow execution was closed due to \
   successful completion.\n\
  \           \n\
  \            }\n\
  \       {-   [WorkflowExecutionContinuedAsNew] \226\128\147 The workflow execution was closed \
   and a new execution of the same type was created with the same workflowId.\n\
  \           \n\
  \            }\n\
  \       {-   [WorkflowExecutionFailed] \226\128\147 The workflow execution closed due to a \
   failure.\n\
  \           \n\
  \            }\n\
  \       {-   [WorkflowExecutionSignaled] \226\128\147 An external signal was received for the \
   workflow execution.\n\
  \           \n\
  \            }\n\
  ...
  \           \n\
  \            }\n\
  \       {-   [WorkflowExecutionTimedOut] \226\128\147 The workflow execution was closed because \
...
type nonrec decision_task = {
  previous_started_event_id : event_id option;
      [@ocaml.doc
        "The ID of the DecisionTaskStarted event of the previous decision task of this workflow \
         execution that was processed by the decider. This can be used to determine the events in \
         the history new since the last decision task received by the decider.\n"]
  next_page_token : page_token option;
      [@ocaml.doc
        "If a [NextPageToken] was returned by a previous call, there are more results available. \
         To retrieve the next page of results, make the call again using the returned token in \
  ...
  workflow_type : workflow_type;
      [@ocaml.doc "The type of the workflow execution for which this decision task was created.\n"]
  workflow_execution : workflow_execution;
      [@ocaml.doc "The workflow execution for which this decision task was created.\n"]
  started_event_id : event_id;
      [@ocaml.doc "The ID of the [DecisionTaskStarted] event recorded in the history.\n"]
  task_token : task_token;
      [@ocaml.doc
...
type nonrec poll_for_decision_task_input = {
  start_at_previous_started_event : start_at_previous_started_event option;
      [@ocaml.doc
        "When set to [true], returns the events with [eventTimestamp] greater than or equal to \
         [eventTimestamp] of the most recent [DecisionTaskStarted] event. By default, this \
         parameter is set to [false].\n"]
  reverse_order : reverse_order option;
      [@ocaml.doc
        "When set to [true], returns the events in reverse order. By default the results are \
         returned in ascending order of the [eventTimestamp] of the events.\n"]
  maximum_page_size : page_size option;
      [@ocaml.doc
        "The maximum number of results that are returned per call. Use [nextPageToken] to obtain \
         further pages of results. \n\n\
        \ This is an upper limit only; the actual number of results returned per call may be fewer \
  ...
  next_page_token : page_token option;
      [@ocaml.doc
        "If [NextPageToken] is returned there are more results available. The value of \
         ...
         pagination token expires after 24 hours. Using an expired pagination token will return a \
         [400] error: \"[Specified token has \n\
        \      exceeded its maximum lifetime]\". \n\n\
        \ The configured [maximumPageSize] determines how many results can be returned in a single \
         call. \n\
        \ \n\
        \   The [nextPageToken] returned by this action cannot be used with \
         [GetWorkflowExecutionHistory] to get the next page. You must call [PollForDecisionTask] \
         again (with the [nextPageToken]) to retrieve the next page of history records. Calling \
         [PollForDecisionTask] with a [nextPageToken] doesn't return a new decision task.\n\
        \   \n\
        \    "]
  identity : identity option;
      [@ocaml.doc
        "Identity of the decider making the request, which is recorded in the DecisionTaskStarted \
         event in the workflow history. This enables diagnostic tracing when problems arise. The \
  ...
  task_list : task_list;
      [@ocaml.doc
        ...
        \ The specified string must not contain a [:] (colon), [/] (slash), [|] (vertical bar), or \
         ...
         the literal string [arn].\n\
        \ "]
  domain : domain_name; [@ocaml.doc "The name of the domain containing the task lists to poll.\n"]
}
[@@ocaml.doc ""]
...
type nonrec activity_task = {
  ...
  activity_type : activity_type; [@ocaml.doc "The type of this activity task.\n"]
  workflow_execution : workflow_execution;
      [@ocaml.doc "The workflow execution that started this activity task.\n"]
  started_event_id : event_id;
      [@ocaml.doc "The ID of the [ActivityTaskStarted] event recorded in the history.\n"]
  activity_id : activity_id; [@ocaml.doc "The unique ID of the task.\n"]
  task_token : task_token;
      [@ocaml.doc
        "The opaque string used as a handle on the task. This token is used by workers to \
...
type nonrec poll_for_activity_task_input = {
  ...
  task_list : task_list;
      [@ocaml.doc
        ...
        \ "]
  domain : domain_name;
      [@ocaml.doc "The name of the domain that contains the task lists being polled.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_workflow_types_input = {
  reverse_order : reverse_order option;
      [@ocaml.doc
        "When set to [true], returns the results in reverse order. By default the results are \
         returned in ascending alphabetical order of the [name] of the workflow types.\n"]
  maximum_page_size : page_size option;
      [@ocaml.doc
        "The maximum number of results that are returned per call. Use [nextPageToken] to obtain \
         further pages of results. \n"]
  ...
  registration_status : registration_status;
      [@ocaml.doc "Specifies the registration status of the workflow types to list.\n"]
  name : name option; [@ocaml.doc "If specified, lists the workflow type with this name.\n"]
  domain : domain_name;
      [@ocaml.doc "The name of the domain in which the workflow types have been registered.\n"]
}
[@@ocaml.doc ""]

type nonrec list_tags_for_resource_output = {
  tags : resource_tag_list option; [@ocaml.doc "An array of tags associated with the domain.\n"]
}
[@@ocaml.doc ""]
...
type nonrec execution_time_filter = {
  latest_date : timestamp option;
      [@ocaml.doc "Specifies the latest start or close date and time to return.\n"]
  oldest_date : timestamp;
      [@ocaml.doc "Specifies the oldest start or close date and time to return.\n"]
}
[@@ocaml.doc
  "Used to filter the workflow executions in visibility APIs by various time-based rules. Each \
   parameter, if specified, defines a rule that must be satisfied by each returned query result. \
   The parameter values are in the {{:https://en.wikipedia.org/wiki/Unix_time}Unix Time format}. \
...
type nonrec list_open_workflow_executions_input = {
  ...
  domain : domain_name;
      [@ocaml.doc "The name of the domain that contains the workflow executions to list.\n"]
}
[@@ocaml.doc ""]
...
type nonrec domain_info = {
  ...
  description : description option;
      [@ocaml.doc "The description of the domain provided through [RegisterDomain].\n"]
  status : registration_status;
      [@ocaml.doc
        "The status of the domain:\n\n\
        \ {ul\n\
        \       {-   [REGISTERED] \226\128\147 The domain is properly registered and available. \
         You can use this domain for registering types and creating new workflow executions. \n\
        \           \n\
        \            }\n\
        \       {-   [DEPRECATED] \226\128\147 The domain was deprecated using [DeprecateDomain], \
        ...
        \  "]
  name : domain_name;
      [@ocaml.doc "The name of the domain. This name is unique within the account.\n"]
}
  ...
  next_page_token : page_token option;
      [@ocaml.doc
        ...
        \ The configured [maximumPageSize] determines how many results can be returned in a single \
         call.\n\
        \ "]
  domain_infos : domain_info_list; [@ocaml.doc "A list of DomainInfo structures.\n"]
}
[@@ocaml.doc "Contains a paginated collection of DomainInfo structures.\n"]

type nonrec list_domains_input = {
  reverse_order : reverse_order option;
      [@ocaml.doc
        "When set to [true], returns the results in reverse order. By default, the results are \
         returned in ascending alphabetical order by [name] of the domains.\n"]
  maximum_page_size : page_size option;
      [@ocaml.doc
        "The maximum number of results that are returned per call. Use [nextPageToken] to obtain \
         further pages of results. \n"]
  registration_status : registration_status;
      [@ocaml.doc "Specifies the registration status of the domains to list.\n"]
  next_page_token : page_token option;
      [@ocaml.doc
        "If [NextPageToken] is returned there are more results available. The value of \
         [NextPageToken] is a unique pagination token for each page. Make the call again using the \
...
type nonrec list_closed_workflow_executions_input = {
  ...
  close_status_filter : close_status_filter option;
      [@ocaml.doc
        "If specified, only workflow executions that match this {i close status} are listed. For \
         example, if TERMINATED is specified, then only TERMINATED workflow executions are \
         listed.\n\n\
        \   [closeStatusFilter], [executionFilter], [typeFilter] and [tagFilter] are mutually \
         exclusive. You can specify at most one of these in a request.\n\
        \  \n\
...
type nonrec activity_type_info = {
  deprecation_date : timestamp option;
      [@ocaml.doc "If DEPRECATED, the date and time [DeprecateActivityType] was called.\n"]
  creation_date : timestamp;
      [@ocaml.doc
        "The date and time this activity type was created through [RegisterActivityType].\n"]
  description : description option;
      [@ocaml.doc "The description of the activity type provided in [RegisterActivityType].\n"]
  status : registration_status; [@ocaml.doc "The current status of the activity type.\n"]
  activity_type : activity_type;
      [@ocaml.doc "The [ActivityType] type structure representing the activity type.\n"]
}
  ...
  next_page_token : page_token option;
      [@ocaml.doc
        ...
        \ The configured [maximumPageSize] determines how many results can be returned in a single \
         call.\n\
        \ "]
  type_infos : activity_type_info_list; [@ocaml.doc "List of activity type information.\n"]
}
[@@ocaml.doc "Contains a paginated list of activity type information structures.\n"]

type nonrec list_activity_types_input = {
  reverse_order : reverse_order option;
      [@ocaml.doc
        "When set to [true], returns the results in reverse order. By default, the results are \
         returned in ascending alphabetical order by [name] of the activity types.\n"]
  maximum_page_size : page_size option;
      [@ocaml.doc
        "The maximum number of results that are returned per call. Use [nextPageToken] to obtain \
         further pages of results. \n"]
  next_page_token : page_token option;
      [@ocaml.doc
        ...
        \ "]
  registration_status : registration_status;
      [@ocaml.doc "Specifies the registration status of the activity types to list.\n"]
  name : name option;
      [@ocaml.doc "If specified, only lists the activity types that have this name.\n"]
  domain : domain_name;
      [@ocaml.doc "The name of the domain in which the activity types have been registered.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_workflow_execution_history_input = {
  ...
  execution : workflow_execution;
      [@ocaml.doc "Specifies the workflow execution for which to return the history.\n"]
  domain : domain_name; [@ocaml.doc "The name of the domain containing the workflow execution.\n"]
}
[@@ocaml.doc ""]

type nonrec describe_workflow_type_input = {
  workflow_type : workflow_type; [@ocaml.doc "The workflow type to describe.\n"]
  domain : domain_name;
      [@ocaml.doc "The name of the domain in which this workflow type is registered.\n"]
}
[@@ocaml.doc ""]

type nonrec describe_workflow_execution_input = {
  execution : workflow_execution; [@ocaml.doc "The workflow execution to describe.\n"]
  domain : domain_name; [@ocaml.doc "The name of the domain containing the workflow execution.\n"]
}
[@@ocaml.doc ""]
...
type nonrec domain_configuration = {
  workflow_execution_retention_period_in_days : duration_in_days;
      [@ocaml.doc "The retention period for workflow executions in this domain.\n"]
}
...
type nonrec activity_type_configuration = {
  ...
  default_task_schedule_to_start_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        " The default maximum duration, specified when registering the activity type, that a task \
         of an activity type can wait before being assigned to a worker. You can override this \
  ...
  default_task_priority : task_priority option;
      [@ocaml.doc
        " The default task priority for tasks of this activity type, specified at registration. If \
         not set, then [0] is used as the default priority. This default can be overridden when \
  ...
  default_task_list : task_list option;
      [@ocaml.doc
        " The default task list specified for this activity type at registration. This default is \
         used if a task list isn't provided when a task is scheduled through the \
         [ScheduleActivityTask] [Decision]. You can override the default registered task list when \
  ...
  default_task_heartbeat_timeout : duration_in_seconds_optional option;
      [@ocaml.doc
        ...
        \ You can specify this value only when {i registering} an activity type. The registered \
         default value can be overridden when you schedule a task through the \
         [ScheduleActivityTask] [Decision]. If the activity worker subsequently attempts to record \
         a heartbeat or returns a result, the activity worker receives an [UnknownResource] fault. \
...
type nonrec activity_type_detail = {
  configuration : activity_type_configuration;
      [@ocaml.doc "The configuration settings registered with the activity type.\n"]
  type_info : activity_type_info;
      [@ocaml.doc
        "General information about the activity type.\n\n\
        \ The status of activity type (returned in the ActivityTypeInfo structure) can be one of \
         the following.\n\
        \ \n\
        \  {ul\n\
        \        {-   [REGISTERED] \226\128\147 The type is registered and available. Workers \
        ...
        \             }\n\
        \        {-   [DEPRECATED] \226\128\147 The type was deprecated using \
         [DeprecateActivityType], but is still in use. You should keep workers supporting this \
         type running. You cannot create new tasks of this type. \n\
        \            \n\
        \             }\n\
        \        }\n\
        \  "]
  ...
  activity_type : activity_type;
      [@ocaml.doc
        "The activity type to get information about. Activity types are identified by the [name] \
         and [version] that were supplied when the activity was registered.\n"]
  domain : domain_name;
      [@ocaml.doc "The name of the domain in which the activity type is registered.\n"]
}
[@@ocaml.doc ""]

type nonrec deprecate_workflow_type_input = {
  workflow_type : workflow_type; [@ocaml.doc "The workflow type to deprecate.\n"]
  domain : domain_name;
      [@ocaml.doc "The name of the domain in which the workflow type is registered.\n"]
}
[@@ocaml.doc ""]
...
type nonrec deprecate_activity_type_input = {
  activity_type : activity_type; [@ocaml.doc "The activity type to deprecate.\n"]
  domain : domain_name;
      [@ocaml.doc "The name of the domain in which the activity type is registered.\n"]
}
[@@ocaml.doc ""]
...
type nonrec count_pending_decision_tasks_input = {
  ...
  domain : domain_name; [@ocaml.doc "The name of the domain that contains the task list.\n"]
}
[@@ocaml.doc ""]
  ...
  start_time_filter : execution_time_filter;
      [@ocaml.doc
        "Specifies the start time criteria that workflow executions must meet in order to be \
         counted.\n"]
  domain : domain_name;
      [@ocaml.doc "The name of the domain containing the workflow executions to count.\n"]
}
[@@ocaml.doc ""]
  ...
  close_status_filter : close_status_filter option;
      [@ocaml.doc
        "If specified, only workflow executions that match this close status are counted. This \
         filter has an affect only if [executionStatus] is specified as [CLOSED].\n\n\
        \   [closeStatusFilter], [executionFilter], [typeFilter] and [tagFilter] are mutually \
         exclusive. You can specify at most one of these in a request.\n\
        \  \n\
        \   "]
