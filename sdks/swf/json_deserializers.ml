...
let workflow_type_info_of_yojson tree path =
  ...
  ({
     deprecation_date =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "deprecationDate") _list path);
     creation_date =
...
let workflow_execution_info_of_yojson tree path =
  ...
  ({
     ...
     close_timestamp =
       (option_of_yojson (value_for_key timestamp_of_yojson "closeTimestamp")
          _list path);
     start_timestamp =
       (value_for_key timestamp_of_yojson "startTimestamp" _list path);
     workflow_type =
       (value_for_key workflow_type_of_yojson "workflowType" _list path);
     execution =
...
let workflow_execution_detail_of_yojson tree path =
  ...
  ({
     ...
     latest_activity_task_timestamp =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "latestActivityTaskTimestamp")
          _list path);
     open_counts =
...
let history_event_of_yojson tree path =
  ...
  ({
     ...
     event_timestamp =
       (value_for_key timestamp_of_yojson "eventTimestamp" _list path)
   } : history_event)
...
let execution_time_filter_of_yojson tree path =
  ...
  ({
     latest_date =
       (option_of_yojson (value_for_key timestamp_of_yojson "latestDate")
          _list path);
     oldest_date =
       (value_for_key timestamp_of_yojson "oldestDate" _list path)
