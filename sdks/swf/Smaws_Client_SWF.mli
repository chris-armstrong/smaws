...
val make_workflow_type : version:version -> name:name -> unit -> workflow_type
...
val make_workflow_execution :
  run_id:workflow_run_id -> workflow_id:workflow_id -> unit -> workflow_execution
...
val make_untag_resource_input :
  tag_keys:resource_tag_key_list -> resource_arn:arn -> unit -> untag_resource_input

val make_undeprecate_workflow_type_input :
  workflow_type:workflow_type -> domain:domain_name -> unit -> undeprecate_workflow_type_input

val make_undeprecate_domain_input : name:domain_name -> unit -> undeprecate_domain_input
val make_activity_type : version:version -> name:name -> unit -> activity_type

val make_undeprecate_activity_type_input :
  activity_type:activity_type -> domain:domain_name -> unit -> undeprecate_activity_type_input
...
val make_timer_fired_event_attributes :
  started_event_id:event_id -> timer_id:timer_id -> unit -> timer_fired_event_attributes
...
val make_describe_workflow_type_input :
  workflow_type:workflow_type -> domain:domain_name -> unit -> describe_workflow_type_input

val make_describe_workflow_execution_input :
  execution:workflow_execution -> domain:domain_name -> unit -> describe_workflow_execution_input
...
val make_domain_detail :
  configuration:domain_configuration -> domain_info:domain_info -> unit -> domain_detail
...
val make_describe_activity_type_input :
  activity_type:activity_type -> domain:domain_name -> unit -> describe_activity_type_input

val make_deprecate_workflow_type_input :
  workflow_type:workflow_type -> domain:domain_name -> unit -> deprecate_workflow_type_input

val make_deprecate_domain_input : name:domain_name -> unit -> deprecate_domain_input

val make_deprecate_activity_type_input :
  activity_type:activity_type -> domain:domain_name -> unit -> deprecate_activity_type_input

val make_delete_workflow_type_input :
  workflow_type:workflow_type -> domain:domain_name -> unit -> delete_workflow_type_input

val make_delete_activity_type_input :
  activity_type:activity_type -> domain:domain_name -> unit -> delete_activity_type_input
...
val make_count_pending_decision_tasks_input :
  task_list:task_list -> domain:domain_name -> unit -> count_pending_decision_tasks_input

val make_count_pending_activity_tasks_input :
  task_list:task_list -> domain:domain_name -> unit -> count_pending_activity_tasks_input
