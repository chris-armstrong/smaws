...
[@@ocaml.doc
  "Represents the subnet associated with a DAX cluster. This parameter refers to subnets defined \
   in Amazon Virtual Private Cloud (Amazon VPC) and used with DAX.\n"]
...
type nonrec subnet_group = {
  ...
  description : string_ option; [@ocaml.doc "The description of the subnet group.\n"]
  subnet_group_name : string_ option; [@ocaml.doc "The name of the subnet group.\n"]
}
[@@ocaml.doc
...
type nonrec update_subnet_group_response = {
  subnet_group : subnet_group option; [@ocaml.doc "The subnet group that has been modified.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "The requested subnet group name does not refer to an existing subnet group.\n"]
...
type nonrec parameter_group = {
  ...
  parameter_group_name : string_ option; [@ocaml.doc "The name of the parameter group.\n"]
}
[@@ocaml.doc "A named set of parameters that are applied to all of the nodes in a DAX cluster.\n"]
  ...
  parameter_name_values : parameter_name_value_list;
      [@ocaml.doc
        ...
        \   [record-ttl-millis] and [query-ttl-millis] are the only supported parameter names. For \
         more details, see \
         {{:https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DAX.cluster-management.html#DAX.cluster-management.custom-settings.ttl}Configuring \
         TTL Settings}.\n\
        \  \n\
        \   "]
...
[@@ocaml.doc "One or more parameters in a parameter group are in an invalid state.\n"]
...
type nonrec endpoint = {
  ur_l : string_ option;
      [@ocaml.doc
        "The URL that applications should use to connect to the endpoint. The default ports are \
         8111 for the \"dax\" protocol and 9111 for the \"daxs\" protocol.\n"]
  port : integer option;
      [@ocaml.doc "The port number that applications should use to connect to the endpoint.\n"]
...
type nonrec node = {
  ...
  node_status : string_ option;
      [@ocaml.doc "The current status of the node. For example: [available].\n"]
  availability_zone : string_ option;
      [@ocaml.doc "The Availability Zone (AZ) in which the node has been deployed.\n"]
  node_create_time : t_stamp option;
      [@ocaml.doc "The date and time (in UNIX epoch format) when the node was launched.\n"]
  endpoint : endpoint option;
      [@ocaml.doc
        "The endpoint for the node, consisting of a DNS name and a port number. Client \
         ...
         the DAX cluster.\n"]
  node_id : string_ option; [@ocaml.doc "A system-generated identifier for the node.\n"]
}
[@@ocaml.doc "Represents an individual node within a DAX cluster.\n"]
...
type nonrec notification_configuration = {
  topic_status : string_ option;
      [@ocaml.doc
        "The current state of the topic. A value of \226\128\156active\226\128\157 means that \
...
type nonrec security_group_membership = {
  ...
  security_group_identifier : string_ option; [@ocaml.doc "The unique ID for this security group.\n"]
}
[@@ocaml.doc "An individual VPC security group and its status.\n"]
...
[@@ocaml.doc "The status of a parameter group.\n"]
...
[@@ocaml.doc "The description of the server-side encryption status on the specified DAX cluster.\n"]

type nonrec cluster_endpoint_encryption_type = TLS [@ocaml.doc ""] | NONE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec cluster = {
  ...
  subnet_group : string_ option; [@ocaml.doc "The subnet group where the DAX cluster is running.\n"]
  ...
  nodes : node_list option; [@ocaml.doc "A list of nodes that are currently in the cluster.\n"]
  ...
  total_nodes : integer_optional option; [@ocaml.doc "The total number of nodes in the cluster.\n"]
  cluster_arn : string_ option;
      [@ocaml.doc "The Amazon Resource Name (ARN) that uniquely identifies the cluster. \n"]
  description : string_ option; [@ocaml.doc "The description of the cluster.\n"]
...
type nonrec update_cluster_response = {
  cluster : cluster option;
      [@ocaml.doc "A description of the DAX cluster, after it has been modified.\n"]
}
[@@ocaml.doc ""]
...
type nonrec update_cluster_request = {
  ...
  cluster_name : string_; [@ocaml.doc "The name of the DAX cluster to be modified.\n"]
}
[@@ocaml.doc ""]

type nonrec invalid_cluster_state_fault = { message : exception_message option [@ocaml.doc ""] }
[@@ocaml.doc "The requested DAX cluster is not in the {i available} state.\n"]

type nonrec cluster_not_found_fault = { message : exception_message option [@ocaml.doc ""] }
[@@ocaml.doc "The requested cluster ID does not refer to an existing DAX cluster.\n"]
...
type nonrec untag_resource_response = {
  tags : tag_list option; [@ocaml.doc "The tag keys that have been removed from the cluster.\n"]
}
[@@ocaml.doc ""]
...
type nonrec untag_resource_request = {
  tag_keys : key_list;
      [@ocaml.doc
        "A list of tag keys. If the DAX cluster has any tags with these keys, then the tags are \
         removed from the cluster.\n"]
  resource_name : string_;
      [@ocaml.doc "The name of the DAX resource from which the tags should be removed.\n"]
}
[@@ocaml.doc ""]

type nonrec tag_not_found_fault = { message : exception_message option [@ocaml.doc ""] }
[@@ocaml.doc "The tag does not exist.\n"]

type nonrec invalid_arn_fault = { message : exception_message option [@ocaml.doc ""] }
[@@ocaml.doc "The Amazon Resource Name (ARN) supplied in the request is not valid.\n"]

type nonrec tag_resource_response = {
  tags : tag_list option;
      [@ocaml.doc "The list of tags that are associated with the DAX resource.\n"]
}
[@@ocaml.doc ""]

type nonrec tag_resource_request = {
  tags : tag_list; [@ocaml.doc "The tags to be assigned to the DAX resource. \n"]
  resource_name : string_;
      [@ocaml.doc "The name of the DAX resource to which tags should be added.\n"]
}
[@@ocaml.doc ""]

type nonrec tag_quota_per_resource_exceeded = { message : exception_message option [@ocaml.doc ""] }
[@@ocaml.doc "You have exceeded the maximum number of tags for this DAX cluster.\n"]
...
[@@ocaml.doc "The specified subnet group is currently in use.\n"]

type nonrec subnet_group_already_exists_fault = {
  message : exception_message option; [@ocaml.doc ""]
}
[@@ocaml.doc "The specified subnet group already exists.\n"]
...
type nonrec reboot_node_response = {
  cluster : cluster option;
      [@ocaml.doc "A description of the DAX cluster after a node has been rebooted.\n"]
}
[@@ocaml.doc ""]

type nonrec reboot_node_request = {
  node_id : string_; [@ocaml.doc "The system-assigned ID of the node to be rebooted.\n"]
  cluster_name : string_;
      [@ocaml.doc "The name of the DAX cluster containing the node to be rebooted.\n"]
}
[@@ocaml.doc ""]

type nonrec node_not_found_fault = { message : exception_message option [@ocaml.doc ""] }
[@@ocaml.doc "None of the nodes in the cluster have the given node ID.\n"]

type nonrec parameter_type = NODE_TYPE_SPECIFIC [@ocaml.doc ""] | DEFAULT [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec node_type_specific_value = {
  value : string_ option; [@ocaml.doc "The parameter value for this node type.\n"]
  node_type : string_ option; [@ocaml.doc "A node type to which the parameter value applies.\n"]
}
[@@ocaml.doc "Represents a parameter value that is applicable to a particular node type.\n"]

type nonrec node_type_specific_value_list = node_type_specific_value list [@@ocaml.doc ""]
...
type nonrec change_type = REQUIRES_REBOOT [@ocaml.doc ""] | IMMEDIATE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec parameter = {
  change_type : change_type option;
      [@ocaml.doc
        "The conditions under which changes to this parameter can be applied. For example, \
         [requires-reboot] indicates that a new value for this parameter will only take effect if \
         a node is rebooted.\n"]
  ...
  node_type_specific_values : node_type_specific_value_list option;
      [@ocaml.doc "A list of node types, and specific parameter values for each node.\n"]
  parameter_value : string_ option; [@ocaml.doc "The value for the parameter.\n"]
...
[@@ocaml.doc "Describes an individual setting that controls some aspect of DAX behavior.\n"]
...
[@@ocaml.doc "You have attempted to exceed the maximum number of parameter groups.\n"]
...
[@@ocaml.doc "The specified parameter group already exists.\n"]
...
[@@ocaml.doc "You have attempted to exceed the maximum number of nodes for a DAX cluster.\n"]
...
type nonrec list_tags_response = {
  ...
  tags : tag_list option; [@ocaml.doc "A list of tags currently associated with the DAX cluster.\n"]
}
[@@ocaml.doc ""]
  ...
  next_token : string_ option;
      [@ocaml.doc
        "An optional token returned from a prior request. Use this token for pagination of results \
         ...
         beyond the token.\n"]
  resource_name : string_; [@ocaml.doc "The name of the DAX resource to which the tags belong.\n"]
}
[@@ocaml.doc ""]
...
type nonrec increase_replication_factor_request = {
  ...
  new_replication_factor : integer; [@ocaml.doc "The new number of nodes for the DAX cluster.\n"]
  cluster_name : string_;
      [@ocaml.doc "The name of the DAX cluster that will receive additional nodes.\n"]
}
[@@ocaml.doc ""]

type nonrec event = {
  date : t_stamp option; [@ocaml.doc "The date and time when the event occurred.\n"]
  message : string_ option; [@ocaml.doc "A user-defined message associated with the event.\n"]
...
type nonrec describe_subnet_groups_request = {
  ...
  max_results : integer_optional option;
      [@ocaml.doc
        ...
        \ "]
  subnet_group_names : subnet_group_name_list option; [@ocaml.doc "The name of the subnet group.\n"]
}
[@@ocaml.doc ""]
...
type nonrec describe_events_response = {
  events : event_list option;
      [@ocaml.doc "An array of events. Each element in the array represents one event.\n"]
  next_token : string_ option;
      [@ocaml.doc "Provides an identifier to allow retrieval of paginated results.\n"]
}
[@@ocaml.doc ""]
...
type nonrec describe_default_parameters_response = {
  parameters : parameter_list option;
      [@ocaml.doc "A list of parameters. Each element in the list represents one parameter.\n"]
  next_token : string_ option;
      [@ocaml.doc "Provides an identifier to allow retrieval of paginated results.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_cluster_response = {
  cluster : cluster option; [@ocaml.doc "A description of the DAX cluster that is being deleted.\n"]
}
[@@ocaml.doc ""]
...
type nonrec decrease_replication_factor_request = {
  node_ids_to_remove : node_identifier_list option;
      [@ocaml.doc "The unique identifiers of the nodes to be removed from the cluster.\n"]
  availability_zones : availability_zone_list option;
      [@ocaml.doc "The Availability Zone(s) from which to remove nodes.\n"]
  new_replication_factor : integer; [@ocaml.doc "The new number of nodes for the DAX cluster.\n"]
  cluster_name : string_;
      [@ocaml.doc "The name of the DAX cluster from which you want to remove nodes.\n"]
}
[@@ocaml.doc ""]

type nonrec create_subnet_group_response = {
  subnet_group : subnet_group option;
      [@ocaml.doc "Represents the output of a {i CreateSubnetGroup} operation.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_subnet_group_request = {
  ...
  subnet_group_name : string_;
      [@ocaml.doc "A name for the subnet group. This value is stored as a lowercase string. \n"]
}
[@@ocaml.doc ""]

type nonrec create_parameter_group_response = {
  parameter_group : parameter_group option;
      [@ocaml.doc "Represents the output of a {i CreateParameterGroup} action.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_cluster_response = {
  cluster : cluster option; [@ocaml.doc "A description of the DAX cluster that you have created.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_cluster_request = {
  ...
  sse_specification : sse_specification option;
      [@ocaml.doc "Represents the settings used to enable server-side encryption on the cluster.\n"]
  tags : tag_list option; [@ocaml.doc "A set of tags to associate with the DAX cluster. \n"]
  parameter_group_name : string_ option;
      [@ocaml.doc "The parameter group to be associated with the DAX cluster.\n"]
  ...
  notification_topic_arn : string_ option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the Amazon SNS topic to which notifications will be \
         sent.\n\n\
  ...
  preferred_maintenance_window : string_ option;
      [@ocaml.doc
        "Specifies the weekly time range during which maintenance on the DAX cluster is performed. \
         ...
         minimum maintenance window is a 60 minute period. Valid values for [ddd] are:\n\n\
        \ {ul\n\
        \       {-   [sun] \n\
        \           \n\
        \            }\n\
        ...
        \     If you don't specify a preferred maintenance window when you create or modify a \
         cache cluster, DAX assigns a 60-minute maintenance window on a randomly selected day of \
         the week.\n\
        \     \n\
        \      "]
  security_group_ids : security_group_identifier_list option;
      [@ocaml.doc
        ...
        \ If this parameter is not specified, DAX assigns the default VPC security group to each \
         node.\n\
        \ "]
  ...
  availability_zones : availability_zone_list option;
      [@ocaml.doc
        "The Availability Zones (AZs) in which the cluster nodes will reside after the cluster has \
         been created or updated. If provided, the length of this list must equal the \
         [ReplicationFactor] parameter. If you omit this parameter, DAX will spread the nodes \
