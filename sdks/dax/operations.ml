...
module CreateCluster =
  struct
    let error_to_string =
      ...
      | `InvalidParameterGroupStateFault _ ->
      ...
      | `SubnetGroupNotFoundFault _ ->
          "com.amazonaws.dax#SubnetGroupNotFoundFault"
      | `TagQuotaPerResourceExceeded _ ->
    ...
    let request context (request : create_cluster_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.CreateCluster" ~service ~context ~input
...
module CreateParameterGroup =
  struct
    ...
    let request context (request : create_parameter_group_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.CreateParameterGroup" ~service ~context
        ~input
...
module CreateSubnetGroup =
  struct
    ...
    let request context (request : create_subnet_group_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.CreateSubnetGroup" ~service ~context ~input
    ...
    let request context (request : decrease_replication_factor_request) =
      let input =
        Json_serializers.decrease_replication_factor_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DecreaseReplicationFactor" ~service ~context
        ~input
...
module DeleteCluster =
  struct
    ...
    let request context (request : delete_cluster_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DeleteCluster" ~service ~context ~input
...
module DeleteParameterGroup =
  struct
    ...
    let request context (request : delete_parameter_group_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DeleteParameterGroup" ~service ~context
        ~input
...
module DeleteSubnetGroup =
  struct
    ...
    let request context (request : delete_subnet_group_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DeleteSubnetGroup" ~service ~context ~input
...
module DescribeClusters =
  struct
    ...
    let request context (request : describe_clusters_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DescribeClusters" ~service ~context ~input
    ...
    let request context (request : describe_default_parameters_request) =
      let input =
        Json_serializers.describe_default_parameters_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DescribeDefaultParameters" ~service ~context
        ~input
...
module DescribeEvents =
  struct
    ...
    let request context (request : describe_events_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DescribeEvents" ~service ~context ~input
...
module DescribeParameterGroups =
  struct
    ...
    let request context (request : describe_parameter_groups_request) =
      let input =
        Json_serializers.describe_parameter_groups_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DescribeParameterGroups" ~service ~context
        ~input
...
module DescribeParameters =
  struct
    ...
    let request context (request : describe_parameters_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DescribeParameters" ~service ~context ~input
...
module DescribeSubnetGroups =
  struct
    ...
    let request context (request : describe_subnet_groups_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.DescribeSubnetGroups" ~service ~context
        ~input
    ...
    let request context (request : increase_replication_factor_request) =
      let input =
        Json_serializers.increase_replication_factor_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.IncreaseReplicationFactor" ~service ~context
        ~input
...
module ListTags =
  struct
    ...
    let request context (request : list_tags_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonDAXV3.ListTags"
...
module RebootNode =
  struct
    ...
    let request context (request : reboot_node_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.RebootNode" ~service ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.TagResource" ~service ~context ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.UntagResource" ~service ~context ~input
...
module UpdateCluster =
  struct
    ...
    let request context (request : update_cluster_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.UpdateCluster" ~service ~context ~input
...
module UpdateParameterGroup =
  struct
    ...
    let request context (request : update_parameter_group_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.UpdateParameterGroup" ~service ~context
        ~input
...
module UpdateSubnetGroup =
  struct
    ...
    let request context (request : update_subnet_group_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonDAXV3.UpdateSubnetGroup" ~service ~context ~input
