...
type nonrec update_subnet_group_request =
  ...
  subnet_group_name: string [@ocaml.doc "The name of the subnet group.\n"]}
[@@ocaml.doc ""]
...
type nonrec parameter_name_value =
  {
  parameter_value: string option [@ocaml.doc "The value of the parameter.\n"];
  parameter_name: string option [@ocaml.doc "The name of the parameter.\n"]}
...
type nonrec endpoint =
  ...
  address: string option [@ocaml.doc "The DNS hostname of the endpoint.\n"]}
[@@ocaml.doc
...
type nonrec security_group_membership =
  {
  status: string option [@ocaml.doc "The status of this security group.\n"];
...
type nonrec cluster =
  ...
  status: string option [@ocaml.doc "The current status of the cluster.\n"];
  ...
  description: string option [@ocaml.doc "The description of the cluster.\n"];
  cluster_name: string option [@ocaml.doc "The name of the DAX cluster.\n"]}
...
type nonrec parameter =
  ...
  description: string option [@ocaml.doc "A description of the parameter\n"];
...
type nonrec create_cluster_request =
  ...
  description: string option [@ocaml.doc "A description of the cluster.\n"];
  node_type: string
    [@ocaml.doc
