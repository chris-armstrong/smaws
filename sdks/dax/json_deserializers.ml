  ...
  ({
     availability_zones =
       option_of_yojson
         ...
         _list path;
     new_replication_factor = value_for_key integer_of_yojson "NewReplicationFactor" _list path;
     cluster_name = value_for_key string__of_yojson "ClusterName" _list path;
   }
  ...
  ({
     ...
     availability_zones =
       option_of_yojson
         (value_for_key availability_zone_list_of_yojson "AvailabilityZones")
         _list path;
     replication_factor = value_for_key integer_of_yojson "ReplicationFactor" _list path;
     description = option_of_yojson (value_for_key string__of_yojson "Description") _list path;
