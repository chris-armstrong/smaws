...
let subnet_of_yojson tree path =
  ...
  ({
     subnet_availability_zone =
       (option_of_yojson
          (value_for_key string__of_yojson "SubnetAvailabilityZone") _list
          path);
     subnet_identifier =
       (option_of_yojson (value_for_key string__of_yojson "SubnetIdentifier")
          _list path)
   } : subnet)
let subnet_list_of_yojson tree path =
  list_of_yojson subnet_of_yojson tree path
let subnet_group_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     subnets =
       (option_of_yojson (value_for_key subnet_list_of_yojson "Subnets")
          _list path);
     vpc_id =
     ...
     description =
       (option_of_yojson (value_for_key string__of_yojson "Description")
          _list path);
     subnet_group_name =
       (option_of_yojson (value_for_key string__of_yojson "SubnetGroupName")
          _list path)
   } : subnet_group)
let update_subnet_group_response_of_yojson tree path =
  ...
  ({
     subnet_group =
       (option_of_yojson (value_for_key subnet_group_of_yojson "SubnetGroup")
          _list path)
   } : update_subnet_group_response)
let subnet_identifier_list_of_yojson tree path =
...
let update_subnet_group_request_of_yojson tree path =
  ...
  ({
     subnet_ids =
       (option_of_yojson
          (value_for_key subnet_identifier_list_of_yojson "SubnetIds") _list
          path);
     description =
       (option_of_yojson (value_for_key string__of_yojson "Description")
          _list path);
     subnet_group_name =
       (value_for_key string__of_yojson "SubnetGroupName" _list path)
...
let parameter_group_of_yojson tree path =
  ...
  ({
     ...
     parameter_group_name =
       (option_of_yojson
          (value_for_key string__of_yojson "ParameterGroupName") _list path)
   } : parameter_group)
let update_parameter_group_response_of_yojson tree path =
  ...
  ({
     parameter_group =
       (option_of_yojson
          (value_for_key parameter_group_of_yojson "ParameterGroup") _list
          path)
...
let update_parameter_group_request_of_yojson tree path =
  ...
  ({
     parameter_name_values =
       (value_for_key parameter_name_value_list_of_yojson
          "ParameterNameValues" _list path);
     parameter_group_name =
       (value_for_key string__of_yojson "ParameterGroupName" _list path)
...
let invalid_parameter_value_exception_of_yojson tree path =
  ...
  ({
     message =
       (option_of_yojson
          (value_for_key aws_query_error_message_of_yojson "message") _list
          path)
...
let endpoint_of_yojson tree path =
  ...
  ({
     ...
     port =
       (option_of_yojson (value_for_key integer__of_yojson "Port") _list path);
     address =
       (option_of_yojson (value_for_key string__of_yojson "Address") _list
          path)
   } : endpoint)
let node_identifier_list_of_yojson tree path =
  list_of_yojson string__of_yojson tree path
...
let node_of_yojson tree path =
  ...
  ({
     parameter_group_status =
       (option_of_yojson
          (value_for_key string__of_yojson "ParameterGroupStatus") _list path);
     node_status =
       (option_of_yojson (value_for_key string__of_yojson "NodeStatus") _list
          path);
     availability_zone =
       (option_of_yojson (value_for_key string__of_yojson "AvailabilityZone")
          _list path);
     node_create_time =
       (option_of_yojson (value_for_key t_stamp_of_yojson "NodeCreateTime")
          _list path);
     endpoint =
       (option_of_yojson (value_for_key endpoint_of_yojson "Endpoint") _list
          path);
     node_id =
       (option_of_yojson (value_for_key string__of_yojson "NodeId") _list
          path)
   } : node)
...
let notification_configuration_of_yojson tree path =
  ...
  ({
     topic_status =
       (option_of_yojson (value_for_key string__of_yojson "TopicStatus")
          _list path);
     topic_arn =
       (option_of_yojson (value_for_key string__of_yojson "TopicArn") _list
          path)
...
let security_group_membership_of_yojson tree path =
  ...
  ({
     ...
     security_group_identifier =
       (option_of_yojson
          (value_for_key string__of_yojson "SecurityGroupIdentifier") _list
          path)
...
let parameter_group_status_of_yojson tree path =
  ...
  ({
     node_ids_to_reboot =
       (option_of_yojson
          (value_for_key node_identifier_list_of_yojson "NodeIdsToReboot")
          _list path);
     parameter_apply_status =
       (option_of_yojson
          (value_for_key string__of_yojson "ParameterApplyStatus") _list path);
     parameter_group_name =
       (option_of_yojson
          (value_for_key string__of_yojson "ParameterGroupName") _list path)
   } : parameter_group_status)
...
let cluster_of_yojson tree path =
  ...
  ({
     cluster_endpoint_encryption_type =
       (option_of_yojson
          (value_for_key cluster_endpoint_encryption_type_of_yojson
             "ClusterEndpointEncryptionType") _list path);
     sse_description =
       (option_of_yojson
     ...
     parameter_group =
       (option_of_yojson
          (value_for_key parameter_group_status_of_yojson "ParameterGroup")
          _list path);
     iam_role_arn =
       (option_of_yojson (value_for_key string__of_yojson "IamRoleArn") _list
          path);
     security_groups =
       (option_of_yojson
          (value_for_key security_group_membership_list_of_yojson
             "SecurityGroups") _list path);
     subnet_group =
       (option_of_yojson (value_for_key string__of_yojson "SubnetGroup")
          _list path);
     notification_configuration =
       (option_of_yojson
          (value_for_key notification_configuration_of_yojson
     ...
     node_ids_to_remove =
       (option_of_yojson
          (value_for_key node_identifier_list_of_yojson "NodeIdsToRemove")
          _list path);
     cluster_discovery_endpoint =
       (option_of_yojson
          (value_for_key endpoint_of_yojson "ClusterDiscoveryEndpoint") _list
          path);
     status =
       (option_of_yojson (value_for_key string__of_yojson "Status") _list
          path);
     node_type =
       (option_of_yojson (value_for_key string__of_yojson "NodeType") _list
          path);
     active_nodes =
       (option_of_yojson
          (value_for_key integer_optional_of_yojson "ActiveNodes") _list path);
     total_nodes =
       (option_of_yojson
          (value_for_key integer_optional_of_yojson "TotalNodes") _list path);
     cluster_arn =
       (option_of_yojson (value_for_key string__of_yojson "ClusterArn") _list
          path);
     description =
       (option_of_yojson (value_for_key string__of_yojson "Description")
          _list path);
     cluster_name =
       (option_of_yojson (value_for_key string__of_yojson "ClusterName")
          _list path)
   } : cluster)
let update_cluster_response_of_yojson tree path =
  ...
  ({
     cluster =
       (option_of_yojson (value_for_key cluster_of_yojson "Cluster") _list
          path)
   } : update_cluster_response)
let security_group_identifier_list_of_yojson tree path =
  list_of_yojson string__of_yojson tree path
let update_cluster_request_of_yojson tree path =
  ...
  ({
     security_group_ids =
       (option_of_yojson
          (value_for_key security_group_identifier_list_of_yojson
             "SecurityGroupIds") _list path);
     parameter_group_name =
       (option_of_yojson
          (value_for_key string__of_yojson "ParameterGroupName") _list path);
     notification_topic_status =
       (option_of_yojson
          (value_for_key string__of_yojson "NotificationTopicStatus") _list
          path);
     notification_topic_arn =
       (option_of_yojson
          (value_for_key string__of_yojson "NotificationTopicArn") _list path);
     preferred_maintenance_window =
       (option_of_yojson
          (value_for_key string__of_yojson "PreferredMaintenanceWindow")
          _list path);
     description =
       (option_of_yojson (value_for_key string__of_yojson "Description")
          _list path);
     cluster_name =
       (value_for_key string__of_yojson "ClusterName" _list path)
...
let untag_resource_request_of_yojson tree path =
  ...
  ({
     ...
     resource_name =
       (value_for_key string__of_yojson "ResourceName" _list path)
...
let subnet_group_name_list_of_yojson tree path =
  list_of_yojson string__of_yojson tree path
let subnet_group_list_of_yojson tree path =
  list_of_yojson subnet_group_of_yojson tree path
...
let parameter_of_yojson tree path =
  ...
  ({
     change_type =
       (option_of_yojson (value_for_key change_type_of_yojson "ChangeType")
          _list path);
     is_modifiable =
       (option_of_yojson
          (value_for_key is_modifiable_of_yojson "IsModifiable") _list path);
     allowed_values =
     ...
     node_type_specific_values =
       (option_of_yojson
          (value_for_key node_type_specific_value_list_of_yojson
     ...
     parameter_type =
       (option_of_yojson
          (value_for_key parameter_type_of_yojson "ParameterType") _list path);
     parameter_name =
       (option_of_yojson (value_for_key string__of_yojson "ParameterName")
          _list path)
   } : parameter)
...
let parameter_group_name_list_of_yojson tree path =
  list_of_yojson string__of_yojson tree path
let parameter_group_list_of_yojson tree path =
  list_of_yojson parameter_group_of_yojson tree path
...
let increase_replication_factor_request_of_yojson tree path =
  ...
  ({
     ...
     new_replication_factor =
       (value_for_key integer__of_yojson "NewReplicationFactor" _list path);
     cluster_name =
       (value_for_key string__of_yojson "ClusterName" _list path)
...
let event_of_yojson tree path =
  ...
  ({
     date =
       (option_of_yojson (value_for_key t_stamp_of_yojson "Date") _list path);
     message =
     ...
     source_type =
       (option_of_yojson (value_for_key source_type_of_yojson "SourceType")
          _list path);
     source_name =
       (option_of_yojson (value_for_key string__of_yojson "SourceName") _list
          path)
   } : event)
...
let describe_subnet_groups_response_of_yojson tree path =
  ...
  ({
     subnet_groups =
       (option_of_yojson
          (value_for_key subnet_group_list_of_yojson "SubnetGroups") _list
          path);
     next_token =
       (option_of_yojson (value_for_key string__of_yojson "NextToken") _list
          path)
...
let describe_subnet_groups_request_of_yojson tree path =
  ...
  ({
     ...
     max_results =
       (option_of_yojson
          (value_for_key integer_optional_of_yojson "MaxResults") _list path);
     subnet_group_names =
       (option_of_yojson
...
let describe_parameter_groups_response_of_yojson tree path =
  ...
  ({
     parameter_groups =
       (option_of_yojson
          (value_for_key parameter_group_list_of_yojson "ParameterGroups")
          _list path);
     next_token =
       (option_of_yojson (value_for_key string__of_yojson "NextToken") _list
          path)
...
let describe_parameter_groups_request_of_yojson tree path =
  ...
  ({
     ...
     parameter_group_names =
       (option_of_yojson
          (value_for_key parameter_group_name_list_of_yojson
             "ParameterGroupNames") _list path)
   } : describe_parameter_groups_request)
let describe_events_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     events =
       (option_of_yojson (value_for_key event_list_of_yojson "Events") _list
          path);
     next_token =
       (option_of_yojson (value_for_key string__of_yojson "NextToken") _list
          path)
...
let describe_events_request_of_yojson tree path =
  ...
  ({
     ...
     duration =
       (option_of_yojson
          (value_for_key integer_optional_of_yojson "Duration") _list path);
     end_time =
       (option_of_yojson (value_for_key t_stamp_of_yojson "EndTime") _list
          path);
     start_time =
       (option_of_yojson (value_for_key t_stamp_of_yojson "StartTime") _list
          path);
     source_type =
       (option_of_yojson (value_for_key source_type_of_yojson "SourceType")
          _list path);
...
let cluster_list_of_yojson tree path =
  list_of_yojson cluster_of_yojson tree path
let describe_clusters_response_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     clusters =
       (option_of_yojson (value_for_key cluster_list_of_yojson "Clusters")
          _list path);
     next_token =
       (option_of_yojson (value_for_key string__of_yojson "NextToken") _list
          path)
   } : describe_clusters_response)
let cluster_name_list_of_yojson tree path =
  list_of_yojson string__of_yojson tree path
let describe_clusters_request_of_yojson tree path =
  ...
  ({
     ...
     cluster_names =
       (option_of_yojson
          (value_for_key cluster_name_list_of_yojson "ClusterNames") _list
          path)
...
let delete_subnet_group_response_of_yojson tree path =
  ...
  ({
     deletion_message =
       (option_of_yojson (value_for_key string__of_yojson "DeletionMessage")
          _list path)
...
let create_subnet_group_request_of_yojson tree path =
  ...
  ({
     subnet_ids =
       (value_for_key subnet_identifier_list_of_yojson "SubnetIds" _list path);
     description =
       (option_of_yojson (value_for_key string__of_yojson "Description")
          _list path);
     subnet_group_name =
  ...
  ({
     ...
     availability_zones =
       (option_of_yojson
          ...
          _list path);
     replication_factor =
       (value_for_key integer__of_yojson "ReplicationFactor" _list path);
     description =
       (option_of_yojson (value_for_key string__of_yojson "Description")
          _list path);
