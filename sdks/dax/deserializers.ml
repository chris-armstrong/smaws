  ...
  let _res : subnet =
    {
      ...
      subnet_identifier =
        (option_of_yojson
           (value_for_key string__of_yojson "SubnetIdentifier") _list path)
    } in
  _res
  ...
  let _res : update_subnet_group_response =
    {
      subnet_group =
        (option_of_yojson
           (value_for_key subnet_group_of_yojson "SubnetGroup") _list path)
    } in
  _res
  ...
  let _res : node =
    {
      parameter_group_status =
        (option_of_yojson
           (value_for_key string__of_yojson "ParameterGroupStatus") _list
           path);
      node_status =
        (option_of_yojson (value_for_key string__of_yojson "NodeStatus")
           _list path);
      availability_zone =
        (option_of_yojson
  ...
  let _res : parameter_group_status =
    {
      ...
      parameter_apply_status =
        (option_of_yojson
           (value_for_key string__of_yojson "ParameterApplyStatus") _list
           path);
      parameter_group_name =
        (option_of_yojson
           (value_for_key string__of_yojson "ParameterGroupName") _list path)
  ...
  let _res : cluster =
    {
      ...
      parameter_group =
        (option_of_yojson
           ...
           _list path);
      iam_role_arn =
        (option_of_yojson (value_for_key string__of_yojson "IamRoleArn")
           _list path);
      security_groups =
        (option_of_yojson
      ...
      cluster_discovery_endpoint =
        (option_of_yojson
           (value_for_key endpoint_of_yojson "ClusterDiscoveryEndpoint")
           _list path);
      status =
        (option_of_yojson (value_for_key string__of_yojson "Status") _list
           path);
      ...
      active_nodes =
        (option_of_yojson
           (value_for_key integer_optional_of_yojson "ActiveNodes") _list
           path);
      total_nodes =
        (option_of_yojson
           (value_for_key integer_optional_of_yojson "TotalNodes") _list path);
      cluster_arn =
        (option_of_yojson (value_for_key string__of_yojson "ClusterArn")
           _list path);
      description =
        (option_of_yojson (value_for_key string__of_yojson "Description")
           _list path);
  ...
  let _res : update_cluster_request =
    {
      ...
      notification_topic_arn =
        (option_of_yojson
           (value_for_key string__of_yojson "NotificationTopicArn") _list
           path);
      preferred_maintenance_window =
        (option_of_yojson
           (value_for_key string__of_yojson "PreferredMaintenanceWindow")
...
let sse_specification_of_yojson tree path =
  ...
  let _res : sse_specification =
    { enabled = (value_for_key sse_enabled_of_yojson "Enabled" _list path) } in
  _res
  ...
  let _res : parameter =
    {
      ...
      parameter_type =
        (option_of_yojson
           (value_for_key parameter_type_of_yojson "ParameterType") _list
           path);
      parameter_name =
        (option_of_yojson (value_for_key string__of_yojson "ParameterName")
           _list path)
  ...
  let _res : event =
    {
      ...
      source_type =
        (option_of_yojson (value_for_key source_type_of_yojson "SourceType")
           _list path);
      source_name =
        (option_of_yojson (value_for_key string__of_yojson "SourceName")
           _list path)
    } in
  _res
  ...
  let _res : create_cluster_request =
    {
      ...
      parameter_group_name =
        (option_of_yojson
           (value_for_key string__of_yojson "ParameterGroupName") _list path);
      iam_role_arn =
        (value_for_key string__of_yojson "IamRoleArn" _list path);
      notification_topic_arn =
        (option_of_yojson
           (value_for_key string__of_yojson "NotificationTopicArn") _list
           path);
