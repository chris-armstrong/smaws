...
type nonrec validation_exception_field = {
  ...
  message : error_message; [@ocaml.doc "A message that describes why the field failed validation.\n"]
}
[@@ocaml.doc
...
type nonrec workflow_status = READY [@ocaml.doc ""] | DELETING [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec create_workflow_request = {
  ...
  trigger_mode : generic_string option; [@ocaml.doc "The trigger mode for the workflow execution.\n"]
}
[@@ocaml.doc ""]
...
type nonrec run_type = ON_DEMAND [@ocaml.doc ""] | SCHEDULED [@ocaml.doc ""] [@@ocaml.doc ""]
