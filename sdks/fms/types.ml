...
type nonrec resource_set_status = ACTIVE [@ocaml.doc ""] | OUT_OF_ADMIN_SCOPE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec resource_tag_logical_operator = AND [@ocaml.doc ""] | OR [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec customer_policy_status = ACTIVE [@ocaml.doc ""] | OUT_OF_ADMIN_SCOPE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec customer_policy_scope_id_type = ACCOUNT [@ocaml.doc ""] | ORG_UNIT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec network_acl_rule_action = ALLOW [@ocaml.doc ""] | DENY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec firewall_deployment_model = CENTRALIZED [@ocaml.doc ""] | DISTRIBUTED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec rule_order = STRICT_ORDER [@ocaml.doc ""] | DEFAULT_ACTION_ORDER [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec remediation_action_type = Remove [@ocaml.doc ""] | Modify [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  web_acl_has_incompatible_configuration_violation :
    web_acl_has_incompatible_configuration_violation option;
      [@ocaml.doc
        "The violation details for a web ACL whose configuration is incompatible with the Firewall \
         Manager policy. \n"]
  web_acl_has_out_of_scope_resources_violation : web_acl_has_out_of_scope_resources_violation option;
      [@ocaml.doc
