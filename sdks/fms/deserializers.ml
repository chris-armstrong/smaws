  ...
  let _res : partial_match =
    {
      target_violation_reasons =
        (option_of_yojson
           (value_for_key target_violation_reasons_of_yojson
              "TargetViolationReasons") _list path);
      reference =
        (option_of_yojson
           (value_for_key reference_rule_of_yojson "Reference") _list path)
    } in
  _res
...
let security_group_rule_description_of_yojson tree path =
  ...
  let _res : security_group_rule_description =
    {
      to_port =
        (option_of_yojson (value_for_key ip_port_number_of_yojson "ToPort")
           _list path);
      from_port =
        (option_of_yojson (value_for_key ip_port_number_of_yojson "FromPort")
           _list path);
      protocol =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Protocol") _list
           path);
      prefix_list_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "PrefixListId") _list path);
      ipv6_range =
        (option_of_yojson (value_for_key cid_r_of_yojson "IPV6Range") _list
           path);
      ipv4_range =
        (option_of_yojson (value_for_key cid_r_of_yojson "IPV4Range") _list
           path)
    } in
  _res
  ...
  let _res : security_group_remediation_action =
    {
      is_default_action =
        (option_of_yojson
           (value_for_key boolean__of_yojson "IsDefaultAction") _list path);
      remediation_result =
        (option_of_yojson
           (value_for_key security_group_rule_description_of_yojson
              "RemediationResult") _list path);
      description =
        (option_of_yojson
           (value_for_key remediation_action_description_of_yojson
              "Description") _list path);
      remediation_action_type =
        (option_of_yojson
           (value_for_key remediation_action_type_of_yojson
              "RemediationActionType") _list path)
    } in
  _res
      ...
      possible_security_group_remediation_actions =
        (option_of_yojson
           (value_for_key security_group_remediation_actions_of_yojson
              "PossibleSecurityGroupRemediationActions") _list path);
      partial_matches =
        (option_of_yojson
           (value_for_key partial_matches_of_yojson "PartialMatches") _list
           path);
      violation_target_description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "ViolationTargetDescription") _list path);
      violation_target =
        (option_of_yojson
           (value_for_key violation_target_of_yojson "ViolationTarget") _list
           path)
    } in
  _res
  ...
  let _res : aws_ec2_network_interface_violation =
    {
      violating_security_groups =
        (option_of_yojson
           (value_for_key resource_id_list_of_yojson
              "ViolatingSecurityGroups") _list path);
      violation_target =
        (option_of_yojson
           (value_for_key violation_target_of_yojson "ViolationTarget") _list
           path)
      ...
      aws_ec2_network_interface_violations =
        (option_of_yojson
           (value_for_key aws_ec2_network_interface_violations_of_yojson
              "AwsEc2NetworkInterfaceViolations") _list path);
      violation_target =
        (option_of_yojson
           (value_for_key violation_target_of_yojson "ViolationTarget") _list
           path)
  ...
  let _res : network_firewall_missing_firewall_violation =
    {
      target_violation_reason =
        (option_of_yojson
           (value_for_key target_violation_reason_of_yojson
              "TargetViolationReason") _list path);
      availability_zone =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "AvailabilityZone")
           _list path);
      vp_c =
        (option_of_yojson (value_for_key resource_id_of_yojson "VPC") _list
           path);
      violation_target =
        (option_of_yojson
           (value_for_key violation_target_of_yojson "ViolationTarget") _list
  ...
  let _res : network_firewall_missing_expected_rt_violation =
    {
      expected_route_table =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "ExpectedRouteTable") _list
           path);
      current_route_table =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "CurrentRouteTable") _list
           path);
      availability_zone =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "AvailabilityZone")
  ...
  let _res : stateless_rule_group =
    {
      ...
      rule_group_name =
        (option_of_yojson
           (value_for_key network_firewall_resource_name_of_yojson
              "RuleGroupName") _list path)
    } in
  _res
  ...
  let _res : stateful_rule_group =
    {
      override =
        (option_of_yojson
           (value_for_key
              network_firewall_stateful_rule_group_override_of_yojson
              "Override") _list path);
      priority =
        (option_of_yojson
           (value_for_key priority_number_of_yojson "Priority") _list path);
      resource_id =
        (option_of_yojson (value_for_key resource_id_of_yojson "ResourceId")
           _list path);
      rule_group_name =
  ...
  let _res : stateful_engine_options =
    {
      stream_exception_policy =
        (option_of_yojson
           (value_for_key stream_exception_policy_of_yojson
              "StreamExceptionPolicy") _list path);
      rule_order =
        (option_of_yojson (value_for_key rule_order_of_yojson "RuleOrder")
           _list path)
    } in
  _res
  ...
  let _res : network_firewall_policy_description =
    {
      stateful_engine_options =
        (option_of_yojson
           (value_for_key stateful_engine_options_of_yojson
              "StatefulEngineOptions") _list path);
      stateful_default_actions =
        (option_of_yojson
           (value_for_key network_firewall_action_list_of_yojson
              "StatefulDefaultActions") _list path);
      stateful_rule_groups =
        (option_of_yojson
           (value_for_key stateful_rule_group_list_of_yojson
              "StatefulRuleGroups") _list path);
      stateless_custom_actions =
        (option_of_yojson
           (value_for_key network_firewall_action_list_of_yojson
              "StatelessCustomActions") _list path);
      stateless_fragment_default_actions =
        (option_of_yojson
           (value_for_key network_firewall_action_list_of_yojson
              "StatelessFragmentDefaultActions") _list path);
      stateless_default_actions =
        (option_of_yojson
           (value_for_key network_firewall_action_list_of_yojson
              "StatelessDefaultActions") _list path);
      stateless_rule_groups =
        (option_of_yojson
           (value_for_key stateless_rule_group_list_of_yojson
              "StatelessRuleGroups") _list path)
    } in
  _res
  ...
  let _res : network_firewall_policy_modified_violation =
    {
      expected_policy_description =
        (option_of_yojson
           (value_for_key network_firewall_policy_description_of_yojson
              "ExpectedPolicyDescription") _list path);
      current_policy_description =
        (option_of_yojson
           (value_for_key network_firewall_policy_description_of_yojson
              "CurrentPolicyDescription") _list path);
      violation_target =
        (option_of_yojson
           (value_for_key violation_target_of_yojson "ViolationTarget") _list
           path)
  ...
  let _res : route =
    {
      target =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Target") _list
           path);
      destination =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Destination")
           _list path);
      target_type =
      ...
      destination_type =
        (option_of_yojson
           (value_for_key destination_type_of_yojson "DestinationType") _list
           path)
    } in
  _res
  ...
  let _res : expected_route =
    {
      route_table_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "RouteTableId") _list path);
      allowed_targets =
        (option_of_yojson
           (value_for_key length_bounded_string_list_of_yojson
              "AllowedTargets") _list path);
      contributing_subnets =
        (option_of_yojson
           (value_for_key resource_id_list_of_yojson "ContributingSubnets")
           _list path);
      ip_v6_cidr =
        (option_of_yojson (value_for_key cid_r_of_yojson "IpV6Cidr") _list
           path);
      prefix_list_id =
        (option_of_yojson (value_for_key cid_r_of_yojson "PrefixListId")
           _list path);
      ip_v4_cidr =
        (option_of_yojson (value_for_key cid_r_of_yojson "IpV4Cidr") _list
           path)
    } in
  _res
let expected_routes_of_yojson tree path =
  list_of_yojson expected_route_of_yojson tree path
let network_firewall_internet_traffic_not_inspected_violation_of_yojson tree
  path =
  let _list = assoc_of_yojson tree path in
  let _res : network_firewall_internet_traffic_not_inspected_violation =
    {
      vpc_id =
        (option_of_yojson (value_for_key resource_id_of_yojson "VpcId") _list
           path);
      actual_internet_gateway_routes =
        (option_of_yojson
           (value_for_key routes_of_yojson "ActualInternetGatewayRoutes")
           _list path);
      expected_internet_gateway_routes =
        (option_of_yojson
           (value_for_key expected_routes_of_yojson
              "ExpectedInternetGatewayRoutes") _list path);
      current_internet_gateway_route_table =
        (option_of_yojson
           (value_for_key resource_id_of_yojson
              "CurrentInternetGatewayRouteTable") _list path);
      internet_gateway_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "InternetGatewayId") _list
           path);
      actual_firewall_subnet_routes =
        (option_of_yojson
           (value_for_key routes_of_yojson "ActualFirewallSubnetRoutes")
           _list path);
      expected_firewall_subnet_routes =
        (option_of_yojson
           (value_for_key expected_routes_of_yojson
              "ExpectedFirewallSubnetRoutes") _list path);
      firewall_subnet_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "FirewallSubnetId") _list
           path);
      expected_firewall_endpoint =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "ExpectedFirewallEndpoint")
           _list path);
      current_firewall_subnet_route_table =
        (option_of_yojson
           (value_for_key resource_id_of_yojson
              "CurrentFirewallSubnetRouteTable") _list path);
      is_route_table_used_in_different_a_z =
        (option_of_yojson
           (value_for_key boolean__of_yojson "IsRouteTableUsedInDifferentAZ")
           _list path);
      violating_routes =
        (option_of_yojson (value_for_key routes_of_yojson "ViolatingRoutes")
           _list path);
      route_table_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "RouteTableId") _list path);
      subnet_availability_zone =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "SubnetAvailabilityZone") _list path);
      subnet_id =
        (option_of_yojson (value_for_key resource_id_of_yojson "SubnetId")
           _list path)
    } in
  _res
let network_firewall_invalid_route_configuration_violation_of_yojson tree
  path =
  let _list = assoc_of_yojson tree path in
  let _res : network_firewall_invalid_route_configuration_violation =
    {
      ...
      actual_firewall_subnet_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "ActualFirewallSubnetId")
           _list path);
      expected_firewall_subnet_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "ExpectedFirewallSubnetId")
           _list path);
      actual_firewall_endpoint =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "ActualFirewallEndpoint")
           _list path);
      expected_firewall_endpoint =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "ExpectedFirewallEndpoint")
      ...
      current_firewall_subnet_route_table =
        (option_of_yojson
           (value_for_key resource_id_of_yojson
              "CurrentFirewallSubnetRouteTable") _list path);
      violating_route =
        (option_of_yojson (value_for_key route_of_yojson "ViolatingRoute")
           _list path);
      is_route_table_used_in_different_a_z =
        (option_of_yojson
           (value_for_key boolean__of_yojson "IsRouteTableUsedInDifferentAZ")
      ...
      affected_subnets =
        (option_of_yojson
           (value_for_key resource_id_list_of_yojson "AffectedSubnets") _list
           path)
    } in
  _res
  ...
  let _res : network_firewall_unexpected_firewall_routes_violation =
    {
      ...
      firewall_endpoint =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "FirewallEndpoint") _list
           path);
      route_table_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "RouteTableId") _list path);
  ...
  let _res : network_firewall_unexpected_gateway_routes_violation =
    {
      ...
      violating_routes =
        (option_of_yojson (value_for_key routes_of_yojson "ViolatingRoutes")
           _list path);
      gateway_id =
        (option_of_yojson (value_for_key resource_id_of_yojson "GatewayId")
           _list path)
    } in
  _res
  ...
  let _res : network_firewall_missing_expected_routes_violation =
    {
      ...
      expected_routes =
        (option_of_yojson
           (value_for_key expected_routes_of_yojson "ExpectedRoutes") _list
           path);
      violation_target =
        (option_of_yojson
           (value_for_key violation_target_of_yojson "ViolationTarget") _list
  ...
  let _res : dns_rule_group_priority_conflict_violation =
    {
      unavailable_priorities =
        (option_of_yojson
           (value_for_key dns_rule_group_priorities_of_yojson
              "UnavailablePriorities") _list path);
      conflicting_policy_id =
        (option_of_yojson
           (value_for_key policy_id_of_yojson "ConflictingPolicyId") _list
           path);
      conflicting_priority =
        (option_of_yojson
           (value_for_key dns_rule_group_priority_of_yojson
              "ConflictingPriority") _list path);
      violation_target_description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "ViolationTargetDescription") _list path);
  ...
  let _res : dns_rule_group_limit_exceeded_violation =
    {
      number_of_rule_groups_already_associated =
        (option_of_yojson
           (value_for_key basic_integer_of_yojson
              "NumberOfRuleGroupsAlreadyAssociated") _list path);
      violation_target_description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "ViolationTargetDescription") _list path);
  ...
  let _res : firewall_subnet_is_out_of_scope_violation =
    {
      vpc_endpoint_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "VpcEndpointId") _list path);
      subnet_availability_zone_id =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "SubnetAvailabilityZoneId") _list path);
      subnet_availability_zone =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "SubnetAvailabilityZone") _list path);
  ...
  let _res : route_has_out_of_scope_endpoint_violation =
    {
      internet_gateway_routes =
        (option_of_yojson
           (value_for_key routes_of_yojson "InternetGatewayRoutes") _list
           path);
      current_internet_gateway_route_table =
        (option_of_yojson
           (value_for_key resource_id_of_yojson
      ...
      firewall_subnet_routes =
        (option_of_yojson
           (value_for_key routes_of_yojson "FirewallSubnetRoutes") _list path);
      firewall_subnet_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "FirewallSubnetId") _list
           path);
...
let network_acl_icmp_type_code_of_yojson tree path =
  ...
  let _res : network_acl_icmp_type_code =
    {
      type_ =
        (option_of_yojson (value_for_key integer_object_of_yojson "Type")
           _list path);
      code =
        (option_of_yojson (value_for_key integer_object_of_yojson "Code")
           _list path)
    } in
  _res
  ...
  let _res : network_acl_port_range =
    {
      to_ =
        (option_of_yojson
           (value_for_key ip_port_number_integer_of_yojson "To") _list path);
      from_ =
        (option_of_yojson
           (value_for_key ip_port_number_integer_of_yojson "From") _list path)
    } in
  _res
  ...
  let _res : network_acl_entry =
    {
      ...
      rule_action =
        (value_for_key network_acl_rule_action_of_yojson "RuleAction" _list
           path);
      ipv6_cidr_block =
        (option_of_yojson
           (value_for_key length_bounded_non_empty_string_of_yojson
              "Ipv6CidrBlock") _list path);
      cidr_block =
        (option_of_yojson
           (value_for_key length_bounded_non_empty_string_of_yojson
              "CidrBlock") _list path);
      port_range =
        (option_of_yojson
           (value_for_key network_acl_port_range_of_yojson "PortRange") _list
           path);
      protocol =
        (value_for_key length_bounded_string_of_yojson "Protocol" _list path);
      icmp_type_code =
        (option_of_yojson
...
let entry_description_of_yojson tree path =
  ...
  let _res : entry_description =
    {
      entry_type =
        (option_of_yojson (value_for_key entry_type_of_yojson "EntryType")
           _list path);
      entry_rule_number =
        (option_of_yojson
      ...
      entry_detail =
        (option_of_yojson
           (value_for_key network_acl_entry_of_yojson "EntryDetail") _list
           path)
    } in
  _res
  ...
  let _res : entry_violation =
    {
      entry_violation_reasons =
        (option_of_yojson
           (value_for_key entry_violation_reasons_of_yojson
              "EntryViolationReasons") _list path);
      entries_with_conflicts =
        (option_of_yojson
           (value_for_key entries_with_conflicts_of_yojson
              "EntriesWithConflicts") _list path);
      entry_at_expected_evaluation_order =
        (option_of_yojson
           (value_for_key entry_description_of_yojson
              "EntryAtExpectedEvaluationOrder") _list path);
      actual_evaluation_order =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "ActualEvaluationOrder") _list path);
      expected_evaluation_order =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "ExpectedEvaluationOrder") _list path);
      expected_entry =
        (option_of_yojson
           (value_for_key entry_description_of_yojson "ExpectedEntry") _list
           path)
    } in
  _res
let entry_violations_of_yojson tree path =
  list_of_yojson entry_violation_of_yojson tree path
  ...
  let _res : invalid_network_acl_entries_violation =
    {
      entry_violations =
        (option_of_yojson
           (value_for_key entry_violations_of_yojson "EntryViolations") _list
           path);
      ...
      subnet_availability_zone =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "SubnetAvailabilityZone") _list path);
      subnet =
        (option_of_yojson (value_for_key resource_id_of_yojson "Subnet")
           _list path);
      vpc =
        (option_of_yojson (value_for_key resource_id_of_yojson "Vpc") _list
           path)
  ...
  let _res : action_target =
    {
      description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Description")
           _list path);
      resource_id =
        (option_of_yojson (value_for_key resource_id_of_yojson "ResourceId")
           _list path)
...
let ec2_create_route_action_of_yojson tree path =
  ...
  let _res : ec2_create_route_action =
    {
      route_table_id =
        (value_for_key action_target_of_yojson "RouteTableId" _list path);
      gateway_id =
        (option_of_yojson (value_for_key action_target_of_yojson "GatewayId")
           _list path);
      vpc_endpoint_id =
        (option_of_yojson
           (value_for_key action_target_of_yojson "VpcEndpointId") _list path);
      destination_ipv6_cidr_block =
        (option_of_yojson
           (value_for_key cid_r_of_yojson "DestinationIpv6CidrBlock") _list
           path);
      destination_prefix_list_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "DestinationPrefixListId")
           _list path);
      destination_cidr_block =
        (option_of_yojson
           (value_for_key cid_r_of_yojson "DestinationCidrBlock") _list path);
      description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Description")
           _list path)
  ...
  let _res : ec2_replace_route_table_association_action =
    {
      route_table_id =
        (value_for_key action_target_of_yojson "RouteTableId" _list path);
      association_id =
        (value_for_key action_target_of_yojson "AssociationId" _list path);
      description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Description")
           _list path)
  ...
  let _res : ec2_associate_route_table_action =
    {
      gateway_id =
        (option_of_yojson (value_for_key action_target_of_yojson "GatewayId")
           _list path);
      subnet_id =
        (option_of_yojson (value_for_key action_target_of_yojson "SubnetId")
           _list path);
      route_table_id =
        (value_for_key action_target_of_yojson "RouteTableId" _list path);
      description =
  ...
  let _res : fms_policy_update_firewall_creation_config_action =
    {
      firewall_creation_config =
        (option_of_yojson
           (value_for_key managed_service_data_of_yojson
              "FirewallCreationConfig") _list path);
      description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Description")
           _list path)
  ...
  let _res : create_network_acl_action =
    {
      fms_can_remediate =
        (option_of_yojson
           (value_for_key boolean__of_yojson "FMSCanRemediate") _list path);
      vpc =
        (option_of_yojson (value_for_key action_target_of_yojson "Vpc") _list
           path);
      description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Description")
...
let replace_network_acl_association_action_of_yojson tree path =
  ...
  let _res : replace_network_acl_association_action =
    {
      ...
      network_acl_id =
        (option_of_yojson
           (value_for_key action_target_of_yojson "NetworkAclId") _list path);
      association_id =
        (option_of_yojson
           (value_for_key action_target_of_yojson "AssociationId") _list path);
      description =
  ...
  _res
let entries_description_of_yojson tree path =
  list_of_yojson entry_description_of_yojson tree path
  ...
  let _res : create_network_acl_entries_action =
    {
      ...
      network_acl_entries_to_be_created =
        (option_of_yojson
           (value_for_key entries_description_of_yojson
              "NetworkAclEntriesToBeCreated") _list path);
      network_acl_id =
        (option_of_yojson
           (value_for_key action_target_of_yojson "NetworkAclId") _list path);
      description =
  ...
  let _res : delete_network_acl_entries_action =
    {
      ...
      network_acl_entries_to_be_deleted =
        (option_of_yojson
           (value_for_key entries_description_of_yojson
              "NetworkAclEntriesToBeDeleted") _list path);
      network_acl_id =
        (option_of_yojson
           (value_for_key action_target_of_yojson "NetworkAclId") _list path);
      description =
  ...
  let _res : remediation_action =
    {
      delete_network_acl_entries_action =
        (option_of_yojson
           (value_for_key delete_network_acl_entries_action_of_yojson
              "DeleteNetworkAclEntriesAction") _list path);
      create_network_acl_entries_action =
        (option_of_yojson
           (value_for_key create_network_acl_entries_action_of_yojson
              "CreateNetworkAclEntriesAction") _list path);
      replace_network_acl_association_action =
        (option_of_yojson
           (value_for_key replace_network_acl_association_action_of_yojson
              "ReplaceNetworkAclAssociationAction") _list path);
      create_network_acl_action =
        (option_of_yojson
           (value_for_key create_network_acl_action_of_yojson
              "CreateNetworkAclAction") _list path);
      fms_policy_update_firewall_creation_config_action =
        (option_of_yojson
           (value_for_key
              fms_policy_update_firewall_creation_config_action_of_yojson
              "FMSPolicyUpdateFirewallCreationConfigAction") _list path);
      ec2_create_route_table_action =
        (option_of_yojson
           (value_for_key ec2_create_route_table_action_of_yojson
              "EC2CreateRouteTableAction") _list path);
      ec2_associate_route_table_action =
        (option_of_yojson
           (value_for_key ec2_associate_route_table_action_of_yojson
              "EC2AssociateRouteTableAction") _list path);
      ec2_replace_route_table_association_action =
        (option_of_yojson
           (value_for_key
              ec2_replace_route_table_association_action_of_yojson
              "EC2ReplaceRouteTableAssociationAction") _list path);
      ec2_copy_route_table_action =
        (option_of_yojson
           (value_for_key ec2_copy_route_table_action_of_yojson
              "EC2CopyRouteTableAction") _list path);
      ec2_delete_route_action =
        (option_of_yojson
           (value_for_key ec2_delete_route_action_of_yojson
              "EC2DeleteRouteAction") _list path);
      ec2_replace_route_action =
        (option_of_yojson
           (value_for_key ec2_replace_route_action_of_yojson
              "EC2ReplaceRouteAction") _list path);
      ec2_create_route_action =
        (option_of_yojson
           (value_for_key ec2_create_route_action_of_yojson
              "EC2CreateRouteAction") _list path);
      description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Description")
           _list path)
...
let remediation_action_with_order_of_yojson tree path =
  ...
  let _res : remediation_action_with_order =
    {
      order =
        (option_of_yojson (value_for_key basic_integer_of_yojson "Order")
           _list path);
      remediation_action =
        (option_of_yojson
           (value_for_key remediation_action_of_yojson "RemediationAction")
           _list path)
    } in
  _res
  ...
  let _res : possible_remediation_action =
    {
      ...
      ordered_remediation_actions =
        (value_for_key ordered_remediation_actions_of_yojson
           "OrderedRemediationActions" _list path);
      description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Description")
           _list path)
  ...
  let _res : possible_remediation_actions =
    {
      actions =
        (option_of_yojson
           (value_for_key possible_remediation_action_list_of_yojson
              "Actions") _list path);
      description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson "Description")
      ...
      possible_remediation_actions =
        (option_of_yojson
           (value_for_key possible_remediation_actions_of_yojson
              "PossibleRemediationActions") _list path);
      invalid_network_acl_entries_violation =
        (option_of_yojson
           (value_for_key invalid_network_acl_entries_violation_of_yojson
              "InvalidNetworkAclEntriesViolation") _list path);
      firewall_subnet_missing_vpc_endpoint_violation =
        (option_of_yojson
           (value_for_key
              firewall_subnet_missing_vpc_endpoint_violation_of_yojson
              "FirewallSubnetMissingVPCEndpointViolation") _list path);
      third_party_firewall_missing_expected_route_table_violation =
        (option_of_yojson
           (value_for_key
              third_party_firewall_missing_expected_route_table_violation_of_yojson
              "ThirdPartyFirewallMissingExpectedRouteTableViolation") _list
           path);
      third_party_firewall_missing_subnet_violation =
        (option_of_yojson
           (value_for_key
              third_party_firewall_missing_subnet_violation_of_yojson
              "ThirdPartyFirewallMissingSubnetViolation") _list path);
      third_party_firewall_missing_firewall_violation =
        (option_of_yojson
           (value_for_key
              third_party_firewall_missing_firewall_violation_of_yojson
              "ThirdPartyFirewallMissingFirewallViolation") _list path);
      route_has_out_of_scope_endpoint_violation =
        (option_of_yojson
           (value_for_key route_has_out_of_scope_endpoint_violation_of_yojson
              "RouteHasOutOfScopeEndpointViolation") _list path);
      firewall_subnet_is_out_of_scope_violation =
        (option_of_yojson
           (value_for_key firewall_subnet_is_out_of_scope_violation_of_yojson
              "FirewallSubnetIsOutOfScopeViolation") _list path);
      dns_rule_group_limit_exceeded_violation =
        (option_of_yojson
           (value_for_key dns_rule_group_limit_exceeded_violation_of_yojson
              "DnsRuleGroupLimitExceededViolation") _list path);
      dns_duplicate_rule_group_violation =
        (option_of_yojson
           (value_for_key dns_duplicate_rule_group_violation_of_yojson
              "DnsDuplicateRuleGroupViolation") _list path);
      dns_rule_group_priority_conflict_violation =
        (option_of_yojson
           (value_for_key
              dns_rule_group_priority_conflict_violation_of_yojson
              "DnsRuleGroupPriorityConflictViolation") _list path);
      network_firewall_missing_expected_routes_violation =
        (option_of_yojson
           (value_for_key
              network_firewall_missing_expected_routes_violation_of_yojson
              "NetworkFirewallMissingExpectedRoutesViolation") _list path);
      network_firewall_unexpected_gateway_routes_violation =
        (option_of_yojson
           (value_for_key
              network_firewall_unexpected_gateway_routes_violation_of_yojson
              "NetworkFirewallUnexpectedGatewayRoutesViolation") _list path);
      network_firewall_unexpected_firewall_routes_violation =
        (option_of_yojson
           (value_for_key
              network_firewall_unexpected_firewall_routes_violation_of_yojson
              "NetworkFirewallUnexpectedFirewallRoutesViolation") _list path);
      network_firewall_black_hole_route_detected_violation =
        (option_of_yojson
           (value_for_key
              network_firewall_black_hole_route_detected_violation_of_yojson
              "NetworkFirewallBlackHoleRouteDetectedViolation") _list path);
      network_firewall_invalid_route_configuration_violation =
        (option_of_yojson
           (value_for_key
              network_firewall_invalid_route_configuration_violation_of_yojson
              "NetworkFirewallInvalidRouteConfigurationViolation") _list path);
      network_firewall_internet_traffic_not_inspected_violation =
        (option_of_yojson
           (value_for_key
              network_firewall_internet_traffic_not_inspected_violation_of_yojson
              "NetworkFirewallInternetTrafficNotInspectedViolation") _list
           path);
      network_firewall_policy_modified_violation =
        (option_of_yojson
           (value_for_key
              network_firewall_policy_modified_violation_of_yojson
              "NetworkFirewallPolicyModifiedViolation") _list path);
      network_firewall_missing_expected_rt_violation =
        (option_of_yojson
           (value_for_key
              network_firewall_missing_expected_rt_violation_of_yojson
              "NetworkFirewallMissingExpectedRTViolation") _list path);
      network_firewall_missing_subnet_violation =
        (option_of_yojson
           (value_for_key network_firewall_missing_subnet_violation_of_yojson
              "NetworkFirewallMissingSubnetViolation") _list path);
      network_firewall_missing_firewall_violation =
        (option_of_yojson
           (value_for_key
              network_firewall_missing_firewall_violation_of_yojson
              "NetworkFirewallMissingFirewallViolation") _list path);
      aws_ec2_instance_violation =
        (option_of_yojson
           (value_for_key aws_ec2_instance_violation_of_yojson
              "AwsEc2InstanceViolation") _list path);
      aws_ec2_network_interface_violation =
        (option_of_yojson
           (value_for_key aws_ec2_network_interface_violation_of_yojson
              "AwsEc2NetworkInterfaceViolation") _list path);
      aws_vpc_security_group_violation =
        (option_of_yojson
           (value_for_key aws_vpc_security_group_violation_of_yojson
              "AwsVPCSecurityGroupViolation") _list path)
    } in
  _res
let resource_violations_of_yojson tree path =
  list_of_yojson resource_violation_of_yojson tree path
  ...
  let _res : violation_detail =
    {
      resource_description =
        (option_of_yojson
           (value_for_key length_bounded_string_of_yojson
              "ResourceDescription") _list path);
      resource_tags =
        (option_of_yojson (value_for_key tag_list_of_yojson "ResourceTags")
           _list path);
      resource_violations =
        (value_for_key resource_violations_of_yojson "ResourceViolations"
           _list path);
      resource_type =
      ...
      member_account =
        (value_for_key aws_account_id_of_yojson "MemberAccount" _list path);
  ...
  let _res : third_party_firewall_policy =
    {
      firewall_deployment_model =
        (option_of_yojson
           (value_for_key firewall_deployment_model_of_yojson
              "FirewallDeploymentModel") _list path)
    } in
  _res
  ...
  let _res : third_party_firewall_firewall_policy =
    {
      ...
      firewall_policy_id =
        (option_of_yojson
           (value_for_key firewall_policy_id_of_yojson "FirewallPolicyId")
           _list path)
    } in
  _res
...
let network_firewall_policy_of_yojson tree path =
  ...
  _res
let network_acl_entries_of_yojson tree path =
  list_of_yojson network_acl_entry_of_yojson tree path
  ...
  let _res : network_acl_entry_set =
    {
      force_remediate_for_last_entries =
        (value_for_key boolean_object_of_yojson
           "ForceRemediateForLastEntries" _list path);
      last_entries =
        (option_of_yojson
           (value_for_key network_acl_entries_of_yojson "LastEntries") _list
           path);
      force_remediate_for_first_entries =
        (value_for_key boolean_object_of_yojson
           "ForceRemediateForFirstEntries" _list path);
      first_entries =
        (option_of_yojson
           (value_for_key network_acl_entries_of_yojson "FirstEntries") _list
           path)
    } in
  _res
  ...
  let _res : network_acl_common_policy =
    {
      network_acl_entry_set =
        (value_for_key network_acl_entry_set_of_yojson "NetworkAclEntrySet"
           _list path)
    } in
  _res
  ...
  let _res : policy_option =
    {
      network_acl_common_policy =
        (option_of_yojson
           (value_for_key network_acl_common_policy_of_yojson
              "NetworkAclCommonPolicy") _list path);
      third_party_firewall_policy =
        (option_of_yojson
           (value_for_key third_party_firewall_policy_of_yojson
              "ThirdPartyFirewallPolicy") _list path);
      network_firewall_policy =
        (option_of_yojson
           (value_for_key network_firewall_policy_of_yojson
              "NetworkFirewallPolicy") _list path)
    } in
  _res
  ...
  let _res : security_service_policy_data =
    {
      policy_option =
        (option_of_yojson
           (value_for_key policy_option_of_yojson "PolicyOption") _list path);
      managed_service_data =
        (option_of_yojson
           (value_for_key managed_service_data_of_yojson "ManagedServiceData")
           _list path);
      type_ =
        (value_for_key security_service_type_of_yojson "Type" _list path)
    } in
  _res
  ...
  let _res : resource_set_summary =
    {
      resource_set_status =
        (option_of_yojson
           (value_for_key resource_set_status_of_yojson "ResourceSetStatus")
           _list path);
      last_update_time =
        (option_of_yojson
           (value_for_key time_stamp_of_yojson "LastUpdateTime") _list path);
      description =
      ...
      id =
        (option_of_yojson (value_for_key base62_id_of_yojson "Id") _list path)
    } in
  _res
let resource_set_summary_list_of_yojson tree path =
  list_of_yojson resource_set_summary_of_yojson tree path
let resource_set_ids_of_yojson tree path =
  list_of_yojson base62_id_of_yojson tree path
  ...
  let _res : resource_set =
    {
      ...
      last_update_time =
        (option_of_yojson
           (value_for_key time_stamp_of_yojson "LastUpdateTime") _list path);
      resource_type_list =
        (value_for_key resource_type_list_of_yojson "ResourceTypeList" _list
           path);
      update_token =
        (option_of_yojson
           (value_for_key update_token_of_yojson "UpdateToken") _list path);
      description =
        (option_of_yojson (value_for_key description_of_yojson "Description")
           _list path);
  ...
  let _res : resource =
    {
      account_id =
        (option_of_yojson
           (value_for_key aws_account_id_of_yojson "AccountId") _list path);
      ur_i = (value_for_key identifier_of_yojson "URI" _list path)
    } in
  _res
let resource_list_of_yojson tree path =
...
let aws_region_list_of_yojson tree path =
  list_of_yojson aws_region_of_yojson tree path
  ...
  let _res : region_scope =
    {
      all_regions_enabled =
        (option_of_yojson
           (value_for_key boolean__of_yojson "AllRegionsEnabled") _list path);
      regions =
        (option_of_yojson (value_for_key aws_region_list_of_yojson "Regions")
           _list path)
    } in
  _res
let put_resource_set_response_of_yojson tree path =
  ...
  let _res : put_resource_set_response =
    {
      resource_set_arn =
        (value_for_key resource_arn_of_yojson "ResourceSetArn" _list path);
      resource_set =
        (value_for_key resource_set_of_yojson "ResourceSet" _list path)
    } in
  _res
...
let protocols_list_of_yojson tree path =
  list_of_yojson protocol_of_yojson tree path
let previous_list_version_of_yojson = string_of_yojson
let previous_protocols_list_of_yojson tree path =
  map_of_yojson previous_list_version_of_yojson protocols_list_of_yojson tree
    path
  ...
  let _res : protocols_list_data =
    {
      previous_protocols_list =
        (option_of_yojson
           (value_for_key previous_protocols_list_of_yojson
              "PreviousProtocolsList") _list path);
      protocols_list =
        (value_for_key protocols_list_of_yojson "ProtocolsList" _list path);
      last_update_time =
        (option_of_yojson
           (value_for_key time_stamp_of_yojson "LastUpdateTime") _list path);
      create_time =
        (option_of_yojson (value_for_key time_stamp_of_yojson "CreateTime")
           _list path);
      list_update_token =
        (option_of_yojson
           (value_for_key update_token_of_yojson "ListUpdateToken") _list
           path);
      list_name =
        (value_for_key resource_name_of_yojson "ListName" _list path);
      list_id =
        (option_of_yojson (value_for_key list_id_of_yojson "ListId") _list
           path)
    } in
  _res
  ...
  let _res : put_protocols_list_response =
    {
      protocols_list_arn =
        (option_of_yojson
           (value_for_key resource_arn_of_yojson "ProtocolsListArn") _list
           path);
      protocols_list =
        (option_of_yojson
           (value_for_key protocols_list_data_of_yojson "ProtocolsList")
           _list path)
    } in
  _res
  ...
  let _res : put_protocols_list_request =
    {
      tag_list =
        (option_of_yojson (value_for_key tag_list_of_yojson "TagList") _list
           path);
      protocols_list =
        (value_for_key protocols_list_data_of_yojson "ProtocolsList" _list
           path)
    } in
  _res
  ...
  let _res : policy =
    {
      ...
      resource_set_ids =
        (option_of_yojson
           (value_for_key resource_set_ids_of_yojson "ResourceSetIds") _list
           path);
      exclude_map =
        (option_of_yojson
           (value_for_key customer_policy_scope_map_of_yojson "ExcludeMap")
           _list path);
      include_map =
        (option_of_yojson
           (value_for_key customer_policy_scope_map_of_yojson "IncludeMap")
           _list path);
      delete_unused_fm_managed_resources =
        (option_of_yojson
           ...
           _list path);
      remediation_enabled =
        (value_for_key boolean__of_yojson "RemediationEnabled" _list path);
      exclude_resource_tags =
        (value_for_key boolean__of_yojson "ExcludeResourceTags" _list path);
      resource_tags =
        (option_of_yojson
           (value_for_key resource_tags_of_yojson "ResourceTags") _list path);
      resource_type_list =
        (option_of_yojson
           (value_for_key resource_type_list_of_yojson "ResourceTypeList")
           _list path);
      resource_type =
        (value_for_key resource_type_of_yojson "ResourceType" _list path);
      security_service_policy_data =
        (value_for_key security_service_policy_data_of_yojson
           "SecurityServicePolicyData" _list path);
      policy_update_token =
        (option_of_yojson
           (value_for_key policy_update_token_of_yojson "PolicyUpdateToken")
           _list path);
      policy_name =
        (value_for_key resource_name_of_yojson "PolicyName" _list path);
      policy_id =
        (option_of_yojson (value_for_key policy_id_of_yojson "PolicyId")
           _list path)
    } in
  _res
let put_policy_response_of_yojson tree path =
  ...
  let _res : put_policy_response =
    {
      policy_arn =
        (option_of_yojson (value_for_key resource_arn_of_yojson "PolicyArn")
           _list path);
      policy =
        (option_of_yojson (value_for_key policy_of_yojson "Policy") _list
           path)
    } in
  _res
...
let put_notification_channel_request_of_yojson tree path =
  ...
  let _res : put_notification_channel_request =
    {
      sns_role_name =
        (value_for_key resource_arn_of_yojson "SnsRoleName" _list path);
      sns_topic_arn =
        (value_for_key resource_arn_of_yojson "SnsTopicArn" _list path)
    } in
  _res
  ...
  let _res : apps_list_data =
    {
      previous_apps_list =
        (option_of_yojson
           (value_for_key previous_apps_list_of_yojson "PreviousAppsList")
           _list path);
  ...
  let _res : put_apps_list_response =
    {
      apps_list_arn =
        (option_of_yojson
           (value_for_key resource_arn_of_yojson "AppsListArn") _list path);
      apps_list =
        (option_of_yojson (value_for_key apps_list_data_of_yojson "AppsList")
           _list path)
    } in
  _res
  ...
  let _res : put_apps_list_request =
    {
      tag_list =
        (option_of_yojson (value_for_key tag_list_of_yojson "TagList") _list
           path);
      apps_list =
        (value_for_key apps_list_data_of_yojson "AppsList" _list path)
    } in
  _res
  ...
  let _res : account_scope =
    {
      exclude_specified_accounts =
        (option_of_yojson
           (value_for_key boolean__of_yojson "ExcludeSpecifiedAccounts")
           _list path);
      all_accounts_enabled =
        (option_of_yojson
           (value_for_key boolean__of_yojson "AllAccountsEnabled") _list path);
      accounts =
        (option_of_yojson
           (value_for_key account_id_list_of_yojson "Accounts") _list path)
    } in
  _res
  ...
  let _res : organizational_unit_scope =
    {
      exclude_specified_organizational_units =
        (option_of_yojson
           (value_for_key boolean__of_yojson
              "ExcludeSpecifiedOrganizationalUnits") _list path);
      ...
      organizational_units =
        (option_of_yojson
           (value_for_key organizational_unit_id_list_of_yojson
  ...
  let _res : policy_type_scope =
    {
      all_policy_types_enabled =
        (option_of_yojson
           (value_for_key boolean__of_yojson "AllPolicyTypesEnabled") _list
           path);
      policy_types =
        (option_of_yojson
  ...
  let _res : admin_scope =
    {
      policy_type_scope =
        (option_of_yojson
           (value_for_key policy_type_scope_of_yojson "PolicyTypeScope")
           _list path);
      region_scope =
        (option_of_yojson
           (value_for_key region_scope_of_yojson "RegionScope") _list path);
      organizational_unit_scope =
        (option_of_yojson
           (value_for_key organizational_unit_scope_of_yojson
              "OrganizationalUnitScope") _list path);
      account_scope =
        (option_of_yojson
           (value_for_key account_scope_of_yojson "AccountScope") _list path)
    } in
  _res
let put_admin_account_request_of_yojson tree path =
  ...
  let _res : put_admin_account_request =
    {
      admin_scope =
        (option_of_yojson (value_for_key admin_scope_of_yojson "AdminScope")
           _list path);
      admin_account =
  ...
  let _res : protocols_list_data_summary =
    {
      protocols_list =
        (option_of_yojson
           (value_for_key protocols_list_of_yojson "ProtocolsList") _list
           path);
      list_name =
        (option_of_yojson (value_for_key resource_name_of_yojson "ListName")
           _list path);
      list_id =
        (option_of_yojson (value_for_key list_id_of_yojson "ListId") _list
           path);
      list_arn =
        (option_of_yojson (value_for_key resource_arn_of_yojson "ListArn")
           _list path)
    } in
  _res
  ...
  let _res : policy_summary =
    {
      ...
      security_service_type =
        (option_of_yojson
           (value_for_key security_service_type_of_yojson
              "SecurityServiceType") _list path);
      resource_type =
        (option_of_yojson
           (value_for_key resource_type_of_yojson "ResourceType") _list path);
      policy_name =
  ...
  let _res : evaluation_result =
    {
      evaluation_limit_exceeded =
        (option_of_yojson
           (value_for_key boolean__of_yojson "EvaluationLimitExceeded") _list
           path);
      violator_count =
        (option_of_yojson
           (value_for_key resource_count_of_yojson "ViolatorCount") _list
           path);
      compliance_status =
        (option_of_yojson
           (value_for_key policy_compliance_status_type_of_yojson
              "ComplianceStatus") _list path)
    } in
  _res
  ...
  let _res : policy_compliance_status =
    {
      issue_info_map =
        (option_of_yojson
           (value_for_key issue_info_map_of_yojson "IssueInfoMap") _list path);
      last_updated =
        (option_of_yojson (value_for_key time_stamp_of_yojson "LastUpdated")
           _list path);
      evaluation_results =
        (option_of_yojson
      ...
      member_account =
        (option_of_yojson
           (value_for_key aws_account_id_of_yojson "MemberAccount") _list
           path);
      policy_name =
        (option_of_yojson
           (value_for_key resource_name_of_yojson "PolicyName") _list path);
      ...
      policy_owner =
        (option_of_yojson
           (value_for_key aws_account_id_of_yojson "PolicyOwner") _list path)
    } in
  _res
...
let compliance_violator_metadata_of_yojson tree path =
  map_of_yojson length_bounded_string_of_yojson
    length_bounded_string_of_yojson tree path
  ...
  let _res : compliance_violator =
    {
      metadata =
        (option_of_yojson
           (value_for_key compliance_violator_metadata_of_yojson "Metadata")
           _list path);
      resource_type =
        (option_of_yojson
           (value_for_key resource_type_of_yojson "ResourceType") _list path);
      violation_reason =
        (option_of_yojson
           (value_for_key violation_reason_of_yojson "ViolationReason") _list
           path);
      resource_id =
        (option_of_yojson (value_for_key resource_id_of_yojson "ResourceId")
           _list path)
  ...
  let _res : policy_compliance_detail =
    {
      issue_info_map =
        (option_of_yojson
           (value_for_key issue_info_map_of_yojson "IssueInfoMap") _list path);
      expired_at =
        (option_of_yojson (value_for_key time_stamp_of_yojson "ExpiredAt")
           _list path);
      evaluation_limit_exceeded =
        (option_of_yojson
           (value_for_key boolean__of_yojson "EvaluationLimitExceeded") _list
      ...
      violators =
        (option_of_yojson
           (value_for_key compliance_violators_of_yojson "Violators") _list
           path);
      member_account =
        (option_of_yojson
           (value_for_key aws_account_id_of_yojson "MemberAccount") _list
      ...
      third_party_firewall_firewall_policies =
        (option_of_yojson
           (value_for_key third_party_firewall_firewall_policies_of_yojson
              "ThirdPartyFirewallFirewallPolicies") _list path)
    } in
  _res
let list_third_party_firewall_firewall_policies_request_of_yojson tree path =
  ...
  let _res : list_third_party_firewall_firewall_policies_request =
    {
      max_results =
        (value_for_key pagination_max_results_of_yojson "MaxResults" _list
           path);
      next_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "NextToken") _list path);
      third_party_firewall =
        (value_for_key third_party_firewall_of_yojson "ThirdPartyFirewall"
           _list path)
    } in
  _res
  ...
  let _res : list_resource_sets_request =
    {
      max_results =
        (option_of_yojson
           (value_for_key pagination_max_results_of_yojson "MaxResults")
           _list path);
      next_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "NextToken") _list path)
  ...
  let _res : list_resource_set_resources_request =
    {
      ...
      max_results =
        (option_of_yojson
           ...
           _list path);
      identifier =
        (value_for_key resource_id_of_yojson "Identifier" _list path)
    } in
  _res
  ...
  let _res : list_protocols_lists_response =
    {
      ...
      protocols_lists =
        (option_of_yojson
           (value_for_key protocols_lists_data_of_yojson "ProtocolsLists")
           _list path)
    } in
  _res
  ...
  let _res : list_protocols_lists_request =
    {
      ...
      next_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "NextToken") _list path);
      default_lists =
        (option_of_yojson (value_for_key boolean__of_yojson "DefaultLists")
           _list path)
    } in
  _res
  ...
  let _res : list_policies_response =
    {
      ...
      policy_list =
        (option_of_yojson
           (value_for_key policy_summary_list_of_yojson "PolicyList") _list
           path)
    } in
  _res
  ...
  let _res : list_member_accounts_response =
    {
      ...
      member_accounts =
        (option_of_yojson
           (value_for_key member_accounts_of_yojson "MemberAccounts") _list
           path)
    } in
  _res
  ...
  let _res : discovered_resource =
    {
      name =
        (option_of_yojson (value_for_key resource_name_of_yojson "Name")
           _list path);
      type_ =
        (option_of_yojson (value_for_key resource_type_of_yojson "Type")
           _list path);
      account_id =
        (option_of_yojson
           (value_for_key aws_account_id_of_yojson "AccountId") _list path);
      ur_i =
        (option_of_yojson (value_for_key identifier_of_yojson "URI") _list
           path)
    } in
  _res
  ...
  let _res : list_discovered_resources_response =
    {
      ...
      items =
        (option_of_yojson
           (value_for_key discovered_resource_list_of_yojson "Items") _list
           path)
    } in
  _res
  ...
  let _res : list_discovered_resources_request =
    {
      ...
      resource_type =
        (value_for_key resource_type_of_yojson "ResourceType" _list path);
      member_account_ids =
        (value_for_key aws_account_id_list_of_yojson "MemberAccountIds" _list
           path)
    } in
  _res
  ...
  let _res : list_compliance_status_response =
    {
      ...
      policy_compliance_status_list =
        (option_of_yojson
           (value_for_key policy_compliance_status_list_of_yojson
              "PolicyComplianceStatusList") _list path)
    } in
  _res
...
let apps_list_data_summary_of_yojson tree path =
  ...
  let _res : apps_list_data_summary =
    {
      apps_list =
        (option_of_yojson (value_for_key apps_list_of_yojson "AppsList")
           _list path);
      list_name =
        (option_of_yojson (value_for_key resource_name_of_yojson "ListName")
           _list path);
  ...
  _res
let apps_lists_data_of_yojson tree path =
  list_of_yojson apps_list_data_summary_of_yojson tree path
  ...
  let _res : list_apps_lists_response =
    {
      ...
      apps_lists =
        (option_of_yojson
           (value_for_key apps_lists_data_of_yojson "AppsLists") _list path)
    } in
  _res
  ...
  let _res : list_admins_managing_account_response =
    {
      ...
      admin_accounts =
        (option_of_yojson
           (value_for_key account_id_list_of_yojson "AdminAccounts") _list
           path)
    } in
  _res
  ...
  let _res : admin_account_summary =
    {
      status =
        (option_of_yojson
           (value_for_key organization_status_of_yojson "Status") _list path);
      default_admin =
        (option_of_yojson (value_for_key boolean__of_yojson "DefaultAdmin")
           _list path);
      admin_account =
        (option_of_yojson
           (value_for_key aws_account_id_of_yojson "AdminAccount") _list path)
  ...
  let _res : list_admin_accounts_for_organization_response =
    {
      ...
      admin_accounts =
        (option_of_yojson
           (value_for_key admin_account_summary_list_of_yojson
              "AdminAccounts") _list path)
    } in
  _res
let list_admin_accounts_for_organization_request_of_yojson tree path =
  ...
  _res
let identifier_list_of_yojson tree path =
  list_of_yojson identifier_of_yojson tree path
  ...
  let _res : get_violation_details_response =
    {
      violation_detail =
        (option_of_yojson
           (value_for_key violation_detail_of_yojson "ViolationDetail") _list
           path)
    } in
  _res
  ...
  let _res : get_third_party_firewall_association_status_response =
    {
      marketplace_onboarding_status =
        (option_of_yojson
           (value_for_key
              marketplace_subscription_onboarding_status_of_yojson
              "MarketplaceOnboardingStatus") _list path);
      third_party_firewall_status =
        (option_of_yojson
           (value_for_key third_party_firewall_association_status_of_yojson
              "ThirdPartyFirewallStatus") _list path)
    } in
  _res
...
let get_resource_set_request_of_yojson tree path =
  ...
  let _res : get_resource_set_request =
    {
      identifier =
        (value_for_key base62_id_of_yojson "Identifier" _list path)
    } in
  _res
...
let get_protocols_list_request_of_yojson tree path =
  ...
  let _res : get_protocols_list_request =
    {
      default_list =
        (option_of_yojson (value_for_key boolean__of_yojson "DefaultList")
           _list path);
  ...
  let _res : get_protection_status_response =
    {
      next_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "NextToken") _list path);
      data =
        (option_of_yojson (value_for_key protection_data_of_yojson "Data")
           _list path);
      service_type =
        (option_of_yojson
           (value_for_key security_service_type_of_yojson "ServiceType")
           _list path);
      admin_account_id =
        (option_of_yojson
           (value_for_key aws_account_id_of_yojson "AdminAccountId") _list
           path)
    } in
  _res
  ...
  let _res : get_protection_status_request =
    {
      ...
      next_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "NextToken") _list path);
      end_time =
        (option_of_yojson (value_for_key time_stamp_of_yojson "EndTime")
           _list path);
      start_time =
        (option_of_yojson (value_for_key time_stamp_of_yojson "StartTime")
           _list path);
      member_account_id =
        (option_of_yojson
           (value_for_key aws_account_id_of_yojson "MemberAccountId") _list
           path);
      policy_id = (value_for_key policy_id_of_yojson "PolicyId" _list path)
    } in
  _res
...
let get_policy_request_of_yojson tree path =
  ...
  let _res : get_policy_request =
    { policy_id = (value_for_key policy_id_of_yojson "PolicyId" _list path) } in
  _res
  ...
  let _res : get_compliance_detail_response =
    {
      policy_compliance_detail =
        (option_of_yojson
           (value_for_key policy_compliance_detail_of_yojson
              "PolicyComplianceDetail") _list path)
    } in
  _res
  ...
  let _res : get_admin_account_response =
    {
      role_status =
        (option_of_yojson
           (value_for_key account_role_status_of_yojson "RoleStatus") _list
           path);
      admin_account =
        (option_of_yojson
           (value_for_key aws_account_id_of_yojson "AdminAccount") _list path)
  ...
  let _res : failed_item =
    {
      reason =
        (option_of_yojson
           (value_for_key failed_item_reason_of_yojson "Reason") _list path);
      ur_i =
        (option_of_yojson (value_for_key identifier_of_yojson "URI") _list
           path)
    } in
  _res
let failed_item_list_of_yojson tree path =
  list_of_yojson failed_item_of_yojson tree path
...
let delete_protocols_list_request_of_yojson tree path =
  ...
  let _res : delete_protocols_list_request =
    { list_id = (value_for_key list_id_of_yojson "ListId" _list path) } in
  _res
  ...
  let _res : delete_policy_request =
    {
      delete_all_policy_resources =
        (option_of_yojson
           (value_for_key boolean__of_yojson "DeleteAllPolicyResources")
           _list path);
      policy_id = (value_for_key policy_id_of_yojson "PolicyId" _list path)
    } in
  _res
...
let batch_disassociate_resource_response_of_yojson tree path =
  ...
  let _res : batch_disassociate_resource_response =
    {
      failed_items =
        (value_for_key failed_item_list_of_yojson "FailedItems" _list path);
      resource_set_identifier =
        (value_for_key identifier_of_yojson "ResourceSetIdentifier" _list
           path)
    } in
  _res
