...
let violation_reason_of_yojson (tree : t) path =
  (let _list = assoc_of_yojson tree path in
   (match tree with
    ...
    | `String "FMS_CREATED_SECURITY_GROUP_EDITED" ->
...
let partial_match_of_yojson tree path =
  ...
  ({
     ...
     reference =
       (option_of_yojson (value_for_key reference_rule_of_yojson "Reference")
          _list path)
   } : partial_match)
  ...
  ({
     ...
     protocol =
       (option_of_yojson
          ...
          path);
     prefix_list_id =
       (option_of_yojson (value_for_key resource_id_of_yojson "PrefixListId")
          _list path);
     ipv6_range =
...
let security_group_remediation_action_of_yojson tree path =
  ...
  ({
     is_default_action =
       (option_of_yojson (value_for_key boolean__of_yojson "IsDefaultAction")
          _list path);
     remediation_result =
       (option_of_yojson
     ...
     override =
       (option_of_yojson
          (value_for_key
             ...
             "Override") _list path);
     priority =
       (option_of_yojson (value_for_key priority_number_of_yojson "Priority")
          _list path);
     resource_id =
       (option_of_yojson (value_for_key resource_id_of_yojson "ResourceId")
          _list path);
...
let route_of_yojson tree path =
  ...
  ({
     target =
       (option_of_yojson
          (value_for_key length_bounded_string_of_yojson "Target") _list path);
     destination =
       (option_of_yojson
          (value_for_key length_bounded_string_of_yojson "Destination") _list
          path);
     target_type =
...
let expected_route_of_yojson tree path =
  ...
  ({
     route_table_id =
       (option_of_yojson (value_for_key resource_id_of_yojson "RouteTableId")
          _list path);
     allowed_targets =
       (option_of_yojson
     ...
     ip_v6_cidr =
       (option_of_yojson (value_for_key cid_r_of_yojson "IpV6Cidr") _list
          path);
     prefix_list_id =
       (option_of_yojson (value_for_key cid_r_of_yojson "PrefixListId") _list
          path);
     ip_v4_cidr =
...
let network_firewall_internet_traffic_not_inspected_violation_of_yojson tree
  ...
  ({
     ...
     actual_firewall_subnet_routes =
       (option_of_yojson
          (value_for_key routes_of_yojson "ActualFirewallSubnetRoutes") _list
          path);
     ...
     firewall_subnet_id =
       (option_of_yojson
          (value_for_key resource_id_of_yojson "FirewallSubnetId") _list path);
...
let network_firewall_unexpected_firewall_routes_violation_of_yojson tree path
  ...
  ({
     ...
     firewall_endpoint =
       (option_of_yojson
          (value_for_key resource_id_of_yojson "FirewallEndpoint") _list path);
     route_table_id =
       (option_of_yojson (value_for_key resource_id_of_yojson "RouteTableId")
          _list path);
     violating_routes =
...
let route_has_out_of_scope_endpoint_violation_of_yojson tree path =
  ...
  ({
     internet_gateway_routes =
       (option_of_yojson
          (value_for_key routes_of_yojson "InternetGatewayRoutes") _list path);
     current_internet_gateway_route_table =
       (option_of_yojson
          (value_for_key resource_id_of_yojson
             "CurrentInternetGatewayRouteTable") _list path);
     ...
     subnet_availability_zone =
       (option_of_yojson
          (value_for_key length_bounded_string_of_yojson
             "SubnetAvailabilityZone") _list path);
     subnet =
       (option_of_yojson (value_for_key resource_id_of_yojson "Subnet") _list
          path);
     vpc =
       (option_of_yojson (value_for_key resource_id_of_yojson "Vpc") _list
          path)
...
let create_network_acl_action_of_yojson tree path =
  ...
  ({
     fms_can_remediate =
       (option_of_yojson (value_for_key boolean__of_yojson "FMSCanRemediate")
          _list path);
     vpc =
...
let network_acl_entry_set_of_yojson tree path =
  ...
  ({
     force_remediate_for_last_entries =
       (value_for_key boolean_object_of_yojson "ForceRemediateForLastEntries"
          _list path);
     last_entries =
       (option_of_yojson
  ...
  ({
     ...
     resource_type_list =
       (value_for_key resource_type_list_of_yojson "ResourceTypeList" _list
          path);
     update_token =
       (option_of_yojson (value_for_key update_token_of_yojson "UpdateToken")
          _list path);
     description =
       (option_of_yojson (value_for_key description_of_yojson "Description")
          _list path);
...
let protocols_list_data_of_yojson tree path =
  ...
  ({
     ...
     list_update_token =
       (option_of_yojson
          (value_for_key update_token_of_yojson "ListUpdateToken") _list path);
     list_name =
...
let put_apps_list_response_of_yojson tree path =
  ...
  ({
     apps_list_arn =
       (option_of_yojson (value_for_key resource_arn_of_yojson "AppsListArn")
          _list path);
     apps_list =
...
let account_scope_of_yojson tree path =
  ...
  ({
     exclude_specified_accounts =
       (option_of_yojson
          (value_for_key boolean__of_yojson "ExcludeSpecifiedAccounts") _list
          path);
     all_accounts_enabled =
       (option_of_yojson
          (value_for_key boolean__of_yojson "AllAccountsEnabled") _list path);
     accounts =
       (option_of_yojson (value_for_key account_id_list_of_yojson "Accounts")
          _list path)
   } : account_scope)
...
let admin_scope_of_yojson tree path =
  ...
  ({
     policy_type_scope =
       (option_of_yojson
          (value_for_key policy_type_scope_of_yojson "PolicyTypeScope") _list
          path);
     region_scope =
       (option_of_yojson (value_for_key region_scope_of_yojson "RegionScope")
          _list path);
     organizational_unit_scope =
       (option_of_yojson
  ...
  ({
     ...
     resource_type =
       (option_of_yojson
          (value_for_key resource_type_of_yojson "ResourceType") _list path);
     policy_name =
       (option_of_yojson (value_for_key resource_name_of_yojson "PolicyName")
          _list path);
     policy_id =
       (option_of_yojson (value_for_key policy_id_of_yojson "PolicyId") _list
          path);
...
let evaluation_result_of_yojson tree path =
  ...
  ({
     ...
     violator_count =
       (option_of_yojson
          (value_for_key resource_count_of_yojson "ViolatorCount") _list path);
     compliance_status =
       (option_of_yojson
...
let apps_list_data_summary_of_yojson tree path =
  ...
  ({
     apps_list =
       (option_of_yojson (value_for_key apps_list_of_yojson "AppsList") _list
          path);
     list_name =
       (option_of_yojson (value_for_key resource_name_of_yojson "ListName")
          _list path);
...
let get_protection_status_response_of_yojson tree path =
  ...
  ({
     ...
     service_type =
       (option_of_yojson
          (value_for_key security_service_type_of_yojson "ServiceType") _list
          path);
     admin_account_id =
       (option_of_yojson
  ...
  ({
     ...
     next_token =
       (option_of_yojson
          (value_for_key pagination_token_of_yojson "NextToken") _list path);
     end_time =
       (option_of_yojson (value_for_key time_stamp_of_yojson "EndTime") _list
          path);
     start_time =
...
let get_notification_channel_response_of_yojson tree path =
  ...
  ({
     sns_role_name =
       (option_of_yojson (value_for_key resource_arn_of_yojson "SnsRoleName")
          _list path);
     sns_topic_arn =
       (option_of_yojson (value_for_key resource_arn_of_yojson "SnsTopicArn")
          _list path)
...
let delete_policy_request_of_yojson tree path =
  ...
  ({
     delete_all_policy_resources =
       (option_of_yojson
          (value_for_key boolean__of_yojson "DeleteAllPolicyResources") _list
          path);
     policy_id = (value_for_key policy_id_of_yojson "PolicyId" _list path)
...
let batch_disassociate_resource_response_of_yojson tree path =
  ...
  ({
     ...
     resource_set_identifier =
       (value_for_key identifier_of_yojson "ResourceSetIdentifier" _list path)
