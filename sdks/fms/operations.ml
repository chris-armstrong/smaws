...
module AssociateAdminAccount = struct
  ...
  let request context (request : associate_admin_account_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101AssociateAdminAccount" ~service
...
module AssociateThirdPartyFirewall = struct
  ...
  let request context (request : associate_third_party_firewall_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101AssociateThirdPartyFirewall"
...
module BatchAssociateResource = struct
  ...
  let request context (request : batch_associate_resource_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101BatchAssociateResource" ~service
      ~config:context.config ~http:context.http ~input
...
module BatchDisassociateResource = struct
  ...
  let request context (request : batch_disassociate_resource_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101BatchDisassociateResource"
      ~service ~config:context.config ~http:context.http ~input
...
module DeleteAppsList = struct
  ...
  let request context (request : delete_apps_list_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101DeleteAppsList" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DeleteNotificationChannel = struct
  ...
  let request context (request : delete_notification_channel_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101DeleteNotificationChannel"
      ~service ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DeletePolicy = struct
  ...
  let request context (request : delete_policy_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101DeletePolicy" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DeleteProtocolsList = struct
  ...
  let request context (request : delete_protocols_list_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101DeleteProtocolsList" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DeleteResourceSet = struct
  ...
  let request context (request : delete_resource_set_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101DeleteResourceSet" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DisassociateAdminAccount = struct
  ...
  let request context (request : disassociate_admin_account_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101DisassociateAdminAccount"
      ~service ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DisassociateThirdPartyFirewall = struct
  ...
  let request context (request : disassociate_third_party_firewall_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101DisassociateThirdPartyFirewall"
      ~service ~config:context.config ~http:context.http ~input
...
module GetAdminAccount = struct
  ...
  let request context (request : get_admin_account_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetAdminAccount" ~service
      ~config:context.config ~http:context.http ~input
...
module GetAdminScope = struct
  ...
  let request context (request : get_admin_scope_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetAdminScope" ~service
      ~config:context.config ~http:context.http ~input
...
module GetAppsList = struct
  ...
  let request context (request : get_apps_list_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetAppsList" ~service
      ~config:context.config ~http:context.http ~input
...
module GetComplianceDetail = struct
  ...
  let request context (request : get_compliance_detail_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetComplianceDetail" ~service
      ~config:context.config ~http:context.http ~input
...
module GetNotificationChannel = struct
  ...
  let request context (request : get_notification_channel_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetNotificationChannel" ~service
      ~config:context.config ~http:context.http ~input
...
module GetPolicy = struct
  ...
  let request context (request : get_policy_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetPolicy" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Json_deserializers.get_policy_response_of_yojson ~error_deserializer
end
...
module GetProtectionStatus = struct
  ...
  let request context (request : get_protection_status_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetProtectionStatus" ~service
      ~config:context.config ~http:context.http ~input
...
module GetProtocolsList = struct
  ...
  let request context (request : get_protocols_list_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetProtocolsList" ~service
      ~config:context.config ~http:context.http ~input
...
module GetResourceSet = struct
  ...
  let request context (request : get_resource_set_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetResourceSet" ~service
      ~config:context.config ~http:context.http ~input
...
module GetThirdPartyFirewallAssociationStatus = struct
  ...
  let request context (request : get_third_party_firewall_association_status_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request
      ~shape_name:"AWSFMS_20180101GetThirdPartyFirewallAssociationStatus" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:
...
module GetViolationDetails = struct
  ...
  let request context (request : get_violation_details_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101GetViolationDetails" ~service
      ~config:context.config ~http:context.http ~input
...
module ListAdminAccountsForOrganization = struct
  ...
  let request context (request : list_admin_accounts_for_organization_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request
      ~shape_name:"AWSFMS_20180101ListAdminAccountsForOrganization" ~service ~config:context.config
...
module ListAdminsManagingAccount = struct
  ...
  let request context (request : list_admins_managing_account_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListAdminsManagingAccount"
      ~service ~config:context.config ~http:context.http ~input
...
module ListAppsLists = struct
  ...
  let request context (request : list_apps_lists_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListAppsLists" ~service
      ~config:context.config ~http:context.http ~input
...
module ListComplianceStatus = struct
  ...
  let request context (request : list_compliance_status_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListComplianceStatus" ~service
      ~config:context.config ~http:context.http ~input
...
module ListDiscoveredResources = struct
  ...
  let request context (request : list_discovered_resources_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListDiscoveredResources"
      ~service ~config:context.config ~http:context.http ~input
...
module ListMemberAccounts = struct
  ...
  let request context (request : list_member_accounts_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListMemberAccounts" ~service
      ~config:context.config ~http:context.http ~input
...
module ListPolicies = struct
  ...
  let request context (request : list_policies_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListPolicies" ~service
      ~config:context.config ~http:context.http ~input
...
module ListProtocolsLists = struct
  ...
  let request context (request : list_protocols_lists_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListProtocolsLists" ~service
      ~config:context.config ~http:context.http ~input
...
module ListResourceSetResources = struct
  ...
  let request context (request : list_resource_set_resources_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListResourceSetResources"
      ~service ~config:context.config ~http:context.http ~input
...
module ListResourceSets = struct
  ...
  let request context (request : list_resource_sets_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListResourceSets" ~service
      ~config:context.config ~http:context.http ~input
...
module ListTagsForResource = struct
  ...
  let request context (request : list_tags_for_resource_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101ListTagsForResource" ~service
      ~config:context.config ~http:context.http ~input
...
module ListThirdPartyFirewallFirewallPolicies = struct
  ...
  let request context (request : list_third_party_firewall_firewall_policies_request) =
    ...
    in
    Smaws_Lib.Protocols.AwsJson.request
      ~shape_name:"AWSFMS_20180101ListThirdPartyFirewallFirewallPolicies" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:
...
module PutAdminAccount = struct
  ...
  let request context (request : put_admin_account_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101PutAdminAccount" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module PutAppsList = struct
  ...
  let request context (request : put_apps_list_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101PutAppsList" ~service
      ~config:context.config ~http:context.http ~input
...
module PutNotificationChannel = struct
  ...
  let request context (request : put_notification_channel_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101PutNotificationChannel" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module PutPolicy = struct
  ...
  let request context (request : put_policy_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101PutPolicy" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Json_deserializers.put_policy_response_of_yojson ~error_deserializer
end
...
module PutProtocolsList = struct
  ...
  let request context (request : put_protocols_list_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101PutProtocolsList" ~service
      ~config:context.config ~http:context.http ~input
...
module PutResourceSet = struct
  ...
  let request context (request : put_resource_set_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101PutResourceSet" ~service
      ~config:context.config ~http:context.http ~input
...
module TagResource = struct
  ...
  let request context (request : tag_resource_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101TagResource" ~service
      ~config:context.config ~http:context.http ~input
...
module UntagResource = struct
  ...
  let request context (request : untag_resource_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSFMS_20180101UntagResource" ~service
      ~config:context.config ~http:context.http ~input
