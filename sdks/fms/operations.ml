...
module AssociateAdminAccount =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InternalErrorException") ->
            `InternalErrorException
              (Json_deserializers.internal_error_exception_of_yojson tree
                 path)
        ...
        | (_, "InvalidOperationException") ->
            `InvalidOperationException
              (Json_deserializers.invalid_operation_exception_of_yojson tree
                 path)
    ...
    let request context (request : associate_admin_account_request) =
      let input =
        Json_serializers.associate_admin_account_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.AssociateAdminAccount" ~service ~context
        ~input
...
module AssociateThirdPartyFirewall =
  struct
    ...
    let request context (request : associate_third_party_firewall_request) =
      let input =
        Json_serializers.associate_third_party_firewall_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.AssociateThirdPartyFirewall" ~service
        ~context ~input
...
module BatchAssociateResource =
  struct
    ...
    let request context (request : batch_associate_resource_request) =
      let input =
        Json_serializers.batch_associate_resource_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.BatchAssociateResource" ~service
        ~context ~input
...
module BatchDisassociateResource =
  struct
    ...
    let request context (request : batch_disassociate_resource_request) =
      let input =
        Json_serializers.batch_disassociate_resource_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.BatchDisassociateResource" ~service
        ~context ~input
...
module DeleteAppsList =
  struct
    ...
    let request context (request : delete_apps_list_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.DeleteAppsList" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeleteNotificationChannel =
  struct
    ...
    let request context (request : delete_notification_channel_request) =
      let input =
        Json_serializers.delete_notification_channel_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.DeleteNotificationChannel" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeletePolicy =
  struct
    ...
    let request context (request : delete_policy_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.DeletePolicy" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeleteProtocolsList =
  struct
    ...
    let request context (request : delete_protocols_list_request) =
      let input =
        Json_serializers.delete_protocols_list_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.DeleteProtocolsList" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeleteResourceSet =
  struct
    ...
    let request context (request : delete_resource_set_request) =
      let input =
        Json_serializers.delete_resource_set_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.DeleteResourceSet" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DisassociateAdminAccount =
  struct
    ...
    let request context (request : disassociate_admin_account_request) =
      let input =
        Json_serializers.disassociate_admin_account_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.DisassociateAdminAccount" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DisassociateThirdPartyFirewall =
  struct
    ...
    let request context (request : disassociate_third_party_firewall_request)
      =
      let input =
        Json_serializers.disassociate_third_party_firewall_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.DisassociateThirdPartyFirewall" ~service
        ~context ~input
...
module GetAdminAccount =
  struct
    ...
    let request context (request : get_admin_account_request) =
      let input =
        Json_serializers.get_admin_account_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetAdminAccount" ~service ~context
        ~input
...
module GetAdminScope =
  struct
    ...
    let request context (request : get_admin_scope_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetAdminScope" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_admin_scope_response_of_yojson
        ~error_deserializer
  end
module GetAppsList =
  struct
    ...
    let request context (request : get_apps_list_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetAppsList" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_apps_list_response_of_yojson
        ~error_deserializer
  end
module GetComplianceDetail =
  struct
    ...
    let request context (request : get_compliance_detail_request) =
      let input =
        Json_serializers.get_compliance_detail_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetComplianceDetail" ~service ~context
        ~input
...
module GetNotificationChannel =
  struct
    ...
    let request context (request : get_notification_channel_request) =
      let input =
        Json_serializers.get_notification_channel_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetNotificationChannel" ~service
        ~context ~input
...
module GetPolicy =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidTypeException") ->
            `InvalidTypeException
              (Json_deserializers.invalid_type_exception_of_yojson tree path)
        | (_, "ResourceNotFoundException") ->
            `ResourceNotFoundException
              (Json_deserializers.resource_not_found_exception_of_yojson tree
                 path)
    ...
    let request context (request : get_policy_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetPolicy" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_policy_response_of_yojson
        ~error_deserializer
  end
module GetProtectionStatus =
  struct
    ...
    let request context (request : get_protection_status_request) =
      let input =
        Json_serializers.get_protection_status_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetProtectionStatus" ~service ~context
        ~input
...
module GetProtocolsList =
  struct
    ...
    let request context (request : get_protocols_list_request) =
      let input =
        Json_serializers.get_protocols_list_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetProtocolsList" ~service ~context
        ~input
...
module GetResourceSet =
  struct
    ...
    let request context (request : get_resource_set_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetResourceSet" ~service ~context ~input
...
module GetThirdPartyFirewallAssociationStatus =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.get_third_party_firewall_association_status_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetThirdPartyFirewallAssociationStatus"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_third_party_firewall_association_status_response_of_yojson
        ~error_deserializer
  end
module GetViolationDetails =
  struct
    ...
    let request context (request : get_violation_details_request) =
      let input =
        Json_serializers.get_violation_details_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.GetViolationDetails" ~service ~context
        ~input
...
module ListAdminAccountsForOrganization =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_admin_accounts_for_organization_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListAdminAccountsForOrganization"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_admin_accounts_for_organization_response_of_yojson
        ~error_deserializer
  end
module ListAdminsManagingAccount =
  struct
    ...
    let request context (request : list_admins_managing_account_request) =
      let input =
        Json_serializers.list_admins_managing_account_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListAdminsManagingAccount" ~service
        ~context ~input
...
module ListAppsLists =
  struct
    ...
    let request context (request : list_apps_lists_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListAppsLists" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_apps_lists_response_of_yojson
        ~error_deserializer
  end
module ListComplianceStatus =
  struct
    ...
    let request context (request : list_compliance_status_request) =
      let input =
        Json_serializers.list_compliance_status_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListComplianceStatus" ~service ~context
        ~input
...
module ListDiscoveredResources =
  struct
    ...
    let request context (request : list_discovered_resources_request) =
      let input =
        Json_serializers.list_discovered_resources_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListDiscoveredResources" ~service
        ~context ~input
...
module ListMemberAccounts =
  struct
    ...
    let request context (request : list_member_accounts_request) =
      let input =
        Json_serializers.list_member_accounts_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListMemberAccounts" ~service ~context
        ~input
...
module ListPolicies =
  struct
    ...
    let request context (request : list_policies_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListPolicies" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_policies_response_of_yojson
        ~error_deserializer
  end
module ListProtocolsLists =
  struct
    ...
    let request context (request : list_protocols_lists_request) =
      let input =
        Json_serializers.list_protocols_lists_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListProtocolsLists" ~service ~context
        ~input
...
module ListResourceSetResources =
  struct
    ...
    let request context (request : list_resource_set_resources_request) =
      let input =
        Json_serializers.list_resource_set_resources_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListResourceSetResources" ~service
        ~context ~input
...
module ListResourceSets =
  struct
    ...
    let request context (request : list_resource_sets_request) =
      let input =
        Json_serializers.list_resource_sets_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListResourceSets" ~service ~context
        ~input
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListTagsForResource" ~service ~context
        ~input
...
module ListThirdPartyFirewallFirewallPolicies =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_third_party_firewall_firewall_policies_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.ListThirdPartyFirewallFirewallPolicies"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_third_party_firewall_firewall_policies_response_of_yojson
        ~error_deserializer
  end
module PutAdminAccount =
  struct
    ...
    let request context (request : put_admin_account_request) =
      let input =
        Json_serializers.put_admin_account_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.PutAdminAccount" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module PutAppsList =
  struct
    ...
    let request context (request : put_apps_list_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.PutAppsList" ~service ~context ~input
        ~output_deserializer:Json_deserializers.put_apps_list_response_of_yojson
        ~error_deserializer
  end
module PutNotificationChannel =
  struct
    ...
    let request context (request : put_notification_channel_request) =
      let input =
        Json_serializers.put_notification_channel_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.PutNotificationChannel" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module PutPolicy =
  struct
    ...
    let request context (request : put_policy_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.PutPolicy" ~service ~context ~input
        ~output_deserializer:Json_deserializers.put_policy_response_of_yojson
        ~error_deserializer
  end
module PutProtocolsList =
  struct
    ...
    let request context (request : put_protocols_list_request) =
      let input =
        Json_serializers.put_protocols_list_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.PutProtocolsList" ~service ~context
        ~input
...
module PutResourceSet =
  struct
    ...
    let request context (request : put_resource_set_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.PutResourceSet" ~service ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.TagResource" ~service ~context ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSFMS_20180101.UntagResource" ~service ~context ~input
