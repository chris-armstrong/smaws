...
module DeleteAppsList =
  struct
    ...
    let request context (request : delete_apps_list_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_apps_list_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DisassociateAdminAccount =
  struct
    ...
    let request context (request : disassociate_admin_account_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.disassociate_admin_account_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module GetAdminScope =
  struct
    ...
    let request context (request : get_admin_scope_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_admin_scope_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module GetResourceSet =
  struct
    ...
    let request context (request : get_resource_set_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_resource_set_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module ListAppsLists =
  struct
    ...
    let request context (request : list_apps_lists_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_apps_lists_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module PutResourceSet =
  struct
    ...
    let request context (request : put_resource_set_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.put_resource_set_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
