...
type nonrec web_acl_has_out_of_scope_resources_violation = {
  out_of_scope_resource_list : resource_arn_list option;
      [@ocaml.doc
        "An array of Amazon Resource Name (ARN) for the resources that are out of scope of the \
         policy and are associated with the web ACL. \n"]
  web_acl_arn : resource_arn option; [@ocaml.doc "The Amazon Resource Name (ARN) of the web ACL. \n"]
}
[@@ocaml.doc
  "The violation details for a web ACL that's associated with at least one resource that's out of \
   scope of the Firewall Manager policy. \n"]

type nonrec length_bounded_string = string [@@ocaml.doc ""]

type nonrec web_acl_has_incompatible_configuration_violation = {
  description : length_bounded_string option;
      [@ocaml.doc
        "Information about the problems that Firewall Manager encountered with the web ACL \
         configuration. \n"]
  web_acl_arn : resource_arn option; [@ocaml.doc "The Amazon Resource Name (ARN) of the web ACL. \n"]
}
[@@ocaml.doc
...
type nonrec violation_target = string [@@ocaml.doc ""]

type nonrec violation_reason =
  | WebACLConfigurationOrScopeOfUse [@ocaml.doc ""]
...
type nonrec reference_rule = string [@@ocaml.doc ""]

type nonrec target_violation_reason = string [@@ocaml.doc ""]

type nonrec target_violation_reasons = target_violation_reason list [@@ocaml.doc ""]

type nonrec partial_match = {
  target_violation_reasons : target_violation_reasons option; [@ocaml.doc "The violation reason.\n"]
  reference : reference_rule option;
      [@ocaml.doc
...
type nonrec partial_matches = partial_match list [@@ocaml.doc ""]

type nonrec remediation_action_type = Modify [@ocaml.doc ""] | Remove [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec remediation_action_description = string [@@ocaml.doc ""]
...
type nonrec security_group_rule_description = {
  ...
  from_port : ip_port_number option;
      [@ocaml.doc
        "The start of the port range for the TCP and UDP protocols, or an ICMP/ICMPv6 type number. \
         A value of [-1] indicates all ICMP/ICMPv6 types.\n"]
  protocol : length_bounded_string option;
      [@ocaml.doc "The IP protocol name ([tcp], [udp], [icmp], [icmpv6]) or number.\n"]
  prefix_list_id : resource_id option;
      [@ocaml.doc "The ID of the prefix list for the security group rule.\n"]
  ipv6_range : cid_r option; [@ocaml.doc "The IPv6 ranges for the security group rule.\n"]
  ipv4_range : cid_r option; [@ocaml.doc "The IPv4 ranges for the security group rule.\n"]
}
[@@ocaml.doc "Describes a set of permissions for a security group rule.\n"]

type nonrec boolean_ = bool [@@ocaml.doc ""]

type nonrec security_group_remediation_action = {
  is_default_action : boolean_ option;
  ...
  description : remediation_action_description option;
...
[@@ocaml.doc "Remediation option for the rule specified in the [ViolationTarget].\n"]

type nonrec security_group_remediation_actions = security_group_remediation_action list
[@@ocaml.doc ""]

type nonrec aws_vpc_security_group_violation = {
  possible_security_group_remediation_actions : security_group_remediation_actions option;
      [@ocaml.doc "Remediation options for the rule specified in the [ViolationTarget].\n"]
  partial_matches : partial_matches option;
      [@ocaml.doc
        "List of rules specified in the security group of the Firewall Manager policy that \
         partially match the [ViolationTarget] rule.\n"]
  violation_target_description : length_bounded_string option;
      [@ocaml.doc "A description of the security group that violates the policy.\n"]
  violation_target : violation_target option;
...
type nonrec aws_ec2_network_interface_violation = {
  violating_security_groups : resource_id_list option;
      [@ocaml.doc
        "List of security groups that violate the rules specified in the primary security group of \
         the Firewall Manager policy.\n"]
  violation_target : violation_target option;
      [@ocaml.doc "The resource ID of the network interface.\n"]
}
[@@ocaml.doc "Violation detail for network interfaces associated with an EC2 instance.\n"]

type nonrec aws_ec2_network_interface_violations = aws_ec2_network_interface_violation list
[@@ocaml.doc ""]

type nonrec aws_ec2_instance_violation = {
  aws_ec2_network_interface_violations : aws_ec2_network_interface_violations option;
      [@ocaml.doc "Violation detail for network interfaces associated with the EC2 instance.\n"]
  violation_target : violation_target option; [@ocaml.doc "The resource ID of the EC2 instance.\n"]
}
[@@ocaml.doc "Violation detail for an EC2 instance resource.\n"]

type nonrec network_firewall_missing_firewall_violation = {
  target_violation_reason : target_violation_reason option;
      [@ocaml.doc "The reason the resource has this violation, if one is available. \n"]
  availability_zone : length_bounded_string option;
      [@ocaml.doc "The Availability Zone of a violating subnet. \n"]
  vp_c : resource_id option;
      [@ocaml.doc "The resource ID of the VPC associated with a violating subnet.\n"]
  violation_target : violation_target option;
      [@ocaml.doc "The ID of the Network Firewall or VPC resource that's in violation.\n"]
}
[@@ocaml.doc
...
type nonrec network_firewall_missing_expected_rt_violation = {
  expected_route_table : resource_id option;
      [@ocaml.doc "The resource ID of the route table that should be associated with the subnet.\n"]
  current_route_table : resource_id option;
      [@ocaml.doc
...
type nonrec network_firewall_resource_name = string [@@ocaml.doc ""]

type nonrec stateless_rule_group_priority = int [@@ocaml.doc ""]

type nonrec stateless_rule_group = {
  priority : stateless_rule_group_priority option;
      [@ocaml.doc
  ...
  resource_id : resource_id option; [@ocaml.doc "The resource ID of the rule group.\n"]
  rule_group_name : network_firewall_resource_name option;
      [@ocaml.doc "The name of the rule group.\n"]
}
[@@ocaml.doc
  "Network Firewall stateless rule group, used in a [NetworkFirewallPolicyDescription]. \n"]

type nonrec stateless_rule_group_list = stateless_rule_group list [@@ocaml.doc ""]

type nonrec network_firewall_action = string [@@ocaml.doc ""]

type nonrec network_firewall_action_list = network_firewall_action list [@@ocaml.doc ""]

type nonrec priority_number = int [@@ocaml.doc ""]

type nonrec network_firewall_override_action = DROP_TO_ALERT [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  override : network_firewall_stateful_rule_group_override option;
      [@ocaml.doc
        "The action that allows the policy owner to override the behavior of the rule group within \
         a policy.\n"]
  priority : priority_number option;
      [@ocaml.doc
        "An integer setting that indicates the order in which to run the stateful rule groups in a \
         single Network Firewall firewall policy. This setting only applies to firewall policies \
        ...
        \  Network Firewall evalutes each stateful rule group against a packet starting with the \
         ...
         are unique within each policy. For information about \n\
        \ \n\
        \   You can change the priority settings of your rule groups at any time. To make it \
         easier to insert rule groups later, number them so there's a wide range in between, for \
...
type nonrec stateful_rule_group_list = stateful_rule_group list [@@ocaml.doc ""]
  ...
  stream_exception_policy : stream_exception_policy option;
      [@ocaml.doc
        ...
        \       {-   [CONTINUE] - Continue to apply rules to subsequent traffic without context \
         from traffic before the break. This impacts the behavior of rules that depend on context. \
         For example, with a stateful rule that drops HTTP traffic, Network Firewall won't match \
         subsequent traffic because the it won't have the context from session initialization, \
         which defines the application layer protocol as HTTP. However, a TCP-layer rule using a \
         [flow:stateless] rule would still match, and so would the [aws:drop_strict] default \
         action. \n\
        \           \n\
        \            }\n\
        \       {-   [REJECT] - Fail closed and drop all subsequent traffic going to the firewall. \
         With this option, Network Firewall also sends a TCP reject packet back to the client so \
        ...
        \   For more information, see \
         ...
         exception policy in your firewall policy} in the {i Network Firewall Developer Guide}.\n\
        \   \n\
        \    Default: [FMS_IGNORE] \n\
        \    "]
  rule_order : rule_order option;
      [@ocaml.doc
        "Indicates how to manage the order of stateful rule evaluation for the policy. Stateful \
         ...
         evaluates them based on certain settings. For more information, see \
...
type nonrec network_firewall_policy_description = {
  ...
  stateful_default_actions : network_firewall_action_list option;
      [@ocaml.doc
        ...
        \        }\n\
        \  "]
  stateful_rule_groups : stateful_rule_group_list option;
      [@ocaml.doc
        "The stateful rule groups that are used in the Network Firewall firewall policy. \n"]
  stateless_custom_actions : network_firewall_action_list option;
      [@ocaml.doc
        "Names of custom actions that are available for use in the stateless default actions \
         settings.\n"]
  stateless_fragment_default_actions : network_firewall_action_list option;
      [@ocaml.doc
        "The actions to take on packet fragments that don't match any of the stateless rule groups. \n"]
  stateless_default_actions : network_firewall_action_list option;
      [@ocaml.doc
        "The actions to take on packets that don't match any of the stateless rule groups. \n"]
  stateless_rule_groups : stateless_rule_group_list option;
      [@ocaml.doc
...
type nonrec network_firewall_policy_modified_violation = {
  ...
  current_policy_description : network_firewall_policy_description option;
      [@ocaml.doc "The policy that's currently in use in the individual account. \n"]
  violation_target : violation_target option;
      [@ocaml.doc "The ID of the Network Firewall or VPC resource that's in violation.\n"]
}
[@@ocaml.doc
...
type nonrec route = {
  target : length_bounded_string option; [@ocaml.doc "The route's target.\n"]
  destination : length_bounded_string option; [@ocaml.doc "The destination of the route.\n"]
  target_type : target_type option; [@ocaml.doc "The type of target for the route.\n"]
  destination_type : destination_type option; [@ocaml.doc "The type of destination for the route.\n"]
}
[@@ocaml.doc "Describes a route in a route table.\n"]

type nonrec routes = route list [@@ocaml.doc ""]

type nonrec length_bounded_string_list = length_bounded_string list [@@ocaml.doc ""]

type nonrec expected_route = {
  route_table_id : resource_id option; [@ocaml.doc "Information about the route table ID.\n"]
  allowed_targets : length_bounded_string_list option;
      [@ocaml.doc "Information about the allowed targets.\n"]
  contributing_subnets : resource_id_list option;
      [@ocaml.doc "Information about the contributing subnets.\n"]
  ip_v6_cidr : cid_r option; [@ocaml.doc "Information about the IPv6 CIDR block.\n"]
  prefix_list_id : cid_r option;
      [@ocaml.doc "Information about the ID of the prefix list for the route.\n"]
  ip_v4_cidr : cid_r option; [@ocaml.doc "Information about the IPv4 CIDR block.\n"]
}
[@@ocaml.doc "Information about the expected route in the route table.\n"]

type nonrec expected_routes = expected_route list [@@ocaml.doc ""]

type nonrec network_firewall_internet_traffic_not_inspected_violation = {
  vpc_id : resource_id option; [@ocaml.doc "Information about the VPC ID.\n"]
  actual_internet_gateway_routes : routes option;
      [@ocaml.doc "The actual internet gateway routes.\n"]
  expected_internet_gateway_routes : expected_routes option;
      [@ocaml.doc "The internet gateway routes that are expected.\n"]
  current_internet_gateway_route_table : resource_id option;
      [@ocaml.doc "The current route table for the internet gateway.\n"]
  internet_gateway_id : resource_id option; [@ocaml.doc "The internet gateway ID.\n"]
  actual_firewall_subnet_routes : routes option; [@ocaml.doc "The actual firewall subnet routes.\n"]
  expected_firewall_subnet_routes : expected_routes option;
      [@ocaml.doc "The firewall subnet routes that are expected.\n"]
  firewall_subnet_id : resource_id option; [@ocaml.doc "The firewall subnet ID.\n"]
  expected_firewall_endpoint : resource_id option;
      [@ocaml.doc "The expected endpoint for the current firewall.\n"]
  current_firewall_subnet_route_table : resource_id option;
      [@ocaml.doc "Information about the subnet route table for the current firewall.\n"]
  is_route_table_used_in_different_a_z : boolean_ option;
      [@ocaml.doc
        "Information about whether the route table is used in another Availability Zone.\n"]
  violating_routes : routes option; [@ocaml.doc "The route or routes that are in violation.\n"]
  route_table_id : resource_id option; [@ocaml.doc "Information about the route table ID.\n"]
  subnet_availability_zone : length_bounded_string option;
      [@ocaml.doc "The subnet Availability Zone.\n"]
  subnet_id : resource_id option; [@ocaml.doc "The subnet ID.\n"]
}
[@@ocaml.doc
...
type nonrec network_firewall_invalid_route_configuration_violation = {
  ...
  internet_gateway_id : resource_id option; [@ocaml.doc "The internet gateway ID.\n"]
  actual_firewall_subnet_routes : routes option;
      [@ocaml.doc "The actual firewall subnet routes that are expected.\n"]
  expected_firewall_subnet_routes : expected_routes option;
      [@ocaml.doc "The firewall subnet routes that are expected.\n"]
  actual_firewall_subnet_id : resource_id option;
      [@ocaml.doc "The actual subnet ID for the firewall.\n"]
  expected_firewall_subnet_id : resource_id option;
      [@ocaml.doc "The expected subnet ID for the firewall.\n"]
  actual_firewall_endpoint : resource_id option; [@ocaml.doc "The actual firewall endpoint.\n"]
  expected_firewall_endpoint : resource_id option;
      [@ocaml.doc "The firewall endpoint that's expected.\n"]
  current_firewall_subnet_route_table : resource_id option;
      [@ocaml.doc "The subnet route table for the current firewall.\n"]
  violating_route : route option; [@ocaml.doc "The route that's in violation.\n"]
  is_route_table_used_in_different_a_z : boolean_ option;
      [@ocaml.doc
        "Information about whether the route table is used in another Availability Zone.\n"]
  route_table_id : resource_id option; [@ocaml.doc "The route table ID.\n"]
  affected_subnets : resource_id_list option; [@ocaml.doc "The subnets that are affected.\n"]
}
[@@ocaml.doc
  "Violation detail for the improperly configured subnet route. It's possible there is a missing \
   route table route, or a configuration that causes traffic to cross an Availability Zone \
   boundary.\n"]

type nonrec network_firewall_black_hole_route_detected_violation = {
  violating_routes : routes option;
      [@ocaml.doc "Information about the route or routes that are in violation.\n"]
  vpc_id : resource_id option; [@ocaml.doc "Information about the VPC ID.\n"]
  route_table_id : resource_id option; [@ocaml.doc "Information about the route table ID.\n"]
  violation_target : violation_target option; [@ocaml.doc "The subnet that has an inactive state.\n"]
}
[@@ocaml.doc
  "Violation detail for an internet gateway route with an inactive state in the customer subnet \
   route table or Network Firewall subnet route table.\n"]

type nonrec network_firewall_unexpected_firewall_routes_violation = {
  vpc_id : resource_id option; [@ocaml.doc "Information about the VPC ID.\n"]
  firewall_endpoint : resource_id option; [@ocaml.doc "The endpoint of the firewall.\n"]
  route_table_id : resource_id option; [@ocaml.doc "The ID of the route table.\n"]
  violating_routes : routes option; [@ocaml.doc "The routes that are in violation.\n"]
  firewall_subnet_id : resource_id option; [@ocaml.doc "The subnet ID for the firewall.\n"]
}
[@@ocaml.doc "Violation detail for an unexpected route that's present in a route table.\n"]

type nonrec network_firewall_unexpected_gateway_routes_violation = {
  vpc_id : resource_id option; [@ocaml.doc "Information about the VPC ID.\n"]
  route_table_id : resource_id option; [@ocaml.doc "Information about the route table.\n"]
  violating_routes : routes option; [@ocaml.doc "The routes that are in violation.\n"]
  gateway_id : resource_id option; [@ocaml.doc "Information about the gateway ID.\n"]
}
[@@ocaml.doc
...
type nonrec network_firewall_missing_expected_routes_violation = {
  vpc_id : resource_id option; [@ocaml.doc "Information about the VPC ID.\n"]
  expected_routes : expected_routes option; [@ocaml.doc "The expected routes.\n"]
  violation_target : violation_target option; [@ocaml.doc "The target of the violation.\n"]
}
[@@ocaml.doc "Violation detail for an expected route missing in Network Firewall.\n"]

type nonrec dns_rule_group_priority = int [@@ocaml.doc ""]

type nonrec dns_rule_group_priorities = dns_rule_group_priority list [@@ocaml.doc ""]

type nonrec dns_rule_group_priority_conflict_violation = {
  unavailable_priorities : dns_rule_group_priorities option;
      [@ocaml.doc
  ...
  conflicting_policy_id : policy_id option;
      [@ocaml.doc
  ...
  conflicting_priority : dns_rule_group_priority option;
  ...
  violation_target_description : length_bounded_string option;
      [@ocaml.doc
        "A description of the violation that specifies the VPC and the rule group that's already \
         associated with it.\n"]
  violation_target : violation_target option; [@ocaml.doc "Information about the VPC ID. \n"]
}
[@@ocaml.doc
  "A rule group that Firewall Manager tried to associate with a VPC has the same priority as a \
   rule group that's already associated. \n"]

type nonrec dns_duplicate_rule_group_violation = {
  violation_target_description : length_bounded_string option;
      [@ocaml.doc "A description of the violation that specifies the rule group and VPC.\n"]
  violation_target : violation_target option; [@ocaml.doc "Information about the VPC ID. \n"]
}
[@@ocaml.doc
...
type nonrec basic_integer = int [@@ocaml.doc ""]

type nonrec dns_rule_group_limit_exceeded_violation = {
  number_of_rule_groups_already_associated : basic_integer option;
      [@ocaml.doc "The number of rule groups currently associated with the VPC. \n"]
  violation_target_description : length_bounded_string option;
      [@ocaml.doc "A description of the violation that specifies the rule group and VPC.\n"]
  violation_target : violation_target option; [@ocaml.doc "Information about the VPC ID. \n"]
}
[@@ocaml.doc
  "The VPC that Firewall Manager was applying a DNS Fireall policy to reached the limit for \
   associated DNS Firewall rule groups. Firewall Manager tried to associate another rule group \
   with the VPC and failed due to the limit. \n"]

type nonrec firewall_subnet_is_out_of_scope_violation = {
  vpc_endpoint_id : resource_id option;
      [@ocaml.doc "The VPC endpoint ID of the firewall subnet that violates the policy scope.\n"]
  subnet_availability_zone_id : length_bounded_string option;
      [@ocaml.doc
        "The Availability Zone ID of the firewall subnet that violates the policy scope.\n"]
  subnet_availability_zone : length_bounded_string option;
      [@ocaml.doc "The Availability Zone of the firewall subnet that violates the policy scope.\n"]
  vpc_id : resource_id option;
      [@ocaml.doc "The VPC ID of the firewall subnet that violates the policy scope.\n"]
  firewall_subnet_id : resource_id option;
      [@ocaml.doc "The ID of the firewall subnet that violates the policy scope.\n"]
}
[@@ocaml.doc "Contains details about the firewall subnet that violates the policy scope.\n"]

type nonrec route_has_out_of_scope_endpoint_violation = {
  internet_gateway_routes : routes option;
      [@ocaml.doc "The routes in the route table associated with the Internet Gateway.\n"]
  current_internet_gateway_route_table : resource_id option;
      [@ocaml.doc "The current route table associated with the Internet Gateway.\n"]
  internet_gateway_id : resource_id option; [@ocaml.doc "The ID of the Internet Gateway.\n"]
  firewall_subnet_routes : routes option; [@ocaml.doc "The list of firewall subnet routes.\n"]
  firewall_subnet_id : resource_id option; [@ocaml.doc "The ID of the firewall subnet.\n"]
  current_firewall_subnet_route_table : resource_id option;
      [@ocaml.doc "The route table associated with the current firewall subnet.\n"]
  subnet_availability_zone_id : length_bounded_string option;
  ...
  subnet_id : resource_id option;
      [@ocaml.doc
        "The ID of the subnet associated with the route that violates the policy scope.\n"]
}
[@@ocaml.doc "Contains details about the route endpoint that violates the policy scope.\n"]

type nonrec third_party_firewall_missing_firewall_violation = {
  target_violation_reason : target_violation_reason option;
      [@ocaml.doc "The reason the resource is causing this violation, if a reason is available.\n"]
  availability_zone : length_bounded_string option;
      [@ocaml.doc
        "The Availability Zone of the third-party firewall that's causing the violation.\n"]
  vp_c : resource_id option;
      [@ocaml.doc "The resource ID of the VPC associated with a third-party firewall.\n"]
  violation_target : violation_target option;
      [@ocaml.doc "The ID of the third-party firewall that's causing the violation.\n"]
}
[@@ocaml.doc
  "The violation details about a third-party firewall's subnet that doesn't have a Firewall \
   Manager managed firewall in its VPC.\n"]

type nonrec third_party_firewall_missing_subnet_violation = {
  target_violation_reason : target_violation_reason option;
      [@ocaml.doc "The reason the resource is causing the violation, if a reason is available.\n"]
  availability_zone : length_bounded_string option;
      [@ocaml.doc "The Availability Zone of a subnet that's causing the violation.\n"]
  vp_c : resource_id option;
      [@ocaml.doc
  ...
  current_route_table : resource_id option;
      [@ocaml.doc
        "The resource ID of the current route table that's associated with the subnet, if one is \
         available.\n"]
  availability_zone : length_bounded_string option;
      [@ocaml.doc "The Availability Zone of the firewall subnet that's causing the violation.\n"]
  vp_c : resource_id option;
      [@ocaml.doc
...
type nonrec firewall_subnet_missing_vpc_endpoint_violation = {
  subnet_availability_zone_id : length_bounded_string option;
      [@ocaml.doc "The ID of the Availability Zone of the deleted VPC subnet.\n"]
  subnet_availability_zone : length_bounded_string option;
      [@ocaml.doc "The name of the Availability Zone of the deleted VPC subnet.\n"]
  vpc_id : resource_id option;
      [@ocaml.doc "The resource ID of the VPC associated with the deleted VPC subnet.\n"]
  firewall_subnet_id : resource_id option;
      [@ocaml.doc "The ID of the firewall that this VPC endpoint is associated with.\n"]
}
[@@ocaml.doc
...
type nonrec network_acl_icmp_type_code = {
  type_ : integer_object option; [@ocaml.doc "ICMP type. \n"]
  code : integer_object option; [@ocaml.doc "ICMP code. \n"]
}
[@@ocaml.doc "ICMP protocol: The ICMP type and code.\n"]

type nonrec ip_port_number_integer = int [@@ocaml.doc ""]

type nonrec network_acl_port_range = {
  to_ : ip_port_number_integer option; [@ocaml.doc "The ending port number of the range. \n"]
  from_ : ip_port_number_integer option; [@ocaml.doc "The beginning port number of the range. \n"]
}
[@@ocaml.doc "TCP or UDP protocols: The range of ports the rule applies to.\n"]

type nonrec length_bounded_non_empty_string = string [@@ocaml.doc ""]

type nonrec network_acl_rule_action = DENY [@ocaml.doc ""] | ALLOW [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec network_acl_entry = {
  ...
  rule_action : network_acl_rule_action;
      [@ocaml.doc "Indicates whether to allow or deny the traffic that matches the rule.\n"]
  ipv6_cidr_block : length_bounded_non_empty_string option;
      [@ocaml.doc "The IPv6 network range to allow or deny, in CIDR notation.\n"]
  cidr_block : length_bounded_non_empty_string option;
      [@ocaml.doc "The IPv4 network range to allow or deny, in CIDR notation.\n"]
  port_range : network_acl_port_range option;
      [@ocaml.doc "TCP or UDP protocols: The range of ports the rule applies to.\n"]
  protocol : length_bounded_string;
      [@ocaml.doc "The protocol number. A value of \"-1\" means all protocols. \n"]
...
[@@ocaml.doc
  ...
  \ Each network ACL has a set of numbered ingress rules and a separate set of numbered egress \
   rules. When determining whether a packet should be allowed in or out of a subnet associated \
   with the network ACL, Amazon Web Services processes the entries in the network ACL according to \
  ...
  \  When you manage an individual network ACL, you explicitly specify the rule numbers. When you \
   specify the network ACL rules in a Firewall Manager policy, you provide the rules to run first, \
   in the order that you want them to run, and the rules to run last, in the order that you want \
   them to run. Firewall Manager assigns the rule numbers for you when you save the network ACL \
   policy specification.\n\
  \  "]

type nonrec integer_object_minimum0 = int [@@ocaml.doc ""]
  ...
  entry_type : entry_type option;
      [@ocaml.doc
        "Specifies whether the entry is managed by Firewall Manager or by a user, and, for \
         Firewall Manager-managed entries, specifies whether the entry is among those that run \
         first in the network ACL or those that run last. \n"]
  entry_rule_number : integer_object_minimum0 option;
      [@ocaml.doc
  ...
  entry_detail : network_acl_entry option;
      [@ocaml.doc
        ...
        \ Each network ACL has a set of numbered ingress rules and a separate set of numbered \
         ...
         associated with the network ACL, Amazon Web Services processes the entries in the network \
        ...
        \  When you manage an individual network ACL, you explicitly specify the rule numbers. \
         ...
         rules to run first, in the order that you want them to run, and the rules to run last, in \
         the order that you want them to run. Firewall Manager assigns the rule numbers for you \
         when you save the network ACL policy specification.\n\
        \  "]
}
[@@ocaml.doc "Describes a single rule in a network ACL.\n"]

type nonrec entries_with_conflicts = entry_description list [@@ocaml.doc ""]
...
type nonrec entry_violation_reasons = entry_violation_reason list [@@ocaml.doc ""]

type nonrec entry_violation = {
  entry_violation_reasons : entry_violation_reasons option;
      [@ocaml.doc
        "Descriptions of the violations that Firewall Manager found for these entries. \n"]
  entries_with_conflicts : entries_with_conflicts option;
      [@ocaml.doc "The list of entries that are in conflict with [ExpectedEntry]. \n"]
  entry_at_expected_evaluation_order : entry_description option;
      [@ocaml.doc
        "The entry that's currently in the [ExpectedEvaluationOrder] location, in place of the \
         expected entry. \n"]
  actual_evaluation_order : length_bounded_string option;
      [@ocaml.doc
        "The evaluation location within the ordered list of entries where the [ExpectedEntry] is \
         currently located. \n"]
  expected_evaluation_order : length_bounded_string option;
      [@ocaml.doc
...
[@@ocaml.doc
  "Detailed information about an entry violation in a network ACL. The violation is against the \
   network ACL specification inside the Firewall Manager network ACL policy. This data object is \
   part of [InvalidNetworkAclEntriesViolation].\n"]

type nonrec entry_violations = entry_violation list [@@ocaml.doc ""]

type nonrec invalid_network_acl_entries_violation = {
  entry_violations : entry_violations option;
      [@ocaml.doc "Detailed information about the entry violations in the network ACL. \n"]
  current_associated_network_acl : resource_id option;
      [@ocaml.doc "The network ACL containing the entry violations. \n"]
  subnet_availability_zone : length_bounded_string option;
      [@ocaml.doc "The Availability Zone where the network ACL is in use. \n"]
  subnet : resource_id option; [@ocaml.doc "The subnet that's associated with the network ACL.\n"]
  vpc : resource_id option; [@ocaml.doc "The VPC where the violation was found. \n"]
}
...
type nonrec action_target = {
  ...
  resource_id : resource_id option; [@ocaml.doc "The ID of the remediation target.\n"]
}
[@@ocaml.doc "Describes a remediation action target.\n"]

type nonrec ec2_create_route_action = {
  route_table_id : action_target;
      [@ocaml.doc "Information about the ID of the route table for the route.\n"]
  ...
  vpc_endpoint_id : action_target option;
      [@ocaml.doc
        "Information about the ID of a VPC endpoint. Supported for Gateway Load Balancer endpoints \
         only.\n"]
  destination_ipv6_cidr_block : cid_r option;
      [@ocaml.doc "Information about the IPv6 CIDR block destination.\n"]
  destination_prefix_list_id : resource_id option;
      [@ocaml.doc "Information about the ID of a prefix list used for the destination match.\n"]
  destination_cidr_block : cid_r option;
      [@ocaml.doc "Information about the IPv4 CIDR address block used for the destination match.\n"]
  description : length_bounded_string option;
...
type nonrec ec2_replace_route_action = {
  route_table_id : action_target; [@ocaml.doc "Information about the ID of the route table.\n"]
  gateway_id : action_target option;
      [@ocaml.doc "Information about the ID of an internet gateway or virtual private gateway.\n"]
  destination_ipv6_cidr_block : cid_r option;
      [@ocaml.doc
...
type nonrec ec2_delete_route_action = {
  ...
  destination_ipv6_cidr_block : cid_r option;
      [@ocaml.doc
        "Information about the IPv6 CIDR range for the route. The value you specify must match the \
         CIDR for the route exactly.\n"]
  destination_prefix_list_id : resource_id option;
      [@ocaml.doc "Information about the ID of the prefix list for the route.\n"]
  destination_cidr_block : cid_r option;
      [@ocaml.doc
        "Information about the IPv4 CIDR range for the route. The value you specify must match the \
         CIDR for the route exactly.\n"]
  description : length_bounded_string option;
      [@ocaml.doc "A description of the DeleteRoute action.\n"]
}
[@@ocaml.doc "Information about the DeleteRoute action in Amazon EC2.\n"]
...
[@@ocaml.doc "An action that copies the EC2 route table for use in remediation.\n"]

type nonrec ec2_replace_route_table_association_action = {
  route_table_id : action_target;
      [@ocaml.doc "Information about the ID of the new route table to associate with the subnet.\n"]
  association_id : action_target; [@ocaml.doc "Information about the association ID.\n"]
  description : length_bounded_string option;
      [@ocaml.doc "A description of the ReplaceRouteTableAssociation action in Amazon EC2.\n"]
}
[@@ocaml.doc "Information about the ReplaceRouteTableAssociation action in Amazon EC2.\n"]
  ...
  subnet_id : action_target option;
      [@ocaml.doc
        "The ID of the subnet for the EC2 route table that is associated with the remediation \
         action.\n"]
  route_table_id : action_target;
      [@ocaml.doc "The ID of the EC2 route table that is associated with the remediation action.\n"]
  description : length_bounded_string option;
      [@ocaml.doc
        "A description of the EC2 route table that is associated with the remediation action.\n"]
}
[@@ocaml.doc
  "The action of associating an EC2 resource, such as a subnet or internet gateway, with a route \
   table.\n"]
...
[@@ocaml.doc "Information about the CreateRouteTable action in Amazon EC2.\n"]

type nonrec managed_service_data = string [@@ocaml.doc ""]

type nonrec fms_policy_update_firewall_creation_config_action = {
  firewall_creation_config : managed_service_data option;
      [@ocaml.doc
  ...
  description : length_bounded_string option; [@ocaml.doc "Describes the remedial action.\n"]
}
[@@ocaml.doc
  "Contains information about the actions that you can take to remediate scope violations caused \
   by your policy's [FirewallCreationConfig]. [FirewallCreationConfig] is an optional \
   configuration that you can use to choose which Availability Zones Firewall Manager creates \
   Network Firewall endpoints in.\n"]

type nonrec create_network_acl_action = {
  fms_can_remediate : boolean_ option;
      [@ocaml.doc
        "Indicates whether it is possible for Firewall Manager to perform this remediation action. \
         A false value indicates that auto remediation is disabled or Firewall Manager is unable \
         to perform the action due to a conflict of some kind.\n"]
...
type nonrec replace_network_acl_association_action = {
  ...
  network_acl_id : action_target option;
      [@ocaml.doc "The network ACL that's associated with the remediation action.\n"]
  association_id : action_target option; [@ocaml.doc ""]
  description : length_bounded_string option;
      [@ocaml.doc "Brief description of this remediation action. \n"]
}
[@@ocaml.doc
  "Information about the [ReplaceNetworkAclAssociation] action in Amazon EC2. This is a \
   remediation option in [RemediationAction].\n"]

type nonrec entries_description = entry_description list [@@ocaml.doc ""]
  ...
  fms_can_remediate : boolean_ option;
      [@ocaml.doc
        "Indicates whether it is possible for Firewall Manager to perform this remediation action. \
         A false value indicates that auto remediation is disabled or Firewall Manager is unable \
         to perform the action due to a conflict of some kind.\n"]
  network_acl_entries_to_be_created : entries_description option;
      [@ocaml.doc "Lists the entries that the remediation action would create.\n"]
  network_acl_id : action_target option;
      [@ocaml.doc "The network ACL that's associated with the remediation action.\n"]
  description : length_bounded_string option;
      [@ocaml.doc "Brief description of this remediation action. \n"]
...
[@@ocaml.doc
  "Information about the [CreateNetworkAclEntries] action in Amazon EC2. This is a remediation \
  ...
  fms_can_remediate : boolean_ option;
      [@ocaml.doc
        "Indicates whether it is possible for Firewall Manager to perform this remediation action. \
         A false value indicates that auto remediation is disabled or Firewall Manager is unable \
         to perform the action due to a conflict of some kind.\n"]
  network_acl_entries_to_be_deleted : entries_description option;
      [@ocaml.doc "Lists the entries that the remediation action would delete.\n"]
  network_acl_id : action_target option;
      [@ocaml.doc "The network ACL that's associated with the remediation action.\n"]
  description : length_bounded_string option;
      [@ocaml.doc "Brief description of this remediation action. \n"]
...
[@@ocaml.doc
  "Information about the [DeleteNetworkAclEntries] action in Amazon EC2. This is a remediation \
   option in [RemediationAction]. \n"]

type nonrec remediation_action = {
  delete_network_acl_entries_action : delete_network_acl_entries_action option;
      [@ocaml.doc "Information about the [DeleteNetworkAclEntries] action in Amazon EC2.\n"]
  create_network_acl_entries_action : create_network_acl_entries_action option;
      [@ocaml.doc "Information about the [CreateNetworkAclEntries] action in Amazon EC2.\n"]
  replace_network_acl_association_action : replace_network_acl_association_action option;
      [@ocaml.doc "Information about the [ReplaceNetworkAclAssociation] action in Amazon EC2. \n"]
  create_network_acl_action : create_network_acl_action option;
      [@ocaml.doc "Information about the [CreateNetworkAcl] action in Amazon EC2.\n"]
  fms_policy_update_firewall_creation_config_action :
    fms_policy_update_firewall_creation_config_action option;
      [@ocaml.doc "The remedial action to take when updating a firewall configuration.\n"]
  ec2_create_route_table_action : ec2_create_route_table_action option;
      [@ocaml.doc "Information about the CreateRouteTable action in the Amazon EC2 API.\n"]
  ec2_associate_route_table_action : ec2_associate_route_table_action option;
      [@ocaml.doc "Information about the AssociateRouteTable action in the Amazon EC2 API.\n"]
  ...
  ec2_copy_route_table_action : ec2_copy_route_table_action option;
      [@ocaml.doc "Information about the CopyRouteTable action in the Amazon EC2 API.\n"]
  ec2_delete_route_action : ec2_delete_route_action option;
      [@ocaml.doc "Information about the DeleteRoute action in the Amazon EC2 API.\n"]
  ec2_replace_route_action : ec2_replace_route_action option;
      [@ocaml.doc "Information about the ReplaceRoute action in the Amazon EC2 API.\n"]
  ec2_create_route_action : ec2_create_route_action option;
      [@ocaml.doc "Information about the CreateRoute action in the Amazon EC2 API.\n"]
  description : length_bounded_string option; [@ocaml.doc "A description of a remediation action.\n"]
}
[@@ocaml.doc "Information about an individual action you can take to remediate a violation.\n"]

type nonrec remediation_action_with_order = {
  order : basic_integer option; [@ocaml.doc "The order of the remediation actions in the list.\n"]
  remediation_action : remediation_action option;
      [@ocaml.doc "Information about an action you can take to remediate a violation.\n"]
}
[@@ocaml.doc "An ordered list of actions you can take to remediate a violation.\n"]

type nonrec ordered_remediation_actions = remediation_action_with_order list [@@ocaml.doc ""]
...
type nonrec possible_remediation_action_list = possible_remediation_action list [@@ocaml.doc ""]

type nonrec possible_remediation_actions = {
  actions : possible_remediation_action_list option; [@ocaml.doc "Information about the actions.\n"]
  description : length_bounded_string option;
      [@ocaml.doc "A description of the possible remediation actions list.\n"]
}
[@@ocaml.doc
  "A list of possible remediation action lists. Each individual possible remediation action is a \
   list of individual remediation actions.\n"]
...
type nonrec resource_violation = {
  ...
  third_party_firewall_missing_firewall_violation :
    third_party_firewall_missing_firewall_violation option;
      [@ocaml.doc "The violation details for a third-party firewall that's been deleted.\n"]
  ...
  dns_rule_group_limit_exceeded_violation : dns_rule_group_limit_exceeded_violation option;
      [@ocaml.doc
        "Violation detail for a DNS Firewall policy that indicates that the VPC reached the limit \
         for associated DNS Firewall rule groups. Firewall Manager tried to associate another rule \
         group with the VPC and failed. \n"]
  dns_duplicate_rule_group_violation : dns_duplicate_rule_group_violation option;
      [@ocaml.doc
        "Violation detail for a DNS Firewall policy that indicates that a rule group that Firewall \
         Manager tried to associate with a VPC is already associated with the VPC and can't be \
         associated again. \n"]
  ...
  network_firewall_policy_modified_violation : network_firewall_policy_modified_violation option;
      [@ocaml.doc
        "Violation detail for an Network Firewall policy that indicates that a firewall policy in \
         an individual account has been modified in a way that makes it noncompliant. For example, \
         the individual account owner might have deleted a rule group, changed the priority of a \
  ...
  network_firewall_missing_subnet_violation : network_firewall_missing_subnet_violation option;
      [@ocaml.doc
        "Violation detail for an Network Firewall policy that indicates that an Availability Zone \
         is missing the expected Firewall Manager managed subnet.\n"]
...
type nonrec resource_violations = resource_violation list [@@ocaml.doc ""]
...
[@@ocaml.doc
  "A collection of key:value pairs associated with an Amazon Web Services resource. The key:value \
   ...
   \"test,\" \"development,\" or \"production\"). You can add up to 50 tags to each Amazon Web \
   Services resource. \n"]

type nonrec tag_list = tag list [@@ocaml.doc ""]

type nonrec violation_detail = {
  resource_description : length_bounded_string option;
  ...
  resource_type : resource_type;
      [@ocaml.doc "The resource type that the violation details were requested for.\n"]
  resource_id : resource_id;
      [@ocaml.doc "The resource ID that the violation details were requested for.\n"]
...
[@@ocaml.doc
  "Violations for a resource based on the specified Firewall Manager policy and Amazon Web \
   Services account.\n"]
...
[@@ocaml.doc
  "The operation failed because there was nothing to do or the operation wasn't possible. For \
   example, you might have submitted an [AssociateAdminAccount] request for an account ID that was \
   already set as the Firewall Manager administrator. Or you might have tried to access a Region \
   that's disabled by default, and that you need to enable for the Firewall Manager administrator \
...
[@@ocaml.doc "The parameters of the request were invalid.\n"]
...
type nonrec firewall_deployment_model = DISTRIBUTED [@ocaml.doc ""] | CENTRALIZED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec third_party_firewall_policy = {
  firewall_deployment_model : firewall_deployment_model option;
      [@ocaml.doc "Defines the deployment model to use for the third-party firewall policy.\n"]
}
[@@ocaml.doc "Configures the deployment model for the third-party firewall.\n"]

type nonrec firewall_policy_id = string [@@ocaml.doc ""]

type nonrec firewall_policy_name = string [@@ocaml.doc ""]

type nonrec third_party_firewall_firewall_policy = {
  firewall_policy_name : firewall_policy_name option;
      [@ocaml.doc "The name of the specified firewall policy.\n"]
  firewall_policy_id : firewall_policy_id option;
      [@ocaml.doc "The ID of the specified firewall policy.\n"]
}
[@@ocaml.doc "Configures the third-party firewall's firewall policy.\n"]

type nonrec third_party_firewall_firewall_policies = third_party_firewall_firewall_policy list
[@@ocaml.doc ""]
...
type nonrec tag_resource_request = {
  tag_list : tag_list; [@ocaml.doc "The tags to add to the resource.\n"]
  resource_arn : resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the resource to return tags for. The Firewall Manager \
         resources that support tagging are policies, applications lists, and protocols lists. \n"]
...
[@@ocaml.doc
  "The operation exceeds a resource limit, for example, the maximum number of [policy] objects \
   that you can create for an Amazon Web Services account. For more information, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/fms-limits.html}Firewall Manager \
   Limits} in the {i WAF Developer Guide}.\n"]
...
type nonrec security_service_type_list = security_service_type list [@@ocaml.doc ""]
...
[@@ocaml.doc
  "Configures the firewall policy deployment model of Network Firewall. For information about \
   Network Firewall deployment models, see \
   {{:https://docs.aws.amazon.com/network-firewall/latest/developerguide/architectures.html}Network \
   Firewall example architectures with routing} in the {i Network Firewall Developer Guide}.\n"]

type nonrec network_acl_entries = network_acl_entry list [@@ocaml.doc ""]

type nonrec network_acl_entry_set = {
  force_remediate_for_last_entries : boolean_object;
      [@ocaml.doc
        "Applies only when remediation is enabled for the policy as a whole. Firewall Manager uses \
         this setting when it finds policy violations that involve conflicts between the custom \
         entries and the policy entries. \n\n\
        \ If forced remediation is disabled, Firewall Manager marks the network ACL as \
         noncompliant and does not try to remediate. For more information about the remediation \
         behavior, see \
        ...
        \ "]
  last_entries : network_acl_entries option;
      [@ocaml.doc
  ...
  force_remediate_for_first_entries : boolean_object;
      [@ocaml.doc
        ...
        \ If forced remediation is disabled, Firewall Manager marks the network ACL as \
         ...
         for managed network ACLs} in the {i Firewall Manager Developer Guide}.\n\
        \ "]
  first_entries : network_acl_entries option;
      [@ocaml.doc
...
type nonrec network_acl_common_policy = {
  network_acl_entry_set : network_acl_entry_set;
      [@ocaml.doc "The definition of the first and last rules for the network ACL policy. \n"]
}
[@@ocaml.doc
  ...
  \ For information about network ACLs, see \
   {{:https://docs.aws.amazon.com/vpc/latest/userguide/vpc-network-acls.html}Control traffic to \
   subnets using network ACLs} in the {i Amazon Virtual Private Cloud User Guide}. \n\
  \ "]
...
type nonrec policy_option = {
  ...
  third_party_firewall_policy : third_party_firewall_policy option;
      [@ocaml.doc "Defines the policy options for a third-party firewall policy.\n"]
  network_firewall_policy : network_firewall_policy option;
      [@ocaml.doc "Defines the deployment model to use for the firewall policy.\n"]
}
[@@ocaml.doc
...
type nonrec security_service_policy_data = {
  ...
  managed_service_data : managed_service_data option;
      [@ocaml.doc
        ...
        \              With automatic Availbility Zone configuration, Firewall Manager chooses \
         which Availability Zones to create the endpoints in. To use the distributed deployment \
         model, you must set \
         {{:https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_PolicyOption.html}PolicyOption} \
         to [NULL]. \n\
        \             \n\
        ...
        \              With custom Availability Zone configuration, you define which specific \
         Availability Zones to create endpoints in by configuring [firewallCreationConfig]. To \
         configure the Availability Zones in [firewallCreationConfig], specify either the \
         [availabilityZoneName] or [availabilityZoneId] parameter, not both parameters. \n\
        \             \n\
        \              To use the distributed deployment model, you must set \
         {{:https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_PolicyOption.html}PolicyOption} \
         to [NULL]. \n\
        ...
        \              Firewall Manager automatically distributes tags from the primary group to \
         the security groups created by this policy. To use security group tag distribution, you \
         must also set [revertManualSecurityGroupChanges] to [true], otherwise Firewall Manager \
         won't be able to create the policy. When you enable [revertManualSecurityGroupChanges], \
        ...
        \               Firewall Manager won't distribute system tags added by Amazon Web Services \
         services into the replica security groups. System tags begin with the [aws:] prefix. \n\
        \              \n\
        \               }\n\
        ...
        \             The security group action for content audit can be [ALLOW] or [DENY]. For \
         ...
         policy's security group rules. For [DENY], all in-scope security group rules must not \
         contain a value or a range that matches a rule value or range in the policy security \
         group.\n\
        \             \n\
        \              }\n\
        ...
        \             If you set [optimizeUnassociatedWebACL] to [true], Firewall Manager creates \
         web ACLs in accounts within the policy scope if the web ACLs will be used by at least one \
         resource. Firewall Manager creates web ACLs in the accounts within policy scope only if \
         the web ACLs will be used by at least one resource. If at any time an account comes into \
         policy scope, Firewall Manager automatically creates a web ACL in the account if at least \
         one resource will use the web ACL.\n\
        \             \n\
        \              Upon enablement, Firewall Manager performs a one-time cleanup of unused web \
         ACLs in your account. The cleanup process can take several hours. If a resource leaves \
         policy scope after Firewall Manager creates a web ACL, Firewall Manager doesn't \
         disassociate the resource from the web ACL. If you want Firewall Manager to clean up the \
         web ACL, you must first manually disassociate the resources from the web ACL, and then \
        ...
        \                       \n\
        \                        }\n\
        \                   {-  Fraud Control account takeover prevention (ATP) - For information \
         about the properties available for [AWSManagedRulesATPRuleSet] managed rule groups, see \
        ...
        \                   {-  Optimize unassociated web ACL - If you set \
         [optimizeUnassociatedWebACL] to [true], Firewall Manager creates web ACLs in accounts \
         within the policy scope if the web ACLs will be used by at least one resource. Firewall \
         Manager creates web ACLs in the accounts within policy scope only if the web ACLs will be \
         used by at least one resource. If at any time an account comes into policy scope, \
         Firewall Manager automatically creates a web ACL in the account if at least one resource \
         will use the web ACL.\n\
        \                       \n\
        \                        Upon enablement, Firewall Manager performs a one-time cleanup of \
         unused web ACLs in your account. The cleanup process can take several hours. If a \
         resource leaves policy scope after Firewall Manager creates a web ACL, Firewall Manager \
         disassociates the resource from the web ACL, but won't clean up the unused web ACL. \
         Firewall Manager only cleans up unused web ACLs when you first enable management of \
         unused web ACLs in a policy.\n\
        \                        \n\
        \                         If you set [optimizeUnassociatedWebACL] to [false] Firewall \
         Manager doesn't manage unused web ACLs, and Firewall Manager automatically creates an \
         empty web ACL in each account that's within policy scope.\n\
        \                         \n\
        \                          }\n\
        \                   {-  Rule action overrides - Firewall Manager supports rule action \
         overrides only for managed rule groups. To configure a [RuleActionOverrides] add the \
         [Name] of the rule to override, and [ActionToUse], which is the new action to use for the \
         rule. For information about using rule action override, see \
        ...
        \                   {-   [CAPTCHA] and [Challenge] configs - If you update the policy's \
         values for [associationConfig], [captchaConfig], [challengeConfig], or [tokenDomains], \
         Firewall Manager will overwrite your local web ACLs to contain the new value(s). However, \
         if you don't update the policy's [associationConfig], [captchaConfig], [challengeConfig], \
         or [tokenDomains] values, the values in your local web ACLs will remain unchanged. For \
        ...
        \                   {-   [defaultSizeInspectionLimit] - Specifies the maximum size of the \
         web request body component that an associated Amazon CloudFront distribution should send \
         to WAF for inspection. For more information, see \
        ...
        \              To use a specific version of a WAF managed rule group in your Firewall \
         Manager policy, you must set [versionEnabled] to [true], and set [version] to the version \
         you'd like to use. If you don't set [versionEnabled] to [true], or if you omit \
         [versionEnabled], then Firewall Manager uses the default version of the WAF managed rule \
         group. \n\
        \             \n\
        \              }\n\
        ...
        \             Firewall Manager supports Amazon Kinesis Data Firehose and Amazon S3 as the \
         [logDestinationConfigs] in your [loggingConfiguration]. For information about WAF logging \
         configurations, see \
        ...
        \              In the [loggingConfiguration], you can specify one [logDestinationConfigs]. \
         Optionally provide as many as 20 [redactedFields]. The [RedactedFieldType] must be one of \
...
[@@ocaml.doc "Details about the security service that is being used to protect the resources.\n"]
...
type nonrec resource_tag = {
  value : resource_tag_value option;
      [@ocaml.doc
        "The resource tag value. To specify an empty string value, either don't provide this or \
         specify it as \"\". \n"]
  key : resource_tag_key; [@ocaml.doc "The resource tag key.\n"]
}
[@@ocaml.doc
  "The resource tags that Firewall Manager uses to determine if a particular resource should be \
   included or excluded from the Firewall Manager policy. Tags enable you to categorize your \
   Amazon Web Services resources in different ways, for example, by purpose, owner, or \
   environment. Each tag consists of a key and an optional value. If you add more than one tag to \
   a policy, you can specify whether to combine them using the logical AND operator or the logical \
   OR operator. For more information, see \
   {{:https://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/tag-editor.html}Working with Tag \
   Editor}.\n\n\
  \ Every resource tag must have a string value, either a non-empty string or an empty string. If \
   you don't provide a value for a resource tag, Firewall Manager saves the value as an empty \
   string: \"\". When Firewall Manager compares tags, it only matches two tags if they have the \
   same key and the same value. A tag with an empty string value only matches with tags that also \
   have an empty string value. \n\
  \ "]

type nonrec resource_tags = resource_tag list [@@ocaml.doc ""]

type nonrec resource_tag_logical_operator = OR [@ocaml.doc ""] | AND [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec base62_id = string [@@ocaml.doc ""]

type nonrec name = string [@@ocaml.doc ""]

type nonrec description = string [@@ocaml.doc ""]

type nonrec resource_set_status = OUT_OF_ADMIN_SCOPE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec resource_set_summary = {
  resource_set_status : resource_set_status option;
      [@ocaml.doc
        ...
        \       }\n\
        \  "]
  last_update_time : time_stamp option;
      [@ocaml.doc "The last time that the resource set was changed.\n"]
  description : description option; [@ocaml.doc "A description of the resource set.\n"]
  name : name option;
      [@ocaml.doc
        "The descriptive name of the resource set. You can't change the name of a resource set \
         after you create it.\n"]
  id : base62_id option;
      [@ocaml.doc
        "A unique identifier for the resource set. This ID is returned in the responses to create \
         and list commands. You provide it to operations like update and delete.\n"]
}
[@@ocaml.doc "Summarizes the resource sets used in a policy.\n"]

type nonrec resource_set_summary_list = resource_set_summary list [@@ocaml.doc ""]

type nonrec resource_set_ids = base62_id list [@@ocaml.doc ""]
...
type nonrec resource_set = {
  ...
  resource_type_list : resource_type_list;
      [@ocaml.doc
        "Determines the resources that can be associated to the resource set. Depending on your \
         setting for max results and the number of resource sets, a single call might not return \
         the full list.\n"]
  update_token : update_token option;
      [@ocaml.doc
        "An optional token that you can use for optimistic locking. Firewall Manager returns a \
         token to your requests that access the resource set. The token marks the state of the \
         resource set resource at the time of the request. Update tokens are not allowed when \
         creating a resource set. After creation, each subsequent update call to the resource set \
        ...
        \  To make a conditional change to the resource set, provide the token in your update \
         ...
         current copy of it with a new token. Reapply your changes as needed, then try the \
...
type nonrec resource = {
  account_id : aws_account_id option;
      [@ocaml.doc "The Amazon Web Services account ID that the associated resource belongs to.\n"]
  ur_i : identifier; [@ocaml.doc "The resource's universal resource indicator (URI).\n"]
}
[@@ocaml.doc "Details of a resource that is associated to an Firewall Manager resource set.\n"]
...
type nonrec aws_region_list = aws_region list [@@ocaml.doc ""]

type nonrec region_scope = {
  all_regions_enabled : boolean_ option;
      [@ocaml.doc
        "Allows the specified Firewall Manager administrator to manage all Amazon Web Services \
         Regions.\n"]
  regions : aws_region_list option;
      [@ocaml.doc
        "The Amazon Web Services Regions that the specified Firewall Manager administrator can \
         perform actions in.\n"]
}
[@@ocaml.doc
...
type nonrec put_resource_set_request = {
  tag_list : tag_list option;
      [@ocaml.doc
        "Retrieves the tags associated with the specified resource set. Tags are key:value pairs \
         ...
         ID. You can specify one or more tags to add to each Amazon Web Services resource, up to \
         50 tags for a resource.\n"]
  resource_set : resource_set;
      [@ocaml.doc "Details about the resource set to be created or updated.>\n"]
}
[@@ocaml.doc ""]

type nonrec list_id = string [@@ocaml.doc ""]

type nonrec protocol = string [@@ocaml.doc ""]

type nonrec protocols_list = protocol list [@@ocaml.doc ""]

type nonrec previous_list_version = string [@@ocaml.doc ""]

type nonrec previous_protocols_list = (previous_list_version * protocols_list) list [@@ocaml.doc ""]

type nonrec protocols_list_data = {
  previous_protocols_list : previous_protocols_list option;
      [@ocaml.doc "A map of previous version numbers to their corresponding protocol arrays.\n"]
  protocols_list : protocols_list;
      [@ocaml.doc "An array of protocols in the Firewall Manager protocols list.\n"]
  last_update_time : time_stamp option;
      [@ocaml.doc "The time that the Firewall Manager protocols list was last updated.\n"]
  create_time : time_stamp option;
      [@ocaml.doc "The time that the Firewall Manager protocols list was created.\n"]
  list_update_token : update_token option;
      [@ocaml.doc
  ...
  list_name : resource_name; [@ocaml.doc "The name of the Firewall Manager protocols list.\n"]
  list_id : list_id option; [@ocaml.doc "The ID of the Firewall Manager protocols list.\n"]
}
[@@ocaml.doc "An Firewall Manager protocols list.\n"]

type nonrec put_protocols_list_response = {
  protocols_list_arn : resource_arn option;
...
type nonrec put_protocols_list_request = {
  tag_list : tag_list option; [@ocaml.doc "The tags associated with the resource.\n"]
  protocols_list : protocols_list_data;
      [@ocaml.doc "The details of the Firewall Manager protocols list to be created.\n"]
}
[@@ocaml.doc ""]

type nonrec policy_update_token = string [@@ocaml.doc ""]

type nonrec customer_policy_scope_id = string [@@ocaml.doc ""]

type nonrec customer_policy_scope_id_list = customer_policy_scope_id list [@@ocaml.doc ""]

type nonrec customer_policy_scope_id_type = ORG_UNIT [@ocaml.doc ""] | ACCOUNT [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec customer_policy_scope_map =
  (customer_policy_scope_id_type * customer_policy_scope_id_list) list
[@@ocaml.doc ""]

type nonrec customer_policy_status = OUT_OF_ADMIN_SCOPE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec policy = {
  resource_tag_logical_operator : resource_tag_logical_operator option;
      [@ocaml.doc
  ...
  policy_status : customer_policy_status option;
      [@ocaml.doc
        ...
        \       }\n\
        \  "]
  policy_description : resource_description option;
      [@ocaml.doc "Your description of the Firewall Manager policy.\n"]
  resource_set_ids : resource_set_ids option;
      [@ocaml.doc "The unique identifiers of the resource sets used by the policy.\n"]
  exclude_map : customer_policy_scope_map option;
      [@ocaml.doc
        "Specifies the Amazon Web Services account IDs and Organizations organizational units \
         (OUs) to exclude from the policy. Specifying an OU is the equivalent of specifying all \
         accounts in the OU and in any of its child OUs, including any child OUs and accounts that \
         are added at a later time.\n\n\
        \ You can specify inclusions or exclusions, but not both. If you specify an [IncludeMap], \
         Firewall Manager applies the policy to all accounts specified by the [IncludeMap], and \
         does not evaluate any [ExcludeMap] specifications. If you do not specify an [IncludeMap], \
         then Firewall Manager applies the policy to all accounts except for those specified by \
         the [ExcludeMap].\n\
        \ \n\
        ...
        \         {-  Specify account IDs by setting the key to [ACCOUNT]. For example, the \
         following is a valid map: [{\226\128\156ACCOUNT\226\128\157 : \
         \\[\226\128\156accountID1\226\128\157, \226\128\156accountID2\226\128\157\\]}].\n\
        \             \n\
        \              }\n\
        \         {-  Specify OUs by setting the key to [ORG_UNIT]. For example, the following is \
         a valid map: [{\226\128\156ORG_UNIT\226\128\157 : \\[\226\128\156ouid111\226\128\157, \
         \226\128\156ouid112\226\128\157\\]}].\n\
        \             \n\
        \              }\n\
        \         {-  Specify accounts and OUs together in a single map, separated with a comma. \
         For example, the following is a valid map: [{\226\128\156ACCOUNT\226\128\157 : \
         \\[\226\128\156accountID1\226\128\157, \226\128\156accountID2\226\128\157\\], \
         \226\128\156ORG_UNIT\226\128\157 : \\[\226\128\156ouid111\226\128\157, \
         \226\128\156ouid112\226\128\157\\]}].\n\
        \             \n\
        \              }\n\
        \         }\n\
  ...
  include_map : customer_policy_scope_map option;
      [@ocaml.doc
        ...
        \         }\n\
        \  "]
  delete_unused_fm_managed_resources : boolean_ option;
      [@ocaml.doc
        "Indicates whether Firewall Manager should automatically remove protections from resources \
         ...
         accounts when those accounts leave policy scope. For example, Firewall Manager will \
         disassociate a Firewall Manager managed web ACL from a protected customer resource when \
         the customer resource leaves policy scope. \n\n\
  ...
  remediation_enabled : boolean_;
      [@ocaml.doc "Indicates if the policy should be automatically applied to new resources.\n"]
  ...
  resource_tags : resource_tags option; [@ocaml.doc "An array of [ResourceTag] objects.\n"]
  resource_type_list : resource_type_list option;
      [@ocaml.doc
  ...
  resource_type : resource_type;
      [@ocaml.doc
        "The type of resource protected by or in scope of the policy. This is in the format shown \
         ...
         Web Services Resource Types Reference}. To apply this policy to multiple resource types, \
  ...
  policy_update_token : policy_update_token option;
      [@ocaml.doc
        "A unique identifier for each update to the policy. When issuing a [PutPolicy] request, \
         the [PolicyUpdateToken] in the request must match the [PolicyUpdateToken] of the current \
         policy version. To get the [PolicyUpdateToken] of the current policy version, use a \
         [GetPolicy] request.\n"]
  policy_name : resource_name; [@ocaml.doc "The name of the Firewall Manager policy.\n"]
  policy_id : policy_id option; [@ocaml.doc "The ID of the Firewall Manager policy.\n"]
}
[@@ocaml.doc "An Firewall Manager policy.\n"]

type nonrec put_policy_response = {
  policy_arn : resource_arn option; [@ocaml.doc "The Amazon Resource Name (ARN) of the policy.\n"]
  policy : policy option; [@ocaml.doc "The details of the Firewall Manager policy.\n"]
}
[@@ocaml.doc ""]

type nonrec put_policy_request = {
  tag_list : tag_list option; [@ocaml.doc "The tags to add to the Amazon Web Services resource.\n"]
  policy : policy; [@ocaml.doc "The details of the Firewall Manager policy to be created.\n"]
}
[@@ocaml.doc ""]

type nonrec invalid_type_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The value of the [Type] parameter is invalid.\n"]
...
type nonrec app = {
  port : ip_port_number; [@ocaml.doc "The application's port number, for example [80].\n"]
  protocol : protocol;
      [@ocaml.doc
        "The IP protocol name or number. The name can be one of [tcp], [udp], or [icmp]. For \
         information on possible numbers, see \
         {{:https://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml}Protocol \
         Numbers}.\n"]
  app_name : resource_name; [@ocaml.doc "The application's name.\n"]
}
[@@ocaml.doc "An individual Firewall Manager application.\n"]

type nonrec apps_list = app list [@@ocaml.doc ""]

type nonrec previous_apps_list = (previous_list_version * apps_list) list [@@ocaml.doc ""]

type nonrec apps_list_data = {
  previous_apps_list : previous_apps_list option;
      [@ocaml.doc "A map of previous version numbers to their corresponding [App] object arrays.\n"]
  apps_list : apps_list;
      [@ocaml.doc "An array of applications in the Firewall Manager applications list.\n"]
  last_update_time : time_stamp option;
      [@ocaml.doc "The time that the Firewall Manager applications list was last updated.\n"]
  create_time : time_stamp option;
      [@ocaml.doc "The time that the Firewall Manager applications list was created.\n"]
  list_update_token : update_token option;
      [@ocaml.doc
        "A unique identifier for each update to the list. When you update the list, the update \
         token must match the token of the current version of the application list. You can \
         retrieve the update token by getting the list. \n"]
  list_name : resource_name; [@ocaml.doc "The name of the Firewall Manager applications list.\n"]
  list_id : list_id option; [@ocaml.doc "The ID of the Firewall Manager applications list.\n"]
}
[@@ocaml.doc "An Firewall Manager applications list.\n"]

type nonrec put_apps_list_response = {
  apps_list_arn : resource_arn option;
...
type nonrec put_apps_list_request = {
  ...
  apps_list : apps_list_data;
      [@ocaml.doc "The details of the Firewall Manager applications list to be created.\n"]
}
[@@ocaml.doc ""]

type nonrec account_id_list = aws_account_id list [@@ocaml.doc ""]

type nonrec account_scope = {
  exclude_specified_accounts : boolean_ option;
      [@ocaml.doc
        "A boolean value that excludes the accounts in [AccountScope$Accounts] from the \
         administrator's scope. If true, the Firewall Manager administrator can apply policies to \
         all members of the organization except for the accounts listed in \
  ...
  all_accounts_enabled : boolean_ option;
      [@ocaml.doc
        "A boolean value that indicates if the administrator can apply policies to all accounts \
         ...
         within the organization. You can either enable management of all accounts through this \
         operation, or you can specify a list of accounts to manage in [AccountScope$Accounts]. \
         You cannot specify both.\n"]
  accounts : account_id_list option;
      [@ocaml.doc
        "The list of accounts within the organization that the specified Firewall Manager \
         administrator either can or cannot apply policies to, based on the value of \
         [ExcludeSpecifiedAccounts]. If [ExcludeSpecifiedAccounts] is set to [true], then the \
         Firewall Manager administrator can apply policies to all members of the organization \
         except for the accounts in this list. If [ExcludeSpecifiedAccounts] is set to [false], \
         then the Firewall Manager administrator can only apply policies to the accounts in this \
         list.\n"]
}
[@@ocaml.doc
  "Configures the accounts within the administrator's Organizations organization that the \
   specified Firewall Manager administrator can apply policies to.\n"]
...
type nonrec organizational_unit_scope = {
  exclude_specified_organizational_units : boolean_ option;
      [@ocaml.doc
        "A boolean value that excludes the OUs in [OrganizationalUnitScope$OrganizationalUnits] \
         ...
         [OrganizationalUnitScope$OrganizationalUnits]. You can either specify a list of OUs to \
         exclude by [OrganizationalUnitScope$OrganizationalUnits], or you can enable management of \
         all OUs by [OrganizationalUnitScope$AllOrganizationalUnitsEnabled]. You cannot specify \
         both.\n"]
  all_organizational_units_enabled : boolean_ option;
      [@ocaml.doc
        "A boolean value that indicates if the administrator can apply policies to all OUs within \
         an organization. If true, the administrator can manage all OUs within the organization. \
         You can either enable management of all OUs through this operation, or you can specify \
         OUs to manage in [OrganizationalUnitScope$OrganizationalUnits]. You cannot specify both.\n"]
  organizational_units : organizational_unit_id_list option;
      [@ocaml.doc
        "The list of OUs within the organization that the specified Firewall Manager administrator \
         either can or cannot apply policies to, based on the value of \
         [OrganizationalUnitScope$ExcludeSpecifiedOrganizationalUnits]. If \
         [OrganizationalUnitScope$ExcludeSpecifiedOrganizationalUnits] is set to [true], then the \
         Firewall Manager administrator can apply policies to all OUs in the organization except \
         for the OUs in this list. If \
         [OrganizationalUnitScope$ExcludeSpecifiedOrganizationalUnits] is set to [false], then the \
...
[@@ocaml.doc
  "Defines the Organizations organizational units (OUs) that the specified Firewall Manager \
   administrator can apply policies to. For more information about OUs in Organizations, see \
...
type nonrec policy_type_scope = {
  all_policy_types_enabled : boolean_ option;
      [@ocaml.doc
        "Allows the specified Firewall Manager administrator to manage all Firewall Manager policy \
         types, except for third-party policy types. Third-party policy types can only be managed \
         by the Firewall Manager default administrator.\n"]
  policy_types : security_service_type_list option;
      [@ocaml.doc
...
[@@ocaml.doc
  "Defines the resources that the Firewall Manager administrator can manage. For more information \
   about administrative scope, see \
...
type nonrec put_admin_account_request = {
  admin_scope : admin_scope option;
      [@ocaml.doc
        "Configures the resources that the specified Firewall Manager administrator can manage. As \
         a best practice, set the administrative scope according to the principles of least \
         privilege. Only grant the administrator the specific resources or permissions that they \
         need to perform the duties of their role.\n"]
  admin_account : aws_account_id;
      [@ocaml.doc
        "The Amazon Web Services account ID to add as an Firewall Manager administrator account. \
         ...
         by [AssociateAdminAccount]. For more information about Organizations, see \
...
type nonrec protocols_list_data_summary = {
  protocols_list : protocols_list option;
      [@ocaml.doc "An array of protocols in the Firewall Manager protocols list.\n"]
  list_name : resource_name option; [@ocaml.doc "The name of the specified protocols list.\n"]
  list_id : list_id option; [@ocaml.doc "The ID of the specified protocols list.\n"]
  list_arn : resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the specified protocols list.\n"]
}
[@@ocaml.doc "Details of the Firewall Manager protocols list.\n"]

type nonrec protocols_lists_data = protocols_list_data_summary list [@@ocaml.doc ""]

type nonrec protection_data = string [@@ocaml.doc ""]
...
type nonrec policy_summary = {
  ...
  delete_unused_fm_managed_resources : boolean_ option;
      [@ocaml.doc
        ...
        \  This option is not available for Shield Advanced or WAF Classic policies.\n\
        \  "]
  remediation_enabled : boolean_ option;
      [@ocaml.doc "Indicates if the policy should be automatically applied to new resources.\n"]
  ...
  policy_name : resource_name option; [@ocaml.doc "The name of the specified policy.\n"]
  policy_id : policy_id option; [@ocaml.doc "The ID of the specified policy.\n"]
  policy_arn : resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the specified policy.\n"]
}
[@@ocaml.doc "Details of the Firewall Manager policy. \n"]

type nonrec policy_summary_list = policy_summary list [@@ocaml.doc ""]
...
type nonrec evaluation_result = {
  evaluation_limit_exceeded : boolean_ option;
      [@ocaml.doc
        "Indicates that over 100 resources are noncompliant with the Firewall Manager policy.\n"]
  violator_count : resource_count option;
      [@ocaml.doc
...
type nonrec detailed_info = string [@@ocaml.doc ""]
...
type nonrec issue_info_map = (dependent_service_name * detailed_info) list [@@ocaml.doc ""]
...
type nonrec policy_compliance_status = {
  ...
  last_updated : time_stamp option;
      [@ocaml.doc "Timestamp of the last update to the [EvaluationResult] objects.\n"]
  evaluation_results : evaluation_results option;
      [@ocaml.doc "An array of [EvaluationResult] objects.\n"]
  member_account : aws_account_id option; [@ocaml.doc "The member account ID.\n"]
  policy_name : resource_name option; [@ocaml.doc "The name of the Firewall Manager policy.\n"]
  policy_id : policy_id option; [@ocaml.doc "The ID of the Firewall Manager policy.\n"]
  policy_owner : aws_account_id option;
      [@ocaml.doc "The Amazon Web Services account that created the Firewall Manager policy.\n"]
}
[@@ocaml.doc
...
type nonrec policy_compliance_status_list = policy_compliance_status list [@@ocaml.doc ""]

type nonrec compliance_violator_metadata = (length_bounded_string * length_bounded_string) list
[@@ocaml.doc ""]

type nonrec compliance_violator = {
  metadata : compliance_violator_metadata option;
      [@ocaml.doc "Metadata about the resource that doesn't comply with the policy scope.\n"]
  resource_type : resource_type option;
      [@ocaml.doc
  ...
  violation_reason : violation_reason option;
      [@ocaml.doc "The reason that the resource is not protected by the policy.\n"]
  resource_id : resource_id option; [@ocaml.doc "The resource ID.\n"]
}
[@@ocaml.doc "Details of the resource that is not protected by the policy.\n"]

type nonrec compliance_violators = compliance_violator list [@@ocaml.doc ""]
...
type nonrec policy_compliance_detail = {
  issue_info_map : issue_info_map option;
      [@ocaml.doc
        "Details about problems with dependent services, such as WAF or Config, and the error \
         message received that indicates the problem with the service.\n"]
  expired_at : time_stamp option;
      [@ocaml.doc
        "A timestamp that indicates when the returned information should be considered out of date.\n"]
  evaluation_limit_exceeded : boolean_ option;
      [@ocaml.doc
        "Indicates if over 100 resources are noncompliant with the Firewall Manager policy.\n"]
  violators : compliance_violators option;
      [@ocaml.doc
        "An array of resources that aren't protected by the WAF or Shield Advanced policy or that \
         aren't in compliance with the security group policy.\n"]
  member_account : aws_account_id option; [@ocaml.doc "The Amazon Web Services account ID.\n"]
  policy_id : policy_id option; [@ocaml.doc "The ID of the Firewall Manager policy.\n"]
  policy_owner : aws_account_id option;
      [@ocaml.doc "The Amazon Web Services account that created the Firewall Manager policy.\n"]
}
...
type nonrec member_accounts = aws_account_id list [@@ocaml.doc ""]
...
type nonrec list_third_party_firewall_firewall_policies_response = {
  ...
  third_party_firewall_firewall_policies : third_party_firewall_firewall_policies option;
      [@ocaml.doc
        "A list that contains one [ThirdPartyFirewallFirewallPolicies] element for each \
         ...
         associated with. Each [ThirdPartyFirewallFirewallPolicies] element contains the firewall \
         policy name and ID.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_third_party_firewall_firewall_policies_request = {
  max_results : pagination_max_results;
      [@ocaml.doc
        "The maximum number of third-party firewall policies that you want Firewall Manager to \
         return. If the specified third-party firewall vendor is associated with more than \
         [MaxResults] firewall policies, the response includes a [NextToken] element. [NextToken] \
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "If the previous response included a [NextToken] element, the specified third-party \
         ...
         third-party firewall policies, submit another \
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "When you request a list of objects with a [MaxResults] setting, if the number of objects \
         that are still available for retrieval exceeds the maximum you requested, Firewall \
         Manager returns a [NextToken] value in the response. To retrieve the next batch of \
         objects, use the token returned from the prior request in your next request.\n"]
  resource_sets : resource_set_summary_list option;
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "When you request a list of objects with a [MaxResults] setting, if the number of objects \
         ...
         objects, use the token returned from the prior request in your next request.\n"]
  items : resource_list;
      [@ocaml.doc "An array of the associated resources' uniform resource identifiers (URI).\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_protocols_lists_response = {
  next_token : pagination_token option;
      [@ocaml.doc
        "If you specify a value for [MaxResults] in your list request, and you have more objects \
         than the maximum, Firewall Manager returns this token in the response. You can use this \
         token in subsequent requests to retrieve the next batch of objects.\n"]
  protocols_lists : protocols_lists_data option;
...
type nonrec list_protocols_lists_request = {
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "If you specify a value for [MaxResults] in your list request, and you have more objects \
         than the maximum, Firewall Manager returns this token in the response. For all but the \
         first request, you provide the token returned by the prior request in the request \
         parameters, to retrieve the next batch of objects.\n"]
  default_lists : boolean_ option;
      [@ocaml.doc
...
type nonrec list_policies_response = {
  ...
  policy_list : policy_summary_list option; [@ocaml.doc "An array of [PolicySummary] objects.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_policies_request = {
  max_results : pagination_max_results option;
      [@ocaml.doc
        "Specifies the number of [PolicySummary] objects that you want Firewall Manager to return \
         for this request. If you have more [PolicySummary] objects than the number that you \
         specify for [MaxResults], the response includes a [NextToken] value that you can use to \
         get another batch of [PolicySummary] objects.\n"]
  next_token : pagination_token option;
      [@ocaml.doc
        "If you specify a value for [MaxResults] and you have more [PolicySummary] objects than \
         ...
         For the second and subsequent [ListPolicies] requests, specify the value of [NextToken] \
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "If you have more member account IDs than the number that you specified for [MaxResults] \
         in the request, the response includes a [NextToken] value. To list more IDs, submit \
         another [ListMemberAccounts] request, and specify the [NextToken] value from the response \
         in the [NextToken] value in the next request.\n"]
  member_accounts : member_accounts option; [@ocaml.doc "An array of account IDs.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_member_accounts_request = {
  max_results : pagination_max_results option;
      [@ocaml.doc
        "Specifies the number of member account IDs that you want Firewall Manager to return for \
         this request. If you have more IDs than the number that you specify for [MaxResults], the \
         response includes a [NextToken] value that you can use to get another batch of member \
         account IDs.\n"]
  next_token : pagination_token option;
      [@ocaml.doc
        "If you specify a value for [MaxResults] and you have more account IDs than the number \
         that you specify for [MaxResults], Firewall Manager returns a [NextToken] value in the \
...
type nonrec discovered_resource = {
  name : resource_name option; [@ocaml.doc "The name of the discovered resource.\n"]
  type_ : resource_type option; [@ocaml.doc "The type of the discovered resource.\n"]
  account_id : aws_account_id option;
      [@ocaml.doc "The Amazon Web Services account ID associated with the discovered resource.\n"]
  ur_i : identifier option;
      [@ocaml.doc "The universal resource identifier (URI) of the discovered resource.\n"]
}
[@@ocaml.doc
  "A resource in the organization that's available to be associated with a Firewall Manager \
   resource set.\n"]

type nonrec discovered_resource_list = discovered_resource list [@@ocaml.doc ""]
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "When you request a list of objects with a [MaxResults] setting, if the number of objects \
         ...
         Manager returns a [NextToken] value in the response. To retrieve the next batch of \
         objects, use the token returned from the prior request in your next request.\n"]
  items : discovered_resource_list option;
  ...
  max_results : pagination_max_results option;
      [@ocaml.doc
        "The maximum number of objects that you want Firewall Manager to return for this request. \
         If more objects are available, in the response, Firewall Manager provides a [NextToken] \
         value that you can use in a subsequent call to get the next batch of objects.\n"]
  resource_type : resource_type; [@ocaml.doc "The type of resources to discover.\n"]
  member_account_ids : aws_account_id_list;
      [@ocaml.doc
        "The Amazon Web Services account IDs to discover resources in. Only one account is \
         supported per request. The account must be a member of your organization.\n"]
}
[@@ocaml.doc ""]
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "If you have more [PolicyComplianceStatus] objects than the number that you specified for \
         ...
         request.\n"]
  policy_compliance_status_list : policy_compliance_status_list option;
...
type nonrec list_compliance_status_request = {
  max_results : pagination_max_results option;
      [@ocaml.doc
        "Specifies the number of [PolicyComplianceStatus] objects that you want Firewall Manager \
         to return for this request. If you have more [PolicyComplianceStatus] objects than the \
         number that you specify for [MaxResults], the response includes a [NextToken] value that \
         you can use to get another batch of [PolicyComplianceStatus] objects.\n"]
  next_token : pagination_token option;
      [@ocaml.doc
  ...
  policy_id : policy_id;
      [@ocaml.doc "The ID of the Firewall Manager policy that you want the details for.\n"]
}
[@@ocaml.doc ""]

type nonrec apps_list_data_summary = {
  apps_list : apps_list option;
      [@ocaml.doc "An array of [App] objects in the Firewall Manager applications list.\n"]
  list_name : resource_name option; [@ocaml.doc "The name of the applications list.\n"]
  list_id : list_id option; [@ocaml.doc "The ID of the applications list.\n"]
  list_arn : resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the applications list.\n"]
}
[@@ocaml.doc "Details of the Firewall Manager applications list.\n"]

type nonrec apps_lists_data = apps_list_data_summary list [@@ocaml.doc ""]
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "If you specify a value for [MaxResults] in your list request, and you have more objects \
         than the maximum, Firewall Manager returns this token in the response. You can use this \
         token in subsequent requests to retrieve the next batch of objects.\n"]
  apps_lists : apps_lists_data option; [@ocaml.doc "An array of [AppsListDataSummary] objects.\n"]
}
[@@ocaml.doc ""]
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "When you request a list of objects with a [MaxResults] setting, if the number of objects \
         ...
         Manager returns a [NextToken] value in the response. To retrieve the next batch of \
         objects, use the token returned from the prior request in your next request.\n"]
  admin_accounts : account_id_list option;
      [@ocaml.doc "The list of accounts who manage member accounts within their [AdminScope].\n"]
}
[@@ocaml.doc ""]
...
type nonrec admin_account_summary = {
  status : organization_status option;
      [@ocaml.doc
        ...
        \       }\n\
        \  "]
  default_admin : boolean_ option;
      [@ocaml.doc
        "A boolean value that indicates if the administrator is the default administrator. If \
         true, then this is the default administrator account. The default administrator can \
         manage third-party firewalls and has full administrative scope. There is only one default \
         administrator account per organization. For information about Firewall Manager default \
         administrator accounts, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/fms-administrators.html}Managing \
         Firewall Manager administrators} in the {i Firewall Manager Developer Guide}.\n"]
  admin_account : aws_account_id option;
      [@ocaml.doc
        "The Amazon Web Services account ID of the Firewall Manager administrator's account.\n"]
}
[@@ocaml.doc "Contains high level information about the Firewall Manager administrator account.\n"]

type nonrec admin_account_summary_list = admin_account_summary list [@@ocaml.doc ""]
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "When you request a list of objects with a [MaxResults] setting, if the number of objects \
         ...
         Manager returns a [NextToken] value in the response. To retrieve the next batch of \
         objects, use the token returned from the prior request in your next request.\n"]
  admin_accounts : admin_account_summary_list option;
      [@ocaml.doc
        "A list of Firewall Manager administrator accounts within the organization that were \
         onboarded as administrators by [AssociateAdminAccount] or [PutAdminAccount].\n"]
}
[@@ocaml.doc ""]
...
type nonrec identifier_list = identifier list [@@ocaml.doc ""]

type nonrec get_violation_details_response = {
  violation_detail : violation_detail option; [@ocaml.doc "Violation detail for a resource.\n"]
}
[@@ocaml.doc ""]
  ...
  resource_type : resource_type;
      [@ocaml.doc
        "The resource type. This is in the format shown in the \
         ...
         [AWS::WAFv2::WebACL], [AWS::EC2::Instance], [AWS::EC2::NetworkInterface], \
         [AWS::EC2::SecurityGroup], [AWS::NetworkFirewall::FirewallPolicy], and \
         [AWS::EC2::Subnet]. \n"]
  resource_id : resource_id; [@ocaml.doc "The ID of the resource that has violations.\n"]
  member_account : aws_account_id;
      [@ocaml.doc "The Amazon Web Services account ID that you want the details for.\n"]
  policy_id : policy_id;
      [@ocaml.doc
        "The ID of the Firewall Manager policy that you want the details for. You can get \
         violation details for the following policy types:\n\n\
        \ {ul\n\
        \       {-  WAF\n\
        \           \n\
        \            }\n\
...
type nonrec get_third_party_firewall_association_status_response = {
  marketplace_onboarding_status : marketplace_subscription_onboarding_status option;
      [@ocaml.doc
        ...
        \       {-   [NO_SUBSCRIPTION] - The Firewall Manager policy administrator isn't \
         subscribed to the third-party firewall service in the Amazon Web Services Marketplace.\n\
        \           \n\
        \            }\n\
        ...
        \       {-   [COMPLETE] - The Firewall Manager policy administrator has an active \
         subscription to the third-party firewall service in the Amazon Web Services Marketplace.\n\
        \           \n\
        \            }\n\
        \       }\n\
        \  "]
  third_party_firewall_status : third_party_firewall_association_status option;
      [@ocaml.doc
        "The current status for setting a Firewall Manager policy administrators account as an \
         administrator of the third-party firewall tenant.\n\n\
        \ {ul\n\
...
type nonrec get_resource_set_response = {
  resource_set_arn : resource_arn;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the resource set.\n"]
  resource_set : resource_set; [@ocaml.doc "Information about the specified resource set.\n"]
}
[@@ocaml.doc ""]

type nonrec get_resource_set_request = {
  identifier : base62_id;
      [@ocaml.doc
        "A unique identifier for the resource set, used in a request to refer to the resource set.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_protocols_list_response = {
  protocols_list_arn : resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the specified protocols list.\n"]
  protocols_list : protocols_list_data option;
      [@ocaml.doc "Information about the specified Firewall Manager protocols list.\n"]
}
[@@ocaml.doc ""]

type nonrec get_protocols_list_request = {
  default_list : boolean_ option;
      [@ocaml.doc
        "Specifies whether the list to retrieve is a default list owned by Firewall Manager.\n"]
  list_id : list_id;
      [@ocaml.doc "The ID of the Firewall Manager protocols list that you want the details for.\n"]
}
[@@ocaml.doc ""]
  ...
  service_type : security_service_type option;
      [@ocaml.doc
        "The service type that is protected by the policy. Currently, this is always \
         [SHIELD_ADVANCED].\n"]
  admin_account_id : aws_account_id option;
      [@ocaml.doc "The ID of the Firewall Manager administrator account for this policy.\n"]
}
[@@ocaml.doc ""]
  ...
  max_results : pagination_max_results option;
      [@ocaml.doc
        "Specifies the number of objects that you want Firewall Manager to return for this \
         request. If you have more objects than the number that you specify for [MaxResults], the \
         response includes a [NextToken] value that you can use to get another batch of objects.\n"]
  next_token : pagination_token option;
      [@ocaml.doc
        "If you specify a value for [MaxResults] and you have more objects than the number that \
         you specify for [MaxResults], Firewall Manager returns a [NextToken] value in the \
  ...
  end_time : time_stamp option;
      [@ocaml.doc
        "The end of the time period to query for the attacks. This is a [timestamp] type. The \
         ...
         Manager is Unix time in seconds. However, any valid [timestamp] format is allowed.\n"]
  start_time : time_stamp option;
      [@ocaml.doc
        "The start of the time period to query for the attacks. This is a [timestamp] type. The \
         request syntax listing indicates a [number] type because the default used by Firewall \
         Manager is Unix time in seconds. However, any valid [timestamp] format is allowed.\n"]
  member_account_id : aws_account_id option;
      [@ocaml.doc
        "The Amazon Web Services account that is in scope of the policy that you want to get the \
         details for.\n"]
  policy_id : policy_id;
      [@ocaml.doc "The ID of the policy for which you want to get the attack information.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_policy_response = {
  policy_arn : resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the specified policy.\n"]
  policy : policy option; [@ocaml.doc "Information about the specified Firewall Manager policy.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_notification_channel_response = {
  sns_role_name : resource_arn option;
      [@ocaml.doc "The IAM role that is used by Firewall Manager to record activity to SNS.\n"]
  sns_topic_arn : resource_arn option;
      [@ocaml.doc "The SNS topic that records Firewall Manager activity. \n"]
}
[@@ocaml.doc ""]

type nonrec get_notification_channel_request = unit [@@ocaml.doc ""]
...
type nonrec get_apps_list_response = {
  apps_list_arn : resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the applications list.\n"]
  apps_list : apps_list_data option;
      [@ocaml.doc "Information about the specified Firewall Manager applications list.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_admin_scope_response = {
  status : organization_status option;
      [@ocaml.doc
        ...
        \  "]
  admin_scope : admin_scope option;
      [@ocaml.doc "Contains details about the administrative scope of the requested account.\n"]
}
[@@ocaml.doc ""]

type nonrec get_admin_scope_request = {
  admin_account : aws_account_id;
      [@ocaml.doc "The administrator account that you want to get the details for.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_admin_account_response = {
  ...
  admin_account : aws_account_id option;
      [@ocaml.doc "The account that is set as the Firewall Manager default administrator.\n"]
}
[@@ocaml.doc ""]

type nonrec get_admin_account_request = unit [@@ocaml.doc ""]
...
type nonrec failed_item = {
  reason : failed_item_reason option;
      [@ocaml.doc "The reason the resource's association could not be updated.\n"]
  ur_i : identifier option;
      [@ocaml.doc "The univeral resource indicator (URI) of the resource that failed.\n"]
}
[@@ocaml.doc
  "Details of a resource that failed when trying to update it's association to a resource set.\n"]

type nonrec failed_item_list = failed_item list [@@ocaml.doc ""]

type nonrec disassociate_third_party_firewall_response = {
  third_party_firewall_status : third_party_firewall_association_status option;
      [@ocaml.doc
        "The current status for the disassociation of a Firewall Manager administrators account \
...
type nonrec disassociate_admin_account_request = unit [@@ocaml.doc ""]
...
type nonrec delete_policy_request = {
  delete_all_policy_resources : boolean_ option;
      [@ocaml.doc
        ...
        \      After the cleanup, in-scope resources are no longer protected by web ACLs in this \
         ...
         in scope of the policy, those accounts and resources are handled by the policy. All \
...
type nonrec delete_notification_channel_request = unit [@@ocaml.doc ""]
...
type nonrec batch_disassociate_resource_response = {
  failed_items : failed_item_list;
      [@ocaml.doc "The resources that failed to disassociate from the resource set.\n"]
...
type nonrec batch_disassociate_resource_request = {
  items : identifier_list;
      [@ocaml.doc
        "The uniform resource identifiers (URI) of resources that should be disassociated from the \
         resource set. The URIs must be Amazon Resource Names (ARNs).\n"]
  resource_set_identifier : identifier;
      [@ocaml.doc
        "A unique identifier for the resource set, used in a request to refer to the resource set.\n"]
}
...
type nonrec batch_associate_resource_response = {
  failed_items : failed_item_list;
      [@ocaml.doc "The resources that failed to associate to the resource set.\n"]
  resource_set_identifier : identifier;
      [@ocaml.doc
        "A unique identifier for the resource set, used in a request to refer to the resource set.\n"]
}
...
type nonrec batch_associate_resource_request = {
  items : identifier_list;
      [@ocaml.doc
        "The uniform resource identifiers (URIs) of resources that should be associated to the \
         resource set. The URIs must be Amazon Resource Names (ARNs).\n"]
  resource_set_identifier : identifier;
      [@ocaml.doc
        "A unique identifier for the resource set, used in a request to refer to the resource set.\n"]
...
type nonrec associate_third_party_firewall_response = {
  third_party_firewall_status : third_party_firewall_association_status option;
      [@ocaml.doc
        "The current status for setting a Firewall Manager policy administrator's account as an \
         administrator of the third-party firewall tenant.\n\n\
        \ {ul\n\
        \       {-   [ONBOARDING] - The Firewall Manager policy administrator is being designated \
         as a tenant administrator.\n\
