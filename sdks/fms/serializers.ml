...
let target_violation_reasons_to_yojson tree =
  list_to_yojson target_violation_reason_to_yojson tree
let partial_match_to_yojson (x : partial_match) =
  assoc_to_yojson
    [("TargetViolationReasons",
       (option_to_yojson target_violation_reasons_to_yojson
          x.target_violation_reasons));
    ("Reference", (option_to_yojson reference_rule_to_yojson x.reference))]
let partial_matches_to_yojson tree =
  list_to_yojson partial_match_to_yojson tree
let remediation_action_type_to_yojson (x : remediation_action_type) =
  match x with | Modify -> `String "MODIFY" | Remove -> `String "REMOVE"
...
let security_group_rule_description_to_yojson
  (x : security_group_rule_description) =
  assoc_to_yojson
...
let security_group_remediation_action_to_yojson
  (x : security_group_remediation_action) =
  assoc_to_yojson
    [("IsDefaultAction",
       (option_to_yojson boolean__to_yojson x.is_default_action));
    ("RemediationResult",
      (option_to_yojson security_group_rule_description_to_yojson
         x.remediation_result));
    ("Description",
      (option_to_yojson remediation_action_description_to_yojson
         x.description));
    ("RemediationActionType",
      (option_to_yojson remediation_action_type_to_yojson
         x.remediation_action_type))]
...
let aws_vpc_security_group_violation_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ViolationTargetDescription",
      (option_to_yojson length_bounded_string_to_yojson
         x.violation_target_description));
    ("ViolationTarget",
...
let aws_ec2_network_interface_violation_to_yojson
  ...
  assoc_to_yojson
    [("ViolatingSecurityGroups",
       (option_to_yojson resource_id_list_to_yojson
          x.violating_security_groups));
    ("ViolationTarget",
      (option_to_yojson violation_target_to_yojson x.violation_target))]
...
let network_firewall_missing_firewall_violation_to_yojson
  ...
  assoc_to_yojson
    [("TargetViolationReason",
       (option_to_yojson target_violation_reason_to_yojson
          x.target_violation_reason));
    ("AvailabilityZone",
...
let stateless_rule_group_to_yojson (x : stateless_rule_group) =
  assoc_to_yojson
    ...
    ("RuleGroupName",
      (option_to_yojson network_firewall_resource_name_to_yojson
         x.rule_group_name))]
let stateless_rule_group_list_to_yojson tree =
  list_to_yojson stateless_rule_group_to_yojson tree
...
let network_firewall_override_action_to_yojson
  (x : network_firewall_override_action) =
...
let stateful_rule_group_to_yojson (x : stateful_rule_group) =
  assoc_to_yojson
    [("Override",
       (option_to_yojson
          network_firewall_stateful_rule_group_override_to_yojson x.override));
    ("Priority", (option_to_yojson priority_number_to_yojson x.priority));
    ("ResourceId", (option_to_yojson resource_id_to_yojson x.resource_id));
    ("RuleGroupName",
      (option_to_yojson network_firewall_resource_name_to_yojson
         x.rule_group_name))]
let stateful_rule_group_list_to_yojson tree =
  list_to_yojson stateful_rule_group_to_yojson tree
...
let stateful_engine_options_to_yojson (x : stateful_engine_options) =
  assoc_to_yojson
    [("StreamExceptionPolicy",
       (option_to_yojson stream_exception_policy_to_yojson
          x.stream_exception_policy));
    ("RuleOrder", (option_to_yojson rule_order_to_yojson x.rule_order))]
let network_firewall_policy_description_to_yojson
  (x : network_firewall_policy_description) =
  assoc_to_yojson
    [("StatefulEngineOptions",
       (option_to_yojson stateful_engine_options_to_yojson
          x.stateful_engine_options));
    ("StatefulDefaultActions",
      (option_to_yojson network_firewall_action_list_to_yojson
         x.stateful_default_actions));
    ("StatefulRuleGroups",
      (option_to_yojson stateful_rule_group_list_to_yojson
         x.stateful_rule_groups));
    ("StatelessCustomActions",
      (option_to_yojson network_firewall_action_list_to_yojson
         x.stateless_custom_actions));
    ("StatelessFragmentDefaultActions",
      (option_to_yojson network_firewall_action_list_to_yojson
         x.stateless_fragment_default_actions));
    ("StatelessDefaultActions",
      (option_to_yojson network_firewall_action_list_to_yojson
         x.stateless_default_actions));
    ("StatelessRuleGroups",
      (option_to_yojson stateless_rule_group_list_to_yojson
         x.stateless_rule_groups))]
let network_firewall_policy_modified_violation_to_yojson
  (x : network_firewall_policy_modified_violation) =
  assoc_to_yojson
    [("ExpectedPolicyDescription",
       (option_to_yojson network_firewall_policy_description_to_yojson
          x.expected_policy_description));
    ("CurrentPolicyDescription",
      (option_to_yojson network_firewall_policy_description_to_yojson
         x.current_policy_description));
    ("ViolationTarget",
      (option_to_yojson violation_target_to_yojson x.violation_target))]
...
let length_bounded_string_list_to_yojson tree =
  list_to_yojson length_bounded_string_to_yojson tree
let expected_route_to_yojson (x : expected_route) =
  assoc_to_yojson
    [("RouteTableId",
       (option_to_yojson resource_id_to_yojson x.route_table_id));
    ("AllowedTargets",
      (option_to_yojson length_bounded_string_list_to_yojson
         x.allowed_targets));
    ("ContributingSubnets",
...
let expected_routes_to_yojson tree =
  list_to_yojson expected_route_to_yojson tree
let network_firewall_internet_traffic_not_inspected_violation_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ExpectedInternetGatewayRoutes",
      (option_to_yojson expected_routes_to_yojson
         x.expected_internet_gateway_routes));
    ("CurrentInternetGatewayRouteTable",
      (option_to_yojson resource_id_to_yojson
         x.current_internet_gateway_route_table));
    ("InternetGatewayId",
    ...
    ("ExpectedFirewallSubnetRoutes",
      (option_to_yojson expected_routes_to_yojson
         x.expected_firewall_subnet_routes));
    ("FirewallSubnetId",
    ...
    ("CurrentFirewallSubnetRouteTable",
      (option_to_yojson resource_id_to_yojson
         x.current_firewall_subnet_route_table));
    ("IsRouteTableUsedInDifferentAZ",
      (option_to_yojson boolean__to_yojson
         x.is_route_table_used_in_different_a_z));
    ("ViolatingRoutes",
...
let dns_rule_group_priorities_to_yojson tree =
  list_to_yojson dns_rule_group_priority_to_yojson tree
let dns_rule_group_priority_conflict_violation_to_yojson
  ...
  assoc_to_yojson
    [("UnavailablePriorities",
       (option_to_yojson dns_rule_group_priorities_to_yojson
          x.unavailable_priorities));
    ("ConflictingPolicyId",
      (option_to_yojson policy_id_to_yojson x.conflicting_policy_id));
    ("ConflictingPriority",
      (option_to_yojson dns_rule_group_priority_to_yojson
         x.conflicting_priority));
    ("ViolationTargetDescription",
      (option_to_yojson length_bounded_string_to_yojson
         x.violation_target_description));
    ("ViolationTarget",
...
let dns_rule_group_limit_exceeded_violation_to_yojson
  ...
  assoc_to_yojson
    [("NumberOfRuleGroupsAlreadyAssociated",
       (option_to_yojson basic_integer_to_yojson
          x.number_of_rule_groups_already_associated));
    ("ViolationTargetDescription",
      (option_to_yojson length_bounded_string_to_yojson
         x.violation_target_description));
    ("ViolationTarget",
...
let network_acl_entry_to_yojson (x : network_acl_entry) =
  assoc_to_yojson
    ...
    ("Ipv6CidrBlock",
      (option_to_yojson length_bounded_non_empty_string_to_yojson
         x.ipv6_cidr_block));
    ("CidrBlock",
      (option_to_yojson length_bounded_non_empty_string_to_yojson
         x.cidr_block));
...
let entries_with_conflicts_to_yojson tree =
  list_to_yojson entry_description_to_yojson tree
...
let entry_violation_reasons_to_yojson tree =
  list_to_yojson entry_violation_reason_to_yojson tree
let entry_violation_to_yojson (x : entry_violation) =
  assoc_to_yojson
    [("EntryViolationReasons",
       (option_to_yojson entry_violation_reasons_to_yojson
          x.entry_violation_reasons));
    ("EntriesWithConflicts",
      (option_to_yojson entries_with_conflicts_to_yojson
         x.entries_with_conflicts));
    ("EntryAtExpectedEvaluationOrder",
      (option_to_yojson entry_description_to_yojson
         x.entry_at_expected_evaluation_order));
    ("ActualEvaluationOrder",
      (option_to_yojson length_bounded_string_to_yojson
         x.actual_evaluation_order));
    ("ExpectedEvaluationOrder",
      (option_to_yojson length_bounded_string_to_yojson
         x.expected_evaluation_order));
    ("ExpectedEntry",
      (option_to_yojson entry_description_to_yojson x.expected_entry))]
let entry_violations_to_yojson tree =
  list_to_yojson entry_violation_to_yojson tree
let invalid_network_acl_entries_violation_to_yojson
  ...
  assoc_to_yojson
    ...
    ("CurrentAssociatedNetworkAcl",
      (option_to_yojson resource_id_to_yojson
         x.current_associated_network_acl));
    ("SubnetAvailabilityZone",
      (option_to_yojson length_bounded_string_to_yojson
         x.subnet_availability_zone));
...
let ec2_create_route_table_action_to_yojson
  (x : ec2_create_route_table_action) =
  assoc_to_yojson
    [("VpcId", (Some (action_target_to_yojson x.vpc_id)));
    ("Description",
      (option_to_yojson length_bounded_string_to_yojson x.description))]
...
let fms_policy_update_firewall_creation_config_action_to_yojson
  ...
  assoc_to_yojson
    [("FirewallCreationConfig",
       (option_to_yojson managed_service_data_to_yojson
          x.firewall_creation_config));
    ("Description",
      (option_to_yojson length_bounded_string_to_yojson x.description))]
...
let replace_network_acl_association_action_to_yojson
  ...
  assoc_to_yojson
    ...
    ("Description",
      (option_to_yojson length_bounded_string_to_yojson x.description))]
let entries_description_to_yojson tree =
  list_to_yojson entry_description_to_yojson tree
let create_network_acl_entries_action_to_yojson
  ...
  assoc_to_yojson
    ...
    ("NetworkAclEntriesToBeCreated",
      (option_to_yojson entries_description_to_yojson
         x.network_acl_entries_to_be_created));
    ("NetworkAclId",
      (option_to_yojson action_target_to_yojson x.network_acl_id));
    ("Description",
      (option_to_yojson length_bounded_string_to_yojson x.description))]
let delete_network_acl_entries_action_to_yojson
  ...
  assoc_to_yojson
    ...
    ("NetworkAclEntriesToBeDeleted",
      (option_to_yojson entries_description_to_yojson
         x.network_acl_entries_to_be_deleted));
    ("NetworkAclId",
      (option_to_yojson action_target_to_yojson x.network_acl_id));
    ("Description",
      (option_to_yojson length_bounded_string_to_yojson x.description))]
let remediation_action_to_yojson (x : remediation_action) =
  assoc_to_yojson
    ...
    ("CreateNetworkAclAction",
      (option_to_yojson create_network_acl_action_to_yojson
         x.create_network_acl_action));
    ("FMSPolicyUpdateFirewallCreationConfigAction",
      (option_to_yojson
         fms_policy_update_firewall_creation_config_action_to_yojson
         x.fms_policy_update_firewall_creation_config_action));
    ("EC2CreateRouteTableAction",
      (option_to_yojson ec2_create_route_table_action_to_yojson
         x.ec2_create_route_table_action));
    ...
    ("EC2CopyRouteTableAction",
      (option_to_yojson ec2_copy_route_table_action_to_yojson
         x.ec2_copy_route_table_action));
    ("EC2DeleteRouteAction",
      (option_to_yojson ec2_delete_route_action_to_yojson
         x.ec2_delete_route_action));
    ("EC2ReplaceRouteAction",
      (option_to_yojson ec2_replace_route_action_to_yojson
         x.ec2_replace_route_action));
    ("EC2CreateRouteAction",
      (option_to_yojson ec2_create_route_action_to_yojson
         x.ec2_create_route_action));
    ("Description",
      (option_to_yojson length_bounded_string_to_yojson x.description))]
let remediation_action_with_order_to_yojson
  (x : remediation_action_with_order) =
  assoc_to_yojson
...
let possible_remediation_action_to_yojson (x : possible_remediation_action) =
  assoc_to_yojson
    ...
    ("OrderedRemediationActions",
      (Some
         (ordered_remediation_actions_to_yojson x.ordered_remediation_actions)));
    ("Description",
      (option_to_yojson length_bounded_string_to_yojson x.description))]
...
let resource_violation_to_yojson (x : resource_violation) =
  assoc_to_yojson
    ...
    ("FirewallSubnetMissingVPCEndpointViolation",
      (option_to_yojson
         firewall_subnet_missing_vpc_endpoint_violation_to_yojson
         x.firewall_subnet_missing_vpc_endpoint_violation));
    ("ThirdPartyFirewallMissingExpectedRouteTableViolation",
      (option_to_yojson
         third_party_firewall_missing_expected_route_table_violation_to_yojson
         x.third_party_firewall_missing_expected_route_table_violation));
    ("ThirdPartyFirewallMissingSubnetViolation",
      (option_to_yojson
         third_party_firewall_missing_subnet_violation_to_yojson
         x.third_party_firewall_missing_subnet_violation));
    ("ThirdPartyFirewallMissingFirewallViolation",
      (option_to_yojson
         third_party_firewall_missing_firewall_violation_to_yojson
         x.third_party_firewall_missing_firewall_violation));
    ...
    ("NetworkFirewallMissingExpectedRoutesViolation",
      (option_to_yojson
         network_firewall_missing_expected_routes_violation_to_yojson
         x.network_firewall_missing_expected_routes_violation));
    ("NetworkFirewallUnexpectedGatewayRoutesViolation",
      (option_to_yojson
         network_firewall_unexpected_gateway_routes_violation_to_yojson
         x.network_firewall_unexpected_gateway_routes_violation));
    ("NetworkFirewallUnexpectedFirewallRoutesViolation",
      (option_to_yojson
         network_firewall_unexpected_firewall_routes_violation_to_yojson
         x.network_firewall_unexpected_firewall_routes_violation));
    ("NetworkFirewallBlackHoleRouteDetectedViolation",
      (option_to_yojson
         network_firewall_black_hole_route_detected_violation_to_yojson
         x.network_firewall_black_hole_route_detected_violation));
    ("NetworkFirewallInvalidRouteConfigurationViolation",
      (option_to_yojson
         network_firewall_invalid_route_configuration_violation_to_yojson
         x.network_firewall_invalid_route_configuration_violation));
    ("NetworkFirewallInternetTrafficNotInspectedViolation",
      (option_to_yojson
         network_firewall_internet_traffic_not_inspected_violation_to_yojson
         x.network_firewall_internet_traffic_not_inspected_violation));
    ...
    ("NetworkFirewallMissingExpectedRTViolation",
      (option_to_yojson
         network_firewall_missing_expected_rt_violation_to_yojson
         x.network_firewall_missing_expected_rt_violation));
    ...
    ("AwsEc2InstanceViolation",
      (option_to_yojson aws_ec2_instance_violation_to_yojson
         x.aws_ec2_instance_violation));
    ...
    ("AwsVPCSecurityGroupViolation",
      (option_to_yojson aws_vpc_security_group_violation_to_yojson
         x.aws_vpc_security_group_violation))]
let resource_violations_to_yojson tree =
  list_to_yojson resource_violation_to_yojson tree
...
let third_party_firewall_policy_to_yojson (x : third_party_firewall_policy) =
  assoc_to_yojson
    [("FirewallDeploymentModel",
       (option_to_yojson firewall_deployment_model_to_yojson
          x.firewall_deployment_model))]
...
let third_party_firewall_firewall_policy_to_yojson
  (x : third_party_firewall_firewall_policy) =
  assoc_to_yojson
    [("FirewallPolicyName",
       (option_to_yojson firewall_policy_name_to_yojson
          x.firewall_policy_name));
    ("FirewallPolicyId",
...
let third_party_firewall_association_status_to_yojson
  (x : third_party_firewall_association_status) =
  match x with
...
let security_service_type_to_yojson (x : security_service_type) =
  ...
  | WAFV2 -> `String "WAFV2"
  | WAF -> `String "WAF"
let security_service_type_list_to_yojson tree =
  list_to_yojson security_service_type_to_yojson tree
let network_firewall_policy_to_yojson (x : network_firewall_policy) =
  assoc_to_yojson
    [("FirewallDeploymentModel",
       (option_to_yojson firewall_deployment_model_to_yojson
          x.firewall_deployment_model))]
let network_acl_entries_to_yojson tree =
  list_to_yojson network_acl_entry_to_yojson tree
...
let policy_option_to_yojson (x : policy_option) =
  assoc_to_yojson
    [("NetworkAclCommonPolicy",
       (option_to_yojson network_acl_common_policy_to_yojson
          x.network_acl_common_policy));
    ("ThirdPartyFirewallPolicy",
      (option_to_yojson third_party_firewall_policy_to_yojson
         x.third_party_firewall_policy));
    ("NetworkFirewallPolicy",
      (option_to_yojson network_firewall_policy_to_yojson
         x.network_firewall_policy))]
...
let resource_set_summary_list_to_yojson tree =
  list_to_yojson resource_set_summary_to_yojson tree
...
let protocols_list_data_to_yojson (x : protocols_list_data) =
  assoc_to_yojson
    [("PreviousProtocolsList",
       (option_to_yojson previous_protocols_list_to_yojson
          x.previous_protocols_list));
...
let customer_policy_scope_id_type_to_yojson
  (x : customer_policy_scope_id_type) =
  match x with
  | ORG_UNIT -> `String "ORG_UNIT"
  | ACCOUNT -> `String "ACCOUNT"
let customer_policy_scope_map_to_yojson tree =
  map_to_yojson customer_policy_scope_id_type_to_yojson
    customer_policy_scope_id_list_to_yojson tree
...
let policy_to_yojson (x : policy) =
  assoc_to_yojson
    ...
    ("DeleteUnusedFMManagedResources",
      (option_to_yojson boolean__to_yojson
         x.delete_unused_fm_managed_resources));
    ...
    ("SecurityServicePolicyData",
      (Some
         (security_service_policy_data_to_yojson
            x.security_service_policy_data)));
    ("PolicyUpdateToken",
...
let put_notification_channel_request_to_yojson
  (x : put_notification_channel_request) =
  assoc_to_yojson
...
let account_id_list_to_yojson tree =
  list_to_yojson aws_account_id_to_yojson tree
...
let admin_scope_to_yojson (x : admin_scope) =
  assoc_to_yojson
    ...
    ("OrganizationalUnitScope",
      (option_to_yojson organizational_unit_scope_to_yojson
         x.organizational_unit_scope));
    ("AccountScope",
...
let protocols_lists_data_to_yojson tree =
  list_to_yojson protocols_list_data_summary_to_yojson tree
...
let policy_summary_to_yojson (x : policy_summary) =
  assoc_to_yojson
    ...
    ("SecurityServiceType",
      (option_to_yojson security_service_type_to_yojson
         x.security_service_type));
    ("ResourceType",
    ...
    ("PolicyId", (option_to_yojson policy_id_to_yojson x.policy_id));
    ("PolicyArn", (option_to_yojson resource_arn_to_yojson x.policy_arn))]
let policy_summary_list_to_yojson tree =
  list_to_yojson policy_summary_to_yojson tree
let policy_compliance_status_type_to_yojson
  (x : policy_compliance_status_type) =
  match x with
...
let evaluation_result_to_yojson (x : evaluation_result) =
  assoc_to_yojson
    ...
    ("ComplianceStatus",
      (option_to_yojson policy_compliance_status_type_to_yojson
         x.compliance_status))]
...
let compliance_violator_metadata_to_yojson tree =
  map_to_yojson length_bounded_string_to_yojson
    length_bounded_string_to_yojson tree
let compliance_violator_to_yojson (x : compliance_violator) =
  assoc_to_yojson
    ...
    ("ResourceId", (option_to_yojson resource_id_to_yojson x.resource_id))]
let compliance_violators_to_yojson tree =
  list_to_yojson compliance_violator_to_yojson tree
...
let organization_status_to_yojson (x : organization_status) =
  ...
  | Onboarding -> `String "ONBOARDING"
let member_accounts_to_yojson tree =
  list_to_yojson aws_account_id_to_yojson tree
...
let list_protocols_lists_response_to_yojson
  (x : list_protocols_lists_response) =
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson pagination_token_to_yojson x.next_token));
    ("ProtocolsLists",
...
let list_member_accounts_response_to_yojson
  (x : list_member_accounts_response) =
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson pagination_token_to_yojson x.next_token));
    ("MemberAccounts",
...
let discovered_resource_list_to_yojson tree =
  list_to_yojson discovered_resource_to_yojson tree
...
let aws_account_id_list_to_yojson tree =
  list_to_yojson aws_account_id_to_yojson tree
...
let list_compliance_status_response_to_yojson
  (x : list_compliance_status_response) =
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson pagination_token_to_yojson x.next_token));
    ("PolicyComplianceStatusList",
      (option_to_yojson policy_compliance_status_list_to_yojson
         x.policy_compliance_status_list))]
let list_compliance_status_request_to_yojson
  (x : list_compliance_status_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson pagination_max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson pagination_token_to_yojson x.next_token));
...
let apps_list_data_summary_to_yojson (x : apps_list_data_summary) =
  assoc_to_yojson
    ...
    ("ListId", (option_to_yojson list_id_to_yojson x.list_id));
    ("ListArn", (option_to_yojson resource_arn_to_yojson x.list_arn))]
let apps_lists_data_to_yojson tree =
  list_to_yojson apps_list_data_summary_to_yojson tree
...
let list_admins_managing_account_response_to_yojson
  (x : list_admins_managing_account_response) =
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson pagination_token_to_yojson x.next_token));
    ("AdminAccounts",
...
let list_admins_managing_account_request_to_yojson
  (x : list_admins_managing_account_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson pagination_max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson pagination_token_to_yojson x.next_token))]
...
let admin_account_summary_list_to_yojson tree =
  list_to_yojson admin_account_summary_to_yojson tree
...
let get_protection_status_response_to_yojson
  (x : get_protection_status_response) =
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson pagination_token_to_yojson x.next_token));
...
let get_protection_status_request_to_yojson
  (x : get_protection_status_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson pagination_max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson pagination_token_to_yojson x.next_token));
...
let get_notification_channel_response_to_yojson
  (x : get_notification_channel_response) =
  assoc_to_yojson
    [("SnsRoleName",
...
let get_compliance_detail_response_to_yojson
  ...
  assoc_to_yojson
    [("PolicyComplianceDetail",
       (option_to_yojson policy_compliance_detail_to_yojson
          x.policy_compliance_detail))]
let get_compliance_detail_request_to_yojson
  (x : get_compliance_detail_request) =
  assoc_to_yojson
    [("MemberAccount", (Some (aws_account_id_to_yojson x.member_account)));
    ("PolicyId", (Some (policy_id_to_yojson x.policy_id)))]
...
let failed_item_to_yojson (x : failed_item) =
  assoc_to_yojson
    ...
    ("URI", (option_to_yojson identifier_to_yojson x.ur_i))]
let failed_item_list_to_yojson tree =
  list_to_yojson failed_item_to_yojson tree
...
let delete_protocols_list_request_to_yojson
  (x : delete_protocols_list_request) =
...
let batch_disassociate_resource_response_to_yojson
  (x : batch_disassociate_resource_response) =
  assoc_to_yojson
