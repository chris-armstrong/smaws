...
type nonrec partial_match =
  {
  target_violation_reasons: target_violation_reasons option
...
type nonrec security_group_remediation_actions =
  security_group_remediation_action list[@@ocaml.doc ""]
type nonrec aws_vpc_security_group_violation =
  {
  possible_security_group_remediation_actions:
    security_group_remediation_actions option
    [@ocaml.doc
...
type nonrec aws_ec2_network_interface_violations =
  aws_ec2_network_interface_violation list[@@ocaml.doc ""]
type nonrec aws_ec2_instance_violation =
  {
  aws_ec2_network_interface_violations:
    aws_ec2_network_interface_violations option
    [@ocaml.doc
...
type nonrec network_firewall_action_list = network_firewall_action list
[@@ocaml.doc ""]
...
type nonrec route =
  ...
  destination: length_bounded_string option
...
type nonrec expected_route =
  {
  route_table_id: resource_id option
...
type nonrec network_firewall_internet_traffic_not_inspected_violation =
  ...
  internet_gateway_id: resource_id option
...
type nonrec network_firewall_invalid_route_configuration_violation =
  ...
  actual_firewall_endpoint: resource_id option
  ...
  affected_subnets: resource_id_list option
...
type nonrec network_firewall_unexpected_firewall_routes_violation =
  {
  vpc_id: resource_id option [@ocaml.doc "Information about the VPC ID.\n"];
  firewall_endpoint: resource_id option
...
type nonrec network_firewall_missing_expected_routes_violation =
  {
  vpc_id: resource_id option [@ocaml.doc "Information about the VPC ID.\n"];
  expected_routes: expected_routes option
...
type nonrec route_has_out_of_scope_endpoint_violation =
  ...
  firewall_subnet_routes: routes option
...
type nonrec network_acl_port_range =
  {
  to_: ip_port_number_integer option
    [@ocaml.doc "The ending port number of the range. \n"];
  from_: ip_port_number_integer option
...
type nonrec ordered_remediation_actions = remediation_action_with_order list
[@@ocaml.doc ""]
...
type nonrec possible_remediation_action_list =
  possible_remediation_action list[@@ocaml.doc ""]
type nonrec possible_remediation_actions =
  {
  actions: possible_remediation_action_list option
...
type nonrec third_party_firewall_firewall_policies =
  third_party_firewall_firewall_policy list[@@ocaml.doc ""]
...
type nonrec previous_protocols_list =
  (previous_list_version * protocols_list) list[@@ocaml.doc ""]
...
type nonrec customer_policy_scope_id_list = customer_policy_scope_id list
[@@ocaml.doc ""]
...
type nonrec policy =
  ...
  resource_tags: resource_tags option
...
type nonrec previous_apps_list = (previous_list_version * apps_list) list
[@@ocaml.doc ""]
...
type nonrec organizational_unit_id_list = organizational_unit_id list
[@@ocaml.doc ""]
...
type nonrec protocols_list_data_summary =
  ...
  protocols_list: protocols_list option
    [@ocaml.doc
      "An array of protocols in the Firewall Manager protocols list.\n"];
  list_name: resource_name option
...
type nonrec policy_summary =
  ...
  policy_name: resource_name option
...
type nonrec issue_info_map = (dependent_service_name * detailed_info) list
[@@ocaml.doc ""]
type nonrec policy_compliance_status =
  ...
  member_account: aws_account_id option
...
type nonrec policy_compliance_status_list = policy_compliance_status list
[@@ocaml.doc ""]
type nonrec compliance_violator_metadata =
  (length_bounded_string * length_bounded_string) list[@@ocaml.doc ""]
...
type nonrec list_third_party_firewall_firewall_policies_response =
  ...
  third_party_firewall_firewall_policies:
    third_party_firewall_firewall_policies option
    [@ocaml.doc
...
type nonrec list_policies_response =
  ...
  policy_list: policy_summary_list option
...
type nonrec list_member_accounts_response =
  ...
  member_accounts: member_accounts option
...
type nonrec list_apps_lists_response =
  ...
  next_token: pagination_token option
    [@ocaml.doc
      "If you specify a value for [MaxResults] in your list request, and you have more objects than the maximum, Firewall Manager returns this token in the response. You can use this token in subsequent requests to retrieve the next batch of objects.\n"];
  apps_lists: apps_lists_data option
...
type nonrec get_violation_details_request =
  ...
  resource_type: resource_type
    [@ocaml.doc
      "The resource type. This is in the format shown in the {{:https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html}Amazon Web Services Resource Types Reference}. Supported resource types are: [AWS::WAFv2::WebACL], [AWS::EC2::Instance], [AWS::EC2::NetworkInterface], [AWS::EC2::SecurityGroup], [AWS::NetworkFirewall::FirewallPolicy], and [AWS::EC2::Subnet]. \n"];
  resource_id: resource_id
...
val make_associate_admin_account_request :
  admin_account:aws_account_id -> unit -> associate_admin_account_request(** {1:operations Operations} *)
