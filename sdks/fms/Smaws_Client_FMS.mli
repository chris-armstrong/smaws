...
val make_network_acl_icmp_type_code :
  ?type_:integer_object -> ?code:integer_object -> unit -> network_acl_icmp_type_code

val make_network_acl_port_range :
  ?to_:ip_port_number_integer -> ?from_:ip_port_number_integer -> unit -> network_acl_port_range
...
val make_action_target :
  ?description:length_bounded_string -> ?resource_id:resource_id -> unit -> action_target
...
val make_tag_resource_request :
  tag_list:tag_list -> resource_arn:resource_arn -> unit -> tag_resource_request
...
val make_region_scope :
  ?all_regions_enabled:boolean_ -> ?regions:aws_region_list -> unit -> region_scope

val make_put_resource_set_response :
  resource_set_arn:resource_arn -> resource_set:resource_set -> unit -> put_resource_set_response
...
val make_app : port:ip_port_number -> protocol:protocol -> app_name:resource_name -> unit -> app
...
val make_put_apps_list_response :
  ?apps_list_arn:resource_arn -> ?apps_list:apps_list_data -> unit -> put_apps_list_response
...
val make_list_policies_response :
  ?next_token:pagination_token -> ?policy_list:policy_summary_list -> unit -> list_policies_response
...
val make_list_apps_lists_response :
  ?next_token:pagination_token -> ?apps_lists:apps_lists_data -> unit -> list_apps_lists_response
...
val make_get_resource_set_response :
  resource_set_arn:resource_arn -> resource_set:resource_set -> unit -> get_resource_set_response
...
val make_get_compliance_detail_request :
  member_account:aws_account_id -> policy_id:policy_id -> unit -> get_compliance_detail_request

val make_get_apps_list_response :
  ?apps_list_arn:resource_arn -> ?apps_list:apps_list_data -> unit -> get_apps_list_response
...
val make_get_admin_scope_response :
  ?status:organization_status -> ?admin_scope:admin_scope -> unit -> get_admin_scope_response
...
val make_failed_item : ?reason:failed_item_reason -> ?ur_i:identifier -> unit -> failed_item
