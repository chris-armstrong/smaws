...
type nonrec sla_met = NA [@ocaml.doc ""] | NO [@ocaml.doc ""] | YES [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec node_update_initiated_by = CUSTOMER [@ocaml.doc ""] | SYSTEM [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec transit_encryption_mode = REQUIRED [@ocaml.doc ""] | PREFERRED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec pending_automatic_failover_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec auth_token_update_status = ROTATING [@ocaml.doc ""] | SETTING [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec log_type = ENGINE_LOG [@ocaml.doc ""] | SLOW_LOG [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec destination_type = KinesisFirehose [@ocaml.doc ""] | CloudWatchLogs [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec log_format = JSON [@ocaml.doc ""] | TEXT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec multi_az_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec data_tiering_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec cache_node = {
  customer_outpost_arn : string_ option;
...
type nonrec outpost_mode = CROSS_OUTPOST [@ocaml.doc ""] | SINGLE_OUTPOST [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec modify_replication_group_message = {
  ...
  replication_group_id : string_; [@ocaml.doc "The identifier of the replication group to modify.\n"]
}
...
type nonrec az_mode = CROSS_AZ [@ocaml.doc ""] | SINGLE_AZ [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec create_user_message = {
  ...
  user_id : user_id; [@ocaml.doc "The ID of the user. This value is stored as a lowercase string.\n"]
}
[@@ocaml.doc ""]
