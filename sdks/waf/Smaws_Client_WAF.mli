...
type nonrec parameter_exception_field =
  ...
  | CHANGE_ACTION [@ocaml.doc ""][@@ocaml.doc ""]
...
type nonrec parameter_exception_reason =
  ...
  | INVALID_OPTION [@ocaml.doc ""][@@ocaml.doc ""]
type nonrec waf_invalid_parameter_exception =
  ...
  field: parameter_exception_field option [@ocaml.doc ""]}[@@ocaml.doc
...
type nonrec migration_error_type =
  ...
  | ENTITY_NOT_SUPPORTED [@ocaml.doc ""][@@ocaml.doc ""]
...
type nonrec sql_injection_match_set_updates =
  sql_injection_match_set_update list[@@ocaml.doc ""]
...
type nonrec size_constraint_set_updates = size_constraint_set_update list
[@@ocaml.doc ""]
...
type nonrec regex_pattern_set_updates = regex_pattern_set_update list
[@@ocaml.doc ""]
...
type nonrec subscribed_rule_group_summaries =
  subscribed_rule_group_summary list[@@ocaml.doc ""]
type nonrec sql_injection_match_tuples = sql_injection_match_tuple list
[@@ocaml.doc ""]
...
type nonrec sql_injection_match_set_summaries =
  sql_injection_match_set_summary list[@@ocaml.doc ""]
...
type nonrec size_constraint_set_summaries = size_constraint_set_summary list
[@@ocaml.doc ""]
...
type nonrec list_activated_rules_in_rule_group_response =
  {
  activated_rules: activated_rules option
...
val make_create_byte_match_set_request :
  change_token:change_token ->
    name:resource_name -> unit -> create_byte_match_set_request(** {1:operations Operations} *)
