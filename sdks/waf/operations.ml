    ...
    let request context (request : create_geo_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824CreateGeoMatchSet"
    ...
    let request context (request : create_ip_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824CreateIPSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : create_rule_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824CreateRule"
            ~service ~config:context.config ~input
    ...
    let request context (request : create_rule_group_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824CreateRuleGroup"
            ~service ~config:context.config ~input
    ...
    let request context (request : create_web_acl_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824CreateWebACL"
            ~service ~config:context.config ~input
    ...
    let request context (request : create_xss_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824CreateXssMatchSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : delete_geo_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824DeleteGeoMatchSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : delete_ip_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824DeleteIPSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : delete_rule_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824DeleteRule"
            ~service ~config:context.config ~input
    ...
    let request context (request : delete_rule_group_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824DeleteRuleGroup"
            ~service ~config:context.config ~input
    ...
    let request context (request : delete_web_acl_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824DeleteWebACL"
            ~service ~config:context.config ~input
    ...
    let request context (request : delete_xss_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824DeleteXssMatchSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : get_byte_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetByteMatchSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : unit) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetChangeToken"
            ~service ~config:context.config ~input
    ...
    let request context (request : get_geo_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetGeoMatchSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : get_ip_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetIPSet" ~service
            ~config:context.config ~input
    ...
    let request context (request : get_rate_based_rule_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetRateBasedRule"
            ~service ~config:context.config ~input
    ...
    let request context (request : get_regex_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetRegexMatchSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : get_rule_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetRule" ~service
            ~config:context.config ~input
    ...
    let request context (request : get_rule_group_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetRuleGroup"
            ~service ~config:context.config ~input
    ...
    let request context (request : get_web_acl_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetWebACL"
            ~service ~config:context.config ~input
    ...
    let request context (request : get_xss_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824GetXssMatchSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : list_byte_match_sets_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824ListByteMatchSets"
            ~service ~config:context.config ~input
    ...
    let request context (request : list_geo_match_sets_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824ListGeoMatchSets"
            ~service ~config:context.config ~input
    ...
    let request context (request : list_ip_sets_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824ListIPSets"
            ~service ~config:context.config ~input
    ...
    let request context (request : list_rule_groups_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824ListRuleGroups"
            ~service ~config:context.config ~input
    ...
    let request context (request : list_rules_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824ListRules"
            ~service ~config:context.config ~input
    ...
    let request context (request : list_web_ac_ls_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824ListWebACLs"
            ~service ~config:context.config ~input
    ...
    let request context (request : list_xss_match_sets_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824ListXssMatchSets"
            ~service ~config:context.config ~input
    ...
    let request context (request : tag_resource_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824TagResource"
            ~service ~config:context.config ~input
    ...
    let request context (request : untag_resource_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824UntagResource"
            ~service ~config:context.config ~input
    ...
    let request context (request : update_geo_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824UpdateGeoMatchSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : update_ip_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824UpdateIPSet"
            ~service ~config:context.config ~input
    ...
    let request context (request : update_rule_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824UpdateRule"
            ~service ~config:context.config ~input
    ...
    let request context (request : update_rule_group_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824UpdateRuleGroup"
            ~service ~config:context.config ~input
    ...
    let request context (request : update_web_acl_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824UpdateWebACL"
            ~service ~config:context.config ~input
    ...
    let request context (request : update_xss_match_set_request) =
      let open Smaws_Lib.Context in
        let open Deserializers in
          ...
          Smaws_Lib.Protocols.AwsJson.request_with_http_module
            ~http_module:(Smaws_Lib.Context.http_module context)
            ~http:context.http ~shape_name:"AWSWAF_20150824UpdateXssMatchSet"
            ~service ~config:context.config ~input
