...
let activated_rule_of_yojson tree path =
  ...
  ({
     ...
     type_ =
       (option_of_yojson (value_for_key waf_rule_type_of_yojson "Type") _list
          path);
     override_action =
       (option_of_yojson
...
let waf_invalid_parameter_exception_of_yojson tree path =
  ...
  ({
     reason =
       (option_of_yojson
          (value_for_key parameter_exception_reason_of_yojson "reason") _list
          path);
     parameter =
       (option_of_yojson
...
let waf_entity_migration_exception_of_yojson tree path =
  ...
  ({
     migration_error_reason =
       (option_of_yojson
          (value_for_key error_reason_of_yojson "MigrationErrorReason") _list
          path);
...
let update_xss_match_set_response_of_yojson tree path =
  ...
  ({
     change_token =
       (option_of_yojson (value_for_key change_token_of_yojson "ChangeToken")
          _list path)
...
let update_web_acl_request_of_yojson tree path =
  ...
  ({
     default_action =
       (option_of_yojson (value_for_key waf_action_of_yojson "DefaultAction")
          _list path);
     updates =
...
let geo_match_constraint_of_yojson tree path =
  ...
  ({
     value =
       (value_for_key geo_match_constraint_value_of_yojson "Value" _list path);
     type_ =
  ...
  ({
     ...
     text_transformation =
       (value_for_key text_transformation_of_yojson "TextTransformation"
          _list path);
     target_string =
       (value_for_key byte_match_target_string_of_yojson "TargetString" _list
          path);
     field_to_match =
       (value_for_key field_to_match_of_yojson "FieldToMatch" _list path)
   } : byte_match_tuple)
...
let size_constraint_set_of_yojson tree path =
  ...
  ({
     size_constraints =
       (value_for_key size_constraints_of_yojson "SizeConstraints" _list path);
     name =
       (option_of_yojson (value_for_key resource_name_of_yojson "Name") _list
          path);
     size_constraint_set_id =
  ...
  ({
     next_marker =
       (option_of_yojson (value_for_key next_marker_of_yojson "NextMarker")
          _list path);
     managed_keys =
       (option_of_yojson (value_for_key managed_keys_of_yojson "ManagedKeys")
          _list path)
