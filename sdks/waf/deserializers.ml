...
let field_to_match_of_yojson tree path =
  ...
  let _res : field_to_match =
    {
      data =
        (option_of_yojson (value_for_key match_field_data_of_yojson "Data")
           _list path);
...
let xss_match_tuple_of_yojson tree path =
  ...
  let _res : xss_match_tuple =
    {
      text_transformation =
        (value_for_key text_transformation_of_yojson "TextTransformation"
           _list path);
      field_to_match =
...
let xss_match_set_update_of_yojson tree path =
  ...
  let _res : xss_match_set_update =
    {
      xss_match_tuple =
        (value_for_key xss_match_tuple_of_yojson "XssMatchTuple" _list path);
  ...
  let _res : xss_match_set_summary =
    {
      ...
      xss_match_set_id =
        (value_for_key resource_id_of_yojson "XssMatchSetId" _list path)
    } in
  _res
...
let xss_match_set_of_yojson tree path =
  ...
  let _res : xss_match_set =
    {
      xss_match_tuples =
        (value_for_key xss_match_tuples_of_yojson "XssMatchTuples" _list path);
      name =
...
let waf_action_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : waf_action =
    { type_ = (value_for_key waf_action_type_of_yojson "Type" _list path) } in
  _res
...
let excluded_rule_of_yojson tree path =
  ...
  let _res : excluded_rule =
    { rule_id = (value_for_key resource_id_of_yojson "RuleId" _list path) } in
  _res
  ...
  let _res : activated_rule =
    {
      excluded_rules =
        (option_of_yojson
           ...
           path);
      type_ =
        (option_of_yojson (value_for_key waf_rule_type_of_yojson "Type")
           _list path);
      override_action =
        (option_of_yojson
           (value_for_key waf_override_action_of_yojson "OverrideAction")
           _list path);
      action =
        (option_of_yojson (value_for_key waf_action_of_yojson "Action") _list
           path);
...
let web_acl_update_of_yojson tree path =
  ...
  let _res : web_acl_update =
    {
      activated_rule =
        (value_for_key activated_rule_of_yojson "ActivatedRule" _list path);
      action = (value_for_key change_action_of_yojson "Action" _list path)
    } in
  _res
let web_acl_updates_of_yojson tree path =
  list_of_yojson web_acl_update_of_yojson tree path
  ...
  let _res : web_acl_summary =
    {
      name = (value_for_key resource_name_of_yojson "Name" _list path);
      web_acl_id =
        (value_for_key resource_id_of_yojson "WebACLId" _list path)
    } in
  _res
...
let activated_rules_of_yojson tree path =
  list_of_yojson activated_rule_of_yojson tree path
  ...
  let _res : web_ac_l =
    {
      ...
      default_action =
        (value_for_key waf_action_of_yojson "DefaultAction" _list path);
      metric_name =
  ...
  let _res : waf_invalid_parameter_exception =
    {
      reason =
        (option_of_yojson
           (value_for_key parameter_exception_reason_of_yojson "reason")
           _list path);
      parameter =
        (option_of_yojson
  ...
  let _res : waf_entity_migration_exception =
    {
      migration_error_reason =
        (option_of_yojson
           (value_for_key error_reason_of_yojson "MigrationErrorReason")
           _list path);
      migration_error_type =
        (option_of_yojson
...
let update_xss_match_set_request_of_yojson tree path =
  ...
  let _res : update_xss_match_set_request =
    {
      updates =
        (value_for_key xss_match_set_updates_of_yojson "Updates" _list path);
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      xss_match_set_id =
        (value_for_key resource_id_of_yojson "XssMatchSetId" _list path)
  ...
  let _res : update_web_acl_request =
    {
      default_action =
        (option_of_yojson
           (value_for_key waf_action_of_yojson "DefaultAction") _list path);
      updates =
        (option_of_yojson (value_for_key web_acl_updates_of_yojson "Updates")
           _list path);
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      web_acl_id =
  ...
  let _res : sql_injection_match_set_update =
    {
      sql_injection_match_tuple =
        (value_for_key sql_injection_match_tuple_of_yojson
           "SqlInjectionMatchTuple" _list path);
      action = (value_for_key change_action_of_yojson "Action" _list path)
    } in
  _res
...
let update_sql_injection_match_set_request_of_yojson tree path =
  ...
  let _res : update_sql_injection_match_set_request =
    {
      updates =
        (value_for_key sql_injection_match_set_updates_of_yojson "Updates"
           _list path);
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      sql_injection_match_set_id =
        (value_for_key resource_id_of_yojson "SqlInjectionMatchSetId" _list
           path)
    } in
  _res
...
let size_constraint_set_update_of_yojson tree path =
  ...
  let _res : size_constraint_set_update =
    {
      size_constraint =
        (value_for_key size_constraint_of_yojson "SizeConstraint" _list path);
      action = (value_for_key change_action_of_yojson "Action" _list path)
    } in
  _res
...
let update_size_constraint_set_request_of_yojson tree path =
  ...
  let _res : update_size_constraint_set_request =
    {
      updates =
        (value_for_key size_constraint_set_updates_of_yojson "Updates" _list
           path);
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      size_constraint_set_id =
        (value_for_key resource_id_of_yojson "SizeConstraintSetId" _list path)
    } in
  _res
...
let rule_update_of_yojson tree path =
  ...
  _res
let rule_updates_of_yojson tree path =
  list_of_yojson rule_update_of_yojson tree path
...
let rule_group_update_of_yojson tree path =
  ...
  _res
let rule_group_updates_of_yojson tree path =
  list_of_yojson rule_group_update_of_yojson tree path
  ...
  let _res : update_rule_group_request =
    {
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      updates =
        (value_for_key rule_group_updates_of_yojson "Updates" _list path);
      rule_group_id =
        (value_for_key resource_id_of_yojson "RuleGroupId" _list path)
    } in
  _res
  ...
  let _res : regex_pattern_set_update =
    {
      regex_pattern_string =
        (value_for_key regex_pattern_string_of_yojson "RegexPatternString"
           _list path);
      action = (value_for_key change_action_of_yojson "Action" _list path)
    } in
  _res
  ...
  let _res : update_regex_pattern_set_request =
    {
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      updates =
        (value_for_key regex_pattern_set_updates_of_yojson "Updates" _list
           path);
      regex_pattern_set_id =
        (value_for_key resource_id_of_yojson "RegexPatternSetId" _list path)
    } in
  _res
...
let regex_match_set_update_of_yojson tree path =
  ...
  let _res : regex_match_set_update =
    {
      regex_match_tuple =
        (value_for_key regex_match_tuple_of_yojson "RegexMatchTuple" _list
           path);
      action = (value_for_key change_action_of_yojson "Action" _list path)
    } in
  _res
  ...
  let _res : update_regex_match_set_request =
    {
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      updates =
        (value_for_key regex_match_set_updates_of_yojson "Updates" _list path);
      regex_match_set_id =
        (value_for_key resource_id_of_yojson "RegexMatchSetId" _list path)
    } in
  _res
...
let update_rate_based_rule_request_of_yojson tree path =
  ...
  let _res : update_rate_based_rule_request =
    {
      rate_limit =
        (value_for_key rate_limit_of_yojson "RateLimit" _list path);
      updates = (value_for_key rule_updates_of_yojson "Updates" _list path);
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      rule_id = (value_for_key resource_id_of_yojson "RuleId" _list path)
...
let ip_set_descriptor_of_yojson tree path =
  ...
  let _res : ip_set_descriptor =
    {
      value =
        (value_for_key ip_set_descriptor_value_of_yojson "Value" _list path);
      type_ =
        (value_for_key ip_set_descriptor_type_of_yojson "Type" _list path)
    } in
  _res
let ip_set_update_of_yojson tree path =
  ...
  let _res : ip_set_update =
    {
      ip_set_descriptor =
        (value_for_key ip_set_descriptor_of_yojson "IPSetDescriptor" _list
           path);
      action = (value_for_key change_action_of_yojson "Action" _list path)
    } in
  _res
let ip_set_updates_of_yojson tree path =
  list_of_yojson ip_set_update_of_yojson tree path
...
let geo_match_constraint_of_yojson tree path =
  ...
  let _res : geo_match_constraint =
    {
      value =
        (value_for_key geo_match_constraint_value_of_yojson "Value" _list
           path);
      type_ =
        (value_for_key geo_match_constraint_type_of_yojson "Type" _list path)
    } in
  _res
  ...
  let _res : geo_match_set_update =
    {
      geo_match_constraint =
        (value_for_key geo_match_constraint_of_yojson "GeoMatchConstraint"
           _list path);
      action = (value_for_key change_action_of_yojson "Action" _list path)
    } in
  _res
...
let update_geo_match_set_request_of_yojson tree path =
  ...
  let _res : update_geo_match_set_request =
    {
      updates =
        (value_for_key geo_match_set_updates_of_yojson "Updates" _list path);
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      geo_match_set_id =
  ...
  let _res : byte_match_tuple =
    {
      ...
      text_transformation =
        (value_for_key text_transformation_of_yojson "TextTransformation"
           _list path);
      target_string =
        (value_for_key byte_match_target_string_of_yojson "TargetString"
           _list path);
      field_to_match =
        (value_for_key field_to_match_of_yojson "FieldToMatch" _list path)
    } in
...
let byte_match_set_update_of_yojson tree path =
  ...
  let _res : byte_match_set_update =
    {
      byte_match_tuple =
        (value_for_key byte_match_tuple_of_yojson "ByteMatchTuple" _list path);
      action = (value_for_key change_action_of_yojson "Action" _list path)
    } in
  _res
...
let update_byte_match_set_request_of_yojson tree path =
  ...
  let _res : update_byte_match_set_request =
    {
      updates =
        (value_for_key byte_match_set_updates_of_yojson "Updates" _list path);
      change_token =
        (value_for_key change_token_of_yojson "ChangeToken" _list path);
      byte_match_set_id =
        (value_for_key resource_id_of_yojson "ByteMatchSetId" _list path)
    } in
  _res
...
let sql_injection_match_set_of_yojson tree path =
  ...
  let _res : sql_injection_match_set =
    {
      sql_injection_match_tuples =
        (value_for_key sql_injection_match_tuples_of_yojson
           "SqlInjectionMatchTuples" _list path);
      name =
        (option_of_yojson (value_for_key resource_name_of_yojson "Name")
           _list path);
      sql_injection_match_set_id =
  ...
  _res
let size_constraints_of_yojson tree path =
  list_of_yojson size_constraint_of_yojson tree path
...
let size_constraint_set_of_yojson tree path =
  ...
  let _res : size_constraint_set =
    {
      size_constraints =
        (value_for_key size_constraints_of_yojson "SizeConstraints" _list
           path);
      name =
        (option_of_yojson (value_for_key resource_name_of_yojson "Name")
           _list path);
  ...
  let _res : sampled_http_request =
    {
      rule_within_rule_group =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "RuleWithinRuleGroup") _list
           path);
      action =
...
let rule_group_of_yojson tree path =
  ...
  _res
let predicates_of_yojson tree path =
  list_of_yojson predicate_of_yojson tree path
let rule_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : rule =
    {
      predicates =
        (value_for_key predicates_of_yojson "Predicates" _list path);
      metric_name =
        (option_of_yojson (value_for_key metric_name_of_yojson "MetricName")
           _list path);
      name =
...
let regex_pattern_set_of_yojson tree path =
  ...
  let _res : regex_pattern_set =
    {
      regex_pattern_strings =
        (value_for_key regex_pattern_strings_of_yojson "RegexPatternStrings"
           _list path);
      name =
        (option_of_yojson (value_for_key resource_name_of_yojson "Name")
           _list path);
  ...
  _res
let regex_match_tuples_of_yojson tree path =
  list_of_yojson regex_match_tuple_of_yojson tree path
  ...
  let _res : regex_match_set =
    {
      regex_match_tuples =
        (option_of_yojson
           (value_for_key regex_match_tuples_of_yojson "RegexMatchTuples")
           _list path);
      name =
        (option_of_yojson (value_for_key resource_name_of_yojson "Name")
           _list path);
  ...
  let _res : rate_based_rule =
    {
      ...
      match_predicates =
        (value_for_key predicates_of_yojson "MatchPredicates" _list path);
      metric_name =
        (option_of_yojson (value_for_key metric_name_of_yojson "MetricName")
           _list path);
      name =
...
let managed_keys_of_yojson tree path =
  list_of_yojson managed_key_of_yojson tree path
  ...
  let _res : list_xss_match_sets_response =
    {
      xss_match_sets =
        (option_of_yojson
           (value_for_key xss_match_set_summaries_of_yojson "XssMatchSets")
           _list path);
      next_marker =
  ...
  let _res : list_subscribed_rule_groups_response =
    {
      rule_groups =
        (option_of_yojson
           (value_for_key subscribed_rule_group_summaries_of_yojson
              "RuleGroups") _list path);
      next_marker =
        (option_of_yojson (value_for_key next_marker_of_yojson "NextMarker")
           _list path)
    } in
  ...
  let _res : list_sql_injection_match_sets_response =
    {
      sql_injection_match_sets =
        (option_of_yojson
           (value_for_key sql_injection_match_set_summaries_of_yojson
              "SqlInjectionMatchSets") _list path);
      next_marker =
        (option_of_yojson (value_for_key next_marker_of_yojson "NextMarker")
           _list path)
    } in
  ...
  let _res : list_size_constraint_sets_response =
    {
      size_constraint_sets =
        (option_of_yojson
           (value_for_key size_constraint_set_summaries_of_yojson
              "SizeConstraintSets") _list path);
      next_marker =
        (option_of_yojson (value_for_key next_marker_of_yojson "NextMarker")
           _list path)
    } in
  ...
  let _res : list_regex_match_sets_response =
    {
      regex_match_sets =
        (option_of_yojson
           (value_for_key regex_match_set_summaries_of_yojson
              "RegexMatchSets") _list path);
      next_marker =
        (option_of_yojson (value_for_key next_marker_of_yojson "NextMarker")
           _list path)
    } in
  ...
  let _res : list_geo_match_sets_response =
    {
      geo_match_sets =
        (option_of_yojson
           (value_for_key geo_match_set_summaries_of_yojson "GeoMatchSets")
           _list path);
      next_marker =
        (option_of_yojson (value_for_key next_marker_of_yojson "NextMarker")
           _list path)
  ...
  let _res : list_activated_rules_in_rule_group_response =
    {
      activated_rules =
        (option_of_yojson
           (value_for_key activated_rules_of_yojson "ActivatedRules") _list
           path);
      next_marker =
        (option_of_yojson (value_for_key next_marker_of_yojson "NextMarker")
           _list path)
  ...
  let _res : list_activated_rules_in_rule_group_request =
    {
      ...
      next_marker =
        (option_of_yojson (value_for_key next_marker_of_yojson "NextMarker")
           _list path);
      rule_group_id =
        (option_of_yojson (value_for_key resource_id_of_yojson "RuleGroupId")
           _list path)
    } in
  _res
let ignore_unsupported_type_of_yojson = bool_of_yojson
let ip_set_descriptors_of_yojson tree path =
  list_of_yojson ip_set_descriptor_of_yojson tree path
let ip_set_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : ip_set =
    {
      ip_set_descriptors =
        (value_for_key ip_set_descriptors_of_yojson "IPSetDescriptors" _list
           path);
      name =
        (option_of_yojson (value_for_key resource_name_of_yojson "Name")
           _list path);
  ...
  let _res : get_xss_match_set_response =
    {
      xss_match_set =
        (option_of_yojson
           (value_for_key xss_match_set_of_yojson "XssMatchSet") _list path)
    } in
  _res
  ...
  let _res : get_sql_injection_match_set_response =
    {
      sql_injection_match_set =
        (option_of_yojson
           (value_for_key sql_injection_match_set_of_yojson
              "SqlInjectionMatchSet") _list path)
    } in
  _res
  ...
  let _res : get_size_constraint_set_response =
    {
      size_constraint_set =
        (option_of_yojson
           (value_for_key size_constraint_set_of_yojson "SizeConstraintSet")
           _list path)
    } in
  _res
...
let get_sampled_requests_request_of_yojson tree path =
  ...
  let _res : get_sampled_requests_request =
    {
      max_items =
        (value_for_key get_sampled_requests_max_items_of_yojson "MaxItems"
           _list path);
      time_window =
...
let get_rule_response_of_yojson tree path =
  ...
  let _res : get_rule_response =
    {
      rule =
        (option_of_yojson (value_for_key rule_of_yojson "Rule") _list path)
    } in
  _res
  ...
  let _res : get_regex_match_set_response =
    {
      regex_match_set =
        (option_of_yojson
           (value_for_key regex_match_set_of_yojson "RegexMatchSet") _list
           path)
    } in
  _res
...
let get_rate_based_rule_response_of_yojson tree path =
  ...
  let _res : get_rate_based_rule_response =
    {
      rule =
        (option_of_yojson (value_for_key rate_based_rule_of_yojson "Rule")
           _list path)
    } in
  _res
  ...
  let _res : get_rate_based_rule_managed_keys_response =
    {
      ...
      managed_keys =
        (option_of_yojson
           (value_for_key managed_keys_of_yojson "ManagedKeys") _list path)
    } in
  _res
  ...
  let _res : geo_match_set =
    {
      geo_match_constraints =
        (value_for_key geo_match_constraints_of_yojson "GeoMatchConstraints"
           _list path);
      name =
        (option_of_yojson (value_for_key resource_name_of_yojson "Name")
           _list path);
  ...
  let _res : get_geo_match_set_response =
    {
      geo_match_set =
        (option_of_yojson
           (value_for_key geo_match_set_of_yojson "GeoMatchSet") _list path)
    } in
  _res
  ...
  let _res : get_change_token_status_response =
    {
      change_token_status =
        (option_of_yojson
           (value_for_key change_token_status_of_yojson "ChangeTokenStatus")
           _list path)
    } in
  _res
...
let byte_match_set_of_yojson tree path =
  ...
  let _res : byte_match_set =
    {
      byte_match_tuples =
        (value_for_key byte_match_tuples_of_yojson "ByteMatchTuples" _list
           path);
      name =
        (option_of_yojson (value_for_key resource_name_of_yojson "Name")
           _list path);
  ...
  let _res : get_byte_match_set_response =
    {
      byte_match_set =
        (option_of_yojson
           (value_for_key byte_match_set_of_yojson "ByteMatchSet") _list path)
    } in
  _res
...
let create_web_acl_migration_stack_response_of_yojson tree path =
  ...
  let _res : create_web_acl_migration_stack_response =
    {
      s3_object_url =
        (value_for_key s3_object_url_of_yojson "S3ObjectUrl" _list path)
    } in
  _res
  ...
  let _res : create_web_acl_migration_stack_request =
    {
      ignore_unsupported_type =
        (value_for_key ignore_unsupported_type_of_yojson
           "IgnoreUnsupportedType" _list path);
      s3_bucket_name =
