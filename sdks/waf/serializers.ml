...
let xss_match_tuples_to_yojson tree =
  list_to_yojson xss_match_tuple_to_yojson tree
...
let xss_match_set_updates_to_yojson tree =
  list_to_yojson xss_match_set_update_to_yojson tree
...
let xss_match_set_summaries_to_yojson tree =
  list_to_yojson xss_match_set_summary_to_yojson tree
...
let waf_override_action_to_yojson (x : waf_override_action) =
  assoc_to_yojson
    [("Type", (Some (waf_override_action_type_to_yojson x.type_)))]
...
let web_acl_update_to_yojson (x : web_acl_update) =
  assoc_to_yojson
    ...
    ("Action", (Some (change_action_to_yojson x.action)))]
let web_acl_updates_to_yojson tree =
  list_to_yojson web_acl_update_to_yojson tree
...
let activated_rules_to_yojson tree =
  list_to_yojson activated_rule_to_yojson tree
...
let waf_referenced_item_exception_to_yojson
  (x : waf_referenced_item_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let waf_nonexistent_container_exception_to_yojson
  (x : waf_nonexistent_container_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
let waf_non_empty_entity_exception_to_yojson
  (x : waf_non_empty_entity_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let waf_invalid_regex_pattern_exception_to_yojson
  (x : waf_invalid_regex_pattern_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let waf_entity_migration_exception_to_yojson
  (x : waf_entity_migration_exception) =
  assoc_to_yojson
...
let waf_disallowed_name_exception_to_yojson
  (x : waf_disallowed_name_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let update_xss_match_set_response_to_yojson
  (x : update_xss_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
...
let update_sql_injection_match_set_response_to_yojson
  (x : update_sql_injection_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
...
let sql_injection_match_set_update_to_yojson
  (x : sql_injection_match_set_update) =
  assoc_to_yojson
    [("SqlInjectionMatchTuple",
       (Some
          (sql_injection_match_tuple_to_yojson x.sql_injection_match_tuple)));
    ("Action", (Some (change_action_to_yojson x.action)))]
...
let update_sql_injection_match_set_request_to_yojson
  (x : update_sql_injection_match_set_request) =
  assoc_to_yojson
    [("Updates",
...
let update_size_constraint_set_response_to_yojson
  (x : update_size_constraint_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
...
let update_size_constraint_set_request_to_yojson
  (x : update_size_constraint_set_request) =
  assoc_to_yojson
...
let rule_group_update_to_yojson (x : rule_group_update) =
  assoc_to_yojson
    [("ActivatedRule", (Some (activated_rule_to_yojson x.activated_rule)));
    ("Action", (Some (change_action_to_yojson x.action)))]
let rule_group_updates_to_yojson tree =
  list_to_yojson rule_group_update_to_yojson tree
...
let update_regex_match_set_response_to_yojson
  (x : update_regex_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
...
let regex_match_set_update_to_yojson (x : regex_match_set_update) =
  assoc_to_yojson
    ...
    ("Action", (Some (change_action_to_yojson x.action)))]
let regex_match_set_updates_to_yojson tree =
  list_to_yojson regex_match_set_update_to_yojson tree
let update_regex_match_set_request_to_yojson
  (x : update_regex_match_set_request) =
  assoc_to_yojson
    [("ChangeToken", (Some (change_token_to_yojson x.change_token)));
...
let ip_set_update_to_yojson (x : ip_set_update) =
  assoc_to_yojson
    ...
    ("Action", (Some (change_action_to_yojson x.action)))]
let ip_set_updates_to_yojson tree =
  list_to_yojson ip_set_update_to_yojson tree
...
let update_geo_match_set_response_to_yojson
  (x : update_geo_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
...
let geo_match_set_update_to_yojson (x : geo_match_set_update) =
  assoc_to_yojson
    ...
    ("Action", (Some (change_action_to_yojson x.action)))]
let geo_match_set_updates_to_yojson tree =
  list_to_yojson geo_match_set_update_to_yojson tree
...
let update_byte_match_set_response_to_yojson
  (x : update_byte_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
...
let byte_match_set_update_to_yojson (x : byte_match_set_update) =
  assoc_to_yojson
    ...
    ("Action", (Some (change_action_to_yojson x.action)))]
let byte_match_set_updates_to_yojson tree =
  list_to_yojson byte_match_set_update_to_yojson tree
let update_byte_match_set_request_to_yojson
  (x : update_byte_match_set_request) =
  assoc_to_yojson
...
let subscribed_rule_group_summary_to_yojson
  (x : subscribed_rule_group_summary) =
  assoc_to_yojson
...
let sql_injection_match_set_summary_to_yojson
  (x : sql_injection_match_set_summary) =
  assoc_to_yojson
    [("Name", (Some (resource_name_to_yojson x.name)));
    ("SqlInjectionMatchSetId",
      (Some (resource_id_to_yojson x.sql_injection_match_set_id)))]
...
let sql_injection_match_set_to_yojson (x : sql_injection_match_set) =
  assoc_to_yojson
    [("SqlInjectionMatchTuples",
       (Some
          (sql_injection_match_tuples_to_yojson x.sql_injection_match_tuples)));
    ("Name", (option_to_yojson resource_name_to_yojson x.name));
    ("SqlInjectionMatchSetId",
      (Some (resource_id_to_yojson x.sql_injection_match_set_id)))]
let size_constraints_to_yojson tree =
  list_to_yojson size_constraint_to_yojson tree
...
let rule_to_yojson (x : rule) =
  assoc_to_yojson
    ...
    ("Name", (option_to_yojson resource_name_to_yojson x.name));
    ("RuleId", (Some (resource_id_to_yojson x.rule_id)))]
let regex_pattern_strings_to_yojson tree =
  list_to_yojson regex_pattern_string_to_yojson tree
...
let regex_pattern_set_to_yojson (x : regex_pattern_set) =
  assoc_to_yojson
    ...
    ("RegexPatternSetId",
      (Some (resource_id_to_yojson x.regex_pattern_set_id)))]
let regex_match_tuples_to_yojson tree =
  list_to_yojson regex_match_tuple_to_yojson tree
let regex_match_set_summary_to_yojson (x : regex_match_set_summary) =
  assoc_to_yojson
    [("Name", (Some (resource_name_to_yojson x.name)));
    ("RegexMatchSetId", (Some (resource_id_to_yojson x.regex_match_set_id)))]
let regex_match_set_summaries_to_yojson tree =
  list_to_yojson regex_match_set_summary_to_yojson tree
...
let list_subscribed_rule_groups_response_to_yojson
  (x : list_subscribed_rule_groups_response) =
  assoc_to_yojson
    [("RuleGroups",
       (option_to_yojson subscribed_rule_group_summaries_to_yojson
          x.rule_groups));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
let list_subscribed_rule_groups_request_to_yojson
  (x : list_subscribed_rule_groups_request) =
  assoc_to_yojson
    [("Limit", (option_to_yojson pagination_limit_to_yojson x.limit));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
let list_sql_injection_match_sets_response_to_yojson
  (x : list_sql_injection_match_sets_response) =
  assoc_to_yojson
    [("SqlInjectionMatchSets",
       (option_to_yojson sql_injection_match_set_summaries_to_yojson
          x.sql_injection_match_sets));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
let list_sql_injection_match_sets_request_to_yojson
  (x : list_sql_injection_match_sets_request) =
  assoc_to_yojson
    [("Limit", (option_to_yojson pagination_limit_to_yojson x.limit));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
let list_size_constraint_sets_response_to_yojson
  (x : list_size_constraint_sets_response) =
  assoc_to_yojson
    [("SizeConstraintSets",
       (option_to_yojson size_constraint_set_summaries_to_yojson
          x.size_constraint_sets));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
let list_size_constraint_sets_request_to_yojson
  (x : list_size_constraint_sets_request) =
  assoc_to_yojson
    [("Limit", (option_to_yojson pagination_limit_to_yojson x.limit));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
...
let list_regex_match_sets_response_to_yojson
  (x : list_regex_match_sets_response) =
  assoc_to_yojson
    [("RegexMatchSets",
       (option_to_yojson regex_match_set_summaries_to_yojson
          x.regex_match_sets));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
let list_regex_match_sets_request_to_yojson
  (x : list_regex_match_sets_request) =
  assoc_to_yojson
    [("Limit", (option_to_yojson pagination_limit_to_yojson x.limit));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
let list_rate_based_rules_response_to_yojson
  (x : list_rate_based_rules_response) =
  assoc_to_yojson
    [("Rules", (option_to_yojson rule_summaries_to_yojson x.rules));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
let list_rate_based_rules_request_to_yojson
  (x : list_rate_based_rules_request) =
  assoc_to_yojson
    [("Limit", (option_to_yojson pagination_limit_to_yojson x.limit));
    ("NextMarker", (option_to_yojson next_marker_to_yojson x.next_marker))]
...
let geo_match_set_summary_to_yojson (x : geo_match_set_summary) =
  assoc_to_yojson
    [("Name", (Some (resource_name_to_yojson x.name)));
    ("GeoMatchSetId", (Some (resource_id_to_yojson x.geo_match_set_id)))]
let geo_match_set_summaries_to_yojson tree =
  list_to_yojson geo_match_set_summary_to_yojson tree
...
let byte_match_set_summary_to_yojson (x : byte_match_set_summary) =
  assoc_to_yojson
    [("Name", (Some (resource_name_to_yojson x.name)));
    ("ByteMatchSetId", (Some (resource_id_to_yojson x.byte_match_set_id)))]
let byte_match_set_summaries_to_yojson tree =
  list_to_yojson byte_match_set_summary_to_yojson tree
let list_byte_match_sets_response_to_yojson
  (x : list_byte_match_sets_response) =
  assoc_to_yojson
    [("ByteMatchSets",
...
let ip_set_descriptors_to_yojson tree =
  list_to_yojson ip_set_descriptor_to_yojson tree
...
let get_sql_injection_match_set_response_to_yojson
  (x : get_sql_injection_match_set_response) =
  assoc_to_yojson
    [("SqlInjectionMatchSet",
       (option_to_yojson sql_injection_match_set_to_yojson
          x.sql_injection_match_set))]
let get_sql_injection_match_set_request_to_yojson
  (x : get_sql_injection_match_set_request) =
  assoc_to_yojson
    [("SqlInjectionMatchSetId",
       (Some (resource_id_to_yojson x.sql_injection_match_set_id)))]
let get_size_constraint_set_response_to_yojson
  (x : get_size_constraint_set_response) =
  assoc_to_yojson
    [("SizeConstraintSet",
       (option_to_yojson size_constraint_set_to_yojson x.size_constraint_set))]
let get_size_constraint_set_request_to_yojson
  (x : get_size_constraint_set_request) =
  assoc_to_yojson
    [("SizeConstraintSetId",
       (Some (resource_id_to_yojson x.size_constraint_set_id)))]
...
let geo_match_constraints_to_yojson tree =
  list_to_yojson geo_match_constraint_to_yojson tree
...
let delete_xss_match_set_response_to_yojson
  (x : delete_xss_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
...
let delete_sql_injection_match_set_response_to_yojson
  (x : delete_sql_injection_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
let delete_sql_injection_match_set_request_to_yojson
  (x : delete_sql_injection_match_set_request) =
  assoc_to_yojson
    [("ChangeToken", (Some (change_token_to_yojson x.change_token)));
    ("SqlInjectionMatchSetId",
      (Some (resource_id_to_yojson x.sql_injection_match_set_id)))]
let delete_size_constraint_set_response_to_yojson
  (x : delete_size_constraint_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
let delete_size_constraint_set_request_to_yojson
  (x : delete_size_constraint_set_request) =
  assoc_to_yojson
    [("ChangeToken", (Some (change_token_to_yojson x.change_token)));
    ("SizeConstraintSetId",
      (Some (resource_id_to_yojson x.size_constraint_set_id)))]
...
let delete_regex_pattern_set_response_to_yojson
  (x : delete_regex_pattern_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
...
let delete_geo_match_set_response_to_yojson
  (x : delete_geo_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
...
let delete_byte_match_set_response_to_yojson
  (x : delete_byte_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token))]
let delete_byte_match_set_request_to_yojson
  (x : delete_byte_match_set_request) =
  assoc_to_yojson
    [("ChangeToken", (Some (change_token_to_yojson x.change_token)));
    ("ByteMatchSetId", (Some (resource_id_to_yojson x.byte_match_set_id)))]
let create_xss_match_set_response_to_yojson
  (x : create_xss_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token));
    ("XssMatchSet",
...
let create_web_acl_migration_stack_response_to_yojson
  (x : create_web_acl_migration_stack_response) =
  assoc_to_yojson
    [("S3ObjectUrl", (Some (s3_object_url_to_yojson x.s3_object_url)))]
let create_web_acl_migration_stack_request_to_yojson
  (x : create_web_acl_migration_stack_request) =
  assoc_to_yojson
...
let create_sql_injection_match_set_response_to_yojson
  (x : create_sql_injection_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token));
    ("SqlInjectionMatchSet",
...
let create_sql_injection_match_set_request_to_yojson
  (x : create_sql_injection_match_set_request) =
  assoc_to_yojson
    [("ChangeToken", (Some (change_token_to_yojson x.change_token)));
    ("Name", (Some (resource_name_to_yojson x.name)))]
let create_size_constraint_set_response_to_yojson
  (x : create_size_constraint_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token));
    ("SizeConstraintSet",
...
let create_size_constraint_set_request_to_yojson
  (x : create_size_constraint_set_request) =
  assoc_to_yojson
    [("ChangeToken", (Some (change_token_to_yojson x.change_token)));
    ("Name", (Some (resource_name_to_yojson x.name)))]
...
let create_regex_match_set_response_to_yojson
  (x : create_regex_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token));
    ("RegexMatchSet",
...
let create_regex_match_set_request_to_yojson
  (x : create_regex_match_set_request) =
  assoc_to_yojson
    [("ChangeToken", (Some (change_token_to_yojson x.change_token)));
    ("Name", (Some (resource_name_to_yojson x.name)))]
let create_rate_based_rule_response_to_yojson
  (x : create_rate_based_rule_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token));
    ("Rule", (option_to_yojson rate_based_rule_to_yojson x.rule))]
let create_rate_based_rule_request_to_yojson
  (x : create_rate_based_rule_request) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("ChangeToken", (Some (change_token_to_yojson x.change_token)));
    ("RateLimit", (Some (rate_limit_to_yojson x.rate_limit)));
...
let create_geo_match_set_response_to_yojson
  (x : create_geo_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token));
    ("GeoMatchSet",
...
let create_byte_match_set_response_to_yojson
  (x : create_byte_match_set_response) =
  assoc_to_yojson
    [("ChangeToken",
       (option_to_yojson change_token_to_yojson x.change_token));
    ("ByteMatchSet",
...
let create_byte_match_set_request_to_yojson
  (x : create_byte_match_set_request) =
  assoc_to_yojson
    [("ChangeToken", (Some (change_token_to_yojson x.change_token)));
    ("Name", (Some (resource_name_to_yojson x.name)))]
