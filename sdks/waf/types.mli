...
type nonrec waf_invalid_parameter_exception =
  ...
  parameter: string option [@ocaml.doc ""];
...
type nonrec waf_entity_migration_exception =
  {
  migration_error_reason: string option [@ocaml.doc ""];
...
type nonrec untag_resource_request =
  {
  tag_keys: string list [@ocaml.doc "\n"];
...
type nonrec size_constraint_set_summary =
  {
  name: string [@ocaml.doc "The name of the [SizeConstraintSet], if any.\n"];
  size_constraint_set_id: string
    [@ocaml.doc
