...
val make_add_permission_request :
  actions:action_name_list ->
    aws_account_ids:aws_account_id_list ->
      label:string_ -> queue_url:string_ -> unit -> add_permission_request
...
sig
  val error_to_string :
    ...
    | `UnsupportedOperation of unsupported_operation ] -> string
  val request :
...
sig
  val error_to_string :
    ...
    | `InvalidAddress of invalid_address 
    | `InvalidSecurity of invalid_security 
    | `KmsAccessDenied of kms_access_denied  | `KmsDisabled of kms_disabled 
    | `KmsInvalidKeyUsage of kms_invalid_key_usage 
    | `KmsInvalidState of kms_invalid_state  | `KmsNotFound of kms_not_found 
