...
module AddPermission = struct
  ...
  let request context (request : add_permission_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSAddPermission" ~service
...
module CancelMessageMoveTask = struct
  ...
  let request context (request : cancel_message_move_task_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSCancelMessageMoveTask" ~service
      ~config:context.config ~http:context.http ~input
...
module ChangeMessageVisibility = struct
  ...
  let request context (request : change_message_visibility_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSChangeMessageVisibility" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module ChangeMessageVisibilityBatch = struct
  ...
  let request context (request : change_message_visibility_batch_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSChangeMessageVisibilityBatch" ~service
      ~config:context.config ~http:context.http ~input
...
module CreateQueue = struct
  ...
  let request context (request : create_queue_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSCreateQueue" ~service
      ~config:context.config ~http:context.http ~input
...
module DeleteMessage = struct
  ...
  let request context (request : delete_message_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSDeleteMessage" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DeleteMessageBatch = struct
  ...
  let request context (request : delete_message_batch_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSDeleteMessageBatch" ~service
      ~config:context.config ~http:context.http ~input
...
module DeleteQueue = struct
  ...
  let request context (request : delete_queue_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSDeleteQueue" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module GetQueueAttributes = struct
  ...
  let request context (request : get_queue_attributes_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSGetQueueAttributes" ~service
      ~config:context.config ~http:context.http ~input
...
module GetQueueUrl = struct
  ...
  let request context (request : get_queue_url_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSGetQueueUrl" ~service
      ~config:context.config ~http:context.http ~input
...
module ListDeadLetterSourceQueues = struct
  ...
  let request context (request : list_dead_letter_source_queues_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSListDeadLetterSourceQueues" ~service
      ~config:context.config ~http:context.http ~input
...
module ListMessageMoveTasks = struct
  ...
  let request context (request : list_message_move_tasks_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSListMessageMoveTasks" ~service
      ~config:context.config ~http:context.http ~input
...
module ListQueueTags = struct
  ...
  let request context (request : list_queue_tags_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSListQueueTags" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Json_deserializers.list_queue_tags_result_of_yojson ~error_deserializer
end
...
module ListQueues = struct
  ...
  let request context (request : list_queues_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSListQueues" ~service
      ~config:context.config ~http:context.http ~input
...
module PurgeQueue = struct
  ...
  let request context (request : purge_queue_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSPurgeQueue" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module ReceiveMessage = struct
  ...
  let request context (request : receive_message_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSReceiveMessage" ~service
      ~config:context.config ~http:context.http ~input
...
module RemovePermission = struct
  ...
  let request context (request : remove_permission_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSRemovePermission" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module SendMessage = struct
  ...
  let request context (request : send_message_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSSendMessage" ~service
      ~config:context.config ~http:context.http ~input
...
module SendMessageBatch = struct
  ...
  let request context (request : send_message_batch_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSSendMessageBatch" ~service
      ~config:context.config ~http:context.http ~input
...
module SetQueueAttributes = struct
  ...
  let request context (request : set_queue_attributes_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSSetQueueAttributes" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module StartMessageMoveTask = struct
  ...
  let request context (request : start_message_move_task_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSStartMessageMoveTask" ~service
      ~config:context.config ~http:context.http ~input
...
module TagQueue = struct
  ...
  let request context (request : tag_queue_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSTagQueue" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module UntagQueue = struct
  ...
  let request context (request : untag_queue_request) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQSUntagQueue" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
