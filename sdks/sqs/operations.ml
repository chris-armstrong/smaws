  ...
  struct
    ...
    let request context (request : add_permission_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.AddPermission" ~service ~context ~input
...
module CancelMessageMoveTask =
  struct
    ...
    let request context (request : cancel_message_move_task_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.CancelMessageMoveTask" ~service ~context
        ~input
...
module ChangeMessageVisibility =
  struct
    ...
    let request context (request : change_message_visibility_request) =
      let input =
        Json_serializers.change_message_visibility_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.ChangeMessageVisibility" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
    ...
    let request context (request : change_message_visibility_batch_request) =
      let input =
        Json_serializers.change_message_visibility_batch_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.ChangeMessageVisibilityBatch" ~service
        ~context ~input
...
module CreateQueue =
  struct
    ...
    let request context (request : create_queue_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQS.CreateQueue"
...
module DeleteMessage =
  struct
    ...
    let request context (request : delete_message_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.DeleteMessage" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeleteMessageBatch =
  struct
    ...
    let request context (request : delete_message_batch_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.DeleteMessageBatch" ~service ~context ~input
...
module DeleteQueue =
  struct
    ...
    let request context (request : delete_queue_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQS.DeleteQueue"
        ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module GetQueueAttributes =
  struct
    ...
    let request context (request : get_queue_attributes_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.GetQueueAttributes" ~service ~context ~input
...
module GetQueueUrl =
  struct
    ...
    let request context (request : get_queue_url_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQS.GetQueueUrl"
        ~service ~context ~input
    ...
    let request context (request : list_dead_letter_source_queues_request) =
      let input =
        Json_serializers.list_dead_letter_source_queues_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.ListDeadLetterSourceQueues" ~service ~context
        ~input
...
module ListMessageMoveTasks =
  struct
    ...
    let request context (request : list_message_move_tasks_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.ListMessageMoveTasks" ~service ~context ~input
...
module ListQueueTags =
  struct
    ...
    let request context (request : list_queue_tags_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.ListQueueTags" ~service ~context ~input
...
module ListQueues =
  struct
    ...
    let request context (request : list_queues_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQS.ListQueues"
        ~service ~context ~input
...
module PurgeQueue =
  struct
    ...
    let request context (request : purge_queue_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQS.PurgeQueue"
        ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module ReceiveMessage =
  struct
    ...
    let request context (request : receive_message_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.ReceiveMessage" ~service ~context ~input
...
module RemovePermission =
  struct
    ...
    let request context (request : remove_permission_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.RemovePermission" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module SendMessage =
  struct
    ...
    let request context (request : send_message_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQS.SendMessage"
        ~service ~context ~input
...
module SendMessageBatch =
  struct
    ...
    let request context (request : send_message_batch_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.SendMessageBatch" ~service ~context ~input
...
module SetQueueAttributes =
  struct
    ...
    let request context (request : set_queue_attributes_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.SetQueueAttributes" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module StartMessageMoveTask =
  struct
    ...
    let request context (request : start_message_move_task_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSQS.StartMessageMoveTask" ~service ~context ~input
...
module TagQueue =
  struct
    ...
    let request context (request : tag_queue_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQS.TagQueue"
        ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module UntagQueue =
  struct
    ...
    let request context (request : untag_queue_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSQS.UntagQueue"
        ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end