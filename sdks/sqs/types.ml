...
type nonrec unsupported_operation = { message : exception_message option [@ocaml.doc ""] }
[@@ocaml.doc "Error code 400. Unsupported operation.\n"]

type nonrec request_throttled = { message : exception_message option [@ocaml.doc ""] }
[@@ocaml.doc
  ...
  \       {-  Ensure that the request rate is within the Amazon SQS limits for sending messages. \
   ...
   {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests}Amazon \
   SQS quotas} in the {i Amazon SQS Developer Guide}.\n\
  \           \n\
  \            }\n\
  \       }\n\
  \  "]
  ...
  task_handle : string_ option;
      [@ocaml.doc
        "An identifier associated with a message movement task. You can use this identifier to \
         cancel a specified message movement task using the [CancelMessageMoveTask] action.\n"]
}
[@@ocaml.doc ""]
...
type nonrec set_queue_attributes_request = {
  attributes : queue_attribute_map;
      [@ocaml.doc
        ...
        \ \n\
        \  {ul\n\
        \        {-   [DelaySeconds] \226\128\147 The length of time, in seconds, for which the \
         delivery of all messages in the queue is delayed. Valid values: An integer from 0 to 900 \
        ...
        \        {-   [MessageRetentionPeriod] \226\128\147 The length of time, in seconds, for \
         which Amazon SQS retains a message. Valid values: An integer representing seconds, from \
         60 (1 minute) to 1,209,600 (14 days). Default: 345,600 (4 days). When you change a \
         ...
         potentially causing them to be expired and deleted if the [MessageRetentionPeriod] is \
         reduced below the age of existing messages.\n\
        \            \n\
        \             }\n\
        \        {-   [Policy] \226\128\147 The queue's policy. A valid Amazon Web Services \
         policy. For more information about policy structure, see \
         {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/PoliciesOverview.html}Overview of \
         Amazon Web Services IAM Policies} in the {i Identity and Access Management User Guide}. \n\
        \            \n\
        \             }\n\
        \        {-   [ReceiveMessageWaitTimeSeconds] \226\128\147 The length of time, in seconds, \
         for which a \n\
        \            {[\n\
        \             [ReceiveMessage] \n\
        \            ]}\n\
        ...
        \            \n\
        \             }\n\
        \        {-   [VisibilityTimeout] \226\128\147 The visibility timeout for the queue, in \
         seconds. Valid values: An integer from 0 to 43,200 (12 hours). Default: 30. For more \
         information about the visibility timeout, see \
        ...
        \   \n\
        \    {ul\n\
        \          {-   [RedrivePolicy] \226\128\147 The string that includes the parameters for \
         the dead-letter queue functionality of the source queue as a JSON object. The parameters \
         are as follows:\n\
        \              \n\
        \               {ul\n\
        \                     {-   [deadLetterTargetArn] \226\128\147 The Amazon Resource Name \
         (ARN) of the dead-letter queue to which Amazon SQS moves messages after the value of \
         [maxReceiveCount] is exceeded.\n\
        \                         \n\
        \                          }\n\
        \                     {-   [maxReceiveCount] \226\128\147 The number of times a message is \
         delivered to the source queue before being moved to the dead-letter queue. Default: 10. \
         When the [ReceiveCount] for a message exceeds the [maxReceiveCount] for a queue, Amazon \
        ...
        \           }\n\
        \            }\n\
        \          {-   [RedriveAllowPolicy] \226\128\147 The string that includes the parameters \
         for the permissions for the dead-letter queue redrive permission and which source queues \
         can specify dead-letter queues as a JSON object. The parameters are as follows:\n\
        \              \n\
        \               {ul\n\
        \                     {-   [redrivePermission] \226\128\147 The permission type that \
         defines which source queues can specify the current queue as the dead-letter queue. Valid \
         values are:\n\
        \                         \n\
        \                          {ul\n\
        \                                {-   [allowAll] \226\128\147 (Default) Any source queues \
         in this Amazon Web Services account in the same Region can specify this queue as the \
         dead-letter queue.\n\
        \                                    \n\
        \                                     }\n\
        \                                {-   [denyAll] \226\128\147 No source queues can specify \
         this queue as the dead-letter queue.\n\
        \                                    \n\
        \                                     }\n\
        \                                {-   [byQueue] \226\128\147 Only queues specified by the \
        ...
        \                      }\n\
        \                       }\n\
        \                     {-   [sourceQueueArns] \226\128\147 The Amazon Resource Names (ARN)s \
         of the source queues that can specify this queue as the dead-letter queue and redrive \
         messages. You can specify this parameter only when the [redrivePermission] parameter is \
         set to [byQueue]. You can specify up to 10 source queue ARNs. To allow more than 10 \
         source queues to specify dead-letter queues, set the [redrivePermission] parameter to \
         [allowAll].\n\
        \                         \n\
        \                          }\n\
        \                     \n\
        ...
        \             {-   [KmsMasterKeyId] \226\128\147 The ID of an Amazon Web Services managed \
         customer master key (CMK) for Amazon SQS or a custom CMK. For more information, see \
         {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html#sqs-sse-key-terms}Key \
         Terms}. While the alias of the AWS-managed CMK for Amazon SQS is always [alias/aws/sqs], \
        ...
        \                 \n\
        \                  }\n\
        \             {-   [KmsDataKeyReusePeriodSeconds] \226\128\147 The length of time, in \
         seconds, for which Amazon SQS can reuse a \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#data-keys}data \
         key} to encrypt or decrypt messages before calling KMS again. An integer representing \
         seconds, between 60 seconds (1 minute) and 86,400 seconds (24 hours). Default: 300 (5 \
         minutes). A shorter time period provides better security but results in more calls to KMS \
         which might incur charges after Free Tier. For more information, see \
         {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html#sqs-how-does-the-data-key-reuse-period-work}How \
         Does the Data Key Reuse Period Work?}. \n\
        \                 \n\
        \                  }\n\
        \             {-   [SqsManagedSseEnabled] \226\128\147 Enables server-side queue \
        ...
        \          {-   [ContentBasedDeduplication] \226\128\147 Enables content-based \
         ...
         {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues-exactly-once-processing.html}Exactly-once \
         processing} in the {i Amazon SQS Developer Guide}. Note the following: \n\
        \              \n\
        \               {ul\n\
        ...
        \                                {-  If you aren't able to provide a \
         ...
         Amazon SQS uses a SHA-256 hash to generate the [MessageDeduplicationId] using the body of \
         the message (but not the attributes of the message). \n\
        \                                    \n\
        \                                     }\n\
        \                                {-  If you don't provide a [MessageDeduplicationId] and \
         the queue doesn't have [ContentBasedDeduplication] set, the action fails with an error.\n\
        \                                    \n\
        \                                     }\n\
        ...
        \                     {-  When [ContentBasedDeduplication] is in effect, messages with \
         identical content sent within the deduplication interval are treated as duplicates and \
         only one copy of the message is delivered.\n\
        \                         \n\
        \                          }\n\
        \                     {-  If you send one message with [ContentBasedDeduplication] enabled \
         and then another message with a [MessageDeduplicationId] that is the same as the one \
        ...
        \          }\n\
        \   The following attributes apply only to \
         {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/high-throughput-fifo.html}high \
         throughput for FIFO queues}:\n\
        \   \n\
        \    {ul\n\
        \          {-   [DeduplicationScope] \226\128\147 Specifies whether message deduplication \
         occurs at the message group or queue level. Valid values are [messageGroup] and [queue].\n\
        \              \n\
        \               }\n\
        \          {-   [FifoThroughputLimit] \226\128\147 Specifies whether the FIFO queue \
         throughput quota applies to the entire queue or per message group. Valid values are \
...
type nonrec message_system_attribute_name_for_sends = AWSTraceHeader [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  message_system_attributes : message_body_system_attribute_map option;
      [@ocaml.doc
        ...
        \        {-  Currently, the only supported message system attribute is [AWSTraceHeader]. \
         Its type must be [String] and its value must be a correctly formatted X-Ray trace header \
         string.\n\
        \            \n\
        \             }\n\
  ...
  message_deduplication_id : string_ option;
      [@ocaml.doc
        ...
        \ The token used for deduplication of messages within a 5-minute minimum deduplication \
         ...
         aren't delivered. For more information, see \
         {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues-exactly-once-processing.html} \
         Exactly-once processing} in the {i Amazon SQS Developer Guide}.\n\
        \ \n\
        \  {ul\n\
...
type nonrec receive_message_request = {
  ...
  attribute_names : attribute_name_list option;
      [@ocaml.doc
        ...
        \              \n\
        \               }\n\
        \          {-   [ApproximateFirstReceiveTimestamp] \226\128\147 Returns the time the \
         message was first received from the queue \
         ({{:http://en.wikipedia.org/wiki/Unix_time}epoch time} in milliseconds).\n\
        \              \n\
        \               }\n\
        \          {-   [ApproximateReceiveCount] \226\128\147 Returns the number of times a \
        ...
        \              \n\
        \               }\n\
        \          {-   [MessageGroupId] \226\128\147 Returns the value provided by the producer \
         that calls the \n\
        \              {[\n\
        \               [SendMessage] \n\
        \              ]}\n\
...
type nonrec list_queue_tags_result = {
  tags : tag_map option; [@ocaml.doc "The list of all tags added to the specified queue.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_message_move_tasks_result_entry_list = list_message_move_tasks_result_entry list
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "For more information, see \
   {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-api-responses.html}Interpreting \
...
type nonrec get_queue_attributes_request = {
  attribute_names : attribute_name_list option;
      [@ocaml.doc
        ...
        \ The [AttributeNames] parameter is optional, but if you don't specify values for this \
        ...
        \       The [ApproximateNumberOfMessagesDelayed], [ApproximateNumberOfMessagesNotVisible], \
         and [ApproximateNumberOfMessages] metrics may not achieve consistency until at least 1 \
         minute after the producers stop sending messages. This period is required for the queue \
        ...
        \                   \n\
        \                    }\n\
        \               {-   [ApproximateNumberOfMessages] \226\128\147 Returns the approximate \
         number of messages available for retrieval from the queue.\n\
        \                   \n\
        \                    }\n\
        \               {-   [ApproximateNumberOfMessagesDelayed] \226\128\147 Returns the \
         approximate number of messages in the queue that are delayed and not available for \
         reading immediately. This can happen when the queue is configured as a delay queue or \
         when a message has been sent with a delay parameter.\n\
        \                   \n\
        \                    }\n\
        \               {-   [ApproximateNumberOfMessagesNotVisible] \226\128\147 Returns the \
         approximate number of messages that are in flight. Messages are considered to be {i in \
         flight} if they have been sent to a client but have not yet been deleted or have not yet \
         reached the end of their visibility window. \n\
        \                   \n\
        \                    }\n\
        \               {-   [CreatedTimestamp] \226\128\147 Returns the time when the queue was \
         created in seconds ({{:http://en.wikipedia.org/wiki/Unix_time}epoch time}).\n\
        \                   \n\
        \                    }\n\
        \               {-   [DelaySeconds] \226\128\147 Returns the default delay on the queue in \
         seconds.\n\
        \                   \n\
        \                    }\n\
        \               {-   [LastModifiedTimestamp] \226\128\147 Returns the time when the queue \
         was last changed in seconds ({{:http://en.wikipedia.org/wiki/Unix_time}epoch time}).\n\
        \                   \n\
        \                    }\n\
        \               {-   [MaximumMessageSize] \226\128\147 Returns the limit of how many bytes \
         a message can contain before Amazon SQS rejects it.\n\
        \                   \n\
        \                    }\n\
        \               {-   [MessageRetentionPeriod] \226\128\147 Returns the length of time, in \
         seconds, for which Amazon SQS retains a message. When you change a queue's attributes, \
         the change can take up to 60 seconds for most of the attributes to propagate throughout \
         the Amazon SQS system. Changes made to the [MessageRetentionPeriod] attribute can take up \
         to 15 minutes and will impact existing messages in the queue potentially causing them to \
         be expired and deleted if the [MessageRetentionPeriod] is reduced below the age of \
         existing messages.\n\
        \                   \n\
        \                    }\n\
        ...
        \                   \n\
        \                    }\n\
        \               {-   [QueueArn] \226\128\147 Returns the Amazon resource name (ARN) of the \
         queue.\n\
        \                   \n\
        \                    }\n\
        \               {-   [ReceiveMessageWaitTimeSeconds] \226\128\147 Returns the length of \
         time, in seconds, for which the [ReceiveMessage] action waits for a message to arrive. \n\
        \                   \n\
        \                    }\n\
        \               {-   [VisibilityTimeout] \226\128\147 Returns the visibility timeout for \
        ...
        \      \n\
        \       {ul\n\
        \             {-   [KmsMasterKeyId] \226\128\147 Returns the ID of an Amazon Web Services \
         managed customer master key (CMK) for Amazon SQS or a custom CMK. For more information, \
         see \
         {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html#sqs-sse-key-terms}Key \
         Terms}. \n\
        \                 \n\
        \                  }\n\
        \             {-   [KmsDataKeyReusePeriodSeconds] \226\128\147 Returns the length of time, \
         in seconds, for which Amazon SQS can reuse a data key to encrypt or decrypt messages \
         before calling KMS again. For more information, see \
         {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html#sqs-how-does-the-data-key-reuse-period-work}How \
         Does the Data Key Reuse Period Work?}. \n\
        \                 \n\
        \                  }\n\
        \             {-   [SqsManagedSseEnabled] \226\128\147 Returns information about whether \
         the queue is using SSE-SQS encryption using SQS owned encryption keys. Only one \
        ...
        \   \n\
        \    {ul\n\
        \          {-   [FifoQueue] \226\128\147 Returns information about whether the queue is \
         FIFO. For more information, see \
         {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues-understanding-logic.html}FIFO \
         queue logic} in the {i Amazon SQS Developer Guide}.\n\
        \              \n\
        ...
        \                \n\
        \                  }\n\
        \          {-   [ContentBasedDeduplication] \226\128\147 Returns whether content-based \
...
[@@ocaml.doc "Encloses the [Id] of an entry in \n{[\n [DeleteMessageBatch].\n]}\n \n"]

type nonrec delete_message_batch_result_entry_list = delete_message_batch_result_entry list
[@@ocaml.doc ""]
...
type nonrec delete_message_batch_request_entry_list = delete_message_batch_request_entry list
[@@ocaml.doc ""]
...
type nonrec create_queue_request = {
  ...
  attributes : queue_attribute_map option;
      [@ocaml.doc
        ...
        \             }\n\
        \        {-   [MessageRetentionPeriod] \226\128\147 The length of time, in seconds, for \
         which Amazon SQS retains a message. Valid values: An integer from 60 seconds (1 minute) \
         to 1,209,600 seconds (14 days). Default: 345,600 (4 days). When you change a queue's \
         attributes, the change can take up to 60 seconds for most of the attributes to propagate \
         throughout the Amazon SQS system. Changes made to the [MessageRetentionPeriod] attribute \
         can take up to 15 minutes and will impact existing messages in the queue potentially \
         causing them to be expired and deleted if the [MessageRetentionPeriod] is reduced below \
        ...
        \        {-   [Policy] \226\128\147 The queue's policy. A valid Amazon Web Services \
         policy. For more information about policy structure, see \
         {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/PoliciesOverview.html}Overview of \
         Amazon Web Services IAM Policies} in the {i IAM User Guide}. \n\
        \            \n\
        \             }\n\
        \        {-   [ReceiveMessageWaitTimeSeconds] \226\128\147 The length of time, in seconds, \
         for which a \n\
        ...
        \   \n\
        \    {ul\n\
        \          {-   [FifoQueue] \226\128\147 Designates a queue as FIFO. Valid values are \
         [true] and [false]. If you don't specify the [FifoQueue] attribute, Amazon SQS creates a \
         standard queue. You can provide this attribute only during queue creation. You can't \
        ...
        \                }\n\
        \          {-   [ContentBasedDeduplication] \226\128\147 Enables content-based \
         deduplication. Valid values are [true] and [false]. For more information, see \
         {{:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues-exactly-once-processing.html}Exactly-once \
         processing} in the {i Amazon SQS Developer Guide}. Note the following: \n\
        \              \n\
        \               {ul\n\
...
type nonrec change_message_visibility_batch_result_entry = {
  id : string_;
      [@ocaml.doc "Represents a message whose visibility timeout has been changed successfully.\n"]
}
[@@ocaml.doc "Encloses the [Id] of an entry in \n{[\n [ChangeMessageVisibilityBatch].\n]}\n \n"]

type nonrec change_message_visibility_batch_result_entry_list =
  change_message_visibility_batch_result_entry list
[@@ocaml.doc ""]
...
type nonrec change_message_visibility_batch_request_entry_list =
  change_message_visibility_batch_request_entry list
[@@ocaml.doc ""]
