...
let start_message_move_task_result_of_yojson tree path =
  ...
  let _res : start_message_move_task_result =
    {
      task_handle =
        (option_of_yojson (value_for_key string__of_yojson "TaskHandle")
           _list path)
    } in
  _res
  ...
  let _res : message_attribute_value =
    {
      ...
      binary_list_values =
        (option_of_yojson
           (value_for_key binary_list_of_yojson "BinaryListValues") _list
           path);
      string_list_values =
        (option_of_yojson
           (value_for_key string_list_of_yojson "StringListValues") _list
           path);
      binary_value =
        (option_of_yojson (value_for_key binary_of_yojson "BinaryValue")
           _list path);
      string_value =
...
let purge_queue_request_of_yojson tree path =
  ...
  let _res : purge_queue_request =
    { queue_url = (value_for_key string__of_yojson "QueueUrl" _list path) } in
  _res
  ...
  let _res : list_queues_request =
    {
      max_results =
        (option_of_yojson
           (value_for_key boxed_integer_of_yojson "MaxResults") _list path);
      next_token =
        (option_of_yojson (value_for_key token_of_yojson "NextToken") _list
           path);
      queue_name_prefix =
...
let delete_message_batch_result_entry_of_yojson tree path =
  ...
  let _res : delete_message_batch_result_entry =
    { id = (value_for_key string__of_yojson "Id" _list path) } in
  _res
