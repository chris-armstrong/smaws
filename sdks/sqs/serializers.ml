...
let too_many_entries_in_batch_request_to_yojson
  (x : too_many_entries_in_batch_request) =
  assoc_to_yojson
    [("message", (option_to_yojson exception_message_to_yojson x.message))]
...
let start_message_move_task_result_to_yojson
  (x : start_message_move_task_result) =
  assoc_to_yojson
...
let start_message_move_task_request_to_yojson
  (x : start_message_move_task_request) =
  assoc_to_yojson
    [("MaxNumberOfMessagesPerSecond",
       (option_to_yojson nullable_integer_to_yojson
          x.max_number_of_messages_per_second));
    ("DestinationArn",
...
let message_system_attribute_value_to_yojson
  (x : message_system_attribute_value) =
  assoc_to_yojson
    [("DataType", (Some (string__to_yojson x.data_type)));
    ("BinaryListValues",
      (option_to_yojson binary_list_to_yojson x.binary_list_values));
...
let message_system_attribute_name_for_sends_to_yojson
  (x : message_system_attribute_name_for_sends) =
...
let send_message_request_to_yojson (x : send_message_request) =
  assoc_to_yojson
    ...
    ("MessageSystemAttributes",
      (option_to_yojson message_body_system_attribute_map_to_yojson
         x.message_system_attributes));
    ("MessageAttributes",
      (option_to_yojson message_body_attribute_map_to_yojson
         x.message_attributes));
    ("DelaySeconds",
...
let send_message_batch_result_entry_to_yojson
  (x : send_message_batch_result_entry) =
  assoc_to_yojson
    [("SequenceNumber",
       (option_to_yojson string__to_yojson x.sequence_number));
    ("MD5OfMessageSystemAttributes",
...
let send_message_batch_request_entry_to_yojson
  (x : send_message_batch_request_entry) =
  assoc_to_yojson
    [("MessageGroupId",
       (option_to_yojson string__to_yojson x.message_group_id));
    ("MessageDeduplicationId",
...
let message_system_attribute_name_to_yojson
  (x : message_system_attribute_name) =
  match x with
...
let message_system_attribute_map_to_yojson tree =
  map_to_yojson message_system_attribute_name_to_yojson string__to_yojson
    tree
...
let receive_message_result_to_yojson (x : receive_message_result) =
  assoc_to_yojson
    [("Messages", (option_to_yojson message_list_to_yojson x.messages))]
let attribute_name_list_to_yojson tree =
  list_to_yojson queue_attribute_name_to_yojson tree
...
let receive_message_request_to_yojson (x : receive_message_request) =
  assoc_to_yojson
    ...
    ("MessageAttributeNames",
      (option_to_yojson message_attribute_name_list_to_yojson
         x.message_attribute_names));
    ("MessageSystemAttributeNames",
      (option_to_yojson message_system_attribute_list_to_yojson
         x.message_system_attribute_names));
    ("AttributeNames",
...
let list_message_move_tasks_result_entry_to_yojson
  (x : list_message_move_tasks_result_entry) =
  assoc_to_yojson
    [("StartedTimestamp",
    ...
    ("ApproximateNumberOfMessagesToMove",
      (option_to_yojson nullable_long_to_yojson
         x.approximate_number_of_messages_to_move));
...
let delete_message_batch_result_entry_to_yojson
  (x : delete_message_batch_result_entry) =
...
let delete_message_batch_request_entry_to_yojson
  (x : delete_message_batch_request_entry) =
  assoc_to_yojson
    [("ReceiptHandle", (Some (string__to_yojson x.receipt_handle)));
    ("Id", (Some (string__to_yojson x.id)))]
...
let change_message_visibility_request_to_yojson
  (x : change_message_visibility_request) =
  assoc_to_yojson
    [("VisibilityTimeout",
...
let change_message_visibility_batch_result_to_yojson
  (x : change_message_visibility_batch_result) =
  assoc_to_yojson
    [("Failed", (Some (batch_result_error_entry_list_to_yojson x.failed)));
    ("Successful",
      (Some
         (change_message_visibility_batch_result_entry_list_to_yojson
            x.successful)))]
...
let change_message_visibility_batch_request_to_yojson
  (x : change_message_visibility_batch_request) =
  assoc_to_yojson
    [("Entries",
       (Some
          (change_message_visibility_batch_request_entry_list_to_yojson
             x.entries)));
    ("QueueUrl", (Some (string__to_yojson x.queue_url)))]
let cancel_message_move_task_result_to_yojson
  (x : cancel_message_move_task_result) =
  assoc_to_yojson
    [("ApproximateNumberOfMessagesMoved",
       (option_to_yojson long_to_yojson
          x.approximate_number_of_messages_moved))]
let cancel_message_move_task_request_to_yojson
  (x : cancel_message_move_task_request) =
