...
type nonrec user_verification_type = PREFERRED [@ocaml.doc ""] | REQUIRED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec verify_software_token_response_type = ERROR [@ocaml.doc ""] | SUCCESS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec verified_attribute_type = EMAIL [@ocaml.doc ""] | PHONE_NUMBER [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec delivery_medium_type = EMAIL [@ocaml.doc ""] | SMS [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec username_attribute_type = EMAIL [@ocaml.doc ""] | PHONE_NUMBER [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec deletion_protection_type = INACTIVE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec status_type = Disabled [@ocaml.doc ""] | Enabled [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec advanced_security_enabled_mode_type = ENFORCED [@ocaml.doc ""] | AUDIT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec issuer_type = UPDATED [@ocaml.doc ""] | ORIGINAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec replica_role_type = SECONDARY [@ocaml.doc ""] | PRIMARY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec prevent_user_existence_error_types = ENABLED [@ocaml.doc ""] | LEGACY [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec auth_session_validity_type = int [@@ocaml.doc ""]

type nonrec feature_type = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec update_replica_status_type = INACTIVE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec feedback_value_type = INVALID [@ocaml.doc ""] | VALID [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec log_level = INFO [@ocaml.doc ""] | ERROR [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec risk_level_type = High [@ocaml.doc ""] | Medium [@ocaml.doc ""] | Low [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec respond_to_auth_challenge_request = {
  ...
  challenge_name : challenge_name_type;
      [@ocaml.doc
        ...
        \              }\n\
        \  "]
  client_id : client_id_type; [@ocaml.doc "The ID of the app client where the user is signing in.\n"]
}
...
type nonrec message_action_type = SUPPRESS [@ocaml.doc ""] | RESEND [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec describe_terms_request = {
  ...
  terms_id : terms_id_type; [@ocaml.doc "The ID of the terms documents that you want to describe.\n"]
}
[@@ocaml.doc ""]
...
type nonrec describe_identity_provider_request = {
  provider_name : provider_name_type;
      [@ocaml.doc "The name of the IdP that you want to describe.\n"]
  user_pool_id : user_pool_id_type;
...
type nonrec challenge_name = Mfa [@ocaml.doc ""] | Password [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec challenge_response = Failure [@ocaml.doc ""] | Success [@ocaml.doc ""]
[@@ocaml.doc ""]
