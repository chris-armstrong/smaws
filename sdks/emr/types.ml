...
type configuration_list = configuration list [@@ocaml.doc ""]
...
type nonrec market_type = ON_DEMAND [@ocaml.doc ""] | SPOT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec add_instance_groups_input = {
  ...
  job_flow_id : xml_string_max_len256; [@ocaml.doc "Job flow in which to add the instance groups.\n"]
}
...
type nonrec auth_mode = SSO [@ocaml.doc ""] | IAM [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec cancel_steps_request_status = SUBMITTED [@ocaml.doc ""] | FAILED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec repo_upgrade_on_boot = SECURITY [@ocaml.doc ""] | NONE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec profiler_type = SHS [@ocaml.doc ""] | TEZUI [@ocaml.doc ""] | YTS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec idc_user_assignment = REQUIRED [@ocaml.doc ""] | OPTIONAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec identity_type = USER [@ocaml.doc ""] | GROUP [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  unhealthy_node_replacement : boolean_object option;
      [@ocaml.doc
        "Indicates whether Amazon EMR should gracefully replace core nodes that have degraded \
         within the cluster.\n"]
  hadoop_version : xml_string_max_len256 option; [@ocaml.doc "The Hadoop version for the cluster.\n"]
}
...
type nonrec scaling_strategy = DEFAULT [@ocaml.doc ""] | ADVANCED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec reconfiguration_type = OVERWRITE [@ocaml.doc ""] | MERGE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec instance_group_timeline = {
  ...
  end_date_time : date option; [@ocaml.doc "The date and time when the instance group terminated.\n"]
}
...
type nonrec list_bootstrap_actions_input = {
  cluster_id : cluster_id;
      [@ocaml.doc "The cluster identifier for the bootstrap actions to list.\n"]
  marker : marker option;
      [@ocaml.doc "The pagination token that indicates the next set of results to retrieve.\n"]
}
