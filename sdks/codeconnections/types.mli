...
type nonrec tls_certificate = string [@@ocaml.doc ""]

type nonrec vpc_configuration = {
  tls_certificate : tls_certificate option;
      [@ocaml.doc
...
type nonrec deployment_file_path = string [@@ocaml.doc ""]
...
type nonrec repository_link_id = string [@@ocaml.doc ""]
...
type nonrec sync_configuration_type = CFN_STACK_SYNC [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec publish_deployment_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec trigger_resource_update_on = FILE_CHANGE [@ocaml.doc ""] | ANY_CHANGE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec pull_request_comment = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec sync_configuration = {
  pull_request_comment : pull_request_comment option;
      [@ocaml.doc
        "A toggle that specifies whether to enable or disable pull request comments for the sync \
  ...
  repository_name : repository_name;
      [@ocaml.doc "The name of the repository associated with a specific sync configuration.\n"]
  repository_link_id : repository_link_id;
      [@ocaml.doc "The ID of the repository link associated with a specific sync configuration.\n"]
  ...
  config_file : deployment_file_path option;
      [@ocaml.doc
  ...
  branch : branch_name; [@ocaml.doc "The branch associated with a specific sync configuration.\n"]
}
[@@ocaml.doc
...
type nonrec update_sync_configuration_output = {
  sync_configuration : sync_configuration;
      [@ocaml.doc "The information returned for the sync configuration to be updated.\n"]
}
[@@ocaml.doc ""]
...
type nonrec update_sync_configuration_input = {
  pull_request_comment : pull_request_comment option;
      [@ocaml.doc
        "TA toggle that specifies whether to enable or disable pull request comments for the sync \
  ...
  role_arn : iam_role_arn option;
      [@ocaml.doc "The ARN of the IAM role for the sync configuration to be updated.\n"]
  resource_name : resource_name;
      [@ocaml.doc
        "The name of the Amazon Web Services resource for the sync configuration to be updated.\n"]
  repository_link_id : repository_link_id option;
      [@ocaml.doc "The ID of the repository link for the sync configuration to be updated.\n"]
  config_file : deployment_file_path option;
      [@ocaml.doc "The configuration file for the sync configuration to be updated.\n"]
  branch : branch_name option; [@ocaml.doc "The branch for the sync configuration to be updated.\n"]
}
[@@ocaml.doc ""]

type nonrec error_message = string [@@ocaml.doc ""]

type nonrec update_out_of_sync_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The update is out of sync. Try syncing again.\n"]
...
[@@ocaml.doc "Resource not found. Verify the connection resource ARN and try again.\n"]

type nonrec invalid_input_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The input is not valid. Verify that the action is typed correctly.\n"]

type nonrec internal_server_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "Received an internal server exception. Try again later.\n"]
...
type nonrec blocker_status = RESOLVED [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec created_reason = string [@@ocaml.doc ""]

type nonrec timestamp = Smaws_Lib.CoreTypes.Timestamp.t [@@ocaml.doc ""]

type nonrec sync_blocker_context_key = string [@@ocaml.doc ""]

type nonrec sync_blocker_context_value = string [@@ocaml.doc ""]

type nonrec sync_blocker_context = {
  value : sync_blocker_context_value;
      [@ocaml.doc "The value provided for a context key-value pair for a specific sync blocker.\n"]
  key : sync_blocker_context_key;
      [@ocaml.doc "The key provided for a context key-value pair for a specific sync blocker.\n"]
}
[@@ocaml.doc "The context for a specific sync blocker.\n"]

type nonrec sync_blocker_context_list = sync_blocker_context list [@@ocaml.doc ""]

type nonrec resolved_reason = string [@@ocaml.doc ""]

type nonrec sync_blocker = {
  resolved_at : timestamp option;
      [@ocaml.doc "The time that a specific sync blocker was resolved.\n"]
  resolved_reason : resolved_reason option;
      [@ocaml.doc "The resolved reason for a specific sync blocker.\n"]
  contexts : sync_blocker_context_list option;
      [@ocaml.doc "The contexts for a specific sync blocker.\n"]
  created_at : timestamp; [@ocaml.doc "The creation time for a specific sync blocker.\n"]
  created_reason : created_reason; [@ocaml.doc "The provided reason for a specific sync blocker.\n"]
  status : blocker_status; [@ocaml.doc "The status for a specific sync blocker.\n"]
  type_ : blocker_type; [@ocaml.doc "The sync blocker type.\n"]
  id : id; [@ocaml.doc "The ID for a specific sync blocker.\n"]
}
[@@ocaml.doc "Information about a blocker for a sync event.\n"]

type nonrec update_sync_blocker_output = {
  sync_blocker : sync_blocker; [@ocaml.doc "Information about the sync blocker to be updated.\n"]
  parent_resource_name : resource_name option;
      [@ocaml.doc "The parent resource name for the sync blocker.\n"]
  resource_name : resource_name; [@ocaml.doc "The resource name for the sync blocker.\n"]
}
[@@ocaml.doc ""]

type nonrec update_sync_blocker_input = {
  resolved_reason : resolved_reason; [@ocaml.doc "The reason for resolving the sync blocker.\n"]
  resource_name : resource_name;
      [@ocaml.doc "The name of the resource for the sync blocker to be updated.\n"]
  sync_type : sync_configuration_type;
      [@ocaml.doc "The sync type of the sync blocker to be updated.\n"]
  id : id; [@ocaml.doc "The ID of the sync blocker to be updated.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "Unable to continue. The sync blocker does not exist.\n"]

type nonrec retry_latest_commit_failed_exception = {
  message : error_message option; [@ocaml.doc ""]
}
[@@ocaml.doc "Retrying the latest commit failed. Try again later.\n"]

type nonrec connection_arn = string [@@ocaml.doc ""]

type nonrec kms_key_arn = string [@@ocaml.doc ""]

type nonrec repository_link_arn = string [@@ocaml.doc ""]

type nonrec repository_link_info = {
  repository_name : repository_name;
      [@ocaml.doc "The name of the repository associated with the repository link.\n"]
  repository_link_id : repository_link_id; [@ocaml.doc "The ID of the repository link.\n"]
  ...
  owner_id : owner_id;
      [@ocaml.doc
        "The owner ID for the repository associated with the repository link, such as the owner ID \
         in GitHub.\n"]
  encryption_key_arn : kms_key_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the encryption key for the repository associated with \
         the repository link.\n"]
...
type nonrec conditional_check_failed_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The conditional check failed. Try again later.\n"]

type nonrec update_host_output = unit [@@ocaml.doc ""]

type nonrec host_arn = string [@@ocaml.doc ""]
...
type nonrec update_host_input = {
  ...
  provider_endpoint : url option; [@ocaml.doc "The URL or endpoint of the host to be updated.\n"]
  host_arn : host_arn; [@ocaml.doc "The Amazon Resource Name (ARN) of the host to be updated.\n"]
}
[@@ocaml.doc ""]

type nonrec unsupported_operation_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The operation is not supported. Check the connection status and try again.\n"]

type nonrec resource_unavailable_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "Resource not found. Verify the ARN for the host resource and try again.\n"]

type nonrec conflict_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "Two conflicting operations have been made on the same resource.\n"]
...
type nonrec unsupported_provider_type_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The specified provider type is not supported for connections.\n"]
...
[@@ocaml.doc "Exceeded the maximum limit for connections.\n"]

type nonrec sync_configuration_still_exists_exception = {
  message : error_message option; [@ocaml.doc ""]
}
[@@ocaml.doc "Unable to continue. The sync blocker still exists.\n"]

type nonrec sync_configuration_list = sync_configuration list [@@ocaml.doc ""]

type nonrec latest_sync_blocker_list = sync_blocker list [@@ocaml.doc ""]

type nonrec sync_blocker_summary = {
  latest_blockers : latest_sync_blocker_list option;
      [@ocaml.doc "The latest events for a sync blocker summary.\n"]
  parent_resource_name : resource_name option;
      [@ocaml.doc "The parent resource name for a sync blocker summary.\n"]
  resource_name : resource_name; [@ocaml.doc "The resource name for sync blocker summary.\n"]
}
[@@ocaml.doc "A summary for sync blockers.\n"]

type nonrec sharp_next_token = string [@@ocaml.doc ""]

type nonrec sh_a = string [@@ocaml.doc ""]

type nonrec directory = string [@@ocaml.doc ""]

type nonrec revision = {
  sha : sh_a; [@ocaml.doc "The SHA, such as the commit ID, for a specific revision.\n"]
  provider_type : provider_type; [@ocaml.doc "The provider type for a revision, such as GitHub.\n"]
  repository_name : repository_name; [@ocaml.doc "The repository name for a specific revision.\n"]
  owner_id : owner_id;
      [@ocaml.doc
        "The owner ID for a specific revision, such as the GitHub owner ID for a GitHub repository.\n"]
  directory : directory; [@ocaml.doc "The directory, if any, for a specific revision.\n"]
  branch : branch_name; [@ocaml.doc "The branch name for a specific revision.\n"]
}
[@@ocaml.doc
  "Information about the revision for a specific sync event, such as the branch, owner ID, and \
...
type nonrec event = string [@@ocaml.doc ""]

type nonrec external_id = string [@@ocaml.doc ""]

type nonrec resource_sync_event = {
  type_ : type_; [@ocaml.doc "The type of resource sync event.\n"]
  time : timestamp; [@ocaml.doc "The time that a resource sync event occurred.\n"]
  external_id : external_id option; [@ocaml.doc "The ID for a resource sync event.\n"]
  event : event; [@ocaml.doc "The event for a resource sync event.\n"]
}
[@@ocaml.doc
  "Information about a resource sync event for the resource associated with a sync configuration.\n"]

type nonrec resource_sync_event_list = resource_sync_event list [@@ocaml.doc ""]
...
type nonrec resource_sync_attempt = {
  ...
  target_revision : revision;
      [@ocaml.doc
        "The desired state of the resource as defined in the resource's [config-file] in the \
         linked repository. Git sync attempts to update the resource to this state.\n"]
  status : resource_sync_status;
      [@ocaml.doc
        ...
        \       }\n\
        \  "]
  started_at : timestamp; [@ocaml.doc "The start time for a resource sync attempt.\n"]
  initial_revision : revision;
      [@ocaml.doc
        "The current state of the resource as defined in the resource's [config-file] in the \
         linked repository.\n"]
  events : resource_sync_event_list; [@ocaml.doc "The events related to a resource sync attempt.\n"]
}
[@@ocaml.doc "Information about a resource sync attempt.\n"]

type nonrec resource_already_exists_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "Unable to create resource. Resource already exists.\n"]
...
type nonrec repository_sync_event = {
  type_ : type_; [@ocaml.doc "The event type for a repository sync event.\n"]
  time : timestamp; [@ocaml.doc "The time that a repository sync event occurred.\n"]
  external_id : external_id option; [@ocaml.doc "The ID for a repository sync event.\n"]
  event : event; [@ocaml.doc "A description of a repository sync event.\n"]
}
[@@ocaml.doc "Information about a repository sync event.\n"]

type nonrec repository_sync_event_list = repository_sync_event list [@@ocaml.doc ""]

type nonrec parent = string [@@ocaml.doc ""]
...
type nonrec repository_sync_definition = {
  ...
  parent : parent; [@ocaml.doc "The parent resource specified for a repository sync definition.\n"]
  directory : directory;
      [@ocaml.doc
  ...
  branch : branch_name; [@ocaml.doc "The branch specified for a repository sync definition.\n"]
}
...
type nonrec repository_sync_attempt = {
  ...
  status : repository_sync_status;
      [@ocaml.doc
        ...
        \           \n\
        \            }\n\
        \       {-  IN_PROGRESS - A repository sync attempt has started and work is being done to \
        ...
        \       }\n\
        \  "]
  started_at : timestamp; [@ocaml.doc "The start time of a specific sync attempt.\n"]
}
[@@ocaml.doc
  "Information about a repository sync attempt for a repository with a sync configuration.\n"]

type nonrec repository_link_list = repository_link_info list [@@ocaml.doc ""]
...
type nonrec list_sync_configurations_output = {
  next_token : sharp_next_token option;
      [@ocaml.doc
        "An enumeration token that allows the operation to batch the next results of the operation.\n"]
  sync_configurations : sync_configuration_list;
      [@ocaml.doc "The list of repository sync definitions returned by the request.\n"]
}
[@@ocaml.doc ""]

type nonrec list_sync_configurations_input = {
  sync_type : sync_configuration_type;
      [@ocaml.doc "The sync type for the requested list of sync configurations.\n"]
  repository_link_id : repository_link_id;
      [@ocaml.doc "The ID of the repository link for the requested list of sync configurations.\n"]
  next_token : sharp_next_token option;
      [@ocaml.doc
  ...
  repository_sync_definitions : repository_sync_definition_list;
      [@ocaml.doc
        "The list of repository sync definitions returned by the request. A \
         [RepositorySyncDefinition] is a mapping from a repository branch to all the Amazon Web \
         Services resources that are being synced from that branch.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_repository_sync_definitions_input = {
  sync_type : sync_configuration_type;
      [@ocaml.doc
        "The sync type of the repository link for the the sync definition for which you want to \
         retrieve information.\n"]
  repository_link_id : repository_link_id;
      [@ocaml.doc
        "The ID of the repository link for the sync definition for which you want to retrieve \
         information.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_repository_links_output = {
  ...
  repository_links : repository_link_list;
      [@ocaml.doc "Lists the repository links called by the list repository links operation.\n"]
}
[@@ocaml.doc ""]
...
type nonrec host_status = string [@@ocaml.doc ""]

type nonrec host_status_message = string [@@ocaml.doc ""]

type nonrec host = {
  status_message : host_status_message option; [@ocaml.doc "The status description for the host.\n"]
  status : host_status option;
      [@ocaml.doc
  ...
  vpc_configuration : vpc_configuration option;
      [@ocaml.doc "The VPC configuration provisioned for the host.\n"]
  provider_endpoint : url option;
      [@ocaml.doc "The endpoint of the infrastructure where your provider type is installed.\n"]
  ...
  host_arn : host_arn option; [@ocaml.doc "The Amazon Resource Name (ARN) of the host.\n"]
  name : host_name option; [@ocaml.doc "The name of the host.\n"]
}
[@@ocaml.doc
  "A resource that represents the infrastructure where a third-party provider is installed. The \
   host is used when you create connections to an installed third-party provider type, such as \
   GitHub Enterprise Server. You create one host for all connections to that provider.\n\n\
...
type nonrec list_hosts_output = {
  next_token : next_token option;
      [@ocaml.doc
        "A token that can be used in the next [ListHosts] call. To view all items in the list, \
         continue to call this operation with each subsequent token until no more [nextToken] \
         values are returned.\n"]
  hosts : host_list option;
      [@ocaml.doc
...
type nonrec list_hosts_input = {
  next_token : next_token option;
      [@ocaml.doc
        "The token that was returned from the previous [ListHosts] call, which can be used to \
...
type nonrec connection = {
  host_arn : host_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the host associated with the connection.\n"]
...
[@@ocaml.doc
  "A resource that is used to connect third-party source providers with services like \
   CodePipeline.\n\n\
  \ Note: A connection created through CloudFormation, the CLI, or the SDK is in `PENDING` status \
   by default. You can make its status `AVAILABLE` by updating the connection in the console.\n\
  \ "]
...
type nonrec list_connections_output = {
  next_token : next_token option;
      [@ocaml.doc
        "A token that can be used in the next [ListConnections] call. To view all items in the \
         list, continue to call this operation with each subsequent token until no more \
         [nextToken] values are returned.\n"]
  connections : connection_list option;
      [@ocaml.doc
...
type nonrec list_connections_input = {
  next_token : next_token option;
      [@ocaml.doc
        "The token that was returned from the previous [ListConnections] call, which can be used \
         to return the next set of connections in the list.\n"]
  max_results : max_results option;
      [@ocaml.doc
        "The maximum number of results to return in a single call. To retrieve the remaining \
         results, make another call with the returned [nextToken] value.\n"]
  host_arn_filter : host_arn option;
      [@ocaml.doc "Filters the list of connections to those associated with a specified host.\n"]
...
type nonrec get_sync_blocker_summary_input = {
  resource_name : resource_name;
      [@ocaml.doc
        "The name of the Amazon Web Services resource currently blocked from automatically being \
         synced from a Git repository.\n"]
  sync_type : sync_configuration_type; [@ocaml.doc "The sync type for the sync blocker summary.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_resource_sync_status_output = {
  ...
  latest_successful_sync : resource_sync_attempt option;
      [@ocaml.doc "The latest successful sync for the sync status with the Git repository.\n"]
...
type nonrec get_resource_sync_status_input = {
  sync_type : sync_configuration_type;
      [@ocaml.doc "The sync type for the sync status with the Git repository.\n"]
  resource_name : resource_name;
      [@ocaml.doc
...
type nonrec get_repository_sync_status_output = {
  latest_sync : repository_sync_attempt;
      [@ocaml.doc "The status of the latest sync returned for a specified repository and branch.\n"]
}
[@@ocaml.doc ""]

type nonrec get_repository_sync_status_input = {
  sync_type : sync_configuration_type; [@ocaml.doc "The sync type of the requested sync status.\n"]
  repository_link_id : repository_link_id;
      [@ocaml.doc "The repository link ID for the requested repository sync status.\n"]
  branch : branch_name;
      [@ocaml.doc "The branch of the repository link for the requested repository sync status.\n"]
}
[@@ocaml.doc ""]

type nonrec get_repository_link_output = {
  repository_link_info : repository_link_info;
      [@ocaml.doc "The information returned for a specified repository link.\n"]
}
[@@ocaml.doc ""]

type nonrec get_repository_link_input = {
  repository_link_id : repository_link_id; [@ocaml.doc "The ID of the repository link to get.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_host_output = {
  ...
  provider_endpoint : url option;
      [@ocaml.doc "The endpoint of the infrastructure represented by the requested host.\n"]
  provider_type : provider_type option;
      [@ocaml.doc "The provider type of the requested host, such as GitHub Enterprise Server.\n"]
  status : host_status option; [@ocaml.doc "The status of the requested host.\n"]
  name : host_name option; [@ocaml.doc "The name of the requested host.\n"]
}
[@@ocaml.doc ""]

type nonrec get_host_input = {
  host_arn : host_arn; [@ocaml.doc "The Amazon Resource Name (ARN) of the requested host.\n"]
}
[@@ocaml.doc ""]

type nonrec get_connection_output = {
  connection : connection option;
      [@ocaml.doc "The connection details, such as status, owner, and provider type.\n"]
}
[@@ocaml.doc ""]

type nonrec get_connection_input = {
  connection_arn : connection_arn; [@ocaml.doc "The Amazon Resource Name (ARN) of a connection.\n"]
}
[@@ocaml.doc ""]

type nonrec delete_sync_configuration_output = unit [@@ocaml.doc ""]
  ...
  resource_name : resource_name;
      [@ocaml.doc
        "The name of the Amazon Web Services resource associated with the sync configuration to be \
         deleted.\n"]
  sync_type : sync_configuration_type; [@ocaml.doc "The type of sync configuration to be deleted.\n"]
}
[@@ocaml.doc ""]

type nonrec delete_repository_link_output = unit [@@ocaml.doc ""]
...
type nonrec delete_host_output = unit [@@ocaml.doc ""]

type nonrec delete_host_input = {
  host_arn : host_arn; [@ocaml.doc "The Amazon Resource Name (ARN) of the host to be deleted.\n"]
}
[@@ocaml.doc ""]

type nonrec delete_connection_output = unit [@@ocaml.doc ""]
...
type nonrec create_sync_configuration_output = {
  sync_configuration : sync_configuration;
      [@ocaml.doc
        "The created sync configuration for the connection. A sync configuration allows Amazon Web \
         Services to sync content from a Git repository to update a specified Amazon Web Services \
         resource. \n"]
}
[@@ocaml.doc ""]
...
type nonrec create_sync_configuration_input = {
  ...
  publish_deployment_status : publish_deployment_status option;
      [@ocaml.doc
        "Whether to enable or disable publishing of deployment status to source providers.\n"]
  sync_type : sync_configuration_type; [@ocaml.doc "The type of sync configuration.\n"]
  role_arn : iam_role_arn;
      [@ocaml.doc
  ...
  config_file : deployment_file_path;
      [@ocaml.doc
        "The file name of the configuration file that manages syncing between the connection and \
         the repository. This configuration file is stored in the repository.\n"]
  branch : branch_name;
      [@ocaml.doc "The branch in the repository from which changes will be synced.\n"]
}
[@@ocaml.doc ""]

type nonrec create_repository_link_output = {
  repository_link_info : repository_link_info;
      [@ocaml.doc "The returned information about the created repository link.\n"]
}
[@@ocaml.doc ""]

type nonrec create_repository_link_input = {
  tags : tag_list option;
      [@ocaml.doc "The tags for the repository to be associated with the repository link.\n"]
  encryption_key_arn : kms_key_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) encryption key for the repository to be associated with \
         the repository link.\n"]
  repository_name : repository_name;
      [@ocaml.doc "The name of the repository to be associated with the repository link.\n"]
  owner_id : owner_id;
      [@ocaml.doc
        "The owner ID for the repository associated with a specific sync configuration, such as \
         the owner ID in GitHub.\n"]
...
type nonrec create_host_output = {
  tags : tag_list option; [@ocaml.doc "Tags for the created host.\n"]
  host_arn : host_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the host to be created.\n"]
}
[@@ocaml.doc ""]

type nonrec create_host_input = {
  tags : tag_list option; [@ocaml.doc "Tags for the host to be created.\n"]
  vpc_configuration : vpc_configuration option;
      [@ocaml.doc
  ...
  provider_type : provider_type;
      [@ocaml.doc
        "The name of the installed provider to be associated with your connection. The host \
         resource represents the infrastructure where your provider type is installed. The valid \
         provider type is GitHub Enterprise Server.\n"]
  name : host_name; [@ocaml.doc "The name of the host to be created.\n"]
}
[@@ocaml.doc ""]

type nonrec create_connection_output = {
  tags : tag_list option; [@ocaml.doc "Specifies the tags applied to the resource.\n"]
  connection_arn : connection_arn;
      [@ocaml.doc
...
type nonrec create_connection_input = {
  ...
  tags : tag_list option; [@ocaml.doc "The key-value pair to use when tagging the resource.\n"]
  connection_name : connection_name; [@ocaml.doc "The name of the connection to be created.\n"]
  provider_type : provider_type option;
      [@ocaml.doc
        "The name of the external provider where your third-party code repository is configured.\n"]
}
