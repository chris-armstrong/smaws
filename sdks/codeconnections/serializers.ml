...
let update_sync_configuration_output_to_yojson
  (x : update_sync_configuration_output) =
  assoc_to_yojson
    [("SyncConfiguration",
...
let sync_blocker_context_list_to_yojson tree =
...
let sync_blocker_to_yojson (x : sync_blocker) =
  assoc_to_yojson
    [("ResolvedAt", (option_to_yojson timestamp__to_yojson x.resolved_at));
    ("ResolvedReason",
...
let sync_blocker_does_not_exist_exception_to_yojson
  (x : sync_blocker_does_not_exist_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let retry_latest_commit_failed_exception_to_yojson
  (x : retry_latest_commit_failed_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let update_repository_link_output_to_yojson
  (x : update_repository_link_output) =
  assoc_to_yojson
    [("RepositoryLinkInfo",
...
let unsupported_provider_type_exception_to_yojson
  (x : unsupported_provider_type_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let sync_configuration_still_exists_exception_to_yojson
  ...
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let sync_configuration_list_to_yojson tree =
  list_to_yojson sync_configuration_to_yojson tree
let latest_sync_blocker_list_to_yojson tree =
...
let resource_sync_attempt_to_yojson (x : resource_sync_attempt) =
  assoc_to_yojson
    ...
    ("StartedAt", (Some (timestamp__to_yojson x.started_at)));
...
let repository_sync_event_to_yojson (x : repository_sync_event) =
  assoc_to_yojson
    ...
    ("ExternalId", (option_to_yojson external_id_to_yojson x.external_id));
    ("Event", (Some (event_to_yojson x.event)))]
let repository_sync_event_list_to_yojson tree =
...
let repository_sync_attempt_to_yojson (x : repository_sync_attempt) =
  assoc_to_yojson
    ...
    ("StartedAt", (Some (timestamp__to_yojson x.started_at)))]
let repository_link_list_to_yojson tree =
  list_to_yojson repository_link_info_to_yojson tree
...
let list_sync_configurations_output_to_yojson
  (x : list_sync_configurations_output) =
  assoc_to_yojson
    [("NextToken",
...
let list_sync_configurations_input_to_yojson
  (x : list_sync_configurations_input) =
  assoc_to_yojson
    [("SyncType", (Some (sync_configuration_type_to_yojson x.sync_type)));
    ("RepositoryLinkId",
      (Some (repository_link_id_to_yojson x.repository_link_id)));
...
let list_repository_sync_definitions_output_to_yojson
  ...
  assoc_to_yojson
    ...
    ("RepositorySyncDefinitions",
      (Some
         (repository_sync_definition_list_to_yojson
            x.repository_sync_definitions)))]
...
let get_sync_configuration_output_to_yojson
  (x : get_sync_configuration_output) =
  assoc_to_yojson
    [("SyncConfiguration",
       (Some (sync_configuration_to_yojson x.sync_configuration)))]
...
let get_resource_sync_status_input_to_yojson
  (x : get_resource_sync_status_input) =
  assoc_to_yojson
    [("SyncType", (Some (sync_configuration_type_to_yojson x.sync_type)));
    ("ResourceName", (Some (resource_name_to_yojson x.resource_name)))]
let get_repository_sync_status_output_to_yojson
  ...
  assoc_to_yojson
    [("LatestSync", (Some (repository_sync_attempt_to_yojson x.latest_sync)))]
...
let create_sync_configuration_output_to_yojson
  (x : create_sync_configuration_output) =
  assoc_to_yojson
    [("SyncConfiguration",
       (Some (sync_configuration_to_yojson x.sync_configuration)))]
...
let create_repository_link_output_to_yojson
  (x : create_repository_link_output) =
  assoc_to_yojson
    [("RepositoryLinkInfo",
       (Some (repository_link_info_to_yojson x.repository_link_info)))]
