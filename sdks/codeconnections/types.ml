...
type nonrec pull_request_comment = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec trigger_resource_update_on = ANY_CHANGE [@ocaml.doc ""] | FILE_CHANGE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec publish_deployment_status = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
