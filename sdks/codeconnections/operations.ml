  ...
  struct
    ...
    let request context (request : create_connection_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_connection_input_to_yojson request in
  ...
  struct
    ...
    let request context (request : create_repository_link_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"CodeConnections_20231201CreateRepositoryLink" ~service
          ~config:context.config ~http:context.http ~input
...
module DeleteConnection =
  struct
    ...
    let request context (request : delete_connection_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_connection_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : delete_repository_link_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"CodeConnections_20231201DeleteRepositoryLink" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : get_sync_configuration_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"CodeConnections_20231201GetSyncConfiguration" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : list_repository_links_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"CodeConnections_20231201ListRepositoryLinks" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : list_tags_for_resource_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"CodeConnections_20231201ListTagsForResource" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : update_repository_link_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"CodeConnections_20231201UpdateRepositoryLink" ~service
          ~config:context.config ~http:context.http ~input
