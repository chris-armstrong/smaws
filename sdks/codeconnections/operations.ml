  ...
  struct
    ...
    let request context (request : create_connection_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.CreateConnection" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.create_connection_output_of_yojson
        ~error_deserializer
  end
module CreateHost =
  struct
    ...
    let request context (request : create_host_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.CreateHost" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.create_host_output_of_yojson
        ~error_deserializer
  end
module CreateRepositoryLink =
  struct
    ...
    let request context (request : create_repository_link_input) =
      let input =
        Json_serializers.create_repository_link_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.CreateRepositoryLink" ~service
        ~context ~input
...
module CreateSyncConfiguration =
  struct
    ...
    let request context (request : create_sync_configuration_input) =
      let input =
        Json_serializers.create_sync_configuration_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteConnection =
  struct
    ...
    let request context (request : delete_connection_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.DeleteConnection" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.delete_connection_output_of_yojson
        ~error_deserializer
  end
module DeleteHost =
  struct
    ...
    let request context (request : delete_host_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.DeleteHost" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.delete_host_output_of_yojson
        ~error_deserializer
  end
module DeleteRepositoryLink =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "SyncConfigurationStillExistsException") ->
            `SyncConfigurationStillExistsException
              (Json_deserializers.sync_configuration_still_exists_exception_of_yojson
                 tree path)
        | (_, "ThrottlingException") ->
            `ThrottlingException
              (Json_deserializers.throttling_exception_of_yojson tree path)
        | (_, "UnsupportedProviderTypeException") ->
            `UnsupportedProviderTypeException
              (Json_deserializers.unsupported_provider_type_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : delete_repository_link_input) =
      let input =
        Json_serializers.delete_repository_link_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.DeleteRepositoryLink" ~service
        ~context ~input
...
module DeleteSyncConfiguration =
  struct
    ...
    let request context (request : delete_sync_configuration_input) =
      let input =
        Json_serializers.delete_sync_configuration_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetConnection =
  struct
    ...
    let request context (request : get_connection_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.GetConnection" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.get_connection_output_of_yojson
        ~error_deserializer
  end
module GetHost =
  struct
    ...
    let request context (request : get_host_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.GetHost" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.get_host_output_of_yojson
        ~error_deserializer
  end
module GetRepositoryLink =
  struct
    ...
    let request context (request : get_repository_link_input) =
      let input =
        Json_serializers.get_repository_link_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.GetRepositoryLink" ~service
        ~context ~input
...
module GetResourceSyncStatus =
  struct
    ...
    let request context (request : get_resource_sync_status_input) =
      let input =
        Json_serializers.get_resource_sync_status_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.GetResourceSyncStatus" ~service
        ~context ~input
...
module GetSyncBlockerSummary =
  struct
    ...
    let request context (request : get_sync_blocker_summary_input) =
      let input =
        Json_serializers.get_sync_blocker_summary_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.GetSyncBlockerSummary" ~service
        ~context ~input
...
module GetSyncConfiguration =
  struct
    ...
    let request context (request : get_sync_configuration_input) =
      let input =
        Json_serializers.get_sync_configuration_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.GetSyncConfiguration" ~service
        ~context ~input
...
module ListConnections =
  struct
    ...
    let request context (request : list_connections_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.ListConnections" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_connections_output_of_yojson
        ~error_deserializer
  end
module ListHosts =
  struct
    ...
    let request context (request : list_hosts_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.ListHosts" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.list_hosts_output_of_yojson
        ~error_deserializer
  end
module ListRepositoryLinks =
  struct
    ...
    let request context (request : list_repository_links_input) =
      let input =
        Json_serializers.list_repository_links_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.ListRepositoryLinks" ~service
        ~context ~input
...
module ListSyncConfigurations =
  struct
    ...
    let request context (request : list_sync_configurations_input) =
      let input =
        Json_serializers.list_sync_configurations_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.ListTagsForResource" ~service
        ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.TagResource" ~service ~context
        ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.UntagResource" ~service
        ~context ~input
...
module UpdateHost =
  struct
    ...
    let request context (request : update_host_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.UpdateHost" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.update_host_output_of_yojson
        ~error_deserializer
  end
module UpdateRepositoryLink =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "UpdateOutOfSyncException") ->
            `UpdateOutOfSyncException
              (Json_deserializers.update_out_of_sync_exception_of_yojson tree
                 path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : update_repository_link_input) =
      let input =
        Json_serializers.update_repository_link_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.UpdateRepositoryLink" ~service
        ~context ~input
...
module UpdateSyncBlocker =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "RetryLatestCommitFailedException") ->
            `RetryLatestCommitFailedException
              (Json_deserializers.retry_latest_commit_failed_exception_of_yojson
                 tree path)
        | (_, "SyncBlockerDoesNotExistException") ->
            `SyncBlockerDoesNotExistException
              (Json_deserializers.sync_blocker_does_not_exist_exception_of_yojson
                 tree path)
        | (_, "ThrottlingException") ->
            `ThrottlingException
              (Json_deserializers.throttling_exception_of_yojson tree path)
    ...
    let request context (request : update_sync_blocker_input) =
      let input =
        Json_serializers.update_sync_blocker_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CodeConnections_20231201.UpdateSyncBlocker" ~service
        ~context ~input
...
module UpdateSyncConfiguration =
  struct
    ...
    let request context (request : update_sync_configuration_input) =
      let input =
        Json_serializers.update_sync_configuration_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
