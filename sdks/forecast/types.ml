...
type nonrec evaluation_type = COMPUTED [@ocaml.doc ""] | SUMMARY [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec time_series_granularity = SPECIFIC [@ocaml.doc ""] | ALL [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec time_point_granularity = SPECIFIC [@ocaml.doc ""] | ALL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec state = Deleted [@ocaml.doc ""] | Active [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec filter_condition_string = IS_NOT [@ocaml.doc ""] | IS [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec data_config = {
  ...
  dataset_group_arn : arn; [@ocaml.doc "The ARN of the dataset group used to train the predictor.\n"]
}
