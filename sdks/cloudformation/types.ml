...
type nonrec version_bump = MAJOR [@ocaml.doc ""] | MINOR [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec call_as = SELF [@ocaml.doc ""] | DELEGATED_ADMIN [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec evaluation_type = Static [@ocaml.doc ""] | Dynamic [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec hook_failure_mode = FAIL [@ocaml.doc ""] | WARN [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec validate_template_output = {
  parameters : template_parameters option;
...
type nonrec permission_models = SERVICE_MANAGED [@ocaml.doc ""] | SELF_MANAGED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec region_concurrency_type = SEQUENTIAL [@ocaml.doc ""] | PARALLEL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec deployment_config_mode = STANDARD [@ocaml.doc ""] | EXPRESS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec generated_template_deletion_policy = DELETE [@ocaml.doc ""] | RETAIN [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec resource_signal_status = SUCCESS [@ocaml.doc ""] | FAILURE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec deprecated_status = LIVE [@ocaml.doc ""] | DEPRECATED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec visibility = PUBLIC [@ocaml.doc ""] | PRIVATE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec stack_set_status = ACTIVE [@ocaml.doc ""] | DELETED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec stack_refactor_detection = AUTO [@ocaml.doc ""] | MANUAL [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec stack_refactor_resource_identifier = string [@@ocaml.doc ""]

type nonrec stack_refactor_action_entity = RESOURCE [@ocaml.doc ""] | STACK [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec stack_refactor_action_type = MOVE [@ocaml.doc ""] | CREATE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec scan_type = FULL [@ocaml.doc ""] | PARTIAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec template_stage = Original [@ocaml.doc ""] | Processed [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec template_format = JSON [@ocaml.doc ""] | YAML [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec stack_set_operation = {
  operation_id : client_request_token option;
      [@ocaml.doc "The unique ID of a StackSet operation.\n"]
  stack_set_id : stack_set_id option; [@ocaml.doc "The ID of the StackSet.\n"]
  action : stack_set_operation_action option;
      [@ocaml.doc
...
type nonrec deletion_mode = STANDARD [@ocaml.doc ""] | FORCE_DELETE_STACK [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec publisher_status = VERIFIED [@ocaml.doc ""] | UNVERIFIED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec validation_status = FAILED [@ocaml.doc ""] | SKIPPED [@ocaml.doc ""] [@@ocaml.doc ""]
