...
module AssociateDRTLogBucket =
  struct
    let error_to_string =
      ...
      | `LimitsExceededException _ ->
          "com.amazonaws.shield#LimitsExceededException"
      | `NoAssociatedRoleException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "AccessDeniedForDependencyException") ->
            `AccessDeniedForDependencyException
              (Json_deserializers.access_denied_for_dependency_exception_of_yojson
                 tree path)
        ...
        | (_, "LimitsExceededException") ->
            `LimitsExceededException
              (Json_deserializers.limits_exceeded_exception_of_yojson tree
                 path)
        | (_, "NoAssociatedRoleException") ->
            `NoAssociatedRoleException
              (Json_deserializers.no_associated_role_exception_of_yojson tree
                 path)
        | (_, "OptimisticLockException") ->
            `OptimisticLockException
              (Json_deserializers.optimistic_lock_exception_of_yojson tree
                 path)
    ...
    let request context (request : associate_drt_log_bucket_request) =
      let input =
        Json_serializers.associate_drt_log_bucket_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.AssociateDRTLogBucket" ~service
        ~context ~input
...
module AssociateDRTRole =
  struct
    ...
    let request context (request : associate_drt_role_request) =
      let input =
        Json_serializers.associate_drt_role_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.AssociateDRTRole" ~service ~context
        ~input
...
module AssociateHealthCheck =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidResourceException") ->
            `InvalidResourceException
              (Json_deserializers.invalid_resource_exception_of_yojson tree
                 path)
        | (_, "LimitsExceededException") ->
            `LimitsExceededException
              (Json_deserializers.limits_exceeded_exception_of_yojson tree
    ...
    let request context (request : associate_health_check_request) =
      let input =
        Json_serializers.associate_health_check_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.AssociateHealthCheck" ~service
        ~context ~input
...
module AssociateProactiveEngagementDetails =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.associate_proactive_engagement_details_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.AssociateProactiveEngagementDetails"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.associate_proactive_engagement_details_response_of_yojson
        ~error_deserializer
  end
module CreateProtection =
  struct
    ...
    let request context (request : create_protection_request) =
      let input =
        Json_serializers.create_protection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.CreateProtection" ~service ~context
        ~input
...
module CreateProtectionGroup =
  struct
    ...
    let request context (request : create_protection_group_request) =
      let input =
        Json_serializers.create_protection_group_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.CreateProtectionGroup" ~service
        ~context ~input
...
module CreateSubscription =
  struct
    ...
    let request context (request : create_subscription_request) =
      let input =
        Json_serializers.create_subscription_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.CreateSubscription" ~service ~context
        ~input
...
module DeleteProtection =
  struct
    ...
    let request context (request : delete_protection_request) =
      let input =
        Json_serializers.delete_protection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DeleteProtection" ~service ~context
        ~input
...
module DeleteProtectionGroup =
  struct
    ...
    let request context (request : delete_protection_group_request) =
      let input =
        Json_serializers.delete_protection_group_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DeleteProtectionGroup" ~service
        ~context ~input
...
module DeleteSubscription =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "LockedSubscriptionException") ->
            `LockedSubscriptionException
              (Json_deserializers.locked_subscription_exception_of_yojson
                 tree path)
        | (_, "ResourceNotFoundException") ->
            `ResourceNotFoundException
              (Json_deserializers.resource_not_found_exception_of_yojson tree
    ...
    let request context (request : delete_subscription_request) =
      let input =
        Json_serializers.delete_subscription_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DeleteSubscription" ~service ~context
        ~input
...
module DescribeAttack =
  struct
    ...
    let request context (request : describe_attack_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DescribeAttack" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.describe_attack_response_of_yojson
        ~error_deserializer
  end
module DescribeAttackStatistics =
  struct
    ...
    let request context (request : describe_attack_statistics_request) =
      let input =
        Json_serializers.describe_attack_statistics_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DescribeAttackStatistics" ~service
        ~context ~input
...
module DescribeDRTAccess =
  struct
    ...
    let request context (request : describe_drt_access_request) =
      let input =
        Json_serializers.describe_drt_access_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DescribeDRTAccess" ~service ~context
        ~input
...
module DescribeEmergencyContactSettings =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_emergency_contact_settings_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeProtection =
  struct
    ...
    let request context (request : describe_protection_request) =
      let input =
        Json_serializers.describe_protection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DescribeProtection" ~service ~context
        ~input
...
module DescribeProtectionGroup =
  struct
    ...
    let request context (request : describe_protection_group_request) =
      let input =
        Json_serializers.describe_protection_group_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DescribeProtectionGroup" ~service
        ~context ~input
...
module DescribeSubscription =
  struct
    ...
    let request context (request : describe_subscription_request) =
      let input =
        Json_serializers.describe_subscription_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DescribeSubscription" ~service
        ~context ~input
...
module DisableApplicationLayerAutomaticResponse =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.disable_application_layer_automatic_response_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DisableApplicationLayerAutomaticResponse"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.disable_application_layer_automatic_response_response_of_yojson
        ~error_deserializer
  end
module DisableProactiveEngagement =
  struct
    ...
    let request context (request : disable_proactive_engagement_request) =
      let input =
        Json_serializers.disable_proactive_engagement_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DisableProactiveEngagement" ~service
        ~context ~input
...
module DisassociateDRTLogBucket =
  struct
    ...
    let request context (request : disassociate_drt_log_bucket_request) =
      let input =
        Json_serializers.disassociate_drt_log_bucket_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DisassociateDRTLogBucket" ~service
        ~context ~input
...
module DisassociateDRTRole =
  struct
    ...
    let request context (request : disassociate_drt_role_request) =
      let input =
        Json_serializers.disassociate_drt_role_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DisassociateDRTRole" ~service
        ~context ~input
...
module DisassociateHealthCheck =
  struct
    ...
    let request context (request : disassociate_health_check_request) =
      let input =
        Json_serializers.disassociate_health_check_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.DisassociateHealthCheck" ~service
        ~context ~input
...
module EnableApplicationLayerAutomaticResponse =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.enable_application_layer_automatic_response_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.EnableApplicationLayerAutomaticResponse"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.enable_application_layer_automatic_response_response_of_yojson
        ~error_deserializer
  end
module EnableProactiveEngagement =
  struct
    ...
    let request context (request : enable_proactive_engagement_request) =
      let input =
        Json_serializers.enable_proactive_engagement_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.EnableProactiveEngagement" ~service
        ~context ~input
...
module GetSubscriptionState =
  struct
    ...
    let request context (request : get_subscription_state_request) =
      let input =
        Json_serializers.get_subscription_state_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.GetSubscriptionState" ~service
        ~context ~input
...
module ListAttacks =
  struct
    ...
    let request context (request : list_attacks_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.ListAttacks" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_attacks_response_of_yojson
        ~error_deserializer
  end
module ListProtectionGroups =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidPaginationTokenException") ->
            `InvalidPaginationTokenException
              (Json_deserializers.invalid_pagination_token_exception_of_yojson
                 tree path)
        | (_, "ResourceNotFoundException") ->
            `ResourceNotFoundException
              (Json_deserializers.resource_not_found_exception_of_yojson tree
    ...
    let request context (request : list_protection_groups_request) =
      let input =
        Json_serializers.list_protection_groups_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.ListProtectionGroups" ~service
        ~context ~input
...
module ListProtections =
  struct
    ...
    let request context (request : list_protections_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.ListProtections" ~service ~context
        ~input
...
module ListResourcesInProtectionGroup =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_resources_in_protection_group_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.ListTagsForResource" ~service
        ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.TagResource" ~service ~context ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.UntagResource" ~service ~context
        ~input
...
module UpdateApplicationLayerAutomaticResponse =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.update_application_layer_automatic_response_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.UpdateApplicationLayerAutomaticResponse"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.update_application_layer_automatic_response_response_of_yojson
        ~error_deserializer
  end
module UpdateEmergencyContactSettings =
  struct
    ...
    let request context (request : update_emergency_contact_settings_request)
      =
      let input =
        Json_serializers.update_emergency_contact_settings_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateProtectionGroup =
  struct
    ...
    let request context (request : update_protection_group_request) =
      let input =
        Json_serializers.update_protection_group_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.UpdateProtectionGroup" ~service
        ~context ~input
...
module UpdateSubscription =
  struct
    ...
    let request context (request : update_subscription_request) =
      let input =
        Json_serializers.update_subscription_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSShield_20160616.UpdateSubscription" ~service ~context
        ~input
