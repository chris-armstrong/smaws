...
module DescribeAttack =
  struct
    ...
    let request context (request : describe_attack_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_attack_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribeAttackStatistics =
  struct
    ...
    let request context (request : describe_attack_statistics_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_attack_statistics_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribeProtectionGroup =
  struct
    ...
    let request context (request : describe_protection_group_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_protection_group_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.disable_proactive_engagement_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSShield_20160616DisableProactiveEngagement" ~service
          ~config:context.config ~http:context.http ~input
...
module DisassociateHealthCheck =
  struct
    ...
    let request context (request : disassociate_health_check_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.disassociate_health_check_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.enable_proactive_engagement_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSShield_20160616EnableProactiveEngagement" ~service
          ~config:context.config ~http:context.http ~input
...
module ListProtections =
  struct
    ...
    let request context (request : list_protections_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_protections_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
