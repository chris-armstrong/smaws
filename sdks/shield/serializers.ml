...
let locked_subscription_exception_to_yojson
  (x : locked_subscription_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let emergency_contact_list_to_yojson tree =
  list_to_yojson emergency_contact_to_yojson tree
...
let top_contributors_to_yojson tree =
  list_to_yojson contributor_to_yojson tree
let token_to_yojson = string_to_yojson
let timestamp__to_yojson = timestamp_to_yojson
let time_range_to_yojson (x : time_range) =
  assoc_to_yojson
    [("ToExclusive", (option_to_yojson timestamp__to_yojson x.to_exclusive));
    ("FromInclusive",
...
let summarized_counter_to_yojson (x : summarized_counter) =
  assoc_to_yojson
    ...
    ("N", (option_to_yojson integer__to_yojson x.n));
    ...
    ("Name", (option_to_yojson string__to_yojson x.name))]
let summarized_counter_list_to_yojson tree =
  list_to_yojson summarized_counter_to_yojson tree
...
let protection_group_pattern_type_limits_to_yojson
  (x : protection_group_pattern_type_limits) =
  assoc_to_yojson
    [("ArbitraryPatternLimits",
       (Some
          (protection_group_arbitrary_pattern_limits_to_yojson
             x.arbitrary_pattern_limits)))]
let protection_group_limits_to_yojson (x : protection_group_limits) =
  assoc_to_yojson
    [("PatternTypeLimits",
       (Some
          (protection_group_pattern_type_limits_to_yojson
             x.pattern_type_limits)));
...
let subscription_to_yojson (x : subscription) =
  assoc_to_yojson
    ...
    ("ProactiveEngagementStatus",
      (option_to_yojson proactive_engagement_status_to_yojson
         x.proactive_engagement_status));
    ("Limits", (option_to_yojson limits_to_yojson x.limits));
    ("AutoRenew", (option_to_yojson auto_renew_to_yojson x.auto_renew));
    ("TimeCommitmentInSeconds",
      (option_to_yojson duration_in_seconds_to_yojson
         x.time_commitment_in_seconds));
...
let health_check_ids_to_yojson tree =
  list_to_yojson health_check_id_to_yojson tree
...
let protection_to_yojson (x : protection) =
  assoc_to_yojson
    [("ApplicationLayerAutomaticResponseConfiguration",
       (option_to_yojson
          application_layer_automatic_response_configuration_to_yojson
          x.application_layer_automatic_response_configuration));
    ("ProtectionArn",
...
let protection_name_filters_to_yojson tree =
  list_to_yojson protection_name_to_yojson tree
let protection_group_to_yojson (x : protection_group) =
  assoc_to_yojson
    ...
    ("ProtectionGroupId",
      (Some (protection_group_id_to_yojson x.protection_group_id)))]
let protection_groups_to_yojson tree =
  list_to_yojson protection_group_to_yojson tree
let protection_group_pattern_filters_to_yojson tree =
  list_to_yojson protection_group_pattern_to_yojson tree
let protection_group_id_filters_to_yojson tree =
  list_to_yojson protection_group_id_to_yojson tree
...
let invalid_pagination_token_exception_to_yojson
  (x : invalid_pagination_token_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let inclusion_protection_filters_to_yojson (x : inclusion_protection_filters)
  ...
  assoc_to_yojson
    [("ResourceTypes",
       (option_to_yojson protected_resource_type_filters_to_yojson
          x.resource_types));
    ("ProtectionNames",
...
let inclusion_protection_group_filters_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ProtectionGroupIds",
      (option_to_yojson protection_group_id_filters_to_yojson
         x.protection_group_ids))]
let list_protection_groups_request_to_yojson
  (x : list_protection_groups_request) =
  assoc_to_yojson
    [("InclusionFilters",
       (option_to_yojson inclusion_protection_group_filters_to_yojson
          x.inclusion_filters));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson token_to_yojson x.next_token))]
...
let attack_summary_to_yojson (x : attack_summary) =
  assoc_to_yojson
    [("AttackVectors",
       (option_to_yojson attack_vector_description_list_to_yojson
          x.attack_vectors));
...
let attack_summaries_to_yojson tree =
  list_to_yojson attack_summary_to_yojson tree
...
let get_subscription_state_response_to_yojson
  (x : get_subscription_state_response) =
  assoc_to_yojson
    [("SubscriptionState",
...
let describe_subscription_response_to_yojson
  (x : describe_subscription_response) =
  assoc_to_yojson
    [("Subscription",
...
let describe_protection_response_to_yojson (x : describe_protection_response)
  =
  assoc_to_yojson
    [("Protection", (option_to_yojson protection_to_yojson x.protection))]
...
let attack_volume_to_yojson (x : attack_volume) =
  assoc_to_yojson
    [("RequestsPerSecond",
       (option_to_yojson attack_volume_statistics_to_yojson
...
let describe_attack_statistics_response_to_yojson
  (x : describe_attack_statistics_response) =
  assoc_to_yojson
    [("DataItems",
...
let attack_property_to_yojson (x : attack_property) =
  assoc_to_yojson
    ...
    ("AttackPropertyIdentifier",
      (option_to_yojson attack_property_identifier_to_yojson
         x.attack_property_identifier));
    ("AttackLayer", (option_to_yojson attack_layer_to_yojson x.attack_layer))]
let attack_properties_to_yojson tree =
  list_to_yojson attack_property_to_yojson tree
...
let describe_attack_response_to_yojson (x : describe_attack_response) =
  assoc_to_yojson
    [("Attack", (option_to_yojson attack_detail_to_yojson x.attack))]
