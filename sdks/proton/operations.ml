...
module CancelComponentDeployment =
  struct
    ...
    let request context (request : cancel_component_deployment_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.cancel_component_deployment_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.cancel_environment_deployment_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AwsProton20200720CancelEnvironmentDeployment" ~service
          ~config:context.config ~http:context.http ~input
...
module CreateEnvironment =
  struct
    ...
    let request context (request : create_environment_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_environment_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateEnvironmentTemplate =
  struct
    ...
    let request context (request : create_environment_template_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_environment_template_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateRepository =
  struct
    ...
    let request context (request : create_repository_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_repository_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateTemplateSyncConfig =
  struct
    ...
    let request context (request : create_template_sync_config_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_template_sync_config_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteDeployment =
  struct
    ...
    let request context (request : delete_deployment_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_deployment_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteEnvironment =
  struct
    ...
    let request context (request : delete_environment_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_environment_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteEnvironmentTemplate =
  struct
    ...
    let request context (request : delete_environment_template_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_environment_template_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteRepository =
  struct
    ...
    let request context (request : delete_repository_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_repository_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteTemplateSyncConfig =
  struct
    ...
    let request context (request : delete_template_sync_config_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_template_sync_config_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module GetServiceTemplateVersion =
  struct
    ...
    let request context (request : get_service_template_version_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_service_template_version_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module ListEnvironments =
  struct
    ...
    let request context (request : list_environments_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_environments_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module ListRepositories =
  struct
    ...
    let request context (request : list_repositories_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_repositories_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_service_instance_outputs_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AwsProton20200720ListServiceInstanceOutputs" ~service
          ~config:context.config ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_service_pipeline_outputs_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AwsProton20200720ListServicePipelineOutputs" ~service
          ~config:context.config ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_service_template_versions_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AwsProton20200720ListServiceTemplateVersions" ~service
          ~config:context.config ~http:context.http ~input
...
module UpdateEnvironment =
  struct
    ...
    let request context (request : update_environment_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_environment_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateEnvironmentTemplate =
  struct
    ...
    let request context (request : update_environment_template_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_environment_template_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateServiceSyncBlocker =
  struct
    ...
    let request context (request : update_service_sync_blocker_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_service_sync_blocker_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateTemplateSyncConfig =
  struct
    ...
    let request context (request : update_template_sync_config_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_template_sync_config_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
