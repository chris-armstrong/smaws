...
module AcceptEnvironmentAccountConnection =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.accept_environment_account_connection_input_to_yojson
          request in
...
module CancelComponentDeployment =
  struct
    ...
    let request context (request : cancel_component_deployment_input) =
      let input =
        Json_serializers.cancel_component_deployment_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CancelComponentDeployment" ~service
        ~context ~input
...
module CancelEnvironmentDeployment =
  struct
    ...
    let request context (request : cancel_environment_deployment_input) =
      let input =
        Json_serializers.cancel_environment_deployment_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CancelEnvironmentDeployment" ~service
        ~context ~input
...
module CancelServiceInstanceDeployment =
  struct
    ...
    let request context (request : cancel_service_instance_deployment_input)
      =
      let input =
        Json_serializers.cancel_service_instance_deployment_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CancelServicePipelineDeployment =
  struct
    ...
    let request context (request : cancel_service_pipeline_deployment_input)
      =
      let input =
        Json_serializers.cancel_service_pipeline_deployment_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateComponent =
  struct
    ...
    let request context (request : create_component_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateComponent" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.create_component_output_of_yojson
        ~error_deserializer
  end
module CreateEnvironment =
  struct
    ...
    let request context (request : create_environment_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateEnvironment" ~service ~context
        ~input
...
module CreateEnvironmentAccountConnection =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.create_environment_account_connection_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateEnvironmentTemplate =
  struct
    ...
    let request context (request : create_environment_template_input) =
      let input =
        Json_serializers.create_environment_template_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateEnvironmentTemplate" ~service
        ~context ~input
...
module CreateEnvironmentTemplateVersion =
  struct
    ...
    let request context (request : create_environment_template_version_input)
      =
      let input =
        Json_serializers.create_environment_template_version_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateRepository =
  struct
    ...
    let request context (request : create_repository_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateRepository" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.create_repository_output_of_yojson
        ~error_deserializer
  end
module CreateService =
  struct
    ...
    let request context (request : create_service_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateService" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.create_service_output_of_yojson
        ~error_deserializer
  end
module CreateServiceInstance =
  struct
    ...
    let request context (request : create_service_instance_input) =
      let input =
        Json_serializers.create_service_instance_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateServiceInstance" ~service
        ~context ~input
...
module CreateServiceSyncConfig =
  struct
    ...
    let request context (request : create_service_sync_config_input) =
      let input =
        Json_serializers.create_service_sync_config_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateServiceSyncConfig" ~service
        ~context ~input
...
module CreateServiceTemplate =
  struct
    ...
    let request context (request : create_service_template_input) =
      let input =
        Json_serializers.create_service_template_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateServiceTemplate" ~service
        ~context ~input
...
module CreateServiceTemplateVersion =
  struct
    ...
    let request context (request : create_service_template_version_input) =
      let input =
        Json_serializers.create_service_template_version_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateServiceTemplateVersion" ~service
        ~context ~input
...
module CreateTemplateSyncConfig =
  struct
    ...
    let request context (request : create_template_sync_config_input) =
      let input =
        Json_serializers.create_template_sync_config_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.CreateTemplateSyncConfig" ~service
        ~context ~input
...
module DeleteComponent =
  struct
    ...
    let request context (request : delete_component_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteComponent" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.delete_component_output_of_yojson
        ~error_deserializer
  end
module DeleteDeployment =
  struct
    ...
    let request context (request : delete_deployment_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteDeployment" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.delete_deployment_output_of_yojson
        ~error_deserializer
  end
module DeleteEnvironment =
  struct
    ...
    let request context (request : delete_environment_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteEnvironment" ~service ~context
        ~input
...
module DeleteEnvironmentAccountConnection =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.delete_environment_account_connection_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteEnvironmentTemplate =
  struct
    ...
    let request context (request : delete_environment_template_input) =
      let input =
        Json_serializers.delete_environment_template_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteEnvironmentTemplate" ~service
        ~context ~input
...
module DeleteEnvironmentTemplateVersion =
  struct
    ...
    let request context (request : delete_environment_template_version_input)
      =
      let input =
        Json_serializers.delete_environment_template_version_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteRepository =
  struct
    ...
    let request context (request : delete_repository_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteRepository" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.delete_repository_output_of_yojson
        ~error_deserializer
  end
module DeleteService =
  struct
    ...
    let request context (request : delete_service_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteService" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.delete_service_output_of_yojson
        ~error_deserializer
  end
module DeleteServiceSyncConfig =
  struct
    ...
    let request context (request : delete_service_sync_config_input) =
      let input =
        Json_serializers.delete_service_sync_config_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteServiceSyncConfig" ~service
        ~context ~input
...
module DeleteServiceTemplate =
  struct
    ...
    let request context (request : delete_service_template_input) =
      let input =
        Json_serializers.delete_service_template_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteServiceTemplate" ~service
        ~context ~input
...
module DeleteServiceTemplateVersion =
  struct
    ...
    let request context (request : delete_service_template_version_input) =
      let input =
        Json_serializers.delete_service_template_version_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteServiceTemplateVersion" ~service
        ~context ~input
...
module DeleteTemplateSyncConfig =
  struct
    ...
    let request context (request : delete_template_sync_config_input) =
      let input =
        Json_serializers.delete_template_sync_config_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.DeleteTemplateSyncConfig" ~service
        ~context ~input
...
module GetAccountSettings =
  struct
    ...
    let request context (request : get_account_settings_input) =
      let input =
        Json_serializers.get_account_settings_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetAccountSettings" ~service ~context
        ~input
...
module GetComponent =
  struct
    ...
    let request context (request : get_component_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetComponent" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_component_output_of_yojson
        ~error_deserializer
  end
module GetDeployment =
  struct
    ...
    let request context (request : get_deployment_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetDeployment" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.get_deployment_output_of_yojson
        ~error_deserializer
  end
module GetEnvironment =
  struct
    ...
    let request context (request : get_environment_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetEnvironment" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.get_environment_output_of_yojson
        ~error_deserializer
  end
module GetEnvironmentAccountConnection =
  struct
    ...
    let request context (request : get_environment_account_connection_input)
      =
      let input =
        Json_serializers.get_environment_account_connection_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetEnvironmentTemplate =
  struct
    ...
    let request context (request : get_environment_template_input) =
      let input =
        Json_serializers.get_environment_template_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetEnvironmentTemplate" ~service
        ~context ~input
...
module GetEnvironmentTemplateVersion =
  struct
    ...
    let request context (request : get_environment_template_version_input) =
      let input =
        Json_serializers.get_environment_template_version_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetRepository =
  struct
    ...
    let request context (request : get_repository_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetRepository" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.get_repository_output_of_yojson
        ~error_deserializer
  end
module GetRepositorySyncStatus =
  struct
    ...
    let request context (request : get_repository_sync_status_input) =
      let input =
        Json_serializers.get_repository_sync_status_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetRepositorySyncStatus" ~service
        ~context ~input
...
module GetResourcesSummary =
  struct
    ...
    let request context (request : get_resources_summary_input) =
      let input =
        Json_serializers.get_resources_summary_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetResourcesSummary" ~service ~context
        ~input
...
module GetService =
  struct
    ...
    let request context (request : get_service_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetService" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_service_output_of_yojson
        ~error_deserializer
  end
module GetServiceInstance =
  struct
    ...
    let request context (request : get_service_instance_input) =
      let input =
        Json_serializers.get_service_instance_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetServiceInstance" ~service ~context
        ~input
...
module GetServiceInstanceSyncStatus =
  struct
    ...
    let request context (request : get_service_instance_sync_status_input) =
      let input =
        Json_serializers.get_service_instance_sync_status_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetServiceInstanceSyncStatus" ~service
        ~context ~input
...
module GetServiceSyncBlockerSummary =
  struct
    ...
    let request context (request : get_service_sync_blocker_summary_input) =
      let input =
        Json_serializers.get_service_sync_blocker_summary_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetServiceSyncBlockerSummary" ~service
        ~context ~input
...
module GetServiceSyncConfig =
  struct
    ...
    let request context (request : get_service_sync_config_input) =
      let input =
        Json_serializers.get_service_sync_config_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetServiceSyncConfig" ~service
        ~context ~input
...
module GetServiceTemplate =
  struct
    ...
    let request context (request : get_service_template_input) =
      let input =
        Json_serializers.get_service_template_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetServiceTemplate" ~service ~context
        ~input
...
module GetServiceTemplateVersion =
  struct
    ...
    let request context (request : get_service_template_version_input) =
      let input =
        Json_serializers.get_service_template_version_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetServiceTemplateVersion" ~service
        ~context ~input
...
module GetTemplateSyncConfig =
  struct
    ...
    let request context (request : get_template_sync_config_input) =
      let input =
        Json_serializers.get_template_sync_config_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetTemplateSyncConfig" ~service
        ~context ~input
...
module GetTemplateSyncStatus =
  struct
    ...
    let request context (request : get_template_sync_status_input) =
      let input =
        Json_serializers.get_template_sync_status_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.GetTemplateSyncStatus" ~service
        ~context ~input
...
module ListComponentOutputs =
  struct
    ...
    let request context (request : list_component_outputs_input) =
      let input =
        Json_serializers.list_component_outputs_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListComponentOutputs" ~service
        ~context ~input
...
module ListComponentProvisionedResources =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_component_provisioned_resources_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListComponents =
  struct
    ...
    let request context (request : list_components_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListComponents" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.list_components_output_of_yojson
        ~error_deserializer
  end
module ListDeployments =
  struct
    ...
    let request context (request : list_deployments_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListDeployments" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.list_deployments_output_of_yojson
        ~error_deserializer
  end
module ListEnvironmentAccountConnections =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_environment_account_connections_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListEnvironmentOutputs =
  struct
    ...
    let request context (request : list_environment_outputs_input) =
      let input =
        Json_serializers.list_environment_outputs_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListEnvironmentOutputs" ~service
        ~context ~input
...
module ListEnvironmentProvisionedResources =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_environment_provisioned_resources_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListEnvironmentProvisionedResources"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_environment_provisioned_resources_output_of_yojson
        ~error_deserializer
  end
module ListEnvironmentTemplateVersions =
  struct
    ...
    let request context (request : list_environment_template_versions_input)
      =
      let input =
        Json_serializers.list_environment_template_versions_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListEnvironmentTemplates =
  struct
    ...
    let request context (request : list_environment_templates_input) =
      let input =
        Json_serializers.list_environment_templates_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListEnvironmentTemplates" ~service
        ~context ~input
...
module ListEnvironments =
  struct
    ...
    let request context (request : list_environments_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListEnvironments" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.list_environments_output_of_yojson
        ~error_deserializer
  end
module ListRepositories =
  struct
    ...
    let request context (request : list_repositories_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListRepositories" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.list_repositories_output_of_yojson
        ~error_deserializer
  end
module ListRepositorySyncDefinitions =
  struct
    ...
    let request context (request : list_repository_sync_definitions_input) =
      let input =
        Json_serializers.list_repository_sync_definitions_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListServiceInstanceOutputs =
  struct
    ...
    let request context (request : list_service_instance_outputs_input) =
      let input =
        Json_serializers.list_service_instance_outputs_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListServiceInstanceOutputs" ~service
        ~context ~input
...
module ListServiceInstanceProvisionedResources =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_service_instance_provisioned_resources_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListServiceInstanceProvisionedResources"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_service_instance_provisioned_resources_output_of_yojson
        ~error_deserializer
  end
module ListServiceInstances =
  struct
    ...
    let request context (request : list_service_instances_input) =
      let input =
        Json_serializers.list_service_instances_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListServiceInstances" ~service
        ~context ~input
...
module ListServicePipelineOutputs =
  struct
    ...
    let request context (request : list_service_pipeline_outputs_input) =
      let input =
        Json_serializers.list_service_pipeline_outputs_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListServicePipelineOutputs" ~service
        ~context ~input
...
module ListServicePipelineProvisionedResources =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_service_pipeline_provisioned_resources_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListServicePipelineProvisionedResources"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_service_pipeline_provisioned_resources_output_of_yojson
        ~error_deserializer
  end
module ListServiceTemplateVersions =
  struct
    ...
    let request context (request : list_service_template_versions_input) =
      let input =
        Json_serializers.list_service_template_versions_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListServiceTemplateVersions" ~service
        ~context ~input
...
module ListServiceTemplates =
  struct
    ...
    let request context (request : list_service_templates_input) =
      let input =
        Json_serializers.list_service_templates_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListServiceTemplates" ~service
        ~context ~input
...
module ListServices =
  struct
    ...
    let request context (request : list_services_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListServices" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_services_output_of_yojson
        ~error_deserializer
  end
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.ListTagsForResource" ~service ~context
        ~input
...
module NotifyResourceDeploymentStatusChange =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.notify_resource_deployment_status_change_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.NotifyResourceDeploymentStatusChange"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.notify_resource_deployment_status_change_output_of_yojson
        ~error_deserializer
  end
module RejectEnvironmentAccountConnection =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.reject_environment_account_connection_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.TagResource" ~service ~context ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UntagResource" ~service ~context
        ~input
...
module UpdateAccountSettings =
  struct
    ...
    let request context (request : update_account_settings_input) =
      let input =
        Json_serializers.update_account_settings_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateAccountSettings" ~service
        ~context ~input
...
module UpdateComponent =
  struct
    ...
    let request context (request : update_component_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateComponent" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.update_component_output_of_yojson
        ~error_deserializer
  end
module UpdateEnvironment =
  struct
    ...
    let request context (request : update_environment_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateEnvironment" ~service ~context
        ~input
...
module UpdateEnvironmentAccountConnection =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.update_environment_account_connection_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateEnvironmentTemplate =
  struct
    ...
    let request context (request : update_environment_template_input) =
      let input =
        Json_serializers.update_environment_template_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateEnvironmentTemplate" ~service
        ~context ~input
...
module UpdateEnvironmentTemplateVersion =
  struct
    ...
    let request context (request : update_environment_template_version_input)
      =
      let input =
        Json_serializers.update_environment_template_version_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateService =
  struct
    ...
    let request context (request : update_service_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateService" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.update_service_output_of_yojson
        ~error_deserializer
  end
module UpdateServiceInstance =
  struct
    ...
    let request context (request : update_service_instance_input) =
      let input =
        Json_serializers.update_service_instance_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateServiceInstance" ~service
        ~context ~input
...
module UpdateServicePipeline =
  struct
    ...
    let request context (request : update_service_pipeline_input) =
      let input =
        Json_serializers.update_service_pipeline_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateServicePipeline" ~service
        ~context ~input
...
module UpdateServiceSyncBlocker =
  struct
    ...
    let request context (request : update_service_sync_blocker_input) =
      let input =
        Json_serializers.update_service_sync_blocker_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateServiceSyncBlocker" ~service
        ~context ~input
...
module UpdateServiceSyncConfig =
  struct
    ...
    let request context (request : update_service_sync_config_input) =
      let input =
        Json_serializers.update_service_sync_config_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateServiceSyncConfig" ~service
        ~context ~input
...
module UpdateServiceTemplate =
  struct
    ...
    let request context (request : update_service_template_input) =
      let input =
        Json_serializers.update_service_template_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateServiceTemplate" ~service
        ~context ~input
...
module UpdateServiceTemplateVersion =
  struct
    ...
    let request context (request : update_service_template_version_input) =
      let input =
        Json_serializers.update_service_template_version_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateServiceTemplateVersion" ~service
        ~context ~input
...
module UpdateTemplateSyncConfig =
  struct
    ...
    let request context (request : update_template_sync_config_input) =
      let input =
        Json_serializers.update_template_sync_config_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AwsProton20200720.UpdateTemplateSyncConfig" ~service
        ~context ~input
