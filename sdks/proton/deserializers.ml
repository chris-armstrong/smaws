...
let template_type_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "TemplateType" value)
  ...
  let _res : service_template_version =
    {
      ...
      arn =
        (value_for_key service_template_version_arn_of_yojson "arn" _list
           path);
      description =
      ...
      status_message =
        (option_of_yojson
           (value_for_key status_message_of_yojson "statusMessage") _list
           path);
      status =
  ...
  let _res : update_service_template_version_input =
    {
      ...
      compatible_environment_templates =
        (option_of_yojson
           (value_for_key
              compatible_environment_template_input_list_of_yojson
              "compatibleEnvironmentTemplates") _list path);
      status =
        (option_of_yojson
...
let provisioning_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "Provisioning" value)
  ...
  let _res : service_template =
    {
      pipeline_provisioning =
        (option_of_yojson
           (value_for_key provisioning_of_yojson "pipelineProvisioning")
           _list path);
      encryption_key =
      ...
      display_name =
        (option_of_yojson
           (value_for_key display_name_of_yojson "displayName") _list path);
      last_modified_at =
        (value_for_key base_timestamp_of_yojson "lastModifiedAt" _list path);
      created_at =
        (value_for_key base_timestamp_of_yojson "createdAt" _list path);
  ...
  let _res : update_service_sync_blocker_output =
    {
      ...
      service_instance_name =
        (option_of_yojson
           (value_for_key resource_name_of_yojson "serviceInstanceName")
           _list path);
      service_name =
        (value_for_key resource_name_of_yojson "serviceName" _list path)
    } in
  ...
  let _res : service_pipeline =
    {
      ...
      last_attempted_deployment_id =
        (option_of_yojson
           ...
           _list path);
      spec =
        (option_of_yojson (value_for_key spec_contents_of_yojson "spec")
           _list path);
  ...
  let _res : update_service_pipeline_input =
    {
      ...
      deployment_type =
        (value_for_key deployment_update_type_of_yojson "deploymentType"
           _list path);
...
let update_service_output_of_yojson tree path =
  ...
  let _res : update_service_output =
    { service = (value_for_key service_of_yojson "service" _list path) } in
  _res
...
let update_service_instance_output_of_yojson tree path =
  ...
  let _res : update_service_instance_output =
    {
      service_instance =
        (value_for_key service_instance_of_yojson "serviceInstance" _list
           path)
    } in
  _res
  ...
  let _res : environment =
    {
      ...
      proton_service_role_arn =
        (option_of_yojson
           (value_for_key arn_of_yojson "protonServiceRoleArn") _list path);
      deployment_status_message =
        (option_of_yojson
           (value_for_key status_message_of_yojson "deploymentStatusMessage")
           _list path);
  ...
  let _res : component =
    {
      ...
      last_deployment_succeeded_at =
        (option_of_yojson
           (value_for_key base_timestamp_of_yojson
  ...
  let _res : revision =
    {
      branch = (value_for_key git_branch_name_of_yojson "branch" _list path);
      directory =
        (value_for_key base_string_of_yojson "directory" _list path);
  ...
  let _res : resource_counts_summary =
    {
      behind_minor =
        (option_of_yojson
           (value_for_key base_integer_of_yojson "behindMinor") _list path);
      behind_major =
        (option_of_yojson
           (value_for_key base_integer_of_yojson "behindMajor") _list path);
      up_to_date =
  ...
  let _res : notify_resource_deployment_status_change_input =
    {
      ...
      status =
        (option_of_yojson
           (value_for_key resource_deployment_status_of_yojson "status")
           _list path);
      resource_arn = (value_for_key arn_of_yojson "resourceArn" _list path)
    } in
  _res
...
let list_service_instances_sort_by_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ ->
       raise (deserialize_wrong_type_error path "ListServiceInstancesSortBy") : 
...
let list_environments_output_of_yojson tree path =
  ...
  let _res : list_environments_output =
    {
      environments =
        (value_for_key environment_summary_list_of_yojson "environments"
           _list path);
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "nextToken")
           _list path)
...
let list_environment_templates_output_of_yojson tree path =
  ...
  let _res : list_environment_templates_output =
    {
      templates =
        (value_for_key environment_template_summary_list_of_yojson
           "templates" _list path);
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "nextToken")
           _list path)
    } in
  ...
  let _res : list_environment_account_connections_input =
    {
      ...
      statuses =
        (option_of_yojson
           (value_for_key
              environment_account_connection_status_list_of_yojson "statuses")
           _list path);
      environment_name =
        (option_of_yojson
...
let get_template_sync_status_input_of_yojson tree path =
  ...
  let _res : get_template_sync_status_input =
    {
      template_version =
        (value_for_key template_version_part_of_yojson "templateVersion"
           _list path);
      template_type =
        (value_for_key template_type_of_yojson "templateType" _list path);
      template_name =
...
let get_service_template_input_of_yojson tree path =
  ...
  let _res : get_service_template_input =
    { name = (value_for_key resource_name_of_yojson "name" _list path) } in
  _res
  ...
  let _res : counts_summary =
    {
      pipelines =
        (option_of_yojson
           (value_for_key resource_counts_summary_of_yojson "pipelines")
           _list path);
      service_templates =
        (option_of_yojson
           (value_for_key resource_counts_summary_of_yojson
              "serviceTemplates") _list path);
      services =
        (option_of_yojson
  ...
  let _res : deployment =
    {
      target_state =
        (option_of_yojson
           (value_for_key deployment_state_of_yojson "targetState") _list
           path);
      initial_state =
        (option_of_yojson
  ...
  let _res : delete_environment_template_output =
    {
      environment_template =
        (option_of_yojson
           (value_for_key environment_template_of_yojson
              "environmentTemplate") _list path)
    } in
  _res
...
let delete_deployment_input_of_yojson tree path =
  ...
  let _res : delete_deployment_input =
    { id = (value_for_key deployment_id_of_yojson "id" _list path) } in
  _res
