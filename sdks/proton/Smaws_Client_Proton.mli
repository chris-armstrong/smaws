...
type nonrec validation_exception = {
  message: error_message [@ocaml.doc ""]}[@@ocaml.doc
...
type nonrec compatible_environment_template_list =
  compatible_environment_template list[@@ocaml.doc ""]
...
type nonrec service_template_supported_component_source_input_list =
  service_template_supported_component_source_type list[@@ocaml.doc ""]
type nonrec service_template_version =
  {
  supported_component_sources:
    service_template_supported_component_source_input_list option
    [@ocaml.doc
...
type nonrec compatible_environment_template_input =
  ...
  template_name: resource_name
    [@ocaml.doc "The compatible environment template name.\n"]}[@@ocaml.doc
                                                                 "Compatible environment template data.\n"]
type nonrec compatible_environment_template_input_list =
  compatible_environment_template_input list[@@ocaml.doc ""]
type nonrec update_service_template_version_input =
  ...
  compatible_environment_templates:
    compatible_environment_template_input_list option
    [@ocaml.doc
...
type nonrec service_template_version_summary_list =
  service_template_version_summary list[@@ocaml.doc ""]
type nonrec service_template_version_resource =
...
[@@ocaml.doc ""]
type nonrec service_pipeline_provisioned_resource_resource =
  Smaws_Lib.CoreTypes.Resource.t[@@ocaml.doc ""]
...
type nonrec service_instance_state =
  ...
  last_successful_component_deployment_ids:
    component_deployment_id_list option
    [@ocaml.doc
...
[@@ocaml.doc ""]
type nonrec service_instance_provisioned_resource_resource =
  Smaws_Lib.CoreTypes.Resource.t[@@ocaml.doc ""]
...
type nonrec provisioned_resource =
  ...
  name: provisioned_resource_name option
...
type nonrec list_service_instances_filter_list =
  list_service_instances_filter list[@@ocaml.doc ""]
...
type nonrec list_repositories_output =
  {
  repositories: repository_summary_list
...
type nonrec environment_template_filter_list =
  environment_template_filter list[@@ocaml.doc ""]
...
type nonrec environment_template_summary =
  ...
  name: resource_name [@ocaml.doc "The name of the environment template.\n"]}
[@@ocaml.doc "The environment template data.\n"]
type nonrec environment_template_summary_list =
  environment_template_summary list[@@ocaml.doc ""]
...
type nonrec environment_template_version_summary_list =
  environment_template_version_summary list[@@ocaml.doc ""]
...
type nonrec environment_account_connection_status_list =
  environment_account_connection_status list[@@ocaml.doc ""]
...
type nonrec list_deployments_output =
  {
  deployments: deployment_summary_list
...
type nonrec list_components_output =
  {
  components: component_summary_list
...
type nonrec environment_template_version_resource =
  Smaws_Lib.CoreTypes.Resource.t[@@ocaml.doc ""]
...
type nonrec environment_resource = Smaws_Lib.CoreTypes.Resource.t[@@ocaml.doc
                                                                   ""]
type nonrec environment_provisioned_resource_resource =
  Smaws_Lib.CoreTypes.Resource.t[@@ocaml.doc ""]
type nonrec environment_output_resource = Smaws_Lib.CoreTypes.Resource.t
[@@ocaml.doc ""]
type nonrec environment_account_connection_resource =
  Smaws_Lib.CoreTypes.Resource.t[@@ocaml.doc ""]
...
type nonrec component_resource = Smaws_Lib.CoreTypes.Resource.t[@@ocaml.doc
                                                                 ""]
type nonrec component_provisioned_resource_resource =
  Smaws_Lib.CoreTypes.Resource.t[@@ocaml.doc ""]
...
val make_accept_environment_account_connection_input :
  id:environment_account_connection_id ->
    unit -> accept_environment_account_connection_input(** {1:operations Operations} *)
