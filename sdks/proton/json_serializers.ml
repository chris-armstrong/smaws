...
let sync_blocker_context_to_yojson (x : sync_blocker_context) =
  assoc_to_yojson
    [("value",
       (Some
          (Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.value)));
    ("key",
      (Some (Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.key)))]
...
let sync_blocker_to_yojson (x : sync_blocker) =
  assoc_to_yojson
    ...
    ("id",
      (Some (Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.id)))]
...
let revision_to_yojson (x : revision) =
  assoc_to_yojson
    ...
    ("directory",
      (Some
         (Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.directory)));
...
let resource_sync_event_to_yojson (x : resource_sync_event) =
  assoc_to_yojson
    [("event",
       (Some
          (Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.event)));
    ("time",
      (Some
         (Smaws_Lib.Smithy_api.Json_serializers.timestamp_to_yojson x.time)));
    ("externalId",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
         x.external_id));
    ("type",
      (Some (Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.type_)))]
...
let resource_sync_attempt_to_yojson (x : resource_sync_attempt) =
  assoc_to_yojson
    ...
    ("target",
      (Some
         (Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.target)));
...
let resource_counts_summary_to_yojson (x : resource_counts_summary) =
  assoc_to_yojson
    ...
    ("upToDate",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.integer_to_yojson x.up_to_date));
    ("failed",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.integer_to_yojson x.failed));
    ("total",
      (Some (Smaws_Lib.Smithy_api.Json_serializers.integer_to_yojson x.total)))]
...
let repository_sync_definition_to_yojson (x : repository_sync_definition) =
  assoc_to_yojson
    ...
    ("parent",
      (Some
         (Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.parent)));
    ("target",
      (Some
         (Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.target)))]
...
let list_tags_for_resource_input_to_yojson (x : list_tags_for_resource_input)
  ...
  assoc_to_yojson
    ...
    ("nextToken",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.next_token));
    ("resourceArn", (Some (arn_to_yojson x.resource_arn)))]
