...
let service_template_version_of_yojson tree path =
  ...
  ({
     ...
     last_modified_at =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.timestamp_epoch_seconds_of_yojson
...
let sync_blocker_context_of_yojson tree path =
  ...
  ({
     value =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "value"
          _list path);
     key =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "key"
          _list path)
...
let sync_blocker_of_yojson tree path =
  ...
  ({
     ...
     id =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "id"
          _list path)
   } : sync_blocker)
  ...
  ({
     ...
     last_client_request_token =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "lastClientRequestToken") _list path);
     spec =
       (option_of_yojson (value_for_key spec_contents_of_yojson "spec") _list
          path);
     deployment_status_message =
...
let resource_sync_event_of_yojson tree path =
  ...
  ({
     event =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "event"
          _list path);
     time =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.timestamp_epoch_seconds_of_yojson
     ...
     external_id =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "externalId") _list path);
     type_ =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "type"
          _list path)
   } : resource_sync_event)
...
let resource_sync_attempt_of_yojson tree path =
  ...
  ({
     ...
     target =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "target"
          _list path);
     target_revision =
...
let resource_counts_summary_of_yojson tree path =
  ...
  ({
     behind_minor =
       (option_of_yojson
          (value_for_key
             ...
             "behindMinor") _list path);
     behind_major =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.integer_of_yojson
             "behindMajor") _list path);
     up_to_date =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.integer_of_yojson
     ...
     total =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.integer_of_yojson "total"
          _list path)
...
let repository_sync_definition_of_yojson tree path =
  ...
  ({
     ...
     parent =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "parent"
          _list path);
     target =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "target"
