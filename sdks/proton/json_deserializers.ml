...
let sync_blocker_of_yojson tree path =
  ...
  ({
     ...
     resolved_reason =
       option_of_yojson
         (value_for_key Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "resolvedReason")
         _list path;
     contexts =
  ...
  ({
     ...
     service_instance_name =
       option_of_yojson
         ...
         _list path;
     service_name =
       value_for_key Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "serviceName" _list
         path;
   }
...
let revision_of_yojson tree path =
  ...
  ({
     branch = value_for_key git_branch_name_of_yojson "branch" _list path;
     directory =
       value_for_key Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "directory" _list
         path;
...
let resource_counts_summary_of_yojson tree path =
  ...
  ({
     behind_minor =
       option_of_yojson
         (value_for_key Smaws_Lib.Smithy_api.Json_deserializers.integer_of_yojson "behindMinor")
         _list path;
     behind_major =
       option_of_yojson
         (value_for_key Smaws_Lib.Smithy_api.Json_deserializers.integer_of_yojson "behindMajor")
         _list path;
     up_to_date =
       option_of_yojson
         (value_for_key Smaws_Lib.Smithy_api.Json_deserializers.integer_of_yojson "upToDate")
         _list path;
     failed =
       option_of_yojson
         (value_for_key Smaws_Lib.Smithy_api.Json_deserializers.integer_of_yojson "failed")
         _list path;
     total =
       value_for_key Smaws_Lib.Smithy_api.Json_deserializers.integer_of_yojson "total" _list path;
   }
...
let repository_sync_definition_of_yojson tree path =
  ...
  ({
     ...
     branch = value_for_key git_branch_name_of_yojson "branch" _list path;
     parent =
       value_for_key Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "parent" _list path;
     target =
       value_for_key Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "target" _list path;
   }
