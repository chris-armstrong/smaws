...
type nonrec state = Active [@ocaml.doc ""] | Suppressed [@ocaml.doc ""] | Baseline [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec query_language = CWLI [@ocaml.doc ""] | SQL [@ocaml.doc ""] | PPL [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  delivery_destination_configuration : delivery_destination_configuration option;
      [@ocaml.doc
        "A structure that contains the ARN of the Amazon Web Services resource that will receive \
         the logs.\n"]
  tags : tags option; [@ocaml.doc "The tags that have been assigned to this delivery destination.\n"]
}
[@@ocaml.doc
...
type nonrec delivery_source_status = ACTIVE [@ocaml.doc ""] | INACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec index_type = FACET [@ocaml.doc ""] | FIELD_INDEX [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec index_source = ACCOUNT [@ocaml.doc ""] | LOG_GROUP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec order_by = LogStreamName [@ocaml.doc ""] | LastEventTime [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec policy_scope = ACCOUNT [@ocaml.doc ""] | RESOURCE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec distribution = Random [@ocaml.doc ""] | ByLogStream [@ocaml.doc ""]
[@@ocaml.doc
...
type nonrec flattened_element = FIRST [@ocaml.doc ""] | LAST [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec schedule_type = CUSTOMER_MANAGED [@ocaml.doc ""] | AWS_MANAGED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ocsf_version = V1_1 [@ocaml.doc ""] | V1_5 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec suppression_state = SUPPRESSED [@ocaml.doc ""] | UNSUPPRESSED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec suppression_type = LIMITED [@ocaml.doc ""] | INFINITE [@ocaml.doc ""] [@@ocaml.doc ""]
