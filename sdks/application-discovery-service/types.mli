type nonrec order_string = DESC [@ocaml.doc ""] | ASC [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec term_length = THREE_YEAR [@ocaml.doc ""] | ONE_YEAR [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec export_info = {
  ...
  export_id : configurations_export_id; [@ocaml.doc "A unique identifier used to query an export.\n"]
}
[@@ocaml.doc
...
type nonrec describe_continuous_exports_request = {
  ...
  max_results : describe_continuous_exports_max_results option;
      [@ocaml.doc
        "A number between 1 and 100 specifying the maximum number of continuous export \
         descriptions returned.\n"]
  export_ids : continuous_export_ids option; [@ocaml.doc "The unique IDs assigned to the exports.\n"]
}
[@@ocaml.doc ""]
