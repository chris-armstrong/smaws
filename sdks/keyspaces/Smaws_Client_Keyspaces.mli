...
type nonrec restore_table_request =
  ...
  restore_timestamp: timestamp option
...
type nonrec replication_group_status_list = replication_group_status list
[@@ocaml.doc ""]
...
type nonrec replica_specification_summary_list =
  replica_specification_summary list[@@ocaml.doc ""]
...
type nonrec replica_auto_scaling_specification_list =
  replica_auto_scaling_specification list[@@ocaml.doc ""]
...
type nonrec get_type_response =
  ...
  direct_parent_types: type_name_list option
...
val make_update_table_response :
  resource_arn:ar_n -> unit -> update_table_response
...
val make_encryption_specification :
  ?kms_key_identifier:kms_key_ar_n ->
...
val make_replica_specification :
  ?read_capacity_auto_scaling:auto_scaling_settings ->
    ?read_capacity_units:capacity_units ->
      region:region -> unit -> replica_specification
...
val make_update_keyspace_response :
  resource_arn:ar_n -> unit -> update_keyspace_response
...
val make_update_keyspace_request :
  ?client_side_timestamps:client_side_timestamps ->
    replication_specification:replication_specification ->
      keyspace_name:keyspace_name -> unit -> update_keyspace_request
val make_untag_resource_response : unit -> unit
val make_untag_resource_request :
  tags:tag_list -> resource_arn:ar_n -> unit -> untag_resource_request
val make_tag_resource_response : unit -> unit
val make_tag_resource_request :
  tags:tag_list -> resource_arn:ar_n -> unit -> tag_resource_request
val make_table_summary :
  resource_arn:ar_n ->
    table_name:table_name ->
      keyspace_name:keyspace_name -> unit -> table_summary
...
val make_clustering_key :
  order_by:sort_order -> name:generic_string -> unit -> clustering_key
val make_schema_definition :
  ?static_columns:static_column_list ->
    ?clustering_keys:clustering_key_list ->
      partition_keys:partition_key_list ->
        all_columns:column_definition_list -> unit -> schema_definition
val make_restore_table_response :
  restored_table_ar_n:ar_n -> unit -> restore_table_response
...
val make_replication_group_status :
  ?tables_replication_progress:tables_replication_progress ->
    keyspace_status:keyspace_status ->
      region:region -> unit -> replication_group_status
...
val make_replica_specification_summary :
  ?capacity_specification:capacity_specification_summary ->
    ?status:table_status ->
      ?region:region -> unit -> replica_specification_summary
val make_replica_auto_scaling_specification :
  ?auto_scaling_specification:auto_scaling_specification ->
    ?region:region -> unit -> replica_auto_scaling_specification
...
val make_list_types_response :
  ?next_token:next_token ->
    types:type_name_list -> unit -> list_types_response
val make_list_types_request :
  ?max_results:max_results ->
    ?next_token:next_token ->
      keyspace_name:keyspace_name -> unit -> list_types_request
val make_list_tags_for_resource_response :
  ?tags:tag_list ->
    ?next_token:next_token -> unit -> list_tags_for_resource_response
val make_list_tags_for_resource_request :
  ?max_results:max_results ->
    ?next_token:next_token ->
      resource_arn:ar_n -> unit -> list_tags_for_resource_request
val make_list_tables_response :
  ?tables:table_summary_list ->
    ?next_token:next_token -> unit -> list_tables_response
val make_list_tables_request :
  ?max_results:max_results ->
    ?next_token:next_token ->
      keyspace_name:keyspace_name -> unit -> list_tables_request
val make_keyspace_summary :
  ?replication_regions:region_list ->
    replication_strategy:rs ->
      resource_arn:ar_n ->
        keyspace_name:keyspace_name -> unit -> keyspace_summary
val make_list_keyspaces_response :
  ?next_token:next_token ->
    keyspaces:keyspace_summary_list -> unit -> list_keyspaces_response
val make_list_keyspaces_request :
  ?max_results:max_results ->
    ?next_token:next_token -> unit -> list_keyspaces_request
val make_field_definition :
  type_:generic_string -> name:generic_string -> unit -> field_definition
        ...
        ?status:type_status ->
          ?last_modified_timestamp:timestamp ->
            ?field_definitions:field_list ->
              keyspace_arn:ar_n ->
                type_name:type_name ->
                  keyspace_name:keyspace_name -> unit -> get_type_response
val make_get_type_request :
  type_name:type_name ->
    keyspace_name:keyspace_name -> unit -> get_type_request
...
val make_create_keyspace_response :
  resource_arn:ar_n -> unit -> create_keyspace_response
val make_create_keyspace_request :
  ?replication_specification:replication_specification ->
    ?tags:tag_list ->
      keyspace_name:keyspace_name -> unit -> create_keyspace_request(** {1:operations Operations} *)
