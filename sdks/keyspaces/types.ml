type nonrec rs = SINGLE_REGION [@ocaml.doc ""] | MULTI_REGION [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec update_table_response = {
  resource_arn : ar_n; [@ocaml.doc "The Amazon Resource Name (ARN) of the modified table.\n"]
}
[@@ocaml.doc ""]
...
type nonrec column_definition = {
  ...
  name : generic_string; [@ocaml.doc "The name of the column.\n"]
}
[@@ocaml.doc "The names and data types of regular columns.\n"]

type nonrec column_definition_list = column_definition list [@@ocaml.doc ""]
  ...
  write_capacity_units : capacity_units option;
      [@ocaml.doc
        "The throughput capacity specified for [write] operations defined in [write capacity \
         units] [(WCUs)].\n"]
  read_capacity_units : capacity_units option;
      [@ocaml.doc
...
type nonrec encryption_specification = {
  kms_key_identifier : kms_key_ar_n option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the customer managed KMS key, for example \
         [kms_key_identifier:ARN].\n"]
  type_ : encryption_type;
      [@ocaml.doc
        "The encryption option specified for the table. You can choose one of the following KMS \
         keys (KMS keys):\n\n\
        \ {ul\n\
        ...
        \       {-   [type:CUSTOMER_MANAGED_KMS_KEY] - This key is stored in your account and is \
         created, owned, and managed by you. This option requires the [kms_key_identifier] of the \
...
[@@ocaml.doc
  "Amazon Keyspaces encrypts and decrypts the table data at rest transparently and integrates with \
   Key Management Service for storing and managing the encryption key. You can choose one of the \
  ...
  \   For more information about encryption at rest in Amazon Keyspaces, see \
   {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/EncryptionAtRest.html}Encryption at \
   rest} in the {i Amazon Keyspaces Developer Guide}.\n\
  \   \n\
  \    For more information about KMS, see \
   {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/EncryptionAtRest.html}KMS management \
   service concepts} in the {i Key Management Service Developer Guide}.\n\
  \    "]
...
[@@ocaml.doc
  "Point-in-time recovery (PITR) helps protect your Amazon Keyspaces tables from accidental write \
   or delete operations by providing you continuous backups of your table data.\n\n\
  \ For more information, see \
...
type nonrec time_to_live_status = ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
[@@ocaml.doc
  "Enable custom Time to Live (TTL) settings for rows and columns without setting a TTL default \
...
type nonrec default_time_to_live = int [@@ocaml.doc ""]

type nonrec client_side_timestamps_status = ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec client_side_timestamps = {
  status : client_side_timestamps_status;
      [@ocaml.doc "Shows how to enable client-side timestamps settings for the specified table.\n"]
}
[@@ocaml.doc
  "The client-side timestamp setting of the table.\n\n\
  \ For more information, see \
   {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/client-side-timestamps-how-it-works.html}How \
   it works: Amazon Keyspaces client-side timestamps} in the {i Amazon Keyspaces Developer Guide}.\n\
  \ "]
...
type nonrec target_tracking_scaling_policy_configuration = {
  target_value : double_object;
      [@ocaml.doc
        ...
        \ Amazon Keyspaces auto scaling scales up capacity automatically when traffic exceeds this \
         ...
         You define [targetValue] as a percentage. A [double] between 20 and 90.\n\
        \ "]
  ...
  disable_scale_in : boolean_object option;
      [@ocaml.doc
        ...
        \ When auto scaling automatically decreases capacity for a table, the table {i scales in}. \
  ...
  target_tracking_scaling_policy_configuration : target_tracking_scaling_policy_configuration option;
      [@ocaml.doc
        "Auto scaling scales up capacity automatically when traffic exceeds this target \
         utilization rate, and then back down when it falls below the target. A [double] between \
         20 and 90.\n"]
}
[@@ocaml.doc
  "Amazon Keyspaces supports the [target tracking] auto scaling policy. With this policy, Amazon \
   Keyspaces auto scaling ensures that the table's ratio of consumed to provisioned capacity stays \
   at or near the target value that you specify. You define the target value as a percentage \
   between 20 and 90.\n"]

type nonrec auto_scaling_settings = {
  scaling_policy : auto_scaling_policy option;
      [@ocaml.doc
        "Amazon Keyspaces supports the [target tracking] auto scaling policy. With this policy, \
         Amazon Keyspaces auto scaling ensures that the table's ratio of consumed to provisioned \
         capacity stays at or near the target value that you specify. You define the target value \
         as a percentage between 20 and 90.\n"]
  maximum_units : capacity_units option;
      [@ocaml.doc
        "Manage costs by specifying the maximum amount of throughput to provision. The value must \
         be between 1 and the max throughput per second quota for your account (40,000 by default).\n"]
  minimum_units : capacity_units option;
      [@ocaml.doc
        "The minimum level of throughput the table should always be ready to support. The value \
         must be between 1 and the max throughput per second quota for your account (40,000 by \
         default).\n"]
  auto_scaling_disabled : boolean_object option;
      [@ocaml.doc "This optional parameter enables auto scaling for the table if set to [false].\n"]
}
[@@ocaml.doc
  ...
  \  \n\
  \   {ul\n\
  \         {-   [minimumUnits]: The minimum level of throughput the table should always be ready \
   to support. The value must be between 1 and the max throughput per second quota for your \
   account (40,000 by default).\n\
  \             \n\
  \              }\n\
  \         {-   [maximumUnits]: The maximum level of throughput the table should always be ready \
   to support. The value must be between 1 and the max throughput per second quota for your \
   account (40,000 by default).\n\
  \             \n\
  \              }\n\
  ...
  \                        \n\
  \                         {ul\n\
  \                               {-   [targetValue]: The target utilization rate of the table. \
   Amazon Keyspaces auto scaling ensures that the ratio of consumed capacity to provisioned \
   capacity stays at or near this value. You define [targetValue] as a percentage. A [double] \
   between 20 and 90. (Required)\n\
  \                                   \n\
  \                                    }\n\
  \                               {-   [disableScaleIn]: A [boolean] that specifies if [scale-in] \
   is disabled or enabled for the table. This parameter is disabled by default. To turn on \
   [scale-in], set the [boolean] value to [FALSE]. This means that capacity for a table can be \
   automatically scaled down on your behalf. (Optional) \n\
  \                                   \n\
  \                                    }\n\
  \                               {-   [scaleInCooldown]: A cooldown period in seconds between \
   scaling activities that lets the table stabilize before another scale in activity starts. If no \
   value is provided, the default is 0. (Optional) \n\
  \                                   \n\
  \                                    }\n\
  \                               {-   [scaleOutCooldown]: A cooldown period in seconds between \
   scaling activities that lets the table stabilize before another scale out activity starts. If \
...
type nonrec auto_scaling_specification = {
  ...
  write_capacity_auto_scaling : auto_scaling_settings option;
      [@ocaml.doc "The auto scaling settings for the table's write capacity.\n"]
}
[@@ocaml.doc
  ...
  read_capacity_units : capacity_units option;
      [@ocaml.doc
        "The provisioned read capacity units for the multi-Region table in the specified Amazon \
         Web Services Region.\n"]
  region : region; [@ocaml.doc "The Amazon Web Services Region.\n"]
}
[@@ocaml.doc
  "The Amazon Web Services Region specific settings of a multi-Region table.\n\n\
  \ For a multi-Region table, you can configure the table's read capacity differently per Amazon \
   Web Services Region. You can do this by configuring the following parameters.\n\
  \ \n\
  \  {ul\n\
...
type nonrec replica_specification_list = replica_specification list [@@ocaml.doc ""]
...
type nonrec tag = {
  ...
  key : tag_key;
      [@ocaml.doc
        "The key of the tag. Tag keys are case sensitive. Each Amazon Keyspaces resource can only \
         have up to one tag with the same key. If you try to add an existing tag (same key), the \
         existing tag value will be updated to the new value.\n"]
}
[@@ocaml.doc
  "Describes a tag. A tag is a key-value pair. You can add up to 50 tags to a single Amazon \
   Keyspaces resource.\n\n\
...
type nonrec cdc_propagate_tags = TABLE [@ocaml.doc ""] | NONE [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec cdc_specification = {
  propagate_tags : cdc_propagate_tags option;
      [@ocaml.doc "Specifies that the stream inherits the tags from the table.\n"]
  tags : tag_list option;
      [@ocaml.doc "The tags (key-value pairs) that you want to apply to the stream.\n"]
  view_type : view_type option;
      [@ocaml.doc
        "The view type specifies the changes Amazon Keyspaces records for each changed row in the \
         stream. After you create the stream, you can't make changes to this selection. \n\n\
        \ The options are:\n\
        \ \n\
        \  {ul\n\
        ...
        \  "]
  status : cdc_status;
      [@ocaml.doc "The status of the CDC stream. You can enable or disable a stream for a table.\n"]
}
[@@ocaml.doc
  "The settings for the CDC stream of a table. For more information about CDC streams, see \
   {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/cdc.html}Working with change data \
...
type nonrec update_table_request = {
  ...
  auto_scaling_specification : auto_scaling_specification option;
      [@ocaml.doc
        "The optional auto scaling settings to update for a table in provisioned capacity mode. \
         ...
         automatically on your behalf. Amazon Keyspaces auto scaling helps you provision \
         throughput capacity for variable workloads efficiently by increasing and decreasing your \
        ...
        \  For more information, see \
         ...
         throughput capacity automatically with Amazon Keyspaces auto scaling} in the {i Amazon \
         Keyspaces Developer Guide}.\n\
        \  "]
  client_side_timestamps : client_side_timestamps option;
      [@ocaml.doc
        "Enables client-side timestamps for the table. By default, the setting is disabled. You \
         can enable client-side timestamps with the following option:\n\n\
        \ {ul\n\
        \       {-   [status: \"enabled\"] \n\
        \           \n\
        \            }\n\
        ...
        \   "]
  default_time_to_live : default_time_to_live option;
      [@ocaml.doc
        "The default Time to Live setting in seconds for the table.\n\n\
        \ For more information, see \
         {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/TTL-how-it-works.html#ttl-howitworks_default_ttl}Setting \
         the default TTL value for a table} in the {i Amazon Keyspaces Developer Guide}.\n\
        \ "]
  ttl : time_to_live option;
      [@ocaml.doc
        ...
        \   \n\
        \    For more information, see \
         {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/TTL.html}Expiring data by using \
         Amazon Keyspaces Time to Live (TTL)} in the {i Amazon Keyspaces Developer Guide}.\n\
        \    "]
  ...
  encryption_specification : encryption_specification option;
      [@ocaml.doc
        "Modifies the encryption settings of the table. You can choose one of the following KMS \
         key (KMS key):\n\n\
        \ {ul\n\
        \       {-   [type:AWS_OWNED_KMS_KEY] - This key is owned by Amazon Keyspaces. \n\
        \           \n\
  ...
  capacity_specification : capacity_specification option;
      [@ocaml.doc
        ...
        \    For more information, see \
         ...
         capacity modes} in the {i Amazon Keyspaces Developer Guide}.\n\
        \    "]
  add_columns : column_definition_list option;
      [@ocaml.doc
  ...
  keyspace_name : keyspace_name;
      [@ocaml.doc "The name of the keyspace the specified table is stored in.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "The operation exceeded the service quota for this resource. For more information on service \
   quotas, see {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/quotas.html}Quotas} in the \
...
[@@ocaml.doc
  "Amazon Keyspaces couldn't complete the requested action. This error may occur if you try to \
   perform an action and the same or a different action is already in progress, or if you try to \
...
type nonrec replication_specification = {
  region_list : region_list option;
      [@ocaml.doc
...
type nonrec update_keyspace_request = {
  ...
  keyspace_name : keyspace_name; [@ocaml.doc " The name of the keyspace. \n"]
}
[@@ocaml.doc ""]
...
type nonrec untag_resource_request = {
  tags : tag_list;
      [@ocaml.doc "A list of existing tags to be removed from the Amazon Keyspaces resource.\n"]
  resource_arn : ar_n;
      [@ocaml.doc
        "The Amazon Keyspaces resource that the tags will be removed from. This value is an Amazon \
         Resource Name (ARN).\n"]
}
[@@ocaml.doc ""]
...
type nonrec type_name_list = type_name list [@@ocaml.doc ""]
...
type nonrec tag_resource_request = {
  tags : tag_list; [@ocaml.doc "The tags to be assigned to the Amazon Keyspaces resource.\n"]
  resource_arn : ar_n;
      [@ocaml.doc
...
type nonrec tables_replication_progress = string [@@ocaml.doc ""]
...
[@@ocaml.doc
  "Returns the name of the specified table, the keyspace it is stored in, and the unique \
   identifier in the format of an Amazon Resource Name (ARN).\n"]

type nonrec table_summary_list = table_summary list [@@ocaml.doc ""]
...
type nonrec static_column = {
  name : generic_string; [@ocaml.doc "The name of the static column.\n"]
}
[@@ocaml.doc
  "The static columns of the table. Static columns store values that are shared by all rows in the \
   same partition.\n"]

type nonrec static_column_list = static_column list [@@ocaml.doc ""]

type nonrec sort_order = ASC [@ocaml.doc ""] | DESC [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec partition_key = {
  name : generic_string; [@ocaml.doc "The name(s) of the partition key column(s).\n"]
}
[@@ocaml.doc
  "The partition key portion of the primary key is required and determines how Amazon Keyspaces \
   stores the data. The partition key can be a single column, or it can be a compound value \
...
type nonrec clustering_key = {
  order_by : sort_order;
      [@ocaml.doc "Sets the ascendant ([ASC]) or descendant ([DESC]) order modifier.\n"]
  name : generic_string; [@ocaml.doc "The name(s) of the clustering column(s).\n"]
}
[@@ocaml.doc
  "The optional clustering column portion of your primary key determines how the data is clustered \
   and sorted within each partition.\n"]

type nonrec clustering_key_list = clustering_key list [@@ocaml.doc ""]

type nonrec schema_definition = {
  static_columns : static_column_list option;
      [@ocaml.doc
        "The columns that have been defined as [STATIC]. Static columns store values that are \
         shared by all rows in the same partition.\n"]
  clustering_keys : clustering_key_list option;
      [@ocaml.doc "The columns that are part of the clustering key of the table.\n"]
  partition_keys : partition_key_list;
      [@ocaml.doc "The columns that are part of the partition key of the table .\n"]
  all_columns : column_definition_list; [@ocaml.doc "The regular columns of the table.\n"]
}
[@@ocaml.doc "Describes the schema of the table.\n"]

type nonrec restore_table_response = {
  restored_table_ar_n : ar_n; [@ocaml.doc "The Amazon Resource Name (ARN) of the restored table.\n"]
}
[@@ocaml.doc ""]

type nonrec restore_table_request = {
  replica_specifications : replica_specification_list option;
      [@ocaml.doc "The optional Region specific settings of a multi-Regional table.\n"]
  auto_scaling_specification : auto_scaling_specification option;
      [@ocaml.doc
        ...
        \ For more information, see \
         ...
         Keyspaces Developer Guide}.\n\
        \ "]
  tags_override : tag_list option;
      [@ocaml.doc
        "A list of key-value pair tags to be attached to the restored table. \n\n\
        \ For more information, see \
         {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/tagging-keyspaces.html}Adding \
         tags and labels to Amazon Keyspaces resources} in the {i Amazon Keyspaces Developer \
         Guide}.\n\
        \ "]
  ...
  capacity_specification_override : capacity_specification option;
      [@ocaml.doc
        ...
        \    For more information, see \
         ...
         capacity modes} in the {i Amazon Keyspaces Developer Guide}.\n\
        \    "]
  restore_timestamp : timestamp option; [@ocaml.doc "The restore timestamp in ISO 8601 format.\n"]
  target_table_name : table_name; [@ocaml.doc "The name of the target table.\n"]
  target_keyspace_name : keyspace_name; [@ocaml.doc "The name of the target keyspace.\n"]
  source_table_name : table_name; [@ocaml.doc "The name of the source table.\n"]
  source_keyspace_name : keyspace_name; [@ocaml.doc "The keyspace name of the source table.\n"]
}
[@@ocaml.doc ""]
...
type nonrec replication_group_status = {
  tables_replication_progress : tables_replication_progress option;
      [@ocaml.doc
        " This shows the replication progress of tables in the keyspace. The value is expressed as \
         a percentage of the newly replicated tables with status [Active] compared to the total \
         number of tables in the keyspace. \n"]
  keyspace_status : keyspace_status; [@ocaml.doc " The status of the keyspace. \n"]
  region : region; [@ocaml.doc " The name of the Region that was added to the keyspace. \n"]
}
[@@ocaml.doc
  " This shows the summary status of the keyspace after a new Amazon Web Services Region was added. \n"]

type nonrec replication_group_status_list = replication_group_status list [@@ocaml.doc ""]

type nonrec capacity_specification_summary = {
  last_update_to_pay_per_request_timestamp : timestamp option;
      [@ocaml.doc
        "The timestamp of the last operation that changed the provisioned throughput capacity of a \
         table.\n"]
  write_capacity_units : capacity_units option;
      [@ocaml.doc
        "The throughput capacity specified for [write] operations defined in [write capacity \
...
type nonrec replica_specification_summary = {
  ...
  region : region option; [@ocaml.doc "The Amazon Web Services Region.\n"]
}
[@@ocaml.doc
  "The Region-specific settings of a multi-Region table in the specified Amazon Web Services \
   Region.\n\n\
  \ If the multi-Region table is using provisioned capacity and has optional auto scaling policies \
   configured, note that the Region specific summary returns both read and write capacity \
   settings. But only Region specific read capacity settings can be configured for a multi-Region \
   table. In a multi-Region table, your write capacity units will be synced across all Amazon Web \
   Services Regions to ensure that there is enough capacity to replicate write events across \
   Regions.\n\
  \ "]

type nonrec replica_specification_summary_list = replica_specification_summary list [@@ocaml.doc ""]
...
type nonrec replica_auto_scaling_specification_list = replica_auto_scaling_specification list
[@@ocaml.doc ""]

type nonrec point_in_time_recovery_summary = {
  earliest_restorable_timestamp : timestamp option;
      [@ocaml.doc
...
type nonrec list_types_response = {
  types : type_name_list; [@ocaml.doc " The list of types contained in the specified keyspace. \n"]
  next_token : next_token option;
      [@ocaml.doc
        " The pagination token. To resume pagination, provide the [NextToken] value as an argument \
...
type nonrec list_types_request = {
  keyspace_name : keyspace_name;
      [@ocaml.doc " The name of the keyspace that contains the listed types. \n"]
  max_results : max_results option;
      [@ocaml.doc
        " The total number of types to return in the output. If the total number of types \
  ...
  max_results : max_results option;
      [@ocaml.doc
        "The total number of tags to return in the output. If the total number of tags available \
         ...
         pagination, provide the [NextToken] value as an argument of a subsequent API invocation.\n"]
  next_token : next_token option;
      [@ocaml.doc
        "The pagination token. To resume pagination, provide the [NextToken] value as argument of \
         a subsequent API invocation.\n"]
  resource_arn : ar_n;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the Amazon Keyspaces resource.\n"]
}
[@@ocaml.doc ""]

type nonrec list_tables_response = {
  tables : table_summary_list option; [@ocaml.doc "A list of tables.\n"]
  next_token : next_token option;
      [@ocaml.doc
        "A token to specify where to start paginating. This is the [NextToken] from a previously \
         truncated response.\n"]
...
type nonrec keyspace_summary = {
  replication_regions : region_list option;
      [@ocaml.doc
...
[@@ocaml.doc "Represents the properties of a keyspace.\n"]

type nonrec keyspace_summary_list = keyspace_summary list [@@ocaml.doc ""]

type nonrec list_keyspaces_response = {
  keyspaces : keyspace_summary_list; [@ocaml.doc "A list of keyspaces.\n"]
  next_token : next_token option;
      [@ocaml.doc
        "A token to specify where to start paginating. This is the [NextToken] from a previously \
         truncated response.\n"]
...
type nonrec field_definition = {
  type_ : generic_string;
      [@ocaml.doc
        " Any supported Cassandra data type, including collections and other user-defined types \
         that are contained in the same keyspace. \n\n\
        \ For more information, see \
         {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/cassandra-apis.html#cassandra-data-type}Cassandra \
         data type support} in the {i Amazon Keyspaces Developer Guide}.\n\
        \ "]
  name : generic_string; [@ocaml.doc " The identifier. \n"]
}
[@@ocaml.doc " A field definition consists out of a name and a type. \n"]

type nonrec field_list = field_definition list [@@ocaml.doc ""]

type nonrec depth = int [@@ocaml.doc ""]

type nonrec get_type_response = {
  keyspace_arn : ar_n;
      [@ocaml.doc
        " The unique identifier of the keyspace that contains this type in the format of an Amazon \
         Resource Name (ARN). \n"]
  max_nesting_depth : depth option;
      [@ocaml.doc " The level of nesting implemented for this type. \n"]
  direct_parent_types : type_name_list option; [@ocaml.doc " The types that use this type. \n"]
  direct_referring_tables : table_name_list option;
  ...
  last_modified_timestamp : timestamp option;
      [@ocaml.doc " The timestamp that shows when this type was last modified. \n"]
  field_definitions : field_list option;
      [@ocaml.doc " The names and types that define this type. \n"]
  type_name : type_name; [@ocaml.doc " The name of the type. \n"]
  keyspace_name : keyspace_name; [@ocaml.doc " The name of the keyspace that contains this type. \n"]
}
[@@ocaml.doc ""]
  ...
  type_name : type_name;
      [@ocaml.doc
        "The formatted name of the type. For example, if the name of the type was created without \
         double quotes, Amazon Keyspaces saved the name in lower-case characters. If the name was \
...
type nonrec get_table_auto_scaling_settings_response = {
  replica_specifications : replica_auto_scaling_specification_list option;
      [@ocaml.doc
        "The Amazon Web Services Region specific settings of a multi-Region table. Returns the \
         settings for all Regions the table is replicated in.\n"]
  auto_scaling_specification : auto_scaling_specification option;
      [@ocaml.doc "The auto scaling settings of the table.\n"]
  resource_arn : ar_n; [@ocaml.doc "The Amazon Resource Name (ARN) of the table.\n"]
  table_name : table_name; [@ocaml.doc "The name of the table.\n"]
  keyspace_name : keyspace_name; [@ocaml.doc "The name of the keyspace.\n"]
}
[@@ocaml.doc ""]
...
type nonrec cdc_specification_summary = {
  view_type : view_type option;
      [@ocaml.doc
        "The view type specifies the changes Amazon Keyspaces records for each changed row in the \
         stream. This setting can't be changed, after the stream has been created. \n\n\
        \ The options are:\n\
        \ \n\
        \  {ul\n\
        \        {-   [NEW_AND_OLD_IMAGES] - both versions of the row, before and after the \
        ...
        \  "]
  status : cdc_status;
      [@ocaml.doc "The status of the CDC stream. Specifies if the table has a CDC stream.\n"]
}
[@@ocaml.doc
  "The settings of the CDC stream of the table. For more information about CDC streams, see \
   {{:https://docs.aws.amazon.com/keyspaces/latest/devguide/cdc.html}Working with change data \
   capture (CDC) streams in Amazon Keyspaces} in the {i Amazon Keyspaces Developer Guide}.\n"]
...
type nonrec get_table_response = {
  ...
  replica_specifications : replica_specification_summary_list option;
      [@ocaml.doc
  ...
  comment : comment option; [@ocaml.doc "The the description of the specified table.\n"]
  default_time_to_live : default_time_to_live option;
      [@ocaml.doc "The default Time to Live settings in seconds of the specified table.\n"]
  ttl : time_to_live option;
  ...
  status : table_status option; [@ocaml.doc "The current status of the specified table.\n"]
  creation_timestamp : timestamp option;
      [@ocaml.doc "The creation timestamp of the specified table.\n"]
  resource_arn : ar_n; [@ocaml.doc "The Amazon Resource Name (ARN) of the specified table.\n"]
  table_name : table_name; [@ocaml.doc "The name of the specified table.\n"]
  keyspace_name : keyspace_name;
      [@ocaml.doc "The name of the keyspace that the specified table is stored in.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_keyspace_response = {
  replication_group_statuses : replication_group_status_list option;
      [@ocaml.doc
  ...
  replication_strategy : rs;
      [@ocaml.doc
        " Returns the replication strategy of the keyspace. The options are [SINGLE_REGION] or \
         [MULTI_REGION]. \n"]
  resource_arn : ar_n; [@ocaml.doc "Returns the ARN of the keyspace.\n"]
  keyspace_name : keyspace_name; [@ocaml.doc "The name of the keyspace.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_type_response = {
  type_name : type_name; [@ocaml.doc " The name of the type that was deleted. \n"]
  keyspace_arn : ar_n;
      [@ocaml.doc
        " The unique identifier of the keyspace from which the type was deleted in the format of \
         an Amazon Resource Name (ARN). \n"]
}
[@@ocaml.doc ""]

type nonrec delete_type_request = {
  type_name : type_name; [@ocaml.doc " The name of the type to be deleted. \n"]
  keyspace_name : keyspace_name;
...
type nonrec delete_table_request = {
  table_name : table_name; [@ocaml.doc "The name of the table to be deleted.\n"]
  keyspace_name : keyspace_name;
      [@ocaml.doc "The name of the keyspace of the to be deleted table.\n"]
}
[@@ocaml.doc ""]

type nonrec delete_keyspace_response = unit [@@ocaml.doc ""]

type nonrec delete_keyspace_request = {
  keyspace_name : keyspace_name; [@ocaml.doc "The name of the keyspace to be deleted.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_type_response = {
  type_name : type_name;
      [@ocaml.doc
        " The formatted name of the user-defined type that was created. Note that Amazon Keyspaces \
         requires the formatted name of the type for other operations, for example [GetType]. \n"]
  keyspace_arn : ar_n;
      [@ocaml.doc
        " The unique identifier of the keyspace that contains the new type in the format of an \
...
type nonrec create_table_request = {
  ...
  replica_specifications : replica_specification_list option;
      [@ocaml.doc
        "The optional Amazon Web Services Region specific settings of a multi-Region table. These \
         settings overwrite the general settings of the table for the specified Region. \n\n\
        \ For a multi-Region table in provisioned capacity mode, you can configure the table's \
         read capacity differently for each Region's replica. The write capacity, however, remains \
  ...
  auto_scaling_specification : auto_scaling_specification option;
      [@ocaml.doc
        "The optional auto scaling settings for a table in provisioned capacity mode. Specifies if \
         the service can manage throughput capacity automatically on your behalf.\n\n\
  ...
  encryption_specification : encryption_specification option;
      [@ocaml.doc
        "Specifies how the encryption key for encryption at rest is managed for the table. You can \
  ...
  comment : comment option;
      [@ocaml.doc "This parameter allows to enter a description of the table.\n"]
  schema_definition : schema_definition;
      [@ocaml.doc
        ...
        \          {-   [partitionKeys] - The partition key can be a single column, or it can be a \
         compound value composed of two or more columns. The partition key portion of the primary \
         key is required and determines how Amazon Keyspaces stores your data.\n\
        \              \n\
        \               }\n\
  ...
  table_name : table_name; [@ocaml.doc "The name of the table.\n"]
  keyspace_name : keyspace_name;
      [@ocaml.doc "The name of the keyspace that the table is going to be created in.\n"]
}
[@@ocaml.doc ""]
  ...
  tags : tag_list option;
      [@ocaml.doc
        ...
        \ For more information, see \
         ...
         Guide}.\n\
        \ "]
  keyspace_name : keyspace_name; [@ocaml.doc "The name of the keyspace to be created.\n"]
}
[@@ocaml.doc ""]
