...
let restore_table_request_to_yojson (x : restore_table_request) =
  assoc_to_yojson
    [
      ...
      ("restoreTimestamp", option_to_yojson timestamp__to_yojson x.restore_timestamp);
...
let get_type_response_to_yojson (x : get_type_response) =
  assoc_to_yojson
    [
      ...
      ("lastModifiedTimestamp", option_to_yojson timestamp__to_yojson x.last_modified_timestamp);
