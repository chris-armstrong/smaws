  ...
  let _res : capacity_specification =
    {
      write_capacity_units =
        (option_of_yojson
           (value_for_key capacity_units_of_yojson "writeCapacityUnits")
           _list path);
      read_capacity_units =
        (option_of_yojson
  ...
  let _res : auto_scaling_settings =
    {
      scaling_policy =
        (option_of_yojson
           (value_for_key auto_scaling_policy_of_yojson "scalingPolicy")
           _list path);
      maximum_units =
        (option_of_yojson
  ...
  let _res : update_table_request =
    {
      ...
      add_columns =
        (option_of_yojson
           (value_for_key column_definition_list_of_yojson "addColumns")
           _list path);
      table_name =
...
let static_column_of_yojson tree path =
  ...
  let _res : static_column =
    { name = (value_for_key generic_string_of_yojson "name" _list path) } in
  _res
  ...
  let _res : restore_table_request =
    {
      ...
      target_keyspace_name =
        (value_for_key keyspace_name_of_yojson "targetKeyspaceName" _list
           path);
      source_table_name =
        (value_for_key table_name_of_yojson "sourceTableName" _list path);
      source_keyspace_name =
        (value_for_key keyspace_name_of_yojson "sourceKeyspaceName" _list
           path)
    } in
  _res
