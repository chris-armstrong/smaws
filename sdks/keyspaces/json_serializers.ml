...
let column_definition_list_to_yojson tree =
  list_to_yojson column_definition_to_yojson tree
...
let auto_scaling_policy_to_yojson (x : auto_scaling_policy) =
  assoc_to_yojson
    [("targetTrackingScalingPolicyConfiguration",
       (option_to_yojson
          target_tracking_scaling_policy_configuration_to_yojson
          x.target_tracking_scaling_policy_configuration))]
...
let auto_scaling_specification_to_yojson (x : auto_scaling_specification) =
  assoc_to_yojson
    [("readCapacityAutoScaling",
       (option_to_yojson auto_scaling_settings_to_yojson
          x.read_capacity_auto_scaling));
    ("writeCapacityAutoScaling",
      (option_to_yojson auto_scaling_settings_to_yojson
         x.write_capacity_auto_scaling))]
...
let update_table_request_to_yojson (x : update_table_request) =
  assoc_to_yojson
    ...
    ("pointInTimeRecovery",
      (option_to_yojson point_in_time_recovery_to_yojson
         x.point_in_time_recovery));
    ("encryptionSpecification",
      (option_to_yojson encryption_specification_to_yojson
         x.encryption_specification));
    ("capacitySpecification",
      (option_to_yojson capacity_specification_to_yojson
         x.capacity_specification));
    ("addColumns",
...
let table_summary_to_yojson (x : table_summary) =
  assoc_to_yojson
    ...
    ("tableName", (Some (table_name_to_yojson x.table_name)));
    ("keyspaceName", (Some (keyspace_name_to_yojson x.keyspace_name)))]
let table_summary_list_to_yojson tree =
  list_to_yojson table_summary_to_yojson tree
...
let static_column_list_to_yojson tree =
  list_to_yojson static_column_to_yojson tree
...
let clustering_key_to_yojson (x : clustering_key) =
  assoc_to_yojson
    ...
    ("name", (Some (generic_string_to_yojson x.name)))]
let clustering_key_list_to_yojson tree =
  list_to_yojson clustering_key_to_yojson tree
...
let restore_table_response_to_yojson (x : restore_table_response) =
  assoc_to_yojson
    [("restoredTableARN", (Some (ar_n_to_yojson x.restored_table_ar_n)))]
let restore_table_request_to_yojson (x : restore_table_request) =
  assoc_to_yojson
    ...
    ("pointInTimeRecoveryOverride",
      (option_to_yojson point_in_time_recovery_to_yojson
         x.point_in_time_recovery_override));
    ("encryptionSpecificationOverride",
      (option_to_yojson encryption_specification_to_yojson
         x.encryption_specification_override));
    ("capacitySpecificationOverride",
      (option_to_yojson capacity_specification_to_yojson
         x.capacity_specification_override));
    ("restoreTimestamp",
      (option_to_yojson timestamp_to_yojson x.restore_timestamp));
  ...
  assoc_to_yojson
    [("lastUpdateToPayPerRequestTimestamp",
       (option_to_yojson timestamp_to_yojson
          x.last_update_to_pay_per_request_timestamp));
    ("writeCapacityUnits",
      (option_to_yojson capacity_units_to_yojson x.write_capacity_units));
    ("readCapacityUnits",
      (option_to_yojson capacity_units_to_yojson x.read_capacity_units));
...
let replica_specification_summary_to_yojson
  (x : replica_specification_summary) =
  assoc_to_yojson
    [("capacitySpecification",
       (option_to_yojson capacity_specification_summary_to_yojson
          x.capacity_specification));
...
let replica_auto_scaling_specification_to_yojson
  (x : replica_auto_scaling_specification) =
  assoc_to_yojson
    [("autoScalingSpecification",
       (option_to_yojson auto_scaling_specification_to_yojson
          x.auto_scaling_specification));
...
let point_in_time_recovery_summary_to_yojson
  (x : point_in_time_recovery_summary) =
  assoc_to_yojson
...
let keyspace_summary_to_yojson (x : keyspace_summary) =
  assoc_to_yojson
    ...
    ("resourceArn", (Some (ar_n_to_yojson x.resource_arn)));
    ("keyspaceName", (Some (keyspace_name_to_yojson x.keyspace_name)))]
let keyspace_summary_list_to_yojson tree =
  list_to_yojson keyspace_summary_to_yojson tree
...
let get_type_response_to_yojson (x : get_type_response) =
  assoc_to_yojson
    ...
    ("lastModifiedTimestamp",
      (option_to_yojson timestamp_to_yojson x.last_modified_timestamp));
    ("fieldDefinitions",
...
let get_table_auto_scaling_settings_response_to_yojson
  ...
  assoc_to_yojson
    [("replicaSpecifications",
       (option_to_yojson replica_auto_scaling_specification_list_to_yojson
          x.replica_specifications));
    ("autoScalingSpecification",
      (option_to_yojson auto_scaling_specification_to_yojson
         x.auto_scaling_specification));
...
let get_table_auto_scaling_settings_request_to_yojson
  (x : get_table_auto_scaling_settings_request) =
  assoc_to_yojson
    [("tableName", (Some (table_name_to_yojson x.table_name)));
    ("keyspaceName", (Some (keyspace_name_to_yojson x.keyspace_name)))]
...
let get_table_response_to_yojson (x : get_table_response) =
  assoc_to_yojson
    ...
    ("ttl", (option_to_yojson time_to_live_to_yojson x.ttl));
    ("pointInTimeRecovery",
      (option_to_yojson point_in_time_recovery_summary_to_yojson
         x.point_in_time_recovery));
    ("encryptionSpecification",
      (option_to_yojson encryption_specification_to_yojson
         x.encryption_specification));
...
let create_keyspace_request_to_yojson (x : create_keyspace_request) =
  assoc_to_yojson
    [("replicationSpecification",
       (option_to_yojson replication_specification_to_yojson
          x.replication_specification));
    ("tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("keyspaceName", (Some (keyspace_name_to_yojson x.keyspace_name)))]