...
let not_authorized_exception_to_yojson (x : not_authorized_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_string_to_yojson x.message))]
...
let sanitized_string_list_to_yojson tree =
  list_to_yojson sanitized_string_to_yojson tree
...
let list_performance_analysis_reports_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AnalysisReports",
      (option_to_yojson analysis_report_summary_list_to_yojson
         x.analysis_reports))]
...
let metric_type_list_to_yojson tree =
  list_to_yojson sanitized_string_to_yojson tree
let list_available_resource_metrics_request_to_yojson
  (x : list_available_resource_metrics_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let dimension_detail_list_to_yojson tree =
  list_to_yojson dimension_detail_to_yojson tree
...
let metric_dimension_groups_to_yojson (x : metric_dimension_groups) =
  assoc_to_yojson
    ...
    ("Metric", (option_to_yojson string__to_yojson x.metric))]
let metric_dimensions_list_to_yojson tree =
  list_to_yojson metric_dimension_groups_to_yojson tree
...
let dimensions_metric_list_to_yojson tree =
  list_to_yojson sanitized_string_to_yojson tree
...
let authorized_actions_list_to_yojson tree =
  list_to_yojson fine_grained_action_to_yojson tree
let list_available_resource_dimensions_request_to_yojson
  (x : list_available_resource_dimensions_request) =
  assoc_to_yojson
    [("AuthorizedActions",
       (option_to_yojson authorized_actions_list_to_yojson
          x.authorized_actions));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
...
let data_points_list_to_yojson tree =
  list_to_yojson data_point_to_yojson tree
...
let get_resource_metrics_response_to_yojson
  (x : get_resource_metrics_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MetricList",
...
let metric_query_list_to_yojson tree =
  list_to_yojson metric_query_to_yojson tree
...
let get_resource_metrics_request_to_yojson (x : get_resource_metrics_request)
  ...
  assoc_to_yojson
    ...
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("PeriodInSeconds",
      (option_to_yojson integer_to_yojson x.period_in_seconds));
...
let descriptive_map_to_yojson tree =
  map_to_yojson descriptive_string_to_yojson descriptive_string_to_yojson
    tree
...
let data_to_yojson (x : data) =
  assoc_to_yojson
    [("PerformanceInsightsMetric",
       (option_to_yojson performance_insights_metric_to_yojson
          x.performance_insights_metric))]
let data_list_to_yojson tree = list_to_yojson data_to_yojson tree
let rec insight_to_yojson (x : insight) =
  assoc_to_yojson
...
and insight_list_to_yojson tree = list_to_yojson insight_to_yojson tree
...
let accept_language_to_yojson (x : accept_language) =
  match x with | EN_US -> `String "EN_US"
let get_performance_analysis_report_request_to_yojson
  (x : get_performance_analysis_report_request) =
  assoc_to_yojson
    [("AcceptLanguage",
...
let dimension_key_detail_list_to_yojson tree =
  list_to_yojson dimension_key_detail_to_yojson tree
let get_dimension_key_details_response_to_yojson
  (x : get_dimension_key_details_response) =
  assoc_to_yojson
    [("Dimensions",
       (option_to_yojson dimension_key_detail_list_to_yojson x.dimensions))]
let get_dimension_key_details_request_to_yojson
  (x : get_dimension_key_details_request) =
  assoc_to_yojson
    [("RequestedDimensions",
       (option_to_yojson requested_dimension_list_to_yojson
          x.requested_dimensions));
...
let describe_dimension_keys_response_to_yojson
  (x : describe_dimension_keys_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Keys",
      (option_to_yojson dimension_key_description_list_to_yojson x.keys));
    ("PartitionKeys",
      (option_to_yojson response_partition_key_list_to_yojson
         x.partition_keys));
    ("AlignedEndTime",
      (option_to_yojson iso_timestamp_to_yojson x.aligned_end_time));
    ("AlignedStartTime",
      (option_to_yojson iso_timestamp_to_yojson x.aligned_start_time))]
let additional_metrics_list_to_yojson tree =
  list_to_yojson sanitized_string_to_yojson tree
let describe_dimension_keys_request_to_yojson
  (x : describe_dimension_keys_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ...
    ("AdditionalMetrics",
      (option_to_yojson additional_metrics_list_to_yojson
         x.additional_metrics));
