...
type nonrec severity = LOW [@ocaml.doc ""] | MEDIUM [@ocaml.doc ""] | HIGH [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec iso_timestamp = Smaws_Lib.CoreTypes.Timestamp.t [@@ocaml.doc ""]

type nonrec context_type = CAUSAL [@ocaml.doc ""] | CONTEXTUAL [@ocaml.doc ""] [@@ocaml.doc ""]

type insight_list = insight list [@@ocaml.doc ""]
...
type nonrec service_type = RDS [@ocaml.doc ""] | DOCDB [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec text_format = PLAIN_TEXT [@ocaml.doc ""] | MARKDOWN [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec period_alignment = END_TIME [@ocaml.doc ""] | START_TIME [@ocaml.doc ""]
[@@ocaml.doc ""]
