...
type nonrec text_format =
  | MARKDOWN [@ocaml.doc ""]
  | PLAIN_TEXT [@ocaml.doc ""][@@ocaml.doc ""]
type nonrec tag =
  {
  value: string
    [@ocaml.doc
...
type nonrec response_resource_metric =
  {
  unit_: string option [@ocaml.doc "The unit of the metric.\n"];
  description: string option [@ocaml.doc "The description of the metric.\n"];
  metric: string option [@ocaml.doc "The full name of the metric.\n"]}
[@@ocaml.doc
...
type nonrec dimension_detail =
  {
  identifier: string option [@ocaml.doc "The identifier of a dimension.\n"]}
...
type nonrec dimension_group_detail =
  ...
  group: string option [@ocaml.doc "The name of the dimension group.\n"]}
...
type nonrec fine_grained_action =
  ...
  | DESCRIBE_DIMENSION_KEYS [@ocaml.doc ""][@@ocaml.doc ""]
...
type nonrec context_type =
  | CONTEXTUAL [@ocaml.doc ""]
  | CAUSAL [@ocaml.doc ""][@@ocaml.doc ""]
...
type nonrec performance_insights_metric =
  ...
  metric: string option [@ocaml.doc "The Performance Insights metric.\n"]}
[@@ocaml.doc
...
type insight =
  ...
  recommendations: recommendation list option
    [@ocaml.doc
      "List of recommendations for the insight. For example, [Investigate the following SQLs that contributed \n                to 100% of the total DBLoad during that time period: sql-id].\n"];
  description: string option
    [@ocaml.doc
      "Description of the insight. For example: [A high severity Insight found between 02:00 to 02:30,\n                where there was an unusually high DB load 600x above baseline. \n                Likely performance impact].\n"];
