  ...
  let _res : recommendation =
    {
      ...
      recommendation_id =
        (option_of_yojson
           (value_for_key string__of_yojson "RecommendationId") _list path)
    } in
  _res
  ...
  let _res : analysis_report_summary =
    {
      ...
      create_time =
        (option_of_yojson
           (value_for_key iso_timestamp_of_yojson "CreateTime") _list path);
      analysis_report_id =
        (option_of_yojson
           (value_for_key string__of_yojson "AnalysisReportId") _list path)
    } in
  _res
...
let dimension_detail_of_yojson tree path =
  ...
  let _res : dimension_detail =
    {
      identifier =
        (option_of_yojson (value_for_key string__of_yojson "Identifier")
           _list path)
    } in
  _res
  ...
  let _res : get_resource_metrics_response =
    {
      ...
      aligned_end_time =
        (option_of_yojson
           (value_for_key iso_timestamp_of_yojson "AlignedEndTime") _list
           path);
      aligned_start_time =
        (option_of_yojson
  ...
  let _res : get_resource_metrics_request =
    {
      ...
      period_in_seconds =
        (option_of_yojson
           (value_for_key integer__of_yojson "PeriodInSeconds") _list path);
  ...
  let _res : analysis_report =
    {
      ...
      identifier =
        (option_of_yojson
           (value_for_key identifier_string_of_yojson "Identifier") _list
           path);
      analysis_report_id =
  ...
  let _res : dimension_key_description =
    {
      ...
      additional_metrics =
        (option_of_yojson
           (value_for_key additional_metrics_map_of_yojson
