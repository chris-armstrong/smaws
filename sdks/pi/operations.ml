...
module CreatePerformanceAnalysisReport =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InternalServiceError") ->
            `InternalServiceError
              (Json_deserializers.internal_service_error_of_yojson tree path)
    ...
    let request context
      ...
      let input =
        Json_serializers.create_performance_analysis_report_request_to_yojson
          request in
...
module DeletePerformanceAnalysisReport =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.delete_performance_analysis_report_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeDimensionKeys =
  struct
    ...
    let request context (request : describe_dimension_keys_request) =
      let input =
        Json_serializers.describe_dimension_keys_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetDimensionKeyDetails =
  struct
    ...
    let request context (request : get_dimension_key_details_request) =
      let input =
        Json_serializers.get_dimension_key_details_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetPerformanceAnalysisReport =
  struct
    ...
    let request context (request : get_performance_analysis_report_request) =
      let input =
        Json_serializers.get_performance_analysis_report_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetResourceMetadata =
  struct
    ...
    let request context (request : get_resource_metadata_request) =
      let input =
        Json_serializers.get_resource_metadata_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetResourceMetrics =
  struct
    ...
    let request context (request : get_resource_metrics_request) =
      let input =
        Json_serializers.get_resource_metrics_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListAvailableResourceDimensions =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_available_resource_dimensions_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListAvailableResourceMetrics =
  struct
    ...
    let request context (request : list_available_resource_metrics_request) =
      let input =
        Json_serializers.list_available_resource_metrics_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListPerformanceAnalysisReports =
  struct
    ...
    let request context (request : list_performance_analysis_reports_request)
      =
      let input =
        Json_serializers.list_performance_analysis_reports_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"PerformanceInsightsv20180227.TagResource" ~service
        ~context ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"PerformanceInsightsv20180227.UntagResource" ~service
        ~context ~input
