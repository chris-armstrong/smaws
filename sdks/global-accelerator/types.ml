...
type nonrec accelerator_status = DEPLOYED [@ocaml.doc ""] | IN_PROGRESS [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec ip_address_family = IPv4 [@ocaml.doc ""] | IPv6 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec client_affinity = NONE [@ocaml.doc ""] | SOURCE_IP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec protocol = TCP [@ocaml.doc ""] | UDP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec custom_routing_protocol = TCP [@ocaml.doc ""] | UDP [@ocaml.doc ""] [@@ocaml.doc ""]
