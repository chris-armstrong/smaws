...
type nonrec target_storage_class = STANDARD [@ocaml.doc ""] | ARCHIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec scan_type = BASIC [@ocaml.doc ""] | ENHANCED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec put_registry_policy_response = {
  registry_id : registry_id option; [@ocaml.doc "The registry ID associated with the request.\n"]
  policy_text : registry_policy_text option; [@ocaml.doc "The JSON policy text for your registry.\n"]
}
[@@ocaml.doc ""]
...
type nonrec tag_status = TAGGED [@ocaml.doc ""] | UNTAGGED [@ocaml.doc ""] | ANY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec lifecycle_policy_storage_class = ARCHIVE [@ocaml.doc ""] | STANDARD [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec lifecycle_policy_rule_priority = int [@@ocaml.doc ""]

type nonrec image_action_type = EXPIRE [@ocaml.doc ""] | TRANSITION [@ocaml.doc ""]
[@@ocaml.doc ""]
