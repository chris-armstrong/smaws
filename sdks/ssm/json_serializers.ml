...
let step_preview_map_to_yojson tree =
  map_to_yojson impact_type_to_yojson integer_to_yojson tree
...
let resource_data_sync_last_modified_time_to_yojson =
  timestamp_epoch_seconds_to_yojson
let last_resource_data_sync_time_to_yojson =
  timestamp_epoch_seconds_to_yojson
...
let resource_data_sync_created_time_to_yojson =
  timestamp_epoch_seconds_to_yojson
...
let progress_counters_to_yojson (x : progress_counters) =
  assoc_to_yojson
    [("TimedOutSteps",
       (option_to_yojson integer_to_yojson x.timed_out_steps));
    ("CancelledSteps",
      (option_to_yojson integer_to_yojson x.cancelled_steps));
...
let inventory_deletion_start_time_to_yojson =
  timestamp_epoch_seconds_to_yojson
...
let describe_patch_group_state_result_to_yojson
  ...
  assoc_to_yojson
    [("InstancesWithAvailableSecurityUpdates",
       (option_to_yojson integer_to_yojson
