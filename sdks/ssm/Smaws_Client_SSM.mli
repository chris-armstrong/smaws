...
val make_patch_filter :
  values:patch_filter_value_list -> key:patch_filter_key -> unit -> patch_filter
...
val make_ops_item_data_value :
  ?type_:ops_item_data_type -> ?value:ops_item_data_value_string -> unit -> ops_item_data_value
...
val make_target_preview : ?target_type:string_ -> ?count:integer -> unit -> target_preview
...
val make_start_access_request_request :
  ?tags:tag_list -> targets:targets -> reason:string1to256 -> unit -> start_access_request_request
...
val make_session_filter :
  value:session_filter_value -> key:session_filter_key -> unit -> session_filter
...
val make_resolved_targets :
  ?truncated:boolean_ -> ?parameter_values:target_parameter_list -> unit -> resolved_targets
...
val make_put_resource_policy_response :
  ?policy_hash:policy_hash -> ?policy_id:policy_id -> unit -> put_resource_policy_response
...
val make_put_inventory_request :
  items:inventory_item_list -> instance_id:instance_id -> unit -> put_inventory_request
...
val make_parameters_filter :
  values:parameters_filter_value_list -> key:parameters_filter_key -> unit -> parameters_filter
...
val make_ops_entity : ?data:ops_entity_item_map -> ?id:ops_entity_id -> unit -> ops_entity
...
val make_document_filter :
  value:document_filter_value -> key:document_filter_key -> unit -> document_filter
...
val make_command_filter :
  value:command_filter_value -> key:command_filter_key -> unit -> command_filter
...
val make_association_filter :
  value:association_filter_value -> key:association_filter_key -> unit -> association_filter
...
val make_inventory_group :
  filters:inventory_filter_list -> name:inventory_group_name -> unit -> inventory_group
...
val make_get_connection_status_response :
  ?status:connection_status -> ?target:session_target -> unit -> get_connection_status_response
...
val make_describe_sessions_response :
  ?next_token:next_token -> ?sessions:session_list -> unit -> describe_sessions_response
...
val make_create_ops_item_response :
  ?ops_item_arn:ops_item_arn -> ?ops_item_id:string_ -> unit -> create_ops_item_response
