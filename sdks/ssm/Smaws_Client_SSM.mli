...
sig
  val error_to_string :
    ...
    | `TooManyUpdates of too_many_updates ] -> string
  val request :
...
sig
  val error_to_string :
    ...
    | `InvalidInstanceId of invalid_instance_id ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InternalServerError of internal_server_error ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `InternalServerError of internal_server_error 
    | `InvalidParameters of invalid_parameters ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InvalidSchedule of invalid_schedule  | `InvalidTag of invalid_tag 
    | `InvalidTarget of invalid_target 
    | `InvalidTargetMaps of invalid_target_maps 
    | `UnsupportedPlatformType of unsupported_platform_type ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
      create_association_request ->
...
sig
  val error_to_string :
    ...
    | `InvalidTypeNameException of invalid_type_name_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `InternalServerError of internal_server_error 
    | `ParameterNotFound of parameter_not_found ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `InternalServerError of internal_server_error 
    | `InvalidResourceId of invalid_resource_id ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `DoesNotExistException of does_not_exist_exception 
    | `InternalServerError of internal_server_error 
    | `TargetInUseException of target_in_use_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InvalidNextToken of invalid_next_token ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InternalServerError of internal_server_error 
    | `InvalidDocument of invalid_document 
    | `InvalidDocumentVersion of invalid_document_version ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InvalidPermissionType of invalid_permission_type ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InvocationDoesNotExist of invocation_does_not_exist ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `ParameterVersionNotFound of parameter_version_not_found ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `InternalServerError of internal_server_error 
    | `InvalidKeyId of invalid_key_id ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `InternalServerError of internal_server_error 
    | `ServiceSettingNotFound of service_setting_not_found ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InvalidNextToken of invalid_next_token 
    | `InvalidResourceId of invalid_resource_id 
    | `InvalidResourceType of invalid_resource_type ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `UnsupportedParameterType of unsupported_parameter_type ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `AssociationDoesNotExist of association_does_not_exist 
    | `InvalidAssociation of invalid_association ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InvalidTarget of invalid_target ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InternalServerError of internal_server_error 
    | `InvalidDocument of invalid_document 
    | `TargetNotConnected of target_not_connected ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InvalidDocumentSchemaVersion of invalid_document_schema_version 
    | `InvalidDocumentVersion of invalid_document_version 
    | `MaxDocumentSizeExceeded of max_document_size_exceeded ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
