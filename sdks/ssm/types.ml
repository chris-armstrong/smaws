...
type nonrec patch_action = Block [@ocaml.doc ""] | AllowAsDependency [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec patch_compliance_status = NonCompliant [@ocaml.doc ""] | Compliant [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ops_item_data_type = STRING [@ocaml.doc ""] | SEARCHABLE_STRING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec document_hash_type = SHA1 [@ocaml.doc ""] | SHA256 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec notification_type = Invocation [@ocaml.doc ""] | Command [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec document_parameter_type = StringList [@ocaml.doc ""] | String [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec document_format = TEXT [@ocaml.doc ""] | JSON [@ocaml.doc ""] | YAML [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec association_sync_compliance = Manual [@ocaml.doc ""] | Auto [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec external_alarm_state = ALARM [@ocaml.doc ""] | UNKNOWN [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec stop_type = CANCEL [@ocaml.doc ""] | COMPLETE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec execution_mode = Interactive [@ocaml.doc ""] | Auto [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec session_state = HISTORY [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec access_type = JUSTINTIME [@ocaml.doc ""] | STANDARD [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec resource_type = EC2_INSTANCE [@ocaml.doc ""] | MANAGED_INSTANCE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec compliance_status = NonCompliant [@ocaml.doc ""] | Compliant [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec remove_tags_from_resource_request = {
  tag_keys : key_list;
      [@ocaml.doc "Tag keys that you want to remove from the specified resource.\n"]
...
type nonrec reboot_option = NO_REBOOT [@ocaml.doc ""] | REBOOT_IF_NEEDED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec compliance_upload_type = Partial [@ocaml.doc ""] | Complete [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec patch_set = Application [@ocaml.doc ""] | Os [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec patch_operation_type = INSTALL [@ocaml.doc ""] | SCAN [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec inventory_attribute_data_type = NUMBER [@ocaml.doc ""] | STRING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec inventory_deletion_status = COMPLETE [@ocaml.doc ""] | IN_PROGRESS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec connection_status = NOT_CONNECTED [@ocaml.doc ""] | CONNECTED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec calendar_state = CLOSED [@ocaml.doc ""] | OPEN [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec automation_subtype = AccessRequest [@ocaml.doc ""] | ChangeRequest [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec fault = Unknown [@ocaml.doc ""] | Server [@ocaml.doc ""] | Client [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec describe_sessions_response = {
  next_token : next_token option;
      [@ocaml.doc
        "The token for the next set of items to return. (You received this token from a previous \
         call.)\n"]
  sessions : session_list option; [@ocaml.doc "A list of sessions meeting the request parameters.\n"]
}
[@@ocaml.doc ""]
...
type nonrec automation_type = Local [@ocaml.doc ""] | CrossAccount [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec association_execution_targets_filter = {
  ...
  key : association_execution_targets_filter_key; [@ocaml.doc "The key value used in the request.\n"]
}
