...
let progress_counters_of_yojson tree path =
  ...
  ({
     timed_out_steps =
       option_of_yojson (value_for_key integer__of_yojson "TimedOutSteps") _list path;
     cancelled_steps =
       option_of_yojson (value_for_key integer__of_yojson "CancelledSteps") _list path;
...
and ops_aggregator_list_of_yojson tree path = list_of_yojson ops_aggregator_of_yojson tree path
...
and node_aggregator_list_of_yojson tree path = list_of_yojson node_aggregator_of_yojson tree path
...
let automation_execution_preview_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     total_accounts = option_of_yojson (value_for_key integer__of_yojson "TotalAccounts") _list path;
     target_previews =
...
let describe_patch_group_state_result_of_yojson tree path =
  ...
  ({
     instances_with_available_security_updates =
       option_of_yojson
         (value_for_key integer__of_yojson "InstancesWithAvailableSecurityUpdates")
         _list path;
     ...
     instances_with_unreported_not_applicable_patches =
       option_of_yojson
         (value_for_key integer__of_yojson "InstancesWithUnreportedNotApplicablePatches")
         _list path;
     instances_with_not_applicable_patches =
       option_of_yojson
         (value_for_key integer__of_yojson "InstancesWithNotApplicablePatches")
         _list path;
     instances_with_failed_patches =
       option_of_yojson (value_for_key integer__of_yojson "InstancesWithFailedPatches") _list path;
     instances_with_missing_patches =
       option_of_yojson (value_for_key integer__of_yojson "InstancesWithMissingPatches") _list path;
     ...
     instances_with_installed_other_patches =
       option_of_yojson
         (value_for_key integer__of_yojson "InstancesWithInstalledOtherPatches")
         _list path;
