...
let patch_action_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ -> raise (deserialize_wrong_type_error path "PatchAction") : patch_action)
  ...
  let _res : update_patch_baseline_result =
    {
      ...
      operating_system =
        (option_of_yojson
           ...
           path);
      name =
        (option_of_yojson (value_for_key baseline_name_of_yojson "Name")
           _list path);
      baseline_id =
  ...
  let _res : update_ops_item_request =
    {
      ...
      planned_end_time =
        (option_of_yojson
           (value_for_key date_time_of_yojson "PlannedEndTime") _list path);
      planned_start_time =
        (option_of_yojson
      ...
      related_ops_items =
        (option_of_yojson
           (value_for_key related_ops_items_of_yojson "RelatedOpsItems")
           _list path);
      priority =
        (option_of_yojson
...
let notification_event_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise
         (deserialize_unknown_enum_value_error path "NotificationEvent" value)
  ...
  let _res : maintenance_window_run_command_parameters =
    {
      ...
      output_s3_bucket_name =
        (option_of_yojson
           (value_for_key s3_bucket_name_of_yojson "OutputS3BucketName")
           _list path);
      notification_config =
        (option_of_yojson
...
let alarm_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : alarm =
    { name = (value_for_key alarm_name_of_yojson "Name" _list path) } in
  _res
  ...
  let _res : update_maintenance_window_task_result =
    {
      ...
      name =
        (option_of_yojson
           (value_for_key maintenance_window_name_of_yojson "Name") _list
           path);
      logging_info =
        (option_of_yojson
           (value_for_key logging_info_of_yojson "LoggingInfo") _list path);
      max_errors =
  ...
  let _res : update_maintenance_window_result =
    {
      ...
      schedule_offset =
        (option_of_yojson
           (value_for_key maintenance_window_offset_of_yojson
              "ScheduleOffset") _list path);
      schedule_timezone =
        (option_of_yojson
  ...
  let _res : document_parameter =
    {
      ...
      type_ =
        (option_of_yojson
           (value_for_key document_parameter_type_of_yojson "Type") _list
           path);
      name =
        (option_of_yojson
           (value_for_key document_parameter_name_of_yojson "Name") _list
           path)
    } in
  _res
...
let platform_type_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String "WINDOWS" -> WINDOWS
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "PlatformType" value)
...
let document_type_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String "Command" -> Command
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "DocumentType" value)
  ...
  let _res : document_requires =
    {
      version_name =
        (option_of_yojson
           (value_for_key document_version_name_of_yojson "VersionName")
           _list path);
      require_type =
        (option_of_yojson
           (value_for_key require_type_of_yojson "RequireType") _list path);
      version =
        (option_of_yojson
           (value_for_key document_version_of_yojson "Version") _list path);
...
let review_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String "APPROVED" -> APPROVED
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "ReviewStatus" value)
  ...
  let _res : document_description =
    {
      ...
      display_name =
        (option_of_yojson
           (value_for_key document_display_name_of_yojson "DisplayName")
           _list path);
      name =
        (option_of_yojson (value_for_key document_ar_n_of_yojson "Name")
           _list path);
      hash_type =
        (option_of_yojson
           (value_for_key document_hash_type_of_yojson "HashType") _list path);
      hash =
        (option_of_yojson (value_for_key document_hash_of_yojson "Hash")
           _list path);
      sha1 =
        (option_of_yojson (value_for_key document_sha1_of_yojson "Sha1")
           _list path)
    } in
  _res
  ...
  let _res : update_document_result =
    {
      document_description =
        (option_of_yojson
           (value_for_key document_description_of_yojson
              "DocumentDescription") _list path)
    } in
  _res
  ...
  let _res : document_review_comment_source =
    {
      ...
      type_ =
        (option_of_yojson
           (value_for_key document_review_comment_type_of_yojson "Type")
           _list path)
    } in
  _res
...
let update_document_metadata_request_of_yojson tree path =
  ...
  let _res : update_document_metadata_request =
    {
      document_reviews =
        (value_for_key document_reviews_of_yojson "DocumentReviews" _list
           path);
      document_version =
        (option_of_yojson
           (value_for_key document_version_of_yojson "DocumentVersion") _list
  ...
  let _res : document_default_version_description =
    {
      default_version_name =
        (option_of_yojson
           (value_for_key document_version_name_of_yojson
              "DefaultVersionName") _list path);
      default_version =
        (option_of_yojson
           (value_for_key document_version_of_yojson "DefaultVersion") _list
           path);
      name =
        (option_of_yojson (value_for_key document_name_of_yojson "Name")
           _list path)
    } in
  _res
  ...
  let _res : association_overview =
    {
      ...
      status =
        (option_of_yojson (value_for_key status_name_of_yojson "Status")
           _list path)
    } in
  _res
  ...
  let _res : s3_output_location =
    {
      ...
      output_s3_region =
        (option_of_yojson
           (value_for_key s3_region_of_yojson "OutputS3Region") _list path)
    } in
  _res
  ...
  let _res : association_description =
    {
      ...
      association_id =
        (option_of_yojson
           (value_for_key association_id_of_yojson "AssociationId") _list
           path);
      parameters =
        (option_of_yojson (value_for_key parameters_of_yojson "Parameters")
           _list path);
  ...
  let _res : unsupported_inventory_item_context_exception =
    {
      ...
      type_name =
        (option_of_yojson
           (value_for_key inventory_item_type_name_of_yojson "TypeName")
           _list path)
    } in
  _res
...
let terminate_session_request_of_yojson tree path =
  ...
  let _res : terminate_session_request =
    {
      session_id =
        (value_for_key session_id_of_yojson "SessionId" _list path)
    } in
  _res
  ...
  let _res : parent_step_details =
    {
      iterator_value =
        (option_of_yojson (value_for_key string__of_yojson "IteratorValue")
           _list path);
      iteration =
        (option_of_yojson (value_for_key integer__of_yojson "Iteration")
           _list path);
      action =
        (option_of_yojson
  ...
  let _res : step_execution =
    {
      ...
      inputs =
        (option_of_yojson
           (value_for_key normal_string_map_of_yojson "Inputs") _list path);
      response_code =
      ...
      execution_start_time =
        (option_of_yojson
           (value_for_key date_time_of_yojson "ExecutionStartTime") _list
           path);
      max_attempts =
  ...
  let _res : severity_summary =
    {
      ...
      low_count =
        (option_of_yojson
           (value_for_key compliance_summary_count_of_yojson "LowCount")
           _list path);
      medium_count =
        (option_of_yojson
...
let session_state_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String "ACTIVE" -> ACTIVE
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "SessionState" value)
  ...
  let _res : service_setting =
    {
      ...
      last_modified_user =
        (option_of_yojson
           (value_for_key string__of_yojson "LastModifiedUser") _list path);
      last_modified_date =
        (option_of_yojson
      ...
      setting_id =
        (option_of_yojson
           (value_for_key service_setting_id_of_yojson "SettingId") _list
           path)
    } in
  _res
  ...
  let _res : command =
    {
      ...
      service_role =
        (option_of_yojson
           (value_for_key service_role_of_yojson "ServiceRole") _list path);
      ...
      target_count =
        (option_of_yojson
           (value_for_key target_count_of_yojson "TargetCount") _list path);
      max_errors =
        (option_of_yojson (value_for_key max_errors_of_yojson "MaxErrors")
           _list path);
      max_concurrency =
      ...
      status_details =
        (option_of_yojson
           (value_for_key status_details_of_yojson "StatusDetails") _list
           path);
      status =
      ...
      instance_ids =
        (option_of_yojson
           (value_for_key instance_id_list_of_yojson "InstanceIds") _list
           path);
      parameters =
        (option_of_yojson (value_for_key parameters_of_yojson "Parameters")
           _list path);
...
let s3_output_url_of_yojson tree path =
  ...
  let _res : s3_output_url =
    {
      output_url =
        (option_of_yojson (value_for_key url_of_yojson "OutputUrl") _list
           path)
    } in
  _res
...
let last_resource_data_sync_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ ->
       raise (deserialize_wrong_type_error path "LastResourceDataSyncStatus") : 
  ...
  let _res : resource_compliance_summary_item =
    {
      ...
      status =
        (option_of_yojson
           (value_for_key compliance_status_of_yojson "Status") _list path);
      resource_id =
        (option_of_yojson
           (value_for_key compliance_resource_id_of_yojson "ResourceId")
           _list path);
      resource_type =
        (option_of_yojson
...
let resolved_targets_of_yojson tree path =
  ...
  let _res : resolved_targets =
    {
      truncated =
        (option_of_yojson (value_for_key boolean__of_yojson "Truncated")
           _list path);
      parameter_values =
        (option_of_yojson
...
let reboot_option_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "RebootOption" value)
  ...
  let _res : put_parameter_result =
    {
      ...
      version =
        (option_of_yojson
           (value_for_key ps_parameter_version_of_yojson "Version") _list
           path)
    } in
  _res
  ...
  let _res : put_parameter_request =
    {
      data_type =
        (option_of_yojson
           (value_for_key parameter_data_type_of_yojson "DataType") _list
           path);
      policies =
        (option_of_yojson
      ...
      allowed_pattern =
        (option_of_yojson
           ...
           path);
      overwrite =
        (option_of_yojson (value_for_key boolean__of_yojson "Overwrite")
           _list path);
      key_id =
      ...
      description =
        (option_of_yojson
           (value_for_key parameter_description_of_yojson "Description")
           _list path);
      name = (value_for_key ps_parameter_name_of_yojson "Name" _list path)
    } in
  _res
  ...
  let _res : inventory_item =
    {
      ...
      content =
        (option_of_yojson
           (value_for_key inventory_item_entry_list_of_yojson "Content")
           _list path);
      content_hash =
        (option_of_yojson
...
let put_inventory_request_of_yojson tree path =
  ...
  let _res : put_inventory_request =
    {
      items =
        (value_for_key inventory_item_list_of_yojson "Items" _list path);
      instance_id =
        (value_for_key instance_id_of_yojson "InstanceId" _list path)
    } in
  _res
  ...
  let _res : put_compliance_items_request =
    {
      upload_type =
        (option_of_yojson
           (value_for_key compliance_upload_type_of_yojson "UploadType")
           _list path);
      item_content_hash =
        (option_of_yojson
      ...
      items =
        (value_for_key compliance_item_entry_list_of_yojson "Items" _list
           path);
      execution_summary =
        (value_for_key compliance_execution_summary_of_yojson
           "ExecutionSummary" _list path);
  ...
  let _res : patch_status =
    {
      ...
      deployment_status =
        (option_of_yojson
           (value_for_key patch_deployment_status_of_yojson
              "DeploymentStatus") _list path)
    } in
  _res
  ...
  let _res : patch_orchestrator_filter =
    {
      ...
      key =
        (option_of_yojson
           (value_for_key patch_orchestrator_filter_key_of_yojson "Key")
           _list path)
    } in
  _res
  ...
  let _res : patch =
    {
      ...
      cve_ids =
        (option_of_yojson
           (value_for_key patch_cve_id_list_of_yojson "CVEIds") _list path);
      bugzilla_ids =
        (option_of_yojson
      ...
      msrc_number =
        (option_of_yojson
           (value_for_key patch_msrc_number_of_yojson "MsrcNumber") _list
           path);
      kb_number =
        (option_of_yojson
           (value_for_key patch_kb_number_of_yojson "KbNumber") _list path);
      msrc_severity =
        (option_of_yojson
      ...
      content_url =
        (option_of_yojson
           (value_for_key patch_content_url_of_yojson "ContentUrl") _list
           path);
      description =
        (option_of_yojson
  ...
  let _res : patch_baseline_identity =
    {
      ...
      baseline_description =
        (option_of_yojson
           (value_for_key baseline_description_of_yojson
              "BaselineDescription") _list path);
      operating_system =
        (option_of_yojson
           (value_for_key operating_system_of_yojson "OperatingSystem") _list
           path);
  ...
  let _res : patch_group_patch_baseline_mapping =
    {
      baseline_identity =
        (option_of_yojson
           (value_for_key patch_baseline_identity_of_yojson
              "BaselineIdentity") _list path);
      patch_group =
        (option_of_yojson (value_for_key patch_group_of_yojson "PatchGroup")
           _list path)
    } in
  ...
  let _res : parameter_inline_policy =
    {
      policy_status =
        (option_of_yojson (value_for_key string__of_yojson "PolicyStatus")
           _list path);
      policy_type =
        (option_of_yojson (value_for_key string__of_yojson "PolicyType")
           _list path);
      policy_text =
        (option_of_yojson (value_for_key string__of_yojson "PolicyText")
           _list path)
    } in
  _res
  ...
  let _res : parameter =
    {
      ...
      value =
        (option_of_yojson
           (value_for_key ps_parameter_value_of_yojson "Value") _list path);
      type_ =
        (option_of_yojson (value_for_key parameter_type_of_yojson "Type")
           _list path);
      name =
...
let ops_metadata_filter_of_yojson tree path =
  ...
  let _res : ops_metadata_filter =
    {
      values =
        (value_for_key ops_metadata_filter_value_list_of_yojson "Values"
           _list path);
      key =
        (value_for_key ops_metadata_filter_key_of_yojson "Key" _list path)
    } in
  _res
  ...
  let _res : ops_item_related_items_filter =
    {
      operator =
        (value_for_key ops_item_related_items_filter_operator_of_yojson
           "Operator" _list path);
      values =
        (value_for_key ops_item_related_items_filter_values_of_yojson
           "Values" _list path);
      key =
        (value_for_key ops_item_related_items_filter_key_of_yojson "Key"
           _list path)
    } in
  _res
...
let ops_item_filter_key_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String "CHANGE_REQUEST_REQUESTER_NAME" -> CHANGE_REQUEST_REQUESTER_NAME
...
let ops_item_event_filter_operator_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ ->
       raise (deserialize_wrong_type_error path "OpsItemEventFilterOperator") : 
  ...
  let _res : ops_entity_item =
    {
      ...
      capture_time =
        (option_of_yojson
           (value_for_key ops_entity_item_capture_time_of_yojson
              "CaptureTime") _list path)
    } in
  _res
  ...
  let _res : ops_entity =
    {
      data =
        (option_of_yojson
           (value_for_key ops_entity_item_map_of_yojson "Data") _list path);
      id =
  ...
  let _res : maintenance_window_task =
    {
      ...
      type_ =
        (option_of_yojson
           (value_for_key maintenance_window_task_type_of_yojson "Type")
           _list path);
      task_arn =
        (option_of_yojson
           (value_for_key maintenance_window_task_arn_of_yojson "TaskArn")
  ...
  let _res : maintenance_window_filter =
    {
      ...
      key =
        (option_of_yojson
           (value_for_key maintenance_window_filter_key_of_yojson "Key")
           _list path)
    } in
  _res
  ...
  let _res : list_ops_metadata_result =
    {
      ...
      ops_metadata_list =
        (option_of_yojson
           (value_for_key ops_metadata_list_of_yojson "OpsMetadataList")
           _list path)
    } in
  _res
  ...
  let _res : list_ops_metadata_request =
    {
      ...
      max_results =
        (option_of_yojson
           (value_for_key list_ops_metadata_max_results_of_yojson
  ...
  let _res : list_inventory_entries_result =
    {
      ...
      entries =
        (option_of_yojson
           (value_for_key inventory_item_entry_list_of_yojson "Entries")
           _list path);
      capture_time =
        (option_of_yojson
           (value_for_key inventory_item_capture_time_of_yojson "CaptureTime")
...
let inventory_query_operator_type_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ ->
       raise (deserialize_wrong_type_error path "InventoryQueryOperatorType") : 
...
let document_filter_key_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise
         (deserialize_unknown_enum_value_error path "DocumentFilterKey" value)
  ...
  let _res : document_key_values_filter =
    {
      values =
        (option_of_yojson
           (value_for_key document_key_values_filter_values_of_yojson
              "Values") _list path);
      key =
        (option_of_yojson
  ...
  let _res : list_document_metadata_history_response =
    {
      ...
      metadata =
        (option_of_yojson
           (value_for_key document_metadata_response_info_of_yojson
              "Metadata") _list path);
      author =
        (option_of_yojson (value_for_key document_author_of_yojson "Author")
           _list path);
  ...
  let _res : compliance_item =
    {
      ...
      severity =
        (option_of_yojson
           (value_for_key compliance_severity_of_yojson "Severity") _list
           path);
      status =
        (option_of_yojson
           (value_for_key compliance_status_of_yojson "Status") _list path);
...
let command_invocation_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise
         (deserialize_unknown_enum_value_error path "CommandInvocationStatus"
            value)
  ...
  let _res : command_plugin =
    {
      ...
      output =
        (option_of_yojson
           (value_for_key command_plugin_output_of_yojson "Output") _list
           path);
      ...
      status =
        (option_of_yojson
           (value_for_key command_plugin_status_of_yojson "Status") _list
           path);
      name =
        (option_of_yojson
           (value_for_key command_plugin_name_of_yojson "Name") _list path)
    } in
  _res
...
let inventory_attribute_data_type_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ ->
       raise (deserialize_wrong_type_error path "InventoryAttributeDataType") : 
...
let inventory_deletion_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise
         (deserialize_unknown_enum_value_error path "InventoryDeletionStatus"
            value)
  ...
  let _res : inventory_deletion_status_item =
    {
      last_status_update_time =
        (option_of_yojson
           (value_for_key
              inventory_deletion_last_status_update_time_of_yojson
...
let instance_property_filter_of_yojson tree path =
  ...
  let _res : instance_property_filter =
    {
      value_set =
        (value_for_key instance_property_filter_value_set_of_yojson
           "valueSet" _list path);
      key =
        (value_for_key instance_property_filter_key_of_yojson "key" _list
           path)
    } in
  _res
  ...
  let _res : instance_property =
    {
      source_type =
        (option_of_yojson (value_for_key source_type_of_yojson "SourceType")
           _list path);
      source_id =
        (option_of_yojson (value_for_key source_id_of_yojson "SourceId")
           _list path);
      ...
      instance_state =
        (option_of_yojson
           (value_for_key instance_state_of_yojson "InstanceState") _list
           path);
      key_name =
      ...
      instance_id =
        (option_of_yojson (value_for_key instance_id_of_yojson "InstanceId")
           _list path);
      name =
        (option_of_yojson (value_for_key instance_name_of_yojson "Name")
           _list path)
    } in
  _res
  ...
  let _res : instance_information =
    {
      ...
      is_latest_version =
        (option_of_yojson
           (value_for_key boolean__of_yojson "IsLatestVersion") _list path);
      agent_version =
        (option_of_yojson (value_for_key version_of_yojson "AgentVersion")
           _list path);
      last_ping_date_time =
  ...
  let _res : get_patch_baseline_result =
    {
      ...
      patch_groups =
        (option_of_yojson
           (value_for_key patch_group_list_of_yojson "PatchGroups") _list
           path);
      rejected_patches_action =
        (option_of_yojson
           (value_for_key patch_action_of_yojson "RejectedPatchesAction")
  ...
  let _res : get_parameters_request =
    {
      with_decryption =
        (option_of_yojson (value_for_key boolean__of_yojson "WithDecryption")
           _list path);
      names =
        (value_for_key parameter_name_list_of_yojson "Names" _list path)
    } in
  _res
  ...
  let _res : get_parameters_by_path_request =
    {
      ...
      recursive =
        (option_of_yojson (value_for_key boolean__of_yojson "Recursive")
           _list path);
  ...
  let _res : get_parameter_history_result =
    {
      ...
      parameters =
        (option_of_yojson
           (value_for_key parameter_history_list_of_yojson "Parameters")
           _list path)
    } in
  _res
  ...
  let _res : get_ops_summary_result =
    {
      ...
      entities =
        (option_of_yojson
           (value_for_key ops_entity_list_of_yojson "Entities") _list path)
    } in
  _res
  ...
  let _res : get_inventory_schema_request =
    {
      ...
      aggregator =
        (option_of_yojson
           (value_for_key aggregator_schema_only_of_yojson "Aggregator")
           _list path);
      max_results =
        (option_of_yojson
      ...
      type_name =
        (option_of_yojson
           (value_for_key inventory_item_type_name_filter_of_yojson
              "TypeName") _list path)
    } in
  _res
...
let attachment_content_of_yojson tree path =
  ...
  let _res : attachment_content =
    {
      url =
        (option_of_yojson (value_for_key attachment_url_of_yojson "Url")
           _list path);
      hash_type =
        (option_of_yojson
...
let get_connection_status_request_of_yojson tree path =
  ...
  let _res : get_connection_status_request =
    { target = (value_for_key session_target_of_yojson "Target" _list path) } in
  _res
  ...
  let _res : get_command_invocation_request =
    {
      ...
      instance_id =
        (value_for_key instance_id_of_yojson "InstanceId" _list path);
      command_id =
        (value_for_key command_id_of_yojson "CommandId" _list path)
    } in
  _res
  ...
  let _res : get_calendar_state_response =
    {
      next_transition_time =
        (option_of_yojson
           (value_for_key iso8601_string_of_yojson "NextTransitionTime")
           _list path);
      at_time =
...
let automation_subtype_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise
         (deserialize_unknown_enum_value_error path "AutomationSubtype" value)
  ...
  let _res : automation_execution =
    {
      ...
      current_step_name =
        (option_of_yojson (value_for_key string__of_yojson "CurrentStepName")
           _list path);
      executed_by =
        (option_of_yojson (value_for_key string__of_yojson "ExecutedBy")
           _list path);
  ...
  let _res : get_automation_execution_result =
    {
      automation_execution =
        (option_of_yojson
           (value_for_key automation_execution_of_yojson
              "AutomationExecution") _list path)
    } in
  _res
  ...
  let _res : effective_patch =
    {
      patch_status =
        (option_of_yojson
           (value_for_key patch_status_of_yojson "PatchStatus") _list path);
      patch =
  ...
  let _res : describe_patch_properties_request =
    {
      ...
      max_results =
        (option_of_yojson (value_for_key max_results_of_yojson "MaxResults")
           _list path);
      patch_set =
        (option_of_yojson (value_for_key patch_set_of_yojson "PatchSet")
           _list path);
      property =
  ...
  let _res : describe_patch_group_state_result =
    {
      ...
      instances_with_installed_patches =
        (option_of_yojson
           ...
           _list path);
      instances =
        (option_of_yojson (value_for_key integer__of_yojson "Instances")
           _list path)
    } in
  _res
  ...
  let _res : describe_instance_patch_states_for_patch_group_request =
    {
      ...
      filters =
        (option_of_yojson
           (value_for_key instance_patch_state_filter_list_of_yojson
              "Filters") _list path);
      patch_group =
        (value_for_key patch_group_of_yojson "PatchGroup" _list path)
    } in
  ...
  let _res : describe_effective_instance_associations_request =
    {
      ...
      max_results =
        (option_of_yojson
           (value_for_key
              effective_instance_association_max_results_of_yojson
              "MaxResults") _list path);
      instance_id =
        (value_for_key instance_id_of_yojson "InstanceId" _list path)
    } in
  ...
  let _res : describe_available_patches_result =
    {
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      patches =
        (option_of_yojson (value_for_key patch_list_of_yojson "Patches")
           _list path)
    } in
  _res
  ...
  let _res : describe_automation_executions_request =
    {
      ...
      filters =
        (option_of_yojson
           (value_for_key automation_execution_filter_list_of_yojson
              "Filters") _list path)
    } in
  _res
...
let association_execution_filter_of_yojson tree path =
  ...
  let _res : association_execution_filter =
    {
      type_ =
        (value_for_key association_filter_operator_type_of_yojson "Type"
           _list path);
      value =
  ...
  let _res : activation =
    {
      ...
      created_date =
        (option_of_yojson
           (value_for_key created_date_of_yojson "CreatedDate") _list path);
      expired =
  ...
  let _res : describe_activations_filter =
    {
      filter_values =
        (option_of_yojson
           (value_for_key string_list_of_yojson "FilterValues") _list path);
      filter_key =
        (option_of_yojson
  ...
  let _res : describe_activations_request =
    {
      ...
      filters =
        (option_of_yojson
           (value_for_key describe_activations_filter_list_of_yojson
              "Filters") _list path)
    } in
  _res
...
let deregister_target_from_maintenance_window_request_of_yojson tree path =
  ...
  let _res : deregister_target_from_maintenance_window_request =
    {
      safe =
        (option_of_yojson (value_for_key boolean__of_yojson "Safe") _list
           path);
      window_target_id =
        (value_for_key maintenance_window_target_id_of_yojson
           "WindowTargetId" _list path);
