...
module AddTagsToResource =
  struct
    let error_to_string =
      ...
      | #Smaws_Lib.Protocols.AwsJson.error as e ->
          Smaws_Lib.Protocols.AwsJson.error_to_string e
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidResourceId") ->
            `InvalidResourceId
              (Json_deserializers.invalid_resource_id_of_yojson tree path)
        | (_, "InvalidResourceType") ->
            `InvalidResourceType
              (Json_deserializers.invalid_resource_type_of_yojson tree path)
        | (_, "TooManyTagsError") ->
            `TooManyTagsError
              (Json_deserializers.too_many_tags_error_of_yojson tree path)
        | (_, "TooManyUpdates") ->
            `TooManyUpdates
              (Json_deserializers.too_many_updates_of_yojson tree path)
    ...
    let request context (request : add_tags_to_resource_request) =
      let input =
        Json_serializers.add_tags_to_resource_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.AddTagsToResource" ~service ~context ~input
...
module AssociateOpsItemRelatedItem =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "OpsItemConflictException") ->
            `OpsItemConflictException
              (Json_deserializers.ops_item_conflict_exception_of_yojson tree
                 path)
        | (_, "OpsItemInvalidParameterException") ->
            `OpsItemInvalidParameterException
              (Json_deserializers.ops_item_invalid_parameter_exception_of_yojson
                 tree path)
        | (_, "OpsItemLimitExceededException") ->
            `OpsItemLimitExceededException
              (Json_deserializers.ops_item_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "OpsItemNotFoundException") ->
            `OpsItemNotFoundException
              (Json_deserializers.ops_item_not_found_exception_of_yojson tree
                 path)
        | (_, "OpsItemRelatedItemAlreadyExistsException") ->
            `OpsItemRelatedItemAlreadyExistsException
              (Json_deserializers.ops_item_related_item_already_exists_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : associate_ops_item_related_item_request) =
      let input =
        Json_serializers.associate_ops_item_related_item_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.AssociateOpsItemRelatedItem" ~service ~context
        ~input
...
module CancelCommand =
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "DuplicateInstanceId") ->
            `DuplicateInstanceId
              (Json_deserializers.duplicate_instance_id_of_yojson tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
        | (_, "InvalidCommandId") ->
            `InvalidCommandId
              (Json_deserializers.invalid_command_id_of_yojson tree path)
        | (_, "InvalidInstanceId") ->
            `InvalidInstanceId
              (Json_deserializers.invalid_instance_id_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : cancel_command_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CancelCommand" ~service ~context ~input
        ~output_deserializer:Json_deserializers.cancel_command_result_of_yojson
        ~error_deserializer
  end
module CancelMaintenanceWindowExecution =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DoesNotExistException") ->
            `DoesNotExistException
              (Json_deserializers.does_not_exist_exception_of_yojson tree
                 path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
    ...
    let request context
      ...
      let input =
        Json_serializers.cancel_maintenance_window_execution_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CancelMaintenanceWindowExecution" ~service
        ~context ~input
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidParameters") ->
            `InvalidParameters
              (Json_deserializers.invalid_parameters_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : create_activation_request) =
      let input =
        Json_serializers.create_activation_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CreateActivation" ~service ~context ~input
        ~output_deserializer:Json_deserializers.create_activation_result_of_yojson
        ~error_deserializer
  end
module CreateAssociation =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "AssociationAlreadyExists") ->
            `AssociationAlreadyExists
              (Json_deserializers.association_already_exists_of_yojson tree
                 path)
        | (_, "AssociationLimitExceeded") ->
            `AssociationLimitExceeded
              (Json_deserializers.association_limit_exceeded_of_yojson tree
                 path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
        | (_, "InvalidDocument") ->
            `InvalidDocument
              (Json_deserializers.invalid_document_of_yojson tree path)
        | (_, "InvalidDocumentVersion") ->
            `InvalidDocumentVersion
              (Json_deserializers.invalid_document_version_of_yojson tree
                 path)
        | (_, "InvalidInstanceId") ->
            `InvalidInstanceId
              (Json_deserializers.invalid_instance_id_of_yojson tree path)
        | (_, "InvalidOutputLocation") ->
            `InvalidOutputLocation
              (Json_deserializers.invalid_output_location_of_yojson tree path)
        | (_, "InvalidParameters") ->
            `InvalidParameters
              (Json_deserializers.invalid_parameters_of_yojson tree path)
        | (_, "InvalidSchedule") ->
            `InvalidSchedule
              (Json_deserializers.invalid_schedule_of_yojson tree path)
        | (_, "InvalidTag") ->
            `InvalidTag (Json_deserializers.invalid_tag_of_yojson tree path)
        | (_, "InvalidTarget") ->
            `InvalidTarget
              (Json_deserializers.invalid_target_of_yojson tree path)
        | (_, "InvalidTargetMaps") ->
            `InvalidTargetMaps
              (Json_deserializers.invalid_target_maps_of_yojson tree path)
        | (_, "UnsupportedPlatformType") ->
            `UnsupportedPlatformType
              (Json_deserializers.unsupported_platform_type_of_yojson tree
                 path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : create_association_request) =
      let input =
        Json_serializers.create_association_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CreateAssociation" ~service ~context ~input
...
module CreateAssociationBatch =
  struct
    ...
    let request context (request : create_association_batch_request) =
      let input =
        Json_serializers.create_association_batch_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CreateAssociationBatch" ~service ~context
        ~input
...
module CreateDocument =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DocumentAlreadyExists") ->
            `DocumentAlreadyExists
              (Json_deserializers.document_already_exists_of_yojson tree path)
        | (_, "DocumentLimitExceeded") ->
            `DocumentLimitExceeded
              (Json_deserializers.document_limit_exceeded_of_yojson tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
        | (_, "InvalidDocumentContent") ->
            `InvalidDocumentContent
              (Json_deserializers.invalid_document_content_of_yojson tree
                 path)
        | (_, "InvalidDocumentSchemaVersion") ->
            `InvalidDocumentSchemaVersion
              (Json_deserializers.invalid_document_schema_version_of_yojson
                 tree path)
        | (_, "MaxDocumentSizeExceeded") ->
            `MaxDocumentSizeExceeded
              (Json_deserializers.max_document_size_exceeded_of_yojson tree
                 path)
        | (_, "TooManyUpdates") ->
            `TooManyUpdates
              (Json_deserializers.too_many_updates_of_yojson tree path)
    ...
    let request context (request : create_document_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CreateDocument" ~service ~context ~input
        ~output_deserializer:Json_deserializers.create_document_result_of_yojson
        ~error_deserializer
  end
module CreateMaintenanceWindow =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ResourceLimitExceededException") ->
            `ResourceLimitExceededException
              (Json_deserializers.resource_limit_exceeded_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : create_maintenance_window_request) =
      let input =
        Json_serializers.create_maintenance_window_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CreateMaintenanceWindow" ~service ~context
        ~input
...
module CreateOpsItem =
  struct
    let error_to_string =
      function
      | `InternalServerError _ -> "com.amazonaws.ssm#InternalServerError"
      | `OpsItemAccessDeniedException _ ->
          "com.amazonaws.ssm#OpsItemAccessDeniedException"
      | `OpsItemAlreadyExistsException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "OpsItemAccessDeniedException") ->
            `OpsItemAccessDeniedException
              (Json_deserializers.ops_item_access_denied_exception_of_yojson
                 tree path)
        | (_, "OpsItemAlreadyExistsException") ->
            `OpsItemAlreadyExistsException
              (Json_deserializers.ops_item_already_exists_exception_of_yojson
                 tree path)
        | (_, "OpsItemInvalidParameterException") ->
            `OpsItemInvalidParameterException
              (Json_deserializers.ops_item_invalid_parameter_exception_of_yojson
    ...
    let request context (request : create_ops_item_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CreateOpsItem" ~service ~context ~input
        ~output_deserializer:Json_deserializers.create_ops_item_response_of_yojson
        ~error_deserializer
  end
module CreateOpsMetadata =
  struct
    let error_to_string =
      function
      | `InternalServerError _ -> "com.amazonaws.ssm#InternalServerError"
      | `OpsMetadataAlreadyExistsException _ ->
      ...
      | `OpsMetadataLimitExceededException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "OpsMetadataAlreadyExistsException") ->
            `OpsMetadataAlreadyExistsException
              (Json_deserializers.ops_metadata_already_exists_exception_of_yojson
                 tree path)
        | (_, "OpsMetadataInvalidArgumentException") ->
            `OpsMetadataInvalidArgumentException
              (Json_deserializers.ops_metadata_invalid_argument_exception_of_yojson
                 tree path)
        | (_, "OpsMetadataLimitExceededException") ->
            `OpsMetadataLimitExceededException
              (Json_deserializers.ops_metadata_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "OpsMetadataTooManyUpdatesException") ->
            `OpsMetadataTooManyUpdatesException
              (Json_deserializers.ops_metadata_too_many_updates_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : create_ops_metadata_request) =
      let input =
        Json_serializers.create_ops_metadata_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CreateOpsMetadata" ~service ~context ~input
...
module CreatePatchBaseline =
  struct
    ...
    let request context (request : create_patch_baseline_request) =
      let input =
        Json_serializers.create_patch_baseline_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CreatePatchBaseline" ~service ~context ~input
...
module CreateResourceDataSync =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ResourceDataSyncAlreadyExistsException") ->
            `ResourceDataSyncAlreadyExistsException
              (Json_deserializers.resource_data_sync_already_exists_exception_of_yojson
                 tree path)
        | (_, "ResourceDataSyncCountExceededException") ->
            `ResourceDataSyncCountExceededException
              (Json_deserializers.resource_data_sync_count_exceeded_exception_of_yojson
                 tree path)
        | (_, "ResourceDataSyncInvalidConfigurationException") ->
            `ResourceDataSyncInvalidConfigurationException
              (Json_deserializers.resource_data_sync_invalid_configuration_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : create_resource_data_sync_request) =
      let input =
        Json_serializers.create_resource_data_sync_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.CreateResourceDataSync" ~service ~context
        ~input
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidActivation") ->
            `InvalidActivation
              (Json_deserializers.invalid_activation_of_yojson tree path)
        | (_, "InvalidActivationId") ->
            `InvalidActivationId
              (Json_deserializers.invalid_activation_id_of_yojson tree path)
        | (_, "TooManyUpdates") ->
            `TooManyUpdates
              (Json_deserializers.too_many_updates_of_yojson tree path)
        | _type -> handler tree path _type in
    ...
    let request context (request : delete_activation_request) =
      let input =
        Json_serializers.delete_activation_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteActivation" ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_activation_result_of_yojson
        ~error_deserializer
  end
module DeleteAssociation =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "AssociationDoesNotExist") ->
            `AssociationDoesNotExist
              (Json_deserializers.association_does_not_exist_of_yojson tree
                 path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
    ...
    let request context (request : delete_association_request) =
      let input =
        Json_serializers.delete_association_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteAssociation" ~service ~context ~input
...
module DeleteDocument =
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "AssociatedInstances") ->
            `AssociatedInstances
              (Json_deserializers.associated_instances_of_yojson tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
        | (_, "InvalidDocument") ->
        ...
        | (_, "InvalidDocumentOperation") ->
            `InvalidDocumentOperation
              (Json_deserializers.invalid_document_operation_of_yojson tree
                 path)
        | (_, "TooManyUpdates") ->
            `TooManyUpdates
              (Json_deserializers.too_many_updates_of_yojson tree path)
    ...
    let request context (request : delete_document_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteDocument" ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_document_result_of_yojson
        ~error_deserializer
  end
module DeleteInventory =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidDeleteInventoryParametersException") ->
            `InvalidDeleteInventoryParametersException
              (Json_deserializers.invalid_delete_inventory_parameters_exception_of_yojson
                 tree path)
        | (_, "InvalidInventoryRequestException") ->
            `InvalidInventoryRequestException
              (Json_deserializers.invalid_inventory_request_exception_of_yojson
                 tree path)
        | (_, "InvalidOptionException") ->
            `InvalidOptionException
              (Json_deserializers.invalid_option_exception_of_yojson tree
                 path)
        | (_, "InvalidTypeNameException") ->
            `InvalidTypeNameException
              (Json_deserializers.invalid_type_name_exception_of_yojson tree
                 path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : delete_inventory_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteInventory" ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_inventory_result_of_yojson
        ~error_deserializer
  end
module DeleteMaintenanceWindow =
  struct
    ...
    let request context (request : delete_maintenance_window_request) =
      let input =
        Json_serializers.delete_maintenance_window_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteMaintenanceWindow" ~service ~context
        ~input
...
module DeleteOpsItem =
  struct
    ...
    let request context (request : delete_ops_item_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteOpsItem" ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_ops_item_response_of_yojson
        ~error_deserializer
  end
module DeleteOpsMetadata =
  struct
    let error_to_string =
      ...
      | `OpsMetadataInvalidArgumentException _ ->
          "com.amazonaws.ssm#OpsMetadataInvalidArgumentException"
      | `OpsMetadataNotFoundException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "OpsMetadataNotFoundException") ->
            `OpsMetadataNotFoundException
              (Json_deserializers.ops_metadata_not_found_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : delete_ops_metadata_request) =
      let input =
        Json_serializers.delete_ops_metadata_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteOpsMetadata" ~service ~context ~input
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "ParameterNotFound") ->
            `ParameterNotFound
              (Json_deserializers.parameter_not_found_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : delete_parameter_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteParameter" ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_parameter_result_of_yojson
        ~error_deserializer
  end
module DeleteParameters =
  struct
    ...
    let request context (request : delete_parameters_request) =
      let input =
        Json_serializers.delete_parameters_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteParameters" ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_parameters_result_of_yojson
        ~error_deserializer
  end
module DeletePatchBaseline =
  struct
    ...
    let request context (request : delete_patch_baseline_request) =
      let input =
        Json_serializers.delete_patch_baseline_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeletePatchBaseline" ~service ~context ~input
...
module DeleteResourceDataSync =
  struct
    let error_to_string =
      ...
      | `ResourceDataSyncInvalidConfigurationException _ ->
          "com.amazonaws.ssm#ResourceDataSyncInvalidConfigurationException"
      | `ResourceDataSyncNotFoundException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "ResourceDataSyncNotFoundException") ->
            `ResourceDataSyncNotFoundException
              (Json_deserializers.resource_data_sync_not_found_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : delete_resource_data_sync_request) =
      let input =
        Json_serializers.delete_resource_data_sync_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteResourceDataSync" ~service ~context
        ~input
...
module DeleteResourcePolicy =
  struct
    let error_to_string =
      ...
      | `ResourcePolicyConflictException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "MalformedResourcePolicyDocumentException") ->
            `MalformedResourcePolicyDocumentException
              (Json_deserializers.malformed_resource_policy_document_exception_of_yojson
                 tree path)
        ...
        | (_, "ResourcePolicyConflictException") ->
            `ResourcePolicyConflictException
              (Json_deserializers.resource_policy_conflict_exception_of_yojson
                 tree path)
        | (_, "ResourcePolicyInvalidParameterException") ->
            `ResourcePolicyInvalidParameterException
              (Json_deserializers.resource_policy_invalid_parameter_exception_of_yojson
                 tree path)
    ...
    let request context (request : delete_resource_policy_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeleteResourcePolicy" ~service ~context ~input
...
module DeregisterManagedInstance =
  struct
    ...
    let request context (request : deregister_managed_instance_request) =
      let input =
        Json_serializers.deregister_managed_instance_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeregisterManagedInstance" ~service ~context
        ~input
...
module DeregisterPatchBaselineForPatchGroup =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.deregister_patch_baseline_for_patch_group_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeregisterPatchBaselineForPatchGroup" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.deregister_patch_baseline_for_patch_group_result_of_yojson
        ~error_deserializer
  end
module DeregisterTargetFromMaintenanceWindow =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "TargetInUseException") ->
            `TargetInUseException
              (Json_deserializers.target_in_use_exception_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context
      ...
      let input =
        Json_serializers.deregister_target_from_maintenance_window_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeregisterTargetFromMaintenanceWindow"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.deregister_target_from_maintenance_window_result_of_yojson
        ~error_deserializer
  end
module DeregisterTaskFromMaintenanceWindow =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.deregister_task_from_maintenance_window_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DeregisterTaskFromMaintenanceWindow" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.deregister_task_from_maintenance_window_result_of_yojson
        ~error_deserializer
  end
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidFilter") ->
            `InvalidFilter
              (Json_deserializers.invalid_filter_of_yojson tree path)
        | (_, "InvalidNextToken") ->
            `InvalidNextToken
              (Json_deserializers.invalid_next_token_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : describe_activations_request) =
      let input =
        Json_serializers.describe_activations_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeActivations" ~service ~context ~input
...
module DescribeAssociation =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidAssociationVersion") ->
            `InvalidAssociationVersion
              (Json_deserializers.invalid_association_version_of_yojson tree
                 path)
        | (_, "InvalidDocument") ->
            `InvalidDocument
              (Json_deserializers.invalid_document_of_yojson tree path)
    ...
    let request context (request : describe_association_request) =
      let input =
        Json_serializers.describe_association_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeAssociation" ~service ~context ~input
...
module DescribeAssociationExecutionTargets =
  struct
    let error_to_string =
      ...
      | `AssociationDoesNotExist _ ->
          "com.amazonaws.ssm#AssociationDoesNotExist"
      | `AssociationExecutionDoesNotExist _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "AssociationExecutionDoesNotExist") ->
            `AssociationExecutionDoesNotExist
              (Json_deserializers.association_execution_does_not_exist_of_yojson
                 tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_association_execution_targets_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeAssociationExecutionTargets" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.describe_association_execution_targets_result_of_yojson
        ~error_deserializer
  end
module DescribeAssociationExecutions =
  struct
    ...
    let request context (request : describe_association_executions_request) =
      let input =
        Json_serializers.describe_association_executions_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeAssociationExecutions" ~service
        ~context ~input
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidFilterKey") ->
            `InvalidFilterKey
              (Json_deserializers.invalid_filter_key_of_yojson tree path)
        | (_, "InvalidFilterValue") ->
            `InvalidFilterValue
              (Json_deserializers.invalid_filter_value_of_yojson tree path)
        | (_, "InvalidNextToken") ->
            `InvalidNextToken
              (Json_deserializers.invalid_next_token_of_yojson tree path)
        | _type -> handler tree path _type in
    ...
    let request context (request : describe_automation_executions_request) =
      let input =
        Json_serializers.describe_automation_executions_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeAutomationExecutions" ~service
        ~context ~input
...
module DescribeAutomationStepExecutions =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "AutomationExecutionNotFoundException") ->
            `AutomationExecutionNotFoundException
              (Json_deserializers.automation_execution_not_found_exception_of_yojson
                 tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_automation_step_executions_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeAutomationStepExecutions" ~service
        ~context ~input
...
module DescribeAvailablePatches =
  struct
    ...
    let request context (request : describe_available_patches_request) =
      let input =
        Json_serializers.describe_available_patches_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeAvailablePatches" ~service ~context
        ~input
...
module DescribeDocument =
  struct
    ...
    let request context (request : describe_document_request) =
      let input =
        Json_serializers.describe_document_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeDocument" ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_document_result_of_yojson
        ~error_deserializer
  end
module DescribeDocumentPermission =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidPermissionType") ->
            `InvalidPermissionType
              (Json_deserializers.invalid_permission_type_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : describe_document_permission_request) =
      let input =
        Json_serializers.describe_document_permission_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeDocumentPermission" ~service ~context
        ~input
...
module DescribeEffectiveInstanceAssociations =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_effective_instance_associations_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeEffectiveInstanceAssociations"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_effective_instance_associations_result_of_yojson
        ~error_deserializer
  end
module DescribeEffectivePatchesForPatchBaseline =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "UnsupportedOperatingSystem") ->
            `UnsupportedOperatingSystem
              (Json_deserializers.unsupported_operating_system_of_yojson tree
                 path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_effective_patches_for_patch_baseline_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeEffectivePatchesForPatchBaseline"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_effective_patches_for_patch_baseline_result_of_yojson
        ~error_deserializer
  end
module DescribeInstanceAssociationsStatus =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_instance_associations_status_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeInstanceAssociationsStatus" ~service
        ~context ~input
...
module DescribeInstanceInformation =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidInstanceInformationFilterValue") ->
            `InvalidInstanceInformationFilterValue
              (Json_deserializers.invalid_instance_information_filter_value_of_yojson
                 tree path)
        | (_, "InvalidNextToken") ->
            `InvalidNextToken
              (Json_deserializers.invalid_next_token_of_yojson tree path)
    ...
    let request context (request : describe_instance_information_request) =
      let input =
        Json_serializers.describe_instance_information_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeInstanceInformation" ~service ~context
        ~input
...
module DescribeInstancePatchStates =
  struct
    ...
    let request context (request : describe_instance_patch_states_request) =
      let input =
        Json_serializers.describe_instance_patch_states_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeInstancePatchStates" ~service ~context
        ~input
...
module DescribeInstancePatchStatesForPatchGroup =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_instance_patch_states_for_patch_group_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeInstancePatchStatesForPatchGroup"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_instance_patch_states_for_patch_group_result_of_yojson
        ~error_deserializer
  end
module DescribeInstancePatches =
  struct
    ...
    let request context (request : describe_instance_patches_request) =
      let input =
        Json_serializers.describe_instance_patches_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeInstancePatches" ~service ~context
        ~input
...
module DescribeInstanceProperties =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidInstancePropertyFilterValue") ->
            `InvalidInstancePropertyFilterValue
              (Json_deserializers.invalid_instance_property_filter_value_of_yojson
                 tree path)
        | (_, "InvalidNextToken") ->
            `InvalidNextToken
              (Json_deserializers.invalid_next_token_of_yojson tree path)
    ...
    let request context (request : describe_instance_properties_request) =
      let input =
        Json_serializers.describe_instance_properties_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeInstanceProperties" ~service ~context
        ~input
...
module DescribeInventoryDeletions =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidDeletionIdException") ->
            `InvalidDeletionIdException
              (Json_deserializers.invalid_deletion_id_exception_of_yojson
                 tree path)
        | (_, "InvalidNextToken") ->
            `InvalidNextToken
              (Json_deserializers.invalid_next_token_of_yojson tree path)
    ...
    let request context (request : describe_inventory_deletions_request) =
      let input =
        Json_serializers.describe_inventory_deletions_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeInventoryDeletions" ~service ~context
        ~input
  ...
  struct
    ...
    let request context
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ...
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_maintenance_window_execution_task_invocations_result_of_yojson
        ~error_deserializer
  end
module DescribeMaintenanceWindowExecutionTasks =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_maintenance_window_execution_tasks_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeMaintenanceWindowExecutionTasks"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_maintenance_window_execution_tasks_result_of_yojson
        ~error_deserializer
  end
module DescribeMaintenanceWindowExecutions =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_maintenance_window_executions_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeMaintenanceWindowExecutions" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.describe_maintenance_window_executions_result_of_yojson
        ~error_deserializer
  end
module DescribeMaintenanceWindowSchedule =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_maintenance_window_schedule_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeMaintenanceWindowSchedule" ~service
        ~context ~input
...
module DescribeMaintenanceWindowTargets =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_maintenance_window_targets_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeMaintenanceWindowTargets" ~service
        ~context ~input
...
module DescribeMaintenanceWindowTasks =
  struct
    ...
    let request context (request : describe_maintenance_window_tasks_request)
      =
      let input =
        Json_serializers.describe_maintenance_window_tasks_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeMaintenanceWindowTasks" ~service
        ~context ~input
...
module DescribeMaintenanceWindows =
  struct
    ...
    let request context (request : describe_maintenance_windows_request) =
      let input =
        Json_serializers.describe_maintenance_windows_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeMaintenanceWindows" ~service ~context
        ~input
...
module DescribeMaintenanceWindowsForTarget =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_maintenance_windows_for_target_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeMaintenanceWindowsForTarget" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.describe_maintenance_windows_for_target_result_of_yojson
        ~error_deserializer
  end
module DescribeOpsItems =
  struct
    ...
    let request context (request : describe_ops_items_request) =
      let input =
        Json_serializers.describe_ops_items_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeOpsItems" ~service ~context ~input
...
module DescribeParameters =
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidFilterOption") ->
            `InvalidFilterOption
              (Json_deserializers.invalid_filter_option_of_yojson tree path)
        | (_, "InvalidFilterValue") ->
            `InvalidFilterValue
              (Json_deserializers.invalid_filter_value_of_yojson tree path)
        | (_, "InvalidNextToken") ->
    ...
    let request context (request : describe_parameters_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeParameters" ~service ~context ~input
...
module DescribePatchBaselines =
  struct
    ...
    let request context (request : describe_patch_baselines_request) =
      let input =
        Json_serializers.describe_patch_baselines_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribePatchBaselines" ~service ~context
        ~input
...
module DescribePatchGroupState =
  struct
    ...
    let request context (request : describe_patch_group_state_request) =
      let input =
        Json_serializers.describe_patch_group_state_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribePatchGroupState" ~service ~context
        ~input
...
module DescribePatchGroups =
  struct
    ...
    let request context (request : describe_patch_groups_request) =
      let input =
        Json_serializers.describe_patch_groups_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribePatchGroups" ~service ~context ~input
...
module DescribePatchProperties =
  struct
    ...
    let request context (request : describe_patch_properties_request) =
      let input =
        Json_serializers.describe_patch_properties_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribePatchProperties" ~service ~context
        ~input
...
module DescribeSessions =
  struct
    ...
    let request context (request : describe_sessions_request) =
      let input =
        Json_serializers.describe_sessions_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DescribeSessions" ~service ~context ~input
...
module DisassociateOpsItemRelatedItem =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "OpsItemRelatedItemAssociationNotFoundException") ->
            `OpsItemRelatedItemAssociationNotFoundException
              (Json_deserializers.ops_item_related_item_association_not_found_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context
      ...
      let input =
        Json_serializers.disassociate_ops_item_related_item_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.DisassociateOpsItemRelatedItem" ~service
        ~context ~input
...
module GetAccessToken =
  struct
    ...
    let request context (request : get_access_token_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetAccessToken" ~service ~context ~input
...
module GetAutomationExecution =
  struct
    ...
    let request context (request : get_automation_execution_request) =
      let input =
        Json_serializers.get_automation_execution_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetAutomationExecution" ~service ~context
        ~input
...
module GetCalendarState =
  struct
    let error_to_string =
      ...
      | `UnsupportedCalendarException _ ->
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidDocumentType") ->
            `InvalidDocumentType
              (Json_deserializers.invalid_document_type_of_yojson tree path)
        | (_, "UnsupportedCalendarException") ->
            `UnsupportedCalendarException
              (Json_deserializers.unsupported_calendar_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : get_calendar_state_request) =
      let input =
        Json_serializers.get_calendar_state_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetCalendarState" ~service ~context ~input
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidPluginName") ->
            `InvalidPluginName
              (Json_deserializers.invalid_plugin_name_of_yojson tree path)
        | (_, "InvocationDoesNotExist") ->
            `InvocationDoesNotExist
              (Json_deserializers.invocation_does_not_exist_of_yojson tree
                 path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : get_command_invocation_request) =
      let input =
        Json_serializers.get_command_invocation_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetCommandInvocation" ~service ~context ~input
...
module GetConnectionStatus =
  struct
    ...
    let request context (request : get_connection_status_request) =
      let input =
        Json_serializers.get_connection_status_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetConnectionStatus" ~service ~context ~input
...
module GetDefaultPatchBaseline =
  struct
    ...
    let request context (request : get_default_patch_baseline_request) =
      let input =
        Json_serializers.get_default_patch_baseline_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetDefaultPatchBaseline" ~service ~context
        ~input
...
module GetDeployablePatchSnapshotForInstance =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "UnsupportedFeatureRequiredException") ->
            `UnsupportedFeatureRequiredException
              (Json_deserializers.unsupported_feature_required_exception_of_yojson
                 tree path)
        | (_, "UnsupportedOperatingSystem") ->
            `UnsupportedOperatingSystem
              (Json_deserializers.unsupported_operating_system_of_yojson tree
    ...
    let request context
      ...
      let input =
        Json_serializers.get_deployable_patch_snapshot_for_instance_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetDeployablePatchSnapshotForInstance"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_deployable_patch_snapshot_for_instance_result_of_yojson
        ~error_deserializer
  end
module GetDocument =
  struct
    ...
    let request context (request : get_document_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSSM.GetDocument"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_document_result_of_yojson
        ~error_deserializer
  end
module GetExecutionPreview =
  struct
    ...
    let request context (request : get_execution_preview_request) =
      let input =
        Json_serializers.get_execution_preview_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetExecutionPreview" ~service ~context ~input
...
module GetInventory =
  struct
    let error_to_string =
      function
      | `InternalServerError _ -> "com.amazonaws.ssm#InternalServerError"
      | `InvalidAggregatorException _ ->
          "com.amazonaws.ssm#InvalidAggregatorException"
      | `InvalidFilter _ -> "com.amazonaws.ssm#InvalidFilter"
      | `InvalidInventoryGroupException _ ->
          "com.amazonaws.ssm#InvalidInventoryGroupException"
      | `InvalidNextToken _ -> "com.amazonaws.ssm#InvalidNextToken"
      | `InvalidResultAttributeException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidAggregatorException") ->
            `InvalidAggregatorException
              (Json_deserializers.invalid_aggregator_exception_of_yojson tree
                 path)
        | (_, "InvalidFilter") ->
            `InvalidFilter
              (Json_deserializers.invalid_filter_of_yojson tree path)
        | (_, "InvalidInventoryGroupException") ->
            `InvalidInventoryGroupException
              (Json_deserializers.invalid_inventory_group_exception_of_yojson
                 tree path)
        | (_, "InvalidNextToken") ->
            `InvalidNextToken
              (Json_deserializers.invalid_next_token_of_yojson tree path)
        | (_, "InvalidResultAttributeException") ->
            `InvalidResultAttributeException
              (Json_deserializers.invalid_result_attribute_exception_of_yojson
                 tree path)
        | (_, "InvalidTypeNameException") ->
            `InvalidTypeNameException
              (Json_deserializers.invalid_type_name_exception_of_yojson tree
    ...
    let request context (request : get_inventory_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetInventory" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_inventory_result_of_yojson
        ~error_deserializer
  end
module GetInventorySchema =
  struct
    ...
    let request context (request : get_inventory_schema_request) =
      let input =
        Json_serializers.get_inventory_schema_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetInventorySchema" ~service ~context ~input
...
module GetMaintenanceWindow =
  struct
    ...
    let request context (request : get_maintenance_window_request) =
      let input =
        Json_serializers.get_maintenance_window_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetMaintenanceWindow" ~service ~context ~input
...
module GetMaintenanceWindowExecution =
  struct
    ...
    let request context (request : get_maintenance_window_execution_request)
      =
      let input =
        Json_serializers.get_maintenance_window_execution_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetMaintenanceWindowExecution" ~service
        ~context ~input
...
module GetMaintenanceWindowExecutionTask =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.get_maintenance_window_execution_task_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetMaintenanceWindowExecutionTask" ~service
        ~context ~input
...
module GetMaintenanceWindowExecutionTaskInvocation =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.get_maintenance_window_execution_task_invocation_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetMaintenanceWindowExecutionTaskInvocation"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_maintenance_window_execution_task_invocation_result_of_yojson
        ~error_deserializer
  end
module GetMaintenanceWindowTask =
  struct
    ...
    let request context (request : get_maintenance_window_task_request) =
      let input =
        Json_serializers.get_maintenance_window_task_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetMaintenanceWindowTask" ~service ~context
        ~input
...
module GetOpsItem =
  struct
    ...
    let request context (request : get_ops_item_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSSM.GetOpsItem"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_ops_item_response_of_yojson
        ~error_deserializer
  end
module GetOpsMetadata =
  struct
    ...
    let request context (request : get_ops_metadata_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetOpsMetadata" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_ops_metadata_result_of_yojson
        ~error_deserializer
  end
module GetOpsSummary =
  struct
    ...
    let request context (request : get_ops_summary_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetOpsSummary" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_ops_summary_result_of_yojson
        ~error_deserializer
  end
module GetParameter =
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidKeyId") ->
            `InvalidKeyId
              (Json_deserializers.invalid_key_id_of_yojson tree path)
        | (_, "ParameterNotFound") ->
            `ParameterNotFound
              (Json_deserializers.parameter_not_found_of_yojson tree path)
        | (_, "ParameterVersionNotFound") ->
            `ParameterVersionNotFound
              (Json_deserializers.parameter_version_not_found_of_yojson tree
                 path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : get_parameter_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetParameter" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_parameter_result_of_yojson
        ~error_deserializer
  end
module GetParameterHistory =
  struct
    ...
    let request context (request : get_parameter_history_request) =
      let input =
        Json_serializers.get_parameter_history_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetParameterHistory" ~service ~context ~input
...
module GetParameters =
  struct
    ...
    let request context (request : get_parameters_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetParameters" ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_parameters_result_of_yojson
        ~error_deserializer
  end
module GetParametersByPath =
  struct
    ...
    let request context (request : get_parameters_by_path_request) =
      let input =
        Json_serializers.get_parameters_by_path_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetParametersByPath" ~service ~context ~input
...
module GetPatchBaseline =
  struct
    ...
    let request context (request : get_patch_baseline_request) =
      let input =
        Json_serializers.get_patch_baseline_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetPatchBaseline" ~service ~context ~input
...
module GetPatchBaselineForPatchGroup =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.get_patch_baseline_for_patch_group_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetPatchBaselineForPatchGroup" ~service
        ~context ~input
...
module GetResourcePolicies =
  struct
    ...
    let request context (request : get_resource_policies_request) =
      let input =
        Json_serializers.get_resource_policies_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetResourcePolicies" ~service ~context ~input
...
module GetServiceSetting =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ServiceSettingNotFound") ->
            `ServiceSettingNotFound
              (Json_deserializers.service_setting_not_found_of_yojson tree
                 path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : get_service_setting_request) =
      let input =
        Json_serializers.get_service_setting_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.GetServiceSetting" ~service ~context ~input
...
module LabelParameterVersion =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ParameterVersionLabelLimitExceeded") ->
            `ParameterVersionLabelLimitExceeded
              (Json_deserializers.parameter_version_label_limit_exceeded_of_yojson
                 tree path)
        | (_, "ParameterVersionNotFound") ->
            `ParameterVersionNotFound
              (Json_deserializers.parameter_version_not_found_of_yojson tree
    ...
    let request context (request : label_parameter_version_request) =
      let input =
        Json_serializers.label_parameter_version_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.LabelParameterVersion" ~service ~context
        ~input
...
module ListAssociationVersions =
  struct
    ...
    let request context (request : list_association_versions_request) =
      let input =
        Json_serializers.list_association_versions_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListAssociationVersions" ~service ~context
        ~input
...
module ListAssociations =
  struct
    ...
    let request context (request : list_associations_request) =
      let input =
        Json_serializers.list_associations_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListAssociations" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_associations_result_of_yojson
        ~error_deserializer
  end
module ListCommandInvocations =
  struct
    ...
    let request context (request : list_command_invocations_request) =
      let input =
        Json_serializers.list_command_invocations_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListCommandInvocations" ~service ~context
        ~input
...
module ListCommands =
  struct
    ...
    let request context (request : list_commands_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListCommands" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_commands_result_of_yojson
        ~error_deserializer
  end
module ListComplianceItems =
  struct
    ...
    let request context (request : list_compliance_items_request) =
      let input =
        Json_serializers.list_compliance_items_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListComplianceItems" ~service ~context ~input
...
module ListComplianceSummaries =
  struct
    ...
    let request context (request : list_compliance_summaries_request) =
      let input =
        Json_serializers.list_compliance_summaries_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListComplianceSummaries" ~service ~context
        ~input
...
module ListDocumentMetadataHistory =
  struct
    ...
    let request context (request : list_document_metadata_history_request) =
      let input =
        Json_serializers.list_document_metadata_history_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListDocumentMetadataHistory" ~service ~context
        ~input
...
module ListDocumentVersions =
  struct
    ...
    let request context (request : list_document_versions_request) =
      let input =
        Json_serializers.list_document_versions_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListDocumentVersions" ~service ~context ~input
...
module ListDocuments =
  struct
    ...
    let request context (request : list_documents_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListDocuments" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_documents_result_of_yojson
        ~error_deserializer
  end
module ListInventoryEntries =
  struct
    ...
    let request context (request : list_inventory_entries_request) =
      let input =
        Json_serializers.list_inventory_entries_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListInventoryEntries" ~service ~context ~input
  ...
  struct
    let error_to_string =
      ...
      | `UnsupportedOperationException _ ->
          "com.amazonaws.ssm#UnsupportedOperationException"
      | #Smaws_Lib.Protocols.AwsJson.error as e ->
          Smaws_Lib.Protocols.AwsJson.error_to_string e
    let error_deserializer tree path =
      let handler handler tree path =
    ...
    let request context (request : list_nodes_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSSM.ListNodes"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_nodes_result_of_yojson
        ~error_deserializer
  end
module ListNodesSummary =
  struct
    ...
    let request context (request : list_nodes_summary_request) =
      let input =
        Json_serializers.list_nodes_summary_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListNodesSummary" ~service ~context ~input
...
module ListOpsItemEvents =
  struct
    ...
    let request context (request : list_ops_item_events_request) =
      let input =
        Json_serializers.list_ops_item_events_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListOpsItemEvents" ~service ~context ~input
...
module ListOpsItemRelatedItems =
  struct
    ...
    let request context (request : list_ops_item_related_items_request) =
      let input =
        Json_serializers.list_ops_item_related_items_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListOpsItemRelatedItems" ~service ~context
        ~input
...
module ListOpsMetadata =
  struct
    ...
    let request context (request : list_ops_metadata_request) =
      let input =
        Json_serializers.list_ops_metadata_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListOpsMetadata" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_ops_metadata_result_of_yojson
        ~error_deserializer
  end
module ListResourceComplianceSummaries =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_resource_compliance_summaries_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListResourceComplianceSummaries" ~service
        ~context ~input
...
module ListResourceDataSync =
  struct
    ...
    let request context (request : list_resource_data_sync_request) =
      let input =
        Json_serializers.list_resource_data_sync_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListResourceDataSync" ~service ~context ~input
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ListTagsForResource" ~service ~context ~input
...
module ModifyDocumentPermission =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DocumentPermissionLimit") ->
            `DocumentPermissionLimit
              (Json_deserializers.document_permission_limit_of_yojson tree
                 path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
    ...
    let request context (request : modify_document_permission_request) =
      let input =
        Json_serializers.modify_document_permission_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ModifyDocumentPermission" ~service ~context
        ~input
...
module PutComplianceItems =
  struct
    let error_to_string =
      ...
      | `InternalServerError _ -> "com.amazonaws.ssm#InternalServerError"
      | `InvalidItemContentException _ ->
          "com.amazonaws.ssm#InvalidItemContentException"
      | `InvalidResourceId _ -> "com.amazonaws.ssm#InvalidResourceId"
      | `InvalidResourceType _ -> "com.amazonaws.ssm#InvalidResourceType"
      | `ItemSizeLimitExceededException _ ->
          "com.amazonaws.ssm#ItemSizeLimitExceededException"
      | `TotalSizeLimitExceededException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "ComplianceTypeCountLimitExceededException") ->
            `ComplianceTypeCountLimitExceededException
              (Json_deserializers.compliance_type_count_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
        | (_, "InvalidItemContentException") ->
            `InvalidItemContentException
              (Json_deserializers.invalid_item_content_exception_of_yojson
                 tree path)
        | (_, "InvalidResourceId") ->
            `InvalidResourceId
              (Json_deserializers.invalid_resource_id_of_yojson tree path)
        ...
        | (_, "ItemSizeLimitExceededException") ->
            `ItemSizeLimitExceededException
              (Json_deserializers.item_size_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "TotalSizeLimitExceededException") ->
            `TotalSizeLimitExceededException
              (Json_deserializers.total_size_limit_exceeded_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : put_compliance_items_request) =
      let input =
        Json_serializers.put_compliance_items_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.PutComplianceItems" ~service ~context ~input
...
module PutInventory =
  struct
    let error_to_string =
      ...
      | `InvalidTypeNameException _ ->
          "com.amazonaws.ssm#InvalidTypeNameException"
      | `ItemContentMismatchException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "CustomSchemaCountLimitExceededException") ->
            `CustomSchemaCountLimitExceededException
              (Json_deserializers.custom_schema_count_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
        ...
        | (_, "InvalidInventoryItemContextException") ->
            `InvalidInventoryItemContextException
              (Json_deserializers.invalid_inventory_item_context_exception_of_yojson
                 tree path)
        | (_, "InvalidItemContentException") ->
            `InvalidItemContentException
              (Json_deserializers.invalid_item_content_exception_of_yojson
        ...
        | (_, "ItemContentMismatchException") ->
            `ItemContentMismatchException
              (Json_deserializers.item_content_mismatch_exception_of_yojson
                 tree path)
        | (_, "ItemSizeLimitExceededException") ->
            `ItemSizeLimitExceededException
              (Json_deserializers.item_size_limit_exceeded_exception_of_yojson
        ...
        | (_, "SubTypeCountLimitExceededException") ->
            `SubTypeCountLimitExceededException
              (Json_deserializers.sub_type_count_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "TotalSizeLimitExceededException") ->
            `TotalSizeLimitExceededException
              (Json_deserializers.total_size_limit_exceeded_exception_of_yojson
        ...
        | (_, "UnsupportedInventoryItemContextException") ->
            `UnsupportedInventoryItemContextException
              (Json_deserializers.unsupported_inventory_item_context_exception_of_yojson
                 tree path)
        | (_, "UnsupportedInventorySchemaVersionException") ->
            `UnsupportedInventorySchemaVersionException
              (Json_deserializers.unsupported_inventory_schema_version_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : put_inventory_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.PutInventory" ~service ~context ~input
        ~output_deserializer:Json_deserializers.put_inventory_result_of_yojson
        ~error_deserializer
  end
module PutParameter =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "HierarchyLevelLimitExceededException") ->
            `HierarchyLevelLimitExceededException
              (Json_deserializers.hierarchy_level_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "HierarchyTypeMismatchException") ->
            `HierarchyTypeMismatchException
              (Json_deserializers.hierarchy_type_mismatch_exception_of_yojson
                 tree path)
        | (_, "IncompatiblePolicyException") ->
            `IncompatiblePolicyException
              (Json_deserializers.incompatible_policy_exception_of_yojson
                 tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
        | (_, "InvalidAllowedPatternException") ->
            `InvalidAllowedPatternException
              (Json_deserializers.invalid_allowed_pattern_exception_of_yojson
                 tree path)
        | (_, "InvalidKeyId") ->
            `InvalidKeyId
              (Json_deserializers.invalid_key_id_of_yojson tree path)
        | (_, "InvalidPolicyAttributeException") ->
            `InvalidPolicyAttributeException
              (Json_deserializers.invalid_policy_attribute_exception_of_yojson
                 tree path)
        | (_, "InvalidPolicyTypeException") ->
            `InvalidPolicyTypeException
              (Json_deserializers.invalid_policy_type_exception_of_yojson
                 tree path)
        | (_, "ParameterAlreadyExists") ->
            `ParameterAlreadyExists
              (Json_deserializers.parameter_already_exists_of_yojson tree
                 path)
        | (_, "ParameterLimitExceeded") ->
            `ParameterLimitExceeded
              (Json_deserializers.parameter_limit_exceeded_of_yojson tree
                 path)
        | (_, "ParameterMaxVersionLimitExceeded") ->
            `ParameterMaxVersionLimitExceeded
              (Json_deserializers.parameter_max_version_limit_exceeded_of_yojson
                 tree path)
        | (_, "ParameterPatternMismatchException") ->
            `ParameterPatternMismatchException
              (Json_deserializers.parameter_pattern_mismatch_exception_of_yojson
                 tree path)
        | (_, "PoliciesLimitExceededException") ->
            `PoliciesLimitExceededException
              (Json_deserializers.policies_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "TooManyUpdates") ->
            `TooManyUpdates
              (Json_deserializers.too_many_updates_of_yojson tree path)
        | (_, "UnsupportedParameterType") ->
            `UnsupportedParameterType
              (Json_deserializers.unsupported_parameter_type_of_yojson tree
                 path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : put_parameter_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.PutParameter" ~service ~context ~input
        ~output_deserializer:Json_deserializers.put_parameter_result_of_yojson
        ~error_deserializer
  end
module PutResourcePolicy =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ResourcePolicyLimitExceededException") ->
            `ResourcePolicyLimitExceededException
              (Json_deserializers.resource_policy_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "ResourcePolicyNotFoundException") ->
            `ResourcePolicyNotFoundException
              (Json_deserializers.resource_policy_not_found_exception_of_yojson
    ...
    let request context (request : put_resource_policy_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.PutResourcePolicy" ~service ~context ~input
...
module RegisterDefaultPatchBaseline =
  struct
    ...
    let request context (request : register_default_patch_baseline_request) =
      let input =
        Json_serializers.register_default_patch_baseline_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.RegisterDefaultPatchBaseline" ~service
        ~context ~input
...
module RegisterPatchBaselineForPatchGroup =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "AlreadyExistsException") ->
            `AlreadyExistsException
              (Json_deserializers.already_exists_exception_of_yojson tree
                 path)
        | (_, "DoesNotExistException") ->
            `DoesNotExistException
              (Json_deserializers.does_not_exist_exception_of_yojson tree
    ...
    let request context
      ...
      let input =
        Json_serializers.register_patch_baseline_for_patch_group_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.RegisterPatchBaselineForPatchGroup" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.register_patch_baseline_for_patch_group_result_of_yojson
        ~error_deserializer
  end
module RegisterTargetWithMaintenanceWindow =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.register_target_with_maintenance_window_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.RegisterTargetWithMaintenanceWindow" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.register_target_with_maintenance_window_result_of_yojson
        ~error_deserializer
  end
module RegisterTaskWithMaintenanceWindow =
  struct
    let error_to_string =
      function
      | `DoesNotExistException _ -> "com.amazonaws.ssm#DoesNotExistException"
      | `FeatureNotAvailableException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "FeatureNotAvailableException") ->
            `FeatureNotAvailableException
              (Json_deserializers.feature_not_available_exception_of_yojson
                 tree path)
        | (_, "IdempotentParameterMismatch") ->
            `IdempotentParameterMismatch
              (Json_deserializers.idempotent_parameter_mismatch_of_yojson
    ...
    let request context
      ...
      let input =
        Json_serializers.register_task_with_maintenance_window_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.RegisterTaskWithMaintenanceWindow" ~service
        ~context ~input
...
module RemoveTagsFromResource =
  struct
    ...
    let request context (request : remove_tags_from_resource_request) =
      let input =
        Json_serializers.remove_tags_from_resource_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.RemoveTagsFromResource" ~service ~context
        ~input
...
module ResetServiceSetting =
  struct
    ...
    let request context (request : reset_service_setting_request) =
      let input =
        Json_serializers.reset_service_setting_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ResetServiceSetting" ~service ~context ~input
...
module ResumeSession =
  struct
    ...
    let request context (request : resume_session_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.ResumeSession" ~service ~context ~input
        ~output_deserializer:Json_deserializers.resume_session_response_of_yojson
        ~error_deserializer
  end
module SendAutomationSignal =
  struct
    let error_to_string =
      ...
      | `AutomationExecutionNotFoundException _ ->
          "com.amazonaws.ssm#AutomationExecutionNotFoundException"
      | `AutomationStepNotFoundException _ ->
          "com.amazonaws.ssm#AutomationStepNotFoundException"
      | `InternalServerError _ -> "com.amazonaws.ssm#InternalServerError"
      | `InvalidAutomationSignalException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "AutomationStepNotFoundException") ->
            `AutomationStepNotFoundException
              (Json_deserializers.automation_step_not_found_exception_of_yojson
                 tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
        | (_, "InvalidAutomationSignalException") ->
            `InvalidAutomationSignalException
              (Json_deserializers.invalid_automation_signal_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : send_automation_signal_request) =
      let input =
        Json_serializers.send_automation_signal_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.SendAutomationSignal" ~service ~context ~input
...
module SendCommand =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidNotificationConfig") ->
            `InvalidNotificationConfig
              (Json_deserializers.invalid_notification_config_of_yojson tree
                 path)
        | (_, "InvalidOutputFolder") ->
            `InvalidOutputFolder
              (Json_deserializers.invalid_output_folder_of_yojson tree path)
        | (_, "InvalidParameters") ->
            `InvalidParameters
              (Json_deserializers.invalid_parameters_of_yojson tree path)
        | (_, "InvalidRole") ->
            `InvalidRole
              (Json_deserializers.invalid_role_of_yojson tree path)
        | (_, "MaxDocumentSizeExceeded") ->
            `MaxDocumentSizeExceeded
              (Json_deserializers.max_document_size_exceeded_of_yojson tree
                 path)
    ...
    let request context (request : send_command_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSSM.SendCommand"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.send_command_result_of_yojson
        ~error_deserializer
  end
module StartAccessRequest =
  struct
    ...
    let request context (request : start_access_request_request) =
      let input =
        Json_serializers.start_access_request_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.StartAccessRequest" ~service ~context ~input
...
module StartAssociationsOnce =
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InvalidAssociation") ->
            `InvalidAssociation
              (Json_deserializers.invalid_association_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : start_associations_once_request) =
      let input =
        Json_serializers.start_associations_once_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.StartAssociationsOnce" ~service ~context
        ~input
...
module StartAutomationExecution =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "AutomationDefinitionNotFoundException") ->
            `AutomationDefinitionNotFoundException
              (Json_deserializers.automation_definition_not_found_exception_of_yojson
                 tree path)
        | (_, "AutomationDefinitionVersionNotFoundException") ->
            `AutomationDefinitionVersionNotFoundException
              (Json_deserializers.automation_definition_version_not_found_exception_of_yojson
                 tree path)
        | (_, "AutomationExecutionLimitExceededException") ->
            `AutomationExecutionLimitExceededException
              (Json_deserializers.automation_execution_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "IdempotentParameterMismatch") ->
            `IdempotentParameterMismatch
              (Json_deserializers.idempotent_parameter_mismatch_of_yojson
        ...
        | (_, "InvalidAutomationExecutionParametersException") ->
            `InvalidAutomationExecutionParametersException
              (Json_deserializers.invalid_automation_execution_parameters_exception_of_yojson
                 tree path)
        | (_, "InvalidTarget") ->
            `InvalidTarget
              (Json_deserializers.invalid_target_of_yojson tree path)
    ...
    let request context (request : start_automation_execution_request) =
      let input =
        Json_serializers.start_automation_execution_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.StartAutomationExecution" ~service ~context
        ~input
...
module StartChangeRequestExecution =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "AutomationDefinitionNotApprovedException") ->
            `AutomationDefinitionNotApprovedException
              (Json_deserializers.automation_definition_not_approved_exception_of_yojson
                 tree path)
        | (_, "AutomationDefinitionNotFoundException") ->
            `AutomationDefinitionNotFoundException
              (Json_deserializers.automation_definition_not_found_exception_of_yojson
    ...
    let request context (request : start_change_request_execution_request) =
      let input =
        Json_serializers.start_change_request_execution_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.StartChangeRequestExecution" ~service ~context
        ~input
...
module StartExecutionPreview =
  struct
    ...
    let request context (request : start_execution_preview_request) =
      let input =
        Json_serializers.start_execution_preview_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.StartExecutionPreview" ~service ~context
        ~input
...
module StartSession =
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "TargetNotConnected") ->
            `TargetNotConnected
              (Json_deserializers.target_not_connected_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : start_session_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.StartSession" ~service ~context ~input
        ~output_deserializer:Json_deserializers.start_session_response_of_yojson
        ~error_deserializer
  end
module StopAutomationExecution =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidAutomationStatusUpdateException") ->
            `InvalidAutomationStatusUpdateException
              (Json_deserializers.invalid_automation_status_update_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : stop_automation_execution_request) =
      let input =
        Json_serializers.stop_automation_execution_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.StopAutomationExecution" ~service ~context
        ~input
...
module TerminateSession =
  struct
    ...
    let request context (request : terminate_session_request) =
      let input =
        Json_serializers.terminate_session_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.TerminateSession" ~service ~context ~input
...
module UnlabelParameterVersion =
  struct
    ...
    let request context (request : unlabel_parameter_version_request) =
      let input =
        Json_serializers.unlabel_parameter_version_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UnlabelParameterVersion" ~service ~context
        ~input
...
module UpdateAssociation =
  struct
    let error_to_string =
      ...
      | `AssociationDoesNotExist _ ->
          "com.amazonaws.ssm#AssociationDoesNotExist"
      | `AssociationVersionLimitExceeded _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "AssociationVersionLimitExceeded") ->
            `AssociationVersionLimitExceeded
              (Json_deserializers.association_version_limit_exceeded_of_yojson
                 tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
        ...
        | (_, "InvalidUpdate") ->
            `InvalidUpdate
              (Json_deserializers.invalid_update_of_yojson tree path)
        | (_, "TooManyUpdates") ->
            `TooManyUpdates
              (Json_deserializers.too_many_updates_of_yojson tree path)
        | _type -> handler tree path _type in
    ...
    let request context (request : update_association_request) =
      let input =
        Json_serializers.update_association_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateAssociation" ~service ~context ~input
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "StatusUnchanged") ->
            `StatusUnchanged
              (Json_deserializers.status_unchanged_of_yojson tree path)
        | (_, "TooManyUpdates") ->
            `TooManyUpdates
              (Json_deserializers.too_many_updates_of_yojson tree path)
        | _type -> handler tree path _type in
    ...
    let request context (request : update_association_status_request) =
      let input =
        Json_serializers.update_association_status_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateAssociationStatus" ~service ~context
        ~input
...
module UpdateDocument =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DocumentVersionLimitExceeded") ->
            `DocumentVersionLimitExceeded
              (Json_deserializers.document_version_limit_exceeded_of_yojson
                 tree path)
        | (_, "DuplicateDocumentContent") ->
            `DuplicateDocumentContent
              (Json_deserializers.duplicate_document_content_of_yojson tree
                 path)
        | (_, "DuplicateDocumentVersionName") ->
            `DuplicateDocumentVersionName
              (Json_deserializers.duplicate_document_version_name_of_yojson
                 tree path)
        | (_, "InternalServerError") ->
            `InternalServerError
              (Json_deserializers.internal_server_error_of_yojson tree path)
    ...
    let request context (request : update_document_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateDocument" ~service ~context ~input
        ~output_deserializer:Json_deserializers.update_document_result_of_yojson
        ~error_deserializer
  end
module UpdateDocumentDefaultVersion =
  struct
    ...
    let request context (request : update_document_default_version_request) =
      let input =
        Json_serializers.update_document_default_version_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateDocumentDefaultVersion" ~service
        ~context ~input
...
module UpdateDocumentMetadata =
  struct
    ...
    let request context (request : update_document_metadata_request) =
      let input =
        Json_serializers.update_document_metadata_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateDocumentMetadata" ~service ~context
        ~input
...
module UpdateMaintenanceWindow =
  struct
    ...
    let request context (request : update_maintenance_window_request) =
      let input =
        Json_serializers.update_maintenance_window_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateMaintenanceWindow" ~service ~context
        ~input
...
module UpdateMaintenanceWindowTarget =
  struct
    ...
    let request context (request : update_maintenance_window_target_request)
      =
      let input =
        Json_serializers.update_maintenance_window_target_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateMaintenanceWindowTarget" ~service
        ~context ~input
...
module UpdateMaintenanceWindowTask =
  struct
    ...
    let request context (request : update_maintenance_window_task_request) =
      let input =
        Json_serializers.update_maintenance_window_task_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateMaintenanceWindowTask" ~service ~context
        ~input
...
module UpdateManagedInstanceRole =
  struct
    ...
    let request context (request : update_managed_instance_role_request) =
      let input =
        Json_serializers.update_managed_instance_role_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateManagedInstanceRole" ~service ~context
        ~input
...
module UpdateOpsItem =
  struct
    ...
    let request context (request : update_ops_item_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateOpsItem" ~service ~context ~input
        ~output_deserializer:Json_deserializers.update_ops_item_response_of_yojson
        ~error_deserializer
  end
module UpdateOpsMetadata =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "OpsMetadataKeyLimitExceededException") ->
            `OpsMetadataKeyLimitExceededException
              (Json_deserializers.ops_metadata_key_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "OpsMetadataNotFoundException") ->
            `OpsMetadataNotFoundException
              (Json_deserializers.ops_metadata_not_found_exception_of_yojson
    ...
    let request context (request : update_ops_metadata_request) =
      let input =
        Json_serializers.update_ops_metadata_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateOpsMetadata" ~service ~context ~input
...
module UpdatePatchBaseline =
  struct
    ...
    let request context (request : update_patch_baseline_request) =
      let input =
        Json_serializers.update_patch_baseline_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdatePatchBaseline" ~service ~context ~input
...
module UpdateResourceDataSync =
  struct
    let error_to_string =
      function
      | `InternalServerError _ -> "com.amazonaws.ssm#InternalServerError"
      | `ResourceDataSyncConflictException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "ResourceDataSyncConflictException") ->
            `ResourceDataSyncConflictException
              (Json_deserializers.resource_data_sync_conflict_exception_of_yojson
                 tree path)
        | (_, "ResourceDataSyncInvalidConfigurationException") ->
            `ResourceDataSyncInvalidConfigurationException
              (Json_deserializers.resource_data_sync_invalid_configuration_exception_of_yojson
    ...
    let request context (request : update_resource_data_sync_request) =
      let input =
        Json_serializers.update_resource_data_sync_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateResourceDataSync" ~service ~context
        ~input
...
module UpdateServiceSetting =
  struct
    ...
    let request context (request : update_service_setting_request) =
      let input =
        Json_serializers.update_service_setting_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AmazonSSM.UpdateServiceSetting" ~service ~context ~input
