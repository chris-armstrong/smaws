...
module CreateDocument =
  struct
    ...
    let request context (request : create_document_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_document_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateMaintenanceWindow =
  struct
    ...
    let request context (request : create_maintenance_window_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_maintenance_window_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateOpsItem =
  struct
    ...
    let request context (request : create_ops_item_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_ops_item_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateResourceDataSync =
  struct
    ...
    let request context (request : create_resource_data_sync_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_resource_data_sync_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteDocument =
  struct
    ...
    let request context (request : delete_document_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_document_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteInventory =
  struct
    ...
    let request context (request : delete_inventory_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_inventory_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteMaintenanceWindow =
  struct
    ...
    let request context (request : delete_maintenance_window_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_maintenance_window_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteOpsItem =
  struct
    ...
    let request context (request : delete_ops_item_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_ops_item_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteParameter =
  struct
    ...
    let request context (request : delete_parameter_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_parameter_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteResourceDataSync =
  struct
    ...
    let request context (request : delete_resource_data_sync_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_resource_data_sync_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.deregister_task_from_maintenance_window_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMDeregisterTaskFromMaintenanceWindow" ~service
          ~config:context.config ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_association_execution_targets_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMDescribeAssociationExecutionTargets" ~service
          ~config:context.config ~http:context.http ~input
...
module DescribeAvailablePatches =
  struct
    ...
    let request context (request : describe_available_patches_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_available_patches_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_instance_associations_status_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMDescribeInstanceAssociationsStatus" ~service
          ~config:context.config ~http:context.http ~input
...
module DescribeInstancePatches =
  struct
    ...
    let request context (request : describe_instance_patches_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_instance_patches_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_maintenance_window_executions_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMDescribeMaintenanceWindowExecutions" ~service
          ~config:context.config ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_maintenance_windows_for_target_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMDescribeMaintenanceWindowsForTarget" ~service
          ~config:context.config ~http:context.http ~input
...
module DescribePatchGroupState =
  struct
    ...
    let request context (request : describe_patch_group_state_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_patch_group_state_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribePatchProperties =
  struct
    ...
    let request context (request : describe_patch_properties_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_patch_properties_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module GetAccessToken =
  struct
    ...
    let request context (request : get_access_token_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_access_token_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module GetDefaultPatchBaseline =
  struct
    ...
    let request context (request : get_default_patch_baseline_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_default_patch_baseline_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : get_document_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMGetDocument" ~service ~config:context.config
  ...
  struct
    ...
    let request context (request : get_inventory_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMGetInventory" ~service ~config:context.config
          ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : get_ops_item_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSSMGetOpsItem"
          ~service ~config:context.config ~http:context.http ~input
...
module GetOpsMetadata =
  struct
    ...
    let request context (request : get_ops_metadata_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_ops_metadata_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module GetOpsSummary =
  struct
    ...
    let request context (request : get_ops_summary_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_ops_summary_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : get_parameter_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMGetParameter" ~service ~config:context.config
          ~http:context.http ~input
...
module ListAssociationVersions =
  struct
    ...
    let request context (request : list_association_versions_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_association_versions_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : list_commands_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMListCommands" ~service ~config:context.config
          ~http:context.http ~input
...
module ListComplianceSummaries =
  struct
    ...
    let request context (request : list_compliance_summaries_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_compliance_summaries_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : list_nodes_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AmazonSSMListNodes"
          ~service ~config:context.config ~http:context.http ~input
...
module ModifyDocumentPermission =
  struct
    ...
    let request context (request : modify_document_permission_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.modify_document_permission_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : put_inventory_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMPutInventory" ~service ~config:context.config
          ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : put_parameter_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMPutParameter" ~service ~config:context.config
          ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.register_patch_baseline_for_patch_group_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMRegisterPatchBaselineForPatchGroup" ~service
          ~config:context.config ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.register_target_with_maintenance_window_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMRegisterTargetWithMaintenanceWindow" ~service
          ~config:context.config ~http:context.http ~input
...
module RemoveTagsFromResource =
  struct
    ...
    let request context (request : remove_tags_from_resource_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.remove_tags_from_resource_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : send_command_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMSendCommand" ~service ~config:context.config
          ~http:context.http ~input
...
module StartAutomationExecution =
  struct
    ...
    let request context (request : start_automation_execution_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.start_automation_execution_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : start_session_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AmazonSSMStartSession" ~service ~config:context.config
          ~http:context.http ~input
...
module StopAutomationExecution =
  struct
    ...
    let request context (request : stop_automation_execution_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.stop_automation_execution_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UnlabelParameterVersion =
  struct
    ...
    let request context (request : unlabel_parameter_version_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.unlabel_parameter_version_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateAssociationStatus =
  struct
    ...
    let request context (request : update_association_status_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_association_status_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateDocument =
  struct
    ...
    let request context (request : update_document_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_document_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateMaintenanceWindow =
  struct
    ...
    let request context (request : update_maintenance_window_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_maintenance_window_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateOpsItem =
  struct
    ...
    let request context (request : update_ops_item_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_ops_item_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateResourceDataSync =
  struct
    ...
    let request context (request : update_resource_data_sync_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_resource_data_sync_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
