...
let update_service_setting_request_to_yojson
  (x : update_service_setting_request) =
  assoc_to_yojson
    [("SettingValue",
...
let resource_data_sync_organizational_unit_to_yojson
  (x : resource_data_sync_organizational_unit) =
  assoc_to_yojson
...
let resource_data_sync_aws_organizations_source_to_yojson
  ...
  assoc_to_yojson
    [("OrganizationalUnits",
       (option_to_yojson
          resource_data_sync_organizational_unit_list_to_yojson
          x.organizational_units));
    ("OrganizationSourceType",
      (Some
         (resource_data_sync_organization_source_type_to_yojson
            x.organization_source_type)))]
...
let resource_data_sync_source_to_yojson (x : resource_data_sync_source) =
  assoc_to_yojson
    [("EnableAllOpsDataSources",
       (option_to_yojson
          resource_data_sync_enable_all_ops_data_sources_to_yojson
    ...
    ("SourceRegions",
      (Some
         (resource_data_sync_source_region_list_to_yojson x.source_regions)));
...
let update_resource_data_sync_request_to_yojson
  (x : update_resource_data_sync_request) =
  assoc_to_yojson
    [("SyncSource",
...
let resource_data_sync_not_found_exception_to_yojson
  (x : resource_data_sync_not_found_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message));
    ("SyncType",
...
let resource_data_sync_conflict_exception_to_yojson
  (x : resource_data_sync_conflict_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let patch_filter_value_list_to_yojson tree =
  list_to_yojson patch_filter_value_to_yojson tree
...
let patch_filter_list_to_yojson tree =
  list_to_yojson patch_filter_to_yojson tree
let patch_filter_group_to_yojson (x : patch_filter_group) =
  assoc_to_yojson
    [("PatchFilters", (Some (patch_filter_list_to_yojson x.patch_filters)))]
...
let patch_rule_group_to_yojson (x : patch_rule_group) =
  assoc_to_yojson
    [("PatchRules", (Some (patch_rule_list_to_yojson x.patch_rules)))]
...
let patch_source_product_list_to_yojson tree =
  list_to_yojson patch_source_product_to_yojson tree
...
let update_patch_baseline_result_to_yojson (x : update_patch_baseline_result)
  ...
  assoc_to_yojson
    ...
    ("ApprovedPatchesComplianceLevel",
      (option_to_yojson patch_compliance_level_to_yojson
...
let metadata_value_to_yojson (x : metadata_value) =
  assoc_to_yojson
    [("Value", (option_to_yojson metadata_value_string_to_yojson x.value))]
let metadata_key_to_yojson = string_to_yojson
let metadata_map_to_yojson tree =
  map_to_yojson metadata_key_to_yojson metadata_value_to_yojson tree
let metadata_keys_to_delete_list_to_yojson tree =
  list_to_yojson metadata_key_to_yojson tree
let update_ops_metadata_request_to_yojson (x : update_ops_metadata_request) =
  assoc_to_yojson
    [("KeysToDelete",
       (option_to_yojson metadata_keys_to_delete_list_to_yojson
          x.keys_to_delete));
    ("MetadataToUpdate",
...
let ops_metadata_too_many_updates_exception_to_yojson
  (x : ops_metadata_too_many_updates_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
let ops_metadata_not_found_exception_to_yojson
  (x : ops_metadata_not_found_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
...
let ops_item_operational_data_to_yojson tree =
  map_to_yojson ops_item_data_key_to_yojson ops_item_data_value_to_yojson
    tree
let ops_item_ops_data_keys_list_to_yojson tree =
...
let ops_item_notifications_to_yojson tree =
  list_to_yojson ops_item_notification_to_yojson tree
...
let related_ops_items_to_yojson tree =
  list_to_yojson related_ops_item_to_yojson tree
...
let update_ops_item_request_to_yojson (x : update_ops_item_request) =
  assoc_to_yojson
    ...
    ("OperationalDataToDelete",
      (option_to_yojson ops_item_ops_data_keys_list_to_yojson
         x.operational_data_to_delete));
    ("OperationalData",
      (option_to_yojson ops_item_operational_data_to_yojson
         x.operational_data));
    ("Description",
...
let ops_item_not_found_exception_to_yojson (x : ops_item_not_found_exception)
  ...
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
let ops_item_parameter_names_list_to_yojson tree =
  list_to_yojson string__to_yojson tree
let integer__to_yojson = int_to_yojson
let ops_item_limit_exceeded_exception_to_yojson
  (x : ops_item_limit_exceeded_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message));
    ("LimitType", (option_to_yojson string__to_yojson x.limit_type));
    ("Limit", (option_to_yojson integer__to_yojson x.limit));
    ("ResourceTypes",
      (option_to_yojson ops_item_parameter_names_list_to_yojson
         x.resource_types))]
let ops_item_invalid_parameter_exception_to_yojson
  (x : ops_item_invalid_parameter_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message));
    ("ParameterNames",
      (option_to_yojson ops_item_parameter_names_list_to_yojson
...
let ops_item_already_exists_exception_to_yojson
  (x : ops_item_already_exists_exception) =
  assoc_to_yojson
...
let update_managed_instance_role_request_to_yojson
  (x : update_managed_instance_role_request) =
  assoc_to_yojson
...
let maintenance_window_task_parameter_value_expression_to_yojson
  ...
  assoc_to_yojson
    [("Values",
       (option_to_yojson
          maintenance_window_task_parameter_value_list_to_yojson x.values))]
...
let cloud_watch_output_config_to_yojson (x : cloud_watch_output_config) =
  assoc_to_yojson
    [("CloudWatchOutputEnabled",
       (option_to_yojson cloud_watch_output_enabled_to_yojson
          x.cloud_watch_output_enabled));
    ("CloudWatchLogGroupName",
      (option_to_yojson cloud_watch_log_group_name_to_yojson
         x.cloud_watch_log_group_name))]
let document_hash_to_yojson = string_to_yojson
let document_hash_type_to_yojson (x : document_hash_type) =
  match x with | SHA1 -> `String "Sha1" | SHA256 -> `String "Sha256"
...
let notification_event_to_yojson (x : notification_event) =
  ...
  | IN_PROGRESS -> `String "InProgress"
  | ALL -> `String "All"
let notification_event_list_to_yojson tree =
  list_to_yojson notification_event_to_yojson tree
...
let notification_config_to_yojson (x : notification_config) =
  assoc_to_yojson
    ...
    ("NotificationEvents",
      (option_to_yojson notification_event_list_to_yojson
...
let parameter_value_list_to_yojson tree =
...
let maintenance_window_run_command_parameters_to_yojson
  ...
  assoc_to_yojson
    ...
    ("CloudWatchOutputConfig",
      (option_to_yojson cloud_watch_output_config_to_yojson
         x.cloud_watch_output_config));
...
let automation_parameter_map_to_yojson tree =
  map_to_yojson automation_parameter_key_to_yojson
    automation_parameter_value_list_to_yojson tree
...
let maintenance_window_step_functions_parameters_to_yojson
  ...
  assoc_to_yojson
    [("Name",
       (option_to_yojson maintenance_window_step_functions_name_to_yojson
          x.name));
    ("Input",
      (option_to_yojson maintenance_window_step_functions_input_to_yojson
         x.input))]
...
let maintenance_window_lambda_parameters_to_yojson
  (x : maintenance_window_lambda_parameters) =
  assoc_to_yojson
    [("Payload",
       (option_to_yojson maintenance_window_lambda_payload_to_yojson
          x.payload));
    ("Qualifier",
      (option_to_yojson maintenance_window_lambda_qualifier_to_yojson
         x.qualifier));
    ("ClientContext",
      (option_to_yojson maintenance_window_lambda_client_context_to_yojson
         x.client_context))]
let maintenance_window_task_invocation_parameters_to_yojson
  (x : maintenance_window_task_invocation_parameters) =
  assoc_to_yojson
    [("Lambda",
       (option_to_yojson maintenance_window_lambda_parameters_to_yojson
          x.lambda));
    ("StepFunctions",
      (option_to_yojson
         maintenance_window_step_functions_parameters_to_yojson
         x.step_functions));
    ("Automation",
      (option_to_yojson maintenance_window_automation_parameters_to_yojson
         x.automation));
    ("RunCommand",
      (option_to_yojson maintenance_window_run_command_parameters_to_yojson
         x.run_command))]
...
let maintenance_window_task_cutoff_behavior_to_yojson
  (x : maintenance_window_task_cutoff_behavior) =
  match x with
...
let alarm_to_yojson (x : alarm) =
  assoc_to_yojson [("Name", (Some (alarm_name_to_yojson x.name)))]
...
let update_maintenance_window_task_result_to_yojson
  (x : update_maintenance_window_task_result) =
  assoc_to_yojson
    [("AlarmConfiguration",
       (option_to_yojson alarm_configuration_to_yojson x.alarm_configuration));
    ("CutoffBehavior",
      (option_to_yojson maintenance_window_task_cutoff_behavior_to_yojson
         x.cutoff_behavior));
    ("Description",
      (option_to_yojson maintenance_window_description_to_yojson
         x.description));
    ...
    ("TaskInvocationParameters",
      (option_to_yojson
         maintenance_window_task_invocation_parameters_to_yojson
         x.task_invocation_parameters));
    ("TaskParameters",
      (option_to_yojson maintenance_window_task_parameters_to_yojson
         x.task_parameters));
    ("ServiceRoleArn",
      (option_to_yojson service_role_to_yojson x.service_role_arn));
    ("TaskArn",
...
let update_maintenance_window_task_request_to_yojson
  (x : update_maintenance_window_task_request) =
  assoc_to_yojson
    [("AlarmConfiguration",
       (option_to_yojson alarm_configuration_to_yojson x.alarm_configuration));
    ("CutoffBehavior",
...
let update_maintenance_window_target_result_to_yojson
  (x : update_maintenance_window_target_result) =
  assoc_to_yojson
    [("Description",
       (option_to_yojson maintenance_window_description_to_yojson
          x.description));
    ...
    ("Targets", (option_to_yojson targets_to_yojson x.targets));
    ("WindowTargetId",
      (option_to_yojson maintenance_window_target_id_to_yojson
         x.window_target_id));
    ("WindowId",
      (option_to_yojson maintenance_window_id_to_yojson x.window_id))]
...
let update_maintenance_window_request_to_yojson
  (x : update_maintenance_window_request) =
  assoc_to_yojson
    [("Replace", (option_to_yojson boolean__to_yojson x.replace));
    ("Enabled",
      (option_to_yojson maintenance_window_enabled_to_yojson x.enabled));
...
let document_parameter_to_yojson (x : document_parameter) =
  assoc_to_yojson
    [("DefaultValue",
       (option_to_yojson document_parameter_default_value_to_yojson
          x.default_value));
    ("Description",
...
let document_parameter_list_to_yojson tree =
  list_to_yojson document_parameter_to_yojson tree
let platform_type_to_yojson (x : platform_type) =
  match x with
  | MACOS -> `String "MacOS"
  | LINUX -> `String "Linux"
  | WINDOWS -> `String "Windows"
let platform_type_list_to_yojson tree =
...
let document_requires_list_to_yojson tree =
  list_to_yojson document_requires_to_yojson tree
...
let review_information_list_to_yojson tree =
  list_to_yojson review_information_to_yojson tree
let category_to_yojson = string_to_yojson
let category_list_to_yojson tree = list_to_yojson category_to_yojson tree
let category_enum_list_to_yojson tree =
  list_to_yojson category_to_yojson tree
let document_description_to_yojson (x : document_description) =
  assoc_to_yojson
    ...
    ("ReviewInformation",
      (option_to_yojson review_information_list_to_yojson
         x.review_information));
    ...
    ("AttachmentsInformation",
      (option_to_yojson attachment_information_list_to_yojson
         x.attachments_information));
    ...
    ("DocumentVersion",
      (option_to_yojson document_version_to_yojson x.document_version));
    ("StatusInformation",
      (option_to_yojson document_status_information_to_yojson
         x.status_information));
...
let update_document_result_to_yojson (x : update_document_result) =
  assoc_to_yojson
    [("DocumentDescription",
       (option_to_yojson document_description_to_yojson
          x.document_description))]
...
let attachments_source_list_to_yojson tree =
  list_to_yojson attachments_source_to_yojson tree
...
let document_review_comment_source_to_yojson
  (x : document_review_comment_source) =
  assoc_to_yojson
    [("Content",
...
let update_document_metadata_request_to_yojson
  (x : update_document_metadata_request) =
  assoc_to_yojson
    [("DocumentReviews",
...
let duplicate_document_version_name_to_yojson
  (x : duplicate_document_version_name) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let document_version_limit_exceeded_to_yojson
  (x : document_version_limit_exceeded) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let instance_association_output_location_to_yojson
  (x : instance_association_output_location) =
  assoc_to_yojson
    [("S3Location",
...
let association_compliance_severity_to_yojson
  (x : association_compliance_severity) =
  match x with
  | Unspecified -> `String "UNSPECIFIED"
  | Low -> `String "LOW"
  | Medium -> `String "MEDIUM"
...
let association_sync_compliance_to_yojson (x : association_sync_compliance) =
  match x with | Manual -> `String "MANUAL" | Auto -> `String "AUTO"
let apply_only_at_cron_interval_to_yojson = bool_to_yojson
let calendar_name_or_ar_n_to_yojson = string_to_yojson
let calendar_name_or_arn_list_to_yojson tree =
  list_to_yojson calendar_name_or_ar_n_to_yojson tree
...
let target_location_to_yojson (x : target_location) =
  assoc_to_yojson
    ...
    ("TargetLocationMaxConcurrency",
      (option_to_yojson max_concurrency_to_yojson
         x.target_location_max_concurrency));
    ("Regions", (option_to_yojson regions_to_yojson x.regions));
    ("Accounts", (option_to_yojson accounts_to_yojson x.accounts))]
let target_locations_to_yojson tree =
  list_to_yojson target_location_to_yojson tree
...
let target_map_value_list_to_yojson tree =
  list_to_yojson target_map_value_to_yojson tree
...
let external_alarm_state_to_yojson (x : external_alarm_state) =
  match x with | ALARM -> `String "ALARM" | UNKNOWN -> `String "UNKNOWN"
...
let association_description_to_yojson (x : association_description) =
  assoc_to_yojson
    ...
    ("ApplyOnlyAtCronInterval",
      (option_to_yojson apply_only_at_cron_interval_to_yojson
         x.apply_only_at_cron_interval));
    ("SyncCompliance",
      (option_to_yojson association_sync_compliance_to_yojson
         x.sync_compliance));
    ("ComplianceSeverity",
      (option_to_yojson association_compliance_severity_to_yojson
         x.compliance_severity));
    ("MaxConcurrency",
      (option_to_yojson max_concurrency_to_yojson x.max_concurrency));
    ("MaxErrors", (option_to_yojson max_errors_to_yojson x.max_errors));
    ("AssociationName",
    ...
    ("OutputLocation",
      (option_to_yojson instance_association_output_location_to_yojson
         x.output_location));
    ("ScheduleExpression",
...
let update_association_status_result_to_yojson
  (x : update_association_status_result) =
  assoc_to_yojson
    [("AssociationDescription",
       (option_to_yojson association_description_to_yojson
          x.association_description))]
let update_association_status_request_to_yojson
  (x : update_association_status_request) =
  assoc_to_yojson
    [("AssociationStatus",
...
let association_version_limit_exceeded_to_yojson
  (x : association_version_limit_exceeded) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let unsupported_feature_required_exception_to_yojson
  (x : unsupported_feature_required_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
let unsupported_calendar_exception_to_yojson
  (x : unsupported_calendar_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
let parameter_label_to_yojson = string_to_yojson
let parameter_label_list_to_yojson tree =
  list_to_yojson parameter_label_to_yojson tree
let unlabel_parameter_version_result_to_yojson
  (x : unlabel_parameter_version_result) =
  assoc_to_yojson
    [("InvalidLabels",
...
let unlabel_parameter_version_request_to_yojson
  (x : unlabel_parameter_version_request) =
  assoc_to_yojson
...
let total_size_limit_exceeded_exception_to_yojson
  (x : total_size_limit_exceeded_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let sub_type_count_limit_exceeded_exception_to_yojson
  (x : sub_type_count_limit_exceeded_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let automation_execution_status_to_yojson (x : automation_execution_status) =
  ...
  | PENDING -> `String "Pending"
let normal_string_map_to_yojson tree =
...
let parent_step_details_to_yojson (x : parent_step_details) =
  assoc_to_yojson
    ...
    ("Iteration", (option_to_yojson integer__to_yojson x.iteration));
...
let step_execution_to_yojson (x : step_execution) =
  assoc_to_yojson
    ...
    ("OverriddenParameters",
      (option_to_yojson automation_parameter_map_to_yojson
         x.overridden_parameters));
    ("StepExecutionId",
      (option_to_yojson string__to_yojson x.step_execution_id));
    ("FailureDetails",
    ...
    ("MaxAttempts", (option_to_yojson integer__to_yojson x.max_attempts));
    ...
    ("Action", (option_to_yojson automation_action_name_to_yojson x.action));
    ("StepName", (option_to_yojson string__to_yojson x.step_name))]
let step_execution_list_to_yojson tree =
  list_to_yojson step_execution_to_yojson tree
...
let step_execution_filter_list_to_yojson tree =
  list_to_yojson step_execution_filter_to_yojson tree
...
let start_change_request_execution_result_to_yojson
  ...
  assoc_to_yojson
    [("AutomationExecutionId",
       (option_to_yojson automation_execution_id_to_yojson
          x.automation_execution_id))]
...
let start_change_request_execution_request_to_yojson
  (x : start_change_request_execution_request) =
  assoc_to_yojson
    [("ChangeDetails",
...
let idempotent_parameter_mismatch_to_yojson
  (x : idempotent_parameter_mismatch) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let start_automation_execution_result_to_yojson
  (x : start_automation_execution_result) =
  assoc_to_yojson
    [("AutomationExecutionId",
       (option_to_yojson automation_execution_id_to_yojson
          x.automation_execution_id))]
...
let start_associations_once_request_to_yojson
  (x : start_associations_once_request) =
  assoc_to_yojson
    [("AssociationIds",
...
let severity_summary_to_yojson (x : severity_summary) =
  assoc_to_yojson
    [("UnspecifiedCount",
       (option_to_yojson compliance_summary_count_to_yojson
          x.unspecified_count));
    ("InformationalCount",
      (option_to_yojson compliance_summary_count_to_yojson
         x.informational_count));
    ("LowCount",
...
let session_state_to_yojson (x : session_state) =
  match x with | HISTORY -> `String "History" | ACTIVE -> `String "Active"
...
let session_manager_output_url_to_yojson (x : session_manager_output_url) =
  assoc_to_yojson
    [("CloudWatchOutputUrl",
       (option_to_yojson session_manager_cloud_watch_output_url_to_yojson
          x.cloud_watch_output_url));
    ("S3OutputUrl",
      (option_to_yojson session_manager_s3_output_url_to_yojson
         x.s3_output_url))]
...
let session_filter_list_to_yojson tree =
  list_to_yojson session_filter_to_yojson tree
...
let instance_id_list_to_yojson tree =
  list_to_yojson instance_id_to_yojson tree
...
let command_to_yojson (x : command) =
  assoc_to_yojson
    ...
    ("DeliveryTimedOutCount",
      (option_to_yojson delivery_timed_out_count_to_yojson
         x.delivery_timed_out_count));
...
let send_command_result_to_yojson (x : send_command_result) =
  assoc_to_yojson
    [("Command", (option_to_yojson command_to_yojson x.command))]
...
let invalid_automation_signal_exception_to_yojson
  (x : invalid_automation_signal_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
let automation_step_not_found_exception_to_yojson
  (x : automation_step_not_found_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let s3_output_url_to_yojson (x : s3_output_url) =
  assoc_to_yojson
    [("OutputUrl", (option_to_yojson url_to_yojson x.output_url))]
...
let result_attribute_list_to_yojson tree =
  list_to_yojson result_attribute_to_yojson tree
...
let resource_type_to_yojson (x : resource_type) =
  ...
  | MANAGED_INSTANCE -> `String "ManagedInstance"
let resource_policy_parameter_names_list_to_yojson tree =
  list_to_yojson string__to_yojson tree
let resource_policy_not_found_exception_to_yojson
  (x : resource_policy_not_found_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let resource_policy_invalid_parameter_exception_to_yojson
  ...
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message));
    ("ParameterNames",
      (option_to_yojson resource_policy_parameter_names_list_to_yojson
         x.parameter_names))]
...
let resource_limit_exceeded_exception_to_yojson
  (x : resource_limit_exceeded_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let resource_data_sync_source_with_state_to_yojson
  (x : resource_data_sync_source_with_state) =
  assoc_to_yojson
    [("EnableAllOpsDataSources",
       (option_to_yojson
          resource_data_sync_enable_all_ops_data_sources_to_yojson
    ...
    ("IncludeFutureRegions",
      (option_to_yojson resource_data_sync_include_future_regions_to_yojson
         x.include_future_regions));
    ("SourceRegions",
      (option_to_yojson resource_data_sync_source_region_list_to_yojson
         x.source_regions));
    ("AwsOrganizationsSource",
      (option_to_yojson resource_data_sync_aws_organizations_source_to_yojson
         x.aws_organizations_source));
    ("SourceType",
      (option_to_yojson resource_data_sync_source_type_to_yojson
         x.source_type))]
...
let resource_data_sync_destination_data_sharing_to_yojson
  ...
  assoc_to_yojson
    [("DestinationDataSharingType",
       (option_to_yojson
          resource_data_sync_destination_data_sharing_type_to_yojson
          x.destination_data_sharing_type))]
let resource_data_sync_s3_destination_to_yojson
  (x : resource_data_sync_s3_destination) =
  assoc_to_yojson
    [("DestinationDataSharing",
       (option_to_yojson
          resource_data_sync_destination_data_sharing_to_yojson
          x.destination_data_sharing));
    ("AWSKMSKeyARN",
      (option_to_yojson resource_data_sync_awskms_key_ar_n_to_yojson
         x.awskms_key_ar_n));
...
let last_resource_data_sync_status_to_yojson
  (x : last_resource_data_sync_status) =
  match x with
  | INPROGRESS -> `String "InProgress"
  | FAILED -> `String "Failed"
...
let resource_data_sync_item_to_yojson (x : resource_data_sync_item) =
  assoc_to_yojson
    [("LastSyncStatusMessage",
       (option_to_yojson last_resource_data_sync_message_to_yojson
          x.last_sync_status_message));
    ("SyncCreatedTime",
      (option_to_yojson resource_data_sync_created_time_to_yojson
         x.sync_created_time));
    ("LastStatus",
      (option_to_yojson last_resource_data_sync_status_to_yojson
         x.last_status));
    ("SyncLastModifiedTime",
      (option_to_yojson resource_data_sync_last_modified_time_to_yojson
         x.sync_last_modified_time));
    ("LastSuccessfulSyncTime",
      (option_to_yojson last_successful_resource_data_sync_time_to_yojson
         x.last_successful_sync_time));
    ("LastSyncTime",
      (option_to_yojson last_resource_data_sync_time_to_yojson
         x.last_sync_time));
    ("S3Destination",
      (option_to_yojson resource_data_sync_s3_destination_to_yojson
         x.s3_destination));
    ("SyncSource",
      (option_to_yojson resource_data_sync_source_with_state_to_yojson
         x.sync_source));
    ("SyncType",
      (option_to_yojson resource_data_sync_type_to_yojson x.sync_type));
    ("SyncName",
...
let resource_compliance_summary_item_to_yojson
  (x : resource_compliance_summary_item) =
  assoc_to_yojson
    [("NonCompliantSummary",
       (option_to_yojson non_compliant_summary_to_yojson
          x.non_compliant_summary));
    ("CompliantSummary",
      (option_to_yojson compliant_summary_to_yojson x.compliant_summary));
    ("ExecutionSummary",
      (option_to_yojson compliance_execution_summary_to_yojson
         x.execution_summary));
    ("OverallSeverity",
...
let register_task_with_maintenance_window_result_to_yojson
  ...
  assoc_to_yojson
    [("WindowTaskId",
       (option_to_yojson maintenance_window_task_id_to_yojson
          x.window_task_id))]
...
let feature_not_available_exception_to_yojson
  (x : feature_not_available_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let maintenance_window_resource_type_to_yojson
  (x : maintenance_window_resource_type) =
  match x with
...
let register_default_patch_baseline_result_to_yojson
  (x : register_default_patch_baseline_result) =
  assoc_to_yojson
    [("BaselineId", (option_to_yojson baseline_id_to_yojson x.baseline_id))]
...
let policies_limit_exceeded_exception_to_yojson
  (x : policies_limit_exceeded_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
let parameter_pattern_mismatch_exception_to_yojson
  (x : parameter_pattern_mismatch_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
let parameter_max_version_limit_exceeded_to_yojson
  (x : parameter_max_version_limit_exceeded) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
...
let invalid_policy_type_exception_to_yojson
  (x : invalid_policy_type_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
let invalid_policy_attribute_exception_to_yojson
  (x : invalid_policy_attribute_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
...
let invalid_allowed_pattern_exception_to_yojson
  (x : invalid_allowed_pattern_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
let incompatible_policy_exception_to_yojson
  (x : incompatible_policy_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
let hierarchy_type_mismatch_exception_to_yojson
  (x : hierarchy_type_mismatch_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
...
let inventory_item_entry_list_to_yojson tree =
  list_to_yojson inventory_item_entry_to_yojson tree
...
let inventory_item_to_yojson (x : inventory_item) =
  assoc_to_yojson
    ...
    ("TypeName", (Some (inventory_item_type_name_to_yojson x.type_name)))]
let inventory_item_list_to_yojson tree =
  list_to_yojson inventory_item_to_yojson tree
...
let item_size_limit_exceeded_exception_to_yojson
  (x : item_size_limit_exceeded_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message));
    ("TypeName",
      (option_to_yojson inventory_item_type_name_to_yojson x.type_name))]
let item_content_mismatch_exception_to_yojson
  (x : item_content_mismatch_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message));
    ("TypeName",
      (option_to_yojson inventory_item_type_name_to_yojson x.type_name))]
...
let invalid_item_content_exception_to_yojson
  (x : invalid_item_content_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message));
    ("TypeName",
      (option_to_yojson inventory_item_type_name_to_yojson x.type_name))]
...
let compliance_item_entry_list_to_yojson tree =
  list_to_yojson compliance_item_entry_to_yojson tree
...
let put_compliance_items_request_to_yojson (x : put_compliance_items_request)
  ...
  assoc_to_yojson
    ...
    ("ItemContentHash",
      (option_to_yojson compliance_item_content_hash_to_yojson
         x.item_content_hash));
...
let progress_counters_to_yojson (x : progress_counters) =
  assoc_to_yojson
    ...
    ("FailedSteps", (option_to_yojson integer__to_yojson x.failed_steps));
    ("SuccessSteps", (option_to_yojson integer__to_yojson x.success_steps));
    ("TotalSteps", (option_to_yojson integer__to_yojson x.total_steps))]
...
let patch_set_to_yojson (x : patch_set) =
  match x with | Application -> `String "APPLICATION" | Os -> `String "OS"
...
let patch_property_to_yojson (x : patch_property) =
  ...
  | Product -> `String "PRODUCT"
let patch_properties_list_to_yojson tree =
  list_to_yojson patch_property_entry_to_yojson tree
...
let patch_operation_type_to_yojson (x : patch_operation_type) =
  match x with | INSTALL -> `String "Install" | SCAN -> `String "Scan"
...
let patch_advisory_id_list_to_yojson tree =
  list_to_yojson patch_advisory_id_to_yojson tree
let patch_bugzilla_id_to_yojson = string_to_yojson
let patch_bugzilla_id_list_to_yojson tree =
  list_to_yojson patch_bugzilla_id_to_yojson tree
let patch_cve_id_to_yojson = string_to_yojson
let patch_cve_id_list_to_yojson tree =
  list_to_yojson patch_cve_id_to_yojson tree
...
let patch_group_patch_baseline_mapping_to_yojson
  (x : patch_group_patch_baseline_mapping) =
  assoc_to_yojson
    [("BaselineIdentity",
       (option_to_yojson patch_baseline_identity_to_yojson
          x.baseline_identity));
    ("PatchGroup", (option_to_yojson patch_group_to_yojson x.patch_group))]
...
let patch_group_list_to_yojson tree =
  list_to_yojson patch_group_to_yojson tree
...
let patch_compliance_data_list_to_yojson tree =
  list_to_yojson patch_compliance_data_to_yojson tree
...
let parameters_filter_list_to_yojson tree =
  list_to_yojson parameters_filter_to_yojson tree
let parameter_version_label_limit_exceeded_to_yojson
  (x : parameter_version_label_limit_exceeded) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
...
let parameter_string_filter_to_yojson (x : parameter_string_filter) =
  assoc_to_yojson
    [("Values",
       (option_to_yojson parameter_string_filter_value_list_to_yojson
          x.values));
    ("Option",
...
let parameter_policy_list_to_yojson tree =
  list_to_yojson parameter_inline_policy_to_yojson tree
let parameter_name_list_to_yojson tree =
  list_to_yojson ps_parameter_name_to_yojson tree
...
let parameter_metadata_list_to_yojson tree =
  list_to_yojson parameter_metadata_to_yojson tree
...
let parameter_history_to_yojson (x : parameter_history) =
  assoc_to_yojson
    ...
    ("Type", (option_to_yojson parameter_type_to_yojson x.type_));
    ("Name", (option_to_yojson ps_parameter_name_to_yojson x.name))]
let parameter_history_list_to_yojson tree =
  list_to_yojson parameter_history_to_yojson tree
...
let ops_result_attribute_to_yojson (x : ops_result_attribute) =
  assoc_to_yojson
    [("TypeName", (Some (ops_data_type_name_to_yojson x.type_name)))]
let ops_result_attribute_list_to_yojson tree =
  list_to_yojson ops_result_attribute_to_yojson tree
...
let ops_metadata_list_to_yojson tree =
  list_to_yojson ops_metadata_to_yojson tree
let ops_metadata_limit_exceeded_exception_to_yojson
  (x : ops_metadata_limit_exceeded_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
...
let ops_metadata_filter_list_to_yojson tree =
  list_to_yojson ops_metadata_filter_to_yojson tree
let ops_metadata_already_exists_exception_to_yojson
  (x : ops_metadata_already_exists_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
...
let ops_item_summaries_to_yojson tree =
  list_to_yojson ops_item_summary_to_yojson tree
let ops_item_related_items_max_results_to_yojson = int_to_yojson
let ops_item_related_items_filter_key_to_yojson
  (x : ops_item_related_items_filter_key) =
  match x with
...
let ops_item_related_item_summary_to_yojson
  (x : ops_item_related_item_summary) =
  assoc_to_yojson
    [("LastModifiedTime",
       (option_to_yojson date_time_to_yojson x.last_modified_time));
    ("LastModifiedBy",
    ...
    ("ResourceUri",
      (option_to_yojson
         ops_item_related_item_association_resource_uri_to_yojson
         x.resource_uri));
    ("AssociationType",
      (option_to_yojson ops_item_related_item_association_type_to_yojson
         x.association_type));
    ("ResourceType",
      (option_to_yojson
         ops_item_related_item_association_resource_type_to_yojson
         x.resource_type));
    ("AssociationId",
      (option_to_yojson ops_item_related_item_association_id_to_yojson
         x.association_id));
    ("OpsItemId", (option_to_yojson ops_item_id_to_yojson x.ops_item_id))]
...
let ops_item_filter_values_to_yojson tree =
  list_to_yojson ops_item_filter_value_to_yojson tree
...
let ops_item_filters_to_yojson tree =
  list_to_yojson ops_item_filter_to_yojson tree
let ops_item_event_summary_to_yojson (x : ops_item_event_summary) =
  assoc_to_yojson
    ...
    ("OpsItemId", (option_to_yojson string__to_yojson x.ops_item_id))]
let ops_item_event_summaries_to_yojson tree =
  list_to_yojson ops_item_event_summary_to_yojson tree
...
let ops_item_event_filter_operator_to_yojson
  (x : ops_item_event_filter_operator) =
  match x with | EQUAL -> `String "Equal"
...
let ops_item_event_filters_to_yojson tree =
  list_to_yojson ops_item_event_filter_to_yojson tree
...
let ops_filter_value_list_to_yojson tree =
  list_to_yojson ops_filter_value_to_yojson tree
...
let ops_entity_item_entry_to_yojson tree =
  map_to_yojson attribute_name_to_yojson attribute_value_to_yojson tree
let ops_entity_item_entry_list_to_yojson tree =
  list_to_yojson ops_entity_item_entry_to_yojson tree
...
let ops_aggregator_value_map_to_yojson tree =
  map_to_yojson ops_aggregator_value_key_to_yojson
    ops_aggregator_value_to_yojson tree
let ops_aggregator_type_to_yojson = string_to_yojson
let rec ops_aggregator_to_yojson (x : ops_aggregator) =
  assoc_to_yojson
    [("Aggregators",
...
let modify_document_permission_request_to_yojson
  (x : modify_document_permission_request) =
  assoc_to_yojson
    [("SharedDocumentVersion",
       (option_to_yojson shared_document_version_to_yojson
          x.shared_document_version));
    ("AccountIdsToRemove",
...
let maintenance_window_identity_for_target_to_yojson
  (x : maintenance_window_identity_for_target) =
  assoc_to_yojson
    [("Name", (option_to_yojson maintenance_window_name_to_yojson x.name));
    ("WindowId",
      (option_to_yojson maintenance_window_id_to_yojson x.window_id))]
...
let maintenance_window_target_to_yojson (x : maintenance_window_target) =
  assoc_to_yojson
    ...
    ("Targets", (option_to_yojson targets_to_yojson x.targets));
    ("ResourceType",
      (option_to_yojson maintenance_window_resource_type_to_yojson
         x.resource_type));
    ("WindowTargetId",
      (option_to_yojson maintenance_window_target_id_to_yojson
         x.window_target_id));
...
let maintenance_window_execution_status_to_yojson
  (x : maintenance_window_execution_status) =
  match x with
...
let maintenance_window_execution_task_invocation_identity_to_yojson
  ...
  assoc_to_yojson
    [("WindowTargetId",
       (option_to_yojson maintenance_window_task_target_id_to_yojson
          x.window_target_id));
    ("OwnerInformation",
      (option_to_yojson owner_information_to_yojson x.owner_information));
    ...
    ("StatusDetails",
      (option_to_yojson maintenance_window_execution_status_details_to_yojson
         x.status_details));
    ("Status",
      (option_to_yojson maintenance_window_execution_status_to_yojson
         x.status));
    ("Parameters",
      (option_to_yojson
         maintenance_window_execution_task_invocation_parameters_to_yojson
         x.parameters));
    ("TaskType",
      (option_to_yojson maintenance_window_task_type_to_yojson x.task_type));
    ("ExecutionId",
      (option_to_yojson
         maintenance_window_execution_task_execution_id_to_yojson
         x.execution_id));
    ("InvocationId",
      (option_to_yojson
         maintenance_window_execution_task_invocation_id_to_yojson
         x.invocation_id));
    ("TaskExecutionId",
      (option_to_yojson maintenance_window_execution_task_id_to_yojson
         x.task_execution_id));
    ("WindowExecutionId",
      (option_to_yojson maintenance_window_execution_id_to_yojson
         x.window_execution_id))]
let maintenance_window_execution_task_invocation_identity_list_to_yojson tree
  =
  list_to_yojson
    maintenance_window_execution_task_invocation_identity_to_yojson tree
...
let list_tags_for_resource_result_to_yojson
  (x : list_tags_for_resource_result) =
  assoc_to_yojson
    [("TagList", (option_to_yojson tag_list_to_yojson x.tag_list))]
let list_tags_for_resource_request_to_yojson
  (x : list_tags_for_resource_request) =
  assoc_to_yojson
    [("ResourceId", (Some (resource_id_to_yojson x.resource_id)));
    ("ResourceType",
      (Some (resource_type_for_tagging_to_yojson x.resource_type)))]
let list_resource_data_sync_result_to_yojson
  (x : list_resource_data_sync_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("ResourceDataSyncItems",
      (option_to_yojson resource_data_sync_item_list_to_yojson
         x.resource_data_sync_items))]
let list_resource_data_sync_request_to_yojson
  (x : list_resource_data_sync_request) =
  assoc_to_yojson
...
let compliance_query_operator_type_to_yojson
  (x : compliance_query_operator_type) =
  match x with
...
let compliance_string_filter_to_yojson (x : compliance_string_filter) =
  assoc_to_yojson
    ...
    ("Values",
      (option_to_yojson compliance_string_filter_value_list_to_yojson
         x.values));
...
let list_ops_item_related_items_response_to_yojson
  (x : list_ops_item_related_items_response) =
  assoc_to_yojson
    [("Summaries",
       (option_to_yojson ops_item_related_item_summaries_to_yojson
          x.summaries));
    ("NextToken", (option_to_yojson string__to_yojson x.next_token))]
let list_ops_item_related_items_request_to_yojson
  (x : list_ops_item_related_items_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson ops_item_related_items_max_results_to_yojson
         x.max_results));
    ("Filters",
      (option_to_yojson ops_item_related_items_filters_to_yojson x.filters));
    ("OpsItemId", (option_to_yojson ops_item_id_to_yojson x.ops_item_id))]
let list_ops_item_events_response_to_yojson
  (x : list_ops_item_events_response) =
  assoc_to_yojson
    [("Summaries",
...
let list_inventory_entries_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("SchemaVersion",
      (option_to_yojson inventory_item_schema_version_to_yojson
         x.schema_version));
    ("InstanceId", (option_to_yojson instance_id_to_yojson x.instance_id));
    ("TypeName",
      (option_to_yojson inventory_item_type_name_to_yojson x.type_name))]
...
let inventory_query_operator_type_to_yojson
  (x : inventory_query_operator_type) =
  match x with
  | EXISTS -> `String "Exists"
  | GREATER_THAN -> `String "GreaterThan"
  | LESS_THAN -> `String "LessThan"
...
let inventory_filter_list_to_yojson tree =
  list_to_yojson inventory_filter_to_yojson tree
let list_inventory_entries_request_to_yojson
  (x : list_inventory_entries_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let document_identifier_to_yojson (x : document_identifier) =
  assoc_to_yojson
    ...
    ("CreatedDate", (option_to_yojson date_time_to_yojson x.created_date));
    ("Name", (option_to_yojson document_ar_n_to_yojson x.name))]
let document_identifier_list_to_yojson tree =
  list_to_yojson document_identifier_to_yojson tree
let list_documents_result_to_yojson (x : list_documents_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("DocumentIdentifiers",
      (option_to_yojson document_identifier_list_to_yojson
         x.document_identifiers))]
...
let document_filter_list_to_yojson tree =
  list_to_yojson document_filter_to_yojson tree
...
let document_metadata_response_info_to_yojson
  (x : document_metadata_response_info) =
  assoc_to_yojson
    [("ReviewerResponse",
       (option_to_yojson document_reviewer_response_list_to_yojson
          x.reviewer_response))]
let list_document_metadata_history_response_to_yojson
  (x : list_document_metadata_history_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Metadata",
...
let list_document_metadata_history_request_to_yojson
  (x : list_document_metadata_history_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let list_compliance_summaries_result_to_yojson
  (x : list_compliance_summaries_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("ComplianceSummaryItems",
      (option_to_yojson compliance_summary_item_list_to_yojson
         x.compliance_summary_items))]
let list_compliance_summaries_request_to_yojson
  (x : list_compliance_summaries_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Filters",
...
let compliance_item_to_yojson (x : compliance_item) =
  assoc_to_yojson
    ...
    ("ComplianceType",
      (option_to_yojson compliance_type_name_to_yojson x.compliance_type))]
let compliance_item_list_to_yojson tree =
  list_to_yojson compliance_item_to_yojson tree
...
let list_compliance_items_request_to_yojson
  (x : list_compliance_items_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("ResourceTypes",
      (option_to_yojson compliance_resource_type_list_to_yojson
         x.resource_types));
    ("ResourceIds",
...
let command_filter_list_to_yojson tree =
  list_to_yojson command_filter_to_yojson tree
...
let command_plugin_list_to_yojson tree =
  list_to_yojson command_plugin_to_yojson tree
let command_invocation_to_yojson (x : command_invocation) =
  assoc_to_yojson
    ...
    ("InstanceId", (option_to_yojson instance_id_to_yojson x.instance_id));
    ("CommandId", (option_to_yojson command_id_to_yojson x.command_id))]
let command_invocation_list_to_yojson tree =
  list_to_yojson command_invocation_to_yojson tree
let list_command_invocations_result_to_yojson
  (x : list_command_invocations_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("CommandInvocations",
      (option_to_yojson command_invocation_list_to_yojson
         x.command_invocations))]
let list_command_invocations_request_to_yojson
  (x : list_command_invocations_request) =
  assoc_to_yojson
...
let association_to_yojson (x : association) =
  assoc_to_yojson
    ...
    ("InstanceId", (option_to_yojson instance_id_to_yojson x.instance_id));
    ("Name", (option_to_yojson document_ar_n_to_yojson x.name))]
let association_list_to_yojson tree =
  list_to_yojson association_to_yojson tree
...
let association_filter_list_to_yojson tree =
  list_to_yojson association_filter_to_yojson tree
let list_associations_request_to_yojson (x : list_associations_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("AssociationFilterList",
      (option_to_yojson association_filter_list_to_yojson
         x.association_filter_list))]
let association_version_info_to_yojson (x : association_version_info) =
  assoc_to_yojson
    ...
    ("AssociationId",
      (option_to_yojson association_id_to_yojson x.association_id))]
let association_version_list_to_yojson tree =
  list_to_yojson association_version_info_to_yojson tree
let list_association_versions_result_to_yojson
  (x : list_association_versions_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("AssociationVersions",
      (option_to_yojson association_version_list_to_yojson
         x.association_versions))]
let list_association_versions_request_to_yojson
  (x : list_association_versions_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("AssociationId", (Some (association_id_to_yojson x.association_id)))]
let label_parameter_version_result_to_yojson
  (x : label_parameter_version_result) =
  assoc_to_yojson
    [("ParameterVersion",
...
let label_parameter_version_request_to_yojson
  (x : label_parameter_version_request) =
  assoc_to_yojson
    [("Labels", (Some (parameter_label_list_to_yojson x.labels)));
    ("ParameterVersion",
      (option_to_yojson ps_parameter_version_to_yojson x.parameter_version));
...
let inventory_result_item_map_to_yojson tree =
  map_to_yojson inventory_result_item_key_to_yojson
    inventory_result_item_to_yojson tree
...
let inventory_attribute_data_type_to_yojson
  (x : inventory_attribute_data_type) =
  match x with | NUMBER -> `String "number" | STRING -> `String "string"
...
let inventory_group_list_to_yojson tree =
  list_to_yojson inventory_group_to_yojson tree
...
let inventory_deletion_summary_item_to_yojson
  (x : inventory_deletion_summary_item) =
  assoc_to_yojson
    [("RemainingCount",
...
let inventory_deletion_summary_to_yojson (x : inventory_deletion_summary) =
  assoc_to_yojson
    [("SummaryItems",
       (option_to_yojson inventory_deletion_summary_items_to_yojson
          x.summary_items));
    ("RemainingCount",
      (option_to_yojson remaining_count_to_yojson x.remaining_count));
...
let inventory_deletion_status_item_to_yojson
  (x : inventory_deletion_status_item) =
  assoc_to_yojson
    [("LastStatusUpdateTime",
       (option_to_yojson inventory_deletion_last_status_update_time_to_yojson
          x.last_status_update_time));
    ("DeletionSummary",
      (option_to_yojson inventory_deletion_summary_to_yojson
         x.deletion_summary));
    ("LastStatusMessage",
      (option_to_yojson inventory_deletion_last_status_message_to_yojson
         x.last_status_message));
    ("LastStatus",
      (option_to_yojson inventory_deletion_status_to_yojson x.last_status));
    ("DeletionStartTime",
      (option_to_yojson inventory_deletion_start_time_to_yojson
         x.deletion_start_time));
    ("TypeName",
      (option_to_yojson inventory_item_type_name_to_yojson x.type_name));
...
let rec inventory_aggregator_to_yojson (x : inventory_aggregator) =
  assoc_to_yojson
    ...
    ("Expression",
      (option_to_yojson inventory_aggregator_expression_to_yojson
         x.expression))]
and inventory_aggregator_list_to_yojson tree =
...
let invalid_inventory_request_exception_to_yojson
  (x : invalid_inventory_request_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
let invalid_inventory_group_exception_to_yojson
  (x : invalid_inventory_group_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
let invalid_instance_property_filter_value_to_yojson
  (x : invalid_instance_property_filter_value) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
...
let invalid_deletion_id_exception_to_yojson
  (x : invalid_deletion_id_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let instance_property_filter_operator_to_yojson
  (x : instance_property_filter_operator) =
  match x with
  | GREATER_THAN -> `String "GreaterThan"
  | LESS_THAN -> `String "LessThan"
  | BEGIN_WITH -> `String "BeginWith"
...
let instance_property_string_filter_to_yojson
  (x : instance_property_string_filter) =
  assoc_to_yojson
    [("Operator",
       (option_to_yojson instance_property_filter_operator_to_yojson
          x.operator));
    ("Values",
...
let instance_aggregated_association_overview_to_yojson
  ...
  assoc_to_yojson
    [("InstanceAssociationStatusAggregatedCount",
       (option_to_yojson
          instance_association_status_aggregated_count_to_yojson
...
let instance_property_to_yojson (x : instance_property) =
  assoc_to_yojson
    ...
    ("AssociationOverview",
      (option_to_yojson instance_aggregated_association_overview_to_yojson
         x.association_overview));
    ("LastSuccessfulAssociationExecutionDate",
      (option_to_yojson date_time_to_yojson
         x.last_successful_association_execution_date));
...
let instance_properties_to_yojson tree =
  list_to_yojson instance_property_to_yojson tree
let install_override_list_to_yojson = string_to_yojson
let instance_patch_state_to_yojson (x : instance_patch_state) =
  assoc_to_yojson
    [("OtherNonCompliantCount",
       (option_to_yojson patch_other_non_compliant_count_to_yojson
          x.other_non_compliant_count));
    ("SecurityNonCompliantCount",
      (option_to_yojson patch_security_non_compliant_count_to_yojson
         x.security_non_compliant_count));
    ("CriticalNonCompliantCount",
      (option_to_yojson patch_critical_non_compliant_count_to_yojson
         x.critical_non_compliant_count));
    ("RebootOption",
      (option_to_yojson reboot_option_to_yojson x.reboot_option));
    ("LastNoRebootInstallOperationTime",
      (option_to_yojson date_time_to_yojson
         x.last_no_reboot_install_operation_time));
    ...
    ("InstalledRejectedCount",
      (option_to_yojson patch_installed_rejected_count_to_yojson
         x.installed_rejected_count));
    ("InstalledPendingRebootCount",
      (option_to_yojson patch_installed_pending_reboot_count_to_yojson
         x.installed_pending_reboot_count));
    ("InstalledOtherCount",
      (option_to_yojson patch_installed_other_count_to_yojson
         x.installed_other_count));
    ("InstalledCount",
      (option_to_yojson patch_installed_count_to_yojson x.installed_count));
    ("OwnerInformation",
      (option_to_yojson owner_information_to_yojson x.owner_information));
    ("InstallOverrideList",
      (option_to_yojson install_override_list_to_yojson
         x.install_override_list));
    ("SnapshotId", (option_to_yojson snapshot_id_to_yojson x.snapshot_id));
    ("BaselineId", (Some (baseline_id_to_yojson x.baseline_id)));
    ("PatchGroup", (Some (patch_group_to_yojson x.patch_group)));
    ("InstanceId", (Some (instance_id_to_yojson x.instance_id)))]
let instance_patch_states_list_to_yojson tree =
  list_to_yojson instance_patch_state_to_yojson tree
let instance_patch_state_operator_type_to_yojson
  (x : instance_patch_state_operator_type) =
  match x with
  | GREATER_THAN -> `String "GreaterThan"
  | LESS_THAN -> `String "LessThan"
  | NOT_EQUAL -> `String "NotEqual"
  | EQUAL -> `String "Equal"
let instance_patch_state_list_to_yojson tree =
  list_to_yojson instance_patch_state_to_yojson tree
...
let instance_information_string_filter_to_yojson
  (x : instance_information_string_filter) =
  assoc_to_yojson
    [("Values",
...
let instance_information_to_yojson (x : instance_information) =
  assoc_to_yojson
    ...
    ("PingStatus", (option_to_yojson ping_status_to_yojson x.ping_status));
    ("InstanceId", (option_to_yojson instance_id_to_yojson x.instance_id))]
let instance_information_list_to_yojson tree =
  list_to_yojson instance_information_to_yojson tree
let instance_information_filter_key_to_yojson
  (x : instance_information_filter_key) =
  match x with
  | ASSOCIATION_STATUS -> `String "AssociationStatus"
  | RESOURCE_TYPE -> `String "ResourceType"
  | IAM_ROLE -> `String "IamRole"
...
let instance_association_output_url_to_yojson
  (x : instance_association_output_url) =
  assoc_to_yojson
    [("S3OutputUrl",
       (option_to_yojson s3_output_url_to_yojson x.s3_output_url))]
let instance_association_status_info_to_yojson
  (x : instance_association_status_info) =
  assoc_to_yojson
    [("AssociationName",
       (option_to_yojson association_name_to_yojson x.association_name));
    ("OutputUrl",
      (option_to_yojson instance_association_output_url_to_yojson
         x.output_url));
    ("ErrorCode", (option_to_yojson agent_error_code_to_yojson x.error_code));
    ("ExecutionSummary",
      (option_to_yojson instance_association_execution_summary_to_yojson
         x.execution_summary));
    ("DetailedStatus",
      (option_to_yojson status_name_to_yojson x.detailed_status));
    ("Status", (option_to_yojson status_name_to_yojson x.status));
...
let instance_association_to_yojson (x : instance_association) =
  assoc_to_yojson
    ...
    ("AssociationId",
      (option_to_yojson association_id_to_yojson x.association_id))]
let instance_association_list_to_yojson tree =
  list_to_yojson instance_association_to_yojson tree
...
let get_resource_policies_response_entry_to_yojson
  (x : get_resource_policies_response_entry) =
  assoc_to_yojson
...
let get_resource_policies_response_to_yojson
  (x : get_resource_policies_response) =
  assoc_to_yojson
    [("Policies",
       (option_to_yojson get_resource_policies_response_entries_to_yojson
          x.policies));
    ("NextToken", (option_to_yojson string__to_yojson x.next_token))]
let get_resource_policies_request_to_yojson
  (x : get_resource_policies_request) =
  assoc_to_yojson
    [("MaxResults",
...
let get_parameters_by_path_result_to_yojson
  (x : get_parameters_by_path_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Parameters", (option_to_yojson parameter_list_to_yojson x.parameters))]
let get_parameters_by_path_max_results_to_yojson = int_to_yojson
let get_parameters_by_path_request_to_yojson
  (x : get_parameters_by_path_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson get_parameters_by_path_max_results_to_yojson
         x.max_results));
    ("WithDecryption",
      (option_to_yojson boolean__to_yojson x.with_decryption));
    ("ParameterFilters",
      (option_to_yojson parameter_string_filter_list_to_yojson
         x.parameter_filters));
...
let get_parameter_result_to_yojson (x : get_parameter_result) =
  assoc_to_yojson
    [("Parameter", (option_to_yojson parameter_to_yojson x.parameter))]
...
let get_parameter_history_request_to_yojson
  (x : get_parameter_history_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("WithDecryption",
...
let get_ops_summary_request_to_yojson (x : get_ops_summary_request) =
  assoc_to_yojson
    ...
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("ResultAttributes",
      (option_to_yojson ops_result_attribute_list_to_yojson
         x.result_attributes));
    ("Aggregators",
      (option_to_yojson ops_aggregator_list_to_yojson x.aggregators));
    ("Filters", (option_to_yojson ops_filter_list_to_yojson x.filters));
...
let get_maintenance_window_task_request_to_yojson
  (x : get_maintenance_window_task_request) =
  assoc_to_yojson
    [("WindowTaskId",
       (Some (maintenance_window_task_id_to_yojson x.window_task_id)));
    ("WindowId", (Some (maintenance_window_id_to_yojson x.window_id)))]
let get_maintenance_window_result_to_yojson
  (x : get_maintenance_window_result) =
  assoc_to_yojson
    [("ModifiedDate", (option_to_yojson date_time_to_yojson x.modified_date));
    ("CreatedDate", (option_to_yojson date_time_to_yojson x.created_date));
    ("Enabled",
...
let get_maintenance_window_request_to_yojson
  (x : get_maintenance_window_request) =
  assoc_to_yojson
    [("WindowId", (Some (maintenance_window_id_to_yojson x.window_id)))]
let get_maintenance_window_execution_task_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("Priority",
      (option_to_yojson maintenance_window_task_priority_to_yojson x.priority));
    ("TaskParameters",
      (option_to_yojson maintenance_window_task_parameters_list_to_yojson
         x.task_parameters));
    ("Type",
      (option_to_yojson maintenance_window_task_type_to_yojson x.type_));
    ("ServiceRole", (option_to_yojson service_role_to_yojson x.service_role));
...
let get_maintenance_window_execution_result_to_yojson
  (x : get_maintenance_window_execution_result) =
  assoc_to_yojson
    [("EndTime", (option_to_yojson date_time_to_yojson x.end_time));
    ("StartTime", (option_to_yojson date_time_to_yojson x.start_time));
    ("StatusDetails",
    ...
    ("Status",
      (option_to_yojson maintenance_window_execution_status_to_yojson
         x.status));
    ("TaskIds",
      (option_to_yojson maintenance_window_execution_task_id_list_to_yojson
         x.task_ids));
    ("WindowExecutionId",
      (option_to_yojson maintenance_window_execution_id_to_yojson
         x.window_execution_id))]
...
let get_inventory_schema_request_to_yojson (x : get_inventory_schema_request)
  ...
  assoc_to_yojson
    ...
    ("MaxResults",
      (option_to_yojson get_inventory_schema_max_results_to_yojson
         x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("TypeName",
...
let attachment_content_to_yojson (x : attachment_content) =
  assoc_to_yojson
    ...
    ("Name", (option_to_yojson attachment_name_to_yojson x.name))]
let attachment_content_list_to_yojson tree =
  list_to_yojson attachment_content_to_yojson tree
let get_document_result_to_yojson (x : get_document_result) =
  assoc_to_yojson
    [("ReviewStatus",
       (option_to_yojson review_status_to_yojson x.review_status));
    ("AttachmentsContent",
      (option_to_yojson attachment_content_list_to_yojson
         x.attachments_content));
    ("Requires",
      (option_to_yojson document_requires_list_to_yojson x.requires));
    ("DocumentFormat",
      (option_to_yojson document_format_to_yojson x.document_format));
...
let get_deployable_patch_snapshot_for_instance_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("SnapshotDownloadUrl",
      (option_to_yojson snapshot_download_url_to_yojson
         x.snapshot_download_url));
    ("SnapshotId", (option_to_yojson snapshot_id_to_yojson x.snapshot_id));
    ("InstanceId", (option_to_yojson instance_id_to_yojson x.instance_id))]
...
let get_default_patch_baseline_result_to_yojson
  (x : get_default_patch_baseline_result) =
  assoc_to_yojson
    [("OperatingSystem",
       (option_to_yojson operating_system_to_yojson x.operating_system));
    ("BaselineId", (option_to_yojson baseline_id_to_yojson x.baseline_id))]
let get_default_patch_baseline_request_to_yojson
  (x : get_default_patch_baseline_request) =
  assoc_to_yojson
    [("OperatingSystem",
       (option_to_yojson operating_system_to_yojson x.operating_system))]
...
let get_command_invocation_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("StandardErrorContent",
      (option_to_yojson standard_error_content_to_yojson
         x.standard_error_content));
    ("StandardOutputUrl",
      (option_to_yojson url_to_yojson x.standard_output_url));
    ("StandardOutputContent",
      (option_to_yojson standard_output_content_to_yojson
         x.standard_output_content));
    ("StatusDetails",
      (option_to_yojson status_details_to_yojson x.status_details));
    ("Status",
      (option_to_yojson command_invocation_status_to_yojson x.status));
    ...
    ("ExecutionStartDateTime",
      (option_to_yojson string_date_time_to_yojson
         x.execution_start_date_time));
    ("ResponseCode",
      (option_to_yojson response_code_to_yojson x.response_code));
    ("PluginName",
...
let get_command_invocation_request_to_yojson
  (x : get_command_invocation_request) =
  assoc_to_yojson
    [("PluginName",
       (option_to_yojson command_plugin_name_to_yojson x.plugin_name));
    ("InstanceId", (Some (instance_id_to_yojson x.instance_id)));
...
let automation_execution_to_yojson (x : automation_execution) =
  assoc_to_yojson
    ...
    ("ParentAutomationExecutionId",
      (option_to_yojson automation_execution_id_to_yojson
         x.parent_automation_execution_id));
    ("Mode", (option_to_yojson execution_mode_to_yojson x.mode));
    ("FailureMessage",
      (option_to_yojson string__to_yojson x.failure_message));
    ("Outputs",
    ...
    ("AutomationExecutionStatus",
      (option_to_yojson automation_execution_status_to_yojson
         x.automation_execution_status));
    ("ExecutionEndTime",
      (option_to_yojson date_time_to_yojson x.execution_end_time));
    ("ExecutionStartTime",
      (option_to_yojson date_time_to_yojson x.execution_start_time));
...
let get_automation_execution_result_to_yojson
  (x : get_automation_execution_result) =
  assoc_to_yojson
    [("AutomationExecution",
       (option_to_yojson automation_execution_to_yojson
          x.automation_execution))]
let get_automation_execution_request_to_yojson
  (x : get_automation_execution_request) =
  assoc_to_yojson
    [("AutomationExecutionId",
       (Some (automation_execution_id_to_yojson x.automation_execution_id)))]
...
let create_association_batch_request_entry_to_yojson
  (x : create_association_batch_request_entry) =
  assoc_to_yojson
    [("AlarmConfiguration",
       (option_to_yojson alarm_configuration_to_yojson x.alarm_configuration));
    ("TargetMaps", (option_to_yojson target_maps_to_yojson x.target_maps));
...
let failed_create_association_to_yojson (x : failed_create_association) =
  assoc_to_yojson
    ...
    ("Entry",
      (option_to_yojson create_association_batch_request_entry_to_yojson
         x.entry))]
...
let effective_patch_list_to_yojson tree =
  list_to_yojson effective_patch_to_yojson tree
...
let disassociate_ops_item_related_item_request_to_yojson
  ...
  assoc_to_yojson
    [("AssociationId",
       (Some
          (ops_item_related_item_association_id_to_yojson x.association_id)));
    ("OpsItemId", (Some (ops_item_id_to_yojson x.ops_item_id)))]
...
let describe_patch_groups_result_to_yojson (x : describe_patch_groups_result)
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Mappings",
      (option_to_yojson patch_group_patch_baseline_mapping_list_to_yojson
         x.mappings))]
let describe_patch_groups_request_to_yojson
  (x : describe_patch_groups_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Filters",
...
let describe_patch_group_state_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("InstancesWithCriticalNonCompliantPatches",
      (option_to_yojson instances_count_to_yojson
         x.instances_with_critical_non_compliant_patches));
    ("InstancesWithUnreportedNotApplicablePatches",
      (option_to_yojson integer__to_yojson
         x.instances_with_unreported_not_applicable_patches));
    ("InstancesWithNotApplicablePatches",
      (option_to_yojson integer__to_yojson
         x.instances_with_not_applicable_patches));
    ...
    ("InstancesWithInstalledRejectedPatches",
      (option_to_yojson instances_count_to_yojson
         x.instances_with_installed_rejected_patches));
    ("InstancesWithInstalledPendingRebootPatches",
      (option_to_yojson instances_count_to_yojson
         x.instances_with_installed_pending_reboot_patches));
    ("InstancesWithInstalledOtherPatches",
      (option_to_yojson integer__to_yojson
         x.instances_with_installed_other_patches));
    ("InstancesWithInstalledPatches",
      (option_to_yojson integer__to_yojson x.instances_with_installed_patches));
    ("Instances", (option_to_yojson integer__to_yojson x.instances))]
let describe_patch_group_state_request_to_yojson
  (x : describe_patch_group_state_request) =
  assoc_to_yojson
    [("PatchGroup", (Some (patch_group_to_yojson x.patch_group)))]
let describe_patch_baselines_result_to_yojson
  (x : describe_patch_baselines_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("BaselineIdentities",
      (option_to_yojson patch_baseline_identity_list_to_yojson
         x.baseline_identities))]
let describe_patch_baselines_request_to_yojson
  (x : describe_patch_baselines_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson patch_baseline_max_results_to_yojson x.max_results));
...
let describe_maintenance_windows_result_to_yojson
  (x : describe_maintenance_windows_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("WindowIdentities",
      (option_to_yojson maintenance_window_identity_list_to_yojson
         x.window_identities))]
let describe_maintenance_windows_request_to_yojson
  (x : describe_maintenance_windows_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson maintenance_window_max_results_to_yojson
         x.max_results));
    ("Filters",
...
let describe_maintenance_windows_for_target_result_to_yojson
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("WindowIdentities",
      (option_to_yojson maintenance_windows_for_target_list_to_yojson
         x.window_identities))]
let describe_maintenance_windows_for_target_request_to_yojson
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson maintenance_window_search_max_results_to_yojson
         x.max_results));
    ("ResourceType",
      (Some (maintenance_window_resource_type_to_yojson x.resource_type)));
    ("Targets", (Some (targets_to_yojson x.targets)))]
...
let describe_maintenance_window_schedule_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ScheduledWindowExecutions",
      (option_to_yojson scheduled_window_execution_list_to_yojson
         x.scheduled_window_executions))]
...
let describe_maintenance_window_executions_result_to_yojson
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("WindowExecutions",
      (option_to_yojson maintenance_window_execution_list_to_yojson
         x.window_executions))]
...
let describe_maintenance_window_execution_tasks_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("WindowExecutionTaskIdentities",
      (option_to_yojson
         maintenance_window_execution_task_identity_list_to_yojson
...
let describe_maintenance_window_execution_task_invocations_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("WindowExecutionTaskInvocationIdentities",
      (option_to_yojson
         maintenance_window_execution_task_invocation_identity_list_to_yojson
...
let describe_inventory_deletions_result_to_yojson
  (x : describe_inventory_deletions_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("InventoryDeletions",
      (option_to_yojson inventory_deletions_list_to_yojson
         x.inventory_deletions))]
let describe_inventory_deletions_request_to_yojson
  (x : describe_inventory_deletions_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("DeletionId", (option_to_yojson uui_d_to_yojson x.deletion_id))]
let describe_instance_properties_result_to_yojson
  (x : describe_instance_properties_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("InstanceProperties",
...
let describe_instance_properties_request_to_yojson
  (x : describe_instance_properties_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson describe_instance_properties_max_results_to_yojson
         x.max_results));
    ("FiltersWithOperator",
      (option_to_yojson instance_property_string_filter_list_to_yojson
         x.filters_with_operator));
    ("InstancePropertyFilterList",
      (option_to_yojson instance_property_filter_list_to_yojson
         x.instance_property_filter_list))]
let describe_instance_patches_result_to_yojson
  (x : describe_instance_patches_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Patches",
      (option_to_yojson patch_compliance_data_list_to_yojson x.patches))]
let describe_instance_patches_request_to_yojson
  (x : describe_instance_patches_request) =
  assoc_to_yojson
    [("MaxResults",
...
let describe_instance_patch_states_result_to_yojson
  (x : describe_instance_patch_states_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("InstancePatchStates",
      (option_to_yojson instance_patch_state_list_to_yojson
         x.instance_patch_states))]
let describe_instance_patch_states_request_to_yojson
  (x : describe_instance_patch_states_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson patch_compliance_max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let describe_instance_patch_states_for_patch_group_result_to_yojson
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("InstancePatchStates",
      (option_to_yojson instance_patch_states_list_to_yojson
         x.instance_patch_states))]
...
let describe_instance_information_result_to_yojson
  (x : describe_instance_information_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("InstanceInformationList",
      (option_to_yojson instance_information_list_to_yojson
         x.instance_information_list))]
let describe_instance_information_request_to_yojson
  (x : describe_instance_information_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson max_results_ec2_compatible_to_yojson x.max_results));
    ("Filters",
      (option_to_yojson instance_information_string_filter_list_to_yojson
         x.filters));
...
let describe_effective_instance_associations_request_to_yojson
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson effective_instance_association_max_results_to_yojson
         x.max_results));
    ("InstanceId", (Some (instance_id_to_yojson x.instance_id)))]
...
let account_sharing_info_list_to_yojson tree =
  list_to_yojson account_sharing_info_to_yojson tree
let describe_document_permission_response_to_yojson
  (x : describe_document_permission_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("AccountSharingInfoList",
      (option_to_yojson account_sharing_info_list_to_yojson
         x.account_sharing_info_list));
    ("AccountIds",
      (option_to_yojson account_id_list_to_yojson x.account_ids))]
let describe_document_permission_request_to_yojson
  (x : describe_document_permission_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson document_permission_max_results_to_yojson
         x.max_results));
    ("PermissionType",
      (Some (document_permission_type_to_yojson x.permission_type)));
    ("Name", (Some (document_name_to_yojson x.name)))]
let describe_available_patches_result_to_yojson
  (x : describe_available_patches_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Patches", (option_to_yojson patch_list_to_yojson x.patches))]
let describe_available_patches_request_to_yojson
  (x : describe_available_patches_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson patch_baseline_max_results_to_yojson x.max_results));
...
let automation_execution_metadata_to_yojson
  (x : automation_execution_metadata) =
  assoc_to_yojson
    [("ChangeRequestName",
       (option_to_yojson change_request_name_to_yojson x.change_request_name));
    ("AssociationId", (option_to_yojson string__to_yojson x.association_id));
...
let describe_automation_executions_result_to_yojson
  (x : describe_automation_executions_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let automation_execution_filter_key_to_yojson
  (x : automation_execution_filter_key) =
  match x with
...
let describe_automation_executions_request_to_yojson
  (x : describe_automation_executions_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("Filters",
...
let association_execution_to_yojson (x : association_execution) =
  assoc_to_yojson
    ...
    ("ResourceCountByStatus",
      (option_to_yojson resource_count_by_status_to_yojson
         x.resource_count_by_status));
    ("LastExecutionDate",
      (option_to_yojson date_time_to_yojson x.last_execution_date));
    ("CreatedTime", (option_to_yojson date_time_to_yojson x.created_time));
    ("DetailedStatus",
    ...
    ("AssociationId",
      (option_to_yojson association_id_to_yojson x.association_id))]
let association_executions_list_to_yojson tree =
  list_to_yojson association_execution_to_yojson tree
let describe_association_executions_result_to_yojson
  (x : describe_association_executions_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("AssociationExecutions",
      (option_to_yojson association_executions_list_to_yojson
         x.association_executions))]
let association_execution_filter_key_to_yojson
  (x : association_execution_filter_key) =
  match x with
...
let association_filter_operator_type_to_yojson
  (x : association_filter_operator_type) =
  match x with
  | GreaterThan -> `String "GREATER_THAN"
  | LessThan -> `String "LESS_THAN"
  | Equal -> `String "EQUAL"
...
let describe_association_executions_request_to_yojson
  (x : describe_association_executions_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("Filters",
...
let association_execution_targets_filter_to_yojson
  (x : association_execution_targets_filter) =
  assoc_to_yojson
    [("Value",
...
let describe_association_execution_targets_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("Filters",
      (option_to_yojson association_execution_targets_filter_list_to_yojson
         x.filters));
    ("ExecutionId",
      (Some (association_execution_id_to_yojson x.execution_id)));
    ("AssociationId", (Some (association_id_to_yojson x.association_id)))]
let association_execution_does_not_exist_to_yojson
  (x : association_execution_does_not_exist) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let activation_to_yojson (x : activation) =
  assoc_to_yojson
    ...
    ("IamRole", (option_to_yojson iam_role_to_yojson x.iam_role));
    ("DefaultInstanceName",
      (option_to_yojson default_instance_name_to_yojson
         x.default_instance_name));
    ("Description",
...
let describe_activations_filter_keys_to_yojson
  (x : describe_activations_filter_keys) =
  match x with
  | IAM_ROLE -> `String "IamRole"
...
let describe_activations_filter_to_yojson (x : describe_activations_filter) =
  assoc_to_yojson
    ...
    ("FilterKey",
      (option_to_yojson describe_activations_filter_keys_to_yojson
         x.filter_key))]
...
let delete_patch_baseline_request_to_yojson
  (x : delete_patch_baseline_request) =
  assoc_to_yojson
    [("BaselineId", (Some (baseline_id_to_yojson x.baseline_id)))]
...
let delete_maintenance_window_result_to_yojson
  (x : delete_maintenance_window_result) =
  assoc_to_yojson
    [("WindowId",
       (option_to_yojson maintenance_window_id_to_yojson x.window_id))]
let delete_maintenance_window_request_to_yojson
  (x : delete_maintenance_window_request) =
  assoc_to_yojson
    [("WindowId", (Some (maintenance_window_id_to_yojson x.window_id)))]
...
let create_maintenance_window_result_to_yojson
  (x : create_maintenance_window_result) =
  assoc_to_yojson
    [("WindowId",
       (option_to_yojson maintenance_window_id_to_yojson x.window_id))]
let create_maintenance_window_request_to_yojson
  (x : create_maintenance_window_request) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("ClientToken", (option_to_yojson client_token_to_yojson x.client_token));
    ("AllowUnassociatedTargets",
...
let create_association_batch_result_to_yojson
  (x : create_association_batch_result) =
  assoc_to_yojson
    [("Failed",
...
let create_association_batch_request_to_yojson
  (x : create_association_batch_request) =
  assoc_to_yojson
    [("Entries",
...
let create_activation_request_to_yojson (x : create_activation_request) =
  assoc_to_yojson
    [("RegistrationMetadata",
       (option_to_yojson registration_metadata_list_to_yojson
          x.registration_metadata));
    ("Tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("ExpirationDate",
      (option_to_yojson expiration_date_to_yojson x.expiration_date));
    ("RegistrationLimit",
...
let associate_ops_item_related_item_request_to_yojson
  (x : associate_ops_item_related_item_request) =
  assoc_to_yojson
    [("ResourceUri",
       (Some
          (ops_item_related_item_association_resource_uri_to_yojson
