  ...
  ({
     ...
     limit_type =
       (option_of_yojson (value_for_key string__of_yojson "LimitType") _list
          path);
     limit =
       (option_of_yojson (value_for_key integer_of_yojson "Limit") _list path);
     resource_types =
       (option_of_yojson
  ...
  ({
     iterator_value =
       (option_of_yojson (value_for_key string__of_yojson "IteratorValue")
          _list path);
     iteration =
       (option_of_yojson (value_for_key integer_of_yojson "Iteration") _list
          path);
     action =
       (option_of_yojson
...
let step_execution_of_yojson tree path =
  ...
  ({
     ...
     max_attempts =
       (option_of_yojson (value_for_key integer_of_yojson "MaxAttempts")
          _list path);
     on_failure =
...
let progress_counters_of_yojson tree path =
  ...
  ({
     timed_out_steps =
       (option_of_yojson (value_for_key integer_of_yojson "TimedOutSteps")
          _list path);
     cancelled_steps =
       (option_of_yojson (value_for_key integer_of_yojson "CancelledSteps")
          _list path);
     failed_steps =
       (option_of_yojson (value_for_key integer_of_yojson "FailedSteps")
          _list path);
     success_steps =
       (option_of_yojson (value_for_key integer_of_yojson "SuccessSteps")
          _list path);
     total_steps =
       (option_of_yojson (value_for_key integer_of_yojson "TotalSteps") _list
          path)
   } : progress_counters)
...
let automation_execution_preview_of_yojson tree path =
  ...
  ({
     total_accounts =
       (option_of_yojson (value_for_key integer_of_yojson "TotalAccounts")
          _list path);
     target_previews =
       (option_of_yojson
...
let describe_patch_group_state_result_of_yojson tree path =
  ...
  ({
     ...
     instances_with_failed_patches =
       (option_of_yojson
          (value_for_key integer_of_yojson "InstancesWithFailedPatches")
          _list path);
     instances_with_missing_patches =
       (option_of_yojson
          (value_for_key integer_of_yojson "InstancesWithMissingPatches")
          _list path);
     ...
     instances_with_installed_patches =
       (option_of_yojson
          (value_for_key integer_of_yojson "InstancesWithInstalledPatches")
          _list path);
     instances =
       (option_of_yojson (value_for_key integer_of_yojson "Instances") _list
          path)
