  ...
  struct
    ...
    let request context (request : describe_stream_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDBStreams_20120810.DescribeStream" ~service
        ~context ~input
...
module GetRecords =
  struct
    ...
    let request context (request : get_records_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDBStreams_20120810.GetRecords" ~service ~context
        ~input
...
module GetShardIterator =
  struct
    ...
    let request context (request : get_shard_iterator_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDBStreams_20120810.GetShardIterator" ~service
        ~context ~input
...
module ListStreams =
  struct
    ...
    let request context (request : list_streams_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDBStreams_20120810.ListStreams" ~service ~context
        ~input
