...
let trimmed_data_access_exception_to_yojson
  (x : trimmed_data_access_exception) =
  assoc_to_yojson
...
let shard_to_yojson (x : shard) =
  assoc_to_yojson
    ...
    ("SequenceNumberRange",
      (option_to_yojson sequence_number_range_to_yojson
         x.sequence_number_range));
    ("ShardId", (option_to_yojson shard_id_to_yojson x.shard_id))]
let shard_description_list_to_yojson tree =
  list_to_yojson shard_to_yojson tree
