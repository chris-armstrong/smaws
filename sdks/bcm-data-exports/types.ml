...
type nonrec compression_option = GZIP [@ocaml.doc ""] | PARQUET [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec format_option = TEXT_OR_CSV [@ocaml.doc ""] | PARQUET [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec get_execution_response = {
  ...
  execution_status : execution_status option; [@ocaml.doc "The status of this specific execution.\n"]
}
[@@ocaml.doc ""]
...
type nonrec export_status_code = HEALTHY [@ocaml.doc ""] | UNHEALTHY [@ocaml.doc ""]
[@@ocaml.doc ""]
