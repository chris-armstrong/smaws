...
type nonrec origin_type_value = SOURCE [@ocaml.doc ""] | TARGET [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec start_metadata_model_conversion_message = {
  migration_project_identifier : migration_project_identifier;
      [@ocaml.doc "The migration project name or Amazon Resource Name (ARN).\n"]
  selection_rules : string_; [@ocaml.doc "A value that specifies the database objects to convert.\n"]
}
[@@ocaml.doc ""]
...
type nonrec reload_option_value = DATA_RELOAD [@ocaml.doc ""] | VALIDATE_ONLY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec nesting_level_value = NONE [@ocaml.doc ""] | ONE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec sql_server_authentication_method = Password [@ocaml.doc ""] | Kerberos [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec oracle_authentication_method = Password [@ocaml.doc ""] | Kerberos [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec my_sql_authentication_method = Password [@ocaml.doc ""] | IAM [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec postgre_sql_authentication_method = Password [@ocaml.doc ""] | IAM [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec database_mode = DEFAULT [@ocaml.doc ""] | BABELFISH [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec encryption_mode_value = SSE_S3 [@ocaml.doc ""] | SSE_KMS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec kafka_sasl_mechanism = SCRAM_SHA_512 [@ocaml.doc ""] | PLAIN [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec message_format_value = JSON [@ocaml.doc ""] | JSON_UNFORMATTED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec auth_type_value = NO [@ocaml.doc ""] | PASSWORD [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec parquet_version_value = PARQUET_1_0 [@ocaml.doc ""] | PARQUET_2_0 [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec data_format_value = CSV [@ocaml.doc ""] | PARQUET [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec compression_type_value = NONE [@ocaml.doc ""] | GZIP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec replication_endpoint_type_value = SOURCE [@ocaml.doc ""] | TARGET [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec assessment_report_type = PDF [@ocaml.doc ""] | CSV [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  marker : string_ option;
      [@ocaml.doc
        "An optional pagination token provided by a previous request. If this parameter is \
         specified, the response includes only records beyond the marker, up to the value \
         specified by [MaxRecords]. \n"]
  filters : filter_list option; [@ocaml.doc "Filters applied to the replication table statistics.\n"]
}
[@@ocaml.doc "\n"]
...
type nonrec release_status_values = BETA [@ocaml.doc ""] | PROD [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  marker : string_ option;
      [@ocaml.doc
        ...
        \ If [Marker] is returned by a previous response, there are more results available. The \
         ...
         make the call again using the returned token and keeping all other arguments unchanged.\n\
        \ "]
  max_records : integer_optional option; [@ocaml.doc "A paginated list of metadata model imports.\n"]
}
[@@ocaml.doc ""]
...
type nonrec collector_status = UNREGISTERED [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec create_event_subscription_message = {
  ...
  tags : tag_list option; [@ocaml.doc "One or more tags to be assigned to the event subscription.\n"]
}
[@@ocaml.doc "\n"]
