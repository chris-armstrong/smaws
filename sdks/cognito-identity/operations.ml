...
module CreateIdentityPool =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "NotAuthorizedException") ->
            `NotAuthorizedException
              (Json_deserializers.not_authorized_exception_of_yojson tree
                 path)
        | (_, "ResourceConflictException") ->
            `ResourceConflictException
              (Json_deserializers.resource_conflict_exception_of_yojson tree
                 path)
        | (_, "TooManyRequestsException") ->
            `TooManyRequestsException
              (Json_deserializers.too_many_requests_exception_of_yojson tree
                 path)
    ...
    let request context (request : create_identity_pool_input) =
      let input =
        Json_serializers.create_identity_pool_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.CreateIdentityPool" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.identity_pool_of_yojson
        ~error_deserializer
  end
module DeleteIdentities =
  struct
    ...
    let request context (request : delete_identities_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.DeleteIdentities" ~service
        ~context ~input
...
module DeleteIdentityPool =
  struct
    ...
    let request context (request : delete_identity_pool_input) =
      let input =
        Json_serializers.delete_identity_pool_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.DeleteIdentityPool" ~service
        ~context ~input
...
module DescribeIdentity =
  struct
    ...
    let request context (request : describe_identity_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.DescribeIdentity" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.identity_description_of_yojson
        ~error_deserializer
  end
module DescribeIdentityPool =
  struct
    ...
    let request context (request : describe_identity_pool_input) =
      let input =
        Json_serializers.describe_identity_pool_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.DescribeIdentityPool" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.identity_pool_of_yojson
        ~error_deserializer
  end
module GetCredentialsForIdentity =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ExternalServiceException") ->
            `ExternalServiceException
              (Json_deserializers.external_service_exception_of_yojson tree
                 path)
        | (_, "InternalErrorException") ->
            `InternalErrorException
              (Json_deserializers.internal_error_exception_of_yojson tree
        ...
        | (_, "InvalidIdentityPoolConfigurationException") ->
            `InvalidIdentityPoolConfigurationException
              (Json_deserializers.invalid_identity_pool_configuration_exception_of_yojson
                 tree path)
        | (_, "InvalidParameterException") ->
            `InvalidParameterException
              (Json_deserializers.invalid_parameter_exception_of_yojson tree
    ...
    let request context (request : get_credentials_for_identity_input) =
      let input =
        Json_serializers.get_credentials_for_identity_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetId =
  struct
    ...
    let request context (request : get_id_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.GetId" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.get_id_response_of_yojson
        ~error_deserializer
  end
module GetIdentityPoolRoles =
  struct
    ...
    let request context (request : get_identity_pool_roles_input) =
      let input =
        Json_serializers.get_identity_pool_roles_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.GetIdentityPoolRoles" ~service
        ~context ~input
...
module GetOpenIdToken =
  struct
    ...
    let request context (request : get_open_id_token_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.GetOpenIdToken" ~service
        ~context ~input
...
module GetOpenIdTokenForDeveloperIdentity =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DeveloperUserAlreadyRegisteredException") ->
            `DeveloperUserAlreadyRegisteredException
              (Json_deserializers.developer_user_already_registered_exception_of_yojson
                 tree path)
        | (_, "InternalErrorException") ->
            `InternalErrorException
              (Json_deserializers.internal_error_exception_of_yojson tree
    ...
    let request context
      ...
      let input =
        Json_serializers.get_open_id_token_for_developer_identity_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.GetOpenIdTokenForDeveloperIdentity"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_open_id_token_for_developer_identity_response_of_yojson
        ~error_deserializer
  end
module GetPrincipalTagAttributeMap =
  struct
    ...
    let request context (request : get_principal_tag_attribute_map_input) =
      let input =
        Json_serializers.get_principal_tag_attribute_map_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListIdentities =
  struct
    ...
    let request context (request : list_identities_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.ListIdentities" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_identities_response_of_yojson
        ~error_deserializer
  end
module ListIdentityPools =
  struct
    ...
    let request context (request : list_identity_pools_input) =
      let input =
        Json_serializers.list_identity_pools_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.ListIdentityPools" ~service
        ~context ~input
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.ListTagsForResource" ~service
        ~context ~input
...
module LookupDeveloperIdentity =
  struct
    ...
    let request context (request : lookup_developer_identity_input) =
      let input =
        Json_serializers.lookup_developer_identity_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module MergeDeveloperIdentities =
  struct
    ...
    let request context (request : merge_developer_identities_input) =
      let input =
        Json_serializers.merge_developer_identities_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module SetIdentityPoolRoles =
  struct
    ...
    let request context (request : set_identity_pool_roles_input) =
      let input =
        Json_serializers.set_identity_pool_roles_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.SetIdentityPoolRoles" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module SetPrincipalTagAttributeMap =
  struct
    ...
    let request context (request : set_principal_tag_attribute_map_input) =
      let input =
        Json_serializers.set_principal_tag_attribute_map_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.TagResource" ~service ~context
        ~input
...
module UnlinkDeveloperIdentity =
  struct
    ...
    let request context (request : unlink_developer_identity_input) =
      let input =
        Json_serializers.unlink_developer_identity_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UnlinkIdentity =
  struct
    ...
    let request context (request : unlink_identity_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.UnlinkIdentity" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.UntagResource" ~service
        ~context ~input
...
module UpdateIdentityPool =
  struct
    ...
    let request context (request : identity_pool) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSCognitoIdentityService.UpdateIdentityPool" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.identity_pool_of_yojson
        ~error_deserializer
  end