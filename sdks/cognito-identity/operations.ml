    ...
    let request context (request : create_identity_pool_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSCognitoIdentityServiceCreateIdentityPool" ~service
...
module DeleteIdentities =
  struct
    ...
    let request context (request : delete_identities_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_identities_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : delete_identity_pool_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSCognitoIdentityServiceDeleteIdentityPool" ~service
          ~config:context.config ~http:context.http ~input
...
module DescribeIdentity =
  struct
    ...
    let request context (request : describe_identity_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_identity_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module GetCredentialsForIdentity =
  struct
    ...
    let request context (request : get_credentials_for_identity_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_credentials_for_identity_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module GetOpenIdToken =
  struct
    ...
    let request context (request : get_open_id_token_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_open_id_token_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : list_tags_for_resource_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSCognitoIdentityServiceListTagsForResource" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : identity_pool) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSCognitoIdentityServiceUpdateIdentityPool" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Json_deserializers.identity_pool_of_yojson
          ~error_deserializer
  end