  ...
  let _res : identity_pool =
    {
      identity_pool_tags =
        (option_of_yojson
           (value_for_key identity_pool_tags_type_of_yojson
              "IdentityPoolTags") _list path);
      saml_provider_ar_ns =
        (option_of_yojson
  ...
  let _res : set_principal_tag_attribute_map_response =
    {
      principal_tags =
        (option_of_yojson
           (value_for_key principal_tags_of_yojson "PrincipalTags") _list
           path);
      use_defaults =
        (option_of_yojson
           (value_for_key use_defaults_of_yojson "UseDefaults") _list path);
  ...
  let _res : lookup_developer_identity_response =
    {
      next_token =
        (option_of_yojson
           (value_for_key pagination_key_of_yojson "NextToken") _list path);
  ...
  let _res : list_tags_for_resource_response =
    {
      tags =
        (option_of_yojson
           (value_for_key identity_pool_tags_type_of_yojson "Tags") _list
           path)
    } in
  _res
  ...
  let _res : list_identity_pools_response =
    {
      ...
      identity_pools =
        (option_of_yojson
           (value_for_key identity_pools_list_of_yojson "IdentityPools")
           _list path)
    } in
  _res
  ...
  let _res : identity_description =
    {
      ...
      creation_date =
        (option_of_yojson (value_for_key date_type_of_yojson "CreationDate")
           _list path);
      logins =
        (option_of_yojson (value_for_key logins_list_of_yojson "Logins")
           _list path);
      identity_id =
        (option_of_yojson (value_for_key identity_id_of_yojson "IdentityId")
           _list path)
  ...
  let _res : get_open_id_token_for_developer_identity_input =
    {
      token_duration =
        (option_of_yojson
           (value_for_key token_duration_of_yojson "TokenDuration") _list
           path);
      principal_tags =
        (option_of_yojson
           (value_for_key principal_tags_of_yojson "PrincipalTags") _list
  ...
  let _res : credentials =
    {
      ...
      session_token =
        (option_of_yojson
           (value_for_key session_token_string_of_yojson "SessionToken")
           _list path);
      secret_key =
        (option_of_yojson
  ...
  let _res : get_credentials_for_identity_input =
    {
      custom_role_arn =
        (option_of_yojson
           (value_for_key arn_string_of_yojson "CustomRoleArn") _list path);
      logins =
        (option_of_yojson (value_for_key logins_map_of_yojson "Logins") _list
           path);
      identity_id =
