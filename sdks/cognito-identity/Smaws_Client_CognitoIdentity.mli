...
type nonrec identity_providers =
  (identity_provider_name * identity_provider_id) list[@@ocaml.doc ""]
...
type nonrec logins_map =
  (identity_provider_name * identity_provider_token) list[@@ocaml.doc ""]
...
type nonrec identity_pool_short_description =
  {
  identity_pool_name: identity_pool_name option
    [@ocaml.doc "A string that you provide.\n"];
  identity_pool_id: identity_pool_id option
    [@ocaml.doc "An identity pool ID in the format REGION:GUID.\n"]}[@@ocaml.doc
