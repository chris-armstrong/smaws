  ...
  struct
    ...
    let request context (request : associate_gateway_to_server_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.associate_gateway_to_server_input_to_yojson
            request in
...
module DeleteHypervisor =
  struct
    ...
    let request context (request : delete_hypervisor_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_hypervisor_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : get_virtual_machine_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"BackupOnPremises_v20210101GetVirtualMachine" ~service
          ~config:context.config ~http:context.http ~input
...
module UpdateGatewaySoftwareNow =
  struct
    ...
    let request context (request : update_gateway_software_now_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_gateway_software_now_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateHypervisor =
  struct
    ...
    let request context (request : update_hypervisor_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_hypervisor_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
