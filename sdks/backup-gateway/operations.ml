...
module AssociateGatewayToServer =
  struct
    ...
    let request context (request : associate_gateway_to_server_input) =
      let input =
        Json_serializers.associate_gateway_to_server_input_to_yojson request in
...
module CreateGateway =
  struct
    ...
    let request context (request : create_gateway_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.CreateGateway" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.create_gateway_output_of_yojson
        ~error_deserializer
  end
module DeleteGateway =
  struct
    ...
    let request context (request : delete_gateway_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.DeleteGateway" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.delete_gateway_output_of_yojson
        ~error_deserializer
  end
module DeleteHypervisor =
  struct
    ...
    let request context (request : delete_hypervisor_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.DeleteHypervisor" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.delete_hypervisor_output_of_yojson
        ~error_deserializer
  end
module DisassociateGatewayFromServer =
  struct
    ...
    let request context (request : disassociate_gateway_from_server_input) =
      let input =
        Json_serializers.disassociate_gateway_from_server_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetBandwidthRateLimitSchedule =
  struct
    ...
    let request context (request : get_bandwidth_rate_limit_schedule_input) =
      let input =
        Json_serializers.get_bandwidth_rate_limit_schedule_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetGateway =
  struct
    ...
    let request context (request : get_gateway_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.GetGateway" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.get_gateway_output_of_yojson
        ~error_deserializer
  end
module GetHypervisor =
  struct
    ...
    let request context (request : get_hypervisor_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.GetHypervisor" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.get_hypervisor_output_of_yojson
        ~error_deserializer
  end
module GetHypervisorPropertyMappings =
  struct
    ...
    let request context (request : get_hypervisor_property_mappings_input) =
      let input =
        Json_serializers.get_hypervisor_property_mappings_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetVirtualMachine =
  struct
    ...
    let request context (request : get_virtual_machine_input) =
      let input =
        Json_serializers.get_virtual_machine_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.GetVirtualMachine" ~service
        ~context ~input
...
module ImportHypervisorConfiguration =
  struct
    ...
    let request context (request : import_hypervisor_configuration_input) =
      let input =
        Json_serializers.import_hypervisor_configuration_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListGateways =
  struct
    ...
    let request context (request : list_gateways_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.ListGateways" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_gateways_output_of_yojson
        ~error_deserializer
  end
module ListHypervisors =
  struct
    ...
    let request context (request : list_hypervisors_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.ListHypervisors" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_hypervisors_output_of_yojson
        ~error_deserializer
  end
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.ListTagsForResource" ~service
        ~context ~input
...
module ListVirtualMachines =
  struct
    ...
    let request context (request : list_virtual_machines_input) =
      let input =
        Json_serializers.list_virtual_machines_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.ListVirtualMachines" ~service
        ~context ~input
...
module PutBandwidthRateLimitSchedule =
  struct
    ...
    let request context (request : put_bandwidth_rate_limit_schedule_input) =
      let input =
        Json_serializers.put_bandwidth_rate_limit_schedule_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module PutHypervisorPropertyMappings =
  struct
    ...
    let request context (request : put_hypervisor_property_mappings_input) =
      let input =
        Json_serializers.put_hypervisor_property_mappings_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module PutMaintenanceStartTime =
  struct
    ...
    let request context (request : put_maintenance_start_time_input) =
      let input =
        Json_serializers.put_maintenance_start_time_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module StartVirtualMachinesMetadataSync =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.start_virtual_machines_metadata_sync_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.TagResource" ~service
        ~context ~input
...
module TestHypervisorConfiguration =
  struct
    ...
    let request context (request : test_hypervisor_configuration_input) =
      let input =
        Json_serializers.test_hypervisor_configuration_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.UntagResource" ~service
        ~context ~input
...
module UpdateGatewayInformation =
  struct
    ...
    let request context (request : update_gateway_information_input) =
      let input =
        Json_serializers.update_gateway_information_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateGatewaySoftwareNow =
  struct
    ...
    let request context (request : update_gateway_software_now_input) =
      let input =
        Json_serializers.update_gateway_software_now_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateHypervisor =
  struct
    ...
    let request context (request : update_hypervisor_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"BackupOnPremises_v20210101.UpdateHypervisor" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.update_hypervisor_output_of_yojson
        ~error_deserializer
  end