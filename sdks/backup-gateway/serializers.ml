...
let virtual_machines_to_yojson tree =
  list_to_yojson virtual_machine_to_yojson tree
...
let put_maintenance_start_time_output_to_yojson
  (x : put_maintenance_start_time_output) =
  assoc_to_yojson
    [("GatewayArn", (option_to_yojson gateway_arn_to_yojson x.gateway_arn))]
...
let put_maintenance_start_time_input_to_yojson
  (x : put_maintenance_start_time_input) =
  assoc_to_yojson
...
let bandwidth_rate_limit_interval_to_yojson
  (x : bandwidth_rate_limit_interval) =
  assoc_to_yojson
...
let put_bandwidth_rate_limit_schedule_input_to_yojson
  (x : put_bandwidth_rate_limit_schedule_input) =
  assoc_to_yojson
    [("BandwidthRateLimitIntervals",
       (Some
          (bandwidth_rate_limit_intervals_to_yojson
             x.bandwidth_rate_limit_intervals)));
    ("GatewayArn", (Some (gateway_arn_to_yojson x.gateway_arn)))]
...
let gateway_type_to_yojson (x : gateway_type) =
  match x with | BACKUP_VM -> `String "BACKUP_VM"
...
let import_hypervisor_configuration_output_to_yojson
  (x : import_hypervisor_configuration_output) =
  assoc_to_yojson
    [("HypervisorArn",
       (option_to_yojson server_arn_to_yojson x.hypervisor_arn))]
let import_hypervisor_configuration_input_to_yojson
  (x : import_hypervisor_configuration_input) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tags_to_yojson x.tags));
    ("KmsKeyArn", (option_to_yojson kms_key_arn_to_yojson x.kms_key_arn));
    ("Password", (option_to_yojson password_to_yojson x.password));
...
let hypervisor_details_to_yojson (x : hypervisor_details) =
  assoc_to_yojson
    [("LatestMetadataSyncStatus",
       (option_to_yojson sync_metadata_status_to_yojson
          x.latest_metadata_sync_status));
    ("LatestMetadataSyncStatusMessage",
      (option_to_yojson string__to_yojson
         x.latest_metadata_sync_status_message));
...
let get_hypervisor_property_mappings_output_to_yojson
  (x : get_hypervisor_property_mappings_output) =
  assoc_to_yojson
    [("IamRoleArn", (option_to_yojson iam_role_arn_to_yojson x.iam_role_arn));
    ("VmwareToAwsTagMappings",
      (option_to_yojson vmware_to_aws_tag_mappings_to_yojson
         x.vmware_to_aws_tag_mappings));
    ("HypervisorArn",
      (option_to_yojson server_arn_to_yojson x.hypervisor_arn))]
let get_hypervisor_property_mappings_input_to_yojson
  (x : get_hypervisor_property_mappings_input) =
  assoc_to_yojson
    [("HypervisorArn", (Some (server_arn_to_yojson x.hypervisor_arn)))]
...
let gateway_details_to_yojson (x : gateway_details) =
  assoc_to_yojson
    ...
    ("MaintenanceStartTime",
      (option_to_yojson maintenance_start_time_to_yojson
         x.maintenance_start_time));
    ("LastSeenTime", (option_to_yojson time_to_yojson x.last_seen_time));
    ("HypervisorId",
      (option_to_yojson hypervisor_id_to_yojson x.hypervisor_id));
    ("GatewayType", (option_to_yojson gateway_type_to_yojson x.gateway_type));
...
let get_gateway_output_to_yojson (x : get_gateway_output) =
  assoc_to_yojson
    [("Gateway", (option_to_yojson gateway_details_to_yojson x.gateway))]
...
let get_bandwidth_rate_limit_schedule_output_to_yojson
  ...
  assoc_to_yojson
    [("BandwidthRateLimitIntervals",
       (option_to_yojson bandwidth_rate_limit_intervals_to_yojson
          x.bandwidth_rate_limit_intervals));
    ("GatewayArn", (option_to_yojson gateway_arn_to_yojson x.gateway_arn))]
let get_bandwidth_rate_limit_schedule_input_to_yojson
  (x : get_bandwidth_rate_limit_schedule_input) =
  assoc_to_yojson
    [("GatewayArn", (Some (gateway_arn_to_yojson x.gateway_arn)))]
let disassociate_gateway_from_server_output_to_yojson
  (x : disassociate_gateway_from_server_output) =
  assoc_to_yojson
    [("GatewayArn", (option_to_yojson gateway_arn_to_yojson x.gateway_arn))]
let disassociate_gateway_from_server_input_to_yojson
  (x : disassociate_gateway_from_server_input) =
  assoc_to_yojson
    [("GatewayArn", (Some (gateway_arn_to_yojson x.gateway_arn)))]
...
let associate_gateway_to_server_output_to_yojson
  (x : associate_gateway_to_server_output) =
  assoc_to_yojson
    [("GatewayArn", (option_to_yojson gateway_arn_to_yojson x.gateway_arn))]
let associate_gateway_to_server_input_to_yojson
  (x : associate_gateway_to_server_input) =
  assoc_to_yojson
