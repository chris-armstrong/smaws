...
let vmware_tag_of_yojson tree path =
  ...
  ({
     vmware_tag_description =
       option_of_yojson (value_for_key string__of_yojson "VmwareTagDescription") _list path;
     vmware_tag_name =
       option_of_yojson (value_for_key vmware_tag_name_of_yojson "VmwareTagName") _list path;
     vmware_category =
       option_of_yojson (value_for_key vmware_category_of_yojson "VmwareCategory") _list path;
   }
    : vmware_tag)

let vmware_tags_of_yojson tree path = list_of_yojson vmware_tag_of_yojson tree path
...
let virtual_machines_of_yojson tree path = list_of_yojson virtual_machine_of_yojson tree path
...
let update_hypervisor_output_of_yojson tree path =
  ...
  ({
     hypervisor_arn =
       option_of_yojson (value_for_key server_arn_of_yojson "HypervisorArn") _list path;
   }
...
let update_gateway_information_input_of_yojson tree path =
  ...
  ({
     gateway_display_name =
       option_of_yojson (value_for_key name_of_yojson "GatewayDisplayName") _list path;
     gateway_arn = value_for_key gateway_arn_of_yojson "GatewayArn" _list path;
   }
...
let put_hypervisor_property_mappings_input_of_yojson tree path =
  ...
  ({
     ...
     vmware_to_aws_tag_mappings =
       value_for_key vmware_to_aws_tag_mappings_of_yojson "VmwareToAwsTagMappings" _list path;
     hypervisor_arn = value_for_key server_arn_of_yojson "HypervisorArn" _list path;
   }
...
let bandwidth_rate_limit_interval_of_yojson tree path =
  ...
  ({
     ...
     average_upload_rate_limit_in_bits_per_sec =
       option_of_yojson
         (value_for_key average_upload_rate_limit_of_yojson "AverageUploadRateLimitInBitsPerSec")
         _list path;
   }
...
let list_virtual_machines_output_of_yojson tree path =
  ...
  ({
     ...
     virtual_machines =
       option_of_yojson (value_for_key virtual_machines_of_yojson "VirtualMachines") _list path;
   }
...
let hypervisors_of_yojson tree path = list_of_yojson hypervisor_of_yojson tree path
...
let gateway_of_yojson tree path =
  ...
  ({
     ...
     hypervisor_id =
       option_of_yojson (value_for_key hypervisor_id_of_yojson "HypervisorId") _list path;
...
let hypervisor_details_of_yojson tree path =
  ...
  ({
     latest_metadata_sync_status =
       option_of_yojson
         (value_for_key sync_metadata_status_of_yojson "LatestMetadataSyncStatus")
         _list path;
     ...
     last_successful_metadata_sync_time =
       option_of_yojson (value_for_key time_of_yojson "LastSuccessfulMetadataSyncTime") _list path;
     state = option_of_yojson (value_for_key hypervisor_state_of_yojson "State") _list path;
     log_group_arn =
       option_of_yojson (value_for_key log_group_arn_of_yojson "LogGroupArn") _list path;
     name = option_of_yojson (value_for_key name_of_yojson "Name") _list path;
...
let get_hypervisor_property_mappings_output_of_yojson tree path =
  ...
  ({
     ...
     vmware_to_aws_tag_mappings =
       option_of_yojson
         (value_for_key vmware_to_aws_tag_mappings_of_yojson "VmwareToAwsTagMappings")
         _list path;
     hypervisor_arn =
       option_of_yojson (value_for_key server_arn_of_yojson "HypervisorArn") _list path;
   }
...
let get_hypervisor_output_of_yojson tree path =
  ...
  ({
     hypervisor =
       option_of_yojson (value_for_key hypervisor_details_of_yojson "Hypervisor") _list path;
   }
...
let gateway_details_of_yojson tree path =
  ...
  ({
     ...
     maintenance_start_time =
       option_of_yojson
         (value_for_key maintenance_start_time_of_yojson "MaintenanceStartTime")
         _list path;
     last_seen_time = option_of_yojson (value_for_key time_of_yojson "LastSeenTime") _list path;
     hypervisor_id =
       option_of_yojson (value_for_key hypervisor_id_of_yojson "HypervisorId") _list path;
