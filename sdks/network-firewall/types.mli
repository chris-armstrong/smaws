...
type nonrec encryption_type = AWS_OWNED_KMS_KEY [@ocaml.doc ""] | CUSTOMER_KMS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec target_type = HTTP_HOST [@ocaml.doc ""] | TLS_SNI [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec stateful_rule_direction = ANY [@ocaml.doc ""] | FORWARD [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec listener_property_type = HTTPS [@ocaml.doc ""] | HTTP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec tls_intercept_mode = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec log_type = TLS [@ocaml.doc ""] | FLOW [@ocaml.doc ""] | ALERT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec enabled_analysis_type = HTTP_HOST [@ocaml.doc ""] | TLS_SNI [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec container_monitoring_type = EKS [@ocaml.doc ""] | ECS [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec subscription_status = SUBSCRIBED [@ocaml.doc ""] | NOT_SUBSCRIBED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec resource_managed_status = ACCOUNT [@ocaml.doc ""] | MANAGED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec flow_operation_type = FLOW_CAPTURE [@ocaml.doc ""] | FLOW_FLUSH [@ocaml.doc ""]
[@@ocaml.doc ""]
