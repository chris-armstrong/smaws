...
type nonrec model_promote_mode = MANAGED [@ocaml.doc ""] | MANUAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec labels_s3_input_configuration = {
  ...
  prefix : s3_prefix option; [@ocaml.doc " The prefix for the S3 bucket used for the label data. \n"]
}
[@@ocaml.doc
...
type nonrec latest_inference_result = ANOMALOUS [@ocaml.doc ""] | NORMAL [@ocaml.doc ""]
[@@ocaml.doc ""]
