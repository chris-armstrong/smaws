...
type nonrec action = ALLOW [@ocaml.doc ""] | BLOCK [@ocaml.doc ""] | ALERT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec mutation_protection_status = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec protocol = DOH [@ocaml.doc ""] | DO53 [@ocaml.doc ""] | DOHFIPS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec domain_list_type = THREAT [@ocaml.doc ""] | CONTENT [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  next_token : next_token option;
      [@ocaml.doc
        ...
        \  For the second and subsequent requests, get the value of [NextToken] from the previous \
         response and specify that value for [NextToken] in the request.\n\
        \  "]
  filters : filters option; [@ocaml.doc "An optional specification to return a subset of objects.\n"]
}
[@@ocaml.doc ""]
