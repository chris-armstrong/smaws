...
let validity_term_of_yojson tree path =
  ...
  ({
     agreement_end_date =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "agreementEndDate") _list path);
     agreement_start_date =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "agreementStartDate") _list path);
     agreement_duration =
       (option_of_yojson
  ...
  ({
     ...
     start_time =
       (option_of_yojson (value_for_key timestamp_of_yojson "startTime")
          _list path);
     acceptance_time =
       (option_of_yojson (value_for_key timestamp_of_yojson "acceptanceTime")
          _list path);
     agreement_id =
...
let schedule_item_of_yojson tree path =
  ...
  ({
     ...
     charge_date =
       (option_of_yojson (value_for_key timestamp_of_yojson "chargeDate")
          _list path)
   } : schedule_item)
