...
let validity_term_of_yojson tree path =
  ...
  ({
     agreement_end_date =
       option_of_yojson (value_for_key timestamp__of_yojson "agreementEndDate") _list path;
     agreement_start_date =
       option_of_yojson (value_for_key timestamp__of_yojson "agreementStartDate") _list path;
     agreement_duration =
...
let agreement_view_summary_of_yojson tree path =
  ...
  ({
     ...
     acceptance_time =
       option_of_yojson (value_for_key timestamp__of_yojson "acceptanceTime") _list path;
