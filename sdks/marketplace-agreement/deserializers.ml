  ...
  let _res : resource =
    {
      type_ =
        (option_of_yojson
           (value_for_key agreement_resource_type_of_yojson "type") _list
           path);
      id =
  ...
  let _res : agreement_view_summary =
    {
      ...
      agreement_type =
        (option_of_yojson
           (value_for_key agreement_type_of_yojson "agreementType") _list
           path);
      end_time =
  ...
  let _res : filter =
    {
      values =
        (option_of_yojson
           (value_for_key filter_value_list_of_yojson "values") _list path);
      name =
  ...
  let _res : renewal_term =
    {
      configuration =
        (option_of_yojson
           (value_for_key renewal_term_configuration_of_yojson
  ...
  let _res : recurring_payment_term =
    {
      ...
      billing_period =
        (option_of_yojson
           (value_for_key bounded_string_of_yojson "billingPeriod") _list
           path);
      currency_code =
        (option_of_yojson
           (value_for_key currency_code_of_yojson "currencyCode") _list path);
  ...
  let _res : document_item =
    {
      version =
        (option_of_yojson (value_for_key bounded_string_of_yojson "version")
           _list path);
      url =
        (option_of_yojson (value_for_key bounded_string_of_yojson "url")
           _list path);
      type_ =
        (option_of_yojson (value_for_key bounded_string_of_yojson "type")
           _list path)
