...
let validity_term_to_yojson (x : validity_term) =
  assoc_to_yojson
    [("agreementEndDate",
       (option_to_yojson timestamp_to_yojson x.agreement_end_date));
    ("agreementStartDate",
      (option_to_yojson timestamp_to_yojson x.agreement_start_date));
    ("agreementDuration",
...
let rate_card_list_to_yojson tree =
  list_to_yojson rate_card_item_to_yojson tree
...
let agreement_view_summary_to_yojson (x : agreement_view_summary) =
  assoc_to_yojson
    ...
    ("acceptanceTime",
      (option_to_yojson timestamp_to_yojson x.acceptance_time));
...
let search_agreements_output_to_yojson (x : search_agreements_output) =
  assoc_to_yojson
    ...
    ("agreementViewSummaries",
      (option_to_yojson agreement_view_summary_list_to_yojson
         x.agreement_view_summaries))]
...
let filter_value_list_to_yojson tree =
  list_to_yojson filter_value_to_yojson tree
...
let schedule_list_to_yojson tree =
  list_to_yojson schedule_item_to_yojson tree
let resource_type_to_yojson (x : resource_type) =
  match x with | AGREEMENT -> `String "Agreement"
...
let renewal_term_configuration_to_yojson (x : renewal_term_configuration) =
  assoc_to_yojson
    [("enableAutoRenew", (Some (boolean__to_yojson x.enable_auto_renew)))]
...
let document_item_to_yojson (x : document_item) =
  assoc_to_yojson
    ...
    ("type", (option_to_yojson bounded_string_to_yojson x.type_))]
let document_list_to_yojson tree =
  list_to_yojson document_item_to_yojson tree
...
let grant_item_to_yojson (x : grant_item) =
  assoc_to_yojson
    [("maxQuantity",
       (option_to_yojson positive_integer_with_default_value_one_to_yojson
          x.max_quantity));
    ("dimensionKey",
      (option_to_yojson bounded_string_to_yojson x.dimension_key))]
...
let constraints_to_yojson (x : constraints) =
  assoc_to_yojson
    ...
    ("multipleDimensionSelection",
      (option_to_yojson bounded_string_to_yojson
         x.multiple_dimension_selection))]
let configurable_upfront_rate_card_item_to_yojson
  (x : configurable_upfront_rate_card_item) =
  assoc_to_yojson
    [("rateCard", (option_to_yojson rate_card_list_to_yojson x.rate_card));
...
let configurable_upfront_pricing_term_to_yojson
  (x : configurable_upfront_pricing_term) =
  assoc_to_yojson
    [("configuration",
       (option_to_yojson
          configurable_upfront_pricing_term_configuration_to_yojson
          x.configuration));
    ("rateCards",
      (option_to_yojson configurable_upfront_rate_card_list_to_yojson
         x.rate_cards));
    ("currencyCode",
      (option_to_yojson currency_code_to_yojson x.currency_code));
    ("type", (option_to_yojson unversioned_term_type_to_yojson x.type_))]
  ...
  | FixedUpfrontPricingTerm arg ->
      assoc_to_yojson
        [("fixedUpfrontPricingTerm",
           (Some (fixed_upfront_pricing_term_to_yojson arg)))]
  | FreeTrialPricingTerm arg ->
      assoc_to_yojson
        [("freeTrialPricingTerm",
           (Some (free_trial_pricing_term_to_yojson arg)))]
  | PaymentScheduleTerm arg ->
      assoc_to_yojson
        [("paymentScheduleTerm",
           (Some (payment_schedule_term_to_yojson arg)))]
  | ValidityTerm arg ->
      assoc_to_yojson
        [("validityTerm", (Some (validity_term_to_yojson arg)))]
  | RecurringPaymentTerm arg ->
      assoc_to_yojson
        [("recurringPaymentTerm",
           (Some (recurring_payment_term_to_yojson arg)))]
  | ByolPricingTerm arg ->
      assoc_to_yojson
        [("byolPricingTerm", (Some (byol_pricing_term_to_yojson arg)))]
  | ConfigurableUpfrontPricingTerm arg ->
      assoc_to_yojson
        [("configurableUpfrontPricingTerm",
           (Some (configurable_upfront_pricing_term_to_yojson arg)))]
  | UsageBasedPricingTerm arg ->
      assoc_to_yojson
        [("usageBasedPricingTerm",
           (Some (usage_based_pricing_term_to_yojson arg)))]
  | RenewalTerm arg ->
      assoc_to_yojson [("renewalTerm", (Some (renewal_term_to_yojson arg)))]
  | SupportTerm arg ->
      assoc_to_yojson [("supportTerm", (Some (support_term_to_yojson arg)))]
  | LegalTerm arg ->
      assoc_to_yojson [("legalTerm", (Some (legal_term_to_yojson arg)))]
let accepted_term_list_to_yojson tree =
  list_to_yojson accepted_term_to_yojson tree
