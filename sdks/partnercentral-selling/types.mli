...
type nonrec aws_funding_used = YES [@ocaml.doc ""] | NO [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec engagement_score = HIGH [@ocaml.doc ""] | MEDIUM [@ocaml.doc ""] | LOW [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec visibility = FULL [@ocaml.doc ""] | LIMITED [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec sales_involvement_type = FOR_VISIBILITY_ONLY [@ocaml.doc ""] | CO_SELL [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec opportunity_origin = AWS_REFERRAL [@ocaml.doc ""] | PARTNER_REFERRAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec marketing_source = MARKETING_ACTIVITY [@ocaml.doc ""] | NONE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec national_security = YES [@ocaml.doc ""] | NO [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec create_opportunity_request = {
  ...
  tags : tag_list option; [@ocaml.doc "A map of the key-value pairs of the tag or tags to assign.\n"]
}
[@@ocaml.doc ""]
...
type nonrec resource_snapshot_job_status = RUNNING [@ocaml.doc ""] | STOPPED [@ocaml.doc ""]
[@@ocaml.doc ""]
