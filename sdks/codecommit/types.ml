...
type nonrec approval_state = APPROVE [@ocaml.doc ""] | REVOKE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec override_status = OVERRIDE [@ocaml.doc ""] | REVOKE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec approval_state_changed_event_metadata = {
  ...
  approval_status : approval_state option; [@ocaml.doc "The approval status for the pull request.\n"]
}
...
type nonrec pull_request_status_enum = OPEN [@ocaml.doc ""] | CLOSED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec put_file_input = {
  ...
  email : email option; [@ocaml.doc "An email address for the person adding or updating the file.\n"]
}
[@@ocaml.doc ""]
...
type nonrec relative_file_version_enum = BEFORE [@ocaml.doc ""] | AFTER [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec repository_name_id_pair = {
  repository_name : repository_name option;
      [@ocaml.doc "The name associated with the repository.\n"]
...
type nonrec order_enum = ASCENDING [@ocaml.doc ""] | DESCENDING [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec sort_by_enum = REPOSITORY_NAME [@ocaml.doc ""] | MODIFIED_DATE [@ocaml.doc ""]
[@@ocaml.doc ""]
