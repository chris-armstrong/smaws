...
type nonrec open_zfs_quota_type = USER [@ocaml.doc ""] | GROUP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec data_compression_type = NONE [@ocaml.doc ""] | LZ4 [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec drive_cache_type = NONE [@ocaml.doc ""] | READ [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec volume_type = ONTAP [@ocaml.doc ""] | OPENZFS [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec volume_style = FLEXVOL [@ocaml.doc ""] | FLEXGROUP [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec snaplock_type = COMPLIANCE [@ocaml.doc ""] | ENTERPRISE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ontap_volume_type = RW [@ocaml.doc ""] | DP [@ocaml.doc ""] | LS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec security_style = UNIX [@ocaml.doc ""] | NTFS [@ocaml.doc ""] | MIXED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec event_type = NEW [@ocaml.doc ""] | CHANGED [@ocaml.doc ""] | DELETED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec snapshot_filter_name = FILE_SYSTEM_ID [@ocaml.doc ""] | VOLUME_ID [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ontap_file_system_user_type = UNIX [@ocaml.doc ""] | WINDOWS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec s3_access_point_attachment_type = OPENZFS [@ocaml.doc ""] | ONTAP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec resource_type = FILE_SYSTEM [@ocaml.doc ""] | VOLUME [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec input_ontap_volume_type = RW [@ocaml.doc ""] | DP [@ocaml.doc ""] [@@ocaml.doc ""]
