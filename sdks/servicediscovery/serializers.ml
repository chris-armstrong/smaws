...
let dns_record_to_yojson (x : dns_record) =
  assoc_to_yojson
    [("TTL", (Some (record_tt_l_to_yojson x.tt_l)));
...
let update_public_dns_namespace_response_to_yojson
  (x : update_public_dns_namespace_response) =
  assoc_to_yojson
    [("OperationId",
       (option_to_yojson operation_id_to_yojson x.operation_id))]
...
let public_dns_properties_mutable_change_to_yojson
  (x : public_dns_properties_mutable_change) =
  assoc_to_yojson [("SOA", (Some (soa_change_to_yojson x.so_a)))]
let public_dns_namespace_properties_change_to_yojson
  (x : public_dns_namespace_properties_change) =
  assoc_to_yojson
    [("DnsProperties",
       (Some
          (public_dns_properties_mutable_change_to_yojson x.dns_properties)))]
let public_dns_namespace_change_to_yojson (x : public_dns_namespace_change) =
  assoc_to_yojson
    [("Properties",
       (option_to_yojson public_dns_namespace_properties_change_to_yojson
          x.properties));
    ("Description",
      (option_to_yojson resource_description_to_yojson x.description))]
let update_public_dns_namespace_request_to_yojson
  (x : update_public_dns_namespace_request) =
  assoc_to_yojson
    [("Namespace",
...
let update_private_dns_namespace_response_to_yojson
  (x : update_private_dns_namespace_response) =
  assoc_to_yojson
    [("OperationId",
       (option_to_yojson operation_id_to_yojson x.operation_id))]
let private_dns_properties_mutable_change_to_yojson
  (x : private_dns_properties_mutable_change) =
  assoc_to_yojson [("SOA", (Some (soa_change_to_yojson x.so_a)))]
let private_dns_namespace_properties_change_to_yojson
  (x : private_dns_namespace_properties_change) =
  assoc_to_yojson
    [("DnsProperties",
       (Some
          (private_dns_properties_mutable_change_to_yojson x.dns_properties)))]
let private_dns_namespace_change_to_yojson (x : private_dns_namespace_change)
  =
  assoc_to_yojson
    [("Properties",
       (option_to_yojson private_dns_namespace_properties_change_to_yojson
          x.properties));
    ("Description",
      (option_to_yojson resource_description_to_yojson x.description))]
let update_private_dns_namespace_request_to_yojson
  (x : update_private_dns_namespace_request) =
  assoc_to_yojson
    [("Namespace",
...
let update_http_namespace_response_to_yojson
  (x : update_http_namespace_response) =
  assoc_to_yojson
    [("OperationId",
       (option_to_yojson operation_id_to_yojson x.operation_id))]
let http_namespace_change_to_yojson (x : http_namespace_change) =
  assoc_to_yojson
    [("Description", (Some (resource_description_to_yojson x.description)))]
let update_http_namespace_request_to_yojson
  (x : update_http_namespace_request) =
  assoc_to_yojson
...
let tag_resource_request_to_yojson (x : tag_resource_request) =
  assoc_to_yojson
    ...
    ("ResourceARN", (Some (amazon_resource_name_to_yojson x.resource_ar_n)))]
let service_type_option_to_yojson (x : service_type_option) =
  match x with | HTTP -> `String "HTTP"
...
let service_summary_to_yojson (x : service_summary) =
  assoc_to_yojson
    [("CreateDate", (option_to_yojson timestamp__to_yojson x.create_date));
    ("HealthCheckCustomConfig",
      (option_to_yojson health_check_custom_config_to_yojson
         x.health_check_custom_config));
    ("HealthCheckConfig",
      (option_to_yojson health_check_config_to_yojson x.health_check_config));
...
let service_summaries_list_to_yojson tree =
...
let attributes_to_yojson tree =
  map_to_yojson attr_key_to_yojson attr_value_to_yojson tree
...
let operation_filters_to_yojson tree =
  list_to_yojson operation_filter_to_yojson tree
...
let http_properties_to_yojson (x : http_properties) =
  assoc_to_yojson
    [("HttpName", (option_to_yojson namespace_name_to_yojson x.http_name))]
...
let namespace_summary_to_yojson (x : namespace_summary) =
  assoc_to_yojson
    ...
    ("Arn", (option_to_yojson arn_to_yojson x.arn));
    ("Id", (option_to_yojson resource_id_to_yojson x.id))]
let namespace_summaries_list_to_yojson tree =
  list_to_yojson namespace_summary_to_yojson tree
...
let namespace_filters_to_yojson tree =
  list_to_yojson namespace_filter_to_yojson tree
...
let instance_summary_to_yojson (x : instance_summary) =
  assoc_to_yojson
    ...
    ("Id", (option_to_yojson resource_id_to_yojson x.id))]
let instance_summary_list_to_yojson tree =
  list_to_yojson instance_summary_to_yojson tree
...
let get_operation_request_to_yojson (x : get_operation_request) =
  assoc_to_yojson
    [("OperationId", (Some (resource_id_to_yojson x.operation_id)))]
...
let get_instances_health_status_response_to_yojson
  (x : get_instances_health_status_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Status",
...
let get_instances_health_status_request_to_yojson
  (x : get_instances_health_status_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
...
let http_instance_summary_list_to_yojson tree =
  list_to_yojson http_instance_summary_to_yojson tree
...
let create_http_namespace_response_to_yojson
  (x : create_http_namespace_response) =
  assoc_to_yojson
    [("OperationId",
       (option_to_yojson operation_id_to_yojson x.operation_id))]
let create_http_namespace_request_to_yojson
  (x : create_http_namespace_request) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("Description",
      (option_to_yojson resource_description_to_yojson x.description));
