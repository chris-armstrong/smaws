...
type nonrec health_check_config =
  ...
  failure_threshold: failure_threshold option
    [@ocaml.doc
      "The number of consecutive health checks that an endpoint must pass or fail for Route\194\16053 to change the current status of the endpoint from unhealthy to healthy or the other way around. For more information, see {{:https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-determining-health-of-endpoints.html}How Route\194\16053 Determines Whether an Endpoint Is Healthy} in the {i Route\194\16053 Developer Guide}.\n"];
  ...
  type_: health_check_type
    [@ocaml.doc
      "The type of health check that you want to create, which indicates how Route\194\16053 determines whether an endpoint is healthy.\n\n  You can't change the value of [Type] after you create a health check.\n  \n    You can create the following types of health checks:\n    \n     {ul\n           {-   {b HTTP}: Route\194\16053 tries to establish a TCP connection. If successful, Route\194\16053 submits an HTTP request and waits for an HTTP status code of 200 or greater and less than 400.\n               \n                }\n           {-   {b HTTPS}: Route\194\16053 tries to establish a TCP connection. If successful, Route\194\16053 submits an HTTPS request and waits for an HTTP status code of 200 or greater and less than 400.\n               \n                 If you specify HTTPS for the value of [Type], the endpoint must support TLS v1.0 or later.\n                 \n                   }\n           {-   {b TCP}: Route\194\16053 tries to establish a TCP connection.\n               \n                If you specify [TCP] for [Type], don't specify a value for [ResourcePath].\n                \n                 }\n           }\n   For more information, see {{:https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-determining-health-of-endpoints.html}How Route\194\16053 Determines Whether an Endpoint Is Healthy} in the {i Route\194\16053 Developer Guide}.\n   "]}
[@@ocaml.doc
...
type nonrec service_attributes_map =
  (service_attribute_key * service_attribute_value) list[@@ocaml.doc ""]
...
type nonrec routing_policy =
  | WEIGHTED [@ocaml.doc ""]
  | MULTIVALUE [@ocaml.doc ""][@@ocaml.doc ""]
...
type nonrec service_filter_name =
  | NAMESPACE_ID [@ocaml.doc ""][@@ocaml.doc ""]
...
type nonrec service =
  ...
  health_check_config: health_check_config option
    [@ocaml.doc
      " {i Public DNS and HTTP namespaces only.} A complex type that contains settings for an optional health check. If you specify settings for a health check, Cloud Map associates the health check with the records that you specify in [DnsConfig].\n\n For information about the charges for health checks, see {{:http://aws.amazon.com/route53/pricing/}Amazon Route\194\16053 Pricing}.\n "];
  type_: service_type option
    [@ocaml.doc
      "Describes the systems that can be used to discover the service instances.\n\n  DNS_HTTP  The service instances can be discovered using either DNS queries or the [DiscoverInstances] API operation.\n            \n              HTTP  The service instances can only be discovered using the [DiscoverInstances] API operation.\n                    \n                      DNS  Reserved.\n                           \n                             "];
  dns_config: dns_config option
...
type nonrec so_a =
  {
  tt_l: record_tt_l
    [@ocaml.doc "The time to live (TTL) for purposes of negative caching.\n"]}
[@@ocaml.doc
...
type nonrec namespace_type =
  ...
  | DNS_PUBLIC [@ocaml.doc ""][@@ocaml.doc ""]
...
type nonrec http_properties =
  {
  http_name: namespace_name option
...
type nonrec instance_summary =
  ...
  attributes: attributes option
    [@ocaml.doc
      "A string map that contains the following information:\n\n {ul\n       {-  The attributes that are associated with the instance. \n           \n            }\n       {-  For each attribute, the applicable value.\n           \n            }\n       }\n   Supported attribute keys include the following:\n   \n     AWS_ALIAS_DNS_NAME  For an alias record that routes traffic to an Elastic Load Balancing load balancer, the DNS name that's associated with the load balancer. \n                         \n                           AWS_EC2_INSTANCE_ID (HTTP namespaces only)  The Amazon EC2 instance ID for the instance. When the [AWS_EC2_INSTANCE_ID] attribute is specified, then the [AWS_INSTANCE_IPV4] attribute contains the primary private IPv4 address.\n                                                                       \n                                                                         AWS_INIT_HEALTH_STATUS  \nIf the service configuration includes [HealthCheckCustomConfig], you can optionally use [AWS_INIT_HEALTH_STATUS] to specify the initial status of the custom health check, [HEALTHY] or [UNHEALTHY]. If you don't specify a value for [AWS_INIT_HEALTH_STATUS], the initial status is [HEALTHY].\n\n  AWS_INSTANCE_CNAME  For a [CNAME] record, the domain name that Route\194\16053 returns in response to DNS queries (for example, [example.com]).\n                      \n                        AWS_INSTANCE_IPV4  For an [A] record, the IPv4 address that Route\194\16053 returns in response to DNS queries (for example, [192.0.2.44]).\n                                           \n                                             AWS_INSTANCE_IPV6  For an [AAAA] record, the IPv6 address that Route\194\16053 returns in response to DNS queries (for example, [2001:0db8:85a3:0000:0000:abcd:0001:2345]).\n                                                                \n                                                                  AWS_INSTANCE_PORT  \nFor an [SRV] record, the value that Route\194\16053 returns for the port. In addition, if the service includes [HealthCheckConfig], the port on the endpoint that Route\194\16053 sends requests to.\n\n  "];
  id: resource_id option
    [@ocaml.doc
...
type nonrec get_service_request =
  {
  id: resource_id
    [@ocaml.doc "The ID of the service that you want to get settings for.\n"]}
[@@ocaml.doc ""]
...
type nonrec operation_type =
  ...
  | CREATE_NAMESPACE [@ocaml.doc ""][@@ocaml.doc ""]
type nonrec message = string[@@ocaml.doc ""]
type nonrec code = string[@@ocaml.doc ""]
type nonrec operation_target_type =
  | INSTANCE [@ocaml.doc ""]
  | SERVICE [@ocaml.doc ""]
  | NAMESPACE [@ocaml.doc ""][@@ocaml.doc ""]
type nonrec operation_targets_map =
  (operation_target_type * resource_id) list[@@ocaml.doc ""]
...
type nonrec health_status =
  ...
  | UNHEALTHY [@ocaml.doc ""]
  | HEALTHY [@ocaml.doc ""][@@ocaml.doc ""]
type nonrec instance_health_status_map = (resource_id * health_status) list
[@@ocaml.doc ""]
...
type nonrec create_service_request =
  ...
  health_check_config: health_check_config option
    [@ocaml.doc
      " {i Public DNS and HTTP namespaces only.} A complex type that contains settings for an optional Route\194\16053 health check. If you specify settings for a health check, Cloud Map associates the health check with all the Route\194\16053 DNS records that you specify in [DnsConfig].\n\n  If you specify a health check configuration, you can specify either [HealthCheckCustomConfig] or [HealthCheckConfig] but not both.\n  \n    For information about the charges for health checks, see {{:http://aws.amazon.com/cloud-map/pricing/}Cloud Map Pricing}.\n    "];
  dns_config: dns_config option
    [@ocaml.doc
...
val make_update_service_response :
  ?operation_id:operation_id -> unit -> update_service_response
val make_dns_record :
  tt_l:record_tt_l -> type_:record_type -> unit -> dns_record
val make_dns_config_change :
  dns_records:dns_record_list -> unit -> dns_config_change
...
val make_service_change :
  ?health_check_config:health_check_config ->
    ?dns_config:dns_config_change ->
      ?description:resource_description -> unit -> service_change
...
val make_update_service_attributes_request :
  attributes:service_attributes_map ->
    service_id:resource_id -> unit -> update_service_attributes_request
...
val make_public_dns_namespace_change :
  ?properties:public_dns_namespace_properties_change ->
    ?description:resource_description -> unit -> public_dns_namespace_change
val make_update_public_dns_namespace_request :
  ?updater_request_id:resource_id ->
    namespace:public_dns_namespace_change ->
      id:resource_id -> unit -> update_public_dns_namespace_request
...
val make_private_dns_namespace_change :
  ?properties:private_dns_namespace_properties_change ->
    ?description:resource_description -> unit -> private_dns_namespace_change
val make_update_private_dns_namespace_request :
  ?updater_request_id:resource_id ->
    namespace:private_dns_namespace_change ->
      id:resource_id -> unit -> update_private_dns_namespace_request
...
val make_http_namespace_change :
  description:resource_description -> unit -> http_namespace_change
val make_update_http_namespace_request :
  ?updater_request_id:resource_id ->
    namespace:http_namespace_change ->
      id:resource_id -> unit -> update_http_namespace_request
...
val make_dns_config :
  ?routing_policy:routing_policy ->
    ?namespace_id:resource_id ->
      dns_records:dns_record_list -> unit -> dns_config
        ...
        ?dns_config:dns_config ->
          ?instance_count:resource_count ->
            ?description:resource_description ->
              ?type_:service_type ->
                ?name:service_name ->
                  ?arn:arn -> ?id:resource_id -> unit -> service_summary
val make_service_filter :
  ?condition:filter_condition ->
    values:filter_values ->
      name:service_filter_name -> unit -> service_filter
val make_service_attributes :
  ?attributes:service_attributes_map ->
    ?service_arn:arn -> unit -> service_attributes
val make_service :
            ...
            ?dns_config:dns_config ->
              ?instance_count:resource_count ->
                ?description:resource_description ->
                  ?namespace_id:resource_id ->
                    ?name:service_name ->
                      ?arn:arn -> ?id:resource_id -> unit -> service
...
val make_register_instance_request :
  ?creator_request_id:resource_id ->
    attributes:attributes ->
      instance_id:instance_id ->
        service_id:resource_id -> unit -> register_instance_request
...
val make_list_services_response :
  ?next_token:next_token ->
    ?services:service_summaries_list -> unit -> list_services_response
val make_list_services_request :
  ?filters:service_filters ->
    ?max_results:max_results ->
      ?next_token:next_token -> unit -> list_services_request
...
val make_list_operations_response :
  ?next_token:next_token ->
    ?operations:operation_summary_list -> unit -> list_operations_response
...
val make_list_operations_request :
  ?filters:operation_filters ->
    ?max_results:max_results ->
      ?next_token:next_token -> unit -> list_operations_request
val make_dns_properties :
  ?so_a:so_a -> ?hosted_zone_id:resource_id -> unit -> dns_properties
val make_http_properties :
  ?http_name:namespace_name -> unit -> http_properties
      ...
      ?service_count:resource_count ->
        ?description:resource_description ->
          ?type_:namespace_type ->
            ?name:namespace_name ->
              ?arn:arn -> ?id:resource_id -> unit -> namespace_summary
val make_list_namespaces_response :
  ?next_token:next_token ->
    ?namespaces:namespace_summaries_list -> unit -> list_namespaces_response
...
val make_list_namespaces_request :
  ?filters:namespace_filters ->
    ?max_results:max_results ->
      ?next_token:next_token -> unit -> list_namespaces_request
val make_instance_summary :
  ?attributes:attributes -> ?id:resource_id -> unit -> instance_summary
val make_list_instances_response :
  ?next_token:next_token ->
    ?instances:instance_summary_list -> unit -> list_instances_response
val make_list_instances_request :
  ?max_results:max_results ->
    ?next_token:next_token ->
      service_id:resource_id -> unit -> list_instances_request
  ...
  ?next_token:next_token ->
    ?max_results:max_results ->
      ?instances:instance_id_list ->
        service_id:resource_id -> unit -> get_instances_health_status_request
val make_instance :
  ?attributes:attributes ->
    ?creator_request_id:resource_id -> id:resource_id -> unit -> instance
val make_get_instance_response :
  ?instance:instance -> unit -> get_instance_response
val make_get_instance_request :
  instance_id:resource_id ->
    service_id:resource_id -> unit -> get_instance_request
val make_discover_instances_revision_response :
  ?instances_revision:revision ->
    unit -> discover_instances_revision_response
val make_discover_instances_revision_request :
  service_name:service_name ->
    namespace_name:namespace_name ->
      unit -> discover_instances_revision_request
val make_http_instance_summary :
  ?attributes:attributes ->
    ?health_status:health_status ->
      ?service_name:service_name ->
        ?namespace_name:namespace_name_http ->
          ?instance_id:resource_id -> unit -> http_instance_summary
...
val make_deregister_instance_request :
  instance_id:resource_id ->
    service_id:resource_id -> unit -> deregister_instance_request
val make_delete_service_attributes_response : unit -> unit
val make_delete_service_attributes_request :
  attributes:service_attribute_key_list ->
    service_id:resource_id -> unit -> delete_service_attributes_request
val make_delete_service_response : unit -> unit
val make_delete_service_request :
  id:resource_id -> unit -> delete_service_request
val make_delete_namespace_response :
  ?operation_id:operation_id -> unit -> delete_namespace_response
val make_delete_namespace_request :
  id:resource_id -> unit -> delete_namespace_request
        ...
        ?health_check_config:health_check_config ->
          ?dns_config:dns_config ->
            ?description:resource_description ->
              ?creator_request_id:resource_id ->
                ?namespace_id:resource_id ->
                  name:service_name -> unit -> create_service_request
  ...
  ?properties:public_dns_namespace_properties ->
    ?tags:tag_list ->
      ?description:resource_description ->
        ?creator_request_id:resource_id ->
          name:namespace_name_public ->
            unit -> create_public_dns_namespace_request
    ...
    ?tags:tag_list ->
      ?description:resource_description ->
        ?creator_request_id:resource_id ->
          vpc:resource_id ->
            name:namespace_name_private ->
              unit -> create_private_dns_namespace_request
...
val make_create_http_namespace_request :
  ?tags:tag_list ->
    ?description:resource_description ->
      ?creator_request_id:resource_id ->
        name:namespace_name_http -> unit -> create_http_namespace_request(** {1:operations Operations} *)
    ...
    Smaws_Lib.Context.t ->
      delete_namespace_request ->
        (delete_namespace_response,
          ...
          | `InvalidInput of invalid_input 
          | `NamespaceNotFound of namespace_not_found 
          | `ResourceInUse of resource_in_use ]) result
end[@@ocaml.doc
    ...
    Smaws_Lib.Context.t ->
      get_namespace_request ->
        (get_namespace_response,
          [> Smaws_Lib.Protocols.AwsJson.error
          | `InvalidInput of invalid_input 
          | `NamespaceNotFound of namespace_not_found ]) result
    ...
    Smaws_Lib.Context.t ->
      get_operation_request ->
        (get_operation_response,
          [> Smaws_Lib.Protocols.AwsJson.error
          | `InvalidInput of invalid_input 
          | `OperationNotFound of operation_not_found ]) result
end[@@ocaml.doc
    ...
    Smaws_Lib.Context.t ->
      list_namespaces_request ->
        (list_namespaces_response,
          [> Smaws_Lib.Protocols.AwsJson.error
          | `InvalidInput of invalid_input ]) result
end[@@ocaml.doc
...
sig
  val request :
    Smaws_Lib.Context.t ->
     ...
     "Submits a request to change the health status of a custom health check to healthy or unhealthy.\n\n You can use [UpdateInstanceCustomHealthStatus] to change the status only for custom health checks, which you define using [HealthCheckCustomConfig] when you create a service. You can't use it to change the status for Route\194\16053 health checks, which you define using [HealthCheckConfig].\n \n  For more information, see {{:https://docs.aws.amazon.com/cloud-map/latest/api/API_HealthCheckCustomConfig.html}HealthCheckCustomConfig}.\n  "]
