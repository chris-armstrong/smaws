...
type nonrec service_change =
  ...
  description: string option [@ocaml.doc "A description for the service.\n"]}
[@@ocaml.doc
...
type nonrec update_public_dns_namespace_request =
  ...
  id: string [@ocaml.doc "The ID of the namespace being updated.\n"]}
[@@ocaml.doc ""]
...
type nonrec tag =
  ...
  key: string [@ocaml.doc "The key identifier, or name, of the tag.\n"]}
...
type nonrec service_summary =
  ...
  name: string option [@ocaml.doc "The name of the service.\n"];
  arn: string option
    [@ocaml.doc
...
type nonrec service =
  ...
  instance_count: int option
    [@ocaml.doc
      "The number of instances that are currently associated with the service. Instances that were previously associated with the service but that are deleted aren't included in the count. The count might not reflect pending registrations and deregistrations.\n"];
  description: string option [@ocaml.doc "The description of the service.\n"];
  namespace_id: string option
    [@ocaml.doc
...
type nonrec operation_summary =
  ...
  id: string option [@ocaml.doc "The ID for an operation.\n"]}[@@ocaml.doc
...
type nonrec http_properties =
  {
  http_name: string option [@ocaml.doc "The name of an HTTP namespace.\n"]}
...
type nonrec namespace_summary =
  ...
  id: string option [@ocaml.doc "The ID of the namespace.\n"]}[@@ocaml.doc
...
type nonrec namespace =
  ...
  arn: string option
    [@ocaml.doc
      "The Amazon Resource Name (ARN) that Cloud Map assigns to the namespace when you create it.\n"];
  id: string option [@ocaml.doc "The ID of a namespace.\n"]}[@@ocaml.doc
...
type nonrec delete_service_request =
  {
  id: string [@ocaml.doc "The ID of the service that you want to delete.\n"]}
[@@ocaml.doc ""]
