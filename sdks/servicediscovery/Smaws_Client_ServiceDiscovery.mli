...
val make_create_http_namespace_request :
  ?tags:tag_list ->
    ?description:resource_description ->
      ?creator_request_id:resource_id ->
        name:namespace_name_http -> unit -> create_http_namespace_request
...
sig
  val error_to_string :
    ...
    | `TooManyTagsException of too_many_tags_exception ] -> string
  val request :
...
sig
  val error_to_string :
    ...
    | `InvalidInput of invalid_input 
    | `NamespaceNotFound of namespace_not_found 
    | `ResourceInUse of resource_in_use ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `ServiceNotFound of service_not_found ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `InvalidInput of invalid_input  | `ResourceInUse of resource_in_use 
    | `ServiceNotFound of service_not_found ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error | `InvalidInput of invalid_input 
    | `NamespaceNotFound of namespace_not_found ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error | `InvalidInput of invalid_input 
    | `OperationNotFound of operation_not_found ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
