  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "DuplicateRequest") ->
            `DuplicateRequest
              (Json_deserializers.duplicate_request_of_yojson tree path)
        | (_, "InvalidInput") ->
            `InvalidInput
              (Json_deserializers.invalid_input_of_yojson tree path)
        | (_, "NamespaceAlreadyExists") ->
            `NamespaceAlreadyExists
              (Json_deserializers.namespace_already_exists_of_yojson tree
                 path)
        | (_, "ResourceLimitExceeded") ->
            `ResourceLimitExceeded
              (Json_deserializers.resource_limit_exceeded_of_yojson tree path)
    ...
    let request context (request : create_http_namespace_request) =
      let input =
        Json_serializers.create_http_namespace_request_to_yojson request in
...
module CreatePrivateDnsNamespace =
  struct
    ...
    let request context (request : create_private_dns_namespace_request) =
      let input =
        Json_serializers.create_private_dns_namespace_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreatePublicDnsNamespace =
  struct
    ...
    let request context (request : create_public_dns_namespace_request) =
      let input =
        Json_serializers.create_public_dns_namespace_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "NamespaceNotFound") ->
            `NamespaceNotFound
              (Json_deserializers.namespace_not_found_of_yojson tree path)
        | (_, "ResourceLimitExceeded") ->
            `ResourceLimitExceeded
              (Json_deserializers.resource_limit_exceeded_of_yojson tree path)
        | (_, "ServiceAlreadyExists") ->
            `ServiceAlreadyExists
              (Json_deserializers.service_already_exists_of_yojson tree path)
        | (_, "TooManyTagsException") ->
            `TooManyTagsException
              (Json_deserializers.too_many_tags_exception_of_yojson tree path)
        | _type -> handler tree path _type in
    ...
    let request context (request : create_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.CreateService" ~service
        ~context ~input
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "ResourceInUse") ->
            `ResourceInUse
              (Json_deserializers.resource_in_use_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : delete_namespace_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.DeleteNamespace" ~service
        ~context ~input
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "ServiceNotFound") ->
            `ServiceNotFound
              (Json_deserializers.service_not_found_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : delete_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.DeleteService" ~service
        ~context ~input
...
module DeleteServiceAttributes =
  struct
    ...
    let request context (request : delete_service_attributes_request) =
      let input =
        Json_serializers.delete_service_attributes_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.DeleteServiceAttributes"
        ~service ~context ~input
  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InstanceNotFound") ->
            `InstanceNotFound
              (Json_deserializers.instance_not_found_of_yojson tree path)
        | (_, "InvalidInput") ->
            `InvalidInput
              (Json_deserializers.invalid_input_of_yojson tree path)
        | (_, "ResourceInUse") ->
    ...
    let request context (request : deregister_instance_request) =
      let input =
        Json_serializers.deregister_instance_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.DeregisterInstance" ~service
        ~context ~input
...
module DiscoverInstances =
  struct
    ...
    let request context (request : discover_instances_request) =
      let input =
        Json_serializers.discover_instances_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.DiscoverInstances" ~service
        ~context ~input
...
module DiscoverInstancesRevision =
  struct
    ...
    let request context (request : discover_instances_revision_request) =
      let input =
        Json_serializers.discover_instances_revision_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetInstance =
  struct
    ...
    let request context (request : get_instance_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.GetInstance" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.get_instance_response_of_yojson
        ~error_deserializer
  end
module GetInstancesHealthStatus =
  struct
    ...
    let request context (request : get_instances_health_status_request) =
      let input =
        Json_serializers.get_instances_health_status_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetNamespace =
  struct
    ...
    let request context (request : get_namespace_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.GetNamespace" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.get_namespace_response_of_yojson
        ~error_deserializer
  end
module GetOperation =
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "OperationNotFound") ->
            `OperationNotFound
              (Json_deserializers.operation_not_found_of_yojson tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
                                        Smaws_Lib.Protocols.AwsJson.Errors.default_handler)
    ...
    let request context (request : get_operation_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.GetOperation" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.get_operation_response_of_yojson
        ~error_deserializer
  end
module GetService =
  struct
    ...
    let request context (request : get_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.GetService" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.get_service_response_of_yojson
        ~error_deserializer
  end
module GetServiceAttributes =
  struct
    ...
    let request context (request : get_service_attributes_request) =
      let input =
        Json_serializers.get_service_attributes_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.GetServiceAttributes"
        ~service ~context ~input
...
module ListInstances =
  struct
    ...
    let request context (request : list_instances_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.ListInstances" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_instances_response_of_yojson
        ~error_deserializer
  end
module ListNamespaces =
  struct
    ...
    let request context (request : list_namespaces_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.ListNamespaces" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_namespaces_response_of_yojson
        ~error_deserializer
  end
module ListOperations =
  struct
    ...
    let request context (request : list_operations_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.ListOperations" ~service
        ~context ~input
...
module ListServices =
  struct
    ...
    let request context (request : list_services_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.ListServices" ~service
        ~context ~input
...
module RegisterInstance =
  struct
    ...
    let request context (request : register_instance_request) =
      let input =
        Json_serializers.register_instance_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.RegisterInstance" ~service
        ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.TagResource" ~service
        ~context ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.UntagResource" ~service
        ~context ~input
...
module UpdateHttpNamespace =
  struct
    ...
    let request context (request : update_http_namespace_request) =
      let input =
        Json_serializers.update_http_namespace_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateInstanceCustomHealthStatus =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "CustomHealthNotFound") ->
            `CustomHealthNotFound
              (Json_deserializers.custom_health_not_found_of_yojson tree path)
        | (_, "InstanceNotFound") ->
            `InstanceNotFound
              (Json_deserializers.instance_not_found_of_yojson tree path)
        | (_, "InvalidInput") ->
    ...
    let request context
      ...
      let input =
        Json_serializers.update_instance_custom_health_status_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdatePrivateDnsNamespace =
  struct
    ...
    let request context (request : update_private_dns_namespace_request) =
      let input =
        Json_serializers.update_private_dns_namespace_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdatePublicDnsNamespace =
  struct
    ...
    let request context (request : update_public_dns_namespace_request) =
      let input =
        Json_serializers.update_public_dns_namespace_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateService =
  struct
    ...
    let request context (request : update_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.UpdateService" ~service
        ~context ~input
...
module UpdateServiceAttributes =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ServiceAttributesLimitExceededException") ->
            `ServiceAttributesLimitExceededException
              (Json_deserializers.service_attributes_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "ServiceNotFound") ->
            `ServiceNotFound
              (Json_deserializers.service_not_found_of_yojson tree path)
    ...
    let request context (request : update_service_attributes_request) =
      let input =
        Json_serializers.update_service_attributes_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Route53AutoNaming_v20170314.UpdateServiceAttributes"
        ~service ~context ~input
