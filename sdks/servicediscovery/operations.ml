...
module DeleteNamespace =
  struct
    ...
    let request context (request : delete_namespace_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_namespace_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteServiceAttributes =
  struct
    ...
    let request context (request : delete_service_attributes_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_service_attributes_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : discover_instances_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"Route53AutoNaming_v20170314DiscoverInstances" ~service
          ~config:context.config ~http:context.http ~input
...
module ListNamespaces =
  struct
    ...
    let request context (request : list_namespaces_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_namespaces_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : register_instance_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"Route53AutoNaming_v20170314RegisterInstance" ~service
          ~config:context.config ~http:context.http ~input
...
module UpdateServiceAttributes =
  struct
    ...
    let request context (request : update_service_attributes_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_service_attributes_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
