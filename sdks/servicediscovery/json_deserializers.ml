...
let dns_record_list_of_yojson tree path = list_of_yojson dns_record_of_yojson tree path
...
let health_check_config_of_yojson tree path =
  ...
  ({
     failure_threshold =
       option_of_yojson (value_for_key failure_threshold_of_yojson "FailureThreshold") _list path;
     resource_path =
       option_of_yojson (value_for_key resource_path_of_yojson "ResourcePath") _list path;
...
let service_change_of_yojson tree path =
  ...
  ({
     health_check_config =
       option_of_yojson (value_for_key health_check_config_of_yojson "HealthCheckConfig") _list path;
     dns_config =
       option_of_yojson (value_for_key dns_config_change_of_yojson "DnsConfig") _list path;
     description =
...
let service_attributes_map_of_yojson tree path =
  map_of_yojson service_attribute_key_of_yojson service_attribute_value_of_yojson tree path
...
let soa_change_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({ tt_l = value_for_key record_tt_l_of_yojson "TTL" _list path } : soa_change)
...
let public_dns_namespace_properties_change_of_yojson tree path =
  ...
  ({
     dns_properties =
       value_for_key public_dns_properties_mutable_change_of_yojson "DnsProperties" _list path;
   }
...
let public_dns_namespace_change_of_yojson tree path =
  ...
  ({
     properties =
       option_of_yojson
         (value_for_key public_dns_namespace_properties_change_of_yojson "Properties")
         _list path;
     description =
       option_of_yojson (value_for_key resource_description_of_yojson "Description") _list path;
   }
...
let private_dns_namespace_properties_change_of_yojson tree path =
  ...
  ({
     dns_properties =
       value_for_key private_dns_properties_mutable_change_of_yojson "DnsProperties" _list path;
   }
...
let private_dns_namespace_change_of_yojson tree path =
  ...
  ({
     properties =
       option_of_yojson
         (value_for_key private_dns_namespace_properties_change_of_yojson "Properties")
         _list path;
     description =
       option_of_yojson (value_for_key resource_description_of_yojson "Description") _list path;
   }
...
let dns_config_of_yojson tree path =
  ...
  ({
     dns_records = value_for_key dns_record_list_of_yojson "DnsRecords" _list path;
     routing_policy =
       option_of_yojson (value_for_key routing_policy_of_yojson "RoutingPolicy") _list path;
...
let service_summary_of_yojson tree path =
  ...
  ({
     ...
     health_check_custom_config =
       option_of_yojson
         (value_for_key health_check_custom_config_of_yojson "HealthCheckCustomConfig")
         _list path;
     health_check_config =
       option_of_yojson (value_for_key health_check_config_of_yojson "HealthCheckConfig") _list path;
     dns_config = option_of_yojson (value_for_key dns_config_of_yojson "DnsConfig") _list path;
     instance_count =
       option_of_yojson (value_for_key resource_count_of_yojson "InstanceCount") _list path;
     description =
       option_of_yojson (value_for_key resource_description_of_yojson "Description") _list path;
...
let service_filters_of_yojson tree path = list_of_yojson service_filter_of_yojson tree path
...
let so_a_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({ tt_l = value_for_key record_tt_l_of_yojson "TTL" _list path } : so_a)
...
let attributes_of_yojson tree path = map_of_yojson attr_key_of_yojson attr_value_of_yojson tree path
...
let list_services_response_of_yojson tree path =
  ...
  ({
     ...
     services =
       option_of_yojson (value_for_key service_summaries_list_of_yojson "Services") _list path;
   }
...
let operation_filters_of_yojson tree path = list_of_yojson operation_filter_of_yojson tree path
...
let dns_properties_of_yojson tree path =
  ...
  ({
     ...
     hosted_zone_id =
       option_of_yojson (value_for_key resource_id_of_yojson "HostedZoneId") _list path;
   }
    : dns_properties)
...
let namespace_properties_of_yojson tree path =
  ...
  ({
     http_properties =
       option_of_yojson (value_for_key http_properties_of_yojson "HttpProperties") _list path;
     dns_properties =
       option_of_yojson (value_for_key dns_properties_of_yojson "DnsProperties") _list path;
   }
...
let namespace_summary_of_yojson tree path =
  ...
  ({
     create_date = option_of_yojson (value_for_key timestamp_of_yojson "CreateDate") _list path;
     properties =
       option_of_yojson (value_for_key namespace_properties_of_yojson "Properties") _list path;
     service_count =
       option_of_yojson (value_for_key resource_count_of_yojson "ServiceCount") _list path;
     description =
       option_of_yojson (value_for_key resource_description_of_yojson "Description") _list path;
...
let list_namespaces_response_of_yojson tree path =
  ...
  ({
     next_token = option_of_yojson (value_for_key next_token_of_yojson "NextToken") _list path;
     namespaces =
       option_of_yojson (value_for_key namespace_summaries_list_of_yojson "Namespaces") _list path;
   }
...
let namespace_filters_of_yojson tree path = list_of_yojson namespace_filter_of_yojson tree path
...
let get_service_attributes_response_of_yojson tree path =
  ...
  ({
     service_attributes =
       option_of_yojson (value_for_key service_attributes_of_yojson "ServiceAttributes") _list path;
   }
...
let operation_targets_map_of_yojson tree path =
  map_of_yojson operation_target_type_of_yojson resource_id_of_yojson tree path
...
let get_instances_health_status_response_of_yojson tree path =
  ...
  ({
     next_token = option_of_yojson (value_for_key next_token_of_yojson "NextToken") _list path;
     status =
       option_of_yojson (value_for_key instance_health_status_map_of_yojson "Status") _list path;
   }
    : get_instances_health_status_response)

let instance_id_list_of_yojson tree path = list_of_yojson resource_id_of_yojson tree path
...
let discover_instances_revision_response_of_yojson tree path =
  ...
  ({
     instances_revision =
       option_of_yojson (value_for_key revision_of_yojson "InstancesRevision") _list path;
   }
...
let http_instance_summary_of_yojson tree path =
  ...
  ({
     ...
     namespace_name =
       option_of_yojson (value_for_key namespace_name_http_of_yojson "NamespaceName") _list path;
...
let discover_instances_response_of_yojson tree path =
  ...
  ({
     instances_revision =
       option_of_yojson (value_for_key revision_of_yojson "InstancesRevision") _list path;
     instances =
       option_of_yojson (value_for_key http_instance_summary_list_of_yojson "Instances") _list path;
   }
...
let discover_instances_request_of_yojson tree path =
  ...
  ({
     ...
     optional_parameters =
       option_of_yojson (value_for_key attributes_of_yojson "OptionalParameters") _list path;
     query_parameters =
       option_of_yojson (value_for_key attributes_of_yojson "QueryParameters") _list path;
     max_results =
       option_of_yojson (value_for_key discover_max_results_of_yojson "MaxResults") _list path;
     service_name = value_for_key service_name_of_yojson "ServiceName" _list path;
     namespace_name = value_for_key namespace_name_of_yojson "NamespaceName" _list path;
   }
...
let public_dns_namespace_properties_of_yojson tree path =
  ...
  ({
     dns_properties =
       value_for_key public_dns_properties_mutable_of_yojson "DnsProperties" _list path;
   }
...
let create_public_dns_namespace_request_of_yojson tree path =
  ...
  ({
     properties =
       option_of_yojson
         (value_for_key public_dns_namespace_properties_of_yojson "Properties")
         _list path;
     tags = option_of_yojson (value_for_key tag_list_of_yojson "Tags") _list path;
     description =
       option_of_yojson (value_for_key resource_description_of_yojson "Description") _list path;
...
let private_dns_namespace_properties_of_yojson tree path =
  ...
  ({
     dns_properties =
       value_for_key private_dns_properties_mutable_of_yojson "DnsProperties" _list path;
   }
...
let create_private_dns_namespace_request_of_yojson tree path =
  ...
  ({
     properties =
       option_of_yojson
         (value_for_key private_dns_namespace_properties_of_yojson "Properties")
         _list path;
     tags = option_of_yojson (value_for_key tag_list_of_yojson "Tags") _list path;
