...
let soa_change_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : soa_change =
    { tt_l = (value_for_key record_tt_l_of_yojson "TTL" _list path) } in
  _res
let public_dns_properties_mutable_change_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : public_dns_properties_mutable_change =
    { so_a = (value_for_key soa_change_of_yojson "SOA" _list path) } in
  _res
...
let update_public_dns_namespace_request_of_yojson tree path =
  ...
  let _res : update_public_dns_namespace_request =
    {
      namespace =
        (value_for_key public_dns_namespace_change_of_yojson "Namespace"
           _list path);
      updater_request_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "UpdaterRequestId") _list
           path);
      id = (value_for_key resource_id_of_yojson "Id" _list path)
    } in
  _res
  ...
  let _res : too_many_tags_exception =
    {
      resource_name =
        (option_of_yojson
           (value_for_key amazon_resource_name_of_yojson "ResourceName")
           _list path);
      message =
        (option_of_yojson (value_for_key error_message_of_yojson "Message")
           _list path)
...
let service_type_option_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise
         (deserialize_unknown_enum_value_error path "ServiceTypeOption" value)
  ...
  let _res : dns_config =
    {
      ...
      routing_policy =
        (option_of_yojson
           (value_for_key routing_policy_of_yojson "RoutingPolicy") _list
           path);
      namespace_id =
  ...
  let _res : service_summary =
    {
      ...
      instance_count =
        (option_of_yojson
           (value_for_key resource_count_of_yojson "InstanceCount") _list
           path);
      description =
        (option_of_yojson
           (value_for_key resource_description_of_yojson "Description") _list
...
let service_filter_name_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise
         (deserialize_unknown_enum_value_error path "ServiceFilterName" value)
  ...
  let _res : service_already_exists =
    {
      ...
      creator_request_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "CreatorRequestId") _list
           path);
      message =
        (option_of_yojson (value_for_key error_message_of_yojson "Message")
           _list path)
  ...
  let _res : list_operations_response =
    {
      ...
      operations =
        (option_of_yojson
           (value_for_key operation_summary_list_of_yojson "Operations")
           _list path)
    } in
  _res
  ...
  let _res : operation_filter =
    {
      ...
      values = (value_for_key filter_values_of_yojson "Values" _list path);
      name =
        (value_for_key operation_filter_name_of_yojson "Name" _list path)
    } in
  _res
  ...
  let _res : dns_properties =
    {
      ...
      hosted_zone_id =
        (option_of_yojson
           (value_for_key resource_id_of_yojson "HostedZoneId") _list path)
    } in
  _res
  ...
  let _res : namespace_properties =
    {
      ...
      dns_properties =
        (option_of_yojson
           (value_for_key dns_properties_of_yojson "DnsProperties") _list
           path)
    } in
  _res
  ...
  let _res : namespace_filter =
    {
      ...
      values = (value_for_key filter_values_of_yojson "Values" _list path);
      name =
        (value_for_key namespace_filter_name_of_yojson "Name" _list path)
    } in
  _res
...
let get_service_request_of_yojson tree path =
  ...
  let _res : get_service_request =
    { id = (value_for_key resource_id_of_yojson "Id" _list path) } in
  _res
...
let health_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String "HEALTHY" -> HEALTHY
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "HealthStatus" value)
  ...
  let _res : get_instances_health_status_response =
    {
      ...
      status =
        (option_of_yojson
           (value_for_key instance_health_status_map_of_yojson "Status")
           _list path)
    } in
  _res
  ...
  let _res : http_instance_summary =
    {
      ...
      namespace_name =
        (option_of_yojson
           (value_for_key namespace_name_http_of_yojson "NamespaceName")
           _list path);
      instance_id =
  ...
  let _res : discover_instances_request =
    {
      health_status =
        (option_of_yojson
           (value_for_key health_status_filter_of_yojson "HealthStatus")
           _list path);
      optional_parameters =
        (option_of_yojson
  ...
  let _res : create_service_request =
    {
      type_ =
        (option_of_yojson
           (value_for_key service_type_option_of_yojson "Type") _list path);
      tags =
        (option_of_yojson (value_for_key tag_list_of_yojson "Tags") _list
           path);
      health_check_custom_config =
...
let public_dns_properties_mutable_of_yojson tree path =
  ...
  let _res : public_dns_properties_mutable =
    { so_a = (value_for_key so_a_of_yojson "SOA" _list path) } in
  _res
let public_dns_namespace_properties_of_yojson tree path =
  ...
  let _res : public_dns_namespace_properties =
    {
      dns_properties =
        (value_for_key public_dns_properties_mutable_of_yojson
           "DnsProperties" _list path)
    } in
  _res
  ...
  let _res : create_public_dns_namespace_request =
    {
      ...
      creator_request_id =
        (option_of_yojson
           ...
           path);
      name =
        (value_for_key namespace_name_public_of_yojson "Name" _list path)
    } in
  _res
