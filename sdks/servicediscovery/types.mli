...
type nonrec health_check_type = HTTP [@ocaml.doc ""] | HTTPS [@ocaml.doc ""] | TCP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec service_type = HTTP [@ocaml.doc ""] | DNS_HTTP [@ocaml.doc ""] | DNS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec routing_policy = MULTIVALUE [@ocaml.doc ""] | WEIGHTED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec custom_health_status = HEALTHY [@ocaml.doc ""] | UNHEALTHY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec service_filter_name = NAMESPACE_ID [@ocaml.doc ""] | RESOURCE_OWNER [@ocaml.doc ""]
[@@ocaml.doc ""]
