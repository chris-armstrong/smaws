...
type nonrec input_lambda_processor_update = {
  role_arn_update : role_ar_n option;
      [@ocaml.doc "The ARN of the new IAM role that is used to access the AWS Lambda function.\n"]
  resource_arn_update : resource_ar_n option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the new {{:https://docs.aws.amazon.com/lambda/}AWS \
         Lambda} function that is used to preprocess the records in the stream.\n\n\
        \  To specify an earlier version of the Lambda function than the latest, include the \
         ...
         ARNs, see {{:/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-lambda}Example \
         ARNs: AWS Lambda} \n\
        \  \n\
        \   "]
}
...
type nonrec kinesis_streams_input_update = {
  ...
  resource_arn_update : resource_ar_n option;
      [@ocaml.doc "Amazon Resource Name (ARN) of the input Amazon Kinesis stream to read.\n"]
}
[@@ocaml.doc
  "When updating application input configuration, provides information about an Amazon Kinesis \
...
[@@ocaml.doc
  "Provides additional mapping information when the record format uses delimiters, such as CSV. \
   For example, the following sample records use CSV format, where the records use the {i '\\n'} \
...
type nonrec record_column = {
  sql_type : record_column_sql_type;
      [@ocaml.doc "Type of column created in the in-application input stream or reference table.\n"]
...
type nonrec input_update = {
  ...
  input_id : id; [@ocaml.doc "Input ID of the application input to be updated.\n"]
}
[@@ocaml.doc
...
[@@ocaml.doc
  " When updating an output configuration using the \
   {{:https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_UpdateApplication.html}UpdateApplication} \
   operation, provides information about an Amazon Kinesis Firehose delivery stream configured as \
   the destination. \n"]
...
type nonrec output_update = {
  ...
  lambda_output_update : lambda_output_update option;
      [@ocaml.doc "Describes an AWS Lambda function as the destination for the output.\n"]
  ...
  kinesis_streams_output_update : kinesis_streams_output_update option;
      [@ocaml.doc "Describes an Amazon Kinesis stream as the destination for the output.\n"]
...
[@@ocaml.doc " Describes updates to the output configuration identified by the [OutputId]. \n"]
...
type nonrec reference_data_source_update = {
  ...
  table_name_update : in_app_table_name option;
      [@ocaml.doc "In-application table name that is created by this update.\n"]
  reference_id : id;
      [@ocaml.doc
...
[@@ocaml.doc
  "When you update a reference data source configuration for an application, this object provides \
   all the updated values (such as the source bucket name and object key name), the in-application \
   table name that is created, and updated mapping information that maps the data in the Amazon S3 \
...
type nonrec cloud_watch_logging_option_update = {
  ...
  log_stream_arn_update : log_stream_ar_n option;
      [@ocaml.doc "ARN of the CloudWatch log to receive application messages.\n"]
  cloud_watch_logging_option_id : id; [@ocaml.doc "ID of the CloudWatch logging option to update\n"]
}
[@@ocaml.doc "Describes CloudWatch logging option updates.\n"]
...
[@@ocaml.doc "Describes updates to apply to an existing Amazon Kinesis Analytics application.\n"]

type nonrec update_application_request = {
  application_update : application_update; [@ocaml.doc "Describes application updates.\n"]
  ...
  application_name : application_name;
      [@ocaml.doc "Name of the Amazon Kinesis Analytics application to update.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "Application is not available for this operation.\n"]

type nonrec invalid_argument_exception = { message : error_message option [@ocaml.doc "\n"] }
[@@ocaml.doc "Specified input parameter value is invalid.\n"]
...
type nonrec code_validation_exception = { message : error_message option [@ocaml.doc "Test\n"] }
[@@ocaml.doc
...
type nonrec untag_resource_request = {
  ...
  resource_ar_n : kinesis_analytics_ar_n;
      [@ocaml.doc "The ARN of the Kinesis Analytics application from which to remove the tags.\n"]
}
[@@ocaml.doc ""]
...
type nonrec stop_application_request = {
  application_name : application_name; [@ocaml.doc "Name of the running application to stop.\n"]
}
[@@ocaml.doc "\n"]
  ...
  input_configurations : input_configurations;
      [@ocaml.doc
        "Identifies the specific input, by ID, that the application starts consuming. Amazon \
         ...
         reading.\n"]
  application_name : application_name; [@ocaml.doc "Name of the application.\n"]
}
[@@ocaml.doc "\n"]
...
[@@ocaml.doc "User-provided application configuration is not valid.\n"]

type nonrec service_unavailable_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "The service is unavailable. Back off and retry the operation. \n"]

type nonrec s3_reference_data_source_description = {
  reference_role_ar_n : role_ar_n;
      [@ocaml.doc
        "ARN of the IAM role that Amazon Kinesis Analytics can assume to read the Amazon S3 object \
         on your behalf to populate the in-application reference table.\n"]
  file_key : file_key; [@ocaml.doc "Amazon S3 object key name.\n"]
  bucket_ar_n : bucket_ar_n; [@ocaml.doc "Amazon Resource Name (ARN) of the S3 bucket.\n"]
}
[@@ocaml.doc "Provides the bucket name and object key name that stores the reference data.\n"]
  ...
  reference_role_ar_n : role_ar_n;
      [@ocaml.doc
        "ARN of the IAM role that the service can assume to read data on your behalf. This role \
         must have permission for the [s3:GetObject] action on the object and trust policy that \
         allows Amazon Kinesis Analytics service principal to assume this role.\n"]
  file_key : file_key; [@ocaml.doc "Object key name containing reference data.\n"]
  bucket_ar_n : bucket_ar_n; [@ocaml.doc "Amazon Resource Name (ARN) of the S3 bucket.\n"]
}
[@@ocaml.doc
  "Identifies the S3 bucket and object that contains the reference data. Also identifies the IAM \
   role Amazon Kinesis Analytics can assume to read this object on your behalf.\n\n\
...
type nonrec s3_configuration = {
  ...
  bucket_ar_n : bucket_ar_n; [@ocaml.doc "ARN of the S3 bucket that contains the data.\n"]
  role_ar_n : role_ar_n; [@ocaml.doc "IAM ARN of the role used to access the data.\n"]
}
[@@ocaml.doc
  "Provides a description of an Amazon S3 data source, including the Amazon Resource Name (ARN) of \
   the S3 bucket, the ARN of the IAM role that is used to access the bucket, and the name of the \
...
[@@ocaml.doc
  "Discovery failed to get a record from the streaming source because of the Amazon Kinesis \
   ...
   {{:https://docs.aws.amazon.com/kinesis/latest/APIReference/API_GetRecords.html}GetRecords} in \
...
[@@ocaml.doc "Describes the reference data source configured for an application.\n"]
...
type nonrec reference_data_source = {
  ...
  s3_reference_data_source : s3_reference_data_source option;
      [@ocaml.doc
        "Identifies the S3 bucket and object that contains the reference data. Also identifies the \
         IAM role Amazon Kinesis Analytics can assume to read this object on your behalf. An \
         Amazon Kinesis Analytics application loads reference data only once. If the data changes, \
         you call the [UpdateApplication] operation to trigger reloading of data into your \
         application. \n"]
  table_name : in_app_table_name; [@ocaml.doc "Name of the in-application table to create.\n"]
}
[@@ocaml.doc
...
type nonrec kinesis_streams_output = {
  ...
  resource_ar_n : resource_ar_n;
      [@ocaml.doc "ARN of the destination Amazon Kinesis stream to write to.\n"]
}
[@@ocaml.doc
  ...
  role_ar_n : role_ar_n;
      [@ocaml.doc
        "ARN of the IAM role that Amazon Kinesis Analytics can assume to write to the destination \
         stream on your behalf. You need to grant the necessary permissions to this role.\n"]
  resource_ar_n : resource_ar_n;
      [@ocaml.doc "ARN of the destination Amazon Kinesis Firehose delivery stream to write to.\n"]
}
[@@ocaml.doc
  "When configuring application output, identifies an Amazon Kinesis Firehose delivery stream as \
   the destination. You provide the stream Amazon Resource Name (ARN) and an IAM role that enables \
   Amazon Kinesis Analytics to write to the stream on your behalf.\n"]
...
type nonrec output = {
  ...
  kinesis_firehose_output : kinesis_firehose_output option;
      [@ocaml.doc "Identifies an Amazon Kinesis Firehose delivery stream as the destination.\n"]
  kinesis_streams_output : kinesis_streams_output option;
      [@ocaml.doc "Identifies an Amazon Kinesis stream as the destination.\n"]
  name : in_app_stream_name; [@ocaml.doc "Name of the in-application stream.\n"]
}
[@@ocaml.doc
...
type nonrec kinesis_firehose_output_description = {
  role_ar_n : role_ar_n option;
      [@ocaml.doc
        "ARN of the IAM role that Amazon Kinesis Analytics can assume to access the stream.\n"]
  resource_ar_n : resource_ar_n option;
      [@ocaml.doc "Amazon Resource Name (ARN) of the Amazon Kinesis Firehose delivery stream.\n"]
}
[@@ocaml.doc
  " For an application output, describes the Amazon Kinesis Firehose delivery stream configured as \
   its destination. \n"]
  ...
  role_ar_n : role_ar_n option;
      [@ocaml.doc
        "ARN of the IAM role that Amazon Kinesis Analytics can assume to write to the destination \
         function.\n"]
  resource_ar_n : resource_ar_n option;
      [@ocaml.doc "Amazon Resource Name (ARN) of the destination Lambda function.\n"]
}
[@@ocaml.doc
...
type nonrec output_description = {
  ...
  kinesis_firehose_output_description : kinesis_firehose_output_description option;
      [@ocaml.doc
        "Describes the Amazon Kinesis Firehose delivery stream configured as the destination where \
         output is written.\n"]
...
[@@ocaml.doc
  "Describes the application output configuration, which includes the in-application stream name \
   and the destination where the stream data is written. The destination can be an Amazon Kinesis \
...
type nonrec application_summary = {
  application_status : application_status; [@ocaml.doc "Status of the application.\n"]
...
[@@ocaml.doc "Exceeded the number of applications allowed.\n"]
...
type nonrec kinesis_streams_input = {
  role_ar_n : role_ar_n;
      [@ocaml.doc
        "ARN of the IAM role that Amazon Kinesis Analytics can assume to access the stream on your \
         behalf. You need to grant the necessary permissions to this role.\n"]
  resource_ar_n : resource_ar_n; [@ocaml.doc "ARN of the input Amazon Kinesis stream to read.\n"]
}
[@@ocaml.doc
  " Identifies an Amazon Kinesis stream as the streaming source. You provide the stream's Amazon \
   Resource Name (ARN) and an IAM role ARN that enables Amazon Kinesis Analytics to access the \
...
[@@ocaml.doc
  " Describes the Amazon Kinesis Firehose delivery stream that is configured as the streaming \
  ...
  role_ar_n : role_ar_n;
      [@ocaml.doc
        "ARN of the IAM role that Amazon Kinesis Analytics can assume to access the stream on your \
         ...
         stream.\n"]
  resource_ar_n : resource_ar_n; [@ocaml.doc "ARN of the input delivery stream.\n"]
}
[@@ocaml.doc
...
type nonrec input_lambda_processor = {
  role_ar_n : role_ar_n;
      [@ocaml.doc "The ARN of the IAM role that is used to access the AWS Lambda function.\n"]
  resource_ar_n : resource_ar_n;
      [@ocaml.doc
        "The ARN of the {{:https://docs.aws.amazon.com/lambda/}AWS Lambda} function that operates \
...
[@@ocaml.doc
  "An object that contains the Amazon Resource Name (ARN) of the \
   {{:https://docs.aws.amazon.com/lambda/}AWS Lambda} function that is used to preprocess records \
...
[@@ocaml.doc
  "Provides a description of a processor that is used to preprocess the records in the stream \
   before being processed by your application code. Currently, the only input processor available \
   is {{:https://docs.aws.amazon.com/lambda/}AWS Lambda}.\n"]
...
type nonrec input_lambda_processor_description = {
  ...
  resource_ar_n : resource_ar_n option;
      [@ocaml.doc
        "The ARN of the {{:https://docs.aws.amazon.com/lambda/}AWS Lambda} function that is used \
         to preprocess the records in the stream.\n"]
}
[@@ocaml.doc
  "An object that contains the Amazon Resource Name (ARN) of the \
   {{:https://docs.aws.amazon.com/lambda/}AWS Lambda} function that is used to preprocess records \
   in the stream, and the ARN of the IAM role that is used to access the AWS Lambda expression.\n"]
...
[@@ocaml.doc
  "Provides configuration information about an input processor. Currently, the only input \
   processor available is {{:https://docs.aws.amazon.com/lambda/}AWS Lambda}.\n"]
...
type nonrec input_description = {
  ...
  in_app_stream_names : in_app_stream_names option;
      [@ocaml.doc "Returns the in-application stream names that are mapped to the stream source.\n"]
  name_prefix : in_app_stream_name option; [@ocaml.doc "In-application name prefix.\n"]
  input_id : id option;
      [@ocaml.doc
...
[@@ocaml.doc
  " This documentation is for version 1 of the Amazon Kinesis Data Analytics API, which only \
   ...
   Data Analytics API V2 Documentation}.\n\
  \ \n\
  \   Provides a description of the application, including the application Amazon Resource Name \
   (ARN), status, latest version, and input and output configuration.\n\
  \   "]
...
type nonrec delete_application_reference_data_source_request = {
  ...
  application_name : application_name; [@ocaml.doc "Name of an existing application.\n"]
}
[@@ocaml.doc ""]
  ...
  output_id : id;
      [@ocaml.doc
        "The ID of the configuration to delete. Each output configuration that is added to the \
         ...
         configuration that you want to delete from the application configuration. You can use the \
         {{:https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html}DescribeApplication} \
  ...
  current_application_version_id : application_version_id;
      [@ocaml.doc
        "Amazon Kinesis Analytics application version. You can use the \
         ...
         operation to get the current application version. If the version specified is not the \
         current version, the [ConcurrentModificationException] is returned. \n"]
  application_name : application_name; [@ocaml.doc "Amazon Kinesis Analytics application name.\n"]
}
[@@ocaml.doc "\n"]

type nonrec delete_application_input_processing_configuration_response = unit [@@ocaml.doc ""]
...
type nonrec delete_application_input_processing_configuration_request = {
  ...
  application_name : application_name; [@ocaml.doc "The Kinesis Analytics application name.\n"]
}
[@@ocaml.doc ""]

type nonrec delete_application_cloud_watch_logging_option_response = unit [@@ocaml.doc ""]

type nonrec delete_application_cloud_watch_logging_option_request = {
  cloud_watch_logging_option_id : id;
      [@ocaml.doc
        "The [CloudWatchLoggingOptionId] of the CloudWatch logging option to delete. You can get \
         the [CloudWatchLoggingOptionId] by using the \
         {{:https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html}DescribeApplication} \
         operation. \n"]
  current_application_version_id : application_version_id;
      [@ocaml.doc "The version ID of the Kinesis Analytics application.\n"]
...
type nonrec delete_application_request = {
  create_timestamp : timestamp;
      [@ocaml.doc " You can use the [DescribeApplication] operation to get this value. \n"]
  application_name : application_name;
      [@ocaml.doc "Name of the Amazon Kinesis Analytics application to delete.\n"]
}
[@@ocaml.doc "\n"]
...
type nonrec cloud_watch_logging_option = {
  role_ar_n : role_ar_n;
      [@ocaml.doc
        "IAM ARN of the role to use to send application messages. Note: To write application \
         messages to CloudWatch, the IAM role that is used must have the [PutLogEvents] policy \
         action enabled.\n"]
  log_stream_ar_n : log_stream_ar_n;
      [@ocaml.doc "ARN of the CloudWatch log to receive application messages.\n"]
}
...
type nonrec create_application_request = {
  ...
  application_code : application_code option;
      [@ocaml.doc
        "One or more SQL statements that read input data, transform it, and generate output. For \
         example, you can write a SQL statement that reads data from one in-application stream, \
         generates a running average of the number of advertisement clicks by vendor, and insert \
         resulting rows in another in-application stream using pumps. For more information about \
         the typical pattern, see \
         {{:https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-app-code.html}Application \
         Code}. \n\n\
        \ You can provide such series of SQL statements, where output of one statement can be used \
         as the input for the next statement. You store intermediate results by creating \
        ...
        \  Note that the application code must create the streams with names specified in the \
         ...
         [ExampleOutputStream1] and [ExampleOutputStream2], then your application code must create \
         these streams. \n\
        \  "]
  cloud_watch_logging_options : cloud_watch_logging_options option;
      [@ocaml.doc
        "Use this parameter to configure a CloudWatch log stream to monitor application \
         configuration errors. For more information, see \
         {{:https://docs.aws.amazon.com/kinesisanalytics/latest/dev/cloudwatch-logs.html}Working \
         with Amazon CloudWatch Logs}.\n"]
  outputs : outputs option;
      [@ocaml.doc
        "You can configure application output to write data from any of the in-application streams \
         to up to three destinations.\n\n\
        ...
        \  In the configuration, you specify the in-application stream name, the destination \
         ...
         data. You must also provide an IAM role that Amazon Kinesis Analytics can assume to write \
        ...
        \   In the output configuration, you also provide the output stream or Lambda function \
         ...
         JSON, CSV). You also must provide an IAM role that Amazon Kinesis Analytics can assume to \
  ...
  inputs : inputs option;
      [@ocaml.doc
        ...
        \ You can configure your application to receive input from a single streaming source. In \
         ...
         created. Your application code can then query the in-application stream like a table (you \
         can think of it as a constantly updating table).\n\
        \ \n\
        \  For the streaming source, you provide its Amazon Resource Name (ARN) and format of data \
         on the stream (for example, JSON, CSV, etc.). You also must provide an IAM role that \
         Amazon Kinesis Analytics can assume to read this stream on your behalf.\n\
        \  \n\
...
type nonrec add_application_output_request = {
  ...
  current_application_version_id : application_version_id;
      [@ocaml.doc
        "Version of the application to which you want to add the output configuration. You can use \
         the \
         {{:https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html}DescribeApplication} \
         operation to get the current application version. If the version specified is not the \
         current version, the [ConcurrentModificationException] is returned. \n"]
  application_name : application_name;
      [@ocaml.doc "Name of the application to which you want to add the output configuration.\n"]
}
[@@ocaml.doc "\n"]

type nonrec add_application_input_processing_configuration_response = unit [@@ocaml.doc ""]
  ...
  input_id : id;
      [@ocaml.doc
        "The ID of the input configuration to add the input processing configuration to. You can \
         get a list of the input IDs for an application using the \
         {{:https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html}DescribeApplication} \
         operation.\n"]
  current_application_version_id : application_version_id;
      [@ocaml.doc
...
type nonrec add_application_input_request = {
  input : input;
      [@ocaml.doc
        "The {{:https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_Input.html}Input} to \
         add.\n"]
  current_application_version_id : application_version_id;
      [@ocaml.doc
  ...
  application_name : application_name;
      [@ocaml.doc
        "Name of your existing Amazon Kinesis Analytics application to which you want to add the \
         streaming source.\n"]
}
[@@ocaml.doc "\n"]

type nonrec add_application_cloud_watch_logging_option_response = unit [@@ocaml.doc ""]

type nonrec add_application_cloud_watch_logging_option_request = {
  cloud_watch_logging_option : cloud_watch_logging_option;
      [@ocaml.doc
        "Provides the CloudWatch log stream Amazon Resource Name (ARN) and the IAM role ARN. Note: \
         To write application messages to CloudWatch, the IAM role that is used must have the \
