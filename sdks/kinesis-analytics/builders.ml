...
let make_cloud_watch_logging_option ~log_stream_ar_n:(log_stream_ar_n_ : log_stream_ar_n)
  ...
  ({ log_stream_ar_n = log_stream_ar_n_; role_ar_n = role_ar_n_ } : cloud_watch_logging_option)
...
let make_kinesis_firehose_input ~resource_ar_n:(resource_ar_n_ : resource_ar_n)
    ~role_ar_n:(role_ar_n_ : role_ar_n) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : kinesis_firehose_input)

let make_kinesis_streams_input ~resource_ar_n:(resource_ar_n_ : resource_ar_n)
    ~role_ar_n:(role_ar_n_ : role_ar_n) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : kinesis_streams_input)

let make_input_lambda_processor ~resource_ar_n:(resource_ar_n_ : resource_ar_n)
    ~role_ar_n:(role_ar_n_ : role_ar_n) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : input_lambda_processor)
...
let make_lambda_output ~resource_ar_n:(resource_ar_n_ : resource_ar_n)
    ~role_ar_n:(role_ar_n_ : role_ar_n) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : lambda_output)

let make_kinesis_firehose_output ~resource_ar_n:(resource_ar_n_ : resource_ar_n)
    ~role_ar_n:(role_ar_n_ : role_ar_n) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : kinesis_firehose_output)

let make_kinesis_streams_output ~resource_ar_n:(resource_ar_n_ : resource_ar_n)
    ~role_ar_n:(role_ar_n_ : role_ar_n) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : kinesis_streams_output)
...
let make_s3_reference_data_source ~bucket_ar_n:(bucket_ar_n_ : bucket_ar_n)
    ~file_key:(file_key_ : file_key) ~reference_role_ar_n:(reference_role_ar_n_ : role_ar_n) () =
...
let make_cloud_watch_logging_option_description
    ...
    ~log_stream_ar_n:(log_stream_ar_n_ : log_stream_ar_n) ~role_ar_n:(role_ar_n_ : role_ar_n) () =
  ({
...
let make_s3_reference_data_source_description ~bucket_ar_n:(bucket_ar_n_ : bucket_ar_n)
    ~file_key:(file_key_ : file_key) ~reference_role_ar_n:(reference_role_ar_n_ : role_ar_n) () =
  ({ bucket_ar_n = bucket_ar_n_; file_key = file_key_; reference_role_ar_n = reference_role_ar_n_ }
...
let make_lambda_output_description ?resource_ar_n:(resource_ar_n_ : resource_ar_n option)
    ?role_ar_n:(role_ar_n_ : role_ar_n option) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : lambda_output_description)

let make_kinesis_firehose_output_description ?resource_ar_n:(resource_ar_n_ : resource_ar_n option)
    ?role_ar_n:(role_ar_n_ : role_ar_n option) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : kinesis_firehose_output_description)

let make_kinesis_streams_output_description ?resource_ar_n:(resource_ar_n_ : resource_ar_n option)
    ?role_ar_n:(role_ar_n_ : role_ar_n option) () =
...
let make_kinesis_firehose_input_description ?resource_ar_n:(resource_ar_n_ : resource_ar_n option)
    ?role_ar_n:(role_ar_n_ : role_ar_n option) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : kinesis_firehose_input_description)

let make_kinesis_streams_input_description ?resource_ar_n:(resource_ar_n_ : resource_ar_n option)
    ?role_ar_n:(role_ar_n_ : role_ar_n option) () =
  ({ resource_ar_n = resource_ar_n_; role_ar_n = role_ar_n_ } : kinesis_streams_input_description)

let make_input_lambda_processor_description ?resource_ar_n:(resource_ar_n_ : resource_ar_n option)
    ?role_ar_n:(role_ar_n_ : role_ar_n option) () =
...
let make_application_summary ~application_name:(application_name_ : application_name)
    ~application_ar_n:(application_ar_n_ : resource_ar_n)
    ~application_status:(application_status_ : application_status) () =
  ({
     application_name = application_name_;
...
let make_cloud_watch_logging_option_update
    ...
    ?role_arn_update:(role_arn_update_ : role_ar_n option)
...
let make_lambda_output_update ?resource_arn_update:(resource_arn_update_ : resource_ar_n option)
    ?role_arn_update:(role_arn_update_ : role_ar_n option) () =
  ({ resource_arn_update = resource_arn_update_; role_arn_update = role_arn_update_ }
...
let make_application_update ?input_updates:(input_updates_ : input_updates option)
...
let make_create_application_request
    ?application_description:(application_description_ : application_description option)
    ?inputs:(inputs_ : inputs option) ?outputs:(outputs_ : outputs option)
    ?cloud_watch_logging_options:(cloud_watch_logging_options_ : cloud_watch_logging_options option)
    ?application_code:(application_code_ : application_code option) ?tags:(tags_ : tags option)
    ~application_name:(application_name_ : application_name) () =
  ({
     application_name = application_name_;
     application_description = application_description_;
...
let make_s3_configuration ~role_ar_n:(role_ar_n_ : role_ar_n)
    ~bucket_ar_n:(bucket_ar_n_ : bucket_ar_n) ~file_key:(file_key_ : file_key) () =
  ({ role_ar_n = role_ar_n_; bucket_ar_n = bucket_ar_n_; file_key = file_key_ } : s3_configuration)
...
let make_input_configuration ~id:(id_ : id)
    ~input_starting_position_configuration:
      (input_starting_position_configuration_ : input_starting_position_configuration) () =
  ({ id = id_; input_starting_position_configuration = input_starting_position_configuration_ }
    : input_configuration)

let make_update_application_response () = (() : unit)

let make_update_application_request ~application_name:(application_name_ : application_name)
    ~current_application_version_id:(current_application_version_id_ : application_version_id)
...
let make_start_application_request ~application_name:(application_name_ : application_name)
    ~input_configurations:(input_configurations_ : input_configurations) () =
  ({ application_name = application_name_; input_configurations = input_configurations_ }
...
let make_list_applications_response
    ...
    ~has_more_applications:(has_more_applications_ : boolean_object) () =
  ({
...
let make_list_applications_request ?limit:(limit_ : list_applications_input_limit option)
    ...
    () =
  ({ limit = limit_; exclusive_start_application_name = exclusive_start_application_name_ }
