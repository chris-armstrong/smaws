...
let make_input_lambda_processor_update ?role_arn_update:(role_arn_update_ : role_ar_n option)
    ?resource_arn_update:(resource_arn_update_ : resource_ar_n option) () =
  ({ role_arn_update = role_arn_update_; resource_arn_update = resource_arn_update_ }
...
let make_kinesis_streams_input_update ?role_arn_update:(role_arn_update_ : role_ar_n option)
    ?resource_arn_update:(resource_arn_update_ : resource_ar_n option) () =
  ({ role_arn_update = role_arn_update_; resource_arn_update = resource_arn_update_ }
    : kinesis_streams_input_update)

let make_kinesis_firehose_input_update ?role_arn_update:(role_arn_update_ : role_ar_n option)
    ?resource_arn_update:(resource_arn_update_ : resource_ar_n option) () =
  ({ role_arn_update = role_arn_update_; resource_arn_update = resource_arn_update_ }
...
let make_input_parallelism_update ?count_update:(count_update_ : input_parallelism_count option) ()
    =
...
let make_kinesis_streams_output_update ?role_arn_update:(role_arn_update_ : role_ar_n option)
    ?resource_arn_update:(resource_arn_update_ : resource_ar_n option) () =
  ({ role_arn_update = role_arn_update_; resource_arn_update = resource_arn_update_ }
    : kinesis_streams_output_update)

let make_kinesis_firehose_output_update ?role_arn_update:(role_arn_update_ : role_ar_n option)
    ?resource_arn_update:(resource_arn_update_ : resource_ar_n option) () =
  ({ role_arn_update = role_arn_update_; resource_arn_update = resource_arn_update_ }
    : kinesis_firehose_output_update)

let make_lambda_output_update ?role_arn_update:(role_arn_update_ : role_ar_n option)
    ?resource_arn_update:(resource_arn_update_ : resource_ar_n option) () =
  ({ role_arn_update = role_arn_update_; resource_arn_update = resource_arn_update_ }
...
let make_s3_reference_data_source_update
    ?reference_role_arn_update:(reference_role_arn_update_ : role_ar_n option)
...
let make_cloud_watch_logging_option_update ?role_arn_update:(role_arn_update_ : role_ar_n option)
...
let make_application_update
    ...
    ?application_code_update:(application_code_update_ : application_code option)
...
let make_update_application_request ~application_update:(application_update_ : application_update)
...
let make_stop_application_request ~application_name:(application_name_ : application_name) () =
...
let make_input_configuration
    ...
    ~id:(id_ : id) () =
  ({ input_starting_position_configuration = input_starting_position_configuration_; id = id_ }
    : input_configuration)

let make_start_application_request
    ~input_configurations:(input_configurations_ : input_configurations)
    ~application_name:(application_name_ : application_name) () =
  ({ input_configurations = input_configurations_; application_name = application_name_ }
    : start_application_request)

let make_s3_reference_data_source_description
    ~reference_role_ar_n:(reference_role_ar_n_ : role_ar_n) ~file_key:(file_key_ : file_key)
...
let make_s3_reference_data_source ~reference_role_ar_n:(reference_role_ar_n_ : role_ar_n)
...
let make_s3_configuration ~file_key:(file_key_ : file_key) ~bucket_ar_n:(bucket_ar_n_ : bucket_ar_n)
  ...
  ({ file_key = file_key_; bucket_ar_n = bucket_ar_n_; role_ar_n = role_ar_n_ } : s3_configuration)
...
let make_application_summary ~application_status:(application_status_ : application_status)
...
let make_list_applications_response ~has_more_applications:(has_more_applications_ : boolean_object)
...
let make_list_applications_request
    ?exclusive_start_application_name:(exclusive_start_application_name_ : application_name option)
    ?limit:(limit_ : list_applications_input_limit option) () =
  ({ exclusive_start_application_name = exclusive_start_application_name_; limit = limit_ }
...
let make_kinesis_streams_input ~role_ar_n:(role_ar_n_ : role_ar_n)
    ~resource_ar_n:(resource_ar_n_ : resource_ar_n) () =
...
let make_kinesis_firehose_input ~role_ar_n:(role_ar_n_ : role_ar_n)
    ~resource_ar_n:(resource_ar_n_ : resource_ar_n) () =
...
let make_input_lambda_processor ~role_ar_n:(role_ar_n_ : role_ar_n)
    ~resource_ar_n:(resource_ar_n_ : resource_ar_n) () =
...
let make_cloud_watch_logging_option_description
    ...
    ~role_ar_n:(role_ar_n_ : role_ar_n) ~log_stream_ar_n:(log_stream_ar_n_ : log_stream_ar_n) () =
  ({
     role_ar_n = role_ar_n_;
...
let make_application_detail ?application_code:(application_code_ : application_code option)
...
let make_describe_application_request ~application_name:(application_name_ : application_name) () =
...
let make_delete_application_input_processing_configuration_response () = (() : unit)
...
let make_delete_application_cloud_watch_logging_option_response () = (() : unit)
...
let make_cloud_watch_logging_option ~role_ar_n:(role_ar_n_ : role_ar_n)
...
let make_create_application_request ?tags:(tags_ : tags option)
    ?application_code:(application_code_ : application_code option)
...
let make_add_application_input_processing_configuration_response () = (() : unit)
