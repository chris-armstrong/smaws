...
let input_configurations_to_yojson tree =
  list_to_yojson input_configuration_to_yojson tree
...
let list_applications_request_to_yojson (x : list_applications_request) =
  assoc_to_yojson
    [("ExclusiveStartApplicationName",
       (option_to_yojson application_name_to_yojson
          x.exclusive_start_application_name));
    ("Limit",
