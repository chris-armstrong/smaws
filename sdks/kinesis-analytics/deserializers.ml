...
let input_lambda_processor_update_of_yojson tree path =
  ...
  ({
     role_arn_update =
       option_of_yojson (value_for_key role_ar_n_of_yojson "RoleARNUpdate") _list path;
     resource_arn_update =
       option_of_yojson (value_for_key resource_ar_n_of_yojson "ResourceARNUpdate") _list path;
   }
...
let input_parallelism_update_of_yojson tree path =
  ...
  ({
     count_update =
       option_of_yojson (value_for_key input_parallelism_count_of_yojson "CountUpdate") _list path;
   }
...
let s3_reference_data_source_update_of_yojson tree path =
  ...
  ({
     reference_role_arn_update =
       option_of_yojson (value_for_key role_ar_n_of_yojson "ReferenceRoleARNUpdate") _list path;
     file_key_update =
...
let start_application_request_of_yojson tree path =
  ...
  ({
     input_configurations =
       value_for_key input_configurations_of_yojson "InputConfigurations" _list path;
     application_name = value_for_key application_name_of_yojson "ApplicationName" _list path;
   }
...
let list_applications_request_of_yojson tree path =
  ...
  ({
     exclusive_start_application_name =
       option_of_yojson
         (value_for_key application_name_of_yojson "ExclusiveStartApplicationName")
         _list path;
     limit =
...
let application_detail_of_yojson tree path =
  ...
  ({
     ...
     application_code =
       option_of_yojson (value_for_key application_code_of_yojson "ApplicationCode") _list path;
...
let create_application_response_of_yojson tree path =
  ...
  ({
     application_summary =
       value_for_key application_summary_of_yojson "ApplicationSummary" _list path;
   }
