...
type nonrec scan_by = TIMESTAMP_ASCENDING [@ocaml.doc ""] | TIMESTAMP_DESCENDING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec o_tel_enrichment_status = STOPPED [@ocaml.doc ""] | RUNNING [@ocaml.doc ""]
...
type nonrec anomaly_detector_type = METRIC_MATH [@ocaml.doc ""] | SINGLE_METRIC [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec alarm_contributor = {
  ...
  contributor_id : contributor_id; [@ocaml.doc "The unique identifier for this alarm contributor.\n"]
}
[@@ocaml.doc
