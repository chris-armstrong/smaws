...
let rec query_stage_plan_nodes_of_yojson tree path =
  list_of_yojson query_stage_plan_node_of_yojson tree path

and query_stage_plan_node_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
...
let rec query_stages_of_yojson tree path = list_of_yojson query_stage_of_yojson tree path

and query_stage_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
