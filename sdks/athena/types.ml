...
type nonrec work_group_state = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec statement_type = UTILITY [@ocaml.doc ""] | DML [@ocaml.doc ""] | DDL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
and query_stage_plan_nodes = query_stage_plan_node list [@@ocaml.doc ""]
...
and query_stages = query_stage list [@@ocaml.doc ""]
...
type nonrec query_result_type = DATA_ROWS [@ocaml.doc ""] | DATA_MANIFEST [@ocaml.doc ""]
[@@ocaml.doc ""]
