...
type nonrec application_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec sign_in_origin = APPLICATION [@ocaml.doc ""] | IDENTITY_CENTER [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec application_visibility = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec federation_protocol = OAUTH [@ocaml.doc ""] | SAML [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  permission_set_arn : permission_set_arn option;
      [@ocaml.doc
        "The ARN of the permission set. For more information about ARNs, see \
         {{:/general/latest/gr/aws-arns-and-namespaces.html}Amazon Resource Names (ARNs) and \
         Amazon Web Services Service Namespaces} in the {i Amazon Web Services General Reference}.\n"]
  account_id : account_id option; [@ocaml.doc "The identifier of the Amazon Web Services account.\n"]
}
[@@ocaml.doc
...
type nonrec put_application_grant_request = {
  ...
  application_arn : application_arn; [@ocaml.doc "Specifies the ARN of the application to update.\n"]
}
[@@ocaml.doc ""]
