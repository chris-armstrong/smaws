...
type nonrec deployment_target = GREENGRASS [@ocaml.doc ""] | CLOUD [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec get_flow_template_request = {
  id : urn;
      [@ocaml.doc
        ...
        \   [urn:tdm:REGION/ACCOUNT ID/default:workflow:WORKFLOWNAME] \n\
        \  "]
  revision_number : version option; [@ocaml.doc "The number of the workflow revision to retrieve.\n"]
}
[@@ocaml.doc ""]
