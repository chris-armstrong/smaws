...
let stream_summary_of_yojson tree path =
  ...
  ({
     stream_creation_timestamp =
       option_of_yojson (value_for_key timestamp__of_yojson "StreamCreationTimestamp") _list path;
     stream_mode_details =
...
let stream_description_summary_of_yojson tree path =
  ...
  ({
     ...
     stream_creation_timestamp =
       value_for_key timestamp__of_yojson "StreamCreationTimestamp" _list path;
...
let consumer_of_yojson tree path =
  ...
  ({
     consumer_creation_timestamp =
       value_for_key timestamp__of_yojson "ConsumerCreationTimestamp" _list path;
