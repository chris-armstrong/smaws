...
let stream_summary_to_yojson (x : stream_summary) =
  assoc_to_yojson
    [
      ("StreamCreationTimestamp", option_to_yojson timestamp__to_yojson x.stream_creation_timestamp);
...
let stream_description_summary_to_yojson (x : stream_description_summary) =
  assoc_to_yojson
    [
      ...
      ("StreamCreationTimestamp", Some (timestamp__to_yojson x.stream_creation_timestamp));
...
let consumer_to_yojson (x : consumer) =
  assoc_to_yojson
    [
      ("ConsumerCreationTimestamp", Some (timestamp__to_yojson x.consumer_creation_timestamp));
