...
let make_warm_throughput_object ?current_mi_bps:(current_mi_bps_ : natural_integer_object option)
    ?target_mi_bps:(target_mi_bps_ : natural_integer_object option) () =
  ({ current_mi_bps = current_mi_bps_; target_mi_bps = target_mi_bps_ } : warm_throughput_object)

let make_update_stream_warm_throughput_output
  ...
  ({ warm_throughput = warm_throughput_; stream_name = stream_name_; stream_ar_n = stream_ar_n_ }
    : update_stream_warm_throughput_output)

let make_update_stream_warm_throughput_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_name:(stream_name_ : stream_name option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_update_shard_count_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_update_max_record_size_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_minimum_throughput_billing_commitment_output
...
let make_untag_resource_input ?stream_id:(stream_id_ : stream_id option)
    ~resource_ar_n:(resource_ar_n_ : resource_ar_n) ~tag_keys:(tag_keys_ : tag_key_list) () =
  ({ stream_id = stream_id_; resource_ar_n = resource_ar_n_; tag_keys = tag_keys_ }
    : untag_resource_input)

let make_tag_resource_input ?stream_id:(stream_id_ : stream_id option)
    ~resource_ar_n:(resource_ar_n_ : resource_ar_n) ~tags:(tags_ : tag_map) () =
  ({ stream_id = stream_id_; resource_ar_n = resource_ar_n_; tags = tags_ } : tag_resource_input)
...
let make_subscribe_to_shard_input ?stream_id:(stream_id_ : stream_id option)
    ~starting_position:(starting_position_ : starting_position) ~shard_id:(shard_id_ : shard_id)
...
let make_stop_stream_encryption_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_start_stream_encryption_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option) ~key_id:(key_id_ : key_id)
    ~encryption_type:(encryption_type_ : encryption_type) () =
  ({
...
let make_split_shard_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option)
...
let make_remove_tags_from_stream_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_register_stream_consumer_input ?tags:(tags_ : tag_map option)
    ?stream_id:(stream_id_ : stream_id option) ~consumer_name:(consumer_name_ : consumer_name)
    ~stream_ar_n:(stream_ar_n_ : stream_ar_n) () =
  ({
     tags = tags_;
     stream_id = stream_id_;
...
let make_put_resource_policy_input ?stream_id:(stream_id_ : stream_id option)
    ~policy:(policy_ : policy) ~resource_ar_n:(resource_ar_n_ : resource_ar_n) () =
  ({ policy = policy_; stream_id = stream_id_; resource_ar_n = resource_ar_n_ }
...
let make_put_records_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option)
...
let make_put_record_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_merge_shards_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option)
...
let make_list_tags_for_stream_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_list_tags_for_resource_input ?stream_id:(stream_id_ : stream_id option)
  ...
  ({ stream_id = stream_id_; resource_ar_n = resource_ar_n_ } : list_tags_for_resource_input)
...
let make_list_stream_consumers_input ?stream_id:(stream_id_ : stream_id option)
...
let make_list_shards_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_increase_stream_retention_period_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option)
    ~retention_period_hours:(retention_period_hours_ : retention_period_hours) () =
  ({
...
let make_get_shard_iterator_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option) ?timestamp:(timestamp_ : timestamp option)
...
let make_get_resource_policy_input ?stream_id:(stream_id_ : stream_id option)
    ~resource_ar_n:(resource_ar_n_ : resource_ar_n) () =
  ({ stream_id = stream_id_; resource_ar_n = resource_ar_n_ } : get_resource_policy_input)
...
let make_get_records_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_enable_enhanced_monitoring_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option)
...
let make_disable_enhanced_monitoring_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option)
    ~shard_level_metrics:(shard_level_metrics_ : metrics_name_list) () =
  ({
...
let make_describe_stream_summary_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option) () =
  ({ stream_id = stream_id_; stream_ar_n = stream_ar_n_; stream_name = stream_name_ }
...
let make_describe_stream_consumer_input ?stream_id:(stream_id_ : stream_id option)
...
let make_describe_stream_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?exclusive_start_shard_id:(exclusive_start_shard_id_ : shard_id option)
...
let make_deregister_stream_consumer_input ?stream_id:(stream_id_ : stream_id option)
    ?consumer_ar_n:(consumer_ar_n_ : consumer_ar_n option)
    ?consumer_name:(consumer_name_ : consumer_name option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option) () =
  ({
...
let make_delete_stream_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
...
let make_delete_resource_policy_input ?stream_id:(stream_id_ : stream_id option)
    ~resource_ar_n:(resource_ar_n_ : resource_ar_n) () =
  ({ stream_id = stream_id_; resource_ar_n = resource_ar_n_ } : delete_resource_policy_input)

let make_decrease_stream_retention_period_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option)
    ~retention_period_hours:(retention_period_hours_ : retention_period_hours) () =
  ({
...
let make_add_tags_to_stream_input ?stream_id:(stream_id_ : stream_id option)
    ?stream_ar_n:(stream_ar_n_ : stream_ar_n option)
    ?stream_name:(stream_name_ : stream_name option) ~tags:(tags_ : tag_map) () =
  ({ stream_id = stream_id_; stream_ar_n = stream_ar_n_; tags = tags_; stream_name = stream_name_ }
