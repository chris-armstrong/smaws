...
[@@ocaml.doc
  "The resource is not available for this operation. For successful operation, the resource must \
...
type nonrec add_tags_to_stream_input = {
  stream_name : stream_name option; [@ocaml.doc "The name of the stream.\n"]
  tags : tag_map;
      [@ocaml.doc
...
type nonrec hash_key = string [@@ocaml.doc ""]

type nonrec hash_key_range = {
  starting_hash_key : hash_key; [@ocaml.doc "The starting hash key of the hash key range.\n"]
  ending_hash_key : hash_key; [@ocaml.doc "The ending hash key of the hash key range.\n"]
}
[@@ocaml.doc
...
type nonrec child_shard = {
  shard_id : shard_id;
      [@ocaml.doc "The shard ID of the existing child shard of the current shard.\n"]
  parent_shards : shard_id_list;
      [@ocaml.doc "The current shard that is the parent of the existing child shard.\n"]
  hash_key_range : hash_key_range; [@ocaml.doc ""]
}
[@@ocaml.doc
  "Output parameter of the GetRecords API. The existing child shard of the current shard.\n"]

type nonrec child_shard_list = child_shard list [@@ocaml.doc ""]
...
type nonrec consumer_ar_n = string [@@ocaml.doc ""]

type nonrec consumer_name = string [@@ocaml.doc ""]
...
type nonrec consumer = {
  ...
  consumer_status : consumer_status;
      [@ocaml.doc "A consumer can't read data while in the [CREATING] or [DELETING] states.\n"]
  consumer_creation_timestamp : timestamp; [@ocaml.doc "\n"]
}
[@@ocaml.doc
...
type nonrec consumer_description = {
  ...
  stream_ar_n : stream_ar_n;
      [@ocaml.doc "The ARN of the stream with which you registered the consumer.\n"]
}
[@@ocaml.doc
  "An object that represents the details of a registered consumer. This type of object is returned \
   by [DescribeStreamConsumer].\n"]

type nonrec consumer_list = consumer list [@@ocaml.doc ""]
...
type nonrec stream_mode = PROVISIONED [@ocaml.doc ""] | ON_DEMAND [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec create_stream_input = {
  stream_name : stream_name;
      [@ocaml.doc
        "A name to identify the stream. The stream name is scoped to the Amazon Web Services \
         account used by the application that creates the stream. It is also scoped by Amazon Web \
         Services Region. That is, two streams in two different Amazon Web Services accounts can \
         have the same name. Two streams in the same Amazon Web Services account but in two \
  ...
  stream_mode_details : stream_mode_details option;
      [@ocaml.doc
        " Indicates the capacity mode of the data stream. Currently, in Kinesis Data Streams, you \
         can choose between an {b on-demand} capacity mode and a {b provisioned} capacity mode for \
         your data streams.\n"]
  tags : tag_map option;
      [@ocaml.doc
        "A set of up to 50 key-value pairs to use to create the tags. A tag consists of a required \
...
type nonrec retention_period_hours = int [@@ocaml.doc ""]

type nonrec decrease_stream_retention_period_input = {
  stream_name : stream_name option; [@ocaml.doc "The name of the stream to modify.\n"]
...
type nonrec delete_stream_input = {
  stream_name : stream_name option; [@ocaml.doc "The name of the stream to delete.\n"]
  ...
  consumer_ar_n : consumer_ar_n option;
      [@ocaml.doc
        "The ARN returned by Kinesis Data Streams when you registered the consumer. If you don't \
         know the ARN of the consumer that you want to deregister, you can use the \
...
type nonrec on_demand_stream_count_limit_object = int [@@ocaml.doc ""]

type nonrec on_demand_stream_count_object = int [@@ocaml.doc ""]

type nonrec shard_count_object = int [@@ocaml.doc ""]

type nonrec describe_limits_output = {
  shard_limit : shard_count_object; [@ocaml.doc "The maximum number of shards.\n"]
  open_shard_count : shard_count_object; [@ocaml.doc "The number of open shards.\n"]
  on_demand_stream_count : on_demand_stream_count_object;
      [@ocaml.doc " Indicates the number of data streams with the on-demand capacity mode.\n"]
  on_demand_stream_count_limit : on_demand_stream_count_limit_object;
      [@ocaml.doc " The maximum number of data streams with the on-demand capacity mode. \n"]
}
[@@ocaml.doc ""]
...
type nonrec encryption_type = NONE [@ocaml.doc ""] | KMS [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec metrics_name_list = metrics_name list [@@ocaml.doc ""]
  ...
  shard_level_metrics : metrics_name_list option;
      [@ocaml.doc
        ...
        \   For more information, see \
         {{:https://docs.aws.amazon.com/kinesis/latest/dev/monitoring-with-cloudwatch.html}Monitoring \
         the Amazon Kinesis Data Streams Service with Amazon CloudWatch} in the {i Amazon Kinesis \
         Data Streams Developer Guide}.\n\
        \   "]
}
[@@ocaml.doc "Represents enhanced metrics types.\n"]

type nonrec enhanced_monitoring_list = enhanced_metrics list [@@ocaml.doc ""]
...
type nonrec shard = {
  shard_id : shard_id; [@ocaml.doc "The unique identifier of the shard within the stream.\n"]
  parent_shard_id : shard_id option; [@ocaml.doc "The shard ID of the shard's parent.\n"]
  adjacent_parent_shard_id : shard_id option;
      [@ocaml.doc "The shard ID of the shard adjacent to the shard's parent.\n"]
...
[@@ocaml.doc "A uniquely identified group of data records in a Kinesis data stream.\n"]
...
type nonrec stream_description = {
  ...
  stream_status : stream_status;
      [@ocaml.doc
        ...
        \       {-   [ACTIVE] - The stream exists and is ready for read and write operations or \
         deletion. You should perform read and write operations only on an [ACTIVE] stream.\n\
        \           \n\
        \            }\n\
  ...
  stream_mode_details : stream_mode_details option;
      [@ocaml.doc
        " Specifies the capacity mode to which you want to set your data stream. Currently, in \
         Kinesis Data Streams, you can choose between an {b on-demand} capacity mode and a {b \
         provisioned} capacity mode for your data streams. \n"]
  shards : shard_list; [@ocaml.doc "The shards that comprise the stream.\n"]
  has_more_shards : boolean_object;
      [@ocaml.doc "If set to [true], more shards in the stream are available to describe.\n"]
  retention_period_hours : retention_period_hours;
      [@ocaml.doc
  ...
  enhanced_monitoring : enhanced_monitoring_list;
      [@ocaml.doc "Represents the current enhanced monitoring settings of the stream.\n"]
  ...
  key_id : key_id option;
      [@ocaml.doc
        "The GUID for the customer-managed Amazon Web Services KMS key to use for encryption. This \
         value can be a globally unique identifier, a fully specified ARN to either an alias or a \
         key, or an alias name prefixed by \"alias/\".You can also use a master key owned by \
  ...
  stream_description : stream_description;
      [@ocaml.doc
        "The current status of the stream, the stream Amazon Resource Name (ARN), an array of \
         shard objects that comprise the stream, and whether there are more shards available.\n"]
}
[@@ocaml.doc "Represents the output for [DescribeStream].\n"]
...
[@@ocaml.doc "Represents the input for [DescribeStream].\n"]
...
type nonrec stream_description_summary = {
  ...
  stream_mode_details : stream_mode_details option;
      [@ocaml.doc
        " Specifies the capacity mode to which you want to set your data stream. Currently, in \
         Kinesis Data Streams, you can choose between an {b on-demand} ycapacity mode and a {b \
         provisioned} capacity mode for your data streams. \n"]
  retention_period_hours : retention_period_hours;
...
[@@ocaml.doc "Represents the output for [DescribeStreamSummary] \n"]

type nonrec describe_stream_summary_output = {
  stream_description_summary : stream_description_summary;
      [@ocaml.doc "A [StreamDescriptionSummary] containing information about the stream.\n"]
}
[@@ocaml.doc ""]
...
type nonrec enhanced_monitoring_output = {
  stream_name : stream_name option; [@ocaml.doc "The name of the Kinesis data stream.\n"]
...
type nonrec disable_enhanced_monitoring_input = {
  stream_name : stream_name option;
      [@ocaml.doc "The name of the Kinesis data stream for which to disable enhanced monitoring.\n"]
  shard_level_metrics : metrics_name_list;
      [@ocaml.doc
        "List of shard-level metrics to disable.\n\n\
        \ The following are the valid shard-level metrics. The value \"[ALL]\" disables every \
         metric.\n\
        \ \n\
        \  {ul\n\
        \        {-   [IncomingBytes] \n\
...
type nonrec enable_enhanced_monitoring_input = {
  stream_name : stream_name option;
      [@ocaml.doc "The name of the stream for which to enable enhanced monitoring.\n"]
  shard_level_metrics : metrics_name_list;
      [@ocaml.doc
...
[@@ocaml.doc "The pagination token passed to the operation is expired.\n"]
...
[@@ocaml.doc
  "The request rate for the stream is too high, or the requested data is too large for the \
   available throughput. Reduce the frequency or size of your requests. For more information, see \
   {{:https://docs.aws.amazon.com/kinesis/latest/dev/service-sizes-and-limits.html}Streams Limits} \
   in the {i Amazon Kinesis Data Streams Developer Guide}, and \
   {{:https://docs.aws.amazon.com/general/latest/gr/api-retries.html}Error Retries and Exponential \
   Backoff in Amazon Web Services} in the {i Amazon Web Services General Reference}.\n"]
...
[@@ocaml.doc
  "The request was rejected because the state of the specified resource isn't valid for this \
   ...
   {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html}How Key State Affects \
   Use of a Customer Master Key} in the {i Amazon Web Services Key Management Service Developer \
   Guide}.\n"]
...
type nonrec record = {
  ...
  approximate_arrival_timestamp : timestamp option;
      [@ocaml.doc "The approximate time that the record was inserted into the stream.\n"]
  data : data;
      [@ocaml.doc
  ...
  partition_key : partition_key;
      [@ocaml.doc "Identifies which shard in the stream the data record is assigned to.\n"]
  encryption_type : encryption_type option;
      [@ocaml.doc
...
type nonrec get_records_output = {
  records : record_list; [@ocaml.doc "The data records retrieved from the shard.\n"]
  next_shard_iterator : shard_iterator option;
      [@ocaml.doc
        "The next position in the shard from which to start sequentially reading data records. If \
         set to [null], the shard has been closed and the requested iterator does not return any \
         more data. \n"]
  millis_behind_latest : millis_behind_latest option;
      [@ocaml.doc
        "The number of milliseconds the [GetRecords] response is from the tip of the stream, \
         indicating how far behind current time the consumer is. A value of zero indicates that \
  ...
  child_shards : child_shard_list option;
      [@ocaml.doc
        "The list of the current shard's child shards, returned in the [GetRecords] API's response \
         only when the end of the current shard is reached.\n"]
}
[@@ocaml.doc "Represents the output for [GetRecords].\n"]
  ...
  limit : get_records_input_limit option;
      [@ocaml.doc
        "The maximum number of records to return. Specify a value of up to 10,000. If you specify \
         a value that is greater than 10,000, [GetRecords] throws [InvalidArgumentException]. The \
...
type nonrec get_resource_policy_output = {
  policy : policy;
      [@ocaml.doc "Details of the resource policy. This is formatted as a JSON string.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_shard_iterator_input = {
  stream_name : stream_name option; [@ocaml.doc "The name of the Amazon Kinesis data stream.\n"]
  shard_id : shard_id;
      [@ocaml.doc "The shard ID of the Kinesis Data Streams shard to get the iterator for.\n"]
  ...
  timestamp : timestamp option;
      [@ocaml.doc
        "The time stamp of the data record from which to start reading. Used with shard iterator \
         ...
         For example, [2016-04-04T19:58:46.480-00:00] or [1459799926.480]. If a record with this \
         exact time stamp does not exist, the iterator returned is for the next (later) record. If \
         the time stamp is older than the current trim horizon, the iterator returned is for the \
         oldest untrimmed data record (TRIM_HORIZON).\n"]
  stream_ar_n : stream_ar_n option; [@ocaml.doc "The ARN of the stream.\n"]
  stream_id : stream_id option; [@ocaml.doc "Not Implemented. Reserved for future use.\n"]
}
[@@ocaml.doc "Represents the input for [GetShardIterator].\n"]
...
[@@ocaml.doc "Represents the input for [IncreaseStreamRetentionPeriod].\n"]
...
type nonrec untag_resource_input = {
  tag_keys : tag_key_list;
      [@ocaml.doc
        "A list of tag key-value pairs. Existing tags of the resource whose keys are members of \
         this list will be removed from the Kinesis resource.\n"]
  resource_ar_n : resource_ar_n;
      [@ocaml.doc
...
type nonrec tag_resource_input = {
  tags : tag_map;
      [@ocaml.doc
        "An array of tags to be added to the Kinesis resource. A tag consists of a required key \
  ...
  continuation_sequence_number : sequence_number;
      [@ocaml.doc
        "Use this as [SequenceNumber] in the next call to [SubscribeToShard], with \
         ...
         [ContinuationSequenceNumber] for checkpointing because it captures your shard progress \
         even when no data is written to the shard.\n"]
...
[@@ocaml.doc
  "After you call [SubscribeToShard], Kinesis Data Streams sends events of this type over an \
   HTTP/2 connection to your consumer.\n"]
  ...
  | SubscribeToShardEvent of subscribe_to_shard_event
      [@ocaml.doc
        "After you call [SubscribeToShard], Kinesis Data Streams sends events of this type to your \
         consumer. For an example of how to handle these events, see \
         {{:/streams/latest/dev/building-enhanced-consumers-api.html}Enhanced Fan-Out Using the \
         Kinesis Data Streams API}.\n"]
  | ResourceNotFoundException of resource_not_found_exception [@ocaml.doc ""]
...
type nonrec subscribe_to_shard_output = {
  event_stream : subscribe_to_shard_event_stream;
      [@ocaml.doc "The event stream that your consumer can use to read records from the shard.\n"]
}
[@@ocaml.doc ""]
...
type nonrec starting_position = {
  type_ : shard_iterator_type;
      [@ocaml.doc
        ...
        \  \n\
        \    [AT_TIMESTAMP]: Start streaming from the position denoted by the time stamp specified \
         in the [Timestamp] field.\n\
        \   \n\
        \     [TRIM_HORIZON]: Start streaming at the last untrimmed record in the shard, which is \
  ...
  sequence_number : sequence_number option;
      [@ocaml.doc
        "The sequence number of the data record in the shard from which to start streaming. To \
         specify a sequence number, set [StartingPosition] to [AT_SEQUENCE_NUMBER] or \
         [AFTER_SEQUENCE_NUMBER].\n"]
  timestamp : timestamp option;
      [@ocaml.doc
        "The time stamp of the data record from which to start reading. To specify a time stamp, \
         set [StartingPosition] to [Type AT_TIMESTAMP]. A time stamp is the Unix epoch date with \
         ...
         streamed from the next (later) record. If the time stamp is older than the current trim \
         horizon, records will be streamed from the oldest untrimmed data record ([TRIM_HORIZON]).\n"]
}
[@@ocaml.doc "The starting position in the data stream from which to start streaming.\n"]
...
type nonrec stop_stream_encryption_input = {
  stream_name : stream_name option;
      [@ocaml.doc "The name of the stream on which to stop encrypting records.\n"]
  encryption_type : encryption_type;
      [@ocaml.doc "The encryption type. The only valid value is [KMS].\n"]
  key_id : key_id;
      [@ocaml.doc
        "The GUID for the customer-managed Amazon Web Services KMS key to use for encryption. This \
         value can be a globally unique identifier, a fully specified Amazon Resource Name (ARN) \
         to either an alias or a key, or an alias name prefixed by \"alias/\".You can also use a \
...
type nonrec start_stream_encryption_input = {
  stream_name : stream_name option;
      [@ocaml.doc "The name of the stream for which to start encrypting records.\n"]
  encryption_type : encryption_type;
      [@ocaml.doc "The encryption type to use. The only valid value is [KMS].\n"]
  key_id : key_id;
      [@ocaml.doc
        "The GUID for the customer-managed Amazon Web Services KMS key to use for encryption. This \
         value can be a globally unique identifier, a fully specified Amazon Resource Name (ARN) \
...
type nonrec split_shard_input = {
  stream_name : stream_name option; [@ocaml.doc "The name of the stream for the shard split.\n"]
  shard_to_split : shard_id; [@ocaml.doc "The shard ID of the shard to split.\n"]
  new_starting_hash_key : hash_key;
      [@ocaml.doc
        "A hash key value for the starting hash key of one of the child shards created by the \
         ...
         positive integers. The value for [NewStartingHashKey] must be in the range of hash keys \
         being mapped into the shard. The [NewStartingHashKey] hash key value and all higher hash \
         key values in hash key range are distributed to one of the child shards. All the lower \
         hash key values in the range are distributed to the other child shard.\n"]
  stream_ar_n : stream_ar_n option; [@ocaml.doc "The ARN of the stream.\n"]
  stream_id : stream_id option; [@ocaml.doc "Not Implemented. Reserved for future use.\n"]
}
[@@ocaml.doc "Represents the input for [SplitShard].\n"]
...
type nonrec register_stream_consumer_input = {
  stream_ar_n : stream_ar_n;
      [@ocaml.doc
        "The ARN of the Kinesis data stream that you want to register the consumer with. For more \
         info, see \
         {{:https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams}Amazon \
         Resource Names (ARNs) and Amazon Web Services Service Namespaces}.\n"]
  consumer_name : consumer_name;
...
type nonrec put_records_result_entry = {
  ...
  shard_id : shard_id option; [@ocaml.doc "The shard ID for an individual record result.\n"]
  ...
  error_message : error_message option;
      [@ocaml.doc
        "The error message for an individual record result. An [ErrorCode] value of \
         ...
         ID, stream name, and shard ID. An [ErrorCode] value of [InternalFailure] has the error \
...
type nonrec put_records_result_entry_list = put_records_result_entry list [@@ocaml.doc ""]

type nonrec put_records_output = {
  failed_record_count : positive_integer_object option;
      [@ocaml.doc "The number of unsuccessfully processed records in a [PutRecords] request.\n"]
  records : put_records_result_entry_list;
      [@ocaml.doc
        "An array of successfully and unsuccessfully processed record results. A record that is \
         successfully added to a stream includes [SequenceNumber] and [ShardId] in the result. A \
         record that fails to be added to a stream includes [ErrorCode] and [ErrorMessage] in the \
         result.\n"]
  encryption_type : encryption_type option;
      [@ocaml.doc
...
type nonrec put_records_request_entry = {
  ...
  explicit_hash_key : hash_key option;
      [@ocaml.doc
        "The hash value used to determine explicitly the shard that the data record is assigned to \
  ...
  partition_key : partition_key;
      [@ocaml.doc
        "Determines which shard in the stream the data record is assigned to. Partition keys are \
         Unicode strings with a maximum length limit of 256 characters for each key. Amazon \
...
type nonrec put_records_request_entry_list = put_records_request_entry list [@@ocaml.doc ""]
...
[@@ocaml.doc "A [PutRecords] request.\n"]

type nonrec put_record_output = {
  shard_id : shard_id; [@ocaml.doc "The shard ID of the shard where the data record was placed.\n"]
  sequence_number : sequence_number;
      [@ocaml.doc
...
type nonrec put_record_input = {
  ...
  sequence_number_for_ordering : sequence_number option;
      [@ocaml.doc
        "Guarantees strictly increasing sequence numbers, for puts from the same client and to the \
         same partition key. Usage: set the [SequenceNumberForOrdering] of record {i n} to the \
         sequence number of record {i n-1} (as returned in the result when putting record {i \
         n-1}). If this parameter is not set, records are coarsely ordered based on arrival time.\n"]
  stream_ar_n : stream_ar_n option; [@ocaml.doc "The ARN of the stream.\n"]
  stream_id : stream_id option; [@ocaml.doc "Not Implemented. Reserved for future use.\n"]
}
...
type nonrec merge_shards_input = {
  stream_name : stream_name option; [@ocaml.doc "The name of the stream for the merge.\n"]
  shard_to_merge : shard_id;
      [@ocaml.doc "The shard ID of the shard to combine with the adjacent shard for the merge.\n"]
  adjacent_shard_to_merge : shard_id;
      [@ocaml.doc "The shard ID of the adjacent shard for the merge.\n"]
  stream_ar_n : stream_ar_n option; [@ocaml.doc "The ARN of the stream.\n"]
  stream_id : stream_id option; [@ocaml.doc "Not Implemented. Reserved for future use.\n"]
}
[@@ocaml.doc "Represents the input for [MergeShards].\n"]
...
[@@ocaml.doc "Metadata assigned to the stream or consumer, consisting of a key-value pair.\n"]
  ...
  limit : list_tags_for_stream_input_limit option;
      [@ocaml.doc
        "The number of tags to return. If this number is less than the total number of tags \
         associated with the stream, [HasMoreTags] is set to [true]. To list additional tags, set \
...
type nonrec list_tags_for_resource_output = {
  tags : tag_list option;
      [@ocaml.doc "An array of tags associated with the specified Kinesis resource.\n"]
}
[@@ocaml.doc ""]
...
type nonrec stream_summary = {
  stream_name : stream_name; [@ocaml.doc "The name of a stream.\n"]
  stream_ar_n : stream_ar_n; [@ocaml.doc "The ARN of the stream.\n"]
...
[@@ocaml.doc "The summary of a stream.\n"]

type nonrec stream_summary_list = stream_summary list [@@ocaml.doc ""]

type nonrec next_token = string [@@ocaml.doc ""]

type nonrec stream_name_list = stream_name list [@@ocaml.doc ""]
...
type nonrec list_streams_output = {
  ...
  has_more_streams : boolean_object;
      [@ocaml.doc "If set to [true], there are more streams available to list.\n"]
  next_token : next_token option; [@ocaml.doc "\n"]
  stream_summaries : stream_summary_list option; [@ocaml.doc "\n"]
}
[@@ocaml.doc "Represents the output for [ListStreams].\n"]

type nonrec list_streams_input_limit = int [@@ocaml.doc ""]
...
type nonrec list_stream_consumers_output = {
  consumers : consumer_list option;
      [@ocaml.doc "An array of JSON objects. Each object represents one registered consumer.\n"]
  next_token : next_token option;
      [@ocaml.doc
        "When the number of consumers that are registered with the data stream is greater than the \
         ...
         [MaxResults] that is less than the number of registered consumers, the response includes \
         a pagination token named [NextToken]. You can specify this [NextToken] value in a \
         subsequent call to [ListStreamConsumers] to list the next set of registered consumers. \
        ...
        \  Tokens expire after 300 seconds. When you obtain a value for [NextToken] in the \
         response to a call to [ListStreamConsumers], you have 300 seconds to use that value. If \
         you specify an expired token in a call to [ListStreamConsumers], you get \
...
type nonrec list_stream_consumers_input = {
  ...
  next_token : next_token option;
      [@ocaml.doc
        ...
        \  You can optionally specify a value for the [MaxResults] parameter when you specify \
         ...
         contain a new [NextToken] value. You can use the new [NextToken] value in a subsequent \
         call to the [ListStreamConsumers] operation to list the next set of consumers.\n\
        \  \n\
        \    Tokens expire after 300 seconds. When you obtain a value for [NextToken] in the \
         response to a call to [ListStreamConsumers], you have 300 seconds to use that value. If \
         you specify an expired token in a call to [ListStreamConsumers], you get \
  ...
  max_results : list_stream_consumers_input_limit option;
      [@ocaml.doc
        "The maximum number of consumers that you want a single call of [ListStreamConsumers] to \
         return. The default value is 100. If you specify a value greater than 100, at most 100 \
  ...
  shards : shard_list option;
      [@ocaml.doc
        "An array of JSON objects. Each object represents one shard and specifies the IDs of the \
         shard, the shard's parent, and the shard that's adjacent to the shard's parent. Each \
  ...
  next_token : next_token option;
      [@ocaml.doc
        "When the number of shards in the data stream is greater than the default value for the \
         ...
         less than the number of shards in the data stream, the response includes a pagination \
        ...
        \  Tokens expire after 300 seconds. When you obtain a value for [NextToken] in the \
         response to a call to [ListShards], you have 300 seconds to use that value. If you \
         specify an expired token in a call to [ListShards], you get [ExpiredNextTokenException].\n\
        \  \n\
        \   "]
}
[@@ocaml.doc ""]
...
type nonrec shard_filter = {
  type_ : shard_filter_type;
      [@ocaml.doc
        "The shard type specified in the [ShardFilter] parameter. This is a required property of \
         the [ShardFilter] parameter.\n\n\
        ...
        \            \n\
        \             }\n\
        \        {-   [AT_LATEST] - the response includes only the currently open shards of the \
         data stream.\n\
        \            \n\
        \             }\n\
        \        {-   [AT_TIMESTAMP] - the response includes all shards whose start timestamp is \
         less than or equal to the given timestamp and end timestamp is greater than or equal to \
         the given timestamp or still open. \n\
        \            \n\
        \             }\n\
        \        {-   [FROM_TIMESTAMP] - the response incldues all closed shards whose end \
         timestamp is greater than or equal to the given timestamp and also all open shards. \
         Corrected to [TRIM_HORIZON] of the data stream if [FROM_TIMESTAMP] is less than the \
         [TRIM_HORIZON] value.\n\
        \            \n\
        \             }\n\
        \        }\n\
  ...
  timestamp : timestamp option;
      [@ocaml.doc
        "The timestamps specified in the [ShardFilter] parameter. A timestamp is a Unix epoch date \
         with precision in milliseconds. For example, 2016-04-04T19:58:46.480-00:00 or \
         1459799926.480. This property can only be used if [FROM_TIMESTAMP] or [AT_TIMESTAMP] \
...
type nonrec list_shards_input = {
  ...
  exclusive_start_shard_id : shard_id option;
      [@ocaml.doc
        ...
        \ If you don't specify this parameter, the default behavior is for [ListShards] to list \
         the shards starting with the first one in the stream.\n\
        \ \n\
        \  You cannot specify this parameter if you specify [NextToken].\n\
        \  "]
  max_results : list_shards_input_limit option;
      [@ocaml.doc
        "The maximum number of shards to return in a single call to [ListShards]. The maximum \
         number of shards to return in a single call. The default value is 1000. If you specify a \
  ...
  shard_filter : shard_filter option;
      [@ocaml.doc
        "Enables you to filter out the response of the [ListShards] API. You can only specify one \
         filter at a time. \n\n\
        ...
        \  If you specify the [AFTER_SHARD_ID] type, you must also provide the value for the \
         optional [ShardId] property. The [ShardId] property is identical in fuctionality to the \
         [ExclusiveStartShardId] parameter of the [ListShards] API. When [ShardId] property is \
         specified, the response includes the shards starting with the shard whose ID immediately \
         follows the [ShardId] that you provided. \n\
        \  \n\
        \   If you specify the [AT_TIMESTAMP] or [FROM_TIMESTAMP_ID] type, you must also provide \
         the value for the optional [Timestamp] property. If you specify the AT_TIMESTAMP type, \
         then all shards that were open at the provided timestamp are returned. If you specify the \
         FROM_TIMESTAMP type, then all shards starting from the provided timestamp to TIP are \
         returned. \n\
        \   "]
  stream_ar_n : stream_ar_n option; [@ocaml.doc "The ARN of the stream.\n"]
  stream_id : stream_id option; [@ocaml.doc "Not Implemented. Reserved for future use.\n"]
