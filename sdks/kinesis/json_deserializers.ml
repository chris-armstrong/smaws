...
let record_of_yojson tree path =
  ...
  ({
     ...
     approximate_arrival_timestamp =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "ApproximateArrivalTimestamp")
          _list path);
     sequence_number =
...
let stream_summary_of_yojson tree path =
  ...
  ({
     stream_creation_timestamp =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "StreamCreationTimestamp") _list
          path);
     stream_mode_details =
       (option_of_yojson
...
let consumer_of_yojson tree path =
  ...
  ({
     consumer_creation_timestamp =
       (value_for_key timestamp_of_yojson "ConsumerCreationTimestamp" _list
          path);
     consumer_status =
