  ...
  struct
    ...
    let request context (request : add_tags_to_stream_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.AddTagsToStream" ~service ~context
        ~input
...
module CreateStream =
  struct
    ...
    let request context (request : create_stream_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.CreateStream" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DecreaseStreamRetentionPeriod =
  struct
    ...
    let request context (request : decrease_stream_retention_period_input) =
      let input =
        Json_serializers.decrease_stream_retention_period_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.DecreaseStreamRetentionPeriod" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeleteResourcePolicy =
  struct
    ...
    let request context (request : delete_resource_policy_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.DeleteResourcePolicy" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeleteStream =
  struct
    ...
    let request context (request : delete_stream_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.DeleteStream" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeregisterStreamConsumer =
  struct
    ...
    let request context (request : deregister_stream_consumer_input) =
      let input =
        Json_serializers.deregister_stream_consumer_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.DeregisterStreamConsumer" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DescribeLimits =
  struct
    ...
    let request context (request : describe_limits_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.DescribeLimits" ~service ~context
        ~input
...
module DescribeStream =
  struct
    ...
    let request context (request : describe_stream_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.DescribeStream" ~service ~context
        ~input
...
module DescribeStreamConsumer =
  struct
    ...
    let request context (request : describe_stream_consumer_input) =
      let input =
        Json_serializers.describe_stream_consumer_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.DescribeStreamConsumer" ~service
        ~context ~input
...
module DescribeStreamSummary =
  struct
    ...
    let request context (request : describe_stream_summary_input) =
      let input =
        Json_serializers.describe_stream_summary_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.DescribeStreamSummary" ~service
        ~context ~input
...
module DisableEnhancedMonitoring =
  struct
    ...
    let request context (request : disable_enhanced_monitoring_input) =
      let input =
        Json_serializers.disable_enhanced_monitoring_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.DisableEnhancedMonitoring" ~service
        ~context ~input
...
module EnableEnhancedMonitoring =
  struct
    ...
    let request context (request : enable_enhanced_monitoring_input) =
      let input =
        Json_serializers.enable_enhanced_monitoring_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.EnableEnhancedMonitoring" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.enhanced_monitoring_output_of_yojson
        ~error_deserializer
  end
module GetRecords =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "KMSDisabledException") ->
            `KMSDisabledException
              (Json_deserializers.kms_disabled_exception_of_yojson tree path)
        ...
        | (_, "KMSNotFoundException") ->
            `KMSNotFoundException
              (Json_deserializers.kms_not_found_exception_of_yojson tree path)
        | (_, "KMSOptInRequired") ->
            `KMSOptInRequired
    ...
    let request context (request : get_records_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.GetRecords" ~service ~context ~input
...
module GetResourcePolicy =
  struct
    ...
    let request context (request : get_resource_policy_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.GetResourcePolicy" ~service ~context
        ~input
...
module GetShardIterator =
  struct
    ...
    let request context (request : get_shard_iterator_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.GetShardIterator" ~service ~context
        ~input
...
module IncreaseStreamRetentionPeriod =
  struct
    ...
    let request context (request : increase_stream_retention_period_input) =
      let input =
        Json_serializers.increase_stream_retention_period_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.IncreaseStreamRetentionPeriod" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module ListShards =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ExpiredNextTokenException") ->
            `ExpiredNextTokenException
              (Json_deserializers.expired_next_token_exception_of_yojson tree
                 path)
        | (_, "InvalidArgumentException") ->
            `InvalidArgumentException
              (Json_deserializers.invalid_argument_exception_of_yojson tree
    ...
    let request context (request : list_shards_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.ListShards" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_shards_output_of_yojson
        ~error_deserializer
  end
module ListStreamConsumers =
  struct
    ...
    let request context (request : list_stream_consumers_input) =
      let input =
        Json_serializers.list_stream_consumers_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.ListStreamConsumers" ~service ~context
        ~input
...
module ListStreams =
  struct
    ...
    let request context (request : list_streams_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.ListStreams" ~service ~context ~input
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.ListTagsForResource" ~service ~context
        ~input
...
module ListTagsForStream =
  struct
    ...
    let request context (request : list_tags_for_stream_input) =
      let input =
        Json_serializers.list_tags_for_stream_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.ListTagsForStream" ~service ~context
        ~input
...
module MergeShards =
  struct
    ...
    let request context (request : merge_shards_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.MergeShards" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module PutRecord =
  struct
    ...
    let request context (request : put_record_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.PutRecord" ~service ~context ~input
        ~output_deserializer:Json_deserializers.put_record_output_of_yojson
        ~error_deserializer
  end
module PutRecords =
  struct
    ...
    let request context (request : put_records_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.PutRecords" ~service ~context ~input
        ~output_deserializer:Json_deserializers.put_records_output_of_yojson
        ~error_deserializer
  end
module PutResourcePolicy =
  struct
    ...
    let request context (request : put_resource_policy_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.PutResourcePolicy" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module RegisterStreamConsumer =
  struct
    ...
    let request context (request : register_stream_consumer_input) =
      let input =
        Json_serializers.register_stream_consumer_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.RegisterStreamConsumer" ~service
        ~context ~input
...
module RemoveTagsFromStream =
  struct
    ...
    let request context (request : remove_tags_from_stream_input) =
      let input =
        Json_serializers.remove_tags_from_stream_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.RemoveTagsFromStream" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module SplitShard =
  struct
    ...
    let request context (request : split_shard_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.SplitShard" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module StartStreamEncryption =
  struct
    ...
    let request context (request : start_stream_encryption_input) =
      let input =
        Json_serializers.start_stream_encryption_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.StartStreamEncryption" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module StopStreamEncryption =
  struct
    ...
    let request context (request : stop_stream_encryption_input) =
      let input =
        Json_serializers.stop_stream_encryption_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.StopStreamEncryption" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module SubscribeToShard =
  struct
    ...
    let request context (request : subscribe_to_shard_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.SubscribeToShard" ~service ~context
        ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.TagResource" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.UntagResource" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module UpdateShardCount =
  struct
    ...
    let request context (request : update_shard_count_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.UpdateShardCount" ~service ~context
        ~input
...
module UpdateStreamMode =
  struct
    ...
    let request context (request : update_stream_mode_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"Kinesis_20131202.UpdateStreamMode" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end