...
module AddTagsToStream = struct
  ...
  let request context (request : add_tags_to_stream_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202AddTagsToStream" ~service
...
module CreateStream = struct
  ...
  let request context (request : create_stream_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202CreateStream" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DecreaseStreamRetentionPeriod = struct
  ...
  let request context (request : decrease_stream_retention_period_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202DecreaseStreamRetentionPeriod"
...
module DeleteResourcePolicy = struct
  ...
  let request context (request : delete_resource_policy_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202DeleteResourcePolicy" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DeleteStream = struct
  ...
  let request context (request : delete_stream_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202DeleteStream" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DeregisterStreamConsumer = struct
  ...
  let request context (request : deregister_stream_consumer_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202DeregisterStreamConsumer"
      ~service ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module DescribeLimits = struct
  ...
  let request context (request : describe_limits_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202DescribeLimits" ~service
      ~config:context.config ~http:context.http ~input
...
module DescribeStream = struct
  ...
  let request context (request : describe_stream_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202DescribeStream" ~service
      ~config:context.config ~http:context.http ~input
...
module DescribeStreamConsumer = struct
  ...
  let request context (request : describe_stream_consumer_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202DescribeStreamConsumer"
      ~service ~config:context.config ~http:context.http ~input
...
module DescribeStreamSummary = struct
  ...
  let request context (request : describe_stream_summary_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202DescribeStreamSummary" ~service
      ~config:context.config ~http:context.http ~input
...
module DisableEnhancedMonitoring = struct
  ...
  let request context (request : disable_enhanced_monitoring_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202DisableEnhancedMonitoring"
      ~service ~config:context.config ~http:context.http ~input
...
module EnableEnhancedMonitoring = struct
  ...
  let request context (request : enable_enhanced_monitoring_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202EnableEnhancedMonitoring"
      ~service ~config:context.config ~http:context.http ~input
      ~output_deserializer:Json_deserializers.enhanced_monitoring_output_of_yojson
      ~error_deserializer
end
...
module GetRecords = struct
  ...
  let request context (request : get_records_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202GetRecords" ~service
      ~config:context.config ~http:context.http ~input
...
module GetResourcePolicy = struct
  ...
  let request context (request : get_resource_policy_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202GetResourcePolicy" ~service
      ~config:context.config ~http:context.http ~input
...
module GetShardIterator = struct
  ...
  let request context (request : get_shard_iterator_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202GetShardIterator" ~service
      ~config:context.config ~http:context.http ~input
...
module IncreaseStreamRetentionPeriod = struct
  ...
  let request context (request : increase_stream_retention_period_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202IncreaseStreamRetentionPeriod"
      ~service ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module ListShards = struct
  ...
  let request context (request : list_shards_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202ListShards" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Json_deserializers.list_shards_output_of_yojson ~error_deserializer
end
...
module ListStreamConsumers = struct
  ...
  let request context (request : list_stream_consumers_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202ListStreamConsumers" ~service
      ~config:context.config ~http:context.http ~input
...
module ListStreams = struct
  ...
  let request context (request : list_streams_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202ListStreams" ~service
      ~config:context.config ~http:context.http ~input
...
module ListTagsForResource = struct
  ...
  let request context (request : list_tags_for_resource_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202ListTagsForResource" ~service
      ~config:context.config ~http:context.http ~input
...
module ListTagsForStream = struct
  ...
  let request context (request : list_tags_for_stream_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202ListTagsForStream" ~service
      ~config:context.config ~http:context.http ~input
...
module MergeShards = struct
  ...
  let request context (request : merge_shards_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202MergeShards" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module PutRecord = struct
  ...
  let request context (request : put_record_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202PutRecord" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Json_deserializers.put_record_output_of_yojson ~error_deserializer
end
...
module PutRecords = struct
  ...
  let request context (request : put_records_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202PutRecords" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Json_deserializers.put_records_output_of_yojson ~error_deserializer
end
...
module PutResourcePolicy = struct
  ...
  let request context (request : put_resource_policy_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202PutResourcePolicy" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module RegisterStreamConsumer = struct
  ...
  let request context (request : register_stream_consumer_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202RegisterStreamConsumer"
      ~service ~config:context.config ~http:context.http ~input
...
module RemoveTagsFromStream = struct
  ...
  let request context (request : remove_tags_from_stream_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202RemoveTagsFromStream" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module SplitShard = struct
  ...
  let request context (request : split_shard_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202SplitShard" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module StartStreamEncryption = struct
  ...
  let request context (request : start_stream_encryption_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202StartStreamEncryption" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module StopStreamEncryption = struct
  ...
  let request context (request : stop_stream_encryption_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202StopStreamEncryption" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module SubscribeToShard = struct
  ...
  let request context (request : subscribe_to_shard_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202SubscribeToShard" ~service
      ~config:context.config ~http:context.http ~input
...
module TagResource = struct
  ...
  let request context (request : tag_resource_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202TagResource" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module UntagResource = struct
  ...
  let request context (request : untag_resource_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202UntagResource" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
...
module UpdateShardCount = struct
  ...
  let request context (request : update_shard_count_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202UpdateShardCount" ~service
      ~config:context.config ~http:context.http ~input
...
module UpdateStreamMode = struct
  ...
  let request context (request : update_stream_mode_input) =
    ...
    Smaws_Lib.Protocols.AwsJson.request ~shape_name:"Kinesis_20131202UpdateStreamMode" ~service
      ~config:context.config ~http:context.http ~input
      ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
      ~error_deserializer
end
