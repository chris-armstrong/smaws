  ...
  struct
    ...
    let request context (request : add_tags_to_stream_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.add_tags_to_stream_input_to_yojson request in
...
module DisableEnhancedMonitoring =
  struct
    ...
    let request context (request : disable_enhanced_monitoring_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.disable_enhanced_monitoring_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module SubscribeToShard =
  struct
    ...
    let request context (request : subscribe_to_shard_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.subscribe_to_shard_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateShardCount =
  struct
    ...
    let request context (request : update_shard_count_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_shard_count_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateStreamMode =
  struct
    ...
    let request context (request : update_stream_mode_input) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_stream_mode_input_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
