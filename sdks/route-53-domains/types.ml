...
type nonrec duplicate_request = {
  ...
  message : error_message option; [@ocaml.doc "The request is already in progress for the domain.\n"]
}
...
type nonrec operator = LE [@ocaml.doc ""] | GE [@ocaml.doc ""] | BEGINS_WITH [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec list_domains_attribute_name = DomainName [@ocaml.doc ""] | Expiry [@ocaml.doc ""]
[@@ocaml.doc ""]
