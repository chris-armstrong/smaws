...
type nonrec case_sensitivity = CaseSensitive [@ocaml.doc ""] | ClientSpecified [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec tape_storage_class = GLACIER [@ocaml.doc ""] | DEEP_ARCHIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec pool_status = DELETED [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec file_share_type = SMB [@ocaml.doc ""] | NFS [@ocaml.doc ""]
