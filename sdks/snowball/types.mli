...
type nonrec shipment_state = RECEIVED [@ocaml.doc ""] | RETURNED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec service_name = KUBERNETES [@ocaml.doc ""] | EKS_ANYWHERE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec address_type = CUST_PICKUP [@ocaml.doc ""] | AWS_SHIP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec job_type = IMPORT [@ocaml.doc ""] | EXPORT [@ocaml.doc ""] | LOCAL_USE [@ocaml.doc ""]
[@@ocaml.doc ""]
