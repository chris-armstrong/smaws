  ...
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidJobStateException") ->
            `InvalidJobStateException
              (Json_deserializers.invalid_job_state_exception_of_yojson tree
                 path)
        ...
        | (_, "KMSRequestFailedException") ->
            `KMSRequestFailedException
              (Json_deserializers.kms_request_failed_exception_of_yojson tree
                 path)
    ...
    let request context (request : cancel_cluster_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ...
        ~output_deserializer:Json_deserializers.cancel_cluster_result_of_yojson
        ~error_deserializer
  end
module CancelJob =
  struct
    ...
    let request context (request : cancel_job_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSIESnowballJobManagementService.CancelJob" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.cancel_job_result_of_yojson
        ~error_deserializer
  end
module CreateAddress =
  struct
    let error_to_string =
      function
      | `InvalidAddressException _ ->
          "com.amazonaws.snowball#InvalidAddressException"
      | `UnsupportedAddressException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidAddressException") ->
            `InvalidAddressException
              (Json_deserializers.invalid_address_exception_of_yojson tree
                 path)
        | (_, "UnsupportedAddressException") ->
            `UnsupportedAddressException
              (Json_deserializers.unsupported_address_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : create_address_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ...
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.create_address_result_of_yojson
        ~error_deserializer
  end
  ...
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "Ec2RequestFailedException") ->
            `Ec2RequestFailedException
              (Json_deserializers.ec2_request_failed_exception_of_yojson tree
                 path)
        | (_, "InvalidInputCombinationException") ->
            `InvalidInputCombinationException
              (Json_deserializers.invalid_input_combination_exception_of_yojson
                 tree path)
        | (_, "InvalidResourceException") ->
            `InvalidResourceException
              (Json_deserializers.invalid_resource_exception_of_yojson tree
    ...
    let request context (request : create_cluster_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ...
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.create_cluster_result_of_yojson
        ~error_deserializer
  end
module CreateJob =
  struct
    let error_to_string =
      function
      | `ClusterLimitExceededException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "ClusterLimitExceededException") ->
            `ClusterLimitExceededException
              (Json_deserializers.cluster_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "Ec2RequestFailedException") ->
            `Ec2RequestFailedException
              (Json_deserializers.ec2_request_failed_exception_of_yojson tree
    ...
    let request context (request : create_job_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSIESnowballJobManagementService.CreateJob" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.create_job_result_of_yojson
        ~error_deserializer
  end
module CreateLongTermPricing =
  struct
    ...
    let request context (request : create_long_term_pricing_request) =
      let input =
        Json_serializers.create_long_term_pricing_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateReturnShippingLabel =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ReturnShippingLabelAlreadyExistsException") ->
            `ReturnShippingLabelAlreadyExistsException
              (Json_deserializers.return_shipping_label_already_exists_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : create_return_shipping_label_request) =
      let input =
        Json_serializers.create_return_shipping_label_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : describe_address_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ...
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_address_result_of_yojson
        ~error_deserializer
  end
module DescribeAddresses =
  struct
    ...
    let request context (request : describe_addresses_request) =
      let input =
        Json_serializers.describe_addresses_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : describe_cluster_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ...
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_cluster_result_of_yojson
        ~error_deserializer
  end
module DescribeJob =
  struct
    ...
    let request context (request : describe_job_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSIESnowballJobManagementService.DescribeJob" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.describe_job_result_of_yojson
        ~error_deserializer
  end
module DescribeReturnShippingLabel =
  struct
    ...
    let request context (request : describe_return_shipping_label_request) =
      let input =
        Json_serializers.describe_return_shipping_label_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : get_job_manifest_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ...
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.get_job_manifest_result_of_yojson
        ~error_deserializer
  end
module GetJobUnlockCode =
  struct
    ...
    let request context (request : get_job_unlock_code_request) =
      let input =
        Json_serializers.get_job_unlock_code_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetSnowballUsage =
  struct
    ...
    let request context (request : get_snowball_usage_request) =
      let input =
        Json_serializers.get_snowball_usage_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetSoftwareUpdates =
  struct
    ...
    let request context (request : get_software_updates_request) =
      let input =
        Json_serializers.get_software_updates_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListClusterJobs =
  struct
    ...
    let request context (request : list_cluster_jobs_request) =
      let input =
        Json_serializers.list_cluster_jobs_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSIESnowballJobManagementService.ListClusterJobs"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_cluster_jobs_result_of_yojson
        ~error_deserializer
  end
module ListClusters =
  struct
    ...
    let request context (request : list_clusters_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSIESnowballJobManagementService.ListClusters" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_clusters_result_of_yojson
        ~error_deserializer
  end
module ListCompatibleImages =
  struct
    ...
    let request context (request : list_compatible_images_request) =
      let input =
        Json_serializers.list_compatible_images_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListJobs =
  struct
    ...
    let request context (request : list_jobs_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSIESnowballJobManagementService.ListJobs" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_jobs_result_of_yojson
        ~error_deserializer
  end
module ListLongTermPricing =
  struct
    ...
    let request context (request : list_long_term_pricing_request) =
      let input =
        Json_serializers.list_long_term_pricing_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListPickupLocations =
  struct
    ...
    let request context (request : list_pickup_locations_request) =
      let input =
        Json_serializers.list_pickup_locations_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListServiceVersions =
  struct
    ...
    let request context (request : list_service_versions_request) =
      let input =
        Json_serializers.list_service_versions_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : update_cluster_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ...
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.update_cluster_result_of_yojson
        ~error_deserializer
  end
module UpdateJob =
  struct
    ...
    let request context (request : update_job_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSIESnowballJobManagementService.UpdateJob" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.update_job_result_of_yojson
        ~error_deserializer
  end
module UpdateJobShipmentState =
  struct
    ...
    let request context (request : update_job_shipment_state_request) =
      let input =
        Json_serializers.update_job_shipment_state_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateLongTermPricing =
  struct
    ...
    let request context (request : update_long_term_pricing_request) =
      let input =
        Json_serializers.update_long_term_pricing_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
