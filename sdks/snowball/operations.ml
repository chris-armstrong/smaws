...
module DescribeAddress =
  struct
    ...
    let request context (request : describe_address_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_address_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribeCluster =
  struct
    ...
    let request context (request : describe_cluster_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_cluster_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : describe_job_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSIESnowballJobManagementServiceDescribeJob" ~service
          ~config:context.config ~http:context.http ~input
...
module GetJobManifest =
  struct
    ...
    let request context (request : get_job_manifest_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_job_manifest_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateJobShipmentState =
  struct
    ...
    let request context (request : update_job_shipment_state_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_job_shipment_state_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
