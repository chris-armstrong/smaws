...
let long_term_pricing_list_entry_of_yojson tree path =
  ...
  ({
     ...
     long_term_pricing_start_date =
       option_of_yojson (value_for_key timestamp__of_yojson "LongTermPricingStartDate") _list path;
     long_term_pricing_end_date =
       option_of_yojson (value_for_key timestamp__of_yojson "LongTermPricingEndDate") _list path;
     long_term_pricing_id =
       option_of_yojson
...
let get_snowball_usage_result_of_yojson tree path =
  ...
  ({
     snowballs_in_use =
       option_of_yojson (value_for_key integer__of_yojson "SnowballsInUse") _list path;
...
let describe_return_shipping_label_result_of_yojson tree path =
  ...
  ({
     ...
     expiration_date =
       option_of_yojson (value_for_key timestamp__of_yojson "ExpirationDate") _list path;
