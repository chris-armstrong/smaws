  ...
  let _res : notification =
    {
      device_pickup_sns_topic_ar_n =
        (option_of_yojson
           ...
           _list path);
      notify_all =
        (option_of_yojson (value_for_key boolean__of_yojson "NotifyAll")
           _list path);
...
let device_service_name_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise
         (deserialize_unknown_enum_value_error path "DeviceServiceName" value)
  ...
  let _res : s3_resource =
    {
      ...
      key_range =
        (option_of_yojson (value_for_key key_range_of_yojson "KeyRange")
           _list path);
      bucket_arn =
  ...
  let _res : job_resource =
    {
      ...
      s3_resources =
        (option_of_yojson
           (value_for_key s3_resource_list_of_yojson "S3Resources") _list
           path)
    } in
  _res
...
let storage_unit_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ -> raise (deserialize_wrong_type_error path "StorageUnit") : storage_unit)
  ...
  let _res : nfs_on_device_service_configuration =
    {
      storage_unit =
        (option_of_yojson
           (value_for_key storage_unit_of_yojson "StorageUnit") _list path);
      storage_limit =
        (option_of_yojson
  ...
  let _res : s3_on_device_service_configuration =
    {
      ...
      service_size =
        (option_of_yojson
           (value_for_key service_size_of_yojson "ServiceSize") _list path);
      storage_unit =
        (option_of_yojson
           (value_for_key storage_unit_of_yojson "StorageUnit") _list path);
      storage_limit =
  ...
  let _res : pickup_details =
    {
      ...
      identification_number =
        (option_of_yojson
           (value_for_key string__of_yojson "IdentificationNumber") _list
           path);
      email =
  ...
  let _res : update_job_request =
    {
      pickup_details =
        (option_of_yojson
           (value_for_key pickup_details_of_yojson "PickupDetails") _list
           path);
  ...
  let _res : update_cluster_request =
    {
      ...
      role_ar_n =
        (option_of_yojson (value_for_key role_ar_n_of_yojson "RoleARN") _list
           path);
      cluster_id =
        (value_for_key cluster_id_of_yojson "ClusterId" _list path)
    } in
  _res
...
let snowball_type_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String "STANDARD" -> STANDARD
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "SnowballType" value)
  ...
  let _res : shipping_details =
    {
      ...
      inbound_shipment =
        (option_of_yojson
           (value_for_key shipment_of_yojson "InboundShipment") _list path);
      shipping_option =
        (option_of_yojson
           (value_for_key shipping_option_of_yojson "ShippingOption") _list
           path)
...
let service_name_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ -> raise (deserialize_wrong_type_error path "ServiceName") : service_name)
  ...
  let _res : long_term_pricing_list_entry =
    {
      ...
      long_term_pricing_end_date =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "LongTermPricingEndDate")
           _list path);
      long_term_pricing_id =
        (option_of_yojson
           (value_for_key long_term_pricing_id_of_yojson "LongTermPricingId")
  ...
  let _res : list_service_versions_result =
    {
      ...
      dependent_services =
        (option_of_yojson
           (value_for_key dependent_service_list_of_yojson
              "DependentServices") _list path);
      service_name =
        (value_for_key service_name_of_yojson "ServiceName" _list path);
      service_versions =
...
let address_type_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ -> raise (deserialize_wrong_type_error path "AddressType") : address_type)
  ...
  let _res : address =
    {
      ...
      phone_number =
        (option_of_yojson (value_for_key string__of_yojson "PhoneNumber")
           _list path);
      postal_code =
        (option_of_yojson (value_for_key string__of_yojson "PostalCode")
           _list path);
      country =
      ...
      prefecture_or_district =
        (option_of_yojson
           (value_for_key string__of_yojson "PrefectureOrDistrict") _list
           path);
      state_or_province =
  ...
  let _res : job_list_entry =
    {
      ...
      is_master =
        (option_of_yojson (value_for_key boolean__of_yojson "IsMaster") _list
           path);
      job_state =
        (option_of_yojson (value_for_key job_state_of_yojson "JobState")
           _list path);
      job_id =
        (option_of_yojson (value_for_key string__of_yojson "JobId") _list
           path)
    } in
  _res
  ...
  let _res : compatible_image =
    {
      name =
        (option_of_yojson (value_for_key string__of_yojson "Name") _list path);
      ami_id =
        (option_of_yojson (value_for_key string__of_yojson "AmiId") _list
           path)
    } in
  _res
...
let cluster_state_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "ClusterState" value)
  ...
  let _res : job_logs =
    {
      job_failure_log_ur_i =
        (option_of_yojson
           (value_for_key string__of_yojson "JobFailureLogURI") _list path);
      job_success_log_ur_i =
        (option_of_yojson
           (value_for_key string__of_yojson "JobSuccessLogURI") _list path);
...
let impact_level_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ -> raise (deserialize_wrong_type_error path "ImpactLevel") : impact_level)
let job_metadata_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : job_metadata =
    {
      snowball_id =
        (option_of_yojson (value_for_key string__of_yojson "SnowballId")
           _list path);
      pickup_details =
        (option_of_yojson
           (value_for_key pickup_details_of_yojson "PickupDetails") _list
      ...
      impact_level =
        (option_of_yojson
           (value_for_key impact_level_of_yojson "ImpactLevel") _list path);
      on_device_service_configuration =
        (option_of_yojson
           (value_for_key on_device_service_configuration_of_yojson
              "OnDeviceServiceConfiguration") _list path);
      ...
      device_configuration =
        (option_of_yojson
           (value_for_key device_configuration_of_yojson
              "DeviceConfiguration") _list path);
      tax_documents =
        (option_of_yojson
...
let get_software_updates_result_of_yojson tree path =
  ...
  let _res : get_software_updates_result =
    {
      updates_ur_i =
        (option_of_yojson (value_for_key string__of_yojson "UpdatesURI")
           _list path)
    } in
  _res
...
let get_job_unlock_code_result_of_yojson tree path =
  ...
  let _res : get_job_unlock_code_result =
    {
      unlock_code =
        (option_of_yojson (value_for_key string__of_yojson "UnlockCode")
           _list path)
    } in
  _res
  ...
  let _res : describe_return_shipping_label_result =
    {
      ...
      status =
        (option_of_yojson
           (value_for_key shipping_label_status_of_yojson "Status") _list
           path)
    } in
  _res
  ...
  let _res : conflict_exception =
    {
      ...
      conflict_resource =
        (option_of_yojson
           (value_for_key string__of_yojson "ConflictResource") _list path)
    } in
  _res
  ...
  let _res : describe_job_result =
    {
      ...
      job_metadata =
        (option_of_yojson
           (value_for_key job_metadata_of_yojson "JobMetadata") _list path)
    } in
  _res
...
let describe_address_request_of_yojson tree path =
  ...
  let _res : describe_address_request =
    {
      address_id =
        (value_for_key address_id_of_yojson "AddressId" _list path)
    } in
  _res
  ...
  let _res : create_cluster_request =
    {
      ...
      force_create_jobs =
        (option_of_yojson
           (value_for_key boolean__of_yojson "ForceCreateJobs") _list path);
