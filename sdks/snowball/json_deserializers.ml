...
let long_term_pricing_list_entry_of_yojson tree path =
  ...
  ({
     ...
     long_term_pricing_start_date =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "LongTermPricingStartDate")
          _list path);
     long_term_pricing_end_date =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "LongTermPricingEndDate") _list
          path);
     long_term_pricing_id =
       (option_of_yojson
          (value_for_key long_term_pricing_id_of_yojson "LongTermPricingId")
...
let get_snowball_usage_result_of_yojson tree path =
  ...
  ({
     snowballs_in_use =
       (option_of_yojson (value_for_key integer_of_yojson "SnowballsInUse")
          _list path);
     snowball_limit =
       (option_of_yojson (value_for_key integer_of_yojson "SnowballLimit")
          _list path)
  ...
  ({
     return_shipping_label_ur_i =
       (option_of_yojson
          ...
          path);
     expiration_date =
       (option_of_yojson (value_for_key timestamp_of_yojson "ExpirationDate")
          _list path);
     status =
       (option_of_yojson
