...
let update_long_term_pricing_request_to_yojson
  (x : update_long_term_pricing_request) =
  assoc_to_yojson
    [("IsLongTermPricingAutoRenew",
       (option_to_yojson java_boolean_to_yojson
          x.is_long_term_pricing_auto_renew));
...
let update_job_shipment_state_request_to_yojson
  (x : update_job_shipment_state_request) =
  assoc_to_yojson
...
let notification_to_yojson (x : notification) =
  assoc_to_yojson
    [("DevicePickupSnsTopicARN",
       (option_to_yojson sns_topic_ar_n_to_yojson
          x.device_pickup_sns_topic_ar_n));
...
let s3_resource_to_yojson (x : s3_resource) =
  assoc_to_yojson
    [("TargetOnDeviceServices",
       (option_to_yojson target_on_device_service_list_to_yojson
          x.target_on_device_services));
    ("KeyRange", (option_to_yojson key_range_to_yojson x.key_range));
    ("BucketArn", (option_to_yojson resource_ar_n_to_yojson x.bucket_arn))]
let s3_resource_list_to_yojson tree =
  list_to_yojson s3_resource_to_yojson tree
...
let lambda_resource_to_yojson (x : lambda_resource) =
  assoc_to_yojson
    [("EventTriggers",
       (option_to_yojson event_trigger_definition_list_to_yojson
          x.event_triggers));
    ("LambdaArn", (option_to_yojson resource_ar_n_to_yojson x.lambda_arn))]
let lambda_resource_list_to_yojson tree =
  list_to_yojson lambda_resource_to_yojson tree
...
let ec2_ami_resource_list_to_yojson tree =
  list_to_yojson ec2_ami_resource_to_yojson tree
...
let storage_unit_to_yojson (x : storage_unit) =
  match x with | TB -> `String "TB"
let nfs_on_device_service_configuration_to_yojson
  (x : nfs_on_device_service_configuration) =
  assoc_to_yojson
    [("StorageUnit",
...
let tgw_on_device_service_configuration_to_yojson
  (x : tgw_on_device_service_configuration) =
  assoc_to_yojson
    [("StorageUnit",
       (option_to_yojson storage_unit_to_yojson x.storage_unit));
    ("StorageLimit",
...
let eks_on_device_service_configuration_to_yojson
  (x : eks_on_device_service_configuration) =
  assoc_to_yojson
    [("EKSAnywhereVersion",
...
let s3_on_device_service_configuration_to_yojson
  (x : s3_on_device_service_configuration) =
  assoc_to_yojson
    [("FaultTolerance",
...
let on_device_service_configuration_to_yojson
  (x : on_device_service_configuration) =
  assoc_to_yojson
    [("S3OnDeviceService",
       (option_to_yojson s3_on_device_service_configuration_to_yojson
          x.s3_on_device_service));
    ("EKSOnDeviceService",
      (option_to_yojson eks_on_device_service_configuration_to_yojson
         x.eks_on_device_service));
    ("TGWOnDeviceService",
      (option_to_yojson tgw_on_device_service_configuration_to_yojson
         x.tgw_on_device_service));
    ("NFSOnDeviceService",
      (option_to_yojson nfs_on_device_service_configuration_to_yojson
         x.nfs_on_device_service))]
...
let update_job_request_to_yojson (x : update_job_request) =
  assoc_to_yojson
    ...
    ("SnowballCapacityPreference",
      (option_to_yojson snowball_capacity_to_yojson
         x.snowball_capacity_preference));
    ...
    ("OnDeviceServiceConfiguration",
      (option_to_yojson on_device_service_configuration_to_yojson
         x.on_device_service_configuration));
...
let invalid_input_combination_exception_to_yojson
  (x : invalid_input_combination_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let unsupported_address_exception_to_yojson
  (x : unsupported_address_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
...
let tax_documents_to_yojson (x : tax_documents) =
  assoc_to_yojson
    [("IND", (option_to_yojson ind_tax_documents_to_yojson x.in_d))]
let snowcone_device_configuration_to_yojson
  (x : snowcone_device_configuration) =
  assoc_to_yojson
    [("WirelessConnection",
...
let service_version_list_to_yojson tree =
  list_to_yojson service_version_to_yojson tree
...
let long_term_pricing_associated_job_id_list_to_yojson tree =
  list_to_yojson job_id_to_yojson tree
let long_term_pricing_list_entry_to_yojson (x : long_term_pricing_list_entry)
  =
  assoc_to_yojson
    [("JobIds",
       (option_to_yojson long_term_pricing_associated_job_id_list_to_yojson
          x.job_ids));
    ("SnowballType",
    ...
    ("LongTermPricingType",
      (option_to_yojson long_term_pricing_type_to_yojson
         x.long_term_pricing_type));
    ("LongTermPricingStartDate",
      (option_to_yojson timestamp_to_yojson x.long_term_pricing_start_date));
    ("LongTermPricingEndDate",
      (option_to_yojson timestamp_to_yojson x.long_term_pricing_end_date));
    ("LongTermPricingId",
      (option_to_yojson long_term_pricing_id_to_yojson x.long_term_pricing_id))]
let long_term_pricing_id_list_to_yojson tree =
  list_to_yojson long_term_pricing_id_to_yojson tree
...
let dependent_service_list_to_yojson tree =
  list_to_yojson dependent_service_to_yojson tree
...
let list_service_versions_request_to_yojson
  (x : list_service_versions_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
...
let list_pickup_locations_request_to_yojson
  (x : list_pickup_locations_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("MaxResults", (option_to_yojson list_limit_to_yojson x.max_results))]
let list_long_term_pricing_result_to_yojson
  (x : list_long_term_pricing_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("LongTermPricingEntries",
      (option_to_yojson long_term_pricing_entry_list_to_yojson
         x.long_term_pricing_entries))]
let list_long_term_pricing_request_to_yojson
  (x : list_long_term_pricing_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("MaxResults", (option_to_yojson list_limit_to_yojson x.max_results))]
...
let job_list_entry_list_to_yojson tree =
  list_to_yojson job_list_entry_to_yojson tree
...
let cluster_list_entry_list_to_yojson tree =
  list_to_yojson cluster_list_entry_to_yojson tree
let list_clusters_result_to_yojson (x : list_clusters_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("ClusterListEntries",
      (option_to_yojson cluster_list_entry_list_to_yojson
         x.cluster_list_entries))]
...
let device_configuration_to_yojson (x : device_configuration) =
  assoc_to_yojson
    [("SnowconeDeviceConfiguration",
       (option_to_yojson snowcone_device_configuration_to_yojson
          x.snowcone_device_configuration))]
...
let job_metadata_to_yojson (x : job_metadata) =
  assoc_to_yojson
    ...
    ("JobState", (option_to_yojson job_state_to_yojson x.job_state));
    ("JobId", (option_to_yojson string__to_yojson x.job_id))]
let job_metadata_list_to_yojson tree =
  list_to_yojson job_metadata_to_yojson tree
...
let get_software_updates_result_to_yojson (x : get_software_updates_result) =
  assoc_to_yojson
    [("UpdatesURI", (option_to_yojson string__to_yojson x.updates_ur_i))]
...
let get_snowball_usage_result_to_yojson (x : get_snowball_usage_result) =
  assoc_to_yojson
    [("SnowballsInUse",
       (option_to_yojson integer_to_yojson x.snowballs_in_use));
...
let create_return_shipping_label_result_to_yojson
  (x : create_return_shipping_label_result) =
  assoc_to_yojson
    [("Status", (option_to_yojson shipping_label_status_to_yojson x.status))]
let create_return_shipping_label_request_to_yojson
  (x : create_return_shipping_label_request) =
  assoc_to_yojson
    [("ShippingOption",
       (option_to_yojson shipping_option_to_yojson x.shipping_option));
    ("JobId", (Some (job_id_to_yojson x.job_id)))]
let create_long_term_pricing_result_to_yojson
  (x : create_long_term_pricing_result) =
  assoc_to_yojson
    [("LongTermPricingId",
       (option_to_yojson long_term_pricing_id_to_yojson
          x.long_term_pricing_id))]
let create_long_term_pricing_request_to_yojson
  (x : create_long_term_pricing_request) =
  assoc_to_yojson
  ...
  assoc_to_yojson
    [("SnowballCapacityPreference",
       (option_to_yojson snowball_capacity_to_yojson
          x.snowball_capacity_preference));
    ("LongTermPricingIds",
      (option_to_yojson long_term_pricing_id_list_to_yojson
         x.long_term_pricing_ids));
    ("ForceCreateJobs",
