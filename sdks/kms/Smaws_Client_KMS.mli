...
val make_cancel_key_deletion_request :
  key_id:key_id_type -> unit -> cancel_key_deletion_request
...
sig
  val error_to_string :
    ...
    | `NotFoundException of not_found_exception ] -> string
  val request :
...
sig
  val error_to_string :
    ...
    | `KMSInternalException of kms_internal_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `XksKeyNotFoundException of xks_key_not_found_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
      create_key_request ->
        (create_key_response,
...
sig
  val error_to_string :
    ...
    | `LimitExceededException of limit_exceeded_exception 
    | `NotFoundException of not_found_exception 
    | `TagException of tag_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
