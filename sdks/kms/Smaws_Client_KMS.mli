...
type nonrec key_metadata =
  {
  current_key_material_id: string option
    [@ocaml.doc
...
type nonrec re_encrypt_response =
  {
  destination_key_material_id: string option
    [@ocaml.doc
  ...
  source_key_material_id: string option
    [@ocaml.doc
...
type nonrec rotations_list_entry =
  ...
  key_material_description: string option
    [@ocaml.doc
