  ...
  struct
    ...
    let request context (request : create_key_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"TrentServiceCreateKey" ~service ~config:context.config
  ...
  struct
    ...
    let request context (request : decrypt_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"TrentServiceDecrypt"
...
module DescribeCustomKeyStores =
  struct
    ...
    let request context (request : describe_custom_key_stores_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_custom_key_stores_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : enable_key_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"TrentServiceEnableKey" ~service ~config:context.config
          ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
  ...
  struct
    ...
    let request context (request : encrypt_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"TrentServiceEncrypt"
          ~service ~config:context.config ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.generate_data_key_without_plaintext_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"TrentServiceGenerateDataKeyWithoutPlaintext" ~service
          ~config:context.config ~http:context.http ~input
...
module GenerateRandom =
  struct
    ...
    let request context (request : generate_random_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.generate_random_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module GetParametersForImport =
  struct
    ...
    let request context (request : get_parameters_for_import_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.get_parameters_for_import_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : list_keys_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"TrentServiceListKeys" ~service ~config:context.config
          ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : re_encrypt_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"TrentServiceReEncrypt" ~service ~config:context.config
          ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : verify_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"TrentServiceVerify"
          ~service ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : verify_mac_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"TrentServiceVerifyMac" ~service ~config:context.config
          ~http:context.http ~input
