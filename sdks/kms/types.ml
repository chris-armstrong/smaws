...
type nonrec xks_proxy_vpc_endpoint_service_not_found_exception = {
  message : error_message_type option; [@ocaml.doc ""]
}
[@@ocaml.doc
  "The request was rejected because KMS could not find the specified VPC endpoint service. Use \
   [DescribeCustomKeyStores] to verify the VPC endpoint service name for the external key store. \
   Also, confirm that the [Allow principals] list for the VPC endpoint service includes the KMS \
   service principal for the Region, such as [cks.kms.us-east-1.amazonaws.com].\n"]
...
[@@ocaml.doc
  "The request was rejected because the Amazon VPC endpoint service configuration does not fulfill \
   ...
   accompanies the exception and \
   {{:https://docs.aws.amazon.com/kms/latest/developerguide/vpc-connectivity.html#xks-vpc-requirements}review \
   the requirements} for Amazon VPC endpoint service connectivity for an external key store.\n"]
...
[@@ocaml.doc
  "The request was rejected because the specified Amazon VPC endpoint service is already \
   associated with another external key store in this Amazon Web Services Region. Each external \
   key store in a Region must use a different Amazon VPC endpoint service.\n"]
...
type nonrec xks_proxy_uri_in_use_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  "The request was rejected because the concatenation of the [XksProxyUriEndpoint] and \
   ...
   Services Region. Each external key store in a Region must use a unique external key store proxy \
   API address.\n"]
...
[@@ocaml.doc
  "The request was rejected because the [XksProxyUriEndpoint] is already associated with another \
   external key store in this Amazon Web Services Region. To identify the cause, see the error \
...
[@@ocaml.doc
  "\n\n\
  \ KMS cannot interpret the response it received from the external key store proxy. The problem \
   might be a poorly constructed response, but it could also be a transient network issue. If you \
   see this error repeatedly, report it to the proxy vendor.\n\
  \ "]
...
[@@ocaml.doc
  "The request was rejected because the proxy credentials failed to authenticate to the specified \
   external key store proxy. The specified external key store proxy rejected a status request from \
   KMS due to invalid credentials. This can indicate an error in the credentials or in the \
   identification of the external key store proxy.\n"]
  ...
  access_key_id : xks_proxy_authentication_access_key_id_type option;
      [@ocaml.doc
        "The part of the external key store \
         {{:https://docs.aws.amazon.com/kms/latest/APIReference/API_CreateCustomKeyStore.html#KMS-CreateCustomKeyStore-request-XksProxyAuthenticationCredential}proxy \
         authentication credential} that uniquely identifies the secret access key.\n"]
...
[@@ocaml.doc
  "Detailed information about the external key store proxy (XKS proxy). Your external key store \
   proxy translates KMS requests into a format that your external key manager can understand. \
   These fields appear in a [DescribeCustomKeyStores] response only when the [CustomKeyStoreType] \
   is [EXTERNAL_KEY_STORE].\n"]

type nonrec xks_proxy_authentication_raw_secret_access_key_type = string [@@ocaml.doc ""]
...
type nonrec xks_key_not_found_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  ...
  \ Verify that the [XksKeyId] represents an existing key in the external key manager. Use the key \
   identifier that the external key store proxy uses to identify the key. For details, see the \
...
[@@ocaml.doc
  "The request was rejected because the external key specified by the [XksKeyId] parameter did not \
   meet the configuration requirements for an external key store.\n\n\
  \ The external key must be an AES-256 symmetric key that is enabled and performs encryption and \
   decryption.\n\
  \ "]
...
[@@ocaml.doc
  "Information about the \
   {{:https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html#concept-external-key}external \
   key }that is associated with a KMS key in an external key store. \n\n\
  \ This element appears in a [CreateKey] or [DescribeKey] response only for a KMS key in an \
   external key store.\n\
  \ \n\
  \  The {i external key} is a symmetric encryption key that is hosted by an external key manager \
   ...
   using the specified external key. For more information, see \
   {{:https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html#concept-external-key}External \
   key} in the {i Key Management Service Developer Guide}.\n\
  \  "]
...
[@@ocaml.doc
  "The request was rejected because the ([XksKeyId]) is already associated with another KMS key in \
   this external key store. Each KMS key in an external key store must be associated with a \
   different external key.\n"]
...
type nonrec verify_response = {
  signing_algorithm : signing_algorithm_spec option;
      [@ocaml.doc "The signing algorithm that was used to verify the signature.\n"]
  signature_valid : boolean_type option;
      [@ocaml.doc
        "A Boolean value that indicates whether the signature was verified. A value of [True] \
         indicates that the [Signature] was produced by signing the [Message] with the specified \
         [KeyID] and [SigningAlgorithm.] If the signature is not verified, the [Verify] operation \
         fails with a [KMSInvalidSignatureException] exception. \n"]
...
type nonrec verify_request = {
  ...
  grant_tokens : grant_token_list option;
      [@ocaml.doc
        ...
        \ Use a grant token when your permission to call this operation comes from a new grant \
         that has not yet achieved {i eventual consistency}. For more information, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#grant_token}Grant \
         token} and \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/using-grant-token.html}Using a \
         grant token} in the {i Key Management Service Developer Guide}.\n\
        \ "]
  ...
  signature : ciphertext_type; [@ocaml.doc "The signature that the [Sign] operation generated.\n"]
  message_type : message_type option;
      [@ocaml.doc
        "Tells KMS whether the value of the [Message] parameter should be hashed as part of the \
         signing algorithm. Use [RAW] for unhashed messages; use [DIGEST] for message digests, \
         which are already hashed; use [EXTERNAL_MU] for 64-byte representative \206\188 used in \
        ...
        \ When the value of [MessageType] is [RAW], KMS uses the standard signing algorithm, which \
         begins with a hash function. When the value is [DIGEST], KMS skips the hashing step in \
         the signing algorithm. When the value is [EXTERNAL_MU] KMS skips the concatenated hashing \
  ...
  message : plaintext_type;
      [@ocaml.doc
        ...
        \ If the message specified here is different from the message that was signed, the \
         signature verification fails. A message and its hash digest are considered to be the same \
         message.\n\
        \ "]
  key_id : key_id_type;
      [@ocaml.doc
        "Identifies the asymmetric KMS key that will be used to verify the signature. This must be \
         the same KMS key that was used to generate the signature. If you specify a different KMS \
         key, the signature verification fails.\n\n\
        ...
        \              }\n\
        \         }\n\
        \   To get the key ID and key ARN for a KMS key, use [ListKeys] or [DescribeKey]. To get \
         the alias name and alias ARN, use [ListAliases].\n\
        \   "]
}
[@@ocaml.doc ""]
...
type nonrec verify_mac_response = {
  ...
  mac_valid : boolean_type option;
      [@ocaml.doc
        "A Boolean value that indicates whether the HMAC was verified. A value of [True] indicates \
         that the HMAC ([Mac]) was generated with the specified [Message], HMAC KMS key ([KeyID]) \
         and [MacAlgorithm.].\n\n\
        \ If the HMAC is not verified, the [VerifyMac] operation fails with a \
         [KMSInvalidMacException] exception. This exception indicates that one or more of the \
         inputs changed since the HMAC was computed.\n\
        \ "]
  key_id : key_id_type option; [@ocaml.doc "The HMAC KMS key used in the verification.\n"]
}
[@@ocaml.doc ""]
...
type nonrec verify_mac_request = {
  ...
  mac : ciphertext_type;
      [@ocaml.doc
        "The HMAC to verify. Enter the HMAC that was generated by the [GenerateMac] operation when \
         you specified the same message, HMAC KMS key, and MAC algorithm as the values specified \
         in this request.\n"]
  mac_algorithm : mac_algorithm_spec;
      [@ocaml.doc
        "The MAC algorithm that will be used in the verification. Enter the same MAC algorithm \
         that was used to compute the HMAC. This algorithm must be supported by the HMAC KMS key \
  ...
  message : plaintext_type;
      [@ocaml.doc
        "The message that will be used in the verification. Enter the same message that was used \
         to generate the HMAC.\n\n\
        \  [GenerateMac] and [VerifyMac] do not provide special handling for message digests. If \
         you generated an HMAC for a hash digest of a message, you must verify the HMAC for the \
         same hash digest.\n\
        \ "]
}
[@@ocaml.doc ""]

type nonrec not_found_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  "The request was rejected because the specified entity or resource could not be found.\n"]

type nonrec kms_invalid_state_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  ...
  \            \n\
  \             To find the key state, use the [DescribeKey] operation. For more information about \
   which key states are compatible with each KMS operation, see \
  ...
  \        {-  For cryptographic operations on KMS keys in custom key stores, this exception \
   represents a general failure with many possible causes. To identify the cause, see the error \
   message that accompanies the exception.\n\
  \            \n\
  \             }\n\
  \        }\n\
...
type nonrec kms_invalid_mac_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  "The request was rejected because the HMAC verification failed. HMAC verification fails when the \
   HMAC computed by using the specified message, HMAC KMS key, and MAC algorithm does not match \
   the HMAC specified in the request.\n"]

type nonrec kms_internal_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  "The request was rejected because an internal exception occurred. The request can be retried.\n"]

type nonrec key_unavailable_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  "The request was rejected because the specified KMS key was not available. You can retry the \
   request.\n"]

type nonrec invalid_key_usage_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  ...
  \   For encrypting, decrypting, re-encrypting, and generating data keys, the [KeyUsage] must be \
   ...
   For generating and verifying message authentication codes (MACs), the [KeyUsage] must be \
   [GENERATE_VERIFY_MAC]. For deriving key agreement secrets, the [KeyUsage] must be \
...
type nonrec invalid_grant_token_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc "The request was rejected because the specified grant token is not valid.\n"]

type nonrec dry_run_operation_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc " The request was rejected because the DryRun parameter was specified. \n"]

type nonrec disabled_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc "The request was rejected because the specified KMS key is not enabled.\n"]
...
type nonrec dependency_timeout_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  ...
  primary_region : region_type;
      [@ocaml.doc
        "The Amazon Web Services Region of the new primary key. Enter the Region ID, such as \
         [us-east-1] or [ap-southeast-2]. There must be an existing replica key in this Region. \n\n\
...
type nonrec invalid_arn_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
...
type nonrec update_custom_key_store_request = {
  xks_proxy_connectivity : xks_proxy_connectivity_type option;
      [@ocaml.doc
        "Changes the connectivity setting for the external key store. To indicate that the \
         ...
         specify [VPC_ENDPOINT_SERVICE]. Otherwise, specify [PUBLIC_ENDPOINT].\n\n\
        \ If you change the [XksProxyConnectivity] to [VPC_ENDPOINT_SERVICE], you must also change \
         the [XksProxyUriEndpoint] and add an [XksProxyVpcEndpointServiceName] value. \n\
        \ \n\
  ...
  xks_proxy_authentication_credential : xks_proxy_authentication_credential_type option;
      [@ocaml.doc
        ...
        \  This parameter doesn't establish or change your authentication credentials on the \
         proxy. It just tells KMS the credential that you established with your external key store \
         proxy. For example, if you rotate the credential on your external key store proxy, you \
         can use this parameter to update the credential in KMS.\n\
        \  \n\
  ...
  xks_proxy_vpc_endpoint_service_name : xks_proxy_vpc_endpoint_service_name_type option;
      [@ocaml.doc
        "Changes the name that KMS uses to identify the Amazon VPC endpoint service for your \
         external key store proxy (XKS proxy). This parameter is valid when the \
  ...
  xks_proxy_uri_path : xks_proxy_uri_path_type option;
      [@ocaml.doc
        "Changes the base path to the proxy APIs for this external key store. To find this value, \
         ...
         [EXTERNAL_KEY_STORE].\n\n\
        \ The value must start with [/] and must end with [/kms/xks/v1], where [v1] represents the \
         version of the KMS external key store proxy API. You can include an optional prefix \
  ...
  xks_proxy_uri_endpoint : xks_proxy_uri_endpoint_type option;
      [@ocaml.doc
        ...
        \  For external key stores with an [XksProxyConnectivity] value of [VPC_ENDPOINT_SERVICE], \
         specify [https://] followed by the private DNS name associated with the VPC endpoint \
  ...
  cloud_hsm_cluster_id : cloud_hsm_cluster_id_type option;
      [@ocaml.doc
        "Associates the custom key store with a related CloudHSM cluster. This parameter is valid \
        ...
        \ Enter the cluster ID of the cluster that you used to create the custom key store or a \
         ...
         cluster. In addition, the replacement cluster must \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/create-keystore.html#before-keystore}fulfill \
         the requirements} for a cluster associated with a custom key store. To view the cluster \
  ...
  key_store_password : key_store_password_type option;
      [@ocaml.doc
        "Enter the current password of the [kmsuser] crypto user (CU) in the CloudHSM cluster that \
         is associated with the custom key store. This parameter is valid only for custom key \
         stores with a [CustomKeyStoreType] of [AWS_CLOUDHSM].\n\n\
        \ This parameter tells KMS the current password of the [kmsuser] crypto user (CU). It does \
...
[@@ocaml.doc
  "The request was rejected because KMS cannot find a custom key store with the specified key \
   store name or ID.\n"]
...
[@@ocaml.doc
  ...
  \        {-  You requested the [CreateKey] operation in a custom key store that is not \
   connected. This operations is valid only when the custom key store [ConnectionState] is \
   [CONNECTED].\n\
  \            \n\
  \             }\n\
  \        {-  You requested the [DisconnectCustomKeyStore] operation on a custom key store with a \
   [ConnectionState] of [DISCONNECTING] or [DISCONNECTED]. This operation is valid for all other \
  ...
  \        {-  You requested the [GenerateRandom] operation in an CloudHSM key store that is not \
   connected. This operation is valid only when the CloudHSM key store [ConnectionState] is \
   [CONNECTED]. \n\
  \            \n\
  \             }\n\
  \        }\n\
...
[@@ocaml.doc
  ...
  \            }\n\
  \       {-  The \
   {{:https://docs.aws.amazon.com/cloudhsm/latest/userguide/configure-sg.html}security group for \
   the cluster} (cloudhsm-cluster-{i }-sg) must include inbound rules and outbound rules that \
   allow TCP traffic on ports 2223-2225. The {b Source} in the inbound rules and the {b \
   Destination} in the outbound rules must match the security group ID. These rules are set by \
   default when you create the CloudHSM cluster. Do not delete or change them. To get information \
   about a particular security group, use the \
  ...
  \            For the [CreateCustomKeyStore], [UpdateCustomKeyStore], and [CreateKey] operations, \
   the CloudHSM cluster must have at least two active HSMs, each in a different Availability Zone. \
   For the [ConnectCustomKeyStore] operation, the CloudHSM must contain at least one active HSM.\n\
  \            \n\
  \             }\n\
  \       }\n\
  \   For information about the requirements for an CloudHSM cluster that is associated with an \
   CloudHSM key store, see \
   {{:https://docs.aws.amazon.com/kms/latest/developerguide/create-keystore.html#before-keystore}Assemble \
   the Prerequisites} in the {i Key Management Service Developer Guide}. For information about \
   creating a private subnet for an CloudHSM cluster, see \
   {{:https://docs.aws.amazon.com/cloudhsm/latest/userguide/create-subnets.html}Create a Private \
   Subnet} in the {i CloudHSM User Guide}. For information about cluster security groups, see \
   {{:https://docs.aws.amazon.com/cloudhsm/latest/userguide/configure-sg.html}Configure a Default \
   Security Group} in the {i  {i CloudHSM User Guide} }. \n\
  \   "]
...
type nonrec limit_exceeded_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  "The request was rejected because a length constraint or quota was exceeded. For more \
   information, see {{:https://docs.aws.amazon.com/kms/latest/developerguide/limits.html}Quotas} \
...
type nonrec tag_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc "The request was rejected because one or more tags are not valid.\n"]
...
[@@ocaml.doc
  ...
  \    For information about the rules that apply to tag keys and tag values, see \
   ...
   Tag Restrictions} in the {i Amazon Web Services Billing and Cost Management User Guide}.\n\
  \    "]
  ...
  tags : tag_list;
      [@ocaml.doc
        ...
        \    You cannot have more than one tag on a KMS key with the same tag key. If you specify \
         an existing tag key with a different tag value, KMS replaces the current tag value with \
         the specified one.\n\
        \    "]
  key_id : key_id_type;
      [@ocaml.doc
...
type nonrec sign_response = {
  ...
  signature : ciphertext_type option;
      [@ocaml.doc
        ...
        \       {-  When used with the supported RSA signing algorithms, the encoding of this \
         value is defined by {{:https://tools.ietf.org/html/rfc8017}PKCS #1 in RFC 8017}.\n\
        \           \n\
        \            }\n\
        \       {-  When used with the [ECDSA_SHA_256], [ECDSA_SHA_384], or [ECDSA_SHA_512] \
         signing algorithms, this value is a DER-encoded object as defined by ANSI \
         X9.62\226\128\1472005 and {{:https://tools.ietf.org/html/rfc3279#section-2.2.3}RFC 3279 \
         Section 2.2.3}. This is the most commonly used signature format and is appropriate for \
         most uses. \n\
        \           \n\
        \            }\n\
        \       }\n\
  ...
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the asymmetric KMS key that was used to sign the message.\n"]
}
[@@ocaml.doc ""]
  ...
  signing_algorithm : signing_algorithm_spec;
      [@ocaml.doc
        ...
        \ Choose an algorithm that is compatible with the type and size of the specified \
         asymmetric KMS key. When signing with RSA key pairs, RSASSA-PSS algorithms are preferred. \
         We include RSASSA-PKCS1-v1_5 algorithms for compatibility with existing applications.\n\
        \ "]
  grant_tokens : grant_token_list option;
      [@ocaml.doc
        "A list of grant tokens.\n\n\
  ...
  key_id : key_id_type;
      [@ocaml.doc
        "Identifies an asymmetric KMS key. KMS uses the private key in the asymmetric KMS key to \
         sign the message. The [KeyUsage] type of the KMS key must be [SIGN_VERIFY]. To find the \
...
type nonrec schedule_key_deletion_response = {
  ...
  key_state : key_state option;
      [@ocaml.doc
        ...
        \ For more information about how key state affects the use of a KMS key, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html}Key states of KMS \
  ...
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the KMS key whose deletion is scheduled.\n"]
}
[@@ocaml.doc ""]
  ...
  pending_window_in_days : pending_window_in_days_type option;
      [@ocaml.doc
        ...
        \ If the KMS key is a multi-Region primary key with replica keys, the waiting period \
         begins when the last of its replica keys is deleted. Otherwise, the waiting period begins \
         immediately.\n\
        \ \n\
...
type nonrec conflict_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  ...
  key_id : key_id_type;
      [@ocaml.doc
        "Identifies a symmetric encryption KMS key. You cannot perform on-demand rotation of \
         ...
         KMS keys}, {{:https://docs.aws.amazon.com/kms/latest/developerguide/hmac.html}HMAC KMS \
         keys}, multi-Region KMS keys with \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys.html}imported key \
         material}, or KMS keys in a \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-store-overview.html}custom \
         key store}. To perform on-demand rotation of a set of related \
...
type nonrec invalid_grant_id_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc "The request was rejected because the specified [GrantId] is not valid.\n"]
  ...
  grant_token : grant_token_type option;
      [@ocaml.doc
        ...
        \ Only the [CreateGrant] operation returns a grant token. For details, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#grant_token}Grant \
         token} and \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#terms-eventual-consistency}Eventual \
         consistency} in the {i Key Management Service Developer Guide}.\n\
        \ "]
}
[@@ocaml.doc ""]
...
type nonrec already_exists_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
...
type nonrec key_manager_type = CUSTOMER [@ocaml.doc ""] | AWS [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec encryption_algorithm_spec_list = encryption_algorithm_spec list [@@ocaml.doc ""]

type nonrec signing_algorithm_spec_list = signing_algorithm_spec list [@@ocaml.doc ""]

type nonrec key_agreement_algorithm_spec = ECDH [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec key_agreement_algorithm_spec_list = key_agreement_algorithm_spec list [@@ocaml.doc ""]

type nonrec multi_region_key_type = REPLICA [@ocaml.doc ""] | PRIMARY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec multi_region_key = {
  ...
  arn : arn_type option;
      [@ocaml.doc "Displays the key ARN of a primary or replica key of a multi-Region key.\n"]
}
...
type nonrec multi_region_configuration = {
  ...
  multi_region_key_type : multi_region_key_type option;
      [@ocaml.doc "Indicates whether the KMS key is a [PRIMARY] or [REPLICA] key.\n"]
}
[@@ocaml.doc
...
type nonrec key_metadata = {
  ...
  pending_deletion_window_in_days : pending_window_in_days_type option;
      [@ocaml.doc
        "The waiting period before the primary key in a multi-Region key is deleted. This waiting \
         period begins when the last of its replica keys is deleted. This value is present only \
         when the [KeyState] of the KMS key is [PendingReplicaDeletion]. That indicates that the \
         KMS key is the primary key in a multi-Region key, it is scheduled for deletion, and it \
         still has existing replica keys.\n\n\
        \ When a single-Region KMS key or a multi-Region replica key is scheduled for deletion, \
         its deletion date is displayed in the [DeletionDate] field. However, when the primary key \
         in a multi-Region key is scheduled for deletion, its waiting period doesn't begin until \
         all of its replica keys are deleted. This value displays that waiting period. When the \
         last replica key in the multi-Region key is deleted, the [KeyState] of the scheduled \
         primary key changes from [PendingReplicaDeletion] to [PendingDeletion] and the deletion \
         date appears in the [DeletionDate] field.\n\
        \ "]
  ...
  multi_region : nullable_boolean_type option;
      [@ocaml.doc
        "Indicates whether the KMS key is a multi-Region ([True]) or regional ([False]) key. This \
         value is [True] for multi-Region primary and replica keys and [False] for regional KMS \
         keys.\n\n\
  ...
  key_agreement_algorithms : key_agreement_algorithm_spec_list option;
      [@ocaml.doc "The key agreement algorithm used to derive a shared secret.\n"]
  ...
  encryption_algorithms : encryption_algorithm_spec_list option;
      [@ocaml.doc
        ...
        \ "]
  key_spec : key_spec option; [@ocaml.doc "Describes the type of key material in the KMS key.\n"]
  customer_master_key_spec : customer_master_key_spec option;
      [@ocaml.doc
        ...
        \ The [KeySpec] and [CustomerMasterKeySpec] fields have the same value. We recommend that \
         you use the [KeySpec] field in your code. However, to avoid breaking changes, KMS \
  ...
  cloud_hsm_cluster_id : cloud_hsm_cluster_id_type option;
      [@ocaml.doc
        "The cluster ID of the CloudHSM cluster that contains the key material for the KMS key. \
         ...
         cluster. This field is present only when the KMS key is created in an CloudHSM key store.\n"]
  custom_key_store_id : custom_key_store_id_type option;
      [@ocaml.doc
        "A unique identifier for the \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-store-overview.html}custom \
         key store} that contains the KMS key. This field is present only when the KMS key is \
         created in a custom key store.\n"]
  origin : origin_type option;
      [@ocaml.doc
        "The source of the key material for the KMS key. When this value is [AWS_KMS], KMS created \
         the key material. When this value is [EXTERNAL], the key material was imported or the KMS \
         key doesn't have any key material. When this value is [AWS_CLOUDHSM], the key material \
  ...
  valid_to : date_type option;
      [@ocaml.doc
        "The earliest time at which any imported key material permanently associated with this KMS \
         ...
         becomes unusable. This value is present only for KMS keys whose [Origin] is [EXTERNAL] \
         and the [ExpirationModel] is [KEY_MATERIAL_EXPIRES], otherwise this value is omitted.\n"]
  deletion_date : date_type option;
      [@ocaml.doc
  ...
  description : description_type option; [@ocaml.doc "The description of the KMS key.\n"]
  enabled : boolean_type option;
      [@ocaml.doc
        "Specifies whether the KMS key is enabled. When [KeyState] is [Enabled] this value is \
         true, otherwise it is false.\n"]
  creation_date : date_type option; [@ocaml.doc "The date and time when the KMS key was created.\n"]
  arn : arn_type option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the KMS key. For examples, see \
         {{:https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kms}Key \
         Management Service (KMS)} in the Example ARNs section of the {i Amazon Web Services \
         General Reference}.\n"]
  key_id : key_id_type; [@ocaml.doc "The globally unique identifier for the KMS key.\n"]
  ...
  replica_key_metadata : key_metadata option;
      [@ocaml.doc
        "Displays details about the new replica key, including its Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) and {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html}Key \
         states of KMS keys}. It also includes the ARN and Amazon Web Services Region of its \
...
type nonrec replicate_key_request = {
  tags : tag_list option;
      [@ocaml.doc
        "Assigns one or more tags to the replica key. Use this parameter to tag the KMS key when \
        ...
        \     Tagging or untagging a KMS key can allow or deny permission to the KMS key. For \
         details, see {{:https://docs.aws.amazon.com/kms/latest/developerguide/abac.html}ABAC for \
        ...
        \        Tags are not a shared property of multi-Region keys. You can specify the same \
         tags or different tags for each key in a set of related multi-Region keys. KMS does not \
         synchronize this property.\n\
        \        \n\
        \         Each tag consists of a tag key and a tag value. Both the tag key and the tag \
         value are required, but the tag value can be an empty (null) string. You cannot have more \
         than one tag on a KMS key with the same tag key. If you specify an existing tag key with \
        ...
        \          When you add tags to an Amazon Web Services resource, Amazon Web Services \
         ...
         be used to control access to a KMS key. For details, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/tagging-keys.html}Tags in KMS}.\n\
        \          "]
  ...
  bypass_policy_lockout_safety_check : boolean_type option;
      [@ocaml.doc
        ...
        \  \n\
        \   For more information, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-default.html#prevent-unmanageable-key}Default \
         key policy} in the {i Key Management Service Developer Guide}.\n\
        \   \n\
  ...
  policy : policy_type option;
      [@ocaml.doc
        "The key policy to attach to the KMS key. This parameter is optional. If you do not \
         provide a key policy, KMS attaches the \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-default.html}default \
         key policy} to the KMS key.\n\n\
        \ The key policy is not a shared property of multi-Region keys. You can specify the same \
         key policy or a different key policy for each key in a set of related multi-Region keys. \
        ...
        \         {-  The key policy must allow the calling principal to make a subsequent \
         ...
         unmanageable. For more information, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-default.html#prevent-unmanageable-key}Default \
         key policy} in the {i Key Management Service Developer Guide}. (To omit this condition, \
         set [BypassPolicyLockoutSafetyCheck] to true.)\n\
        \             \n\
        \              }\n\
        \         {-  Each statement in the key policy must contain one or more principals. The \
         principals in the key policy must exist and be visible to KMS. When you create a new \
         Amazon Web Services principal, you might need to enforce a delay before including the new \
         principal in a key policy because the new principal might not be immediately visible to \
         KMS. For more information, see \
         {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/troubleshoot_general.html#troubleshoot_general_eventual-consistency}Changes \
         that I make are not always immediately visible} in the {i Amazon Web Services Identity \
        ...
        \   For information about key policies, see \
         ...
         in KMS} in the {i Key Management Service Developer Guide}. For help writing and \
         formatting a JSON policy document, see the \
         {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies.html}IAM JSON \
         Policy Reference} in the {i  {i Identity and Access Management User Guide} }.\n\
        \   "]
  replica_region : region_type;
      [@ocaml.doc
        "The Region ID of the Amazon Web Services Region for this replica key. \n\n\
        \ Enter the Region ID, such as [us-east-1] or [ap-southeast-2]. For a list of Amazon Web \
         Services Regions in which KMS is supported, see \
         {{:https://docs.aws.amazon.com/general/latest/gr/kms.html#kms_region}KMS service \
        ...
        \  The replica must be in a different Amazon Web Services Region than its primary key and \
         other replicas of that primary key, but in the same Amazon Web Services partition. KMS \
         must be available in the replica Region. If the Region is not enabled by default, the \
         Amazon Web Services account must be enabled in the Region. For information about Amazon \
         Web Services partitions, see \
         {{:https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html}Amazon \
         Resource Names (ARNs)} in the {i Amazon Web Services General Reference}. For information \
         about enabling and disabling Regions, see \
         {{:https://docs.aws.amazon.com/general/latest/gr/rande-manage.html#rande-manage-enable}Enabling \
         a Region} and \
         {{:https://docs.aws.amazon.com/general/latest/gr/rande-manage.html#rande-manage-disable}Disabling \
         a Region} in the {i Amazon Web Services General Reference}.\n\
        \  "]
  key_id : key_id_type;
      [@ocaml.doc
        "Identifies the multi-Region primary key that is being replicated. To determine whether a \
         KMS key is a multi-Region primary key, use the [DescribeKey] operation to check the value \
         of the [MultiRegionKeyType] property.\n\n\
        \ Specify the key ID or key ARN of a multi-Region primary key.\n\
        \ \n\
        \  For example:\n\
        \  \n\
...
type nonrec invalid_ciphertext_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  ...
  \ From the [ImportKeyMaterial] operation, the request was rejected because KMS could not decrypt \
   the encrypted (wrapped) key material. \n\
  \ "]

type nonrec incorrect_key_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
...
type nonrec re_encrypt_response = {
  ...
  destination_encryption_algorithm : encryption_algorithm_spec option;
      [@ocaml.doc "The encryption algorithm that was used to reencrypt the data.\n"]
  ...
  source_key_id : key_id_type option;
      [@ocaml.doc "Unique identifier of the KMS key used to originally encrypt the data.\n"]
  ciphertext_blob : ciphertext_type option;
      [@ocaml.doc
        "The reencrypted data. When you use the HTTP API or the Amazon Web Services CLI, the value \
...
type nonrec re_encrypt_request = {
  ...
  destination_encryption_context : encryption_context_type option;
      [@ocaml.doc
        ...
        \  Do not include confidential or sensitive information in this field. This field may be \
         displayed in plaintext in CloudTrail logs and other output.\n\
        \  \n\
        \    A destination encryption context is valid only when the destination KMS key is a \
         symmetric encryption KMS key. The standard ciphertext format for asymmetric KMS keys does \
         not include fields for metadata.\n\
        \    \n\
        \     An {i encryption context} is a collection of non-secret key-value pairs that \
  ...
  source_encryption_context : encryption_context_type option;
      [@ocaml.doc
        ...
        \ An {i encryption context} is a collection of non-secret key-value pairs that represent \
         ...
         data. An encryption context is supported only on operations with symmetric encryption KMS \
  ...
  policy : policy_type;
      [@ocaml.doc
        ...
        \    If either of the required [Resource] or [Action] elements are missing from a key \
         policy statement, the policy statement has no effect. When a key policy statement is \
         missing one of these elements, the KMS console correctly reports an error, but the \
         [PutKeyPolicy] API request succeeds, even though the policy statement is ineffective.\n\
        \    \n\
        \     For more information on required key policy elements, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-overview.html#key-policy-elements}Elements \
         in a key policy} in the {i Key Management Service Developer Guide}.\n\
        \     \n\
        \       A key policy document can include only the following characters:\n\
        \       \n\
        \        {ul\n\
        ...
        \      For information about key policies, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html}Key policies \
         in KMS} in the {i Key Management Service Developer Guide}.For help writing and formatting \
         a JSON policy document, see the \
         {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies.html}IAM JSON \
         Policy Reference} in the {i  {i Identity and Access Management User Guide} }.\n\
        \      "]
...
type nonrec invalid_marker_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
  "The request was rejected because the marker that specifies where pagination should next begin \
   is not valid.\n"]
...
type nonrec grant_list_entry = {
  ...
  issuing_account : principal_id_type option;
      [@ocaml.doc "The Amazon Web Services account under which the grant was issued.\n"]
  ...
  grant_id : grant_id_type option; [@ocaml.doc "The unique identifier for the grant.\n"]
  key_id : key_id_type option;
      [@ocaml.doc "The unique identifier for the KMS key to which the grant applies.\n"]
}
  ...
  limit : limit_type option;
      [@ocaml.doc
        "Use this parameter to specify the maximum number of items to return. When this value is \
         present, KMS does not return more than the specified number of items, but it might return \
         fewer.\n\n\
...
type nonrec import_state = PENDING_IMPORT [@ocaml.doc ""] | IMPORTED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec rotation_type = ON_DEMAND [@ocaml.doc ""] | AUTOMATIC [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  rotation_type : rotation_type option;
      [@ocaml.doc
        "Identifies whether the key material rotation was a scheduled \
         ...
         rotation} or an \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/rotating-keys-on-demand.html}on-demand \
  ...
  expiration_model : expiration_model_type option;
      [@ocaml.doc
        "Indicates if the key material is configured to automatically expire. There are two \
         ...
         [KEY_MATERIAL_DOES_NOT_EXPIRE]. For any key material that expires, the expiration date \
         and time is indicated in [ValidTo]. This field is only present for symmetric encryption \
  ...
  import_state : import_state option;
      [@ocaml.doc
        "Indicates if the key material is currently imported into KMS. It has two possible values: \
         [IMPORTED] or [PENDING_IMPORT]. This field is only present for symmetric encryption KMS \
         keys with [EXTERNAL] origin.\n"]
  ...
  rotations : rotations_list option;
      [@ocaml.doc
        "A list of completed key material rotations. When the optional input parameter \
         [IncludeKeyMaterial] is specified with a value of [ALL_KEY_MATERIAL], this list includes \
         the first key material and any imported key material pending rotation.\n"]
}
[@@ocaml.doc ""]

type nonrec include_key_material =
  | ROTATIONS_ONLY [@ocaml.doc ""]
  | ALL_KEY_MATERIAL [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  include_key_material : include_key_material option;
      [@ocaml.doc
        "Use this optional parameter to control which key materials associated with this key are \
         listed in the response. The default value of this parameter is [ROTATIONS_ONLY]. If you \
         omit this parameter, KMS returns information on the key materials created by automatic or \
         on-demand key rotation. When you specify a value of [ALL_KEY_MATERIAL], KMS adds the \
         first key material and any imported key material pending rotation to the response. This \
...
type nonrec list_key_policies_response = {
  ...
  policy_names : policy_name_list option;
      [@ocaml.doc "A list of key policy names. The only valid value is [default].\n"]
}
[@@ocaml.doc ""]
...
type nonrec alias_list_entry = {
  ...
  alias_arn : arn_type option; [@ocaml.doc "String that contains the key ARN.\n"]
  alias_name : alias_name_type option;
      [@ocaml.doc "String that contains the alias. This value begins with [alias/].\n"]
}
...
type nonrec list_aliases_request = {
  ...
  key_id : key_id_type option;
      [@ocaml.doc
        "Lists only aliases that are associated with the specified KMS key. Enter a KMS key in \
...
type nonrec invalid_import_token_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
...
[@@ocaml.doc
  "The request was rejected because the key material in the request is, expired, invalid, or does \
   not meet expectations. For example, it is not the same key material that was previously \
   imported or KMS expected new key material but the key material being imported is already \
   associated with the KMS key.\n"]

type nonrec expired_import_token_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc
...
type nonrec import_key_material_response = {
  ...
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the KMS key into which key material was imported.\n"]
}
[@@ocaml.doc ""]

type nonrec import_type = EXISTING_KEY_MATERIAL [@ocaml.doc ""] | NEW_KEY_MATERIAL [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  key_material_id : backing_key_id_type option;
      [@ocaml.doc
        "Identifies the key material being imported. This parameter is optional and only usable \
         with symmetric encryption keys. You cannot specify a key material ID with [ImportType] \
         set to [NEW_KEY_MATERIAL]. Whenever you import key material into a symmetric encryption \
         key, KMS assigns a unique identifier to the key material based on the KMS key ID and the \
         imported key material. When you re-import key material with a specified key material ID, \
         KMS:\n\n\
        \ {ul\n\
  ...
  expiration_model : expiration_model_type option;
      [@ocaml.doc
        "Specifies whether the key material expires. The default is [KEY_MATERIAL_EXPIRES]. For \
         help with this choice, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys-import-key-material.html#importing-keys-expiration}Setting \
         an expiration time} in the {i Key Management Service Developer Guide}.\n\n\
  ...
  valid_to : date_type option;
      [@ocaml.doc
        "The date and time when the imported key material expires. This parameter is required when \
         the value of the [ExpirationModel] parameter is [KEY_MATERIAL_EXPIRES]. Otherwise it is \
         not valid.\n\n\
        ...
        \  When the key material expires, KMS deletes the key material from the KMS key. Without \
         its key material, the KMS key is unusable. To use the KMS key in cryptographic \
         operations, you must reimport the same key material.\n\
        \  \n\
        \   You cannot change the [ExpirationModel] or [ValidTo] values for the current import \
         after the request completes. To change either value, you must delete \
  ...
  encrypted_key_material : ciphertext_type;
      [@ocaml.doc
        "The encrypted key material to import. The key material must be encrypted under the public \
         wrapping key that [GetParametersForImport] returned, using the wrapping algorithm that \
         you specified in the same [GetParametersForImport] request.\n"]
  ...
  key_id : key_id_type;
      [@ocaml.doc
        "The identifier of the KMS key that will be associated with the imported key material. \
         This must be the same KMS key specified in the [KeyID] parameter of the corresponding \
        ...
        \ The KMS key can be a symmetric encryption KMS key, HMAC KMS key, asymmetric encryption \
         KMS key, or asymmetric signing KMS key, including a \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-overview.html}multi-Region \
         key} of any supported type. You cannot perform this operation on a KMS key in a custom \
         key store, or on a KMS key in a different Amazon Web Services account.\n\
        \ \n\
        \  Specify the key ID or key ARN of the KMS key.\n\
        \  \n\
        \   For example:\n\
...
type nonrec get_public_key_response = {
  ...
  public_key : public_key_type option;
      [@ocaml.doc
        ...
        \ The value is a DER-encoded X.509 public key, also known as [SubjectPublicKeyInfo] \
         (SPKI), as defined in {{:https://tools.ietf.org/html/rfc5280}RFC 5280}. When you use the \
         HTTP API or the Amazon Web Services CLI, the value is Base64-encoded. Otherwise, it is \
         not Base64-encoded.\n\
        \ \n\
        \  \n\
        \  "]
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the asymmetric KMS key from which the public key was downloaded.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_parameters_for_import_response = {
  ...
  import_token : ciphertext_type option;
      [@ocaml.doc "The import token to send in a subsequent [ImportKeyMaterial] request.\n"]
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the KMS key to use in a subsequent [ImportKeyMaterial] request. This is the same \
         KMS key specified in the [GetParametersForImport] request.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_parameters_for_import_request = {
  ...
  wrapping_algorithm : algorithm_spec;
      [@ocaml.doc
        "The algorithm you will use with the RSA public key ([PublicKey]) in the response to \
         protect your key material during import. For more information, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys-get-public-key-and-token.html#select-wrapping-algorithm}Select \
         a wrapping algorithm} in the {i Key Management Service Developer Guide}.\n\n\
        ...
        \  \n\
        \   {ul\n\
        \         {-   {b RSA_AES_KEY_WRAP_SHA_256} \226\128\148 Supported for wrapping RSA and \
         ECC key material.\n\
        \             \n\
        \              }\n\
        \         {-   {b RSA_AES_KEY_WRAP_SHA_1} \226\128\148 Supported for wrapping RSA and ECC \
         key material.\n\
        \             \n\
        \              }\n\
        \         {-   {b RSAES_OAEP_SHA_256} \226\128\148 Supported for all types of key \
        ...
        \              \n\
        \               }\n\
        \         {-   {b RSAES_OAEP_SHA_1} \226\128\148 Supported for all types of key material, \
        ...
        \              \n\
        \               }\n\
        \         {-   {b RSAES_PKCS1_V1_5} (Deprecated) \226\128\148 As of October 10, 2023, KMS \
...
type nonrec get_key_rotation_status_response = {
  on_demand_rotation_start_date : date_type option;
      [@ocaml.doc
        ...
        \ KMS uses a background process to perform rotations. As a result, there might be a slight \
         ...
         on-demand rotation is complete, KMS removes this field from the response. You can use \
         [ListKeyRotations] to view the details of the completed on-demand rotation.\n\
        \ "]
  next_rotation_date : date_type option;
      [@ocaml.doc "The next date that KMS will automatically rotate the key material.\n"]
  ...
  key_rotation_enabled : boolean_type option;
      [@ocaml.doc "A Boolean value that specifies whether key rotation is enabled.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_key_policy_response = {
  policy_name : policy_name_type option;
      [@ocaml.doc "The name of the key policy. The only valid value is [default].\n"]
  policy : policy_type option; [@ocaml.doc "A key policy document in JSON format.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_key_policy_request = {
  policy_name : policy_name_type option;
      [@ocaml.doc
        "Specifies the name of the key policy. If no policy name is specified, the default value \
         is [default]. The only valid name is [default]. To get the names of key policies, use \
         [ListKeyPolicies].\n"]
  key_id : key_id_type;
      [@ocaml.doc
...
type nonrec generate_random_response = {
  ...
  plaintext : plaintext_type option;
      [@ocaml.doc
        "The random byte string. When you use the HTTP API or the Amazon Web Services CLI, the \
...
type nonrec key_encryption_mechanism = RSAES_OAEP_SHA_256 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec generate_random_request = {
  ...
  number_of_bytes : number_of_bytes_type option;
      [@ocaml.doc "The length of the random byte string. This parameter is required.\n"]
}
[@@ocaml.doc ""]

type nonrec generate_mac_response = {
  key_id : key_id_type option; [@ocaml.doc "The HMAC KMS key used in the operation.\n"]
  mac_algorithm : mac_algorithm_spec option;
...
type nonrec generate_mac_request = {
  ...
  mac_algorithm : mac_algorithm_spec;
      [@ocaml.doc
        ...
        \  The algorithm must be compatible with the HMAC KMS key that you specify. To find the \
         MAC algorithms that your HMAC KMS key supports, use the [DescribeKey] operation and see \
         the [MacAlgorithms] field in the [DescribeKey] response.\n\
        \ "]
  key_id : key_id_type;
      [@ocaml.doc
        "The HMAC KMS key to use in the operation. The MAC algorithm computes the HMAC for the \
         message and the key as described in {{:https://datatracker.ietf.org/doc/html/rfc2104}RFC \
         2104}.\n\n\
  ...
  message : plaintext_type;
      [@ocaml.doc
        ...
        \  [GenerateMac] and [VerifyMac] do not provide special handling for message digests. If \
         you generate an HMAC for a hash digest of a message, you must verify the HMAC of the same \
         hash digest.\n\
        \ "]
}
[@@ocaml.doc ""]
...
type nonrec generate_data_key_without_plaintext_response = {
  key_material_id : backing_key_id_type option;
      [@ocaml.doc "The identifier of the key material used to encrypt the data key.\n"]
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the KMS key that encrypted the data key.\n"]
  ciphertext_blob : ciphertext_type option;
      [@ocaml.doc
        "The encrypted data key. When you use the HTTP API or the Amazon Web Services CLI, the \
         value is Base64-encoded. Otherwise, it is not Base64-encoded.\n"]
}
[@@ocaml.doc ""]

type nonrec data_key_spec = AES_128 [@ocaml.doc ""] | AES_256 [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  key_id : key_id_type;
      [@ocaml.doc
        "Specifies the symmetric encryption KMS key that encrypts the data key. You cannot specify \
         an asymmetric KMS key or a KMS key in a custom key store. To get the type and origin of \
...
type nonrec generate_data_key_pair_without_plaintext_response = {
  ...
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the KMS key that encrypted the private key.\n"]
  public_key : public_key_type option;
      [@ocaml.doc
        "The public key (in plaintext). When you use the HTTP API or the Amazon Web Services CLI, \
...
type nonrec generate_data_key_pair_without_plaintext_request = {
  ...
  key_pair_spec : data_key_pair_spec;
      [@ocaml.doc
        ...
        \ The KMS rule that restricts the use of asymmetric RSA and SM2 KMS keys to encrypt and \
         decrypt or to sign and verify (but not both), the rule that permits you to use ECC KMS \
         keys only to sign and verify, and the rule that permits you to use ML-DSA key pairs to \
         sign and verify only are not effective on data key pairs, which are used outside of KMS. \
  ...
  key_id : key_id_type;
      [@ocaml.doc
        "Specifies the symmetric encryption KMS key that encrypts the private key in the data key \
         pair. You cannot specify an asymmetric KMS key or a KMS key in a custom key store. To get \
         the type and origin of your KMS key, use the [DescribeKey] operation. \n\n\
        \ To specify a KMS key, use its key ID, key ARN, alias name, or alias ARN. When using an \
         alias name, prefix it with [\"alias/\"]. To specify a KMS key in a different Amazon Web \
         Services account, you must use the key ARN or alias ARN.\n\
        \ \n\
...
type nonrec generate_data_key_response = {
  ...
  plaintext : plaintext_type option;
      [@ocaml.doc
        "The plaintext data key. When you use the HTTP API or the Amazon Web Services CLI, the \
         value is Base64-encoded. Otherwise, it is not Base64-encoded. Use this data key to \
         encrypt your data outside of KMS. Then, remove it from memory as soon as possible.\n\n\
        \ If the response includes the [CiphertextForRecipient] field, the [Plaintext] field is \
         null or empty.\n\
        \ "]
  ciphertext_blob : ciphertext_type option;
  ...
  recipient : recipient_info option;
      [@ocaml.doc
        ...
        \  When you use this parameter, instead of returning the plaintext data key, KMS encrypts \
         ...
         [CiphertextBlob] field in the response contains a copy of the data key encrypted under \
         the KMS key specified by the [KeyId] parameter. The [Plaintext] field in the response is \
         null or empty.\n\
        \  \n\
        \   For information about the interaction between KMS and Amazon Web Services Nitro \
         Enclaves, see \
...
type nonrec encrypt_response = {
  encryption_algorithm : encryption_algorithm_spec option;
      [@ocaml.doc "The encryption algorithm that was used to encrypt the plaintext.\n"]
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the KMS key that was used to encrypt the plaintext.\n"]
  ciphertext_blob : ciphertext_type option;
      [@ocaml.doc
        "The encrypted plaintext. When you use the HTTP API or the Amazon Web Services CLI, the \
         value is Base64-encoded. Otherwise, it is not Base64-encoded.\n"]
}
[@@ocaml.doc ""]
  ...
  key_id : key_id_type;
      [@ocaml.doc
        "Identifies the KMS key to use in the encryption operation. The KMS key must have a \
         [KeyUsage] of [ENCRYPT_DECRYPT]. To find the [KeyUsage] of a KMS key, use the \
         [DescribeKey] operation.\n\n\
        \ To specify a KMS key, use its key ID, key ARN, alias name, or alias ARN. When using an \
         alias name, prefix it with [\"alias/\"]. To specify a KMS key in a different Amazon Web \
         Services account, you must use the key ARN or alias ARN.\n\
  ...
  rotation_period_in_days : rotation_period_in_days_type option;
      [@ocaml.doc
        ...
        \  You can use the \
         ...
         [kms:RotationPeriodInDays] } condition key to further constrain the values that \
  ...
  key_id : key_id_type;
      [@ocaml.doc
        "Identifies a symmetric encryption KMS key. You cannot enable automatic rotation of \
         ...
         material}, or KMS keys in a \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-store-overview.html}custom \
         key store}. To enable or disable automatic rotation of a set of related \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/rotate-keys.html#multi-region-rotate}multi-Region \
  ...
  key_id : key_id_type;
      [@ocaml.doc
        "Identifies a symmetric encryption KMS key. You cannot enable or disable automatic \
         rotation of \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/symmetric-asymmetric.html#asymmetric-cmks}asymmetric \
         KMS keys}, {{:https://docs.aws.amazon.com/kms/latest/developerguide/hmac.html}HMAC KMS \
         keys}, KMS keys with \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys.html}imported key \
         material}, or KMS keys in a \
...
type nonrec describe_key_response = {
  key_metadata : key_metadata option; [@ocaml.doc "Metadata associated with the key.\n"]
}
[@@ocaml.doc ""]
...
type nonrec custom_key_stores_list_entry = {
  xks_proxy_configuration : xks_proxy_configuration_type option;
      [@ocaml.doc
        "Configuration settings for the external key store proxy (XKS proxy). The external key \
         ...
         understand. The proxy configuration includes connection information that KMS requires.\n\n\
  ...
  custom_key_store_type : custom_key_store_type option;
      [@ocaml.doc
        "Indicates the type of the custom key store. [AWS_CLOUDHSM] indicates a custom key store \
         backed by an CloudHSM cluster. [EXTERNAL_KEY_STORE] indicates a custom key store backed \
         by an external key store proxy and external key manager outside of Amazon Web Services.\n"]
  creation_date : date_type option;
  ...
  connection_error_code : connection_error_code_type option;
      [@ocaml.doc
        ...
        \ Many failures can be resolved by updating the properties of the custom key store. To \
         ...
         ([UpdateCustomKeyStore]), and try to connect again ([ConnectCustomKeyStore]). For \
         additional help resolving these errors, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html#fix-keystore-failed}How \
         to Fix a Connection Failure} in {i Key Management Service Developer Guide}.\n\
        \ \n\
        \   {b All custom key stores:} \n\
        \  \n\
        \   {ul\n\
        \         {-   [INTERNAL_ERROR] \226\128\148 KMS could not complete the request due to an \
         internal error. Retry the request. For [ConnectCustomKeyStore] requests, disconnect the \
         custom key store before trying to connect again.\n\
        \             \n\
        \              }\n\
        \         {-   [NETWORK_ERRORS] \226\128\148 Network errors are preventing KMS from \
        ...
        \   \n\
        \    {ul\n\
        \          {-   [CLUSTER_NOT_FOUND] \226\128\148 KMS cannot find the CloudHSM cluster with \
         the specified cluster ID.\n\
        \              \n\
        \               }\n\
        \          {-   [INSUFFICIENT_CLOUDHSM_HSMS] \226\128\148 The associated CloudHSM cluster \
         does not contain any active HSMs. To connect a custom key store to its CloudHSM cluster, \
         the cluster must contain at least one active HSM.\n\
        \              \n\
        \               }\n\
        \          {-   [INSUFFICIENT_FREE_ADDRESSES_IN_SUBNET] \226\128\148 At least one private \
         subnet associated with the CloudHSM cluster doesn't have any available IP addresses. A \
         CloudHSM key store connection requires one free IP address in each of the associated \
         private subnets, although two are preferable. For details, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html#fix-keystore-failed}How \
         to Fix a Connection Failure} in the {i Key Management Service Developer Guide}.\n\
        \              \n\
        \               }\n\
        \          {-   [INVALID_CREDENTIALS] \226\128\148 The [KeyStorePassword] for the custom \
         key store doesn't match the current password of the [kmsuser] crypto user in the CloudHSM \
         cluster. Before you can connect your custom key store to its CloudHSM cluster, you must \
         change the [kmsuser] account password and update the [KeyStorePassword] value for the \
         custom key store.\n\
        \              \n\
        \               }\n\
        \          {-   [SUBNET_NOT_FOUND] \226\128\148 A subnet in the CloudHSM cluster \
         configuration was deleted. If KMS cannot find all of the subnets in the cluster \
         configuration, attempts to connect the custom key store to the CloudHSM cluster fail. To \
         fix this error, create a cluster from a recent backup and associate it with your custom \
        ...
        \              \n\
        \               }\n\
        \          {-   [USER_LOCKED_OUT] \226\128\148 The [kmsuser] CU account is locked out of \
         the associated CloudHSM cluster due to too many failed password attempts. Before you can \
         connect your custom key store to its CloudHSM cluster, you must change the [kmsuser] \
         account password and update the key store password value for the custom key store.\n\
        \              \n\
        \               }\n\
        \          {-   [USER_LOGGED_IN] \226\128\148 The [kmsuser] CU account is logged into the \
         associated CloudHSM cluster. This prevents KMS from rotating the [kmsuser] account \
         password and logging into the cluster. Before you can connect your custom key store to \
         its CloudHSM cluster, you must log the [kmsuser] CU out of the cluster. If you changed \
         the [kmsuser] password to log into the cluster, you must also and update the key store \
         password value for the custom key store. For help, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html#login-kmsuser-2}How \
         to Log Out and Reconnect} in the {i Key Management Service Developer Guide}.\n\
        \              \n\
        \               }\n\
        \          {-   [USER_NOT_FOUND] \226\128\148 KMS cannot find a [kmsuser] CU account in \
         the associated CloudHSM cluster. Before you can connect your custom key store to its \
         CloudHSM cluster, you must create a [kmsuser] CU account in the cluster, and then update \
        ...
        \   \n\
        \    {ul\n\
        \          {-   [INVALID_CREDENTIALS] \226\128\148 One or both of the \
         [XksProxyAuthenticationCredential] values is not valid on the specified external key \
         store proxy.\n\
        \              \n\
        \               }\n\
        \          {-   [XKS_PROXY_ACCESS_DENIED] \226\128\148 KMS requests are denied access to \
         the external key store proxy. If the external key store proxy has authorization rules, \
         verify that they permit KMS to communicate with the proxy on your behalf.\n\
        \              \n\
        \               }\n\
        \          {-   [XKS_PROXY_INVALID_CONFIGURATION] \226\128\148 A configuration error is \
         preventing the external key store from connecting to its proxy. Verify the value of the \
         [XksProxyUriPath].\n\
        \              \n\
        \               }\n\
        \          {-   [XKS_PROXY_INVALID_RESPONSE] \226\128\148 KMS cannot interpret the \
         response from the external key store proxy. If you see this connection error code \
         repeatedly, notify your external key store proxy vendor.\n\
        \              \n\
        \               }\n\
        \          {-   [XKS_PROXY_INVALID_TLS_CONFIGURATION] \226\128\148 KMS cannot connect to \
         the external key store proxy because the TLS configuration is invalid. Verify that the \
         XKS proxy supports TLS 1.2 or 1.3. Also, verify that the TLS certificate is not expired, \
         and that it matches the hostname in the [XksProxyUriEndpoint] value, and that it is \
         signed by a certificate authority included in the \
         {{:https://github.com/aws/aws-kms-xksproxy-api-spec/blob/main/TrustedCertificateAuthorities}Trusted \
         Certificate Authorities} list.\n\
        \              \n\
        \               }\n\
        \          {-   [XKS_PROXY_NOT_REACHABLE] \226\128\148 KMS can't communicate with your \
         external key store proxy. Verify that the [XksProxyUriEndpoint] and [XksProxyUriPath] are \
         correct. Use the tools for your external key store proxy to verify that the proxy is \
        ...
        \              \n\
        \               }\n\
        \          {-   [XKS_PROXY_TIMED_OUT] \226\128\148 KMS can connect to the external key \
         store proxy, but the proxy does not respond to KMS in the time allotted. If you see this \
         connection error code repeatedly, notify your external key store proxy vendor.\n\
        \              \n\
        \               }\n\
        \          {-   [XKS_VPC_ENDPOINT_SERVICE_INVALID_CONFIGURATION] \226\128\148 The Amazon \
         VPC endpoint service configuration doesn't conform to the requirements for an KMS \
         external key store.\n\
        \              \n\
        \               {ul\n\
        ...
        \                     {-  It must have a private DNS name. The private DNS name for an \
         external key store with [VPC_ENDPOINT_SERVICE] connectivity must be unique in its Amazon \
         Web Services Region.\n\
        \                         \n\
        \                          }\n\
        \                     {-  The domain of the private DNS name must have a \
         {{:https://docs.aws.amazon.com/vpc/latest/privatelink/verify-domains.html}verification \
         status} of [verified].\n\
        \                         \n\
        \                          }\n\
        \                     {-  The \
         {{:https://docs.aws.amazon.com/elasticloadbalancing/latest/network/create-tls-listener.html}TLS \
        ...
        \           }\n\
        \            }\n\
        \          {-   [XKS_VPC_ENDPOINT_SERVICE_NOT_FOUND] \226\128\148 KMS can't find the VPC \
         endpoint service that it uses to communicate with the external key store proxy. Verify \
         that the [XksProxyVpcEndpointServiceName] is correct and the KMS service principal has \
  ...
  connection_state : connection_state_type option;
      [@ocaml.doc
        "Indicates whether the custom key store is connected to its backing key store. For an \
         CloudHSM key store, the [ConnectionState] indicates whether it is connected to its \
         CloudHSM cluster. For an external key store, the [ConnectionState] indicates whether it \
         is connected to the external key store proxy that communicates with your external key \
         manager.\n\n\
        ...
        \  The [ConnectionState] value is [DISCONNECTED] only if the key store has never been \
         connected or you use the [DisconnectCustomKeyStore] operation to disconnect it. If the \
         value is [CONNECTED] but you are having trouble using the custom key store, make sure \
         that the backing key store is reachable and active. For an CloudHSM key store, verify \
         that its associated CloudHSM cluster is active and contains at least one active HSM. For \
         an external key store, verify that the external key store proxy and external key manager \
        ...
        \   A value of [FAILED] indicates that an attempt to connect was unsuccessful. The \
         ...
         resolving a connection failure, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html}Troubleshooting \
         a custom key store} in the {i Key Management Service Developer Guide}.\n\
        \   "]
  trust_anchor_certificate : trust_anchor_certificate_type option;
      [@ocaml.doc
        "The trust anchor certificate of the CloudHSM cluster associated with an CloudHSM key \
         store. When you \
         {{:https://docs.aws.amazon.com/cloudhsm/latest/userguide/initialize-cluster.html#sign-csr}initialize \
         the cluster}, you create this certificate and save it in the [customerCA.crt] file.\n\n\
  ...
  cloud_hsm_cluster_id : cloud_hsm_cluster_id_type option;
      [@ocaml.doc
        "A unique identifier for the CloudHSM cluster that is associated with an CloudHSM key \
         store. This field appears only when the [CustomKeyStoreType] is [AWS_CLOUDHSM].\n"]
  custom_key_store_name : custom_key_store_name_type option;
      [@ocaml.doc "The user-specified friendly name for the custom key store.\n"]
  custom_key_store_id : custom_key_store_id_type option;
      [@ocaml.doc "A unique identifier for the custom key store.\n"]
}
[@@ocaml.doc "Contains information about each custom key store in the custom key store list.\n"]

type nonrec custom_key_stores_list = custom_key_stores_list_entry list [@@ocaml.doc ""]
...
type nonrec describe_custom_key_stores_request = {
  ...
  custom_key_store_name : custom_key_store_name_type option;
      [@ocaml.doc
        "Gets only information about the specified custom key store. Enter the friendly name of \
  ...
  key_origin : origin_type option;
      [@ocaml.doc
        ...
        \  The only valid values for DeriveSharedSecret are [AWS_KMS] and [EXTERNAL]. \
         DeriveSharedSecret does not support KMS keys with a [KeyOrigin] value of [AWS_CLOUDHSM] \
...
type nonrec derive_shared_secret_request = {
  ...
  public_key : public_key_type;
      [@ocaml.doc
        ...
        \  \n\
        \    If you use \
         {{:https://docs.aws.amazon.com/cli/v1/userguide/cli-chap-welcome.html}Amazon Web Services \
         CLI version 1}, you must provide the DER-encoded X.509 public key in a file. Otherwise, \
...
type nonrec delete_imported_key_material_response = {
  ...
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the KMS key from which the key material was deleted.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_imported_key_material_request = {
  ...
  key_id : key_id_type;
      [@ocaml.doc
        "Identifies the KMS key from which you are deleting imported key material. The [Origin] of \
...
type nonrec decrypt_response = {
  ...
  plaintext : plaintext_type option;
      [@ocaml.doc
        "Decrypted plaintext data. When you use the HTTP API or the Amazon Web Services CLI, the \
         value is Base64-encoded. Otherwise, it is not Base64-encoded.\n\n\
        \ If the response includes the [CiphertextForRecipient] field, the [Plaintext] field is \
         null or empty.\n\
        \ "]
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the KMS key that was used to decrypt the ciphertext.\n"]
}
[@@ocaml.doc ""]
...
type nonrec decrypt_request = {
  ...
  encryption_algorithm : encryption_algorithm_spec option;
      [@ocaml.doc
        ...
        \ This parameter is required only when the ciphertext was encrypted under an asymmetric \
         KMS key. The default value, [SYMMETRIC_DEFAULT], represents the only supported algorithm \
...
type nonrec create_key_response = {
  key_metadata : key_metadata option; [@ocaml.doc "Metadata associated with the KMS key.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_key_request = {
  xks_key_id : xks_key_id_type option;
      [@ocaml.doc
        "Identifies the \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html#concept-external-key}external \
         key} that serves as key material for the KMS key in an \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html}external \
         key store}. Specify the ID that the \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html#concept-xks-proxy}external \
         key store proxy} uses to refer to the external key. For help, see the documentation for \
        ...
        \ \n\
        \  The external key must be an existing 256-bit AES symmetric encryption key hosted \
         outside of Amazon Web Services in an external key manager associated with the external \
         key store specified by the [CustomKeyStoreId] parameter. This key must be enabled and \
         configured to perform encryption and decryption. Each KMS key in an external key store \
         must use a different external key. For details, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/create-xks-keys.html#xks-key-requirements}Requirements \
         for a KMS key in an external key store} in the {i Key Management Service Developer Guide}.\n\
        \  \n\
        \   Each KMS key in an external key store is associated two backing keys. One is key \
         material that KMS generates. The other is the external key specified by this parameter. \
         When you use the KMS key in an external key store to encrypt data, the encryption \
         operation is performed first by KMS using the KMS key material, and then by the external \
         key manager using the specified external key, a process known as {i double encryption}. \
         For details, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/keystore-external.html#concept-double-encryption}Double \
         encryption} in the {i Key Management Service Developer Guide}.\n\
        \   "]
  multi_region : nullable_boolean_type option;
      [@ocaml.doc
        ...
        \ For a multi-Region key, set this parameter to [True]. For a single-Region KMS key, omit \
         this parameter or set it to [False]. The default value is [False].\n\
        \ \n\
        \  This operation supports {i multi-Region keys}, an KMS feature that lets you create \
         multiple interoperable KMS keys in different Amazon Web Services Regions. Because these \
         KMS keys have the same key ID, key material, and other metadata, you can use them \
         ...
         keys in KMS} in the {i Key Management Service Developer Guide}.\n\
        \  \n\
        \   This value creates a {i primary key}, not a replica. To create a {i replica key}, use \
         the [ReplicateKey] operation. \n\
        \   \n\
        \    You can create a symmetric or asymmetric multi-Region key, and you can create a \
         multi-Region key with imported key material. However, you cannot create a multi-Region \
  ...
  custom_key_store_id : custom_key_store_id_type option;
      [@ocaml.doc
        "Creates the KMS key in the specified \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-store-overview.html}custom \
         key store}. The [ConnectionState] of the custom key store must be [CONNECTED]. To find \
        ...
        \  When you create a KMS key in an CloudHSM key store, KMS generates a non-exportable \
         256-bit symmetric key in its associated CloudHSM cluster and associates it with the KMS \
         key. When you create a KMS key in an external key store, you must use the [XksKeyId] \
  ...
  origin : origin_type option;
      [@ocaml.doc
        "The source of the key material for the KMS key. You cannot change the origin after you \
         create the KMS key. The default is [AWS_KMS], which means that KMS creates the key \
         material.\n\n\
        \ To \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys-create-cmk.html}create \
         ...
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys.html}Importing \
         Key Material} in the {i Key Management Service Developer Guide}. The [EXTERNAL] origin \
         value is valid only for symmetric KMS keys.\n\
        \ \n\
        \  To \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/create-cmk-keystore.html}create \
         ...
         [CustomKeyStoreId] parameter to identify the CloudHSM key store. The [KeySpec] value must \
         be [SYMMETRIC_DEFAULT].\n\
        \  \n\
        \   To \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/create-xks-keys.html}create a \
         KMS key in an external key store}, set this value to [EXTERNAL_KEY_STORE]. You must also \
         use the [CustomKeyStoreId] parameter to identify the external key store and the \
         [XksKeyId] parameter to identify the associated external key. The [KeySpec] value must be \
         [SYMMETRIC_DEFAULT].\n\
        \   "]
  key_spec : key_spec option;
      [@ocaml.doc
        "Specifies the type of KMS key to create. The default value, [SYMMETRIC_DEFAULT], creates \
         ...
         a detailed description of all supported key specs, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/symm-asymm-choose-key-spec.html}Key \
         spec reference} in the {i  {i Key Management Service Developer Guide} }.\n\n\
        \ The [KeySpec] determines whether the KMS key contains a symmetric key or an asymmetric \
         ...
         information, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/conditions-kms.html#conditions-kms-encryption-algorithm}kms:EncryptionAlgorithm}, \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/conditions-kms.html#conditions-kms-mac-algorithm}kms:MacAlgorithm}, \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/conditions-kms.html#conditions-kms-key-agreement-algorithm}kms:KeyAgreementAlgorithm}, \
         or \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/conditions-kms.html#conditions-kms-signing-algorithm}kms:SigningAlgorithm} \
         in the {i  {i Key Management Service Developer Guide} }.\n\
        \ \n\
        \    {{:http://aws.amazon.com/kms/features/#AWS_Service_Integration}Amazon Web Services \
         services that are integrated with KMS} use symmetric encryption KMS keys to protect your \
  ...
  customer_master_key_spec : customer_master_key_spec option;
      [@ocaml.doc
        ...
        \ The [KeySpec] and [CustomerMasterKeySpec] parameters work the same way. Only the names \
         differ. We recommend that you use [KeySpec] parameter in your code. However, to avoid \
  ...
  policy : policy_type option;
      [@ocaml.doc
        ...
        \    If either of the required [Resource] or [Action] elements are missing from a key \
         policy statement, the policy statement has no effect. When a key policy statement is \
         missing one of these elements, the KMS console correctly reports an error, but the \
         [CreateKey] and [PutKeyPolicy] API requests succeed, even though the policy statement is \
         ineffective.\n\
        \    \n\
        \     For more information on required key policy elements, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-overview.html#key-policy-elements}Elements \
         in a key policy} in the {i Key Management Service Developer Guide}.\n\
        \     \n\
        \       If you do not provide a key policy, KMS attaches a default key policy to the KMS \
  ...
  operations : grant_operation_list;
      [@ocaml.doc
        ...
        \ This list must include only operations that are permitted in a grant. Also, the \
         operation must be supported on the KMS key. For example, you cannot create a grant for a \
         symmetric encryption KMS key that allows the [Sign] operation, or a grant for an \
         asymmetric KMS key that allows the [GenerateDataKey] operation. If you try, KMS returns a \
         [ValidationError] exception. For details, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#terms-grant-operations}Grant \
         operations} in the {i Key Management Service Developer Guide}.\n\
        \ "]
  retiring_principal : principal_id_type option;
      [@ocaml.doc
  ...
  grantee_principal : principal_id_type;
      [@ocaml.doc
        ...
        \ To specify the grantee principal, use the Amazon Resource Name (ARN) of an Amazon Web \
         Services principal. Valid principals include Amazon Web Services accounts, IAM users, IAM \
         roles, federated users, and assumed role users. For help with the ARN syntax for a \
         principal, see \
         {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html#identifiers-arns}IAM \
         ARNs} in the {i  {i Identity and Access Management User Guide} }.\n\
        \ "]
...
[@@ocaml.doc
  "The request was rejected because the specified CloudHSM cluster is already associated with an \
   CloudHSM key store in the account, or it shares a backup history with an CloudHSM key store in \
   the account. Each CloudHSM key store in the account must be associated with a different \
   CloudHSM cluster.\n\n\
  \ CloudHSM clusters that share a backup history have the same cluster certificate. To view the \
   cluster certificate of an CloudHSM cluster, use the \
   {{:https://docs.aws.amazon.com/cloudhsm/latest/APIReference/API_DescribeClusters.html}DescribeClusters} \
...
type nonrec create_custom_key_store_request = {
  xks_proxy_connectivity : xks_proxy_connectivity_type option;
      [@ocaml.doc
        ...
        \ If the external key store proxy uses a public endpoint, specify [PUBLIC_ENDPOINT]. If \
         the external key store proxy uses a Amazon VPC endpoint service for communication with \
         KMS, specify [VPC_ENDPOINT_SERVICE]. For help making this choice, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/choose-xks-connectivity.html}Choosing \
        ...
        \  An Amazon VPC endpoint service keeps your communication with KMS in a private address \
         ...
         establishing a Amazon VPC with multiple subnets, a VPC endpoint service, a network load \
         balancer, and a verified private DNS name. A public endpoint is simpler to set up, but it \
         might be slower and might not fulfill your security requirements. You might consider \
         testing with a public endpoint, and then establishing a VPC endpoint service for \
         production tasks. Note that this choice does not determine the location of the external \
         key store proxy. Even if you choose a VPC endpoint service, the proxy can be hosted \
  ...
  xks_proxy_authentication_credential : xks_proxy_authentication_credential_type option;
      [@ocaml.doc
        ...
        \ The [XksProxyAuthenticationCredential] has two required elements: [RawSecretAccessKey], \
         a secret key, and [AccessKeyId], a unique identifier for the [RawSecretAccessKey]. For \
         character requirements, see \
         {{:API_XksProxyAuthenticationCredentialType.html}XksProxyAuthenticationCredentialType}.\n\
        \ \n\
  ...
  xks_proxy_vpc_endpoint_service_name : xks_proxy_vpc_endpoint_service_name_type option;
      [@ocaml.doc
        "Specifies the name of the Amazon VPC endpoint service for interface endpoints that is \
         used to communicate with your external key store proxy (XKS proxy). This parameter is \
         required when the value of [CustomKeyStoreType] is [EXTERNAL_KEY_STORE] and the value of \
         [XksProxyConnectivity] is [VPC_ENDPOINT_SERVICE].\n\n\
        \ The Amazon VPC endpoint service must \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/create-xks-keystore.html#xks-requirements}fulfill \
         all requirements} for use with an external key store. \n\
        \ \n\
        \   {b Uniqueness requirements:} \n\
        \  \n\
        \   {ul\n\
        \         {-  External key stores with [VPC_ENDPOINT_SERVICE] connectivity can share an \
         Amazon VPC, but each external key store must have its own VPC endpoint service and \
         private DNS name.\n\
        \             \n\
        \              }\n\
        \         }\n\
  ...
  xks_proxy_uri_path : xks_proxy_uri_path_type option;
      [@ocaml.doc
        "Specifies the base path to the proxy APIs for this external key store. To find this \
         ...
         required for all custom key stores with a [CustomKeyStoreType] of [EXTERNAL_KEY_STORE].\n\n\
        \ The value must start with [/] and must end with [/kms/xks/v1] where [v1] represents the \
         version of the KMS external key store proxy API. This path can include an optional prefix \
         between the required elements such as \n\
        \ {[\n\
        \ /{i prefix}/kms/xks/v1\n\
        \ ]}\n\
  ...
  xks_proxy_uri_endpoint : xks_proxy_uri_endpoint_type option;
      [@ocaml.doc
        ...
        \    The value of this parameter must begin with [https://]. The remainder can contain \
         upper and lower case letters (A-Z and a-z), numbers (0-9), dots ([.]), and hyphens ([-]). \
        ...
        \            {-  Each external key store with [VPC_ENDPOINT_SERVICE] connectivity must \
         have its own private DNS name. The [XksProxyUriEndpoint] value for external key stores \
         with [VPC_ENDPOINT_SERVICE] connectivity (private DNS name) must be unique in the Amazon \
  ...
  custom_key_store_type : custom_key_store_type option;
      [@ocaml.doc
        ...
        \ For a custom key store backed by an CloudHSM cluster, omit the parameter or enter \
         [AWS_CLOUDHSM]. For a custom key store backed by an external key manager outside of \
         Amazon Web Services, enter [EXTERNAL_KEY_STORE]. You cannot change this property after \
         the key store is created.\n\
        \ "]
  key_store_password : key_store_password_type option;
      [@ocaml.doc
        "Specifies the [kmsuser] password for an CloudHSM key store. This parameter is required \
  ...
  trust_anchor_certificate : trust_anchor_certificate_type option;
      [@ocaml.doc
        ...
        \ Enter the content of the trust anchor certificate for the CloudHSM cluster. This is the \
         content of the [customerCA.crt] file that you created when you \
         {{:https://docs.aws.amazon.com/cloudhsm/latest/userguide/initialize-cluster.html}initialized \
         the cluster}.\n\
        \ "]
  cloud_hsm_cluster_id : cloud_hsm_cluster_id_type option;
      [@ocaml.doc
        "Identifies the CloudHSM cluster for an CloudHSM key store. This parameter is required for \
         custom key stores with [CustomKeyStoreType] of [AWS_CLOUDHSM].\n\n\
        \ Enter the cluster ID of any active CloudHSM cluster that is not already associated with \
         a custom key store. To find the cluster ID, use the \
         {{:https://docs.aws.amazon.com/cloudhsm/latest/APIReference/API_DescribeClusters.html}DescribeClusters} \
         operation.\n\
        \ "]
  custom_key_store_name : custom_key_store_name_type;
      [@ocaml.doc
        "Specifies a friendly name for the custom key store. The name must be unique in your \
         Amazon Web Services account and Region. This parameter is required for all custom key \
         stores.\n\n\
        \  Do not include confidential or sensitive information in this field. This field may be \
         displayed in plaintext in CloudTrail logs and other output.\n\
        \  \n\
...
type nonrec invalid_alias_name_exception = { message : error_message_type option [@ocaml.doc ""] }
[@@ocaml.doc "The request was rejected because the specified alias name is not valid.\n"]
  ...
  target_key_id : key_id_type;
      [@ocaml.doc
        ...
        \  For help finding the key ID and ARN, see \
         {{:https://docs.aws.amazon.com/kms/latest/developerguide/find-cmk-id-arn.html}Find the \
         key ID and key ARN} in the {i  {i Key Management Service Developer Guide} }.\n\
        \  \n\
        \   Specify the key ID or key ARN of the KMS key.\n\
        \   \n\
        \    For example:\n\
...
type nonrec connect_custom_key_store_request = {
  custom_key_store_id : custom_key_store_id_type;
      [@ocaml.doc
        "Enter the key store ID of the custom key store that you want to connect. To find the ID \
...
type nonrec cancel_key_deletion_response = {
  key_id : key_id_type option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN}key \
         ARN}) of the KMS key whose deletion is canceled.\n"]
}
[@@ocaml.doc ""]
