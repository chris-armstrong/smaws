...
type nonrec key_manager_type = AWS [@ocaml.doc ""] | CUSTOMER [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec data_key_spec = AES_256 [@ocaml.doc ""] | AES_128 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec import_type = NEW_KEY_MATERIAL [@ocaml.doc ""] | EXISTING_KEY_MATERIAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec import_state = IMPORTED [@ocaml.doc ""] | PENDING_IMPORT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec rotation_type = AUTOMATIC [@ocaml.doc ""] | ON_DEMAND [@ocaml.doc ""] [@@ocaml.doc ""]
