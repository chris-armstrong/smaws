...
let xks_key_configuration_type_of_yojson tree path =
  ...
  let _res : xks_key_configuration_type =
    {
      id =
        (option_of_yojson (value_for_key xks_key_id_type_of_yojson "Id")
           _list path)
    } in
  _res
  ...
  let _res : verify_request =
    {
      dry_run =
        (option_of_yojson
           (value_for_key nullable_boolean_type_of_yojson "DryRun") _list
           path);
      grant_tokens =
        (option_of_yojson
           (value_for_key grant_token_list_of_yojson "GrantTokens") _list
           path);
      signing_algorithm =
        (value_for_key signing_algorithm_spec_of_yojson "SigningAlgorithm"
           _list path);
  ...
  let _res : update_custom_key_store_request =
    {
      ...
      key_store_password =
        (option_of_yojson
           (value_for_key key_store_password_type_of_yojson
              "KeyStorePassword") _list path);
  ...
  let _res : schedule_key_deletion_response =
    {
      ...
      key_state =
        (option_of_yojson (value_for_key key_state_of_yojson "KeyState")
           _list path);
      deletion_date =
...
let multi_region_key_of_yojson tree path =
  ...
  let _res : multi_region_key =
    {
      region =
        (option_of_yojson (value_for_key region_type_of_yojson "Region")
           _list path);
      arn =
  ...
  let _res : multi_region_configuration =
    {
      replica_keys =
        (option_of_yojson
           (value_for_key multi_region_key_list_of_yojson "ReplicaKeys")
           _list path);
      primary_key =
        (option_of_yojson
      ...
      multi_region_key_type =
        (option_of_yojson
           (value_for_key multi_region_key_type_of_yojson
              "MultiRegionKeyType") _list path)
    } in
  _res
  ...
  let _res : key_metadata =
    {
      ...
      multi_region =
        (option_of_yojson
           (value_for_key nullable_boolean_type_of_yojson "MultiRegion")
           _list path);
      ...
      origin =
        (option_of_yojson (value_for_key origin_type_of_yojson "Origin")
           _list path);
      valid_to =
      ...
      description =
        (option_of_yojson
           (value_for_key description_type_of_yojson "Description") _list
           path);
      enabled =
  ...
  let _res : replicate_key_request =
    {
      ...
      policy =
        (option_of_yojson (value_for_key policy_type_of_yojson "Policy")
           _list path);
      replica_region =
  ...
  let _res : list_retirable_grants_request =
    {
      retiring_principal =
        (value_for_key principal_id_type_of_yojson "RetiringPrincipal" _list
           path);
      marker =
        (option_of_yojson (value_for_key marker_type_of_yojson "Marker")
           _list path);
      limit =
  ...
  let _res : list_keys_response =
    {
      ...
      next_marker =
        (option_of_yojson (value_for_key marker_type_of_yojson "NextMarker")
           _list path);
      keys =
        (option_of_yojson (value_for_key key_list_of_yojson "Keys") _list
           path)
    } in
  _res
  ...
  let _res : list_key_rotations_response =
    {
      ...
      rotations =
        (option_of_yojson
           (value_for_key rotations_list_of_yojson "Rotations") _list path)
    } in
  _res
  ...
  let _res : list_key_policies_response =
    {
      ...
      policy_names =
        (option_of_yojson
           (value_for_key policy_name_list_of_yojson "PolicyNames") _list
           path)
    } in
  _res
  ...
  let _res : list_aliases_response =
    {
      ...
      next_marker =
        (option_of_yojson (value_for_key marker_type_of_yojson "NextMarker")
           _list path);
      aliases =
        (option_of_yojson (value_for_key alias_list_of_yojson "Aliases")
           _list path)
    } in
  _res
  ...
  let _res : get_parameters_for_import_response =
    {
      ...
      public_key =
        (option_of_yojson
           (value_for_key plaintext_type_of_yojson "PublicKey") _list path);
      import_token =
        (option_of_yojson
           (value_for_key ciphertext_type_of_yojson "ImportToken") _list path);
      key_id =
  ...
  let _res : get_parameters_for_import_request =
    {
      wrapping_key_spec =
        (value_for_key wrapping_key_spec_of_yojson "WrappingKeySpec" _list
           path);
      wrapping_algorithm =
        (value_for_key algorithm_spec_of_yojson "WrappingAlgorithm" _list
           path);
      key_id = (value_for_key key_id_type_of_yojson "KeyId" _list path)
    } in
  _res
  ...
  let _res : generate_random_request =
    {
      recipient =
        (option_of_yojson
           (value_for_key recipient_info_of_yojson "Recipient") _list path);
      custom_key_store_id =
        (option_of_yojson
           (value_for_key custom_key_store_id_type_of_yojson
              "CustomKeyStoreId") _list path);
  ...
  let _res : generate_data_key_pair_without_plaintext_response =
    {
      ...
      private_key_ciphertext_blob =
        (option_of_yojson
           (value_for_key ciphertext_type_of_yojson
              "PrivateKeyCiphertextBlob") _list path)
    } in
  _res
  ...
  let _res : describe_key_response =
    {
      key_metadata =
        (option_of_yojson
           (value_for_key key_metadata_of_yojson "KeyMetadata") _list path)
    } in
  _res
  ...
  let _res : custom_key_stores_list_entry =
    {
      ...
      custom_key_store_type =
        (option_of_yojson
           (value_for_key custom_key_store_type_of_yojson
              "CustomKeyStoreType") _list path);
      creation_date =
        (option_of_yojson (value_for_key date_type_of_yojson "CreationDate")
           _list path);
  ...
  let _res : create_key_request =
    {
      xks_key_id =
        (option_of_yojson
           (value_for_key xks_key_id_type_of_yojson "XksKeyId") _list path);
      multi_region =
        (option_of_yojson
           (value_for_key nullable_boolean_type_of_yojson "MultiRegion")
           _list path);
