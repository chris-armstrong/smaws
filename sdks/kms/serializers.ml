...
let xks_proxy_configuration_type_to_yojson (x : xks_proxy_configuration_type)
  ...
  assoc_to_yojson
    ...
    ("AccessKeyId",
      (option_to_yojson xks_proxy_authentication_access_key_id_type_to_yojson
         x.access_key_id));
    ("Connectivity",
...
let xks_proxy_authentication_credential_type_to_yojson
  ...
  assoc_to_yojson
    [("RawSecretAccessKey",
       (Some
          (xks_proxy_authentication_raw_secret_access_key_type_to_yojson
             x.raw_secret_access_key)));
    ("AccessKeyId",
      (Some
         (xks_proxy_authentication_access_key_id_type_to_yojson
            x.access_key_id)))]
...
let xks_key_invalid_configuration_exception_to_yojson
  (x : xks_key_invalid_configuration_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
...
let xks_key_already_in_use_exception_to_yojson
  (x : xks_key_already_in_use_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
...
let grant_token_list_to_yojson tree =
  list_to_yojson grant_token_type_to_yojson tree
...
let invalid_grant_token_exception_to_yojson
  (x : invalid_grant_token_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
...
let kms_invalid_signature_exception_to_yojson
  (x : kms_invalid_signature_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
...
let update_primary_region_request_to_yojson
  (x : update_primary_region_request) =
  assoc_to_yojson
...
let update_key_description_request_to_yojson
  (x : update_key_description_request) =
  assoc_to_yojson
...
let update_custom_key_store_request_to_yojson
  (x : update_custom_key_store_request) =
  assoc_to_yojson
    [("XksProxyConnectivity",
       (option_to_yojson xks_proxy_connectivity_type_to_yojson
          x.xks_proxy_connectivity));
    ...
    ("XksProxyUriPath",
      (option_to_yojson xks_proxy_uri_path_type_to_yojson
         x.xks_proxy_uri_path));
    ("XksProxyUriEndpoint",
      (option_to_yojson xks_proxy_uri_endpoint_type_to_yojson
         x.xks_proxy_uri_endpoint));
    ("CloudHsmClusterId",
      (option_to_yojson cloud_hsm_cluster_id_type_to_yojson
         x.cloud_hsm_cluster_id));
    ("KeyStorePassword",
      (option_to_yojson key_store_password_type_to_yojson
         x.key_store_password));
    ("NewCustomKeyStoreName",
      (option_to_yojson custom_key_store_name_type_to_yojson
         x.new_custom_key_store_name));
    ("CustomKeyStoreId",
      (Some (custom_key_store_id_type_to_yojson x.custom_key_store_id)))]
let custom_key_store_not_found_exception_to_yojson
  (x : custom_key_store_not_found_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
let custom_key_store_name_in_use_exception_to_yojson
  (x : custom_key_store_name_in_use_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
...
let cloud_hsm_cluster_not_related_exception_to_yojson
  (x : cloud_hsm_cluster_not_related_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
let cloud_hsm_cluster_not_found_exception_to_yojson
  (x : cloud_hsm_cluster_not_found_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
let cloud_hsm_cluster_not_active_exception_to_yojson
  (x : cloud_hsm_cluster_not_active_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
...
let schedule_key_deletion_response_to_yojson
  (x : schedule_key_deletion_response) =
  assoc_to_yojson
    [("PendingWindowInDays",
       (option_to_yojson pending_window_in_days_type_to_yojson
          x.pending_window_in_days));
...
let schedule_key_deletion_request_to_yojson
  (x : schedule_key_deletion_request) =
  assoc_to_yojson
    [("PendingWindowInDays",
       (option_to_yojson pending_window_in_days_type_to_yojson
          x.pending_window_in_days));
...
let rotate_key_on_demand_response_to_yojson
  (x : rotate_key_on_demand_response) =
  assoc_to_yojson
    [("KeyId", (option_to_yojson key_id_type_to_yojson x.key_id))]
...
let key_manager_type_to_yojson (x : key_manager_type) =
  match x with | CUSTOMER -> `String "CUSTOMER" | AWS -> `String "AWS"
...
let multi_region_key_type_to_yojson (x : multi_region_key_type) =
  match x with | REPLICA -> `String "REPLICA" | PRIMARY -> `String "PRIMARY"
...
let multi_region_key_list_to_yojson tree =
  list_to_yojson multi_region_key_to_yojson tree
let multi_region_configuration_to_yojson (x : multi_region_configuration) =
  assoc_to_yojson
    ...
    ("MultiRegionKeyType",
      (option_to_yojson multi_region_key_type_to_yojson
...
let key_metadata_to_yojson (x : key_metadata) =
  assoc_to_yojson
    ...
    ("PendingDeletionWindowInDays",
      (option_to_yojson pending_window_in_days_type_to_yojson
         x.pending_deletion_window_in_days));
    ("MultiRegionConfiguration",
      (option_to_yojson multi_region_configuration_to_yojson
         x.multi_region_configuration));
    ("MultiRegion",
      (option_to_yojson nullable_boolean_type_to_yojson x.multi_region));
    ("KeyAgreementAlgorithms",
      (option_to_yojson key_agreement_algorithm_spec_list_to_yojson
         x.key_agreement_algorithms));
    ("SigningAlgorithms",
      (option_to_yojson signing_algorithm_spec_list_to_yojson
         x.signing_algorithms));
    ("EncryptionAlgorithms",
      (option_to_yojson encryption_algorithm_spec_list_to_yojson
         x.encryption_algorithms));
    ("KeySpec", (option_to_yojson key_spec_to_yojson x.key_spec));
    ("CustomerMasterKeySpec",
      (option_to_yojson customer_master_key_spec_to_yojson
         x.customer_master_key_spec));
    ("KeyManager",
    ...
    ("CloudHsmClusterId",
      (option_to_yojson cloud_hsm_cluster_id_type_to_yojson
         x.cloud_hsm_cluster_id));
    ("CustomKeyStoreId",
      (option_to_yojson custom_key_store_id_type_to_yojson
         x.custom_key_store_id));
...
let replicate_key_request_to_yojson (x : replicate_key_request) =
  assoc_to_yojson
    ...
    ("BypassPolicyLockoutSafetyCheck",
      (option_to_yojson boolean_type_to_yojson
         x.bypass_policy_lockout_safety_check));
...
let encryption_context_type_to_yojson tree =
  map_to_yojson encryption_context_key_to_yojson
    encryption_context_value_to_yojson tree
let re_encrypt_request_to_yojson (x : re_encrypt_request) =
  assoc_to_yojson
    ...
    ("DestinationEncryptionContext",
      (option_to_yojson encryption_context_type_to_yojson
         x.destination_encryption_context));
    ("DestinationKeyId", (Some (key_id_type_to_yojson x.destination_key_id)));
    ("SourceKeyId", (option_to_yojson key_id_type_to_yojson x.source_key_id));
    ("SourceEncryptionContext",
      (option_to_yojson encryption_context_type_to_yojson
         x.source_encryption_context));
...
let grant_operation_list_to_yojson tree =
  list_to_yojson grant_operation_to_yojson tree
let grant_constraints_to_yojson (x : grant_constraints) =
  assoc_to_yojson
    [("EncryptionContextEquals",
       (option_to_yojson encryption_context_type_to_yojson
          x.encryption_context_equals));
    ("EncryptionContextSubset",
      (option_to_yojson encryption_context_type_to_yojson
         x.encryption_context_subset))]
let grant_list_entry_to_yojson (x : grant_list_entry) =
  assoc_to_yojson
    ...
    ("GrantId", (option_to_yojson grant_id_type_to_yojson x.grant_id));
    ("KeyId", (option_to_yojson key_id_type_to_yojson x.key_id))]
let grant_list_to_yojson tree =
  list_to_yojson grant_list_entry_to_yojson tree
...
let list_retirable_grants_request_to_yojson
  (x : list_retirable_grants_request) =
  assoc_to_yojson
    [("RetiringPrincipal",
...
let alias_list_to_yojson tree =
  list_to_yojson alias_list_entry_to_yojson tree
...
let invalid_import_token_exception_to_yojson
  (x : invalid_import_token_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
let incorrect_key_material_exception_to_yojson
  (x : incorrect_key_material_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_type_to_yojson x.message))]
...
let get_parameters_for_import_response_to_yojson
  (x : get_parameters_for_import_response) =
  assoc_to_yojson
    [("ParametersValidTo",
...
let get_parameters_for_import_request_to_yojson
  (x : get_parameters_for_import_request) =
  assoc_to_yojson
    [("WrappingKeySpec",
...
let get_key_rotation_status_response_to_yojson
  (x : get_key_rotation_status_response) =
  assoc_to_yojson
    ...
    ("RotationPeriodInDays",
      (option_to_yojson rotation_period_in_days_type_to_yojson
         x.rotation_period_in_days));
    ("KeyId", (option_to_yojson key_id_type_to_yojson x.key_id));
    ("KeyRotationEnabled",
      (option_to_yojson boolean_type_to_yojson x.key_rotation_enabled))]
let get_key_rotation_status_request_to_yojson
  (x : get_key_rotation_status_request) =
  assoc_to_yojson [("KeyId", (Some (key_id_type_to_yojson x.key_id)))]
...
let recipient_info_to_yojson (x : recipient_info) =
  assoc_to_yojson
    [("AttestationDocument",
       (option_to_yojson attestation_document_type_to_yojson
          x.attestation_document));
    ("KeyEncryptionAlgorithm",
      (option_to_yojson key_encryption_mechanism_to_yojson
         x.key_encryption_algorithm))]
...
let data_key_spec_to_yojson (x : data_key_spec) =
  match x with | AES_128 -> `String "AES_128" | AES_256 -> `String "AES_256"
...
let generate_data_key_pair_without_plaintext_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("PrivateKeyCiphertextBlob",
      (option_to_yojson ciphertext_type_to_yojson
         x.private_key_ciphertext_blob))]
...
let generate_data_key_pair_request_to_yojson
  (x : generate_data_key_pair_request) =
  assoc_to_yojson
    [("DryRun", (option_to_yojson nullable_boolean_type_to_yojson x.dry_run));
    ("Recipient", (option_to_yojson recipient_info_to_yojson x.recipient));
    ("GrantTokens",
...
let custom_key_stores_list_entry_to_yojson (x : custom_key_stores_list_entry)
  ...
  assoc_to_yojson
    [("XksProxyConfiguration",
       (option_to_yojson xks_proxy_configuration_type_to_yojson
          x.xks_proxy_configuration));
    ("CustomKeyStoreType",
      (option_to_yojson custom_key_store_type_to_yojson
         x.custom_key_store_type));
    ("CreationDate", (option_to_yojson date_type_to_yojson x.creation_date));
    ("ConnectionErrorCode",
      (option_to_yojson connection_error_code_type_to_yojson
         x.connection_error_code));
    ("ConnectionState",
      (option_to_yojson connection_state_type_to_yojson x.connection_state));
    ("TrustAnchorCertificate",
      (option_to_yojson trust_anchor_certificate_type_to_yojson
         x.trust_anchor_certificate));
    ("CloudHsmClusterId",
      (option_to_yojson cloud_hsm_cluster_id_type_to_yojson
         x.cloud_hsm_cluster_id));
    ("CustomKeyStoreName",
      (option_to_yojson custom_key_store_name_type_to_yojson
         x.custom_key_store_name));
    ("CustomKeyStoreId",
      (option_to_yojson custom_key_store_id_type_to_yojson
         x.custom_key_store_id))]
...
let describe_custom_key_stores_response_to_yojson
  (x : describe_custom_key_stores_response) =
  assoc_to_yojson
    [("Truncated", (option_to_yojson boolean_type_to_yojson x.truncated));
    ("NextMarker", (option_to_yojson marker_type_to_yojson x.next_marker));
    ("CustomKeyStores",
...
let describe_custom_key_stores_request_to_yojson
  (x : describe_custom_key_stores_request) =
  assoc_to_yojson
    [("Marker", (option_to_yojson marker_type_to_yojson x.marker));
    ("Limit", (option_to_yojson limit_type_to_yojson x.limit));
    ("CustomKeyStoreName",
...
let derive_shared_secret_response_to_yojson
  (x : derive_shared_secret_response) =
  assoc_to_yojson
    [("KeyOrigin", (option_to_yojson origin_type_to_yojson x.key_origin));
    ("KeyAgreementAlgorithm",
      (option_to_yojson key_agreement_algorithm_spec_to_yojson
         x.key_agreement_algorithm));
    ("CiphertextForRecipient",
      (option_to_yojson ciphertext_type_to_yojson x.ciphertext_for_recipient));
    ("SharedSecret",
