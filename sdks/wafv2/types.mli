...
type nonrec json_match_scope = VALUE [@ocaml.doc ""] | KEY [@ocaml.doc ""] | ALL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec map_match_scope = VALUE [@ocaml.doc ""] | KEY [@ocaml.doc ""] | ALL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec fallback_behavior = NO_MATCH [@ocaml.doc ""] | MATCH [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec default_action = {
  ...
  block : block_action option; [@ocaml.doc "Specifies that WAF should block requests by default. \n"]
}
[@@ocaml.doc
...
type nonrec sensitivity_level = HIGH [@ocaml.doc ""] | LOW [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec payload_type = FORM_ENCODED [@ocaml.doc ""] | JSON [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec inspection_level = TARGETED [@ocaml.doc ""] | COMMON [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec usage_of_action = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec label_match_scope = NAMESPACE [@ocaml.doc ""] | LABEL [@ocaml.doc ""] [@@ocaml.doc ""]
...
and statements = statement list [@@ocaml.doc ""]
...
type nonrec data_protection_action = HASH [@ocaml.doc ""] | SUBSTITUTION [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec low_reputation_mode = ALWAYS_ON [@ocaml.doc ""] | ACTIVE_UNDER_DDOS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ip_address_version = IPV6 [@ocaml.doc ""] | IPV4 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec filter_behavior = DROP [@ocaml.doc ""] | KEEP [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec filter_requirement = MEETS_ANY [@ocaml.doc ""] | MEETS_ALL [@ocaml.doc ""]
[@@ocaml.doc ""]
