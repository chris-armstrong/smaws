type nonrec api_key = string [@@ocaml.doc ""]

type nonrec api_key_version = int [@@ocaml.doc ""]

type nonrec timestamp = Smaws_Lib.CoreTypes.Timestamp.t [@@ocaml.doc ""]

type nonrec token_domain = string [@@ocaml.doc ""]

type nonrec token_domains = token_domain list [@@ocaml.doc ""]

type nonrec api_key_summary = {
  token_domains : token_domains option;
      [@ocaml.doc "The token domains that are defined in this API key. \n"]
  api_key : api_key option;
      [@ocaml.doc
  ...
  version : api_key_version option; [@ocaml.doc "Internal value used by WAF to manage the key. \n"]
}
[@@ocaml.doc
...
type nonrec api_key_summaries = api_key_summary list [@@ocaml.doc ""]

type nonrec api_key_token_domains = token_domain list [@@ocaml.doc ""]

type nonrec as_n = Smaws_Lib.CoreTypes.Int64.t [@@ocaml.doc ""]

type nonrec boolean_ = bool [@@ocaml.doc ""]

type nonrec failure_value = string [@@ocaml.doc ""]

type nonrec response_inspection_json_failure_values = failure_value list [@@ocaml.doc ""]

type nonrec success_value = string [@@ocaml.doc ""]

type nonrec response_inspection_json_success_values = success_value list [@@ocaml.doc ""]

type nonrec field_identifier = string [@@ocaml.doc ""]

type nonrec response_inspection_json = {
  identifier : field_identifier;
      [@ocaml.doc
        "The identifier for the value to match against in the JSON. The identifier must be an \
  ...
  failure_values : response_inspection_json_failure_values;
      [@ocaml.doc
        "Values for the specified identifier in the response JSON that indicate a failed login or \
         account creation attempt. To be counted as a failure, the value must be an exact match, \
         including case. Each value must be unique among the success and failure values. \n\n\
        \ JSON example: [\"FailureValues\": \\[ \"False\", \"Failed\" \\]] \n\
        \ "]
}
[@@ocaml.doc
  "Configures inspection of the response JSON. WAF can inspect the first 65,536 bytes (64 KB) of \
   the response JSON. This is part of the [ResponseInspection] configuration for \
   [AWSManagedRulesATPRuleSet] and [AWSManagedRulesACFPRuleSet]. \n\n\
  \  Response inspection is available only in web ACLs that protect Amazon CloudFront distributions.\n\
  \  \n\
  \   "]

type nonrec response_inspection_body_contains_failure_strings = failure_value list [@@ocaml.doc ""]

type nonrec response_inspection_body_contains_success_strings = success_value list [@@ocaml.doc ""]
  ...
  success_strings : response_inspection_body_contains_success_strings;
      [@ocaml.doc
        "Strings in the body of the response that indicate a successful login or account creation \
         attempt. To be counted as a success, the string can be anywhere in the body and must be \
  ...
  failure_strings : response_inspection_body_contains_failure_strings;
      [@ocaml.doc
        "Strings in the body of the response that indicate a failed login or account creation \
         attempt. To be counted as a failure, the string can be anywhere in the body and must be \
         an exact match, including case. Each string must be unique among the success and failure \
         strings. \n\n\
...
[@@ocaml.doc
  "Configures inspection of the response body. WAF can inspect the first 65,536 bytes (64 KB) of \
   the response body. This is part of the [ResponseInspection] configuration for \
   [AWSManagedRulesATPRuleSet] and [AWSManagedRulesACFPRuleSet]. \n\n\
  \  Response inspection is available only in web ACLs that protect Amazon CloudFront distributions.\n\
  \  \n\
  \   "]

type nonrec response_inspection_header_failure_values = failure_value list [@@ocaml.doc ""]

type nonrec response_inspection_header_success_values = success_value list [@@ocaml.doc ""]

type nonrec response_inspection_header_name = string [@@ocaml.doc ""]
  ...
  success_values : response_inspection_header_success_values;
      [@ocaml.doc
        "Values in the response header with the specified name that indicate a successful login or \
         account creation attempt. To be counted as a success, the value must be an exact match, \
         including case. Each value must be unique among the success and failure values. \n\n\
...
type nonrec failure_code = int [@@ocaml.doc ""]

type nonrec response_inspection_status_code_failure_codes = failure_code list [@@ocaml.doc ""]

type nonrec success_code = int [@@ocaml.doc ""]

type nonrec response_inspection_status_code_success_codes = success_code list [@@ocaml.doc ""]
...
type nonrec response_inspection_status_code = {
  ...
  failure_codes : response_inspection_status_code_failure_codes;
      [@ocaml.doc
        "Status codes in the response that indicate a failed login or account creation attempt. To \
         be counted as a failure, the response status code must match one of these. Each code must \
...
type nonrec response_inspection = {
  ...
  body_contains : response_inspection_body_contains option;
      [@ocaml.doc
        "Configures inspection of the response body for success and failure indicators. WAF can \
         inspect the first 65,536 bytes (64 KB) of the response body. \n"]
  json : response_inspection_json option;
      [@ocaml.doc
        "Configures inspection of the response JSON for success and failure indicators. WAF can \
         inspect the first 65,536 bytes (64 KB) of the response JSON. \n"]
}
[@@ocaml.doc
  "The criteria for inspecting responses to login requests and account creation requests, used by \
   the ATP and ACFP rule groups to track login and account creation success and failure rates. \n\n\
  \  Response inspection is available only in web ACLs that protect Amazon CloudFront distributions.\n\
  \  \n\
  \    The rule groups evaluates the responses that your protected resources send back to client \
   login and account creation attempts, keeping count of successful and failed attempts from each \
   IP address and client session. Using this information, the rule group labels and mitigates \
   requests from client sessions and IP addresses with too much suspicious activity in a short \
   amount of time. \n\
  \    \n\
  ...
  \      Enable response inspection by configuring exactly one component of the response to \
   inspect, for example, [Header] or [StatusCode]. You can't configure more than one component for \
   inspection. If you don't configure any of the response inspection options, response inspection \
   is disabled. \n\
  \      "]
  ...
  identifier : field_identifier;
      [@ocaml.doc
        ...
        \        {-  For JSON payloads, specify the field identifiers in JSON pointer syntax. For \
         ...
         documentation {{:https://tools.ietf.org/html/rfc6901}JavaScript Object Notation (JSON) \
         Pointer}. \n\
        \            \n\
        ...
        \             For example, for an HTML form with input elements named \
         [primaryaddressline1], [primaryaddressline2], and [primaryaddressline3], the address \
         fields identifiers are [primaryaddressline1], [primaryaddressline2], and \
         [primaryaddressline3]. \n\
        \             \n\
        \              }\n\
        \        }\n\
...
type nonrec address_fields = address_field list [@@ocaml.doc ""]
  ...
  identifier : field_identifier;
      [@ocaml.doc
        ...
        \             For example, for the JSON payload [{ \"form\": { \"primaryphoneline1\": \
         ...
         \"THE_PHONE3\" } }], the phone number field identifiers are [/form/primaryphoneline1], \
...
type nonrec phone_number_fields = phone_number_field list [@@ocaml.doc ""]
...
type nonrec email_field = {
  identifier : field_identifier;
      [@ocaml.doc
        ...
        \        {-  For form encoded payload types, use the HTML form names.\n\
        \            \n\
        \             For example, for an HTML form with the input element named [email1], the \
  ...
  identifier : field_identifier;
      [@ocaml.doc
        ...
        \             For example, for the JSON payload [{ \"form\": { \"password\": \
         \"THE_PASSWORD\" } }], the password field specification is [/form/password].\n\
        \             \n\
        \              }\n\
        \        {-  For form encoded payload types, use the HTML form names.\n\
        \            \n\
  ...
  identifier : field_identifier;
      [@ocaml.doc
        ...
        \             For example, for the JSON payload [{ \"form\": { \"username\": \
         \"THE_USERNAME\" } }], the username field specification is [/form/username]. \n\
        \             \n\
        \              }\n\
        \        {-  For form encoded payload types, use the HTML form names.\n\
        \            \n\
...
type nonrec payload_type = JSON [@ocaml.doc ""] | FORM_ENCODED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec request_inspection_acf_p = {
  ...
  email_field : email_field option;
      [@ocaml.doc
        ...
        \        }\n\
        \  "]
  phone_number_fields : phone_number_fields option;
      [@ocaml.doc
        ...
        \             \n\
        \              For example, for an HTML form with input elements named \
         [primaryphoneline1], [primaryphoneline2], and [primaryphoneline3], the phone number field \
         identifiers are [primaryphoneline1], [primaryphoneline2], and [primaryphoneline3]. \n\
        \              \n\
        \               }\n\
        \         }\n\
        \  "]
  address_fields : address_fields option;
      [@ocaml.doc
...
type nonrec registration_page_path_string = string [@@ocaml.doc ""]

type nonrec creation_path_string = string [@@ocaml.doc ""]

type nonrec aws_managed_rules_acfp_rule_set = {
  creation_path : creation_path_string;
      [@ocaml.doc
        "The path of the account creation endpoint for your application. This is the page on your \
         website that accepts the completed registration form for a new user. This page must \
         accept [POST] requests.\n\n\
        \ For example, for the URL [https://example.com/web/newaccount], you would provide the \
         path [/web/newaccount]. Account creation page paths that start with the path that you \
         provide are considered a match. For example [/web/newaccount] matches the account \
         creation paths [/web/newaccount], [/web/newaccount/], [/web/newaccountPage], and \
  ...
  registration_page_path : registration_page_path_string;
      [@ocaml.doc
        "The path of the account registration endpoint for your application. This is the page on \
         your website that presents the registration form to new users. \n\n\
        \  This page must accept [GET] text/html requests.\n\
        \  \n\
        \    For example, for the URL [https://example.com/web/registration], you would provide \
         the path [/web/registration]. Registration page paths that start with the path that you \
         provide are considered a match. For example [/web/registration] matches the registration \
         paths [/web/registration], [/web/registration/], [/web/registrationPage], and \
  ...
  response_inspection : response_inspection option;
      [@ocaml.doc
        ...
        \    The ACFP rule group evaluates the responses that your protected resources send back \
         to client account creation attempts, keeping count of successful and failed attempts from \
         each IP address and client session. Using this information, the rule group labels and \
         mitigates requests from client sessions and IP addresses that have had too many \
         successful account creation attempts in a short amount of time. \n\
        \    "]
  enable_regex_in_path : boolean_ option;
      [@ocaml.doc
...
[@@ocaml.doc
  ...
  \ For additional information about this and the other intelligent threat mitigation rule groups, \
   see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-managed-protections}Intelligent \
   threat mitigation in WAF} and \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/aws-managed-rule-groups-list}Amazon \
   Web Services Managed Rules rule groups list} in the {i WAF Developer Guide}. \n\
  \ "]

type nonrec request_inspection = {
  payload_type : payload_type;
      [@ocaml.doc "The payload type for your login endpoint, either JSON or form encoded.\n"]
  ...
  login_path : string_;
      [@ocaml.doc
        "The path of the login endpoint for your application. For example, for the URL \
         [https://example.com/web/login], you would provide the path [/web/login]. Login paths \
         that start with the path that you provide are considered a match. For example \
         [/web/login] matches the login paths [/web/login], [/web/login/], [/web/loginPage], and \
  ...
  response_inspection : response_inspection option;
      [@ocaml.doc
        ...
        \    The ATP rule group evaluates the responses that your protected resources send back to \
         client login attempts, keeping count of successful and failed attempts for each IP \
        ...
        \    "]
  enable_regex_in_path : boolean_ option;
      [@ocaml.doc "Allow the use of regular expressions in the login page path. \n"]
}
[@@ocaml.doc
...
type nonrec regex = {
  regex_string : regex_pattern_string option;
...
[@@ocaml.doc
  "A single regular expression. This is used in a [RegexPatternSet] and also in the configuration \
   for the Amazon Web Services Managed Rules rule group [AWSManagedRulesAntiDDoSRuleSet].\n"]

type nonrec regular_expression_list = regex list [@@ocaml.doc ""]

type nonrec usage_of_action = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  usage_of_action : usage_of_action;
      [@ocaml.doc
        "Determines whether to use the [AWSManagedRulesAntiDDoSRuleSet] rules \
         [ChallengeAllDuringEvent] and [ChallengeDDoSRequests] in the rule group evaluation and \
         the related label [awswaf:managed:aws:anti-ddos:challengeable-request]. \n\n\
        \ {ul\n\
        \       {-  If usage is enabled: \n\
        \           \n\
        \            {ul\n\
        \                  {-  The managed rule group adds the label \
         [awswaf:managed:aws:anti-ddos:challengeable-request] to any web request whose URL does {i \
        ...
        \                  {-  The two rules are evaluated against web requests for protected \
         resources that are experiencing a DDoS attack. The two rules only apply their action to \
        ...
        \     This setting doesn't alter the action setting in the two rules. To override the \
         actions used by the rules [ChallengeAllDuringEvent] and [ChallengeDDoSRequests], enable \
         this setting, and then override the rule actions in the usual way, in your managed rule \
         group configuration. \n\
        \     \n\
        \      "]
  sensitivity : sensitivity_to_act option;
      [@ocaml.doc
        "The sensitivity that the rule group rule [ChallengeDDoSRequests] uses when matching \
         against the DDoS suspicion labeling on a request. The managed rule group adds the \
         labeling during DDoS events, before the [ChallengeDDoSRequests] rule runs. \n\n\
        \ The higher the sensitivity, the more levels of labeling that the rule matches: \n\
        \ \n\
        \  {ul\n\
        \        {-  Low sensitivity is less sensitive, causing the rule to match only on the most \
        ...
        \   Default: [HIGH] \n\
        \   "]
  exempt_uri_regular_expressions : regular_expression_list option;
      [@ocaml.doc
        "The regular expression to match against the web request URI, used to identify requests \
         that can't handle a silent browser challenge. When the [ClientSideAction] setting \
         [UsageOfAction] is enabled, the managed rule group uses this setting to determine which \
         requests to label with [awswaf:managed:aws:anti-ddos:challengeable-request]. If \
         [UsageOfAction] is disabled, this setting has no effect and the managed rule group \
         doesn't add the label to any requests.\n\n\
        \ The anti-DDoS managed rule group doesn't evaluate the rules [ChallengeDDoSRequests] or \
         ...
         regardless of whether you override the rule action for either of the rules in your web \
         ACL configuration. \n\
        \ \n\
...
type nonrec client_side_action_config = {
  challenge : client_side_action;
      [@ocaml.doc
        ...
        \  This setting isn't related to the configuration of the [Challenge] action itself. It \
         only configures the use of the two anti-DDoS rules named here. \n\
        \  \n\
  ...
  client_side_action_config : client_side_action_config;
      [@ocaml.doc
        "Configures the request handling that's applied by the managed rule group rules \
         [ChallengeAllDuringEvent] and [ChallengeDDoSRequests] during a distributed denial of \
         service (DDoS) attack.\n"]
  sensitivity_to_block : sensitivity_to_act option;
      [@ocaml.doc
        "The sensitivity that the rule group rule [DDoSRequests] uses when matching against the \
         DDoS suspicion labeling on a request. The managed rule group adds the labeling during \
         DDoS events, before the [DDoSRequests] rule runs. \n\n\
        \ The higher the sensitivity, the more levels of labeling that the rule matches: \n\
        \ \n\
        \  {ul\n\
        \        {-  Low sensitivity is less sensitive, causing the rule to match only on the most \
...
[@@ocaml.doc
  ...
  \ The configuration that you provide here determines whether and how the rules in the rule group \
   are used. \n\
  \ \n\
  \  For additional information about this and the other intelligent threat mitigation rule \
   groups, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-managed-protections}Intelligent \
   threat mitigation in WAF} and \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/aws-managed-rule-groups-list}Amazon \
...
type nonrec enable_machine_learning = bool [@@ocaml.doc ""]

type nonrec inspection_level = COMMON [@ocaml.doc ""] | TARGETED [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec aws_managed_rules_bot_control_rule_set = {
  inspection_level : inspection_level;
      [@ocaml.doc
        "The inspection level to use for the Bot Control rule group. The common level is the least \
         expensive. The targeted level includes all common level rules and adds rules with more \
         advanced inspection criteria. For details, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/aws-managed-rule-groups-bot.html}WAF \
         Bot Control rule group} in the {i WAF Developer Guide}.\n"]
  enable_machine_learning : enable_machine_learning option;
      [@ocaml.doc
        ...
        \ Determines whether to use machine learning (ML) to analyze your web traffic for \
         ...
         [TGT_ML_CoordinatedActivityLow] and [TGT_ML_CoordinatedActivityMedium], which inspect for \
         anomalous behavior that might indicate distributed, coordinated bot activity.\n\
        \ \n\
        \  For more information about this choice, see the listing for these rules in the table at \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/aws-managed-rule-groups-bot.html#aws-managed-rule-groups-bot-rules}Bot \
         Control rules listing} in the {i WAF Developer Guide}.\n\
        \  \n\
        \   Default: [TRUE] \n\
        \   "]
}
...
type nonrec waf_unavailable_entity_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  "WAF couldn\226\128\153t retrieve a resource that you specified for this operation. If you've \
   just created a resource that you're using in this operation, you might just need to wait a few \
   minutes. It can take from a few seconds to a number of minutes for changes to propagate. Verify \
   the resource specifications in your request parameters and then retry the operation.\n"]
...
type nonrec waf_optimistic_lock_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  "WAF couldn\226\128\153t save your changes because you tried to update or delete a resource that \
   has changed since you last retrieved it. Get the resource again, make any changes you need to \
   make to the new copy, and retry your operation. \n"]

type nonrec waf_nonexistent_item_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  "WAF couldn\226\128\153t perform the operation because your resource doesn't exist. If you've \
   just created a resource that you're using in this operation, you might just need to wait a few \
...
type nonrec waf_limits_exceeded_exception = {
  message : error_message option; [@ocaml.doc ""]
  source_type : source_type option; [@ocaml.doc "Source type for the exception. \n"]
}
[@@ocaml.doc
  "WAF couldn\226\128\153t perform the operation because you exceeded your resource limit. For \
   example, the maximum number of [WebACL] objects that you can create for an Amazon Web Services \
   account. For more information, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/limits.html}WAF quotas} in the {i WAF \
   Developer Guide}.\n"]

type nonrec waf_invalid_resource_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  "WAF couldn\226\128\153t perform the operation because the resource that you requested \
   isn\226\128\153t valid. Check the resource, and try again.\n"]
...
type nonrec waf_invalid_parameter_exception = {
  ...
  parameter : parameter_exception_parameter option;
      [@ocaml.doc "The invalid parameter that resulted in the exception. \n"]
  reason : error_reason option; [@ocaml.doc "Additional information about the exception.\n"]
}
[@@ocaml.doc
...
[@@ocaml.doc "The operation isn't valid. \n"]
...
[@@ocaml.doc
  "The operation failed because the specified version for the managed rule group has expired. You \
   can retrieve the available versions for the managed rule group by calling \
   [ListAvailableManagedRuleGroupVersions].\n"]

type nonrec waf_duplicate_item_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  "WAF couldn\226\128\153t perform the operation because the resource that you tried to save is a \
   duplicate of an existing one.\n"]

type nonrec waf_configuration_warning_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  "The operation failed because you are inspecting the web request body, headers, or cookies \
   without specifying how to handle oversize components. Rules that inspect the body must either \
   provide an [OversizeHandling] configuration or they must be preceded by a \
   [SizeConstraintStatement] that blocks the body content from being too large. Rules that inspect \
   the headers or cookies must provide an [OversizeHandling] configuration. \n\n\
  \ Provide the handling configuration and retry your operation.\n\
  \ \n\
  \  Alternately, you can suppress this warning by adding the following tag to the resource that \
   you provide to this operation: [Tag] (key:[WAF:OversizeFieldsHandlingConstraintOptOut], \
   value:[true]).\n\
  \  "]

type nonrec lock_token = string [@@ocaml.doc ""]
  ...
  next_lock_token : lock_token option;
      [@ocaml.doc
        "A token used for optimistic locking. WAF returns this token to your [update] requests. \
         You use [NextLockToken] in the same manner as you use [LockToken]. \n"]
}
[@@ocaml.doc ""]

type nonrec currency_mode = REAL [@ocaml.doc ""] | TEST [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec attribute_values = attribute_value list [@@ocaml.doc ""]

type nonrec attribute_name = string [@@ocaml.doc ""]

type nonrec application_attribute = {
  name : attribute_name option; [@ocaml.doc "Specifies the attribute name.\n"]
  values : attribute_values option; [@ocaml.doc "Specifies the attribute value.\n"]
}
[@@ocaml.doc
  "Application details defined during the web ACL creation process. Application attributes help \
...
type nonrec application_config = {
  attributes : application_attributes option;
      [@ocaml.doc "Contains the attribute name and a list of values for that attribute.\n"]
}
[@@ocaml.doc "A list of [ApplicationAttribute]s that contains information about the application.\n"]

type nonrec low_reputation_mode = ACTIVE_UNDER_DDOS [@ocaml.doc ""] | ALWAYS_ON [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  alb_low_reputation_mode : low_reputation_mode;
      [@ocaml.doc
        "The level of DDoS protection that applies to web ACLs associated with Application Load \
         Balancers. [ACTIVE_UNDER_DDOS] protection is enabled by default whenever a web ACL is \
         associated with an Application Load Balancer. In the event that an Application Load \
         Balancer experiences high-load conditions or suspected DDoS attacks, the \
         [ACTIVE_UNDER_DDOS] protection automatically rate limits traffic from known low \
         reputation sources without disrupting Application Load Balancer availability. [ALWAYS_ON] \
         protection provides constant, always-on monitoring of known low reputation sources for \
         suspected DDoS attacks. While this provides a higher level of protection, there may be \
  ...
  default_size_inspection_limit : size_inspection_limit;
      [@ocaml.doc
        "Specifies the maximum size of the web request body component that an associated \
         CloudFront, API Gateway, Amazon Cognito, App Runner, or Verified Access resource should \
         send to WAF for inspection. This applies to statements in the web ACL that inspect the \
         body or JSON body. \n\n\
...
[@@ocaml.doc
  "Customizes the maximum size of the request body that your protected CloudFront, API Gateway, \
   Amazon Cognito, App Runner, and Verified Access resources forward to WAF for inspection. The \
   default size is 16 KB (16,384 bytes). You can change the setting for any of the available \
   resource types. \n\n\
  \  You are charged additional fees when your protected resources forward body sizes that are \
   larger than the default. For more information, see {{:http://aws.amazon.com/waf/pricing/}WAF \
   Pricing}.\n\
  \  \n\
  \    Example JSON: [ {\n\
  \    \"API_GATEWAY\": \"KB_48\",\n\
...
type nonrec request_body =
  (associated_resource_type * request_body_associated_resource_type_config) list
[@@ocaml.doc ""]
  ...
  request_body : request_body option;
      [@ocaml.doc
        "Customizes the maximum size of the request body that your protected CloudFront, API \
         Gateway, Amazon Cognito, App Runner, and Verified Access resources forward to WAF for \
         inspection. The default size is 16 KB (16,384 bytes). You can change the setting for any \
         of the available resource types. \n\n\
        \  You are charged additional fees when your protected resources forward body sizes that \
         are larger than the default. For more information, see \
...
[@@ocaml.doc
  ...
  \ Use this to customize the maximum size of the request body that your protected resources \
   forward to WAF for inspection. You can customize this setting for CloudFront, API Gateway, \
...
[@@ocaml.doc
  "Used for CAPTCHA and challenge token settings. Determines how long a [CAPTCHA] or challenge \
   timestamp remains valid after WAF updates it for a successful [CAPTCHA] or challenge response. \n"]
...
[@@ocaml.doc
  "Specifies how WAF should handle [Challenge] evaluations. This is available at the web ACL level \
   and in each rule. \n"]
...
[@@ocaml.doc
  "Specifies how WAF should handle [CAPTCHA] evaluations. This is available at the web ACL level \
   and in each rule. \n"]

type nonrec response_content = string [@@ocaml.doc ""]
  ...
  content : response_content;
      [@ocaml.doc
        ...
        \  For information about the limits on count and size for custom request and response \
         settings, see {{:https://docs.aws.amazon.com/waf/latest/developerguide/limits.html}WAF \
         quotas} in the {i WAF Developer Guide}. \n\
        \  "]
}
[@@ocaml.doc
...
type nonrec custom_response_bodies = (entity_name * custom_response_body) list [@@ocaml.doc ""]

type nonrec data_protection_action = SUBSTITUTION [@ocaml.doc ""] | HASH [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec field_to_protect_key_name = string [@@ocaml.doc ""]

type nonrec field_to_protect_keys = field_to_protect_key_name list [@@ocaml.doc ""]
...
type nonrec field_to_protect = {
  ...
  field_keys : field_to_protect_keys option;
      [@ocaml.doc
        "Specifies the keys to protect for the specified field type. If you don't specify any key, \
         then all keys for the field type are protected. \n"]
}
[@@ocaml.doc
...
type nonrec data_protection = {
  ...
  action : data_protection_action;
      [@ocaml.doc
        ...
        \       }\n\
        \  "]
  exclude_rule_match_details : boolean_ option;
      [@ocaml.doc
        "Specifies whether to also exclude any rule match details from the data protection you \
         have enabled for a given field. WAF logs these details for non-terminating matching rules \
         and for the terminating matching rule. For additional information, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/logging-fields.html}Log fields \
         for web ACL traffic} in the {i WAF Developer Guide}.\n\n\
        \ Default: [FALSE] \n\
        \ "]
  exclude_rate_based_details : boolean_ option;
      [@ocaml.doc
        "Specifies whether to also exclude any rate-based rule details from the data protection \
         you have enabled for a given field. If you specify this exception, RateBasedDetails will \
         show the value of the field. For additional information, see the log field \
         [rateBasedRuleList] at \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/logging-fields.html}Log fields \
         for web ACL traffic} in the {i WAF Developer Guide}.\n\n\
        \ Default: [FALSE] \n\
        \ "]
...
type nonrec data_protections = data_protection list [@@ocaml.doc ""]

type nonrec data_protection_config = {
  data_protections : data_protections;
      [@ocaml.doc
        "An array of data protection configurations for specific web request field types. This is \
         defined for each web ACL. WAF applies the specified protection to all web requests that \
         the web ACL inspects. \n"]
}
[@@ocaml.doc
  "Specifies data protection to apply to the web request data for the web ACL. This is a web ACL \
   level data protection option. \n\n\
  \ The data protection that you configure for the web ACL alters the data that's available for \
   any other data collection activity, including your WAF logging destinations, web ACL request \
  ...
  cloud_watch_metrics_enabled : boolean_;
      [@ocaml.doc
        "Indicates whether the associated resource sends metrics to Amazon CloudWatch. For the \
         ...
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/monitoring-cloudwatch.html#waf-metrics}WAF \
         Metrics} in the {i WAF Developer Guide}.\n\n\
        \ For web ACLs, the metrics are for web requests that have the web ACL default action \
         applied. WAF applies the default action to web requests that pass the inspection of all \
         rules in the web ACL without being either allowed or blocked. For more information, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/web-acl-default-action.html}The \
         web ACL default action} in the {i WAF Developer Guide}.\n\
        \ "]
  metric_name : metric_name;
      [@ocaml.doc
        "A name of the Amazon CloudWatch metric dimension. The name can contain only the \
         characters: A-Z, a-z, 0-9, - (hyphen), and _ (underscore). The name can be from one to \
         128 characters long. It can't contain whitespace or metric names that are reserved for \
...
type nonrec label_name = string [@@ocaml.doc ""]

type nonrec label = { name : label_name [@ocaml.doc "The label string. \n"] }
[@@ocaml.doc
...
type nonrec none_action = unit [@@ocaml.doc ""]

type nonrec custom_http_header_value = string [@@ocaml.doc ""]

type nonrec custom_http_header_name = string [@@ocaml.doc ""]

type nonrec custom_http_header = {
  name : custom_http_header_name;
      [@ocaml.doc
        "The name of the custom header. \n\n\
        \ For custom request header insertion, when WAF inserts the header into the request, it \
         prefixes this name [x-amzn-waf-], to avoid confusion with the headers that are already in \
         the request. For example, for the header name [sample], WAF inserts the header \
         [x-amzn-waf-sample].\n\
        \ "]
  value : custom_http_header_value; [@ocaml.doc "The value of the custom header.\n"]
}
[@@ocaml.doc
...
type nonrec custom_request_handling = {
  insert_headers : custom_http_headers;
      [@ocaml.doc
...
[@@ocaml.doc
  "Custom request handling behavior that inserts custom headers into a web request. You can add \
   custom request handling for WAF to use when the rule action doesn't block the request. For \
   example, [CaptchaAction] for requests with valid t okens, and [AllowAction]. \n\n\
  \ For information about customizing web requests and responses, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-custom-request-response.html}Customizing \
   web requests and responses in WAF} in the {i WAF Developer Guide}. \n\
  \ "]
...
[@@ocaml.doc
  "Specifies that WAF should count the request. Optionally defines additional custom handling for \
   the request.\n\n\
  ...
  count : count_action option;
      [@ocaml.doc
        ...
        \  This option is usually set to none. It does not affect how the rules in the rule group \
         are evaluated. If you want the rules in the rule group to only count matches, do not use \
         this and instead use the rule action override option, with [Count] action, in your rule \
...
[@@ocaml.doc
  "Specifies that WAF should run a [Challenge] check against the request to verify that the \
   request is coming from a legitimate client session: \n\n\
  \ {ul\n\
  \       {-  If the request includes a valid, unexpired challenge token, WAF applies any custom \
   request handling and labels that you've configured and then allows the web request inspection \
   to proceed to the next rule, similar to a [CountAction]. \n\
  \           \n\
  \            }\n\
  ...
  \                       \n\
  \                        }\n\
  \                   {-  If the request contains an [Accept] header with a value of [text/html], \
  ...
  \          A challenge enforces token acquisition using an interstitial JavaScript challenge \
   that inspects the client session for legitimate behavior. The challenge blocks bots or at least \
...
[@@ocaml.doc
  ...
  \ {ul\n\
  \       {-  If the request includes a valid, unexpired [CAPTCHA] token, WAF applies any custom \
   request handling and labels that you've configured and then allows the web request inspection \
   to proceed to the next rule, similar to a [CountAction]. \n\
  \           \n\
  \            }\n\
  ...
  \                        }\n\
  \                   {-  If the request contains an [Accept] header with a value of [text/html], \
   the response includes a [CAPTCHA] JavaScript page interstitial. \n\
  \                       \n\
  \                        }\n\
  \                   \n\
  \        }\n\
...
[@@ocaml.doc
  "Specifies that WAF should allow the request and optionally defines additional custom handling \
   for the request.\n\n\
  \ This is used in the context of other settings, for example to specify values for [RuleAction] \
   and web ACL [DefaultAction]. \n\
  \ "]

type nonrec response_status_code = int [@@ocaml.doc ""]
  ...
  response_code : response_status_code;
      [@ocaml.doc
        ...
        \ For a list of status codes that you can use in your custom responses, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/customizing-the-response-status-codes.html}Supported \
         status codes for custom response} in the {i WAF Developer Guide}. \n\
        \ "]
  custom_response_body_key : entity_name option;
      [@ocaml.doc
        "References the response body that you want WAF to return to the web request client. You \
         can define a custom response for a rule action or a default web ACL action that is set to \
         block. To do this, you first define the response body key and value in the \
         [CustomResponseBodies] setting for the [WebACL] or [RuleGroup] where you want to use it. \
         Then, in the rule action or web ACL default action [BlockAction] setting, you reference \
         the response body using this key. \n"]
  response_headers : custom_http_headers option;
      [@ocaml.doc
...
[@@ocaml.doc
  "A custom response to send to the client. You can define a custom response for rule actions and \
   default web ACL actions that are set to [BlockAction]. \n\n\
  \ For information about customizing web requests and responses, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-custom-request-response.html}Customizing \
   web requests and responses in WAF} in the {i WAF Developer Guide}. \n\
  \ "]
...
[@@ocaml.doc
  "Specifies that WAF should block the request and optionally defines additional custom handling \
...
type nonrec rule_action = {
  block : block_action option; [@ocaml.doc "Instructs WAF to block the web request.\n"]
  allow : allow_action option; [@ocaml.doc "Instructs WAF to allow the web request.\n"]
  count : count_action option;
      [@ocaml.doc
        "Instructs WAF to count the web request and then continue evaluating the request using the \
         remaining rules in the web ACL.\n"]
  captcha : captcha_action option;
      [@ocaml.doc "Instructs WAF to run a [CAPTCHA] check against the web request.\n"]
...
[@@ocaml.doc
  "The action that WAF should take on a web request when it matches a rule's statement. Settings \
   at the web ACL level can override the rule action setting. \n"]

type nonrec fallback_behavior = MATCH [@ocaml.doc ""] | NO_MATCH [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec forwarded_ip_header_name = string [@@ocaml.doc ""]
...
type nonrec forwarded_ip_config = {
  header_name : forwarded_ip_header_name;
      [@ocaml.doc
        ...
        \  If the specified header isn't present in the request, WAF doesn't apply the rule to the \
         web request at all.\n\
        \  \n\
        \   "]
...
[@@ocaml.doc
  ...
  \  If the specified header isn't present in the request, WAF doesn't apply the rule to the web \
   request at all.\n\
  \  \n\
...
[@@ocaml.doc
  ...
  \ For additional details, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-rule-statement-type-asn-match.html}ASN \
   match rule statement} in the \
...
type nonrec text_transformation_priority = int [@@ocaml.doc ""]
  ...
  type_ : text_transformation_type;
      [@ocaml.doc
        "For detailed descriptions of each of the transformation types, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-rule-statement-transformation.html}Text \
         transformations} in the {i WAF Developer Guide}.\n"]
}
[@@ocaml.doc
...
type nonrec text_transformations = text_transformation list [@@ocaml.doc ""]

type nonrec uri_fragment = {
  fallback_behavior : fallback_behavior option;
      [@ocaml.doc
        "What WAF should do if it fails to completely parse the JSON body. The options are the \
         following:\n\n\
        \ {ul\n\
        ...
        \    \n\
        \      WAF parsing doesn't fully validate the input JSON string, so parsing can succeed \
         even for invalid JSON. When parsing succeeds, WAF doesn't apply the fallback behavior. \
         For more information, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-rule-statement-fields-list.html#waf-rule-statement-request-component-json-body}JSON \
         body} in the {i WAF Developer Guide}.\n\
        \      \n\
        \       "]
}
[@@ocaml.doc
  "Inspect fragments of the request URI. You can specify the parts of the URI fragment to inspect \
   and you can narrow the set of URI fragments to inspect by including or excluding specific keys. \
   \n\n\
...
[@@ocaml.doc
  "Available for use with Amazon CloudFront distributions and Application Load Balancers. Match \
   against the request's JA4 fingerprint. The JA4 fingerprint is a 36-character hash derived from \
   the TLS Client Hello of an incoming request. This fingerprint serves as a unique identifier for \
   the client's TLS configuration. WAF calculates and logs this fingerprint for each request that \
   has enough TLS Client Hello information for the calculation. Almost all web requests include \
   this information.\n\n\
  \  You can use this choice only with a string match [ByteMatchStatement] with the \
   [PositionalConstraint] set to [EXACTLY]. \n\
  \  \n\
  \    You can obtain the JA4 fingerprint for client requests from the web ACL logs. If WAF is \
   able to calculate the fingerprint, it includes it in the logs. For information about the \
   logging fields, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/logging-fields.html}Log fields} in the \
   {i WAF Developer Guide}. \n\
  \    \n\
...
[@@ocaml.doc
  "Available for use with Amazon CloudFront distributions and Application Load Balancers. Match \
   against the request's JA3 fingerprint. The JA3 fingerprint is a 32-character hash derived from \
   the TLS Client Hello of an incoming request. This fingerprint serves as a unique identifier for \
   the client's TLS configuration. WAF calculates and logs this fingerprint for each request that \
   has enough TLS Client Hello information for the calculation. Almost all web requests include \
   this information.\n\n\
  \  You can use this choice only with a string match [ByteMatchStatement] with the \
   [PositionalConstraint] set to [EXACTLY]. \n\
  \  \n\
  \    You can obtain the JA3 fingerprint for client requests from the web ACL logs. If WAF is \
   able to calculate the fingerprint, it includes it in the logs. For information about the \
   logging fields, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/logging-fields.html}Log fields} in the \
   {i WAF Developer Guide}. \n\
...
type nonrec header_order = {
  oversize_handling : oversize_handling;
      [@ocaml.doc
        "What WAF should do if the headers determined by your match scope are more numerous or \
         larger than WAF can inspect. WAF does not support inspecting the entire contents of \
         request headers when they exceed 8 KB (8192 bytes) or 200 total headers. The underlying \
         host service forwards a maximum of 200 headers and at most 8 KB of header contents to \
         WAF. \n\n\
...
[@@ocaml.doc
  "Inspect a string containing the list of the request's header names, ordered as they appear in \
   the web request that WAF receives for inspection. WAF generates the string and then uses that \
   as the field to match component in its inspection. WAF separates the header names in the string \
   using colons and no added spaces, for example [host:user-agent:accept:authorization:referer].\n"]

type nonrec map_match_scope = ALL [@ocaml.doc ""] | KEY [@ocaml.doc ""] | VALUE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec single_cookie_name = string [@@ocaml.doc ""]

type nonrec cookie_names = single_cookie_name list [@@ocaml.doc ""]

type nonrec all = unit [@@ocaml.doc ""]

type nonrec cookie_match_pattern = {
  all : all option; [@ocaml.doc "Inspect all cookies. \n"]
  included_cookies : cookie_names option;
      [@ocaml.doc
        "Inspect only the cookies that have a key that matches one of the strings specified here. \n"]
  excluded_cookies : cookie_names option;
      [@ocaml.doc
  ...
  match_scope : map_match_scope;
      [@ocaml.doc
        ...
        \  [All] does not require a match to be found in the keys and a match to be found in the \
         values. It requires a match to be found in the keys or the values or both. To require a \
         match in the keys and in the values, use a logical [AND] statement to combine two match \
         rules, one that inspects the keys and another that inspects the values. \n\
        \ "]
  oversize_handling : oversize_handling;
      [@ocaml.doc
        "What WAF should do if the cookies of the request are more numerous or larger than WAF can \
         inspect. WAF does not support inspecting the entire contents of request cookies when they \
         exceed 8 KB (8192 bytes) or 200 total cookies. The underlying host service forwards a \
...
[@@ocaml.doc
  "Inspect the cookies in the web request. You can specify the parts of the cookies to inspect and \
...
type nonrec field_to_match_data = string [@@ocaml.doc ""]

type nonrec header_names = field_to_match_data list [@@ocaml.doc ""]

type nonrec header_match_pattern = {
  all : all option; [@ocaml.doc "Inspect all headers. \n"]
  included_headers : header_names option;
      [@ocaml.doc
        "Inspect only the headers that have a key that matches one of the strings specified here. \n"]
  excluded_headers : header_names option;
      [@ocaml.doc
...
[@@ocaml.doc
  "Inspect all headers in the web request. You can specify the parts of the headers to inspect and \
...
type nonrec json_match_scope = ALL [@ocaml.doc ""] | KEY [@ocaml.doc ""] | VALUE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec json_pointer_path = string [@@ocaml.doc ""]

type nonrec json_pointer_paths = json_pointer_path list [@@ocaml.doc ""]
...
type nonrec json_match_pattern = {
  all : all option;
      [@ocaml.doc
        ...
        \ "]
  included_paths : json_pointer_paths option;
      [@ocaml.doc
        "Match only the specified include paths. See also [MatchScope] in [JsonBody]. \n\n\
        \ Provide the include paths using JSON Pointer syntax. For example, [\"IncludedPaths\":\n\
        \            \\[\"/dogs/0/name\", \"/dogs/1/name\"\\]]. For information about this syntax, \
         see the Internet Engineering Task Force (IETF) documentation \
...
[@@ocaml.doc
  "The patterns to look for in the JSON body. WAF inspects the results of these pattern matches \
   against the rule inspection criteria. This is used with the [FieldToMatch] option [JsonBody]. \n"]
  ...
  oversize_handling : oversize_handling option;
      [@ocaml.doc
        ...
        \ WAF does not support inspecting the entire contents of the web request body if the body \
         exceeds the limit for the resource type. When a web request body is larger than the \
         limit, the underlying host service only forwards the contents that are within the limit \
        ...
        \            \n\
        \             }\n\
        \        {-  For CloudFront, API Gateway, Amazon Cognito, App Runner, and Verified Access, \
         the default limit is 16 KB (16,384 bytes), and you can increase the limit for each \
         resource type in the web ACL [AssociationConfig], for additional processing fees. \n\
        \            \n\
        \             }\n\
        ...
        \   You can combine the [MATCH] or [NO_MATCH] settings for oversize handling with your \
         rule and web ACL action settings, so that you block any request whose body is over the \
         limit. \n\
        \   \n\
        \    Default: [CONTINUE] \n\
        \    "]
...
[@@ocaml.doc
  ...
  \  Use the specifications in this object to indicate which parts of the JSON body to inspect \
   using the rule's inspection criteria. WAF inspects only the parts of the JSON that result from \
   the matches that you indicate. \n\
  \  \n\
...
type nonrec method_ = unit [@@ocaml.doc ""]
...
type nonrec query_string = unit [@@ocaml.doc ""]

type nonrec uri_path = unit [@@ocaml.doc ""]

type nonrec all_query_arguments = unit [@@ocaml.doc ""]

type nonrec single_query_argument = {
  name : field_to_match_data; [@ocaml.doc "The name of the query argument to inspect.\n"]
}
[@@ocaml.doc
  "Inspect one query argument in the web request, identified by name, for example {i UserName} or \
   {i SalesRegion}. The name isn't case sensitive. \n\n\
  \ This is used to indicate the web request component to inspect, in the [FieldToMatch] \
   specification. \n\
  \ \n\
...
type nonrec single_header = {
  name : field_to_match_data; [@ocaml.doc "The name of the query header to inspect.\n"]
}
[@@ocaml.doc
  "Inspect one of the headers in the web request, identified by name, for example, [User-Agent] or \
   [Referer]. The name isn't case sensitive.\n\n\
...
type nonrec field_to_match = {
  ...
  single_query_argument : single_query_argument option;
      [@ocaml.doc
        "Inspect a single query argument. Provide the name of the query argument to inspect, such \
         as {i UserName} or {i SalesRegion}. The name can be up to 30 characters long and isn't \
         case sensitive. \n\n\
        \ Example JSON: [\"SingleQueryArgument\": { \"Name\": \"myArgument\" }] \n\
        \ "]
  all_query_arguments : all_query_arguments option; [@ocaml.doc "Inspect all query arguments. \n"]
  ...
  query_string : query_string option;
      [@ocaml.doc
        "Inspect the query string. This is the part of a URL that appears after a [?] character, \
         if any.\n"]
  body : body option;
      [@ocaml.doc
  ...
  headers : headers option;
      [@ocaml.doc
        ...
        \ Only the first 8 KB (8192 bytes) of a request's headers and only the first 200 headers \
         ...
         how to handle any oversize header content in the [Headers] object. WAF applies the \
         pattern matching filters to the headers that it receives from the underlying host \
         service. \n\
        \ "]
  cookies : cookies option;
      [@ocaml.doc
        ...
        \ Only the first 8 KB (8192 bytes) of a request's cookies and only the first 200 cookies \
         are forwarded to WAF for inspection by the underlying host service. You must configure \
         how to handle any oversize cookie content in the [Cookies] object. WAF applies the \
         pattern matching filters to the cookies that it receives from the underlying host \
         service. \n\
        \ "]
  header_order : header_order option;
      [@ocaml.doc
        "Inspect a string containing the list of the request's header names, ordered as they \
         appear in the web request that WAF receives for inspection. WAF generates the string and \
         then uses that as the field to match component in its inspection. WAF separates the \
         header names in the string using colons and no added spaces, for example \
  ...
  ja3_fingerprint : ja3_fingerprint option;
      [@ocaml.doc
        "Available for use with Amazon CloudFront distributions and Application Load Balancers. \
         ...
         derived from the TLS Client Hello of an incoming request. This fingerprint serves as a \
         unique identifier for the client's TLS configuration. WAF calculates and logs this \
         fingerprint for each request that has enough TLS Client Hello information for the \
        ...
        \    You can obtain the JA3 fingerprint for client requests from the web ACL logs. If WAF \
         is able to calculate the fingerprint, it includes it in the logs. For information about \
         the logging fields, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/logging-fields.html}Log fields} \
  ...
  uri_fragment : uri_fragment option;
      [@ocaml.doc
        "Inspect fragments of the request URI. You must configure scope and pattern matching \
         filters in the [UriFragment] object, to define the fragment of a URI that WAF inspects. \n\n\
        \ Only the first 8 KB (8192 bytes) of a request's URI fragments and only the first 200 URI \
         fragments are forwarded to WAF for inspection by the underlying host service. You must \
...
[@@ocaml.doc
  "Specifies a web request component to be used in a rule match statement or in a logging \
   configuration. \n\n\
  \ {ul\n\
  \       {-  In a rule statement, this is the part of the web request that you want WAF to \
   ...
   [FieldToMatch] for each rule statement that requires it. To inspect more than one component of \
   the web request, create a separate rule statement for each component.\n\
  \           \n\
  ...
  \               \n\
  \                }\n\
  \       {-  In a logging configuration, this is used in the [RedactedFields] property to specify \
   a field to redact from the logging records. For this use case, note the following: \n\
  \           \n\
  \            {ul\n\
  \                  {-  Even though all [FieldToMatch] settings are available, the only valid \
   settings for field redaction are [UriPath], [QueryString], [SingleHeader], and [Method].\n\
  \                      \n\
  \                       }\n\
  \                  {-  In this documentation, the descriptions of the individual fields talk \
   about specifying the web request component to inspect, but for field redaction, you are \
   specifying the component type to redact from the logs. \n\
  \                      \n\
  \                       }\n\
  \                  {-  If you have request sampling enabled, the redacted fields configuration \
   for logging has no impact on sampling. You can only exclude fields from request sampling by \
   disabling sampling in the web ACL visibility configuration or by configuring data protection \
   for the web ACL.\n\
  \                      \n\
  \                       }\n\
  \                  \n\
...
type nonrec regex_match_statement = {
  ...
  field_to_match : field_to_match;
      [@ocaml.doc "The part of the web request that you want WAF to inspect. \n"]
  text_transformations : text_transformations;
      [@ocaml.doc
        "Text transformations eliminate some of the unusual formatting that attackers use in web \
         requests in an effort to bypass detection. Text transformations are used in rule match \
         statements, to transform the [FieldToMatch] request component before inspecting it, and \
         they're used in rate-based rule statements, to transform request components before using \
         them as custom aggregation keys. If you specify one or more transformations to apply, WAF \
         performs all transformations on the specified content, starting from the lowest priority \
...
type nonrec label_match_key = string [@@ocaml.doc ""]

type nonrec label_match_scope = LABEL [@ocaml.doc ""] | NAMESPACE [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  key : label_match_key;
      [@ocaml.doc
        ...
        \       {-  If the [Scope] indicates [LABEL], then this specification must include the \
         name and can include any number of preceding namespace specifications and prefix up to \
         providing the fully qualified label name. \n\
        \           \n\
        \            }\n\
        \       {-  If the [Scope] indicates [NAMESPACE], then this specification can include any \
         number of contiguous namespace strings, and can include the entire label namespace prefix \
         from the rule group or web ACL where the label originates.\n\
        \           \n\
        \            }\n\
        \       }\n\
...
[@@ocaml.doc
  ...
  \ The label match statement provides the label or namespace string to search for. The label \
   ...
   not provide the fully qualified name in your label match string, WAF performs the search for \
...
type nonrec rule_action_overrides = rule_action_override list [@@ocaml.doc ""]

type nonrec login_path_string = string [@@ocaml.doc ""]

type nonrec managed_rule_group_config = {
  login_path : login_path_string option;
      [@ocaml.doc
  ...
  aws_managed_rules_bot_control_rule_set : aws_managed_rules_bot_control_rule_set option;
      [@ocaml.doc
        "Additional configuration for using the Bot Control managed rule group. Use this to \
         specify the inspection level that you want to use. For information about using the Bot \
         Control managed rule group, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/aws-managed-rule-groups-bot.html}WAF \
         Bot Control rule group} and \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-bot-control.html}WAF Bot \
         Control} in the {i WAF Developer Guide}.\n"]
  aws_managed_rules_atp_rule_set : aws_managed_rules_atp_rule_set option;
      [@ocaml.doc
        "Additional configuration for using the account takeover prevention (ATP) managed rule \
         group, [AWSManagedRulesATPRuleSet]. Use this to provide login request information to the \
         rule group. For web ACLs that protect CloudFront distributions, use this to also provide \
        ...
        \  For information about using the ATP managed rule group, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/aws-managed-rule-groups-atp.html}WAF \
         Fraud Control account takeover prevention (ATP) rule group} and \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-atp.html}WAF Fraud Control \
         account takeover prevention (ATP)} in the {i WAF Developer Guide}.\n\
        \  "]
  aws_managed_rules_acfp_rule_set : aws_managed_rules_acfp_rule_set option;
      [@ocaml.doc
        "Additional configuration for using the account creation fraud prevention (ACFP) managed \
         rule group, [AWSManagedRulesACFPRuleSet]. Use this to provide account creation request \
         information to the rule group. For web ACLs that protect CloudFront distributions, use \
         this to also provide the information about how your distribution responds to account \
         creation requests. \n\n\
        \ For information about using the ACFP managed rule group, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/aws-managed-rule-groups-acfp.html}WAF \
         Fraud Control account creation fraud prevention (ACFP) rule group} and \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-acfp.html}WAF Fraud Control \
         account creation fraud prevention (ACFP)} in the {i WAF Developer Guide}.\n\
        \ "]
  aws_managed_rules_anti_d_do_s_rule_set : aws_managed_rules_anti_d_do_s_rule_set option;
      [@ocaml.doc
        "Additional configuration for using the anti-DDoS managed rule group, \
         [AWSManagedRulesAntiDDoSRuleSet]. Use this to configure anti-DDoS behavior for the rule \
         group. \n\n\
        \ For information about using the anti-DDoS managed rule group, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/aws-managed-rule-groups-anti-ddos.html}WAF \
         Anti-DDoS rule group} and \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-anti-ddos.html}Distributed \
         Denial of Service (DDoS) prevention} in the {i WAF Developer Guide}.\n\
        \ "]
}
[@@ocaml.doc
  ...
  \        {-  Use the [AWSManagedRulesAntiDDoSRuleSet] configuration object to configure the \
   anti-DDoS managed rule group. The configuration includes the sensitivity levels to use in the \
   rules that typically block and challenge requests that might be participating in DDoS attacks \
   and the specification to use to indicate whether a request can handle a silent browser \
   challenge. \n\
  \            \n\
  \             }\n\
...
type nonrec managed_rule_group_configs = managed_rule_group_config list [@@ocaml.doc ""]

type nonrec excluded_rule = {
  name : entity_name;
      [@ocaml.doc "The name of the rule whose action you want to override to [Count].\n"]
}
[@@ocaml.doc
...
type nonrec version_key_string = string [@@ocaml.doc ""]

type nonrec vendor_name = string [@@ocaml.doc ""]

type nonrec rate_limit_asn = unit [@@ocaml.doc ""]
...
[@@ocaml.doc
  "Use the request's JA4 fingerprint derived from the TLS Client Hello of an incoming request as \
   an aggregate key. If you use a single JA4 fingerprint as your custom key, then each value fully \
...
[@@ocaml.doc
  " Use the request's JA3 fingerprint derived from the TLS Client Hello of an incoming request as \
   an aggregate key. If you use a single JA3 fingerprint as your custom key, then each value fully \
   defines an aggregation instance. \n"]
...
[@@ocaml.doc
  "Specifies the request's URI path as an aggregate key for a rate-based rule. Each distinct URI \
   path contributes to the aggregation instance. If you use just the URI path as your custom key, \
   then each URI path fully defines an aggregation instance. \n"]

type nonrec label_namespace = string [@@ocaml.doc ""]

type nonrec rate_limit_label_namespace = {
  namespace : label_namespace; [@ocaml.doc "The namespace to use for aggregation. \n"]
}
[@@ocaml.doc
  "Specifies a label namespace to use as an aggregate key for a rate-based rule. Each distinct \
   fully qualified label name that has the specified label namespace contributes to the \
   aggregation instance. If you use just one label namespace as your custom key, then each label \
  ...
  \  For information about label namespaces and names, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-rule-label-requirements.html}Label \
   syntax and naming requirements} in the {i WAF Developer Guide}.\n\
  \  "]

type nonrec rate_limit_i_p = unit [@@ocaml.doc ""]

type nonrec rate_limit_forwarded_i_p = unit [@@ocaml.doc ""]

type nonrec rate_limit_http_method = unit [@@ocaml.doc ""]
...
[@@ocaml.doc
  "Specifies the request's query string as an aggregate key for a rate-based rule. Each distinct \
   string contributes to the aggregation instance. If you use just the query string as your custom \
   key, then each string fully defines an aggregation instance. \n"]

type nonrec rate_limit_query_argument = {
  name : field_to_match_data; [@ocaml.doc "The name of the query argument to use. \n"]
  text_transformations : text_transformations;
      [@ocaml.doc
        "Text transformations eliminate some of the unusual formatting that attackers use in web \
         requests in an effort to bypass detection. Text transformations are used in rule match \
...
[@@ocaml.doc
  "Specifies a query argument in the request as an aggregate key for a rate-based rule. Each \
   distinct value for the named query argument contributes to the aggregation instance. If you use \
   a single query argument as your custom key, then each value fully defines an aggregation \
   instance. \n"]

type nonrec rate_limit_cookie = {
  name : field_to_match_data; [@ocaml.doc "The name of the cookie to use. \n"]
  text_transformations : text_transformations;
      [@ocaml.doc
        "Text transformations eliminate some of the unusual formatting that attackers use in web \
         requests in an effort to bypass detection. Text transformations are used in rule match \
...
[@@ocaml.doc
  "Specifies a cookie as an aggregate key for a rate-based rule. Each distinct value in the cookie \
   contributes to the aggregation instance. If you use a single cookie as your custom key, then \
   each value fully defines an aggregation instance. \n"]

type nonrec rate_limit_header = {
  name : field_to_match_data; [@ocaml.doc "The name of the header to use. \n"]
  text_transformations : text_transformations;
      [@ocaml.doc
        "Text transformations eliminate some of the unusual formatting that attackers use in web \
         requests in an effort to bypass detection. Text transformations are used in rule match \
...
[@@ocaml.doc
  "Specifies a header as an aggregate key for a rate-based rule. Each distinct value in the header \
   contributes to the aggregation instance. If you use a single header as your custom key, then \
   each value fully defines an aggregation instance. \n"]

type nonrec rate_based_statement_custom_key = {
  header : rate_limit_header option;
      [@ocaml.doc
        "Use the value of a header in the request as an aggregate key. Each distinct value in the \
         header contributes to the aggregation instance. If you use a single header as your custom \
         key, then each value fully defines an aggregation instance. \n"]
  cookie : rate_limit_cookie option;
      [@ocaml.doc
        "Use the value of a cookie in the request as an aggregate key. Each distinct value in the \
         cookie contributes to the aggregation instance. If you use a single cookie as your custom \
         key, then each value fully defines an aggregation instance. \n"]
  query_argument : rate_limit_query_argument option;
      [@ocaml.doc
        "Use the specified query argument as an aggregate key. Each distinct value for the named \
         query argument contributes to the aggregation instance. If you use a single query \
         argument as your custom key, then each value fully defines an aggregation instance. \n"]
  query_string : rate_limit_query_string option;
      [@ocaml.doc
        "Use the request's query string as an aggregate key. Each distinct string contributes to \
         the aggregation instance. If you use just the query string as your custom key, then each \
  ...
  forwarded_i_p : rate_limit_forwarded_i_p option;
      [@ocaml.doc
        ...
        \ When you specify an IP or forwarded IP in the custom key settings, you must also specify \
         at least one other key to use. You can aggregate on only the forwarded IP address by \
         specifying [FORWARDED_IP] in your rate-based statement's [AggregateKeyType]. \n\
        \ \n\
  ...
  i_p : rate_limit_i_p option;
      [@ocaml.doc
        ...
        \ When you specify an IP or forwarded IP in the custom key settings, you must also specify \
         ...
         [IP] in your rate-based statement's [AggregateKeyType]. \n\
        \ "]
  label_namespace : rate_limit_label_namespace option;
      [@ocaml.doc
        "Use the specified label namespace as an aggregate key. Each distinct fully qualified \
         label name that has the specified label namespace contributes to the aggregation \
         instance. If you use just one label namespace as your custom key, then each label name \
  ...
  uri_path : rate_limit_uri_path option;
      [@ocaml.doc
        "Use the request's URI path as an aggregate key. Each distinct URI path contributes to the \
         aggregation instance. If you use just the URI path as your custom key, then each URI path \
         fully defines an aggregation instance. \n"]
  ja3_fingerprint : rate_limit_ja3_fingerprint option;
      [@ocaml.doc
        " Use the request's JA3 fingerprint as an aggregate key. If you use a single JA3 \
         fingerprint as your custom key, then each value fully defines an aggregation instance. \n"]
  ja4_fingerprint : rate_limit_ja4_fingerprint option;
      [@ocaml.doc
        "Use the request's JA4 fingerprint as an aggregate key. If you use a single JA4 \
         fingerprint as your custom key, then each value fully defines an aggregation instance. \n"]
  as_n : rate_limit_asn option;
      [@ocaml.doc
        "Use an Autonomous System Number (ASN) derived from the request's originating or forwarded \
         IP address as an aggregate key. Each distinct ASN contributes to the aggregation \
         instance. \n"]
}
[@@ocaml.doc
...
type nonrec rate_based_statement_custom_keys = rate_based_statement_custom_key list [@@ocaml.doc ""]
...
[@@ocaml.doc
  "A rule statement used to search web request components for matches with regular expressions. To \
   use this, create a [RegexPatternSet] that specifies the expressions that you want to detect, \
   then use the ARN of that set in this statement. A web request matches the pattern set rule \
   statement if the request component matches any of the patterns in the set. To create a regex \
  ...
  position : forwarded_ip_position;
      [@ocaml.doc
        "The position in the header to search for the IP address. The header can contain IP \
         ...
         be [10.1.1.1, 127.0.0.0, 10.10.10.10] where the first IP address identifies the original \
...
type nonrec ip_set_reference_statement = {
  ar_n : resource_arn;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the [IPSet] that this statement references.\n"]
  ip_set_forwarded_ip_config : ip_set_forwarded_ip_config option;
      [@ocaml.doc
        "The configuration for inspecting IP addresses in an HTTP header that you specify, instead \
         of using the IP address that's reported by the web request origin. Commonly, this is the \
         X-Forwarded-For (XFF) header, but you can specify any header name. \n\n\
        \  If the specified header isn't present in the request, WAF doesn't apply the rule to the \
         web request at all.\n\
        \  \n\
...
[@@ocaml.doc
  "A rule statement used to detect web requests coming from particular IP addresses or address \
   ranges. To use this, create an [IPSet] that specifies the addresses you want to detect, then \
   use the ARN of that set in this statement. To create an IP set, see [CreateIPSet].\n\n\
...
type nonrec rule_group_reference_statement = {
  ar_n : resource_arn; [@ocaml.doc "The Amazon Resource Name (ARN) of the entity.\n"]
  excluded_rules : excluded_rules option;
      [@ocaml.doc
        ...
        \  \n\
        \   "]
  rule_action_overrides : rule_action_overrides option;
      [@ocaml.doc
        "Action settings to use in the place of the rule actions that are configured inside the \
        ...
        \    You can use overrides for testing, for example you can override all of rule actions \
         to [Count] and then monitor the resulting count metrics to understand how the rule group \
         would handle your web traffic. You can also permanently override some or all actions, to \
         modify how the rule group manages your web traffic.\n\
        \    "]
}
[@@ocaml.doc
  "A rule statement used to run the rules that are defined in a [RuleGroup]. To use this, create a \
...
type nonrec country_codes = country_code list [@@ocaml.doc ""]

type nonrec geo_match_statement = {
  country_codes : country_codes option;
      [@ocaml.doc
        "An array of two-character country codes that you want to match against, for example, [\\[ \
         \"US\", \"CN\" \\]], from the alpha-2 country ISO codes of the ISO 3166 international \
         standard. \n\n\
        \ When you use a geo match statement just for the region and country labels that it adds \
         to requests, you still have to supply a country code for the rule to evaluate. In this \
         case, you configure the rule to only count matching requests, but it will still generate \
         logging and count metrics for any matches. You can reduce the logging and metrics that \
         the rule produces by specifying a country that's unlikely to be a source of traffic to \
         your site.\n\
        \ "]
  forwarded_ip_config : forwarded_ip_config option;
      [@ocaml.doc
...
[@@ocaml.doc
  "A rule statement that labels web requests by country and region and that matches against web \
   requests based on country code. A geo match rule labels every request that it inspects \
  ...
  \       {-  To manage requests only by country, you can use this statement by itself and specify \
   the countries that you want to match against in the [CountryCodes] array. \n\
  \           \n\
  \            }\n\
  \       {-  Otherwise, configure your geo match rule with Count action so that it only labels \
   requests. Then, add one or more label match rules to run after the geo match rule and configure \
   them to match against the geographic labels and handle the requests as needed. \n\
  \           \n\
  \            }\n\
  \       }\n\
  \   WAF labels requests using the alpha-2 country and region codes from the International \
   Organization for Standardization (ISO) 3166 standard. WAF determines the codes using either the \
   IP address in the web request origin or, if you specify it, the address in the geo match \
   [ForwardedIPConfig]. \n\
  \   \n\
  ...
  \     \n\
  \      For additional details, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-rule-statement-type-geo-match.html}Geographic \
   match rule statement} in the \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html}WAF Developer Guide}. \n\
  \      "]
...
type nonrec size_constraint_statement = {
  ...
  comparison_operator : comparison_operator;
      [@ocaml.doc "The operator to use to compare the request part to the size setting. \n"]
  size : size;
      [@ocaml.doc "The size, in byte, to compare to the request part, after any transformations.\n"]
  text_transformations : text_transformations;
      [@ocaml.doc
        "Text transformations eliminate some of the unusual formatting that attackers use in web \
         requests in an effort to bypass detection. Text transformations are used in rule match \
...
[@@ocaml.doc
  "A rule statement that compares a number of bytes against the size of a request component, using \
  ...
  \ If you configure WAF to inspect the request body, WAF inspects only the number of bytes in the \
   body up to the limit for the web ACL and protected resource type. If you know that the request \
   body for your web requests should never exceed the inspection limit, you can use a size \
   constraint statement to block requests that have a larger request body size. For more \
...
[@@ocaml.doc
  "A rule statement that inspects for cross-site scripting (XSS) attacks. In XSS attacks, the \
   attacker uses vulnerabilities in a benign website as a vehicle to inject malicious client-site \
   scripts into other legitimate web browsers. \n"]

type nonrec sensitivity_level = LOW [@ocaml.doc ""] | HIGH [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec sqli_match_statement = {
  ...
  sensitivity_level : sensitivity_level option;
      [@ocaml.doc
        ...
        \  [HIGH] detects more attacks, but might generate more false positives, especially if \
         your web requests frequently contain unusual strings. For information about identifying \
         and mitigating false positives, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/web-acl-testing.html}Testing and \
         tuning} in the {i WAF Developer Guide}.\n\
        \ \n\
...
[@@ocaml.doc
  "A rule statement that inspects for malicious SQL code. Attackers insert malicious SQL code into \
   web requests to do things like modify your database or extract data from it. \n"]
...
type nonrec search_string = bytes [@@ocaml.doc ""]

type nonrec byte_match_statement = {
  search_string : search_string;
      [@ocaml.doc
        "A string value that you want WAF to search for. WAF searches only in the part of web \
         requests that you designate for inspection in [FieldToMatch]. The maximum length of the \
         value is 200 bytes.\n\n\
        ...
        \        {-   [JA3Fingerprint]: Available for use with Amazon CloudFront distributions and \
         ...
         configuration. You can use this choice only with a string match [ByteMatchStatement] with \
         the [PositionalConstraint] set to [EXACTLY]. \n\
        \            \n\
        \             You can obtain the JA3 fingerprint for client requests from the web ACL \
         logs. If WAF is able to calculate the fingerprint, it includes it in the logs. For \
         information about the logging fields, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/logging-fields.html}Log fields} \
         in the {i WAF Developer Guide}. \n\
        \             \n\
        \              }\n\
        \        {-   [HeaderOrder]: The list of header names to match for. WAF creates a string \
         that contains the ordered list of header names, from the headers in the web request, and \
         then matches against that string. \n\
        \            \n\
        \             }\n\
        \        }\n\
        \   If [SearchString] includes alphabetic characters A-Z and a-z, note that the value is \
         case sensitive.\n\
        \   \n\
  ...
  positional_constraint : positional_constraint;
      [@ocaml.doc
        ...
        \    The specified part of the web request must include the value of [SearchString], and \
         [SearchString] must contain only alphanumeric characters or underscore (A-Z, a-z, 0-9, or \
         _). In addition, [SearchString] must be a word, which means that both of the following \
         are true:\n\
        \    \n\
        \     {ul\n\
        \           {-   [SearchString] is at the beginning of the specified part of the web \
         request or is preceded by a character other than an alphanumeric character or underscore \
        ...
        \           {-   [SearchString] is at the end of the specified part of the web request or \
         is followed by a character other than an alphanumeric character or underscore (_), for \
         example, [BadBot;] and [-BadBot;].\n\
        \               \n\
        \                }\n\
        \           }\n\
        \    {b EXACTLY} \n\
...
[@@ocaml.doc
  "A rule statement that defines a string match search for WAF to apply to web requests. The byte \
   ...
   search, and other settings. The bytes to search for are typically a string that corresponds \
   with ASCII characters. In the WAF console and the developer guide, this is called a string \
   match statement.\n"]

type statements = statement list [@@ocaml.doc ""]

and statement = {
  byte_match_statement : byte_match_statement option;
      [@ocaml.doc
        "A rule statement that defines a string match search for WAF to apply to web requests. The \
         byte match statement provides the bytes to search for, the location in requests that you \
         want WAF to search, and other settings. The bytes to search for are typically a string \
         that corresponds with ASCII characters. In the WAF console and the developer guide, this \
         is called a string match statement.\n"]
  sqli_match_statement : sqli_match_statement option;
      [@ocaml.doc
        "A rule statement that inspects for malicious SQL code. Attackers insert malicious SQL \
         code into web requests to do things like modify your database or extract data from it. \n"]
  ...
  size_constraint_statement : size_constraint_statement option;
      [@ocaml.doc
        "A rule statement that compares a number of bytes against the size of a request component, \
         using a comparison operator, such as greater than (>) or less than (<). For example, you \
         can use a size constraint statement to look for query strings that are longer than 100 \
         bytes. \n\n\
        \ If you configure WAF to inspect the request body, WAF inspects only the number of bytes \
         in the body up to the limit for the web ACL and protected resource type. If you know that \
         the request body for your web requests should never exceed the inspection limit, you can \
         use a size constraint statement to block requests that have a larger request body size. \
         For more information about the inspection limits, see [Body] and [JsonBody] settings for \
         the [FieldToMatch] data type. \n\
        \ \n\
        \  If you choose URI for the value of Part of the request to filter on, the slash (/) in \
         the URI counts as one character. For example, the URI [/logo.jpg] is nine characters long.\n\
        \  "]
  geo_match_statement : geo_match_statement option;
      [@ocaml.doc
        ...
        \       {-  To manage requests only by country, you can use this statement by itself and \
         specify the countries that you want to match against in the [CountryCodes] array. \n\
        \           \n\
        \            }\n\
        \       {-  Otherwise, configure your geo match rule with Count action so that it only \
         labels requests. Then, add one or more label match rules to run after the geo match rule \
         and configure them to match against the geographic labels and handle the requests as \
         needed. \n\
        \           \n\
        \            }\n\
        \       }\n\
        \   WAF labels requests using the alpha-2 country and region codes from the International \
         ...
         either the IP address in the web request origin or, if you specify it, the address in the \
        ...
        \      For additional details, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-rule-statement-type-geo-match.html}Geographic \
         match rule statement} in the \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html}WAF Developer \
         Guide}. \n\
        \      "]
  rule_group_reference_statement : rule_group_reference_statement option;
      [@ocaml.doc
        "A rule statement used to run the rules that are defined in a [RuleGroup]. To use this, \
         create a rule group with your rules, then provide the ARN of the rule group in this \
         statement.\n\n\
        \ You cannot nest a [RuleGroupReferenceStatement], for example for use inside a \
         ...
         another rule group. You can only reference a rule group as a top-level statement within a \
         rule that you define in a web ACL.\n\
        \ "]
  ip_set_reference_statement : ip_set_reference_statement option;
      [@ocaml.doc
        "A rule statement used to detect web requests coming from particular IP addresses or \
         address ranges. To use this, create an [IPSet] that specifies the addresses you want to \
         detect, then use the ARN of that set in this statement. To create an IP set, see \
         [CreateIPSet].\n\n\
        \ Each IP set rule statement references an IP set. You create and maintain the set \
         ...
         you update the referenced set, WAF automatically updates all rules that reference it.\n\
        \ "]
  regex_pattern_set_reference_statement : regex_pattern_set_reference_statement option;
      [@ocaml.doc
        "A rule statement used to search web request components for matches with regular \
         expressions. To use this, create a [RegexPatternSet] that specifies the expressions that \
         you want to detect, then use the ARN of that set in this statement. A web request matches \
         the pattern set rule statement if the request component matches any of the patterns in \
         the set. To create a regex pattern set, see [CreateRegexPatternSet].\n\n\
        \ Each regex pattern set rule statement references a regex pattern set. You create and \
         ...
         multiple rules. When you update the referenced set, WAF automatically updates all rules \
         that reference it.\n\
        \ "]
  rate_based_statement : rate_based_statement option;
      [@ocaml.doc
        "A rate-based rule counts incoming requests and rate limits requests when they are coming \
         at too fast a rate. The rule categorizes requests according to your aggregation criteria, \
         collects them into aggregation instances, and counts and rate limits the requests for \
         each instance. \n\n\
        \  If you change any of these settings in a rule that's currently in use, the change \
         resets the rule's rate limiting counts. This can pause the rule's rate limiting \
        ...
        \          {-  If the aggregation criteria is just the IP address, then each individual \
         address is an aggregation instance, and WAF counts requests separately for each. The \
        ...
        \          {-  If the aggregation criteria is HTTP method, then each individual HTTP \
         method is an aggregation instance. The aggregation instances and request counts for our \
        ...
        \          {-  If the aggregation criteria is IP address and HTTP method, then each IP \
         address and each HTTP method would contribute to the combined aggregation instance. The \
         aggregation instances and request counts for our example would be the following: \n\
        \              \n\
        \               {ul\n\
        ...
        \    You can optionally nest another statement inside the rate-based statement, to narrow \
         ...
         nested statement. You can use this nested scope-down statement in conjunction with your \
         aggregation key specifications or you can just count and rate limit all requests that \
         match the scope-down statement, without additional aggregation. When you choose to just \
         manage all requests that match a scope-down statement, the aggregation instance is \
         singular for the rule. \n\
        \    \n\
        \     You cannot nest a [RateBasedStatement] inside another statement, for example inside \
         a [NotStatement] or [OrStatement]. You can define a [RateBasedStatement] inside a web ACL \
         and inside a rule group. \n\
        \     \n\
        \      For additional information about the options, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-rate-based-rules.html}Rate \
         limiting web requests using rate-based rules} in the {i WAF Developer Guide}. \n\
        \      \n\
        \       If you only aggregate on the individual IP address or forwarded IP address, you \
         can retrieve the list of IP addresses that WAF is currently rate limiting for a rule \
         through the API call [GetRateBasedStatementManagedKeys]. This option is not available for \
         other aggregation configurations.\n\
        \       \n\
        \        WAF tracks and manages web requests separately for each instance of a rate-based \
         rule that you use. For example, if you provide the same rate-based rule settings in two \
         web ACLs, each of the two rule statements represents a separate instance of the \
         rate-based rule and gets its own tracking and management by WAF. If you define a \
         rate-based rule inside a rule group, and then use that rule group in multiple places, \
         each use creates a separate instance of the rate-based rule that gets its own tracking \
  ...
  or_statement : or_statement option;
      [@ocaml.doc
        "A logical rule statement used to combine other rule statements with OR logic. You provide \
         more than one [Statement] within the [OrStatement]. \n"]
  ...
  managed_rule_group_statement : managed_rule_group_statement option;
      [@ocaml.doc
        "A rule statement used to run the rules that are defined in a managed rule group. To use \
         ...
         retrieve the required names by calling [ListAvailableManagedRuleGroups].\n\n\
        \ You cannot nest a [ManagedRuleGroupStatement], for example for use inside a \
         [NotStatement] or [OrStatement]. You cannot use a managed rule group inside another rule \
         group. You can only reference a managed rule group as a top-level statement within a rule \
         that you define in a web ACL.\n\
        \ \n\
        \   You are charged additional fees when you use the WAF Bot Control managed rule group \
         [AWSManagedRulesBotControlRuleSet], the WAF Fraud Control account takeover prevention \
         (ATP) managed rule group [AWSManagedRulesATPRuleSet], or the WAF Fraud Control account \
         creation fraud prevention (ACFP) managed rule group [AWSManagedRulesACFPRuleSet]. For \
         more information, see {{:http://aws.amazon.com/waf/pricing/}WAF Pricing}.\n\
        \   \n\
        \    "]
  label_match_statement : label_match_statement option;
      [@ocaml.doc
        ...
        \ The label match statement provides the label or namespace string to search for. The \
         label string can represent a part or all of the fully qualified label name that had been \
         added to the web request. Fully qualified labels have a prefix, optional namespaces, and \
         label name. The prefix identifies the rule group or web ACL context of the rule that \
         added the label. If you do not provide the fully qualified name in your label match \
         string, WAF performs the search for labels that were added in the same context as the \
...
[@@ocaml.doc
  "The processing guidance for a [Rule], used by WAF to determine whether a web request matches \
   the rule. \n\n\
  \ For example specifications, see the examples section of [CreateWebACL].\n\
  \ "]
...
and rate_based_statement = {
  limit : rate_limit;
      [@ocaml.doc
        "The limit on requests during the specified evaluation window for a single aggregation \
         ...
         [ScopeDownStatement], this limit is applied only to the requests that match the \
         statement.\n\n\
        \ Examples: \n\
        \ \n\
        \  {ul\n\
        ...
        \        }\n\
        \  "]
  evaluation_window_sec : evaluation_window_sec option;
      [@ocaml.doc
        "The amount of time, in seconds, that WAF should include in its request counts, looking \
         back from the current time. For example, for a setting of 120, when WAF checks the rate, \
         it counts the requests for the 2 minutes immediately preceding the current time. Valid \
         settings are 60, 120, 300, and 600. \n\n\
        \ This setting doesn't determine how often WAF checks the rate, but how far back it looks \
         each time it checks. WAF checks the rate about every 10 seconds.\n\
        \ \n\
  ...
  aggregate_key_type : rate_based_statement_aggregate_key_type;
      [@ocaml.doc
        ...
        \          {-   [CONSTANT] - Count and limit the requests that match the rate-based rule's \
         ...
         that satisfy the scope-down statement goes over the limit, WAF applies the rule action to \
         all requests that satisfy the scope-down statement. \n\
        \              \n\
        ...
        \                To aggregate on only the IP address or only the forwarded IP address, \
         don't use custom keys. Instead, set the aggregate key type to [IP] or [FORWARDED_IP].\n\
        \                \n\
        \                 }\n\
  ...
  scope_down_statement : statement option;
      [@ocaml.doc
        "An optional nested statement that narrows the scope of the web requests that are \
         ...
         the rate-based rule only tracks and rate limits requests that match the scope-down \
         statement. You can use any nestable [Statement] in the scope-down statement, and you can \
  ...
  forwarded_ip_config : forwarded_ip_config option;
      [@ocaml.doc
        ...
        \    "]
  custom_keys : rate_based_statement_custom_keys option;
      [@ocaml.doc "Specifies the aggregate keys to use in a rate-base rule. \n"]
}
[@@ocaml.doc
  "A rate-based rule counts incoming requests and rate limits requests when they are coming at too \
   fast a rate. The rule categorizes requests according to your aggregation criteria, collects \
   them into aggregation instances, and counts and rate limits the requests for each instance. \n\n\
  ...
  \     Each unique set of values for the aggregation keys that you specify is a separate \
   ...
   definition. \n\
  \     \n\
  \      For example, assume the rule evaluates web requests with the following IP address and \
   HTTP method values: \n\
  \      \n\
  \       {ul\n\
  \             {-  IP address 10.1.1.1, HTTP method POST\n\
  ...
  \   \n\
  \    {ul\n\
  \          {-  If the aggregation criteria is just the IP address, then each individual address \
   is an aggregation instance, and WAF counts requests separately for each. The aggregation \
  ...
  \           }\n\
  \            }\n\
  \          {-  If the aggregation criteria is HTTP method, then each individual HTTP method is \
   an aggregation instance. The aggregation instances and request counts for our example would be \
   the following: \n\
  \              \n\
  \               {ul\n\
  \                     {-  HTTP method POST: count 2\n\
  ...
  \           }\n\
  \            }\n\
  \          {-  If the aggregation criteria is IP address and HTTP method, then each IP address \
   and each HTTP method would contribute to the combined aggregation instance. The aggregation \
   instances and request counts for our example would be the following: \n\
  \              \n\
  \               {ul\n\
  \                     {-  IP address 10.1.1.1, HTTP method POST: count 1\n\
  ...
  \   For any n-tuple of aggregation keys, each unique combination of values for the keys defines \
   a separate aggregation instance, which WAF counts and rate-limits individually. \n\
  \   \n\
  ...
  \       If you only aggregate on the individual IP address or forwarded IP address, you can \
   retrieve the list of IP addresses that WAF is currently rate limiting for a rule through the \
   API call [GetRateBasedStatementManagedKeys]. This option is not available for other aggregation \
   configurations.\n\
  \       \n\
  \        WAF tracks and manages web requests separately for each instance of a rate-based rule \
   ...
   its own tracking and management by WAF. If you define a rate-based rule inside a rule group, \
   and then use that rule group in multiple places, each use creates a separate instance of the \
...
and not_statement = {
  statement : statement;
      [@ocaml.doc "The statement to negate. You can use any statement that can be nested.\n"]
}
[@@ocaml.doc
...
and managed_rule_group_statement = {
  vendor_name : vendor_name;
      [@ocaml.doc
        "The name of the managed rule group vendor. You use this, along with the rule group name, \
         to identify a rule group.\n"]
  name : entity_name;
      [@ocaml.doc
        "The name of the managed rule group. You use this, along with the vendor name, to identify \
         the rule group.\n"]
  version : version_key_string option;
      [@ocaml.doc
        "The version of the managed rule group to use. If you specify this, the version setting is \
         fixed until you change it. If you don't specify this, WAF uses the vendor's default \
         version, and then keeps the version at the vendor's default when the vendor updates the \
  ...
  scope_down_statement : statement option;
      [@ocaml.doc
        "An optional nested statement that narrows the scope of the web requests that are \
         evaluated by the managed rule group. Requests are only evaluated by the rule group if \
         they match the scope-down statement. You can use any nestable [Statement] in the \
         scope-down statement, and you can nest statements at any level, the same as you can for a \
         rule statement. \n"]
  managed_rule_group_configs : managed_rule_group_configs option;
      [@ocaml.doc
        ...
        \        {-  Use the [AWSManagedRulesACFPRuleSet] configuration object to configure the \
         account creation fraud prevention managed rule group. The configuration includes the \
         registration and sign-up pages of your application and the locations in the account \
        ...
        \        {-  Use the [AWSManagedRulesAntiDDoSRuleSet] configuration object to configure \
         the anti-DDoS managed rule group. The configuration includes the sensitivity levels to \
         use in the rules that typically block and challenge requests that might be participating \
         in DDoS attacks and the specification to use to indicate whether a request can handle a \
        ...
        \        {-  Use the [AWSManagedRulesATPRuleSet] configuration object to configure the \
         ...
         page of your application and the locations in the login request payload of data such as \
...
[@@ocaml.doc
  "A rule statement used to run the rules that are defined in a managed rule group. To use this, \
   ...
   required names by calling [ListAvailableManagedRuleGroups].\n\n\
  \ You cannot nest a [ManagedRuleGroupStatement], for example for use inside a [NotStatement] or \
   [OrStatement]. You cannot use a managed rule group inside another rule group. You can only \
   reference a managed rule group as a top-level statement within a rule that you define in a web \
   ACL.\n\
  \ \n\
  \   You are charged additional fees when you use the WAF Bot Control managed rule group \
   [AWSManagedRulesBotControlRuleSet], the WAF Fraud Control account takeover prevention (ATP) \
   managed rule group [AWSManagedRulesATPRuleSet], or the WAF Fraud Control account creation fraud \
   prevention (ACFP) managed rule group [AWSManagedRulesACFPRuleSet]. For more information, see \
   {{:http://aws.amazon.com/waf/pricing/}WAF Pricing}.\n\
  \   \n\
  \    "]
...
type nonrec rule = {
  name : entity_name;
      [@ocaml.doc
        ...
        \ If you change the name of a [Rule] after you create it and you want the rule's metric \
         name to reflect the change, update the metric name in the rule's [VisibilityConfig] \
  ...
  priority : rule_priority;
      [@ocaml.doc
        "If you define more than one [Rule] in a [WebACL], WAF evaluates each request against the \
         [Rules] in order based on the value of [Priority]. WAF processes rules with lower \
         priority first. The priorities don't need to be consecutive, but they must all be \
         different.\n"]
  statement : statement;
      [@ocaml.doc
  ...
  override_action : override_action option;
      [@ocaml.doc
        "The action to use in the place of the action that results from the rule group evaluation. \
         Set the override action to none to leave the result of the rule group alone. Set it to \
  ...
  rule_labels : labels option;
      [@ocaml.doc
        "Labels to apply to web requests that match the rule match statement. WAF applies fully \
         ...
         of a label namespace and a rule label. The rule's rule group or web ACL defines the label \
         namespace. \n\n\
  ...
  visibility_config : visibility_config;
      [@ocaml.doc
        ...
        \ If you change the name of a [Rule] after you create it and you want the rule's metric \
         name to reflect the change, update the metric name as well. WAF doesn't automatically \
         update the metric name. \n\
        \ "]
  captcha_config : captcha_config option;
      [@ocaml.doc
        "Specifies how WAF should handle [CAPTCHA] evaluations. If you don't specify this, WAF \
         uses the [CAPTCHA] configuration that's defined for the web ACL. \n"]
  challenge_config : challenge_config option;
      [@ocaml.doc
        "Specifies how WAF should handle [Challenge] evaluations. If you don't specify this, WAF \
         uses the challenge configuration that's defined for the web ACL. \n"]
}
[@@ocaml.doc
  "A single rule, which you can use in a [WebACL] or [RuleGroup] to identify web requests that you \
   want to manage in some way. Each rule includes one top-level [Statement] that WAF uses to \
...
type nonrec default_action = {
  ...
  allow : allow_action option; [@ocaml.doc "Specifies that WAF should allow requests by default.\n"]
}
[@@ocaml.doc
  "In a [WebACL], this is the action that you want WAF to perform when a web request doesn't match \
   any of the rules in the [WebACL]. The default action must be a terminating action.\n"]

type nonrec entity_id = string [@@ocaml.doc ""]

type nonrec scope = CLOUDFRONT [@ocaml.doc ""] | REGIONAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec update_web_acl_request = {
  ...
  id : entity_id;
      [@ocaml.doc
        "The unique identifier for the web ACL. This ID is returned in the responses to create and \
         list commands. You provide it to operations like update and delete.\n"]
  default_action : default_action;
      [@ocaml.doc
        "The action to perform if none of the [Rules] contained in the [WebACL] match. \n"]
  description : entity_description option;
      [@ocaml.doc "A description of the web ACL that helps with identification. \n"]
  rules : rules option;
      [@ocaml.doc
        "The [Rule] statements used to identify the web requests that you want to manage. Each \
         rule includes one top-level statement that WAF uses to identify matching web requests, \
  ...
  data_protection_config : data_protection_config option;
      [@ocaml.doc
        "Specifies data protection to apply to the web request data for the web ACL. This is a web \
         ACL level data protection option. \n\n\
  ...
  lock_token : lock_token;
      [@ocaml.doc
        "A token used for optimistic locking. WAF returns a token to your [get] and [list] \
         requests, to mark the state of the entity at the time of the request. To make changes to \
         the entity associated with the token, you provide the token to operations like [update] \
         ...
         [WAFOptimisticLockException]. If this happens, perform another [get], and use the new \
  ...
  custom_response_bodies : custom_response_bodies option;
      [@ocaml.doc
        "A map of custom response keys and content bodies. When you create a rule with a block \
         action, you can send a custom response to the web request. You define these for the web \
         ACL, and then use them in the rules and default actions that you define in the web ACL. \n\n\
        \ For information about customizing web requests and responses, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-custom-request-response.html}Customizing \
         web requests and responses in WAF} in the {i WAF Developer Guide}. \n\
        \ \n\
  ...
  token_domains : token_domains option;
      [@ocaml.doc
        "Specifies the domains that WAF should accept in a web request token. This enables the use \
         of tokens across multiple protected websites. When WAF provides a token, it uses the \
         domain of the Amazon Web Services resource that the web ACL is protecting. If you don't \
         specify a list of token domains, WAF accepts tokens only for the domain of the protected \
         resource. With a token domain list, WAF accepts the resource's host domain plus all \
  ...
  association_config : association_config option;
      [@ocaml.doc
        ...
        \ Use this to customize the maximum size of the request body that your protected resources \
         ...
         Gateway, Amazon Cognito, App Runner, or Verified Access resources. The default setting is \
         16 KB (16,384 bytes). \n\
        \ \n\
        \   You are charged additional fees when your protected resources forward body sizes that \
         are larger than the default. For more information, see \
  ...
  on_source_d_do_s_protection_config : on_source_d_do_s_protection_config option;
      [@ocaml.doc
        "Specifies the type of DDoS protection to apply to web request data for a web ACL. For \
         most scenarios, it is recommended to use the default protection level, \
         [ACTIVE_UNDER_DDOS]. If a web ACL is associated with multiple Application Load Balancers, \
         the changes you make to DDoS protection in that web ACL will apply to all associated \
...
type nonrec update_rule_group_request = {
  ...
  description : entity_description option;
      [@ocaml.doc "A description of the rule group that helps with identification. \n"]
  rules : rules option;
      [@ocaml.doc
        "The [Rule] statements used to identify the web requests that you want to manage. Each \
         rule includes one top-level statement that WAF uses to identify matching web requests, \
  ...
  custom_response_bodies : custom_response_bodies option;
      [@ocaml.doc
        "A map of custom response keys and content bodies. When you create a rule with a block \
         action, you can send a custom response to the web request. You define these for the rule \
         group, and then use them in the rules that you define in the rule group. \n\n\
        \ For information about customizing web requests and responses, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-custom-request-response.html}Customizing \
         web requests and responses in WAF} in the {i WAF Developer Guide}. \n\
        \ \n\
...
type nonrec update_regex_pattern_set_request = {
  name : entity_name;
      [@ocaml.doc "The name of the set. You cannot change the name after you create the set.\n"]
  scope : scope;
      [@ocaml.doc
        "Specifies whether this is for a global resource type, such as a Amazon CloudFront \
         distribution. For an Amplify application, use [CLOUDFRONT].\n\n\
  ...
  id : entity_id;
      [@ocaml.doc
        "A unique identifier for the set. This ID is returned in the responses to create and list \
         commands. You provide it to operations like update and delete.\n"]
  description : entity_description option;
      [@ocaml.doc "A description of the set that helps with identification. \n"]
  regular_expression_list : regular_expression_list; [@ocaml.doc "\n"]
  lock_token : lock_token;
      [@ocaml.doc
        "A token used for optimistic locking. WAF returns a token to your [get] and [list] \
         requests, to mark the state of the entity at the time of the request. To make changes to \
...
type nonrec update_managed_rule_set_version_expiry_date_response = {
  expiring_version : version_key_string option; [@ocaml.doc "The version that is set to expire. \n"]
  expiry_timestamp : timestamp option;
      [@ocaml.doc
...
type nonrec update_managed_rule_set_version_expiry_date_request = {
  ...
  id : entity_id;
      [@ocaml.doc
        "A unique identifier for the managed rule set. The ID is returned in the responses to \
         commands like [list]. You provide it to operations like [get] and [update].\n"]
  lock_token : lock_token;
      [@ocaml.doc
        "A token used for optimistic locking. WAF returns a token to your [get] and [list] \
         requests, to mark the state of the entity at the time of the request. To make changes to \
  ...
  id : entity_id;
      [@ocaml.doc
        "A unique identifier for the set. This ID is returned in the responses to create and list \
         commands. You provide it to operations like update and delete.\n"]
  description : entity_description option;
      [@ocaml.doc "A description of the IP set that helps with identification. \n"]
  addresses : ip_addresses;
      [@ocaml.doc
        "Contains an array of strings that specifies zero or more IP addresses or blocks of IP \
         addresses that you want WAF to inspect for in incoming requests. All addresses must be \
         specified using Classless Inter-Domain Routing (CIDR) notation. WAF supports all IPv4 and \
         IPv6 CIDR ranges except for [/0]. \n\n\
...
[@@ocaml.doc
  "WAF couldn\226\128\153t perform your tagging operation because of an internal error. Retry your \
   request.\n"]

type nonrec waf_tag_operation_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "An error occurred during the tagging operation. Retry your request.\n"]
...
type nonrec untag_resource_request = {
  resource_ar_n : resource_arn; [@ocaml.doc "The Amazon Resource Name (ARN) of the resource.\n"]
  tag_keys : tag_key_list;
      [@ocaml.doc "An array of keys identifying the tags to disassociate from the resource.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "A tag associated with an Amazon Web Services resource. Tags are key:value pairs that you can \
   use to categorize and manage your resources, for purposes like billing or other management. \
   ...
   or ID. You can specify one or more tags to add to each Amazon Web Services resource, up to 50 \
   tags for a resource.\n\n\
...
type nonrec tag_resource_request = {
  resource_ar_n : resource_arn; [@ocaml.doc "The Amazon Resource Name (ARN) of the resource.\n"]
  tags : tag_list; [@ocaml.doc "An array of key:value pairs to associate with the resource.\n"]
}
[@@ocaml.doc ""]
  ...
  lock_token : lock_token;
      [@ocaml.doc
        "A token used for optimistic locking. WAF returns a token to your [get] and [list] \
         ...
         [WAFOptimisticLockException]. If this happens, perform another [get], and use the new \
         token returned by that operation. \n"]
  recommended_version : version_key_string option;
      [@ocaml.doc
...
[@@ocaml.doc
  "WAF is not able to access the service linked role. This can be caused by a previous \
   ...
   recently made a call to [DeleteServiceLinkedRole], wait at least 15 minutes and try the request \
   again. If you receive this same exception again, you will have to wait additional time until \
...
type nonrec filter_behavior = KEEP [@ocaml.doc ""] | DROP [@ocaml.doc ""] [@@ocaml.doc ""]
  ...
  label_name : label_name;
      [@ocaml.doc
        "The label name that a log record must contain in order to meet the condition. This must \
         be a fully qualified label name. Fully qualified labels have a prefix, optional \
         namespaces, and label name. The prefix identifies the rule group or web ACL context of \
         the rule that added the label. \n"]
}
[@@ocaml.doc "A single label name condition for a [Condition] in a logging filter.\n"]
...
type nonrec action_condition = {
  action : action_value;
      [@ocaml.doc
        "The action setting that a log record must contain in order to meet the condition. This is \
         the action that WAF applied to the web request. \n\n\
        \ For rule groups, this is either the configured rule action setting, or if you've applied \
         ...
         [EXCLUDED_AS_COUNT] matches on excluded rules and also on rules that have a rule action \
         override of Count. \n\
        \ "]
}
[@@ocaml.doc "A single action condition for a [Condition] in a logging filter.\n"]

type nonrec condition = {
  action_condition : action_condition option;
      [@ocaml.doc
        "A single action condition. This is the action setting that a log record must contain in \
...
type nonrec conditions = condition list [@@ocaml.doc ""]

type nonrec filter_requirement = MEETS_ALL [@ocaml.doc ""] | MEETS_ANY [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec filter = {
  behavior : filter_behavior;
      [@ocaml.doc "How to handle logs that satisfy the filter's conditions and requirement. \n"]
  requirement : filter_requirement;
      [@ocaml.doc
        "Logic to apply to the filtering conditions. You can specify that, in order to satisfy the \
         filter, a log must match all conditions or must match at least one condition.\n"]
  conditions : conditions; [@ocaml.doc "Match conditions for the filter.\n"]
}
...
type nonrec logging_filter = {
  filters : filters; [@ocaml.doc "The filters that you want to apply to the logs. \n"]
...
type nonrec logging_configuration = {
  ...
  redacted_fields : redacted_fields option;
      [@ocaml.doc
        ...
        \ For example, if you redact the [SingleHeader] field, the [HEADER] field in the logs will \
        ...
        \     \n\
        \        This setting has no impact on request sampling. You can only exclude fields from \
         request sampling by disabling sampling in the web ACL visibility configuration or by \
         configuring data protection for the web ACL.\n\
        \        \n\
        \         "]
  managed_by_firewall_manager : boolean_ option;
      [@ocaml.doc
        "Indicates whether the logging configuration was created by Firewall Manager, as part of \
         an WAF policy configuration. If true, only Firewall Manager can modify or delete the \
         configuration. \n\n\
        \ The logging configuration can be created by Firewall Manager for use with any web ACL \
         that Firewall Manager is using for an WAF policy. Web ACLs that Firewall Manager creates \
         and uses have their [ManagedByFirewallManager] property set to true. Web ACLs that were \
         created by a customer account and then retrofitted by Firewall Manager for use by a \
         policy have their [RetrofittedByFirewallManager] property set to true. For either case, \
         any corresponding logging configuration will indicate [ManagedByFirewallManager].\n\
        \ "]
  ...
  log_scope : log_scope option;
      [@ocaml.doc
        ...
        \ The log scope [SECURITY_LAKE] indicates a configuration that is managed through Amazon \
         ...
         sources for normalization, analysis, and management. For information, see \
...
[@@ocaml.doc
  "Defines an association between logging destinations and a web ACL resource, for logging from \
   WAF. As part of the association, you can specify parts of the standard logging fields to keep \
   out of the logs and you can specify filters so that you log only a subset of the logging \
   records. \n\n\
  ...
  lock_token : lock_token option;
      [@ocaml.doc
        "A token used for optimistic locking. WAF returns a token to your [get] and [list] \
         ...
         [WAFOptimisticLockException]. If this happens, perform another [get], and use the new \
         token returned by that operation. \n"]
  ar_n : resource_arn option; [@ocaml.doc "The Amazon Resource Name (ARN) of the entity.\n"]
}
[@@ocaml.doc
  "High-level information about a [WebACL], returned by operations like create and list. This \
   provides information like the ID, that you can use to retrieve and manage a [WebACL], and the \
   ARN, that you provide to operations like [AssociateWebACL].\n"]
...
type nonrec list_web_ac_ls_response = {
  ...
  web_ac_ls : web_acl_summaries option;
      [@ocaml.doc
        "Array of web ACLs. If you specified a [Limit] in your request, this might not be the full \
         list. \n"]
}
[@@ocaml.doc ""]
  ...
  limit : pagination_limit option;
      [@ocaml.doc
        "The maximum number of objects that you want WAF to return for this request. If more \
         objects are available, in the response, WAF provides a [NextMarker] value that you can \
...
type nonrec tag_info_for_resource = {
  ...
  tag_list : tag_list option; [@ocaml.doc "The array of [Tag] objects defined for the resource. \n"]
}
[@@ocaml.doc
  "The collection of tagging definitions for an Amazon Web Services resource. Tags are key:value \
   pairs that you can use to categorize and manage your resources, for purposes like billing or \
   ...
   \"development,\" or \"production\". Or you might set the tag key to \"customer\" and the value \
   to the customer name or ID. You can specify one or more tags to add to each Amazon Web Services \
...
type nonrec list_tags_for_resource_response = {
  ...
  tag_info_for_resource : tag_info_for_resource option;
      [@ocaml.doc
        "The collection of tagging definitions for the resource. If you specified a [Limit] in \
  ...
  start_time : timestamp;
      [@ocaml.doc
        "The beginning of the time range from which you want [GetSampledRequests] to return a \
         sample of the requests that your Amazon Web Services resource received. You must specify \
  ...
  end_time : timestamp;
      [@ocaml.doc
        "The end of the time range from which you want [GetSampledRequests] to return a sample of \
         the requests that your Amazon Web Services resource received. You must specify the times \
...
[@@ocaml.doc
  ...
  \ You must specify the times in Coordinated Universal Time (UTC) format. UTC format includes the \
   special designator, [Z]. For example, [\"2016-09-27T14:50Z\"]. You can specify any time range \
   in the previous three hours.\n\
  \ \n\
  \  In a [GetSampledRequests] response, the [StartTime] and [EndTime] objects specify the time \
   range for which WAF actually returned a sample of web requests. WAF gets the specified number \
   of requests from among the first 5,000 requests that your Amazon Web Services resource receives \
   during the specified time period. If your resource receives more than 5,000 requests during \
   that period, WAF stops sampling after the 5,000th request. In that case, [EndTime] is the time \
...
[@@ocaml.doc
  "High-level information about a [RuleGroup], returned by operations like create and list. This \
   provides information like the ID, that you can use to retrieve and manage a [RuleGroup], and \
...
type nonrec list_rule_groups_response = {
  ...
  rule_groups : rule_group_summaries option;
      [@ocaml.doc
        "Array of rule groups. If you specified a [Limit] in your request, this might not be the \
         full list. \n"]
}
[@@ocaml.doc ""]
...
type nonrec list_resources_for_web_acl_response = {
  resource_arns : resource_arns option;
      [@ocaml.doc "The array of Amazon Resource Names (ARNs) of the associated resources.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_resources_for_web_acl_request = {
  web_acl_arn : resource_arn; [@ocaml.doc "The Amazon Resource Name (ARN) of the web ACL.\n"]
...
[@@ocaml.doc
  "High-level information about a [RegexPatternSet], returned by operations like create and list. \
   ...
   [RegexPatternSet], and the ARN, that you provide to the [RegexPatternSetReferenceStatement] to \
...
type nonrec list_regex_pattern_sets_response = {
  ...
  regex_pattern_sets : regex_pattern_set_summaries option;
      [@ocaml.doc
        "Array of regex pattern sets. If you specified a [Limit] in your request, this might not \
         be the full list. \n"]
}
[@@ocaml.doc ""]
...
type nonrec release_summary = {
  release_version : version_key_string option; [@ocaml.doc "The release version. \n"]
  timestamp : timestamp option; [@ocaml.doc "The timestamp of the release. \n"]
}
[@@ocaml.doc "High level information for an SDK release. \n"]

type nonrec release_summaries = release_summary list [@@ocaml.doc ""]

type nonrec list_mobile_sdk_releases_response = {
  release_summaries : release_summaries option;
      [@ocaml.doc
        "The high level information for the available SDK releases. If you specified a [Limit] in \
         your request, this might not be the full list. \n"]
  next_marker : next_marker option;
      [@ocaml.doc
        "When you request a list of objects with a [Limit] setting, if the number of objects that \
...
type nonrec platform = IOS [@ocaml.doc ""] | ANDROID [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec list_mobile_sdk_releases_request = {
  platform : platform; [@ocaml.doc "The device platform to retrieve the list for.\n"]
  next_marker : next_marker option;
      [@ocaml.doc
        "When you request a list of objects with a [Limit] setting, if the number of objects that \
         are still available for retrieval exceeds the limit, WAF returns a [NextMarker] value in \
...
type nonrec managed_rule_set_summary = {
  ...
  label_namespace : label_name option;
      [@ocaml.doc
        "The label namespace prefix for the managed rule groups that are offered to customers from \
         this managed rule set. All labels that are added by rules in the managed rule group have \
         this prefix. \n\n\
        \ {ul\n\
        ...
        \       {-  When a rule with a label matches a web request, WAF adds the fully qualified \
         label to the request. A fully qualified label is made up of the label namespace from the \
         rule group or web ACL where the rule is defined and the label from the rule, separated by \
         a colon: \n\
        \           \n\
        \             \n\
        \            {[\n\
...
type nonrec managed_rule_set_summaries = managed_rule_set_summary list [@@ocaml.doc ""]
...
type nonrec list_managed_rule_sets_response = {
  ...
  managed_rule_sets : managed_rule_set_summaries option;
      [@ocaml.doc
        "Your managed rule sets. If you specified a [Limit] in your request, this might not be the \
         full list. \n"]
}
[@@ocaml.doc ""]
...
type nonrec list_logging_configurations_response = {
  logging_configurations : logging_configurations option;
      [@ocaml.doc
        "Array of logging configurations. If you specified a [Limit] in your request, this might \
...
[@@ocaml.doc
  "High-level information about an [IPSet], returned by operations like create and list. This \
   provides information like the ID, that you can use to retrieve and manage an [IPSet], and the \
   ARN, that you provide to the [IPSetReferenceStatement] to use the address set in a [Rule].\n"]
  ...
  next_marker : next_marker option;
      [@ocaml.doc
        "When you request a list of objects with a [Limit] setting, if the number of objects that \
         ...
         the response. To retrieve the next batch of objects, provide the marker from the prior \
         call in your next request.\n"]
  ip_sets : ip_set_summaries option;
      [@ocaml.doc
        "Array of IPSets. If you specified a [Limit] in your request, this might not be the full \
         list. \n"]
}
[@@ocaml.doc ""]
...
type nonrec managed_rule_group_version = {
  name : version_key_string option; [@ocaml.doc "The version name. \n"]
  last_update_timestamp : timestamp option;
      [@ocaml.doc
        "The date and time that the managed rule group owner updated the rule group version \
         information. \n"]
}
[@@ocaml.doc "Describes a single version of a managed rule group. \n"]

type nonrec managed_rule_group_versions = managed_rule_group_version list [@@ocaml.doc ""]
  ...
  next_marker : next_marker option;
      [@ocaml.doc
        "When you request a list of objects with a [Limit] setting, if the number of objects that \
         ...
         the response. To retrieve the next batch of objects, provide the marker from the prior \
         call in your next request.\n"]
  versions : managed_rule_group_versions option;
      [@ocaml.doc
        "The versions that are currently available for the specified managed rule group. If you \
         specified a [Limit] in your request, this might not be the full list. \n"]
  current_default_version : version_key_string option;
      [@ocaml.doc "The name of the version that's currently set as the default. \n"]
}
[@@ocaml.doc ""]
...
type nonrec managed_rule_group_summary = {
  ...
  name : entity_name option;
      [@ocaml.doc
        "The name of the managed rule group. You use this, along with the vendor name, to identify \
         the rule group.\n"]
  versioning_supported : boolean_ option;
      [@ocaml.doc
  ...
  description : entity_description option;
      [@ocaml.doc
        "The description of the managed rule group, provided by Amazon Web Services Managed Rules \
         or the Amazon Web Services Marketplace seller who manages it.\n"]
}
[@@ocaml.doc
  "High-level information about a managed rule group, returned by \
   [ListAvailableManagedRuleGroups]. This provides information like the name and vendor name, that \
   you provide when you add a [ManagedRuleGroupStatement] to a web ACL. Managed rule groups \
   include Amazon Web Services Managed Rules rule groups and Amazon Web Services Marketplace \
   managed rule groups. To use any Amazon Web Services Marketplace managed rule group, first \
   subscribe to the rule group through Amazon Web Services Marketplace. \n"]

type nonrec managed_rule_group_summaries = managed_rule_group_summary list [@@ocaml.doc ""]
  ...
  next_marker : next_marker option;
      [@ocaml.doc
        "When you request a list of objects with a [Limit] setting, if the number of objects that \
         ...
         the response. To retrieve the next batch of objects, provide the marker from the prior \
         call in your next request.\n"]
  managed_rule_groups : managed_rule_group_summaries option;
      [@ocaml.doc
  ...
  next_marker : next_marker option;
      [@ocaml.doc
        "When you request a list of objects with a [Limit] setting, if the number of objects that \
         ...
         the response. To retrieve the next batch of objects, provide the marker from the prior \
         call in your next request.\n"]
  api_key_summaries : api_key_summaries option;
      [@ocaml.doc
        "The array of key summaries. If you specified a [Limit] in your request, this might not be \
         the full list. \n"]
...
type nonrec firewall_manager_statement = {
  managed_rule_group_statement : managed_rule_group_statement option;
      [@ocaml.doc
        "A statement used by Firewall Manager to run the rules that are defined in a managed rule \
         group. This is managed by Firewall Manager for an Firewall Manager WAF policy.\n"]
  rule_group_reference_statement : rule_group_reference_statement option;
      [@ocaml.doc
  ...
  priority : rule_priority;
      [@ocaml.doc
        "If you define more than one rule group in the first or last Firewall Manager rule groups, \
         WAF evaluates each request against the rule groups in order, starting from the lowest \
         priority setting. The priorities don't need to be consecutive, but they must all be \
         different.\n"]
  firewall_manager_statement : firewall_manager_statement;
      [@ocaml.doc
        "The processing guidance for an Firewall Manager rule. This is like a regular rule \
         [Statement], but it can only contain a rule group reference.\n"]
...
[@@ocaml.doc "A rule group that's defined for an Firewall Manager WAF policy.\n"]

type nonrec firewall_manager_rule_groups = firewall_manager_rule_group list [@@ocaml.doc ""]
...
type nonrec web_ac_l = {
  ...
  id : entity_id;
      [@ocaml.doc
        "A unique identifier for the [WebACL]. This ID is returned in the responses to create and \
  ...
  data_protection_config : data_protection_config option;
      [@ocaml.doc
        ...
        \ The data protection that you configure for the web ACL alters the data that's available \
         ...
         option for data protection is in the logging configuration, which only affects logging. \n\
        \ "]
  capacity : consumed_capacity option;
      [@ocaml.doc
        ...
        \ WAF uses WCUs to calculate and control the operating resources that are used to run your \
         ...
         WCUs than more complex rules that use more processing power. Rule group capacity is fixed \
         at creation, which helps users plan their web ACL WCU usage when they use a rule group. \
         For more information, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/aws-waf-capacity-units.html}WAF \
         web ACL capacity units (WCU)} in the {i WAF Developer Guide}. \n\
        \ "]
  pre_process_firewall_manager_rule_groups : firewall_manager_rule_groups option;
      [@ocaml.doc
        "The first set of rules for WAF to process in the web ACL. This is defined in an Firewall \
         Manager WAF policy and contains only rule group references. You can't alter these. Any \
         rules and rule groups that you define for the web ACL are prioritized after these. \n\n\
        \ In the Firewall Manager WAF policy, the Firewall Manager administrator can define a set \
         of rule groups to run first in the web ACL and a set of rule groups to run last. Within \
         each set, the administrator prioritizes the rule groups, to determine their relative \
         processing order.\n\
        \ "]
  post_process_firewall_manager_rule_groups : firewall_manager_rule_groups option;
      [@ocaml.doc
  ...
  managed_by_firewall_manager : boolean_ option;
      [@ocaml.doc
        "Indicates whether this web ACL was created by Firewall Manager and is being managed by \
         Firewall Manager. If true, then only Firewall Manager can delete the web ACL or any \
         Firewall Manager rule groups in the web ACL. See also the properties \
         [RetrofittedByFirewallManager], [PreProcessFirewallManagerRuleGroups], and \
  ...
  association_config : association_config option;
      [@ocaml.doc
        ...
        \     For Application Load Balancer and AppSync, the limit is fixed at 8 KB (8,192 bytes).\n\
        \     "]
  retrofitted_by_firewall_manager : boolean_ option;
      [@ocaml.doc
        "Indicates whether this web ACL was created by a customer account and then retrofitted by \
         Firewall Manager. If true, then the web ACL is currently being managed by a Firewall \
         Manager WAF policy, and only Firewall Manager can manage any Firewall Manager rule groups \
         in the web ACL. See also the properties [ManagedByFirewallManager], \
         [PreProcessFirewallManagerRuleGroups], and [PostProcessFirewallManagerRuleGroups]. \n"]
  on_source_d_do_s_protection_config : on_source_d_do_s_protection_config option;
      [@ocaml.doc
        "Configures the level of DDoS protection that applies to web ACLs associated with \
         Application Load Balancers.\n"]
  application_config : application_config option;
...
type nonrec get_web_acl_for_resource_response = {
  web_ac_l : web_ac_l option;
      [@ocaml.doc
        "The web ACL that is associated with the resource. If there is no associated resource, WAF \
         returns a null web ACL.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_web_acl_for_resource_request = {
  resource_arn : resource_arn;
      [@ocaml.doc
        ...
        \            {[\n\
        \            arn:{i partition}:elasticloadbalancing:{i region}:{i \
         account-id}:loadbalancer/app/{i load-balancer-name}/{i load-balancer-id} \n\
        \            ]}\n\
        \             \n\
        \            \n\
        \             }\n\
        ...
        \            {[\n\
        \            arn:{i partition}:apigateway:{i region}::/restapis/{i api-id}/stages/{i \
         stage-name} \n\
        \            ]}\n\
        \             \n\
        \            \n\
        ...
        \            {[\n\
        \            arn:{i partition}:cognito-idp:{i region}:{i account-id}:userpool/{i \
         user-pool-id} \n\
        \            ]}\n\
        \             \n\
        \            \n\
        ...
        \            {[\n\
        \            arn:{i partition}:apprunner:{i region}:{i account-id}:service/{i \
         apprunner-service-name}/{i apprunner-service-id} \n\
        \            ]}\n\
        \             \n\
        \            \n\
        \             }\n\
        ...
        \            {[\n\
        \            arn:{i partition}:ec2:{i region}:{i account-id}:verified-access-instance/{i \
         instance-id} \n\
        \            ]}\n\
        \             \n\
        \            \n\
  ...
  application_integration_ur_l : output_url option;
      [@ocaml.doc
        "The URL to use in SDK integrations with Amazon Web Services managed rule groups. For \
         ...
         rule group [AWSManagedRulesATPRuleSet] and the account creation fraud prevention managed \
         rule group [AWSManagedRulesACFPRuleSet]. This is only populated if you are using a rule \
         group in your web ACL that integrates with your applications in this way. For more \
         information, see \
         {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-application-integration.html}WAF \
         client application integration} in the {i WAF Developer Guide}.\n"]
}
...
type nonrec get_web_acl_request = {
  ...
  id : entity_id option;
      [@ocaml.doc
        "The unique identifier for the web ACL. This ID is returned in the responses to create and \
         list commands. You provide it to operations like update and delete.\n"]
  ar_n : resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the web ACL that you want to retrieve. \n"]
}
[@@ocaml.doc ""]
  ...
  response_code : response_code option;
      [@ocaml.doc
        "The HTTP response code indicating the status of the challenge token in the web request. \
         If the token is missing, invalid, or expired, this code is [202 Request Accepted].\n"]
  solve_timestamp : solve_timestamp option;
      [@ocaml.doc "The time that the challenge was last solved for the supplied token. \n"]
  failure_reason : failure_reason option;
      [@ocaml.doc "The reason for failure, populated when the evaluation of the token fails.\n"]
}
[@@ocaml.doc "The result from the inspection of the web request for a valid challenge token. \n"]

type nonrec captcha_response = {
  response_code : response_code option;
      [@ocaml.doc
        "The HTTP response code indicating the status of the [CAPTCHA] token in the web request. \
         If the token is missing, invalid, or expired, this code is [405 Method\n\
        \            Not Allowed].\n"]
  solve_timestamp : solve_timestamp option;
      [@ocaml.doc "The time that the [CAPTCHA] was last solved for the supplied token. \n"]
  failure_reason : failure_reason option;
      [@ocaml.doc "The reason for failure, populated when the evaluation of the token fails.\n"]
}
[@@ocaml.doc "The result from the inspection of the web request for a valid [CAPTCHA] token. \n"]
...
type nonrec http_header = {
  name : header_name option; [@ocaml.doc "The name of the HTTP header.\n"]
  value : header_value option; [@ocaml.doc "The value of the HTTP header.\n"]
}
[@@ocaml.doc
  "Part of the response from [GetSampledRequests]. This is a complex type that appears as \
   [Headers] in the response syntax. [HTTPHeader] contains the names and values of all of the \
...
type nonrec sampled_http_request = {
  ...
  weight : sample_weight;
      [@ocaml.doc
        "A value that indicates how one result in the response relates proportionally to other \
         results in the response. For example, a result that has a weight of [2] represents \
         roughly twice as many web requests as a result that has a weight of [1].\n"]
  timestamp : timestamp option;
      [@ocaml.doc
        "The time at which WAF received the request from your Amazon Web Services resource, in \
         Unix time format (in seconds).\n"]
  action : action option; [@ocaml.doc "The action that WAF applied to the request.\n"]
  rule_name_within_rule_group : entity_name option;
      [@ocaml.doc
        "The name of the [Rule] that the request matched. For managed rule groups, the format for \
         this name is \n\
         {[\n\
         ##\n\
         ]}\n\
  ...
  request_headers_inserted : http_headers option;
      [@ocaml.doc
  ...
  response_code_sent : response_status_code option;
  ...
  overridden_action : action option;
      [@ocaml.doc
        "Used only for rule group rules that have a rule action override in place in the web ACL. \
         This is the action that the rule group rule is configured for, and not the action that \
         was applied to the request. The action that WAF applied is the [Action] value. \n"]
}
[@@ocaml.doc
  ...
  time_window : time_window option;
      [@ocaml.doc
        "Usually, [TimeWindow] is the time range that you specified in the [GetSampledRequests] \
         ...
         during the time range that you specified in the request, [GetSampledRequests] returns the \
  ...
  time_window : time_window;
      [@ocaml.doc
        "The start date and time and the end date and time of the range for which you want \
         ...
         three hours. If you specify a start time that's earlier than three hours ago, WAF sets it \
         to three hours ago.\n"]
...
[@@ocaml.doc
  "List of labels used by one or more of the rules of a [RuleGroup]. This summary object is used \
   for the following rule group lists: \n\n\
  \ {ul\n\
  \       {-   [AvailableLabels] - Labels that rules add to matching requests. These labels are \
  ...
  capacity : capacity_unit;
      [@ocaml.doc
        ...
        \  WAF uses WCUs to calculate and control the operating resources that are used to run \
         ...
         type, to reflect the relative cost of each rule. Simple rules that cost little to run use \
         fewer WCUs than more complex rules that use more processing power. Rule group capacity is \
         fixed at creation, which helps users plan their web ACL WCU usage when they use a rule \
  ...
  custom_response_bodies : custom_response_bodies option;
      [@ocaml.doc
        ...
        \  For information about the limits on count and size for custom request and response \
         ...
         quotas} in the {i WAF Developer Guide}. \n\
        \  "]
  available_labels : label_summaries option;
      [@ocaml.doc
  ...
  consumed_labels : label_summaries option;
      [@ocaml.doc
        "The labels that one or more rules in this rule group match against in label match \
         statements. These labels are defined in a [LabelMatchStatement] specification, in the \
...
type nonrec regex_pattern_set = {
  ...
  description : entity_description option;
      [@ocaml.doc "A description of the set that helps with identification. \n"]
  regular_expression_list : regular_expression_list option;
      [@ocaml.doc "The regular expression patterns in the set.\n"]
}
[@@ocaml.doc
  "Contains one or more regular expressions. \n\n\
  \ WAF assigns an ARN to each [RegexPatternSet] that you create. To use a set in a rule, you \
   provide the ARN to the [Rule] statement [RegexPatternSetReferenceStatement]. \n\
  \ "]
...
[@@ocaml.doc
  "The rule that you've named doesn't aggregate solely on the IP address or solely on the \
   forwarded IP address. This call is only available for rate-based rules with an \
   [AggregateKeyType] setting of [IP] or [FORWARDED_IP].\n"]

type nonrec ip_address_version = IPV4 [@ocaml.doc ""] | IPV6 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec rate_based_statement_managed_keys_ip_set = {
  ...
  addresses : ip_addresses option; [@ocaml.doc "The IP addresses that are currently blocked.\n"]
}
[@@ocaml.doc
  ...
  \ A rate-based rule applies its rule action to requests from IP addresses that are in the rule's \
   managed keys list and that match the rule's scope-down statement. When a rule has no scope-down \
   statement, it applies the action to all requests from the IP addresses that are in the list. \
   The rule applies its rule action to rate limit the matching requests. The action is usually \
   Block but it can be any valid rule action except for Allow. \n\
  \ \n\
  \  The maximum number of IP addresses that can be rate limited by a single rate-based rule \
...
type nonrec get_rate_based_statement_managed_keys_response = {
  managed_keys_ip_v4 : rate_based_statement_managed_keys_ip_set option;
      [@ocaml.doc "The keys that are of Internet Protocol version 4 (IPv4). \n"]
  managed_keys_ip_v6 : rate_based_statement_managed_keys_ip_set option;
      [@ocaml.doc "The keys that are of Internet Protocol version 6 (IPv6). \n"]
}
[@@ocaml.doc ""]
...
type nonrec get_rate_based_statement_managed_keys_request = {
  ...
  web_acl_id : entity_id;
      [@ocaml.doc
        "The unique identifier for the web ACL. This ID is returned in the responses to create and \
         list commands. You provide it to operations like update and delete.\n"]
  rule_group_rule_name : entity_name option;
      [@ocaml.doc
...
type nonrec get_permission_policy_response = {
  policy : policy_string option;
      [@ocaml.doc "The IAM policy that is attached to the specified rule group.\n"]
}
[@@ocaml.doc ""]
...
type nonrec release_notes = string [@@ocaml.doc ""]

type nonrec mobile_sdk_release = {
  release_version : version_key_string option; [@ocaml.doc "The release version. \n"]
  timestamp : timestamp option; [@ocaml.doc "The timestamp of the release. \n"]
  release_notes : release_notes option; [@ocaml.doc "Notes describing the release.\n"]
...
type nonrec get_mobile_sdk_release_response = {
  mobile_sdk_release : mobile_sdk_release option;
      [@ocaml.doc "Information for a specified SDK release, including release notes and tags.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_mobile_sdk_release_request = {
  ...
  release_version : version_key_string;
      [@ocaml.doc "The release version. For the latest available version, specify [LATEST].\n"]
}
[@@ocaml.doc ""]
...
type nonrec managed_rule_set_version = {
  ...
  publish_timestamp : timestamp option;
      [@ocaml.doc
...
[@@ocaml.doc
  "Contains zero or more IP addresses or blocks of IP addresses specified in Classless \
   ...
   For information about CIDR notation, see the Wikipedia entry \
   {{:https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing}Classless Inter-Domain \
   Routing}. \n\n\
...
type nonrec get_decrypted_api_key_request = {
  scope : scope;
      [@ocaml.doc
        ...
        \        }\n\
        \  "]
  api_key : api_key; [@ocaml.doc "The encrypted API key. \n"]
}
[@@ocaml.doc ""]

type nonrec download_url = string [@@ocaml.doc ""]

type nonrec generate_mobile_sdk_release_url_response = {
  url : download_url option;
      [@ocaml.doc "The presigned download URL for the specified SDK release.\n"]
}
[@@ocaml.doc ""]
...
type nonrec disassociate_web_acl_response = unit [@@ocaml.doc ""]
...
type nonrec rule_summary = {
  name : entity_name option; [@ocaml.doc "The name of the rule. \n"]
  action : rule_action option;
      [@ocaml.doc
...
[@@ocaml.doc
  "High-level information about a [Rule], returned by operations like [DescribeManagedRuleGroup]. \
   This provides information like the ID, that you can use to retrieve and manage a [RuleGroup], \
...
type nonrec describe_managed_rule_group_response = {
  version_name : version_key_string option; [@ocaml.doc "The managed rule group's version. \n"]
  sns_topic_arn : resource_arn option;
      [@ocaml.doc
        "The Amazon resource name (ARN) of the Amazon Simple Notification Service SNS topic that's \
         used to provide notification of changes to the managed rule group. You can subscribe to \
         the SNS topic to receive notifications when the managed rule group is modified, such as \
         for new versions and for version expiration. For more information, see the \
  ...
  capacity : capacity_unit option;
      [@ocaml.doc
        ...
        \ WAF uses WCUs to calculate and control the operating resources that are used to run your \
         ...
         web ACL capacity units (WCU)} in the {i WAF Developer Guide}. \n\
        \ "]
  rules : rule_summaries option; [@ocaml.doc "\n"]
  label_namespace : label_name option;
      [@ocaml.doc
        "The label namespace prefix for this rule group. All labels added by rules in this rule \
         group have this prefix. \n\n\
...
type nonrec describe_managed_rule_group_request = {
  ...
  scope : scope;
      [@ocaml.doc
        ...
        \        }\n\
        \  "]
  version_name : version_key_string option;
      [@ocaml.doc
...
type nonrec product_title = string [@@ocaml.doc ""]

type nonrec product_link = string [@@ocaml.doc ""]
...
type nonrec managed_product_descriptor = {
  vendor_name : vendor_name option;
      [@ocaml.doc
        "The name of the managed rule group vendor. You use this, along with the rule group name, \
         to identify a rule group.\n"]
  managed_rule_set_name : entity_name option;
      [@ocaml.doc
  ...
  product_id : product_id option;
      [@ocaml.doc
        "A unique identifier for the rule group. This ID is returned in the responses to create \
         and list commands. You provide it to operations like update and delete.\n"]
  product_link : product_link option;
      [@ocaml.doc
        "For Amazon Web Services Marketplace managed rule groups only, the link to the rule group \
         product page. \n"]
  product_title : product_title option;
      [@ocaml.doc
        "The display name for the managed rule group. For example, [Anonymous IP list] or [Account \
         takeover prevention].\n"]
  product_description : product_description option;
  ...
  sns_topic_arn : resource_arn option;
      [@ocaml.doc
        "The Amazon resource name (ARN) of the Amazon Simple Notification Service SNS topic that's \
         ...
         {{:https://docs.aws.amazon.com/sns/latest/dg/welcome.html}Amazon Simple Notification \
         Service Developer Guide}.\n"]
  is_versioning_supported : boolean_ option;
      [@ocaml.doc "Indicates whether the rule group is versioned. \n"]
  is_advanced_managed_rule_set : boolean_ option;
      [@ocaml.doc
        "Indicates whether the rule group provides an advanced set of protections, such as the the \
         Amazon Web Services Managed Rules rule groups that are used for WAF intelligent threat \
         mitigation. \n"]
}
[@@ocaml.doc
  "The properties of a managed product, such as an Amazon Web Services Managed Rules rule group or \
   an Amazon Web Services Marketplace managed rule group. \n"]

type nonrec managed_product_descriptors = managed_product_descriptor list [@@ocaml.doc ""]

type nonrec describe_managed_products_by_vendor_response = {
  managed_products : managed_product_descriptors option;
      [@ocaml.doc
...
type nonrec describe_all_managed_products_response = {
  managed_products : managed_product_descriptors option;
      [@ocaml.doc
        "High-level information for the Amazon Web Services Managed Rules rule groups and Amazon \
         Web Services Marketplace managed rule groups. \n"]
}
[@@ocaml.doc ""]
...
type nonrec waf_associated_item_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  "WAF couldn\226\128\153t perform the operation because your resource is being used by another \
   resource or it\226\128\153s associated with another resource. \n"]

type nonrec delete_web_acl_response = unit [@@ocaml.doc ""]
...
type nonrec delete_rule_group_response = unit [@@ocaml.doc ""]
...
type nonrec delete_regex_pattern_set_response = unit [@@ocaml.doc ""]
...
type nonrec delete_ip_set_response = unit [@@ocaml.doc ""]
...
type nonrec delete_firewall_manager_rule_groups_response = {
  next_web_acl_lock_token : lock_token option;
      [@ocaml.doc
        "A token used for optimistic locking. WAF returns a token to your [get] and [list] \
         requests, to mark the state of the entity at the time of the request. To make changes to \
         the entity associated with the token, you provide the token to operations like [update] \
...
type nonrec delete_api_key_response = unit [@@ocaml.doc ""]
...
type nonrec delete_api_key_request = {
  scope : scope;
      [@ocaml.doc
        ...
        \        }\n\
        \  "]
  api_key : api_key; [@ocaml.doc "The encrypted API key that you want to delete. \n"]
}
[@@ocaml.doc ""]
...
type nonrec create_web_acl_request = {
  ...
  tags : tag_list option;
      [@ocaml.doc "An array of key:value pairs to associate with the resource.\n"]
  custom_response_bodies : custom_response_bodies option;
      [@ocaml.doc
        "A map of custom response keys and content bodies. When you create a rule with a block \
         action, you can send a custom response to the web request. You define these for the web \
  ...
  summary : rule_group_summary option;
      [@ocaml.doc
        "High-level information about a [RuleGroup], returned by operations like create and list. \
         This provides information like the ID, that you can use to retrieve and manage a \
         [RuleGroup], and the ARN, that you provide to the [RuleGroupReferenceStatement] to use \
         the rule group in a [Rule].\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_regex_pattern_set_response = {
  summary : regex_pattern_set_summary option;
      [@ocaml.doc
        "High-level information about a [RegexPatternSet], returned by operations like create and \
         list. This provides information like the ID, that you can use to retrieve and manage a \
  ...
  summary : ip_set_summary option;
      [@ocaml.doc
        "High-level information about an [IPSet], returned by operations like create and list. \
         ...
         [IPSet], and the ARN, that you provide to the [IPSetReferenceStatement] to use the \
         address set in a [Rule].\n"]
}
[@@ocaml.doc ""]
...
type nonrec check_capacity_response = {
  capacity : consumed_capacity option; [@ocaml.doc "The capacity required by the rules and scope.\n"]
}
[@@ocaml.doc ""]
...
type nonrec associate_web_acl_response = unit [@@ocaml.doc ""]
