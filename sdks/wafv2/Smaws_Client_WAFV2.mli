...
val make_json_match_pattern :
  ?included_paths:json_pointer_paths -> ?all:all -> unit -> json_match_pattern
...
val make_custom_http_header :
  value:custom_http_header_value -> name:custom_http_header_name -> unit -> custom_http_header
...
val make_rule_action_override :
  action_to_use:rule_action -> name:entity_name -> unit -> rule_action_override
...
val make_rate_limit_header :
  text_transformations:text_transformations -> name:field_to_match_data -> unit -> rate_limit_header

val make_rate_limit_cookie :
  text_transformations:text_transformations -> name:field_to_match_data -> unit -> rate_limit_cookie
...
val make_label_match_statement :
  key:label_match_key -> scope:label_match_scope -> unit -> label_match_statement
...
val make_custom_response_body :
  content:response_content -> content_type:response_content_type -> unit -> custom_response_body
...
val make_rule_summary : ?action:rule_action -> ?name:entity_name -> unit -> rule_summary
...
val make_logging_filter :
  default_behavior:filter_behavior -> filters:filters -> unit -> logging_filter
...
val make_managed_rule_group_version :
  ?last_update_timestamp:timestamp -> ?name:version_key_string -> unit -> managed_rule_group_version
...
val make_list_ip_sets_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> scope:scope -> unit -> list_ip_sets_request
...
val make_get_rule_group_response :
  ?lock_token:lock_token -> ?rule_group:rule_group -> unit -> get_rule_group_response
...
val make_get_regex_pattern_set_request :
  id:entity_id -> scope:scope -> name:entity_name -> unit -> get_regex_pattern_set_request
...
val make_get_mobile_sdk_release_request :
  release_version:version_key_string -> platform:platform -> unit -> get_mobile_sdk_release_request
...
val make_get_managed_rule_set_request :
  id:entity_id -> scope:scope -> name:entity_name -> unit -> get_managed_rule_set_request
...
val make_get_ip_set_request :
  id:entity_id -> scope:scope -> name:entity_name -> unit -> get_ip_set_request
...
val make_describe_managed_products_by_vendor_request :
  scope:scope -> vendor_name:vendor_name -> unit -> describe_managed_products_by_vendor_request
...
val make_delete_api_key_request : api_key:api_key -> scope:scope -> unit -> delete_api_key_request
...
val make_create_api_key_request :
  token_domains:api_key_token_domains -> scope:scope -> unit -> create_api_key_request

val make_check_capacity_response : ?capacity:consumed_capacity -> unit -> check_capacity_response
val make_check_capacity_request : rules:rules -> scope:scope -> unit -> check_capacity_request
val make_associate_web_acl_response : unit -> unit

val make_associate_web_acl_request :
  resource_arn:resource_arn -> web_acl_arn:resource_arn -> unit -> associate_web_acl_request
