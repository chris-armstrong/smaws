...
type nonrec rate_based_statement_custom_keys =
  rate_based_statement_custom_key list[@@ocaml.doc ""]
...
type nonrec label = {
  name: label_name [@ocaml.doc "The label string. \n"]}[@@ocaml.doc
...
type nonrec custom_response_bodies =
  (entity_name * custom_response_body) list[@@ocaml.doc ""]
...
type nonrec application_attribute =
  {
  values: attribute_values option
...
type nonrec web_ac_l =
  ...
  post_process_firewall_manager_rule_groups:
    firewall_manager_rule_groups option
    [@ocaml.doc
...
type nonrec versions_to_publish =
  (version_key_string * version_to_publish) list[@@ocaml.doc ""]
...
type nonrec update_managed_rule_set_version_expiry_date_response =
  ...
  expiring_version: version_key_string option
...
type nonrec release_summary =
  ...
  release_version: version_key_string option
...
type nonrec published_versions =
  (version_key_string * managed_rule_set_version) list[@@ocaml.doc ""]
...
type nonrec mobile_sdk_release =
  ...
  release_notes: release_notes option
...
type nonrec api_key_summary =
  {
  version: api_key_version option
...
val make_associate_web_acl_request :
  resource_arn:resource_arn ->
    web_acl_arn:resource_arn -> unit -> associate_web_acl_request(** {1:operations Operations} *)
