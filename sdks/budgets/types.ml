...
type nonrec subscription_type = SNS [@ocaml.doc ""] | EMAIL [@ocaml.doc ""]
...
type nonrec notification_state = OK [@ocaml.doc ""] | ALARM [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec threshold_type = PERCENTAGE [@ocaml.doc ""] | ABSOLUTE_VALUE [@ocaml.doc ""]
...
type nonrec notification_type = ACTUAL [@ocaml.doc ""] | FORECASTED [@ocaml.doc ""]
...
type nonrec approval_model = AUTO [@ocaml.doc ""] | MANUAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec action_sub_type = STOP_EC2 [@ocaml.doc ""] | STOP_RDS [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec action_type = IAM [@ocaml.doc ""] | SCP [@ocaml.doc ""] | SSM [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec health_status_value = HEALTHY [@ocaml.doc ""] | UNHEALTHY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec auto_adjust_type = HISTORICAL [@ocaml.doc ""] | FORECAST [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec untag_resource_request = {
  ...
  resource_tag_keys : resource_tag_key_list; [@ocaml.doc "The key that's associated with the tag.\n"]
}
[@@ocaml.doc ""]
