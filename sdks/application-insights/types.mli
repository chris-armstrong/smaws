...
type nonrec os_type = WINDOWS [@ocaml.doc ""] | LINUX [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec discovery_type = RESOURCE_GROUP_BASED [@ocaml.doc ""] | ACCOUNT_BASED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec log_filter = ERROR [@ocaml.doc ""] | WARN [@ocaml.doc ""] | INFO [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec visibility = IGNORED [@ocaml.doc ""] | VISIBLE [@ocaml.doc ""] [@@ocaml.doc ""]
