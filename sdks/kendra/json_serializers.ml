...
let table_excerpt_to_yojson (x : table_excerpt) =
  assoc_to_yojson
    [("TotalNumberOfRows",
       (option_to_yojson integer_to_yojson x.total_number_of_rows));
...
let query_result_to_yojson (x : query_result) =
  assoc_to_yojson
    ...
    ("TotalNumberOfResults",
      (option_to_yojson integer_to_yojson x.total_number_of_results));
    ("FacetResults",
      (option_to_yojson facet_result_list_to_yojson x.facet_results));
    ("ResultItems",
...
let expand_configuration_to_yojson (x : expand_configuration) =
  assoc_to_yojson
    ...
    ("MaxResultItemsToExpand",
      (option_to_yojson integer_to_yojson x.max_result_items_to_expand))]
...
let group_ordering_id_summary_to_yojson (x : group_ordering_id_summary) =
  assoc_to_yojson
    ...
    ("LastUpdatedAt",
      (option_to_yojson timestamp_to_yojson x.last_updated_at));
    ("Status",
...
let get_query_suggestions_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("MaxSuggestionsCount",
      (option_to_yojson integer_to_yojson x.max_suggestions_count));
...
let describe_query_suggestions_config_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("TotalSuggestionsCount",
      (option_to_yojson integer_to_yojson x.total_suggestions_count));
    ("LastClearTime",
      (option_to_yojson timestamp_to_yojson x.last_clear_time));
