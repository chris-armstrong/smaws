...
type nonrec key_location = SECRET_MANAGER [@ocaml.doc ""] | URL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec user_group_resolution_mode = NONE [@ocaml.doc ""] | AWS_SSO [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec user_context_policy = USER_TOKEN [@ocaml.doc ""] | ATTRIBUTE_FILTER [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec mode = LEARN_ONLY [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec attribute_suggestions_mode = INACTIVE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec order = DESCENDING [@ocaml.doc ""] | ASCENDING [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec featured_results_set_status = INACTIVE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec salesforce_configuration = {
  ...
  secret_arn : secret_arn;
      [@ocaml.doc
        ...
        \       }\n\
        \  "]
  server_url : url; [@ocaml.doc "The instance URL for the Salesforce site that you want to index.\n"]
}
[@@ocaml.doc
...
type nonrec service_now_build_version_type = OTHERS [@ocaml.doc ""] | LONDON [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec service_now_authentication_type = OAUTH2 [@ocaml.doc ""] | HTTP_BASIC [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec confluence_version = SERVER [@ocaml.doc ""] | CLOUD [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec confluence_authentication_type = PAT [@ocaml.doc ""] | HTTP_BASIC [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec type_ = ON_PREMISE [@ocaml.doc ""] | SAAS [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec principal_type = GROUP [@ocaml.doc ""] | USER [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec read_access_type = DENY [@ocaml.doc ""] | ALLOW [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec highlight_type = THESAURUS_SYNONYM [@ocaml.doc ""] | STANDARD [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec suggestion_type = DOCUMENT_ATTRIBUTES [@ocaml.doc ""] | QUERY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec relevance_type = NOT_RELEVANT [@ocaml.doc ""] | RELEVANT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec sort_order = ASC [@ocaml.doc ""] | DESC [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec query_suggestions_status = UPDATING [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec query_result_format = TEXT [@ocaml.doc ""] | TABLE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec persona = VIEWER [@ocaml.doc ""] | OWNER [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec entity_type = GROUP [@ocaml.doc ""] | USER [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec error_code = INVALID_REQUEST [@ocaml.doc ""] | INTERNAL_ERROR [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec describe_thesaurus_request = {
  index_id : index_id; [@ocaml.doc "The identifier of the index for the thesaurus.\n"]
  id : thesaurus_id; [@ocaml.doc "The identifier of the thesaurus you want to get information on.\n"]
}
[@@ocaml.doc ""]
