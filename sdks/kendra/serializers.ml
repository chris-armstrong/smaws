...
let data_source_inclusions_exclusions_strings_to_yojson tree =
  list_to_yojson data_source_inclusions_exclusions_strings_member_to_yojson
    tree
...
let data_source_to_index_field_mapping_to_yojson
  (x : data_source_to_index_field_mapping) =
  assoc_to_yojson
    [("IndexFieldName",
       (Some (index_field_name_to_yojson x.index_field_name)));
    ("DateFieldFormat",
      (option_to_yojson data_source_date_field_format_to_yojson
         x.date_field_format));
    ("DataSourceFieldName",
  ...
  assoc_to_yojson
    ...
    ("ExclusionPatterns",
      (option_to_yojson data_source_inclusions_exclusions_strings_to_yojson
         x.exclusion_patterns));
    ("InclusionPatterns",
      (option_to_yojson data_source_inclusions_exclusions_strings_to_yojson
         x.inclusion_patterns));
...
let site_maps_configuration_to_yojson (x : site_maps_configuration) =
  assoc_to_yojson
    [("SiteMaps", (Some (site_maps_list_to_yojson x.site_maps)))]
let urls_to_yojson (x : urls) =
  assoc_to_yojson
    [("SiteMapsConfiguration",
       (option_to_yojson site_maps_configuration_to_yojson
          x.site_maps_configuration));
    ("SeedUrlConfiguration",
      (option_to_yojson seed_url_configuration_to_yojson
         x.seed_url_configuration))]
...
let basic_authentication_configuration_to_yojson
  (x : basic_authentication_configuration) =
  assoc_to_yojson
...
let authentication_configuration_to_yojson (x : authentication_configuration)
  ...
  assoc_to_yojson
    [("BasicAuthentication",
       (option_to_yojson basic_authentication_configuration_list_to_yojson
          x.basic_authentication))]
let web_crawler_configuration_to_yojson (x : web_crawler_configuration) =
  assoc_to_yojson
    [("AuthenticationConfiguration",
       (option_to_yojson authentication_configuration_to_yojson
          x.authentication_configuration));
    ("ProxyConfiguration",
    ...
    ("MaxUrlsPerMinuteCrawlRate",
      (option_to_yojson max_urls_per_minute_crawl_rate_to_yojson
         x.max_urls_per_minute_crawl_rate));
...
let jwt_token_type_configuration_to_yojson (x : jwt_token_type_configuration)
  ...
  assoc_to_yojson
    ...
    ("GroupAttributeField",
      (option_to_yojson group_attribute_field_to_yojson
         x.group_attribute_field));
    ("UserNameAttributeField",
      (option_to_yojson user_name_attribute_field_to_yojson
         x.user_name_attribute_field));
    ("SecretManagerArn",
...
let json_token_type_configuration_to_yojson
  (x : json_token_type_configuration) =
  assoc_to_yojson
    [("GroupAttributeField",
...
let user_token_configuration_to_yojson (x : user_token_configuration) =
  assoc_to_yojson
    [("JsonTokenTypeConfiguration",
       (option_to_yojson json_token_type_configuration_to_yojson
          x.json_token_type_configuration));
    ("JwtTokenTypeConfiguration",
      (option_to_yojson jwt_token_type_configuration_to_yojson
         x.jwt_token_type_configuration))]
...
let data_source_groups_to_yojson tree =
  list_to_yojson data_source_group_to_yojson tree
...
let suggestable_config_list_to_yojson tree =
  list_to_yojson suggestable_config_to_yojson tree
...
let attribute_suggestions_update_config_to_yojson
  (x : attribute_suggestions_update_config) =
  assoc_to_yojson
    [("AttributeSuggestionsMode",
       (option_to_yojson attribute_suggestions_mode_to_yojson
          x.attribute_suggestions_mode));
    ("SuggestableConfigList",
      (option_to_yojson suggestable_config_list_to_yojson
         x.suggestable_config_list))]
let update_query_suggestions_config_request_to_yojson
  (x : update_query_suggestions_config_request) =
  assoc_to_yojson
    ...
    ("IncludeQueriesWithoutUserInformation",
      (option_to_yojson object_boolean_to_yojson
         x.include_queries_without_user_information));
    ("QueryLogLookBackWindowInDays",
      (option_to_yojson integer__to_yojson
         x.query_log_look_back_window_in_days));
...
let document_attribute_value_type_to_yojson
  (x : document_attribute_value_type) =
  match x with
...
let relevance_to_yojson (x : relevance) =
  assoc_to_yojson
    [("ValueImportanceMap",
       (option_to_yojson value_importance_map_to_yojson
          x.value_importance_map));
...
let document_metadata_configuration_to_yojson
  (x : document_metadata_configuration) =
  assoc_to_yojson
...
let update_index_request_to_yojson (x : update_index_request) =
  assoc_to_yojson
    ...
    ("UserTokenConfigurations",
      (option_to_yojson user_token_configuration_list_to_yojson
         x.user_token_configurations));
    ("CapacityUnits",
      (option_to_yojson capacity_units_configuration_to_yojson
         x.capacity_units));
...
let featured_document_list_to_yojson tree =
  list_to_yojson featured_document_to_yojson tree
...
let featured_results_set_to_yojson (x : featured_results_set) =
  assoc_to_yojson
    ...
    ("Description",
      (option_to_yojson featured_results_set_description_to_yojson
         x.description));
    ("FeaturedResultsSetName",
      (option_to_yojson featured_results_set_name_to_yojson
         x.featured_results_set_name));
    ("FeaturedResultsSetId",
      (option_to_yojson featured_results_set_id_to_yojson
         x.featured_results_set_id))]
let update_featured_results_set_response_to_yojson
  (x : update_featured_results_set_response) =
  assoc_to_yojson
    [("FeaturedResultsSet",
       (option_to_yojson featured_results_set_to_yojson
          x.featured_results_set))]
let update_featured_results_set_request_to_yojson
  (x : update_featured_results_set_request) =
  assoc_to_yojson
    [("FeaturedDocuments",
       (option_to_yojson featured_document_list_to_yojson
          x.featured_documents));
    ("QueryTexts",
      (option_to_yojson query_text_list_to_yojson x.query_texts));
    ("Status",
      (option_to_yojson featured_results_set_status_to_yojson x.status));
...
let conflicting_items_to_yojson tree =
  list_to_yojson conflicting_item_to_yojson tree
let featured_results_conflict_exception_to_yojson
  (x : featured_results_conflict_exception) =
  assoc_to_yojson
    [("ConflictingItems",
...
let data_source_id_list_to_yojson tree =
  list_to_yojson data_source_id_to_yojson tree
...
let experience_configuration_to_yojson (x : experience_configuration) =
  assoc_to_yojson
    [("UserIdentityConfiguration",
       (option_to_yojson user_identity_configuration_to_yojson
          x.user_identity_configuration));
    ("ContentSourceConfiguration",
      (option_to_yojson content_source_configuration_to_yojson
         x.content_source_configuration))]
...
let access_control_list_configuration_to_yojson
  ...
  assoc_to_yojson
    [("KeyPath", (option_to_yojson s3_object_key_to_yojson x.key_path))]
...
let security_group_id_list_to_yojson tree =
  list_to_yojson vpc_security_group_id_to_yojson tree
let data_source_vpc_configuration_to_yojson
  (x : data_source_vpc_configuration) =
  assoc_to_yojson
    [("SecurityGroupIds",
...
let share_point_online_authentication_type_to_yojson
  (x : share_point_online_authentication_type) =
  match x with
...
let share_point_configuration_to_yojson (x : share_point_configuration) =
  assoc_to_yojson
    [("ProxyConfiguration",
       (option_to_yojson proxy_configuration_to_yojson x.proxy_configuration));
    ("AuthenticationType",
      (option_to_yojson share_point_online_authentication_type_to_yojson
    ...
    ("DocumentTitleFieldName",
      (option_to_yojson data_source_field_name_to_yojson
         x.document_title_field_name));
    ("FieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.field_mappings));
    ("VpcConfiguration",
      (option_to_yojson data_source_vpc_configuration_to_yojson
         x.vpc_configuration));
    ("ExclusionPatterns",
      (option_to_yojson data_source_inclusions_exclusions_strings_to_yojson
         x.exclusion_patterns));
...
let change_detecting_columns_to_yojson tree =
  list_to_yojson column_name_to_yojson tree
...
let salesforce_standard_object_name_to_yojson
  (x : salesforce_standard_object_name) =
  match x with
  | USER -> `String "USER"
  | TASK -> `String "TASK"
...
let salesforce_knowledge_article_state_to_yojson
  (x : salesforce_knowledge_article_state) =
  match x with
...
let salesforce_custom_knowledge_article_type_configuration_list_to_yojson
  tree =
  list_to_yojson
    salesforce_custom_knowledge_article_type_configuration_to_yojson tree
let salesforce_knowledge_article_configuration_to_yojson
  (x : salesforce_knowledge_article_configuration) =
  assoc_to_yojson
    [("CustomKnowledgeArticleTypeConfigurations",
       (option_to_yojson
          salesforce_custom_knowledge_article_type_configuration_list_to_yojson
          x.custom_knowledge_article_type_configurations));
    ("StandardKnowledgeArticleTypeConfiguration",
      (option_to_yojson
         salesforce_standard_knowledge_article_type_configuration_to_yojson
         x.standard_knowledge_article_type_configuration));
    ("IncludedStates",
      (Some
         (salesforce_knowledge_article_state_list_to_yojson x.included_states)))]
...
let salesforce_chatter_feed_configuration_to_yojson
  (x : salesforce_chatter_feed_configuration) =
  assoc_to_yojson
    [("IncludeFilterTypes",
       (option_to_yojson
          salesforce_chatter_feed_include_filter_types_to_yojson
...
let salesforce_configuration_to_yojson (x : salesforce_configuration) =
  assoc_to_yojson
    ...
    ("StandardObjectAttachmentConfiguration",
      (option_to_yojson
         salesforce_standard_object_attachment_configuration_to_yojson
    ...
    ("StandardObjectConfigurations",
      (option_to_yojson
         salesforce_standard_object_configuration_list_to_yojson
...
let one_drive_user_list_to_yojson tree =
  list_to_yojson one_drive_user_to_yojson tree
...
let service_now_build_version_type_to_yojson
  (x : service_now_build_version_type) =
  match x with | OTHERS -> `String "OTHERS" | LONDON -> `String "LONDON"
...
let service_now_knowledge_article_configuration_to_yojson
  ...
  assoc_to_yojson
    [("FilterQuery",
       (option_to_yojson service_now_knowledge_article_filter_query_to_yojson
          x.filter_query));
    ("FieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.field_mappings));
...
let service_now_authentication_type_to_yojson
  (x : service_now_authentication_type) =
  match x with
  | OAUTH2 -> `String "OAUTH2"
  | HTTP_BASIC -> `String "HTTP_BASIC"
let service_now_configuration_to_yojson (x : service_now_configuration) =
  assoc_to_yojson
    [("AuthenticationType",
       (option_to_yojson service_now_authentication_type_to_yojson
          x.authentication_type));
    ...
    ("ServiceNowBuildVersion",
      (Some
         (service_now_build_version_type_to_yojson
            x.service_now_build_version)));
    ("SecretArn", (Some (secret_arn_to_yojson x.secret_arn)));
    ("HostUrl", (Some (service_now_host_url_to_yojson x.host_url)))]
let confluence_version_to_yojson (x : confluence_version) =
  match x with | SERVER -> `String "SERVER" | CLOUD -> `String "CLOUD"
let confluence_space_identifier_to_yojson = string_to_yojson
let confluence_space_list_to_yojson tree =
  list_to_yojson confluence_space_identifier_to_yojson tree
...
let confluence_space_to_index_field_mapping_to_yojson
  (x : confluence_space_to_index_field_mapping) =
  assoc_to_yojson
    [("IndexFieldName",
    ...
    ("DateFieldFormat",
      (option_to_yojson data_source_date_field_format_to_yojson
         x.date_field_format));
    ("DataSourceFieldName",
      (option_to_yojson confluence_space_field_name_to_yojson
         x.data_source_field_name))]
...
let confluence_space_configuration_to_yojson
  (x : confluence_space_configuration) =
  assoc_to_yojson
    [("SpaceFieldMappings",
       (option_to_yojson confluence_space_field_mappings_list_to_yojson
          x.space_field_mappings));
    ("ExcludeSpaces",
...
let confluence_page_to_index_field_mapping_to_yojson
  (x : confluence_page_to_index_field_mapping) =
  assoc_to_yojson
    [("IndexFieldName",
       (option_to_yojson index_field_name_to_yojson x.index_field_name));
    ("DateFieldFormat",
      (option_to_yojson data_source_date_field_format_to_yojson
         x.date_field_format));
    ("DataSourceFieldName",
      (option_to_yojson confluence_page_field_name_to_yojson
         x.data_source_field_name))]
...
let confluence_page_configuration_to_yojson
  (x : confluence_page_configuration) =
  assoc_to_yojson
    [("PageFieldMappings",
       (option_to_yojson confluence_page_field_mappings_list_to_yojson
          x.page_field_mappings))]
...
let confluence_blog_to_index_field_mapping_to_yojson
  (x : confluence_blog_to_index_field_mapping) =
  assoc_to_yojson
    [("IndexFieldName",
       (option_to_yojson index_field_name_to_yojson x.index_field_name));
    ("DateFieldFormat",
      (option_to_yojson data_source_date_field_format_to_yojson
         x.date_field_format));
    ("DataSourceFieldName",
      (option_to_yojson confluence_blog_field_name_to_yojson
         x.data_source_field_name))]
...
let confluence_blog_configuration_to_yojson
  (x : confluence_blog_configuration) =
  assoc_to_yojson
    [("BlogFieldMappings",
       (option_to_yojson confluence_blog_field_mappings_list_to_yojson
          x.blog_field_mappings))]
let confluence_attachment_field_name_to_yojson
  (x : confluence_attachment_field_name) =
  match x with
  | VERSION -> `String "VERSION"
  | URL -> `String "URL"
  | SPACE_NAME -> `String "SPACE_NAME"
  ...
  assoc_to_yojson
    ...
    ("DateFieldFormat",
      (option_to_yojson data_source_date_field_format_to_yojson
         x.date_field_format));
    ("DataSourceFieldName",
      (option_to_yojson confluence_attachment_field_name_to_yojson
         x.data_source_field_name))]
...
let confluence_attachment_configuration_to_yojson
  (x : confluence_attachment_configuration) =
  assoc_to_yojson
...
let confluence_authentication_type_to_yojson
  (x : confluence_authentication_type) =
  match x with | PAT -> `String "PAT" | HTTP_BASIC -> `String "HTTP_BASIC"
let confluence_configuration_to_yojson (x : confluence_configuration) =
  assoc_to_yojson
    [("AuthenticationType",
       (option_to_yojson confluence_authentication_type_to_yojson
          x.authentication_type));
    ("ProxyConfiguration",
      (option_to_yojson proxy_configuration_to_yojson x.proxy_configuration));
    ("ExclusionPatterns",
    ...
    ("AttachmentConfiguration",
      (option_to_yojson confluence_attachment_configuration_to_yojson
         x.attachment_configuration));
    ("BlogConfiguration",
      (option_to_yojson confluence_blog_configuration_to_yojson
         x.blog_configuration));
    ("PageConfiguration",
      (option_to_yojson confluence_page_configuration_to_yojson
         x.page_configuration));
    ("SpaceConfiguration",
      (option_to_yojson confluence_space_configuration_to_yojson
         x.space_configuration));
    ("Version", (Some (confluence_version_to_yojson x.version)));
    ("SecretArn", (Some (secret_arn_to_yojson x.secret_arn)));
    ("ServerUrl", (Some (url_to_yojson x.server_url)))]
let mime_type_to_yojson = string_to_yojson
let exclude_mime_types_list_to_yojson tree =
  list_to_yojson mime_type_to_yojson tree
let exclude_user_accounts_list_to_yojson tree =
  list_to_yojson user_account_to_yojson tree
let shared_drive_id_to_yojson = string_to_yojson
let exclude_shared_drives_list_to_yojson tree =
  list_to_yojson shared_drive_id_to_yojson tree
let google_drive_configuration_to_yojson (x : google_drive_configuration) =
  assoc_to_yojson
    [("ExcludeSharedDrives",
       (option_to_yojson exclude_shared_drives_list_to_yojson
          x.exclude_shared_drives));
    ("ExcludeUserAccounts",
      (option_to_yojson exclude_user_accounts_list_to_yojson
         x.exclude_user_accounts));
    ("ExcludeMimeTypes",
      (option_to_yojson exclude_mime_types_list_to_yojson
         x.exclude_mime_types));
    ("FieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.field_mappings));
    ("ExclusionPatterns",
...
let slack_entity_list_to_yojson tree =
  list_to_yojson slack_entity_to_yojson tree
let since_crawl_date_to_yojson = string_to_yojson
let look_back_period_to_yojson = int_to_yojson
let private_channel_filter_to_yojson tree =
  list_to_yojson string__to_yojson tree
let public_channel_filter_to_yojson tree =
  list_to_yojson string__to_yojson tree
  ...
  assoc_to_yojson
    ...
    ("InclusionPatterns",
      (option_to_yojson data_source_inclusions_exclusions_strings_to_yojson
         x.inclusion_patterns));
    ("PublicChannelFilter",
      (option_to_yojson public_channel_filter_to_yojson
         x.public_channel_filter));
    ("PrivateChannelFilter",
      (option_to_yojson private_channel_filter_to_yojson
         x.private_channel_filter));
    ("LookBackPeriod",
...
let box_configuration_to_yojson (x : box_configuration) =
  assoc_to_yojson
    ...
    ("WebLinkFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.web_link_field_mappings));
    ("CommentFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.comment_field_mappings));
    ("TaskFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.task_field_mappings));
    ("FileFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.file_field_mappings));
    ("CrawlWebLinks",
...
let quip_configuration_to_yojson (x : quip_configuration) =
  assoc_to_yojson
    ...
    ("MessageFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.message_field_mappings));
    ("ThreadFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.thread_field_mappings));
...
let issue_sub_entity_filter_to_yojson tree =
  list_to_yojson issue_sub_entity_to_yojson tree
let jira_configuration_to_yojson (x : jira_configuration) =
  assoc_to_yojson
    ...
    ("WorkLogFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.work_log_field_mappings));
    ("ProjectFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.project_field_mappings));
    ("IssueFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.issue_field_mappings));
    ("CommentFieldMappings",
      (option_to_yojson data_source_to_index_field_mapping_list_to_yojson
         x.comment_field_mappings));
    ("AttachmentFieldMappings",
    ...
    ("IssueSubEntityFilter",
      (option_to_yojson issue_sub_entity_filter_to_yojson
         x.issue_sub_entity_filter));
...
let type__to_yojson (x : type_) =
  match x with | ON_PREMISE -> `String "ON_PREMISE" | SAAS -> `String "SAAS"
  ...
  assoc_to_yojson
    [("CrawlPullRequestCommentAttachment",
       (option_to_yojson boolean__to_yojson
          x.crawl_pull_request_comment_attachment));
...
let repository_names_to_yojson tree =
...
let git_hub_configuration_to_yojson (x : git_hub_configuration) =
  assoc_to_yojson
    ...
    ("ExclusionFolderNamePatterns",
      (option_to_yojson string_list_to_yojson
         x.exclusion_folder_name_patterns));
    ...
    ("InclusionFolderNamePatterns",
      (option_to_yojson string_list_to_yojson
         x.inclusion_folder_name_patterns));
    ("RepositoryFilter",
    ...
    ("OnPremiseConfiguration",
      (option_to_yojson on_premise_configuration_to_yojson
         x.on_premise_configuration));
    ("SaaSConfiguration",
...
let alfresco_entity_to_yojson (x : alfresco_entity) =
  ...
  | Blog -> `String "blog"
  | Wiki -> `String "wiki"
let entity_filter_to_yojson tree =
  list_to_yojson alfresco_entity_to_yojson tree
...
let template_configuration_to_yojson (x : template_configuration) =
  assoc_to_yojson
    [("Template", (option_to_yojson template_to_yojson x.template))]
let data_source_configuration_to_yojson (x : data_source_configuration) =
  assoc_to_yojson
    [("TemplateConfiguration",
       (option_to_yojson template_configuration_to_yojson
          x.template_configuration));
    ("AlfrescoConfiguration",
      (option_to_yojson alfresco_configuration_to_yojson
         x.alfresco_configuration));
    ("GitHubConfiguration",
      (option_to_yojson git_hub_configuration_to_yojson
         x.git_hub_configuration));
    ("JiraConfiguration",
    ...
    ("WorkDocsConfiguration",
      (option_to_yojson work_docs_configuration_to_yojson
         x.work_docs_configuration));
    ("WebCrawlerConfiguration",
      (option_to_yojson web_crawler_configuration_to_yojson
         x.web_crawler_configuration));
    ("GoogleDriveConfiguration",
      (option_to_yojson google_drive_configuration_to_yojson
         x.google_drive_configuration));
    ("ConfluenceConfiguration",
      (option_to_yojson confluence_configuration_to_yojson
         x.confluence_configuration));
    ("ServiceNowConfiguration",
      (option_to_yojson service_now_configuration_to_yojson
         x.service_now_configuration));
    ("OneDriveConfiguration",
      (option_to_yojson one_drive_configuration_to_yojson
         x.one_drive_configuration));
    ("SalesforceConfiguration",
      (option_to_yojson salesforce_configuration_to_yojson
         x.salesforce_configuration));
    ("DatabaseConfiguration",
      (option_to_yojson database_configuration_to_yojson
         x.database_configuration));
    ("SharePointConfiguration",
      (option_to_yojson share_point_configuration_to_yojson
         x.share_point_configuration));
    ("S3Configuration",
      (option_to_yojson s3_data_source_configuration_to_yojson
         x.s3_configuration))]
...
let document_attribute_string_list_value_to_yojson tree =
  list_to_yojson string__to_yojson tree
let timestamp__to_yojson = timestamp_to_yojson
let document_attribute_value_to_yojson (x : document_attribute_value) =
  assoc_to_yojson
    [("DateValue", (option_to_yojson timestamp__to_yojson x.date_value));
    ("LongValue", (option_to_yojson long_to_yojson x.long_value));
    ("StringListValue",
      (option_to_yojson document_attribute_string_list_value_to_yojson
         x.string_list_value));
    ("StringValue",
      (option_to_yojson document_attribute_string_value_to_yojson
         x.string_value))]
let document_attribute_condition_to_yojson (x : document_attribute_condition)
  =
  assoc_to_yojson
    [("ConditionOnValue",
       (option_to_yojson document_attribute_value_to_yojson
          x.condition_on_value));
    ("Operator", (Some (condition_operator_to_yojson x.operator)));
    ("ConditionDocumentAttributeKey",
      (Some
         (document_attribute_key_to_yojson x.condition_document_attribute_key)))]
let document_attribute_target_to_yojson (x : document_attribute_target) =
  assoc_to_yojson
    [("TargetDocumentAttributeValue",
       (option_to_yojson document_attribute_value_to_yojson
          x.target_document_attribute_value));
    ("TargetDocumentAttributeValueDeletion",
      (option_to_yojson boolean__to_yojson
         x.target_document_attribute_value_deletion));
    ("TargetDocumentAttributeKey",
      (option_to_yojson document_attribute_key_to_yojson
         x.target_document_attribute_key))]
...
let inline_custom_document_enrichment_configuration_list_to_yojson tree =
  list_to_yojson inline_custom_document_enrichment_configuration_to_yojson
    tree
...
let hook_configuration_to_yojson (x : hook_configuration) =
  assoc_to_yojson
    ...
    ("InvocationCondition",
      (option_to_yojson document_attribute_condition_to_yojson
         x.invocation_condition))]
let custom_document_enrichment_configuration_to_yojson
  (x : custom_document_enrichment_configuration) =
  assoc_to_yojson
    [("RoleArn", (option_to_yojson role_arn_to_yojson x.role_arn));
    ("PostExtractionHookConfiguration",
      (option_to_yojson hook_configuration_to_yojson
         x.post_extraction_hook_configuration));
    ("PreExtractionHookConfiguration",
      (option_to_yojson hook_configuration_to_yojson
         x.pre_extraction_hook_configuration));
    ("InlineConfigurations",
      (option_to_yojson
         inline_custom_document_enrichment_configuration_list_to_yojson
...
let hierarchical_principal_to_yojson (x : hierarchical_principal) =
  assoc_to_yojson
    [("PrincipalList", (Some (principal_list_to_yojson x.principal_list)))]
...
let update_access_control_configuration_request_to_yojson
  ...
  assoc_to_yojson
    [("HierarchicalAccessControlList",
       (option_to_yojson hierarchical_principal_list_to_yojson
          x.hierarchical_access_control_list));
    ("AccessControlList",
...
let resource_unavailable_exception_to_yojson
  (x : resource_unavailable_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let thesaurus_summary_to_yojson (x : thesaurus_summary) =
  assoc_to_yojson
    [("UpdatedAt", (option_to_yojson timestamp__to_yojson x.updated_at));
    ("CreatedAt", (option_to_yojson timestamp__to_yojson x.created_at));
    ("Status", (option_to_yojson thesaurus_status_to_yojson x.status));
    ("Name", (option_to_yojson thesaurus_name_to_yojson x.name));
    ("Id", (option_to_yojson thesaurus_id_to_yojson x.id))]
let thesaurus_summary_items_to_yojson tree =
  list_to_yojson thesaurus_summary_to_yojson tree
...
let highlight_to_yojson (x : highlight) =
  assoc_to_yojson
    ...
    ("EndOffset", (Some (integer__to_yojson x.end_offset)));
    ("BeginOffset", (Some (integer__to_yojson x.begin_offset)))]
...
let table_row_to_yojson (x : table_row) =
  assoc_to_yojson
    [("Cells", (option_to_yojson table_cell_list_to_yojson x.cells))]
...
let suggestion_highlight_to_yojson (x : suggestion_highlight) =
  assoc_to_yojson
    [("EndOffset", (option_to_yojson integer__to_yojson x.end_offset));
    ("BeginOffset", (option_to_yojson integer__to_yojson x.begin_offset))]
let suggestion_highlight_list_to_yojson tree =
  list_to_yojson suggestion_highlight_to_yojson tree
let suggestion_text_with_highlights_to_yojson
  (x : suggestion_text_with_highlights) =
  assoc_to_yojson
    [("Highlights",
...
let suggestion_type_to_yojson (x : suggestion_type) =
  ...
  | QUERY -> `String "QUERY"
let suggestion_types_to_yojson tree =
  list_to_yojson suggestion_type_to_yojson tree
...
let document_attribute_list_to_yojson tree =
  list_to_yojson document_attribute_to_yojson tree
let source_document_to_yojson (x : source_document) =
  assoc_to_yojson
    [("AdditionalAttributes",
       (option_to_yojson document_attribute_list_to_yojson
          x.additional_attributes));
    ("SuggestionAttributes",
      (option_to_yojson document_attribute_key_list_to_yojson
         x.suggestion_attributes));
    ("DocumentId", (option_to_yojson string__to_yojson x.document_id))]
let source_documents_to_yojson tree =
  list_to_yojson source_document_to_yojson tree
...
let click_feedback_to_yojson (x : click_feedback) =
  assoc_to_yojson
    [("ClickTime", (Some (timestamp__to_yojson x.click_time)));
    ("ResultId", (Some (result_id_to_yojson x.result_id)))]
let click_feedback_list_to_yojson tree =
  list_to_yojson click_feedback_to_yojson tree
...
let relevance_feedback_to_yojson (x : relevance_feedback) =
  assoc_to_yojson
    ...
    ("ResultId", (Some (result_id_to_yojson x.result_id)))]
let relevance_feedback_list_to_yojson tree =
  list_to_yojson relevance_feedback_to_yojson tree
let submit_feedback_request_to_yojson (x : submit_feedback_request) =
  assoc_to_yojson
    [("RelevanceFeedbackItems",
       (option_to_yojson relevance_feedback_list_to_yojson
          x.relevance_feedback_items));
    ("ClickFeedbackItems",
...
let stop_data_source_sync_job_request_to_yojson
  (x : stop_data_source_sync_job_request) =
  assoc_to_yojson
    [("IndexId", (Some (index_id_to_yojson x.index_id)));
    ("Id", (Some (data_source_id_to_yojson x.id)))]
...
let spell_correction_configuration_to_yojson
  (x : spell_correction_configuration) =
  assoc_to_yojson
...
let spell_corrected_query_list_to_yojson tree =
  list_to_yojson spell_corrected_query_to_yojson tree
...
let sorting_configuration_list_to_yojson tree =
  list_to_yojson sorting_configuration_to_yojson tree
let snapshots_data_record_to_yojson tree =
  list_to_yojson string__to_yojson tree
let snapshots_data_records_to_yojson tree =
  list_to_yojson snapshots_data_record_to_yojson tree
let snapshots_data_header_fields_to_yojson tree =
  list_to_yojson string__to_yojson tree
...
let retrieve_result_item_to_yojson (x : retrieve_result_item) =
  assoc_to_yojson
    ...
    ("DocumentId", (option_to_yojson document_id_to_yojson x.document_id));
    ("Id", (option_to_yojson result_id_to_yojson x.id))]
let retrieve_result_item_list_to_yojson tree =
  list_to_yojson retrieve_result_item_to_yojson tree
...
let rec attribute_filter_to_yojson (x : attribute_filter) =
  assoc_to_yojson
    [("LessThanOrEquals",
...
and attribute_filter_list_to_yojson tree =
  list_to_yojson attribute_filter_to_yojson tree
let document_relevance_configuration_to_yojson
  (x : document_relevance_configuration) =
  assoc_to_yojson
...
let retrieve_request_to_yojson (x : retrieve_request) =
  assoc_to_yojson
    ...
    ("PageSize", (option_to_yojson integer__to_yojson x.page_size));
    ("PageNumber", (option_to_yojson integer__to_yojson x.page_number));
    ("DocumentRelevanceOverrideConfigurations",
      (option_to_yojson
         document_relevance_override_configuration_list_to_yojson
         x.document_relevance_override_configurations));
    ("RequestedDocumentAttributes",
      (option_to_yojson document_attribute_key_list_to_yojson
         x.requested_document_attributes));
    ("AttributeFilter",
...
let resource_already_exist_exception_to_yojson
  (x : resource_already_exist_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let query_suggestions_block_list_status_to_yojson
  (x : query_suggestions_block_list_status) =
  match x with
  | FAILED -> `String "FAILED"
  | ACTIVE_BUT_UPDATE_FAILED -> `String "ACTIVE_BUT_UPDATE_FAILED"
  | UPDATING -> `String "UPDATING"
...
let query_suggestions_block_list_summary_to_yojson
  (x : query_suggestions_block_list_summary) =
  assoc_to_yojson
    [("ItemCount", (option_to_yojson integer__to_yojson x.item_count));
    ("UpdatedAt", (option_to_yojson timestamp__to_yojson x.updated_at));
    ("CreatedAt", (option_to_yojson timestamp__to_yojson x.created_at));
    ("Status",
      (option_to_yojson query_suggestions_block_list_status_to_yojson
         x.status));
    ("Name",
      (option_to_yojson query_suggestions_block_list_name_to_yojson x.name));
...
let query_result_format_to_yojson (x : query_result_format) =
  match x with | TEXT -> `String "TEXT" | TABLE -> `String "TABLE"
let additional_result_attribute_value_type_to_yojson
  (x : additional_result_attribute_value_type) =
  match x with
  | TEXT_WITH_HIGHLIGHTS_VALUE -> `String "TEXT_WITH_HIGHLIGHTS_VALUE"
let additional_result_attribute_value_to_yojson
  (x : additional_result_attribute_value) =
  assoc_to_yojson
    [("TextWithHighlightsValue",
       (option_to_yojson text_with_highlights_to_yojson
          x.text_with_highlights_value))]
...
let expanded_result_item_to_yojson (x : expanded_result_item) =
  assoc_to_yojson
    ...
    ("DocumentId", (option_to_yojson document_id_to_yojson x.document_id));
    ("Id", (option_to_yojson result_id_to_yojson x.id))]
let expanded_result_list_to_yojson tree =
  list_to_yojson expanded_result_item_to_yojson tree
...
let query_result_item_to_yojson (x : query_result_item) =
  assoc_to_yojson
    [("CollapsedResultDetail",
       (option_to_yojson collapsed_result_detail_to_yojson
          x.collapsed_result_detail));
    ("TableExcerpt",
    ...
    ("DocumentId", (option_to_yojson document_id_to_yojson x.document_id));
    ("AdditionalAttributes",
      (option_to_yojson additional_result_attribute_list_to_yojson
         x.additional_attributes));
    ("Format", (option_to_yojson query_result_format_to_yojson x.format));
    ("Type", (option_to_yojson query_result_type_to_yojson x.type_));
    ("Id", (option_to_yojson result_id_to_yojson x.id))]
let query_result_item_list_to_yojson tree =
  list_to_yojson query_result_item_to_yojson tree
let rec document_attribute_value_count_pair_to_yojson
  (x : document_attribute_value_count_pair) =
  assoc_to_yojson
    [("FacetResults",
...
and facet_result_to_yojson (x : facet_result) =
  assoc_to_yojson
    ...
    ("DocumentAttributeValueType",
      (option_to_yojson document_attribute_value_type_to_yojson
         x.document_attribute_value_type));
    ("DocumentAttributeKey",
      (option_to_yojson document_attribute_key_to_yojson
         x.document_attribute_key))]
and facet_result_list_to_yojson tree =
  list_to_yojson facet_result_to_yojson tree
let featured_results_item_to_yojson (x : featured_results_item) =
  assoc_to_yojson
    ...
    ("Type", (option_to_yojson query_result_type_to_yojson x.type_));
    ("Id", (option_to_yojson result_id_to_yojson x.id))]
let featured_results_item_list_to_yojson tree =
  list_to_yojson featured_results_item_to_yojson tree
let query_result_to_yojson (x : query_result) =
  assoc_to_yojson
    [("FeaturedResultsItems",
       (option_to_yojson featured_results_item_list_to_yojson
          x.featured_results_items));
    ("SpellCorrectedQueries",
      (option_to_yojson spell_corrected_query_list_to_yojson
         x.spell_corrected_queries));
    ...
    ("QueryId", (option_to_yojson query_id_to_yojson x.query_id))]
let rec facet_to_yojson (x : facet) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson
          top_document_attribute_value_count_pairs_size_to_yojson
          x.max_results));
    ("Facets", (option_to_yojson facet_list_to_yojson x.facets));
    ("DocumentAttributeKey",
      (option_to_yojson document_attribute_key_to_yojson
         x.document_attribute_key))]
and facet_list_to_yojson tree = list_to_yojson facet_to_yojson tree
let missing_attribute_key_strategy_to_yojson
  (x : missing_attribute_key_strategy) =
  match x with
...
let collapse_configuration_to_yojson (x : collapse_configuration) =
  assoc_to_yojson
    [("ExpandConfiguration",
       (option_to_yojson expand_configuration_to_yojson
          x.expand_configuration));
    ("Expand", (option_to_yojson boolean__to_yojson x.expand));
    ("MissingAttributeKeyStrategy",
      (option_to_yojson missing_attribute_key_strategy_to_yojson
         x.missing_attribute_key_strategy));
    ("SortingConfigurations",
      (option_to_yojson sorting_configuration_list_to_yojson
         x.sorting_configurations));
    ("DocumentAttributeKey",
      (Some (document_attribute_key_to_yojson x.document_attribute_key)))]
let query_request_to_yojson (x : query_request) =
  assoc_to_yojson
    [("CollapseConfiguration",
       (option_to_yojson collapse_configuration_to_yojson
          x.collapse_configuration));
    ("SpellCorrectionConfiguration",
      (option_to_yojson spell_correction_configuration_to_yojson
         x.spell_correction_configuration));
    ...
    ("SortingConfiguration",
      (option_to_yojson sorting_configuration_to_yojson
         x.sorting_configuration));
    ("PageSize", (option_to_yojson integer__to_yojson x.page_size));
    ("PageNumber", (option_to_yojson integer__to_yojson x.page_number));
    ("DocumentRelevanceOverrideConfigurations",
      (option_to_yojson
    ...
    ("QueryResultTypeFilter",
      (option_to_yojson query_result_type_to_yojson
         x.query_result_type_filter));
    ("RequestedDocumentAttributes",
      (option_to_yojson document_attribute_key_list_to_yojson
         x.requested_document_attributes));
    ("Facets", (option_to_yojson facet_list_to_yojson x.facets));
...
let put_principal_mapping_request_to_yojson
  (x : put_principal_mapping_request) =
  assoc_to_yojson
    [("RoleArn", (option_to_yojson role_arn_to_yojson x.role_arn));
    ("OrderingId",
...
let persona_to_yojson (x : persona) =
  match x with | VIEWER -> `String "VIEWER" | OWNER -> `String "OWNER"
...
let personas_summary_list_to_yojson tree =
  list_to_yojson personas_summary_to_yojson tree
...
let max_results_integer_for_list_data_source_sync_jobs_request_to_yojson =
  int_to_yojson
let max_results_integer_for_list_access_control_configurations_request_to_yojson
  = int_to_yojson
let list_thesauri_response_to_yojson (x : list_thesauri_response) =
  assoc_to_yojson
    [("ThesaurusSummaryItems",
       (option_to_yojson thesaurus_summary_items_to_yojson
          x.thesaurus_summary_items));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token))]
let list_thesauri_request_to_yojson (x : list_thesauri_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson
          max_results_integer_for_list_thesauri_request_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("IndexId", (Some (index_id_to_yojson x.index_id)))]
...
let list_query_suggestions_block_lists_request_to_yojson
  ...
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson
          max_results_integer_for_list_query_suggestions_block_lists_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("IndexId", (Some (index_id_to_yojson x.index_id)))]
...
let list_of_group_summaries_to_yojson tree =
...
let index_configuration_summary_to_yojson (x : index_configuration_summary) =
  assoc_to_yojson
    ...
    ("UpdatedAt", (Some (timestamp__to_yojson x.updated_at)));
    ("CreatedAt", (Some (timestamp__to_yojson x.created_at)));
...
let list_indices_request_to_yojson (x : list_indices_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson
          max_results_integer_for_list_indices_request_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token))]
...
let list_groups_older_than_ordering_id_request_to_yojson
  ...
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson
          max_results_integer_for_list_principals_request_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let list_featured_results_sets_response_to_yojson
  (x : list_featured_results_sets_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let list_featured_results_sets_request_to_yojson
  (x : list_featured_results_sets_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson
          max_results_integer_for_list_featured_results_sets_request_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("IndexId", (Some (index_id_to_yojson x.index_id)))]
...
let faq_summary_items_to_yojson tree =
  list_to_yojson faq_summary_to_yojson tree
...
let list_faqs_request_to_yojson (x : list_faqs_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson max_results_integer_for_list_faqs_request_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("IndexId", (Some (index_id_to_yojson x.index_id)))]
...
let experience_endpoints_to_yojson tree =
  list_to_yojson experience_endpoint_to_yojson tree
let experiences_summary_to_yojson (x : experiences_summary) =
  assoc_to_yojson
    ...
    ("Name", (option_to_yojson experience_name_to_yojson x.name))]
let experiences_summary_list_to_yojson tree =
  list_to_yojson experiences_summary_to_yojson tree
...
let list_experiences_request_to_yojson (x : list_experiences_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson
          max_results_integer_for_list_experiences_request_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("IndexId", (Some (index_id_to_yojson x.index_id)))]
...
let list_experience_entities_response_to_yojson
  (x : list_experience_entities_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("SummaryItems",
      (option_to_yojson experience_entities_summary_list_to_yojson
         x.summary_items))]
let list_experience_entities_request_to_yojson
  (x : list_experience_entities_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("IndexId", (Some (index_id_to_yojson x.index_id)));
    ("Id", (Some (experience_id_to_yojson x.id)))]
let list_entity_personas_response_to_yojson
  (x : list_entity_personas_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("SummaryItems",
...
let list_entity_personas_request_to_yojson (x : list_entity_personas_request)
  ...
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson
          max_results_integer_for_list_entity_personas_request_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("IndexId", (Some (index_id_to_yojson x.index_id)));
    ("Id", (Some (experience_id_to_yojson x.id)))]
...
let data_source_summary_to_yojson (x : data_source_summary) =
  assoc_to_yojson
    ...
    ("Name", (option_to_yojson data_source_name_to_yojson x.name))]
let data_source_summary_list_to_yojson tree =
  list_to_yojson data_source_summary_to_yojson tree
...
let list_data_sources_request_to_yojson (x : list_data_sources_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson
          max_results_integer_for_list_data_sources_request_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("IndexId", (Some (index_id_to_yojson x.index_id)))]
...
let list_data_source_sync_jobs_response_to_yojson
  (x : list_data_source_sync_jobs_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("History",
      (option_to_yojson data_source_sync_job_history_list_to_yojson x.history))]
let list_data_source_sync_jobs_request_to_yojson
  (x : list_data_source_sync_jobs_request) =
  assoc_to_yojson
    [("StatusFilter",
       (option_to_yojson data_source_sync_job_status_to_yojson
          x.status_filter));
    ("StartTimeFilter",
      (option_to_yojson time_range_to_yojson x.start_time_filter));
    ("MaxResults",
      (option_to_yojson
         max_results_integer_for_list_data_source_sync_jobs_request_to_yojson
         x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("IndexId", (Some (index_id_to_yojson x.index_id)));
    ("Id", (Some (data_source_id_to_yojson x.id)))]
let access_control_configuration_summary_to_yojson
  (x : access_control_configuration_summary) =
  assoc_to_yojson
    [("Id", (Some (access_control_configuration_id_to_yojson x.id)))]
...
let list_access_control_configurations_response_to_yojson
  ...
  assoc_to_yojson
    [("AccessControlConfigurations",
       (Some
          (access_control_configuration_summary_list_to_yojson
             x.access_control_configurations)));
...
let faq_statistics_to_yojson (x : faq_statistics) =
  assoc_to_yojson
    [("IndexedQuestionAnswersCount",
       (Some
          (indexed_question_answers_count_to_yojson
             x.indexed_question_answers_count)))]
...
let group_ordering_id_summary_to_yojson (x : group_ordering_id_summary) =
  assoc_to_yojson
    ...
    ("OrderingId",
      (option_to_yojson principal_ordering_id_to_yojson x.ordering_id));
    ("ReceivedAt", (option_to_yojson timestamp__to_yojson x.received_at));
    ("LastUpdatedAt",
...
let get_snapshots_response_to_yojson (x : get_snapshots_response) =
  assoc_to_yojson
    ...
    ("SnapshotsDataHeader",
      (option_to_yojson snapshots_data_header_fields_to_yojson
         x.snapshots_data_header));
    ("SnapShotTimeFilter",
      (option_to_yojson time_range_to_yojson x.snap_shot_time_filter))]
let get_snapshots_request_to_yojson (x : get_snapshots_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson integer__to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let get_query_suggestions_response_to_yojson
  (x : get_query_suggestions_response) =
  assoc_to_yojson
    [("Suggestions",
...
let attribute_suggestions_get_config_to_yojson
  (x : attribute_suggestions_get_config) =
  assoc_to_yojson
    [("UserContext",
       (option_to_yojson user_context_to_yojson x.user_context));
    ("AttributeFilter",
    ...
    ("AdditionalResponseAttributes",
      (option_to_yojson document_attribute_key_list_to_yojson
         x.additional_response_attributes));
    ("SuggestionAttributes",
      (option_to_yojson document_attribute_key_list_to_yojson
         x.suggestion_attributes))]
let get_query_suggestions_request_to_yojson
  (x : get_query_suggestions_request) =
  assoc_to_yojson
    [("AttributeSuggestionsConfig",
       (option_to_yojson attribute_suggestions_get_config_to_yojson
          x.attribute_suggestions_config));
    ("SuggestionTypes",
...
let featured_document_with_metadata_to_yojson
  (x : featured_document_with_metadata) =
  assoc_to_yojson
...
let failed_entity_to_yojson (x : failed_entity) =
  assoc_to_yojson
    [("ErrorMessage",
       (option_to_yojson error_message_to_yojson x.error_message));
    ("EntityId", (option_to_yojson entity_id_to_yojson x.entity_id))]
let failed_entity_list_to_yojson tree =
...
let entity_configuration_to_yojson (x : entity_configuration) =
  assoc_to_yojson
    ...
    ("EntityId", (Some (entity_id_to_yojson x.entity_id)))]
let document_status_list_to_yojson tree =
  list_to_yojson status_to_yojson tree
...
let document_to_yojson (x : document) =
  assoc_to_yojson
    [("AccessControlConfigurationId",
       (option_to_yojson access_control_configuration_id_to_yojson
          x.access_control_configuration_id));
...
let document_info_list_to_yojson tree =
  list_to_yojson document_info_to_yojson tree
let document_id_list_to_yojson tree =
  list_to_yojson document_id_to_yojson tree
...
let disassociate_personas_from_entities_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("IndexId", (Some (index_id_to_yojson x.index_id)));
    ("Id", (Some (experience_id_to_yojson x.id)))]
let disassociate_entity_list_to_yojson tree =
  list_to_yojson entity_configuration_to_yojson tree
...
let attribute_suggestions_describe_config_to_yojson
  (x : attribute_suggestions_describe_config) =
  assoc_to_yojson
    [("AttributeSuggestionsMode",
       (option_to_yojson attribute_suggestions_mode_to_yojson
          x.attribute_suggestions_mode));
...
let describe_principal_mapping_response_to_yojson
  (x : describe_principal_mapping_response) =
  assoc_to_yojson
    [("GroupOrderingIdSummaries",
       (option_to_yojson group_ordering_id_summaries_to_yojson
          x.group_ordering_id_summaries));
    ("GroupId", (option_to_yojson group_id_to_yojson x.group_id));
    ("DataSourceId",
      (option_to_yojson data_source_id_to_yojson x.data_source_id));
    ("IndexId", (option_to_yojson index_id_to_yojson x.index_id))]
let describe_principal_mapping_request_to_yojson
  (x : describe_principal_mapping_request) =
  assoc_to_yojson
    [("GroupId", (Some (group_id_to_yojson x.group_id)));
    ("DataSourceId",
      (option_to_yojson data_source_id_to_yojson x.data_source_id));
...
let describe_featured_results_set_response_to_yojson
  (x : describe_featured_results_set_response) =
  assoc_to_yojson
    [("CreationTimestamp",
       (option_to_yojson long_to_yojson x.creation_timestamp));
    ("LastUpdatedTimestamp",
    ...
    ("FeaturedDocumentsMissing",
      (option_to_yojson featured_document_missing_list_to_yojson
         x.featured_documents_missing));
...
let describe_featured_results_set_request_to_yojson
  (x : describe_featured_results_set_request) =
  assoc_to_yojson
    [("FeaturedResultsSetId",
       (Some (featured_results_set_id_to_yojson x.featured_results_set_id)));
    ("IndexId", (Some (index_id_to_yojson x.index_id)))]
...
let describe_data_source_response_to_yojson
  (x : describe_data_source_response) =
  assoc_to_yojson
    [("CustomDocumentEnrichmentConfiguration",
       (option_to_yojson custom_document_enrichment_configuration_to_yojson
          x.custom_document_enrichment_configuration));
...
let delete_principal_mapping_request_to_yojson
  (x : delete_principal_mapping_request) =
  assoc_to_yojson
    [("OrderingId",
       (option_to_yojson principal_ordering_id_to_yojson x.ordering_id));
    ("GroupId", (Some (group_id_to_yojson x.group_id)));
...
let data_source_sync_job_metric_target_to_yojson
  ...
  assoc_to_yojson
    [("DataSourceSyncJobId",
       (option_to_yojson data_source_sync_job_id_to_yojson
          x.data_source_sync_job_id));
    ("DataSourceId", (Some (data_source_id_to_yojson x.data_source_id)))]
...
let create_featured_results_set_response_to_yojson
  (x : create_featured_results_set_response) =
  assoc_to_yojson
    [("FeaturedResultsSet",
       (option_to_yojson featured_results_set_to_yojson
          x.featured_results_set))]
let create_featured_results_set_request_to_yojson
  (x : create_featured_results_set_request) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("FeaturedDocuments",
      (option_to_yojson featured_document_list_to_yojson x.featured_documents));
...
let clear_query_suggestions_request_to_yojson
  (x : clear_query_suggestions_request) =
  assoc_to_yojson [("IndexId", (Some (index_id_to_yojson x.index_id)))]
...
let batch_put_document_response_to_yojson (x : batch_put_document_response) =
  assoc_to_yojson
    [("FailedDocuments",
       (option_to_yojson
          batch_put_document_response_failed_documents_to_yojson
          x.failed_documents))]
...
let batch_get_document_status_response_to_yojson
  (x : batch_get_document_status_response) =
  assoc_to_yojson
    [("DocumentStatusList",
       (option_to_yojson document_status_list_to_yojson
          x.document_status_list));
    ("Errors",
      (option_to_yojson batch_get_document_status_response_errors_to_yojson
         x.errors))]
let batch_get_document_status_request_to_yojson
  (x : batch_get_document_status_request) =
  assoc_to_yojson
    [("DocumentInfoList",
       (Some (document_info_list_to_yojson x.document_info_list)));
    ("IndexId", (Some (index_id_to_yojson x.index_id)))]
let batch_delete_featured_results_set_error_to_yojson
  (x : batch_delete_featured_results_set_error) =
  assoc_to_yojson
...
let batch_delete_featured_results_set_request_to_yojson
  ...
  assoc_to_yojson
    [("FeaturedResultsSetIds",
       (Some
          (featured_results_set_id_list_to_yojson x.featured_results_set_ids)));
    ("IndexId", (Some (index_id_to_yojson x.index_id)))]
...
let batch_delete_document_response_to_yojson
  (x : batch_delete_document_response) =
  assoc_to_yojson
    [("FailedDocuments",
       (option_to_yojson
          batch_delete_document_response_failed_documents_to_yojson
          x.failed_documents))]
let batch_delete_document_request_to_yojson
  (x : batch_delete_document_request) =
  assoc_to_yojson
...
let associate_personas_to_entities_response_to_yojson
  (x : associate_personas_to_entities_response) =
  assoc_to_yojson
    [("FailedEntityList",
       (option_to_yojson failed_entity_list_to_yojson x.failed_entity_list))]
let associate_personas_to_entities_request_to_yojson
  (x : associate_personas_to_entities_request) =
  assoc_to_yojson
    [("Personas",
       (Some (entity_persona_configuration_list_to_yojson x.personas)));
    ("IndexId", (Some (index_id_to_yojson x.index_id)));
    ("Id", (Some (experience_id_to_yojson x.id)))]
let associate_entity_list_to_yojson tree =
  list_to_yojson entity_configuration_to_yojson tree
...
let associate_entities_to_experience_response_to_yojson
  ...
  assoc_to_yojson
    [("FailedEntityList",
       (option_to_yojson
          associate_entities_to_experience_failed_entity_list_to_yojson
