...
let update_query_suggestions_config_request_of_yojson tree path =
  ...
  ({
     ...
     query_log_look_back_window_in_days =
       option_of_yojson (value_for_key integer__of_yojson "QueryLogLookBackWindowInDays") _list path;
...
let table_excerpt_of_yojson tree path =
  ...
  ({
     total_number_of_rows =
       option_of_yojson (value_for_key integer__of_yojson "TotalNumberOfRows") _list path;
...
and attribute_filter_list_of_yojson tree path = list_of_yojson attribute_filter_of_yojson tree path
...
and facet_result_list_of_yojson tree path = list_of_yojson facet_result_of_yojson tree path
...
let query_result_of_yojson tree path =
  ...
  ({
     ...
     total_number_of_results =
       option_of_yojson (value_for_key integer__of_yojson "TotalNumberOfResults") _list path;
     facet_results =
       option_of_yojson (value_for_key facet_result_list_of_yojson "FacetResults") _list path;
     result_items =
...
let expand_configuration_of_yojson tree path =
  ...
  ({
     max_expanded_results_per_item =
       option_of_yojson (value_for_key integer__of_yojson "MaxExpandedResultsPerItem") _list path;
     max_result_items_to_expand =
       option_of_yojson (value_for_key integer__of_yojson "MaxResultItemsToExpand") _list path;
   }
...
let group_ordering_id_summary_of_yojson tree path =
  ...
  ({
     ...
     last_updated_at =
       option_of_yojson (value_for_key timestamp__of_yojson "LastUpdatedAt") _list path;
     status =
...
let get_query_suggestions_request_of_yojson tree path =
  ...
  ({
     ...
     max_suggestions_count =
       option_of_yojson (value_for_key integer__of_yojson "MaxSuggestionsCount") _list path;
...
let describe_query_suggestions_config_response_of_yojson tree path =
  ...
  ({
     ...
     total_suggestions_count =
       option_of_yojson (value_for_key integer__of_yojson "TotalSuggestionsCount") _list path;
     last_clear_time =
       option_of_yojson (value_for_key timestamp__of_yojson "LastClearTime") _list path;
     last_suggestions_build_time =
       option_of_yojson (value_for_key timestamp__of_yojson "LastSuggestionsBuildTime") _list path;
     minimum_query_count =
       option_of_yojson (value_for_key minimum_query_count_of_yojson "MinimumQueryCount") _list path;
     minimum_number_of_querying_users =
       option_of_yojson
