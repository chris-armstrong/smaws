  ...
  let _res : jwt_token_type_configuration =
    {
      claim_regex =
        (option_of_yojson (value_for_key claim_regex_of_yojson "ClaimRegex")
           _list path);
      issuer =
        (option_of_yojson (value_for_key issuer_of_yojson "Issuer") _list
           path);
      ...
      ur_l =
        (option_of_yojson (value_for_key url_of_yojson "URL") _list path);
      key_location =
  ...
  let _res : data_source_group =
    {
      ...
      group_id =
        (value_for_key principal_name_of_yojson "GroupId" _list path)
    } in
  _res
  ...
  let _res : search =
    {
      ...
      searchable =
        (option_of_yojson (value_for_key boolean__of_yojson "Searchable")
           _list path);
      facetable =
        (option_of_yojson (value_for_key boolean__of_yojson "Facetable")
           _list path)
    } in
  _res
let document_metadata_configuration_of_yojson tree path =
  ...
  let _res : document_metadata_configuration =
    {
      search =
        (option_of_yojson (value_for_key search_of_yojson "Search") _list
           path);
      relevance =
  ...
  let _res : featured_results_set =
    {
      ...
      featured_documents =
        (option_of_yojson
           (value_for_key featured_document_list_of_yojson
              "FeaturedDocuments") _list path);
      query_texts =
        (option_of_yojson
...
let conflicting_item_of_yojson tree path =
  ...
  let _res : conflicting_item =
    {
      set_id =
        (option_of_yojson (value_for_key string__of_yojson "SetId") _list
           path);
      set_name =
  ...
  let _res : content_source_configuration =
    {
      ...
      data_source_ids =
        (option_of_yojson
           (value_for_key data_source_id_list_of_yojson "DataSourceIds")
           _list path)
    } in
  _res
  ...
  let _res : share_point_configuration =
    {
      ...
      ssl_certificate_s3_path =
        (option_of_yojson
           (value_for_key s3_path_of_yojson "SslCertificateS3Path") _list
           path);
      ...
      secret_arn =
        (value_for_key secret_arn_of_yojson "SecretArn" _list path);
      urls = (value_for_key share_point_url_list_of_yojson "Urls" _list path);
      share_point_version =
        (value_for_key share_point_version_of_yojson "SharePointVersion"
           _list path)
    } in
  _res
  ...
  let _res : column_configuration =
    {
      ...
      document_id_column_name =
        (value_for_key column_name_of_yojson "DocumentIdColumnName" _list
           path)
    } in
  _res
  ...
  let _res : salesforce_custom_knowledge_article_type_configuration =
    {
      ...
      name =
        (value_for_key
           salesforce_custom_knowledge_article_type_name_of_yojson "Name"
           _list path)
    } in
  _res
  ...
  let _res : salesforce_configuration =
    {
      ...
      knowledge_article_configuration =
        (option_of_yojson
           (value_for_key
              salesforce_knowledge_article_configuration_of_yojson
  ...
  let _res : service_now_knowledge_article_configuration =
    {
      filter_query =
        (option_of_yojson
           (value_for_key
              service_now_knowledge_article_filter_query_of_yojson
  ...
  let _res : confluence_space_configuration =
    {
      ...
      crawl_archived_spaces =
        (option_of_yojson
           (value_for_key boolean__of_yojson "CrawlArchivedSpaces") _list
           path);
      crawl_personal_spaces =
        (option_of_yojson
           (value_for_key boolean__of_yojson "CrawlPersonalSpaces") _list
           path)
    } in
  _res
  ...
  let _res : google_drive_configuration =
    {
      ...
      exclude_mime_types =
        (option_of_yojson
           (value_for_key exclude_mime_types_list_of_yojson
              "ExcludeMimeTypes") _list path);
      field_mappings =
        (option_of_yojson
           (value_for_key data_source_to_index_field_mapping_list_of_yojson
              "FieldMappings") _list path);
  ...
  let _res : slack_configuration =
    {
      ...
      exclude_archived =
        (option_of_yojson
           (value_for_key boolean__of_yojson "ExcludeArchived") _list path);
      crawl_bot_message =
        (option_of_yojson
           (value_for_key boolean__of_yojson "CrawlBotMessage") _list path);
      use_change_log =
        (option_of_yojson (value_for_key boolean__of_yojson "UseChangeLog")
           _list path);
      slack_entity_list =
  ...
  let _res : quip_configuration =
    {
      ...
      folder_ids =
        (option_of_yojson
           (value_for_key folder_id_list_of_yojson "FolderIds") _list path);
      crawl_attachments =
        (option_of_yojson
           (value_for_key boolean__of_yojson "CrawlAttachments") _list path);
      crawl_chat_rooms =
  ...
  let _res : jira_configuration =
    {
      ...
      status =
        (option_of_yojson (value_for_key jira_status_of_yojson "Status")
           _list path);
      issue_type =
  ...
  let _res : git_hub_document_crawl_properties =
    {
      ...
      crawl_repository_documents =
        (option_of_yojson
           (value_for_key boolean__of_yojson "CrawlRepositoryDocuments")
           _list path)
    } in
  _res
  ...
  let _res : git_hub_configuration =
    {
      ...
      git_hub_pull_request_comment_configuration_field_mappings =
        (option_of_yojson
           (value_for_key data_source_to_index_field_mapping_list_of_yojson
              "GitHubPullRequestCommentConfigurationFieldMappings") _list
           path);
      ...
      repository_filter =
        (option_of_yojson
           (value_for_key repository_names_of_yojson "RepositoryFilter")
           _list path);
  ...
  let _res : highlight =
    {
      type_ =
        (option_of_yojson (value_for_key highlight_type_of_yojson "Type")
           _list path);
      top_answer =
        (option_of_yojson (value_for_key boolean__of_yojson "TopAnswer")
           _list path);
...
let suggestion_highlight_of_yojson tree path =
  ...
  let _res : suggestion_highlight =
    {
      end_offset =
        (option_of_yojson (value_for_key integer__of_yojson "EndOffset")
           _list path);
      begin_offset =
  ...
  let _res : source_document =
    {
      ...
      document_id =
        (option_of_yojson (value_for_key string__of_yojson "DocumentId")
           _list path)
    } in
  _res
...
let click_feedback_of_yojson tree path =
  ...
  let _res : click_feedback =
    {
      click_time =
        (value_for_key timestamp__of_yojson "ClickTime" _list path);
...
let sorting_configuration_of_yojson tree path =
  ...
  let _res : sorting_configuration =
    {
      sort_order =
        (value_for_key sort_order_of_yojson "SortOrder" _list path);
  ...
  let _res : retrieve_result_item =
    {
      ...
      document_title =
        (option_of_yojson
           (value_for_key document_title_of_yojson "DocumentTitle") _list
           path);
      document_id =
        (option_of_yojson (value_for_key document_id_of_yojson "DocumentId")
           _list path);
  ...
  let _res : retrieve_request =
    {
      user_context =
        (option_of_yojson
           (value_for_key user_context_of_yojson "UserContext") _list path);
      page_size =
      ...
      attribute_filter =
        (option_of_yojson
           ...
           path);
      query_text =
        (value_for_key query_text_of_yojson "QueryText" _list path);
      index_id = (value_for_key index_id_of_yojson "IndexId" _list path)
    } in
  _res
...
let query_suggestions_block_list_summary_of_yojson tree path =
  ...
  let _res : query_suggestions_block_list_summary =
    {
      item_count =
        (option_of_yojson (value_for_key integer__of_yojson "ItemCount")
           _list path);
      updated_at =
        (option_of_yojson (value_for_key timestamp__of_yojson "UpdatedAt")
           _list path);
  ...
  let _res : query_result_item =
    {
      ...
      feedback_token =
        (option_of_yojson
           (value_for_key feedback_token_of_yojson "FeedbackToken") _list
           path);
      score_attributes =
        (option_of_yojson
           (value_for_key score_attributes_of_yojson "ScoreAttributes") _list
  ...
  let _res : collapse_configuration =
    {
      expand_configuration =
        (option_of_yojson
           (value_for_key expand_configuration_of_yojson
              "ExpandConfiguration") _list path);
      expand =
...
let member_user_of_yojson tree path =
  ...
  let _res : member_user =
    { user_id = (value_for_key user_id_of_yojson "UserId" _list path) } in
  _res
  ...
  let _res : group_members =
    {
      ...
      member_users =
        (option_of_yojson
           (value_for_key member_users_of_yojson "MemberUsers") _list path);
      member_groups =
        (option_of_yojson
  ...
  let _res : personas_summary =
    {
      ...
      persona =
        (option_of_yojson (value_for_key persona_of_yojson "Persona") _list
           path);
      entity_id =
        (option_of_yojson (value_for_key entity_id_of_yojson "EntityId")
           _list path)
    } in
  _res
  ...
  let _res : list_query_suggestions_block_lists_response =
    {
      ...
      block_list_summary_items =
        (option_of_yojson
           (value_for_key
              query_suggestions_block_list_summary_items_of_yojson
  ...
  let _res : faq_summary =
    {
      ...
      status =
        (option_of_yojson (value_for_key faq_status_of_yojson "Status") _list
           path);
      name =
        (option_of_yojson (value_for_key faq_name_of_yojson "Name") _list
           path);
      id =
        (option_of_yojson (value_for_key faq_id_of_yojson "Id") _list path)
    } in
  _res
  ...
  let _res : list_faqs_response =
    {
      faq_summary_items =
        (option_of_yojson
           (value_for_key faq_summary_items_of_yojson "FaqSummaryItems")
           _list path);
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path)
  ...
  let _res : experiences_summary =
    {
      ...
      status =
        (option_of_yojson
           (value_for_key experience_status_of_yojson "Status") _list path);
      created_at =
        (option_of_yojson (value_for_key timestamp__of_yojson "CreatedAt")
           _list path);
      id =
...
let entity_display_data_of_yojson tree path =
  ...
  let _res : entity_display_data =
    {
      last_name =
        (option_of_yojson (value_for_key name_type_of_yojson "LastName")
           _list path);
      first_name =
      ...
      identified_user_name =
        (option_of_yojson
           (value_for_key name_type_of_yojson "IdentifiedUserName") _list
           path);
      group_name =
        (option_of_yojson (value_for_key name_type_of_yojson "GroupName")
           _list path);
      user_name =
        (option_of_yojson (value_for_key name_type_of_yojson "UserName")
           _list path)
    } in
  _res
  ...
  let _res : data_source_sync_job_metrics =
    {
      ...
      documents_failed =
        (option_of_yojson
           (value_for_key metric_value_of_yojson "DocumentsFailed") _list
           path);
      documents_deleted =
        (option_of_yojson
  ...
  let _res : list_data_source_sync_jobs_request =
    {
      status_filter =
        (option_of_yojson
           (value_for_key data_source_sync_job_status_of_yojson
              "StatusFilter") _list path);
      start_time_filter =
        (option_of_yojson
  ...
  let _res : group_ordering_id_summary =
    {
      ...
      last_updated_at =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "LastUpdatedAt") _list path);
      status =
        (option_of_yojson
  ...
  let _res : get_query_suggestions_request =
    {
      ...
      max_suggestions_count =
        (option_of_yojson
           (value_for_key integer__of_yojson "MaxSuggestionsCount") _list
           path);
      query_text =
...
let featured_document_with_metadata_of_yojson tree path =
  ...
  let _res : featured_document_with_metadata =
    {
      ur_i =
        (option_of_yojson (value_for_key url_of_yojson "URI") _list path);
      title =
        (option_of_yojson (value_for_key string__of_yojson "Title") _list
           path);
      id =
        (option_of_yojson (value_for_key document_id_of_yojson "Id") _list
           path)
  ...
  let _res : document =
    {
      ...
      content_type =
        (option_of_yojson
           (value_for_key content_type_of_yojson "ContentType") _list path);
      hierarchical_access_control_list =
        (option_of_yojson
           (value_for_key hierarchical_principal_list_of_yojson
              "HierarchicalAccessControlList") _list path);
  ...
  let _res : describe_thesaurus_response =
    {
      ...
      term_count =
        (option_of_yojson (value_for_key long_of_yojson "TermCount") _list
           path);
      file_size_bytes =
        (option_of_yojson (value_for_key long_of_yojson "FileSizeBytes")
           _list path);
      source_s3_path =
        (option_of_yojson (value_for_key s3_path_of_yojson "SourceS3Path")
           _list path);
  ...
  let _res : describe_query_suggestions_config_response =
    {
      ...
      last_clear_time =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "LastClearTime") _list path);
...
let describe_query_suggestions_config_request_of_yojson tree path =
  ...
  let _res : describe_query_suggestions_config_request =
    { index_id = (value_for_key index_id_of_yojson "IndexId" _list path) } in
  _res
...
let describe_index_request_of_yojson tree path =
  ...
  let _res : describe_index_request =
    { id = (value_for_key index_id_of_yojson "Id" _list path) } in
  _res
...
let create_experience_response_of_yojson tree path =
  ...
  let _res : create_experience_response =
    { id = (value_for_key experience_id_of_yojson "Id" _list path) } in
  _res
...
let create_data_source_response_of_yojson tree path =
  ...
  let _res : create_data_source_response =
    { id = (value_for_key data_source_id_of_yojson "Id" _list path) } in
  _res
...
let associate_entities_to_experience_request_of_yojson tree path =
  ...
  let _res : associate_entities_to_experience_request =
    {
      entity_list =
        (value_for_key associate_entity_list_of_yojson "EntityList" _list
           path);
      index_id = (value_for_key index_id_of_yojson "IndexId" _list path);
      id = (value_for_key experience_id_of_yojson "Id" _list path)
    } in
