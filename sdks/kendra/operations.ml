  ...
  struct
    ...
    let request context (request : batch_delete_document_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSKendraFrontendServiceBatchDeleteDocument" ~service
...
module BatchGetDocumentStatus =
  struct
    ...
    let request context (request : batch_get_document_status_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.batch_get_document_status_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateThesaurus =
  struct
    ...
    let request context (request : create_thesaurus_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_thesaurus_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteThesaurus =
  struct
    ...
    let request context (request : delete_thesaurus_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_thesaurus_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribePrincipalMapping =
  struct
    ...
    let request context (request : describe_principal_mapping_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_principal_mapping_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : get_query_suggestions_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSKendraFrontendServiceGetQuerySuggestions" ~service
          ~config:context.config ~http:context.http ~input
...
module ListDataSourceSyncJobs =
  struct
    ...
    let request context (request : list_data_source_sync_jobs_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_data_source_sync_jobs_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module ListExperiences =
  struct
    ...
    let request context (request : list_experiences_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_experiences_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module ListFeaturedResultsSets =
  struct
    ...
    let request context (request : list_featured_results_sets_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_featured_results_sets_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSKendraFrontendServiceListTagsForResource" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : put_principal_mapping_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSKendraFrontendServicePutPrincipalMapping" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
...
module StartDataSourceSyncJob =
  struct
    ...
    let request context (request : start_data_source_sync_job_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.start_data_source_sync_job_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module StopDataSourceSyncJob =
  struct
    ...
    let request context (request : stop_data_source_sync_job_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.stop_data_source_sync_job_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module SubmitFeedback =
  struct
    ...
    let request context (request : submit_feedback_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.submit_feedback_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateThesaurus =
  struct
    ...
    let request context (request : update_thesaurus_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_thesaurus_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
