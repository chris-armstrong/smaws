...
module AssociateEntitiesToExperience =
  struct
    let error_to_string =
      ...
      | `ResourceAlreadyExistException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "ResourceAlreadyExistException") ->
            `ResourceAlreadyExistException
              (Json_deserializers.resource_already_exist_exception_of_yojson
                 tree path)
    ...
    let request context (request : associate_entities_to_experience_request)
      =
      let input =
        Json_serializers.associate_entities_to_experience_request_to_yojson
          request in
...
module AssociatePersonasToEntities =
  struct
    ...
    let request context (request : associate_personas_to_entities_request) =
      let input =
        Json_serializers.associate_personas_to_entities_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module BatchDeleteDocument =
  struct
    ...
    let request context (request : batch_delete_document_request) =
      let input =
        Json_serializers.batch_delete_document_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.BatchDeleteDocument" ~service
        ~context ~input
...
module BatchDeleteFeaturedResultsSet =
  struct
    ...
    let request context (request : batch_delete_featured_results_set_request)
      =
      let input =
        Json_serializers.batch_delete_featured_results_set_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module BatchGetDocumentStatus =
  struct
    ...
    let request context (request : batch_get_document_status_request) =
      let input =
        Json_serializers.batch_get_document_status_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module BatchPutDocument =
  struct
    ...
    let request context (request : batch_put_document_request) =
      let input =
        Json_serializers.batch_put_document_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.BatchPutDocument" ~service
        ~context ~input
...
module ClearQuerySuggestions =
  struct
    ...
    let request context (request : clear_query_suggestions_request) =
      let input =
        Json_serializers.clear_query_suggestions_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.ClearQuerySuggestions" ~service
        ~context ~input
...
module CreateAccessControlConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.create_access_control_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateDataSource =
  struct
    ...
    let request context (request : create_data_source_request) =
      let input =
        Json_serializers.create_data_source_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.CreateDataSource" ~service
        ~context ~input
...
module CreateExperience =
  struct
    ...
    let request context (request : create_experience_request) =
      let input =
        Json_serializers.create_experience_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.CreateExperience" ~service
        ~context ~input
...
module CreateFaq =
  struct
    ...
    let request context (request : create_faq_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.CreateFaq" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.create_faq_response_of_yojson
        ~error_deserializer
  end
  ...
  struct
    let error_to_string =
      ...
      | `AccessDeniedException _ ->
          "com.amazonaws.kendra#AccessDeniedException"
      | `ConflictException _ -> "com.amazonaws.kendra#ConflictException"
      | `FeaturedResultsConflictException _ ->
      ...
      let handler handler tree path =
        ...
        | (_, "FeaturedResultsConflictException") ->
            `FeaturedResultsConflictException
              (Json_deserializers.featured_results_conflict_exception_of_yojson
                 tree path)
        | (_, "InternalServerException") ->
            `InternalServerException
              (Json_deserializers.internal_server_exception_of_yojson tree
    ...
    let request context (request : create_featured_results_set_request) =
      let input =
        Json_serializers.create_featured_results_set_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateIndex =
  struct
    ...
    let request context (request : create_index_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.CreateIndex" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.create_index_response_of_yojson
        ~error_deserializer
  end
module CreateQuerySuggestionsBlockList =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.create_query_suggestions_block_list_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateThesaurus =
  struct
    ...
    let request context (request : create_thesaurus_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.CreateThesaurus" ~service
        ~context ~input
...
module DeleteAccessControlConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.delete_access_control_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteDataSource =
  struct
    ...
    let request context (request : delete_data_source_request) =
      let input =
        Json_serializers.delete_data_source_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DeleteDataSource" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeleteExperience =
  struct
    ...
    let request context (request : delete_experience_request) =
      let input =
        Json_serializers.delete_experience_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DeleteExperience" ~service
        ~context ~input
...
module DeleteFaq =
  struct
    ...
    let request context (request : delete_faq_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DeleteFaq" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeleteIndex =
  struct
    ...
    let request context (request : delete_index_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DeleteIndex" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeletePrincipalMapping =
  struct
    ...
    let request context (request : delete_principal_mapping_request) =
      let input =
        Json_serializers.delete_principal_mapping_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteQuerySuggestionsBlockList =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.delete_query_suggestions_block_list_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteThesaurus =
  struct
    ...
    let request context (request : delete_thesaurus_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DeleteThesaurus" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DescribeAccessControlConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_access_control_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DescribeAccessControlConfiguration"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_access_control_configuration_response_of_yojson
        ~error_deserializer
  end
module DescribeDataSource =
  struct
    ...
    let request context (request : describe_data_source_request) =
      let input =
        Json_serializers.describe_data_source_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DescribeDataSource" ~service
        ~context ~input
...
module DescribeExperience =
  struct
    ...
    let request context (request : describe_experience_request) =
      let input =
        Json_serializers.describe_experience_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DescribeExperience" ~service
        ~context ~input
...
module DescribeFaq =
  struct
    ...
    let request context (request : describe_faq_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DescribeFaq" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.describe_faq_response_of_yojson
        ~error_deserializer
  end
module DescribeFeaturedResultsSet =
  struct
    ...
    let request context (request : describe_featured_results_set_request) =
      let input =
        Json_serializers.describe_featured_results_set_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeIndex =
  struct
    ...
    let request context (request : describe_index_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DescribeIndex" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.describe_index_response_of_yojson
        ~error_deserializer
  end
module DescribePrincipalMapping =
  struct
    ...
    let request context (request : describe_principal_mapping_request) =
      let input =
        Json_serializers.describe_principal_mapping_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeQuerySuggestionsBlockList =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_query_suggestions_block_list_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DescribeQuerySuggestionsBlockList"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_query_suggestions_block_list_response_of_yojson
        ~error_deserializer
  end
module DescribeQuerySuggestionsConfig =
  struct
    ...
    let request context (request : describe_query_suggestions_config_request)
      =
      let input =
        Json_serializers.describe_query_suggestions_config_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeThesaurus =
  struct
    ...
    let request context (request : describe_thesaurus_request) =
      let input =
        Json_serializers.describe_thesaurus_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DescribeThesaurus" ~service
        ~context ~input
...
module DisassociateEntitiesFromExperience =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.disassociate_entities_from_experience_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.DisassociateEntitiesFromExperience"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.disassociate_entities_from_experience_response_of_yojson
        ~error_deserializer
  end
module DisassociatePersonasFromEntities =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.disassociate_personas_from_entities_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetQuerySuggestions =
  struct
    ...
    let request context (request : get_query_suggestions_request) =
      let input =
        Json_serializers.get_query_suggestions_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.GetQuerySuggestions" ~service
        ~context ~input
...
module GetSnapshots =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidRequestException") ->
            `InvalidRequestException
              (Json_deserializers.invalid_request_exception_of_yojson tree
                 path)
        | (_, "ResourceNotFoundException") ->
            `ResourceNotFoundException
              (Json_deserializers.resource_not_found_exception_of_yojson tree
    ...
    let request context (request : get_snapshots_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.GetSnapshots" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.get_snapshots_response_of_yojson
        ~error_deserializer
  end
module ListAccessControlConfigurations =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_access_control_configurations_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListDataSourceSyncJobs =
  struct
    ...
    let request context (request : list_data_source_sync_jobs_request) =
      let input =
        Json_serializers.list_data_source_sync_jobs_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListDataSources =
  struct
    ...
    let request context (request : list_data_sources_request) =
      let input =
        Json_serializers.list_data_sources_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.ListDataSources" ~service
        ~context ~input
...
module ListEntityPersonas =
  struct
    ...
    let request context (request : list_entity_personas_request) =
      let input =
        Json_serializers.list_entity_personas_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.ListEntityPersonas" ~service
        ~context ~input
...
module ListExperienceEntities =
  struct
    ...
    let request context (request : list_experience_entities_request) =
      let input =
        Json_serializers.list_experience_entities_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListExperiences =
  struct
    ...
    let request context (request : list_experiences_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.ListExperiences" ~service
        ~context ~input
...
module ListFaqs =
  struct
    ...
    let request context (request : list_faqs_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.ListFaqs" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.list_faqs_response_of_yojson
        ~error_deserializer
  end
module ListFeaturedResultsSets =
  struct
    ...
    let request context (request : list_featured_results_sets_request) =
      let input =
        Json_serializers.list_featured_results_sets_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListGroupsOlderThanOrderingId =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_groups_older_than_ordering_id_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListIndices =
  struct
    ...
    let request context (request : list_indices_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.ListIndices" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.list_indices_response_of_yojson
        ~error_deserializer
  end
module ListQuerySuggestionsBlockLists =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_query_suggestions_block_lists_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ListTagsForResource =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ResourceUnavailableException") ->
            `ResourceUnavailableException
              (Json_deserializers.resource_unavailable_exception_of_yojson
                 tree path)
        | (_, "ThrottlingException") ->
            `ThrottlingException
              (Json_deserializers.throttling_exception_of_yojson tree path)
    ...
    let request context (request : list_tags_for_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.ListTagsForResource" ~service
        ~context ~input
...
module ListThesauri =
  struct
    ...
    let request context (request : list_thesauri_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.ListThesauri" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.list_thesauri_response_of_yojson
        ~error_deserializer
  end
module PutPrincipalMapping =
  struct
    ...
    let request context (request : put_principal_mapping_request) =
      let input =
        Json_serializers.put_principal_mapping_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.PutPrincipalMapping" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module Query =
  struct
    ...
    let request context (request : query_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.Query" ~service ~context ~input
        ~output_deserializer:Json_deserializers.query_result_of_yojson
        ~error_deserializer
  end
module Retrieve =
  struct
    ...
    let request context (request : retrieve_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.Retrieve" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.retrieve_result_of_yojson
        ~error_deserializer
  end
module StartDataSourceSyncJob =
  struct
    ...
    let request context (request : start_data_source_sync_job_request) =
      let input =
        Json_serializers.start_data_source_sync_job_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module StopDataSourceSyncJob =
  struct
    ...
    let request context (request : stop_data_source_sync_job_request) =
      let input =
        Json_serializers.stop_data_source_sync_job_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.StopDataSourceSyncJob" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module SubmitFeedback =
  struct
    ...
    let request context (request : submit_feedback_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.SubmitFeedback" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.TagResource" ~service ~context
        ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.UntagResource" ~service
        ~context ~input
...
module UpdateAccessControlConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.update_access_control_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateDataSource =
  struct
    ...
    let request context (request : update_data_source_request) =
      let input =
        Json_serializers.update_data_source_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.UpdateDataSource" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module UpdateExperience =
  struct
    ...
    let request context (request : update_experience_request) =
      let input =
        Json_serializers.update_experience_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.UpdateExperience" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module UpdateFeaturedResultsSet =
  struct
    ...
    let request context (request : update_featured_results_set_request) =
      let input =
        Json_serializers.update_featured_results_set_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateIndex =
  struct
    ...
    let request context (request : update_index_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.UpdateIndex" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module UpdateQuerySuggestionsBlockList =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.update_query_suggestions_block_list_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateQuerySuggestionsConfig =
  struct
    ...
    let request context (request : update_query_suggestions_config_request) =
      let input =
        Json_serializers.update_query_suggestions_config_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateThesaurus =
  struct
    ...
    let request context (request : update_thesaurus_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSKendraFrontendService.UpdateThesaurus" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end