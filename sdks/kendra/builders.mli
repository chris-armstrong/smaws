...
val make_proxy_configuration :
  ?credentials:secret_arn -> port:port -> host:host -> unit -> proxy_configuration

val make_basic_authentication_configuration :
  credentials:secret_arn -> port:port -> host:host -> unit -> basic_authentication_configuration
...
val make_warning : ?code:warning_code -> ?message:warning_message -> unit -> warning
...
val make_data_source_group :
  data_source_id:data_source_id -> group_id:principal_name -> unit -> data_source_group
...
val make_s3_path : key:s3_object_key -> bucket:s3_bucket_name -> unit -> s3_path
...
val make_conflicting_item :
  ?set_id:string_ -> ?set_name:string_ -> ?query_text:query_text -> unit -> conflicting_item
...
val make_saa_s_configuration :
  host_url:url -> organization_name:organization_name -> unit -> saa_s_configuration
...
val make_time_range : ?end_time:timestamp -> ?start_time:timestamp -> unit -> time_range
...
val make_table_excerpt :
  ?total_number_of_rows:integer -> ?rows:table_row_list -> unit -> table_excerpt

val make_suggestion_highlight :
  ?end_offset:integer -> ?begin_offset:integer -> unit -> suggestion_highlight

val make_suggestion_text_with_highlights :
  ?highlights:suggestion_highlight_list -> ?text:string_ -> unit -> suggestion_text_with_highlights

val make_suggestion_value : ?text:suggestion_text_with_highlights -> unit -> suggestion_value

val make_document_attribute :
  value:document_attribute_value -> key:document_attribute_key -> unit -> document_attribute
...
val make_click_feedback : click_time:timestamp -> result_id:result_id -> unit -> click_feedback

val make_relevance_feedback :
  relevance_value:relevance_type -> result_id:result_id -> unit -> relevance_feedback
...
val make_stop_data_source_sync_job_request :
  index_id:index_id -> id:data_source_id -> unit -> stop_data_source_sync_job_request
...
val make_start_data_source_sync_job_request :
  index_id:index_id -> id:data_source_id -> unit -> start_data_source_sync_job_request
...
val make_group_summary :
  ?ordering_id:principal_ordering_id -> ?group_id:group_id -> unit -> group_summary
...
val make_list_faqs_response :
  ?faq_summary_items:faq_summary_items -> ?next_token:next_token -> unit -> list_faqs_response
...
val make_experience_endpoint :
  ?endpoint:endpoint -> ?endpoint_type:endpoint_type -> unit -> experience_endpoint
...
val make_featured_document_with_metadata :
  ?ur_i:url -> ?title:string_ -> ?id:document_id -> unit -> featured_document_with_metadata

val make_featured_document_missing : ?id:document_id -> unit -> featured_document_missing

val make_failed_entity :
  ?error_message:error_message -> ?entity_id:entity_id -> unit -> failed_entity

val make_entity_persona_configuration :
  persona:persona -> entity_id:entity_id -> unit -> entity_persona_configuration

val make_entity_configuration :
  entity_type:entity_type -> entity_id:entity_id -> unit -> entity_configuration
...
val make_describe_faq_request : index_id:index_id -> id:faq_id -> unit -> describe_faq_request
...
val make_describe_experience_request :
  index_id:index_id -> id:experience_id -> unit -> describe_experience_request
...
val make_describe_data_source_request :
  index_id:index_id -> id:data_source_id -> unit -> describe_data_source_request
...
val make_delete_faq_request : index_id:index_id -> id:faq_id -> unit -> delete_faq_request
...
val make_delete_data_source_request :
  index_id:index_id -> id:data_source_id -> unit -> delete_data_source_request
