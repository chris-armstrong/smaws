...
type nonrec transfer_participant = {
  management_account_email : email option;
...
type nonrec resource_policy_summary = {
  ...
  id : resource_policy_id option; [@ocaml.doc "The unique identifier (ID) of the resource policy.\n"]
}
...
type nonrec parent_type = ORGANIZATIONAL_UNIT [@ocaml.doc ""] | ROOT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec organization_feature_set = CONSOLIDATED_BILLING [@ocaml.doc ""] | ALL [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  next_token : next_token option;
      [@ocaml.doc
        "If present, indicates that more output is available than is included in the current \
         ...
         operation to get the next part of the output. You should repeat this until the \
         [NextToken] response element comes back as [null].\n"]
  parents : parents option; [@ocaml.doc "A list of parents for the specified child account or OU.\n"]
}
[@@ocaml.doc ""]
...
and handshake_resources = handshake_resource list [@@ocaml.doc ""]
...
type nonrec account_joined_method = CREATED [@ocaml.doc ""] | INVITED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec child_type = ORGANIZATIONAL_UNIT [@ocaml.doc ""] | ACCOUNT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec iam_user_access_to_billing = DENY [@ocaml.doc ""] | ALLOW [@ocaml.doc ""]
[@@ocaml.doc ""]
