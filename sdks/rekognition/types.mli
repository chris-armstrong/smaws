...
type nonrec gender_type = Male [@ocaml.doc ""] | Female [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec celebrity_recognition_sort_by = ID [@ocaml.doc ""] | TIMESTAMP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec content_moderation_sort_by = NAME [@ocaml.doc ""] | TIMESTAMP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec project_auto_update = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec text_types = LINE [@ocaml.doc ""] | WORD [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec face_attributes = DEFAULT [@ocaml.doc ""] | ALL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec face_search_sort_by = INDEX [@ocaml.doc ""] | TIMESTAMP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec video_color_range = FULL [@ocaml.doc ""] | LIMITED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec label_detection_aggregate_by = TIMESTAMPS [@ocaml.doc ""] | SEGMENTS [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec label_detection_sort_by = NAME [@ocaml.doc ""] | TIMESTAMP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec person_tracking_sort_by = INDEX [@ocaml.doc ""] | TIMESTAMP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec segment_type = TECHNICAL_CUE [@ocaml.doc ""] | SHOT [@ocaml.doc ""] [@@ocaml.doc ""]
