...
type nonrec agent_status = ONLINE [@ocaml.doc ""] | OFFLINE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec atime = NONE [@ocaml.doc ""] | BEST_EFFORT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec azure_blob_authentication_type = SAS [@ocaml.doc ""] | NONE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec efs_in_transit_encryption = NONE [@ocaml.doc ""] | TLS1_2 [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec hdfs_authentication_type = SIMPLE [@ocaml.doc ""] | KERBEROS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec object_storage_server_protocol = HTTPS [@ocaml.doc ""] | HTTP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec smb_authentication_type = NTLM [@ocaml.doc ""] | KERBEROS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec task_mode = BASIC [@ocaml.doc ""] | ENHANCED [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec report_level = ERRORS_ONLY [@ocaml.doc ""] | SUCCESSES_AND_ERRORS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec object_version_ids = INCLUDE [@ocaml.doc ""] | NONE [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec report_output_type = SUMMARY_ONLY [@ocaml.doc ""] | STANDARD [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec schedule_status = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec object_tags = PRESERVE [@ocaml.doc ""] | NONE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec transfer_mode = CHANGED [@ocaml.doc ""] | ALL [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec log_level = OFF [@ocaml.doc ""] | BASIC [@ocaml.doc ""] | TRANSFER [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec task_queueing = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec posix_permissions = NONE [@ocaml.doc ""] | PRESERVE [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec preserve_devices = NONE [@ocaml.doc ""] | PRESERVE [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec preserve_deleted_files = PRESERVE [@ocaml.doc ""] | REMOVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec mtime = NONE [@ocaml.doc ""] | PRESERVE [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec overwrite_mode = ALWAYS [@ocaml.doc ""] | NEVER [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec schedule_disabled_by = USER [@ocaml.doc ""] | SERVICE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec task_filter_name = LocationId [@ocaml.doc ""] | CreationTime [@ocaml.doc ""]
[@@ocaml.doc ""]
