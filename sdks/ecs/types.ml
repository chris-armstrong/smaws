...
type nonrec access_type = PUBLIC [@ocaml.doc ""] | PRIVATE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec setting_type = USER [@ocaml.doc ""] | AWS_MANAGED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec ipc_mode = HOST [@ocaml.doc ""] | TASK [@ocaml.doc ""] | NONE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec pid_mode = HOST [@ocaml.doc ""] | TASK [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec cpu_architecture = X86_64 [@ocaml.doc ""] | ARM64 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec efs_authorization_config_ia_m = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec efs_transit_encryption = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec scope = TASK [@ocaml.doc ""] | SHARED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec firelens_configuration_type = FLUENTD [@ocaml.doc ""] | FLUENTBIT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec version_consistency = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec transport_protocol = TCP [@ocaml.doc ""] | UDP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec deployment_lifecycle_hook_action = ROLLBACK [@ocaml.doc ""] | CONTINUE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec auto_repair_actions_status = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec managed_draining = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec managed_termination_protection = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec managed_scaling_status = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec availability_zone_rebalancing = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec propagate_mi_tags = CAPACITY_PROVIDER [@ocaml.doc ""] | NONE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec connectivity = CONNECTED [@ocaml.doc ""] | DISCONNECTED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec network_interface = {
  ...
  ipv6_address : string_ option; [@ocaml.doc "The private IPv6 address for the network interface.\n"]
}
[@@ocaml.doc
...
type nonrec daemon_status = ACTIVE [@ocaml.doc ""] | DELETE_IN_PROGRESS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec daemon_propagate_tags = DAEMON [@ocaml.doc ""] | NONE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec resource_management_type = CUSTOMER [@ocaml.doc ""] | ECS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec scheduling_strategy = REPLICA [@ocaml.doc ""] | DAEMON [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec service_connect_access_logging_format = TEXT [@ocaml.doc ""] | JSON [@ocaml.doc ""]
[@@ocaml.doc
...
type nonrec stability_status = STEADY_STATE [@ocaml.doc ""] | STABILIZING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec describe_container_instances_response = {
  container_instances : container_instances option;
...
type nonrec platform_device_type = GPU [@ocaml.doc ""] | NEURON_DEVICE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec stop_service_deployment_stop_type = ABORT [@ocaml.doc ""] | ROLLBACK [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec submit_container_state_change_request = {
  ...
  network_bindings : network_bindings option; [@ocaml.doc "The network bindings of the container.\n"]
}
[@@ocaml.doc ""]
