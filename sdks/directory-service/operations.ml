  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "ClientException") ->
            `ClientException
              (Json_deserializers.client_exception_of_yojson tree path)
        | (_, "DirectoryAlreadySharedException") ->
            `DirectoryAlreadySharedException
              (Json_deserializers.directory_already_shared_exception_of_yojson
                 tree path)
        | (_, "EntityDoesNotExistException") ->
            `EntityDoesNotExistException
              (Json_deserializers.entity_does_not_exist_exception_of_yojson
                 tree path)
    ...
    let request context (request : accept_shared_directory_request) =
      let input =
        Json_serializers.accept_shared_directory_request_to_yojson request in
...
module AddIpRoutes =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "EntityAlreadyExistsException") ->
            `EntityAlreadyExistsException
              (Json_deserializers.entity_already_exists_exception_of_yojson
                 tree path)
        | (_, "EntityDoesNotExistException") ->
            `EntityDoesNotExistException
              (Json_deserializers.entity_does_not_exist_exception_of_yojson
        ...
        | (_, "IpRouteLimitExceededException") ->
            `IpRouteLimitExceededException
              (Json_deserializers.ip_route_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "ServiceException") ->
            `ServiceException
              (Json_deserializers.service_exception_of_yojson tree path)
    ...
    let request context (request : add_ip_routes_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.AddIpRoutes" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.add_ip_routes_result_of_yojson
        ~error_deserializer
  end
module AddRegion =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DirectoryAlreadyInRegionException") ->
            `DirectoryAlreadyInRegionException
              (Json_deserializers.directory_already_in_region_exception_of_yojson
                 tree path)
        | (_, "DirectoryDoesNotExistException") ->
            `DirectoryDoesNotExistException
              (Json_deserializers.directory_does_not_exist_exception_of_yojson
                 tree path)
        | (_, "DirectoryUnavailableException") ->
            `DirectoryUnavailableException
              (Json_deserializers.directory_unavailable_exception_of_yojson
        ...
        | (_, "RegionLimitExceededException") ->
            `RegionLimitExceededException
              (Json_deserializers.region_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "ServiceException") ->
            `ServiceException
              (Json_deserializers.service_exception_of_yojson tree path)
    ...
    let request context (request : add_region_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.AddRegion" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.add_region_result_of_yojson
        ~error_deserializer
  end
module AddTagsToResource =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "TagLimitExceededException") ->
            `TagLimitExceededException
              (Json_deserializers.tag_limit_exceeded_exception_of_yojson tree
                 path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : add_tags_to_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.AddTagsToResource" ~service
        ~context ~input
...
module CancelSchemaExtension =
  struct
    ...
    let request context (request : cancel_schema_extension_request) =
      let input =
        Json_serializers.cancel_schema_extension_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module ConnectDirectory =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DirectoryLimitExceededException") ->
            `DirectoryLimitExceededException
              (Json_deserializers.directory_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "InvalidParameterException") ->
            `InvalidParameterException
              (Json_deserializers.invalid_parameter_exception_of_yojson tree
    ...
    let request context (request : connect_directory_request) =
      let input =
        Json_serializers.connect_directory_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.ConnectDirectory" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.connect_directory_result_of_yojson
        ~error_deserializer
  end
module CreateAlias =
  struct
    ...
    let request context (request : create_alias_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.CreateAlias" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.create_alias_result_of_yojson
        ~error_deserializer
  end
module CreateComputer =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "AuthenticationFailedException") ->
            `AuthenticationFailedException
              (Json_deserializers.authentication_failed_exception_of_yojson
                 tree path)
        | (_, "ClientException") ->
            `ClientException
              (Json_deserializers.client_exception_of_yojson tree path)
    ...
    let request context (request : create_computer_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.CreateComputer" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.create_computer_result_of_yojson
        ~error_deserializer
  end
module CreateConditionalForwarder =
  struct
    ...
    let request context (request : create_conditional_forwarder_request) =
      let input =
        Json_serializers.create_conditional_forwarder_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateDirectory =
  struct
    ...
    let request context (request : create_directory_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.CreateDirectory" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.create_directory_result_of_yojson
        ~error_deserializer
  end
module CreateLogSubscription =
  struct
    ...
    let request context (request : create_log_subscription_request) =
      let input =
        Json_serializers.create_log_subscription_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module CreateMicrosoftAD =
  struct
    ...
    let request context (request : create_microsoft_ad_request) =
      let input =
        Json_serializers.create_microsoft_ad_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.CreateMicrosoftAD" ~service
        ~context ~input
...
module CreateSnapshot =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "SnapshotLimitExceededException") ->
            `SnapshotLimitExceededException
              (Json_deserializers.snapshot_limit_exceeded_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : create_snapshot_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.CreateSnapshot" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.create_snapshot_result_of_yojson
        ~error_deserializer
  end
module CreateTrust =
  struct
    ...
    let request context (request : create_trust_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.CreateTrust" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.create_trust_result_of_yojson
        ~error_deserializer
  end
module DeleteConditionalForwarder =
  struct
    ...
    let request context (request : delete_conditional_forwarder_request) =
      let input =
        Json_serializers.delete_conditional_forwarder_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteDirectory =
  struct
    ...
    let request context (request : delete_directory_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DeleteDirectory" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.delete_directory_result_of_yojson
        ~error_deserializer
  end
module DeleteLogSubscription =
  struct
    ...
    let request context (request : delete_log_subscription_request) =
      let input =
        Json_serializers.delete_log_subscription_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeleteSnapshot =
  struct
    ...
    let request context (request : delete_snapshot_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DeleteSnapshot" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.delete_snapshot_result_of_yojson
        ~error_deserializer
  end
module DeleteTrust =
  struct
    ...
    let request context (request : delete_trust_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DeleteTrust" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.delete_trust_result_of_yojson
        ~error_deserializer
  end
module DeregisterCertificate =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "CertificateDoesNotExistException") ->
            `CertificateDoesNotExistException
              (Json_deserializers.certificate_does_not_exist_exception_of_yojson
                 tree path)
        | (_, "CertificateInUseException") ->
            `CertificateInUseException
              (Json_deserializers.certificate_in_use_exception_of_yojson tree
                 path)
        | (_, "ClientException") ->
            `ClientException
              (Json_deserializers.client_exception_of_yojson tree path)
    ...
    let request context (request : deregister_certificate_request) =
      let input =
        Json_serializers.deregister_certificate_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DeregisterEventTopic =
  struct
    ...
    let request context (request : deregister_event_topic_request) =
      let input =
        Json_serializers.deregister_event_topic_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DeregisterEventTopic" ~service
        ~context ~input
...
module DescribeCertificate =
  struct
    ...
    let request context (request : describe_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DescribeCertificate" ~service
        ~context ~input
...
module DescribeClientAuthenticationSettings =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_client_authentication_settings_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DescribeClientAuthenticationSettings"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_client_authentication_settings_result_of_yojson
        ~error_deserializer
  end
module DescribeConditionalForwarders =
  struct
    ...
    let request context (request : describe_conditional_forwarders_request) =
      let input =
        Json_serializers.describe_conditional_forwarders_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeDirectories =
  struct
    ...
    let request context (request : describe_directories_request) =
      let input =
        Json_serializers.describe_directories_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DescribeDirectories" ~service
        ~context ~input
...
module DescribeDirectoryDataAccess =
  struct
    ...
    let request context (request : describe_directory_data_access_request) =
      let input =
        Json_serializers.describe_directory_data_access_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DescribeDirectoryDataAccess"
        ~service ~context ~input
...
module DescribeDomainControllers =
  struct
    ...
    let request context (request : describe_domain_controllers_request) =
      let input =
        Json_serializers.describe_domain_controllers_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeEventTopics =
  struct
    ...
    let request context (request : describe_event_topics_request) =
      let input =
        Json_serializers.describe_event_topics_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DescribeEventTopics" ~service
        ~context ~input
...
module DescribeLDAPSSettings =
  struct
    ...
    let request context (request : describe_ldaps_settings_request) =
      let input =
        Json_serializers.describe_ldaps_settings_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeRegions =
  struct
    ...
    let request context (request : describe_regions_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DescribeRegions" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.describe_regions_result_of_yojson
        ~error_deserializer
  end
module DescribeSettings =
  struct
    ...
    let request context (request : describe_settings_request) =
      let input =
        Json_serializers.describe_settings_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DescribeSettings" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.describe_settings_result_of_yojson
        ~error_deserializer
  end
module DescribeSharedDirectories =
  struct
    ...
    let request context (request : describe_shared_directories_request) =
      let input =
        Json_serializers.describe_shared_directories_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DescribeSnapshots =
  struct
    ...
    let request context (request : describe_snapshots_request) =
      let input =
        Json_serializers.describe_snapshots_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DescribeSnapshots" ~service
        ~context ~input
...
module DescribeTrusts =
  struct
    ...
    let request context (request : describe_trusts_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DescribeTrusts" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.describe_trusts_result_of_yojson
        ~error_deserializer
  end
module DescribeUpdateDirectory =
  struct
    ...
    let request context (request : describe_update_directory_request) =
      let input =
        Json_serializers.describe_update_directory_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DisableClientAuthentication =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidClientAuthStatusException") ->
            `InvalidClientAuthStatusException
              (Json_deserializers.invalid_client_auth_status_exception_of_yojson
                 tree path)
        | (_, "ServiceException") ->
            `ServiceException
              (Json_deserializers.service_exception_of_yojson tree path)
    ...
    let request context (request : disable_client_authentication_request) =
      let input =
        Json_serializers.disable_client_authentication_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module DisableDirectoryDataAccess =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DirectoryInDesiredStateException") ->
            `DirectoryInDesiredStateException
              (Json_deserializers.directory_in_desired_state_exception_of_yojson
                 tree path)
        | (_, "DirectoryUnavailableException") ->
            `DirectoryUnavailableException
              (Json_deserializers.directory_unavailable_exception_of_yojson
    ...
    let request context (request : disable_directory_data_access_request) =
      let input =
        Json_serializers.disable_directory_data_access_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DisableDirectoryDataAccess"
        ~service ~context ~input
...
module DisableLDAPS =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidLDAPSStatusException") ->
            `InvalidLDAPSStatusException
              (Json_deserializers.invalid_ldaps_status_exception_of_yojson
                 tree path)
        | (_, "InvalidParameterException") ->
            `InvalidParameterException
              (Json_deserializers.invalid_parameter_exception_of_yojson tree
    ...
    let request context (request : disable_ldaps_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DisableLDAPS" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.disable_ldaps_result_of_yojson
        ~error_deserializer
  end
module DisableRadius =
  struct
    ...
    let request context (request : disable_radius_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DisableRadius" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.disable_radius_result_of_yojson
        ~error_deserializer
  end
module DisableSso =
  struct
    ...
    let request context (request : disable_sso_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.DisableSso" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.disable_sso_result_of_yojson
        ~error_deserializer
  end
module EnableClientAuthentication =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "NoAvailableCertificateException") ->
            `NoAvailableCertificateException
              (Json_deserializers.no_available_certificate_exception_of_yojson
                 tree path)
        | (_, "ServiceException") ->
            `ServiceException
              (Json_deserializers.service_exception_of_yojson tree path)
    ...
    let request context (request : enable_client_authentication_request) =
      let input =
        Json_serializers.enable_client_authentication_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module EnableDirectoryDataAccess =
  struct
    ...
    let request context (request : enable_directory_data_access_request) =
      let input =
        Json_serializers.enable_directory_data_access_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.EnableDirectoryDataAccess"
        ~service ~context ~input
...
module EnableLDAPS =
  struct
    ...
    let request context (request : enable_ldaps_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.EnableLDAPS" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.enable_ldaps_result_of_yojson
        ~error_deserializer
  end
module EnableRadius =
  struct
    ...
    let request context (request : enable_radius_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.EnableRadius" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.enable_radius_result_of_yojson
        ~error_deserializer
  end
module EnableSso =
  struct
    ...
    let request context (request : enable_sso_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.EnableSso" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.enable_sso_result_of_yojson
        ~error_deserializer
  end
module GetDirectoryLimits =
  struct
    ...
    let request context (request : get_directory_limits_request) =
      let input =
        Json_serializers.get_directory_limits_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.GetDirectoryLimits" ~service
        ~context ~input
...
module GetSnapshotLimits =
  struct
    ...
    let request context (request : get_snapshot_limits_request) =
      let input =
        Json_serializers.get_snapshot_limits_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.GetSnapshotLimits" ~service
        ~context ~input
...
module ListCertificates =
  struct
    ...
    let request context (request : list_certificates_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.ListCertificates" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_certificates_result_of_yojson
        ~error_deserializer
  end
module ListIpRoutes =
  struct
    ...
    let request context (request : list_ip_routes_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.ListIpRoutes" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.list_ip_routes_result_of_yojson
        ~error_deserializer
  end
module ListLogSubscriptions =
  struct
    ...
    let request context (request : list_log_subscriptions_request) =
      let input =
        Json_serializers.list_log_subscriptions_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.ListLogSubscriptions" ~service
        ~context ~input
...
module ListSchemaExtensions =
  struct
    ...
    let request context (request : list_schema_extensions_request) =
      let input =
        Json_serializers.list_schema_extensions_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.ListSchemaExtensions" ~service
        ~context ~input
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.ListTagsForResource" ~service
        ~context ~input
...
module RegisterCertificate =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "CertificateAlreadyExistsException") ->
            `CertificateAlreadyExistsException
              (Json_deserializers.certificate_already_exists_exception_of_yojson
                 tree path)
        | (_, "CertificateLimitExceededException") ->
            `CertificateLimitExceededException
              (Json_deserializers.certificate_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "ClientException") ->
            `ClientException
              (Json_deserializers.client_exception_of_yojson tree path)
        ...
        | (_, "InvalidCertificateException") ->
            `InvalidCertificateException
              (Json_deserializers.invalid_certificate_exception_of_yojson
                 tree path)
        | (_, "InvalidParameterException") ->
            `InvalidParameterException
              (Json_deserializers.invalid_parameter_exception_of_yojson tree
    ...
    let request context (request : register_certificate_request) =
      let input =
        Json_serializers.register_certificate_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.RegisterCertificate" ~service
        ~context ~input
...
module RegisterEventTopic =
  struct
    ...
    let request context (request : register_event_topic_request) =
      let input =
        Json_serializers.register_event_topic_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.RegisterEventTopic" ~service
        ~context ~input
...
module RejectSharedDirectory =
  struct
    ...
    let request context (request : reject_shared_directory_request) =
      let input =
        Json_serializers.reject_shared_directory_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module RemoveIpRoutes =
  struct
    ...
    let request context (request : remove_ip_routes_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.RemoveIpRoutes" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.remove_ip_routes_result_of_yojson
        ~error_deserializer
  end
module RemoveRegion =
  struct
    ...
    let request context (request : remove_region_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.RemoveRegion" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.remove_region_result_of_yojson
        ~error_deserializer
  end
...
module ResetUserPassword =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "UserDoesNotExistException") ->
            `UserDoesNotExistException
              (Json_deserializers.user_does_not_exist_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : reset_user_password_request) =
      let input =
        Json_serializers.reset_user_password_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.ResetUserPassword" ~service
        ~context ~input
...
module RestoreFromSnapshot =
  struct
    ...
    let request context (request : restore_from_snapshot_request) =
      let input =
        Json_serializers.restore_from_snapshot_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.RestoreFromSnapshot" ~service
        ~context ~input
...
module ShareDirectory =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidTargetException") ->
            `InvalidTargetException
              (Json_deserializers.invalid_target_exception_of_yojson tree
                 path)
        | (_, "OrganizationsException") ->
            `OrganizationsException
              (Json_deserializers.organizations_exception_of_yojson tree path)
        | (_, "ServiceException") ->
            `ServiceException
              (Json_deserializers.service_exception_of_yojson tree path)
        | (_, "ShareLimitExceededException") ->
            `ShareLimitExceededException
              (Json_deserializers.share_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "UnsupportedOperationException") ->
            `UnsupportedOperationException
              (Json_deserializers.unsupported_operation_exception_of_yojson
    ...
    let request context (request : share_directory_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.ShareDirectory" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.share_directory_result_of_yojson
        ~error_deserializer
  end
module StartSchemaExtension =
  struct
    ...
    let request context (request : start_schema_extension_request) =
      let input =
        Json_serializers.start_schema_extension_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.StartSchemaExtension" ~service
        ~context ~input
...
module UnshareDirectory =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DirectoryNotSharedException") ->
            `DirectoryNotSharedException
              (Json_deserializers.directory_not_shared_exception_of_yojson
                 tree path)
        | (_, "EntityDoesNotExistException") ->
            `EntityDoesNotExistException
              (Json_deserializers.entity_does_not_exist_exception_of_yojson
    ...
    let request context (request : unshare_directory_request) =
      let input =
        Json_serializers.unshare_directory_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.UnshareDirectory" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.unshare_directory_result_of_yojson
        ~error_deserializer
  end
module UpdateConditionalForwarder =
  struct
    ...
    let request context (request : update_conditional_forwarder_request) =
      let input =
        Json_serializers.update_conditional_forwarder_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateDirectorySetup =
  struct
    ...
    let request context (request : update_directory_setup_request) =
      let input =
        Json_serializers.update_directory_setup_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.UpdateDirectorySetup" ~service
        ~context ~input
...
module UpdateNumberOfDomainControllers =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "DomainControllerLimitExceededException") ->
            `DomainControllerLimitExceededException
              (Json_deserializers.domain_controller_limit_exceeded_exception_of_yojson
                 tree path)
        | (_, "EntityDoesNotExistException") ->
            `EntityDoesNotExistException
              (Json_deserializers.entity_does_not_exist_exception_of_yojson
    ...
    let request context
      ...
      let input =
        Json_serializers.update_number_of_domain_controllers_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
...
module UpdateRadius =
  struct
    ...
    let request context (request : update_radius_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.UpdateRadius" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.update_radius_result_of_yojson
        ~error_deserializer
  end
module UpdateSettings =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "IncompatibleSettingsException") ->
            `IncompatibleSettingsException
              (Json_deserializers.incompatible_settings_exception_of_yojson
                 tree path)
        | (_, "InvalidParameterException") ->
            `InvalidParameterException
              (Json_deserializers.invalid_parameter_exception_of_yojson tree
        ...
        | (_, "UnsupportedSettingsException") ->
            `UnsupportedSettingsException
              (Json_deserializers.unsupported_settings_exception_of_yojson
                 tree path)
        | _type -> handler tree path _type in
      Smaws_Lib.Protocols.AwsJson.(error_deserializer
                                     (handler
    ...
    let request context (request : update_settings_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.UpdateSettings" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.update_settings_result_of_yojson
        ~error_deserializer
  end
module UpdateTrust =
  struct
    ...
    let request context (request : update_trust_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.UpdateTrust" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.update_trust_result_of_yojson
        ~error_deserializer
  end
module VerifyTrust =
  struct
    ...
    let request context (request : verify_trust_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DirectoryService_20150416.VerifyTrust" ~service ~context
        ~input
        ~output_deserializer:Json_deserializers.verify_trust_result_of_yojson
        ~error_deserializer
  end