...
module CreateComputer =
  struct
    ...
    let request context (request : create_computer_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_computer_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateDirectory =
  struct
    ...
    let request context (request : create_directory_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_directory_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateSnapshot =
  struct
    ...
    let request context (request : create_snapshot_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_snapshot_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteDirectory =
  struct
    ...
    let request context (request : delete_directory_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_directory_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteSnapshot =
  struct
    ...
    let request context (request : delete_snapshot_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_snapshot_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : describe_certificate_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"DirectoryService_20150416DescribeCertificate" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : describe_directories_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"DirectoryService_20150416DescribeDirectories" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : describe_event_topics_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"DirectoryService_20150416DescribeEventTopics" ~service
          ~config:context.config ~http:context.http ~input
...
module DescribeRegions =
  struct
    ...
    let request context (request : describe_regions_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_regions_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribeTrusts =
  struct
    ...
    let request context (request : describe_trusts_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_trusts_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribeUpdateDirectory =
  struct
    ...
    let request context (request : describe_update_directory_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_update_directory_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : get_directory_limits_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"DirectoryService_20150416GetDirectoryLimits" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"DirectoryService_20150416ListTagsForResource" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : register_certificate_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"DirectoryService_20150416RegisterCertificate" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : register_event_topic_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"DirectoryService_20150416RegisterEventTopic" ~service
          ~config:context.config ~http:context.http ~input
...
module RemoveIpRoutes =
  struct
    ...
    let request context (request : remove_ip_routes_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.remove_ip_routes_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : restore_from_snapshot_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"DirectoryService_20150416RestoreFromSnapshot" ~service
          ~config:context.config ~http:context.http ~input
...
module ShareDirectory =
  struct
    ...
    let request context (request : share_directory_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.share_directory_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateSettings =
  struct
    ...
    let request context (request : update_settings_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_settings_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
