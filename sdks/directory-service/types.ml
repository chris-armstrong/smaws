    ...
    update_security_group_for_directory_controllers option;
      [@ocaml.doc
        "If set to true, updates the inbound and outbound rules of the security group that has the \
         description: \"Amazon Web Services created security group for {i directory ID} directory \
         controllers.\" Following are the new rules: \n\n\
        \ Inbound:\n\
        \ \n\
        \  {ul\n\
        \        {-  Type: Custom UDP Rule, Protocol: UDP, Range: 88, Source: Managed Microsoft AD \
         VPC IPv4 CIDR\n\
        \            \n\
        \             }\n\
        ...
        \            \n\
        \             }\n\
        \        {-  Type: Custom TCP Rule, Protocol: TCP, Range: 88, Source: Managed Microsoft AD \
         VPC IPv4 CIDR\n\
        \            \n\
        \             }\n\
        ...
        \            \n\
        \             }\n\
        \        {-  Type: LDAP, Protocol: TCP, Range: 389, Source: Managed Microsoft AD VPC IPv4 \
         CIDR\n\
        \            \n\
        \             }\n\
