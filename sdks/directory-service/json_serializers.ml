...
let entity_does_not_exist_exception_to_yojson
  (x : entity_does_not_exist_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let user_does_not_exist_exception_to_yojson
  (x : user_does_not_exist_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let radius_authentication_protocol_to_yojson
  (x : radius_authentication_protocol) =
  match x with
...
let radius_settings_to_yojson (x : radius_settings) =
  assoc_to_yojson
    ...
    ("AuthenticationProtocol",
      (option_to_yojson radius_authentication_protocol_to_yojson
         x.authentication_protocol));
    ("SharedSecret",
...
let update_number_of_domain_controllers_request_to_yojson
  ...
  assoc_to_yojson
    [("DesiredNumber",
       (Some
          (desired_number_of_domain_controllers_to_yojson x.desired_number)));
    ("DirectoryId", (Some (directory_id_to_yojson x.directory_id)))]
...
let update_info_entry_to_yojson (x : update_info_entry) =
  assoc_to_yojson
    [("LastUpdatedDateTime",
       (option_to_yojson last_updated_date_time_to_yojson
...
let update_directory_setup_request_to_yojson
  ...
  assoc_to_yojson
    [("CreateSnapshotBeforeUpdate",
       (option_to_yojson create_snapshot_before_update_to_yojson
          x.create_snapshot_before_update));
    ("OSUpdateSettings",
      (option_to_yojson os_update_settings_to_yojson x.os_update_settings));
    ("UpdateType", (Some (update_type_to_yojson x.update_type)));
    ("DirectoryId", (Some (directory_id_to_yojson x.directory_id)))]
let snapshot_limit_exceeded_exception_to_yojson
  (x : snapshot_limit_exceeded_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
let directory_in_desired_state_exception_to_yojson
  (x : directory_in_desired_state_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let directory_not_shared_exception_to_yojson
  (x : directory_not_shared_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
let trust_type_to_yojson (x : trust_type) =
  match x with | EXTERNAL -> `String "External" | FOREST -> `String "Forest"
...
let state_last_updated_date_time_to_yojson =
...
let trust_to_yojson (x : trust) =
  assoc_to_yojson
    ...
    ("StateLastUpdatedDateTime",
      (option_to_yojson state_last_updated_date_time_to_yojson
         x.state_last_updated_date_time));
    ("LastUpdatedDateTime",
      (option_to_yojson last_updated_date_time_to_yojson
         x.last_updated_date_time));
    ("CreatedDateTime",
...
let subscription_created_date_time_to_yojson =
  timestamp_epoch_seconds_to_yojson
...
let start_schema_extension_result_to_yojson
  (x : start_schema_extension_result) =
  assoc_to_yojson
    [("SchemaExtensionId",
...
let start_schema_extension_request_to_yojson
  (x : start_schema_extension_request) =
  assoc_to_yojson
...
let snapshot_limits_to_yojson (x : snapshot_limits) =
  assoc_to_yojson
    [("ManualSnapshotsLimitReached",
       (option_to_yojson manual_snapshots_limit_reached_to_yojson
          x.manual_snapshots_limit_reached));
...
let shared_directories_to_yojson tree =
  list_to_yojson shared_directory_to_yojson tree
let share_target_to_yojson (x : share_target) =
  assoc_to_yojson
    [("Type", (Some (target_type_to_yojson x.type_)));
    ("Id", (Some (target_id_to_yojson x.id)))]
let share_limit_exceeded_exception_to_yojson
  (x : share_limit_exceeded_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let directory_already_shared_exception_to_yojson
  (x : directory_already_shared_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let directory_configuration_status_to_yojson
  (x : directory_configuration_status) =
  match x with
...
let directory_configuration_setting_request_detailed_status_to_yojson tree =
  map_to_yojson region_name_to_yojson
    directory_configuration_status_to_yojson tree
...
let setting_entry_to_yojson (x : setting_entry) =
  assoc_to_yojson
    [("DataType",
       (option_to_yojson directory_configuration_setting_data_type_to_yojson
          x.data_type));
    ("LastRequestedDateTime",
      (option_to_yojson
         directory_configuration_setting_last_requested_date_time_to_yojson
         x.last_requested_date_time));
    ("LastUpdatedDateTime",
      (option_to_yojson
         directory_configuration_setting_last_updated_date_time_to_yojson
         x.last_updated_date_time));
    ("RequestStatusMessage",
      (option_to_yojson
         directory_configuration_setting_request_status_message_to_yojson
         x.request_status_message));
    ("RequestDetailedStatus",
      (option_to_yojson
         directory_configuration_setting_request_detailed_status_to_yojson
         x.request_detailed_status));
    ("RequestStatus",
      (option_to_yojson directory_configuration_status_to_yojson
         x.request_status));
    ("RequestedValue",
      (option_to_yojson directory_configuration_setting_value_to_yojson
         x.requested_value));
    ("AppliedValue",
      (option_to_yojson directory_configuration_setting_value_to_yojson
         x.applied_value));
    ("AllowedValues",
      (option_to_yojson
         directory_configuration_setting_allowed_values_to_yojson
         x.allowed_values));
    ("Name",
      (option_to_yojson directory_configuration_setting_name_to_yojson x.name));
    ("Type",
      (option_to_yojson directory_configuration_setting_type_to_yojson
         x.type_))]
let setting_entries_to_yojson tree =
  list_to_yojson setting_entry_to_yojson tree
...
let schema_extension_info_to_yojson (x : schema_extension_info) =
  assoc_to_yojson
    ...
    ("SchemaExtensionStatusReason",
      (option_to_yojson schema_extension_status_reason_to_yojson
         x.schema_extension_status_reason));
    ("SchemaExtensionStatus",
      (option_to_yojson schema_extension_status_to_yojson
         x.schema_extension_status));
...
let remove_ip_routes_request_to_yojson (x : remove_ip_routes_request) =
  assoc_to_yojson
    ...
    ("DirectoryId", (Some (directory_id_to_yojson x.directory_id)))]
let remote_domain_names_to_yojson tree =
  list_to_yojson remote_domain_name_to_yojson tree
let reject_shared_directory_result_to_yojson
  (x : reject_shared_directory_result) =
  assoc_to_yojson
    [("SharedDirectoryId",
       (option_to_yojson directory_id_to_yojson x.shared_directory_id))]
let reject_shared_directory_request_to_yojson
  (x : reject_shared_directory_request) =
  assoc_to_yojson
    [("SharedDirectoryId",
...
let client_cert_auth_settings_to_yojson (x : client_cert_auth_settings) =
  assoc_to_yojson
    [("OCSPUrl", (option_to_yojson ocsp_url_to_yojson x.ocsp_url))]
let register_certificate_request_to_yojson (x : register_certificate_request)
  =
  assoc_to_yojson
    [("ClientCertAuthSettings",
       (option_to_yojson client_cert_auth_settings_to_yojson
          x.client_cert_auth_settings));
...
let invalid_certificate_exception_to_yojson
  (x : invalid_certificate_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
let certificate_limit_exceeded_exception_to_yojson
  (x : certificate_limit_exceeded_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
let certificate_already_exists_exception_to_yojson
  (x : certificate_already_exists_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
let additional_regions_to_yojson tree =
  list_to_yojson region_name_to_yojson tree
...
let region_description_to_yojson (x : region_description) =
  assoc_to_yojson
    ...
    ("StatusLastUpdatedDateTime",
      (option_to_yojson state_last_updated_date_time_to_yojson
         x.status_last_updated_date_time));
    ...
    ("DirectoryId", (option_to_yojson directory_id_to_yojson x.directory_id))]
let regions_description_to_yojson tree =
  list_to_yojson region_description_to_yojson tree
let region_limit_exceeded_exception_to_yojson
  (x : region_limit_exceeded_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let owner_directory_description_to_yojson (x : owner_directory_description) =
  assoc_to_yojson
    ...
    ("VpcSettings",
      (option_to_yojson directory_vpc_settings_description_to_yojson
         x.vpc_settings));
...
let no_available_certificate_exception_to_yojson
  (x : no_available_certificate_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let log_subscription_to_yojson (x : log_subscription) =
  assoc_to_yojson
    [("SubscriptionCreatedDateTime",
       (option_to_yojson subscription_created_date_time_to_yojson
          x.subscription_created_date_time));
    ("LogGroupName",
      (option_to_yojson log_group_name_to_yojson x.log_group_name));
    ("DirectoryId", (option_to_yojson directory_id_to_yojson x.directory_id))]
let log_subscriptions_to_yojson tree =
  list_to_yojson log_subscription_to_yojson tree
...
let list_schema_extensions_result_to_yojson
  (x : list_schema_extensions_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("SchemaExtensionsInfo",
      (option_to_yojson schema_extensions_info_to_yojson
         x.schema_extensions_info))]
let list_schema_extensions_request_to_yojson
  (x : list_schema_extensions_request) =
  assoc_to_yojson
    [("Limit", (option_to_yojson limit_to_yojson x.limit));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("DirectoryId", (Some (directory_id_to_yojson x.directory_id)))]
let list_log_subscriptions_result_to_yojson
  (x : list_log_subscriptions_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("LogSubscriptions",
      (option_to_yojson log_subscriptions_to_yojson x.log_subscriptions))]
let list_log_subscriptions_request_to_yojson
  (x : list_log_subscriptions_request) =
  assoc_to_yojson
    [("Limit", (option_to_yojson limit_to_yojson x.limit));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("DirectoryId", (option_to_yojson directory_id_to_yojson x.directory_id))]
...
let ip_route_info_to_yojson (x : ip_route_info) =
  assoc_to_yojson
    [("Description", (option_to_yojson description_to_yojson x.description));
    ("IpRouteStatusReason",
      (option_to_yojson ip_route_status_reason_to_yojson
         x.ip_route_status_reason));
    ("AddedDateTime",
    ...
    ("DirectoryId", (option_to_yojson directory_id_to_yojson x.directory_id))]
let ip_routes_info_to_yojson tree =
  list_to_yojson ip_route_info_to_yojson tree
...
let certificate_expiry_date_time_to_yojson =
  timestamp_epoch_seconds_to_yojson
let certificate_info_to_yojson (x : certificate_info) =
  assoc_to_yojson
    [("Type", (option_to_yojson certificate_type_to_yojson x.type_));
    ("ExpiryDateTime",
      (option_to_yojson certificate_expiry_date_time_to_yojson
         x.expiry_date_time));
    ...
    ("CertificateId",
      (option_to_yojson certificate_id_to_yojson x.certificate_id))]
let certificates_info_to_yojson tree =
  list_to_yojson certificate_info_to_yojson tree
...
let list_certificates_request_to_yojson (x : list_certificates_request) =
  assoc_to_yojson
    ...
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("DirectoryId", (Some (directory_id_to_yojson x.directory_id)))]
let ldaps_type_to_yojson (x : ldaps_type) =
  match x with | CLIENT -> `String "Client"
...
let ldaps_settings_info_to_yojson tree =
  list_to_yojson ldaps_setting_info_to_yojson tree
...
let directory_limits_to_yojson (x : directory_limits) =
  assoc_to_yojson
    ...
    ("CloudOnlyMicrosoftADCurrentCount",
      (option_to_yojson limit_to_yojson
         x.cloud_only_microsoft_ad_current_count));
    ...
    ("CloudOnlyDirectoriesCurrentCount",
      (option_to_yojson limit_to_yojson
         x.cloud_only_directories_current_count));
...
let entity_already_exists_exception_to_yojson
  (x : entity_already_exists_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let authentication_failed_exception_to_yojson
  (x : authentication_failed_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let enable_client_authentication_request_to_yojson
  (x : enable_client_authentication_request) =
  assoc_to_yojson
...
let domain_controller_to_yojson (x : domain_controller) =
  assoc_to_yojson
    ...
    ("LaunchTime", (option_to_yojson launch_time_to_yojson x.launch_time));
    ("StatusReason",
      (option_to_yojson domain_controller_status_reason_to_yojson
         x.status_reason));
    ("Status",
    ...
    ("DirectoryId", (option_to_yojson directory_id_to_yojson x.directory_id))]
let domain_controllers_to_yojson tree =
...
let describe_shared_directories_result_to_yojson
  (x : describe_shared_directories_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("SharedDirectories",
...
let describe_shared_directories_request_to_yojson
  (x : describe_shared_directories_request) =
  assoc_to_yojson
    [("Limit", (option_to_yojson limit_to_yojson x.limit));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("SharedDirectoryIds",
...
let directory_connect_settings_description_to_yojson
  (x : directory_connect_settings_description) =
  assoc_to_yojson
...
let directory_description_to_yojson (x : directory_description) =
  assoc_to_yojson
    ...
    ("OwnerDirectoryDescription",
      (option_to_yojson owner_directory_description_to_yojson
         x.owner_directory_description));
    ("DesiredNumberOfDomainControllers",
      (option_to_yojson desired_number_of_domain_controllers_to_yojson
         x.desired_number_of_domain_controllers));
    ...
    ("RadiusSettings",
      (option_to_yojson radius_settings_to_yojson x.radius_settings));
    ("ConnectSettings",
      (option_to_yojson directory_connect_settings_description_to_yojson
         x.connect_settings));
    ("VpcSettings",
      (option_to_yojson directory_vpc_settings_description_to_yojson
         x.vpc_settings));
    ...
    ("StageLastUpdatedDateTime",
      (option_to_yojson last_updated_date_time_to_yojson
         x.stage_last_updated_date_time));
    ("LaunchTime", (option_to_yojson launch_time_to_yojson x.launch_time));
    ("ShareNotes", (option_to_yojson notes_to_yojson x.share_notes));
    ("ShareMethod", (option_to_yojson share_method_to_yojson x.share_method));
    ("ShareStatus", (option_to_yojson share_status_to_yojson x.share_status));
    ...
    ("DirectoryId", (option_to_yojson directory_id_to_yojson x.directory_id))]
let directory_descriptions_to_yojson tree =
  list_to_yojson directory_description_to_yojson tree
let describe_directories_result_to_yojson (x : describe_directories_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("DirectoryDescriptions",
      (option_to_yojson directory_descriptions_to_yojson
         x.directory_descriptions))]
...
let conditional_forwarder_to_yojson (x : conditional_forwarder) =
  assoc_to_yojson
    ...
    ("RemoteDomainName",
      (option_to_yojson remote_domain_name_to_yojson x.remote_domain_name))]
let conditional_forwarders_to_yojson tree =
  list_to_yojson conditional_forwarder_to_yojson tree
let describe_conditional_forwarders_result_to_yojson
  (x : describe_conditional_forwarders_result) =
  assoc_to_yojson
    [("ConditionalForwarders",
       (option_to_yojson conditional_forwarders_to_yojson
          x.conditional_forwarders))]
let describe_conditional_forwarders_request_to_yojson
  (x : describe_conditional_forwarders_request) =
  assoc_to_yojson
    [("RemoteDomainNames",
...
let client_authentication_setting_info_to_yojson
  (x : client_authentication_setting_info) =
  assoc_to_yojson
    [("LastUpdatedDateTime",
       (option_to_yojson last_updated_date_time_to_yojson
          x.last_updated_date_time));
...
let certificate_does_not_exist_exception_to_yojson
  (x : certificate_does_not_exist_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
let certificate_state_reason_to_yojson = string_to_yojson
let certificate_registered_date_time_to_yojson =
  timestamp_epoch_seconds_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ExpiryDateTime",
      (option_to_yojson certificate_expiry_date_time_to_yojson
         x.expiry_date_time));
    ("RegisteredDateTime",
      (option_to_yojson certificate_registered_date_time_to_yojson
         x.registered_date_time));
    ("CommonName",
      (option_to_yojson certificate_c_n_to_yojson x.common_name));
    ("StateReason",
...
let create_trust_request_to_yojson (x : create_trust_request) =
  assoc_to_yojson
    ...
    ("ConditionalForwarderIpAddrs",
      (option_to_yojson dns_ip_addrs_to_yojson
         x.conditional_forwarder_ip_addrs));
    ("TrustType", (option_to_yojson trust_type_to_yojson x.trust_type));
...
let directory_limit_exceeded_exception_to_yojson
  (x : directory_limit_exceeded_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let create_computer_result_to_yojson (x : create_computer_result) =
  assoc_to_yojson
    [("Computer", (option_to_yojson computer_to_yojson x.computer))]
...
let create_computer_request_to_yojson (x : create_computer_request) =
  assoc_to_yojson
    ...
    ("OrganizationalUnitDistinguishedName",
      (option_to_yojson organizational_unit_d_n_to_yojson
...
let directory_already_in_region_exception_to_yojson
  (x : directory_already_in_region_exception) =
  assoc_to_yojson
    [("RequestId", (option_to_yojson request_id_to_yojson x.request_id));
    ("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let add_ip_routes_request_to_yojson (x : add_ip_routes_request) =
  assoc_to_yojson
    [("UpdateSecurityGroupForDirectoryControllers",
       (option_to_yojson
          update_security_group_for_directory_controllers_to_yojson
