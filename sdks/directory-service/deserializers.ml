...
let verify_trust_request_of_yojson tree path =
  ...
  let _res : verify_trust_request =
    { trust_id = (value_for_key trust_id_of_yojson "TrustId" _list path) } in
  _res
  ...
  let _res : update_trust_request =
    {
      selective_auth =
        (option_of_yojson
           (value_for_key selective_auth_of_yojson "SelectiveAuth") _list
           path);
...
let update_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "UpdateStatus" value)
  ...
  let _res : radius_settings =
    {
      use_same_username =
        (option_of_yojson
           (value_for_key use_same_username_of_yojson "UseSameUsername")
           _list path);
      display_label =
        (option_of_yojson
           (value_for_key radius_display_label_of_yojson "DisplayLabel")
           _list path);
      ...
      shared_secret =
        (option_of_yojson
           (value_for_key radius_shared_secret_of_yojson "SharedSecret")
           _list path);
      radius_retries =
        (option_of_yojson
           (value_for_key radius_retries_of_yojson "RadiusRetries") _list
           path);
      radius_timeout =
        (option_of_yojson
           (value_for_key radius_timeout_of_yojson "RadiusTimeout") _list
           path);
      radius_port =
  ...
  let _res : update_info_entry =
    {
      ...
      initiated_by =
        (option_of_yojson
           (value_for_key initiated_by_of_yojson "InitiatedBy") _list path);
      status_reason =
        (option_of_yojson
           (value_for_key update_status_reason_of_yojson "StatusReason")
           _list path);
      status =
        (option_of_yojson (value_for_key update_status_of_yojson "Status")
           _list path);
      region =
        (option_of_yojson (value_for_key region_name_of_yojson "Region")
           _list path)
    } in
  _res
  ...
  let _res : trust =
    {
      ...
      created_date_time =
        (option_of_yojson
           (value_for_key created_date_time_of_yojson "CreatedDateTime")
           _list path);
      trust_state =
...
let topic_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ -> raise (deserialize_wrong_type_error path "TopicStatus") : topic_status)
...
let snapshot_type_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String "AUTO" -> AUTO
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "SnapshotType" value)
  ...
  let _res : snapshot =
    {
      ...
      status =
        (option_of_yojson (value_for_key snapshot_status_of_yojson "Status")
           _list path);
      name =
        (option_of_yojson (value_for_key snapshot_name_of_yojson "Name")
           _list path);
      type_ =
        (option_of_yojson (value_for_key snapshot_type_of_yojson "Type")
           _list path);
      snapshot_id =
  ...
  let _res : snapshot_limits =
    {
      ...
      manual_snapshots_current_count =
        (option_of_yojson
           (value_for_key limit_of_yojson "ManualSnapshotsCurrentCount")
           _list path);
...
let share_method_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ -> raise (deserialize_wrong_type_error path "ShareMethod") : share_method)
let share_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ -> raise (deserialize_wrong_type_error path "ShareStatus") : share_status)
  ...
  let _res : shared_directory =
    {
      ...
      share_status =
        (option_of_yojson
           (value_for_key share_status_of_yojson "ShareStatus") _list path);
      shared_directory_id =
        (option_of_yojson
           (value_for_key directory_id_of_yojson "SharedDirectoryId") _list
           path);
...
let register_event_topic_request_of_yojson tree path =
  ...
  let _res : register_event_topic_request =
    {
      topic_name =
        (value_for_key topic_name_of_yojson "TopicName" _list path);
      directory_id =
        (value_for_key directory_id_of_yojson "DirectoryId" _list path)
    } in
  _res
  ...
  let _res : register_certificate_result =
    {
      certificate_id =
        (option_of_yojson
           (value_for_key certificate_id_of_yojson "CertificateId") _list
           path)
    } in
  _res
  ...
  let _res : register_certificate_request =
    {
      ...
      type_ =
        (option_of_yojson (value_for_key certificate_type_of_yojson "Type")
           _list path);
      certificate_data =
        (value_for_key certificate_data_of_yojson "CertificateData" _list
           path);
      directory_id =
        (value_for_key directory_id_of_yojson "DirectoryId" _list path)
    } in
...
let radius_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | `String "CREATING" -> CREATING
   | `String value ->
       raise (deserialize_unknown_enum_value_error path "RadiusStatus" value)
  ...
  let _res : directory_vpc_settings_description =
    {
      ...
      security_group_id =
        (option_of_yojson
           (value_for_key security_group_id_of_yojson "SecurityGroupId")
           _list path);
      subnet_ids =
...
let ldaps_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ -> raise (deserialize_wrong_type_error path "LDAPSStatus") : ldaps_status)
  ...
  let _res : event_topic =
    {
      ...
      created_date_time =
        (option_of_yojson
           ...
           _list path);
      topic_arn =
        (option_of_yojson (value_for_key topic_arn_of_yojson "TopicArn")
           _list path);
      topic_name =
  ...
  let _res : enable_sso_request =
    {
      ...
      user_name =
        (option_of_yojson (value_for_key user_name_of_yojson "UserName")
           _list path);
      directory_id =
        (value_for_key directory_id_of_yojson "DirectoryId" _list path)
    } in
  ...
  let _res : domain_controller =
    {
      ...
      availability_zone =
        (option_of_yojson
           ...
           _list path);
      subnet_id =
        (option_of_yojson (value_for_key subnet_id_of_yojson "SubnetId")
           _list path);
      vpc_id =
        (option_of_yojson (value_for_key vpc_id_of_yojson "VpcId") _list path);
      dns_ip_addr =
  ...
  let _res : describe_trusts_result =
    {
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      trusts =
        (option_of_yojson (value_for_key trusts_of_yojson "Trusts") _list
           path)
    } in
  _res
  ...
  let _res : describe_trusts_request =
    {
      ...
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      trust_ids =
        (option_of_yojson (value_for_key trust_ids_of_yojson "TrustIds")
           _list path);
      directory_id =
        (option_of_yojson
           (value_for_key directory_id_of_yojson "DirectoryId") _list path)
  ...
  let _res : describe_snapshots_request =
    {
      ...
      snapshot_ids =
        (option_of_yojson
           (value_for_key snapshot_ids_of_yojson "SnapshotIds") _list path);
      directory_id =
        (option_of_yojson
           (value_for_key directory_id_of_yojson "DirectoryId") _list path)
    } in
  ...
  let _res : describe_event_topics_result =
    {
      event_topics =
        (option_of_yojson
           (value_for_key event_topics_of_yojson "EventTopics") _list path)
    } in
  _res
  ...
  let _res : directory_description =
    {
      ...
      regions_info =
        (option_of_yojson
           (value_for_key regions_info_of_yojson "RegionsInfo") _list path);
      ...
      stage_reason =
        (option_of_yojson
           (value_for_key stage_reason_of_yojson "StageReason") _list path);
      radius_status =
        (option_of_yojson
           (value_for_key radius_status_of_yojson "RadiusStatus") _list path);
      radius_settings =
...
let client_authentication_status_of_yojson (tree : t) path =
  (match tree with
   ...
   | _ ->
       raise (deserialize_wrong_type_error path "ClientAuthenticationStatus") : 
