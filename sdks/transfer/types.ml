...
type nonrec overwrite_existing = FALSE [@ocaml.doc ""] | TRUE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec web_app_endpoint_type = VPC [@ocaml.doc ""] | PUBLIC [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec web_app_endpoint_policy = STANDARD [@ocaml.doc ""] | FIPS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec home_directory_type = LOGICAL [@ocaml.doc ""] | PATH [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec map_entry = string [@@ocaml.doc ""]

type nonrec map_target = string [@@ocaml.doc ""]

type nonrec map_type = DIRECTORY [@ocaml.doc ""] | FILE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec set_stat_option = ENABLE_NO_OP [@ocaml.doc ""] | DEFAULT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec directory_listing_optimization = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc
...
type nonrec ip_address_type = DUALSTACK [@ocaml.doc ""] | IPV4 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec compression_enum = DISABLED [@ocaml.doc ""] | ZLIB [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec mdn_response = ASYNC [@ocaml.doc ""] | NONE [@ocaml.doc ""] | SYNC [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec as2_connector_secret_id = string [@@ocaml.doc ""]

type nonrec preserve_content_type = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec connectors_ip_address_type = DUALSTACK [@ocaml.doc ""] | IPV4 [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec agreement_status_type = INACTIVE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec preserve_filename_type = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec enforce_message_signing_type = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec custom_http_header = {
  value : custom_http_header_value_type option;
...
type nonrec custom_step_status = FAILURE [@ocaml.doc ""] | SUCCESS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec security_policy_resource_type = CONNECTOR [@ocaml.doc ""] | SERVER [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec security_policy_protocol = FTPS [@ocaml.doc ""] | SFTP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec describe_host_key_request = {
  host_key_id : host_key_id;
      [@ocaml.doc "The identifier of the host key that you want described.\n"]
  server_id : server_id;
      [@ocaml.doc
...
type nonrec profile_type = PARTNER [@ocaml.doc ""] | LOCAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec domain = EFS [@ocaml.doc ""] | S3 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec connector_egress_type = VPC_LATTICE [@ocaml.doc ""] | SERVICE_MANAGED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec describe_agreement_request = {
  server_id : server_id;
      [@ocaml.doc "The server identifier that's associated with the agreement.\n"]
  agreement_id : agreement_id;
      [@ocaml.doc
        "A unique identifier for the agreement. This identifier is returned when you create an \
         agreement.\n"]
...
type nonrec create_workflow_request = {
  ...
  steps : workflow_steps;
      [@ocaml.doc
        ...
        \      "]
  description : workflow_description option; [@ocaml.doc "A textual description for the workflow.\n"]
}
[@@ocaml.doc ""]
