...
type nonrec resource_not_found_exception = {
  scheduled_query_arn : amazon_resource_name option;
...
type nonrec query_pricing_model = COMPUTE_UNITS [@ocaml.doc ""] | BYTES_SCANNED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec compute_mode = PROVISIONED [@ocaml.doc ""] | ON_DEMAND [@ocaml.doc ""]
[@@ocaml.doc ""]
...
and time_series_data_point_list = time_series_data_point list [@@ocaml.doc ""]
...
type nonrec s3_encryption_option = SSE_KMS [@ocaml.doc ""] | SSE_S3 [@ocaml.doc ""]
[@@ocaml.doc ""]
