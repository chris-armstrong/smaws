...
let rec column_info_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
...
let rec datum_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
...
and time_series_data_point_list_of_yojson tree path =
