...
type nonrec uncertainty_range = {
  upper_bound_value : float_;
      [@ocaml.doc " The upper bound value of the area under curve (auc). \n"]
  lower_bound_value : float_; [@ocaml.doc " The lower bound value of the area under curve (auc). \n"]
}
[@@ocaml.doc
...
type nonrec event_ingestion = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec rule_execution_mode = FIRST_MATCHED [@ocaml.doc ""] | ALL_MATCHED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec model_input_data_format = JSON [@ocaml.doc ""] | CSV [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec model_output_data_format = JSONLINES [@ocaml.doc ""] | CSV [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec model_endpoint_status = DISSOCIATED [@ocaml.doc ""] | ASSOCIATED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec get_batch_prediction_jobs_request = {
  ...
  max_results : batch_predictions_max_page_size option;
      [@ocaml.doc "The maximum number of objects to return for the request.\n"]
  job_id : identifier option; [@ocaml.doc "The batch prediction job for which to get the details.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_detector_version_result = {
  ...
  detector_id : identifier option; [@ocaml.doc "The ID for the created version's parent detector.\n"]
}
[@@ocaml.doc ""]
