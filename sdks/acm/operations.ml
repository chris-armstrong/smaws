  ...
  struct
    ...
    let request context (request : add_tags_to_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.AddTagsToCertificate" ~service
        ~context ~input
...
module DeleteCertificate =
  struct
    ...
    let request context (request : delete_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.DeleteCertificate" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DescribeCertificate =
  struct
    ...
    let request context (request : describe_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.DescribeCertificate" ~service
        ~context ~input
...
module ExportCertificate =
  struct
    ...
    let request context (request : export_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.ExportCertificate" ~service ~context
        ~input
...
module GetAccountConfiguration =
  struct
    ...
    let request context (request : Smaws_Lib.Smithy_api.Types.unit_) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.GetAccountConfiguration" ~service
        ~context ~input
...
module GetCertificate =
  struct
    ...
    let request context (request : get_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.GetCertificate" ~service ~context
        ~input
...
module ImportCertificate =
  struct
    ...
    let request context (request : import_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.ImportCertificate" ~service ~context
        ~input
...
module ListCertificates =
  struct
    ...
    let request context (request : list_certificates_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.ListCertificates" ~service ~context
        ~input
...
module ListTagsForCertificate =
  struct
    ...
    let request context (request : list_tags_for_certificate_request) =
      let input =
        Json_serializers.list_tags_for_certificate_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.ListTagsForCertificate" ~service
        ~context ~input
...
module PutAccountConfiguration =
  struct
    ...
    let request context (request : put_account_configuration_request) =
      let input =
        Json_serializers.put_account_configuration_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.PutAccountConfiguration" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
    ...
    let request context (request : remove_tags_from_certificate_request) =
      let input =
        Json_serializers.remove_tags_from_certificate_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.RemoveTagsFromCertificate" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module RenewCertificate =
  struct
    ...
    let request context (request : renew_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.RenewCertificate" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module RequestCertificate =
  struct
    ...
    let request context (request : request_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.RequestCertificate" ~service ~context
        ~input
...
module ResendValidationEmail =
  struct
    ...
    let request context (request : resend_validation_email_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.ResendValidationEmail" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module RevokeCertificate =
  struct
    ...
    let request context (request : revoke_certificate_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.RevokeCertificate" ~service ~context
        ~input
...
module UpdateCertificateOptions =
  struct
    ...
    let request context (request : update_certificate_options_request) =
      let input =
        Json_serializers.update_certificate_options_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"CertificateManager.UpdateCertificateOptions" ~service
        ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end