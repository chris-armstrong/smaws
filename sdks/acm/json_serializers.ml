...
let validation_email_list_to_yojson tree =
...
let request_in_progress_exception_to_yojson
  (x : request_in_progress_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message))]
let request_certificate_response_to_yojson (x : request_certificate_response)
  ...
  assoc_to_yojson
    [("CertificateArn", (option_to_yojson arn_to_yojson x.certificate_arn))]
let domain_list_to_yojson tree =
  list_to_yojson domain_name_string_to_yojson tree
...
let request_certificate_request_to_yojson (x : request_certificate_request) =
  assoc_to_yojson
    ...
    ("DomainValidationOptions",
      (option_to_yojson domain_validation_option_list_to_yojson
...
let domain_validation_to_yojson (x : domain_validation) =
  assoc_to_yojson
    ...
    ("DomainName", (Some (domain_name_string_to_yojson x.domain_name)))]
let domain_validation_list_to_yojson tree =
  list_to_yojson domain_validation_to_yojson tree
let failure_reason_to_yojson (x : failure_reason) =
  ...
  | PCA_NAME_CONSTRAINTS_VALIDATION ->
      `String "PCA_NAME_CONSTRAINTS_VALIDATION"
...
let remove_tags_from_certificate_request_to_yojson
  (x : remove_tags_from_certificate_request) =
  assoc_to_yojson
...
let put_account_configuration_request_to_yojson
  (x : put_account_configuration_request) =
  assoc_to_yojson
    [("IdempotencyToken",
...
let key_usage_names_to_yojson tree =
  list_to_yojson key_usage_name_to_yojson tree
...
let extended_key_usage_names_to_yojson tree =
...
let certificate_summary_to_yojson (x : certificate_summary) =
  assoc_to_yojson
    ...
    ("HasAdditionalSubjectAlternativeNames",
      (option_to_yojson nullable_boolean_to_yojson
         x.has_additional_subject_alternative_names));
    ("SubjectAlternativeNameSummaries",
      (option_to_yojson domain_list_to_yojson
         x.subject_alternative_name_summaries));
    ("DomainName",
...
let list_certificates_response_to_yojson (x : list_certificates_response) =
  assoc_to_yojson
    [("CertificateSummaryList",
       (option_to_yojson certificate_summary_list_to_yojson
          x.certificate_summary_list));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token))]
let certificate_statuses_to_yojson tree =
  list_to_yojson certificate_status_to_yojson tree
let extended_key_usage_filter_list_to_yojson tree =
  list_to_yojson extended_key_usage_name_to_yojson tree
let key_usage_filter_list_to_yojson tree =
  list_to_yojson key_usage_name_to_yojson tree
let key_algorithm_list_to_yojson tree =
...
let filters_to_yojson (x : filters) =
  assoc_to_yojson
    ...
    ("extendedKeyUsage",
      (option_to_yojson extended_key_usage_filter_list_to_yojson
         x.extended_key_usage))]
...
let key_usage_to_yojson (x : key_usage) =
  assoc_to_yojson
    [("Name", (option_to_yojson key_usage_name_to_yojson x.name))]
...
let get_account_configuration_response_to_yojson
  (x : get_account_configuration_response) =
  assoc_to_yojson
    [("ExpiryEvents",
       (option_to_yojson expiry_events_configuration_to_yojson
          x.expiry_events))]
...
let extended_key_usage_list_to_yojson tree =
  list_to_yojson extended_key_usage_to_yojson tree
...
let certificate_detail_to_yojson (x : certificate_detail) =
  assoc_to_yojson
    ...
    ("ExtendedKeyUsages",
      (option_to_yojson extended_key_usage_list_to_yojson
         x.extended_key_usages));
...
let describe_certificate_response_to_yojson
  (x : describe_certificate_response) =
  assoc_to_yojson
    [("Certificate",
...
let add_tags_to_certificate_request_to_yojson
  (x : add_tags_to_certificate_request) =
  assoc_to_yojson
    [("Tags", (Some (tag_list_to_yojson x.tags)));
    ("CertificateArn", (Some (arn_to_yojson x.certificate_arn)))]