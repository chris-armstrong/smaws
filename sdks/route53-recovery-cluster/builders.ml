...
let make_update_routing_control_state_entry
  ...
  ({ routing_control_state = routing_control_state_; routing_control_arn = routing_control_arn_ }
...
let make_list_routing_controls_request ?max_results:(max_results_ : max_results option)
    ?next_token:(next_token_ : page_token option)
    ?control_panel_arn:(control_panel_arn_ : arn option) () =
  ({ max_results = max_results_; next_token = next_token_; control_panel_arn = control_panel_arn_ }
