...
type nonrec tag =
  ...
  value: tag_value_type
    [@ocaml.doc
      "The value for a session tag.\n\n You can pass up to 50 session tags. The plain text session tag values can\226\128\153t exceed 256 characters. For these and additional limits, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-limits.html#reference_iam-limits-entity-length}IAM and STS Character Limits} in the {i IAM User Guide}.\n "];
  key: tag_key_type
    [@ocaml.doc
      "The key for a session tag.\n\n You can pass up to 50 session tags. The plain text session tag keys can\226\128\153t exceed 128 characters. For these and additional limits, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-limits.html#reference_iam-limits-entity-length}IAM and STS Character Limits} in the {i IAM User Guide}.\n "]}
[@@ocaml.doc
  "You can pass custom key-value pair attributes when you assume a role or federate a user. These are called session tags. You can then use the session tags to control access to resources. For more information, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_session-tags.html}Tagging Amazon Web Services STS Sessions} in the {i IAM User Guide}.\n"]
...
type nonrec policy_descriptor_type =
  ...
  arn: arn_type option
    [@ocaml.doc
      "The Amazon Resource Name (ARN) of the IAM managed policy to use as a session policy for the role. For more information about ARNs, see {{:https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html}Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces} in the {i Amazon Web Services General Reference}.\n"]}
[@@ocaml.doc
  "A reference to the IAM managed policy that is passed as a session policy for a role session or a federated user session.\n"]
type nonrec policy_descriptor_list_type = policy_descriptor_type list
[@@ocaml.doc ""]
...
type nonrec region_disabled_exception =
  {
  message: region_disabled_message option [@ocaml.doc ""]}[@@ocaml.doc
                                                            "STS is not activated in the requested region for the account that is being asked to generate credentials. The account administrator must use the IAM console to activate STS in that region. For more information, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html}Activating and Deactivating STS in an Amazon Web Services Region} in the {i IAM User Guide}.\n"]
...
type nonrec packed_policy_too_large_exception =
  {
  message: packed_policy_too_large_message option [@ocaml.doc ""]}[@@ocaml.doc
                                                                    "The request was rejected because the total packed size of the session policies and session tags combined was too large. An Amazon Web Services conversion compresses the session policy document, session policy ARNs, and session tags into a packed binary format that has a separate limit. The error message indicates by percentage how close the policies and tags are to the upper size limit. For more information, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_session-tags.html}Passing Session Tags in STS} in the {i IAM User Guide}.\n\n You could receive this error even though you meet other defined session policy and session tag limits. For more information, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html#reference_iam-limits-entity-length}IAM and STS Entity Character Limits} in the {i IAM User Guide}.\n "]
type nonrec name_qualifier = string[@@ocaml.doc ""]
type nonrec malformed_policy_document_exception =
  {
  message: malformed_policy_document_message option [@ocaml.doc ""]}[@@ocaml.doc
                                                                    "The request was rejected because the policy document was malformed. The error message describes the specific error.\n"]
type nonrec issuer = string[@@ocaml.doc ""]
type nonrec invalid_identity_token_exception =
  {
  message: invalid_identity_token_message option [@ocaml.doc ""]}[@@ocaml.doc
...
type nonrec invalid_authorization_message_exception =
  {
  message: invalid_authorization_message option [@ocaml.doc ""]}[@@ocaml.doc
...
type nonrec idp_rejected_claim_exception =
  {
  message: idp_rejected_claim_message option [@ocaml.doc ""]}[@@ocaml.doc
                                                               "The identity provider (IdP) reported that authentication failed. This might be because the claim is invalid.\n\n If this error is returned for the [AssumeRoleWithWebIdentity] operation, it can also mean that the claim has expired or has been explicitly revoked. \n "]
type nonrec idp_communication_error_exception =
  {
  message: idp_communication_error_message option [@ocaml.doc ""]}[@@ocaml.doc
...
type nonrec federated_user =
  ...
  arn: arn_type
    [@ocaml.doc
      "The ARN that specifies the federated user that is associated with the credentials. For more information about ARNs and how to use them in policies, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html}IAM Identifiers} in the {i IAM User Guide}. \n"];
...
type nonrec get_caller_identity_response =
  ...
  user_id: user_id_type option
    [@ocaml.doc
      "The unique identifier of the calling entity. The exact value depends on the type of entity that is making the call. The values returned are those listed in the {b aws:userid} column in the {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_variables.html#principaltable}Principal table} found on the {b Policy Variables} reference page in the {i IAM User Guide}.\n"]}
[@@ocaml.doc
...
type nonrec expired_token_exception =
  {
  message: expired_identity_token_message option [@ocaml.doc ""]}[@@ocaml.doc
...
type nonrec assumed_role_user =
  ...
  arn: arn_type
    [@ocaml.doc
      "The ARN of the temporary security credentials that are returned from the [AssumeRole] action. For more information about ARNs and how to use them in policies, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html}IAM Identifiers} in the {i IAM User Guide}.\n"];
...
type nonrec assume_root_response =
  ...
  source_identity: source_identity_type option
    [@ocaml.doc
      "The source identity specified by the principal that is calling the [AssumeRoot] operation.\n\n You can use the [aws:SourceIdentity] condition key to control access based on the value of source identity. For more information about using source identity, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_control-access_monitor.html}Monitor and control actions taken with assumed roles} in the {i IAM User Guide}.\n \n  The regex used to validate this parameter is a string of characters consisting of upper- and lower-case alphanumeric characters with no spaces. You can also include underscores or any of the following characters: =,.\\@-\n  "];
  credentials: credentials option
    [@ocaml.doc
...
type nonrec assume_role_with_web_identity_response =
  ...
  source_identity: source_identity_type option
    [@ocaml.doc
      "The value of the source identity that is returned in the JSON web token (JWT) from the identity provider.\n\n You can require users to set a source identity value when they assume a role. You do this by using the [sts:SourceIdentity] condition key in a role trust policy. That way, actions that are taken with the role are associated with that user. After the source identity is set, the value cannot be changed. It is present in the request for all actions that are taken by the role and persists across {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html#id_roles_terms-and-concepts}chained role} sessions. You can configure your identity provider to use an attribute associated with your users, like user name or email, as the source identity when calling [AssumeRoleWithWebIdentity]. You do this by adding a claim to the JSON web token. To learn more about OIDC tokens and claims, see {{:https://docs.aws.amazon.com/cognito/latest/developerguide/amazon-cognito-user-pools-using-tokens-with-identity-providers.html}Using Tokens with User Pools} in the {i Amazon Cognito Developer Guide}. For more information about using source identity, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_control-access_monitor.html}Monitor and control actions taken with assumed roles} in the {i IAM User Guide}.\n \n  The regex used to validate this parameter is a string of characters consisting of upper- and lower-case alphanumeric characters with no spaces. You can also include underscores or any of the following characters: =,.\\@-\n  "];
...
type nonrec assume_role_with_web_identity_request =
  ...
  role_session_name: role_session_name_type
    [@ocaml.doc
      "An identifier for the assumed role session. Typically, you pass the name or identifier that is associated with the user who is using your application. That way, the temporary security credentials that your application will use are associated with that user. This session name is included as part of the ARN and assumed role ID in the [AssumedRoleUser] response element.\n\n For security purposes, administrators can view this field in {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/cloudtrail-integration.html#cloudtrail-integration_signin-tempcreds}CloudTrail logs} to help identify who performed an action in Amazon Web Services. Your administrator might require that you specify your user name as the session name when you assume the role. For more information, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_iam-condition-keys.html#ck_rolesessionname} [sts:RoleSessionName] }.\n \n  The regex used to validate this parameter is a string of characters consisting of upper- and lower-case alphanumeric characters with no spaces. You can also include underscores or any of the following characters: =,.\\@-\n  "];
  role_arn: arn_type
    [@ocaml.doc
      "The Amazon Resource Name (ARN) of the role that the caller is assuming.\n\n  Additional considerations apply to Amazon Cognito identity pools that assume {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies-cross-account-resource-access.html}cross-account IAM roles}. The trust policies of these roles must accept the [cognito-identity.amazonaws.com] service principal and must contain the [cognito-identity.amazonaws.com:aud] condition key to restrict role assumption to users from your intended identity pools. A policy that trusts Amazon Cognito identity pools without this condition creates a risk that a user from an unintended identity pool can assume the role. For more information, see {{:https://docs.aws.amazon.com/cognito/latest/developerguide/iam-roles.html#trust-policies} Trust policies for IAM roles in Basic (Classic) authentication } in the {i Amazon Cognito Developer Guide}.\n  \n   "]}
[@@ocaml.doc ""]
type nonrec assume_role_with_saml_response =
  {
  source_identity: source_identity_type option
    [@ocaml.doc
      "The value in the [SourceIdentity] attribute in the SAML assertion. The source identity value persists across {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html#iam-term-role-chaining}chained role} sessions.\n\n You can require users to set a source identity value when they assume a role. You do this by using the [sts:SourceIdentity] condition key in a role trust policy. That way, actions that are taken with the role are associated with that user. After the source identity is set, the value cannot be changed. It is present in the request for all actions that are taken by the role and persists across {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html#id_roles_terms-and-concepts}chained role} sessions. You can configure your SAML identity provider to use an attribute associated with your users, like user name or email, as the source identity when calling [AssumeRoleWithSAML]. You do this by adding an attribute to the SAML assertion. For more information about using source identity, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_control-access_monitor.html}Monitor and control actions taken with assumed roles} in the {i IAM User Guide}.\n \n  The regex used to validate this parameter is a string of characters consisting of upper- and lower-case alphanumeric characters with no spaces. You can also include underscores or any of the following characters: =,.\\@-\n  "];
...
type nonrec assume_role_with_saml_request =
  ...
  saml_assertion: saml_assertion_type
    [@ocaml.doc
      "The base64 encoded SAML authentication response provided by the IdP.\n\n For more information, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/create-role-saml-IdP-tasks.html}Configuring a Relying Party and Adding Claims} in the {i IAM User Guide}. \n "];
...
type nonrec assume_role_request =
  ...
  source_identity: source_identity_type option
    [@ocaml.doc
      "The source identity specified by the principal that is calling the [AssumeRole] operation. The source identity value persists across {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html#iam-term-role-chaining}chained role} sessions.\n\n You can require users to specify a source identity when they assume a role. You do this by using the {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_condition-keys.html#condition-keys-sourceidentity} [sts:SourceIdentity] } condition key in a role trust policy. You can use source identity information in CloudTrail logs to determine who took actions with a role. You can use the [aws:SourceIdentity] condition key to further control access to Amazon Web Services resources based on the value of source identity. For more information about using source identity, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_control-access_monitor.html}Monitor and control actions taken with assumed roles} in the {i IAM User Guide}.\n \n  The regex used to validate this parameter is a string of characters consisting of upper- and lower-case alphanumeric characters with no spaces. You can also include underscores or any of the following characters: +=,.\\@-. You cannot use a value that begins with the text [aws:]. This prefix is reserved for Amazon Web Services internal use.\n  "];
  token_code: token_code_type option
    [@ocaml.doc
