...
val make_policy_descriptor_type :
  ?arn:arn_type -> unit -> policy_descriptor_type
val make_provided_context :
  ?context_assertion:context_assertion_type ->
    ?provider_arn:arn_type -> unit -> provided_context
...
val make_get_session_token_response :
  ?credentials:credentials -> unit -> get_session_token_response
          ...
          ?assumed_role_user:assumed_role_user ->
            ?subject_from_web_identity_token:web_identity_subject_type ->
              ?credentials:credentials ->
                unit -> assume_role_with_web_identity_response
        ...
        ?provider_id:url_type ->
          web_identity_token:client_token_type ->
            role_session_name:role_session_name_type ->
              role_arn:arn_type ->
                unit -> assume_role_with_web_identity_request
          ...
          ?subject_type:subject_type ->
            ?subject:subject ->
              ?packed_policy_size:non_negative_integer_type ->
                ?assumed_role_user:assumed_role_user ->
                  ?credentials:credentials ->
                    unit -> assume_role_with_saml_response
      ...
      ?policy_arns:policy_descriptor_list_type ->
        saml_assertion:saml_assertion_type ->
          principal_arn:arn_type ->
            role_arn:arn_type -> unit -> assume_role_with_saml_request
val make_assume_role_response :
  ?source_identity:source_identity_type ->
    ?packed_policy_size:non_negative_integer_type ->
      ?assumed_role_user:assumed_role_user ->
        ?credentials:credentials -> unit -> assume_role_response
              ...
              ?tags:tag_list_type ->
                ?duration_seconds:role_duration_seconds_type ->
                  ?policy:unrestricted_session_policy_document_type ->
                    ?policy_arns:policy_descriptor_list_type ->
                      role_session_name:role_session_name_type ->
                        role_arn:arn_type -> unit -> assume_role_request
...
sig
  val error_to_string :
    ...
    | `RegionDisabledException of region_disabled_exception ] -> string
  val request :
    ...
    'http_type Smaws_Lib.Context.t ->
      assume_role_with_saml_request ->
        (assume_role_with_saml_response,
          ...
          | `ExpiredTokenException of expired_token_exception 
          | `IDPRejectedClaimException of idp_rejected_claim_exception 
          | `InvalidIdentityTokenException of
    ...
    'http_type Smaws_Lib.Context.t ->
      assume_role_with_web_identity_request ->
        (assume_role_with_web_identity_response,
          [> Smaws_Lib.Protocols.AwsQuery.error
          | `ExpiredTokenException of expired_token_exception 
          | `IDPCommunicationErrorException of
...
sig
  ...
  val request :
    'http_type Smaws_Lib.Context.t ->
     ...
     "Returns a set of short term credentials you can use to perform privileged tasks on a member account in your organization.\n\n Before you can launch a privileged session, you must have centralized root access in your organization. For steps to enable this feature, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_root-enable-root-access.html}Centralize root access for member accounts} in the {i IAM User Guide}.\n \n   The STS global endpoint is not supported for AssumeRoot. You must send this request to a Regional STS endpoint. For more information, see {{:https://docs.aws.amazon.com/STS/latest/APIReference/welcome.html#sts-endpoints}Endpoints}.\n   \n     You can track AssumeRoot in CloudTrail logs to determine what actions were performed in a session. For more information, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/cloudtrail-track-privileged-tasks.html}Track privileged tasks in CloudTrail} in the {i IAM User Guide}.\n     "]
...
sig
  ...
  val request :
    'http_type Smaws_Lib.Context.t ->
     ...
     "Returns details about the IAM user or role whose credentials are used to call the operation.\n\n  No permissions are required to perform this operation. If an administrator attaches a policy to your identity that explicitly denies access to the [sts:GetCallerIdentity] action, you can still perform this operation. Permissions are not required because the same information is returned when access is denied. To view an example response, see {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/troubleshoot_general.html#troubleshoot_general_access-denied-delete-mfa}I Am Not Authorized to Perform: iam:DeleteVirtualMFADevice} in the {i IAM User Guide}.\n  \n   "]
