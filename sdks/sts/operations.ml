...
module AssumeRole = struct
  ...
  let error_deserializer (error : Smaws_Lib.Protocols.AwsQuery.Error.t) =
    ...
    | "ExpiredTokenException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "MalformedPolicyDocumentException" ->
        Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "PackedPolicyTooLargeException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "RegionDisabledException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
...
module AssumeRoleWithSAML = struct
  ...
  let error_deserializer (error : Smaws_Lib.Protocols.AwsQuery.Error.t) =
    match error.Smaws_Lib.Protocols.AwsQuery.Error.code with
    | "ExpiredTokenException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "IDPRejectedClaimException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "InvalidIdentityTokenException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "MalformedPolicyDocumentException" ->
        Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "PackedPolicyTooLargeException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "RegionDisabledException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
...
module AssumeRoleWithWebIdentity = struct
  ...
  let error_deserializer (error : Smaws_Lib.Protocols.AwsQuery.Error.t) =
    match error.Smaws_Lib.Protocols.AwsQuery.Error.code with
    | "ExpiredTokenException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "IDPCommunicationErrorException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "IDPRejectedClaimException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "InvalidIdentityTokenException" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "MalformedPolicyDocumentException" ->
        Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
