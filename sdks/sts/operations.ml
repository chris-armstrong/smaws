    ...
    let error_deserializer (error : Smaws_Lib.Protocols.AwsQuery.Error.t)
      ...
      | "ExpiredTokenException" ->
          (match Smaws_Lib.Protocols.AwsQuery.Response.parse_error_struct
                   ~body ~structParser:expired_token_exception_of_xml
           with
      ...
      | "RegionDisabledException" ->
          (match Smaws_Lib.Protocols.AwsQuery.Response.parse_error_struct
                   ~body ~structParser:region_disabled_exception_of_xml
           with
...
module AssumeRoleWithSAML =
  struct
    ...
    let error_deserializer (error : Smaws_Lib.Protocols.AwsQuery.Error.t)
      ...
      | "IDPRejectedClaim" ->
          (match Smaws_Lib.Protocols.AwsQuery.Response.parse_error_struct
                   ~body ~structParser:idp_rejected_claim_exception_of_xml
           with
