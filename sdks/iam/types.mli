...
type nonrec server_certificate_metadata = {
  ...
  expiration : date_type option; [@ocaml.doc "The date on which the certificate is set to expire.\n"]
}
[@@ocaml.doc
...
type nonrec assertion_encryption_mode_type = Required [@ocaml.doc ""] | Allowed [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec global_endpoint_token_version = V1Token [@ocaml.doc ""] | V2Token [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec policy_type = INLINE [@ocaml.doc ""] | MANAGED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec policy_scope_type = All [@ocaml.doc ""] | AWS [@ocaml.doc ""] | Local [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec policy_parameter_type_enum = STRING [@ocaml.doc ""] | STRING_LIST [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec encoding_type = SSH [@ocaml.doc ""] | PEM [@ocaml.doc ""] [@@ocaml.doc ""]
