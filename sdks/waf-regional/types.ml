...
type nonrec change_action = INSERT [@ocaml.doc ""] | DELETE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec waf_override_action_type = NONE [@ocaml.doc ""] | COUNT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec regex_match_set_update = {
  action : change_action;
      [@ocaml.doc "Specifies whether to insert or delete a [RegexMatchTuple].\n"]
...
type nonrec ip_set_descriptor_type = IPV4 [@ocaml.doc ""] | IPV6 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec tag = { key : tag_key; [@ocaml.doc "\n"] value : tag_value [@ocaml.doc "\n"] }
[@@ocaml.doc
  " This is {b AWS WAF Classic} documentation. For more information, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/classic-waf-chapter.html}AWS WAF \
   Classic} in the developer guide.\n\
...
[@@ocaml.doc
  "The operation failed because the entity referenced is temporarily unavailable. Retry your \
   request.\n"]

type nonrec get_web_acl_for_resource_response = {
  web_acl_summary : web_acl_summary option;
      [@ocaml.doc
        "Information about the web ACL that you specified in the [GetWebACLForResource] request. \
         If there is no associated resource, a null WebACLSummary is returned.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_web_acl_for_resource_request = {
  resource_arn : resource_arn;
      [@ocaml.doc
        "The ARN (Amazon Resource Name) of the resource for which to get the web ACL, either an \
        ...
        \            {[\n\
        \            arn:aws:apigateway:{i region}::/restapis/{i api-id}/stages/{i stage-name} \n\
        \            ]}\n\
        \             \n\
        \            \n\
        \             }\n\
...
type nonrec associate_web_acl_request = {
  web_acl_id : resource_id; [@ocaml.doc "A unique identifier (ID) for the web ACL. \n"]
  resource_arn : resource_arn;
      [@ocaml.doc
