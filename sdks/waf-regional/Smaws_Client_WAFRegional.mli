(** WAF Regional client library built on EIO. *)
...
val make_xss_match_set_update :
  xss_match_tuple:xss_match_tuple -> action:change_action -> unit -> xss_match_set_update

val make_xss_match_set_summary :
  name:resource_name -> xss_match_set_id:resource_id -> unit -> xss_match_set_summary
...
val make_web_acl_update :
  activated_rule:activated_rule -> action:change_action -> unit -> web_acl_update

val make_web_acl_summary : name:resource_name -> web_acl_id:resource_id -> unit -> web_acl_summary
...
val make_size_constraint_set_update :
  size_constraint:size_constraint -> action:change_action -> unit -> size_constraint_set_update
...
val make_predicate :
  data_id:resource_id -> type_:predicate_type -> negated:negated -> unit -> predicate
...
val make_rule_group_update :
  activated_rule:activated_rule -> action:change_action -> unit -> rule_group_update
...
val make_regex_match_set_update :
  regex_match_tuple:regex_match_tuple -> action:change_action -> unit -> regex_match_set_update
...
val make_ip_set_descriptor :
  value:ip_set_descriptor_value -> type_:ip_set_descriptor_type -> unit -> ip_set_descriptor

val make_ip_set_update :
  ip_set_descriptor:ip_set_descriptor -> action:change_action -> unit -> ip_set_update
...
val make_geo_match_set_update :
  geo_match_constraint:geo_match_constraint -> action:change_action -> unit -> geo_match_set_update
...
val make_byte_match_set_update :
  byte_match_tuple:byte_match_tuple -> action:change_action -> unit -> byte_match_set_update
...
val make_time_window : end_time:timestamp -> start_time:timestamp -> unit -> time_window
...
val make_size_constraint_set_summary :
  name:resource_name -> size_constraint_set_id:resource_id -> unit -> size_constraint_set_summary
...
val make_rule_summary : name:resource_name -> rule_id:resource_id -> unit -> rule_summary

val make_rule_group_summary :
  name:resource_name -> rule_group_id:resource_id -> unit -> rule_group_summary

val make_rule_group :
  ?metric_name:metric_name -> ?name:resource_name -> rule_group_id:resource_id -> unit -> rule_group
...
val make_regex_pattern_set_summary :
  name:resource_name -> regex_pattern_set_id:resource_id -> unit -> regex_pattern_set_summary
...
val make_regex_match_set_summary :
  name:resource_name -> regex_match_set_id:resource_id -> unit -> regex_match_set_summary
...
val make_put_permission_policy_request :
  policy:policy_string -> resource_arn:resource_arn -> unit -> put_permission_policy_request
...
val make_list_xss_match_sets_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_xss_match_sets_request

val make_list_web_ac_ls_response :
  ?web_ac_ls:web_acl_summaries -> ?next_marker:next_marker -> unit -> list_web_ac_ls_response

val make_list_web_ac_ls_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_web_ac_ls_request
...
val make_list_subscribed_rule_groups_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_subscribed_rule_groups_request
...
val make_list_size_constraint_sets_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_size_constraint_sets_request

val make_list_rules_response :
  ?rules:rule_summaries -> ?next_marker:next_marker -> unit -> list_rules_response

val make_list_rules_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_rules_request
...
val make_list_rule_groups_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_rule_groups_request
...
val make_list_regex_pattern_sets_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_regex_pattern_sets_request
...
val make_list_regex_match_sets_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_regex_match_sets_request

val make_list_rate_based_rules_response :
  ?rules:rule_summaries -> ?next_marker:next_marker -> unit -> list_rate_based_rules_response

val make_list_rate_based_rules_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_rate_based_rules_request
...
val make_list_logging_configurations_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_logging_configurations_request

val make_ip_set_summary : name:resource_name -> ip_set_id:resource_id -> unit -> ip_set_summary

val make_list_ip_sets_response :
  ?ip_sets:ip_set_summaries -> ?next_marker:next_marker -> unit -> list_ip_sets_response

val make_list_ip_sets_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_ip_sets_request

val make_geo_match_set_summary :
  name:resource_name -> geo_match_set_id:resource_id -> unit -> geo_match_set_summary
...
val make_list_geo_match_sets_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_geo_match_sets_request

val make_byte_match_set_summary :
  name:resource_name -> byte_match_set_id:resource_id -> unit -> byte_match_set_summary
...
val make_list_byte_match_sets_request :
  ?limit:pagination_limit -> ?next_marker:next_marker -> unit -> list_byte_match_sets_request
...
val make_delete_xss_match_set_request :
  change_token:change_token -> xss_match_set_id:resource_id -> unit -> delete_xss_match_set_request

val make_delete_web_acl_response : ?change_token:change_token -> unit -> delete_web_acl_response

val make_delete_web_acl_request :
  change_token:change_token -> web_acl_id:resource_id -> unit -> delete_web_acl_request
...
val make_delete_rule_request :
  change_token:change_token -> rule_id:resource_id -> unit -> delete_rule_request
...
val make_delete_rule_group_request :
  change_token:change_token -> rule_group_id:resource_id -> unit -> delete_rule_group_request
...
val make_delete_rate_based_rule_request :
  change_token:change_token -> rule_id:resource_id -> unit -> delete_rate_based_rule_request
...
val make_delete_ip_set_request :
  change_token:change_token -> ip_set_id:resource_id -> unit -> delete_ip_set_request
...
val make_delete_geo_match_set_request :
  change_token:change_token -> geo_match_set_id:resource_id -> unit -> delete_geo_match_set_request
...
val make_create_xss_match_set_request :
  change_token:change_token -> name:resource_name -> unit -> create_xss_match_set_request

val make_create_web_acl_response :
  ?change_token:change_token -> ?web_ac_l:web_ac_l -> unit -> create_web_acl_response
...
val make_create_sql_injection_match_set_request :
  change_token:change_token -> name:resource_name -> unit -> create_sql_injection_match_set_request
...
val make_create_size_constraint_set_request :
  change_token:change_token -> name:resource_name -> unit -> create_size_constraint_set_request
...
val make_create_rule_group_response :
  ?change_token:change_token -> ?rule_group:rule_group -> unit -> create_rule_group_response
...
val make_create_regex_pattern_set_request :
  change_token:change_token -> name:resource_name -> unit -> create_regex_pattern_set_request
...
val make_create_regex_match_set_request :
  change_token:change_token -> name:resource_name -> unit -> create_regex_match_set_request

val make_create_rate_based_rule_response :
  ?change_token:change_token -> ?rule:rate_based_rule -> unit -> create_rate_based_rule_response
...
val make_create_ip_set_response :
  ?change_token:change_token -> ?ip_set:ip_set -> unit -> create_ip_set_response

val make_create_ip_set_request :
  change_token:change_token -> name:resource_name -> unit -> create_ip_set_request
...
val make_create_geo_match_set_request :
  change_token:change_token -> name:resource_name -> unit -> create_geo_match_set_request
...
val make_create_byte_match_set_request :
  change_token:change_token -> name:resource_name -> unit -> create_byte_match_set_request

val make_associate_web_acl_response : unit -> unit

val make_associate_web_acl_request :
  resource_arn:resource_arn -> web_acl_id:resource_id -> unit -> associate_web_acl_request
...
[@@ocaml.doc
  " This is {b AWS WAF Classic Regional} documentation. For more information, see \
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Associates a web ACL with a resource, either an application load balancer or Amazon API \
   Gateway stage.\n\
  \    "]
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Creates a [ByteMatchSet]. You then use [UpdateByteMatchSet] to identify the part of a web \
   request that you want AWS WAF to inspect, such as the values of the [User-Agent] header or the \
   query string. For example, you can create a [ByteMatchSet] that matches any requests with \
   [User-Agent] headers that contain the string [BadBot]. You can then configure AWS WAF to reject \
   those requests.\n\
  \    \n\
  ...
  \            {-  Submit an [UpdateByteMatchSet] request to specify the part of the request that \
   you want AWS WAF to inspect (for example, the header or the URI) and the value that you want \
   AWS WAF to watch for.\n\
  \                \n\
  \                 }\n\
  \            }\n\
  \   For more information about how to use the AWS WAF API to allow or block HTTP requests, see \
   the {{:https://docs.aws.amazon.com/waf/latest/developerguide/}AWS WAF Developer Guide}.\n\
  \   "]
...
[@@ocaml.doc
  ...
  \    Creates an [GeoMatchSet], which you use to specify which web requests you want to allow or \
   block based on the country that the requests originate from. For example, if you're receiving a \
   lot of requests from one or more countries and you want to block the requests, you can create \
   an [GeoMatchSet] that contains those countries and then configure AWS WAF to block the \
   requests. \n\
  \    \n\
...
[@@ocaml.doc
  ...
  \    Creates an [IPSet], which you use to specify which web requests that you want to allow or \
   ...
   receiving a lot of requests from one or more individual IP addresses or one or more ranges of \
   IP addresses and you want to block the requests, you can create an [IPSet] that contains those \
...
[@@ocaml.doc
  ...
  \    Creates a [RateBasedRule]. The [RateBasedRule] contains a [RateLimit], which specifies the \
   ...
   other predicates that identify the requests that you want to count or block if these requests \
   exceed the [RateLimit].\n\
  \    \n\
  \     If you add more than one predicate to a [RateBasedRule], a request not only must exceed \
   the [RateLimit], but it also must match all the conditions to be counted or blocked. For \
  ...
  \    You then add the [RateBasedRule] to a [WebACL] and specify that you want to block requests \
   that meet the conditions in the rule. For a request to be blocked, it must come from the IP \
   address 192.0.2.44 {i and} the [User-Agent] header in the request must contain the value \
   [BadBot]. Further, requests that match these two conditions must be received at a rate of more \
   than 1,000 requests every five minutes. If both conditions are met and the rate is exceeded, \
   AWS WAF blocks the requests. If the rate drops below 1,000 for a five-minute period, AWS WAF no \
   longer blocks the requests.\n\
  \    \n\
  \     As a second example, suppose you want to limit requests to a particular page on your site. \
   To do this, you could add the following to a [RateBasedRule]:\n\
  \     \n\
  \      {ul\n\
  ...
  \            {-  Create and update the predicates that you want to include in the rule. For more \
   information, see [CreateByteMatchSet], [CreateIPSet], and [CreateSqlInjectionMatchSet].\n\
  \                \n\
  \                 }\n\
  \            {-  Use [GetChangeToken] to get the change token that you provide in the \
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Creates a [RegexMatchSet]. You then use [UpdateRegexMatchSet] to identify the part of a web \
   request that you want AWS WAF to inspect, such as the values of the [User-Agent] header or the \
   query string. For example, you can create a [RegexMatchSet] that contains a [RegexMatchTuple] \
   that looks for any requests with [User-Agent] headers that match a [RegexPatternSet] with \
   pattern [B\\[a@\\]dB\\[o0\\]t]. You can then configure AWS WAF to reject those requests.\n\
  \    \n\
  ...
  \            {-  Submit an [UpdateRegexMatchSet] request to specify the part of the request that \
   you want AWS WAF to inspect (for example, the header or the URI) and the value, using a \
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Creates a [Rule], which contains the [IPSet] objects, [ByteMatchSet] objects, and other \
   predicates that identify the requests that you want to block. If you add more than one \
   predicate to a [Rule], a request must match all of the specifications to be allowed or blocked. \
  ...
  \   You then add the [Rule] to a [WebACL] and specify that you want to blocks requests that \
   satisfy the [Rule]. For a request to be blocked, it must come from the IP address 192.0.2.44 {i \
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Creates a [RuleGroup]. A rule group is a collection of predefined rules that you add to a \
   web ACL. You use [UpdateRuleGroup] to add rules to the rule group.\n\
  \    \n\
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Creates a [SizeConstraintSet]. You then use [UpdateSizeConstraintSet] to identify the part \
   of a web request that you want AWS WAF to check for length, such as the length of the \
   [User-Agent] header or the length of the query string. For example, you can create a \
   [SizeConstraintSet] that matches any requests that have a query string that is longer than 100 \
  ...
  \            {-  Submit an [UpdateSizeConstraintSet] request to specify the part of the request \
   that you want AWS WAF to inspect (for example, the header or the URI) and the value that you \
...
[@@ocaml.doc
  ...
  \    Creates a [WebACL], which contains the [Rules] that identify the CloudFront web requests \
   that you want to allow, block, or count. AWS WAF evaluates [Rules] in order based on the value \
  ...
  \             {-  Submit an [UpdateWebACL] request to specify the [Rules] that you want to \
   include in the [WebACL], to specify the default action, and to associate the [WebACL] with a \
...
[@@ocaml.doc
  "Creates an AWS CloudFormation WAFV2 template for the specified web ACL in the specified Amazon \
   S3 bucket. Then, in CloudFormation, you create a stack from the template, to create the web ACL \
   and its resources in AWS WAFV2. Use this to migrate your AWS WAF Classic web ACL to the latest \
   version of AWS WAF.\n\n\
  \ This is part of a larger migration procedure for web ACLs from AWS WAF Classic to the latest \
   version of AWS WAF. For the full procedure, including caveats and manual steps to complete the \
   migration and switch over to the new web ACL, see \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-migrating-from-classic.html}Migrating \
   your AWS WAF Classic resources to AWS WAF} in the \
   {{:https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html}AWS WAF Developer \
   Guide}. \n\
  \ "]
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Permanently deletes a [RegexMatchSet]. You can't delete a [RegexMatchSet] if it's still \
   used in any [Rules] or if it still includes any [RegexMatchTuples] objects (any filters).\n\
  \    \n\
...
[@@ocaml.doc
  ...
  \    Permanently deletes a [SizeConstraintSet]. You can't delete a [SizeConstraintSet] if it's \
   still used in any [Rules] or if it still includes any [SizeConstraint] objects (any filters).\n\
  \    \n\
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Removes a web ACL from the specified resource, either an application load balancer or \
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    When you want to create, update, or delete AWS WAF objects, get a change token and include \
   the change token in the create, update, or delete request. Change tokens ensure that your \
  ...
  \     Each create, update, or delete request must use a unique change token. If your application \
   ...
   submitting a create, update, or delete request, the second [GetChangeToken] request returns the \
   same value as the first [GetChangeToken] request.\n\
  \     \n\
  \      When you use a change token in a create, update, or delete request, the status of the \
   change token changes to [PENDING], which indicates that AWS WAF is propagating the change to \
   all AWS WAF servers. Use [GetChangeTokenStatus] to determine the status of your change token.\n\
  \      "]
...
[@@ocaml.doc
  ...
  \           {-   [PROVISIONED]: You requested the change token by calling [GetChangeToken], but \
   you haven't used it yet in a call to create, update, or delete an AWS WAF object.\n\
  \               \n\
  \                }\n\
...
[@@ocaml.doc
  ...
  \    Returns an array of IP addresses currently being blocked by the [RateBasedRule] that is \
   specified by the [RuleId]. The maximum number of managed keys that will be blocked is 10,000. \
   If more than 10,000 addresses exceed the rate limit, the 10,000 addresses with the highest \
...
[@@ocaml.doc
  ...
  \    Gets detailed information about a specified number of requests--a sample--that AWS WAF \
   randomly selects from among the first 5,000 requests that your AWS resource received during a \
   time range that you choose. You can specify a sample size of up to 500 requests, and you can \
  ...
  \      [GetSampledRequests] returns a time range, which is usually the time range that you \
   ...
   range. This new time range indicates the actual period during which AWS WAF selected the \
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Returns the web ACL for the specified resource, either an application load balancer or \
   Amazon API Gateway stage.\n\
  \    "]
...
[@@ocaml.doc
  ...
  \                 Create the data firehose with a PUT source and in the region that you are \
   operating. However, if you are capturing logs for Amazon CloudFront, always create the firehose \
  ...
  \   When you successfully enable logging using a [PutLoggingConfiguration] request, AWS WAF will \
   create a service linked role with the necessary permissions to write logs to the Amazon Kinesis \
   Data Firehose. For more information, see \
...
[@@ocaml.doc
  ...
  \   {b For the latest version of AWS WAF}, use the AWS WAFV2 API and see the \
   ...
   use. \n\
  \  \n\
  \    Attaches an IAM policy to the specified resource. The only supported use for this action is \
   to share a RuleGroup across accounts.\n\
  \    \n\
  ...
  \            {-  The [Action] in the policy must be [waf:UpdateWebACL], \
   [waf-regional:UpdateWebACL], [waf:GetRuleGroup] and [waf-regional:GetRuleGroup] . Any extra or \
   wildcard actions in the policy will be rejected.\n\
  \                \n\
  \                 }\n\
...
[@@ocaml.doc
  ...
  \    Associates tags with the specified AWS resource. Tags are key:value pairs that you can use \
   to categorize and manage your resources, for purposes like billing. For example, you might set \
   the tag key to \"customer\" and the value to the customer name or ID. You can specify one or \
   more tags to add to each AWS resource, up to 50 tags for a resource.\n\
  \    \n\
  \     Tagging is only available through the API, SDKs, and CLI. You can't manage or view tags \
   through the AWS WAF Classic console. You can use this action to tag the AWS resources that you \
...
[@@ocaml.doc
  ...
  \           {-  The bytes (typically a string that corresponds with ASCII characters) that you \
   want AWS WAF to look for. For more information, including how you specify the values for the \
   AWS WAF API and the AWS CLI or SDKs, see [TargetString] in the [ByteMatchTuple] data type. \n\
  \               \n\
  \                }\n\
  ...
  \   For example, you can add a [ByteMatchSetUpdate] object that matches web requests in which \
   [User-Agent] headers contain the string [BadBot]. You can then configure AWS WAF to block those \
   requests.\n\
  \   \n\
  \    To create and configure a [ByteMatchSet], perform the following steps:\n\
  \    \n\
...
[@@ocaml.doc
  ...
  \           {-  The IP address in CIDR notation, for example, [192.0.2.0/24] (for the range of \
   IP addresses from [192.0.2.0] to [192.0.2.255]) or [192.0.2.44/32] (for the individual IP \
   address [192.0.2.44]). \n\
  \               \n\
  \                }\n\
  \           }\n\
  \   AWS WAF supports IPv4 address ranges: /8 and any range between /16 through /32. AWS WAF \
   ...
   CIDR notation, see the Wikipedia entry \
  ...
  \   You use an [IPSet] to specify which web requests you want to allow or block based on the IP \
   addresses that the requests originated from. For example, if you're receiving a lot of requests \
   from one or a small number of IP addresses and you want to block the requests, you can create \
   an [IPSet] that specifies those IP addresses, and then configure AWS WAF to block the requests. \n\
  \   \n\
  \    To create and configure an [IPSet], perform the following steps:\n\
  \    \n\
  \     {ol\n\
  ...
  \   When you update an [IPSet], you specify the IP addresses that you want to add and/or the IP \
   addresses that you want to delete. If you want to change an IP address, you delete the existing \
   IP address and add the new one.\n\
  \   \n\
...
[@@ocaml.doc
  ...
  \     Each [Predicate] object identifies a predicate, such as a [ByteMatchSet] or an [IPSet], \
   that specifies the web requests that you want to block or count. The [RateLimit] specifies the \
  ...
  \   \n\
  \    You then add the [RateBasedRule] to a [WebACL] and specify that you want to block requests \
   that satisfy the rule. For a request to be blocked, it must come from the IP address 192.0.2.44 \
   {i and} the [User-Agent] header in the request must contain the value [BadBot]. Further, \
   requests that match these two conditions much be received at a rate of more than 1,000 every \
   five minutes. If the rate drops below this limit, AWS WAF no longer blocks the requests.\n\
  \    \n\
  \     As a second example, suppose you want to limit requests to a particular page on your site. \
   To do this, you could add the following to a [RateBasedRule]:\n\
  \     \n\
...
[@@ocaml.doc
  ...
  \    For example, you can create a [RegexPatternSet] that matches any requests with [User-Agent] \
   headers that contain the string [B\\[a@\\]dB\\[o0\\]t]. You can then configure AWS WAF to \
  ...
  \                }\n\
  \           {-  Submit an [UpdateRegexMatchSet] request to specify the part of the request that \
   you want AWS WAF to inspect (for example, the header or the URI) and the identifier of the \
...
[@@ocaml.doc
  ...
  \    Inserts or deletes [Predicate] objects in a [Rule]. Each [Predicate] object identifies a \
   ...
   want to allow, block, or count. If you add more than one predicate to a [Rule], a request must \
   match all of the specifications to be allowed, blocked, or counted. For example, suppose that \
  ...
  \   You then add the [Rule] to a [WebACL] and specify that you want to block requests that \
   ...
   contain the value [BadBot] {i and} the request must originate from the IP address 192.0.2.44.\n\
  \   \n\
  \    To create and configure a [Rule], perform the following steps:\n\
  \    \n\
  \     {ol\n\
...
[@@ocaml.doc
  ...
  \           {-  The part of a web request that you want AWS WAF to evaluate, such as the length \
   of a query string or the length of the [User-Agent] header.\n\
  \               \n\
  \                }\n\
  \           {-  Whether to perform any transformations on the request, such as converting it to \
   lowercase, before checking its length. Note that transformations of the request body are not \
   supported because the AWS resource forwards only the first [8192] bytes of your request to AWS \
   WAF.\n\
  \               \n\
  ...
  \                }\n\
  \           }\n\
  \   For example, you can add a [SizeConstraintSetUpdate] object that matches web requests in \
   which the length of the [User-Agent] header is greater than 100 bytes. You can then configure \
...
[@@ocaml.doc
  ...
  \           {-   [Action]: Whether to insert the object into or delete the object from the \
   array. To change a [SqlInjectionMatchTuple], you delete the existing object and add a new one.\n\
  \               \n\
  \                }\n\
  \           {-   [FieldToMatch]: The part of web requests that you want AWS WAF to inspect and, \
   if you want AWS WAF to inspect a header or custom query parameter, the name of the header or \
   parameter.\n\
  \               \n\
  \                }\n\
  ...
  \   You use [SqlInjectionMatchSet] objects to specify which CloudFront requests that you want to \
   allow, block, or count. For example, if you're receiving requests that contain snippets of SQL \
   code in the query string and you want to block the requests, you can create a \
...
[@@ocaml.doc
  ...
  \           {-  A default action for the [WebACL], either [ALLOW] or [BLOCK]. AWS WAF performs \
   the default action if a request doesn't match the criteria in any of the [Rules] in a [WebACL].\n\
  \               \n\
  \                }\n\
  ...
  \           {-  The order in which you want AWS WAF to evaluate the [Rules] in a [WebACL]. If \
   you add more than one [Rule] to a [WebACL], AWS WAF evaluates each request against the [Rules] \
   in order based on the value of [Priority]. (The [Rule] that has the lowest value for [Priority] \
   is evaluated first.) When a web request matches all the predicates (such as [ByteMatchSets] and \
   [IPSets]) in a [Rule], AWS WAF immediately takes the corresponding action, allow or block, and \
   doesn't evaluate the request against the remaining [Rules] in the [WebACL], if any. \n\
  \               \n\
  \                }\n\
  \           }\n\
  \   To create and configure a [WebACL], perform the following steps:\n\
  ...
  \          {-  Submit an [UpdateWebACL] request to specify the [Rules] that you want to include \
   in the [WebACL], to specify the default action, and to associate the [WebACL] with a CloudFront \
   distribution. \n\
  \              \n\
  ...
  \                If you already have a rule group associated with a web ACL and want to submit \
   an [UpdateWebACL] request to exclude certain rules from that rule group, you must first remove \
  ...
  \   Be aware that if you try to add a RATE_BASED rule to a web ACL without setting the rule type \
   when first creating the rule, the [UpdateWebACL] request will fail because the request tries to \
   add a REGULAR rule (the default rule type) with the specified ID, which does not exist. \n\
  \   \n\
  \    For more information about how to use the AWS WAF API to allow or block HTTP requests, see \
   the {{:https://docs.aws.amazon.com/waf/latest/developerguide/}AWS WAF Developer Guide}.\n\
  \    "]
...
[@@ocaml.doc
  ...
  \     {ul\n\
  \           {-   [Action]: Whether to insert the object into or delete the object from the \
   array. To change an [XssMatchTuple], you delete the existing object and add a new one.\n\
  \               \n\
  \                }\n\
  \           {-   [FieldToMatch]: The part of web requests that you want AWS WAF to inspect and, \
   if you want AWS WAF to inspect a header or custom query parameter, the name of the header or \
  ...
  \   You use [XssMatchSet] objects to specify which CloudFront requests that you want to allow, \
   ...
   attacks in the request body and you want to block the requests, you can create an [XssMatchSet] \
