...
let make_list_resources_for_web_acl_request ?resource_type:(resource_type_ : resource_type option)
  ...
  ({ web_acl_id = web_acl_id_; resource_type = resource_type_ }
...
let make_associate_web_acl_request ~web_acl_id:(web_acl_id_ : resource_id)
    ~resource_arn:(resource_arn_ : resource_arn) () =
  ({ web_acl_id = web_acl_id_; resource_arn = resource_arn_ } : associate_web_acl_request)
