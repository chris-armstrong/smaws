...
type nonrec ingress_ip_operator = NOT_CIDR_MATCHES [@ocaml.doc ""] | CIDR_MATCHES [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ingress_ipv6_expression = {
  values : ipv6_cidrs;
      [@ocaml.doc "The right hand side argument of an IPv6 condition expression.\n"]
  operator : ingress_ip_operator;
...
type nonrec ingress_tls_protocol_attribute = TLS1_3 [@ocaml.doc ""] | TLS1_2 [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ingress_boolean_operator = IS_FALSE [@ocaml.doc ""] | IS_TRUE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec accept_action = DENY [@ocaml.doc ""] | ALLOW [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec rule_boolean_operator = IS_FALSE [@ocaml.doc ""] | IS_TRUE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec rule_ip_operator = NOT_CIDR_MATCHES [@ocaml.doc ""] | CIDR_MATCHES [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec rule_verdict_attribute = DKIM [@ocaml.doc ""] | SPF [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec rule_verdict_operator = NOT_EQUALS [@ocaml.doc ""] | EQUALS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec rule_dmarc_operator = NOT_EQUALS [@ocaml.doc ""] | EQUALS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec action_failure_policy = DROP [@ocaml.doc ""] | CONTINUE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec id_or_arn = string [@@ocaml.doc ""]

type nonrec mail_from = PRESERVE [@ocaml.doc ""] | REPLACE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec sns_notification_encoding = BASE64 [@ocaml.doc ""] | UTF_8 [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec sns_notification_payload_type = CONTENT [@ocaml.doc ""] | HEADERS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec lambda_invocation_type = REQUEST_RESPONSE [@ocaml.doc ""] | EVENT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ingress_point_status_to_update = CLOSED [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec trust_store_response_option = INCLUDE [@ocaml.doc ""] | EXCLUDE [@ocaml.doc ""]
...
type nonrec archive_boolean_operator = IS_FALSE [@ocaml.doc ""] | IS_TRUE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ip_type = DUAL_STACK [@ocaml.doc ""] | IPV4 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec import_data_type = JSON [@ocaml.doc ""] | CSV [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec archive_state = PENDING_DELETION [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
