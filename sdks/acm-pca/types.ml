...
type nonrec crl_type = PARTITIONED [@ocaml.doc ""] | COMPLETE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec resource_owner = OTHER_ACCOUNTS [@ocaml.doc ""] | SELF [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec certificate_authority_type = SUBORDINATE [@ocaml.doc ""] | ROOT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec audit_report_response_format = CSV [@ocaml.doc ""] | JSON [@ocaml.doc ""]
[@@ocaml.doc ""]
