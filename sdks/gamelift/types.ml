...
type nonrec acceptance_type = ACCEPT [@ocaml.doc ""] | REJECT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec routing_strategy_type = SIMPLE [@ocaml.doc ""] | TERMINAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec backfill_mode = AUTOMATIC [@ocaml.doc ""] | MANUAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec certificate_type = Disabled [@ocaml.doc ""] | Generated [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec filter_instance_status = ACTIVE [@ocaml.doc ""] | DRAINING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec game_server_utilization_status = AVAILABLE [@ocaml.doc ""] | UTILIZED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec compute_type = EC2 [@ocaml.doc ""] | ANYWHERE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec player_gateway_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec protection_policy = NoProtection [@ocaml.doc ""] | FullProtection [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec container_fleet_billing_type = ON_DEMAND [@ocaml.doc ""] | SPOT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec ip_protocol = TCP [@ocaml.doc ""] | UDP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec container_group_type = GAME_SERVER [@ocaml.doc ""] | PER_INSTANCE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec game_server_ip_protocol_supported = IPv4 [@ocaml.doc ""] | DUAL_STACK [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec fleet_type = OnDemand [@ocaml.doc ""] | Spot [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec player_session_creation_policy = ACCEPT_ALL [@ocaml.doc ""] | DENY_ALL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec flex_match_mode = STANDALONE [@ocaml.doc ""] | WITH_QUEUE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec deployment_impairment_strategy = MAINTAIN [@ocaml.doc ""] | ROLLBACK [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec describe_fleet_port_settings_output = {
  fleet_id : fleet_id option;
      [@ocaml.doc "A unique identifier for the fleet that was requested. \n"]
  fleet_arn : fleet_arn option;
      [@ocaml.doc
        "The Amazon Resource Name \
         ({{:https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html}ARN}) that is \
...
type nonrec policy_type = RuleBased [@ocaml.doc ""] | TargetBased [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec list_scripts_output = {
  scripts : script_list option;
      [@ocaml.doc "A set of properties describing the requested script.\n"]
...
type nonrec location_filter = AWS [@ocaml.doc ""] | CUSTOM [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec list_compute_input_status = ACTIVE [@ocaml.doc ""] | IMPAIRED [@ocaml.doc ""]
[@@ocaml.doc ""]
