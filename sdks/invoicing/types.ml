...
type nonrec tax_authority_status = CANCELLED [@ocaml.doc ""] | ISSUED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec procurement_portal_name = COUPA [@ocaml.doc ""] | SAP_BUSINESS_NETWORK [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec billing_entity = AWS_MARKETPLACE [@ocaml.doc ""] | AWS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec invoice_frequency = RECURRING [@ocaml.doc ""] | ONE_TIME [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec einvoice_delivery_status = NOT_DELIVERED [@ocaml.doc ""] | DELIVERED [@ocaml.doc ""]
[@@ocaml.doc ""]
