...
type nonrec iterator_position = AT_TIP [@ocaml.doc ""] | BEHIND_TIP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type keyspaces_udt_map = (Smaws_Lib.Smithy_api.Types.string_ * keyspaces_cell) list [@@ocaml.doc ""]
...
type nonrec origin_type = USER [@ocaml.doc ""] | REPLICATION [@ocaml.doc ""] | TTL [@ocaml.doc ""]
[@@ocaml.doc ""]
