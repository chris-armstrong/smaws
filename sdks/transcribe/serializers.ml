...
let vocabulary_filters_to_yojson tree =
  list_to_yojson vocabulary_filter_info_to_yojson tree
let vocabulary_filter_method_to_yojson (x : vocabulary_filter_method) =
  match x with
  | TAG -> `String "tag"
  | MASK -> `String "mask"
  | REMOVE -> `String "remove"
let vocabularies_to_yojson tree =
  list_to_yojson vocabulary_info_to_yojson tree
...
let update_vocabulary_request_to_yojson (x : update_vocabulary_request) =
  assoc_to_yojson
    [("DataAccessRoleArn",
       (option_to_yojson data_access_role_arn_to_yojson
          x.data_access_role_arn));
    ("VocabularyFileUri",
...
let update_vocabulary_filter_response_to_yojson
  (x : update_vocabulary_filter_response) =
  assoc_to_yojson
    [("LastModifiedTime",
       (option_to_yojson date_time_to_yojson x.last_modified_time));
    ("LanguageCode",
...
let update_vocabulary_filter_request_to_yojson
  (x : update_vocabulary_filter_request) =
  assoc_to_yojson
    [("DataAccessRoleArn",
       (option_to_yojson data_access_role_arn_to_yojson
          x.data_access_role_arn));
...
let bad_request_exception_to_yojson (x : bad_request_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson failure_reason_to_yojson x.message))]
let conflict_exception_to_yojson (x : conflict_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message))]
let update_medical_vocabulary_response_to_yojson
  (x : update_medical_vocabulary_response) =
  assoc_to_yojson
    [("VocabularyState",
       (option_to_yojson vocabulary_state_to_yojson x.vocabulary_state));
    ("LastModifiedTime",
...
let update_medical_vocabulary_request_to_yojson
  (x : update_medical_vocabulary_request) =
  assoc_to_yojson
...
let participant_role_to_yojson (x : participant_role) =
  match x with | CUSTOMER -> `String "CUSTOMER" | AGENT -> `String "AGENT"
...
let string_target_list_to_yojson tree =
...
let sentiment_value_list_to_yojson tree =
  list_to_yojson sentiment_value_to_yojson tree
...
let rule_to_yojson (x : rule) =
  ...
  | SentimentFilter arg ->
      assoc_to_yojson
        [("SentimentFilter", (Some (sentiment_filter_to_yojson arg)))]
  | TranscriptFilter arg ->
      assoc_to_yojson
        [("TranscriptFilter", (Some (transcript_filter_to_yojson arg)))]
  | InterruptionFilter arg ->
      assoc_to_yojson
        [("InterruptionFilter", (Some (interruption_filter_to_yojson arg)))]
...
let redaction_type_to_yojson (x : redaction_type) =
  match x with | PII -> `String "PII"
...
let pii_entity_types_to_yojson tree =
  list_to_yojson pii_entity_type_to_yojson tree
...
let language_code_item_to_yojson (x : language_code_item) =
  assoc_to_yojson
    ...
    ("LanguageCode",
      (option_to_yojson language_code_to_yojson x.language_code))]
let language_code_list_to_yojson tree =
  list_to_yojson language_code_item_to_yojson tree
let toxicity_category_to_yojson (x : toxicity_category) =
  match x with | ALL -> `String "ALL"
let toxicity_categories_to_yojson tree =
  list_to_yojson toxicity_category_to_yojson tree
...
let toxicity_detection_to_yojson tree =
  list_to_yojson toxicity_detection_settings_to_yojson tree
let transcription_job_summary_to_yojson (x : transcription_job_summary) =
  assoc_to_yojson
    ...
    ("IdentifiedLanguageScore",
      (option_to_yojson identified_language_score_to_yojson
         x.identified_language_score));
    ...
    ("TranscriptionJobStatus",
      (option_to_yojson transcription_job_status_to_yojson
         x.transcription_job_status));
    ("LanguageCode",
      (option_to_yojson language_code_to_yojson x.language_code));
    ("CompletionTime",
...
let subtitle_formats_to_yojson tree =
  list_to_yojson subtitle_format_to_yojson tree
...
let subtitles_output_to_yojson (x : subtitles_output) =
  assoc_to_yojson
    [("OutputStartIndex",
       (option_to_yojson subtitle_output_start_index_to_yojson
          x.output_start_index));
    ("SubtitleFileUris",
...
let transcription_job_to_yojson (x : transcription_job) =
  assoc_to_yojson
    [("ToxicityDetection",
       (option_to_yojson toxicity_detection_to_yojson x.toxicity_detection));
    ("LanguageIdSettings",
      (option_to_yojson language_id_settings_map_to_yojson
         x.language_id_settings));
    ...
    ("JobExecutionSettings",
      (option_to_yojson job_execution_settings_to_yojson
         x.job_execution_settings));
    ("ModelSettings",
      (option_to_yojson model_settings_to_yojson x.model_settings));
    ...
    ("MediaSampleRateHertz",
      (option_to_yojson media_sample_rate_hertz_to_yojson
         x.media_sample_rate_hertz));
    ("LanguageCode",
      (option_to_yojson language_code_to_yojson x.language_code));
    ("TranscriptionJobStatus",
      (option_to_yojson transcription_job_status_to_yojson
...
let start_transcription_job_response_to_yojson
  (x : start_transcription_job_response) =
  assoc_to_yojson
    [("TranscriptionJob",
...
let start_transcription_job_request_to_yojson
  (x : start_transcription_job_request) =
  assoc_to_yojson
    [("ToxicityDetection",
       (option_to_yojson toxicity_detection_to_yojson x.toxicity_detection));
    ("LanguageIdSettings",
    ...
    ("KMSEncryptionContext",
      (option_to_yojson kms_encryption_context_map_to_yojson
         x.kms_encryption_context));
...
let medical_transcription_setting_to_yojson
  (x : medical_transcription_setting) =
  assoc_to_yojson
    [("VocabularyName",
       (option_to_yojson vocabulary_name_to_yojson x.vocabulary_name));
    ("MaxAlternatives",
...
let medical_content_identification_type_to_yojson
  (x : medical_content_identification_type) =
  match x with | PHI -> `String "PHI"
let specialty_to_yojson (x : specialty) =
  match x with | PRIMARYCARE -> `String "PRIMARYCARE"
let medical_transcription_job_to_yojson (x : medical_transcription_job) =
  assoc_to_yojson
    ...
    ("ContentIdentificationType",
      (option_to_yojson medical_content_identification_type_to_yojson
         x.content_identification_type));
    ("Settings",
    ...
    ("MediaFormat", (option_to_yojson media_format_to_yojson x.media_format));
    ("MediaSampleRateHertz",
      (option_to_yojson medical_media_sample_rate_hertz_to_yojson
         x.media_sample_rate_hertz));
    ("LanguageCode",
      (option_to_yojson language_code_to_yojson x.language_code));
    ("TranscriptionJobStatus",
...
let start_medical_transcription_job_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("MedicalTranscriptionJobName",
      (Some
         (transcription_job_name_to_yojson x.medical_transcription_job_name)))]
...
let medical_scribe_job_to_yojson (x : medical_scribe_job) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("ChannelDefinitions",
      (option_to_yojson medical_scribe_channel_definitions_to_yojson
         x.channel_definitions));
    ("DataAccessRoleArn",
    ...
    ("StartTime", (option_to_yojson date_time_to_yojson x.start_time));
    ("MedicalScribeOutput",
      (option_to_yojson medical_scribe_output_to_yojson
         x.medical_scribe_output));
    ("Media", (option_to_yojson media_to_yojson x.media));
    ("LanguageCode",
      (option_to_yojson medical_scribe_language_code_to_yojson
         x.language_code));
    ("MedicalScribeJobStatus",
      (option_to_yojson medical_scribe_job_status_to_yojson
         x.medical_scribe_job_status));
    ("MedicalScribeJobName",
      (option_to_yojson transcription_job_name_to_yojson
         x.medical_scribe_job_name))]
let start_medical_scribe_job_response_to_yojson
  (x : start_medical_scribe_job_response) =
  assoc_to_yojson
    [("MedicalScribeJob",
       (option_to_yojson medical_scribe_job_to_yojson x.medical_scribe_job))]
let start_medical_scribe_job_request_to_yojson
  (x : start_medical_scribe_job_request) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("ChannelDefinitions",
      (option_to_yojson medical_scribe_channel_definitions_to_yojson
...
let call_analytics_skipped_reason_code_to_yojson
  (x : call_analytics_skipped_reason_code) =
  match x with
...
let call_analytics_skipped_feature_to_yojson
  (x : call_analytics_skipped_feature) =
  assoc_to_yojson
    [("Message", (option_to_yojson string__to_yojson x.message));
    ("ReasonCode",
      (option_to_yojson call_analytics_skipped_reason_code_to_yojson
         x.reason_code));
    ("Feature",
...
let call_analytics_job_details_to_yojson (x : call_analytics_job_details) =
  assoc_to_yojson
    [("Skipped",
       (option_to_yojson call_analytics_skipped_feature_list_to_yojson
          x.skipped))]
...
let channel_definitions_to_yojson tree =
...
let call_analytics_job_to_yojson (x : call_analytics_job) =
  assoc_to_yojson
    ...
    ("CallAnalyticsJobDetails",
      (option_to_yojson call_analytics_job_details_to_yojson
         x.call_analytics_job_details));
    ("CallAnalyticsJobStatus",
      (option_to_yojson call_analytics_job_status_to_yojson
         x.call_analytics_job_status));
    ("CallAnalyticsJobName",
      (option_to_yojson call_analytics_job_name_to_yojson
         x.call_analytics_job_name))]
let start_call_analytics_job_response_to_yojson
  (x : start_call_analytics_job_response) =
  assoc_to_yojson
    [("CallAnalyticsJob",
       (option_to_yojson call_analytics_job_to_yojson x.call_analytics_job))]
let start_call_analytics_job_request_to_yojson
  (x : start_call_analytics_job_request) =
  assoc_to_yojson
    [("ChannelDefinitions",
       (option_to_yojson channel_definitions_to_yojson x.channel_definitions));
    ("Tags", (option_to_yojson tag_list_to_yojson x.tags));
...
let list_vocabulary_filters_response_to_yojson
  (x : list_vocabulary_filters_response) =
  assoc_to_yojson
    [("VocabularyFilters",
...
let list_vocabulary_filters_request_to_yojson
  (x : list_vocabulary_filters_request) =
  assoc_to_yojson
    [("NameContains",
...
let list_transcription_jobs_response_to_yojson
  (x : list_transcription_jobs_response) =
  assoc_to_yojson
    [("TranscriptionJobSummaries",
       (option_to_yojson transcription_job_summaries_to_yojson
          x.transcription_job_summaries));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Status",
      (option_to_yojson transcription_job_status_to_yojson x.status))]
let list_transcription_jobs_request_to_yojson
  (x : list_transcription_jobs_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("JobNameContains",
...
let list_medical_vocabularies_response_to_yojson
  (x : list_medical_vocabularies_response) =
  assoc_to_yojson
    [("Vocabularies",
       (option_to_yojson vocabularies_to_yojson x.vocabularies));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let list_medical_vocabularies_request_to_yojson
  (x : list_medical_vocabularies_request) =
  assoc_to_yojson
    [("NameContains",
       (option_to_yojson vocabulary_name_to_yojson x.name_contains));
    ("StateEquals",
...
let medical_transcription_job_summary_to_yojson
  (x : medical_transcription_job_summary) =
  assoc_to_yojson
    [("Type", (option_to_yojson type__to_yojson x.type_));
    ("ContentIdentificationType",
      (option_to_yojson medical_content_identification_type_to_yojson
...
let list_medical_transcription_jobs_request_to_yojson
  (x : list_medical_transcription_jobs_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("JobNameContains",
...
let list_medical_scribe_jobs_response_to_yojson
  (x : list_medical_scribe_jobs_response) =
  assoc_to_yojson
    [("MedicalScribeJobSummaries",
       (option_to_yojson medical_scribe_job_summaries_to_yojson
          x.medical_scribe_job_summaries));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Status",
      (option_to_yojson medical_scribe_job_status_to_yojson x.status))]
let list_medical_scribe_jobs_request_to_yojson
  (x : list_medical_scribe_jobs_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("JobNameContains",
...
let list_language_models_response_to_yojson
  (x : list_language_models_response) =
  assoc_to_yojson
...
let list_call_analytics_jobs_response_to_yojson
  (x : list_call_analytics_jobs_response) =
  assoc_to_yojson
    [("CallAnalyticsJobSummaries",
       (option_to_yojson call_analytics_job_summaries_to_yojson
          x.call_analytics_job_summaries));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Status",
      (option_to_yojson call_analytics_job_status_to_yojson x.status))]
let list_call_analytics_jobs_request_to_yojson
  (x : list_call_analytics_jobs_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("JobNameContains",
...
let get_vocabulary_filter_request_to_yojson
  (x : get_vocabulary_filter_request) =
  assoc_to_yojson
    [("VocabularyFilterName",
       (Some (vocabulary_filter_name_to_yojson x.vocabulary_filter_name)))]
...
let get_transcription_job_response_to_yojson
  (x : get_transcription_job_response) =
  assoc_to_yojson
    [("TranscriptionJob",
       (option_to_yojson transcription_job_to_yojson x.transcription_job))]
let get_transcription_job_request_to_yojson
  (x : get_transcription_job_request) =
  assoc_to_yojson
    [("TranscriptionJobName",
       (Some (transcription_job_name_to_yojson x.transcription_job_name)))]
let get_medical_vocabulary_response_to_yojson
  (x : get_medical_vocabulary_response) =
  assoc_to_yojson
    [("DownloadUri", (option_to_yojson uri_to_yojson x.download_uri));
    ("FailureReason",
      (option_to_yojson failure_reason_to_yojson x.failure_reason));
...
let delete_transcription_job_request_to_yojson
  (x : delete_transcription_job_request) =
  assoc_to_yojson
    [("TranscriptionJobName",
       (Some (transcription_job_name_to_yojson x.transcription_job_name)))]
let delete_medical_vocabulary_request_to_yojson
  (x : delete_medical_vocabulary_request) =
  assoc_to_yojson
    [("VocabularyName", (Some (vocabulary_name_to_yojson x.vocabulary_name)))]
...
let delete_medical_scribe_job_request_to_yojson
  (x : delete_medical_scribe_job_request) =
  assoc_to_yojson
    [("MedicalScribeJobName",
       (Some (transcription_job_name_to_yojson x.medical_scribe_job_name)))]
...
let create_vocabulary_filter_response_to_yojson
  (x : create_vocabulary_filter_response) =
  assoc_to_yojson
    [("LastModifiedTime",
       (option_to_yojson date_time_to_yojson x.last_modified_time));
    ("LanguageCode",
...
let create_vocabulary_filter_request_to_yojson
  (x : create_vocabulary_filter_request) =
  assoc_to_yojson
    [("DataAccessRoleArn",
       (option_to_yojson data_access_role_arn_to_yojson
          x.data_access_role_arn));
...
let create_medical_vocabulary_response_to_yojson
  (x : create_medical_vocabulary_response) =
  assoc_to_yojson
    [("FailureReason",
       (option_to_yojson failure_reason_to_yojson x.failure_reason));
    ("LastModifiedTime",
...
let create_medical_vocabulary_request_to_yojson
  (x : create_medical_vocabulary_request) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("VocabularyFileUri", (Some (uri_to_yojson x.vocabulary_file_uri)));
    ("LanguageCode", (Some (language_code_to_yojson x.language_code)));
...
let create_language_model_response_to_yojson
  (x : create_language_model_response) =
  assoc_to_yojson
    [("ModelStatus",
...
let create_language_model_request_to_yojson
  (x : create_language_model_request) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("InputDataConfig",
...
let create_call_analytics_category_response_to_yojson
  (x : create_call_analytics_category_response) =
  assoc_to_yojson
    [("CategoryProperties",
       (option_to_yojson category_properties_to_yojson x.category_properties))]
