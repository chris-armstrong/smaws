...
val make_untag_resource_request :
  tag_keys:tag_key_list -> resource_arn:transcribe_arn -> unit -> untag_resource_request
...
val make_media : ?redacted_media_file_uri:uri -> ?media_file_uri:uri -> unit -> media

val make_transcript :
  ?redacted_transcript_file_uri:uri -> ?transcript_file_uri:uri -> unit -> transcript
...
val make_tag_resource_request :
  tags:tag_list -> resource_arn:transcribe_arn -> unit -> tag_resource_request

val make_start_transcription_job_response :
  ?transcription_job:transcription_job -> unit -> start_transcription_job_response

val make_subtitles :
  ?output_start_index:subtitle_output_start_index -> ?formats:subtitle_formats -> unit -> subtitles
...
val make_medical_scribe_output :
  clinical_document_uri:uri -> transcript_file_uri:uri -> unit -> medical_scribe_output
...
val make_channel_definition :
  ?participant_role:participant_role -> ?channel_id:channel_id -> unit -> channel_definition
...
val make_list_tags_for_resource_response :
  ?tags:tag_list -> ?resource_arn:transcribe_arn -> unit -> list_tags_for_resource_response
...
val make_list_language_models_response :
  ?models:models -> ?next_token:next_token -> unit -> list_language_models_response
