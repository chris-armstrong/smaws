  ...
  vocabulary_state : vocabulary_state option;
      [@ocaml.doc
        "The processing state of your custom vocabulary. If the state is [READY], you can use the \
         custom vocabulary in a [StartTranscriptionJob] request.\n"]
  ...
  language_code : language_code option;
      [@ocaml.doc
        ...
        \ A custom vocabulary can only be used to transcribe files in the same language as the \
         ...
         ([en-US]), you can only apply this custom vocabulary to files that contain English audio.\n\
        \ "]
...
[@@ocaml.doc
  "Provides information about a custom vocabulary filter, including the language of the filter, \
...
type nonrec update_vocabulary_response = {
  ...
  last_modified_time : date_time option;
      [@ocaml.doc
        ...
        \ "]
  language_code : language_code option;
      [@ocaml.doc "The language code you selected for your custom vocabulary.\n"]
  vocabulary_name : vocabulary_name option;
...
type nonrec update_vocabulary_request = {
  data_access_role_arn : data_access_role_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of an IAM role that has permissions to access the Amazon \
         S3 bucket that contains your input files (in this case, your custom vocabulary). If the \
         role that you specify doesn\226\128\153t have the appropriate permissions to access the \
  ...
  vocabulary_file_uri : uri option;
      [@ocaml.doc
        "The Amazon S3 location of the text file that contains your custom vocabulary. The URI \
  ...
  phrases : phrases option;
      [@ocaml.doc
        "Use this parameter if you want to update your custom vocabulary by including all desired \
         terms, as comma-separated values, within your request. The other option for updating your \
         custom vocabulary is to save your entries in a text file and upload them to an Amazon S3 \
         bucket, then specify the location of your file using the [VocabularyFileUri] parameter.\n\n\
        ...
        \  Each language has a character set that contains all allowed characters for that \
         ...
         request fails. Refer to \
         {{:https://docs.aws.amazon.com/transcribe/latest/dg/charsets.html}Character Sets for \
  ...
  vocabulary_name : vocabulary_name;
      [@ocaml.doc
        "The name of the custom vocabulary you want to update. Custom vocabulary names are case \
         sensitive.\n"]
}
[@@ocaml.doc ""]
...
type nonrec update_vocabulary_filter_response = {
  last_modified_time : date_time option;
      [@ocaml.doc
        ...
        \ "]
  language_code : language_code option;
      [@ocaml.doc "The language code you selected for your custom vocabulary filter.\n"]
  vocabulary_filter_name : vocabulary_filter_name option;
...
type nonrec update_vocabulary_filter_request = {
  data_access_role_arn : data_access_role_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of an IAM role that has permissions to access the Amazon \
         ...
         If the role that you specify doesn\226\128\153t have the appropriate permissions to \
  ...
  words : words option;
      [@ocaml.doc
        "Use this parameter if you want to update your custom vocabulary filter by including all \
...
type nonrec internal_failure_exception = { message : string_ option [@ocaml.doc ""] }
[@@ocaml.doc
  "There was an internal error. Check the error message, correct the issue, and try your request \
   again.\n"]

type nonrec failure_reason = string [@@ocaml.doc ""]

type nonrec bad_request_exception = { message : failure_reason option [@ocaml.doc ""] }
[@@ocaml.doc
  "Your request didn't pass one or more validation tests. This can occur when the entity you're \
   trying to delete doesn't exist or if it's in a non-terminal state (such as [IN PROGRESS]). See \
...
type nonrec update_medical_vocabulary_response = {
  vocabulary_state : vocabulary_state option;
      [@ocaml.doc
        "The processing state of your custom medical vocabulary. If the state is [READY], you can \
         use the custom vocabulary in a [StartMedicalTranscriptionJob] request.\n"]
  last_modified_time : date_time option;
      [@ocaml.doc
...
type nonrec update_medical_vocabulary_request = {
  vocabulary_file_uri : uri;
      [@ocaml.doc
        "The Amazon S3 location of the text file that contains your custom medical vocabulary. The \
  ...
  language_code : language_code;
      [@ocaml.doc
        "The language code that represents the language of the entries in the custom vocabulary \
         you want to update. US English ([en-US]) is the only language supported with Amazon \
         Transcribe Medical.\n"]
  vocabulary_name : vocabulary_name;
      [@ocaml.doc
  ...
  end_time : timestamp_milliseconds option;
      [@ocaml.doc
        "The time, in milliseconds, when Amazon Transcribe stops searching for the specified \
         criteria in your audio. If you include [EndTime] in your request, you must also include \
         [StartTime].\n"]
  start_time : timestamp_milliseconds option;
      [@ocaml.doc
        "The time, in milliseconds, when Amazon Transcribe starts searching for the specified \
         criteria in your audio. If you include [StartTime] in your request, you must also include \
         [EndTime].\n"]
}
[@@ocaml.doc
  ...
  \ You can use [StartTime] and [EndTime] to search a custom segment. For example, setting \
   ...
   audio contained between the 10,000 millisecond mark and the 50,000 millisecond mark of your \
   media file. You must use [StartTime] and [EndTime] as a set; that is, if you include one, you \
   must include both.\n\
  \ \n\
  \  You can use also [First] to search from the start of the audio until the time that you \
   specify, or [Last] to search from the time that you specify until the end of the audio. For \
   example, setting [First] to 50000 only searches for your specified criteria in the audio \
   contained between the start of the media file to the 50,000 millisecond mark. You can use \
  ...
  end_percentage : percentage option;
      [@ocaml.doc
        "The time, in percentage, when Amazon Transcribe stops searching for the specified \
         criteria in your media file. If you include [EndPercentage] in your request, you must \
         also include [StartPercentage].\n"]
  start_percentage : percentage option;
      [@ocaml.doc
        "The time, in percentage, when Amazon Transcribe starts searching for the specified \
         criteria in your media file. If you include [StartPercentage] in your request, you must \
         also include [EndPercentage].\n"]
}
[@@ocaml.doc
  ...
  \ You can use [StartPercentage] and [EndPercentage] to search a custom segment. For example, \
   ...
   criteria in the audio contained between the 10 percent mark and the 50 percent mark of your \
   media file.\n\
  \ \n\
  \  You can use also [First] to search from the start of the media file until the time that you \
   specify. Or use [Last] to search from the time that you specify until the end of the media \
   file. For example, setting [First] to 10 only searches for your specified criteria in the audio \
...
type nonrec non_talk_time_filter = {
  ...
  absolute_time_range : absolute_time_range option;
      [@ocaml.doc
        "Makes it possible to specify a time range (in milliseconds) in your audio, during which \
...
type nonrec participant_role = CUSTOMER [@ocaml.doc ""] | AGENT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec interruption_filter = {
  ...
  participant_role : participant_role option;
      [@ocaml.doc
        "Specify the interrupter that you want to flag. Omitting this parameter is equivalent to \
...
type nonrec transcript_filter_type = EXACT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec transcript_filter = {
  targets : string_target_list; [@ocaml.doc "Specify the phrases that you want to flag.\n"]
  negate : boolean_ option;
      [@ocaml.doc
        "Set to [TRUE] to flag the absence of the phrase that you specified in your request. Set \
         to [FALSE] to flag the presence of the phrase that you specified in your request.\n"]
  participant_role : participant_role option;
      [@ocaml.doc
        "Specify the participant that you want to flag. Omitting this parameter is equivalent to \
         specifying both participants.\n"]
  relative_time_range : relative_time_range option;
      [@ocaml.doc
        "Makes it possible to specify a time range (in percentage) in your media file, during \
  ...
  transcript_filter_type : transcript_filter_type;
      [@ocaml.doc
        "Flag the presence or absence of an exact match to the phrases that you specify. For \
         example, if you specify the phrase \"speak to a manager\" as your [Targets] value, only \
         that exact phrase is flagged.\n\n\
        \ Note that semantic matching is not supported. For example, if your customer says \"speak \
         to {i the} manager\", instead of \"speak to {i a} manager\", your content is not flagged.\n\
        \ "]
}
[@@ocaml.doc
...
type nonrec sentiment_filter = {
  ...
  sentiments : sentiment_value_list; [@ocaml.doc "Specify the sentiments that you want to flag.\n"]
}
[@@ocaml.doc
  ...
  \ \n\
  \  {ul\n\
  \        {-  The presence or absence of a positive sentiment felt by the customer, agent, or \
   both at specified points in the call\n\
  \            \n\
  \             }\n\
  \        {-  The presence or absence of a negative sentiment felt by the customer, agent, or \
   both at specified points in the call\n\
  \            \n\
  \             }\n\
  ...
  \            \n\
  \             }\n\
  \        {-  The presence or absence of a mixed sentiment felt by the customer, the agent, or \
   both at specified points in the call\n\
  \            \n\
  \             }\n\
  \        }\n\
  ...
  | NonTalkTimeFilter of non_talk_time_filter
      [@ocaml.doc
        "Flag the presence or absence of periods of silence in your Call Analytics transcription \
         output. Refer to for more detail.\n"]
[@@ocaml.doc
  "A rule is a set of criteria that you can specify to flag an attribute in your Call Analytics \
...
type nonrec tag = {
  value : tag_value;
      [@ocaml.doc
        ...
        \ Note that you can set the value of a tag to an empty string, but you can't set the value \
         of a tag to null. Omitting the tag value is the same as using an empty string.\n\
        \ "]
  key : tag_key;
      [@ocaml.doc
...
[@@ocaml.doc
  ...
  \ For example, you could add the tag [Department:Sales] to a resource to indicate that it \
   pertains to your organization's sales department. You can also use tags for tag-based access \
   control.\n\
  \ \n\
...
type nonrec input_type = POST_CALL [@ocaml.doc ""] | REAL_TIME [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec category_properties = {
  input_type : input_type option;
      [@ocaml.doc
        "The input type associated with the specified category. [POST_CALL] refers to a category \
         that is applied to batch transcriptions; [REAL_TIME] refers to a category that is applied \
  ...
  rules : rule_list option;
      [@ocaml.doc
        "The rules used to define a Call Analytics category. Each category can have between 1 and \
         20 rules.\n"]
...
[@@ocaml.doc
  "Provides you with the properties of the Call Analytics category you specified in your request. \
   This includes the list of rules that define the specified category.\n"]
...
type nonrec update_call_analytics_category_request = {
  input_type : input_type option;
      [@ocaml.doc
        "Choose whether you want to update a real-time or a post-call category. The input type you \
         specify must match the input type specified when the category was created. For example, \
         if you created a category with the [POST_CALL] input type, you must use [POST_CALL] as \
...
type nonrec untag_resource_request = {
  tag_keys : tag_key_list;
      [@ocaml.doc "Removes the specified tag keys from the specified Amazon Transcribe resource.\n"]
...
type nonrec type_ = DICTATION [@ocaml.doc ""] | CONVERSATION [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec redaction_type = PII [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec redaction_output = REDACTED_AND_UNREDACTED [@ocaml.doc ""] | REDACTED [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  pii_entity_types : pii_entity_types option;
      [@ocaml.doc
        "Specify which types of personally identifiable information (PII) you want to redact in \
         your transcript. You can include as many types as you'd like, or you can select [ALL]. If \
  ...
  redaction_type : redaction_type;
      [@ocaml.doc
        "Specify the category of information you want to redact; [PII] (personally identifiable \
         information) is the only valid value. You can use [PiiEntityTypes] to choose which types \
         of PII you want to redact. If you do not include [PiiEntityTypes] in your request, all \
         PII is redacted.\n"]
}
[@@ocaml.doc
  "Makes it possible to redact or flag specified personally identifiable information (PII) in your \
   transcript. If you use [ContentRedaction], you must also include the sub-parameters: \
   [RedactionOutput] and [RedactionType]. You can optionally include [PiiEntityTypes] to choose \
...
[@@ocaml.doc
  "Provides the name of the custom language model that was included in the specified transcription \
   job.\n\n\
  \ Only use [ModelSettings] with the [LanguageModelName] sub-parameter if you're {b not} using \
   automatic language identification (). If using [LanguageIdSettings] in your request, this \
   parameter contains a [LanguageModelName] sub-parameter.\n\
  \ "]
...
type nonrec language_code_item = {
  ...
  language_code : language_code option;
      [@ocaml.doc "Provides the language code for each language identified in your media.\n"]
}
[@@ocaml.doc
  "Provides information on the speech contained in a discreet utterance when multi-language \
   identification is enabled in your request. This utterance represents a block of speech \
   consisting of one language, preceded or followed by a block of speech in a different language.\n"]

type nonrec language_code_list = language_code_item list [@@ocaml.doc ""]

type nonrec toxicity_category = ALL [@ocaml.doc ""] [@@ocaml.doc ""]
...
[@@ocaml.doc
  "Contains [ToxicityCategories], which is a required parameter if you want to enable toxicity \
   detection ([ToxicityDetection]) in your transcription request.\n"]
...
type nonrec transcription_job_summary = {
  ...
  identify_multiple_languages : boolean_ option;
      [@ocaml.doc
        "Indicates whether automatic multi-language identification was enabled ([TRUE]) for the \
  ...
  output_location_type : output_location_type option;
      [@ocaml.doc
        ...
        \ If the value is [CUSTOMER_BUCKET], the location is the Amazon S3 bucket you specified \
         using the [OutputBucketName] parameter in your request. If you also included [OutputKey] \
         in your request, your output is located in the path you specified in your request.\n\
        \ \n\
        \  If the value is [SERVICE_BUCKET], the location is a service-managed Amazon S3 bucket. \
  ...
  failure_reason : failure_reason option;
      [@ocaml.doc
        "If [TranscriptionJobStatus] is [FAILED], [FailureReason] contains information about why \
         the transcription job failed. See also: \
  ...
  transcription_job_status : transcription_job_status option;
      [@ocaml.doc
        ...
        \ If the status is [COMPLETED], the job is finished and you can find the results at the \
         location specified in [TranscriptFileUri] (or [RedactedTranscriptFileUri], if you \
         requested transcript redaction). If the status is [FAILED], [FailureReason] provides \
  ...
  transcription_job_name : transcription_job_name option;
      [@ocaml.doc
        "The name of the transcription job. Job names are case sensitive and must be unique within \
         an Amazon Web Services account.\n"]
}
[@@ocaml.doc "Provides detailed information about a specific transcription job.\n"]

type nonrec transcription_job_summaries = transcription_job_summary list [@@ocaml.doc ""]
...
[@@ocaml.doc
  ...
  \ For information on supported media formats, refer to the [MediaFormat] parameter or the \
...
type nonrec transcript = {
  redacted_transcript_file_uri : uri option;
      [@ocaml.doc
        "The Amazon S3 location of your redacted transcript. You can use this URI to access or \
         download your transcript.\n\n\
        \ If you included [OutputBucketName] in your transcription job request, this is the URI of \
         that bucket. If you also included [OutputKey] in your request, your output is located in \
        ...
        \    Temporary URIs for service-managed Amazon S3 buckets are only valid for 15 minutes. \
         If you get an [AccesDenied] error, you can get a new temporary URI by running a \
  ...
  transcript_file_uri : uri option;
      [@ocaml.doc
        ...
        \ \n\
        \  If you didn't include [OutputBucketName] in your transcription job request, your \
         transcript is stored in a service-managed bucket, and [TranscriptFileUri] provides you \
         with a temporary URI you can use for secure access to your transcript.\n\
        \  \n\
        \    Temporary URIs for service-managed Amazon S3 buckets are only valid for 15 minutes. \
         If you get an [AccesDenied] error, you can get a new temporary URI by running a \
         [GetTranscriptionJob] or [ListTranscriptionJob] request.\n\
...
[@@ocaml.doc "Provides you with the Amazon S3 URI you can use to access your transcript.\n"]
...
type nonrec settings = {
  ...
  vocabulary_filter_name : vocabulary_filter_name option;
      [@ocaml.doc
        "The name of the custom vocabulary filter you want to use in your transcription job \
         request. This name is case sensitive, cannot contain spaces, and must be unique within an \
  ...
  max_alternatives : max_alternatives option;
      [@ocaml.doc
        "Indicate the maximum number of alternative transcriptions you want Amazon Transcribe to \
  ...
  show_alternatives : boolean_ option;
      [@ocaml.doc
        ...
        \ If you have multi-channel audio and do not enable channel identification, your audio is \
         transcribed in a continuous manner and your transcript does not separate the speech by \
         channel.\n\
        \ \n\
...
type nonrec job_execution_settings = {
  data_access_role_arn : data_access_role_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of an IAM role that has permissions to access the Amazon \
         S3 bucket that contains your input files. If the role that you specify doesn\226\128\153t \
         have the appropriate permissions to access the specified Amazon S3 location, your request \
         fails.\n\n\
        \ IAM role ARNs have the format [arn:partition:iam::account:role/role-name-with-path]. For \
         example: [arn:aws:iam::111122223333:role/Admin]. For more information, see \
         {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html#identifiers-arns}IAM \
         ARNs}.\n\
        \ \n\
  ...
  allow_deferred_execution : boolean_ option;
      [@ocaml.doc
        "Makes it possible to enable job queuing when your concurrent request limit is exceeded. \
         When [AllowDeferredExecution] is set to [true], transcription job requests are placed in \
         a queue until the number of jobs falls below the concurrent request limit. If \
         [AllowDeferredExecution] is set to [false] and the number of transcription job requests \
         exceed the concurrent request limit, you get a [LimitExceededException] error.\n\n\
...
type nonrec subtitle_format = SRT [@ocaml.doc ""] | VTT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec subtitles_output = {
  output_start_index : subtitle_output_start_index option;
      [@ocaml.doc
        "Provides the start index value for your subtitle files. If you did not specify a value in \
         your request, the default value of [0] is used.\n"]
  subtitle_file_uris : subtitle_file_uris option;
      [@ocaml.doc
        ...
        \ \n\
        \  If you didn't include [OutputBucketName] in your transcription job request, your \
         subtitle file is stored in a service-managed bucket, and [TranscriptFileUri] provides you \
         with a temporary URI you can use for secure access to your subtitle file.\n\
        \  \n\
        \    Temporary URIs for service-managed Amazon S3 buckets are only valid for 15 minutes. \
         If you get an [AccesDenied] error, you can get a new temporary URI by running a \
         [GetTranscriptionJob] or [ListTranscriptionJob] request.\n\
  ...
  formats : subtitle_formats option;
      [@ocaml.doc
        "Provides the format of your subtitle files. If your request included both WebVTT ([vtt]) \
         and SubRip ([srt]) formats, both formats are shown.\n"]
}
[@@ocaml.doc
...
type nonrec language_id_settings = {
  ...
  vocabulary_filter_name : vocabulary_filter_name option;
      [@ocaml.doc
        ...
        \ The language of the specified custom vocabulary filter must match the language code that \
         you specify in your transcription request. If the languages do not match, the custom \
...
[@@ocaml.doc
  "If using automatic language identification in your request and you want to apply a custom \
   language model, a custom vocabulary, or a custom vocabulary filter, include \
   [LanguageIdSettings] with the relevant sub-parameters ([VocabularyName], [LanguageModelName], \
   and [VocabularyFilterName]). Note that multi-language identification \
  ...
  \  [LanguageIdSettings] supports two to five language codes. Each language code you include can \
   have an associated custom language model, custom vocabulary, and custom vocabulary filter. The \
   language codes that you specify must match the languages of the associated custom language \
  ...
  \  It's recommended that you include [LanguageOptions] when using [LanguageIdSettings] to ensure \
   that the correct language dialect is identified. For example, if you specify a custom \
   vocabulary that is in [en-US] but Amazon Transcribe determines that the language spoken in your \
   media is [en-AU], your custom vocabulary {i is not} applied to your transcription. If you \
   include [LanguageOptions] and include [en-US] as the only English language dialect, your custom \
   vocabulary {i is} applied to your transcription.\n\
  \  \n\
  \   If you want to include a custom language model with your request but {b do not} want to use \
   automatic language identification, use instead the  parameter with the [LanguageModelName] \
   sub-parameter. If you want to include a custom vocabulary or a custom vocabulary filter (or \
   both) with your request but {b do not} want to use automatic language identification, use \
   instead the  parameter with the [VocabularyName] or [VocabularyFilterName] (or both) \
   sub-parameter.\n\
  \   "]

type nonrec language_id_settings_map = (language_code * language_id_settings) list [@@ocaml.doc ""]
...
type nonrec transcription_job = {
  ...
  subtitles : subtitles_output option;
      [@ocaml.doc "Indicates whether subtitles were generated with your transcription.\n"]
  tags : tag_list option;
      [@ocaml.doc
  ...
  language_options : language_options option;
      [@ocaml.doc "Provides the language codes you specified in your request.\n"]
  identify_multiple_languages : boolean_ option;
      [@ocaml.doc
        "Indicates whether automatic multi-language identification was enabled ([TRUE]) for the \
         specified transcription job.\n"]
  identify_language : boolean_ option;
      [@ocaml.doc
        "Indicates whether automatic language identification was enabled ([TRUE]) for the \
         specified transcription job.\n"]
  content_redaction : content_redaction option;
      [@ocaml.doc "Indicates whether redaction was enabled in your transcript.\n"]
  job_execution_settings : job_execution_settings option;
      [@ocaml.doc
        "Provides information about how your transcription job was processed. This parameter shows \
         if your request was queued and what data access role was used.\n"]
  ...
  failure_reason : failure_reason option;
      [@ocaml.doc
        "If [TranscriptionJobStatus] is [FAILED], [FailureReason] contains information about why \
         the transcription job request failed.\n\n\
        \ The [FailureReason] field contains one of the following values:\n\
        \ \n\
        \  {ul\n\
        \        {-   [Unsupported media format].\n\
        \            \n\
        \             The media format specified in [MediaFormat] isn't valid. Refer to refer to \
         the [MediaFormat] parameter for a list of supported formats.\n\
        \             \n\
        \              }\n\
        \        {-   [The media format provided does not match the detected media\n\
        \                        format].\n\
        \            \n\
        \             The media format specified in [MediaFormat] doesn't match the format of the \
         input file. Check the media format of your media file and correct the specified value.\n\
        \             \n\
        \              }\n\
        \        {-   [Invalid sample rate for audio file].\n\
        \            \n\
        \             The sample rate specified in [MediaSampleRateHertz] isn't valid. The sample \
        ...
        \                    rate].\n\
        \            \n\
        \             The sample rate specified in [MediaSampleRateHertz] doesn't match the sample \
  ...
  transcript : transcript option;
      [@ocaml.doc "Provides you with the Amazon S3 URI you can use to access your transcript.\n"]
  media : media option;
      [@ocaml.doc "Provides the Amazon S3 location of the media file you used in your request.\n"]
  media_format : media_format option; [@ocaml.doc "The format of the input media file.\n"]
  media_sample_rate_hertz : media_sample_rate_hertz option;
      [@ocaml.doc "The sample rate, in hertz, of the audio track in your input media file.\n"]
  language_code : language_code option;
      [@ocaml.doc
...
[@@ocaml.doc
  ...
  \ To view the status of the specified transcription job, check the [TranscriptionJobStatus] \
   field. If the status is [COMPLETED], the job is finished and you can find the results at the \
...
type nonrec kms_encryption_context_map = (non_empty_string * non_empty_string) list [@@ocaml.doc ""]
  ...
  output_start_index : subtitle_output_start_index option;
      [@ocaml.doc
        ...
        \ The default start index for Amazon Transcribe is [0], which differs from the more widely \
         used standard of [1]. If you're uncertain which value to use, we recommend choosing [1], \
         as this may improve compatibility with other services.\n\
        \ "]
  formats : subtitle_formats option;
      [@ocaml.doc
        "Specify the output format for your subtitle file; if you select both WebVTT ([vtt]) and \
         SubRip ([srt]) formats, two output files are generated.\n"]
}
[@@ocaml.doc
  "Generate subtitles for your media file with your transcription request.\n\n\
  \ You can choose a start index of 0 or 1, and you can specify either WebVTT or SubRip (or both) \
...
type nonrec start_transcription_job_request = {
  toxicity_detection : toxicity_detection option;
      [@ocaml.doc
        "Enables toxic speech detection in your transcript. If you include [ToxicityDetection] in \
         your request, you must also include [ToxicityCategories].\n\n\
        \ For information on the types of toxic speech Amazon Transcribe can detect, see \
         {{:https://docs.aws.amazon.com/transcribe/latest/dg/toxic-language.html}Detecting toxic \
         speech}.\n\
        \ "]
  language_id_settings : language_id_settings_map option;
      [@ocaml.doc
        ...
        \  It's recommended that you include [LanguageOptions] when using [LanguageIdSettings] to \
         ...
         custom vocabulary that is in [en-US] but Amazon Transcribe determines that the language \
         spoken in your media is [en-AU], your custom vocabulary {i is not} applied to your \
         transcription. If you include [LanguageOptions] and include [en-US] as the only English \
         language dialect, your custom vocabulary {i is} applied to your transcription.\n\
        \  \n\
        \   If you want to include a custom language model with your request but {b do not} want \
         to use automatic language identification, use instead the  parameter with the \
         [LanguageModelName] sub-parameter. If you want to include a custom vocabulary or a custom \
         vocabulary filter (or both) with your request but {b do not} want to use automatic \
  ...
  language_options : language_options option;
      [@ocaml.doc
        "You can specify two or more language codes that represent the languages you think may be \
         present in your media. Including more than five is not recommended. If you're unsure what \
  ...
  identify_multiple_languages : boolean_ option;
      [@ocaml.doc
        "Enables automatic multi-language identification in your transcription job request. Use \
         this parameter if your media file contains more than one language. If your media contains \
         only one language, use [IdentifyLanguage] instead.\n\n\
  ...
  content_redaction : content_redaction option;
      [@ocaml.doc
        "Makes it possible to redact or flag specified personally identifiable information (PII) \
         ...
         [PiiEntityTypes] to choose which types of PII you want to redact. If you do not include \
  ...
  model_settings : model_settings option;
      [@ocaml.doc
        "Specify the custom language model you want to include with your transcription job. If you \
         include [ModelSettings] in your request, you must include the [LanguageModelName] \
         sub-parameter.\n\n\
        \ For more information, see \
  ...
  settings : settings option;
      [@ocaml.doc
        ...
        \ If you want to include a custom vocabulary or a custom vocabulary filter (or both) with \
         your request but {b do not} want to use automatic language identification, use [Settings] \
        ...
        \  If you're using automatic language identification with your request and want to include \
         ...
         the  parameter with the [LanguageModelName], [VocabularyName] or [VocabularyFilterName] \
         sub-parameters.\n\
        \  "]
  ...
  output_key : output_key option;
      [@ocaml.doc
        ...
        \        {-  If you specify 'my-first-transcription' as the [TranscriptionJobName], \
         'DOC-EXAMPLE-BUCKET' as the [OutputBucketName], and 'my-transcript' as the [OutputKey], \
  ...
  output_bucket_name : output_bucket_name option;
      [@ocaml.doc
        "The name of the Amazon S3 bucket where you want your transcription output stored. Do not \
        ...
        \ If you want your output to go to a sub-folder of this bucket, specify it using the \
         [OutputKey] parameter; [OutputBucketName] only accepts the name of a bucket.\n\
        \ \n\
        ...
        \   Note that Amazon Transcribe must have permission to use the specified location. You \
         can change Amazon S3 permissions using the {{:https://console.aws.amazon.com/s3}Amazon \
  ...
  media : media;
      [@ocaml.doc
        "Describes the Amazon S3 location of the media file you want to use in your request.\n"]
  media_format : media_format option; [@ocaml.doc "Specify the format of your input media file.\n"]
  media_sample_rate_hertz : media_sample_rate_hertz option;
      [@ocaml.doc
  ...
  transcription_job_name : transcription_job_name;
      [@ocaml.doc
        "A unique name, chosen by you, for your transcription job. The name that you specify is \
         also used as the default name of your transcription output file. If you want to specify a \
         different name for your transcription output, use the [OutputKey] parameter.\n\n\
  ...
  show_alternatives : boolean_ option;
      [@ocaml.doc
        ...
        \ If you include [ShowAlternatives], you must also include [MaxAlternatives], which is the \
         maximum number of alternative transcriptions you want Amazon Transcribe Medical to \
         generate.\n\
        \ \n\
        \  For more information, see \
         {{:https://docs.aws.amazon.com/transcribe/latest/dg/how-alternatives.html}Alternative \
...
type nonrec medical_content_identification_type = PHI [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec specialty = PRIMARYCARE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec medical_transcription_job = {
  ...
  specialty : specialty option;
      [@ocaml.doc "Describes the medical specialty represented in your media.\n"]
  ...
  language_code : language_code option;
      [@ocaml.doc
        "The language code used to create your medical transcription job. US English ([en-US]) is \
...
[@@ocaml.doc
  ...
  \ To view the status of the specified medical transcription job, check the \
   ...
   find the results at the location specified in [TranscriptFileUri]. If the status is [FAILED], \
...
type nonrec start_medical_transcription_job_request = {
  ...
  type_ : type_;
      [@ocaml.doc
        "Specify whether your input media contains only one person ([DICTATION]) or contains a \
         conversation between two people ([CONVERSATION]).\n\n\
        \ For example, [DICTATION] could be used for a medical professional wanting to transcribe \
         voice memos; [CONVERSATION] could be used for transcribing the doctor-patient dialogue \
  ...
  content_identification_type : medical_content_identification_type option;
      [@ocaml.doc
        "Labels all personal health information (PHI) identified in your transcript. For more \
         information, see \
         {{:https://docs.aws.amazon.com/transcribe/latest/dg/phi-id.html}Identifying personal \
  ...
  output_key : output_key option;
      [@ocaml.doc
        "Use in combination with [OutputBucketName] to specify the output location of your \
         transcript and, optionally, a unique name for your output file. The default name for your \
         transcription output is the same as the name you specified for your medical transcription \
         job ([MedicalTranscriptionJobName]).\n\n\
        \ Here are some examples of how you can use [OutputKey]:\n\
        \ \n\
        \  {ul\n\
        \        {-  If you specify 'DOC-EXAMPLE-BUCKET' as the [OutputBucketName] and \
  ...
  output_bucket_name : output_bucket_name;
      [@ocaml.doc
        "The name of the Amazon S3 bucket where you want your medical transcription output stored. \
         Do not include the [S3://] prefix of the specified bucket.\n\n\
        \ If you want your output to go to a sub-folder of this bucket, specify it using the \
         [OutputKey] parameter; [OutputBucketName] only accepts the name of a bucket.\n\
        \ \n\
        \  For example, if you want your output stored in [S3://DOC-EXAMPLE-BUCKET], set \
  ...
  language_code : language_code;
      [@ocaml.doc
        "The language code that represents the language spoken in the input media file. US English \
         ([en-US]) is the only valid value for medical transcription jobs. Any other value you \
...
type nonrec medical_scribe_language_code = EN_US [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec medical_scribe_output = {
  clinical_document_uri : uri; [@ocaml.doc "Holds the Amazon S3 URI for the Clinical Document.\n"]
  transcript_file_uri : uri; [@ocaml.doc "Holds the Amazon S3 URI for the Transcript.\n"]
}
[@@ocaml.doc
  "The location of the output of your Medical Scribe job. [ClinicalDocumentUri] holds the Amazon \
   S3 URI for the Clinical Document and [TranscriptFileUri] holds the Amazon S3 URI for the \
   Transcript.\n"]
...
type nonrec medical_scribe_note_template =
  ...
  | BIRP [@ocaml.doc ""]
  | GIRPP [@ocaml.doc ""]
  | HISTORY_AND_PHYSICAL [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  note_template : medical_scribe_note_template option;
      [@ocaml.doc
        "Specify one of the following templates to use for the clinical note summary. The default \
         is [HISTORY_AND_PHYSICAL].\n\n\
        \ {ul\n\
        \       {-  HISTORY_AND_PHYSICAL: Provides summaries for key sections of the clinical \
         documentation. Examples of sections include Chief Complaint, History of Present Illness, \
...
[@@ocaml.doc
  "Makes it possible to control how your Medical Scribe job is processed using a \
   [MedicalScribeSettings] object. Specify [ChannelIdentification] if [ChannelDefinitions] are \
   set. Enabled [ShowSpeakerLabels] if [ChannelIdentification] and [ChannelDefinitions] are not \
...
type nonrec medical_scribe_participant_role = CLINICIAN [@ocaml.doc ""] | PATIENT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec medical_scribe_channel_definitions = medical_scribe_channel_definition list
[@@ocaml.doc ""]
...
type nonrec medical_scribe_job = {
  ...
  channel_definitions : medical_scribe_channel_definitions option;
      [@ocaml.doc
        "Makes it possible to specify which speaker is on which channel. For example, if the \
         clinician is the first participant to speak, you would set [ChannelId] of the first \
         [ChannelDefinition] in the list to [0] (to indicate the first channel) and \
         [ParticipantRole] to [CLINICIAN] (to indicate that it's the clinician speaking). Then you \
         would set the [ChannelId] of the second [ChannelDefinition] in the list to [1] (to \
         indicate the second channel) and [ParticipantRole] to [PATIENT] (to indicate that it's \
         the patient speaking). \n"]
  data_access_role_arn : data_access_role_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of an IAM role that has permissions to access the Amazon \
         S3 bucket that contains your input files, write to the output bucket, and use your KMS \
         key if supplied. If the role that you specify doesn\226\128\153t have the appropriate \
  ...
  failure_reason : failure_reason option;
      [@ocaml.doc
        "If [MedicalScribeJobStatus] is [FAILED], [FailureReason] contains information about why \
         the transcription job failed. See also: \
         {{:https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html}Common \
         Errors}.\n"]
  completion_time : date_time option;
  ...
  medical_scribe_output : medical_scribe_output option;
      [@ocaml.doc
        "The location of the output of your Medical Scribe job. [ClinicalDocumentUri] holds the \
         Amazon S3 URI for the Clinical Document and [TranscriptFileUri] holds the Amazon S3 URI \
         for the Transcript.\n"]
  media : media option; [@ocaml.doc ""]
  language_code : medical_scribe_language_code option;
      [@ocaml.doc
        "The language code used to create your Medical Scribe job. US English ([en-US]) is the \
         only supported language for Medical Scribe jobs. \n"]
  medical_scribe_job_status : medical_scribe_job_status option;
      [@ocaml.doc
        "Provides the status of the specified Medical Scribe job.\n\n\
        \ If the status is [COMPLETED], the job is finished and you can find the results at the \
         location specified in [MedicalScribeOutput] If the status is [FAILED], [FailureReason] \
...
[@@ocaml.doc
  ...
  \ To view the status of the specified Medical Scribe job, check the [MedicalScribeJobStatus] \
   field. If the status is [COMPLETED], the job is finished and you can find the results at the \
   locations specified in [MedicalScribeOutput]. If the status is [FAILED], [FailureReason] \
   provides details on why your Medical Scribe job failed.\n\
  \ "]
...
type nonrec start_medical_scribe_job_response = {
  medical_scribe_job : medical_scribe_job option;
      [@ocaml.doc
        "Provides detailed information about the current Medical Scribe job, including job status \
         and, if applicable, failure reason.\n"]
}
[@@ocaml.doc ""]
  ...
  output_bucket_name : output_bucket_name;
      [@ocaml.doc
        ...
        \ Note that the role specified in the [DataAccessRoleArn] request parameter must have \
         ...
         {{:https://console.aws.amazon.com/s3}Amazon Web Services Management Console}. See also \
         {{:https://docs.aws.amazon.com/transcribe/latest/dg/security_iam_id-based-policy-examples.html#auth-role-iam-user}Permissions \
         Required for IAM User Roles}.\n\
        \ "]
  media : media; [@ocaml.doc ""]
...
type nonrec call_analytics_feature = GENERATIVE_SUMMARIZATION [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec call_analytics_skipped_feature = {
  ...
  feature : call_analytics_feature option;
      [@ocaml.doc
        "Indicates the type of analytics feature that was skipped during the analysis of a call \
         analytics job.\n"]
}
[@@ocaml.doc
  ...
  \ \n\
  \  The [Message] field contains additional information or a message explaining why the analytics \
   feature was skipped.\n\
  \  \n\
  \   The [ReasonCode] field provides a code indicating the reason why the analytics feature was \
   skipped.\n\
  \   "]

type nonrec call_analytics_skipped_feature_list = call_analytics_skipped_feature list
[@@ocaml.doc ""]

type nonrec call_analytics_job_details = {
  skipped : call_analytics_skipped_feature_list option;
      [@ocaml.doc
        "Contains information about any skipped analytics features during the analysis of a call \
         analytics job.\n\n\
...
[@@ocaml.doc
  "Contains [GenerateAbstractiveSummary], which is a required parameter if you want to enable \
...
type nonrec call_analytics_job_settings = {
  summarization : summarization option;
      [@ocaml.doc
        "Contains [GenerateAbstractiveSummary], which is a required parameter if you want to \
         enable Generative call summarization in your Call Analytics request.\n"]
  language_id_settings : language_id_settings_map option;
      [@ocaml.doc
        "If using automatic language identification in your request and you want to apply a custom \
         language model, a custom vocabulary, or a custom vocabulary filter, include \
        ...
        \   If you want to include a custom language model, custom vocabulary, or custom \
         vocabulary filter with your request but {b do not} want to use automatic language \
  ...
  language_options : language_options option;
      [@ocaml.doc
        ...
        \   To transcribe speech in Modern Standard Arabic ([ar-SA]) in Amazon Web Services \
         GovCloud (US) (US-West, us-gov-west-1), Amazon Web Services GovCloud (US) (US-East, \
         us-gov-east-1), Canada (Calgary) ca-west-1 and Africa (Cape Town) af-south-1, your media \
...
[@@ocaml.doc
  "Provides additional optional settings for your request, including content redaction, automatic \
   language identification; allows you to apply custom language models, custom vocabulary filters, \
  ...
  participant_role : participant_role option;
      [@ocaml.doc
        "Specify the speaker you want to define. Omitting this parameter is equivalent to \
         specifying both participants.\n"]
  channel_id : channel_id option; [@ocaml.doc "Specify the audio channel you want to define.\n"]
}
[@@ocaml.doc
  "Makes it possible to specify which speaker is on which channel. For example, if your agent is \
   the first participant to speak, you would set [ChannelId] to [0] (to indicate the first \
   channel) and [ParticipantRole] to [AGENT] (to indicate that it's the agent speaking).\n"]
...
type nonrec call_analytics_job = {
  ...
  identified_language_score : identified_language_score option;
      [@ocaml.doc
        ...
        \ "]
  data_access_role_arn : data_access_role_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) you included in your request.\n"]
  failure_reason : failure_reason option;
      [@ocaml.doc
        "If [CallAnalyticsJobStatus] is [FAILED], [FailureReason] contains information about why \
         the Call Analytics job request failed.\n\n\
        \ The [FailureReason] field contains one of the following values:\n\
        \ \n\
        \  {ul\n\
        \        {-   [Unsupported media format].\n\
  ...
  language_code : language_code option;
      [@ocaml.doc
        "The language code used to create your Call Analytics job. For a list of supported \
         languages and their associated language codes, refer to the \
         {{:https://docs.aws.amazon.com/transcribe/latest/dg/supported-languages.html}Supported \
         languages} table.\n\n\
        \ If you do not know the language spoken in your media file, you can omit this field and \
         ...
         accuracy of language identification, you can include several language codes and Amazon \
...
[@@ocaml.doc
  ...
  \   If you chose to redact the audio in your media file, you can find your redacted media file \
   at the location specified in the [RedactedMediaFileUri] field of your response.\n\
  \   "]
...
type nonrec start_call_analytics_job_request = {
  channel_definitions : channel_definitions option;
      [@ocaml.doc
        "Makes it possible to specify which speaker is on which channel. For example, if your \
         agent is the first participant to speak, you would set [ChannelId] to [0] (to indicate \
         the first channel) and [ParticipantRole] to [AGENT] (to indicate that it's the agent \
         speaking).\n"]
  tags : tag_list option;
      [@ocaml.doc
  ...
  settings : call_analytics_job_settings option;
      [@ocaml.doc
        "Specify additional optional settings in your request, including content redaction; allows \
         you to apply custom language models, vocabulary filters, and custom vocabularies to your \
         Call Analytics job.\n"]
  data_access_role_arn : data_access_role_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of an IAM role that has permissions to access the Amazon \
  ...
  next_token : next_token option;
      [@ocaml.doc
        "If [NextToken] is present in your response, it indicates that not all results are \
         ...
         [NextToken] parameter in your results output, then run your request again including \
  ...
  next_token : next_token option;
      [@ocaml.doc
        "If your [ListVocabularyFilters] request returns more results than can be displayed, \
         [NextToken] is displayed in the response with an associated string. To get the next page \
         of results, copy this string and repeat your request, including [NextToken] with the \
...
type nonrec list_vocabularies_response = {
  vocabularies : vocabularies option;
      [@ocaml.doc
        "Provides information about the custom vocabularies that match the criteria specified in \
         your request.\n"]
  next_token : next_token option;
      [@ocaml.doc
        "If [NextToken] is present in your response, it indicates that not all results are \
  ...
  state_equals : vocabulary_state option;
      [@ocaml.doc
        "Returns only custom vocabularies with the specified state. Vocabularies are ordered by \
         creation date, with the newest vocabulary first. If you do not include [StateEquals], all \
         custom medical vocabularies are returned.\n"]
  max_results : max_results option;
      [@ocaml.doc
        "The maximum number of custom vocabularies to return in each page of results. If there are \
         fewer results than the value that you specify, only the actual results are returned. If \
         you do not specify a value, a default of 5 is used.\n"]
  next_token : next_token option;
      [@ocaml.doc
  ...
  status : transcription_job_status option;
      [@ocaml.doc
        "Returns only transcription jobs with the specified status. Jobs are ordered by creation \
         date, with the newest job first. If you do not include [Status], all transcription jobs \
         are returned.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_tags_for_resource_response = {
  ...
  resource_arn : transcribe_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) specified in your request.\n"]
}
[@@ocaml.doc ""]
...
type nonrec medical_transcription_job_summary = {
  ...
  content_identification_type : medical_content_identification_type option;
      [@ocaml.doc
        "Labels all personal health information (PHI) identified in your transcript. For more \
         ...
         health information (PHI) in a transcription}.\n"]
  specialty : specialty option;
      [@ocaml.doc "Provides the medical specialty represented in your media.\n"]
  output_location_type : output_location_type option;
      [@ocaml.doc
  ...
  language_code : language_code option;
      [@ocaml.doc
        "The language code used to create your medical transcription. US English ([en-US]) is the \
...
[@@ocaml.doc "Provides detailed information about a specific medical transcription job.\n"]

type nonrec medical_transcription_job_summaries = medical_transcription_job_summary list
[@@ocaml.doc ""]

type nonrec list_medical_transcription_jobs_response = {
  medical_transcription_job_summaries : medical_transcription_job_summaries option;
      [@ocaml.doc "Provides a summary of information about each result.\n"]
  next_token : next_token option;
      [@ocaml.doc
        "If [NextToken] is present in your response, it indicates that not all results are \
  ...
  status : transcription_job_status option;
      [@ocaml.doc
        "Lists all medical transcription jobs that have the status specified in your request. Jobs \
  ...
  status : transcription_job_status option;
      [@ocaml.doc
        "Returns only medical transcription jobs with the specified status. Jobs are ordered by \
         creation date, with the newest job first. If you do not include [Status], all medical \
...
[@@ocaml.doc "Provides detailed information about a specific Medical Scribe job.\n"]

type nonrec medical_scribe_job_summaries = medical_scribe_job_summary list [@@ocaml.doc ""]
...
type nonrec list_medical_scribe_jobs_response = {
  ...
  status : medical_scribe_job_status option;
      [@ocaml.doc
        "Lists all Medical Scribe jobs that have the status specified in your request. Jobs are \
         ordered by creation date, with the newest job first.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_medical_scribe_jobs_request = {
  max_results : max_results option;
      [@ocaml.doc
        "The maximum number of Medical Scribe jobs to return in each page of results. If there are \
         fewer results than the value that you specify, only the actual results are returned. If \
         you do not specify a value, a default of 5 is used.\n"]
  next_token : next_token option;
      [@ocaml.doc
  ...
  job_name_contains : transcription_job_name option;
      [@ocaml.doc
        "Returns only the Medical Scribe jobs that contain the specified string. The search is not \
         case sensitive.\n"]
  status : medical_scribe_job_status option;
      [@ocaml.doc
        "Returns only Medical Scribe jobs with the specified status. Jobs are ordered by creation \
         date, with the newest job first. If you do not include [Status], all Medical Scribe jobs \
         are returned.\n"]
}
[@@ocaml.doc ""]
...
type nonrec base_model_name = WIDE_BAND [@ocaml.doc ""] | NARROW_BAND [@ocaml.doc ""]
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "Contains the Amazon S3 location of the training data you want to use to create a new custom \
   language model, and permissions to access this location.\n\n\
...
type nonrec language_model = {
  input_data_config : input_data_config option;
      [@ocaml.doc
        "The Amazon S3 location of the input files used to train and tune your custom language \
         model, in addition to the data access role ARN (Amazon Resource Name) that has \
         permissions to access these data.\n"]
  failure_reason : failure_reason option;
      [@ocaml.doc
        "If [ModelStatus] is [FAILED], [FailureReason] contains information about why the custom \
         language model request failed. See also: \
         {{:https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html}Common \
         Errors}.\n"]
  upgrade_availability : boolean_ option;
      [@ocaml.doc
        ...
        \ \n\
        \  If [true], there is a newer base model available than the one your language model is \
         using.\n\
        \  \n\
  ...
  language_code : clm_language_code option;
      [@ocaml.doc
        "The language code used to create your custom language model. Each custom language model \
         must contain terms in only one language, and the language you select for your custom \
         language model must match the language of your training and tuning data.\n\n\
        \ For a list of supported languages and their associated language codes, refer to the \
         {{:https://docs.aws.amazon.com/transcribe/latest/dg/supported-languages.html}Supported \
...
type nonrec list_language_models_request = {
  ...
  name_contains : model_name option;
      [@ocaml.doc
        "Returns only the custom language models that contain the specified string. The search is \
         not case sensitive.\n"]
...
type nonrec call_analytics_job_summary = {
  failure_reason : failure_reason option;
      [@ocaml.doc
        "If [CallAnalyticsJobStatus] is [FAILED], [FailureReason] contains information about why \
         the Call Analytics job failed. See also: \
         {{:https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html}Common \
         Errors}.\n"]
  call_analytics_job_details : call_analytics_job_details option;
      [@ocaml.doc
  ...
  call_analytics_job_status : call_analytics_job_status option;
      [@ocaml.doc
        ...
        \ "]
  language_code : language_code option;
      [@ocaml.doc "The language code used to create your Call Analytics transcription.\n"]
  completion_time : date_time option;
      [@ocaml.doc
        "The date and time the specified Call Analytics job finished processing.\n\n\
        \ Timestamps are in the format [YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC]. For example, \
...
[@@ocaml.doc "Provides detailed information about a specific Call Analytics job.\n"]

type nonrec call_analytics_job_summaries = call_analytics_job_summary list [@@ocaml.doc ""]
  ...
  status : call_analytics_job_status option;
      [@ocaml.doc
        "Returns only Call Analytics jobs with the specified status. Jobs are ordered by creation \
         date, with the newest job first. If you do not include [Status], all Call Analytics jobs \
         are returned.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_call_analytics_categories_response = {
  categories : category_properties_list option;
      [@ocaml.doc
        "Provides detailed information about your Call Analytics categories, including all the \
...
type nonrec get_vocabulary_filter_response = {
  download_uri : uri option;
      [@ocaml.doc
        "The Amazon S3 location where the custom vocabulary filter is stored; use this URI to view \
         or download the custom vocabulary filter.\n"]
  last_modified_time : date_time option;
      [@ocaml.doc
        "The date and time the specified custom vocabulary filter was last modified.\n\n\
        \ Timestamps are in the format [YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC]. For example, \
  ...
  language_code : language_code option;
      [@ocaml.doc "The language code you selected for your custom vocabulary filter.\n"]
  vocabulary_filter_name : vocabulary_filter_name option;
      [@ocaml.doc "The name of the custom vocabulary filter you requested information about.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_vocabulary_response = {
  ...
  failure_reason : failure_reason option;
      [@ocaml.doc
        "If [VocabularyState] is [FAILED], [FailureReason] contains information about why the \
         custom vocabulary request failed. See also: \
         {{:https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html}Common \
         Errors}.\n"]
  last_modified_time : date_time option;
      [@ocaml.doc
  ...
  language_code : language_code option;
      [@ocaml.doc "The language code you selected for your custom vocabulary.\n"]
  vocabulary_name : vocabulary_name option;
      [@ocaml.doc "The name of the custom vocabulary you requested information about.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_vocabulary_request = {
  vocabulary_name : vocabulary_name;
      [@ocaml.doc
        "The name of the custom vocabulary you want information about. Custom vocabulary names are \
         case sensitive.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_medical_vocabulary_response = {
  download_uri : uri option;
      [@ocaml.doc
        "The Amazon S3 location where the specified custom medical vocabulary is stored; use this \
         URI to view or download the custom vocabulary.\n"]
  failure_reason : failure_reason option;
      [@ocaml.doc
        "If [VocabularyState] is [FAILED], [FailureReason] contains information about why the \
         custom medical vocabulary request failed. See also: \
         {{:https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html}Common \
         Errors}.\n"]
  last_modified_time : date_time option;
      [@ocaml.doc
  ...
  language_code : language_code option;
      [@ocaml.doc
        "The language code you selected for your custom medical vocabulary. US English ([en-US]) \
         is the only language supported with Amazon Transcribe Medical.\n"]
  vocabulary_name : vocabulary_name option;
      [@ocaml.doc "The name of the custom medical vocabulary you requested information about.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_medical_transcription_job_response = {
  medical_transcription_job : medical_transcription_job option;
      [@ocaml.doc
        "Provides detailed information about the specified medical transcription job, including \
...
type nonrec get_medical_scribe_job_response = {
  medical_scribe_job : medical_scribe_job option;
      [@ocaml.doc
        "Provides detailed information about the specified Medical Scribe job, including job \
         status and, if applicable, failure reason\n"]
}
[@@ocaml.doc ""]
...
type nonrec describe_language_model_request = {
  model_name : model_name;
      [@ocaml.doc
        "The name of the custom language model you want information about. Model names are case \
         sensitive.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_vocabulary_request = {
  vocabulary_name : vocabulary_name;
      [@ocaml.doc
        "The name of the custom vocabulary you want to delete. Custom vocabulary names are case \
         sensitive.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_call_analytics_category_request = {
  category_name : category_name;
      [@ocaml.doc
        "The name of the Call Analytics category you want to delete. Category names are case \
         sensitive.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_vocabulary_filter_request = {
  ...
  words : words option;
      [@ocaml.doc
        "Use this parameter if you want to create your custom vocabulary filter by including all \
         desired terms, as comma-separated values, within your request. The other option for \
  ...
  vocabulary_filter_name : vocabulary_filter_name;
      [@ocaml.doc
        ...
        \ This name is case sensitive, cannot contain spaces, and must be unique within an Amazon \
         Web Services account. If you try to create a new custom vocabulary filter with the same \
         name as an existing custom vocabulary filter, you get a [ConflictException] error.\n\
        \ "]
}
[@@ocaml.doc ""]
  ...
  phrases : phrases option;
      [@ocaml.doc
        "Use this parameter if you want to create your custom vocabulary by including all desired \
         terms, as comma-separated values, within your request. The other option for creating your \
         custom vocabulary is to save your entries in a text file and upload them to an Amazon S3 \
         bucket, then specify the location of your file using the [VocabularyFileUri] parameter.\n\n\
        \ Note that if you include [Phrases] in your request, you cannot use [VocabularyFileUri]; \
         you must choose one or the other.\n\
...
type nonrec create_medical_vocabulary_response = {
  failure_reason : failure_reason option;
      [@ocaml.doc
        "If [VocabularyState] is [FAILED], [FailureReason] contains information about why the \
         medical transcription job request failed. See also: \
         {{:https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html}Common \
         Errors}.\n"]
  last_modified_time : date_time option;
      [@ocaml.doc
...
type nonrec create_medical_vocabulary_request = {
  ...
  language_code : language_code;
      [@ocaml.doc
        "The language code that represents the language of the entries in your custom vocabulary. \
         US English ([en-US]) is the only language supported with Amazon Transcribe Medical.\n"]
  vocabulary_name : vocabulary_name;
      [@ocaml.doc
...
type nonrec create_language_model_response = {
  model_status : model_status option;
      [@ocaml.doc
        "The status of your custom language model. When the status displays as [COMPLETED], your \
         model is ready to use.\n"]
  input_data_config : input_data_config option;
      [@ocaml.doc
        "Lists your data access role ARN (Amazon Resource Name) and the Amazon S3 locations you \
         provided for your training ([S3Uri]) and tuning ([TuningDataS3Uri]) data.\n"]
  model_name : model_name option; [@ocaml.doc "The name of your custom language model.\n"]
  base_model_name : base_model_name option;
      [@ocaml.doc
        "The Amazon Transcribe standard language model, or base model, you specified when creating \
         your custom language model.\n"]
  language_code : clm_language_code option;
      [@ocaml.doc "The language code you selected for your custom language model.\n"]
}
[@@ocaml.doc ""]
  ...
  language_code : clm_language_code;
      [@ocaml.doc
        ...
        \  A custom language model can only be used to transcribe files in the same language as \
         the model. For example, if you create a custom language model using US English ([en-US]), \
  ...
  rules : rule_list;
      [@ocaml.doc
        "Rules define a Call Analytics category. When creating a new category, you must create \
         ...
         detects if a customer's sentiment was positive during the last 30 seconds of the call.\n"]
  category_name : category_name;
      [@ocaml.doc
        "A unique name, chosen by you, for your Call Analytics category. It's helpful to use a \
         ...
         better to use [sentiment-positive-last30seconds] for a category over a generic name like \
         [test-category].\n\n\
