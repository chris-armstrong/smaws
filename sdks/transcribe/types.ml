...
type nonrec base_model_name = NARROW_BAND [@ocaml.doc ""] | WIDE_BAND [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec participant_role = AGENT [@ocaml.doc ""] | CUSTOMER [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec redaction_output = REDACTED [@ocaml.doc ""] | REDACTED_AND_UNREDACTED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec input_type = REAL_TIME [@ocaml.doc ""] | POST_CALL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec medical_scribe_participant_role = PATIENT [@ocaml.doc ""] | CLINICIAN [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec type_ = CONVERSATION [@ocaml.doc ""] | DICTATION [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec subtitle_format = VTT [@ocaml.doc ""] | SRT [@ocaml.doc ""] [@@ocaml.doc ""]
