     ...
     error_code =
       (option_of_yojson
          (value_for_key
             ...
             "errorCode") _list path);
     error_message =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "errorMessage") _list path);
     id =
       (option_of_yojson (value_for_key vpc_endpoint_id_of_yojson "id") _list
          path)
  ...
  ({
     failure_message =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "failureMessage") _list path);
     failure_code =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "failureCode") _list path);
     created_date =
       (option_of_yojson
          (value_for_key
...
let security_policy_detail_of_yojson tree path =
  ...
  ({
     ...
     policy =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.document_of_yojson
             "policy") _list path);
     description =
       (option_of_yojson
  ...
  ({
     quota_code =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "quotaCode") _list path);
     service_code =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
          "serviceCode" _list path);
     resource_type =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
     ...
     resource_id =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "resourceId") _list path);
     message =
       (value_for_key
          Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "message"
          _list path)
...
let update_collection_detail_of_yojson tree path =
  ...
  ({
     ...
     arn =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "arn")
          _list path);
     description =
       (option_of_yojson
          (value_for_key
  ...
  ({
     network_policy_count =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.long_of_yojson
             "NetworkPolicyCount") _list path);
     encryption_policy_count =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.long_of_yojson
             "EncryptionPolicyCount") _list path)
  ...
  ({
     retention_policy_count =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.long_of_yojson
             "RetentionPolicyCount") _list path)
     ...
     no_min_retention_period =
       (option_of_yojson
          (value_for_key
             ...
             "noMinRetentionPeriod") _list path);
     retention_period =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "retentionPeriod") _list path);
     resource_type =
       (option_of_yojson
  ...
  ({
     ...
     dashboard_endpoint =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "dashboardEndpoint") _list path);
     collection_endpoint =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
             "collectionEndpoint") _list path);
     last_modified_date =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.long_of_yojson
