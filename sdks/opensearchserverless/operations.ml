...
module CreateAccessPolicy =
  struct
    ...
    let request context (request : create_access_policy_request) =
      let input =
        Json_serializers.create_access_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.CreateAccessPolicy" ~service
        ~context ~input
...
module CreateCollection =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "OcuLimitExceededException") ->
            `OcuLimitExceededException
              (Json_deserializers.ocu_limit_exceeded_exception_of_yojson tree
                 path)
        | (_, "ServiceQuotaExceededException") ->
            `ServiceQuotaExceededException
              (Json_deserializers.service_quota_exceeded_exception_of_yojson
    ...
    let request context (request : create_collection_request) =
      let input =
        Json_serializers.create_collection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.CreateCollection" ~service ~context
        ~input
...
module CreateSecurityConfig =
  struct
    ...
    let request context (request : create_security_config_request) =
      let input =
        Json_serializers.create_security_config_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.CreateSecurityConfig" ~service
        ~context ~input
...
module CreateVpcEndpoint =
  struct
    ...
    let request context (request : create_vpc_endpoint_request) =
      let input =
        Json_serializers.create_vpc_endpoint_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.CreateVpcEndpoint" ~service
        ~context ~input
...
module DeleteAccessPolicy =
  struct
    ...
    let request context (request : delete_access_policy_request) =
      let input =
        Json_serializers.delete_access_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.DeleteAccessPolicy" ~service
        ~context ~input
...
module DeleteCollection =
  struct
    ...
    let request context (request : delete_collection_request) =
      let input =
        Json_serializers.delete_collection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.DeleteCollection" ~service ~context
        ~input
...
module DeleteLifecyclePolicy =
  struct
    ...
    let request context (request : delete_lifecycle_policy_request) =
      let input =
        Json_serializers.delete_lifecycle_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.DeleteLifecyclePolicy" ~service
        ~context ~input
...
module DeleteSecurityConfig =
  struct
    ...
    let request context (request : delete_security_config_request) =
      let input =
        Json_serializers.delete_security_config_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.DeleteSecurityConfig" ~service
        ~context ~input
...
module DeleteSecurityPolicy =
  struct
    ...
    let request context (request : delete_security_policy_request) =
      let input =
        Json_serializers.delete_security_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.DeleteSecurityPolicy" ~service
        ~context ~input
...
module DeleteVpcEndpoint =
  struct
    ...
    let request context (request : delete_vpc_endpoint_request) =
      let input =
        Json_serializers.delete_vpc_endpoint_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.DeleteVpcEndpoint" ~service
        ~context ~input
...
module GetAccessPolicy =
  struct
    ...
    let request context (request : get_access_policy_request) =
      let input =
        Json_serializers.get_access_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.GetAccessPolicy" ~service ~context
        ~input
...
module GetSecurityConfig =
  struct
    ...
    let request context (request : get_security_config_request) =
      let input =
        Json_serializers.get_security_config_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.GetSecurityConfig" ~service
        ~context ~input
...
module GetSecurityPolicy =
  struct
    ...
    let request context (request : get_security_policy_request) =
      let input =
        Json_serializers.get_security_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.GetSecurityPolicy" ~service
        ~context ~input
...
module ListAccessPolicies =
  struct
    ...
    let request context (request : list_access_policies_request) =
      let input =
        Json_serializers.list_access_policies_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.ListAccessPolicies" ~service
        ~context ~input
...
module ListCollections =
  struct
    ...
    let request context (request : list_collections_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.ListCollections" ~service ~context
        ~input
...
module ListLifecyclePolicies =
  struct
    ...
    let request context (request : list_lifecycle_policies_request) =
      let input =
        Json_serializers.list_lifecycle_policies_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.ListLifecyclePolicies" ~service
        ~context ~input
...
module ListSecurityConfigs =
  struct
    ...
    let request context (request : list_security_configs_request) =
      let input =
        Json_serializers.list_security_configs_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.ListSecurityConfigs" ~service
        ~context ~input
...
module ListSecurityPolicies =
  struct
    ...
    let request context (request : list_security_policies_request) =
      let input =
        Json_serializers.list_security_policies_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.ListSecurityPolicies" ~service
        ~context ~input
...
module ListVpcEndpoints =
  struct
    ...
    let request context (request : list_vpc_endpoints_request) =
      let input =
        Json_serializers.list_vpc_endpoints_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.ListVpcEndpoints" ~service ~context
        ~input
...
module BatchGetCollection =
  struct
    ...
    let request context (request : batch_get_collection_request) =
      let input =
        Json_serializers.batch_get_collection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.BatchGetCollection" ~service
        ~context ~input
...
module BatchGetEffectiveLifecyclePolicy =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.batch_get_effective_lifecycle_policy_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.BatchGetEffectiveLifecyclePolicy"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.batch_get_effective_lifecycle_policy_response_of_yojson
        ~error_deserializer
  end
module BatchGetLifecyclePolicy =
  struct
    ...
    let request context (request : batch_get_lifecycle_policy_request) =
      let input =
        Json_serializers.batch_get_lifecycle_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.BatchGetLifecyclePolicy" ~service
        ~context ~input
...
module BatchGetVpcEndpoint =
  struct
    ...
    let request context (request : batch_get_vpc_endpoint_request) =
      let input =
        Json_serializers.batch_get_vpc_endpoint_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.BatchGetVpcEndpoint" ~service
        ~context ~input
...
module CreateLifecyclePolicy =
  struct
    ...
    let request context (request : create_lifecycle_policy_request) =
      let input =
        Json_serializers.create_lifecycle_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.CreateLifecyclePolicy" ~service
        ~context ~input
...
module CreateSecurityPolicy =
  struct
    ...
    let request context (request : create_security_policy_request) =
      let input =
        Json_serializers.create_security_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.CreateSecurityPolicy" ~service
        ~context ~input
...
module GetAccountSettings =
  struct
    ...
    let request context (request : get_account_settings_request) =
      let input =
        Json_serializers.get_account_settings_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.GetAccountSettings" ~service
        ~context ~input
...
module GetPoliciesStats =
  struct
    ...
    let request context (request : get_policies_stats_request) =
      let input =
        Json_serializers.get_policies_stats_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.GetPoliciesStats" ~service ~context
        ~input
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.ListTagsForResource" ~service
        ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.TagResource" ~service ~context
        ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.UntagResource" ~service ~context
        ~input
...
module UpdateAccessPolicy =
  struct
    ...
    let request context (request : update_access_policy_request) =
      let input =
        Json_serializers.update_access_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.UpdateAccessPolicy" ~service
        ~context ~input
...
module UpdateAccountSettings =
  struct
    ...
    let request context (request : update_account_settings_request) =
      let input =
        Json_serializers.update_account_settings_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.UpdateAccountSettings" ~service
        ~context ~input
...
module UpdateCollection =
  struct
    ...
    let request context (request : update_collection_request) =
      let input =
        Json_serializers.update_collection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.UpdateCollection" ~service ~context
        ~input
...
module UpdateLifecyclePolicy =
  struct
    ...
    let request context (request : update_lifecycle_policy_request) =
      let input =
        Json_serializers.update_lifecycle_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.UpdateLifecyclePolicy" ~service
        ~context ~input
...
module UpdateSecurityConfig =
  struct
    ...
    let request context (request : update_security_config_request) =
      let input =
        Json_serializers.update_security_config_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.UpdateSecurityConfig" ~service
        ~context ~input
...
module UpdateSecurityPolicy =
  struct
    ...
    let request context (request : update_security_policy_request) =
      let input =
        Json_serializers.update_security_policy_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.UpdateSecurityPolicy" ~service
        ~context ~input
...
module UpdateVpcEndpoint =
  struct
    ...
    let request context (request : update_vpc_endpoint_request) =
      let input =
        Json_serializers.update_vpc_endpoint_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"OpenSearchServerless.UpdateVpcEndpoint" ~service
        ~context ~input
