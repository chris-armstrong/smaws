...
module ListCollections =
  struct
    ...
    let request context (request : list_collections_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_collections_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module BatchGetLifecyclePolicy =
  struct
    ...
    let request context (request : batch_get_lifecycle_policy_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.batch_get_lifecycle_policy_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"OpenSearchServerlessBatchGetLifecyclePolicy" ~service
          ~config:context.config ~http:context.http ~input
