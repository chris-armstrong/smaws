  ...
  let _res : vpc_endpoint_summary =
    {
      status =
        (option_of_yojson
           (value_for_key vpc_endpoint_status_of_yojson "status") _list path);
      name =
        (option_of_yojson (value_for_key vpc_endpoint_name_of_yojson "name")
           _list path);
      id =
        (option_of_yojson (value_for_key vpc_endpoint_id_of_yojson "id")
           _list path)
    } in
  _res
let vpc_endpoint_summaries_of_yojson tree path =
  list_of_yojson vpc_endpoint_summary_of_yojson tree path
let vpc_endpoint_ids_of_yojson tree path =
  list_of_yojson vpc_endpoint_id_of_yojson tree path
...
let vpc_endpoint_error_detail_of_yojson tree path =
  ...
  let _res : vpc_endpoint_error_detail =
    {
      error_code =
        (option_of_yojson (value_for_key base_string_of_yojson "errorCode")
           _list path);
      error_message =
        (option_of_yojson
           (value_for_key base_string_of_yojson "errorMessage") _list path);
      id =
        (option_of_yojson (value_for_key vpc_endpoint_id_of_yojson "id")
           _list path)
    } in
  ...
  let _res : vpc_endpoint_detail =
    {
      ...
      security_group_ids =
        (option_of_yojson
           (value_for_key security_group_ids_of_yojson "securityGroupIds")
           _list path);
      subnet_ids =
  ...
  let _res : update_vpc_endpoint_detail =
    {
      last_modified_date =
        (option_of_yojson
           (value_for_key base_long_of_yojson "lastModifiedDate") _list path);
      security_group_ids =
        (option_of_yojson
           (value_for_key security_group_ids_of_yojson "securityGroupIds")
           _list path);
  ...
  let _res : update_vpc_endpoint_response =
    {
      update_vpc_endpoint_detail =
        (option_of_yojson
           (value_for_key update_vpc_endpoint_detail_of_yojson
              "UpdateVpcEndpointDetail") _list path)
    } in
  _res
  ...
  let _res : update_vpc_endpoint_request =
    {
      ...
      remove_security_group_ids =
        (option_of_yojson
           (value_for_key security_group_ids_of_yojson
              "removeSecurityGroupIds") _list path);
      ...
      remove_subnet_ids =
        (option_of_yojson
           (value_for_key subnet_ids_of_yojson "removeSubnetIds") _list path);
      add_subnet_ids =
        (option_of_yojson (value_for_key subnet_ids_of_yojson "addSubnetIds")
           _list path);
  ...
  let _res : security_policy_detail =
    {
      ...
      created_date =
        (option_of_yojson (value_for_key base_long_of_yojson "createdDate")
           _list path);
      policy =
        (option_of_yojson (value_for_key base_document_of_yojson "policy")
           _list path);
      description =
        (option_of_yojson
      ...
      policy_version =
        (option_of_yojson
           (value_for_key policy_version_of_yojson "policyVersion") _list
           path);
      name =
        (option_of_yojson (value_for_key policy_name_of_yojson "name") _list
           path);
      type_ =
        (option_of_yojson
           (value_for_key security_policy_type_of_yojson "type") _list path)
    } in
  _res
  ...
  let _res : update_security_policy_response =
    {
      security_policy_detail =
        (option_of_yojson
           (value_for_key security_policy_detail_of_yojson
              "securityPolicyDetail") _list path)
    } in
  _res
  ...
  let _res : update_security_policy_request =
    {
      client_token =
        (option_of_yojson
           (value_for_key client_token_of_yojson "clientToken") _list path);
      policy =
        (option_of_yojson (value_for_key policy_document_of_yojson "policy")
           _list path);
      description =
        (option_of_yojson
           (value_for_key policy_description_of_yojson "description") _list
           path);
      policy_version =
        (value_for_key policy_version_of_yojson "policyVersion" _list path);
...
let service_quota_exceeded_exception_of_yojson tree path =
  ...
  let _res : service_quota_exceeded_exception =
    {
      quota_code =
        (option_of_yojson (value_for_key base_string_of_yojson "quotaCode")
           _list path);
      service_code =
        (value_for_key base_string_of_yojson "serviceCode" _list path);
      resource_type =
        (option_of_yojson
           (value_for_key base_string_of_yojson "resourceType") _list path);
      resource_id =
        (option_of_yojson (value_for_key base_string_of_yojson "resourceId")
           _list path);
  ...
  let _res : saml_config_options =
    {
      ...
      user_attribute =
        (option_of_yojson
           (value_for_key saml_user_attribute_of_yojson "userAttribute")
           _list path);
      metadata =
        (value_for_key saml_metadata_of_yojson "metadata" _list path)
    } in
  _res
  ...
  let _res : security_config_detail =
    {
      ...
      description =
        (option_of_yojson
           (value_for_key config_description_of_yojson "description") _list
           path);
      config_version =
        (option_of_yojson
           (value_for_key policy_version_of_yojson "configVersion") _list
           path);
      type_ =
        (option_of_yojson
           (value_for_key security_config_type_of_yojson "type") _list path);
      id =
        (option_of_yojson (value_for_key security_config_id_of_yojson "id")
           _list path)
    } in
  _res
  ...
  let _res : update_security_config_request =
    {
      ...
      description =
        (option_of_yojson
           ...
           path);
      config_version =
        (value_for_key policy_version_of_yojson "configVersion" _list path);
  ...
  let _res : lifecycle_policy_detail =
    {
      ...
      type_ =
        (option_of_yojson
           (value_for_key lifecycle_policy_type_of_yojson "type") _list path)
    } in
  _res
  ...
  let _res : update_lifecycle_policy_response =
    {
      lifecycle_policy_detail =
        (option_of_yojson
           (value_for_key lifecycle_policy_detail_of_yojson
              "lifecyclePolicyDetail") _list path)
    } in
  _res
  ...
  let _res : update_collection_detail =
    {
      ...
      created_date =
        (option_of_yojson (value_for_key base_long_of_yojson "createdDate")
           _list path);
      arn =
        (option_of_yojson (value_for_key base_string_of_yojson "arn") _list
           path);
      description =
        (option_of_yojson (value_for_key base_string_of_yojson "description")
           _list path);
      type_ =
        (option_of_yojson (value_for_key collection_type_of_yojson "type")
           _list path);
      status =
        (option_of_yojson
           (value_for_key collection_status_of_yojson "status") _list path);
      name =
        (option_of_yojson (value_for_key collection_name_of_yojson "name")
           _list path);
      id =
        (option_of_yojson (value_for_key collection_id_of_yojson "id") _list
           path)
    } in
  _res
  ...
  let _res : update_collection_response =
    {
      update_collection_detail =
        (option_of_yojson
           (value_for_key update_collection_detail_of_yojson
              "updateCollectionDetail") _list path)
    } in
  _res
  ...
  let _res : capacity_limits =
    {
      max_search_capacity_in_oc_u =
        (option_of_yojson
           (value_for_key search_capacity_value_of_yojson
              "maxSearchCapacityInOCU") _list path);
      max_indexing_capacity_in_oc_u =
        (option_of_yojson
           (value_for_key indexing_capacity_value_of_yojson
              "maxIndexingCapacityInOCU") _list path)
    } in
  _res
  ...
  let _res : account_settings_detail =
    {
      capacity_limits =
        (option_of_yojson
           (value_for_key capacity_limits_of_yojson "capacityLimits") _list
           path)
    } in
  _res
  ...
  let _res : update_account_settings_response =
    {
      account_settings_detail =
        (option_of_yojson
           (value_for_key account_settings_detail_of_yojson
              "accountSettingsDetail") _list path)
    } in
  _res
  ...
  let _res : access_policy_detail =
    {
      ...
      name =
        (option_of_yojson (value_for_key policy_name_of_yojson "name") _list
           path);
      type_ =
        (option_of_yojson (value_for_key access_policy_type_of_yojson "type")
           _list path)
    } in
  _res
  ...
  let _res : security_policy_stats =
    {
      network_policy_count =
        (option_of_yojson
           (value_for_key base_long_of_yojson "NetworkPolicyCount") _list
           path);
      encryption_policy_count =
        (option_of_yojson
           (value_for_key base_long_of_yojson "EncryptionPolicyCount") _list
           path)
    } in
  _res
  ...
  let _res : access_policy_stats =
    {
      data_policy_count =
        (option_of_yojson
           (value_for_key base_long_of_yojson "DataPolicyCount") _list path)
    } in
  _res
  ...
  let _res : lifecycle_policy_stats =
    {
      retention_policy_count =
        (option_of_yojson
           (value_for_key base_long_of_yojson "RetentionPolicyCount") _list
           path)
    } in
  _res
  ...
  let _res : get_policies_stats_response =
    {
      total_policy_count =
        (option_of_yojson
           (value_for_key base_long_of_yojson "TotalPolicyCount") _list path);
      lifecycle_policy_stats =
        (option_of_yojson
           (value_for_key lifecycle_policy_stats_of_yojson
              "LifecyclePolicyStats") _list path);
      security_config_stats =
        (option_of_yojson
           (value_for_key security_config_stats_of_yojson
              "SecurityConfigStats") _list path);
      security_policy_stats =
        (option_of_yojson
           (value_for_key security_policy_stats_of_yojson
              "SecurityPolicyStats") _list path);
      access_policy_stats =
        (option_of_yojson
           (value_for_key access_policy_stats_of_yojson "AccessPolicyStats")
           _list path)
    } in
  _res
  ...
  let _res : batch_get_vpc_endpoint_response =
    {
      vpc_endpoint_error_details =
        (option_of_yojson
           (value_for_key vpc_endpoint_error_details_of_yojson
              "vpcEndpointErrorDetails") _list path);
...
let batch_get_vpc_endpoint_request_of_yojson tree path =
  ...
  let _res : batch_get_vpc_endpoint_request =
    { ids = (value_for_key vpc_endpoint_ids_of_yojson "ids" _list path) } in
  _res
  ...
  let _res : batch_get_lifecycle_policy_response =
    {
      lifecycle_policy_error_details =
        (option_of_yojson
           (value_for_key lifecycle_policy_error_details_of_yojson
              "lifecyclePolicyErrorDetails") _list path);
      lifecycle_policy_details =
        (option_of_yojson
           (value_for_key lifecycle_policy_details_of_yojson
              "lifecyclePolicyDetails") _list path)
    } in
  _res
...
let batch_get_lifecycle_policy_request_of_yojson tree path =
  ...
  let _res : batch_get_lifecycle_policy_request =
    {
      identifiers =
        (value_for_key lifecycle_policy_identifiers_of_yojson "identifiers"
           _list path)
    } in
  _res
  ...
  let _res : effective_lifecycle_policy_detail =
    {
      no_min_retention_period =
        (option_of_yojson
           (value_for_key base_boolean_of_yojson "noMinRetentionPeriod")
           _list path);
      retention_period =
        (option_of_yojson
           (value_for_key base_string_of_yojson "retentionPeriod") _list path);
      resource_type =
        (option_of_yojson
           (value_for_key resource_type_of_yojson "resourceType") _list path);
      policy_name =
        (option_of_yojson (value_for_key policy_name_of_yojson "policyName")
           _list path);
      resource =
        (option_of_yojson (value_for_key resource_of_yojson "resource") _list
           path);
      type_ =
        (option_of_yojson
           (value_for_key lifecycle_policy_type_of_yojson "type") _list path)
...
let lifecycle_policy_resource_identifier_of_yojson tree path =
  ...
  let _res : lifecycle_policy_resource_identifier =
    {
      resource =
        (value_for_key resource_name_of_yojson "resource" _list path);
      type_ =
        (value_for_key lifecycle_policy_type_of_yojson "type" _list path)
    } in
  _res
  ...
  let _res : batch_get_effective_lifecycle_policy_request =
    {
      resource_identifiers =
        (value_for_key lifecycle_policy_resource_identifiers_of_yojson
...
let collection_detail_of_yojson tree path =
  ...
  let _res : collection_detail =
    {
      ...
      collection_endpoint =
        (option_of_yojson
           (value_for_key base_string_of_yojson "collectionEndpoint") _list
           path);
      last_modified_date =
        (option_of_yojson
           (value_for_key base_long_of_yojson "lastModifiedDate") _list path);
      ...
      standby_replicas =
        (option_of_yojson
           (value_for_key standby_replicas_of_yojson "standbyReplicas") _list
           path);
      kms_key_arn =
        (option_of_yojson (value_for_key base_string_of_yojson "kmsKeyArn")
           _list path);
      arn =
        (option_of_yojson (value_for_key base_string_of_yojson "arn") _list
           path);
  ...
  _res
let collection_details_of_yojson tree path =
  list_of_yojson collection_detail_of_yojson tree path
  ...
  let _res : batch_get_collection_response =
    {
      collection_error_details =
        (option_of_yojson
           (value_for_key collection_error_details_of_yojson
              "collectionErrorDetails") _list path);
      collection_details =
        (option_of_yojson
           (value_for_key collection_details_of_yojson "collectionDetails")
           _list path)
    } in
  _res
let collection_ids_of_yojson tree path =
  list_of_yojson collection_id_of_yojson tree path
let collection_names_of_yojson tree path =
  list_of_yojson collection_name_of_yojson tree path
let batch_get_collection_request_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : batch_get_collection_request =
    {
      names =
        (option_of_yojson (value_for_key collection_names_of_yojson "names")
           _list path);
      ids =
        (option_of_yojson (value_for_key collection_ids_of_yojson "ids")
           _list path)
    } in
  _res
let ocu_limit_exceeded_exception_of_yojson tree path =
  ...
  let _res : ocu_limit_exceeded_exception =
    { message = (value_for_key base_string_of_yojson "message" _list path) } in
  _res
  ...
  let _res : list_vpc_endpoints_response =
    {
      ...
      vpc_endpoint_summaries =
        (option_of_yojson
           (value_for_key vpc_endpoint_summaries_of_yojson
              "vpcEndpointSummaries") _list path)
    } in
  _res
let list_vpc_endpoints_request_of_yojson tree path =
  ...
  let _res : list_vpc_endpoints_request =
    {
      max_results =
        (option_of_yojson (value_for_key base_integer_of_yojson "maxResults")
           _list path);
      next_token =
        (option_of_yojson (value_for_key base_string_of_yojson "nextToken")
           _list path);
  ...
  let _res : list_security_policies_response =
    {
      ...
      security_policy_summaries =
        (option_of_yojson
           (value_for_key security_policy_summaries_of_yojson
              "securityPolicySummaries") _list path)
    } in
  _res
  ...
  let _res : list_security_policies_request =
    {
      ...
      resource =
        (option_of_yojson
           (value_for_key resource_filter_of_yojson "resource") _list path);
      type_ =
        (value_for_key security_policy_type_of_yojson "type" _list path)
    } in
  _res
  ...
  let _res : list_security_configs_response =
    {
      ...
      security_config_summaries =
        (option_of_yojson
           (value_for_key security_config_summaries_of_yojson
              "securityConfigSummaries") _list path)
    } in
  _res
  ...
  let _res : list_lifecycle_policies_response =
    {
      ...
      lifecycle_policy_summaries =
        (option_of_yojson
           (value_for_key lifecycle_policy_summaries_of_yojson
              "lifecyclePolicySummaries") _list path)
    } in
  _res
  ...
  let _res : list_lifecycle_policies_request =
    {
      ...
      resources =
        (option_of_yojson
           (value_for_key lifecycle_resource_filter_of_yojson "resources")
           _list path);
      type_ =
        (value_for_key lifecycle_policy_type_of_yojson "type" _list path)
    } in
...
let collection_summary_of_yojson tree path =
  ...
  _res
let collection_summaries_of_yojson tree path =
  list_of_yojson collection_summary_of_yojson tree path
  ...
  let _res : list_collections_response =
    {
      ...
      collection_summaries =
        (option_of_yojson
           (value_for_key collection_summaries_of_yojson
              "collectionSummaries") _list path)
    } in
  _res
  ...
  let _res : list_collections_request =
    {
      ...
      collection_filters =
        (option_of_yojson
           (value_for_key collection_filters_of_yojson "collectionFilters")
           _list path)
    } in
  _res
  ...
  let _res : list_access_policies_response =
    {
      ...
      access_policy_summaries =
        (option_of_yojson
           (value_for_key access_policy_summaries_of_yojson
              "accessPolicySummaries") _list path)
    } in
  _res
...
let get_security_config_request_of_yojson tree path =
  ...
  let _res : get_security_config_request =
    { id = (value_for_key security_config_id_of_yojson "id" _list path) } in
  _res
  ...
  let _res : delete_vpc_endpoint_response =
    {
      delete_vpc_endpoint_detail =
        (option_of_yojson
           (value_for_key delete_vpc_endpoint_detail_of_yojson
              "deleteVpcEndpointDetail") _list path)
    } in
  _res
  ...
  let _res : delete_collection_response =
    {
      delete_collection_detail =
        (option_of_yojson
           (value_for_key delete_collection_detail_of_yojson
              "deleteCollectionDetail") _list path)
    } in
  _res
  ...
  let _res : create_vpc_endpoint_response =
    {
      create_vpc_endpoint_detail =
        (option_of_yojson
           (value_for_key create_vpc_endpoint_detail_of_yojson
              "createVpcEndpointDetail") _list path)
    } in
  _res
  ...
  let _res : create_collection_response =
    {
      create_collection_detail =
        (option_of_yojson
           (value_for_key create_collection_detail_of_yojson
              "createCollectionDetail") _list path)
    } in
  _res
