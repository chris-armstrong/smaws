...
let vpc_endpoint_error_detail_of_yojson tree path =
  ...
  ({
     ...
     error_message =
       option_of_yojson (value_for_key base_string_of_yojson "errorMessage") _list path;
     id = option_of_yojson (value_for_key vpc_endpoint_id_of_yojson "id") _list path;
   }
...
let vpc_endpoint_detail_of_yojson tree path =
  ...
  ({
     failure_message =
       option_of_yojson (value_for_key base_string_of_yojson "failureMessage") _list path;
     failure_code = option_of_yojson (value_for_key base_string_of_yojson "failureCode") _list path;
...
let update_vpc_endpoint_detail_of_yojson tree path =
  ...
  ({
     last_modified_date =
       option_of_yojson (value_for_key base_long_of_yojson "lastModifiedDate") _list path;
     security_group_ids =
       option_of_yojson (value_for_key security_group_ids_of_yojson "securityGroupIds") _list path;
     subnet_ids = option_of_yojson (value_for_key subnet_ids_of_yojson "subnetIds") _list path;
     status = option_of_yojson (value_for_key vpc_endpoint_status_of_yojson "status") _list path;
...
let service_quota_exceeded_exception_of_yojson tree path =
  ...
  ({
     ...
     resource_type =
       option_of_yojson (value_for_key base_string_of_yojson "resourceType") _list path;
...
let saml_config_options_of_yojson tree path =
  ...
  ({
     session_timeout =
       option_of_yojson (value_for_key base_integer_of_yojson "sessionTimeout") _list path;
...
let iam_identity_center_config_options_of_yojson tree path =
  ...
  ({
     ...
     application_description =
       option_of_yojson (value_for_key base_string_of_yojson "applicationDescription") _list path;
     application_name =
       option_of_yojson (value_for_key base_string_of_yojson "applicationName") _list path;
     application_arn =
       option_of_yojson
...
let security_policy_stats_of_yojson tree path =
  ...
  ({
     network_policy_count =
       option_of_yojson (value_for_key base_long_of_yojson "NetworkPolicyCount") _list path;
     encryption_policy_count =
       option_of_yojson (value_for_key base_long_of_yojson "EncryptionPolicyCount") _list path;
   }
...
let security_config_stats_of_yojson tree path =
  ...
  ({
     saml_config_count =
       option_of_yojson (value_for_key base_long_of_yojson "SamlConfigCount") _list path;
   }
...
let access_policy_stats_of_yojson tree path =
  ...
  ({
     data_policy_count =
       option_of_yojson (value_for_key base_long_of_yojson "DataPolicyCount") _list path;
   }
    : access_policy_stats)
...
let lifecycle_policy_stats_of_yojson tree path =
  ...
  ({
     retention_policy_count =
       option_of_yojson (value_for_key base_long_of_yojson "RetentionPolicyCount") _list path;
   }
...
let get_policies_stats_response_of_yojson tree path =
  ...
  ({
     total_policy_count =
       option_of_yojson (value_for_key base_long_of_yojson "TotalPolicyCount") _list path;
     lifecycle_policy_stats =
       option_of_yojson
...
let effective_lifecycle_policy_detail_of_yojson tree path =
  ...
  ({
     no_min_retention_period =
       option_of_yojson (value_for_key base_boolean_of_yojson "noMinRetentionPeriod") _list path;
     retention_period =
       option_of_yojson (value_for_key base_string_of_yojson "retentionPeriod") _list path;
     resource_type =
...
let collection_detail_of_yojson tree path =
  ...
  ({
     ...
     failure_code = option_of_yojson (value_for_key base_string_of_yojson "failureCode") _list path;
     dashboard_endpoint =
       option_of_yojson (value_for_key base_string_of_yojson "dashboardEndpoint") _list path;
     collection_endpoint =
       option_of_yojson (value_for_key base_string_of_yojson "collectionEndpoint") _list path;
     last_modified_date =
       option_of_yojson (value_for_key base_long_of_yojson "lastModifiedDate") _list path;
     created_date = option_of_yojson (value_for_key base_long_of_yojson "createdDate") _list path;
     standby_replicas =
