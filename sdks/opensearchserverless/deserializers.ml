  ...
  ({
     ...
     name =
       (option_of_yojson (value_for_key vpc_endpoint_name_of_yojson "name")
          _list path);
     id =
       (option_of_yojson (value_for_key vpc_endpoint_id_of_yojson "id") _list
          path)
  ...
  ({
     error_code =
       (option_of_yojson (value_for_key base_string_of_yojson "errorCode")
          _list path);
     error_message =
       (option_of_yojson (value_for_key base_string_of_yojson "errorMessage")
          _list path);
     id =
       (option_of_yojson (value_for_key vpc_endpoint_id_of_yojson "id") _list
          path)
...
let service_quota_exceeded_exception_of_yojson tree path =
  ...
  ({
     ...
     resource_type =
       (option_of_yojson (value_for_key base_string_of_yojson "resourceType")
          _list path);
     resource_id =
...
let saml_config_options_of_yojson tree path =
  ...
  ({
     ...
     user_attribute =
       (option_of_yojson
          (value_for_key saml_user_attribute_of_yojson "userAttribute") _list
          path);
  ...
  ({
     ...
     type_ =
       (option_of_yojson (value_for_key collection_type_of_yojson "type")
          _list path);
     status =
       (option_of_yojson (value_for_key collection_status_of_yojson "status")
          _list path);
     name =
...
let security_policy_stats_of_yojson tree path =
  ...
  ({
     network_policy_count =
       (option_of_yojson
          (value_for_key base_long_of_yojson "NetworkPolicyCount") _list path);
...
let effective_lifecycle_policy_detail_of_yojson tree path =
  ...
  ({
     no_min_retention_period =
       (option_of_yojson
          (value_for_key base_boolean_of_yojson "noMinRetentionPeriod") _list
          path);
     retention_period =
       (option_of_yojson
  ...
  ({
     names =
       (option_of_yojson (value_for_key collection_names_of_yojson "names")
          _list path);
     ids =
       (option_of_yojson (value_for_key collection_ids_of_yojson "ids") _list
          path)
  ...
  ({
     ...
     next_token =
       (option_of_yojson (value_for_key base_string_of_yojson "nextToken")
          _list path);
     resource =
       (option_of_yojson (value_for_key resource_filter_of_yojson "resource")
          _list path);
     type_ = (value_for_key security_policy_type_of_yojson "type" _list path)
