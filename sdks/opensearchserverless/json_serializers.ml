...
let security_policy_detail_to_yojson (x : security_policy_detail) =
  assoc_to_yojson
    ...
    ("policy",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.document_to_yojson x.policy));
    ("description",
...
let update_collection_detail_to_yojson (x : update_collection_detail) =
  assoc_to_yojson
    ...
    ("arn",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.arn));
    ("description",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
         x.description));
