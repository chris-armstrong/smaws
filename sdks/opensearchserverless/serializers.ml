...
let vpc_endpoint_summaries_to_yojson tree =
  list_to_yojson vpc_endpoint_summary_to_yojson tree
let vpc_endpoint_ids_to_yojson tree =
  list_to_yojson vpc_endpoint_id_to_yojson tree
...
let vpc_endpoint_error_detail_to_yojson (x : vpc_endpoint_error_detail) =
  assoc_to_yojson
    [("errorCode", (option_to_yojson base_string_to_yojson x.error_code));
    ("errorMessage",
...
let vpc_endpoint_detail_to_yojson (x : vpc_endpoint_detail) =
  assoc_to_yojson
    ...
    ("name", (option_to_yojson vpc_endpoint_name_to_yojson x.name));
    ("id", (option_to_yojson vpc_endpoint_id_to_yojson x.id))]
let vpc_endpoint_details_to_yojson tree =
  list_to_yojson vpc_endpoint_detail_to_yojson tree
...
let update_vpc_endpoint_response_to_yojson (x : update_vpc_endpoint_response)
  ...
  assoc_to_yojson
    [("UpdateVpcEndpointDetail",
       (option_to_yojson update_vpc_endpoint_detail_to_yojson
          x.update_vpc_endpoint_detail))]
...
let security_policy_detail_to_yojson (x : security_policy_detail) =
  assoc_to_yojson
    [("lastModifiedDate",
       (option_to_yojson base_long_to_yojson x.last_modified_date));
    ("createdDate", (option_to_yojson base_long_to_yojson x.created_date));
    ("policy", (option_to_yojson base_document_to_yojson x.policy));
    ("description",
...
let update_security_policy_response_to_yojson
  (x : update_security_policy_response) =
  assoc_to_yojson
    [("securityPolicyDetail",
       (option_to_yojson security_policy_detail_to_yojson
          x.security_policy_detail))]
let policy_document_to_yojson = string_to_yojson
let update_security_policy_request_to_yojson
  (x : update_security_policy_request) =
  assoc_to_yojson
    [("clientToken",
       (option_to_yojson client_token_to_yojson x.client_token));
...
let service_quota_exceeded_exception_to_yojson
  ...
  assoc_to_yojson
    [("quotaCode", (option_to_yojson base_string_to_yojson x.quota_code));
    ("serviceCode", (Some (base_string_to_yojson x.service_code)));
    ("resourceType",
      (option_to_yojson base_string_to_yojson x.resource_type));
    ("resourceId", (option_to_yojson base_string_to_yojson x.resource_id));
    ("message", (Some (base_string_to_yojson x.message)))]
...
let update_security_config_response_to_yojson
  (x : update_security_config_response) =
  assoc_to_yojson
...
let update_lifecycle_policy_response_to_yojson
  (x : update_lifecycle_policy_response) =
  assoc_to_yojson
    [("lifecyclePolicyDetail",
       (option_to_yojson lifecycle_policy_detail_to_yojson
          x.lifecycle_policy_detail))]
let update_lifecycle_policy_request_to_yojson
  (x : update_lifecycle_policy_request) =
  assoc_to_yojson
    [("clientToken",
       (option_to_yojson client_token_to_yojson x.client_token));
    ("policy", (option_to_yojson policy_document_to_yojson x.policy));
...
let update_collection_detail_to_yojson (x : update_collection_detail) =
  assoc_to_yojson
    [("lastModifiedDate",
       (option_to_yojson base_long_to_yojson x.last_modified_date));
    ("createdDate", (option_to_yojson base_long_to_yojson x.created_date));
    ("arn", (option_to_yojson base_string_to_yojson x.arn));
    ("description", (option_to_yojson base_string_to_yojson x.description));
...
let update_collection_response_to_yojson (x : update_collection_response) =
  assoc_to_yojson
    [("updateCollectionDetail",
       (option_to_yojson update_collection_detail_to_yojson
          x.update_collection_detail))]
...
let capacity_limits_to_yojson (x : capacity_limits) =
  assoc_to_yojson
    [("maxSearchCapacityInOCU",
       (option_to_yojson search_capacity_value_to_yojson
          x.max_search_capacity_in_oc_u));
    ("maxIndexingCapacityInOCU",
      (option_to_yojson indexing_capacity_value_to_yojson
...
let update_account_settings_response_to_yojson
  (x : update_account_settings_response) =
  assoc_to_yojson
...
let update_account_settings_request_to_yojson
  (x : update_account_settings_request) =
  assoc_to_yojson
    [("capacityLimits",
       (option_to_yojson capacity_limits_to_yojson x.capacity_limits))]
let access_policy_type_to_yojson (x : access_policy_type) =
...
let update_access_policy_response_to_yojson
  (x : update_access_policy_response) =
  assoc_to_yojson
    [("accessPolicyDetail",
       (option_to_yojson access_policy_detail_to_yojson
          x.access_policy_detail))]
...
let security_policy_summary_to_yojson (x : security_policy_summary) =
  assoc_to_yojson
    ...
    ("name", (option_to_yojson policy_name_to_yojson x.name));
    ("type", (option_to_yojson security_policy_type_to_yojson x.type_))]
let security_policy_summaries_to_yojson tree =
  list_to_yojson security_policy_summary_to_yojson tree
...
let security_config_summary_to_yojson (x : security_config_summary) =
  assoc_to_yojson
    ...
    ("type", (option_to_yojson security_config_type_to_yojson x.type_));
    ("id", (option_to_yojson security_config_id_to_yojson x.id))]
let security_config_summaries_to_yojson tree =
  list_to_yojson security_config_summary_to_yojson tree
...
let resource_type_to_yojson (x : resource_type) =
  match x with | Index -> `String "index"
...
let get_policies_stats_response_to_yojson (x : get_policies_stats_response) =
  assoc_to_yojson
    ...
    ("LifecyclePolicyStats",
      (option_to_yojson lifecycle_policy_stats_to_yojson
         x.lifecycle_policy_stats));
    ("SecurityConfigStats",
      (option_to_yojson security_config_stats_to_yojson
         x.security_config_stats));
    ("SecurityPolicyStats",
      (option_to_yojson security_policy_stats_to_yojson
...
let create_security_policy_request_to_yojson
  (x : create_security_policy_request) =
  assoc_to_yojson
    [("clientToken",
       (option_to_yojson client_token_to_yojson x.client_token));
...
let create_lifecycle_policy_response_to_yojson
  (x : create_lifecycle_policy_response) =
  assoc_to_yojson
    [("lifecyclePolicyDetail",
       (option_to_yojson lifecycle_policy_detail_to_yojson
          x.lifecycle_policy_detail))]
let create_lifecycle_policy_request_to_yojson
  (x : create_lifecycle_policy_request) =
  assoc_to_yojson
    [("clientToken",
       (option_to_yojson client_token_to_yojson x.client_token));
    ("policy", (Some (policy_document_to_yojson x.policy)));
...
let batch_get_vpc_endpoint_response_to_yojson
  (x : batch_get_vpc_endpoint_response) =
  assoc_to_yojson
    [("vpcEndpointErrorDetails",
       (option_to_yojson vpc_endpoint_error_details_to_yojson
          x.vpc_endpoint_error_details));
    ("vpcEndpointDetails",
      (option_to_yojson vpc_endpoint_details_to_yojson x.vpc_endpoint_details))]
let batch_get_vpc_endpoint_request_to_yojson
  (x : batch_get_vpc_endpoint_request) =
  assoc_to_yojson [("ids", (Some (vpc_endpoint_ids_to_yojson x.ids)))]
let lifecycle_policy_details_to_yojson tree =
  list_to_yojson lifecycle_policy_detail_to_yojson tree
let lifecycle_policy_error_detail_to_yojson
  (x : lifecycle_policy_error_detail) =
  assoc_to_yojson
    [("errorCode", (option_to_yojson base_string_to_yojson x.error_code));
    ("errorMessage",
      (option_to_yojson base_string_to_yojson x.error_message));
...
let batch_get_lifecycle_policy_response_to_yojson
  (x : batch_get_lifecycle_policy_response) =
  assoc_to_yojson
    [("lifecyclePolicyErrorDetails",
       (option_to_yojson lifecycle_policy_error_details_to_yojson
          x.lifecycle_policy_error_details));
    ("lifecyclePolicyDetails",
      (option_to_yojson lifecycle_policy_details_to_yojson
         x.lifecycle_policy_details))]
...
let batch_get_lifecycle_policy_request_to_yojson
  (x : batch_get_lifecycle_policy_request) =
  assoc_to_yojson
    [("identifiers",
...
let effective_lifecycle_policy_detail_to_yojson
  (x : effective_lifecycle_policy_detail) =
  assoc_to_yojson
...
let effective_lifecycle_policy_error_detail_to_yojson
  (x : effective_lifecycle_policy_error_detail) =
  assoc_to_yojson
    [("errorCode", (option_to_yojson base_string_to_yojson x.error_code));
    ("errorMessage",
      (option_to_yojson base_string_to_yojson x.error_message));
...
let lifecycle_policy_resource_identifier_to_yojson
  (x : lifecycle_policy_resource_identifier) =
  assoc_to_yojson
...
let batch_get_effective_lifecycle_policy_request_to_yojson
  ...
  assoc_to_yojson
    [("resourceIdentifiers",
       (Some
          (lifecycle_policy_resource_identifiers_to_yojson
...
let collection_detail_to_yojson (x : collection_detail) =
  assoc_to_yojson
    ...
    ("kmsKeyArn", (option_to_yojson base_string_to_yojson x.kms_key_arn));
    ("arn", (option_to_yojson base_string_to_yojson x.arn));
    ("description", (option_to_yojson base_string_to_yojson x.description));
    ("type", (option_to_yojson collection_type_to_yojson x.type_));
    ("status", (option_to_yojson collection_status_to_yojson x.status));
    ("name", (option_to_yojson collection_name_to_yojson x.name));
    ("id", (option_to_yojson collection_id_to_yojson x.id))]
let collection_details_to_yojson tree =
  list_to_yojson collection_detail_to_yojson tree
let collection_error_detail_to_yojson (x : collection_error_detail) =
  assoc_to_yojson
    ...
    ("name", (option_to_yojson collection_name_to_yojson x.name));
    ("id", (option_to_yojson collection_id_to_yojson x.id))]
let collection_error_details_to_yojson tree =
  list_to_yojson collection_error_detail_to_yojson tree
let batch_get_collection_response_to_yojson
  (x : batch_get_collection_response) =
  assoc_to_yojson
    [("collectionErrorDetails",
       (option_to_yojson collection_error_details_to_yojson
          x.collection_error_details));
    ("collectionDetails",
      (option_to_yojson collection_details_to_yojson x.collection_details))]
let collection_ids_to_yojson tree =
  list_to_yojson collection_id_to_yojson tree
let collection_names_to_yojson tree =
  list_to_yojson collection_name_to_yojson tree
...
let list_vpc_endpoints_response_to_yojson (x : list_vpc_endpoints_response) =
  assoc_to_yojson
    ...
    ("vpcEndpointSummaries",
      (option_to_yojson vpc_endpoint_summaries_to_yojson
         x.vpc_endpoint_summaries))]
let list_vpc_endpoints_request_to_yojson (x : list_vpc_endpoints_request) =
  assoc_to_yojson
    [("maxResults", (option_to_yojson base_integer_to_yojson x.max_results));
    ("nextToken", (option_to_yojson base_string_to_yojson x.next_token));
    ("vpcEndpointFilters",
      (option_to_yojson vpc_endpoint_filters_to_yojson x.vpc_endpoint_filters))]
let list_security_policies_response_to_yojson
  (x : list_security_policies_response) =
  assoc_to_yojson
    [("nextToken", (option_to_yojson base_string_to_yojson x.next_token));
    ("securityPolicySummaries",
      (option_to_yojson security_policy_summaries_to_yojson
         x.security_policy_summaries))]
let list_security_policies_request_to_yojson
  (x : list_security_policies_request) =
  assoc_to_yojson
    [("maxResults", (option_to_yojson base_integer_to_yojson x.max_results));
    ("nextToken", (option_to_yojson base_string_to_yojson x.next_token));
...
let list_security_configs_response_to_yojson
  (x : list_security_configs_response) =
  assoc_to_yojson
    [("nextToken", (option_to_yojson base_string_to_yojson x.next_token));
    ("securityConfigSummaries",
      (option_to_yojson security_config_summaries_to_yojson
         x.security_config_summaries))]
let list_security_configs_request_to_yojson
  (x : list_security_configs_request) =
  assoc_to_yojson
    [("maxResults", (option_to_yojson base_integer_to_yojson x.max_results));
    ("nextToken", (option_to_yojson base_string_to_yojson x.next_token));
...
let list_lifecycle_policies_response_to_yojson
  (x : list_lifecycle_policies_response) =
  assoc_to_yojson
    [("nextToken", (option_to_yojson base_string_to_yojson x.next_token));
    ("lifecyclePolicySummaries",
      (option_to_yojson lifecycle_policy_summaries_to_yojson
         x.lifecycle_policy_summaries))]
let lifecycle_resource_to_yojson = string_to_yojson
let lifecycle_resource_filter_to_yojson tree =
  list_to_yojson lifecycle_resource_to_yojson tree
let list_lifecycle_policies_request_to_yojson
  (x : list_lifecycle_policies_request) =
  assoc_to_yojson
    [("maxResults", (option_to_yojson base_integer_to_yojson x.max_results));
    ("nextToken", (option_to_yojson base_string_to_yojson x.next_token));
    ("resources",
...
let collection_summary_to_yojson (x : collection_summary) =
  assoc_to_yojson
    ...
    ("name", (option_to_yojson collection_name_to_yojson x.name));
    ("id", (option_to_yojson collection_id_to_yojson x.id))]
let collection_summaries_to_yojson tree =
  list_to_yojson collection_summary_to_yojson tree
...
let access_policy_summary_to_yojson (x : access_policy_summary) =
  assoc_to_yojson
    ...
    ("name", (option_to_yojson policy_name_to_yojson x.name));
    ("type", (option_to_yojson access_policy_type_to_yojson x.type_))]
let access_policy_summaries_to_yojson tree =
  list_to_yojson access_policy_summary_to_yojson tree
let list_access_policies_response_to_yojson
  (x : list_access_policies_response) =
  assoc_to_yojson
    [("nextToken", (option_to_yojson base_string_to_yojson x.next_token));
    ("accessPolicySummaries",
      (option_to_yojson access_policy_summaries_to_yojson
         x.access_policy_summaries))]
...
let delete_vpc_endpoint_response_to_yojson (x : delete_vpc_endpoint_response)
  ...
  assoc_to_yojson
    [("deleteVpcEndpointDetail",
       (option_to_yojson delete_vpc_endpoint_detail_to_yojson
          x.delete_vpc_endpoint_detail))]
...
let delete_collection_response_to_yojson (x : delete_collection_response) =
  assoc_to_yojson
    [("deleteCollectionDetail",
       (option_to_yojson delete_collection_detail_to_yojson
          x.delete_collection_detail))]
...
let create_vpc_endpoint_response_to_yojson (x : create_vpc_endpoint_response)
  ...
  assoc_to_yojson
    [("createVpcEndpointDetail",
       (option_to_yojson create_vpc_endpoint_detail_to_yojson
          x.create_vpc_endpoint_detail))]
...
let create_security_config_response_to_yojson
  (x : create_security_config_response) =
  assoc_to_yojson
    [("securityConfigDetail",
       (option_to_yojson security_config_detail_to_yojson
          x.security_config_detail))]
...
let create_collection_response_to_yojson (x : create_collection_response) =
  assoc_to_yojson
    [("createCollectionDetail",
       (option_to_yojson create_collection_detail_to_yojson
          x.create_collection_detail))]
...
let create_access_policy_response_to_yojson
  (x : create_access_policy_response) =
  assoc_to_yojson
    [("accessPolicyDetail",
       (option_to_yojson access_policy_detail_to_yojson
          x.access_policy_detail))]
