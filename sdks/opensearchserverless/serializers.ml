...
let vpc_endpoint_error_detail_to_yojson (x : vpc_endpoint_error_detail) =
  assoc_to_yojson
    [
      ...
      ("errorMessage", option_to_yojson base_string_to_yojson x.error_message);
      ("id", option_to_yojson vpc_endpoint_id_to_yojson x.id);
    ]
...
let vpc_endpoint_detail_to_yojson (x : vpc_endpoint_detail) =
  assoc_to_yojson
    [
      ("failureMessage", option_to_yojson base_string_to_yojson x.failure_message);
...
let validation_exception_to_yojson (x : validation_exception) =
  assoc_to_yojson [ ("message", option_to_yojson base_string_to_yojson x.message) ]

let update_vpc_endpoint_detail_to_yojson (x : update_vpc_endpoint_detail) =
  assoc_to_yojson
    [
      ("lastModifiedDate", option_to_yojson base_long_to_yojson x.last_modified_date);
      ("securityGroupIds", option_to_yojson security_group_ids_to_yojson x.security_group_ids);
      ("subnetIds", option_to_yojson subnet_ids_to_yojson x.subnet_ids);
      ("status", option_to_yojson vpc_endpoint_status_to_yojson x.status);
      ("name", option_to_yojson vpc_endpoint_name_to_yojson x.name);
...
let service_quota_exceeded_exception_to_yojson (x : service_quota_exceeded_exception) =
  assoc_to_yojson
    [
      ...
      ("resourceType", option_to_yojson base_string_to_yojson x.resource_type);
...
let saml_config_options_to_yojson (x : saml_config_options) =
  assoc_to_yojson
    [
      ("sessionTimeout", option_to_yojson base_integer_to_yojson x.session_timeout);
...
let iam_identity_center_config_options_to_yojson (x : iam_identity_center_config_options) =
  assoc_to_yojson
    [
      ...
      ("applicationDescription", option_to_yojson base_string_to_yojson x.application_description);
      ("applicationName", option_to_yojson base_string_to_yojson x.application_name);
      ( "applicationArn",
...
let security_policy_stats_to_yojson (x : security_policy_stats) =
  assoc_to_yojson
    [
      ("NetworkPolicyCount", option_to_yojson base_long_to_yojson x.network_policy_count);
      ("EncryptionPolicyCount", option_to_yojson base_long_to_yojson x.encryption_policy_count);
    ]
...
let security_config_stats_to_yojson (x : security_config_stats) =
  assoc_to_yojson [ ("SamlConfigCount", option_to_yojson base_long_to_yojson x.saml_config_count) ]
...
let access_policy_stats_to_yojson (x : access_policy_stats) =
  assoc_to_yojson [ ("DataPolicyCount", option_to_yojson base_long_to_yojson x.data_policy_count) ]

let lifecycle_policy_stats_to_yojson (x : lifecycle_policy_stats) =
  assoc_to_yojson
    [ ("RetentionPolicyCount", option_to_yojson base_long_to_yojson x.retention_policy_count) ]

let get_policies_stats_response_to_yojson (x : get_policies_stats_response) =
  assoc_to_yojson
    [
      ("TotalPolicyCount", option_to_yojson base_long_to_yojson x.total_policy_count);
...
let effective_lifecycle_policy_detail_to_yojson (x : effective_lifecycle_policy_detail) =
  assoc_to_yojson
    [
      ("noMinRetentionPeriod", option_to_yojson base_boolean_to_yojson x.no_min_retention_period);
      ("retentionPeriod", option_to_yojson base_string_to_yojson x.retention_period);
...
let collection_detail_to_yojson (x : collection_detail) =
  assoc_to_yojson
    [
      ("failureMessage", option_to_yojson base_string_to_yojson x.failure_message);
      ("failureCode", option_to_yojson base_string_to_yojson x.failure_code);
      ("dashboardEndpoint", option_to_yojson base_string_to_yojson x.dashboard_endpoint);
      ("collectionEndpoint", option_to_yojson base_string_to_yojson x.collection_endpoint);
      ("lastModifiedDate", option_to_yojson base_long_to_yojson x.last_modified_date);
      ("createdDate", option_to_yojson base_long_to_yojson x.created_date);
