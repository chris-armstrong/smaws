...
type nonrec managed_credentials_action = DISABLE [@ocaml.doc ""] | ENABLE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec member_permissions = READ_ONLY [@ocaml.doc ""] | READ_WRITE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec environment_type = EC2 [@ocaml.doc ""] | SSH [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec connection_type = CONNECT_SSM [@ocaml.doc ""] | CONNECT_SSH [@ocaml.doc ""]
[@@ocaml.doc ""]
