...
type nonrec opt_in_type = NotifyAndAdjust [@ocaml.doc ""] | NotifyOnly [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec quota_context_scope = ACCOUNT [@ocaml.doc ""] | RESOURCE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec opt_in_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""] [@@ocaml.doc ""]
