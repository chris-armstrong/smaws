...
module AssociateCustomDomain =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InternalServiceErrorException") ->
            `InternalServiceErrorException
              (Json_deserializers.internal_service_error_exception_of_yojson
                 tree path)
    ...
    let request context (request : associate_custom_domain_request) =
      let input =
        Json_serializers.associate_custom_domain_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.AssociateCustomDomain" ~service ~context
        ~input
...
module CreateAutoScalingConfiguration =
  struct
    ...
    let request context (request : create_auto_scaling_configuration_request)
      =
      let input =
        Json_serializers.create_auto_scaling_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.CreateAutoScalingConfiguration" ~service
        ~context ~input
...
module CreateConnection =
  struct
    ...
    let request context (request : create_connection_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.CreateConnection" ~service ~context ~input
...
module CreateObservabilityConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.create_observability_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.CreateObservabilityConfiguration" ~service
        ~context ~input
...
module CreateService =
  struct
    ...
    let request context (request : create_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.CreateService" ~service ~context ~input
        ~output_deserializer:Json_deserializers.create_service_response_of_yojson
        ~error_deserializer
  end
module CreateVpcConnector =
  struct
    ...
    let request context (request : create_vpc_connector_request) =
      let input =
        Json_serializers.create_vpc_connector_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.CreateVpcConnector" ~service ~context ~input
...
module CreateVpcIngressConnection =
  struct
    ...
    let request context (request : create_vpc_ingress_connection_request) =
      let input =
        Json_serializers.create_vpc_ingress_connection_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.CreateVpcIngressConnection" ~service ~context
        ~input
...
module DeleteAutoScalingConfiguration =
  struct
    ...
    let request context (request : delete_auto_scaling_configuration_request)
      =
      let input =
        Json_serializers.delete_auto_scaling_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DeleteAutoScalingConfiguration" ~service
        ~context ~input
...
module DeleteConnection =
  struct
    ...
    let request context (request : delete_connection_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DeleteConnection" ~service ~context ~input
...
module DeleteObservabilityConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.delete_observability_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DeleteObservabilityConfiguration" ~service
        ~context ~input
...
module DeleteService =
  struct
    ...
    let request context (request : delete_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DeleteService" ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_service_response_of_yojson
        ~error_deserializer
  end
module DeleteVpcConnector =
  struct
    ...
    let request context (request : delete_vpc_connector_request) =
      let input =
        Json_serializers.delete_vpc_connector_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DeleteVpcConnector" ~service ~context ~input
...
module DeleteVpcIngressConnection =
  struct
    ...
    let request context (request : delete_vpc_ingress_connection_request) =
      let input =
        Json_serializers.delete_vpc_ingress_connection_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DeleteVpcIngressConnection" ~service ~context
        ~input
...
module DescribeAutoScalingConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_auto_scaling_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DescribeAutoScalingConfiguration" ~service
        ~context ~input
...
module DescribeCustomDomains =
  struct
    ...
    let request context (request : describe_custom_domains_request) =
      let input =
        Json_serializers.describe_custom_domains_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DescribeCustomDomains" ~service ~context
        ~input
...
module DescribeObservabilityConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.describe_observability_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DescribeObservabilityConfiguration" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.describe_observability_configuration_response_of_yojson
        ~error_deserializer
  end
module DescribeService =
  struct
    ...
    let request context (request : describe_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DescribeService" ~service ~context ~input
...
module DescribeVpcConnector =
  struct
    ...
    let request context (request : describe_vpc_connector_request) =
      let input =
        Json_serializers.describe_vpc_connector_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DescribeVpcConnector" ~service ~context ~input
...
module DescribeVpcIngressConnection =
  struct
    ...
    let request context (request : describe_vpc_ingress_connection_request) =
      let input =
        Json_serializers.describe_vpc_ingress_connection_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DescribeVpcIngressConnection" ~service
        ~context ~input
...
module DisassociateCustomDomain =
  struct
    ...
    let request context (request : disassociate_custom_domain_request) =
      let input =
        Json_serializers.disassociate_custom_domain_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.DisassociateCustomDomain" ~service ~context
        ~input
...
module ListAutoScalingConfigurations =
  struct
    ...
    let request context (request : list_auto_scaling_configurations_request)
      =
      let input =
        Json_serializers.list_auto_scaling_configurations_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ListAutoScalingConfigurations" ~service
        ~context ~input
...
module ListConnections =
  struct
    ...
    let request context (request : list_connections_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ListConnections" ~service ~context ~input
...
module ListObservabilityConfigurations =
  struct
    ...
    let request context (request : list_observability_configurations_request)
      =
      let input =
        Json_serializers.list_observability_configurations_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ListObservabilityConfigurations" ~service
        ~context ~input
...
module ListOperations =
  struct
    ...
    let request context (request : list_operations_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ListOperations" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_operations_response_of_yojson
        ~error_deserializer
  end
module ListServices =
  struct
    ...
    let request context (request : list_services_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ListServices" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_services_response_of_yojson
        ~error_deserializer
  end
module ListServicesForAutoScalingConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_services_for_auto_scaling_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ListServicesForAutoScalingConfiguration"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_services_for_auto_scaling_configuration_response_of_yojson
        ~error_deserializer
  end
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ListTagsForResource" ~service ~context ~input
...
module ListVpcConnectors =
  struct
    ...
    let request context (request : list_vpc_connectors_request) =
      let input =
        Json_serializers.list_vpc_connectors_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ListVpcConnectors" ~service ~context ~input
...
module ListVpcIngressConnections =
  struct
    ...
    let request context (request : list_vpc_ingress_connections_request) =
      let input =
        Json_serializers.list_vpc_ingress_connections_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ListVpcIngressConnections" ~service ~context
        ~input
...
module PauseService =
  struct
    ...
    let request context (request : pause_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.PauseService" ~service ~context ~input
        ~output_deserializer:Json_deserializers.pause_service_response_of_yojson
        ~error_deserializer
  end
module ResumeService =
  struct
    ...
    let request context (request : resume_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.ResumeService" ~service ~context ~input
        ~output_deserializer:Json_deserializers.resume_service_response_of_yojson
        ~error_deserializer
  end
module StartDeployment =
  struct
    ...
    let request context (request : start_deployment_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.StartDeployment" ~service ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AppRunner.TagResource"
        ~service ~context ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.UntagResource" ~service ~context ~input
...
module UpdateDefaultAutoScalingConfiguration =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.update_default_auto_scaling_configuration_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.UpdateDefaultAutoScalingConfiguration"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.update_default_auto_scaling_configuration_response_of_yojson
        ~error_deserializer
  end
module UpdateService =
  struct
    ...
    let request context (request : update_service_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.UpdateService" ~service ~context ~input
        ~output_deserializer:Json_deserializers.update_service_response_of_yojson
        ~error_deserializer
  end
module UpdateVpcIngressConnection =
  struct
    ...
    let request context (request : update_vpc_ingress_connection_request) =
      let input =
        Json_serializers.update_vpc_ingress_connection_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AppRunner.UpdateVpcIngressConnection" ~service ~context
        ~input
