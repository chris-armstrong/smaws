      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_observability_configuration_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AppRunnerDescribeObservabilityConfiguration" ~service
          ~config:context.config ~http:context.http ~input
...
module DescribeService =
  struct
    ...
    let request context (request : describe_service_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_service_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DisassociateCustomDomain =
  struct
    ...
    let request context (request : disassociate_custom_domain_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.disassociate_custom_domain_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module ListOperations =
  struct
    ...
    let request context (request : list_operations_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_operations_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : list_services_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AppRunnerListServices" ~service ~config:context.config
  ...
  struct
    ...
    let request context (request : pause_service_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AppRunnerPauseService" ~service ~config:context.config
          ~http:context.http ~input
...
module StartDeployment =
  struct
    ...
    let request context (request : start_deployment_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.start_deployment_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : tag_resource_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AppRunnerTagResource" ~service ~config:context.config
          ~http:context.http ~input
