type nonrec as_config_max_concurrency = int [@@ocaml.doc ""]

type nonrec as_config_max_size = int [@@ocaml.doc ""]

type nonrec as_config_min_size = int [@@ocaml.doc ""]

type nonrec error_message = string [@@ocaml.doc ""]

type nonrec resource_not_found_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc
  "A resource doesn't exist for the specified Amazon Resource Name (ARN) in your Amazon Web \
   Services account.\n"]

type nonrec invalid_state_exception = { message : error_message option [@ocaml.doc ""] }
[@@ocaml.doc "You can't perform this action when the resource is in its current state.\n"]
...
[@@ocaml.doc "An unexpected service exception occurred.\n"]
...
type nonrec ingress_vpc_configuration = {
  vpc_id : string_ option; [@ocaml.doc "The ID of the VPC that is used for the VPC endpoint.\n"]
  vpc_endpoint_id : string_ option;
      [@ocaml.doc "The ID of the VPC endpoint that your App Runner service connects to. \n"]
}
[@@ocaml.doc
  "The configuration of your VPC and the associated VPC endpoint. The VPC endpoint is an Amazon \
   Web Services PrivateLink resource that allows access to your App Runner services from within an \
   Amazon VPC.\n"]
...
type nonrec app_runner_resource_arn = string [@@ocaml.doc ""]

type nonrec vpc_ingress_connection_name = string [@@ocaml.doc ""]

type nonrec vpc_ingress_connection = {
  vpc_ingress_connection_arn : app_runner_resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the VPC Ingress Connection. \n"]
  vpc_ingress_connection_name : vpc_ingress_connection_name option;
      [@ocaml.doc "The customer-provided VPC Ingress Connection name.\n"]
  service_arn : app_runner_resource_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the service associated with the VPC Ingress Connection. \n"]
  status : vpc_ingress_connection_status option;
      [@ocaml.doc
        "The current status of the VPC Ingress Connection. The VPC Ingress Connection displays one \
         of the following statuses: [AVAILABLE], [PENDING_CREATION], [PENDING_UPDATE], \
         [PENDING_DELETION],[FAILED_CREATION], [FAILED_UPDATE], [FAILED_DELETION], and [DELETED].. \n"]
  account_id : customer_account_id option;
      [@ocaml.doc "The Account Id you use to create the VPC Ingress Connection resource.\n"]
  domain_name : domain_name option;
      [@ocaml.doc "The domain name associated with the VPC Ingress Connection resource.\n"]
  ingress_vpc_configuration : ingress_vpc_configuration option;
      [@ocaml.doc
        "Specifications for the customer\226\128\153s VPC and related PrivateLink VPC endpoint \
...
[@@ocaml.doc
  "The App Runner resource that specifies an App Runner endpoint for incoming traffic. It \
   establishes a connection between a VPC interface endpoint and a App Runner service, to make \
   your App Runner service accessible from only within an Amazon VPC.\n"]

type nonrec update_vpc_ingress_connection_response = {
  vpc_ingress_connection : vpc_ingress_connection;
      [@ocaml.doc
        "A description of the App Runner VPC Ingress Connection resource that's updated by this \
         request.\n"]
}
[@@ocaml.doc ""]
...
type nonrec update_vpc_ingress_connection_request = {
  vpc_ingress_connection_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (Arn) for the App Runner VPC Ingress Connection resource that \
         you want to update.\n"]
  ingress_vpc_configuration : ingress_vpc_configuration;
      [@ocaml.doc
        "Specifications for the customer\226\128\153s Amazon VPC and the related Amazon Web \
         Services PrivateLink VPC endpoint that are used to update the VPC Ingress Connection \
         resource.\n"]
}
[@@ocaml.doc ""]
...
type nonrec service_observability_configuration = {
  ...
  observability_configuration_arn : app_runner_resource_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the observability configuration that is associated with \
         the service. Specified only when [ObservabilityEnabled] is [true].\n\n\
...
[@@ocaml.doc
  "Describes the observability configuration of an App Runner service. These are additional \
   observability features, like tracing, that you choose to enable. They're configured in a \
   separate resource that you associate with your service.\n"]

type nonrec ip_address_type = IPV4 [@ocaml.doc ""] | DUAL_STACK [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec ingress_configuration = {
  is_publicly_accessible : boolean_ option;
      [@ocaml.doc
        "Specifies whether your App Runner service is publicly accessible. To make the service \
         publicly accessible set it to [True]. To make the service privately accessible, from only \
         within an Amazon VPC set it to [False]. \n"]
}
[@@ocaml.doc "Network configuration settings for inbound network traffic.\n"]

type nonrec egress_type = DEFAULT [@ocaml.doc ""] | VPC [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec egress_configuration = {
  egress_type : egress_type option;
      [@ocaml.doc
        ...
        \  "]
  vpc_connector_arn : app_runner_resource_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner VPC connector that you want to associate \
         with your App Runner service. Only valid when [EgressType =\n\
        \        VPC].\n"]
}
[@@ocaml.doc
...
type nonrec network_configuration = {
  egress_configuration : egress_configuration option;
      [@ocaml.doc "Network configuration settings for outbound message traffic.\n"]
...
[@@ocaml.doc
  "Describes configuration settings related to network traffic of an App Runner service. Consists \
   of embedded objects for each configurable network feature.\n"]

type nonrec is_default = bool [@@ocaml.doc ""]

type nonrec has_associated_service = bool [@@ocaml.doc ""]

type nonrec auto_scaling_configuration_status = ACTIVE [@ocaml.doc ""] | INACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec integer = int [@@ocaml.doc ""]

type nonrec auto_scaling_configuration_name = string [@@ocaml.doc ""]

type nonrec auto_scaling_configuration_summary = {
  auto_scaling_configuration_arn : app_runner_resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of this auto scaling configuration.\n"]
  auto_scaling_configuration_name : auto_scaling_configuration_name option;
      [@ocaml.doc
        "The customer-provided auto scaling configuration name. It can be used in multiple \
         revisions of a configuration.\n"]
  auto_scaling_configuration_revision : integer option;
      [@ocaml.doc
        "The revision of this auto scaling configuration. It's unique among all the active \
         configurations ([\"Status\": \"ACTIVE\"]) with the same [AutoScalingConfigurationName].\n"]
  ...
  has_associated_service : has_associated_service option;
      [@ocaml.doc
        "Indicates if this auto scaling configuration has an App Runner service associated with \
         it. A value of [true] indicates one or more services are associated. A value of [false] \
         indicates no services are associated.\n"]
  is_default : is_default option;
      [@ocaml.doc
        "Indicates if this auto scaling configuration should be used as the default for a new App \
         Runner service that does not have an auto scaling configuration ARN specified during \
         creation. Each account can have only one default [AutoScalingConfiguration] per region. \
         The default [AutoScalingConfiguration] can be any revision under the same \
         [AutoScalingConfigurationName].\n"]
}
[@@ocaml.doc
  "Provides summary information about an App Runner automatic scaling configuration resource.\n\n\
  \ This type contains limited information about an auto scaling configuration. It includes only \
   identification information, without configuration details. It's returned by the \
   [ListAutoScalingConfigurations] action. Complete configuration information is returned by the \
...
type nonrec health_check_unhealthy_threshold = int [@@ocaml.doc ""]

type nonrec health_check_healthy_threshold = int [@@ocaml.doc ""]
...
type nonrec health_check_protocol = TCP [@ocaml.doc ""] | HTTP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec health_check_configuration = {
  ...
  path : health_check_path option;
      [@ocaml.doc
        ...
        \  Default: [\"/\"] \n\
        \  "]
  interval : health_check_interval option;
      [@ocaml.doc "The time interval, in seconds, between health checks.\n\n Default: [5] \n "]
  timeout : health_check_timeout option;
      [@ocaml.doc
        "The time, in seconds, to wait for a health check response before deciding it failed.\n\n\
        \ Default: [2] \n\
        \ "]
  healthy_threshold : health_check_healthy_threshold option;
      [@ocaml.doc
        "The number of consecutive checks that must succeed before App Runner decides that the \
         service is healthy.\n\n\
        \ Default: [1] \n\
        \ "]
  unhealthy_threshold : health_check_unhealthy_threshold option;
      [@ocaml.doc
...
type nonrec encryption_configuration = {
  kms_key : kms_key_arn; [@ocaml.doc "The ARN of the KMS key that's used for encryption.\n"]
}
[@@ocaml.doc
...
type nonrec memory = string [@@ocaml.doc ""]

type nonrec cpu = string [@@ocaml.doc ""]
...
type nonrec instance_configuration = {
  ...
  memory : memory option;
      [@ocaml.doc
        ...
        \ Default: [2 GB] \n\
        \ "]
  instance_role_arn : role_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of an IAM role that provides permissions to your App \
         Runner service. These are permissions that your code needs when it calls any Amazon Web \
         Services APIs.\n"]
}
[@@ocaml.doc
...
type nonrec authentication_configuration = {
  connection_arn : app_runner_resource_arn option;
      [@ocaml.doc
  ...
  access_role_arn : role_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the IAM role that grants the App Runner service access \
         to a source repository. It's required for ECR image repositories (but not for ECR Public \
         repositories).\n"]
}
[@@ocaml.doc
  "Describes resources needed to authenticate access to some source repositories. The specific \
   resource depends on the repository provider.\n"]

type nonrec nullable_boolean = bool [@@ocaml.doc ""]

type nonrec image_repository_type = ECR [@ocaml.doc ""] | ECR_PUBLIC [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec runtime_environment_secrets_value = string [@@ocaml.doc ""]

type nonrec runtime_environment_secrets_name = string [@@ocaml.doc ""]

type nonrec runtime_environment_secrets =
  (runtime_environment_secrets_name * runtime_environment_secrets_value) list
[@@ocaml.doc ""]

type nonrec start_command = string [@@ocaml.doc ""]

type nonrec runtime_environment_variables_value = string [@@ocaml.doc ""]

type nonrec runtime_environment_variables_key = string [@@ocaml.doc ""]

type nonrec runtime_environment_variables =
  (runtime_environment_variables_key * runtime_environment_variables_value) list
[@@ocaml.doc ""]

type nonrec image_configuration = {
  runtime_environment_variables : runtime_environment_variables option;
      [@ocaml.doc
        "Environment variables that are available to your running App Runner service. An array of \
         key-value pairs.\n"]
  start_command : start_command option;
      [@ocaml.doc
        "An optional command that App Runner runs to start the application in the source image. If \
         specified, this command overrides the Docker image\226\128\153s default start command.\n"]
  port : string_ option;
      [@ocaml.doc
  ...
  runtime_environment_secrets : runtime_environment_secrets option;
      [@ocaml.doc
        ...
        \        {-   If the Amazon Web Services Systems Manager Parameter Store parameter exists \
         in the same Amazon Web Services Region as the service that you're launching, you can use \
         either the full ARN or name of the secret. If the parameter exists in a different Region, \
...
[@@ocaml.doc
  "Describes the configuration that App Runner uses to run an App Runner service using an image \
   pulled from a source image repository.\n"]

type nonrec image_identifier = string [@@ocaml.doc ""]
...
type nonrec image_repository = {
  ...
  image_repository_type : image_repository_type;
      [@ocaml.doc
        "The type of the image repository. This reflects the repository provider and whether the \
         repository is private or public.\n"]
}
[@@ocaml.doc "Describes a source image repository.\n"]

type nonrec source_directory = string [@@ocaml.doc ""]

type nonrec build_command = string [@@ocaml.doc ""]
...
type nonrec code_configuration_values = {
  ...
  build_command : build_command option;
  ...
  runtime_environment_variables : runtime_environment_variables option;
      [@ocaml.doc
        "The environment variables that are available to your running App Runner service. An array \
         of key-value pairs.\n"]
  runtime_environment_secrets : runtime_environment_secrets option;
      [@ocaml.doc
        "An array of key-value pairs representing the secrets and parameters that get referenced \
...
[@@ocaml.doc
  "Describes the basic configuration needed for building and running an App Runner service. This \
   type doesn't support the full set of possible configuration options. Fur full configuration \
   capabilities, use a [apprunner.yaml] file in the source code repository.\n"]

type nonrec configuration_source = REPOSITORY [@ocaml.doc ""] | API [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec code_configuration = {
  configuration_source : configuration_source;
      [@ocaml.doc
        ...
        \ {ul\n\
        \       {-   [REPOSITORY] \226\128\147 App Runner reads configuration values from the \
         [apprunner.yaml] file in the source code repository and ignores [CodeConfigurationValues].\n\
        \           \n\
        \            }\n\
        \       {-   [API] \226\128\147 App Runner uses configuration values provided in \
  ...
  code_configuration_values : code_configuration_values option;
      [@ocaml.doc
        "The basic configuration for building and running the App Runner service. Use it to \
         quickly launch an App Runner service without providing a [apprunner.yaml] file in the \
...
type nonrec source_code_version_type = BRANCH [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec code_repository = {
  repository_url : string_;
      [@ocaml.doc "The location of the repository that contains the source code.\n"]
  source_code_version : source_code_version;
      [@ocaml.doc "The version that should be used within the source code repository.\n"]
  code_configuration : code_configuration option;
      [@ocaml.doc
        ...
        \  \n\
        \   "]
  source_directory : source_directory option;
      [@ocaml.doc
        "The path of the directory that stores source code and configuration files. The build and \
         start commands also execute from here. The path is absolute from root and, if not \
         specified, defaults to the repository root.\n"]
}
...
type nonrec source_configuration = {
  ...
  image_repository : image_repository option;
      [@ocaml.doc
        ...
        \ "]
  auto_deployments_enabled : nullable_boolean option;
      [@ocaml.doc
        "If [true], continuous integration from the source repository is enabled for the App \
         Runner service. Each repository change (including any source code commit or new image \
         version) starts a deployment.\n\n\
        \ Default: App Runner sets to [false] for a source image that uses an ECR Public \
         repository or an ECR repository that's in an Amazon Web Services account other than the \
         one that the service is in. App Runner sets to [true] in all other cases (which currently \
         include a source code repository or a source image using a same-account ECR repository).\n\
        \ "]
...
type nonrec service_id = string [@@ocaml.doc ""]

type nonrec service_name = string [@@ocaml.doc ""]

type nonrec service = {
  service_name : service_name; [@ocaml.doc "The customer-provided service name.\n"]
  ...
  status : service_status;
      [@ocaml.doc
        ...
        \ {ul\n\
        \       {-   [CREATE_FAILED] \226\128\147 The service failed to create. The failed service \
         isn't usable, and still counts towards your service quota. To troubleshoot this failure, \
         read the failure events and logs, change any parameters that need to be fixed, and \
         rebuild your service using [UpdateService].\n\
        \           \n\
        \            }\n\
        \       {-   [DELETE_FAILED] \226\128\147 The service failed to delete and can't be \
         successfully recovered. Retry the service deletion call to ensure that all related \
  ...
  instance_configuration : instance_configuration;
      [@ocaml.doc "The runtime configuration of instances (scaling units) of this service.\n"]
  encryption_configuration : encryption_configuration option;
      [@ocaml.doc
        "The encryption key that App Runner uses to encrypt the service logs and the copy of the \
         source repository that App Runner maintains for the service. It can be either a \
         customer-provided encryption key or an Amazon Web Services managed key.\n"]
  health_check_configuration : health_check_configuration option;
      [@ocaml.doc
        "The settings for the health check that App Runner performs to monitor the health of this \
         service.\n"]
...
[@@ocaml.doc
  "Describes an App Runner service. It can describe a service in any state, including deleted \
   services.\n\n\
  \ This type contains the full information about a service, including configuration details. It's \
   ...
   and {{:https://docs.aws.amazon.com/apprunner/latest/api/API_DeleteService.html}DeleteService} \
   actions. A subset of this information is returned by the \
   {{:https://docs.aws.amazon.com/apprunner/latest/api/API_ListServices.html}ListServices} action \
   using the \
...
type nonrec update_service_response = {
  service : service;
      [@ocaml.doc
        "A description of the App Runner service updated by this request. All configuration values \
         in the returned [Service] structure reflect configuration changes that are being applied \
         by this request.\n"]
  operation_id : uui_d;
      [@ocaml.doc
        "The unique ID of the asynchronous operation that this request started. You can use it \
         combined with the [ListOperations] call to track the operation's progress.\n"]
}
[@@ocaml.doc ""]
...
type nonrec update_service_request = {
  ...
  health_check_configuration : health_check_configuration option;
      [@ocaml.doc
        "The settings for the health check that App Runner performs to monitor the health of the \
         App Runner service.\n"]
  network_configuration : network_configuration option;
      [@ocaml.doc
        "Configuration settings related to network traffic of the web application that the App \
         Runner service runs.\n"]
  observability_configuration : service_observability_configuration option;
...
type nonrec latest = bool [@@ocaml.doc ""]

type nonrec auto_scaling_configuration_revision = int [@@ocaml.doc ""]
...
type nonrec auto_scaling_configuration = {
  ...
  auto_scaling_configuration_name : auto_scaling_configuration_name option;
      [@ocaml.doc
        "The customer-provided auto scaling configuration name. It can be used in multiple \
         revisions of a configuration.\n"]
  auto_scaling_configuration_revision : auto_scaling_configuration_revision option;
      [@ocaml.doc
        "The revision of this auto scaling configuration. It's unique among all the active \
         configurations ([\"Status\": \"ACTIVE\"]) that share the same \
         [AutoScalingConfigurationName].\n"]
  ...
  max_concurrency : max_concurrency option;
      [@ocaml.doc
        "The maximum number of concurrent requests that an instance processes. If the number of \
         concurrent requests exceeds this limit, App Runner scales the service up.\n"]
  min_size : min_size option;
      [@ocaml.doc
        "The minimum number of instances that App Runner provisions for a service. The service \
         always has at least [MinSize] provisioned instances. Some of them actively serve traffic. \
         The rest of them (provisioned and inactive instances) are a cost-effective compute \
         capacity reserve and are ready to be quickly activated. You pay for memory usage of all \
         the provisioned instances. You pay for CPU usage of only the active subset.\n\n\
...
[@@ocaml.doc
  ...
  \ A higher [MinSize] increases the spread of your App Runner service over more Availability \
  ...
  \  \n\
  \   Multiple revisions of a configuration might have the same [AutoScalingConfigurationName] and \
...
type nonrec update_default_auto_scaling_configuration_request = {
  auto_scaling_configuration_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner auto scaling configuration that you want \
...
type nonrec untag_resource_request = {
  resource_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the resource that you want to remove tags from.\n\n\
        \ It must be the ARN of an App Runner resource.\n\
        \ "]
  tag_keys : tag_key_list; [@ocaml.doc "A list of tag keys that you want to remove.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "Describes a tag that is applied to an App Runner resource. A tag is a metadata item consisting \
   of a key-value pair.\n"]
...
type nonrec tag_resource_request = {
  ...
  tags : tag_list;
      [@ocaml.doc
        "A list of tag key-value pairs to add or update. If a key is new to the resource, the tag \
         is added with the provided value. If a key is already associated with the resource, the \
         value of the tag is updated.\n"]
}
[@@ocaml.doc ""]
...
type nonrec start_deployment_request = {
  service_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner service that you want to manually deploy \
         to.\n"]
}
[@@ocaml.doc ""]
...
type nonrec resume_service_response = {
  service : service;
      [@ocaml.doc "A description of the App Runner service that this request just resumed.\n"]
  operation_id : uui_d option;
      [@ocaml.doc
        "The unique ID of the asynchronous operation that this request started. You can use it \
         combined with the [ListOperations] call to track the operation's progress.\n"]
}
...
type nonrec pause_service_response = {
  service : service;
      [@ocaml.doc "A description of the App Runner service that this request just paused.\n"]
  operation_id : uui_d option;
      [@ocaml.doc
        "The unique ID of the asynchronous operation that this request started. You can use it \
         combined with the [ListOperations] call to track the operation's progress.\n"]
...
type nonrec vpc_ingress_connection_summary_list = vpc_ingress_connection_summary list
[@@ocaml.doc ""]
...
type nonrec list_vpc_ingress_connections_filter = {
  service_arn : app_runner_resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of a service to filter by. \n"]
  vpc_endpoint_id : string_ option; [@ocaml.doc "The ID of a VPC Endpoint to filter by. \n"]
}
[@@ocaml.doc
...
type nonrec list_vpc_ingress_connections_request = {
  ...
  max_results : max_results option;
      [@ocaml.doc
        "The maximum number of results to include in each response (result page). It's used for a \
         paginated request.\n\n\
  ...
  next_token : next_token option;
      [@ocaml.doc
        "A token from a previous result page. It's used for a paginated request. The request \
         retrieves the next result page. All other parameter values must be identical to the ones \
         that are specified in the initial request.\n\n\
        \ If you don't specify [NextToken], the request retrieves the first result page.\n\
        \ "]
}
[@@ocaml.doc ""]

type nonrec vpc_connector_status = ACTIVE [@ocaml.doc ""] | INACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec string_list = string_ list [@@ocaml.doc ""]

type nonrec vpc_connector_name = string [@@ocaml.doc ""]

type nonrec vpc_connector = {
  vpc_connector_name : vpc_connector_name option;
      [@ocaml.doc "The customer-provided VPC connector name.\n"]
  vpc_connector_arn : app_runner_resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of this VPC connector.\n"]
  vpc_connector_revision : integer option;
      [@ocaml.doc
  ...
  subnets : string_list option;
      [@ocaml.doc
        "A list of IDs of subnets that App Runner uses for your service. All IDs are of subnets of \
         a single Amazon VPC.\n"]
  ...
  created_at : timestamp option;
      [@ocaml.doc "The time when the VPC connector was created. It's in Unix time stamp format.\n"]
  deleted_at : timestamp option;
      [@ocaml.doc "The time when the VPC connector was deleted. It's in Unix time stamp format.\n"]
}
[@@ocaml.doc
  "Describes an App Runner VPC connector resource. A VPC connector describes the Amazon Virtual \
   Private Cloud (Amazon VPC) that an App Runner service is associated with, and the subnets and \
   security group that are used.\n\n\
...
type nonrec vpc_connectors = vpc_connector list [@@ocaml.doc ""]
...
type nonrec list_tags_for_resource_response = {
  tags : tag_list option;
      [@ocaml.doc "A list of the tag key-value pairs that are associated with the resource.\n"]
}
[@@ocaml.doc ""]
...
type nonrec service_arn_list = app_runner_resource_arn list [@@ocaml.doc ""]
...
type nonrec service_summary = {
  service_name : service_name option; [@ocaml.doc "The customer-provided service name.\n"]
  service_id : service_id option;
      [@ocaml.doc
        "An ID that App Runner generated for this service. It's unique within the Amazon Web \
         Services Region.\n"]
  service_arn : app_runner_resource_arn option;
...
[@@ocaml.doc
  ...
  \ This type contains limited information about a service. It doesn't include configuration \
   details. It's returned by the \
   {{:https://docs.aws.amazon.com/apprunner/latest/api/API_ListServices.html}ListServices} action. \
   Complete service information is returned by the \
   {{:https://docs.aws.amazon.com/apprunner/latest/api/API_CreateService.html}CreateService}, \
   {{:https://docs.aws.amazon.com/apprunner/latest/api/API_DescribeService.html}DescribeService}, \
   and {{:https://docs.aws.amazon.com/apprunner/latest/api/API_DeleteService.html}DeleteService} \
   actions using the {{:https://docs.aws.amazon.com/apprunner/latest/api/API_Service.html}Service} \
   type.\n\
  \ "]
...
type nonrec list_services_response = {
  service_summary_list : service_summary_list;
      [@ocaml.doc
...
type nonrec service_max_results = int [@@ocaml.doc ""]
...
type nonrec list_services_request = {
  next_token : string_ option;
      [@ocaml.doc
        ...
        \ If you don't specify [NextToken], the request retrieves the first result page.\n\
        \ "]
  max_results : service_max_results option;
      [@ocaml.doc
        "The maximum number of results to include in each response (result page). It's used for a \
         paginated request.\n\n\
        \ If you don't specify [MaxResults], the request retrieves all available results in a \
...
type nonrec operation_summary = {
  ...
  type_ : operation_type option;
      [@ocaml.doc "The type of operation. It indicates a specific action that occured.\n"]
  status : operation_status option; [@ocaml.doc "The current state of the operation.\n"]
  target_arn : app_runner_resource_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the resource that the operation acted on (for example, \
         an App Runner service).\n"]
  started_at : timestamp option;
      [@ocaml.doc "The time when the operation started. It's in the Unix time stamp format.\n"]
  ended_at : timestamp option;
      [@ocaml.doc "The time when the operation ended. It's in the Unix time stamp format.\n"]
  updated_at : timestamp option;
      [@ocaml.doc
...
type nonrec list_operations_response = {
  operation_summary_list : operation_summary_list option;
      [@ocaml.doc
...
type nonrec list_operations_max_results = int [@@ocaml.doc ""]
...
type nonrec list_operations_request = {
  ...
  next_token : string_ option;
      [@ocaml.doc
        ...
        \ If you don't specify [NextToken], the request retrieves the first result page.\n\
        \ "]
  max_results : list_operations_max_results option;
      [@ocaml.doc
        "The maximum number of results to include in each response (result page). It's used for a \
         paginated request.\n\n\
        \ If you don't specify [MaxResults], the request retrieves all available results in a \
...
type nonrec observability_configuration_name = string [@@ocaml.doc ""]

type nonrec observability_configuration_summary = {
  observability_configuration_arn : app_runner_resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of this observability configuration.\n"]
  observability_configuration_name : observability_configuration_name option;
      [@ocaml.doc
        "The customer-provided observability configuration name. It can be used in multiple \
         revisions of a configuration.\n"]
  observability_configuration_revision : integer option;
      [@ocaml.doc
...
[@@ocaml.doc
  ...
  \ This type contains limited information about an observability configuration. It includes only \
   identification information, without configuration details. It's returned by the \
   [ListObservabilityConfigurations] action. Complete configuration information is returned by the \
   [CreateObservabilityConfiguration], [DescribeObservabilityConfiguration], and \
   [DeleteObservabilityConfiguration] actions using the [ObservabilityConfiguration] type.\n\
  \ "]

type nonrec observability_configuration_summary_list = observability_configuration_summary list
[@@ocaml.doc ""]
  ...
  observability_configuration_name : observability_configuration_name option;
      [@ocaml.doc
        "The name of the App Runner observability configuration that you want to list. If \
         specified, App Runner lists revisions that share this name. If not specified, App Runner \
         returns revisions of all active configurations.\n"]
  latest_only : boolean_ option;
      [@ocaml.doc
...
type nonrec provider_type = GITHUB [@ocaml.doc ""] | BITBUCKET [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec connection_name = string [@@ocaml.doc ""]

type nonrec connection_summary = {
  connection_name : connection_name option; [@ocaml.doc "The customer-provided connection name.\n"]
  connection_arn : app_runner_resource_arn option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of this connection.\n"]
  provider_type : provider_type option; [@ocaml.doc "The source repository provider.\n"]
  status : connection_status option;
      [@ocaml.doc
        "The current state of the App Runner connection. When the state is [AVAILABLE], you can \
         use the connection to create an App Runner service.\n"]
  created_at : timestamp option;
      [@ocaml.doc "The App Runner connection creation time, expressed as a Unix time stamp.\n"]
}
[@@ocaml.doc "Provides summary information about an App Runner connection resource.\n"]
...
type nonrec list_connections_request = {
  ...
  max_results : max_results option;
      [@ocaml.doc
        "The maximum number of results to include in each response (result page). Used for a \
         paginated request.\n\n\
        \ If you don't specify [MaxResults], the request retrieves all available results in a \
         single response.\n\
        \ "]
...
type nonrec auto_scaling_configuration_summary_list = auto_scaling_configuration_summary list
[@@ocaml.doc ""]
...
type nonrec vpc_dns_target = {
  vpc_ingress_connection_arn : app_runner_resource_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the VPC Ingress Connection that is associated with your \
         service.\n"]
  vpc_id : string_ option;
      [@ocaml.doc
        "The ID of the Amazon VPC that is associated with the custom domain name of the target DNS.\n"]
  domain_name : domain_name option;
      [@ocaml.doc "The domain name of your target DNS that is associated with the Amazon VPC.\n"]
}
[@@ocaml.doc "DNS Target record for a custom domain of this Amazon VPC.\n"]

type nonrec vpc_dns_target_list = vpc_dns_target list [@@ocaml.doc ""]
...
type nonrec certificate_validation_record = {
  name : string_ option; [@ocaml.doc "The certificate CNAME record name.\n"]
  type_ : string_ option; [@ocaml.doc "The record type, always [CNAME].\n"]
  value : string_ option; [@ocaml.doc "The certificate CNAME record value.\n"]
...
type nonrec certificate_validation_record_list = certificate_validation_record list [@@ocaml.doc ""]
...
type nonrec custom_domain = {
  ...
  certificate_validation_records : certificate_validation_record_list option;
      [@ocaml.doc "A list of certificate CNAME records that's used for this domain name.\n"]
  status : custom_domain_association_status;
      [@ocaml.doc "The current state of the domain name association.\n"]
}
[@@ocaml.doc "Describes a custom domain that's associated with an App Runner service.\n"]

type nonrec disassociate_custom_domain_response = {
  dns_target : string_;
      [@ocaml.doc
        "The App Runner subdomain of the App Runner service. The disassociated custom domain name \
         was mapped to this target name.\n"]
  service_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner service that a custom domain name is \
         disassociated from.\n"]
  custom_domain : custom_domain;
      [@ocaml.doc "A description of the domain name that's being disassociated.\n"]
  vpc_dns_targets : vpc_dns_target_list;
      [@ocaml.doc "DNS Target records for the custom domains of this Amazon VPC. \n"]
}
[@@ocaml.doc ""]
...
type nonrec disassociate_custom_domain_request = {
  service_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner service that you want to disassociate a \
         custom domain name from.\n"]
  domain_name : domain_name;
      [@ocaml.doc "The domain name that you want to disassociate from the App Runner service.\n"]
}
[@@ocaml.doc ""]
...
type nonrec describe_vpc_ingress_connection_request = {
  vpc_ingress_connection_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner VPC Ingress Connection that you want a \
         description for.\n"]
}
[@@ocaml.doc ""]
...
type nonrec observability_configuration_status = ACTIVE [@ocaml.doc ""] | INACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec tracing_vendor = AWSXRAY [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec trace_configuration = {
  vendor : tracing_vendor;
      [@ocaml.doc "The implementation provider chosen for tracing App Runner services.\n"]
}
[@@ocaml.doc
...
type nonrec observability_configuration = {
  ...
  trace_configuration : trace_configuration option;
      [@ocaml.doc
        "The configuration of the tracing feature within this observability configuration. If not \
         specified, tracing isn't enabled.\n"]
  observability_configuration_revision : integer option;
      [@ocaml.doc
        "The revision of this observability configuration. It's unique among all the active \
         configurations ([\"Status\": \"ACTIVE\"]) that share the same \
         [ObservabilityConfigurationName].\n"]
  latest : boolean_ option;
      [@ocaml.doc
        "It's set to [true] for the configuration with the highest [Revision] among all \
...
[@@ocaml.doc
  "Describes an App Runner observability configuration resource. Multiple revisions of a \
   configuration have the same [ObservabilityConfigurationName] and different \
   [ObservabilityConfigurationRevision] values.\n\n\
  \ The resource is designed to configure multiple features (currently one feature, tracing). This \
   type contains optional members that describe the configuration of these features (currently one \
...
type nonrec describe_observability_configuration_response = {
  observability_configuration : observability_configuration;
      [@ocaml.doc
        "A full description of the App Runner observability configuration that you specified in \
         this request.\n"]
}
[@@ocaml.doc ""]
...
type nonrec describe_observability_configuration_request = {
  observability_configuration_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner observability configuration that you \
...
type nonrec custom_domain_list = custom_domain list [@@ocaml.doc ""]
...
type nonrec describe_custom_domains_response = {
  ...
  custom_domains : custom_domain_list;
      [@ocaml.doc
        "A list of descriptions of custom domain names that are associated with the service. In a \
         paginated request, the request returns up to [MaxResults] records per call.\n"]
  vpc_dns_targets : vpc_dns_target_list;
      [@ocaml.doc "DNS Target records for the custom domains of this Amazon VPC. \n"]
  next_token : string_ option;
      [@ocaml.doc
...
type nonrec describe_custom_domains_max_results = int [@@ocaml.doc ""]

type nonrec describe_custom_domains_request = {
  service_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner service that you want associated custom \
         domain names to be described for.\n"]
  next_token : string_ option;
      [@ocaml.doc
        "A token from a previous result page. It's used for a paginated request. The request \
         retrieves the next result page. All other parameter values must be identical to the ones \
        ...
        \ If you don't specify [NextToken], the request retrieves the first result page.\n\
        \ "]
  max_results : describe_custom_domains_max_results option;
      [@ocaml.doc
        "The maximum number of results that each response (result page) can include. It's used for \
         a paginated request.\n\n\
        \ If you don't specify [MaxResults], the request retrieves all available results in a \
         single response.\n\
        \ "]
...
type nonrec describe_auto_scaling_configuration_response = {
  auto_scaling_configuration : auto_scaling_configuration;
      [@ocaml.doc
        "A full description of the App Runner auto scaling configuration that you specified in \
         this request.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_vpc_ingress_connection_request = {
  vpc_ingress_connection_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner VPC Ingress Connection that you want to \
         delete.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_vpc_connector_response = {
  vpc_connector : vpc_connector;
      [@ocaml.doc "A description of the App Runner VPC connector that this request just deleted.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_service_response = {
  service : service;
      [@ocaml.doc "A description of the App Runner service that this request just deleted.\n"]
  operation_id : uui_d;
      [@ocaml.doc
        "The unique ID of the asynchronous operation that this request started. You can use it \
         combined with the [ListOperations] call to track the operation's progress.\n"]
...
[@@ocaml.doc "Describes an App Runner connection resource.\n"]

type nonrec delete_connection_response = {
  connection : connection option;
      [@ocaml.doc "A description of the App Runner connection that this request just deleted.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_auto_scaling_configuration_request = {
  auto_scaling_configuration_arn : app_runner_resource_arn;
      [@ocaml.doc
        ...
        \ . If a revision isn't specified, the latest active revision is deleted.\n\
        \ "]
  delete_all_revisions : boolean_ option;
      [@ocaml.doc
...
[@@ocaml.doc
  "App Runner can't create this resource. You've reached your account quota for this resource \
   type.\n\n\
  \ For App Runner per-resource quotas, see \
   {{:https://docs.aws.amazon.com/general/latest/gr/apprunner.html}App Runner endpoints and \
...
type nonrec create_vpc_ingress_connection_response = {
  vpc_ingress_connection : vpc_ingress_connection;
      [@ocaml.doc
        "A description of the App Runner VPC Ingress Connection resource that's created by this \
         request. \n"]
}
[@@ocaml.doc ""]
...
type nonrec create_vpc_ingress_connection_request = {
  ...
  ingress_vpc_configuration : ingress_vpc_configuration;
      [@ocaml.doc
        "Specifications for the customer\226\128\153s Amazon VPC and the related Amazon Web \
         Services PrivateLink VPC endpoint that are used to create the VPC Ingress Connection \
         resource.\n"]
  tags : tag_list option;
      [@ocaml.doc
...
type nonrec create_vpc_connector_response = {
  vpc_connector : vpc_connector;
      [@ocaml.doc "A description of the App Runner VPC connector that's created by this request.\n"]
}
[@@ocaml.doc ""]
  ...
  security_groups : string_list option;
      [@ocaml.doc
        "A list of IDs of security groups that App Runner should use for access to Amazon Web \
         Services resources under the specified subnets. If not specified, App Runner uses the \
         default security group of the Amazon VPC. The default security group allows all outbound \
         traffic.\n"]
  tags : tag_list option;
      [@ocaml.doc
        "A list of metadata items that you can associate with your VPC connector resource. A tag \
         is a key-value pair.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_service_response = {
  service : service;
      [@ocaml.doc "A description of the App Runner service that's created by this request.\n"]
  operation_id : uui_d;
      [@ocaml.doc
        "The unique ID of the asynchronous operation that this request started. You can use it \
         combined with the \
...
type nonrec create_service_request = {
  ...
  instance_configuration : instance_configuration option;
      [@ocaml.doc "The runtime configuration of instances (scaling units) of your service.\n"]
  tags : tag_list option;
      [@ocaml.doc
  ...
  encryption_configuration : encryption_configuration option;
      [@ocaml.doc
        "An optional custom encryption key that App Runner uses to encrypt the copy of your source \
         repository that it maintains and your service logs. By default, App Runner uses an Amazon \
  ...
  auto_scaling_configuration_arn : app_runner_resource_arn option;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of an App Runner automatic scaling configuration resource \
         that you want to associate with your service. If not provided, App Runner associates the \
         latest revision of a default auto scaling configuration.\n\n\
        \ Specify an ARN with a name and a revision number to associate that revision. For \
         example: \
...
type nonrec create_observability_configuration_request = {
  observability_configuration_name : observability_configuration_name;
      [@ocaml.doc
        "A name for the observability configuration. When you use it for the first time in an \
         Amazon Web Services Region, App Runner creates revision number [1] of this name. When you \
         use the same name in subsequent calls, App Runner creates incremental revisions of the \
         configuration.\n\n\
        ...
        \   When you want to use your own observability configuration for your App Runner service, \
         {i create a configuration with a different name}, and then provide it when you create or \
         update your service.\n\
        \   \n\
        \    "]
  trace_configuration : trace_configuration option;
      [@ocaml.doc
        "The configuration of the tracing feature within this observability configuration. If you \
         don't specify it, App Runner doesn't enable tracing.\n"]
  tags : tag_list option;
      [@ocaml.doc
...
type nonrec create_connection_response = {
  connection : connection;
      [@ocaml.doc "A description of the App Runner connection that's created by this request.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_connection_request = {
  connection_name : connection_name;
      [@ocaml.doc
        "A name for the new connection. It must be unique across all App Runner connections for \
         the Amazon Web Services account in the Amazon Web Services Region.\n"]
  provider_type : provider_type; [@ocaml.doc "The source repository provider.\n"]
  tags : tag_list option;
      [@ocaml.doc
        "A list of metadata items that you can associate with your connection resource. A tag is a \
         key-value pair.\n"]
}
[@@ocaml.doc ""]
  ...
  auto_scaling_configuration_name : auto_scaling_configuration_name;
      [@ocaml.doc
        ...
        \  Prior to the release of \
         ...
         scale configuration enhancements}, the name [DefaultConfiguration] was reserved. \n\
        \  \n\
        ...
        \          {-  If you delete the auto scaling configuration you can create another custom \
         auto scaling configuration with the same [DefaultConfiguration] name. The original \
         [DefaultConfiguration] resource provided by App Runner remains in your account unless you \
         make changes to it.\n\
        \              \n\
        \               }\n\
        \          }\n\
        \   "]
  max_concurrency : as_config_max_concurrency option;
      [@ocaml.doc
        "The maximum number of concurrent requests that you want an instance to process. If the \
         number of concurrent requests exceeds this limit, App Runner scales up your service.\n\n\
        \ Default: [100] \n\
        \ "]
  min_size : as_config_min_size option;
      [@ocaml.doc
        ...
        \  Default: [1] \n\
        \  "]
  max_size : as_config_max_size option;
      [@ocaml.doc
...
type nonrec associate_custom_domain_response = {
  dns_target : string_;
      [@ocaml.doc
        "The App Runner subdomain of the App Runner service. The custom domain name is mapped to \
         this target name.\n"]
  service_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner service with which a custom domain name \
         is associated.\n"]
  custom_domain : custom_domain;
      [@ocaml.doc "A description of the domain name that's being associated.\n"]
  vpc_dns_targets : vpc_dns_target_list;
      [@ocaml.doc "DNS Target records for the custom domains of this Amazon VPC. \n"]
}
[@@ocaml.doc ""]
...
type nonrec associate_custom_domain_request = {
  service_arn : app_runner_resource_arn;
      [@ocaml.doc
        "The Amazon Resource Name (ARN) of the App Runner service that you want to associate a \
  ...
  domain_name : domain_name;
      [@ocaml.doc
        "A custom domain endpoint to associate. Specify a root domain (for example, \
         [example.com]), a subdomain (for example, [login.example.com] or \
         [admin.login.example.com]), or a wildcard (for example, [*.example.com]).\n"]
  enable_www_subdomain : nullable_boolean option;
      [@ocaml.doc
