...
let vpc_ingress_connection_status_of_yojson (tree : t) path =
  (let _list = assoc_of_yojson tree path in
   (match tree with
    ...
    | _ ->
        raise
          (deserialize_wrong_type_error path "VpcIngressConnectionStatus") : 
     vpc_ingress_connection_status) : vpc_ingress_connection_status)
  ...
  ({
     vpc_endpoint_id =
       (option_of_yojson (value_for_key string__of_yojson "VpcEndpointId")
          _list path);
     vpc_id =
       (option_of_yojson (value_for_key string__of_yojson "VpcId") _list path)
...
let vpc_ingress_connection_of_yojson tree path =
  ...
  ({
     deleted_at =
       (option_of_yojson (value_for_key timestamp_of_yojson "DeletedAt")
          _list path);
     created_at =
       (option_of_yojson (value_for_key timestamp_of_yojson "CreatedAt")
          _list path);
     ingress_vpc_configuration =
       (option_of_yojson
  ...
  (let _list = assoc_of_yojson tree path in
   (match tree with
    ...
    | _ -> raise (deserialize_wrong_type_error path "VpcConnectorStatus") : 
     vpc_connector_status) : vpc_connector_status)
let vpc_connector_of_yojson tree path =
  ...
  ({
     ...
     vpc_connector_revision =
       (option_of_yojson
          (value_for_key integer_of_yojson "VpcConnectorRevision") _list path);
     vpc_connector_arn =
       (option_of_yojson
...
let update_vpc_ingress_connection_response_of_yojson tree path =
  ...
  ({
     vpc_ingress_connection =
       (value_for_key vpc_ingress_connection_of_yojson "VpcIngressConnection"
          _list path)
  ...
  (let _list = assoc_of_yojson tree path in
   (match tree with
    ...
    | _ -> raise (deserialize_wrong_type_error path "SourceCodeVersionType") : 
     source_code_version_type) : source_code_version_type)
  ...
  ({
     ...
     code_configuration =
       (option_of_yojson
          ...
          _list path);
     source_code_version =
       (value_for_key source_code_version_of_yojson "SourceCodeVersion" _list
          path);
     repository_url =
  ...
  ({
     ...
     image_configuration =
       (option_of_yojson
          ...
          _list path);
     image_identifier =
       (value_for_key image_identifier_of_yojson "ImageIdentifier" _list path)
   } : image_repository)
...
let instance_configuration_of_yojson tree path =
  ...
  ({
     instance_role_arn =
       (option_of_yojson (value_for_key role_arn_of_yojson "InstanceRoleArn")
          _list path);
     memory =
       (option_of_yojson (value_for_key memory_of_yojson "Memory") _list path);
...
let health_check_configuration_of_yojson tree path =
  ...
  ({
     ...
     timeout =
       (option_of_yojson
          (value_for_key health_check_timeout_of_yojson "Timeout") _list path);
     interval =
       (option_of_yojson
  ...
  (let _list = assoc_of_yojson tree path in
   (match tree with
    ...
    | _ ->
     ...
     auto_scaling_configuration_status) : auto_scaling_configuration_status)
...
let service_of_yojson tree path =
  ...
  ({
     ...
     service_url =
       (option_of_yojson (value_for_key string__of_yojson "ServiceUrl") _list
          path);
     service_arn =
  ...
  ({
     ...
     status =
       (option_of_yojson
          ...
          _list path);
     latest =
       (option_of_yojson (value_for_key latest_of_yojson "Latest") _list path);
     auto_scaling_configuration_revision =
       (option_of_yojson
  ...
  ({
     status =
       (option_of_yojson (value_for_key service_status_of_yojson "Status")
          _list path);
     updated_at =
       (option_of_yojson (value_for_key timestamp_of_yojson "UpdatedAt")
          _list path);
     created_at =
       (option_of_yojson (value_for_key timestamp_of_yojson "CreatedAt")
          _list path);
  ...
  ({
     updated_at =
       (option_of_yojson (value_for_key timestamp_of_yojson "UpdatedAt")
          _list path);
     ended_at =
       (option_of_yojson (value_for_key timestamp_of_yojson "EndedAt") _list
          path);
     started_at =
       (option_of_yojson (value_for_key timestamp_of_yojson "StartedAt")
          _list path);
     target_arn =
       (option_of_yojson
          (value_for_key app_runner_resource_arn_of_yojson "TargetArn") _list
          path);
     status =
...
let observability_configuration_summary_of_yojson tree path =
  ...
  ({
     observability_configuration_revision =
       (option_of_yojson
          (value_for_key integer_of_yojson
  ...
  (let _list = assoc_of_yojson tree path in
   (match tree with
    ...
    | _ ->
     ...
     custom_domain_association_status) : custom_domain_association_status)
  ...
  ({
     ...
     vpc_dns_targets =
       (value_for_key vpc_dns_target_list_of_yojson "VpcDNSTargets" _list
          path);
     custom_domains =
       (value_for_key custom_domain_list_of_yojson "CustomDomains" _list path);
     service_arn =
       (value_for_key app_runner_resource_arn_of_yojson "ServiceArn" _list
          path);
     dns_target = (value_for_key string__of_yojson "DNSTarget" _list path)
...
let delete_connection_request_of_yojson tree path =
  ...
  ({
     connection_arn =
       (value_for_key app_runner_resource_arn_of_yojson "ConnectionArn" _list
          path)
