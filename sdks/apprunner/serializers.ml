...
let vpc_ingress_connection_summary_to_yojson
  (x : vpc_ingress_connection_summary) =
  assoc_to_yojson
    [("ServiceArn",
       (option_to_yojson app_runner_resource_arn_to_yojson x.service_arn));
    ("VpcIngressConnectionArn",
      (option_to_yojson app_runner_resource_arn_to_yojson
         x.vpc_ingress_connection_arn))]
...
let vpc_ingress_connection_status_to_yojson
  (x : vpc_ingress_connection_status) =
  match x with
...
let vpc_ingress_connection_to_yojson (x : vpc_ingress_connection) =
  assoc_to_yojson
    [("DeletedAt", (option_to_yojson timestamp__to_yojson x.deleted_at));
    ("CreatedAt", (option_to_yojson timestamp__to_yojson x.created_at));
    ("IngressVpcConfiguration",
      (option_to_yojson ingress_vpc_configuration_to_yojson
         x.ingress_vpc_configuration));
    ...
    ("VpcIngressConnectionName",
      (option_to_yojson vpc_ingress_connection_name_to_yojson
         x.vpc_ingress_connection_name));
    ("VpcIngressConnectionArn",
      (option_to_yojson app_runner_resource_arn_to_yojson
         x.vpc_ingress_connection_arn))]
let vpc_dns_target_to_yojson (x : vpc_dns_target) =
  assoc_to_yojson
    ...
    ("VpcIngressConnectionArn",
      (option_to_yojson app_runner_resource_arn_to_yojson
         x.vpc_ingress_connection_arn))]
let vpc_dns_target_list_to_yojson tree =
  list_to_yojson vpc_dns_target_to_yojson tree
...
let vpc_connectors_to_yojson tree =
  list_to_yojson vpc_connector_to_yojson tree
let update_vpc_ingress_connection_response_to_yojson
  (x : update_vpc_ingress_connection_response) =
  assoc_to_yojson
    [("VpcIngressConnection",
       (Some (vpc_ingress_connection_to_yojson x.vpc_ingress_connection)))]
let update_vpc_ingress_connection_request_to_yojson
  (x : update_vpc_ingress_connection_request) =
  assoc_to_yojson
    [("IngressVpcConfiguration",
       (Some
          (ingress_vpc_configuration_to_yojson x.ingress_vpc_configuration)));
    ("VpcIngressConnectionArn",
...
let internal_service_error_exception_to_yojson
  (x : internal_service_error_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let code_configuration_values_to_yojson (x : code_configuration_values) =
  assoc_to_yojson
    [("RuntimeEnvironmentSecrets",
       (option_to_yojson runtime_environment_secrets_to_yojson
          x.runtime_environment_secrets));
    ("RuntimeEnvironmentVariables",
      (option_to_yojson runtime_environment_variables_to_yojson
         x.runtime_environment_variables));
...
let code_configuration_to_yojson (x : code_configuration) =
  assoc_to_yojson
    [("CodeConfigurationValues",
       (option_to_yojson code_configuration_values_to_yojson
          x.code_configuration_values));
    ("ConfigurationSource",
...
let health_check_configuration_to_yojson (x : health_check_configuration) =
  assoc_to_yojson
    [("UnhealthyThreshold",
       (option_to_yojson health_check_unhealthy_threshold_to_yojson
          x.unhealthy_threshold));
    ("HealthyThreshold",
      (option_to_yojson health_check_healthy_threshold_to_yojson
         x.healthy_threshold));
...
let auto_scaling_configuration_status_to_yojson
  (x : auto_scaling_configuration_status) =
  match x with | INACTIVE -> `String "INACTIVE" | ACTIVE -> `String "ACTIVE"
...
let auto_scaling_configuration_summary_to_yojson
  (x : auto_scaling_configuration_summary) =
  assoc_to_yojson
    [("IsDefault", (option_to_yojson is_default_to_yojson x.is_default));
    ("HasAssociatedService",
      (option_to_yojson has_associated_service_to_yojson
         x.has_associated_service));
    ("CreatedAt", (option_to_yojson timestamp__to_yojson x.created_at));
    ("Status",
    ...
    ("AutoScalingConfigurationName",
      (option_to_yojson auto_scaling_configuration_name_to_yojson
         x.auto_scaling_configuration_name));
    ("AutoScalingConfigurationArn",
      (option_to_yojson app_runner_resource_arn_to_yojson
         x.auto_scaling_configuration_arn))]
...
let network_configuration_to_yojson (x : network_configuration) =
  assoc_to_yojson
    ...
    ("IngressConfiguration",
      (option_to_yojson ingress_configuration_to_yojson
         x.ingress_configuration));
    ("EgressConfiguration",
      (option_to_yojson egress_configuration_to_yojson x.egress_configuration))]
let service_observability_configuration_to_yojson
  (x : service_observability_configuration) =
  assoc_to_yojson
    [("ObservabilityConfigurationArn",
       (option_to_yojson app_runner_resource_arn_to_yojson
          x.observability_configuration_arn));
    ("ObservabilityEnabled",
      (Some (boolean__to_yojson x.observability_enabled)))]
let service_to_yojson (x : service) =
  assoc_to_yojson
    [("ObservabilityConfiguration",
       (option_to_yojson service_observability_configuration_to_yojson
          x.observability_configuration));
    ("NetworkConfiguration",
      (Some (network_configuration_to_yojson x.network_configuration)));
    ("AutoScalingConfigurationSummary",
      (Some
         (auto_scaling_configuration_summary_to_yojson
            x.auto_scaling_configuration_summary)));
    ("HealthCheckConfiguration",
      (option_to_yojson health_check_configuration_to_yojson
         x.health_check_configuration));
  ...
  assoc_to_yojson
    ...
    ("AutoScalingConfigurationArn",
      (option_to_yojson app_runner_resource_arn_to_yojson
         x.auto_scaling_configuration_arn));
    ("InstanceConfiguration",
      (option_to_yojson instance_configuration_to_yojson
         x.instance_configuration));
    ("SourceConfiguration",
...
let update_default_auto_scaling_configuration_response_to_yojson
  ...
  assoc_to_yojson
    [("AutoScalingConfiguration",
       (Some
          (auto_scaling_configuration_to_yojson x.auto_scaling_configuration)))]
...
let tracing_vendor_to_yojson (x : tracing_vendor) =
  match x with | AWSXRAY -> `String "AWSXRAY"
...
let service_arn_list_to_yojson tree =
  list_to_yojson app_runner_resource_arn_to_yojson tree
...
let operation_summary_to_yojson (x : operation_summary) =
  assoc_to_yojson
    [("UpdatedAt", (option_to_yojson timestamp__to_yojson x.updated_at));
    ("EndedAt", (option_to_yojson timestamp__to_yojson x.ended_at));
    ("StartedAt", (option_to_yojson timestamp__to_yojson x.started_at));
    ("TargetArn",
...
let operation_summary_list_to_yojson tree =
  list_to_yojson operation_summary_to_yojson tree
let observability_configuration_name_to_yojson = string_to_yojson
let observability_configuration_summary_to_yojson
  (x : observability_configuration_summary) =
  assoc_to_yojson
    [("ObservabilityConfigurationRevision",
       (option_to_yojson integer__to_yojson
          x.observability_configuration_revision));
...
let observability_configuration_status_to_yojson
  (x : observability_configuration_status) =
  match x with | INACTIVE -> `String "INACTIVE" | ACTIVE -> `String "ACTIVE"
...
let list_vpc_ingress_connections_response_to_yojson
  (x : list_vpc_ingress_connections_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("VpcIngressConnectionSummaryList",
      (Some
         (vpc_ingress_connection_summary_list_to_yojson
            x.vpc_ingress_connection_summary_list)))]
let list_vpc_ingress_connections_filter_to_yojson
  (x : list_vpc_ingress_connections_filter) =
  assoc_to_yojson
    [("VpcEndpointId",
       (option_to_yojson string__to_yojson x.vpc_endpoint_id));
    ("ServiceArn",
...
let list_vpc_ingress_connections_request_to_yojson
  (x : list_vpc_ingress_connections_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("Filter",
      (option_to_yojson list_vpc_ingress_connections_filter_to_yojson
         x.filter))]
...
let list_operations_response_to_yojson (x : list_operations_response) =
  assoc_to_yojson
    ...
    ("OperationSummaryList",
      (option_to_yojson operation_summary_list_to_yojson
         x.operation_summary_list))]
...
let connection_summary_list_to_yojson tree =
  list_to_yojson connection_summary_to_yojson tree
...
let certificate_validation_record_status_to_yojson
  (x : certificate_validation_record_status) =
  match x with
  | FAILED -> `String "FAILED"
  | SUCCESS -> `String "SUCCESS"
  | PENDING_VALIDATION -> `String "PENDING_VALIDATION"
let certificate_validation_record_to_yojson
  (x : certificate_validation_record) =
  assoc_to_yojson
    [("Status",
       (option_to_yojson certificate_validation_record_status_to_yojson
          x.status));
...
let custom_domain_association_status_to_yojson
  (x : custom_domain_association_status) =
  match x with
...
let disassociate_custom_domain_response_to_yojson
  (x : disassociate_custom_domain_response) =
  assoc_to_yojson
    [("VpcDNSTargets",
...
let disassociate_custom_domain_request_to_yojson
  (x : disassociate_custom_domain_request) =
  assoc_to_yojson
    [("DomainName", (Some (domain_name_to_yojson x.domain_name)));
    ("ServiceArn", (Some (app_runner_resource_arn_to_yojson x.service_arn)))]
...
let describe_vpc_ingress_connection_request_to_yojson
  (x : describe_vpc_ingress_connection_request) =
  assoc_to_yojson
    [("VpcIngressConnectionArn",
       (Some (app_runner_resource_arn_to_yojson x.vpc_ingress_connection_arn)))]
let describe_vpc_connector_response_to_yojson
  (x : describe_vpc_connector_response) =
  assoc_to_yojson
    [("VpcConnector", (Some (vpc_connector_to_yojson x.vpc_connector)))]
let describe_vpc_connector_request_to_yojson
  (x : describe_vpc_connector_request) =
  assoc_to_yojson
    [("VpcConnectorArn",
...
let describe_observability_configuration_response_to_yojson
  ...
  assoc_to_yojson
    [("ObservabilityConfiguration",
       (Some
          (observability_configuration_to_yojson
             x.observability_configuration)))]
let describe_observability_configuration_request_to_yojson
  ...
  assoc_to_yojson
    [("ObservabilityConfigurationArn",
       (Some
          (app_runner_resource_arn_to_yojson
             x.observability_configuration_arn)))]
let custom_domain_list_to_yojson tree =
  list_to_yojson custom_domain_to_yojson tree
let describe_custom_domains_response_to_yojson
  (x : describe_custom_domains_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("VpcDNSTargets",
      (Some (vpc_dns_target_list_to_yojson x.vpc_dns_targets)));
...
let describe_custom_domains_request_to_yojson
  (x : describe_custom_domains_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson describe_custom_domains_max_results_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("ServiceArn", (Some (app_runner_resource_arn_to_yojson x.service_arn)))]
...
let delete_vpc_ingress_connection_response_to_yojson
  (x : delete_vpc_ingress_connection_response) =
  assoc_to_yojson
    [("VpcIngressConnection",
       (Some (vpc_ingress_connection_to_yojson x.vpc_ingress_connection)))]
let delete_vpc_ingress_connection_request_to_yojson
  (x : delete_vpc_ingress_connection_request) =
  assoc_to_yojson
    [("VpcIngressConnectionArn",
       (Some (app_runner_resource_arn_to_yojson x.vpc_ingress_connection_arn)))]
let delete_vpc_connector_response_to_yojson
  (x : delete_vpc_connector_response) =
  assoc_to_yojson
    [("VpcConnector", (Some (vpc_connector_to_yojson x.vpc_connector)))]
...
let delete_connection_response_to_yojson (x : delete_connection_response) =
  assoc_to_yojson
    [("Connection", (option_to_yojson connection_to_yojson x.connection))]
...
let create_vpc_ingress_connection_response_to_yojson
  (x : create_vpc_ingress_connection_response) =
  assoc_to_yojson
    [("VpcIngressConnection",
       (Some (vpc_ingress_connection_to_yojson x.vpc_ingress_connection)))]
let create_vpc_ingress_connection_request_to_yojson
  (x : create_vpc_ingress_connection_request) =
  assoc_to_yojson
    ...
    ("VpcIngressConnectionName",
      (Some
         (vpc_ingress_connection_name_to_yojson x.vpc_ingress_connection_name)));
    ("ServiceArn", (Some (app_runner_resource_arn_to_yojson x.service_arn)))]
let create_vpc_connector_response_to_yojson
  (x : create_vpc_connector_response) =
  assoc_to_yojson
    [("VpcConnector", (Some (vpc_connector_to_yojson x.vpc_connector)))]
...
let create_observability_configuration_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ObservabilityConfigurationName",
      (Some
         (observability_configuration_name_to_yojson
            x.observability_configuration_name)))]
let create_connection_response_to_yojson (x : create_connection_response) =
  assoc_to_yojson
    [("Connection", (Some (connection_to_yojson x.connection)))]
...
let create_auto_scaling_configuration_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AutoScalingConfigurationName",
      (Some
         (auto_scaling_configuration_name_to_yojson
            x.auto_scaling_configuration_name)))]
let associate_custom_domain_response_to_yojson
  (x : associate_custom_domain_response) =
  assoc_to_yojson
    [("VpcDNSTargets",
       (Some (vpc_dns_target_list_to_yojson x.vpc_dns_targets)));
    ("CustomDomain", (Some (custom_domain_to_yojson x.custom_domain)));
...
let associate_custom_domain_request_to_yojson
  (x : associate_custom_domain_request) =
  assoc_to_yojson
    [("EnableWWWSubdomain",
