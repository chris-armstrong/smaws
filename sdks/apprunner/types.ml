...
type nonrec vpc_connector_status = INACTIVE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec configuration_source = API [@ocaml.doc ""] | REPOSITORY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec image_repository_type = ECR_PUBLIC [@ocaml.doc ""] | ECR [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec health_check_protocol = HTTP [@ocaml.doc ""] | TCP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec auto_scaling_configuration_status = INACTIVE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec egress_type = VPC [@ocaml.doc ""] | DEFAULT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec provider_type = BITBUCKET [@ocaml.doc ""] | GITHUB [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec observability_configuration_status = INACTIVE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
