...
type nonrec vpc_ingress_connection_summary_list =
  vpc_ingress_connection_summary list[@@ocaml.doc ""]
...
type nonrec runtime_environment_variables =
  (runtime_environment_variables_key * runtime_environment_variables_value)
    list[@@ocaml.doc ""]
...
type nonrec auto_scaling_configuration =
  ...
  auto_scaling_configuration_revision:
    auto_scaling_configuration_revision option
    [@ocaml.doc
...
type nonrec certificate_validation_record_list =
  certificate_validation_record list[@@ocaml.doc ""]
...
val make_ingress_vpc_configuration :
  ?vpc_endpoint_id:string_ ->
    ?vpc_id:string_ -> unit -> ingress_vpc_configuration
...
val make_code_repository :
  ?source_directory:source_directory ->
    ?code_configuration:code_configuration ->
      source_code_version:source_code_version ->
        repository_url:string_ -> unit -> code_repository
...
val make_image_repository :
  ?image_configuration:image_configuration ->
    image_repository_type:image_repository_type ->
      image_identifier:image_identifier -> unit -> image_repository
...
val make_instance_configuration :
  ?instance_role_arn:role_arn ->
    ?memory:memory -> ?cpu:cpu -> unit -> instance_configuration
val make_encryption_configuration :
  kms_key:kms_key_arn -> unit -> encryption_configuration
...
val make_ingress_configuration :
  ?is_publicly_accessible:boolean_ -> unit -> ingress_configuration
                    ...
                    status:service_status ->
                      updated_at:timestamp ->
                        created_at:timestamp ->
                          service_arn:app_runner_resource_arn ->
                            service_id:service_id ->
                              service_name:service_name -> unit -> service
...
val make_untag_resource_request :
  tag_keys:tag_key_list ->
    resource_arn:app_runner_resource_arn -> unit -> untag_resource_request
...
val make_tag_resource_request :
  tags:tag_list ->
    resource_arn:app_runner_resource_arn -> unit -> tag_resource_request
val make_start_deployment_response :
  operation_id:uui_d -> unit -> start_deployment_response
    ...
    ?updated_at:timestamp ->
      ?created_at:timestamp ->
        ?service_url:string_ ->
          ?service_arn:app_runner_resource_arn ->
            ?service_id:service_id ->
              ?service_name:service_name -> unit -> service_summary
      ...
      ?started_at:timestamp ->
        ?target_arn:app_runner_resource_arn ->
          ?status:operation_status ->
            ?type_:operation_type -> ?id:uui_d -> unit -> operation_summary
...
val make_list_vpc_ingress_connections_filter :
  ?vpc_endpoint_id:string_ ->
    ?service_arn:app_runner_resource_arn ->
      unit -> list_vpc_ingress_connections_filter
...
val make_list_vpc_connectors_response :
  ?next_token:next_token ->
    vpc_connectors:vpc_connectors -> unit -> list_vpc_connectors_response
val make_list_vpc_connectors_request :
  ?next_token:next_token ->
    ?max_results:max_results -> unit -> list_vpc_connectors_request
...
val make_list_services_request :
  ?max_results:service_max_results ->
    ?next_token:string_ -> unit -> list_services_request
...
val make_list_operations_request :
  ?max_results:list_operations_max_results ->
    ?next_token:string_ ->
      service_arn:app_runner_resource_arn -> unit -> list_operations_request
val make_list_observability_configurations_response :
  ?next_token:next_token ->
    observability_configuration_summary_list:observability_configuration_summary_list
      -> unit -> list_observability_configurations_response
...
val make_connection_summary :
  ?created_at:timestamp ->
    ?status:connection_status ->
      ?provider_type:provider_type ->
        ?connection_arn:app_runner_resource_arn ->
          ?connection_name:connection_name -> unit -> connection_summary
...
val make_list_connections_request :
  ?next_token:next_token ->
    ?max_results:max_results ->
      ?connection_name:connection_name -> unit -> list_connections_request
val make_list_auto_scaling_configurations_response :
  ?next_token:next_token ->
    auto_scaling_configuration_summary_list:auto_scaling_configuration_summary_list
      -> unit -> list_auto_scaling_configurations_response
...
val make_certificate_validation_record :
  ?status:certificate_validation_record_status ->
    ?value:string_ ->
      ?type_:string_ ->
        ?name:string_ -> unit -> certificate_validation_record
val make_custom_domain :
  ?certificate_validation_records:certificate_validation_record_list ->
    status:custom_domain_association_status ->
      enable_www_subdomain:nullable_boolean ->
        domain_name:domain_name -> unit -> custom_domain
val make_disassociate_custom_domain_response :
  vpc_dns_targets:vpc_dns_target_list ->
    custom_domain:custom_domain ->
      service_arn:app_runner_resource_arn ->
        dns_target:string_ -> unit -> disassociate_custom_domain_response
val make_disassociate_custom_domain_request :
  domain_name:domain_name ->
    service_arn:app_runner_resource_arn ->
      unit -> disassociate_custom_domain_request
...
val make_describe_vpc_connector_request :
  vpc_connector_arn:app_runner_resource_arn ->
    unit -> describe_vpc_connector_request
...
val make_describe_custom_domains_response :
  ?next_token:string_ ->
    vpc_dns_targets:vpc_dns_target_list ->
      custom_domains:custom_domain_list ->
        service_arn:app_runner_resource_arn ->
          dns_target:string_ -> unit -> describe_custom_domains_response
val make_describe_custom_domains_request :
  ?max_results:describe_custom_domains_max_results ->
    ?next_token:string_ ->
      service_arn:app_runner_resource_arn ->
        unit -> describe_custom_domains_request
...
val make_delete_vpc_connector_request :
  vpc_connector_arn:app_runner_resource_arn ->
    unit -> delete_vpc_connector_request
...
val make_create_vpc_ingress_connection_request :
  ?tags:tag_list ->
    ingress_vpc_configuration:ingress_vpc_configuration ->
      vpc_ingress_connection_name:vpc_ingress_connection_name ->
        service_arn:app_runner_resource_arn ->
          unit -> create_vpc_ingress_connection_request
        ...
        ?health_check_configuration:health_check_configuration ->
          ?encryption_configuration:encryption_configuration ->
            ?tags:tag_list ->
              ?instance_configuration:instance_configuration ->
                source_configuration:source_configuration ->
                  service_name:service_name -> unit -> create_service_request
...
val make_create_connection_request :
  ?tags:tag_list ->
    provider_type:provider_type ->
      connection_name:connection_name -> unit -> create_connection_request
...
val make_associate_custom_domain_response :
  vpc_dns_targets:vpc_dns_target_list ->
    custom_domain:custom_domain ->
      service_arn:app_runner_resource_arn ->
        dns_target:string_ -> unit -> associate_custom_domain_response
val make_associate_custom_domain_request :
  ?enable_www_subdomain:nullable_boolean ->
    domain_name:domain_name ->
      service_arn:app_runner_resource_arn ->
        unit -> associate_custom_domain_request(** {1:operations Operations} *)
