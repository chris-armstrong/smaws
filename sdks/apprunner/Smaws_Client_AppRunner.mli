...
val make_associate_custom_domain_request :
  ?enable_www_subdomain:nullable_boolean ->
    domain_name:domain_name ->
      service_arn:app_runner_resource_arn ->
        unit -> associate_custom_domain_request
...
sig
  val error_to_string :
    ...
    | `InvalidStateException of invalid_state_exception ] -> string
  val request :
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `InternalServiceErrorException of internal_service_error_exception 
    | `InvalidRequestException of invalid_request_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
