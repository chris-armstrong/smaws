...
let update_event_bus_response_of_yojson tree path =
  ...
  ({
     ...
     description =
       (option_of_yojson
          (value_for_key event_bus_description_of_yojson "Description") _list
          path);
     kms_key_identifier =
       (option_of_yojson
...
let endpoint_event_bus_of_yojson tree path =
  ...
  ({
     event_bus_arn =
       (value_for_key non_partner_event_bus_arn_of_yojson "EventBusArn" _list
          path)
   } : endpoint_event_bus)
  ...
  ({
     state =
       (option_of_yojson (value_for_key endpoint_state_of_yojson "State")
          _list path);
     endpoint_url =
       (option_of_yojson (value_for_key endpoint_url_of_yojson "EndpointUrl")
          _list path);
     endpoint_id =
     ...
     arn =
       (option_of_yojson (value_for_key endpoint_arn_of_yojson "Arn") _list
          path);
     name =
       (option_of_yojson (value_for_key endpoint_name_of_yojson "Name") _list
          path)
...
let update_connection_response_of_yojson tree path =
  ...
  ({
     last_authorized_time =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "LastAuthorizedTime") _list path);
     last_modified_time =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "LastModifiedTime") _list path);
     creation_time =
       (option_of_yojson (value_for_key timestamp_of_yojson "CreationTime")
          _list path);
     connection_state =
       (option_of_yojson
...
let connection_header_parameter_of_yojson tree path =
  ...
  ({
     ...
     value =
       (option_of_yojson
          (value_for_key header_value_sensitive_of_yojson "Value") _list path);
     key =
...
let run_command_target_of_yojson tree path =
  ...
  ({
     values =
       (value_for_key run_command_target_values_of_yojson "Values" _list path);
...
let run_command_parameters_of_yojson tree path =
  ...
  ({
     run_command_targets =
       (value_for_key run_command_targets_of_yojson "RunCommandTargets" _list
          path)
...
let ecs_parameters_of_yojson tree path =
  ...
  ({
     ...
     reference_id =
       (option_of_yojson (value_for_key reference_id_of_yojson "ReferenceId")
          _list path);
     propagate_tags =
       (option_of_yojson
     ...
     group =
       (option_of_yojson (value_for_key string__of_yojson "Group") _list path);
     platform_version =
...
let batch_array_properties_of_yojson tree path =
  ...
  ({
     size =
       (option_of_yojson (value_for_key integer_of_yojson "Size") _list path)
   } : batch_array_properties)
let batch_retry_strategy_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  ({
     attempts =
       (option_of_yojson (value_for_key integer_of_yojson "Attempts") _list
          path)
...
let redshift_data_parameters_of_yojson tree path =
  ...
  ({
     ...
     with_event =
       (option_of_yojson (value_for_key boolean__of_yojson "WithEvent") _list
          path);
     statement_name =
       (option_of_yojson
          (value_for_key statement_name_of_yojson "StatementName") _list path);
  ...
  ({
     app_sync_parameters =
       (option_of_yojson
          ...
          _list path);
     retry_policy =
       (option_of_yojson (value_for_key retry_policy_of_yojson "RetryPolicy")
          _list path);
     dead_letter_config =
       (option_of_yojson
          (value_for_key dead_letter_config_of_yojson "DeadLetterConfig")
     ...
     sqs_parameters =
       (option_of_yojson
          (value_for_key sqs_parameters_of_yojson "SqsParameters") _list path);
     batch_parameters =
       (option_of_yojson
     ...
     ecs_parameters =
       (option_of_yojson
          (value_for_key ecs_parameters_of_yojson "EcsParameters") _list path);
     run_command_parameters =
       (option_of_yojson
     ...
     input =
       (option_of_yojson (value_for_key target_input_of_yojson "Input") _list
          path);
     role_arn =
...
let start_replay_response_of_yojson tree path =
  ...
  ({
     replay_start_time =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "ReplayStartTime") _list path);
     state_reason =
       (option_of_yojson
...
let start_replay_request_of_yojson tree path =
  ...
  ({
     ...
     event_end_time =
       (value_for_key timestamp_of_yojson "EventEndTime" _list path);
     event_start_time =
       (value_for_key timestamp_of_yojson "EventStartTime" _list path);
     event_source_arn =
...
let rule_of_yojson tree path =
  ...
  ({
     ...
     description =
       (option_of_yojson
          (value_for_key rule_description_of_yojson "Description") _list path);
     state =
...
let replay_of_yojson tree path =
  ...
  ({
     replay_end_time =
       (option_of_yojson (value_for_key timestamp_of_yojson "ReplayEndTime")
          _list path);
     replay_start_time =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "ReplayStartTime") _list path);
     event_last_replayed_time =
       (option_of_yojson
          (value_for_key timestamp_of_yojson "EventLastReplayedTime") _list
          path);
     event_end_time =
       (option_of_yojson (value_for_key timestamp_of_yojson "EventEndTime")
          _list path);
     event_start_time =
       (option_of_yojson (value_for_key timestamp_of_yojson "EventStartTime")
          _list path);
     state_reason =
       (option_of_yojson
          (value_for_key replay_state_reason_of_yojson "StateReason") _list
  ...
  ({
     ...
     error_code =
       (option_of_yojson (value_for_key error_code_of_yojson "ErrorCode")
          _list path);
     target_id =
       (option_of_yojson (value_for_key target_id_of_yojson "TargetId") _list
          path)
...
let remove_targets_response_of_yojson tree path =
  ...
  ({
     ...
     failed_entry_count =
       (option_of_yojson (value_for_key integer_of_yojson "FailedEntryCount")
          _list path)
  ...
  ({
     ...
     remove_all_permissions =
       (option_of_yojson
          ...
          path);
     statement_id =
       (option_of_yojson (value_for_key statement_id_of_yojson "StatementId")
          _list path)
  ...
  ({
     ...
     resources =
       (option_of_yojson
          ...
          path);
     source =
       (option_of_yojson (value_for_key event_source_name_of_yojson "Source")
          _list path);
     time =
  ...
  ({
     endpoint_id =
       (option_of_yojson (value_for_key endpoint_id_of_yojson "EndpointId")
          _list path);
     entries =
       (value_for_key put_events_request_entry_list_of_yojson "Entries" _list
          path)
   } : put_events_request)
...
let partner_event_source_account_of_yojson tree path =
  ...
  ({
     state =
       (option_of_yojson (value_for_key event_source_state_of_yojson "State")
          _list path);
     expiration_time =
       (option_of_yojson (value_for_key timestamp_of_yojson "ExpirationTime")
          _list path);
     creation_time =
       (option_of_yojson (value_for_key timestamp_of_yojson "CreationTime")
          _list path);
     account =
       (option_of_yojson (value_for_key account_id_of_yojson "Account") _list
          path)
...
let list_targets_by_rule_request_of_yojson tree path =
  ...
  ({
     limit =
       (option_of_yojson (value_for_key limit_max100_of_yojson "Limit") _list
          path);
     next_token =
       (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
          _list path);
  ...
  ({
     next_token =
       (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
          _list path);
     rules =
       (option_of_yojson (value_for_key rule_response_list_of_yojson "Rules")
          _list path)
   } : list_rules_response)
  ...
  ({
     next_token =
       (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
          _list path);
     rule_names =
       (option_of_yojson (value_for_key rule_name_list_of_yojson "RuleNames")
          _list path)
  ...
  ({
     ...
     next_token =
       (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
          _list path);
     name_prefix =
       (value_for_key partner_event_source_name_prefix_of_yojson "NamePrefix"
          _list path)
...
let endpoint_of_yojson tree path =
  ...
  ({
     ...
     state_reason =
       (option_of_yojson
          (value_for_key endpoint_state_reason_of_yojson "StateReason") _list
          path);
     state =
       (option_of_yojson (value_for_key endpoint_state_of_yojson "State")
          _list path);
  ...
  ({
     ...
     home_region =
       (option_of_yojson (value_for_key home_region_of_yojson "HomeRegion")
          _list path);
     name_prefix =
       (option_of_yojson (value_for_key endpoint_name_of_yojson "NamePrefix")
          _list path)
