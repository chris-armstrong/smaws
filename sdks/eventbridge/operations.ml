  ...
  struct
    ...
    let request context (request : cancel_replay_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSEventsCancelReplay" ~service ~config:context.config
...
module CreateEndpoint =
  struct
    ...
    let request context (request : create_endpoint_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_endpoint_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module CreateEventBus =
  struct
    ...
    let request context (request : create_event_bus_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.create_event_bus_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteEndpoint =
  struct
    ...
    let request context (request : delete_endpoint_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_endpoint_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DeleteEventBus =
  struct
    ...
    let request context (request : delete_event_bus_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.delete_event_bus_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : delete_rule_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEventsDeleteRule"
...
module DescribeArchive =
  struct
    ...
    let request context (request : describe_archive_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_archive_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribeReplay =
  struct
    ...
    let request context (request : describe_replay_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_replay_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : describe_rule_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSEventsDescribeRule" ~service ~config:context.config
          ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : disable_rule_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSEventsDisableRule" ~service ~config:context.config
          ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
  ...
  struct
    ...
    let request context (request : enable_rule_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEventsEnableRule"
          ~service ~config:context.config ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
  ...
  struct
    ...
    let request context (request : list_archives_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSEventsListArchives" ~service ~config:context.config
          ~http:context.http ~input
...
module ListConnections =
  struct
    ...
    let request context (request : list_connections_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_connections_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module ListEventBuses =
  struct
    ...
    let request context (request : list_event_buses_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_event_buses_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module ListPartnerEventSources =
  struct
    ...
    let request context (request : list_partner_event_sources_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_partner_event_sources_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : list_replays_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSEventsListReplays" ~service ~config:context.config
          ~http:context.http ~input
...
module ListRuleNamesByTarget =
  struct
    ...
    let request context (request : list_rule_names_by_target_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.list_rule_names_by_target_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
  ...
  struct
    ...
    let request context (request : list_rules_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEventsListRules"
          ~service ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : put_events_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEventsPutEvents"
          ~service ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : put_targets_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEventsPutTargets"
          ~service ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : start_replay_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSEventsStartReplay" ~service ~config:context.config
          ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : tag_resource_request) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"AWSEventsTagResource" ~service ~config:context.config
          ~http:context.http ~input
...
module UpdateEndpoint =
  struct
    ...
    let request context (request : update_endpoint_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_endpoint_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
...
module UpdateEventBus =
  struct
    ...
    let request context (request : update_event_bus_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.update_event_bus_request_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
