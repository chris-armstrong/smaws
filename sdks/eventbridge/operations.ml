  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "InternalException") ->
            `InternalException
              (Json_deserializers.internal_exception_of_yojson tree path)
        ...
        | (_, "OperationDisabledException") ->
            `OperationDisabledException
              (Json_deserializers.operation_disabled_exception_of_yojson tree
                 path)
    ...
    let request context (request : activate_event_source_request) =
      let input =
        Json_serializers.activate_event_source_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ActivateEventSource" ~service ~context ~input
...
module CancelReplay =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "IllegalStatusException") ->
            `IllegalStatusException
              (Json_deserializers.illegal_status_exception_of_yojson tree
                 path)
        | (_, "InternalException") ->
            `InternalException
              (Json_deserializers.internal_exception_of_yojson tree path)
    ...
    let request context (request : cancel_replay_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.CancelReplay" ~service ~context ~input
        ~output_deserializer:Json_deserializers.cancel_replay_response_of_yojson
        ~error_deserializer
  end
module CreateApiDestination =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ResourceAlreadyExistsException") ->
            `ResourceAlreadyExistsException
              (Json_deserializers.resource_already_exists_exception_of_yojson
                 tree path)
        | (_, "ResourceNotFoundException") ->
            `ResourceNotFoundException
              (Json_deserializers.resource_not_found_exception_of_yojson tree
    ...
    let request context (request : create_api_destination_request) =
      let input =
        Json_serializers.create_api_destination_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.CreateApiDestination" ~service ~context ~input
...
module CreateArchive =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "InvalidEventPatternException") ->
            `InvalidEventPatternException
              (Json_deserializers.invalid_event_pattern_exception_of_yojson
                 tree path)
        | (_, "LimitExceededException") ->
            `LimitExceededException
              (Json_deserializers.limit_exceeded_exception_of_yojson tree
    ...
    let request context (request : create_archive_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.CreateArchive" ~service ~context ~input
        ~output_deserializer:Json_deserializers.create_archive_response_of_yojson
        ~error_deserializer
  end
module CreateConnection =
  struct
    ...
    let request context (request : create_connection_request) =
      let input =
        Json_serializers.create_connection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.CreateConnection" ~service ~context ~input
...
module CreateEndpoint =
  struct
    ...
    let request context (request : create_endpoint_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.CreateEndpoint" ~service ~context ~input
        ~output_deserializer:Json_deserializers.create_endpoint_response_of_yojson
        ~error_deserializer
  end
module CreateEventBus =
  struct
    ...
    let request context (request : create_event_bus_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.CreateEventBus" ~service ~context ~input
...
module CreatePartnerEventSource =
  struct
    ...
    let request context (request : create_partner_event_source_request) =
      let input =
        Json_serializers.create_partner_event_source_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.CreatePartnerEventSource" ~service ~context
        ~input
...
module DeactivateEventSource =
  struct
    ...
    let request context (request : deactivate_event_source_request) =
      let input =
        Json_serializers.deactivate_event_source_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DeactivateEventSource" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeauthorizeConnection =
  struct
    ...
    let request context (request : deauthorize_connection_request) =
      let input =
        Json_serializers.deauthorize_connection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DeauthorizeConnection" ~service ~context
        ~input
...
module DeleteApiDestination =
  struct
    ...
    let request context (request : delete_api_destination_request) =
      let input =
        Json_serializers.delete_api_destination_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DeleteApiDestination" ~service ~context ~input
...
module DeleteArchive =
  struct
    ...
    let request context (request : delete_archive_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DeleteArchive" ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_archive_response_of_yojson
        ~error_deserializer
  end
module DeleteConnection =
  struct
    ...
    let request context (request : delete_connection_request) =
      let input =
        Json_serializers.delete_connection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DeleteConnection" ~service ~context ~input
...
module DeleteEndpoint =
  struct
    ...
    let request context (request : delete_endpoint_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DeleteEndpoint" ~service ~context ~input
        ~output_deserializer:Json_deserializers.delete_endpoint_response_of_yojson
        ~error_deserializer
  end
module DeleteEventBus =
  struct
    ...
    let request context (request : delete_event_bus_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DeleteEventBus" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeletePartnerEventSource =
  struct
    ...
    let request context (request : delete_partner_event_source_request) =
      let input =
        Json_serializers.delete_partner_event_source_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DeletePartnerEventSource" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module DeleteRule =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ManagedRuleException") ->
            `ManagedRuleException
              (Json_deserializers.managed_rule_exception_of_yojson tree path)
        | (_, "ResourceNotFoundException") ->
            `ResourceNotFoundException
              (Json_deserializers.resource_not_found_exception_of_yojson tree
                 path)
    ...
    let request context (request : delete_rule_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.DeleteRule"
...
module DescribeApiDestination =
  struct
    ...
    let request context (request : describe_api_destination_request) =
      let input =
        Json_serializers.describe_api_destination_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DescribeApiDestination" ~service ~context
        ~input
...
module DescribeArchive =
  struct
    ...
    let request context (request : describe_archive_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DescribeArchive" ~service ~context ~input
...
module DescribeConnection =
  struct
    ...
    let request context (request : describe_connection_request) =
      let input =
        Json_serializers.describe_connection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DescribeConnection" ~service ~context ~input
...
module DescribeEndpoint =
  struct
    ...
    let request context (request : describe_endpoint_request) =
      let input =
        Json_serializers.describe_endpoint_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DescribeEndpoint" ~service ~context ~input
...
module DescribeEventBus =
  struct
    ...
    let request context (request : describe_event_bus_request) =
      let input =
        Json_serializers.describe_event_bus_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DescribeEventBus" ~service ~context ~input
...
module DescribeEventSource =
  struct
    ...
    let request context (request : describe_event_source_request) =
      let input =
        Json_serializers.describe_event_source_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DescribeEventSource" ~service ~context ~input
...
module DescribePartnerEventSource =
  struct
    ...
    let request context (request : describe_partner_event_source_request) =
      let input =
        Json_serializers.describe_partner_event_source_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DescribePartnerEventSource" ~service ~context
        ~input
...
module DescribeReplay =
  struct
    ...
    let request context (request : describe_replay_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DescribeReplay" ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_replay_response_of_yojson
        ~error_deserializer
  end
module DescribeRule =
  struct
    ...
    let request context (request : describe_rule_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.DescribeRule" ~service ~context ~input
        ~output_deserializer:Json_deserializers.describe_rule_response_of_yojson
        ~error_deserializer
  end
module DisableRule =
  struct
    ...
    let request context (request : disable_rule_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.DisableRule"
        ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module EnableRule =
  struct
    ...
    let request context (request : enable_rule_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.EnableRule"
        ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module ListApiDestinations =
  struct
    ...
    let request context (request : list_api_destinations_request) =
      let input =
        Json_serializers.list_api_destinations_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListApiDestinations" ~service ~context ~input
...
module ListArchives =
  struct
    ...
    let request context (request : list_archives_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListArchives" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_archives_response_of_yojson
        ~error_deserializer
  end
module ListConnections =
  struct
    ...
    let request context (request : list_connections_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListConnections" ~service ~context ~input
...
module ListEndpoints =
  struct
    ...
    let request context (request : list_endpoints_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListEndpoints" ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_endpoints_response_of_yojson
        ~error_deserializer
  end
module ListEventBuses =
  struct
    ...
    let request context (request : list_event_buses_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListEventBuses" ~service ~context ~input
...
module ListEventSources =
  struct
    ...
    let request context (request : list_event_sources_request) =
      let input =
        Json_serializers.list_event_sources_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListEventSources" ~service ~context ~input
...
module ListPartnerEventSourceAccounts =
  struct
    ...
    let request context
      ...
      let input =
        Json_serializers.list_partner_event_source_accounts_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListPartnerEventSourceAccounts" ~service
        ~context ~input
...
module ListPartnerEventSources =
  struct
    ...
    let request context (request : list_partner_event_sources_request) =
      let input =
        Json_serializers.list_partner_event_sources_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListPartnerEventSources" ~service ~context
        ~input
...
module ListReplays =
  struct
    ...
    let request context (request : list_replays_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.ListReplays"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.list_replays_response_of_yojson
        ~error_deserializer
  end
module ListRuleNamesByTarget =
  struct
    ...
    let request context (request : list_rule_names_by_target_request) =
      let input =
        Json_serializers.list_rule_names_by_target_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListRuleNamesByTarget" ~service ~context
        ~input
...
module ListRules =
  struct
    ...
    let request context (request : list_rules_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.ListRules"
        ~service ~context ~input
...
module ListTagsForResource =
  struct
    ...
    let request context (request : list_tags_for_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListTagsForResource" ~service ~context ~input
...
module ListTargetsByRule =
  struct
    ...
    let request context (request : list_targets_by_rule_request) =
      let input =
        Json_serializers.list_targets_by_rule_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.ListTargetsByRule" ~service ~context ~input
...
module PutEvents =
  struct
    ...
    let request context (request : put_events_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.PutEvents"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.put_events_response_of_yojson
        ~error_deserializer
  end
module PutPartnerEvents =
  struct
    ...
    let request context (request : put_partner_events_request) =
      let input =
        Json_serializers.put_partner_events_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.PutPartnerEvents" ~service ~context ~input
...
module PutPermission =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "PolicyLengthExceededException") ->
            `PolicyLengthExceededException
              (Json_deserializers.policy_length_exceeded_exception_of_yojson
                 tree path)
        | (_, "ResourceNotFoundException") ->
            `ResourceNotFoundException
              (Json_deserializers.resource_not_found_exception_of_yojson tree
    ...
    let request context (request : put_permission_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.PutPermission" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module PutRule =
  struct
    ...
    let request context (request : put_rule_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.PutRule"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.put_rule_response_of_yojson
        ~error_deserializer
  end
module PutTargets =
  struct
    ...
    let request context (request : put_targets_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.PutTargets"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.put_targets_response_of_yojson
        ~error_deserializer
  end
module RemovePermission =
  struct
    ...
    let request context (request : remove_permission_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.RemovePermission" ~service ~context ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module RemoveTargets =
  struct
    ...
    let request context (request : remove_targets_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.RemoveTargets" ~service ~context ~input
        ~output_deserializer:Json_deserializers.remove_targets_response_of_yojson
        ~error_deserializer
  end
module StartReplay =
  struct
    ...
    let request context (request : start_replay_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.StartReplay"
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.start_replay_response_of_yojson
        ~error_deserializer
  end
module TagResource =
  struct
    ...
    let request context (request : tag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request ~shape_name:"AWSEvents.TagResource"
        ~service ~context ~input
...
module TestEventPattern =
  struct
    ...
    let request context (request : test_event_pattern_request) =
      let input =
        Json_serializers.test_event_pattern_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.TestEventPattern" ~service ~context ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.UntagResource" ~service ~context ~input
...
module UpdateApiDestination =
  struct
    ...
    let request context (request : update_api_destination_request) =
      let input =
        Json_serializers.update_api_destination_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.UpdateApiDestination" ~service ~context ~input
...
module UpdateArchive =
  struct
    ...
    let request context (request : update_archive_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.UpdateArchive" ~service ~context ~input
        ~output_deserializer:Json_deserializers.update_archive_response_of_yojson
        ~error_deserializer
  end
module UpdateConnection =
  struct
    ...
    let request context (request : update_connection_request) =
      let input =
        Json_serializers.update_connection_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.UpdateConnection" ~service ~context ~input
...
module UpdateEndpoint =
  struct
    ...
    let request context (request : update_endpoint_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.UpdateEndpoint" ~service ~context ~input
        ~output_deserializer:Json_deserializers.update_endpoint_response_of_yojson
        ~error_deserializer
  end
module UpdateEventBus =
  struct
    ...
    let request context (request : update_event_bus_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSEvents.UpdateEventBus" ~service ~context ~input
