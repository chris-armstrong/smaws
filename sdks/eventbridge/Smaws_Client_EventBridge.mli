...
val make_log_config : ?include_detail:include_detail -> ?level:level -> unit -> log_config
...
val make_failover_config : primary:primary -> secondary:secondary -> unit -> failover_config
...
val make_list_endpoints_response :
  ?endpoints:endpoint_list -> ?next_token:next_token -> unit -> list_endpoints_response
