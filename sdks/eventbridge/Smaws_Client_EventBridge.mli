...
type nonrec secondary =
  {
  route: route [@ocaml.doc "Defines the secondary Region.\n"]}[@@ocaml.doc
...
type nonrec connection_header_parameters_list =
  connection_header_parameter list[@@ocaml.doc ""]
...
type nonrec connection_query_string_parameters_list =
  connection_query_string_parameter list[@@ocaml.doc ""]
...
type nonrec update_api_destination_request =
  ...
  invocation_rate_limit_per_second:
    api_destination_invocation_rate_limit_per_second option
    [@ocaml.doc
...
type nonrec transformer_paths =
  (input_transformer_path_key * target_input_path) list[@@ocaml.doc ""]
...
type nonrec query_string_parameters_map =
  (query_string_key * query_string_value) list[@@ocaml.doc ""]
...
type nonrec sage_maker_pipeline_parameter_list =
  sage_maker_pipeline_parameter list[@@ocaml.doc ""]
...
type nonrec remove_targets_result_entry_list =
  remove_targets_result_entry list[@@ocaml.doc ""]
...
type nonrec put_partner_events_result_entry_list =
  put_partner_events_result_entry list[@@ocaml.doc ""]
...
type nonrec put_partner_events_request_entry_list =
  put_partner_events_request_entry list[@@ocaml.doc ""]
...
type nonrec partner_event_source_account_list =
  partner_event_source_account list[@@ocaml.doc ""]
...
val make_activate_event_source_request :
  name:event_source_name -> unit -> activate_event_source_request(** {1:operations Operations} *)
