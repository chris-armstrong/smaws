...
let start_replay_response_of_yojson tree path =
  ...
  ({
     replay_start_time =
       option_of_yojson (value_for_key timestamp__of_yojson "ReplayStartTime") _list path;
     state_reason =
...
let replay_of_yojson tree path =
  ...
  ({
     replay_end_time =
       option_of_yojson (value_for_key timestamp__of_yojson "ReplayEndTime") _list path;
     replay_start_time =
       option_of_yojson (value_for_key timestamp__of_yojson "ReplayStartTime") _list path;
     event_last_replayed_time =
       option_of_yojson (value_for_key timestamp__of_yojson "EventLastReplayedTime") _list path;
     event_end_time =
       option_of_yojson (value_for_key timestamp__of_yojson "EventEndTime") _list path;
     event_start_time =
       option_of_yojson (value_for_key timestamp__of_yojson "EventStartTime") _list path;
     state_reason =
       option_of_yojson (value_for_key replay_state_reason_of_yojson "StateReason") _list path;
     state = option_of_yojson (value_for_key replay_state_of_yojson "State") _list path;
     event_source_arn =
  ...
  ({
     failed_entries =
       option_of_yojson
         ...
         _list path;
     failed_entry_count =
       option_of_yojson (value_for_key integer__of_yojson "FailedEntryCount") _list path;
   }
...
let partner_event_source_account_of_yojson tree path =
  ...
  ({
     ...
     expiration_time =
       option_of_yojson (value_for_key timestamp__of_yojson "ExpirationTime") _list path;
     creation_time = option_of_yojson (value_for_key timestamp__of_yojson "CreationTime") _list path;
