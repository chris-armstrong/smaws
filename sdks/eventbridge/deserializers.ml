  ...
  let _res : update_event_bus_response =
    {
      ...
      description =
        (option_of_yojson
           (value_for_key event_bus_description_of_yojson "Description")
           _list path);
      kms_key_identifier =
        (option_of_yojson
           ...
           _list path);
      name =
        (option_of_yojson (value_for_key event_bus_name_of_yojson "Name")
           _list path);
      arn =
...
let primary_of_yojson tree path =
  ...
  let _res : primary =
    {
      health_check =
        (value_for_key health_check_of_yojson "HealthCheck" _list path)
    } in
  _res
...
let secondary_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : secondary =
    { route = (value_for_key route_of_yojson "Route" _list path) } in
  _res
...
let routing_config_of_yojson tree path =
  ...
  let _res : routing_config =
    {
      failover_config =
        (value_for_key failover_config_of_yojson "FailoverConfig" _list path)
    } in
  _res
...
let replication_config_of_yojson tree path =
  ...
  let _res : replication_config =
    {
      state =
        (option_of_yojson (value_for_key replication_state_of_yojson "State")
           _list path)
    } in
  _res
...
let endpoint_event_bus_of_yojson tree path =
  ...
  let _res : endpoint_event_bus =
    {
      event_bus_arn =
        (value_for_key non_partner_event_bus_arn_of_yojson "EventBusArn"
           _list path)
    } in
  _res
...
let update_endpoint_response_of_yojson tree path =
  ...
  let _res : update_endpoint_response =
    {
      state =
        (option_of_yojson (value_for_key endpoint_state_of_yojson "State")
           _list path);
      endpoint_url =
        (option_of_yojson
           (value_for_key endpoint_url_of_yojson "EndpointUrl") _list path);
      endpoint_id =
        (option_of_yojson (value_for_key endpoint_id_of_yojson "EndpointId")
           _list path);
      role_arn =
      ...
      event_buses =
        (option_of_yojson
           (value_for_key endpoint_event_bus_list_of_yojson "EventBuses")
           _list path);
      replication_config =
        (option_of_yojson
           (value_for_key replication_config_of_yojson "ReplicationConfig")
           _list path);
      routing_config =
        (option_of_yojson
           (value_for_key routing_config_of_yojson "RoutingConfig") _list
           path);
      arn =
        (option_of_yojson (value_for_key endpoint_arn_of_yojson "Arn") _list
           path);
      name =
        (option_of_yojson (value_for_key endpoint_name_of_yojson "Name")
           _list path)
    } in
  _res
  ...
  let _res : update_endpoint_request =
    {
      ...
      description =
        (option_of_yojson
           (value_for_key endpoint_description_of_yojson "Description") _list
           path);
  ...
  let _res : update_connection_response =
    {
      last_authorized_time =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "LastAuthorizedTime") _list
           path);
      last_modified_time =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "LastModifiedTime") _list path);
      creation_time =
        (option_of_yojson (value_for_key timestamp__of_yojson "CreationTime")
           _list path);
      connection_state =
        (option_of_yojson
      ...
      connection_arn =
        (option_of_yojson
           (value_for_key connection_arn_of_yojson "ConnectionArn") _list
           path)
    } in
  _res
  ...
  let _res : update_connection_basic_auth_request_parameters =
    {
      ...
      username =
        (option_of_yojson
           (value_for_key auth_header_parameters_of_yojson "Username") _list
           path)
    } in
  _res
  ...
  let _res : update_connection_o_auth_client_request_parameters =
    {
      ...
      client_i_d =
        (option_of_yojson
           (value_for_key auth_header_parameters_of_yojson "ClientID") _list
           path)
    } in
  _res
...
let connection_header_parameter_of_yojson tree path =
  ...
  let _res : connection_header_parameter =
    {
      is_value_secret =
        (option_of_yojson (value_for_key boolean__of_yojson "IsValueSecret")
           _list path);
      value =
        (option_of_yojson
           (value_for_key header_value_sensitive_of_yojson "Value") _list
           path);
      key =
        (option_of_yojson (value_for_key header_key_of_yojson "Key") _list
           path)
    } in
  _res
  ...
  let _res : connection_query_string_parameter =
    {
      ...
      value =
        (option_of_yojson
           (value_for_key query_string_value_sensitive_of_yojson "Value")
           _list path);
      key =
        (option_of_yojson (value_for_key query_string_key_of_yojson "Key")
           _list path)
    } in
  _res
  ...
  let _res : connection_body_parameter =
    {
      is_value_secret =
        (option_of_yojson (value_for_key boolean__of_yojson "IsValueSecret")
           _list path);
      value =
        (option_of_yojson (value_for_key sensitive_string_of_yojson "Value")
           _list path);
      key =
        (option_of_yojson (value_for_key string__of_yojson "Key") _list path)
    } in
  _res
  ...
  let _res : connection_http_parameters =
    {
      body_parameters =
        (option_of_yojson
           (value_for_key connection_body_parameters_list_of_yojson
              "BodyParameters") _list path);
      query_string_parameters =
        (option_of_yojson
           (value_for_key connection_query_string_parameters_list_of_yojson
              "QueryStringParameters") _list path);
      header_parameters =
        (option_of_yojson
           (value_for_key connection_header_parameters_list_of_yojson
              "HeaderParameters") _list path)
    } in
  _res
      ...
      o_auth_http_parameters =
        (option_of_yojson
           (value_for_key connection_http_parameters_of_yojson
              "OAuthHttpParameters") _list path);
      http_method =
        (option_of_yojson
           (value_for_key connection_o_auth_http_method_of_yojson
              "HttpMethod") _list path);
      authorization_endpoint =
        (option_of_yojson
           (value_for_key https_endpoint_of_yojson "AuthorizationEndpoint")
           _list path);
      client_parameters =
        (option_of_yojson
           (value_for_key
  ...
  let _res : update_connection_api_key_auth_request_parameters =
    {
      api_key_value =
        (option_of_yojson
           (value_for_key auth_header_parameters_sensitive_of_yojson
              "ApiKeyValue") _list path);
      api_key_name =
        (option_of_yojson
           (value_for_key auth_header_parameters_of_yojson "ApiKeyName")
           _list path)
    } in
  _res
  ...
  let _res : update_connection_auth_request_parameters =
    {
      invocation_http_parameters =
        (option_of_yojson
           (value_for_key connection_http_parameters_of_yojson
              "InvocationHttpParameters") _list path);
      api_key_auth_parameters =
        (option_of_yojson
           (value_for_key
              update_connection_api_key_auth_request_parameters_of_yojson
      ...
      basic_auth_parameters =
        (option_of_yojson
           (value_for_key
              update_connection_basic_auth_request_parameters_of_yojson
  ...
  let _res : update_connection_request =
    {
      ...
      authorization_type =
        (option_of_yojson
           (value_for_key connection_authorization_type_of_yojson
              "AuthorizationType") _list path);
      description =
        (option_of_yojson
  ...
  let _res : update_archive_response =
    {
      ...
      state =
        (option_of_yojson (value_for_key archive_state_of_yojson "State")
           _list path);
      archive_arn =
        (option_of_yojson (value_for_key archive_arn_of_yojson "ArchiveArn")
           _list path)
    } in
  _res
  ...
  let _res : update_archive_request =
    {
      retention_days =
        (option_of_yojson
           (value_for_key retention_days_of_yojson "RetentionDays") _list
           path);
      event_pattern =
        (option_of_yojson
           (value_for_key event_pattern_of_yojson "EventPattern") _list path);
      description =
        (option_of_yojson
  ...
  let _res : update_api_destination_response =
    {
      ...
      api_destination_state =
        (option_of_yojson
           (value_for_key api_destination_state_of_yojson
              "ApiDestinationState") _list path);
      api_destination_arn =
        (option_of_yojson
           (value_for_key api_destination_arn_of_yojson "ApiDestinationArn")
           _list path)
    } in
  _res
  ...
  let _res : update_api_destination_request =
    {
      invocation_rate_limit_per_second =
        (option_of_yojson
           (value_for_key
              api_destination_invocation_rate_limit_per_second_of_yojson
      ...
      invocation_endpoint =
        (option_of_yojson
           (value_for_key https_endpoint_of_yojson "InvocationEndpoint")
           _list path);
      connection_arn =
        (option_of_yojson
           (value_for_key connection_arn_of_yojson "ConnectionArn") _list
...
let transformer_paths_of_yojson tree path =
  map_of_yojson input_transformer_path_key_of_yojson
    target_input_path_of_yojson tree path
...
let test_event_pattern_response_of_yojson tree path =
  ...
  let _res : test_event_pattern_response =
    {
      result =
        (option_of_yojson (value_for_key boolean__of_yojson "Result") _list
           path)
    } in
  _res
...
let input_transformer_of_yojson tree path =
  ...
  let _res : input_transformer =
    {
      input_template =
        (value_for_key transformer_input_of_yojson "InputTemplate" _list path);
      input_paths_map =
        (option_of_yojson
           (value_for_key transformer_paths_of_yojson "InputPathsMap") _list
           path)
    } in
  _res
let kinesis_parameters_of_yojson tree path =
  ...
  let _res : kinesis_parameters =
    {
      partition_key_path =
        (value_for_key target_partition_key_path_of_yojson "PartitionKeyPath"
           _list path)
    } in
  _res
...
let run_command_target_of_yojson tree path =
  ...
  let _res : run_command_target =
    {
      values =
        (value_for_key run_command_target_values_of_yojson "Values" _list
           path);
      key = (value_for_key run_command_target_key_of_yojson "Key" _list path)
    } in
  _res
let run_command_targets_of_yojson tree path =
  list_of_yojson run_command_target_of_yojson tree path
let run_command_parameters_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : run_command_parameters =
    {
      run_command_targets =
        (value_for_key run_command_targets_of_yojson "RunCommandTargets"
           _list path)
    } in
  _res
  ...
  let _res : aws_vpc_configuration =
    {
      assign_public_ip =
        (option_of_yojson
           (value_for_key assign_public_ip_of_yojson "AssignPublicIp") _list
           path);
      security_groups =
        (option_of_yojson
           (value_for_key string_list_of_yojson "SecurityGroups") _list path);
      ...
      awsvpc_configuration =
        (option_of_yojson
           (value_for_key aws_vpc_configuration_of_yojson
              "awsvpcConfiguration") _list path)
    } in
  _res
  ...
  let _res : capacity_provider_strategy_item =
    {
      ...
      weight =
        (option_of_yojson
           (value_for_key capacity_provider_strategy_item_weight_of_yojson
              "weight") _list path);
      capacity_provider =
        (value_for_key capacity_provider_of_yojson "capacityProvider" _list
           path)
    } in
  _res
  ...
  let _res : placement_constraint =
    {
      expression =
        (option_of_yojson
           (value_for_key placement_constraint_expression_of_yojson
              "expression") _list path);
      type_ =
        (option_of_yojson
           (value_for_key placement_constraint_type_of_yojson "type") _list
           path)
    } in
  _res
  ...
  let _res : placement_strategy =
    {
      field =
        (option_of_yojson
           (value_for_key placement_strategy_field_of_yojson "field") _list
           path);
      type_ =
        (option_of_yojson
           (value_for_key placement_strategy_type_of_yojson "type") _list
           path)
    } in
  _res
  ...
  let _res : ecs_parameters =
    {
      ...
      reference_id =
        (option_of_yojson
           (value_for_key reference_id_of_yojson "ReferenceId") _list path);
      propagate_tags =
        (option_of_yojson
           (value_for_key propagate_tags_of_yojson "PropagateTags") _list
           path);
      placement_strategy =
        (option_of_yojson
      ...
      placement_constraints =
        (option_of_yojson
           (value_for_key placement_constraints_of_yojson
              "PlacementConstraints") _list path);
      enable_execute_command =
        (option_of_yojson
           (value_for_key boolean__of_yojson "EnableExecuteCommand") _list
           path);
      enable_ecs_managed_tags =
        (option_of_yojson
           (value_for_key boolean__of_yojson "EnableECSManagedTags") _list
           path);
      capacity_provider_strategy =
        (option_of_yojson
           (value_for_key capacity_provider_strategy_of_yojson
              "CapacityProviderStrategy") _list path);
      group =
        (option_of_yojson (value_for_key string__of_yojson "Group") _list
           path);
      platform_version =
      ...
      launch_type =
        (option_of_yojson (value_for_key launch_type_of_yojson "LaunchType")
           _list path);
      task_count =
        (option_of_yojson (value_for_key limit_min1_of_yojson "TaskCount")
           _list path);
      task_definition_arn =
...
let batch_array_properties_of_yojson tree path =
  ...
  let _res : batch_array_properties =
    {
      size =
        (option_of_yojson (value_for_key integer__of_yojson "Size") _list
           path)
    } in
  _res
let batch_retry_strategy_of_yojson tree path =
  ...
  let _res : batch_retry_strategy =
    {
      attempts =
        (option_of_yojson (value_for_key integer__of_yojson "Attempts") _list
           path)
    } in
  _res
  ...
  let _res : batch_parameters =
    {
      retry_strategy =
        (option_of_yojson
           (value_for_key batch_retry_strategy_of_yojson "RetryStrategy")
           _list path);
      array_properties =
        (option_of_yojson
      ...
      job_definition =
        (value_for_key string__of_yojson "JobDefinition" _list path)
    } in
  _res
  ...
  let _res : sqs_parameters =
    {
      message_group_id =
        (option_of_yojson
           (value_for_key message_group_id_of_yojson "MessageGroupId") _list
           path)
    } in
  _res
let path_parameter_of_yojson = string_of_yojson
let path_parameter_list_of_yojson tree path =
  list_of_yojson path_parameter_of_yojson tree path
...
let query_string_parameters_map_of_yojson tree path =
  map_of_yojson query_string_key_of_yojson query_string_value_of_yojson tree
    path
...
let redshift_data_parameters_of_yojson tree path =
  ...
  let _res : redshift_data_parameters =
    {
      sqls =
        (option_of_yojson (value_for_key sqls_of_yojson "Sqls") _list path);
      with_event =
        (option_of_yojson (value_for_key boolean__of_yojson "WithEvent")
           _list path);
      statement_name =
        (option_of_yojson
           (value_for_key statement_name_of_yojson "StatementName") _list
           path);
      sql = (option_of_yojson (value_for_key sql_of_yojson "Sql") _list path);
      db_user =
        (option_of_yojson (value_for_key db_user_of_yojson "DbUser") _list
           path);
      database = (value_for_key database_of_yojson "Database" _list path);
      secret_manager_arn =
        (option_of_yojson
           (value_for_key redshift_secret_manager_arn_of_yojson
              "SecretManagerArn") _list path)
    } in
  _res
...
let sage_maker_pipeline_parameter_of_yojson tree path =
  ...
  let _res : sage_maker_pipeline_parameter =
    {
      value =
        (value_for_key sage_maker_pipeline_parameter_value_of_yojson "Value"
           _list path);
      name =
        (value_for_key sage_maker_pipeline_parameter_name_of_yojson "Name"
           _list path)
    } in
  _res
  ...
  let _res : sage_maker_pipeline_parameters =
    {
      pipeline_parameter_list =
        (option_of_yojson
           (value_for_key sage_maker_pipeline_parameter_list_of_yojson
              "PipelineParameterList") _list path)
    } in
  _res
  ...
  let _res : retry_policy =
    {
      maximum_event_age_in_seconds =
        (option_of_yojson
           (value_for_key maximum_event_age_in_seconds_of_yojson
              "MaximumEventAgeInSeconds") _list path);
      maximum_retry_attempts =
        (option_of_yojson
           (value_for_key maximum_retry_attempts_of_yojson
              "MaximumRetryAttempts") _list path)
    } in
  _res
  ...
  let _res : app_sync_parameters =
    {
      graph_ql_operation =
        (option_of_yojson
           (value_for_key graph_ql_operation_of_yojson "GraphQLOperation")
           _list path)
    } in
  _res
let target_of_yojson tree path =
  ...
  let _res : target =
    {
      app_sync_parameters =
        (option_of_yojson
           (value_for_key app_sync_parameters_of_yojson "AppSyncParameters")
           _list path);
      retry_policy =
        (option_of_yojson
           (value_for_key retry_policy_of_yojson "RetryPolicy") _list path);
      dead_letter_config =
        (option_of_yojson
           (value_for_key dead_letter_config_of_yojson "DeadLetterConfig")
           _list path);
      sage_maker_pipeline_parameters =
        (option_of_yojson
           (value_for_key sage_maker_pipeline_parameters_of_yojson
              "SageMakerPipelineParameters") _list path);
      redshift_data_parameters =
        (option_of_yojson
           (value_for_key redshift_data_parameters_of_yojson
              "RedshiftDataParameters") _list path);
      http_parameters =
        (option_of_yojson
           (value_for_key http_parameters_of_yojson "HttpParameters") _list
           path);
      sqs_parameters =
        (option_of_yojson
           (value_for_key sqs_parameters_of_yojson "SqsParameters") _list
           path);
      batch_parameters =
        (option_of_yojson
           (value_for_key batch_parameters_of_yojson "BatchParameters") _list
           path);
      ecs_parameters =
        (option_of_yojson
           (value_for_key ecs_parameters_of_yojson "EcsParameters") _list
           path);
      run_command_parameters =
        (option_of_yojson
           (value_for_key run_command_parameters_of_yojson
              "RunCommandParameters") _list path);
      kinesis_parameters =
        (option_of_yojson
           (value_for_key kinesis_parameters_of_yojson "KinesisParameters")
           _list path);
      input_transformer =
        (option_of_yojson
           (value_for_key input_transformer_of_yojson "InputTransformer")
           _list path);
      input_path =
        (option_of_yojson
           (value_for_key target_input_path_of_yojson "InputPath") _list path);
      input =
        (option_of_yojson (value_for_key target_input_of_yojson "Input")
           _list path);
      role_arn =
  ...
  _res
let target_list_of_yojson tree path =
  list_of_yojson target_of_yojson tree path
  ...
  let _res : start_replay_response =
    {
      replay_start_time =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "ReplayStartTime") _list path);
      state_reason =
        (option_of_yojson
           (value_for_key replay_state_reason_of_yojson "StateReason") _list
           path);
      state =
        (option_of_yojson (value_for_key replay_state_of_yojson "State")
           _list path);
      replay_arn =
        (option_of_yojson (value_for_key replay_arn_of_yojson "ReplayArn")
           _list path)
    } in
  _res
let replay_name_of_yojson = string_of_yojson
let replay_description_of_yojson = string_of_yojson
let replay_destination_filters_of_yojson tree path =
  ...
  let _res : replay_destination =
    {
      filter_arns =
        (option_of_yojson
           (value_for_key replay_destination_filters_of_yojson "FilterArns")
           _list path);
...
let start_replay_request_of_yojson tree path =
  ...
  let _res : start_replay_request =
    {
      destination =
        (value_for_key replay_destination_of_yojson "Destination" _list path);
      event_end_time =
        (value_for_key timestamp__of_yojson "EventEndTime" _list path);
      event_start_time =
      ...
      description =
        (option_of_yojson
           ...
           path);
      replay_name =
        (value_for_key replay_name_of_yojson "ReplayName" _list path)
    } in
  _res
  ...
  let _res : rule =
    {
      event_bus_name =
        (option_of_yojson
           (value_for_key event_bus_name_of_yojson "EventBusName") _list path);
      managed_by =
        (option_of_yojson (value_for_key managed_by_of_yojson "ManagedBy")
           _list path);
      role_arn =
        (option_of_yojson (value_for_key role_arn_of_yojson "RoleArn") _list
           path);
      ...
      description =
        (option_of_yojson
           (value_for_key rule_description_of_yojson "Description") _list
           path);
      state =
        (option_of_yojson (value_for_key rule_state_of_yojson "State") _list
           path);
      event_pattern =
        (option_of_yojson
           (value_for_key event_pattern_of_yojson "EventPattern") _list path);
      arn =
        (option_of_yojson (value_for_key rule_arn_of_yojson "Arn") _list path);
      name =
        (option_of_yojson (value_for_key rule_name_of_yojson "Name") _list
           path)
    } in
  _res
let rule_response_list_of_yojson tree path =
...
let replay_of_yojson tree path =
  ...
  let _res : replay =
    {
      replay_end_time =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "ReplayEndTime") _list path);
      replay_start_time =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "ReplayStartTime") _list path);
      event_last_replayed_time =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "EventLastReplayedTime") _list
           path);
      event_end_time =
        (option_of_yojson (value_for_key timestamp__of_yojson "EventEndTime")
           _list path);
      event_start_time =
        (option_of_yojson
           (value_for_key timestamp__of_yojson "EventStartTime") _list path);
      ...
      state =
        (option_of_yojson (value_for_key replay_state_of_yojson "State")
           _list path);
      event_source_arn =
        (option_of_yojson (value_for_key arn_of_yojson "EventSourceArn")
           _list path);
      replay_name =
  ...
  _res
let replay_list_of_yojson tree path =
  list_of_yojson replay_of_yojson tree path
  ...
  let _res : remove_targets_result_entry =
    {
      ...
      error_code =
        (option_of_yojson (value_for_key error_code_of_yojson "ErrorCode")
           _list path);
      target_id =
        (option_of_yojson (value_for_key target_id_of_yojson "TargetId")
           _list path)
    } in
  _res
  ...
  let _res : remove_targets_response =
    {
      failed_entries =
        (option_of_yojson
           (value_for_key remove_targets_result_entry_list_of_yojson
              "FailedEntries") _list path);
      failed_entry_count =
        (option_of_yojson
           (value_for_key integer__of_yojson "FailedEntryCount") _list path)
    } in
  _res
  ...
  let _res : remove_targets_request =
    {
      ...
      event_bus_name =
        (option_of_yojson
           (value_for_key event_bus_name_or_arn_of_yojson "EventBusName")
           _list path);
  ...
  let _res : remove_permission_request =
    {
      ...
      remove_all_permissions =
        (option_of_yojson
           (value_for_key boolean__of_yojson "RemoveAllPermissions") _list
           path);
      statement_id =
        (option_of_yojson
           (value_for_key statement_id_of_yojson "StatementId") _list path)
    } in
  _res
  ...
  let _res : put_targets_response =
    {
      failed_entries =
        (option_of_yojson
           (value_for_key put_targets_result_entry_list_of_yojson
              "FailedEntries") _list path);
      failed_entry_count =
        (option_of_yojson
           (value_for_key integer__of_yojson "FailedEntryCount") _list path)
...
let put_rule_response_of_yojson tree path =
  ...
  let _res : put_rule_response =
    {
      rule_arn =
        (option_of_yojson (value_for_key rule_arn_of_yojson "RuleArn") _list
           path)
    } in
  _res
...
let put_permission_request_of_yojson tree path =
  ...
  let _res : put_permission_request =
    {
      policy =
        (option_of_yojson (value_for_key string__of_yojson "Policy") _list
           path);
      condition =
        (option_of_yojson (value_for_key condition_of_yojson "Condition")
           _list path);
      statement_id =
        (option_of_yojson
           (value_for_key statement_id_of_yojson "StatementId") _list path);
      principal =
        (option_of_yojson (value_for_key principal_of_yojson "Principal")
           _list path);
      action =
  ...
  let _res : put_partner_events_result_entry =
    {
      ...
      error_code =
        (option_of_yojson (value_for_key error_code_of_yojson "ErrorCode")
           _list path);
      event_id =
        (option_of_yojson (value_for_key event_id_of_yojson "EventId") _list
           path)
    } in
  _res
  ...
  let _res : put_partner_events_response =
    {
      entries =
        (option_of_yojson
           (value_for_key put_partner_events_result_entry_list_of_yojson
              "Entries") _list path);
      failed_entry_count =
        (option_of_yojson
           (value_for_key integer__of_yojson "FailedEntryCount") _list path)
...
let event_resource_list_of_yojson tree path =
  list_of_yojson event_resource_of_yojson tree path
  ...
  let _res : put_partner_events_request_entry =
    {
      detail =
        (option_of_yojson (value_for_key string__of_yojson "Detail") _list
           path);
      detail_type =
        (option_of_yojson (value_for_key string__of_yojson "DetailType")
           _list path);
      resources =
        (option_of_yojson
           (value_for_key event_resource_list_of_yojson "Resources") _list
           path);
      source =
        (option_of_yojson
           (value_for_key event_source_name_of_yojson "Source") _list path);
      time =
        (option_of_yojson (value_for_key event_time_of_yojson "Time") _list
           path)
    } in
  _res
...
let put_partner_events_request_of_yojson tree path =
  ...
  let _res : put_partner_events_request =
    {
      entries =
        (value_for_key put_partner_events_request_entry_list_of_yojson
           "Entries" _list path)
    } in
  _res
  ...
  let _res : put_events_response =
    {
      entries =
        (option_of_yojson
           (value_for_key put_events_result_entry_list_of_yojson "Entries")
           _list path);
      failed_entry_count =
        (option_of_yojson
           (value_for_key integer__of_yojson "FailedEntryCount") _list path)
  ...
  let _res : put_events_request_entry =
    {
      trace_header =
        (option_of_yojson
           (value_for_key trace_header_of_yojson "TraceHeader") _list path);
      event_bus_name =
        (option_of_yojson
           (value_for_key non_partner_event_bus_name_or_arn_of_yojson
  ...
  let _res : put_events_request =
    {
      endpoint_id =
        (option_of_yojson (value_for_key endpoint_id_of_yojson "EndpointId")
           _list path);
      entries =
        (value_for_key put_events_request_entry_list_of_yojson "Entries"
           _list path)
    } in
  _res
  ...
  let _res : partner_event_source_account =
    {
      state =
        (option_of_yojson
           (value_for_key event_source_state_of_yojson "State") _list path);
      expiration_time =
        (option_of_yojson
      ...
      creation_time =
        (option_of_yojson (value_for_key timestamp__of_yojson "CreationTime")
           _list path);
      account =
        (option_of_yojson (value_for_key account_id_of_yojson "Account")
           _list path)
    } in
  _res
  ...
  let _res : list_targets_by_rule_response =
    {
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      targets =
        (option_of_yojson (value_for_key target_list_of_yojson "Targets")
           _list path)
    } in
  _res
...
let list_targets_by_rule_request_of_yojson tree path =
  ...
  let _res : list_targets_by_rule_request =
    {
      limit =
        (option_of_yojson (value_for_key limit_max100_of_yojson "Limit")
           _list path);
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
  ...
  let _res : list_rules_response =
    {
      ...
      rules =
        (option_of_yojson
           (value_for_key rule_response_list_of_yojson "Rules") _list path)
    } in
  _res
  ...
  let _res : list_rules_request =
    {
      ...
      event_bus_name =
        (option_of_yojson
           ...
           _list path);
      name_prefix =
        (option_of_yojson (value_for_key rule_name_of_yojson "NamePrefix")
           _list path)
    } in
  _res
  ...
  let _res : list_rule_names_by_target_response =
    {
      ...
      rule_names =
        (option_of_yojson
           (value_for_key rule_name_list_of_yojson "RuleNames") _list path)
    } in
  _res
  ...
  let _res : list_rule_names_by_target_request =
    {
      ...
      event_bus_name =
        (option_of_yojson
           ...
           _list path);
      target_arn =
        (value_for_key target_arn_of_yojson "TargetArn" _list path)
    } in
  _res
  ...
  let _res : list_replays_response =
    {
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      replays =
        (option_of_yojson (value_for_key replay_list_of_yojson "Replays")
           _list path)
    } in
  _res
  ...
  let _res : list_replays_request =
    {
      ...
      state =
        (option_of_yojson (value_for_key replay_state_of_yojson "State")
           _list path);
      name_prefix =
        (option_of_yojson (value_for_key replay_name_of_yojson "NamePrefix")
           _list path)
    } in
  _res
  ...
  let _res : list_partner_event_sources_response =
    {
      ...
      partner_event_sources =
        (option_of_yojson
           (value_for_key partner_event_source_list_of_yojson
              "PartnerEventSources") _list path)
    } in
  _res
  ...
  let _res : list_partner_event_sources_request =
    {
      ...
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      name_prefix =
        (value_for_key partner_event_source_name_prefix_of_yojson
  ...
  let _res : list_partner_event_source_accounts_request =
    {
      ...
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      event_source_name =
        (value_for_key event_source_name_of_yojson "EventSourceName" _list
           path)
    } in
  _res
let event_source_of_yojson tree path =
  ...
  _res
let event_source_list_of_yojson tree path =
  list_of_yojson event_source_of_yojson tree path
  ...
  let _res : list_event_sources_response =
    {
      ...
      event_sources =
        (option_of_yojson
           (value_for_key event_source_list_of_yojson "EventSources") _list
           path)
    } in
  _res
  ...
  let _res : list_event_sources_request =
    {
      ...
      name_prefix =
        (option_of_yojson
           (value_for_key event_source_name_prefix_of_yojson "NamePrefix")
           _list path)
    } in
  _res
let event_bus_of_yojson tree path =
  ...
  _res
let event_bus_list_of_yojson tree path =
  list_of_yojson event_bus_of_yojson tree path
  ...
  let _res : list_event_buses_request =
    {
      ...
      name_prefix =
        (option_of_yojson
           (value_for_key event_bus_name_of_yojson "NamePrefix") _list path)
    } in
  _res
...
let endpoint_of_yojson tree path =
  ...
  let _res : endpoint =
    {
      ...
      state_reason =
        (option_of_yojson
           (value_for_key endpoint_state_reason_of_yojson "StateReason")
           _list path);
      state =
        (option_of_yojson (value_for_key endpoint_state_of_yojson "State")
           _list path);
  ...
  _res
let endpoint_list_of_yojson tree path =
  ...
  let _res : list_endpoints_response =
    {
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      endpoints =
        (option_of_yojson (value_for_key endpoint_list_of_yojson "Endpoints")
           _list path)
    } in
  _res
...
let list_endpoints_request_of_yojson tree path =
  ...
  let _res : list_endpoints_request =
    {
      max_results =
        (option_of_yojson (value_for_key limit_max100_of_yojson "MaxResults")
           _list path);
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      home_region =
        (option_of_yojson (value_for_key home_region_of_yojson "HomeRegion")
           _list path);
      name_prefix =
        (option_of_yojson
           (value_for_key endpoint_name_of_yojson "NamePrefix") _list path)
    } in
  _res
...
let connection_of_yojson tree path =
  ...
  let _res : connection =
    {
      ...
      state_reason =
        (option_of_yojson
           (value_for_key connection_state_reason_of_yojson "StateReason")
           _list path);
      connection_state =
        (option_of_yojson
           (value_for_key connection_state_of_yojson "ConnectionState") _list
           path);
      name =
        (option_of_yojson (value_for_key connection_name_of_yojson "Name")
           _list path);
      connection_arn =
        (option_of_yojson
           (value_for_key connection_arn_of_yojson "ConnectionArn") _list
  ...
  _res
let connection_response_list_of_yojson tree path =
  ...
  let _res : list_connections_response =
    {
      ...
      connections =
        (option_of_yojson
           (value_for_key connection_response_list_of_yojson "Connections")
           _list path)
    } in
  _res
...
let archive_of_yojson tree path =
  ...
  let _res : archive =
    {
      creation_time =
        (option_of_yojson (value_for_key timestamp__of_yojson "CreationTime")
           _list path);
      event_count =
        (option_of_yojson (value_for_key long_of_yojson "EventCount") _list
           path);
      size_bytes =
        (option_of_yojson (value_for_key long_of_yojson "SizeBytes") _list
           path);
      retention_days =
        (option_of_yojson
           (value_for_key retention_days_of_yojson "RetentionDays") _list
  ...
  _res
let archive_response_list_of_yojson tree path =
  list_of_yojson archive_of_yojson tree path
  ...
  let _res : list_archives_response =
    {
      ...
      archives =
        (option_of_yojson
           (value_for_key archive_response_list_of_yojson "Archives") _list
           path)
    } in
  _res
  ...
  let _res : api_destination =
    {
      ...
      name =
        (option_of_yojson
           (value_for_key api_destination_name_of_yojson "Name") _list path);
      api_destination_arn =
        (option_of_yojson
           (value_for_key api_destination_arn_of_yojson "ApiDestinationArn")
           _list path)
  ...
  let _res : list_api_destinations_response =
    {
      ...
      api_destinations =
        (option_of_yojson
           (value_for_key api_destination_response_list_of_yojson
              "ApiDestinations") _list path)
    } in
  _res
  ...
  let _res : list_api_destinations_request =
    {
      ...
      name_prefix =
        (option_of_yojson
           (value_for_key api_destination_name_of_yojson "NamePrefix") _list
           path)
    } in
  _res
...
let describe_rule_response_of_yojson tree path =
  ...
  let _res : describe_rule_response =
    {
      created_by =
        (option_of_yojson (value_for_key created_by_of_yojson "CreatedBy")
           _list path);
      event_bus_name =
        (option_of_yojson
           (value_for_key event_bus_name_of_yojson "EventBusName") _list path);
...
let describe_partner_event_source_request_of_yojson tree path =
  ...
  let _res : describe_partner_event_source_request =
    { name = (value_for_key event_source_name_of_yojson "Name" _list path) } in
  _res
  ...
  let _res : describe_event_bus_request =
    {
      name =
        (option_of_yojson
           (value_for_key event_bus_name_or_arn_of_yojson "Name") _list path)
    } in
  _res
  ...
  let _res : connection_o_auth_response_parameters =
    {
      ...
      client_parameters =
        (option_of_yojson
           (value_for_key
              connection_o_auth_client_response_parameters_of_yojson
              "ClientParameters") _list path)
    } in
  _res
  ...
  let _res : connection_auth_response_parameters =
    {
      ...
      api_key_auth_parameters =
        (option_of_yojson
           (value_for_key
              connection_api_key_auth_response_parameters_of_yojson
              "ApiKeyAuthParameters") _list path);
      o_auth_parameters =
        (option_of_yojson
           (value_for_key connection_o_auth_response_parameters_of_yojson
              "OAuthParameters") _list path);
      basic_auth_parameters =
        (option_of_yojson
           (value_for_key connection_basic_auth_response_parameters_of_yojson
              "BasicAuthParameters") _list path)
    } in
  _res
...
let delete_endpoint_request_of_yojson tree path =
  ...
  let _res : delete_endpoint_request =
    { name = (value_for_key endpoint_name_of_yojson "Name" _list path) } in
  _res
...
let create_partner_event_source_response_of_yojson tree path =
  ...
  let _res : create_partner_event_source_response =
    {
      event_source_arn =
        (option_of_yojson (value_for_key string__of_yojson "EventSourceArn")
           _list path)
    } in
  _res
  ...
  let _res : create_event_bus_response =
    {
      ...
      description =
        (option_of_yojson
           ...
           _list path);
      event_bus_arn =
        (option_of_yojson (value_for_key string__of_yojson "EventBusArn")
           _list path)
    } in
  _res
  ...
  let _res : create_event_bus_request =
    {
      ...
      event_source_name =
        (option_of_yojson
           (value_for_key event_source_name_of_yojson "EventSourceName")
           _list path);
  ...
  let _res : create_endpoint_request =
    {
      role_arn =
        (option_of_yojson (value_for_key iam_role_arn_of_yojson "RoleArn")
           _list path);
      event_buses =
        (value_for_key endpoint_event_bus_list_of_yojson "EventBuses" _list
           path);
      replication_config =
        (option_of_yojson
           (value_for_key replication_config_of_yojson "ReplicationConfig")
           _list path);
      routing_config =
        (value_for_key routing_config_of_yojson "RoutingConfig" _list path);
      description =
        (option_of_yojson
           (value_for_key endpoint_description_of_yojson "Description") _list
           path);
  ...
  let _res : create_connection_basic_auth_request_parameters =
    {
      password =
        (value_for_key auth_header_parameters_sensitive_of_yojson "Password"
           _list path);
      username =
        (value_for_key auth_header_parameters_of_yojson "Username" _list path)
    } in
  _res
  ...
  let _res : create_connection_o_auth_client_request_parameters =
    {
      client_secret =
        (value_for_key auth_header_parameters_sensitive_of_yojson
           "ClientSecret" _list path);
      client_i_d =
        (value_for_key auth_header_parameters_of_yojson "ClientID" _list path)
    } in
  _res
  ...
  let _res : create_connection_o_auth_request_parameters =
    {
      ...
      http_method =
        (value_for_key connection_o_auth_http_method_of_yojson "HttpMethod"
           _list path);
      authorization_endpoint =
        (value_for_key https_endpoint_of_yojson "AuthorizationEndpoint" _list
           path);
      client_parameters =
        (value_for_key
  ...
  let _res : create_connection_auth_request_parameters =
    {
      ...
      api_key_auth_parameters =
        (option_of_yojson
           (value_for_key
              create_connection_api_key_auth_request_parameters_of_yojson
              "ApiKeyAuthParameters") _list path);
      o_auth_parameters =
        (option_of_yojson
           (value_for_key
              create_connection_o_auth_request_parameters_of_yojson
              "OAuthParameters") _list path);
      basic_auth_parameters =
        (option_of_yojson
           (value_for_key
  ...
  let _res : create_api_destination_request =
    {
      ...
      http_method =
        (value_for_key api_destination_http_method_of_yojson "HttpMethod"
           _list path);
      invocation_endpoint =
        (value_for_key https_endpoint_of_yojson "InvocationEndpoint" _list
           path);
      connection_arn =
