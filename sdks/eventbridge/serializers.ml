...
let primary_to_yojson (x : primary) =
  assoc_to_yojson [ ("HealthCheck", Some (health_check_to_yojson x.health_check)) ]
...
let routing_config_to_yojson (x : routing_config) =
  assoc_to_yojson [ ("FailoverConfig", Some (failover_config_to_yojson x.failover_config)) ]
...
let replication_config_to_yojson (x : replication_config) =
  assoc_to_yojson [ ("State", option_to_yojson replication_state_to_yojson x.state) ]

let non_partner_event_bus_arn_to_yojson = string_to_yojson

let endpoint_event_bus_to_yojson (x : endpoint_event_bus) =
  assoc_to_yojson [ ("EventBusArn", Some (non_partner_event_bus_arn_to_yojson x.event_bus_arn)) ]

let endpoint_event_bus_list_to_yojson tree = list_to_yojson endpoint_event_bus_to_yojson tree
...
let update_endpoint_response_to_yojson (x : update_endpoint_response) =
  assoc_to_yojson
    [
      ...
      ("EventBuses", option_to_yojson endpoint_event_bus_list_to_yojson x.event_buses);
      ("ReplicationConfig", option_to_yojson replication_config_to_yojson x.replication_config);
      ("RoutingConfig", option_to_yojson routing_config_to_yojson x.routing_config);
...
let update_endpoint_request_to_yojson (x : update_endpoint_request) =
  assoc_to_yojson
    [
      ...
      ("ReplicationConfig", option_to_yojson replication_config_to_yojson x.replication_config);
      ("RoutingConfig", option_to_yojson routing_config_to_yojson x.routing_config);
      ("Description", option_to_yojson endpoint_description_to_yojson x.description);
...
let update_connection_response_to_yojson (x : update_connection_response) =
  assoc_to_yojson
    [
      ("LastAuthorizedTime", option_to_yojson timestamp__to_yojson x.last_authorized_time);
      ("LastModifiedTime", option_to_yojson timestamp__to_yojson x.last_modified_time);
...
let connection_o_auth_http_method_to_yojson (x : connection_o_auth_http_method) =
  match x with PUT -> `String "PUT" | POST -> `String "POST" | GET -> `String "GET"
...
let connectivity_resource_configuration_arn_to_yojson (x : connectivity_resource_configuration_arn)
    =
  assoc_to_yojson
    [
      ( "ResourceConfigurationArn",
        Some (resource_configuration_arn_to_yojson x.resource_configuration_arn) );
    ]

let connectivity_resource_parameters_to_yojson (x : connectivity_resource_parameters) =
  assoc_to_yojson
    [
      ( "ResourceParameters",
        Some (connectivity_resource_configuration_arn_to_yojson x.resource_parameters) );
    ]
  ...
  assoc_to_yojson
    [
      ( "ConnectivityParameters",
        option_to_yojson connectivity_resource_parameters_to_yojson x.connectivity_parameters );
...
let batch_retry_strategy_to_yojson (x : batch_retry_strategy) =
  assoc_to_yojson [ ("Attempts", option_to_yojson integer__to_yojson x.attempts) ]
...
let app_sync_parameters_to_yojson (x : app_sync_parameters) =
  assoc_to_yojson
    [ ("GraphQLOperation", option_to_yojson graph_ql_operation_to_yojson x.graph_ql_operation) ]

let target_to_yojson (x : target) =
  assoc_to_yojson
    [
      ("AppSyncParameters", option_to_yojson app_sync_parameters_to_yojson x.app_sync_parameters);
...
let start_replay_response_to_yojson (x : start_replay_response) =
  assoc_to_yojson
    [
      ("ReplayStartTime", option_to_yojson timestamp__to_yojson x.replay_start_time);
...
let replay_to_yojson (x : replay) =
  assoc_to_yojson
    [
      ("ReplayEndTime", option_to_yojson timestamp__to_yojson x.replay_end_time);
      ("ReplayStartTime", option_to_yojson timestamp__to_yojson x.replay_start_time);
      ("EventLastReplayedTime", option_to_yojson timestamp__to_yojson x.event_last_replayed_time);
      ("EventEndTime", option_to_yojson timestamp__to_yojson x.event_end_time);
      ("EventStartTime", option_to_yojson timestamp__to_yojson x.event_start_time);
      ("StateReason", option_to_yojson replay_state_reason_to_yojson x.state_reason);
      ("State", option_to_yojson replay_state_to_yojson x.state);
      ("EventSourceArn", option_to_yojson archive_arn_to_yojson x.event_source_arn);
...
let remove_targets_response_to_yojson (x : remove_targets_response) =
  assoc_to_yojson
    [
      ...
      ("FailedEntryCount", option_to_yojson integer__to_yojson x.failed_entry_count);
    ]
...
let partner_event_source_account_to_yojson (x : partner_event_source_account) =
  assoc_to_yojson
    [
      ...
      ("ExpirationTime", option_to_yojson timestamp__to_yojson x.expiration_time);
      ("CreationTime", option_to_yojson timestamp__to_yojson x.creation_time);
...
let endpoint_to_yojson (x : endpoint) =
  assoc_to_yojson
    [
      ("LastModifiedTime", option_to_yojson timestamp__to_yojson x.last_modified_time);
      ("CreationTime", option_to_yojson timestamp__to_yojson x.creation_time);
      ("StateReason", option_to_yojson endpoint_state_reason_to_yojson x.state_reason);
      ("State", option_to_yojson endpoint_state_to_yojson x.state);
      ("EndpointUrl", option_to_yojson endpoint_url_to_yojson x.endpoint_url);
      ("EndpointId", option_to_yojson endpoint_id_to_yojson x.endpoint_id);
      ("RoleArn", option_to_yojson iam_role_arn_to_yojson x.role_arn);
...
let archive_to_yojson (x : archive) =
  assoc_to_yojson
    [
      ...
      ("StateReason", option_to_yojson archive_state_reason_to_yojson x.state_reason);
      ("State", option_to_yojson archive_state_to_yojson x.state);
      ("EventSourceArn", option_to_yojson event_bus_arn_to_yojson x.event_source_arn);
...
let describe_connection_resource_parameters_to_yojson (x : describe_connection_resource_parameters)
    =
  assoc_to_yojson
    [
...
let describe_connection_connectivity_parameters_to_yojson
  ...
  assoc_to_yojson
    [
      ( "ResourceParameters",
        Some (describe_connection_resource_parameters_to_yojson x.resource_parameters) );
    ]
