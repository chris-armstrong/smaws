...
let update_connection_response_to_yojson (x : update_connection_response) =
  assoc_to_yojson
    ...
    ("CreationTime", (option_to_yojson timestamp__to_yojson x.creation_time));
    ("ConnectionState",
...
let batch_array_properties_to_yojson (x : batch_array_properties) =
  assoc_to_yojson [("Size", (option_to_yojson integer__to_yojson x.size))]
let batch_retry_strategy_to_yojson (x : batch_retry_strategy) =
  assoc_to_yojson
    [("Attempts", (option_to_yojson integer__to_yojson x.attempts))]
