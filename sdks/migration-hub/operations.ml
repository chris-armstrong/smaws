  ...
  struct
    ...
    let error_deserializer tree path =
      let handler handler tree path =
        ...
        | (_, "DryRunOperation") ->
            `DryRunOperation
              (Json_deserializers.dry_run_operation_of_yojson tree path)
        | (_, "HomeRegionNotSetException") ->
            `HomeRegionNotSetException
              (Json_deserializers.home_region_not_set_exception_of_yojson
                 tree path)
        ...
        | (_, "UnauthorizedOperation") ->
            `UnauthorizedOperation
              (Json_deserializers.unauthorized_operation_of_yojson tree path)
    ...
    let request context (request : associate_created_artifact_request) =
      let input =
        Json_serializers.associate_created_artifact_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.AssociateCreatedArtifact" ~service
        ~context ~input
...
module AssociateDiscoveredResource =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "PolicyErrorException") ->
            `PolicyErrorException
              (Json_deserializers.policy_error_exception_of_yojson tree path)
        | (_, "ResourceNotFoundException") ->
            `ResourceNotFoundException
              (Json_deserializers.resource_not_found_exception_of_yojson tree
                 path)
    ...
    let request context (request : associate_discovered_resource_request) =
      let input =
        Json_serializers.associate_discovered_resource_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.AssociateDiscoveredResource" ~service
        ~context ~input
...
module AssociateSourceResource =
  struct
    ...
    let request context (request : associate_source_resource_request) =
      let input =
        Json_serializers.associate_source_resource_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.AssociateSourceResource" ~service
        ~context ~input
...
module CreateProgressUpdateStream =
  struct
    ...
    let request context (request : create_progress_update_stream_request) =
      let input =
        Json_serializers.create_progress_update_stream_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.CreateProgressUpdateStream" ~service
        ~context ~input
...
module DeleteProgressUpdateStream =
  struct
    ...
    let request context (request : delete_progress_update_stream_request) =
      let input =
        Json_serializers.delete_progress_update_stream_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.DeleteProgressUpdateStream" ~service
        ~context ~input
...
module DescribeApplicationState =
  struct
    ...
    let request context (request : describe_application_state_request) =
      let input =
        Json_serializers.describe_application_state_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.DescribeApplicationState" ~service
        ~context ~input
...
module DescribeMigrationTask =
  struct
    ...
    let request context (request : describe_migration_task_request) =
      let input =
        Json_serializers.describe_migration_task_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.DescribeMigrationTask" ~service ~context
        ~input
...
module DisassociateCreatedArtifact =
  struct
    ...
    let request context (request : disassociate_created_artifact_request) =
      let input =
        Json_serializers.disassociate_created_artifact_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.DisassociateCreatedArtifact" ~service
        ~context ~input
...
module DisassociateDiscoveredResource =
  struct
    ...
    let request context (request : disassociate_discovered_resource_request)
      =
      let input =
        Json_serializers.disassociate_discovered_resource_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.DisassociateDiscoveredResource" ~service
        ~context ~input
...
module DisassociateSourceResource =
  struct
    ...
    let request context (request : disassociate_source_resource_request) =
      let input =
        Json_serializers.disassociate_source_resource_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.DisassociateSourceResource" ~service
        ~context ~input
...
module ImportMigrationTask =
  struct
    ...
    let request context (request : import_migration_task_request) =
      let input =
        Json_serializers.import_migration_task_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.ImportMigrationTask" ~service ~context
        ~input
...
module ListApplicationStates =
  struct
    ...
    let request context (request : list_application_states_request) =
      let input =
        Json_serializers.list_application_states_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.ListApplicationStates" ~service ~context
        ~input
...
module ListCreatedArtifacts =
  struct
    ...
    let request context (request : list_created_artifacts_request) =
      let input =
        Json_serializers.list_created_artifacts_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.ListCreatedArtifacts" ~service ~context
        ~input
...
module ListDiscoveredResources =
  struct
    ...
    let request context (request : list_discovered_resources_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.ListDiscoveredResources" ~service
        ~context ~input
...
module ListMigrationTaskUpdates =
  struct
    ...
    let request context (request : list_migration_task_updates_request) =
      let input =
        Json_serializers.list_migration_task_updates_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.ListMigrationTaskUpdates" ~service
        ~context ~input
...
module ListMigrationTasks =
  struct
    ...
    let request context (request : list_migration_tasks_request) =
      let input =
        Json_serializers.list_migration_tasks_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.ListMigrationTasks" ~service ~context
        ~input
...
module ListProgressUpdateStreams =
  struct
    ...
    let request context (request : list_progress_update_streams_request) =
      let input =
        Json_serializers.list_progress_update_streams_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.ListProgressUpdateStreams" ~service
        ~context ~input
...
module ListSourceResources =
  struct
    ...
    let request context (request : list_source_resources_request) =
      let input =
        Json_serializers.list_source_resources_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.ListSourceResources" ~service ~context
        ~input
...
module NotifyApplicationState =
  struct
    ...
    let request context (request : notify_application_state_request) =
      let input =
        Json_serializers.notify_application_state_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.NotifyApplicationState" ~service
        ~context ~input
...
module NotifyMigrationTaskState =
  struct
    ...
    let request context (request : notify_migration_task_state_request) =
      let input =
        Json_serializers.notify_migration_task_state_request_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.NotifyMigrationTaskState" ~service
        ~context ~input
...
module PutResourceAttributes =
  struct
    ...
    let request context (request : put_resource_attributes_request) =
      let input =
        Json_serializers.put_resource_attributes_request_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"AWSMigrationHub.PutResourceAttributes" ~service ~context
        ~input
