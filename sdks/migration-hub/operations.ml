  ...
  struct
    ...
    let request context (request : associate_created_artifact_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.associate_created_artifact_request_to_yojson
            request in
...
module AssociateSourceResource =
  struct
    ...
    let request context (request : associate_source_resource_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.associate_source_resource_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
...
module DescribeApplicationState =
  struct
    ...
    let request context (request : describe_application_state_request) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.describe_application_state_request_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
