  ...
  let _res : notify_migration_task_state_request =
    {
      dry_run =
        (option_of_yojson (value_for_key dry_run_of_yojson "DryRun") _list
           path);
      next_update_seconds =
        (value_for_key next_update_seconds_of_yojson "NextUpdateSeconds"
           _list path);
      update_date_time =
  ...
  let _res : discovered_resource =
    {
      ...
      configuration_id =
        (value_for_key configuration_id_of_yojson "ConfigurationId" _list
           path)
    } in
  _res
  ...
  let _res : created_artifact =
    {
      description =
        (option_of_yojson
           (value_for_key created_artifact_description_of_yojson
              "Description") _list path);
      name =
        (value_for_key created_artifact_name_of_yojson "Name" _list path)
    } in
  _res
  ...
  let _res : list_created_artifacts_request =
    {
      max_results =
        (option_of_yojson
           (value_for_key max_results_created_artifacts_of_yojson
  ...
  let _res : application_state =
    {
      ...
      application_id =
        (option_of_yojson
           (value_for_key application_id_of_yojson "ApplicationId") _list
           path)
    } in
  _res
  ...
  let _res : describe_migration_task_result =
    {
      migration_task =
        (option_of_yojson
           (value_for_key migration_task_of_yojson "MigrationTask") _list
           path)
    } in
  _res
  ...
  let _res : associate_created_artifact_request =
    {
      dry_run =
        (option_of_yojson (value_for_key dry_run_of_yojson "DryRun") _list
           path);
      created_artifact =
        (value_for_key created_artifact_of_yojson "CreatedArtifact" _list
           path);
      migration_task_name =
        (value_for_key migration_task_name_of_yojson "MigrationTaskName"
           _list path);
