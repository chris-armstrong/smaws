...
type nonrec progress_update_stream_summary_list =
  progress_update_stream_summary list[@@ocaml.doc ""]
...
type nonrec list_source_resources_result =
  {
  source_resource_list: source_resource_list option
...
type nonrec list_progress_update_streams_result =
  ...
  progress_update_stream_summary_list:
    progress_update_stream_summary_list option
    [@ocaml.doc
