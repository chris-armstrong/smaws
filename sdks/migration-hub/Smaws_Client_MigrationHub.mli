...
val make_resource_attribute :
  value:resource_attribute_value -> type_:resource_attribute_type -> unit -> resource_attribute
...
val make_list_progress_update_streams_request :
  ?max_results:max_results -> ?next_token:token -> unit -> list_progress_update_streams_request
