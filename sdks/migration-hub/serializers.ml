...
let resource_attribute_list_to_yojson tree =
  list_to_yojson resource_attribute_to_yojson tree
let put_resource_attributes_result_to_yojson
  (x : put_resource_attributes_result) = assoc_to_yojson []
...
let put_resource_attributes_request_to_yojson
  (x : put_resource_attributes_request) =
  assoc_to_yojson
...
let home_region_not_set_exception_to_yojson
  (x : home_region_not_set_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let progress_update_stream_summary_to_yojson
  (x : progress_update_stream_summary) =
  assoc_to_yojson
    [("ProgressUpdateStreamName",
       (option_to_yojson progress_update_stream_to_yojson
          x.progress_update_stream_name))]
...
let notify_application_state_result_to_yojson
  (x : notify_application_state_result) = assoc_to_yojson []
...
let notify_application_state_request_to_yojson
  (x : notify_application_state_request) =
  assoc_to_yojson
    [("DryRun", (option_to_yojson dry_run_to_yojson x.dry_run));
    ("UpdateDateTime",
...
let latest_resource_attribute_list_to_yojson tree =
  list_to_yojson resource_attribute_to_yojson tree
let migration_task_to_yojson (x : migration_task) =
  assoc_to_yojson
    [("ResourceAttributeList",
       (option_to_yojson latest_resource_attribute_list_to_yojson
          x.resource_attribute_list));
    ("UpdateDateTime",
      (option_to_yojson update_date_time_to_yojson x.update_date_time));
...
let list_progress_update_streams_request_to_yojson
  (x : list_progress_update_streams_request) =
  assoc_to_yojson
...
let list_migration_tasks_result_to_yojson (x : list_migration_tasks_result) =
  assoc_to_yojson
    [("MigrationTaskSummaryList",
       (option_to_yojson migration_task_summary_list_to_yojson
          x.migration_task_summary_list));
    ("NextToken", (option_to_yojson token_to_yojson x.next_token))]
...
let discovered_resource_to_yojson (x : discovered_resource) =
  assoc_to_yojson
    [("Description",
       (option_to_yojson discovered_resource_description_to_yojson
          x.description));
    ("ConfigurationId",
...
let list_discovered_resources_result_to_yojson
  (x : list_discovered_resources_result) =
  assoc_to_yojson
    [("DiscoveredResourceList",
       (option_to_yojson discovered_resource_list_to_yojson
          x.discovered_resource_list));
    ("NextToken", (option_to_yojson token_to_yojson x.next_token))]
...
let created_artifact_list_to_yojson tree =
  list_to_yojson created_artifact_to_yojson tree
let list_created_artifacts_result_to_yojson
  (x : list_created_artifacts_result) =
  assoc_to_yojson
    [("CreatedArtifactList",
       (option_to_yojson created_artifact_list_to_yojson
          x.created_artifact_list));
    ("NextToken", (option_to_yojson token_to_yojson x.next_token))]
let list_created_artifacts_request_to_yojson
  (x : list_created_artifacts_request) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson max_results_created_artifacts_to_yojson
          x.max_results));
    ("NextToken", (option_to_yojson token_to_yojson x.next_token));
    ("MigrationTaskName",
      (Some (migration_task_name_to_yojson x.migration_task_name)));
...
let application_state_list_to_yojson tree =
  list_to_yojson application_state_to_yojson tree
let list_application_states_result_to_yojson
  (x : list_application_states_result) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson token_to_yojson x.next_token));
    ("ApplicationStateList",
      (option_to_yojson application_state_list_to_yojson
         x.application_state_list))]
let application_ids_to_yojson tree =
  list_to_yojson application_id_to_yojson tree
let list_application_states_request_to_yojson
  (x : list_application_states_request) =
  assoc_to_yojson
    [("MaxResults", (option_to_yojson max_results_to_yojson x.max_results));
    ("NextToken", (option_to_yojson token_to_yojson x.next_token));
    ("ApplicationIds",
      (option_to_yojson application_ids_to_yojson x.application_ids))]
let import_migration_task_result_to_yojson (x : import_migration_task_result)
  = assoc_to_yojson []
let import_migration_task_request_to_yojson
  (x : import_migration_task_request) =
  assoc_to_yojson
    [("DryRun", (option_to_yojson dry_run_to_yojson x.dry_run));
    ("MigrationTaskName",
      (Some (migration_task_name_to_yojson x.migration_task_name)));
...
let disassociate_discovered_resource_result_to_yojson
  (x : disassociate_discovered_resource_result) = assoc_to_yojson []
...
let disassociate_created_artifact_result_to_yojson
  (x : disassociate_created_artifact_result) = assoc_to_yojson []
let disassociate_created_artifact_request_to_yojson
  (x : disassociate_created_artifact_request) =
  assoc_to_yojson
    [("DryRun", (option_to_yojson dry_run_to_yojson x.dry_run));
    ("CreatedArtifactName",
...
let describe_application_state_result_to_yojson
  (x : describe_application_state_result) =
  assoc_to_yojson
    [("LastUpdatedTime",
       (option_to_yojson update_date_time_to_yojson x.last_updated_time));
    ("ApplicationStatus",
...
let associate_created_artifact_result_to_yojson
  (x : associate_created_artifact_result) = assoc_to_yojson []
let associate_created_artifact_request_to_yojson
  (x : associate_created_artifact_request) =
  assoc_to_yojson
    [("DryRun", (option_to_yojson dry_run_to_yojson x.dry_run));
    ("CreatedArtifact",
