...
type nonrec retention_action = Terminate [@ocaml.doc ""] | Retain [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec refresh_strategy = ReplaceRootVolume [@ocaml.doc ""] | Rolling [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec retry_strategy = NONE [@ocaml.doc ""] | RETRY_WITH_GROUP_CONFIGURATION [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec instance_metadata_endpoint_state = Enabled [@ocaml.doc ""] | Disabled [@ocaml.doc ""]
[@@ocaml.doc ""]
