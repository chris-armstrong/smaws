...
type nonrec s3_backup_mode = Enabled [@ocaml.doc ""] | Disabled [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec parquet_writer_version = V2 [@ocaml.doc ""] | V1 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec orc_compression = SNAPPY [@ocaml.doc ""] | ZLIB [@ocaml.doc ""] | NONE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec list_of_non_empty_strings_without_whitespace = non_empty_string_without_whitespace list
[@@ocaml.doc ""]

type nonrec orc_format_version = V0_12 [@ocaml.doc ""] | V0_11 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec redshift_s3_backup_mode = Enabled [@ocaml.doc ""] | Disabled [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec hec_endpoint_type = Event [@ocaml.doc ""] | Raw [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec splunk_s3_backup_mode = AllEvents [@ocaml.doc ""] | FailedEventsOnly [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec content_encoding = GZIP [@ocaml.doc ""] | NONE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec snowflake_s3_backup_mode = AllData [@ocaml.doc ""] | FailedDataOnly [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec iceberg_s3_backup_mode = AllData [@ocaml.doc ""] | FailedDataOnly [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec key_type = CUSTOMER_MANAGED_CMK [@ocaml.doc ""] | AWS_OWNED_CMK [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec connectivity = PRIVATE [@ocaml.doc ""] | PUBLIC [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec database_type = PostgreSQL [@ocaml.doc ""] | MySQL [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec database_endpoint = string [@@ocaml.doc ""]

type nonrec database_port = int [@@ocaml.doc ""]

type nonrec ssl_mode = Enabled [@ocaml.doc ""] | Disabled [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec snapshot_requested_by = FIREHOSE [@ocaml.doc ""] | USER [@ocaml.doc ""]
[@@ocaml.doc ""]
