...
type nonrec partition_key_type = MEASURE [@ocaml.doc ""] | DIMENSION [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec partition_key_enforcement_level = OPTIONAL [@ocaml.doc ""] | REQUIRED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec list_batch_load_tasks_response = {
  batch_load_tasks : batch_load_task_list option;
