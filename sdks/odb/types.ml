...
type nonrec access = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec refreshable_status = REFRESHING [@ocaml.doc ""] | NOT_REFRESHING [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec refreshable_mode = AUTOMATIC [@ocaml.doc ""] | MANUAL [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec disaster_recovery_type = ADG [@ocaml.doc ""] | BACKUP_BASED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec compute_model = ECPU [@ocaml.doc ""] | OCPU [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec net_services_architecture = DEDICATED [@ocaml.doc ""] | SHARED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec autonomous_maintenance_schedule_type = EARLY [@ocaml.doc ""] | REGULAR [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec permission_level = RESTRICTED [@ocaml.doc ""] | UNRESTRICTED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec open_mode = READ_ONLY [@ocaml.doc ""] | READ_WRITE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec database_type = REGULAR [@ocaml.doc ""] | CLONE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec autonomous_database_wallet_status = ACTIVE [@ocaml.doc ""] | UPDATING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec clone_type = FULL [@ocaml.doc ""] | METADATA [@ocaml.doc ""] | PARTIAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec preference_type = NO_PREFERENCE [@ocaml.doc ""] | CUSTOM_PREFERENCE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec patching_mode_type = ROLLING [@ocaml.doc ""] | NONROLLING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec disk_redundancy = HIGH [@ocaml.doc ""] | NORMAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec wallet_type = REGIONAL [@ocaml.doc ""] | INSTANCE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec character_set_type = DATABASE [@ocaml.doc ""] | NATIONAL [@ocaml.doc ""]
[@@ocaml.doc ""]
