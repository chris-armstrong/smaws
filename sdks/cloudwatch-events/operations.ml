...
module ActivateEventSource = struct
  let error_to_string = function
    ...
    | `InternalException _ -> "com.amazonaws.cloudwatchevents#InternalException"
    | `InvalidStateException _ -> "com.amazonaws.cloudwatchevents#InvalidStateException"
    | `OperationDisabledException _ -> "com.amazonaws.cloudwatchevents#OperationDisabledException"
    | `ResourceNotFoundException _ -> "com.amazonaws.cloudwatchevents#ResourceNotFoundException"
...
module CancelReplay = struct
  let error_to_string = function
    | `ConcurrentModificationException _ ->
        "com.amazonaws.cloudwatchevents#ConcurrentModificationException"
    | `IllegalStatusException _ -> "com.amazonaws.cloudwatchevents#IllegalStatusException"
    | `InternalException _ -> "com.amazonaws.cloudwatchevents#InternalException"
    | `ResourceNotFoundException _ -> "com.amazonaws.cloudwatchevents#ResourceNotFoundException"
    | #Smaws_Lib.Protocols.AwsJson.error as e -> Smaws_Lib.Protocols.AwsJson.error_to_string e
...
module CreateApiDestination = struct
  let error_to_string = function
    | `InternalException _ -> "com.amazonaws.cloudwatchevents#InternalException"
    | `LimitExceededException _ -> "com.amazonaws.cloudwatchevents#LimitExceededException"
...
module DeleteRule = struct
  let error_to_string = function
    | `ConcurrentModificationException _ ->
        "com.amazonaws.cloudwatchevents#ConcurrentModificationException"
    | `InternalException _ -> "com.amazonaws.cloudwatchevents#InternalException"
    | `ManagedRuleException _ -> "com.amazonaws.cloudwatchevents#ManagedRuleException"
    | `ResourceNotFoundException _ -> "com.amazonaws.cloudwatchevents#ResourceNotFoundException"
    | #Smaws_Lib.Protocols.AwsJson.error as e -> Smaws_Lib.Protocols.AwsJson.error_to_string e
