...
let s3_bucket_does_not_exist_exception_to_yojson
  (x : s3_bucket_does_not_exist_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let organizations_not_in_use_exception_to_yojson
  (x : organizations_not_in_use_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let operation_not_permitted_exception_to_yojson
  (x : operation_not_permitted_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let invalid_sns_topic_name_exception_to_yojson
  (x : invalid_sns_topic_name_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let invalid_s3_bucket_name_exception_to_yojson
  (x : invalid_s3_bucket_name_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let invalid_home_region_exception_to_yojson
  (x : invalid_home_region_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let invalid_event_selectors_exception_to_yojson
  (x : invalid_event_selectors_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let insufficient_sns_topic_policy_exception_to_yojson
  (x : insufficient_sns_topic_policy_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let insufficient_s3_bucket_policy_exception_to_yojson
  (x : insufficient_s3_bucket_policy_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let cloud_trail_arn_invalid_exception_to_yojson
  (x : cloud_trail_arn_invalid_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let advanced_field_selectors_to_yojson tree =
  list_to_yojson advanced_field_selector_to_yojson tree
...
let advanced_event_selectors_to_yojson tree =
  list_to_yojson advanced_event_selector_to_yojson tree
...
let update_event_data_store_response_to_yojson
  (x : update_event_data_store_response) =
  assoc_to_yojson
    [("FederationRoleArn",
...
let update_event_data_store_request_to_yojson
  (x : update_event_data_store_request) =
  assoc_to_yojson
    [("BillingMode",
...
let invalid_insight_selectors_exception_to_yojson
  (x : invalid_insight_selectors_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let inactive_event_data_store_exception_to_yojson
  (x : inactive_event_data_store_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let event_data_store_not_found_exception_to_yojson
  (x : event_data_store_not_found_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let event_data_store_arn_invalid_exception_to_yojson
  (x : event_data_store_arn_invalid_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let channel_arn_invalid_exception_to_yojson
  (x : channel_arn_invalid_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let channel_already_exists_exception_to_yojson
  (x : channel_already_exists_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let trail_already_exists_exception_to_yojson
  (x : trail_already_exists_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let import_destinations_to_yojson tree =
...
let invalid_import_source_exception_to_yojson
  (x : invalid_import_source_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let restore_event_data_store_request_to_yojson
  (x : restore_event_data_store_request) =
  assoc_to_yojson
    [("EventDataStore",
       (Some (event_data_store_arn_to_yojson x.event_data_store)))]
...
let resource_type_not_supported_exception_to_yojson
  (x : resource_type_not_supported_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let resource_policy_not_valid_exception_to_yojson
  (x : resource_policy_not_valid_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let query_statistics_for_describe_query_to_yojson
  (x : query_statistics_for_describe_query) =
  assoc_to_yojson
    [("CreationTime", (option_to_yojson date_to_yojson x.creation_time));
    ("ExecutionTimeInMillis",
      (option_to_yojson integer_to_yojson x.execution_time_in_millis));
...
let query_statistics_to_yojson (x : query_statistics) =
  assoc_to_yojson
    [("BytesScanned", (option_to_yojson long_to_yojson x.bytes_scanned));
    ("TotalResultsCount",
      (option_to_yojson integer_to_yojson x.total_results_count));
...
let query_result_row_to_yojson tree =
  list_to_yojson query_result_column_to_yojson tree
let query_result_rows_to_yojson tree =
  list_to_yojson query_result_row_to_yojson tree
...
let insight_selectors_to_yojson tree =
  list_to_yojson insight_selector_to_yojson tree
let put_insight_selectors_response_to_yojson
  (x : put_insight_selectors_response) =
  assoc_to_yojson
    [("InsightsDestination",
       (option_to_yojson event_data_store_arn_to_yojson
          x.insights_destination));
    ("EventDataStoreArn",
      (option_to_yojson event_data_store_arn_to_yojson x.event_data_store_arn));
    ("InsightSelectors",
...
let put_insight_selectors_request_to_yojson
  (x : put_insight_selectors_request) =
  assoc_to_yojson
    [("InsightsDestination",
       (option_to_yojson event_data_store_arn_to_yojson
          x.insights_destination));
...
let data_resource_values_to_yojson tree =
...
let data_resources_to_yojson tree =
  list_to_yojson data_resource_to_yojson tree
let exclude_management_event_sources_to_yojson tree =
  list_to_yojson string__to_yojson tree
...
let event_selectors_to_yojson tree =
  list_to_yojson event_selector_to_yojson tree
...
let lookup_attributes_list_to_yojson tree =
  list_to_yojson lookup_attribute_to_yojson tree
let event_category_to_yojson (x : event_category) =
  match x with | Insight -> `String "insight"
...
let invalid_max_results_exception_to_yojson
  (x : invalid_max_results_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let invalid_lookup_attributes_exception_to_yojson
  (x : invalid_lookup_attributes_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let invalid_event_category_exception_to_yojson
  (x : invalid_event_category_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let insights_metric_values_to_yojson tree =
  list_to_yojson double_to_yojson tree
let insights_metric_next_token_to_yojson = string_to_yojson
let list_insights_metric_data_response_to_yojson
  (x : list_insights_metric_data_response) =
  assoc_to_yojson
    [("NextToken",
...
let list_insights_metric_data_request_to_yojson
  (x : list_insights_metric_data_request) =
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson insights_metric_next_token_to_yojson x.next_token));
    ("MaxResults",
...
let imports_list_item_to_yojson (x : imports_list_item) =
  assoc_to_yojson
    ...
    ("ImportStatus",
      (option_to_yojson import_status_to_yojson x.import_status));
    ("ImportId", (option_to_yojson uui_d_to_yojson x.import_id))]
let imports_list_to_yojson tree =
  list_to_yojson imports_list_item_to_yojson tree
...
let list_imports_request_to_yojson (x : list_imports_request) =
  assoc_to_yojson
    ...
    ("MaxResults",
      (option_to_yojson list_imports_max_results_count_to_yojson
         x.max_results))]
...
let import_failure_list_to_yojson tree =
  list_to_yojson import_failure_list_item_to_yojson tree
let list_import_failures_response_to_yojson
  (x : list_import_failures_response) =
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson pagination_token_to_yojson x.next_token));
...
let list_import_failures_request_to_yojson (x : list_import_failures_request)
  ...
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson pagination_token_to_yojson x.next_token));
    ("MaxResults",
      (option_to_yojson list_import_failures_max_results_count_to_yojson
         x.max_results));
...
let event_data_store_to_yojson (x : event_data_store) =
  assoc_to_yojson
    ...
    ("EventDataStoreArn",
      (option_to_yojson event_data_store_arn_to_yojson x.event_data_store_arn))]
let event_data_stores_to_yojson tree =
  list_to_yojson event_data_store_to_yojson tree
let list_event_data_stores_response_to_yojson
  (x : list_event_data_stores_response) =
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson pagination_token_to_yojson x.next_token));
    ("EventDataStores",
...
let list_event_data_stores_request_to_yojson
  (x : list_event_data_stores_request) =
  assoc_to_yojson
    [("MaxResults",
  ...
  assoc_to_yojson
    ...
    ("LatestNotificationAttemptSucceeded",
      (option_to_yojson string__to_yojson
         x.latest_notification_attempt_succeeded));
    ...
    ("LatestCloudWatchLogsDeliveryTime",
      (option_to_yojson date_to_yojson
         x.latest_cloud_watch_logs_delivery_time));
    ("LatestCloudWatchLogsDeliveryError",
      (option_to_yojson string__to_yojson
         x.latest_cloud_watch_logs_delivery_error));
    ("StopLoggingTime",
...
let get_insight_selectors_response_to_yojson
  (x : get_insight_selectors_response) =
  assoc_to_yojson
    [("InsightsDestination",
       (option_to_yojson event_data_store_arn_to_yojson
          x.insights_destination));
...
let get_insight_selectors_request_to_yojson
  (x : get_insight_selectors_request) =
  assoc_to_yojson
    [("EventDataStore",
       (option_to_yojson event_data_store_arn_to_yojson x.event_data_store));
    ("TrailName", (option_to_yojson string__to_yojson x.trail_name))]
...
let get_event_data_store_response_to_yojson
  (x : get_event_data_store_response) =
  assoc_to_yojson
    [("PartitionKeys",
...
let describe_trails_response_to_yojson (x : describe_trails_response) =
  assoc_to_yojson
    [("trailList", (option_to_yojson trail_list_to_yojson x.trail_list))]
...
let describe_query_response_to_yojson (x : describe_query_response) =
  assoc_to_yojson
    ...
    ("ErrorMessage",
      (option_to_yojson error_message_to_yojson x.error_message));
    ("QueryStatistics",
      (option_to_yojson query_statistics_for_describe_query_to_yojson
         x.query_statistics));
    ("QueryStatus", (option_to_yojson query_status_to_yojson x.query_status));
    ("QueryString",
...
let create_event_data_store_response_to_yojson
  (x : create_event_data_store_response) =
  assoc_to_yojson
    [("BillingMode",
       (option_to_yojson billing_mode_to_yojson x.billing_mode));
    ("KmsKeyId",
...
let create_event_data_store_request_to_yojson
  (x : create_event_data_store_request) =
  assoc_to_yojson
    [("BillingMode",
       (option_to_yojson billing_mode_to_yojson x.billing_mode));
    ("StartIngestion",
...
let channel_max_limit_exceeded_exception_to_yojson
  (x : channel_max_limit_exceeded_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
