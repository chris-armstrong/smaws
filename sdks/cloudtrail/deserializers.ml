...
let update_trail_response_of_yojson tree path =
  ...
  ({
     is_organization_trail =
       (option_of_yojson
          (value_for_key boolean__of_yojson "IsOrganizationTrail") _list path);
     kms_key_id =
     ...
     cloud_watch_logs_log_group_arn =
       (option_of_yojson
          (value_for_key string__of_yojson "CloudWatchLogsLogGroupArn") _list
          path);
     log_file_validation_enabled =
       (option_of_yojson
          (value_for_key boolean__of_yojson "LogFileValidationEnabled") _list
          path);
     trail_ar_n =
  ...
  ({
     ...
     not_starts_with =
       (option_of_yojson (value_for_key operator_of_yojson "NotStartsWith")
          _list path);
     not_equals =
       (option_of_yojson (value_for_key operator_of_yojson "NotEquals") _list
          path);
     ends_with =
  ...
  ({
     field_selectors =
       (value_for_key advanced_field_selectors_of_yojson "FieldSelectors"
          _list path);
     name =
       (option_of_yojson (value_for_key selector_name_of_yojson "Name") _list
          path)
...
let update_event_data_store_response_of_yojson tree path =
  ...
  ({
     ...
     organization_enabled =
       (option_of_yojson
          (value_for_key boolean__of_yojson "OrganizationEnabled") _list path);
...
let update_channel_response_of_yojson tree path =
  ...
  ({
     ...
     source =
       (option_of_yojson (value_for_key source_of_yojson "Source") _list path);
     name =
...
let trail_info_of_yojson tree path =
  ...
  ({
     home_region =
       (option_of_yojson (value_for_key string__of_yojson "HomeRegion") _list
          path);
     name =
       (option_of_yojson (value_for_key string__of_yojson "Name") _list path);
     trail_ar_n =
...
let trail_of_yojson tree path =
  ...
  ({
     ...
     has_insight_selectors =
       (option_of_yojson
          (value_for_key boolean__of_yojson "HasInsightSelectors") _list path);
...
let import_statistics_of_yojson tree path =
  ...
  ({
     failed_entries =
       (option_of_yojson (value_for_key long_of_yojson "FailedEntries") _list
          path);
     events_completed =
     ...
     prefixes_completed =
       (option_of_yojson (value_for_key long_of_yojson "PrefixesCompleted")
          _list path);
     prefixes_found =
       (option_of_yojson (value_for_key long_of_yojson "PrefixesFound") _list
          path)
   } : import_statistics)
  ...
  ({
     ...
     bytes_scanned =
       (option_of_yojson (value_for_key long_of_yojson "BytesScanned") _list
          path);
     events_scanned =
       (option_of_yojson (value_for_key long_of_yojson "EventsScanned") _list
          path);
     events_matched =
       (option_of_yojson (value_for_key long_of_yojson "EventsMatched") _list
          path)
  ...
  ({
     creation_time =
       (option_of_yojson (value_for_key date_of_yojson "CreationTime") _list
          path);
     query_status =
       (option_of_yojson (value_for_key query_status_of_yojson "QueryStatus")
          _list path);
     query_id =
       (option_of_yojson (value_for_key uui_d_of_yojson "QueryId") _list path)
   } : query)
...
let insight_selector_of_yojson tree path =
  ...
  ({
     insight_type =
       (option_of_yojson (value_for_key insight_type_of_yojson "InsightType")
          _list path)
   } : insight_selector)
...
let event_selector_of_yojson tree path =
  ...
  ({
     ...
     data_resources =
       (option_of_yojson
          (value_for_key data_resources_of_yojson "DataResources") _list path);
  ...
  ({
     next_token =
       (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
          _list path);
     events =
       (option_of_yojson (value_for_key events_list_of_yojson "Events") _list
          path)
...
let lookup_attribute_of_yojson tree path =
  ...
  ({
     attribute_value =
       (value_for_key lookup_attribute_value_of_yojson "AttributeValue" _list
          path);
     attribute_key =
...
let lookup_events_request_of_yojson tree path =
  ...
  ({
     ...
     event_category =
       (option_of_yojson
          (value_for_key event_category_of_yojson "EventCategory") _list path);
     end_time =
  ...
  ({
     next_token =
       (option_of_yojson (value_for_key string__of_yojson "NextToken") _list
          path);
     trails =
       (option_of_yojson (value_for_key trails_of_yojson "Trails") _list path)
...
let list_tags_response_of_yojson tree path =
  ...
  ({
     ...
     resource_tag_list =
       (option_of_yojson
          (value_for_key resource_tag_list_of_yojson "ResourceTagList") _list
          path)
   } : list_tags_response)
...
let import_failure_list_item_of_yojson tree path =
  ...
  ({
     ...
     status =
       (option_of_yojson
          (value_for_key import_failure_status_of_yojson "Status") _list path);
     location =
...
let list_import_failures_response_of_yojson tree path =
  ...
  ({
     ...
     failures =
       (option_of_yojson
          (value_for_key import_failure_list_of_yojson "Failures") _list path)
...
let list_event_data_stores_response_of_yojson tree path =
  ...
  ({
     ...
     event_data_stores =
       (option_of_yojson
          (value_for_key event_data_stores_of_yojson "EventDataStores") _list
          path)
...
let get_trail_status_response_of_yojson tree path =
  ...
  ({
     ...
     latest_delivery_attempt_time =
       (option_of_yojson
          (value_for_key string__of_yojson "LatestDeliveryAttemptTime") _list
          path);
     latest_digest_delivery_error =
       (option_of_yojson
          (value_for_key string__of_yojson "LatestDigestDeliveryError") _list
          path);
     ...
     is_logging =
       (option_of_yojson (value_for_key boolean__of_yojson "IsLogging") _list
          path)
...
let get_query_results_response_of_yojson tree path =
  ...
  ({
     ...
     query_result_rows =
       (option_of_yojson
          (value_for_key query_result_rows_of_yojson "QueryResultRows") _list
          path);
     query_statistics =
       (option_of_yojson
...
let enable_federation_request_of_yojson tree path =
  ...
  ({
     federation_role_arn =
       (value_for_key federation_role_arn_of_yojson "FederationRoleArn" _list
          path);
     event_data_store =
       (value_for_key event_data_store_arn_of_yojson "EventDataStore" _list
          path)
...
let describe_trails_request_of_yojson tree path =
  ...
  ({
     include_shadow_trails =
       (option_of_yojson
          (value_for_key boolean__of_yojson "includeShadowTrails") _list path);
     trail_name_list =
       (option_of_yojson
