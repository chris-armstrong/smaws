  ...
  let _res : update_trail_response =
    {
      is_organization_trail =
        (option_of_yojson
           (value_for_key boolean__of_yojson "IsOrganizationTrail") _list
           path);
      kms_key_id =
        (option_of_yojson (value_for_key string__of_yojson "KmsKeyId") _list
           path);
      cloud_watch_logs_role_arn =
        (option_of_yojson
           (value_for_key string__of_yojson "CloudWatchLogsRoleArn") _list
           path);
      cloud_watch_logs_log_group_arn =
        (option_of_yojson
           (value_for_key string__of_yojson "CloudWatchLogsLogGroupArn")
           _list path);
      log_file_validation_enabled =
        (option_of_yojson
           (value_for_key boolean__of_yojson "LogFileValidationEnabled")
           _list path);
      trail_ar_n =
        (option_of_yojson (value_for_key string__of_yojson "TrailARN") _list
           path);
      is_multi_region_trail =
        (option_of_yojson
           (value_for_key boolean__of_yojson "IsMultiRegionTrail") _list path);
      include_global_service_events =
        (option_of_yojson
           (value_for_key boolean__of_yojson "IncludeGlobalServiceEvents")
           _list path);
      sns_topic_ar_n =
        (option_of_yojson (value_for_key string__of_yojson "SnsTopicARN")
           _list path);
      sns_topic_name =
        (option_of_yojson (value_for_key string__of_yojson "SnsTopicName")
           _list path);
      s3_key_prefix =
  ...
  let _res : update_trail_request =
    {
      ...
      enable_log_file_validation =
        (option_of_yojson
           (value_for_key boolean__of_yojson "EnableLogFileValidation") _list
           path);
      is_multi_region_trail =
        (option_of_yojson
           (value_for_key boolean__of_yojson "IsMultiRegionTrail") _list path);
...
let operator_of_yojson tree path =
  list_of_yojson operator_value_of_yojson tree path
let advanced_field_selector_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : advanced_field_selector =
    {
      not_ends_with =
        (option_of_yojson (value_for_key operator_of_yojson "NotEndsWith")
           _list path);
      not_starts_with =
        (option_of_yojson (value_for_key operator_of_yojson "NotStartsWith")
           _list path);
      not_equals =
        (option_of_yojson (value_for_key operator_of_yojson "NotEquals")
           _list path);
      ends_with =
        (option_of_yojson (value_for_key operator_of_yojson "EndsWith") _list
           path);
      starts_with =
        (option_of_yojson (value_for_key operator_of_yojson "StartsWith")
           _list path);
      equals =
        (option_of_yojson (value_for_key operator_of_yojson "Equals") _list
           path);
...
let advanced_event_selector_of_yojson tree path =
  ...
  let _res : advanced_event_selector =
    {
      field_selectors =
        (value_for_key advanced_field_selectors_of_yojson "FieldSelectors"
           _list path);
      name =
        (option_of_yojson (value_for_key selector_name_of_yojson "Name")
           _list path)
    } in
  _res
  ...
  let _res : update_event_data_store_response =
    {
      federation_role_arn =
        (option_of_yojson
           (value_for_key federation_role_arn_of_yojson "FederationRoleArn")
           _list path);
      federation_status =
        (option_of_yojson
           (value_for_key federation_status_of_yojson "FederationStatus")
           _list path);
      billing_mode =
        (option_of_yojson
      ...
      kms_key_id =
        (option_of_yojson
           (value_for_key event_data_store_kms_key_id_of_yojson "KmsKeyId")
           _list path);
      updated_timestamp =
      ...
      retention_period =
        (option_of_yojson
           (value_for_key retention_period_of_yojson "RetentionPeriod") _list
           path);
      organization_enabled =
        (option_of_yojson
           (value_for_key boolean__of_yojson "OrganizationEnabled") _list
           path);
      multi_region_enabled =
        (option_of_yojson
           (value_for_key boolean__of_yojson "MultiRegionEnabled") _list path);
      advanced_event_selectors =
        (option_of_yojson
           (value_for_key advanced_event_selectors_of_yojson
              "AdvancedEventSelectors") _list path);
      status =
        (option_of_yojson
           (value_for_key event_data_store_status_of_yojson "Status") _list
           path);
      name =
        (option_of_yojson
           (value_for_key event_data_store_name_of_yojson "Name") _list path);
...
let destination_of_yojson tree path =
  ...
  _res
let destinations_of_yojson tree path =
  list_of_yojson destination_of_yojson tree path
  ...
  let _res : update_channel_response =
    {
      destinations =
        (option_of_yojson
           (value_for_key destinations_of_yojson "Destinations") _list path);
      source =
        (option_of_yojson (value_for_key source_of_yojson "Source") _list
           path);
      name =
        (option_of_yojson (value_for_key channel_name_of_yojson "Name") _list
           path);
      channel_arn =
        (option_of_yojson (value_for_key channel_arn_of_yojson "ChannelArn")
           _list path)
    } in
  _res
...
let trail_info_of_yojson tree path =
  ...
  let _res : trail_info =
    {
      home_region =
        (option_of_yojson (value_for_key string__of_yojson "HomeRegion")
           _list path);
      name =
        (option_of_yojson (value_for_key string__of_yojson "Name") _list path);
      trail_ar_n =
  ...
  _res
let trails_of_yojson tree path =
  list_of_yojson trail_info_of_yojson tree path
let trail_name_list_of_yojson tree path =
  ...
  let _res : trail =
    {
      ...
      has_insight_selectors =
        (option_of_yojson
           (value_for_key boolean__of_yojson "HasInsightSelectors") _list
           path);
      has_custom_event_selectors =
        (option_of_yojson
           (value_for_key boolean__of_yojson "HasCustomEventSelectors") _list
           path);
      kms_key_id =
        (option_of_yojson (value_for_key string__of_yojson "KmsKeyId") _list
           path);
  ...
  let _res : s3_import_source =
    {
      s3_bucket_access_role_arn =
        (value_for_key string__of_yojson "S3BucketAccessRoleArn" _list path);
      s3_bucket_region =
        (value_for_key string__of_yojson "S3BucketRegion" _list path);
      s3_location_uri =
        (value_for_key string__of_yojson "S3LocationUri" _list path)
    } in
  _res
let import_source_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : import_source =
    { s3 = (value_for_key s3_import_source_of_yojson "S3" _list path) } in
  _res
...
let import_statistics_of_yojson tree path =
  ...
  let _res : import_statistics =
    {
      failed_entries =
        (option_of_yojson (value_for_key long_of_yojson "FailedEntries")
           _list path);
      events_completed =
        (option_of_yojson (value_for_key long_of_yojson "EventsCompleted")
           _list path);
      files_completed =
        (option_of_yojson (value_for_key long_of_yojson "FilesCompleted")
           _list path);
      prefixes_completed =
        (option_of_yojson (value_for_key long_of_yojson "PrefixesCompleted")
           _list path);
      prefixes_found =
        (option_of_yojson (value_for_key long_of_yojson "PrefixesFound")
           _list path)
    } in
  _res
  ...
  let _res : stop_import_response =
    {
      import_statistics =
        (option_of_yojson
           (value_for_key import_statistics_of_yojson "ImportStatistics")
           _list path);
      end_event_time =
        (option_of_yojson (value_for_key date_of_yojson "EndEventTime") _list
           path);
      start_event_time =
        (option_of_yojson (value_for_key date_of_yojson "StartEventTime")
           _list path);
      updated_timestamp =
        (option_of_yojson (value_for_key date_of_yojson "UpdatedTimestamp")
           _list path);
      ...
      destinations =
        (option_of_yojson
           (value_for_key import_destinations_of_yojson "Destinations") _list
           path);
      import_source =
        (option_of_yojson
           (value_for_key import_source_of_yojson "ImportSource") _list path);
      import_id =
        (option_of_yojson (value_for_key uui_d_of_yojson "ImportId") _list
           path)
    } in
  _res
let stop_import_request_of_yojson tree path =
  ...
  let _res : stop_import_request =
    { import_id = (value_for_key uui_d_of_yojson "ImportId" _list path) } in
  _res
...
let start_query_response_of_yojson tree path =
  ...
  let _res : start_query_response =
    {
      query_id =
        (option_of_yojson (value_for_key uui_d_of_yojson "QueryId") _list
           path)
    } in
  _res
  ...
  let _res : start_query_request =
    {
      ...
      delivery_s3_uri =
        (option_of_yojson
           (value_for_key delivery_s3_uri_of_yojson "DeliveryS3Uri") _list
           path);
      query_statement =
        (option_of_yojson
...
let resource_tag_of_yojson tree path =
  ...
  let _res : resource_tag =
    {
      tags_list =
        (option_of_yojson (value_for_key tags_list_of_yojson "TagsList")
           _list path);
      resource_id =
        (option_of_yojson (value_for_key string__of_yojson "ResourceId")
           _list path)
    } in
  _res
...
let resource_of_yojson tree path =
  ...
  let _res : resource =
    {
      resource_name =
        (option_of_yojson (value_for_key string__of_yojson "ResourceName")
           _list path);
      resource_type =
...
let register_organization_delegated_admin_request_of_yojson tree path =
  ...
  let _res : register_organization_delegated_admin_request =
    {
      member_account_id =
        (value_for_key account_id_of_yojson "MemberAccountId" _list path)
    } in
  _res
  ...
  let _res : query_statistics_for_describe_query =
    {
      ...
      execution_time_in_millis =
        (option_of_yojson
           (value_for_key integer__of_yojson "ExecutionTimeInMillis") _list
           path);
      bytes_scanned =
        (option_of_yojson (value_for_key long_of_yojson "BytesScanned") _list
           path);
      events_scanned =
        (option_of_yojson (value_for_key long_of_yojson "EventsScanned")
           _list path);
      events_matched =
        (option_of_yojson (value_for_key long_of_yojson "EventsMatched")
           _list path)
    } in
  _res
  ...
  let _res : query_statistics =
    {
      ...
      total_results_count =
        (option_of_yojson
           (value_for_key integer__of_yojson "TotalResultsCount") _list path);
      results_count =
        (option_of_yojson (value_for_key integer__of_yojson "ResultsCount")
           _list path)
    } in
  _res
...
let query_result_column_of_yojson tree path =
  map_of_yojson query_result_key_of_yojson query_result_value_of_yojson tree
    path
let query_result_row_of_yojson tree path =
  list_of_yojson query_result_column_of_yojson tree path
let query_result_rows_of_yojson tree path =
  list_of_yojson query_result_row_of_yojson tree path
...
let put_resource_policy_request_of_yojson tree path =
  ...
  let _res : put_resource_policy_request =
    {
      resource_policy =
        (value_for_key resource_policy_of_yojson "ResourcePolicy" _list path);
      resource_arn =
        (value_for_key resource_arn_of_yojson "ResourceArn" _list path)
    } in
  _res
  ...
  let _res : insight_selector =
    {
      insight_type =
        (option_of_yojson
           (value_for_key insight_type_of_yojson "InsightType") _list path)
    } in
  _res
let insight_selectors_of_yojson tree path =
  list_of_yojson insight_selector_of_yojson tree path
  ...
  let _res : put_insight_selectors_response =
    {
      insights_destination =
        (option_of_yojson
           (value_for_key event_data_store_arn_of_yojson
              "InsightsDestination") _list path);
      event_data_store_arn =
        (option_of_yojson
           (value_for_key event_data_store_arn_of_yojson "EventDataStoreArn")
           _list path);
      insight_selectors =
        (option_of_yojson
           (value_for_key insight_selectors_of_yojson "InsightSelectors")
           _list path);
      trail_ar_n =
        (option_of_yojson (value_for_key string__of_yojson "TrailARN") _list
           path)
  ...
  let _res : put_insight_selectors_request =
    {
      ...
      event_data_store =
        (option_of_yojson
           (value_for_key event_data_store_arn_of_yojson "EventDataStore")
           _list path);
      insight_selectors =
        (value_for_key insight_selectors_of_yojson "InsightSelectors" _list
           path);
      trail_name =
        (option_of_yojson (value_for_key string__of_yojson "TrailName") _list
           path)
    } in
  _res
let data_resource_values_of_yojson tree path =
  list_of_yojson string__of_yojson tree path
  ...
  let _res : data_resource =
    {
      values =
        (option_of_yojson
           (value_for_key data_resource_values_of_yojson "Values") _list path);
      type_ =
        (option_of_yojson (value_for_key string__of_yojson "Type") _list path)
    } in
  _res
let data_resources_of_yojson tree path =
  list_of_yojson data_resource_of_yojson tree path
  ...
  let _res : event_selector =
    {
      exclude_management_event_sources =
        (option_of_yojson
           (value_for_key exclude_management_event_sources_of_yojson
              "ExcludeManagementEventSources") _list path);
      data_resources =
        (option_of_yojson
           (value_for_key data_resources_of_yojson "DataResources") _list
           path);
      include_management_events =
        (option_of_yojson
           (value_for_key boolean__of_yojson "IncludeManagementEvents") _list
           path);
      read_write_type =
        (option_of_yojson
           (value_for_key read_write_type_of_yojson "ReadWriteType") _list
           path)
    } in
  _res
let event_selectors_of_yojson tree path =
  list_of_yojson event_selector_of_yojson tree path
  ...
  let _res : put_event_selectors_response =
    {
      ...
      event_selectors =
        (option_of_yojson
           (value_for_key event_selectors_of_yojson "EventSelectors") _list
           path);
      trail_ar_n =
        (option_of_yojson (value_for_key string__of_yojson "TrailARN") _list
           path)
...
let public_key_of_yojson tree path =
  ...
  let _res : public_key =
    {
      fingerprint =
        (option_of_yojson (value_for_key string__of_yojson "Fingerprint")
           _list path);
      validity_end_time =
        (option_of_yojson (value_for_key date_of_yojson "ValidityEndTime")
           _list path);
      validity_start_time =
        (option_of_yojson (value_for_key date_of_yojson "ValidityStartTime")
           _list path);
      value =
        (option_of_yojson (value_for_key byte_buffer_of_yojson "Value") _list
           path)
    } in
  _res
...
let event_of_yojson tree path =
  ...
  let _res : event =
    {
      cloud_trail_event =
        (option_of_yojson (value_for_key string__of_yojson "CloudTrailEvent")
           _list path);
      resources =
        (option_of_yojson (value_for_key resource_list_of_yojson "Resources")
           _list path);
      username =
      ...
      event_source =
        (option_of_yojson (value_for_key string__of_yojson "EventSource")
           _list path);
      event_time =
        (option_of_yojson (value_for_key date_of_yojson "EventTime") _list
           path);
      access_key_id =
        (option_of_yojson (value_for_key string__of_yojson "AccessKeyId")
           _list path);
      read_only =
        (option_of_yojson (value_for_key string__of_yojson "ReadOnly") _list
           path);
      event_name =
        (option_of_yojson (value_for_key string__of_yojson "EventName") _list
           path);
      event_id =
  ...
  _res
let events_list_of_yojson tree path =
  list_of_yojson event_of_yojson tree path
  ...
  let _res : lookup_events_response =
    {
      next_token =
        (option_of_yojson (value_for_key next_token_of_yojson "NextToken")
           _list path);
      events =
        (option_of_yojson (value_for_key events_list_of_yojson "Events")
           _list path)
    } in
  _res
...
let lookup_attribute_of_yojson tree path =
  ...
  let _res : lookup_attribute =
    {
      attribute_value =
        (value_for_key lookup_attribute_value_of_yojson "AttributeValue"
           _list path);
      attribute_key =
        (value_for_key lookup_attribute_key_of_yojson "AttributeKey" _list
           path)
    } in
  _res
  ...
  let _res : lookup_events_request =
    {
      ...
      event_category =
        (option_of_yojson
           (value_for_key event_category_of_yojson "EventCategory") _list
           path);
      end_time =
  ...
  let _res : list_trails_response =
    {
      next_token =
        (option_of_yojson (value_for_key string__of_yojson "NextToken") _list
           path);
      trails =
        (option_of_yojson (value_for_key trails_of_yojson "Trails") _list
           path)
    } in
  _res
  ...
  let _res : list_tags_response =
    {
      ...
      resource_tag_list =
        (option_of_yojson
           (value_for_key resource_tag_list_of_yojson "ResourceTagList")
           _list path)
    } in
  _res
  ...
  let _res : list_tags_request =
    {
      next_token =
        (option_of_yojson (value_for_key string__of_yojson "NextToken") _list
           path);
      resource_id_list =
        (value_for_key resource_id_list_of_yojson "ResourceIdList" _list path)
    } in
  _res
  ...
  let _res : list_queries_response =
    {
      ...
      queries =
        (option_of_yojson (value_for_key queries_of_yojson "Queries") _list
           path)
    } in
  _res
  ...
  let _res : list_queries_request =
    {
      ...
      max_results =
        (option_of_yojson
           (value_for_key list_queries_max_results_count_of_yojson
  ...
  let _res : list_public_keys_response =
    {
      ...
      public_key_list =
        (option_of_yojson
           (value_for_key public_key_list_of_yojson "PublicKeyList") _list
           path)
    } in
  _res
...
let insights_metric_values_of_yojson tree path =
  list_of_yojson double_of_yojson tree path
  ...
  let _res : list_insights_metric_data_response =
    {
      next_token =
        (option_of_yojson
           (value_for_key insights_metric_next_token_of_yojson "NextToken")
           _list path);
      values =
        (option_of_yojson
           (value_for_key insights_metric_values_of_yojson "Values") _list
           path);
      timestamps =
        (option_of_yojson (value_for_key timestamps_of_yojson "Timestamps")
           _list path);
      error_code =
      ...
      insight_type =
        (option_of_yojson
           (value_for_key insight_type_of_yojson "InsightType") _list path);
      event_name =
        (option_of_yojson (value_for_key event_name_of_yojson "EventName")
           _list path);
      event_source =
        (option_of_yojson
  ...
  let _res : list_insights_metric_data_request =
    {
      ...
      data_type =
        (option_of_yojson
           (value_for_key insights_metric_data_type_of_yojson "DataType")
           _list path);
      period =
        (option_of_yojson
           (value_for_key insights_metric_period_of_yojson "Period") _list
           path);
      end_time =
        (option_of_yojson (value_for_key date_of_yojson "EndTime") _list path);
      start_time =
      ...
      insight_type =
        (value_for_key insight_type_of_yojson "InsightType" _list path);
      event_name =
        (value_for_key event_name_of_yojson "EventName" _list path);
      event_source =
        (value_for_key event_source_of_yojson "EventSource" _list path)
    } in
  _res
let imports_list_item_of_yojson tree path =
  ...
  _res
let imports_list_of_yojson tree path =
  list_of_yojson imports_list_item_of_yojson tree path
  ...
  let _res : list_imports_response =
    {
      next_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "NextToken") _list path);
      imports =
        (option_of_yojson (value_for_key imports_list_of_yojson "Imports")
           _list path)
    } in
  _res
  ...
  let _res : list_imports_request =
    {
      ...
      destination =
        (option_of_yojson
           (value_for_key event_data_store_arn_of_yojson "Destination") _list
           path);
      max_results =
        (option_of_yojson
           (value_for_key list_imports_max_results_count_of_yojson
              "MaxResults") _list path)
    } in
  _res
  ...
  let _res : import_failure_list_item =
    {
      ...
      error_message =
        (option_of_yojson (value_for_key string__of_yojson "ErrorMessage")
           _list path);
      error_type =
        (option_of_yojson (value_for_key string__of_yojson "ErrorType") _list
           path);
      status =
        (option_of_yojson
           (value_for_key import_failure_status_of_yojson "Status") _list
           path);
      location =
        (option_of_yojson (value_for_key string__of_yojson "Location") _list
           path)
    } in
  _res
  ...
  let _res : list_import_failures_response =
    {
      ...
      failures =
        (option_of_yojson
           (value_for_key import_failure_list_of_yojson "Failures") _list
           path)
    } in
  _res
  ...
  let _res : list_import_failures_request =
    {
      ...
      max_results =
        (option_of_yojson
           (value_for_key list_import_failures_max_results_count_of_yojson
              "MaxResults") _list path);
...
let event_data_store_of_yojson tree path =
  ...
  _res
let event_data_stores_of_yojson tree path =
  list_of_yojson event_data_store_of_yojson tree path
  ...
  let _res : list_event_data_stores_response =
    {
      ...
      event_data_stores =
        (option_of_yojson
           (value_for_key event_data_stores_of_yojson "EventDataStores")
           _list path)
    } in
  _res
  ...
  let _res : list_event_data_stores_request =
    {
      max_results =
        (option_of_yojson
           (value_for_key list_event_data_stores_max_results_count_of_yojson
              "MaxResults") _list path);
      next_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "NextToken") _list path)
  ...
  let _res : list_channels_response =
    {
      next_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "NextToken") _list path);
      channels =
        (option_of_yojson (value_for_key channels_of_yojson "Channels") _list
           path)
    } in
  _res
  ...
  let _res : list_channels_request =
    {
      ...
      max_results =
        (option_of_yojson
           (value_for_key list_channels_max_results_count_of_yojson
              "MaxResults") _list path)
    } in
  _res
  ...
  let _res : ingestion_status =
    {
      latest_ingestion_attempt_event_i_d =
        (option_of_yojson
           (value_for_key uui_d_of_yojson "LatestIngestionAttemptEventID")
           _list path);
      latest_ingestion_attempt_time =
        (option_of_yojson
           (value_for_key date_of_yojson "LatestIngestionAttemptTime") _list
           path);
      ...
      latest_ingestion_success_event_i_d =
        (option_of_yojson
           (value_for_key uui_d_of_yojson "LatestIngestionSuccessEventID")
           _list path);
      latest_ingestion_success_time =
        (option_of_yojson
           (value_for_key date_of_yojson "LatestIngestionSuccessTime") _list
           path)
    } in
  _res
  ...
  let _res : get_trail_status_response =
    {
      time_logging_stopped =
        (option_of_yojson
           (value_for_key string__of_yojson "TimeLoggingStopped") _list path);
      time_logging_started =
        (option_of_yojson
           (value_for_key string__of_yojson "TimeLoggingStarted") _list path);
      ...
      latest_notification_attempt_succeeded =
        (option_of_yojson
           (value_for_key string__of_yojson
              "LatestNotificationAttemptSucceeded") _list path);
      latest_notification_attempt_time =
        (option_of_yojson
           (value_for_key string__of_yojson "LatestNotificationAttemptTime")
           _list path);
      latest_delivery_attempt_time =
        (option_of_yojson
           (value_for_key string__of_yojson "LatestDeliveryAttemptTime")
           _list path);
      latest_digest_delivery_error =
        (option_of_yojson
           (value_for_key string__of_yojson "LatestDigestDeliveryError")
           _list path);
      latest_digest_delivery_time =
        (option_of_yojson
           (value_for_key date_of_yojson "LatestDigestDeliveryTime") _list
           path);
      latest_cloud_watch_logs_delivery_time =
        (option_of_yojson
           (value_for_key date_of_yojson "LatestCloudWatchLogsDeliveryTime")
           _list path);
      latest_cloud_watch_logs_delivery_error =
        (option_of_yojson
           (value_for_key string__of_yojson
              "LatestCloudWatchLogsDeliveryError") _list path);
      stop_logging_time =
        (option_of_yojson (value_for_key date_of_yojson "StopLoggingTime")
           _list path);
      start_logging_time =
        (option_of_yojson (value_for_key date_of_yojson "StartLoggingTime")
           _list path);
      latest_notification_time =
        (option_of_yojson
           (value_for_key date_of_yojson "LatestNotificationTime") _list path);
      latest_delivery_time =
        (option_of_yojson (value_for_key date_of_yojson "LatestDeliveryTime")
           _list path);
      latest_notification_error =
        (option_of_yojson
           (value_for_key string__of_yojson "LatestNotificationError") _list
           path);
      latest_delivery_error =
        (option_of_yojson
           (value_for_key string__of_yojson "LatestDeliveryError") _list path);
      is_logging =
        (option_of_yojson (value_for_key boolean__of_yojson "IsLogging")
           _list path)
    } in
  _res
...
let get_trail_response_of_yojson tree path =
  ...
  let _res : get_trail_response =
    {
      trail =
        (option_of_yojson (value_for_key trail_of_yojson "Trail") _list path)
    } in
  _res
  ...
  let _res : get_query_results_response =
    {
      ...
      query_result_rows =
        (option_of_yojson
           (value_for_key query_result_rows_of_yojson "QueryResultRows")
           _list path);
      query_statistics =
        (option_of_yojson
           (value_for_key query_statistics_of_yojson "QueryStatistics") _list
           path);
      query_status =
        (option_of_yojson
           (value_for_key query_status_of_yojson "QueryStatus") _list path)
  ...
  let _res : get_query_results_request =
    {
      max_query_results =
        (option_of_yojson
           (value_for_key max_query_results_of_yojson "MaxQueryResults")
           _list path);
      next_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "NextToken") _list path);
...
let get_event_selectors_request_of_yojson tree path =
  ...
  let _res : get_event_selectors_request =
    { trail_name = (value_for_key string__of_yojson "TrailName" _list path) } in
  _res
  ...
  let _res : get_event_data_store_response =
    {
      partition_keys =
        (option_of_yojson
           (value_for_key partition_key_list_of_yojson "PartitionKeys") _list
           path);
      federation_role_arn =
        (option_of_yojson
           (value_for_key federation_role_arn_of_yojson "FederationRoleArn")
  ...
  let _res : get_channel_response =
    {
      ingestion_status =
        (option_of_yojson
           (value_for_key ingestion_status_of_yojson "IngestionStatus") _list
           path);
      destinations =
        (option_of_yojson
           (value_for_key destinations_of_yojson "Destinations") _list path);
      source_config =
        (option_of_yojson
           (value_for_key source_config_of_yojson "SourceConfig") _list path);
      source =
        (option_of_yojson (value_for_key source_of_yojson "Source") _list
           path);
      name =
...
let get_channel_request_of_yojson tree path =
  ...
  let _res : get_channel_request =
    { channel = (value_for_key channel_arn_of_yojson "Channel" _list path) } in
  _res
...
let describe_trails_response_of_yojson tree path =
  ...
  let _res : describe_trails_response =
    {
      trail_list =
        (option_of_yojson (value_for_key trail_list_of_yojson "trailList")
           _list path)
    } in
  _res
  ...
  let _res : describe_trails_request =
    {
      include_shadow_trails =
        (option_of_yojson
           (value_for_key boolean__of_yojson "includeShadowTrails") _list
           path);
      trail_name_list =
        (option_of_yojson
           (value_for_key trail_name_list_of_yojson "trailNameList") _list
           path)
    } in
  _res
  ...
  let _res : describe_query_response =
    {
      ...
      query_statistics =
        (option_of_yojson
           (value_for_key query_statistics_for_describe_query_of_yojson
              "QueryStatistics") _list path);
      query_status =
        (option_of_yojson
           (value_for_key query_status_of_yojson "QueryStatus") _list path);
      query_string =
        (option_of_yojson
           (value_for_key query_statement_of_yojson "QueryString") _list path);
      query_id =
        (option_of_yojson (value_for_key uui_d_of_yojson "QueryId") _list
           path)
    } in
  ...
  let _res : deregister_organization_delegated_admin_request =
    {
      delegated_admin_account_id =
        (value_for_key account_id_of_yojson "DelegatedAdminAccountId" _list
           path)
    } in
  _res
  ...
  let _res : create_trail_request =
    {
      ...
      s3_key_prefix =
        (option_of_yojson (value_for_key string__of_yojson "S3KeyPrefix")
           _list path);
      s3_bucket_name =
        (value_for_key string__of_yojson "S3BucketName" _list path);
      name = (value_for_key string__of_yojson "Name" _list path)
    } in
  _res
  ...
  let _res : create_event_data_store_request =
    {
      billing_mode =
        (option_of_yojson
           (value_for_key billing_mode_of_yojson "BillingMode") _list path);
      start_ingestion =
        (option_of_yojson (value_for_key boolean__of_yojson "StartIngestion")
           _list path);
      kms_key_id =
        (option_of_yojson
           (value_for_key event_data_store_kms_key_id_of_yojson "KmsKeyId")
