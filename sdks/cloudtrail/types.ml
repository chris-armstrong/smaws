type nonrec query_alias = string [@@ocaml.doc ""]

type nonrec query_statement = string [@@ocaml.doc ""]

type nonrec query_parameter = string [@@ocaml.doc ""]

type nonrec query_parameters = query_parameter list [@@ocaml.doc ""]

type nonrec view_properties_value = string [@@ocaml.doc ""]

type nonrec view_properties_key = string [@@ocaml.doc ""]

type nonrec view_properties_map = (view_properties_key * view_properties_value) list
[@@ocaml.doc ""]
  ...
  view_properties : view_properties_map option;
      [@ocaml.doc
        " The view properties for the widget. For more information about view properties, see \
         ...
         View properties for widgets } in the {i CloudTrail User Guide}.. \n"]
  query_parameters : query_parameters option;
      [@ocaml.doc " The query parameters for the widget. \n"]
  query_statement : query_statement option;
      [@ocaml.doc " The SQL query statement for the widget. \n"]
  query_alias : query_alias option;
      [@ocaml.doc "The query alias used to identify the query for the widget. \n"]
}
...
type nonrec update_trail_response = {
  is_organization_trail : boolean_ option;
  ...
  cloud_watch_logs_role_arn : string_ option;
      [@ocaml.doc
        "Specifies the role for the CloudWatch Logs endpoint to assume to write to a user's log \
         group.\n"]
  cloud_watch_logs_log_group_arn : string_ option;
      [@ocaml.doc
        "Specifies the Amazon Resource Name (ARN) of the log group to which CloudTrail logs are \
         delivered.\n"]
  log_file_validation_enabled : boolean_ option;
      [@ocaml.doc "Specifies whether log file integrity validation is enabled.\n"]
  trail_ar_n : string_ option;
      [@ocaml.doc
        ...
        \ "]
  is_multi_region_trail : boolean_ option;
      [@ocaml.doc "Specifies whether the trail exists in one Region or in all Regions.\n"]
  include_global_service_events : boolean_ option;
      [@ocaml.doc
  ...
  sns_topic_ar_n : string_ option;
      [@ocaml.doc
        "Specifies the ARN of the Amazon SNS topic that CloudTrail uses to send notifications when \
         log files are delivered. The following is the format of a topic ARN.\n\n\
        \  [arn:aws:sns:us-east-2:123456789012:MyTopic] \n\
        \ "]
  sns_topic_name : string_ option;
  ...
  s3_key_prefix : string_ option;
      [@ocaml.doc
        "Specifies the Amazon S3 key prefix that comes after the name of the bucket you have \
         designated for log file delivery. For more information, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/get-and-view-cloudtrail-log-files.html#cloudtrail-find-log-files}Finding \
         Your IAM Log Files}.\n"]
  s3_bucket_name : string_ option;
      [@ocaml.doc
        "Specifies the name of the Amazon S3 bucket designated for publishing log files.\n"]
  name : string_ option; [@ocaml.doc "Specifies the name of the trail.\n"]
}
[@@ocaml.doc
  ...
  is_organization_trail : boolean_ option;
      [@ocaml.doc
        "Specifies whether the trail is applied to all accounts in an organization in \
         ...
         that is the management account for an organization in Organizations. If the trail is not \
         an organization trail and this is set to [true], the trail will be created in all Amazon \
         Web Services accounts that belong to the organization. If the trail is an organization \
         trail and this is set to [false], the trail will remain in the current Amazon Web \
  ...
  kms_key_id : string_ option;
      [@ocaml.doc
        ...
        \ CloudTrail also supports KMS multi-Region keys. For more information about multi-Region \
         ...
         multi-Region keys} in the {i Key Management Service Developer Guide}.\n\
        \ \n\
        \  Examples:\n\
        \  \n\
        \   {ul\n\
  ...
  cloud_watch_logs_log_group_arn : string_ option;
      [@ocaml.doc
        "Specifies a log group name using an Amazon Resource Name (ARN), a unique identifier that \
         represents the log group to which CloudTrail logs are delivered. You must use a log group \
         that exists in your account.\n\n\
        \ Not required unless you specify [CloudWatchLogsRoleArn].\n\
        \ "]
  enable_log_file_validation : boolean_ option;
      [@ocaml.doc
        ...
        \  When you disable log file integrity validation, the chain of digest files is broken \
         ...
         during a period in which log file integrity validation was disabled. For example, if you \
         enable log file integrity validation at noon on January 1, disable it at noon on January \
         2, and re-enable it at noon on January 10, digest files will not be created for the log \
         files delivered from noon on January 2 to noon on January 10. The same applies whenever \
...
type nonrec unsupported_operation_exception = {
  message : error_message option;
      [@ocaml.doc "Brief description of the exception returned by the request.\n"]
}
[@@ocaml.doc "This exception is thrown when the requested operation is not supported.\n"]
...
[@@ocaml.doc "This exception is thrown when the trail with the given name is not found.\n"]

type nonrec throttling_exception = {
  message : error_message option;
      [@ocaml.doc "Brief description of the exception returned by the request.\n"]
}
[@@ocaml.doc " This exception is thrown when the request rate exceeds the limit. \n"]

type nonrec s3_bucket_does_not_exist_exception = {
  message : error_message option;
      [@ocaml.doc "Brief description of the exception returned by the request.\n"]
}
[@@ocaml.doc "This exception is thrown when the specified S3 bucket does not exist.\n"]
...
[@@ocaml.doc
  "This exception is thrown when the request is made from an Amazon Web Services account that is \
   not a member of an organization. To make this request, sign in using the credentials of an \
...
[@@ocaml.doc
  "This exception is thrown when Organizations is not configured to support all features. All \
   features must be enabled in Organizations to support creating an organization trail or event \
   data store.\n"]
...
[@@ocaml.doc "This exception is thrown when the requested operation is not permitted.\n"]
...
[@@ocaml.doc
  "This exception is thrown when the Amazon Web Services account making the request to create or \
   update an organization trail or event data store is not the management account for an \
   ...
   For Creating a Trail For Your Organization} or \
   {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-lake-organizations.html}Organization \
   event data stores}.\n"]
...
[@@ocaml.doc
  "This exception is thrown when the KMS key does not exist, when the S3 bucket and the KMS key \
   are not in the same Region, or when the KMS key associated with the Amazon SNS topic either \
   does not exist or is not in the same Region.\n"]
...
[@@ocaml.doc
  "This exception is thrown when there is an issue with the specified KMS key and the trail or \
   event data store can't be updated.\n"]
...
[@@ocaml.doc "This exception is thrown when the provided SNS topic name is not valid.\n"]

type nonrec invalid_s3_prefix_exception = {
  message : error_message option;
      [@ocaml.doc "Brief description of the exception returned by the request.\n"]
}
[@@ocaml.doc "This exception is thrown when the provided S3 prefix is not valid.\n"]

type nonrec invalid_s3_bucket_name_exception = {
  message : error_message option;
      [@ocaml.doc "Brief description of the exception returned by the request.\n"]
}
[@@ocaml.doc "This exception is thrown when the provided S3 bucket name is not valid.\n"]
...
[@@ocaml.doc "This exception is thrown when the combination of parameters provided is not valid.\n"]
...
[@@ocaml.doc
  "This exception is thrown when an operation is called on a trail from a Region other than the \
...
[@@ocaml.doc
  "This exception is thrown when the [PutEventSelectors] operation is called with a number of \
   event selectors, advanced event selectors, or data resources that is not valid. The combination \
   of event selectors or advanced event selectors and data resources is not valid. A trail can \
   have up to 5 event selectors. If a trail uses advanced event selectors, a maximum of 500 total \
   values for all conditions in all advanced event selectors is allowed. A trail is limited to 250 \
   data resources. These data resources can be distributed across event selectors, but the overall \
  ...
  \        {-  Specify a valid number of data resources (1 to 250) for an event selector. The \
   limit of number of resources on an individual event selector is configurable up to 250. \
   However, this upper limit is allowed only if the total number of data resources does not exceed \
...
[@@ocaml.doc "This exception is thrown when the provided role is not valid.\n"]

type nonrec invalid_cloud_watch_logs_log_group_arn_exception = {
  message : error_message option;
      [@ocaml.doc "Brief description of the exception returned by the request.\n"]
}
[@@ocaml.doc "This exception is thrown when the provided CloudWatch Logs log group is not valid.\n"]
...
[@@ocaml.doc "This exception is thrown when the policy on the S3 bucket is not sufficient.\n"]
...
[@@ocaml.doc
  "For the [CreateTrail] [PutInsightSelectors], [UpdateTrail], [StartQuery], and [StartImport] \
   operations, this exception is thrown when the policy on the S3 bucket or KMS key does not have \
   sufficient permissions for the operation.\n\n\
  \ For all other operations, this exception is thrown when the policy for the KMS key does not \
...
[@@ocaml.doc
  "This exception is thrown when the IAM identity that is used to create the organization resource \
   lacks one or more required permissions for creating an organization resource in a required \
   service.\n"]
...
[@@ocaml.doc
  "This exception is thrown when the specified resource is not ready for an operation. This can \
   occur when you try to run an operation on a resource before CloudTrail has time to fully load \
   the resource, or because another operation is modifying the resource. If this exception occurs, \
...
[@@ocaml.doc
  "This exception is thrown when a call results in the [InvalidClientTokenId] error code. This can \
   occur when you are creating or updating a trail to send notifications to an Amazon SNS topic \
   that is in a suspended Amazon Web Services account.\n"]
...
[@@ocaml.doc
  "This exception is thrown when trusted access has not been enabled between CloudTrail and \
   ...
   {{:https://docs.aws.amazon.com/organizations/latest/userguide/orgs_integrate_services.html#orgs_how-to-enable-disable-trusted-access}How \
   to enable or disable trusted access} in the {i Organizations User Guide} and \
   {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/creating-an-organizational-trail-prepare.html}Prepare \
   For Creating a Trail For Your Organization} in the {i CloudTrail User Guide}.\n"]

type nonrec event_data_store_arn = string [@@ocaml.doc ""]

type nonrec event_data_store_name = string [@@ocaml.doc ""]
...
type nonrec selector_name = string [@@ocaml.doc ""]

type nonrec selector_field = string [@@ocaml.doc ""]

type nonrec operator_value = string [@@ocaml.doc ""]

type nonrec operator = operator_value list [@@ocaml.doc ""]

type nonrec advanced_field_selector = {
  not_ends_with : operator option;
      [@ocaml.doc
  ...
  field : selector_field;
      [@ocaml.doc
        " A field in a CloudTrail event record on which to filter events to be logged. For event \
         ...
         events as filtering is not supported.\n\n\
        ...
        \ \n\
        \   Selectors don't support the use of wildcards like [*] . To match multiple values with \
         a single condition, you may use [StartsWith], [EndsWith], [NotStartsWith], or \
...
type nonrec advanced_field_selectors = advanced_field_selector list [@@ocaml.doc ""]

type nonrec advanced_event_selector = {
  field_selectors : advanced_field_selectors;
      [@ocaml.doc "Contains all selector statements in an advanced event selector.\n"]
  name : selector_name option;
      [@ocaml.doc
        "An optional, descriptive name for an advanced event selector, such as \"Log data events \
         for only two S3 buckets\".\n"]
}
[@@ocaml.doc
  "Advanced event selectors let you create fine-grained selectors for CloudTrail management, data, \
   and network activity events. They help you control costs by logging only those events that are \
   important to you. For more information about configuring advanced event selectors, see the \
   ...
   management events} topics in the {i CloudTrail User Guide}.\n\n\
  \ You cannot apply both event selectors and advanced event selectors to a trail.\n\
  \ \n\
  \  For information about configurable advanced event selector fields, see \
   {{:https://docs.aws.amazon.com/awscloudtrail/latest/APIReference/API_AdvancedEventSelector.html}AdvancedEventSelector} \
   in the {i CloudTrail API Reference}.\n\
  \  "]

type nonrec advanced_event_selectors = advanced_event_selector list [@@ocaml.doc ""]

type nonrec retention_period = int [@@ocaml.doc ""]

type nonrec termination_protection_enabled = bool [@@ocaml.doc ""]

type nonrec date = Smaws_Lib.CoreTypes.Timestamp.t [@@ocaml.doc ""]

type nonrec event_data_store_kms_key_id = string [@@ocaml.doc ""]
...
type nonrec federation_role_arn = string [@@ocaml.doc ""]

type nonrec update_event_data_store_response = {
  federation_role_arn : federation_role_arn option;
      [@ocaml.doc
        " If Lake query federation is enabled, provides the ARN of the federation role used to \
         access the resources for the federated event data store. \n"]
  federation_status : federation_status option;
      [@ocaml.doc
        " Indicates the \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-federation.html}Lake \
         query federation} status. The status is [ENABLED] if Lake query federation is enabled, or \
         [DISABLED] if Lake query federation is disabled. You cannot delete an event data store if \
         the [FederationStatus] is [ENABLED]. \n"]
  billing_mode : billing_mode option; [@ocaml.doc "The billing mode for the event data store.\n"]
  kms_key_id : event_data_store_kms_key_id option;
      [@ocaml.doc
        "Specifies the KMS key ID that encrypts the events delivered by CloudTrail. The value is a \
         fully specified ARN to a KMS key in the following format.\n\n\
        \  [arn:aws:kms:us-east-2:123456789012:key/12345678-1234-1234-1234-123456789012] \n\
        \ "]
  updated_timestamp : date option;
      [@ocaml.doc
  ...
  created_timestamp : date option;
      [@ocaml.doc "The timestamp that shows when an event data store was first created.\n"]
  termination_protection_enabled : termination_protection_enabled option;
      [@ocaml.doc "Indicates whether termination protection is enabled for the event data store.\n"]
  retention_period : retention_period option; [@ocaml.doc "The retention period, in days.\n"]
  organization_enabled : boolean_ option;
      [@ocaml.doc
        "Indicates whether an event data store is collecting logged events for an organization in \
         Organizations.\n"]
  multi_region_enabled : boolean_ option;
      [@ocaml.doc
        "Indicates whether the event data store includes events from all Regions, or only from the \
         Region in which it was created.\n"]
  advanced_event_selectors : advanced_event_selectors option;
      [@ocaml.doc "The advanced event selectors that are applied to the event data store.\n"]
  status : event_data_store_status option; [@ocaml.doc "The status of an event data store.\n"]
  name : event_data_store_name option; [@ocaml.doc "The name of the event data store.\n"]
  event_data_store_arn : event_data_store_arn option;
...
type nonrec update_event_data_store_request = {
  billing_mode : billing_mode option;
      [@ocaml.doc
        " You can't change the billing mode from [EXTENDABLE_RETENTION_PRICING] to \
         [FIXED_RETENTION_PRICING]. If [BillingMode] is set to [EXTENDABLE_RETENTION_PRICING] and \
         you want to use [FIXED_RETENTION_PRICING] instead, you'll need to stop ingestion on the \
         event data store and create a new event data store that uses [FIXED_RETENTION_PRICING].\n\
        \ \n\
        \   The billing mode for the event data store determines the cost for ingesting events and \
         the default and maximum retention period for the event data store.\n\
        \   \n\
        \    The following are the possible values:\n\
        \    \n\
        \     {ul\n\
        \           {-   [EXTENDABLE_RETENTION_PRICING] - This billing mode is generally \
         recommended if you want a flexible retention period of up to 3653 days (about 10 years). \
        ...
        \           {-   [FIXED_RETENTION_PRICING] - This billing mode is recommended if you \
         expect to ingest more than 25 TB of event data per month and need a retention period of \
         up to 2557 days (about 7 years). The default retention period for this billing mode is \
         2557 days.\n\
        \               \n\
        \                }\n\
        \           }\n\
        \   For more information about CloudTrail pricing, see \
         {{:http://aws.amazon.com/cloudtrail/pricing/}CloudTrail Pricing} and \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-lake-manage-costs.html}Managing \
         CloudTrail Lake costs}.\n\
        \   "]
  kms_key_id : event_data_store_kms_key_id option;
      [@ocaml.doc
        "Specifies the KMS key ID to use to encrypt the events delivered by CloudTrail. The value \
         can be an alias name prefixed by [alias/], a fully specified ARN to an alias, a fully \
         specified ARN to a key, or a globally unique identifier.\n\n\
        \  Disabling or deleting the KMS key, or removing CloudTrail permissions on the key, \
         prevents CloudTrail from logging events to the event data store, and prevents users from \
         querying the data in the event data store that was encrypted with the key. After you \
         associate an event data store with a KMS key, the KMS key cannot be removed or changed. \
         Before you disable or delete a KMS key that you are using with an event data store, \
  ...
  retention_period : retention_period option;
      [@ocaml.doc
        "The retention period of the event data store, in days. If [BillingMode] is set to \
         [EXTENDABLE_RETENTION_PRICING], you can set a retention period of up to 3653 days, the \
         equivalent of 10 years. If [BillingMode] is set to [FIXED_RETENTION_PRICING], you can set \
         a retention period of up to 2557 days, the equivalent of seven years.\n\n\
        ...
        \   If you decrease the retention period of an event data store, CloudTrail will remove \
         any events with an [eventTime] older than the new retention period. For example, if the \
  ...
  organization_enabled : boolean_ option;
      [@ocaml.doc
        "Specifies whether an event data store collects events logged for an organization in \
         Organizations.\n\n\
        \  Only the management account for the organization can convert an organization event data \
         store to a non-organization event data store, or convert a non-organization event data \
         store to an organization event data store.\n\
        \  \n\
        \   "]
  multi_region_enabled : boolean_ option;
      [@ocaml.doc
  ...
  name : event_data_store_name option; [@ocaml.doc "The event data store name.\n"]
...
[@@ocaml.doc
  "For [PutInsightSelectors], this exception is thrown when the formatting or syntax of the \
   ...
   destination event data store specified by the [InsightsDestination] parameter must log Insights \
   events and the source event data store specified by the [EventDataStore] parameter must log \
   management events.\n\n\
  \ For [UpdateEventDataStore], this exception is thrown if Insights are enabled on the event data \
   ...
   [ApiCallRateInsight], the source event data store must log [write] management events. If the \
   [InsightSelectors] includes an [InsightType] of [ApiErrorRateInsight], the source event data \
   store must log management events.\n\
  \ "]
...
[@@ocaml.doc
  " This exception is thrown when you try to update or delete an event data store that currently \
   has an import in progress. \n"]
...
type nonrec dashboard_type = CUSTOM [@ocaml.doc ""] | MANAGED [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec refresh_schedule_frequency_unit = DAYS [@ocaml.doc ""] | HOURS [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec refresh_schedule_frequency_value = int [@@ocaml.doc ""]

type nonrec refresh_schedule_frequency = {
  value : refresh_schedule_frequency_value option;
      [@ocaml.doc
...
type nonrec refresh_schedule_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec time_of_day = string [@@ocaml.doc ""]

type nonrec refresh_schedule = {
  time_of_day : time_of_day option;
      [@ocaml.doc
        " The time of day in UTC to run the schedule; for hourly only refer to minutes; default is \
         00:00. \n"]
  status : refresh_schedule_status option;
      [@ocaml.doc
        " Specifies whether the refresh schedule is enabled. Set the value to [ENABLED] to enable \
         the refresh schedule, or to [DISABLED] to turn off the refresh schedule. \n"]
  frequency : refresh_schedule_frequency option;
      [@ocaml.doc " The frequency at which you want the dashboard refreshed. \n"]
}
[@@ocaml.doc " The schedule for a dashboard refresh. \n"]

type nonrec update_dashboard_response = {
  updated_timestamp : date option;
      [@ocaml.doc " The timestamp that shows when the dashboard was updated. \n"]
  created_timestamp : date option;
      [@ocaml.doc " The timestamp that shows when the dashboard was created. \n"]
  termination_protection_enabled : termination_protection_enabled option;
      [@ocaml.doc " Indicates whether termination protection is enabled for the dashboard. \n"]
  refresh_schedule : refresh_schedule option;
      [@ocaml.doc " The refresh schedule for the dashboard, if configured. \n"]
  widgets : widget_list option; [@ocaml.doc " An array of widgets for the dashboard. \n"]
  type_ : dashboard_type option; [@ocaml.doc " The type of dashboard. \n"]
  name : dashboard_name option; [@ocaml.doc " The name for the dashboard. \n"]
  dashboard_arn : dashboard_arn option; [@ocaml.doc " The ARN for the dashboard. \n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc " Contains information about a widget on a CloudTrail Lake dashboard. \n"]

type nonrec request_widget_list = request_widget list [@@ocaml.doc ""]

type nonrec update_dashboard_request = {
  termination_protection_enabled : termination_protection_enabled option;
      [@ocaml.doc
        " Specifies whether termination protection is enabled for the dashboard. If termination \
         protection is enabled, you cannot delete the dashboard until termination protection is \
         disabled. \n"]
  refresh_schedule : refresh_schedule option;
      [@ocaml.doc " The refresh schedule configuration for the dashboard. \n"]
  widgets : request_widget_list option;
      [@ocaml.doc
        " An array of widgets for the dashboard. A custom dashboard can have a maximum of 10 \
         widgets. \n\n\
        \ To add new widgets, pass in an array that includes the existing widgets along with any \
         new widgets. Run the [GetDashboard] operation to get the list of widgets for the \
         dashboard.\n\
        \ \n\
        \  To remove widgets, pass in an array that includes the existing widgets minus the \
         widgets you want removed.\n\
        \  "]
...
[@@ocaml.doc
  " This exception is thrown when the quota is exceeded. For information about CloudTrail quotas, \
   see {{:https://docs.aws.amazon.com/general/latest/gr/ct.html#limits_cloudtrail}Service quotas} \
...
[@@ocaml.doc "This exception is thrown when the specified resource is not found.\n"]
...
[@@ocaml.doc
  "The query that was submitted has validation errors, or uses incorrect syntax or unsupported \
   keywords. For more information about writing a query, see \
   {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-create-edit-query.html}Create \
   or edit a query} in the {i CloudTrail User Guide}.\n"]

type nonrec channel_arn = string [@@ocaml.doc ""]

type nonrec channel_name = string [@@ocaml.doc ""]

type nonrec source = string [@@ocaml.doc ""]

type nonrec destination_type = AWS_SERVICE [@ocaml.doc ""] | EVENT_DATA_STORE [@ocaml.doc ""]
[@@ocaml.doc ""]
  ...
  location : location;
      [@ocaml.doc
        " For channels used for a CloudTrail Lake integration, the location is the ARN of an event \
         data store that receives events from a channel. For service-linked channels, the location \
         is the name of the Amazon Web Services service.\n"]
  type_ : destination_type;
      [@ocaml.doc
        "The type of destination for events arriving from a channel. For channels used for a \
         CloudTrail Lake integration, the value is [EVENT_DATA_STORE]. For service-linked \
         channels, the value is [AWS_SERVICE]. \n"]
}
[@@ocaml.doc "Contains information about the destination receiving events.\n"]

type nonrec destinations = destination list [@@ocaml.doc ""]

type nonrec update_channel_response = {
  destinations : destinations option;
      [@ocaml.doc "The event data stores that log events arriving through the channel.\n"]
  source : source option; [@ocaml.doc "The event source of the channel that was updated.\n"]
  name : channel_name option; [@ocaml.doc "The name of the channel that was updated.\n"]
  channel_arn : channel_arn option; [@ocaml.doc "The ARN of the channel that was updated.\n"]
}
[@@ocaml.doc ""]

type nonrec update_channel_request = {
  name : channel_name option; [@ocaml.doc " Changes the name of the channel. \n"]
  destinations : destinations option;
      [@ocaml.doc
        "The ARNs of event data stores that you want to log events arriving through the channel.\n"]
  channel : channel_arn;
      [@ocaml.doc "The ARN or ID (the ARN suffix) of the channel that you want to update.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "This exception is thrown when CloudTrail cannot find the specified channel.\n"]

type nonrec channel_arn_invalid_exception = {
  message : error_message option;
      [@ocaml.doc "Brief description of the exception returned by the request.\n"]
}
[@@ocaml.doc "This exception is thrown when the specified value of [ChannelARN] is not valid.\n"]

type nonrec channel_already_exists_exception = {
  message : error_message option;
      [@ocaml.doc "Brief description of the exception returned by the request.\n"]
}
[@@ocaml.doc " This exception is thrown when the provided channel already exists. \n"]

type nonrec uui_d = string [@@ocaml.doc ""]

type nonrec type_ = RequestContext [@ocaml.doc ""] | TagContext [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec trail_info = {
  home_region : string_ option;
      [@ocaml.doc "The Amazon Web Services Region in which a trail was created.\n"]
  name : string_ option; [@ocaml.doc "The name of a trail.\n"]
  trail_ar_n : string_ option; [@ocaml.doc "The ARN of a trail.\n"]
}
[@@ocaml.doc
  "Information about a CloudTrail trail, including the trail's name, home Region, and Amazon \
   Resource Name (ARN).\n"]

type nonrec trails = trail_info list [@@ocaml.doc ""]

type nonrec trail_name_list = string_ list [@@ocaml.doc ""]

type nonrec trail = {
  is_organization_trail : boolean_ option;
      [@ocaml.doc "Specifies whether the trail is an organization trail.\n"]
  has_insight_selectors : boolean_ option;
      [@ocaml.doc
        "Specifies whether a trail has insight types specified in an [InsightSelector] list.\n"]
  has_custom_event_selectors : boolean_ option;
  ...
  trail_ar_n : string_ option;
      [@ocaml.doc
        ...
        \  [arn:aws:cloudtrail:us-east-2:123456789012:trail/MyTrail] \n\
        \ "]
  home_region : string_ option; [@ocaml.doc "The Region in which the trail was created.\n"]
  is_multi_region_trail : boolean_ option;
      [@ocaml.doc
        "Specifies whether the trail exists only in one Region or exists in all Regions.\n"]
  include_global_service_events : boolean_ option;
      [@ocaml.doc
        "Set to {b True} to include Amazon Web Services API calls from Amazon Web Services global \
         services such as IAM. Otherwise, {b False}.\n"]
  sns_topic_ar_n : string_ option;
      [@ocaml.doc
        "Specifies the ARN of the Amazon SNS topic that CloudTrail uses to send notifications when \
         log files are delivered. The following is the format of a topic ARN.\n\n\
...
type nonrec trail_list = trail list [@@ocaml.doc ""]
...
[@@ocaml.doc
  "A custom key-value pair associated with a resource such as a CloudTrail trail, event data \
...
[@@ocaml.doc
  "The number of tags per trail, event data store, dashboard, or channel has exceeded the \
   permitted amount. Currently, the limit is 50.\n"]

type nonrec stop_logging_response = unit [@@ocaml.doc ""]
...
[@@ocaml.doc
  "Passes the request to CloudTrail to stop logging Amazon Web Services API calls for the \
   specified account.\n"]
...
type nonrec s3_import_source = {
  ...
  s3_bucket_region : string_; [@ocaml.doc " The Region associated with the source S3 bucket. \n"]
  s3_location_uri : string_; [@ocaml.doc " The URI for the source S3 bucket. \n"]
}
[@@ocaml.doc " The settings for the source S3 bucket. \n"]

type nonrec import_source = { s3 : s3_import_source [@ocaml.doc " The source S3 bucket. \n"] }
[@@ocaml.doc " The import source. \n"]

type nonrec import_destinations = event_data_store_arn list [@@ocaml.doc ""]
...
type nonrec import_statistics = {
  ...
  events_completed : long option;
      [@ocaml.doc " The number of trail events imported into the event data store. \n"]
  files_completed : long option; [@ocaml.doc "The number of log files that completed import.\n"]
  prefixes_completed : long option;
      [@ocaml.doc " The number of S3 prefixes that completed import. \n"]
  prefixes_found : long option; [@ocaml.doc " The number of S3 prefixes found for the import. \n"]
}
[@@ocaml.doc
  " Provides statistics for the specified [ImportID]. CloudTrail does not update import statistics \
   in real-time. Returned values for parameters such as [EventsCompleted] may be lower than the \
   actual value, because CloudTrail updates statistics incrementally over the course of the \
   import. \n"]
...
type nonrec stop_import_response = {
  ...
  start_event_time : date option;
      [@ocaml.doc
        " Used with [EndEventTime] to bound a [StartImport] request, and limit imported trail \
         events to only those events logged within a specified time period. \n"]
  updated_timestamp : date option; [@ocaml.doc " The timestamp of the import's last update. \n"]
  created_timestamp : date option; [@ocaml.doc " The timestamp of the import's creation. \n"]
  import_status : import_status option; [@ocaml.doc " The status of the import. \n"]
  destinations : import_destinations option;
      [@ocaml.doc " The ARN of the destination event data store. \n"]
  import_source : import_source option; [@ocaml.doc " The source S3 bucket for the import. \n"]
  import_id : uui_d option; [@ocaml.doc " The ID for the import. \n"]
}
[@@ocaml.doc ""]

type nonrec stop_import_request = { import_id : uui_d [@ocaml.doc " The ID of the import. \n"] }
[@@ocaml.doc ""]
...
type nonrec stop_event_data_store_ingestion_response = unit [@@ocaml.doc ""]
...
[@@ocaml.doc "The event data store is not in a status that supports the operation.\n"]

type nonrec account_id = string [@@ocaml.doc ""]

type nonrec start_query_response = {
  event_data_store_owner_account_id : account_id option;
      [@ocaml.doc " The account ID of the event data store owner. \n"]
  query_id : uui_d option; [@ocaml.doc "The ID of the started query.\n"]
}
[@@ocaml.doc ""]

type nonrec delivery_s3_uri = string [@@ocaml.doc ""]
...
type nonrec start_query_request = {
  ...
  query_alias : query_alias option; [@ocaml.doc " The alias that identifies a query template. \n"]
  delivery_s3_uri : delivery_s3_uri option;
      [@ocaml.doc " The URI for the S3 bucket where CloudTrail delivers the query results. \n"]
  query_statement : query_statement option; [@ocaml.doc "The SQL code of your query.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "You are already running the maximum number of concurrent queries. The maximum number of \
   concurrent queries is 10. Wait a minute for some queries to finish, and then run the query \
   again.\n"]

type nonrec start_logging_response = unit [@@ocaml.doc ""]
...
type nonrec start_import_response = {
  updated_timestamp : date option;
      [@ocaml.doc " The timestamp of the import's last update, if applicable. \n"]
  created_timestamp : date option; [@ocaml.doc " The timestamp for the import's creation. \n"]
  import_status : import_status option;
      [@ocaml.doc
        " Shows the status of the import after a [StartImport] request. An import finishes with a \
         status of [COMPLETED] if there were no failures, or [FAILED] if there were failures. \n"]
  end_event_time : date option;
      [@ocaml.doc
        " Used with [StartEventTime] to bound a [StartImport] request, and limit imported trail \
         events to only those events logged within a specified time period. \n"]
  ...
  destinations : import_destinations option;
      [@ocaml.doc " The ARN of the destination event data store. \n"]
  import_id : uui_d option; [@ocaml.doc " The ID of the import. \n"]
}
[@@ocaml.doc ""]

type nonrec start_import_request = {
  import_id : uui_d option;
      [@ocaml.doc " The ID of the import. Use this parameter when you are retrying an import. \n"]
  end_event_time : date option;
      [@ocaml.doc
        " Use with [StartEventTime] to bound a [StartImport] request, and limit imported trail \
         events to only those events logged within a specified time period. When you specify a \
         time range, CloudTrail checks the prefix and log file names to verify the names contain a \
         date between the specified [StartEventTime] and [EndEventTime] before attempting to \
         import events. \n"]
  start_event_time : date option;
      [@ocaml.doc
  ...
  import_source : import_source option;
      [@ocaml.doc " The source S3 bucket for the import. Use this parameter for a new import. \n"]
  destinations : import_destinations option;
      [@ocaml.doc
...
type nonrec start_event_data_store_ingestion_response = unit [@@ocaml.doc ""]
...
type nonrec refresh_id = string [@@ocaml.doc ""]

type nonrec start_dashboard_refresh_response = {
  refresh_id : refresh_id option; [@ocaml.doc " The refresh ID for the dashboard. \n"]
}
[@@ocaml.doc ""]

type nonrec query_parameter_value = string [@@ocaml.doc ""]

type nonrec query_parameter_key = string [@@ocaml.doc ""]

type nonrec query_parameter_values = (query_parameter_key * query_parameter_value) list
[@@ocaml.doc ""]
...
type nonrec source_config = {
  advanced_event_selectors : advanced_event_selectors option;
      [@ocaml.doc " The advanced event selectors that are configured for the channel.\n"]
  apply_to_all_regions : boolean_ option;
      [@ocaml.doc " Specifies whether the channel applies to a single Region or to all Regions.\n"]
}
[@@ocaml.doc " Contains configuration information about the channel. \n"]

type nonrec sample_query_name = string [@@ocaml.doc ""]

type nonrec sample_query_description = string [@@ocaml.doc ""]

type nonrec sample_query_sq_l = string [@@ocaml.doc ""]

type nonrec sample_query_relevance = float [@@ocaml.doc ""]

type nonrec search_sample_queries_search_result = {
  relevance : sample_query_relevance option;
      [@ocaml.doc
        " A value between 0 and 1 indicating the similarity between the search phrase and result. \n"]
  sq_l : sample_query_sq_l option; [@ocaml.doc " The SQL code of the sample query. \n"]
  description : sample_query_description option;
      [@ocaml.doc " A longer description of a sample query. \n"]
  name : sample_query_name option; [@ocaml.doc " The name of a sample query. \n"]
}
[@@ocaml.doc " A search result returned by the [SearchSampleQueries] operation. \n"]

type nonrec search_sample_queries_search_results = search_sample_queries_search_result list
[@@ocaml.doc ""]

type nonrec search_sample_queries_search_phrase = string [@@ocaml.doc ""]
...
type nonrec search_sample_queries_response = {
  ...
  search_results : search_sample_queries_search_results option;
      [@ocaml.doc
        " A list of objects containing the search results ordered from most relevant to least \
         relevant. \n"]
}
[@@ocaml.doc ""]

type nonrec search_sample_queries_max_results = int [@@ocaml.doc ""]

type nonrec search_sample_queries_request = {
  next_token : pagination_token option;
      [@ocaml.doc
        " A token you can use to get the next page of results. The length constraint is in \
         characters, not words. \n"]
  max_results : search_sample_queries_max_results option;
      [@ocaml.doc
  ...
  search_phrase : search_sample_queries_search_phrase;
      [@ocaml.doc
        " The natural language phrase to use for the semantic search. The phrase must be in \
         English. The length constraint is in characters, not words.\n"]
}
[@@ocaml.doc ""]
...
type nonrec restore_event_data_store_response = {
  ...
  updated_timestamp : date option;
      [@ocaml.doc
        "The timestamp that shows when an event data store was updated, if applicable. \
         ...
         [CreatedTimestamp].\n"]
  created_timestamp : date option; [@ocaml.doc "The timestamp of an event data store's creation.\n"]
  termination_protection_enabled : termination_protection_enabled option;
      [@ocaml.doc
        "Indicates that termination protection is enabled and the event data store cannot be \
         automatically deleted.\n"]
  ...
  advanced_event_selectors : advanced_event_selectors option;
      [@ocaml.doc "The advanced event selectors that were used to select events.\n"]
  status : event_data_store_status option; [@ocaml.doc "The status of the event data store.\n"]
  name : event_data_store_name option; [@ocaml.doc "The name of the event data store.\n"]
  event_data_store_arn : event_data_store_arn option; [@ocaml.doc "The event data store ARN.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "Your account has used the maximum number of event data stores.\n"]
...
type nonrec resource_tag = {
  tags_list : tags_list option; [@ocaml.doc "A list of tags.\n"]
  resource_id : string_ option; [@ocaml.doc "Specifies the ARN of the resource.\n"]
}
...
[@@ocaml.doc
  " This exception is thrown when the resouce-based policy has syntax errors, or contains a \
...
[@@ocaml.doc " This exception is thrown when the specified resource policy is not found. \n"]
  ...
  resource_type : string_ option;
      [@ocaml.doc
        "The type of a resource referenced by the event returned. When the resource type cannot be \
         determined, null is returned. Some examples of resource types are: {b Instance} for EC2, \
         {b Trail} for CloudTrail, {b DBInstance} for Amazon RDS, and {b AccessKey} for IAM. To \
         learn more about how to look up and filter events by the resource types supported for a \
         service, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/view-cloudtrail-events-console.html#filtering-cloudtrail-events}Filtering \
         CloudTrail Events}.\n"]
}
[@@ocaml.doc "Specifies the type and name of a resource referenced by an event.\n"]

type nonrec resource_list = resource list [@@ocaml.doc ""]

type nonrec resource_id_list = string_ list [@@ocaml.doc ""]
...
type nonrec remove_tags_response = unit [@@ocaml.doc ""]

type nonrec remove_tags_request = {
  tags_list : tags_list; [@ocaml.doc "Specifies a list of tags to be removed.\n"]
  resource_id : string_;
      [@ocaml.doc
        "Specifies the ARN of the trail, event data store, dashboard, or channel from which tags \
         should be removed.\n\n\
...
[@@ocaml.doc
  "This exception is thrown when the specified tag key or values are not valid. It can also occur \
   if there are duplicate tags or too many tags on the resource.\n"]

type nonrec register_organization_delegated_admin_response = unit [@@ocaml.doc ""]
...
[@@ocaml.doc
  "The task can't be completed because you are signed in with an account that lacks permissions to \
   view or create a service-linked role. Sign in with an account that has the required permissions \
   and then try again.\n"]
...
[@@ocaml.doc
  "This exception is thrown when the maximum number of CloudTrail delegated administrators is \
   reached.\n"]
...
type nonrec query_statistics_for_describe_query = {
  creation_time : date option; [@ocaml.doc "The creation time of the query.\n"]
  execution_time_in_millis : integer option; [@ocaml.doc "The query's run time, in milliseconds.\n"]
  bytes_scanned : long option;
      [@ocaml.doc
        "The total bytes that the query scanned in the event data store. This value matches the \
         ...
         running.\n"]
  events_scanned : long option;
      [@ocaml.doc "The number of events that the query scanned in the event data store.\n"]
  events_matched : long option; [@ocaml.doc "The number of events that matched a query.\n"]
}
[@@ocaml.doc
  "Gets metadata about a query, including the number of events that were matched, the total number \
   of events scanned, the query run time in milliseconds, and the query's creation time.\n"]
  ...
  bytes_scanned : long option;
      [@ocaml.doc
        "The total bytes that the query scanned in the event data store. This value matches the \
         number of bytes for which your account is billed for the query, unless the query is still \
         running.\n"]
  total_results_count : integer option;
      [@ocaml.doc "The total number of results returned by a query.\n"]
  results_count : integer option; [@ocaml.doc "The number of results returned.\n"]
}
[@@ocaml.doc "Metadata about a query, such as the number of results.\n"]

type nonrec query_result_value = string [@@ocaml.doc ""]

type nonrec query_result_key = string [@@ocaml.doc ""]

type nonrec query_result_column = (query_result_key * query_result_value) list [@@ocaml.doc ""]

type nonrec query_result_row = query_result_column list [@@ocaml.doc ""]

type nonrec query_result_rows = query_result_row list [@@ocaml.doc ""]
...
type nonrec query = {
  creation_time : date option; [@ocaml.doc "The creation time of a query.\n"]
  query_status : query_status option;
      [@ocaml.doc
        "The status of the query. This can be [QUEUED], [RUNNING], [FINISHED], [FAILED], \
         [TIMED_OUT], or [CANCELLED].\n"]
  query_id : uui_d option; [@ocaml.doc "The ID of a query.\n"]
}
[@@ocaml.doc
...
type nonrec put_resource_policy_response = {
  delegated_admin_resource_policy : resource_policy option;
      [@ocaml.doc
        " The default resource-based policy that is automatically generated for the delegated \
         ...
         with any policy you submit for the resource. For more information about this policy, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-lake-organizations.html#cloudtrail-lake-organizations-eds-rbp}Default \
         resource policy for delegated administrators}. \n"]
  resource_policy : resource_policy option;
      [@ocaml.doc
        " The JSON-formatted string of the Amazon Web Services resource-based policy attached to \
...
[@@ocaml.doc
  "A JSON string that contains a list of Insights types that are logged on a trail or event data \
   store.\n"]

type nonrec insight_selectors = insight_selector list [@@ocaml.doc ""]

type nonrec put_insight_selectors_response = {
  insights_destination : event_data_store_arn option;
      [@ocaml.doc " The ARN of the destination event data store that logs Insights events. \n"]
  event_data_store_arn : event_data_store_arn option;
      [@ocaml.doc
...
type nonrec put_insight_selectors_request = {
  insights_destination : event_data_store_arn option;
      [@ocaml.doc
        ...
        \ "]
  event_data_store : event_data_store_arn option;
      [@ocaml.doc
        "The ARN (or ID suffix of the ARN) of the source event data store for which you want to \
         change or add Insights selectors. To enable Insights on an event data store, you must \
...
type nonrec data_resource_values = string_ list [@@ocaml.doc ""]

type nonrec data_resource = {
  values : data_resource_values option;
      [@ocaml.doc
        ...
        \             This also enables logging of data event activity performed by any user or \
         role in your Amazon Web Services account, even if that activity is performed on a bucket \
        ...
        \       {-  To log data events for specific objects, specify the S3 bucket and object \
         prefix such as [arn:aws:s3:::amzn-s3-demo-bucket1/example-images]. The trail logs data \
        ...
        \           \n\
        \             This also enables logging of [Invoke] activity performed by any user or role \
        ...
        \             Lambda function ARNs are exact. For example, if you specify a function ARN \
         {i arn:aws:lambda:us-west-2:111111111111:function:helloworld}, data events will only be \
         logged for {i arn:aws:lambda:us-west-2:111111111111:function:helloworld}. They will not \
         be logged for {i arn:aws:lambda:us-west-2:111111111111:function:helloworld2}.\n\
        \             \n\
        \               }\n\
  ...
  type_ : string_ option;
      [@ocaml.doc
        "The resource type in which you want to log data events. You can specify the following {i \
        ...
        \            }\n\
        \       }\n\
        \   Additional resource types are available through {i advanced} event selectors. For more \
         information, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/APIReference/API_AdvancedEventSelector.html}AdvancedEventSelector}.\n\
        \   "]
}
[@@ocaml.doc
  ...
  \   \n\
  \    Configure the [DataResource] to specify the resource type and resource ARNs for which you \
   want to log data events.\n\
  \    \n\
  \      The total number of allowed data resources is 250. This number can be distributed between \
   1 and 5 event selectors, but the total cannot exceed 250 across all selectors for the trail.\n\
  \      \n\
  \        The following example demonstrates how logging works when you configure logging of all \
   data events for a general purpose bucket named [amzn-s3-demo-bucket1]. In this example, the \
   CloudTrail user specified an empty prefix, and the option to log both [Read] and [Write] data \
   events.\n\
  \        \n\
  \         {ol\n\
  ...
  \               {-  The [PutObject] API operation is an Amazon S3 object-level API. It is \
   recorded as a data event in CloudTrail. Because the CloudTrail user specified an S3 bucket with \
   an empty prefix, events that occur on any object in that bucket are logged. The trail processes \
   and logs the event.\n\
  \                   \n\
  \                    }\n\
  ...
  \               {-  The [PutObject] API operation occurred for an object in an S3 bucket that \
   the CloudTrail user didn't specify for the trail. The trail doesn\226\128\153t log the event.\n\
  \                   \n\
  \                    }\n\
  \               }\n\
  \   The following example demonstrates how logging works when you configure logging of Lambda \
   data events for a Lambda function named {i MyLambdaFunction}, but not for all Lambda functions.\n\
  \   \n\
  \    {ol\n\
  \          {-  A user runs a script that includes a call to the {i MyLambdaFunction} function \
   and the {i MyOtherLambdaFunction} function.\n\
  \              \n\
  \               }\n\
  \          {-  The [Invoke] API operation on {i MyLambdaFunction} is an Lambda API. It is \
   recorded as a data event in CloudTrail. Because the CloudTrail user specified logging data \
   events for {i MyLambdaFunction}, any invocations of that function are logged. The trail \
   processes and logs the event.\n\
  \              \n\
  \               }\n\
  \          {-  The [Invoke] API operation on {i MyOtherLambdaFunction} is an Lambda API. Because \
   the CloudTrail user did not specify logging data events for all Lambda functions, the [Invoke] \
   operation for {i MyOtherLambdaFunction} does not match the function specified for the trail. \
   The trail doesn\226\128\153t log the event. \n\
  \              \n\
  \               }\n\
  \          }\n\
  \  "]

type nonrec data_resources = data_resource list [@@ocaml.doc ""]

type nonrec exclude_management_event_sources = string_ list [@@ocaml.doc ""]

type nonrec event_selector = {
  exclude_management_event_sources : exclude_management_event_sources option;
      [@ocaml.doc
        "An optional list of service event sources from which you do not want management events to \
         be logged on your trail. In this release, the list can be empty (disables the filter), or \
         it can filter out Key Management Service or Amazon RDS Data API events by containing \
         [kms.amazonaws.com] or [rdsdata.amazonaws.com]. By default, \
         [ExcludeManagementEventSources] is empty, and KMS and Amazon RDS Data API events are \
         logged to your trail. You can exclude management event sources only in Regions that \
         support the event source.\n"]
  data_resources : data_resources option;
      [@ocaml.doc
        ...
        \ For more information, see \
         ...
         Events} and \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/WhatIsCloudTrail-Limits.html}Limits \
        ...
        \   \n\
        \    "]
  include_management_events : boolean_ option;
      [@ocaml.doc
        "Specify if you want your event selector to include management events for your trail.\n\n\
        \  For more information, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-management-events-with-cloudtrail.html}Management \
         Events} in the {i CloudTrail User Guide}.\n\
        \ \n\
        \  By default, the value is [true].\n\
        \  \n\
        \   The first copy of management events is free. You are charged for additional copies of \
         management events that you are logging on any subsequent trail in the same Region. For \
         more information about CloudTrail pricing, see \
...
type nonrec event_selectors = event_selector list [@@ocaml.doc ""]

type nonrec put_event_selectors_response = {
  advanced_event_selectors : advanced_event_selectors option;
      [@ocaml.doc "Specifies the advanced event selectors configured for your trail.\n"]
  event_selectors : event_selectors option;
...
type nonrec put_event_selectors_request = {
  advanced_event_selectors : advanced_event_selectors option;
      [@ocaml.doc
        " Specifies the settings for advanced event selectors. You can use advanced event \
         selectors to log management events, data events for all resource types, and network \
         activity events.\n\n\
        \ You can add advanced event selectors, and conditions for your advanced event selectors, \
         ...
         more information about advanced event selectors, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.html}Logging \
         data events} and \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-network-events-with-cloudtrail.html}Logging \
         network activity events} in the {i CloudTrail User Guide}. \n\
        \ "]
  event_selectors : event_selectors option;
      [@ocaml.doc
...
type nonrec max_event_size = Large [@ocaml.doc ""] | Standard [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec operator_target_list_member = string [@@ocaml.doc ""]

type nonrec operator_target_list = operator_target_list_member list [@@ocaml.doc ""]

type nonrec context_key_selector = {
  equals : operator_target_list;
      [@ocaml.doc "A list of keys defined by Type to be included in CloudTrail enriched events. \n"]
  type_ : type_;
      [@ocaml.doc
...
type nonrec put_event_configuration_response = {
  ...
  max_event_size : max_event_size option;
      [@ocaml.doc "The maximum allowed size for events stored in the specified event data store.\n"]
  event_data_store_arn : event_data_store_arn option;
      [@ocaml.doc
...
type nonrec byte_buffer = bytes [@@ocaml.doc ""]

type nonrec public_key = {
  fingerprint : string_ option; [@ocaml.doc "The fingerprint of the public key.\n"]
  validity_end_time : date option; [@ocaml.doc "The ending time of validity of the public key.\n"]
  validity_start_time : date option;
      [@ocaml.doc "The starting time of validity of the public key.\n"]
  value : byte_buffer option; [@ocaml.doc "The DER encoded public key value in PKCS#1 format.\n"]
}
[@@ocaml.doc "Contains information about a returned public key.\n"]

type nonrec public_key_list = public_key list [@@ocaml.doc ""]

type nonrec prompt = string [@@ocaml.doc ""]

type nonrec partition_key_type = string [@@ocaml.doc ""]

type nonrec partition_key_name = string [@@ocaml.doc ""]

type nonrec partition_key = {
  type_ : partition_key_type;
      [@ocaml.doc "The data type of the partition key. For example, [bigint] or [string].\n"]
  name : partition_key_name; [@ocaml.doc "The name of the partition key.\n"]
}
[@@ocaml.doc "Contains information about a partition key for an event data store.\n"]
...
[@@ocaml.doc "This exception is thrown when the maximum number of trails is reached.\n"]
...
type nonrec event = {
  cloud_trail_event : string_ option;
      [@ocaml.doc "A JSON string that contains a representation of the event returned.\n"]
  ...
  event_source : string_ option;
      [@ocaml.doc "The Amazon Web Services service to which the request was made.\n"]
  event_time : date option; [@ocaml.doc "The date and time of the event returned.\n"]
  access_key_id : string_ option;
      [@ocaml.doc
        "The Amazon Web Services access key ID that was used to sign the request. If the request \
         ...
         credentials.\n"]
  read_only : string_ option;
      [@ocaml.doc "Information about whether the event is a write event or a read event. \n"]
  event_name : string_ option; [@ocaml.doc "The name of the event returned.\n"]
  event_id : string_ option; [@ocaml.doc "The CloudTrail ID of the event returned.\n"]
}
[@@ocaml.doc
...
type nonrec events_list = event list [@@ocaml.doc ""]
  ...
  next_token : next_token option;
      [@ocaml.doc
        "The token to use to get the next page of results after a previous API call. If the token \
         ...
         the same parameters as the previous call. For example, if the original call specified an \
...
type nonrec lookup_attribute_value = string [@@ocaml.doc ""]

type nonrec lookup_attribute = {
  attribute_value : lookup_attribute_value;
      [@ocaml.doc
        "Specifies a value for the specified [AttributeKey].\n\n\
        \ The maximum length for the [AttributeValue] is 2000 characters. The following characters \
         ('[_]', '[ ]', '[,]', '[\\\\n]') count as two characters towards the 2000 character limit.\n\
        \ "]
  attribute_key : lookup_attribute_key;
      [@ocaml.doc "Specifies an attribute on which to filter the events returned.\n"]
}
[@@ocaml.doc "Specifies an attribute and value that filter the events returned.\n"]
...
type nonrec lookup_events_request = {
  ...
  lookup_attributes : lookup_attributes_list option;
      [@ocaml.doc
...
[@@ocaml.doc
  "Occurs if the timestamp values are not valid. Either the start time occurs after the end time, \
...
[@@ocaml.doc "This exception is thrown if the limit specified is not valid.\n"]

type nonrec invalid_lookup_attributes_exception = {
  message : error_message option;
      [@ocaml.doc "Brief description of the exception returned by the request.\n"]
}
[@@ocaml.doc "Occurs when a lookup attribute is specified that is not valid.\n"]
  ...
  next_token : string_ option;
      [@ocaml.doc
        "The token to use to get the next page of results after a previous API call. If the token \
         ...
         AttributeKey of 'Username' with a value of 'root', the call with NextToken should include \
         those same parameters.\n"]
  trails : trails option;
      [@ocaml.doc "Returns the name, ARN, and home Region of trails in the current account.\n"]
}
[@@ocaml.doc ""]
...
type nonrec list_tags_response = {
  next_token : string_ option; [@ocaml.doc "Reserved for future use.\n"]
  resource_tag_list : resource_tag_list option; [@ocaml.doc "A list of resource tags.\n"]
}
[@@ocaml.doc
  "Returns the objects or data listed below if successful. Otherwise, returns an error.\n"]
...
type nonrec list_tags_request = {
  ...
  resource_id_list : resource_id_list;
      [@ocaml.doc
        "Specifies a list of trail, event data store, dashboard, or channel ARNs whose tags will \
...
type nonrec list_queries_max_results_count = int [@@ocaml.doc ""]

type nonrec list_queries_request = {
  query_status : query_status option;
      [@ocaml.doc
        "The status of queries that you want to return in results. Valid values for [QueryStatus] \
         include [QUEUED], [RUNNING], [FINISHED], [FAILED], [TIMED_OUT], or [CANCELLED].\n"]
  end_time : date option;
      [@ocaml.doc
  ...
  max_results : list_queries_max_results_count option;
...
[@@ocaml.doc
  "A date range for the query was specified that is not valid. Be sure that the start time is \
   chronologically before the end time. For more information about writing a query, see \
   {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-create-edit-query.html}Create \
   or edit a query} in the {i CloudTrail User Guide}.\n"]

type nonrec list_public_keys_response = {
  next_token : string_ option; [@ocaml.doc "Reserved for future use.\n"]
  public_key_list : public_key_list option;
      [@ocaml.doc
...
type nonrec event_source = string [@@ocaml.doc ""]

type nonrec event_name = string [@@ocaml.doc ""]

type nonrec error_code = string [@@ocaml.doc ""]

type nonrec double = float [@@ocaml.doc ""]

type nonrec insights_metric_values = double list [@@ocaml.doc ""]

type nonrec insights_metric_next_token = string [@@ocaml.doc ""]

type nonrec list_insights_metric_data_response = {
  next_token : insights_metric_next_token option;
      [@ocaml.doc
        "Only returned if the full results could not be returned in a single query. You can set \
         the [NextToken] parameter in the next request to this value to continue retrieval.\n"]
  values : insights_metric_values option;
      [@ocaml.doc
        "List of values representing the API call rate or error rate at each timestamp. The number \
         of values is equal to the number of timestamps.\n"]
  timestamps : timestamps option;
      [@ocaml.doc "List of timestamps at intervals corresponding to the specified time period.\n"]
  ...
  event_name : event_name option;
      [@ocaml.doc
        "The name of the event, typically the Amazon Web Services API on which unusual levels of \
...
type nonrec insights_metric_period = int [@@ocaml.doc ""]
...
type nonrec insights_metric_max_results = int [@@ocaml.doc ""]
...
type nonrec list_insights_metric_data_request = {
  next_token : insights_metric_next_token option;
      [@ocaml.doc
        ...
        \ Add this parameter to the request to continue retrieving results starting from the last \
         evaluated point.\n\
        \ "]
  max_results : insights_metric_max_results option;
      [@ocaml.doc
  ...
  data_type : insights_metric_data_type option;
      [@ocaml.doc
        "Type of data points to return. Valid values are [NonZeroData] and [FillWithZeros]. The \
         default is [NonZeroData].\n"]
  period : insights_metric_period option;
      [@ocaml.doc
        "Granularity of data to retrieve, in seconds. Valid values are [60], [300], and [3600]. If \
         you specify any other value, you will get an error. The default is 3600 seconds.\n"]
  end_time : date option;
      [@ocaml.doc
...
[@@ocaml.doc " Contains information about an import that was returned by a lookup request. \n"]

type nonrec imports_list = imports_list_item list [@@ocaml.doc ""]

type nonrec list_imports_response = {
  next_token : pagination_token option;
      [@ocaml.doc " A token you can use to get the next page of import results. \n"]
  imports : imports_list option; [@ocaml.doc " The list of returned imports. \n"]
}
[@@ocaml.doc ""]

type nonrec list_imports_max_results_count = int [@@ocaml.doc ""]

type nonrec list_imports_request = {
  next_token : pagination_token option;
      [@ocaml.doc " A token you can use to get the next page of import results. \n"]
  import_status : import_status option; [@ocaml.doc " The status of the import. \n"]
  destination : event_data_store_arn option;
      [@ocaml.doc " The ARN of the destination event data store. \n"]
  max_results : list_imports_max_results_count option;
      [@ocaml.doc " The maximum number of imports to display on a single page. \n"]
}
[@@ocaml.doc ""]
...
type nonrec import_failure_list_item = {
  last_updated_time : date option; [@ocaml.doc " When the import was last updated. \n"]
  error_message : string_ option; [@ocaml.doc " Provides the reason the import failed. \n"]
  error_type : string_ option; [@ocaml.doc " The type of import error. \n"]
  status : import_failure_status option; [@ocaml.doc " The status of the import. \n"]
  location : string_ option; [@ocaml.doc " The location of the failure in the S3 bucket. \n"]
}
[@@ocaml.doc " Provides information about an import failure. \n"]

type nonrec import_failure_list = import_failure_list_item list [@@ocaml.doc ""]

type nonrec list_import_failures_response = {
  next_token : pagination_token option;
      [@ocaml.doc " A token you can use to get the next page of results. \n"]
  failures : import_failure_list option;
      [@ocaml.doc " Contains information about the import failures. \n"]
}
[@@ocaml.doc ""]

type nonrec list_import_failures_max_results_count = int [@@ocaml.doc ""]

type nonrec list_import_failures_request = {
  next_token : pagination_token option;
      [@ocaml.doc " A token you can use to get the next page of import failures. \n"]
  max_results : list_import_failures_max_results_count option;
      [@ocaml.doc " The maximum number of failures to display on a single page. \n"]
  import_id : uui_d; [@ocaml.doc " The ID of the import. \n"]
}
[@@ocaml.doc ""]
...
type nonrec event_data_store = {
  ...
  status : event_data_store_status option; [@ocaml.doc "The status of an event data store.\n"]
  termination_protection_enabled : termination_protection_enabled option;
      [@ocaml.doc "Indicates whether the event data store is protected from termination.\n"]
  name : event_data_store_name option; [@ocaml.doc "The name of the event data store.\n"]
  event_data_store_arn : event_data_store_arn option;
      [@ocaml.doc "The ARN of the event data store.\n"]
}
[@@ocaml.doc
  "A storage lake of event data against which you can run complex SQL-based queries. An event data \
   store can include events that you have logged on your account. To select events for an event \
   data store, use \
   {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-lake-concepts.html#adv-event-selectors}advanced \
   event selectors}.\n"]

type nonrec event_data_stores = event_data_store list [@@ocaml.doc ""]

type nonrec list_event_data_stores_response = {
  next_token : pagination_token option;
      [@ocaml.doc "A token you can use to get the next page of results.\n"]
  event_data_stores : event_data_stores option;
      [@ocaml.doc
        "Contains information about event data stores in the account, in the current Region.\n"]
}
[@@ocaml.doc ""]

type nonrec list_event_data_stores_max_results_count = int [@@ocaml.doc ""]

type nonrec list_event_data_stores_request = {
  max_results : list_event_data_stores_max_results_count option;
      [@ocaml.doc "The maximum number of event data stores to display on a single page.\n"]
  next_token : pagination_token option;
      [@ocaml.doc "A token you can use to get the next page of event data store results.\n"]
}
[@@ocaml.doc ""]
...
type nonrec dashboards = dashboard_detail list [@@ocaml.doc ""]

type nonrec list_dashboards_response = {
  next_token : pagination_token option;
      [@ocaml.doc " A token you can use to get the next page of dashboard results. \n"]
  dashboards : dashboards option;
      [@ocaml.doc
        " Contains information about dashboards in the account, in the current Region that match \
         the applied filters. \n"]
}
[@@ocaml.doc ""]

type nonrec list_dashboards_max_results_count = int [@@ocaml.doc ""]

type nonrec list_dashboards_request = {
  max_results : list_dashboards_max_results_count option;
      [@ocaml.doc " The maximum number of dashboards to display on a single page. \n"]
  next_token : pagination_token option;
      [@ocaml.doc " A token you can use to get the next page of dashboard results. \n"]
  type_ : dashboard_type option;
      [@ocaml.doc " Specify a dashboard type to filter on: [CUSTOM] or [MANAGED]. \n"]
  name_prefix : dashboard_name option; [@ocaml.doc " Specify a name prefix to filter on. \n"]
}
[@@ocaml.doc ""]
...
type nonrec channel = {
  ...
  channel_arn : channel_arn option; [@ocaml.doc "The Amazon Resource Name (ARN) of a channel.\n"]
}
[@@ocaml.doc "Contains information about a returned CloudTrail channel.\n"]

type nonrec channels = channel list [@@ocaml.doc ""]

type nonrec list_channels_response = {
  next_token : pagination_token option;
      [@ocaml.doc "The token to use to get the next page of results after a previous API call.\n"]
  channels : channels option; [@ocaml.doc " The list of channels in the account. \n"]
}
[@@ocaml.doc ""]

type nonrec list_channels_max_results_count = int [@@ocaml.doc ""]
  ...
  next_token : pagination_token option;
      [@ocaml.doc
        "The token to use to get the next page of results after a previous API call. This token \
         ...
         example, if the original call specified an AttributeKey of 'Username' with a value of \
         'root', the call with NextToken should include those same parameters.\n"]
  max_results : list_channels_max_results_count option;
      [@ocaml.doc " The maximum number of CloudTrail channels to display on a single page. \n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "This exception is thrown when the specified value of [Source] is not valid.\n"]
...
type nonrec ingestion_status = {
  latest_ingestion_attempt_event_i_d : uui_d option;
      [@ocaml.doc "The event ID of the most recent attempt to ingest events.\n"]
  latest_ingestion_attempt_time : date option;
      [@ocaml.doc "The time stamp of the most recent attempt to ingest events on the channel.\n"]
  latest_ingestion_error_code : error_message option;
      [@ocaml.doc "The error code for the most recent failure to ingest events.\n"]
  latest_ingestion_success_event_i_d : uui_d option;
      [@ocaml.doc "The event ID of the most recent successful ingestion of events.\n"]
  latest_ingestion_success_time : date option;
      [@ocaml.doc
        "The time stamp of the most recent successful ingestion of events for the channel.\n"]
}
[@@ocaml.doc
  "A table showing information about the most recent successful and failed attempts to ingest \
   events.\n"]
...
[@@ocaml.doc
  "The specified query cannot be canceled because it is in the [FINISHED], [FAILED], [TIMED_OUT], \
   or [CANCELLED] state.\n"]

type nonrec get_trail_status_response = {
  time_logging_stopped : string_ option; [@ocaml.doc "This field is no longer in use.\n"]
  time_logging_started : string_ option; [@ocaml.doc "This field is no longer in use.\n"]
  latest_delivery_attempt_succeeded : string_ option;
      [@ocaml.doc "This field is no longer in use.\n"]
  latest_notification_attempt_succeeded : string_ option;
      [@ocaml.doc "This field is no longer in use.\n"]
  latest_notification_attempt_time : string_ option;
      [@ocaml.doc "This field is no longer in use.\n"]
  latest_delivery_attempt_time : string_ option; [@ocaml.doc "This field is no longer in use.\n"]
  latest_digest_delivery_error : string_ option;
      [@ocaml.doc
        "Displays any Amazon S3 error that CloudTrail encountered when attempting to deliver a \
         digest file to the designated bucket. For more information, see \
        ...
        \  This error occurs only when there is a problem with the destination S3 bucket, and does \
         not occur for requests that time out. To resolve the issue, fix the \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/create-s3-bucket-policy-for-cloudtrail.html}bucket \
         policy} so that CloudTrail can write to the bucket; or create a new bucket and call \
         [UpdateTrail] to specify the new bucket.\n\
        \  \n\
        \   "]
  latest_digest_delivery_time : date option;
      [@ocaml.doc
        "Specifies the date and time that CloudTrail last delivered a digest file to an account's \
         Amazon S3 bucket.\n"]
  latest_cloud_watch_logs_delivery_time : date option;
      [@ocaml.doc
        "Displays the most recent date and time when CloudTrail delivered logs to CloudWatch Logs.\n"]
  latest_cloud_watch_logs_delivery_error : string_ option;
      [@ocaml.doc
        "Displays any CloudWatch Logs error that CloudTrail encountered when attempting to deliver \
         logs to CloudWatch Logs.\n"]
  stop_logging_time : date option;
      [@ocaml.doc
        "Specifies the most recent date and time when CloudTrail stopped recording API calls for \
         an Amazon Web Services account.\n"]
  start_logging_time : date option;
      [@ocaml.doc
        "Specifies the most recent date and time when CloudTrail started recording API calls for \
         an Amazon Web Services account.\n"]
  latest_notification_time : date option;
      [@ocaml.doc
  ...
  latest_delivery_error : string_ option;
      [@ocaml.doc
        "Displays any Amazon S3 error that CloudTrail encountered when attempting to deliver log \
         files to the designated bucket. For more information, see \
         {{:https://docs.aws.amazon.com/AmazonS3/latest/API/ErrorResponses.html}Error Responses} \
         in the Amazon S3 API Reference. \n\n\
        \  This error occurs only when there is a problem with the destination S3 bucket, and does \
         not occur for requests that time out. To resolve the issue, fix the \
...
[@@ocaml.doc "The name of a trail about which you want the current status.\n"]

type nonrec get_trail_response = { trail : trail option [@ocaml.doc ""] } [@@ocaml.doc ""]
...
type nonrec get_query_results_response = {
  ...
  next_token : pagination_token option;
      [@ocaml.doc "A token you can use to get the next page of query results.\n"]
  query_result_rows : query_result_rows option;
      [@ocaml.doc "Contains the individual event results of the query.\n"]
  query_statistics : query_statistics option; [@ocaml.doc "Shows the count of query results.\n"]
  query_status : query_status option;
      [@ocaml.doc
...
type nonrec get_query_results_request = {
  event_data_store_owner_account_id : account_id option;
      [@ocaml.doc " The account ID of the event data store owner. \n"]
  max_query_results : max_query_results option;
      [@ocaml.doc "The maximum number of query results to display on a single page.\n"]
  next_token : pagination_token option;
      [@ocaml.doc "A token you can use to get the next page of query results.\n"]
  query_id : uui_d; [@ocaml.doc "The ID of the query for which you want to get results.\n"]
  event_data_store : event_data_store_arn option;
      [@ocaml.doc
...
type nonrec get_insight_selectors_request = {
  event_data_store : event_data_store_arn option;
      [@ocaml.doc
        " Specifies the ARN (or ID suffix of the ARN) of the event data store for which you want \
...
type nonrec get_import_response = {
  import_statistics : import_statistics option;
      [@ocaml.doc
        " Provides statistics for the import. CloudTrail does not update import statistics in \
         real-time. Returned values for parameters such as [EventsCompleted] may be lower than the \
         actual value, because CloudTrail updates statistics incrementally over the course of the \
         import. \n"]
  updated_timestamp : date option; [@ocaml.doc " The timestamp of when the import was updated. \n"]
  created_timestamp : date option; [@ocaml.doc " The timestamp of the import's creation. \n"]
  import_status : import_status option; [@ocaml.doc " The status of the import. \n"]
  end_event_time : date option;
      [@ocaml.doc
  ...
  start_event_time : date option;
      [@ocaml.doc
        " Used with [EndEventTime] to bound a [StartImport] request, and limit imported trail \
         events to only those events logged within a specified time period. \n"]
  import_source : import_source option; [@ocaml.doc " The source S3 bucket. \n"]
  destinations : import_destinations option;
      [@ocaml.doc " The ARN of the destination event data store. \n"]
  import_id : uui_d option; [@ocaml.doc " The ID of the import. \n"]
}
...
type nonrec get_import_request = { import_id : uui_d [@ocaml.doc " The ID for the import. \n"] }
[@@ocaml.doc ""]

type nonrec get_event_selectors_response = {
  advanced_event_selectors : advanced_event_selectors option;
      [@ocaml.doc " The advanced event selectors that are configured for the trail. \n"]
  event_selectors : event_selectors option;
      [@ocaml.doc "The event selectors that are configured for the trail.\n"]
  trail_ar_n : string_ option; [@ocaml.doc "The specified trail ARN that has the event selectors.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_event_data_store_response = {
  partition_keys : partition_key_list option;
      [@ocaml.doc
  ...
  updated_timestamp : date option;
      [@ocaml.doc
        "Shows the time that an event data store was updated, if applicable. [UpdatedTimestamp] is \
  ...
  multi_region_enabled : boolean_ option;
      [@ocaml.doc
        "Indicates whether the event data store includes events from all Regions, or only from the \
         Region in which it was created.\n"]
  advanced_event_selectors : advanced_event_selectors option;
      [@ocaml.doc "The advanced event selectors used to select events for the data store.\n"]
  status : event_data_store_status option; [@ocaml.doc "The status of an event data store.\n"]
  name : event_data_store_name option; [@ocaml.doc "The name of the event data store.\n"]
  event_data_store_arn : event_data_store_arn option;
...
type nonrec get_dashboard_response = {
  termination_protection_enabled : termination_protection_enabled option;
      [@ocaml.doc " Indicates whether termination protection is enabled for the dashboard. \n"]
  last_refresh_failure_reason : error_message option;
      [@ocaml.doc " Provides information about failures for the last scheduled refresh. \n"]
  last_refresh_id : refresh_id option; [@ocaml.doc " The ID of the last dashboard refresh. \n"]
  updated_timestamp : date option;
      [@ocaml.doc " The timestamp that shows when the dashboard was last updated. \n"]
  created_timestamp : date option;
      [@ocaml.doc " The timestamp that shows when the dashboard was created. \n"]
  refresh_schedule : refresh_schedule option;
      [@ocaml.doc " The refresh schedule for the dashboard, if configured. \n"]
  widgets : widget_list option; [@ocaml.doc " An array of widgets for the dashboard. \n"]
  status : dashboard_status option; [@ocaml.doc " The status of the dashboard. \n"]
  type_ : dashboard_type option; [@ocaml.doc " The type of dashboard. \n"]
  dashboard_arn : dashboard_arn option; [@ocaml.doc " The ARN for the dashboard. \n"]
}
[@@ocaml.doc ""]
...
type nonrec get_dashboard_request = {
  dashboard_id : dashboard_arn; [@ocaml.doc " The name or ARN for the dashboard. \n"]
}
[@@ocaml.doc ""]
...
type nonrec get_channel_response = {
  ...
  destinations : destinations option;
      [@ocaml.doc
        "The destinations for the channel. For channels created for integrations, the destinations \
         are the event data stores that log events arriving through the channel. For \
         service-linked channels, the destination is the Amazon Web Services service that created \
         the service-linked channel to receive events.\n"]
  ...
  source : source option; [@ocaml.doc "The source for the CloudTrail channel.\n"]
  name : channel_name option;
      [@ocaml.doc
        " The name of the CloudTrail channel. For service-linked channels, the name is \
         [aws-service-channel/service-name/custom-suffix] where [service-name] represents the name \
  ...
  channel_arn : channel_arn option;
      [@ocaml.doc "The ARN of an channel returned by a [GetChannel] request.\n"]
}
[@@ocaml.doc ""]

type nonrec get_channel_request = {
  channel : channel_arn; [@ocaml.doc "The ARN or [UUID] of a channel.\n"]
}
[@@ocaml.doc ""]
...
type nonrec generate_query_response = {
  ...
  query_alias : query_alias option;
      [@ocaml.doc
        " An alias that identifies the prompt. When you run the [StartQuery] operation, you can \
         pass in either the [QueryAlias] or [QueryStatement] parameter. \n"]
  query_statement : query_statement option;
      [@ocaml.doc " The SQL query statement generated from the prompt. \n"]
}
[@@ocaml.doc ""]

type nonrec event_data_store_list = event_data_store_arn list [@@ocaml.doc ""]
  ...
  prompt : prompt;
      [@ocaml.doc
        " The prompt that you want to use to generate the query. The prompt must be in English. \
         ...
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/lake-query-generator.html#lake-query-generator-examples}Example \
         prompts} in the {i CloudTrail } user guide. \n"]
  event_data_stores : event_data_store_list;
      [@ocaml.doc
        " The ARN (or ID suffix of the ARN) of the event data store that you want to query. You \
         can only specify one event data store. \n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  " You cannot delete the event data store because Lake query federation is enabled. To delete the \
   event data store, run the [DisableFederation] operation to disable Lake query federation on the \
   event data store. \n"]

type nonrec enable_federation_response = {
  federation_role_arn : federation_role_arn option;
      [@ocaml.doc " The ARN of the federation role. \n"]
  federation_status : federation_status option; [@ocaml.doc " The federation status. \n"]
  event_data_store_arn : event_data_store_arn option;
      [@ocaml.doc
  ...
  federation_role_arn : federation_role_arn;
      [@ocaml.doc
        " The ARN of the federation role to use for the event data store. Amazon Web Services \
         ...
         event data store. The federation role must exist in your account and provide the \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-federation.html#query-federation-permissions-role}required \
         minimum permissions}. \n"]
  event_data_store : event_data_store_arn;
      [@ocaml.doc
...
[@@ocaml.doc
  " You are trying to update a resource when another request is in progress. Allow sufficient wait \
   time for the previous request to complete, then retry your request. \n"]
...
type nonrec describe_trails_request = {
  include_shadow_trails : boolean_ option;
      [@ocaml.doc
  ...
  trail_name_list : trail_name_list option;
      [@ocaml.doc
...
type nonrec describe_query_response = {
  ...
  delivery_status : delivery_status option; [@ocaml.doc "The delivery status.\n"]
  delivery_s3_uri : delivery_s3_uri option;
      [@ocaml.doc
  ...
  query_string : query_statement option; [@ocaml.doc "The SQL code of a query.\n"]
  query_id : uui_d option; [@ocaml.doc "The ID of the query.\n"]
}
[@@ocaml.doc ""]
...
type nonrec describe_query_request = {
  event_data_store_owner_account_id : account_id option;
      [@ocaml.doc " The account ID of the event data store owner. \n"]
  refresh_id : refresh_id option; [@ocaml.doc " The ID of the dashboard refresh. \n"]
  query_alias : query_alias option; [@ocaml.doc " The alias that identifies a query template. \n"]
  query_id : uui_d option; [@ocaml.doc "The query ID.\n"]
  event_data_store : event_data_store_arn option;
      [@ocaml.doc
        "The ARN (or the ID suffix of the ARN) of an event data store on which the specified query \
         was run.\n"]
}
[@@ocaml.doc ""]

type nonrec deregister_organization_delegated_admin_response = unit [@@ocaml.doc ""]

type nonrec deregister_organization_delegated_admin_request = {
  delegated_admin_account_id : account_id;
      [@ocaml.doc
        "A delegated administrator account ID. This is a member account in an organization that is \
...
type nonrec delete_trail_response = unit [@@ocaml.doc ""]

type nonrec delete_trail_request = {
  name : string_;
      [@ocaml.doc
        "Specifies the name or the CloudTrail ARN of the trail to be deleted. The following is the \
         format of a trail ARN. [arn:aws:cloudtrail:us-east-2:123456789012:trail/MyTrail] \n"]
}
...
type nonrec delete_event_data_store_response = unit [@@ocaml.doc ""]

type nonrec delete_event_data_store_request = {
  event_data_store : event_data_store_arn;
      [@ocaml.doc "The ARN (or the ID suffix of the ARN) of the event data store to delete.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_dashboard_response = unit [@@ocaml.doc ""]
...
type nonrec delete_channel_response = unit [@@ocaml.doc ""]

type nonrec delete_channel_request = {
  channel : channel_arn;
      [@ocaml.doc "The ARN or the [UUID] value of the channel that you want to delete.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_trail_response = {
  ...
  cloud_watch_logs_log_group_arn : string_ option;
      [@ocaml.doc
        "Specifies the Amazon Resource Name (ARN) of the log group to which CloudTrail logs will \
         be delivered.\n"]
  log_file_validation_enabled : boolean_ option;
      [@ocaml.doc "Specifies whether log file integrity validation is enabled.\n"]
  trail_ar_n : string_ option;
...
type nonrec create_trail_request = {
  tags_list : tags_list option; [@ocaml.doc ""]
  is_organization_trail : boolean_ option;
      [@ocaml.doc
        "Specifies whether the trail is created for all accounts in an organization in \
         Organizations, or only for the current Amazon Web Services account. The default is false, \
         and cannot be true unless the call is made on behalf of an Amazon Web Services account \
         that is the management account or delegated administrator account for an organization in \
         Organizations.\n"]
  kms_key_id : string_ option;
      [@ocaml.doc
        "Specifies the KMS key ID to use to encrypt the logs delivered by CloudTrail. The value \
  ...
  cloud_watch_logs_log_group_arn : string_ option;
      [@ocaml.doc
        "Specifies a log group name using an Amazon Resource Name (ARN), a unique identifier that \
         represents the log group to which CloudTrail logs will be delivered. You must use a log \
  ...
  s3_bucket_name : string_;
      [@ocaml.doc
        "Specifies the name of the Amazon S3 bucket designated for publishing log files. For \
         information about bucket naming rules, see \
         {{:https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html}Bucket \
         naming rules} in the {i Amazon Simple Storage Service User Guide}. \n"]
  name : string_;
      [@ocaml.doc
...
type nonrec create_event_data_store_response = {
  ...
  updated_timestamp : date option;
      [@ocaml.doc
        "The timestamp that shows when an event data store was updated, if applicable. \
         ...
         [CreatedTimestamp].\n"]
  created_timestamp : date option;
      [@ocaml.doc "The timestamp that shows when the event data store was created.\n"]
  tags_list : tags_list option; [@ocaml.doc ""]
  termination_protection_enabled : termination_protection_enabled option;
      [@ocaml.doc "Indicates whether termination protection is enabled for the event data store.\n"]
  retention_period : retention_period option;
  ...
  multi_region_enabled : boolean_ option;
      [@ocaml.doc
        "Indicates whether the event data store collects events from all Regions, or only from the \
         Region in which it was created.\n"]
  advanced_event_selectors : advanced_event_selectors option;
      [@ocaml.doc
        "The advanced event selectors that were used to select the events for the data store.\n"]
  status : event_data_store_status option; [@ocaml.doc "The status of event data store creation.\n"]
  name : event_data_store_name option; [@ocaml.doc "The name of the event data store.\n"]
  event_data_store_arn : event_data_store_arn option;
      [@ocaml.doc "The ARN of the event data store.\n"]
}
  ...
  billing_mode : billing_mode option;
      [@ocaml.doc
        ...
        \        {-   [FIXED_RETENTION_PRICING] - This billing mode is recommended if you expect \
         to ingest more than 25 TB of event data per month and need a retention period of up to \
        ...
        \    For more information about CloudTrail pricing, see \
         ...
         CloudTrail Lake costs}.\n\
        \    "]
  start_ingestion : boolean_ option;
      [@ocaml.doc
        "Specifies whether the event data store should start ingesting live events. The default is \
         true.\n"]
  kms_key_id : event_data_store_kms_key_id option;
      [@ocaml.doc
        "Specifies the KMS key ID to use to encrypt the events delivered by CloudTrail. The value \
  ...
  retention_period : retention_period option;
      [@ocaml.doc
        ...
        \   If you plan to copy trail events to this event data store, we recommend that you \
         consider both the age of the events that you want to copy as well as how long you want to \
         keep the copied events in your event data store. For example, if you copy trail events \
         that are 5 years old and specify a retention period of 7 years, the event data store will \
         retain those events for two years.\n\
        \   \n\
        \    "]
  organization_enabled : boolean_ option;
      [@ocaml.doc
  ...
  advanced_event_selectors : advanced_event_selectors option;
      [@ocaml.doc
        ...
        \  For more information about how to use advanced event selectors to log CloudTrail \
         events, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.html#creating-data-event-selectors-advanced}Log \
        ...
        \  For more information about how to use advanced event selectors to include Config \
         ...
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/lake-eds-cli.html#lake-cli-create-eds-config}Create \
         an event data store for Config configuration items} in the CloudTrail User Guide.\n\
        \  \n\
        \   For more information about how to use advanced event selectors to include events \
         outside of Amazon Web Services events in your event data store, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/lake-integrations-cli.html#lake-cli-create-integration}Create \
         an integration to log events from outside Amazon Web Services} in the CloudTrail User \
         Guide.\n\
        \   "]
  name : event_data_store_name; [@ocaml.doc "The name of the event data store.\n"]
}
[@@ocaml.doc ""]
...
type nonrec create_dashboard_response = {
  ...
  name : dashboard_name option; [@ocaml.doc " The name of the dashboard. \n"]
  dashboard_arn : dashboard_arn option; [@ocaml.doc " The ARN for the dashboard. \n"]
}
[@@ocaml.doc ""]
...
type nonrec create_channel_response = {
  tags : tags_list option; [@ocaml.doc ""]
  destinations : destinations option;
      [@ocaml.doc "The event data stores that log the events arriving through the channel.\n"]
  source : source option; [@ocaml.doc "The partner or external event source name.\n"]
  name : channel_name option; [@ocaml.doc "The name of the new channel.\n"]
  channel_arn : channel_arn option;
...
type nonrec create_channel_request = {
  ...
  source : source;
      [@ocaml.doc
        "The name of the partner or external event source. You cannot change this name after you \
         create the channel. A maximum of one channel is allowed per source.\n\n\
        \  A source can be either [Custom] for all valid non-Amazon Web Services events, or the \
         name of a partner event source. For information about the source names for available \
         partners, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-event-data-store-integration.html#cloudtrail-lake-partner-information}Additional \
         information about integration partners} in the CloudTrail User Guide. \n\
        \ "]
  name : channel_name; [@ocaml.doc "The name of the channel.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc " This exception is thrown when the maximum number of channels limit is exceeded. \n"]
...
type nonrec cancel_query_response = {
  ...
  query_status : query_status;
      [@ocaml.doc
        "Shows the status of a query after a [CancelQuery] request. Typically, the values shown \
         are either [RUNNING] or [CANCELLED].\n"]
  query_id : uui_d; [@ocaml.doc "The ID of the canceled query.\n"]
}
[@@ocaml.doc ""]
...
type nonrec add_tags_response = unit [@@ocaml.doc ""]

type nonrec add_tags_request = {
  tags_list : tags_list; [@ocaml.doc "Contains a list of tags, up to a limit of 50\n"]
  resource_id : string_;
      [@ocaml.doc
        "Specifies the ARN of the trail, event data store, dashboard, or channel to which one or \
...
[@@ocaml.doc "Specifies the tags to add to a trail, event data store, dashboard, or channel.\n"]
