...
let query_statistics_for_describe_query_of_yojson tree path =
  ...
  ({
     ...
     execution_time_in_millis =
       (option_of_yojson
          (value_for_key integer_of_yojson "ExecutionTimeInMillis") _list
          path);
     bytes_scanned =
...
let query_statistics_of_yojson tree path =
  ...
  ({
     ...
     total_results_count =
       (option_of_yojson
          (value_for_key integer_of_yojson "TotalResultsCount") _list path);
     results_count =
       (option_of_yojson (value_for_key integer_of_yojson "ResultsCount")
          _list path)
   } : query_statistics)
