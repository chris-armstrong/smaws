...
type nonrec refresh_schedule_status = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec refresh_schedule_frequency_value = int [@@ocaml.doc ""]

type nonrec refresh_schedule_frequency_unit = HOURS [@ocaml.doc ""] | DAYS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec dashboard_type = MANAGED [@ocaml.doc ""] | CUSTOM [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec destination_type = EVENT_DATA_STORE [@ocaml.doc ""] | AWS_SERVICE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec source_event_category = Management [@ocaml.doc ""] | Data [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec type_ = TagContext [@ocaml.doc ""] | RequestContext [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec max_event_size = Standard [@ocaml.doc ""] | Large [@ocaml.doc ""] [@@ocaml.doc ""]
