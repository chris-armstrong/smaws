...
type nonrec status = AVAILABLE [@ocaml.doc ""] | CREATING [@ocaml.doc ""] | FAILED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec provisioning_artifact_guidance = DEFAULT [@ocaml.doc ""] | DEPRECATED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec property_key = Owner [@ocaml.doc ""] | LaunchRole [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec last_sync_status = SUCCEEDED [@ocaml.doc ""] | FAILED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec search_products_as_admin_input = {
  ...
  page_size : page_size option;
      [@ocaml.doc "The maximum number of items to return with this call.\n"]
  product_source : product_source option; [@ocaml.doc "Access level of the source of the product.\n"]
}
[@@ocaml.doc ""]
...
type nonrec engine_workflow_status = SUCCEEDED [@ocaml.doc ""] | FAILED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec provisioned_product_plan_summary = {
  ...
  provisioning_artifact_id : id option; [@ocaml.doc "The identifier of the provisioning artifact.\n"]
}
...
type nonrec principal_type = IAM [@ocaml.doc ""] | IAM_PATTERN [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec list_constraints_for_portfolio_output = {
  constraint_details : constraint_details option;
...
type nonrec change_action = ADD [@ocaml.doc ""] | MODIFY [@ocaml.doc ""] | REMOVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec describe_product_output = {
  ...
  budgets : budgets option; [@ocaml.doc "Information about the associated budgets.\n"]
  launch_paths : launch_paths option; [@ocaml.doc "Information about the associated launch paths.\n"]
}
[@@ocaml.doc ""]
...
type nonrec associate_budget_with_resource_input = {
  ...
  resource_id : id; [@ocaml.doc " The resource identifier. Either a portfolio-id or a product-id.\n"]
}
[@@ocaml.doc ""]
