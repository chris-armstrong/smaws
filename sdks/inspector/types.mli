...
type nonrec scope_type = INSTANCE_ID [@ocaml.doc ""] | RULES_PACKAGE_ARN [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec report_type = FINDING [@ocaml.doc ""] | FULL [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec report_file_format = HTML [@ocaml.doc ""] | PDF [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec preview_status = WORK_IN_PROGRESS [@ocaml.doc ""] | COMPLETED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec subscribe_to_event_request = {
  ...
  topic_arn : arn; [@ocaml.doc "The ARN of the SNS topic to which the SNS notifications are sent.\n"]
}
[@@ocaml.doc ""]

type nonrec stop_action = START_EVALUATION [@ocaml.doc ""] | SKIP_EVALUATION [@ocaml.doc ""]
[@@ocaml.doc ""]
