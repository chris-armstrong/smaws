...
type nonrec report_type = CODE_COVERAGE [@ocaml.doc ""] | TEST [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec report_export_config_type = NO_EXPORT [@ocaml.doc ""] | S3 [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec report_packaging_type = NONE [@ocaml.doc ""] | ZIP [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec report_group_status_type = DELETING [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec project_visibility_type = PRIVATE [@ocaml.doc ""] | PUBLIC_READ [@ocaml.doc ""]
[@@ocaml.doc
...
type nonrec artifact_namespace = BUILD_ID [@ocaml.doc ""] | NONE [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec artifact_packaging = ZIP [@ocaml.doc ""] | NONE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec cache_type = LOCAL [@ocaml.doc ""] | S3 [@ocaml.doc ""] | NO_CACHE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec machine_type = NVME [@ocaml.doc ""] | GENERAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec image_pull_credentials_type = SERVICE_ROLE [@ocaml.doc ""] | CODEBUILD [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec docker_server_status = {
  message : string_ option;
      [@ocaml.doc "A message associated with the status of a docker server.\n"]
...
type nonrec logs_config_status_type = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec fleet_status = {
  message : string_ option;
      [@ocaml.doc "A message associated with the status of a compute fleet.\n"]
...
type nonrec fleet_overflow_behavior = ON_DEMAND [@ocaml.doc ""] | QUEUE [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec fleet_proxy_rule_behavior = DENY_ALL [@ocaml.doc ""] | ALLOW_ALL [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec fleet_proxy_rule_type = IP [@ocaml.doc ""] | DOMAIN [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec fleet_proxy_rule_effect_type = DENY [@ocaml.doc ""] | ALLOW [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec sort_order_type = DESCENDING [@ocaml.doc ""] | ASCENDING [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec shared_resource_sort_by_type = MODIFIED_TIME [@ocaml.doc ""] | ARN [@ocaml.doc ""]
[@@ocaml.doc ""]
