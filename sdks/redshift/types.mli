...
type nonrec usage_limit_limit_type = DATA_SCANNED [@ocaml.doc ""] | TIME [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec sort_by_order = DESCENDING [@ocaml.doc ""] | ASCENDING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec snapshot_sorting_entity = {
  ...
  attribute : snapshot_attribute_to_sort_by; [@ocaml.doc "The category for sorting the snapshots.\n"]
}
...
type nonrec service_authorization = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec scheduled_action_state = DISABLED [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec authorization_status = REVOKING [@ocaml.doc ""] | AUTHORIZED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec endpoint_authorization = {
  ...
  grantor : string_ option; [@ocaml.doc "The Amazon Web Services account ID of the cluster owner.\n"]
}
[@@ocaml.doc
...
type nonrec parameter_apply_type = Dynamic [@ocaml.doc ""] | Static [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec reserved_node_offering_type = Upgradable [@ocaml.doc ""] | Regular [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec application_type = LAKEHOUSE [@ocaml.doc ""] | NONE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec lakehouse_registration = DEREGISTER [@ocaml.doc ""] | REGISTER [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec lakehouse_idc_registration = DISASSOCIATE [@ocaml.doc ""] | ASSOCIATE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec integration_error = {
  error_message : string_ option;
      [@ocaml.doc "The error message of an inbound integration error.\n"]
...
type nonrec recommended_action_type = CLI [@ocaml.doc ""] | SQL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec log_destination_type = CLOUDWATCH [@ocaml.doc ""] | S3 [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec mode = HIGH_PERFORMANCE [@ocaml.doc ""] | STANDARD [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec data_share_status_for_consumer = AVAILABLE [@ocaml.doc ""] | ACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
