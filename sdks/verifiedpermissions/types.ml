...
type nonrec alias_state = ACTIVE [@ocaml.doc ""] | PENDING_DELETION [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type set_attribute = attribute_value list [@@ocaml.doc ""]
...
type nonrec policy_type = STATIC [@ocaml.doc ""] | TEMPLATE_LINKED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec decision = ALLOW [@ocaml.doc ""] | DENY [@ocaml.doc ""] [@@ocaml.doc ""]
...
and cedar_tag_record_attribute = (Smaws_Lib.Smithy_api.Types.string_ * cedar_tag_value) list
[@@ocaml.doc ""]
...
type nonrec cedar_version = CEDAR_2 [@ocaml.doc ""] | CEDAR_4 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec policy_effect = PERMIT [@ocaml.doc ""] | FORBID [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec validation_mode = OFF [@ocaml.doc ""] | STRICT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec deletion_mode = SOFT_DELETE [@ocaml.doc ""] | HARD_DELETE [@ocaml.doc ""]
[@@ocaml.doc
