...
type nonrec element_requirement = OPTIONAL [@ocaml.doc ""] | MANDATORY [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec x12_split_by = NONE [@ocaml.doc ""] | TRANSACTION [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec file_format = XML [@ocaml.doc ""] | JSON [@ocaml.doc ""] | NOT_USED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec conversion_source_format = JSON [@ocaml.doc ""] | XML [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec start_transformer_job_request = {
  ...
  client_token : Smaws_Lib.Smithy_api.Types.string_ option; [@ocaml.doc "Reserved for future use.\n"]
}
[@@ocaml.doc ""]
...
type nonrec mapping_type = JSONATA [@ocaml.doc ""] | XSLT [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec capability_direction = INBOUND [@ocaml.doc ""] | OUTBOUND [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec line_terminator = CRLF [@ocaml.doc ""] | LF [@ocaml.doc ""] | CR [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec create_capability_request = {
  name : capability_name;
      [@ocaml.doc "Specifies the name of the capability, used to identify it.\n"]
  type_ : capability_type;
...
type nonrec logging = ENABLED [@ocaml.doc ""] | DISABLED [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec mapping_template_language = XSLT [@ocaml.doc ""] | JSONATA [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec transformer_status = ACTIVE [@ocaml.doc ""] | INACTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
