...
val make_time_window : ?end_time:date -> ?start_time:date -> unit -> time_window
...
val make_resource_key :
  resource_id:resource_id -> resource_type:resource_type -> unit -> resource_key
...
val make_list_stored_queries_request :
  ?max_results:limit -> ?next_token:string_ -> unit -> list_stored_queries_request
...
val make_resource_count : ?count:long -> ?resource_type:resource_type -> unit -> resource_count
...
val make_compliance_contributor_count :
  ?cap_exceeded:boolean_ -> ?capped_count:integer -> unit -> compliance_contributor_count
...
val make_grouped_resource_count :
  resource_count:long -> group_name:string_with_char_limit256 -> unit -> grouped_resource_count
...
val make_config_rule_compliance_summary_filters :
  ?aws_region:aws_region -> ?account_id:account_id -> unit -> config_rule_compliance_summary_filters
...
val make_describe_aggregation_authorizations_request :
  ?next_token:string_ -> ?limit:limit -> unit -> describe_aggregation_authorizations_request
