...
[@@ocaml.doc
  ...
  \ For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutStoredQuery.html}PutStoredQuery}, \
  ...
  \        }\n\
  \   For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_DescribeConfigurationRecorders.html}DescribeConfigurationRecorders} \
   and \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_DescribeConfigurationRecorderStatus.html}DescribeConfigurationRecorderStatus}, \
   one of the following errors:\n\
  \   \n\
  \    {ul\n\
  ...
  \          }\n\
  \   For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_AssociateResourceTypes.html}AssociateResourceTypes} \
   and \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_DisassociateResourceTypes.html}DisassociateResourceTypes}, \
   one of the following errors:\n\
  \   \n\
  \    {ul\n\
...
type nonrec aggregate_resource_identifier = {
  ...
  resource_type : resource_type; [@ocaml.doc "The type of the Amazon Web Services resource.\n"]
  resource_id : resource_id; [@ocaml.doc "The ID of the Amazon Web Services resource.\n"]
  source_region : aws_region; [@ocaml.doc "The source region where data is aggregated.\n"]
  source_account_id : account_id; [@ocaml.doc "The 12-digit account ID of the source account.\n"]
}
[@@ocaml.doc
  "The details that identify a resource that is collected by Config aggregator, including the \
   resource type, ID, (if available) the custom resource name, the source account, and source \
   region.\n"]

type nonrec unprocessed_resource_identifier_list = aggregate_resource_identifier list
[@@ocaml.doc ""]
...
[@@ocaml.doc
  ...
  \ For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutConfigurationRecorder.html}PutConfigurationRecorder}, \
   ...
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutServiceLinkedConfigurationRecorder.html}PutServiceLinkedConfigurationRecorder} \
   operation to create a service-linked configuration recorder.\n\
  \ \n\
  \  For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_DeleteConfigurationRecorder.html}DeleteConfigurationRecorder}, \
   you will see this exception because you cannot use this operation to delete a service-linked \
   configuration recorder. Use the \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_DeleteServiceLinkedConfigurationRecorder.html}DeleteServiceLinkedConfigurationRecorder} \
  ...
  \   For \
   ...
   and \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_StopConfigurationRecorder.html}StopConfigurationRecorder}, \
   you will see this exception because these operations do not affect service-linked configuration \
   recorders. Service-linked configuration recorders are always recording. To stop recording, you \
   must delete the service-linked configuration recorder. Use the \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_DeleteServiceLinkedConfigurationRecorder.html}DeleteServiceLinkedConfigurationRecorder} \
   operation to delete a service-linked configuration recorder.\n\
  \   "]
...
[@@ocaml.doc
  "You have reached the limit of the number of tags you can use. For more information, see \
...
type nonrec time_window = {
  end_time : date option;
      [@ocaml.doc "The end time of an execution. The end time must be after the start date.\n"]
...
[@@ocaml.doc
  "This API allows you to create a conformance pack template with an Amazon Web Services Systems \
   Manager document (SSM document). To deploy a conformance pack using an SSM document, first \
   create an SSM document with conformance pack content, and then provide the [DocumentName] in \
   the \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutConformancePack.html}PutConformancePack \
...
type nonrec stored_query_metadata = {
  description : query_description option; [@ocaml.doc "A unique description for the query.\n"]
...
[@@ocaml.doc "Returns details of a specific query. \n"]
...
[@@ocaml.doc "Provides the details of a stored query.\n"]
...
[@@ocaml.doc "You have specified a configuration recorder that does not exist.\n"]
...
type nonrec status_detail_filters = {
  member_account_rule_status : member_account_rule_status option;
      [@ocaml.doc
        "Indicates deployment status for Config rule in the member account. When management \
         account calls [PutOrganizationConfigRule] action for the first time, Config rule status \
         is created in the member account. When management account calls \
         [PutOrganizationConfigRule] action for the second time, Config rule status is updated in \
         the member account. Config rule status is deleted when the management account deletes \
  ...
  account_id : account_id option;
      [@ocaml.doc "The 12-digit account ID of the member account within an organization.\n"]
}
[@@ocaml.doc
  "Status filter object to filter results based on specific member account ID or status type for \
...
type nonrec static_value = {
  values : static_parameter_values;
      [@ocaml.doc "A list of values. For example, the ARN of the assumed role. \n"]
}
...
type nonrec start_resource_evaluation_response = {
  resource_evaluation_id : resource_evaluation_id option;
      [@ocaml.doc "A unique ResourceEvaluationId that is associated with a single execution.\n"]
}
[@@ocaml.doc ""]
...
type nonrec resource_configuration_schema_type = CFN_RESOURCE_SCHEMA [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec resource_details = {
  resource_configuration_schema_type : resource_configuration_schema_type option;
      [@ocaml.doc
        ...
        \  You can find the \
         ...
         type schema}, or [CFN_RESOURCE_SCHEMA], in \"{i Amazon Web Services public extensions}\" \
         within the CloudFormation registry or with the following CLI commmand: [aws \
         cloudformation describe-type --type-name \"AWS::S3::Bucket\" --type RESOURCE].\n\
        \  \n\
  ...
  resource_type : string_with_char_limit256; [@ocaml.doc "The type of resource being evaluated.\n"]
  resource_id : base_resource_id; [@ocaml.doc "A unique resource ID for an evaluation.\n"]
}
[@@ocaml.doc "Returns information about the resource being evaluated.\n"]
...
type nonrec evaluation_context = {
  evaluation_context_identifier : evaluation_context_identifier option;
      [@ocaml.doc "A unique EvaluationContextIdentifier ID for an EvaluationContext.\n"]
}
[@@ocaml.doc
  "Use EvaluationContext to group independently initiated proactive resource evaluations. For \
   example, CFN Stack. If you want to check just a resource definition, you do not need to provide \
   evaluation context.\n"]

type nonrec evaluation_mode = PROACTIVE [@ocaml.doc ""] | DETECTIVE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec start_resource_evaluation_request = {
  client_token : client_token option;
      [@ocaml.doc
        "A client token is a unique, case-sensitive string of up to 64 ASCII characters. To make \
         an idempotent API request using one of these actions, specify a client token in the \
         request.\n\n\
        \  Avoid reusing the same client token for other API requests. If you retry a request that \
         completed successfully using the same client token and the same parameters, the retry \
         succeeds without performing any further actions. If you retry a successful request using \
         the same client token, but one or more of the parameters are different, other than the \
         Region or Availability Zone, the retry fails with an IdempotentParameterMismatch error.\n\
        \  \n\
        \   "]
...
[@@ocaml.doc
  "One or more of the specified parameters are not valid. Verify that your parameters are valid \
   and try again.\n"]

type nonrec idempotent_parameter_mismatch = { message : string_ option [@ocaml.doc ""] }
[@@ocaml.doc
  "Using the same client token with one or more different parameters. Specify a new client token \
   with the parameter changes and try again.\n"]

type nonrec resource_key = {
  resource_id : resource_id; [@ocaml.doc "The ID of the resource (for example., sg-xxxxxx). \n"]
...
type nonrec start_remediation_execution_response = {
  ...
  failure_message : string_ option;
      [@ocaml.doc "Returns a failure message. For example, the resource is already compliant.\n"]
}
[@@ocaml.doc ""]
...
type nonrec start_remediation_execution_request = {
  resource_keys : resource_keys;
      [@ocaml.doc
        "A list of resource keys to be processed with the current request. Each element in the \
...
[@@ocaml.doc "You specified an Config rule without a remediation configuration.\n"]
...
[@@ocaml.doc
  ...
  \ {ul\n\
  \       {-  For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutConfigRule.html}PutConfigRule}, \
   the rule cannot be created because the IAM role assigned to Config lacks permissions to perform \
  ...
  \            }\n\
  \       {-  For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutOrganizationConfigRule.html}PutOrganizationConfigRule}, \
   organization Config rule cannot be created because you do not have permissions to call IAM \
  ...
  \       {-  For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutConformancePack.html}PutConformancePack} \
   and \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutOrganizationConformancePack.html}PutOrganizationConformancePack}, \
  ...
  \       {-  For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutServiceLinkedConfigurationRecorder.html}PutServiceLinkedConfigurationRecorder}, \
   a service-linked configuration recorder cannot be created because you do not have the following \
...
[@@ocaml.doc "There is no delivery channel available to record configurations.\n"]
...
type nonrec start_config_rules_evaluation_request = {
  config_rule_names : reevaluate_config_rule_names option;
      [@ocaml.doc "The list of names of Config rules that you want to run evaluations for.\n"]
}
[@@ocaml.doc "\n"]
...
[@@ocaml.doc
  ...
  \       {-  For DeleteConfigRule, a remediation action is associated with the rule and Config \
   cannot delete this rule. Delete the remediation action associated with the rule before deleting \
   the rule and try your request again later.\n\
  \           \n\
  \            }\n\
...
[@@ocaml.doc
  "The Config rule in the request is not valid. Verify that the rule is an Config Process Check \
   rule, that the rule name is correct, and that valid Amazon Resouce Names (ARNs) are used before \
   trying again.\n"]
...
[@@ocaml.doc
  "For [PutServiceLinkedConfigurationRecorder] API, this exception is thrown if the number of \
   service-linked roles in the account exceeds the limit.\n\n\
...
type nonrec field_info = { name : field_name option [@ocaml.doc "Name of the field.\n"] }
[@@ocaml.doc "Details about the fields such as name of the field.\n"]

type nonrec field_info_list = field_info list [@@ocaml.doc ""]

type nonrec query_info = {
  select_fields : field_info_list option; [@ocaml.doc "Returns a [FieldInfo] object.\n"]
}
[@@ocaml.doc "Details about the query.\n"]
...
type nonrec select_resource_config_response = {
  ...
  query_info : query_info option; [@ocaml.doc "Returns the [QueryInfo] object.\n"]
  results : results option; [@ocaml.doc "Returns the results for the SQL query.\n"]
}
[@@ocaml.doc ""]
...
type nonrec select_resource_config_request = {
  next_token : next_token option;
      [@ocaml.doc
        "The [nextToken] string returned in a previous request that you use to request the next \
         page of results in a paginated response. \n"]
  limit : limit option; [@ocaml.doc "The maximum number of query results returned on each page. \n"]
...
[@@ocaml.doc "You have specified a configuration aggregator that does not exist.\n"]
...
type nonrec select_aggregate_resource_config_request = {
  ...
  max_results : limit option;
      [@ocaml.doc
        "The maximum number of query results returned on each page. Config also allows the Limit \
         request parameter.\n"]
  limit : limit option; [@ocaml.doc "The maximum number of query results returned on each page. \n"]
  ...
  stored_query : stored_query;
      [@ocaml.doc
        ...
        \  When you are creating a query, you must provide a query name and an expression. When \
         you are updating a query, you must provide a query name but updating the description is \
         optional.\n\
        \  \n\
        \   "]
}
...
[@@ocaml.doc
  "For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutServiceLinkedConfigurationRecorder.html}PutServiceLinkedConfigurationRecorder}, \
   you cannot create a service-linked recorder because a service-linked recorder already exists \
   for the specified service.\n\n\
  \ For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_DeleteServiceLinkedConfigurationRecorder.html}DeleteServiceLinkedConfigurationRecorder}, \
   you cannot delete the service-linked recorder because it is currently in use by the linked \
   Amazon Web Services service.\n\
  \ \n\
  \  For \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_DeleteDeliveryChannel.html}DeleteDeliveryChannel}, \
   you cannot delete the specified delivery channel because the customer managed configuration \
   recorder is running. Use the \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_StopConfigurationRecorder.html}StopConfigurationRecorder} \
...
type nonrec put_service_linked_configuration_recorder_request = {
  tags : tags_list option;
      [@ocaml.doc
        "The tags for a service-linked configuration recorder. Each tag consists of a key and an \
...
[@@ocaml.doc
  "Failed to add the retention configuration because a retention configuration with that name \
   already exists.\n"]
...
[@@ocaml.doc
  "An object with the name of the retention configuration and the retention period in days. The \
   object stores the configuration for data retention in Config.\n"]
...
[@@ocaml.doc
  "You have reached the limit of active custom resource types in your account. There is a limit of \
   100,000. Delete unused resources using \
...
type nonrec put_resource_config_request = {
  tags : tags option;
      [@ocaml.doc
        ...
        \  This field is not to be confused with the Amazon Web Services-wide tag feature for \
         Amazon Web Services resources. Tags for [PutResourceConfig] are tags that you supply for \
         the configuration items of your custom resources.\n\
        \  \n\
        \   "]
  ...
  resource_id : resource_id; [@ocaml.doc "Unique identifier of the resource.\n"]
  schema_version_id : schema_version_id;
      [@ocaml.doc "Version of the schema registered for the ResourceType in CloudFormation.\n"]
  resource_type : resource_type_string;
      [@ocaml.doc
        "The type of the resource. The custom resource type must be registered with \
         CloudFormation. \n\n\
        \  You cannot use the organization names \226\128\156amzn\226\128\157, \
         \226\128\156amazon\226\128\157, \226\128\156alexa\226\128\157, \
         \226\128\156custom\226\128\157 with custom resource types. It is the first part of the \
...
type nonrec remediation_exception = {
  ...
  resource_type : string_with_char_limit256; [@ocaml.doc "The type of a resource.\n"]
  config_rule_name : config_rule_name; [@ocaml.doc "The name of the Config rule.\n"]
}
[@@ocaml.doc
...
type nonrec failed_remediation_exception_batch = {
  failed_items : remediation_exceptions option;
      [@ocaml.doc "Returns remediation exception resource key object of the failed items.\n"]
  failure_message : string_ option;
      [@ocaml.doc "Returns a failure message. For example, the auto-remediation has failed.\n"]
}
[@@ocaml.doc "List of each of the failed remediation exceptions with specific reasons.\n"]

type nonrec failed_remediation_exception_batches = failed_remediation_exception_batch list
[@@ocaml.doc ""]
...
type nonrec remediation_exception_resource_key = {
  resource_id : string_with_char_limit1024 option;
      [@ocaml.doc "The ID of the resource (for example., sg-xxxxxx).\n"]
  resource_type : string_with_char_limit256 option; [@ocaml.doc "The type of a resource.\n"]
}
[@@ocaml.doc
  "The details that identify a resource within Config, including the resource type and resource ID. \n"]

type nonrec remediation_exception_resource_keys = remediation_exception_resource_key list
[@@ocaml.doc ""]

type nonrec put_remediation_exceptions_request = {
  expiration_time : date option;
      [@ocaml.doc "The exception is automatically deleted after the expiration date.\n"]
  message : string_with_char_limit1024 option;
  ...
  resource_keys : remediation_exception_resource_keys;
      [@ocaml.doc
        "An exception list of resource exception keys to be processed with the current request. \
         Config adds exception for each resource key. For example, Config adds 3 exceptions for 3 \
         resource keys. \n"]
  config_rule_name : config_rule_name;
      [@ocaml.doc
...
type nonrec remediation_target_type = SSM_DOCUMENT [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec resource_value_type = RESOURCE_ID [@ocaml.doc ""] [@@ocaml.doc ""]
...
[@@ocaml.doc
  "The value is either a dynamic (resource) value or a static value. You must select either a \
   dynamic value or a static value.\n"]

type nonrec remediation_parameters = (string_with_char_limit256 * remediation_parameter_value) list
[@@ocaml.doc ""]
...
[@@ocaml.doc "Amazon Web Services Systems Manager (SSM) specific remediation controls.\n"]
...
type nonrec remediation_configuration = {
  created_by_service : string_with_char_limit1024 option;
      [@ocaml.doc "Name of the service that owns the service-linked rule, if applicable.\n"]
  ...
  retry_attempt_seconds : auto_remediation_attempt_seconds option;
      [@ocaml.doc
        "Time window to determine whether or not to add a remediation exception to prevent \
         infinite remediation attempts. If [MaximumAutomaticAttempts] remediation attempts have \
         been made under [RetryAttemptSeconds], a remediation exception will be added to the \
        ...
        \ For example, if you specify [RetryAttemptSeconds] as 50 seconds and \
         [MaximumAutomaticAttempts] as 5, Config will run auto-remediations 5 times within 50 \
  ...
  maximum_automatic_attempts : auto_remediation_attempts option;
      [@ocaml.doc
        ...
        \ For example, if you specify MaximumAutomaticAttempts as 5 with RetryAttemptSeconds as 50 \
         seconds, Config will put a RemediationException on your behalf for the failing resource \
         after the 5th failed attempt within 50 seconds.\n\
        \ "]
  execution_controls : execution_controls option; [@ocaml.doc "An ExecutionControls object.\n"]
  automatic : boolean_ option; [@ocaml.doc "The remediation is triggered automatically.\n"]
  ...
  target_version : string_ option;
      [@ocaml.doc
        ...
        \  \n\
        \   "]
  target_id : string_with_char_limit256; [@ocaml.doc "Target ID is the name of the SSM document.\n"]
...
type nonrec remediation_configurations = remediation_configuration list [@@ocaml.doc ""]
...
[@@ocaml.doc "List of each of the failed remediations with specific reasons.\n"]

type nonrec failed_remediation_batches = failed_remediation_batch list [@@ocaml.doc ""]
...
[@@ocaml.doc "You have specified a template that is not valid or supported.\n"]
...
[@@ocaml.doc
  ...
  \       {-  The configuration aggregator cannot be updated because your Amazon Web Services \
   Organization management account or the delegated administrator role changed. Delete this \
   aggregator and create a new one with the current Amazon Web Services Organization.\n\
  \           \n\
  \            }\n\
  \       {-  The configuration aggregator is associated with a previous Amazon Web Services \
   Organization and Config cannot aggregate data with current Amazon Web Services Organization. \
  ...
  \       {-  You are not a registered delegated administrator for Config with permissions to call \
   ...
   administrator for Config service principal name before the delegated administrator creates an \
   aggregator.\n\
  \           \n\
  \            }\n\
  \       }\n\
  \   For all [OrganizationConfigRule] and [OrganizationConformancePack] APIs, Config throws an \
   exception if APIs are called from member accounts. All APIs must be called from organization \
   management account.\n\
  \   "]
...
type nonrec conformance_pack_input_parameter = {
  parameter_value : parameter_value; [@ocaml.doc "Another part of the key-value pair. \n"]
  parameter_name : parameter_name; [@ocaml.doc "One part of a key-value pair.\n"]
}
[@@ocaml.doc
  "Input parameters in the form of key-value pairs for the conformance pack, both of which you \
   define. Keys can have a maximum character length of 255 characters, and values can have a \
   maximum length of 4096 characters.\n"]

type nonrec conformance_pack_input_parameters = conformance_pack_input_parameter list
[@@ocaml.doc ""]
  ...
  template_s3_uri : template_s3_uri option;
      [@ocaml.doc
        "Location of file containing the template body. The uri must point to the conformance pack \
         template (max size: 300 KB).\n\n\
        \  You must have access to read Amazon S3 bucket. In addition, in order to ensure a \
         successful deployment, the template object must not be in an \
         {{:https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-class-intro.html}archived \
         storage class} if this parameter is passed.\n\
        \  \n\
        \   "]
  organization_conformance_pack_name : organization_conformance_pack_name;
      [@ocaml.doc "Name of the organization conformance pack you want to create.\n"]
}
[@@ocaml.doc ""]
...
type nonrec put_organization_config_rule_response = {
  organization_config_rule_arn : string_with_char_limit256 option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of an organization Config rule.\n"]
}
[@@ocaml.doc ""]
...
type nonrec organization_managed_rule_metadata = {
  ...
  resource_id_scope : string_with_char_limit768 option;
      [@ocaml.doc "The ID of the Amazon Web Services resource that was evaluated.\n"]
  resource_types_scope : resource_types_scope option;
      [@ocaml.doc "The type of the Amazon Web Services resource that was evaluated.\n"]
  ...
  rule_identifier : string_with_char_limit256;
      [@ocaml.doc
        "For organization config managed rules, a predefined identifier from a list. For example, \
         ...
         {{:https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html}Using \
         Config managed rules}.\n"]
  description : string_with_char_limit256_min0 option;
      [@ocaml.doc "The description that you provide for your organization Config rule.\n"]
}
[@@ocaml.doc
  "An object that specifies organization managed rule metadata such as resource type and ID of \
   Amazon Web Services resource along with the rule identifier. It also provides the frequency \
...
type nonrec organization_config_rule_trigger_types = organization_config_rule_trigger_type list
[@@ocaml.doc ""]
...
type nonrec organization_custom_rule_metadata = {
  ...
  maximum_execution_frequency : maximum_execution_frequency option;
      [@ocaml.doc
        "The maximum frequency with which Config runs evaluations for a rule. Your custom rule is \
  ...
  organization_config_rule_trigger_types : organization_config_rule_trigger_types;
      [@ocaml.doc
        "The type of notification that triggers Config to run an evaluation for a rule. You can \
        ...
        \       {-   [OversizedConfigurationItemChangeNotification] - Triggers an evaluation when \
         ...
         type when a resource changes and the notification exceeds the maximum size allowed by \
         Amazon SNS.\n\
        \           \n\
        \            }\n\
        ...
        \       }\n\
        \  "]
  lambda_function_arn : string_with_char_limit256; [@ocaml.doc "The lambda function ARN.\n"]
  description : string_with_char_limit256_min0 option;
      [@ocaml.doc "The description that you provide for your organization Config rule.\n"]
}
[@@ocaml.doc
  "An object that specifies organization custom rule metadata such as resource type, resource ID \
   of Amazon Web Services resource, Lambda function ARN, and organization trigger types that \
   trigger Config to evaluate your Amazon Web Services resources against a rule. It also provides \
   the frequency with which you want Config to run evaluations for the rule if the trigger type is \
   periodic.\n"]
...
type nonrec organization_custom_policy_rule_metadata = {
  debug_log_delivery_accounts : debug_log_delivery_accounts option;
      [@ocaml.doc
        "A list of accounts that you can enable debug logging for your organization Config Custom \
         Policy rule. List is null when debug logging is enabled for all accounts.\n"]
  ...
  policy_runtime : policy_runtime;
      [@ocaml.doc
        "The runtime system for your organization Config Custom Policy rules. Guard is a \
         policy-as-code language that allows you to write policies that are enforced by Config \
...
[@@ocaml.doc
  "An object that specifies metadata for your organization's Config Custom Policy rule. The \
   metadata includes the runtime system in use, which accounts have debug logging enabled, and \
   other custom rule metadata, such as resource type, resource ID of Amazon Web Services resource, \
   and organization trigger types that initiate Config to evaluate Amazon Web Services resources \
   against a rule.\n"]
...
type nonrec put_organization_config_rule_request = {
  organization_custom_policy_rule_metadata : organization_custom_policy_rule_metadata option;
      [@ocaml.doc
        "An [OrganizationCustomPolicyRuleMetadata] object. This object specifies metadata for your \
         organization's Config Custom Policy rule. The metadata includes the runtime system in \
         use, which accounts have debug logging enabled, and other custom rule metadata, such as \
         resource type, resource ID of Amazon Web Services resource, and organization trigger \
  ...
  organization_custom_rule_metadata : organization_custom_rule_metadata option;
      [@ocaml.doc
        "An [OrganizationCustomRuleMetadata] object. This object specifies organization custom \
         rule metadata such as resource type, resource ID of Amazon Web Services resource, Lambda \
         function ARN, and organization trigger types that trigger Config to evaluate your Amazon \
         Web Services resources against a rule. It also provides the frequency with which you want \
  ...
  organization_managed_rule_metadata : organization_managed_rule_metadata option;
      [@ocaml.doc
        "An [OrganizationManagedRuleMetadata] object. This object specifies organization managed \
         rule metadata such as resource type and ID of Amazon Web Services resource along with the \
         rule identifier. It also provides the frequency with which you want Config to run \
...
type nonrec external_evaluation = {
  ...
  compliance_type : compliance_type;
      [@ocaml.doc
        "The compliance of the Amazon Web Services resource. The valid values are [COMPLIANT, \
...
[@@ocaml.doc
  "Identifies an Amazon Web Services resource and indicates whether it complies with the Config \
   rule that it was evaluated against.\n"]

type nonrec put_external_evaluation_request = {
  external_evaluation : external_evaluation;
      [@ocaml.doc "An [ExternalEvaluation] object that provides details about compliance.\n"]
  config_rule_name : config_rule_name; [@ocaml.doc "The name of the Config rule.\n"]
}
[@@ocaml.doc ""]
  ...
  ordering_timestamp : ordering_timestamp;
      [@ocaml.doc
        "The time of the event in Config that triggered the evaluation. For event-based \
         evaluations, the time indicates when Config created the configuration item that triggered \
         the evaluation. For periodic evaluations, the time indicates when Config triggered the \
         evaluation at the frequency that you specified (for example, every 24 hours).\n"]
  annotation : string_with_char_limit256 option;
      [@ocaml.doc "Supplementary information about how the evaluation determined the compliance.\n"]
  compliance_type : compliance_type;
      [@ocaml.doc
        "Indicates whether the Amazon Web Services resource complies with the Config rule that it \
         was evaluated against.\n\n\
        \ For the [Evaluation] data type, Config supports only the [COMPLIANT], [NON_COMPLIANT], \
         and [NOT_APPLICABLE] values. Config does not support the [INSUFFICIENT_DATA] value for \
         this data type.\n\
        \ \n\
        \  Similarly, Config does not accept [INSUFFICIENT_DATA] as the value for [ComplianceType] \
         from a [PutEvaluations] request. For example, an Lambda function for a custom Config rule \
         cannot pass an [INSUFFICIENT_DATA] value to Config.\n\
        \  "]
  compliance_resource_id : base_resource_id;
      [@ocaml.doc "The ID of the Amazon Web Services resource that was evaluated.\n"]
  compliance_resource_type : string_with_char_limit256;
      [@ocaml.doc "The type of Amazon Web Services resource that was evaluated.\n"]
}
[@@ocaml.doc
  "Identifies an Amazon Web Services resource and indicates whether it complies with the Config \
   rule that it was evaluated against.\n"]
...
type nonrec put_evaluations_response = {
  failed_evaluations : evaluations option;
      [@ocaml.doc "Requests that failed because of a client or server error.\n"]
}
[@@ocaml.doc "\n"]
...
type nonrec put_evaluations_request = {
  test_mode : boolean_ option;
      [@ocaml.doc
        "Use this parameter to specify a test run for [PutEvaluations]. You can verify whether \
         your Lambda function will deliver evaluation results to Config. No updates occur to your \
         existing evaluations, and evaluation results are not sent to Config.\n\n\
  ...
  result_token : string_;
      [@ocaml.doc
        "An encrypted token that associates an evaluation with an Config rule. Identifies the rule \
  ...
  evaluations : evaluations option;
      [@ocaml.doc
        "The assessments that the Lambda function performs. Each evaluation identifies an Amazon \
         Web Services resource and indicates whether it complies with the Config rule that invokes \
         the Lambda function.\n"]
}
[@@ocaml.doc "\n"]
...
[@@ocaml.doc
  "There are no customer managed configuration recorders available to record your resources. Use \
   the \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_PutConfigurationRecorder.html}PutConfigurationRecorder} \
...
[@@ocaml.doc "You have reached the limit of the number of delivery channels you can create.\n"]
...
[@@ocaml.doc "Your Amazon S3 bucket policy does not allow Config to write to it.\n"]
...
type nonrec config_snapshot_delivery_properties = {
  delivery_frequency : maximum_execution_frequency option;
      [@ocaml.doc "The frequency with which Config delivers configuration snapshots.\n"]
}
[@@ocaml.doc
  "Provides options for how often Config delivers configuration snapshots to the Amazon S3 bucket \
   in your delivery channel.\n\n\
  \ The frequency for a rule that triggers evaluations for your resources when Config delivers the \
  ...
  \        {-  The value for the [deliveryFrequency] parameter within the delivery channel \
   configuration, which sets how often Config delivers configuration snapshots. This value also \
   sets how often Config invokes evaluations for Config rules.\n\
  \            \n\
  \             }\n\
  \        {-  The value for the [MaximumExecutionFrequency] parameter, which sets the maximum \
   frequency with which Config invokes evaluations for the rule. For more information, see \
   [ConfigRule].\n\
  \            \n\
  \             }\n\
  \        }\n\
  ...
  \          {-  Because the value for [deliveryFrequency] is less frequent than \
   [MaximumExecutionFrequency], Config invokes evaluations for the rule every 24 hours. \n\
  \              \n\
  \               }\n\
  \          }\n\
  ...
  \   \n\
  \    To update the [deliveryFrequency] with which Config delivers your configuration snapshots, \
...
type nonrec delivery_channel = {
  ...
  sns_topic_ar_n : string_ option;
      [@ocaml.doc
        ...
        \ If you choose a topic from another account, the topic must have policies that grant \
         ...
         {{:https://docs.aws.amazon.com/config/latest/developerguide/sns-topic-policy.html}Permissions \
         for the Amazon SNS Topic} in the {i Config Developer Guide}.\n\
        \ "]
  ...
  s3_key_prefix : string_ option; [@ocaml.doc "The prefix for the specified Amazon S3 bucket.\n"]
  s3_bucket_name : string_ option;
      [@ocaml.doc
        ...
        \ If you specify a bucket that belongs to another Amazon Web Services account, that bucket \
         must have policies that grant access permissions to Config. For more information, see \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/s3-bucket-policy.html}Permissions \
         for the Amazon S3 Bucket} in the {i Config Developer Guide}.\n\
        \ "]
...
[@@ocaml.doc
  "You have reached the limit of the number of conformance packs you can create in an account. For \
...
type nonrec put_conformance_pack_response = {
  conformance_pack_arn : conformance_pack_arn option; [@ocaml.doc "ARN of the conformance pack.\n"]
}
[@@ocaml.doc ""]
...
type nonrec put_conformance_pack_request = {
  template_ssm_document_details : template_ssm_document_details option;
      [@ocaml.doc
        "An object of type [TemplateSSMDocumentDetails], which contains the name or the Amazon \
         Resource Name (ARN) of the Amazon Web Services Systems Manager document (SSM document) \
  ...
  template_s3_uri : template_s3_uri option;
      [@ocaml.doc
        "The location of the file containing the template body ([s3://bucketname/prefix]). The uri \
         must point to a conformance pack template (max size: 300 KB) that is located in an Amazon \
  ...
  conformance_pack_name : conformance_pack_name;
      [@ocaml.doc "The unique name of the conformance pack you want to deploy.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "You have provided a null or empty Amazon Resource Name (ARN) for the IAM role assumed by Config \
   and used by the customer managed configuration recorder.\n"]
...
[@@ocaml.doc
  ...
  \                  {-  Setting the [allSupported] field of \
   {{:https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html}RecordingGroup} \
   to [true], but also setting the [useOnly] field of \
...
[@@ocaml.doc
  "Specifies whether the configuration recorder excludes certain resource types from being \
   recorded. Use the [resourceTypes] field to enter a comma-separated list of resource types you \
   want to exclude from recording.\n\n\
  \ By default, when Config adds support for a new resource type in the Region where you set up \
   the configuration recorder, including global resource types, Config starts recording resources \
  ...
  \    To use this option, you must set the [useOnly] field of \
   ...
   to [EXCLUSION_BY_RESOURCE_TYPES].\n\
  \    \n\
  \     Config will then record configuration changes for all supported resource types, except the \
  ...
  \        IAM users, groups, roles, and customer managed policies will be recorded in the Region \
   ...
   before February 2022. You cannot be record the global IAM resouce types in Regions supported by \
   Config after February 2022. For a list of those Regions, see \
   {{:https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-all}Recording \
  ...
  use_only : recording_strategy_type option;
      [@ocaml.doc
        ...
        \       {-  If you set this option to [ALL_SUPPORTED_RESOURCE_TYPES], Config records \
         ...
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html}RecordingGroup} \
         to [true]. When Config adds support for a new resource type, Config automatically starts \
         recording resources of that type. For a list of supported resource types, see \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/resource-config-reference.html#supported-resources}Supported \
         Resource Types} in the {i Config developer guide}.\n\
        \           \n\
        \            }\n\
        ...
        \       The [recordingStrategy] field is required if you list resource types to exclude \
         from recording in the [resourceTypes] field of \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_ExclusionByResourceTypes.html}ExclusionByResourceTypes}.\n\
        \       \n\
        \           {b Overriding fields} \n\
        \          \n\
        ...
        \                By default, if you choose the [EXCLUSION_BY_RESOURCE_TYPES] recording \
         strategy, when Config adds support for a new resource type in the Region where you set up \
         the configuration recorder, including global resource types, Config starts recording \
         resources of that type automatically.\n\
        \                \n\
        \                 Unless specifically listed as exclusions, [AWS::RDS::GlobalCluster] will \
...
[@@ocaml.doc "Specifies the recording strategy of the configuration recorder.\n"]
...
type nonrec recording_group = {
  recording_strategy : recording_strategy option;
      [@ocaml.doc
        ...
        \       {-  If you set the [useOnly] field of \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html}RecordingStrategy} \
         to [ALL_SUPPORTED_RESOURCE_TYPES], Config records configuration changes for all supported \
        ...
        \       {-  If you set the [useOnly] field of \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html}RecordingStrategy} \
         to [INCLUSION_BY_RESOURCE_TYPES], Config records configuration changes for only the \
        ...
        \       {-  If you set the [useOnly] field of \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingStrategy.html}RecordingStrategy} \
         to [EXCLUSION_BY_RESOURCE_TYPES], Config records configuration changes for all supported \
        ...
        \                  IAM users, groups, roles, and customer managed policies will be \
         recorded in the Region where you set up the configuration recorder if that is a Region \
         where Config was available before February 2022. You cannot be record the global IAM \
         resouce types in Regions supported by Config after February 2022. For a list of those \
         Regions, see \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-all}Recording \
         Amazon Web Services Resources | Global Resources}.\n\
        \                  \n\
  ...
  exclusion_by_resource_types : exclusion_by_resource_types option;
      [@ocaml.doc
        "An object that specifies how Config excludes resource types from being recorded by the \
  ...
  resource_types : resource_type_list option;
      [@ocaml.doc
        ...
        \ For a list of valid [resourceTypes] values, see the {b Resource Type Value} column in \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/resource-config-reference.html#supported-resources}Supported \
         Amazon Web Services resource Types} in the {i Config developer guide}.\n\
        \ \n\
        \    {b Required and optional fields} \n\
        \   \n\
        ...
        \     To record all configuration changes, set the [allSupported] field of \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html}RecordingGroup} \
         to [true], and either omit this field or don't specify any resource types in this field. \
         If you set the [allSupported] field to [false] and specify values for [resourceTypes], \
         when Config adds support for a new type of resource, it will not record resources of that \
         type unless you manually add that type to your recording group.\n\
        \     \n\
        \         {b Region availability} \n\
        \        \n\
        \         Before specifying a resource type for Config to track, check \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/what-is-resource-config-coverage.html}Resource \
         Coverage by Region Availability} to see if the resource type is supported in the Amazon \
         Web Services Region where you set up Config. If a resource type is supported by Config in \
         at least one Region, you can enable the recording of that resource type in all Regions \
         supported by Config, even if the specified resource type is not supported in the Amazon \
         Web Services Region where you set up Config.\n\
        \         \n\
        \          "]
  include_global_resource_types : include_global_resource_types option;
      [@ocaml.doc
        "This option is a bundle which only applies to the global IAM resource types: IAM users, \
         groups, roles, and customer managed policies. These global IAM resource types can only be \
         recorded by Config in Regions where Config was available before February 2022. You cannot \
         be record the global IAM resouce types in Regions supported by Config after February \
         2022. For a list of those Regions, see \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-all}Recording \
         Amazon Web Services Resources | Global Resources}.\n\n\
        \   {b Aurora global clusters are recorded in all enabled Regions} \n\
        \  \n\
        \   The [AWS::RDS::GlobalCluster] resource type will be recorded in all supported Config \
         Regions where the configuration recorder is enabled, even if [includeGlobalResourceTypes] \
         is set[false]. The [includeGlobalResourceTypes] option is a bundle which only applies to \
        ...
        \    If you do not want to record [AWS::RDS::GlobalCluster] in all enabled Regions, use \
         one of the following recording strategies:\n\
        \    \n\
        \     {ol\n\
        ...
        \           }\n\
        \   For more information, see \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html#select-resources-all}Selecting \
         Which Resources are Recorded} in the {i Config developer guide}.\n\
        \   \n\
        ...
        \       The [includeGlobalResourceTypes] field has no impact on the \
         ...
         types (IAM users, groups, roles, and customer managed policies) will not be automatically \
         added as exclusions for [exclusionByResourceTypes] when [includeGlobalResourceTypes] is \
         set to [false].\n\
        \       \n\
        \        The [includeGlobalResourceTypes] field should only be used to modify the \
         ...
         configuration changes for all supported resource types excluding the global IAM resource \
         types. To include the global IAM resource types when [AllSupported] is set to [true], \
         make sure to set [includeGlobalResourceTypes] to [true].\n\
        \        \n\
        ...
        \                 {b Overriding fields} \n\
        \                \n\
        \                 If you set this field to [false] but list global IAM resource types in \
         the [resourceTypes] field of \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html}RecordingGroup}, \
         Config will still record configuration changes for those specified resource types {i \
        ...
        \                  If you do not want to record configuration changes to the global IAM \
         resource types (IAM users, groups, roles, and customer managed policies), make sure to \
  ...
  all_supported : all_supported option;
      [@ocaml.doc
        ...
        \ If you set this field to [true], when Config adds support for a new resource type, \
         Config starts recording resources of that type automatically.\n\
        \ \n\
        \  If you set this field to [true], you cannot enumerate specific resource types to record \
         in the [resourceTypes] field of \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html}RecordingGroup}, \
...
[@@ocaml.doc
  "Specifies which resource types Config records for configuration changes. By default, Config \
   records configuration changes for all current and future supported resource types in the Amazon \
   Web Services Region where you have enabled Config, excluding the global IAM resource types: IAM \
  ...
  \ In the recording group, you specify whether you want to record all supported current and \
   ...
   Resource Types} in the {i Config developer guide}.\n\
  \ \n\
  \  If you don't want Config to record all current and future supported resource types (excluding \
   the global IAM resource types), use one of the following recording strategies:\n\
  \  \n\
  \   {ol\n\
  \         {-   {b Record all current and future resource types with exclusions} \
   ([EXCLUSION_BY_RESOURCE_TYPES]), or\n\
  ...
  \              }\n\
  \         }\n\
  \   If you use the recording strategy to {b Record all current and future resource types} \
...
type nonrec recording_frequency = DAILY [@ocaml.doc ""] | CONTINUOUS [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec recording_mode_override = {
  recording_frequency : recording_frequency;
      [@ocaml.doc
        ...
        \       {-  Daily recording allows you to receive a configuration item (CI) representing \
         ...
         it\226\128\153s different from the previous CI recorded. \n\
        \           \n\
        \            }\n\
        \       }\n\
        \    Firewall Manager depends on continuous recording to monitor your resources. If you \
         are using Firewall Manager, it is recommended that you set the recording frequency to \
         Continuous.\n\
        \    \n\
        \     "]
  resource_types : recording_mode_resource_types_list;
      [@ocaml.doc
        ...
        \         }\n\
        \   "]
  description : description option; [@ocaml.doc "A description that you provide for the override.\n"]
}
[@@ocaml.doc "An object for you to specify your overrides for the recording mode.\n"]
...
type nonrec recording_mode = {
  recording_mode_overrides : recording_mode_overrides option;
      [@ocaml.doc
        "An array of [recordingModeOverride] objects for you to specify your overrides for the \
         recording mode. The [recordingModeOverride] object in the [recordingModeOverrides] array \
         consists of three fields: a [description], the new [recordingFrequency], and an array of \
  ...
  recording_frequency : recording_frequency;
      [@ocaml.doc
        ...
        \              }\n\
        \         }\n\
        \   For the {b allSupported} ([ALL_SUPPORTED_RESOURCE_TYPES]) recording strategy, these \
...
[@@ocaml.doc
  "Specifies the default recording frequency that Config uses to record configuration changes. \
   Config supports {i Continuous recording} and {i Daily recording}.\n\n\
  \ {ul\n\
  \       {-  Continuous recording allows you to record configuration changes continuously \
   whenever a change occurs.\n\
  \           \n\
  \            }\n\
  \       {-  Daily recording allows you to receive a configuration item (CI) representing the \
   most recent state of your resources over the last 24-hour period, only if it\226\128\153s \
   different from the previous CI recorded. \n\
  \           \n\
  \            }\n\
  \       }\n\
  \    Firewall Manager depends on continuous recording to monitor your resources. If you are \
   using Firewall Manager, it is recommended that you set the recording frequency to Continuous.\n\
  \    \n\
  \      You can also override the recording frequency for specific resource types.\n\
  \      "]

type nonrec recording_scope = PAID [@ocaml.doc ""] | INTERNAL [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec configuration_recorder = {
  ...
  recording_scope : recording_scope option;
      [@ocaml.doc
        "Specifies whether the \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_ConfigurationItem.html}ConfigurationItems} \
         in scope for the specified configuration recorder are recorded for free ([INTERNAL]) or \
  ...
  recording_mode : recording_mode option;
      [@ocaml.doc
        "Specifies the default recording frequency for the configuration recorder. Config supports \
         {i Continuous recording} and {i Daily recording}.\n\n\
        \ {ul\n\
        \       {-  Continuous recording allows you to record configuration changes continuously \
         whenever a change occurs.\n\
        \           \n\
  ...
  recording_group : recording_group option;
      [@ocaml.doc
        ...
        \   You might notice increased activity in your account during your initial month \
         ...
         bootstrapping process, Config runs evaluations on all the resources in your account that \
         you have selected for Config to record.\n\
        \   \n\
        \    If you are running ephemeral workloads, you may see increased activity from Config as \
         it records configuration changes associated with creating and deleting these temporary \
         resources. An {i ephemeral workload} is a temporary use of computing resources that are \
         loaded and run when needed. Examples include Amazon Elastic Compute Cloud (Amazon EC2) \
        ...
        \     If you want to avoid the increased activity from running ephemeral workloads, you \
         can set up the configuration recorder to exclude these resource types from being \
         recorded, or run these types of workloads in a separate account with Config turned off to \
  ...
  role_ar_n : string_ option;
      [@ocaml.doc
        ...
        \   {b The server will reject a request without a defined [roleARN] for the configuration \
         recorder} \n\
        \  \n\
        ...
        \      {{:https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html}IAM \
         policies} and \
         {{:https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies.html}other \
         policies managed in Organizations} can impact whether Config has permissions to record \
         ...
         evaluations. Make sure that the policies in effect align with how you intend to use \
         Config.\n\
        \     \n\
        ...
        \        For example, if Control Tower has an IAM role that allows Config to read S3 \
         objects, make sure that the same permissions are granted to the IAM role you use when \
         setting up Config. Otherwise, it may interfere with how Control Tower operates.\n\
        \        \n\
        \          {b The service-linked IAM role for Config must be used for service-linked \
         configuration recorders} \n\
        \         \n\
        \          For service-linked configuration recorders, you must use the service-linked IAM \
         role for Config: \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/using-service-linked-roles.html}AWSServiceRoleForConfig}.\n\
        \          \n\
        \           "]
  name : recorder_name option;
      [@ocaml.doc
        "The name of the configuration recorder.\n\n\
        \ For customer managed configuration recorders, Config automatically assigns the name of \
         \"default\" when creating a configuration recorder if you do not specify a name at \
         creation time.\n\
        \ \n\
...
type nonrec put_configuration_recorder_request = {
  tags : tags_list option;
      [@ocaml.doc
        "The tags for the customer managed configuration recorder. Each tag consists of a key and \
...
type nonrec account_aggregation_source_account_list = account_id list [@@ocaml.doc ""]

type nonrec aggregator_region_list = string_ list [@@ocaml.doc ""]

type nonrec account_aggregation_source = {
  aws_regions : aggregator_region_list option; [@ocaml.doc "The source regions being aggregated.\n"]
  all_aws_regions : boolean_ option;
      [@ocaml.doc "If true, aggregate existing Config regions and future regions.\n"]
  account_ids : account_aggregation_source_account_list;
      [@ocaml.doc "The 12-digit account ID of the account being aggregated. \n"]
}
[@@ocaml.doc "A collection of accounts and regions.\n"]

type nonrec account_aggregation_source_list = account_aggregation_source list [@@ocaml.doc ""]
...
type nonrec aggregator_filter_type = INCLUDE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec aggregator_filter_resource_type = {
  ...
  type_ : aggregator_filter_type option;
      [@ocaml.doc
        "The type of resource type filter to apply. [INCLUDE] specifies that the list of resource \
         types in the [Value] field will be aggregated and no other resource types will be \
         filtered.\n"]
}
[@@ocaml.doc
  "An object to filter the configuration recorders based on the resource types in scope for \
   recording.\n"]

type nonrec service_principal_value = string [@@ocaml.doc ""]

type nonrec service_principal_value_list = service_principal_value list [@@ocaml.doc ""]

type nonrec aggregator_filter_service_principal = {
  value : service_principal_value_list option;
      [@ocaml.doc
        "Comma-separated list of service principals for the linked Amazon Web Services services to \
         filter your aggregated service-linked configuration recorders.\n"]
  type_ : aggregator_filter_type option;
      [@ocaml.doc
        "The type of service principal filter to apply. [INCLUDE] specifies that the list of \
         service principals in the [Value] field will be aggregated and no other service \
...
type nonrec aggregator_filters = {
  service_principal : aggregator_filter_service_principal option;
      [@ocaml.doc
        "An object to filter service-linked configuration recorders in an aggregator based on the \
...
type nonrec configuration_aggregator = {
  ...
  created_by : string_with_char_limit256 option;
      [@ocaml.doc "Amazon Web Services service that created the configuration aggregator.\n"]
  last_updated_time : date option; [@ocaml.doc "The time of the last update.\n"]
  creation_time : date option;
      [@ocaml.doc "The time stamp when the configuration aggregator was created.\n"]
  organization_aggregation_source : organization_aggregation_source option;
      [@ocaml.doc "Provides an organization and list of regions to be aggregated.\n"]
  account_aggregation_sources : account_aggregation_source_list option;
      [@ocaml.doc "Provides a list of source accounts and regions to be aggregated.\n"]
...
[@@ocaml.doc
  "Failed to add the Config rule because the account already contains the maximum number of 1000 \
   rules. Consider deleting any deactivated rules before you add new rules.\n"]
  ...
  tag_value : string_with_char_limit256 option;
      [@ocaml.doc
        "The tag value applied to only those Amazon Web Services resources that you want to \
         trigger an evaluation for the rule. If you specify a value for [TagValue], you must also \
         specify a value for [TagKey].\n"]
  tag_key : string_with_char_limit128 option;
      [@ocaml.doc
        "The tag key that is applied to only those Amazon Web Services resources that you want to \
...
[@@ocaml.doc
  "Defines which resources trigger an evaluation for an Config rule. The scope can include one or \
   more resource types, a combination of a tag key and value, or a combination of one resource \
   type and one resource ID. Specify a scope to constrain which resources trigger an evaluation \
   for a rule. Otherwise, evaluations for the rule are triggered when any resource in your \
...
type nonrec event_source = Aws_Config [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec source_detail = {
  maximum_execution_frequency : maximum_execution_frequency option;
      [@ocaml.doc
        ...
        \   Based on the valid value you choose, Config runs evaluations once for each valid \
         value. For example, if you choose [Three_Hours], Config runs evaluations once every three \
  ...
  event_source : event_source option;
      [@ocaml.doc
        "The source of the event, such as an Amazon Web Services service, that triggers Config to \
         evaluate your Amazon Web Services resources.\n"]
}
[@@ocaml.doc
  "Provides the source and the message types that trigger Config to evaluate your Amazon Web \
   Services resources against a rule. It also provides the frequency with which you want Config to \
...
type nonrec custom_policy_details = {
  enable_debug_log_delivery : boolean_ option;
      [@ocaml.doc
        "The boolean expression for enabling debug logging for your Config Custom Policy rule. The \
  ...
  policy_runtime : policy_runtime;
      [@ocaml.doc
        "The runtime system for your Config Custom Policy rule. Guard is a policy-as-code language \
         that allows you to write policies that are enforced by Config Custom Policy rules. For \
         more information about Guard, see the \
         {{:https://github.com/aws-cloudformation/cloudformation-guard}Guard GitHub Repository}.\n"]
}
[@@ocaml.doc
  "Provides the runtime system, policy definition, and whether debug logging enabled. You can \
   specify the following CustomPolicyDetails parameter values only for Config Custom Policy rules.\n"]
...
type nonrec source = {
  ...
  source_details : source_details option;
      [@ocaml.doc
        "Provides the source and the message types that cause Config to evaluate your Amazon Web \
         Services resources against a rule. It also provides the frequency with which you want \
         Config to run evaluations for the rule if the trigger type is periodic.\n\n\
  ...
  source_identifier : string_with_char_limit256 option;
      [@ocaml.doc
        ...
        \ For Config Custom Lambda rules, the identifier is the Amazon Resource Name (ARN) of the \
  ...
  owner : owner;
      [@ocaml.doc
        ...
        \ Config Managed Rules are predefined rules owned by Amazon Web Services. For more \
         information, see \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html}Config \
         Managed Rules} in the {i Config developer guide}.\n\
        \ \n\
        \  Config Custom Rules are rules that you can develop either with Guard ([CUSTOM_POLICY]) \
         or Lambda ([CUSTOM_LAMBDA]). For more information, see \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_develop-rules.html}Config \
         Custom Rules } in the {i Config developer guide}.\n\
        \  "]
}
[@@ocaml.doc
...
[@@ocaml.doc
  "The configuration object for Config rule evaluation mode. The supported valid values are \
...
type nonrec config_rule = {
  evaluation_modes : evaluation_modes option;
      [@ocaml.doc
        "The modes the Config rule can be evaluated in. The valid values are distinct objects. By \
         default, the value is Detective evaluation mode only.\n"]
  created_by : string_with_char_limit256 option;
      [@ocaml.doc
  ...
  config_rule_state : config_rule_state option;
      [@ocaml.doc
        "Indicates whether the Config rule is active or is currently being deleted by Config. It \
         can also indicate the evaluation status for the Config rule.\n\n\
        ...
        \   Config temporarily sets the state of a rule to [DELETING] after you use the \
         [DeleteConfigRule] request to delete the rule. After Config deletes the rule, the rule \
         and all of its evaluations are erased and are no longer available.\n\
        \   "]
  maximum_execution_frequency : maximum_execution_frequency option;
      [@ocaml.doc
        "The maximum frequency with which Config runs evaluations for a rule. You can specify a \
         value for [MaximumExecutionFrequency] when:\n\n\
        \ {ul\n\
        \       {-  This is for an Config managed rule that is triggered at a periodic frequency.\n\
        \           \n\
        \            }\n\
        \       {-  Your custom rule is triggered when Config delivers the configuration snapshot. \
  ...
  input_parameters : string_with_char_limit1024 option;
      [@ocaml.doc "A string, in JSON format, that is passed to the Config rule Lambda function.\n"]
  source : source;
      [@ocaml.doc
        "Provides the rule owner ([Amazon Web Services] for managed rules, [CUSTOM_POLICY] for \
         Custom Policy rules, and [CUSTOM_LAMBDA] for Custom Lambda rules), the rule identifier, \
  ...
  config_rule_name : config_rule_name option;
      [@ocaml.doc
        "The name that you assign to the Config rule. The name is required if you are adding a new \
         rule.\n"]
}
[@@ocaml.doc
  "Config rules evaluate the configuration settings of your Amazon Web Services resources. A rule \
   can run when Config detects a configuration change to an Amazon Web Services resource or at a \
   periodic frequency that you choose (for example, every 24 hours). There are two types of rules: \
   {i Config Managed Rules} and {i Config Custom Rules}.\n\n\
  ...
  \   For more information about developing and using Config rules, see \
   ...
   Resource with Config Rules} in the {i Config Developer Guide}.\n\
  \   \n\
  \     You can use the Amazon Web Services CLI and Amazon Web Services SDKs if you want to create \
   a rule that triggers evaluations for your resources when Config delivers the configuration \
...
type nonrec put_config_rule_request = {
  tags : tags_list option; [@ocaml.doc "An array of tag object.\n"]
  config_rule : config_rule; [@ocaml.doc "The rule that you want to add to your account.\n"]
}
[@@ocaml.doc ""]

type nonrec aggregation_authorization = {
  creation_time : date option;
      [@ocaml.doc "The time stamp when the aggregation authorization was created.\n"]
  ...
  authorized_account_id : account_id option;
      [@ocaml.doc "The 12-digit account ID of the account authorized to aggregate data.\n"]
  aggregation_authorization_arn : string_ option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the aggregation object.\n"]
}
[@@ocaml.doc
  ...
  next_token : string_ option;
      [@ocaml.doc
        "If the previous paginated request didn't return all of the remaining results, the \
         ...
         of results, call this operation again and assign that token to the request object's \
...
type nonrec list_stored_queries_request = {
  max_results : limit option;
      [@ocaml.doc "The maximum number of results to be returned with a single call.\n"]
  next_token : string_ option;
      [@ocaml.doc
        "The nextToken string returned in a previous request that you use to request the next page \
         of results in a paginated response.\n"]
...
type nonrec resource_evaluation = {
  evaluation_start_timestamp : date option; [@ocaml.doc "The starting time of an execution.\n"]
  evaluation_mode : evaluation_mode option;
      [@ocaml.doc "The mode of an evaluation. The valid values are Detective or Proactive.\n"]
  resource_evaluation_id : resource_evaluation_id option;
      [@ocaml.doc "The ResourceEvaluationId of a evaluation.\n"]
}
[@@ocaml.doc "Returns details of a resource evaluation.\n"]
...
type nonrec resource_evaluation_filters = {
  ...
  time_window : time_window option; [@ocaml.doc "Returns a [TimeWindow] object.\n"]
  evaluation_mode : evaluation_mode option;
      [@ocaml.doc
...
[@@ocaml.doc "Returns details of a resource evaluation based on the selected filter.\n"]
...
type nonrec list_resource_evaluations_request = {
  ...
  limit : list_resource_evaluations_page_item_limit option;
      [@ocaml.doc
        "The maximum number of evaluations returned on each page. The default is 10. You cannot \
...
[@@ocaml.doc
  "The details that identify a resource that is discovered by Config, including the resource type, \
...
type nonrec list_discovered_resources_request = {
  ...
  resource_name : resource_name option;
      [@ocaml.doc
        "The custom name of only those resources that you want Config to list in the response. If \
         you do not specify this parameter, Config lists all resources of the specified type that \
         it has discovered.\n"]
  resource_ids : resource_id_list option;
      [@ocaml.doc
        "The IDs of only those resources that you want Config to list in the response. If you do \
         not specify this parameter, Config lists all resources of the specified type that it has \
         discovered. You can list a minimum of 1 resourceID and a maximum of 20 resourceIds.\n"]
  resource_type : resource_type;
      [@ocaml.doc "The type of resources that you want Config to list in the response.\n"]
}
[@@ocaml.doc "\n"]
...
type nonrec conformance_pack_compliance_score = {
  last_updated_time : last_updated_time option;
      [@ocaml.doc "The time that the conformance pack compliance score was last updated.\n"]
...
[@@ocaml.doc
  "A compliance score is the percentage of the number of compliant rule-resource combinations in a \
   ...
   conformance pack. This metric provides you with a high-level view of the compliance state of \
   your conformance packs. You can use it to identify, investigate, and understand the level of \
   compliance in your conformance packs.\n"]

type nonrec conformance_pack_compliance_scores = conformance_pack_compliance_score list
[@@ocaml.doc ""]
...
type nonrec list_conformance_pack_compliance_scores_response = {
  ...
  next_token : next_token option;
      [@ocaml.doc
        "The [nextToken] string that you can use to get the next page of results in a paginated \
         response.\n"]
}
[@@ocaml.doc ""]

type nonrec conformance_pack_name_filter = conformance_pack_name list [@@ocaml.doc ""]

type nonrec conformance_pack_compliance_scores_filters = {
  conformance_pack_names : conformance_pack_name_filter;
      [@ocaml.doc
        "The names of the conformance packs whose compliance scores you want to include in the \
         conformance pack compliance score result set. You can include up to 25 conformance packs \
         in the [ConformancePackNames] array of strings, each with a character limit of 256 \
         characters for the conformance pack name.\n"]
}
[@@ocaml.doc "A list of filters to apply to the conformance pack compliance score result set. \n"]

type nonrec sort_order = DESCENDING [@ocaml.doc ""] | ASCENDING [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec sort_by = SCORE [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec list_conformance_pack_compliance_scores_request = {
  next_token : next_token option;
      [@ocaml.doc
        "The [nextToken] string in a prior request that you can use to get the paginated response \
  ...
  sort_by : sort_by option;
      [@ocaml.doc
        "Sorts your conformance pack compliance scores in either ascending or descending order, \
         depending on [SortOrder].\n\n\
        \ By default, conformance pack compliance scores are sorted in alphabetical order by name \
         of the conformance pack. Enter [SCORE], to sort conformance pack compliance scores by the \
         numerical value of the compliance score.\n\
        \ "]
  sort_order : sort_order option;
      [@ocaml.doc
        "Determines the order in which conformance pack compliance scores are sorted. Either in \
        ...
        \  You can sort conformance pack compliance scores by the numerical value of the \
         ...
         sorted by [SCORE], conformance packs with a compliance score of [INSUFFICIENT_DATA] will \
  ...
  filters : conformance_pack_compliance_scores_filters option;
      [@ocaml.doc "Filters the results based on the [ConformancePackComplianceScoresFilters].\n"]
}
[@@ocaml.doc ""]
...
type nonrec configuration_recorder_summary = {
  recording_scope : recording_scope;
      [@ocaml.doc
        "Indicates whether the \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_ConfigurationItem.html}ConfigurationItems} \
         in scope for the configuration recorder are recorded for free ([INTERNAL]) or if you are \
         charged a service fee for recording ([PAID]).\n"]
  service_principal : service_principal option;
      [@ocaml.doc
  ...
  name : recorder_name; [@ocaml.doc "The name of the configuration recorder.\n"]
  arn : amazon_resource_name;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the configuration recorder.\n"]
}
[@@ocaml.doc
  "A summary of a configuration recorder, including the [arn], [name], [servicePrincipal], and \
   [recordingScope].\n"]

type nonrec configuration_recorder_summaries = configuration_recorder_summary list [@@ocaml.doc ""]
...
type nonrec list_configuration_recorders_response = {
  ...
  configuration_recorder_summaries : configuration_recorder_summaries;
      [@ocaml.doc "A list of [ConfigurationRecorderSummary] objects that includes.\n"]
}
[@@ocaml.doc ""]

type nonrec configuration_recorder_filter_name = RecordingScope [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec configuration_recorder_filter_value = string [@@ocaml.doc ""]

type nonrec configuration_recorder_filter_values = configuration_recorder_filter_value list
[@@ocaml.doc ""]

type nonrec configuration_recorder_filter = {
  filter_value : configuration_recorder_filter_values option;
      [@ocaml.doc
        "The value of the filter. For [recordingScope], valid values include: [INTERNAL] and \
         [PAID].\n\n\
...
type nonrec configuration_recorder_filter_list = configuration_recorder_filter list [@@ocaml.doc ""]
...
type nonrec list_configuration_recorders_request = {
  ...
  max_results : max_results option;
      [@ocaml.doc "The maximum number of results to include in the response.\n"]
  filters : configuration_recorder_filter_list option;
      [@ocaml.doc
        "Filters the results based on a list of [ConfigurationRecorderFilter] objects that you \
         specify.\n"]
}
[@@ocaml.doc ""]

type nonrec discovered_resource_identifier_list = aggregate_resource_identifier list
[@@ocaml.doc ""]
...
type nonrec resource_filters = {
  ...
  resource_name : resource_name option; [@ocaml.doc "The name of the resource.\n"]
  resource_id : resource_id option; [@ocaml.doc "The ID of the resource.\n"]
  account_id : account_id option; [@ocaml.doc "The 12-digit source account ID.\n"]
}
[@@ocaml.doc
...
type nonrec list_aggregate_discovered_resources_request = {
  ...
  limit : limit option;
      [@ocaml.doc
        "The maximum number of resource identifiers returned on each page. You cannot specify a \
         number greater than 100. If you specify 0, Config uses the default.\n"]
  filters : resource_filters option;
      [@ocaml.doc "Filters the results based on the [ResourceFilters] object.\n"]
  resource_type : resource_type;
      [@ocaml.doc "The type of resources that you want Config to list in the response.\n"]
  configuration_aggregator_name : configuration_aggregator_name;
      [@ocaml.doc "The name of the configuration aggregator. \n"]
...
type nonrec get_stored_query_response = {
  stored_query : stored_query option; [@ocaml.doc "Returns a [StoredQuery] object.\n"]
}
[@@ocaml.doc ""]
...
type nonrec get_resource_evaluation_summary_response = {
  resource_details : resource_details option; [@ocaml.doc "Returns a [ResourceDetails] object.\n"]
  evaluation_context : evaluation_context option;
      [@ocaml.doc "Returns an [EvaluationContext] object.\n"]
  compliance : compliance_type option;
      [@ocaml.doc "The compliance status of the resource evaluation summary.\n"]
  ...
  resource_evaluation_id : resource_evaluation_id option;
      [@ocaml.doc
        "The unique [ResourceEvaluationId] of Amazon Web Services resource execution for which you \
...
[@@ocaml.doc "You have specified a resource that is either unknown or has not been discovered.\n"]

type nonrec configuration_item_capture_time = Smaws_Lib.CoreTypes.Timestamp.t [@@ocaml.doc ""]
...
type nonrec relationship = {
  ...
  resource_id : resource_id option;
      [@ocaml.doc "The ID of the related resource (for example, [sg-xxxxxx]).\n"]
  resource_type : resource_type option; [@ocaml.doc "The resource type of the related resource.\n"]
}
[@@ocaml.doc "The relationship of the related resource to the main resource.\n"]

type nonrec relationship_list = relationship list [@@ocaml.doc ""]

type nonrec configuration_item_delivery_time = Smaws_Lib.CoreTypes.Timestamp.t [@@ocaml.doc ""]
...
type nonrec configuration_item = {
  ...
  related_events : related_event_list option;
      [@ocaml.doc
        ...
        \ A populated field indicates that the current configuration was initiated by the events \
         recorded in the CloudTrail log. For more information about CloudTrail, see \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/what_is_cloud_trail_top_level.html}What \
         Is CloudTrail}.\n\
        \ \n\
        \  An empty field indicates that the current configuration was not initiated by any event. \
         As of Version 1.3, the relatedEvents field is empty. You can access the \
         {{:https://docs.aws.amazon.com/awscloudtrail/latest/APIReference/API_LookupEvents.html}LookupEvents \
         API} in the {i CloudTrail API Reference} to retrieve the events for the resource.\n\
        \  "]
  tags : tags option; [@ocaml.doc "A mapping of key value tags associated with the resource.\n"]
  ...
  aws_region : aws_region option; [@ocaml.doc "The region where the resource resides.\n"]
  resource_name : resource_name option;
      [@ocaml.doc "The custom name of the resource, if available.\n"]
  resource_id : resource_id option;
      [@ocaml.doc "The ID of the resource (for example, [sg-xxxxxx]).\n"]
  resource_type : resource_type option; [@ocaml.doc "The type of Amazon Web Services resource.\n"]
  arn : ar_n option; [@ocaml.doc "Amazon Resource Name (ARN) associated with the resource.\n"]
  ...
  configuration_item_status : configuration_item_status option;
      [@ocaml.doc
        ...
        \           \n\
        \            }\n\
        \       {-  ResourceNotRecorded \226\128\147 The resource was discovered but its \
         configuration was not recorded since the recorder doesn't record resources of this type\n\
        \           \n\
        \            }\n\
        \       {-  ResourceDeleted \226\128\147 The resource was deleted\n\
        \           \n\
        \            }\n\
        \       {-  ResourceDeletedNotRecorded \226\128\147 The resource was deleted but its \
         configuration was not recorded since the recorder doesn't record resources of this type\n\
        \           \n\
        \            }\n\
        \       }\n\
  ...
  account_id : account_id option;
      [@ocaml.doc "The 12-digit Amazon Web Services account ID associated with the resource.\n"]
  version : version option; [@ocaml.doc "The version number of the resource configuration.\n"]
}
[@@ocaml.doc "A list that contains detailed configurations of a specified resource.\n"]
...
type nonrec chronological_order = Forward [@ocaml.doc ""] | Reverse [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec get_resource_config_history_request = {
  ...
  limit : limit option;
      [@ocaml.doc
        "The maximum number of configuration items returned on each page. The default is 10. You \
         cannot specify a number greater than 100. If you specify 0, Config uses the default.\n"]
  ...
  earlier_time : earlier_time option;
      [@ocaml.doc
        "The chronologically earliest time in the time range for which the history requested. If \
         not specified, the action returns paginated results that contain configuration items that \
         start when the first configuration item was recorded.\n"]
  later_time : later_time option;
      [@ocaml.doc
        "The chronologically latest time in the time range for which the history requested. If not \
         specified, current time is taken.\n"]
  resource_id : resource_id; [@ocaml.doc "The ID of the resource (for example., [sg-xxxxxx]).\n"]
  resource_type : resource_type; [@ocaml.doc "The resource type.\n"]
}
[@@ocaml.doc "The input for the [GetResourceConfigHistory] action.\n"]

type nonrec no_such_organization_config_rule_exception = {
  message : error_message option; [@ocaml.doc "Error executing the command\n"]
}
[@@ocaml.doc
  "The Config rule in the request is not valid. Verify that the rule is an organization Config \
   Process Check rule, that the rule name is correct, and that valid Amazon Resouce Names (ARNs) \
...
type nonrec get_organization_custom_rule_policy_request = {
  organization_config_rule_name : organization_config_rule_name;
      [@ocaml.doc "The name of your organization Config Custom Policy rule. \n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  ...
  \ For DeleteOrganizationConformancePack, you tried to delete an organization conformance pack \
   that does not exist.\n\
  \ "]
...
type nonrec organization_conformance_pack_detailed_status = {
  last_update_time : date option; [@ocaml.doc "The timestamp of the last status update.\n"]
  ...
  status : organization_resource_detailed_status;
      [@ocaml.doc
        "Indicates deployment status for conformance pack in a member account. When management \
         account calls [PutOrganizationConformancePack] action for the first time, conformance \
         pack status is created in the member account. When management account calls \
         [PutOrganizationConformancePack] action for the second time, conformance pack status is \
         updated in the member account. Conformance pack status is deleted when the management \
  ...
  conformance_pack_name : string_with_char_limit256;
      [@ocaml.doc "The name of conformance pack deployed in the member account.\n"]
  account_id : account_id; [@ocaml.doc "The 12-digit account ID of a member account.\n"]
}
[@@ocaml.doc
  "Organization conformance pack creation or deletion status in each member account. This includes \
   the name of the conformance pack, the status, error code and error message when the conformance \
   pack creation or deletion failed. \n"]
...
type nonrec get_organization_conformance_pack_detailed_status_response = {
  ...
  organization_conformance_pack_detailed_statuses :
    organization_conformance_pack_detailed_statuses option;
      [@ocaml.doc "A list of [OrganizationConformancePackDetailedStatus] objects. \n"]
}
[@@ocaml.doc ""]
...
type nonrec get_organization_conformance_pack_detailed_status_request = {
  ...
  limit : cosmos_page_limit option;
      [@ocaml.doc
        "The maximum number of [OrganizationConformancePackDetailedStatuses] returned on each \
...
type nonrec organization_config_rule_detailed_status = member_account_status list [@@ocaml.doc ""]
...
type nonrec get_organization_config_rule_detailed_status_response = {
  next_token : string_ option;
      [@ocaml.doc
        "The [nextToken] string returned on a previous page that you use to get the next page of \
         results in a paginated response. \n"]
  organization_config_rule_detailed_status : organization_config_rule_detailed_status option;
...
type nonrec get_organization_config_rule_detailed_status_request = {
  ...
  limit : cosmos_page_limit option;
      [@ocaml.doc
        "The maximum number of [OrganizationConfigRuleDetailedStatus] returned on each page. If \
         you do not specify a number, Config uses the default. The default is 100.\n"]
  filters : status_detail_filters option; [@ocaml.doc "A [StatusDetailFilters] object.\n"]
  organization_config_rule_name : organization_config_rule_name;
      [@ocaml.doc
...
type nonrec resource_count = {
  ...
  resource_type : resource_type option;
      [@ocaml.doc "The resource type (for example, [\"AWS::EC2::Instance\"]).\n"]
}
[@@ocaml.doc "An object that contains the resource type and the number of resources.\n"]
...
type nonrec get_discovered_resource_counts_response = {
  ...
  total_discovered_resources : long option;
      [@ocaml.doc
        "The total number of resources that Config is recording in the region for your account. If \
         you specify resource types in the request, Config returns only the total number of \
         resources for those resource types.\n\n\
        \  {b Example} \n\
        \ \n\
        \  {ol\n\
        \        {-  Config is recording three resource types in the US East (Ohio) Region for \
         your account: 25 EC2 instances, 20 IAM users, and 15 S3 buckets, for a total of 60 \
         resources.\n\
        \            \n\
        \             }\n\
...
type nonrec get_discovered_resource_counts_request = {
  ...
  limit : limit option;
      [@ocaml.doc
        "The maximum number of [ResourceCount] objects returned on each page. The default is 100. \
  ...
  resource_types : resource_types option;
      [@ocaml.doc
        "The comma-separated list that specifies the resource types that you want Config to return \
         (for example, [\"AWS::EC2::Instance\"], [\"AWS::IAM::User\"]).\n\n\
        \ If a value for [resourceTypes] is not specified, Config returns all resource types that \
        ...
        \   If the configuration recorder is turned off, Config returns an empty list of \
         ...
         resource type (for example, S3 buckets), that resource type is not returned in the list \
         of [ResourceCount] objects.\n\
        \   \n\
        \    "]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "You specified one or more conformance packs that do not exist.\n"]
...
[@@ocaml.doc "Summary includes the name and status of the conformance pack.\n"]

type nonrec conformance_pack_compliance_summary_list = conformance_pack_compliance_summary list
[@@ocaml.doc ""]
...
type nonrec get_conformance_pack_compliance_summary_response = {
  next_token : next_token option;
      [@ocaml.doc
        "The nextToken string returned on a previous page that you use to get the next page of \
         results in a paginated response.\n"]
  conformance_pack_compliance_summary_list : conformance_pack_compliance_summary_list option;
      [@ocaml.doc "A list of [ConformancePackComplianceSummary] objects. \n"]
}
[@@ocaml.doc ""]

type nonrec conformance_pack_names_to_summarize_list = conformance_pack_name list [@@ocaml.doc ""]
  ...
  next_token : next_token option;
      [@ocaml.doc
        "The nextToken string returned on a previous page that you use to get the next page of \
         results in a paginated response.\n"]
  limit : page_size_limit option;
      [@ocaml.doc "The maximum number of conformance packs returned on each page.\n"]
...
type nonrec evaluation_result_qualifier = {
  ...
  resource_type : string_with_char_limit256 option;
      [@ocaml.doc "The type of Amazon Web Services resource that was evaluated.\n"]
  config_rule_name : config_rule_name option;
      [@ocaml.doc "The name of the Config rule that was used in the evaluation.\n"]
}
[@@ocaml.doc
  "Identifies an Config rule that evaluated an Amazon Web Services resource, and provides the type \
  ...
  ordering_timestamp : date option;
      [@ocaml.doc
        "The time of the event that triggered the evaluation of your Amazon Web Services \
         resources. The time can indicate when Config delivered a configuration item change \
         notification, or it can indicate when Config delivered the configuration snapshot, \
...
type nonrec conformance_pack_evaluation_result = {
  ...
  config_rule_invoked_time : date;
      [@ocaml.doc "The time when Config rule evaluated Amazon Web Services resource.\n"]
...
[@@ocaml.doc
  "The details of a conformance pack evaluation. Provides Config rule and Amazon Web Services \
   resource type that was evaluated, the compliance of the conformance pack, related time stamps, \
   and supplementary information. \n"]

type nonrec conformance_pack_rule_evaluation_results_list = conformance_pack_evaluation_result list
[@@ocaml.doc ""]
...
type nonrec get_conformance_pack_compliance_details_response = {
  next_token : next_token option;
      [@ocaml.doc
        "The [nextToken] string returned in a previous request that you use to request the next \
         page of results in a paginated response.\n"]
  conformance_pack_rule_evaluation_results : conformance_pack_rule_evaluation_results_list option;
      [@ocaml.doc "Returns a list of [ConformancePackEvaluationResult] objects.\n"]
  conformance_pack_name : conformance_pack_name; [@ocaml.doc "Name of the conformance pack.\n"]
}
[@@ocaml.doc ""]

type nonrec conformance_pack_config_rule_names = string_with_char_limit64 list [@@ocaml.doc ""]

type nonrec conformance_pack_compliance_resource_ids = string_with_char_limit256 list
[@@ocaml.doc ""]
...
type nonrec get_conformance_pack_compliance_details_request = {
  ...
  limit : get_conformance_pack_compliance_details_limit option;
      [@ocaml.doc
        "The maximum number of evaluation results returned on each page. If you do no specify a \
...
type nonrec compliance_contributor_count = {
  cap_exceeded : boolean_ option; [@ocaml.doc "Indicates whether the maximum count is reached.\n"]
...
type nonrec compliance_summary = {
  ...
  non_compliant_resource_count : compliance_contributor_count option;
      [@ocaml.doc
        "The number of Config rules or Amazon Web Services resources that are noncompliant, up to \
         a maximum of 25 for rules and 100 for resources.\n"]
  compliant_resource_count : compliance_contributor_count option;
      [@ocaml.doc
        "The number of Config rules or Amazon Web Services resources that are compliant, up to a \
...
type nonrec compliance_summary_by_resource_type = {
  compliance_summary : compliance_summary option;
      [@ocaml.doc
        "The number of Amazon Web Services resources that are compliant or noncompliant, up to a \
         maximum of 100 for each.\n"]
  resource_type : string_with_char_limit256 option;
      [@ocaml.doc "The type of Amazon Web Services resource.\n"]
}
[@@ocaml.doc
  "The number of Amazon Web Services resources of a specific type that are compliant or \
   noncompliant, up to a maximum of 100 for each.\n"]

type nonrec compliance_summaries_by_resource_type = compliance_summary_by_resource_type list
[@@ocaml.doc ""]

type nonrec get_compliance_summary_by_resource_type_response = {
  compliance_summaries_by_resource_type : compliance_summaries_by_resource_type option;
      [@ocaml.doc
        "The number of resources that are compliant and the number that are noncompliant. If one \
         or more resource types were provided with the request, the numbers are returned for each \
...
type nonrec get_compliance_summary_by_resource_type_request = {
  resource_types : resource_types option;
      [@ocaml.doc
        "Specify one or more resource types to get the number of resources that are compliant and \
         the number that are noncompliant for each resource type.\n\n\
        \ For this request, you can specify an Amazon Web Services resource type such as \
         [AWS::EC2::Instance]. You can specify that the resource type is an Amazon Web Services \
...
type nonrec get_compliance_summary_by_config_rule_response = {
  compliance_summary : compliance_summary option;
      [@ocaml.doc
        "The number of Config rules that are compliant and the number that are noncompliant, up to \
  ...
  result_token : string_ option;
      [@ocaml.doc
        "An encrypted token that associates an evaluation with an Config rule. The token \
         identifies the rule, the Amazon Web Services resource being evaluated, and the event that \
         triggered the evaluation.\n"]
  annotation : string_with_char_limit256 option;
      [@ocaml.doc "Supplementary information about how the evaluation determined the compliance.\n"]
  config_rule_invoked_time : date option;
      [@ocaml.doc "The time when the Config rule evaluated the Amazon Web Services resource.\n"]
...
[@@ocaml.doc
  "The details of an Config evaluation. Provides the Amazon Web Services resource that was \
   evaluated, the compliance of the resource, related time stamps, and supplementary information.\n"]
...
type nonrec get_compliance_details_by_config_rule_request = {
  ...
  compliance_types : compliance_types option;
      [@ocaml.doc
        ...
        \ "]
  config_rule_name : string_with_char_limit64;
      [@ocaml.doc "The name of the Config rule for which you want compliance information.\n"]
}
[@@ocaml.doc "\n"]
...
type nonrec grouped_resource_count_list = grouped_resource_count list [@@ocaml.doc ""]
...
type nonrec get_aggregate_discovered_resource_counts_response = {
  ...
  group_by_key : string_with_char_limit256 option;
      [@ocaml.doc
        "The key passed into the request object. If [GroupByKey] is not provided, the result will \
         be empty.\n"]
...
type nonrec resource_count_filters = {
  region : aws_region option; [@ocaml.doc "The region where the account is located.\n"]
  account_id : account_id option; [@ocaml.doc "The 12-digit ID of the account.\n"]
  resource_type : resource_type option;
      [@ocaml.doc "The type of the Amazon Web Services resource.\n"]
}
[@@ocaml.doc "Filters the resource count based on account ID, region, and resource type.\n"]
...
type nonrec get_aggregate_discovered_resource_counts_request = {
  ...
  limit : group_by_api_limit option;
      [@ocaml.doc
        "The maximum number of [GroupedResourceCount] objects returned on each page. The default \
         is 1000. You cannot specify a number greater than 1000. If you specify 0, Config uses the \
         default.\n"]
  ...
  filters : resource_count_filters option;
      [@ocaml.doc "Filters the results based on the [ResourceCountFilters] object.\n"]
  configuration_aggregator_name : configuration_aggregator_name;
      [@ocaml.doc "The name of the configuration aggregator.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "The number of conformance packs that are compliant and noncompliant.\n"]
...
type nonrec aggregate_conformance_pack_compliance_summary = {
  ...
  compliance_summary : aggregate_conformance_pack_compliance_count option;
      [@ocaml.doc "Returns an [AggregateConformancePackComplianceCount] object. \n"]
}
[@@ocaml.doc "Provides a summary of compliance based on either account ID or region. \n"]
...
type nonrec get_aggregate_conformance_pack_compliance_summary_response = {
  ...
  aggregate_conformance_pack_compliance_summaries :
    aggregate_conformance_pack_compliance_summary_list option;
      [@ocaml.doc "Returns a list of [AggregateConformancePackComplianceSummary] object.\n"]
}
[@@ocaml.doc ""]

type nonrec aggregate_conformance_pack_compliance_summary_filters = {
  aws_region : aws_region option;
      [@ocaml.doc "The source Amazon Web Services Region from where the data is aggregated.\n"]
  account_id : account_id option;
      [@ocaml.doc "The 12-digit Amazon Web Services account ID of the source account.\n"]
}
...
type nonrec aggregate_compliance_count = {
  ...
  group_name : string_with_char_limit256 option;
      [@ocaml.doc "The 12-digit account ID or region based on the GroupByKey value.\n"]
}
[@@ocaml.doc
  "Returns the number of compliant and noncompliant rules for one or more accounts and regions in \
   an aggregator.\n"]

type nonrec aggregate_compliance_count_list = aggregate_compliance_count list [@@ocaml.doc ""]
...
type nonrec config_rule_compliance_summary_filters = {
  aws_region : aws_region option; [@ocaml.doc "The source region where the data is aggregated.\n"]
  account_id : account_id option; [@ocaml.doc "The 12-digit account ID of the source account.\n"]
}
[@@ocaml.doc "Filters the results based on the account IDs and regions.\n"]
...
type nonrec get_aggregate_config_rule_compliance_summary_request = {
  ...
  limit : group_by_api_limit option;
      [@ocaml.doc
        "The maximum number of evaluation results returned on each page. The default is 1000. You \
  ...
  filters : config_rule_compliance_summary_filters option;
      [@ocaml.doc "Filters the results based on the ConfigRuleComplianceSummaryFilters object.\n"]
  configuration_aggregator_name : configuration_aggregator_name;
      [@ocaml.doc "The name of the configuration aggregator.\n"]
}
[@@ocaml.doc ""]
...
type nonrec aggregate_evaluation_result = {
  ...
  config_rule_invoked_time : date option;
      [@ocaml.doc "The time when the Config rule evaluated the Amazon Web Services resource.\n"]
  result_recorded_time : date option;
      [@ocaml.doc "The time when Config recorded the aggregate evaluation result.\n"]
  compliance_type : compliance_type option;
      [@ocaml.doc
...
type nonrec aggregate_evaluation_result_list = aggregate_evaluation_result list [@@ocaml.doc ""]
...
type nonrec get_aggregate_compliance_details_by_config_rule_request = {
  ...
  compliance_type : compliance_type option;
      [@ocaml.doc
        ...
        \  \n\
        \   "]
  aws_region : aws_region; [@ocaml.doc "The source region from where the data is aggregated.\n"]
  account_id : account_id; [@ocaml.doc "The 12-digit account ID of the source account.\n"]
  config_rule_name : config_rule_name;
      [@ocaml.doc "The name of the Config rule for which you want compliance information.\n"]
  configuration_aggregator_name : configuration_aggregator_name;
      [@ocaml.doc "The name of the configuration aggregator.\n"]
...
[@@ocaml.doc "You have specified a retention configuration that does not exist.\n"]

type nonrec retention_configuration_list = retention_configuration list [@@ocaml.doc ""]
...
type nonrec retention_configuration_name_list = retention_configuration_name list [@@ocaml.doc ""]
  ...
  retention_configuration_names : retention_configuration_name_list option;
      [@ocaml.doc
        "A list of names of retention configurations for which you want details. If you do not \
         specify a name, Config returns details for all the retention configurations for that \
         account.\n\n\
...
type nonrec remediation_execution_step = {
  ...
  error_message : string_ option;
      [@ocaml.doc "An error message if the step was interrupted during execution.\n"]
  state : remediation_execution_step_state option; [@ocaml.doc "The valid status of the step.\n"]
  name : string_ option; [@ocaml.doc "The details of the step.\n"]
}
[@@ocaml.doc "Name of the step from the SSM document.\n"]

type nonrec remediation_execution_steps = remediation_execution_step list [@@ocaml.doc ""]

type nonrec remediation_execution_status = {
  last_updated_time : date option;
      [@ocaml.doc "The time when the remediation execution was last updated.\n"]
  invocation_time : date option; [@ocaml.doc "Start time when the remediation was executed.\n"]
  step_details : remediation_execution_steps option; [@ocaml.doc "Details of every step.\n"]
  state : remediation_execution_state option; [@ocaml.doc "ENUM of the values.\n"]
  resource_key : resource_key option; [@ocaml.doc ""]
}
[@@ocaml.doc
  "Provides details of the current status of the invoked remediation action for that resource.\n"]

type nonrec remediation_execution_statuses = remediation_execution_status list [@@ocaml.doc ""]
...
type nonrec describe_remediation_execution_status_response = {
  ...
  remediation_execution_statuses : remediation_execution_statuses option;
      [@ocaml.doc "Returns a list of remediation execution statuses objects.\n"]
}
[@@ocaml.doc ""]
...
type nonrec describe_remediation_execution_status_request = {
  ...
  limit : limit option;
      [@ocaml.doc
        "The maximum number of RemediationExecutionStatuses returned on each page. The default is \
...
type nonrec pending_aggregation_request = {
  ...
  requester_account_id : account_id option;
      [@ocaml.doc "The 12-digit account ID of the account requesting to aggregate data.\n"]
}
[@@ocaml.doc
...
type nonrec pending_aggregation_request_list = pending_aggregation_request list [@@ocaml.doc ""]
...
type nonrec organization_conformance_pack_status = {
  last_update_time : date option; [@ocaml.doc "The timestamp of the last update.\n"]
  error_message : string_ option;
      [@ocaml.doc
  ...
  status : organization_resource_status;
      [@ocaml.doc
        "Indicates deployment status of an organization conformance pack. When management account \
         ...
         created in all the member accounts. When management account calls \
         ...
         when the management account deletes OrganizationConformancePack in all the member \
        ...
        \  "]
  organization_conformance_pack_name : organization_conformance_pack_name;
      [@ocaml.doc "The name that you assign to organization conformance pack.\n"]
}
[@@ocaml.doc "Returns the status for an organization conformance pack in an organization.\n"]

type nonrec organization_conformance_pack_statuses = organization_conformance_pack_status list
[@@ocaml.doc ""]
...
type nonrec describe_organization_conformance_pack_statuses_response = {
  next_token : string_ option;
      [@ocaml.doc
        "The nextToken string returned on a previous page that you use to get the next page of \
         results in a paginated response. \n"]
  organization_conformance_pack_statuses : organization_conformance_pack_statuses option;
      [@ocaml.doc "A list of [OrganizationConformancePackStatus] objects. \n"]
}
[@@ocaml.doc ""]

type nonrec organization_conformance_pack_names = organization_conformance_pack_name list
[@@ocaml.doc ""]
...
type nonrec describe_organization_conformance_pack_statuses_request = {
  ...
  limit : cosmos_page_limit option;
      [@ocaml.doc
        "The maximum number of OrganizationConformancePackStatuses returned on each page. If you \
         do no specify a number, Config uses the default. The default is 100. \n"]
  organization_conformance_pack_names : organization_conformance_pack_names option;
      [@ocaml.doc
        "The names of organization conformance packs for which you want status details. If you do \
         not specify any names, Config returns details for all your organization conformance \
         packs. \n"]
}
[@@ocaml.doc ""]
...
type nonrec organization_conformance_pack = {
  last_update_time : date;
      [@ocaml.doc "Last time when organization conformation pack was updated.\n"]
  excluded_accounts : excluded_accounts option;
      [@ocaml.doc
  ...
  organization_conformance_pack_arn : string_with_char_limit256;
      [@ocaml.doc "Amazon Resource Name (ARN) of organization conformance pack.\n"]
  organization_conformance_pack_name : organization_conformance_pack_name;
      [@ocaml.doc "The name you assign to an organization conformance pack.\n"]
}
[@@ocaml.doc
  "An organization conformance pack that has information about conformance packs that Config \
   creates in member accounts. \n"]

type nonrec organization_conformance_packs = organization_conformance_pack list [@@ocaml.doc ""]
...
type nonrec describe_organization_conformance_packs_request = {
  ...
  organization_conformance_pack_names : organization_conformance_pack_names option;
      [@ocaml.doc "The name that you assign to an organization conformance pack.\n"]
}
[@@ocaml.doc ""]
  ...
  organization_rule_status : organization_rule_status;
      [@ocaml.doc
        "Indicates deployment status of an organization Config rule. When management account calls \
         ...
         the member accounts. When management account calls PutOrganizationConfigRule action for \
         the second time, Config rule status is updated in all the member accounts. Additionally, \
         Config rule status is updated when one or more member accounts join or leave an \
         organization. Config rule status is deleted when the management account deletes \
...
[@@ocaml.doc "Returns the status for an organization Config rule in an organization.\n"]

type nonrec organization_config_rule_statuses = organization_config_rule_status list
[@@ocaml.doc ""]
...
type nonrec organization_config_rule_names = string_with_char_limit64 list [@@ocaml.doc ""]
...
type nonrec describe_organization_config_rule_statuses_request = {
  ...
  limit : cosmos_page_limit option;
      [@ocaml.doc
        "The maximum number of [OrganizationConfigRuleStatuses] returned on each page. If you do \
  ...
  organization_config_rule_names : organization_config_rule_names option;
      [@ocaml.doc
        "The names of organization Config rules for which you want status details. If you do not \
         specify any names, Config returns details for all your organization Config rules.\n"]
}
[@@ocaml.doc ""]
...
type nonrec organization_custom_policy_rule_metadata_no_policy = {
  ...
  organization_config_rule_trigger_types : organization_config_rule_trigger_type_no_s_ns option;
      [@ocaml.doc
        "The type of notification that triggers Config to run an evaluation for a rule. For Config \
         Custom Policy rules, Config supports change triggered notification types:\n\n\
        \ {ul\n\
        \       {-   [ConfigurationItemChangeNotification] - Triggers an evaluation when Config \
         delivers a configuration item as a result of a resource change.\n\
        \           \n\
...
[@@ocaml.doc
  " metadata for your organization Config Custom Policy rule including the runtime system in use, \
   which accounts have debug logging enabled, and other custom rule metadata such as resource \
   type, resource ID of Amazon Web Services resource, and organization trigger types that trigger \
...
type nonrec organization_config_rule = {
  organization_custom_policy_rule_metadata :
    organization_custom_policy_rule_metadata_no_policy option;
      [@ocaml.doc
        "An object that specifies metadata for your organization's Config Custom Policy rule. The \
         metadata includes the runtime system in use, which accounts have debug logging enabled, \
         and other custom rule metadata, such as resource type, resource ID of Amazon Web Services \
         resource, and organization trigger types that initiate Config to evaluate Amazon Web \
         Services resources against a rule.\n"]
  last_update_time : date option; [@ocaml.doc "The timestamp of the last update.\n"]
  excluded_accounts : excluded_accounts option;
      [@ocaml.doc "A comma-separated list of accounts excluded from organization Config rule.\n"]
  organization_custom_rule_metadata : organization_custom_rule_metadata option;
...
[@@ocaml.doc
  "An organization Config rule that has information about Config rules that Config creates in \
   member accounts.\n"]

type nonrec organization_config_rules = organization_config_rule list [@@ocaml.doc ""]
...
type nonrec config_export_delivery_info = {
  next_delivery_time : date option; [@ocaml.doc "The time that the next delivery occurs.\n"]
  last_successful_time : date option; [@ocaml.doc "The time of the last successful delivery.\n"]
  last_attempt_time : date option; [@ocaml.doc "The time of the last attempted delivery.\n"]
  ...
  last_status : delivery_status option; [@ocaml.doc "Status of the last attempted delivery.\n"]
}
[@@ocaml.doc
  "Provides status of the delivery of the snapshot or the configuration history to the specified \
   Amazon S3 bucket. Also provides the status of notifications about the Amazon S3 delivery to the \
   specified Amazon SNS topic.\n"]

type nonrec config_stream_delivery_info = {
  last_status_change_time : date option; [@ocaml.doc "The time from the last status change.\n"]
  last_error_message : string_ option;
      [@ocaml.doc "The error message from the last attempted delivery.\n"]
  last_error_code : string_ option;
      [@ocaml.doc "The error code from the last attempted delivery.\n"]
  last_status : delivery_status option;
      [@ocaml.doc
        ...
        \  {b Note} Providing an SNS topic on a \
         {{:https://docs.aws.amazon.com/config/latest/APIReference/API_DeliveryChannel.html}DeliveryChannel} \
         for Config is optional. If the SNS delivery is turned off, the last status will be {b \
         Not_Applicable}.\n\
        \ "]
}
[@@ocaml.doc
...
type nonrec delivery_channel_status_list = delivery_channel_status list [@@ocaml.doc ""]

type nonrec describe_delivery_channel_status_response = {
  delivery_channels_status : delivery_channel_status_list option;
      [@ocaml.doc "A list that contains the status of a specified delivery channel.\n"]
}
...
[@@ocaml.doc "The input for the [DeliveryChannelStatus] action.\n"]
...
type nonrec describe_delivery_channels_response = {
  delivery_channels : delivery_channel_list option;
      [@ocaml.doc "A list that contains the descriptions of the specified delivery channel.\n"]
}
...
[@@ocaml.doc "The input for the [DescribeDeliveryChannels] action.\n"]
...
type nonrec conformance_pack_status_detail = {
  last_update_completed_time : date option;
      [@ocaml.doc "Last time when conformation pack creation and update was successful.\n"]
  last_update_requested_time : date;
      [@ocaml.doc "Last time when conformation pack creation and update was requested.\n"]
  ...
  stack_arn : stack_arn; [@ocaml.doc "Amazon Resource Name (ARN) of CloudFormation stack. \n"]
  conformance_pack_state : conformance_pack_state;
      [@ocaml.doc
        ...
        \            \n\
        \             }\n\
        \        {-  CREATE_COMPLETE when a conformance pack has been successfully created in your \
         account.\n\
        \            \n\
        \             }\n\
  ...
  conformance_pack_id : conformance_pack_id; [@ocaml.doc "ID of the conformance pack.\n"]
  conformance_pack_name : conformance_pack_name; [@ocaml.doc "Name of the conformance pack.\n"]
}
[@@ocaml.doc "Status details of a conformance pack.\n"]

type nonrec conformance_pack_status_details_list = conformance_pack_status_detail list
[@@ocaml.doc ""]
...
type nonrec describe_conformance_pack_status_response = {
  next_token : next_token option;
      [@ocaml.doc
        "The [nextToken] string returned in a previous request that you use to request the next \
         page of results in a paginated response.\n"]
  conformance_pack_status_details : conformance_pack_status_details_list option;
  ...
  next_token : next_token option;
      [@ocaml.doc
        "The [nextToken] string returned in a previous request that you use to request the next \
         page of results in a paginated response.\n"]
  limit : page_size_limit option;
      [@ocaml.doc "The maximum number of conformance packs status returned on each page.\n"]
  ...
  template_ssm_document_details : template_ssm_document_details option;
      [@ocaml.doc
        "An object that contains the name or Amazon Resource Name (ARN) of the Amazon Web Services \
         Systems Manager document (SSM document) and the version of the SSM document that is used \
         to create a conformance pack.\n"]
  created_by : string_with_char_limit256 option;
      [@ocaml.doc "The Amazon Web Services service that created the conformance pack.\n"]
...
type nonrec conformance_pack_detail_list = conformance_pack_detail list [@@ocaml.doc ""]
...
type nonrec describe_conformance_packs_request = {
  ...
  conformance_pack_names : conformance_pack_names_list option;
      [@ocaml.doc
        "Comma-separated list of conformance pack names for which you want details. If you do not \
         specify any names, Config returns details for all your conformance packs. \n"]
}
[@@ocaml.doc ""]
  ...
  controls : controls_list option;
      [@ocaml.doc
        "Controls for the conformance pack. A control is a process to prevent or detect problems \
         while meeting objectives. A control can align with a specific compliance regime or map to \
         internal controls defined by an organization.\n"]
  compliance_type : conformance_pack_compliance_type option;
      [@ocaml.doc "Compliance of the Config rule.\n"]
  config_rule_name : config_rule_name option; [@ocaml.doc "Name of the Config rule.\n"]
}
[@@ocaml.doc
  "Compliance information of one or more Config rules within a conformance pack. You can filter \
   using Config rule names and compliance types.\n"]

type nonrec conformance_pack_rule_compliance_list = conformance_pack_rule_compliance list
[@@ocaml.doc ""]
...
type nonrec describe_conformance_pack_compliance_response = {
  ...
  conformance_pack_rule_compliance_list : conformance_pack_rule_compliance_list;
      [@ocaml.doc "Returns a list of [ConformancePackRuleCompliance] objects.\n"]
  conformance_pack_name : conformance_pack_name; [@ocaml.doc "Name of the conformance pack.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "Filters the conformance pack by compliance types and Config rule names.\n"]
...
type nonrec configuration_recorder_status = {
  ...
  last_error_message : string_ option;
      [@ocaml.doc "The latest error message from when the recorder last failed.\n"]
  last_error_code : string_ option;
      [@ocaml.doc "The latest error code from when the recorder last failed.\n"]
  last_status : recorder_status option;
      [@ocaml.doc "The status of the latest recording event processed by the recorder.\n"]
  recording : boolean_ option;
      [@ocaml.doc "Specifies whether or not the recorder is currently recording.\n"]
  last_stop_time : date option; [@ocaml.doc "The time the recorder was last stopped.\n"]
  last_start_time : date option; [@ocaml.doc "The time the recorder was last started.\n"]
  name : string_ option; [@ocaml.doc "The name of the configuration recorder.\n"]
  arn : amazon_resource_name option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the configuration recorder.\n"]
}
[@@ocaml.doc
...
type nonrec configuration_recorder_status_list = configuration_recorder_status list [@@ocaml.doc ""]
...
[@@ocaml.doc "The output for the [DescribeConfigurationRecorderStatus] action, in JSON format.\n"]
...
[@@ocaml.doc "The input for the [DescribeConfigurationRecorderStatus] action.\n"]

type nonrec configuration_recorder_list = configuration_recorder list [@@ocaml.doc ""]
...
type nonrec aggregated_source_type = ORGANIZATION [@ocaml.doc ""] | ACCOUNT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec aggregated_source_status = {
  ...
  last_update_status : aggregated_source_status_type option;
      [@ocaml.doc
        ...
        \       }\n\
        \  "]
  aws_region : aws_region option; [@ocaml.doc "The region authorized to collect aggregated data.\n"]
  source_type : aggregated_source_type option;
      [@ocaml.doc "The source account or an organization.\n"]
  source_id : string_ option; [@ocaml.doc "The source account ID or an organization.\n"]
}
[@@ocaml.doc "The current sync status between the source and the aggregator account.\n"]

type nonrec aggregated_source_status_list = aggregated_source_status list [@@ocaml.doc ""]
...
type nonrec aggregated_source_status_type_list = aggregated_source_status_type list [@@ocaml.doc ""]
...
type nonrec configuration_aggregator_list = configuration_aggregator list [@@ocaml.doc ""]
...
type nonrec configuration_aggregator_name_list = configuration_aggregator_name list [@@ocaml.doc ""]

type nonrec describe_configuration_aggregators_request = {
  limit : limit option;
      [@ocaml.doc
        "The maximum number of configuration aggregators returned on each page. The default is \
         maximum. If you specify 0, Config uses the default.\n"]
  next_token : string_ option;
      [@ocaml.doc
        "The [nextToken] string returned on a previous page that you use to get the next page of \
...
type nonrec describe_config_rules_response = {
  next_token : string_ option;
      [@ocaml.doc
        "The string that you use in a subsequent request to get the next page of results in a \
         paginated response.\n"]
  config_rules : config_rules option; [@ocaml.doc "The details about your Config rules.\n"]
}
[@@ocaml.doc "\n"]
...
[@@ocaml.doc
  "Returns a filtered list of Detective or Proactive Config rules. By default, if the filter is \
   not defined, this API returns an unfiltered list. For more information on Detective or \
   Proactive Config rules, see \
   {{:https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config-rules.html} {b \
   Evaluation Mode} } in the {i Config Developer Guide}.\n"]

type nonrec describe_config_rules_request = {
  filters : describe_config_rules_filters option;
      [@ocaml.doc
        "Returns a list of Detective or Proactive Config rules. By default, this API returns an \
         unfiltered list. For more information on Detective or Proactive Config rules, see \
         {{:https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config-rules.html} \
         {b Evaluation Mode} } in the {i Config Developer Guide}.\n"]
  next_token : string_ option;
      [@ocaml.doc
        "The [nextToken] string returned on a previous page that you use to get the next page of \
         results in a paginated response.\n"]
...
type nonrec config_rule_evaluation_status = {
  ...
  last_debug_log_delivery_status : string_ option;
      [@ocaml.doc
        "The status of the last attempted delivery of a debug log for your Config Custom Policy \
         rules. Either [Successful] or [Failed].\n"]
  first_evaluation_started : boolean_ option;
      [@ocaml.doc
        ...
        \  "]
  last_error_message : string_ option;
      [@ocaml.doc "The error message that Config returned when the rule last failed.\n"]
  last_error_code : string_ option;
      [@ocaml.doc "The error code that Config returned when the rule last failed.\n"]
  ...
  last_failed_invocation_time : date option;
      [@ocaml.doc
        "The time that Config last failed to invoke the Config rule to evaluate your Amazon Web \
         Services resources.\n"]
  ...
  config_rule_arn : string_ option;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the Config rule.\n"]
  config_rule_name : config_rule_name option; [@ocaml.doc "The name of the Config rule.\n"]
}
[@@ocaml.doc
  "Status information for your Config Managed rules and Config Custom Policy rules. The status \
   includes information such as the last time the rule ran, the last time it failed, and the \
   related error for the last failure.\n\n\
  \ This operation does not return status information about Config Custom Lambda rules.\n\
  \ "]

type nonrec config_rule_evaluation_status_list = config_rule_evaluation_status list [@@ocaml.doc ""]
...
type nonrec describe_config_rule_evaluation_status_request = {
  limit : rule_limit option;
      [@ocaml.doc
        ...
        \  For information about requesting a rule limit increase, see \
         {{:http://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits_config}Config \
         Limits} in the {i Amazon Web Services General Reference Guide}.\n\
        \  "]
  next_token : string_ option;
      [@ocaml.doc
        "The [nextToken] string returned on a previous page that you use to get the next page of \
  ...
  config_rule_names : config_rule_names option;
      [@ocaml.doc
        "The name of the Config managed rules for which you want status information. If you do not \
         specify any names, Config returns status information for all Config managed rules that \
         you use.\n"]
}
[@@ocaml.doc "\n"]
...
type nonrec compliance = {
  ...
  compliance_type : compliance_type option;
      [@ocaml.doc
        ...
        \ A resource is compliant if it complies with all of the Config rules that evaluate it. A \
        ...
        \  \n\
        \   Config returns the [INSUFFICIENT_DATA] value when no evaluation results are available \
        ...
        \    For the [Compliance] data type, Config supports only [COMPLIANT], [NON_COMPLIANT], \
         and [INSUFFICIENT_DATA] values. Config does not support the [NOT_APPLICABLE] value for \
...
type nonrec compliance_by_resource = {
  compliance : compliance option;
      [@ocaml.doc
        "Indicates whether the Amazon Web Services resource complies with all of the Config rules \
         that evaluated it.\n"]
  resource_id : base_resource_id option;
      [@ocaml.doc "The ID of the Amazon Web Services resource that was evaluated.\n"]
  resource_type : string_with_char_limit256 option;
...
[@@ocaml.doc
  "Indicates whether an Amazon Web Services resource that is evaluated according to one or more \
   Config rules is compliant. A resource is compliant if it complies with all of the rules that \
   evaluate it. A resource is noncompliant if it does not comply with one or more of these rules.\n"]
...
type nonrec describe_compliance_by_resource_response = {
  ...
  compliance_by_resources : compliance_by_resources option;
      [@ocaml.doc
        "Indicates whether the specified Amazon Web Services resource complies with all of the \
...
type nonrec describe_compliance_by_resource_request = {
  ...
  limit : limit option;
      [@ocaml.doc
        "The maximum number of evaluation results returned on each page. The default is 10. You \
         cannot specify a number greater than 100. If you specify 0, Config uses the default.\n"]
  compliance_types : compliance_types option; [@ocaml.doc "Filters the results by compliance.\n"]
  resource_id : base_resource_id option;
      [@ocaml.doc
        "The ID of the Amazon Web Services resource for which you want compliance information. You \
         can specify only one resource ID. If you specify a resource ID, you must also specify a \
         type for [ResourceType].\n"]
  resource_type : string_with_char_limit256 option;
      [@ocaml.doc
        "The types of Amazon Web Services resources for which you want compliance information (for \
         example, [AWS::EC2::Instance]). For this operation, you can specify that the resource \
         type is an Amazon Web Services account by specifying [AWS::::Account].\n"]
}
[@@ocaml.doc "\n"]

type nonrec compliance_by_config_rule = {
  compliance : compliance option; [@ocaml.doc "Indicates whether the Config rule is compliant.\n"]
  config_rule_name : string_with_char_limit64 option; [@ocaml.doc "The name of the Config rule.\n"]
}
[@@ocaml.doc
  "Indicates whether an Config rule is compliant. A rule is compliant if all of the resources that \
   the rule evaluated comply with it. A rule is noncompliant if any of these resources do not \
   comply.\n"]

type nonrec compliance_by_config_rules = compliance_by_config_rule list [@@ocaml.doc ""]
...
type nonrec describe_compliance_by_config_rule_response = {
  ...
  compliance_by_config_rules : compliance_by_config_rules option;
      [@ocaml.doc "Indicates whether each of the specified Config rules is compliant.\n"]
}
[@@ocaml.doc "\n"]
...
type nonrec describe_compliance_by_config_rule_request = {
  ...
  compliance_types : compliance_types option; [@ocaml.doc "Filters the results by compliance.\n"]
  config_rule_names : config_rule_names option;
      [@ocaml.doc "Specify one or more Config rule names to filter the results by rule.\n"]
}
[@@ocaml.doc "\n"]

type nonrec aggregation_authorization_list = aggregation_authorization list [@@ocaml.doc ""]
...
type nonrec describe_aggregation_authorizations_request = {
  ...
  limit : limit option;
      [@ocaml.doc
        "The maximum number of AggregationAuthorizations returned on each page. The default is \
         maximum. If you specify 0, Config uses the default.\n"]
}
[@@ocaml.doc ""]
...
type nonrec aggregate_conformance_pack_compliance = {
  total_rule_count : integer option;
      [@ocaml.doc
        "Total number of compliant rules, noncompliant rules, and the rules that do not have any \
         applicable resources to evaluate upon resulting in insufficient data.\n"]
  non_compliant_rule_count : integer option;
      [@ocaml.doc "The number of noncompliant Config Rules.\n"]
  compliant_rule_count : integer option; [@ocaml.doc "The number of compliant Config Rules.\n"]
  compliance_type : conformance_pack_compliance_type option;
      [@ocaml.doc "The compliance status of the conformance pack.\n"]
}
[@@ocaml.doc
  "Provides the number of compliant and noncompliant rules within a conformance pack. Also \
   provides the compliance status of the conformance pack and the total rule count which includes \
   compliant rules, noncompliant rules, and rules that cannot be evaluated due to insufficient \
   data.\n\n\
  \ A conformance pack is compliant if all of the rules in a conformance packs are compliant. It \
   is noncompliant if any of the rules are not compliant. The compliance status of a conformance \
   pack is INSUFFICIENT_DATA only if all rules within a conformance pack cannot be evaluated due \
   to insufficient data. If some of the rules in a conformance pack are compliant but the \
   compliance status of other rules in that same conformance pack is INSUFFICIENT_DATA, the \
...
[@@ocaml.doc
  "Provides aggregate compliance of the conformance pack. Indicates whether a conformance pack is \
   compliant based on the name of the conformance pack, account ID, and region.\n\n\
  \ A conformance pack is compliant if all of the rules in a conformance packs are compliant. It \
   is noncompliant if any of the rules are not compliant. The compliance status of a conformance \
   pack is INSUFFICIENT_DATA only if all rules within a conformance pack cannot be evaluated due \
   to insufficient data. If some of the rules in a conformance pack are compliant but the \
...
type nonrec describe_aggregate_compliance_by_conformance_packs_response = {
  next_token : next_token option;
      [@ocaml.doc
        "The [nextToken] string returned on a previous page that you use to get the next page of \
         results in a paginated response.\n"]
  aggregate_compliance_by_conformance_packs : aggregate_compliance_by_conformance_pack_list option;
      [@ocaml.doc "Returns the [AggregateComplianceByConformancePack] object.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc
  "Filters the conformance packs based on an account ID, region, compliance type, and the name of \
...
type nonrec describe_aggregate_compliance_by_conformance_packs_request = {
  ...
  limit : limit option;
      [@ocaml.doc
        "The maximum number of conformance packs compliance details returned on each page. The \
         default is maximum. If you specify 0, Config uses the default. \n"]
  filters : aggregate_conformance_pack_compliance_filters option;
      [@ocaml.doc "Filters the result by [AggregateConformancePackComplianceFilters] object.\n"]
  configuration_aggregator_name : configuration_aggregator_name;
      [@ocaml.doc "The name of the configuration aggregator.\n"]
}
[@@ocaml.doc ""]
...
type nonrec aggregate_compliance_by_config_rule_list = aggregate_compliance_by_config_rule list
[@@ocaml.doc ""]
...
type nonrec describe_aggregate_compliance_by_config_rules_response = {
  next_token : next_token option;
      [@ocaml.doc
        "The [nextToken] string returned on a previous page that you use to get the next page of \
         results in a paginated response.\n"]
  aggregate_compliance_by_config_rules : aggregate_compliance_by_config_rule_list option;
      [@ocaml.doc "Returns a list of AggregateComplianceByConfigRule object.\n"]
}
[@@ocaml.doc ""]
  ...
  compliance_type : compliance_type option;
      [@ocaml.doc
        ...
        \ For the [ConfigRuleComplianceFilters] data type, Config supports only [COMPLIANT] and \
         [NON_COMPLIANT]. Config does not support the [NOT_APPLICABLE] and the [INSUFFICIENT_DATA] \
         values.\n\
        \ "]
  config_rule_name : config_rule_name option; [@ocaml.doc "The name of the Config rule.\n"]
}
...
type nonrec describe_aggregate_compliance_by_config_rules_request = {
  ...
  filters : config_rule_compliance_filters option;
      [@ocaml.doc "Filters the results by ConfigRuleComplianceFilters object. \n"]
  configuration_aggregator_name : configuration_aggregator_name;
      [@ocaml.doc "The name of the configuration aggregator.\n"]
}
[@@ocaml.doc ""]
...
type nonrec deliver_config_snapshot_response = {
  config_snapshot_id : string_ option; [@ocaml.doc "The ID of the snapshot that is being created.\n"]
}
[@@ocaml.doc "The output for the [DeliverConfigSnapshot] action, in JSON format.\n"]

type nonrec deliver_config_snapshot_request = {
  delivery_channel_name : channel_name;
      [@ocaml.doc "The name of the delivery channel through which the snapshot is delivered.\n"]
}
...
type nonrec delete_stored_query_request = {
  query_name : query_name; [@ocaml.doc "The name of the query that you want to delete.\n"]
}
[@@ocaml.doc ""]

type nonrec delete_service_linked_configuration_recorder_response = {
  name : recorder_name; [@ocaml.doc "The name of the specified configuration recorder.\n"]
  arn : amazon_resource_name;
      [@ocaml.doc "The Amazon Resource Name (ARN) of the specified configuration recorder.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_resource_config_request = {
  resource_id : resource_id; [@ocaml.doc "Unique identifier of the resource.\n"]
  resource_type : resource_type_string; [@ocaml.doc "The type of the resource.\n"]
}
[@@ocaml.doc ""]
...
[@@ocaml.doc "You tried to delete a remediation exception that does not exist.\n"]
...
[@@ocaml.doc "List of each of the failed delete remediation exceptions with specific reasons.\n"]

type nonrec failed_delete_remediation_exceptions_batches =
  failed_delete_remediation_exceptions_batch list
[@@ocaml.doc ""]
...
type nonrec delete_pending_aggregation_request_request = {
  requester_aws_region : aws_region; [@ocaml.doc "The region requesting to aggregate data.\n"]
...
type nonrec delete_organization_conformance_pack_request = {
  organization_conformance_pack_name : organization_conformance_pack_name;
      [@ocaml.doc "The name of organization conformance pack that you want to delete.\n"]
}
[@@ocaml.doc ""]

type nonrec delete_organization_config_rule_request = {
  organization_config_rule_name : organization_config_rule_name;
      [@ocaml.doc "The name of organization Config rule that you want to delete.\n"]
}
[@@ocaml.doc ""]
...
type nonrec delete_delivery_channel_request = {
  delivery_channel_name : channel_name;
      [@ocaml.doc "The name of the delivery channel that you want to delete.\n"]
}
[@@ocaml.doc
  "The input for the [DeleteDeliveryChannel] action. The action accepts the following data, in \
   JSON format. \n"]
...
[@@ocaml.doc "The request object for the [DeleteConfigurationRecorder] operation.\n"]
...
type nonrec base_configuration_item = {
  ...
  resource_id : resource_id option;
      [@ocaml.doc "The ID of the resource (for example., sg-xxxxxx).\n"]
  resource_type : resource_type option; [@ocaml.doc "The type of Amazon Web Services resource.\n"]
  arn : ar_n option; [@ocaml.doc "The Amazon Resource Name (ARN) of the resource.\n"]
  configuration_state_id : configuration_state_id option;
      [@ocaml.doc
        "An identifier that indicates the ordering of the configuration items of a resource.\n"]
  configuration_item_status : configuration_item_status option;
...
type nonrec batch_get_resource_config_response = {
  ...
  base_configuration_items : base_configuration_items option;
      [@ocaml.doc "A list that contains the current configuration of one or more resources.\n"]
}
[@@ocaml.doc ""]
...
type nonrec batch_get_aggregate_resource_config_response = {
  unprocessed_resource_identifiers : unprocessed_resource_identifier_list option;
      [@ocaml.doc
        "A list of resource identifiers that were not processed with current scope. The list is \
         empty if all the resources are processed.\n"]
  base_configuration_items : base_configuration_items option;
      [@ocaml.doc "A list that contains the current configuration of one or more resources.\n"]
}
[@@ocaml.doc ""]

type nonrec resource_identifiers_list = aggregate_resource_identifier list [@@ocaml.doc ""]
