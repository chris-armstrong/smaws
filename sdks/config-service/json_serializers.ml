...
let aggregate_resource_identifier_to_yojson
  (x : aggregate_resource_identifier) =
  assoc_to_yojson
    [("ResourceName",
...
let template_ssm_document_details_to_yojson
  (x : template_ssm_document_details) =
  assoc_to_yojson
    [("DocumentVersion",
...
let stored_query_metadata_list_to_yojson tree =
  list_to_yojson stored_query_metadata_to_yojson tree
...
let stop_configuration_recorder_request_to_yojson
  (x : stop_configuration_recorder_request) =
  assoc_to_yojson
...
let status_detail_filters_to_yojson (x : status_detail_filters) =
  assoc_to_yojson
    [("MemberAccountRuleStatus",
       (option_to_yojson member_account_rule_status_to_yojson
          x.member_account_rule_status));
    ("AccountId", (option_to_yojson account_id_to_yojson x.account_id))]
let static_parameter_values_to_yojson tree =
  list_to_yojson string_with_char_limit256_to_yojson tree
let static_value_to_yojson (x : static_value) =
  assoc_to_yojson
    [("Values", (Some (static_parameter_values_to_yojson x.values)))]
let resource_evaluation_id_to_yojson = string_to_yojson
let start_resource_evaluation_response_to_yojson
  (x : start_resource_evaluation_response) =
  assoc_to_yojson
    [("ResourceEvaluationId",
       (option_to_yojson resource_evaluation_id_to_yojson
          x.resource_evaluation_id))]
...
let evaluation_context_to_yojson (x : evaluation_context) =
  assoc_to_yojson
    [("EvaluationContextIdentifier",
       (option_to_yojson evaluation_context_identifier_to_yojson
          x.evaluation_context_identifier))]
...
let start_resource_evaluation_request_to_yojson
  (x : start_resource_evaluation_request) =
  assoc_to_yojson
    [("ClientToken",
...
let invalid_parameter_value_exception_to_yojson
  (x : invalid_parameter_value_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let start_remediation_execution_response_to_yojson
  (x : start_remediation_execution_response) =
  assoc_to_yojson
    [("FailedItems",
...
let start_remediation_execution_request_to_yojson
  (x : start_remediation_execution_request) =
  assoc_to_yojson
...
let insufficient_permissions_exception_to_yojson
  (x : insufficient_permissions_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
let start_configuration_recorder_request_to_yojson
  (x : start_configuration_recorder_request) =
  assoc_to_yojson
    [("ConfigurationRecorderName",
       (Some (recorder_name_to_yojson x.configuration_recorder_name)))]
...
let start_config_rules_evaluation_request_to_yojson
  (x : start_config_rules_evaluation_request) =
  assoc_to_yojson
    [("ConfigRuleNames",
       (option_to_yojson reevaluate_config_rule_names_to_yojson
          x.config_rule_names))]
let resource_in_use_exception_to_yojson (x : resource_in_use_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
let no_such_config_rule_exception_to_yojson
  (x : no_such_config_rule_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let select_resource_config_response_to_yojson
  (x : select_resource_config_response) =
  assoc_to_yojson
...
let select_resource_config_request_to_yojson
  (x : select_resource_config_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let put_retention_configuration_response_to_yojson
  (x : put_retention_configuration_response) =
  assoc_to_yojson
    [("RetentionConfiguration",
       (option_to_yojson retention_configuration_to_yojson
          x.retention_configuration))]
let put_retention_configuration_request_to_yojson
  (x : put_retention_configuration_request) =
  assoc_to_yojson
    [("RetentionPeriodInDays",
       (Some (retention_period_in_days_to_yojson x.retention_period_in_days)))]
...
let max_active_resources_exceeded_exception_to_yojson
  (x : max_active_resources_exceeded_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let remediation_exception_to_yojson (x : remediation_exception) =
  assoc_to_yojson
    ...
    ("ConfigRuleName",
      (Some (config_rule_name_to_yojson x.config_rule_name)))]
let remediation_exceptions_to_yojson tree =
  list_to_yojson remediation_exception_to_yojson tree
let failed_remediation_exception_batch_to_yojson
  (x : failed_remediation_exception_batch) =
  assoc_to_yojson
    [("FailedItems",
...
let put_remediation_exceptions_response_to_yojson
  (x : put_remediation_exceptions_response) =
  assoc_to_yojson
    [("FailedBatches",
       (option_to_yojson failed_remediation_exception_batches_to_yojson
          x.failed_batches))]
let remediation_exception_resource_key_to_yojson
  (x : remediation_exception_resource_key) =
  assoc_to_yojson
    [("ResourceId",
...
let put_remediation_exceptions_request_to_yojson
  (x : put_remediation_exceptions_request) =
  assoc_to_yojson
    [("ExpirationTime", (option_to_yojson date_to_yojson x.expiration_time));
    ("Message",
      (option_to_yojson string_with_char_limit1024_to_yojson x.message));
...
let remediation_parameters_to_yojson tree =
  map_to_yojson string_with_char_limit256_to_yojson
    remediation_parameter_value_to_yojson tree
...
let ssm_controls_to_yojson (x : ssm_controls) =
  assoc_to_yojson
    ...
    ("ConcurrentExecutionRatePercentage",
      (option_to_yojson percentage_to_yojson
         x.concurrent_execution_rate_percentage))]
...
let remediation_configuration_to_yojson (x : remediation_configuration) =
  assoc_to_yojson
    [("CreatedByService",
       (option_to_yojson string_with_char_limit1024_to_yojson
          x.created_by_service));
    ("Arn", (option_to_yojson string_with_char_limit1024_to_yojson x.arn));
    ("RetryAttemptSeconds",
      (option_to_yojson auto_remediation_attempt_seconds_to_yojson
         x.retry_attempt_seconds));
    ("MaximumAutomaticAttempts",
      (option_to_yojson auto_remediation_attempts_to_yojson
         x.maximum_automatic_attempts));
    ("ExecutionControls",
...
let put_remediation_configurations_response_to_yojson
  (x : put_remediation_configurations_response) =
  assoc_to_yojson
    [("FailedBatches",
       (option_to_yojson failed_remediation_batches_to_yojson
          x.failed_batches))]
let put_remediation_configurations_request_to_yojson
  (x : put_remediation_configurations_request) =
  assoc_to_yojson
    [("RemediationConfigurations",
       (Some
          (remediation_configurations_to_yojson x.remediation_configurations)))]
...
let organization_access_denied_exception_to_yojson
  (x : organization_access_denied_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
let no_available_organization_exception_to_yojson
  (x : no_available_organization_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let put_organization_conformance_pack_response_to_yojson
  ...
  assoc_to_yojson
    [("OrganizationConformancePackArn",
       (option_to_yojson string_with_char_limit256_to_yojson
          x.organization_conformance_pack_arn))]
...
let conformance_pack_input_parameter_to_yojson
  (x : conformance_pack_input_parameter) =
  assoc_to_yojson
...
let excluded_accounts_to_yojson tree =
...
let put_organization_conformance_pack_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("DeliveryS3KeyPrefix",
      (option_to_yojson delivery_s3_key_prefix_to_yojson
         x.delivery_s3_key_prefix));
    ("DeliveryS3Bucket",
    ...
    ("OrganizationConformancePackName",
      (Some
         (organization_conformance_pack_name_to_yojson
            x.organization_conformance_pack_name)))]
...
let put_organization_config_rule_response_to_yojson
  (x : put_organization_config_rule_response) =
  assoc_to_yojson
    [("OrganizationConfigRuleArn",
       (option_to_yojson string_with_char_limit256_to_yojson
          x.organization_config_rule_arn))]
...
let resource_types_scope_to_yojson tree =
  list_to_yojson string_with_char_limit256_to_yojson tree
let organization_managed_rule_metadata_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ResourceIdScope",
      (option_to_yojson string_with_char_limit768_to_yojson
         x.resource_id_scope));
    ("ResourceTypesScope",
      (option_to_yojson resource_types_scope_to_yojson x.resource_types_scope));
    ("MaximumExecutionFrequency",
      (option_to_yojson maximum_execution_frequency_to_yojson
         x.maximum_execution_frequency));
    ("InputParameters",
      (option_to_yojson string_with_char_limit2048_to_yojson
         x.input_parameters));
    ("RuleIdentifier",
      (Some (string_with_char_limit256_to_yojson x.rule_identifier)));
    ("Description",
      (option_to_yojson string_with_char_limit256_min0_to_yojson
         x.description))]
let organization_config_rule_trigger_type_to_yojson
  (x : organization_config_rule_trigger_type) =
  match x with
...
let organization_custom_rule_metadata_to_yojson
  ...
  assoc_to_yojson
    ...
    ("OrganizationConfigRuleTriggerTypes",
      (Some
         (organization_config_rule_trigger_types_to_yojson
...
let debug_log_delivery_accounts_to_yojson tree =
  list_to_yojson account_id_to_yojson tree
let organization_custom_policy_rule_metadata_to_yojson
  (x : organization_custom_policy_rule_metadata) =
  assoc_to_yojson
    [("DebugLogDeliveryAccounts",
       (option_to_yojson debug_log_delivery_accounts_to_yojson
          x.debug_log_delivery_accounts));
    ...
    ("OrganizationConfigRuleTriggerTypes",
      (option_to_yojson
         organization_config_rule_trigger_type_no_s_ns_to_yojson
         x.organization_config_rule_trigger_types));
    ("Description",
      (option_to_yojson string_with_char_limit256_min0_to_yojson
         x.description))]
let put_organization_config_rule_request_to_yojson
  (x : put_organization_config_rule_request) =
  assoc_to_yojson
...
let put_external_evaluation_request_to_yojson
  (x : put_external_evaluation_request) =
  assoc_to_yojson
    [("ExternalEvaluation",
...
let invalid_result_token_exception_to_yojson
  (x : invalid_result_token_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let put_conformance_pack_response_to_yojson
  (x : put_conformance_pack_response) =
  assoc_to_yojson
    [("ConformancePackArn",
       (option_to_yojson conformance_pack_arn_to_yojson
          x.conformance_pack_arn))]
...
let put_conformance_pack_request_to_yojson (x : put_conformance_pack_request)
  ...
  assoc_to_yojson
    [("TemplateSSMDocumentDetails",
       (option_to_yojson template_ssm_document_details_to_yojson
          x.template_ssm_document_details));
    ("ConformancePackInputParameters",
      (option_to_yojson conformance_pack_input_parameters_to_yojson
         x.conformance_pack_input_parameters));
...
let invalid_recording_group_exception_to_yojson
  (x : invalid_recording_group_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let resource_type_list_to_yojson tree =
  list_to_yojson resource_type_to_yojson tree
...
let recording_group_to_yojson (x : recording_group) =
  assoc_to_yojson
    ...
    ("exclusionByResourceTypes",
      (option_to_yojson exclusion_by_resource_types_to_yojson
         x.exclusion_by_resource_types));
    ("resourceTypes",
      (option_to_yojson resource_type_list_to_yojson x.resource_types));
    ("includeGlobalResourceTypes",
      (option_to_yojson include_global_resource_types_to_yojson
         x.include_global_resource_types));
    ("allSupported",
...
let recording_mode_resource_types_list_to_yojson tree =
  list_to_yojson resource_type_to_yojson tree
...
let recording_mode_overrides_to_yojson tree =
  list_to_yojson recording_mode_override_to_yojson tree
let recording_mode_to_yojson (x : recording_mode) =
  assoc_to_yojson
    [("recordingModeOverrides",
       (option_to_yojson recording_mode_overrides_to_yojson
...
let account_aggregation_source_account_list_to_yojson tree =
  list_to_yojson account_id_to_yojson tree
let aggregator_region_list_to_yojson tree =
...
let configuration_aggregator_to_yojson (x : configuration_aggregator) =
  assoc_to_yojson
    ...
    ("AccountAggregationSources",
      (option_to_yojson account_aggregation_source_list_to_yojson
         x.account_aggregation_sources));
    ("ConfigurationAggregatorArn",
      (option_to_yojson configuration_aggregator_arn_to_yojson
         x.configuration_aggregator_arn));
    ("ConfigurationAggregatorName",
      (option_to_yojson configuration_aggregator_name_to_yojson
         x.configuration_aggregator_name))]
let put_configuration_aggregator_response_to_yojson
  (x : put_configuration_aggregator_response) =
  assoc_to_yojson
    [("ConfigurationAggregator",
       (option_to_yojson configuration_aggregator_to_yojson
          x.configuration_aggregator))]
...
let scope_to_yojson (x : scope) =
  assoc_to_yojson
    ...
    ("ComplianceResourceTypes",
      (option_to_yojson compliance_resource_types_to_yojson
         x.compliance_resource_types))]
...
let event_source_to_yojson (x : event_source) =
  match x with | Aws_Config -> `String "aws.config"
...
let source_details_to_yojson tree =
  list_to_yojson source_detail_to_yojson tree
...
let source_to_yojson (x : source) =
  assoc_to_yojson
    [("CustomPolicyDetails",
       (option_to_yojson custom_policy_details_to_yojson
          x.custom_policy_details));
    ("SourceDetails",
...
let evaluation_mode_configuration_to_yojson
  (x : evaluation_mode_configuration) =
  assoc_to_yojson
    [("Mode", (option_to_yojson evaluation_mode_to_yojson x.mode))]
let evaluation_modes_to_yojson tree =
  list_to_yojson evaluation_mode_configuration_to_yojson tree
let config_rule_to_yojson (x : config_rule) =
  assoc_to_yojson
    ...
    ("Description",
      (option_to_yojson emptiable_string_with_char_limit256_to_yojson
         x.description));
    ("ConfigRuleId",
...
let put_aggregation_authorization_response_to_yojson
  (x : put_aggregation_authorization_response) =
  assoc_to_yojson
    [("AggregationAuthorization",
       (option_to_yojson aggregation_authorization_to_yojson
          x.aggregation_authorization))]
let put_aggregation_authorization_request_to_yojson
  (x : put_aggregation_authorization_request) =
  assoc_to_yojson
    [("Tags", (option_to_yojson tags_list_to_yojson x.tags));
    ("AuthorizedAwsRegion",
...
let list_stored_queries_response_to_yojson (x : list_stored_queries_response)
  ...
  assoc_to_yojson
    ...
    ("StoredQueryMetadata",
      (option_to_yojson stored_query_metadata_list_to_yojson
         x.stored_query_metadata))]
...
let resource_evaluation_to_yojson (x : resource_evaluation) =
  assoc_to_yojson
    ...
    ("ResourceEvaluationId",
      (option_to_yojson resource_evaluation_id_to_yojson
         x.resource_evaluation_id))]
let resource_evaluations_to_yojson tree =
  list_to_yojson resource_evaluation_to_yojson tree
let list_resource_evaluations_response_to_yojson
  (x : list_resource_evaluations_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("ResourceEvaluations",
...
let list_resource_evaluations_request_to_yojson
  (x : list_resource_evaluations_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("Limit",
      (option_to_yojson list_resource_evaluations_page_item_limit_to_yojson
         x.limit));
    ("Filters",
...
let list_discovered_resources_request_to_yojson
  (x : list_discovered_resources_request) =
  assoc_to_yojson
    [("nextToken", (option_to_yojson next_token_to_yojson x.next_token));
...
let conformance_pack_compliance_score_to_yojson
  (x : conformance_pack_compliance_score) =
  assoc_to_yojson
    [("LastUpdatedTime",
       (option_to_yojson last_updated_time_to_yojson x.last_updated_time));
    ("ConformancePackName",
      (option_to_yojson conformance_pack_name_to_yojson
         x.conformance_pack_name));
...
let list_conformance_pack_compliance_scores_response_to_yojson
  ...
  assoc_to_yojson
    [("ConformancePackComplianceScores",
       (Some
          (conformance_pack_compliance_scores_to_yojson
             x.conformance_pack_compliance_scores)));
    ("NextToken", (option_to_yojson next_token_to_yojson x.next_token))]
...
let conformance_pack_compliance_scores_filters_to_yojson
  ...
  assoc_to_yojson
    [("ConformancePackNames",
       (Some
          (conformance_pack_name_filter_to_yojson x.conformance_pack_names)))]
...
let list_aggregate_discovered_resources_response_to_yojson
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("ResourceIdentifiers",
      (option_to_yojson discovered_resource_identifier_list_to_yojson
         x.resource_identifiers))]
...
let get_resource_evaluation_summary_request_to_yojson
  (x : get_resource_evaluation_summary_request) =
  assoc_to_yojson
    [("ResourceEvaluationId",
       (Some (resource_evaluation_id_to_yojson x.resource_evaluation_id)))]
let resource_not_discovered_exception_to_yojson
  (x : resource_not_discovered_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
let configuration_item_capture_time_to_yojson =
...
let related_event_list_to_yojson tree =
  list_to_yojson related_event_to_yojson tree
...
let relationship_to_yojson (x : relationship) =
  assoc_to_yojson
    ...
    ("resourceType",
      (option_to_yojson resource_type_to_yojson x.resource_type))]
let relationship_list_to_yojson tree =
  list_to_yojson relationship_to_yojson tree
let configuration_item_delivery_time_to_yojson =
  timestamp_epoch_seconds_to_yojson
let configuration_item_to_yojson (x : configuration_item) =
  assoc_to_yojson
    ...
    ("supplementaryConfiguration",
      (option_to_yojson supplementary_configuration_to_yojson
         x.supplementary_configuration));
    ("configuration",
    ...
    ("resourceCreationTime",
      (option_to_yojson resource_creation_time_to_yojson
         x.resource_creation_time));
    ("availabilityZone",
    ...
    ("configurationItemMD5Hash",
      (option_to_yojson configuration_item_md5_hash_to_yojson
         x.configuration_item_md5_hash));
    ("configurationStateId",
      (option_to_yojson configuration_state_id_to_yojson
         x.configuration_state_id));
    ("configurationItemStatus",
      (option_to_yojson configuration_item_status_to_yojson
         x.configuration_item_status));
    ("configurationItemCaptureTime",
      (option_to_yojson configuration_item_capture_time_to_yojson
         x.configuration_item_capture_time));
    ("accountId", (option_to_yojson account_id_to_yojson x.account_id));
    ("version", (option_to_yojson version_to_yojson x.version))]
let configuration_item_list_to_yojson tree =
  list_to_yojson configuration_item_to_yojson tree
let get_resource_config_history_response_to_yojson
  (x : get_resource_config_history_response) =
  assoc_to_yojson
    [("nextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("configurationItems",
      (option_to_yojson configuration_item_list_to_yojson
         x.configuration_items))]
...
let get_resource_config_history_request_to_yojson
  (x : get_resource_config_history_request) =
  assoc_to_yojson
    [("nextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("limit", (option_to_yojson limit_to_yojson x.limit));
    ("chronologicalOrder",
...
let get_organization_custom_rule_policy_response_to_yojson
  ...
  assoc_to_yojson
    [("PolicyText", (option_to_yojson policy_text_to_yojson x.policy_text))]
...
let organization_resource_detailed_status_to_yojson
  (x : organization_resource_detailed_status) =
  match x with
  | UPDATE_FAILED -> `String "UPDATE_FAILED"
  | UPDATE_IN_PROGRESS -> `String "UPDATE_IN_PROGRESS"
  | UPDATE_SUCCESSFUL -> `String "UPDATE_SUCCESSFUL"
...
let get_organization_conformance_pack_detailed_status_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("OrganizationConformancePackDetailedStatuses",
      (option_to_yojson
         organization_conformance_pack_detailed_statuses_to_yojson
...
let organization_resource_detailed_status_filters_to_yojson
  ...
  assoc_to_yojson
    [("Status",
       (option_to_yojson organization_resource_detailed_status_to_yojson
          x.status));
    ("AccountId", (option_to_yojson account_id_to_yojson x.account_id))]
...
let get_organization_conformance_pack_detailed_status_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("Filters",
      (option_to_yojson
         organization_resource_detailed_status_filters_to_yojson x.filters));
    ("OrganizationConformancePackName",
      (Some
         (organization_conformance_pack_name_to_yojson
            x.organization_conformance_pack_name)))]
let member_account_status_to_yojson (x : member_account_status) =
  assoc_to_yojson
    ...
    ("MemberAccountRuleStatus",
      (Some
         (member_account_rule_status_to_yojson x.member_account_rule_status)));
    ("ConfigRuleName",
...
let resource_count_to_yojson (x : resource_count) =
  assoc_to_yojson
    ...
    ("resourceType",
      (option_to_yojson resource_type_to_yojson x.resource_type))]
let resource_counts_to_yojson tree =
  list_to_yojson resource_count_to_yojson tree
let get_discovered_resource_counts_response_to_yojson
  (x : get_discovered_resource_counts_response) =
  assoc_to_yojson
    [("nextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("resourceCounts",
...
let resource_types_to_yojson tree =
  list_to_yojson string_with_char_limit256_to_yojson tree
let get_discovered_resource_counts_request_to_yojson
  (x : get_discovered_resource_counts_request) =
  assoc_to_yojson
    [("nextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("limit", (option_to_yojson limit_to_yojson x.limit));
    ("resourceTypes",
...
let get_custom_rule_policy_response_to_yojson
  (x : get_custom_rule_policy_response) =
  assoc_to_yojson
    [("PolicyText", (option_to_yojson policy_text_to_yojson x.policy_text))]
let get_custom_rule_policy_request_to_yojson
  (x : get_custom_rule_policy_request) =
  assoc_to_yojson
    [("ConfigRuleName",
       (option_to_yojson config_rule_name_to_yojson x.config_rule_name))]
let no_such_conformance_pack_exception_to_yojson
  (x : no_such_conformance_pack_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
let conformance_pack_compliance_type_to_yojson
  (x : conformance_pack_compliance_type) =
  match x with
  | INSUFFICIENT_DATA -> `String "INSUFFICIENT_DATA"
  | NON_COMPLIANT -> `String "NON_COMPLIANT"
  | COMPLIANT -> `String "COMPLIANT"
let conformance_pack_compliance_summary_to_yojson
  (x : conformance_pack_compliance_summary) =
  assoc_to_yojson
    [("ConformancePackComplianceStatus",
       (Some
          (conformance_pack_compliance_type_to_yojson
             x.conformance_pack_compliance_status)));
    ("ConformancePackName",
      (Some (conformance_pack_name_to_yojson x.conformance_pack_name)))]
...
let get_conformance_pack_compliance_summary_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ConformancePackNames",
      (Some
         (conformance_pack_names_to_summarize_list_to_yojson
            x.conformance_pack_names)))]
...
let evaluation_result_identifier_to_yojson (x : evaluation_result_identifier)
  ...
  assoc_to_yojson
    ...
    ("EvaluationResultQualifier",
      (option_to_yojson evaluation_result_qualifier_to_yojson
         x.evaluation_result_qualifier))]
let annotation_to_yojson = string_to_yojson
let conformance_pack_evaluation_result_to_yojson
  (x : conformance_pack_evaluation_result) =
  assoc_to_yojson
    ...
    ("EvaluationResultIdentifier",
      (Some
         (evaluation_result_identifier_to_yojson
            x.evaluation_result_identifier)));
    ("ComplianceType",
...
let get_conformance_pack_compliance_details_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ConformancePackRuleEvaluationResults",
      (option_to_yojson
         conformance_pack_rule_evaluation_results_list_to_yojson
...
let conformance_pack_evaluation_filters_to_yojson
  (x : conformance_pack_evaluation_filters) =
  assoc_to_yojson
    [("ResourceIds",
       (option_to_yojson conformance_pack_compliance_resource_ids_to_yojson
          x.resource_ids));
    ("ResourceType",
      (option_to_yojson string_with_char_limit256_to_yojson x.resource_type));
    ("ComplianceType",
      (option_to_yojson conformance_pack_compliance_type_to_yojson
         x.compliance_type));
    ("ConfigRuleNames",
      (option_to_yojson conformance_pack_config_rule_names_to_yojson
         x.config_rule_names))]
...
let get_conformance_pack_compliance_details_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("Limit",
      (option_to_yojson
         get_conformance_pack_compliance_details_limit_to_yojson x.limit));
    ("Filters",
      (option_to_yojson conformance_pack_evaluation_filters_to_yojson
         x.filters));
    ("ConformancePackName",
      (Some (conformance_pack_name_to_yojson x.conformance_pack_name)))]
...
let compliance_summary_to_yojson (x : compliance_summary) =
  assoc_to_yojson
    ...
    ("NonCompliantResourceCount",
      (option_to_yojson compliance_contributor_count_to_yojson
         x.non_compliant_resource_count));
    ("CompliantResourceCount",
      (option_to_yojson compliance_contributor_count_to_yojson
         x.compliant_resource_count))]
let compliance_summary_by_resource_type_to_yojson
  (x : compliance_summary_by_resource_type) =
  assoc_to_yojson
    [("ComplianceSummary",
...
let evaluation_result_to_yojson (x : evaluation_result) =
  assoc_to_yojson
    ...
    ("EvaluationResultIdentifier",
      (option_to_yojson evaluation_result_identifier_to_yojson
         x.evaluation_result_identifier))]
let evaluation_results_to_yojson tree =
  list_to_yojson evaluation_result_to_yojson tree
...
let compliance_types_to_yojson tree =
  list_to_yojson compliance_type_to_yojson tree
...
let get_aggregate_discovered_resource_counts_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("GroupedResourceCounts",
      (option_to_yojson grouped_resource_count_list_to_yojson
         x.grouped_resource_counts));
    ("GroupByKey",
  ...
  assoc_to_yojson
    [("NonCompliantConformancePackCount",
       (option_to_yojson integer_to_yojson
          x.non_compliant_conformance_pack_count));
...
let aggregate_conformance_pack_compliance_summary_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ComplianceSummary",
      (option_to_yojson aggregate_conformance_pack_compliance_count_to_yojson
...
let get_aggregate_conformance_pack_compliance_summary_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AggregateConformancePackComplianceSummaries",
      (option_to_yojson
         aggregate_conformance_pack_compliance_summary_list_to_yojson
...
let get_aggregate_conformance_pack_compliance_summary_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("GroupByKey",
      (option_to_yojson
         aggregate_conformance_pack_compliance_summary_group_key_to_yojson
         x.group_by_key));
    ("Filters",
      (option_to_yojson
         aggregate_conformance_pack_compliance_summary_filters_to_yojson
         x.filters));
    ("ConfigurationAggregatorName",
      (Some
         (configuration_aggregator_name_to_yojson
...
let get_aggregate_config_rule_compliance_summary_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AggregateComplianceCounts",
      (option_to_yojson aggregate_compliance_count_list_to_yojson
         x.aggregate_compliance_counts));
    ("GroupByKey",
      (option_to_yojson string_with_char_limit256_to_yojson x.group_by_key))]
let config_rule_compliance_summary_filters_to_yojson
  (x : config_rule_compliance_summary_filters) =
  assoc_to_yojson
    [("AwsRegion", (option_to_yojson aws_region_to_yojson x.aws_region));
    ("AccountId", (option_to_yojson account_id_to_yojson x.account_id))]
...
let get_aggregate_config_rule_compliance_summary_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("Limit", (option_to_yojson group_by_api_limit_to_yojson x.limit));
    ("GroupByKey",
      (option_to_yojson config_rule_compliance_summary_group_key_to_yojson
         x.group_by_key));
    ("Filters",
      (option_to_yojson config_rule_compliance_summary_filters_to_yojson
         x.filters));
    ("ConfigurationAggregatorName",
      (Some
         (configuration_aggregator_name_to_yojson
...
let get_aggregate_compliance_details_by_config_rule_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AggregateEvaluationResults",
      (option_to_yojson aggregate_evaluation_result_list_to_yojson
         x.aggregate_evaluation_results))]
...
let describe_retention_configurations_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("RetentionConfigurations",
      (option_to_yojson retention_configuration_list_to_yojson
         x.retention_configurations))]
...
let describe_retention_configurations_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("RetentionConfigurationNames",
      (option_to_yojson retention_configuration_name_list_to_yojson
         x.retention_configuration_names))]
...
let remediation_execution_step_state_to_yojson
  (x : remediation_execution_step_state) =
  match x with
  | FAILED -> `String "FAILED"
...
let describe_remediation_execution_status_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("RemediationExecutionStatuses",
      (option_to_yojson remediation_execution_statuses_to_yojson
         x.remediation_execution_statuses))]
...
let describe_remediation_exceptions_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("RemediationExceptions",
      (option_to_yojson remediation_exceptions_to_yojson
         x.remediation_exceptions))]
let describe_remediation_exceptions_request_to_yojson
  (x : describe_remediation_exceptions_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("Limit", (option_to_yojson limit_to_yojson x.limit));
    ("ResourceKeys",
      (option_to_yojson remediation_exception_resource_keys_to_yojson
         x.resource_keys));
    ("ConfigRuleName",
      (Some (config_rule_name_to_yojson x.config_rule_name)))]
let describe_remediation_configurations_response_to_yojson
  ...
  assoc_to_yojson
    [("RemediationConfigurations",
       (option_to_yojson remediation_configurations_to_yojson
          x.remediation_configurations))]
let config_rule_names_to_yojson tree =
  list_to_yojson config_rule_name_to_yojson tree
...
let describe_pending_aggregation_requests_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("PendingAggregationRequests",
      (option_to_yojson pending_aggregation_request_list_to_yojson
         x.pending_aggregation_requests))]
...
let describe_pending_aggregation_requests_request_to_yojson
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("Limit",
      (option_to_yojson describe_pending_aggregation_requests_limit_to_yojson
         x.limit))]
...
let organization_conformance_pack_status_to_yojson
  (x : organization_conformance_pack_status) =
  assoc_to_yojson
    [("LastUpdateTime", (option_to_yojson date_to_yojson x.last_update_time));
    ("ErrorMessage", (option_to_yojson string__to_yojson x.error_message));
    ("ErrorCode", (option_to_yojson string__to_yojson x.error_code));
...
let organization_conformance_pack_to_yojson
  (x : organization_conformance_pack) =
  assoc_to_yojson
    ...
    ("OrganizationConformancePackArn",
      (Some
         (string_with_char_limit256_to_yojson
            x.organization_conformance_pack_arn)));
    ("OrganizationConformancePackName",
      (Some
         (organization_conformance_pack_name_to_yojson
...
let describe_organization_conformance_packs_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("OrganizationConformancePacks",
      (option_to_yojson organization_conformance_packs_to_yojson
         x.organization_conformance_packs))]
...
let organization_config_rule_status_to_yojson
  (x : organization_config_rule_status) =
  assoc_to_yojson
    [("LastUpdateTime", (option_to_yojson date_to_yojson x.last_update_time));
    ("ErrorMessage", (option_to_yojson string__to_yojson x.error_message));
    ("ErrorCode", (option_to_yojson string__to_yojson x.error_code));
...
let describe_organization_config_rule_statuses_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("OrganizationConfigRuleNames",
      (option_to_yojson organization_config_rule_names_to_yojson
         x.organization_config_rule_names))]
...
let organization_config_rule_to_yojson (x : organization_config_rule) =
  assoc_to_yojson
    [("OrganizationCustomPolicyRuleMetadata",
       (option_to_yojson
          organization_custom_policy_rule_metadata_no_policy_to_yojson
          x.organization_custom_policy_rule_metadata));
    ("LastUpdateTime", (option_to_yojson date_to_yojson x.last_update_time));
    ("ExcludedAccounts",
      (option_to_yojson excluded_accounts_to_yojson x.excluded_accounts));
    ...
    ("OrganizationConfigRuleArn",
      (Some
         (string_with_char_limit256_to_yojson x.organization_config_rule_arn)));
    ("OrganizationConfigRuleName",
      (Some
         (organization_config_rule_name_to_yojson
            x.organization_config_rule_name)))]
...
let describe_organization_config_rules_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("OrganizationConfigRules",
      (option_to_yojson organization_config_rules_to_yojson
         x.organization_config_rules))]
...
let no_such_delivery_channel_exception_to_yojson
  (x : no_such_delivery_channel_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let delivery_channel_status_to_yojson (x : delivery_channel_status) =
  assoc_to_yojson
    [("configStreamDeliveryInfo",
       (option_to_yojson config_stream_delivery_info_to_yojson
          x.config_stream_delivery_info));
    ("configHistoryDeliveryInfo",
      (option_to_yojson config_export_delivery_info_to_yojson
         x.config_history_delivery_info));
    ("configSnapshotDeliveryInfo",
      (option_to_yojson config_export_delivery_info_to_yojson
         x.config_snapshot_delivery_info));
    ("name", (option_to_yojson string__to_yojson x.name))]
...
let describe_delivery_channel_status_response_to_yojson
  ...
  assoc_to_yojson
    [("DeliveryChannelsStatus",
       (option_to_yojson delivery_channel_status_list_to_yojson
          x.delivery_channels_status))]
let delivery_channel_name_list_to_yojson tree =
  list_to_yojson channel_name_to_yojson tree
let describe_delivery_channel_status_request_to_yojson
  (x : describe_delivery_channel_status_request) =
  assoc_to_yojson
    [("DeliveryChannelNames",
       (option_to_yojson delivery_channel_name_list_to_yojson
          x.delivery_channel_names))]
let delivery_channel_list_to_yojson tree =
  list_to_yojson delivery_channel_to_yojson tree
let describe_delivery_channels_response_to_yojson
  (x : describe_delivery_channels_response) =
  assoc_to_yojson
    [("DeliveryChannels",
       (option_to_yojson delivery_channel_list_to_yojson x.delivery_channels))]
let describe_delivery_channels_request_to_yojson
  (x : describe_delivery_channels_request) =
  assoc_to_yojson
    [("DeliveryChannelNames",
       (option_to_yojson delivery_channel_name_list_to_yojson
          x.delivery_channel_names))]
...
let conformance_pack_status_detail_to_yojson
  (x : conformance_pack_status_detail) =
  assoc_to_yojson
    ...
    ("ConformancePackStatusReason",
      (option_to_yojson conformance_pack_status_reason_to_yojson
         x.conformance_pack_status_reason));
...
let conformance_pack_names_list_to_yojson tree =
  list_to_yojson conformance_pack_name_to_yojson tree
let describe_conformance_pack_status_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("Limit", (option_to_yojson page_size_limit_to_yojson x.limit));
    ("ConformancePackNames",
      (option_to_yojson conformance_pack_names_list_to_yojson
         x.conformance_pack_names))]
...
let describe_conformance_packs_response_to_yojson
  (x : describe_conformance_packs_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("ConformancePackDetails",
      (option_to_yojson conformance_pack_detail_list_to_yojson
         x.conformance_pack_details))]
let describe_conformance_packs_request_to_yojson
  (x : describe_conformance_packs_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Limit", (option_to_yojson page_size_limit_to_yojson x.limit));
    ("ConformancePackNames",
      (option_to_yojson conformance_pack_names_list_to_yojson
         x.conformance_pack_names))]
let controls_list_to_yojson tree =
  list_to_yojson string_with_char_limit128_to_yojson tree
let conformance_pack_rule_compliance_to_yojson
  (x : conformance_pack_rule_compliance) =
  assoc_to_yojson
...
let describe_conformance_pack_compliance_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ConformancePackRuleComplianceList",
      (Some
         (conformance_pack_rule_compliance_list_to_yojson
            x.conformance_pack_rule_compliance_list)));
    ("ConformancePackName",
      (Some (conformance_pack_name_to_yojson x.conformance_pack_name)))]
let conformance_pack_compliance_filters_to_yojson
  (x : conformance_pack_compliance_filters) =
  assoc_to_yojson
    [("ComplianceType",
       (option_to_yojson conformance_pack_compliance_type_to_yojson
          x.compliance_type));
...
let describe_conformance_pack_compliance_request_to_yojson
  ...
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Limit",
      (option_to_yojson describe_conformance_pack_compliance_limit_to_yojson
         x.limit));
    ("Filters",
      (option_to_yojson conformance_pack_compliance_filters_to_yojson
         x.filters));
    ("ConformancePackName",
      (Some (conformance_pack_name_to_yojson x.conformance_pack_name)))]
...
let configuration_recorder_name_list_to_yojson tree =
  list_to_yojson recorder_name_to_yojson tree
...
let describe_configuration_recorders_response_to_yojson
  ...
  assoc_to_yojson
    [("ConfigurationRecorders",
       (option_to_yojson configuration_recorder_list_to_yojson
          x.configuration_recorders))]
...
let aggregated_source_status_type_to_yojson
  (x : aggregated_source_status_type) =
  match x with
...
let aggregated_source_status_to_yojson (x : aggregated_source_status) =
  assoc_to_yojson
    ...
    ("LastUpdateTime", (option_to_yojson date_to_yojson x.last_update_time));
    ("LastUpdateStatus",
      (option_to_yojson aggregated_source_status_type_to_yojson
         x.last_update_status));
    ("AwsRegion", (option_to_yojson aws_region_to_yojson x.aws_region));
    ("SourceType",
...
let describe_configuration_aggregator_sources_status_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AggregatedSourceStatusList",
      (option_to_yojson aggregated_source_status_list_to_yojson
         x.aggregated_source_status_list))]
...
let describe_configuration_aggregator_sources_status_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("NextToken", (option_to_yojson string__to_yojson x.next_token));
    ("UpdateStatus",
      (option_to_yojson aggregated_source_status_type_list_to_yojson
         x.update_status));
    ("ConfigurationAggregatorName",
      (Some
         (configuration_aggregator_name_to_yojson
...
let describe_configuration_aggregators_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ConfigurationAggregators",
      (option_to_yojson configuration_aggregator_list_to_yojson
         x.configuration_aggregators))]
...
let config_rule_evaluation_status_to_yojson
  (x : config_rule_evaluation_status) =
  assoc_to_yojson
    ...
    ("LastDebugLogDeliveryStatusReason",
      (option_to_yojson string__to_yojson
         x.last_debug_log_delivery_status_reason));
...
let compliance_to_yojson (x : compliance) =
  assoc_to_yojson
    [("ComplianceContributorCount",
       (option_to_yojson compliance_contributor_count_to_yojson
          x.compliance_contributor_count));
    ("ComplianceType",
      (option_to_yojson compliance_type_to_yojson x.compliance_type))]
let compliance_by_resource_to_yojson (x : compliance_by_resource) =
  assoc_to_yojson
    ...
    ("ResourceType",
      (option_to_yojson string_with_char_limit256_to_yojson x.resource_type))]
let compliance_by_resources_to_yojson tree =
  list_to_yojson compliance_by_resource_to_yojson tree
let describe_compliance_by_resource_response_to_yojson
  (x : describe_compliance_by_resource_response) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("ComplianceByResources",
      (option_to_yojson compliance_by_resources_to_yojson
         x.compliance_by_resources))]
let describe_compliance_by_resource_request_to_yojson
  (x : describe_compliance_by_resource_request) =
  assoc_to_yojson
    [("NextToken", (option_to_yojson next_token_to_yojson x.next_token));
    ("Limit", (option_to_yojson limit_to_yojson x.limit));
    ("ComplianceTypes",
...
let describe_compliance_by_config_rule_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ComplianceByConfigRules",
      (option_to_yojson compliance_by_config_rules_to_yojson
         x.compliance_by_config_rules))]
...
let describe_aggregation_authorizations_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AggregationAuthorizations",
      (option_to_yojson aggregation_authorization_list_to_yojson
         x.aggregation_authorizations))]
...
let aggregate_conformance_pack_compliance_to_yojson
  (x : aggregate_conformance_pack_compliance) =
  assoc_to_yojson
    [("TotalRuleCount",
       (option_to_yojson integer_to_yojson x.total_rule_count));
    ("NonCompliantRuleCount",
      (option_to_yojson integer_to_yojson x.non_compliant_rule_count));
    ("CompliantRuleCount",
      (option_to_yojson integer_to_yojson x.compliant_rule_count));
    ("ComplianceType",
      (option_to_yojson conformance_pack_compliance_type_to_yojson
         x.compliance_type))]
let aggregate_compliance_by_conformance_pack_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AccountId", (option_to_yojson account_id_to_yojson x.account_id));
    ("Compliance",
      (option_to_yojson aggregate_conformance_pack_compliance_to_yojson
         x.compliance));
    ("ConformancePackName",
      (option_to_yojson conformance_pack_name_to_yojson
         x.conformance_pack_name))]
...
let describe_aggregate_compliance_by_conformance_packs_response_to_yojson
  ...
  assoc_to_yojson
    ...
    ("AggregateComplianceByConformancePacks",
      (option_to_yojson
         aggregate_compliance_by_conformance_pack_list_to_yojson
...
let describe_aggregate_compliance_by_conformance_packs_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("Filters",
      (option_to_yojson
         aggregate_conformance_pack_compliance_filters_to_yojson x.filters));
    ("ConfigurationAggregatorName",
      (Some
         (configuration_aggregator_name_to_yojson
            x.configuration_aggregator_name)))]
let aggregate_compliance_by_config_rule_to_yojson
  (x : aggregate_compliance_by_config_rule) =
  assoc_to_yojson
    [("AwsRegion", (option_to_yojson aws_region_to_yojson x.aws_region));
    ("AccountId", (option_to_yojson account_id_to_yojson x.account_id));
    ("Compliance", (option_to_yojson compliance_to_yojson x.compliance));
...
let config_rule_compliance_filters_to_yojson
  (x : config_rule_compliance_filters) =
  assoc_to_yojson
    [("AwsRegion", (option_to_yojson aws_region_to_yojson x.aws_region));
    ("AccountId", (option_to_yojson account_id_to_yojson x.account_id));
    ("ComplianceType",
...
let delete_retention_configuration_request_to_yojson
  ...
  assoc_to_yojson
    [("RetentionConfigurationName",
       (Some
          (retention_configuration_name_to_yojson
             x.retention_configuration_name)))]
let delete_resource_config_request_to_yojson
  (x : delete_resource_config_request) =
  assoc_to_yojson
    [("ResourceId", (Some (resource_id_to_yojson x.resource_id)));
    ("ResourceType", (Some (resource_type_string_to_yojson x.resource_type)))]
let no_such_remediation_exception_exception_to_yojson
  (x : no_such_remediation_exception_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let delete_remediation_exceptions_response_to_yojson
  (x : delete_remediation_exceptions_response) =
  assoc_to_yojson
    [("FailedBatches",
       (option_to_yojson
          failed_delete_remediation_exceptions_batches_to_yojson
          x.failed_batches))]
let delete_remediation_exceptions_request_to_yojson
  (x : delete_remediation_exceptions_request) =
  assoc_to_yojson
    [("ResourceKeys",
       (Some (remediation_exception_resource_keys_to_yojson x.resource_keys)));
    ("ConfigRuleName",
...
let delete_organization_config_rule_request_to_yojson
  (x : delete_organization_config_rule_request) =
  assoc_to_yojson
    [("OrganizationConfigRuleName",
       (Some
          (organization_config_rule_name_to_yojson
...
let base_configuration_item_to_yojson (x : base_configuration_item) =
  assoc_to_yojson
    ...
    ("accountId", (option_to_yojson account_id_to_yojson x.account_id));
    ("version", (option_to_yojson version_to_yojson x.version))]
let base_configuration_items_to_yojson tree =
  list_to_yojson base_configuration_item_to_yojson tree
let batch_get_resource_config_response_to_yojson
  (x : batch_get_resource_config_response) =
  assoc_to_yojson
    [("unprocessedResourceKeys",
       (option_to_yojson resource_keys_to_yojson x.unprocessed_resource_keys));
    ("baseConfigurationItems",
      (option_to_yojson base_configuration_items_to_yojson
         x.base_configuration_items))]
let batch_get_resource_config_request_to_yojson
  (x : batch_get_resource_config_request) =
  assoc_to_yojson
    [("resourceKeys", (Some (resource_keys_to_yojson x.resource_keys)))]
