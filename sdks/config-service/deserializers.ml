...
let organization_managed_rule_metadata_of_yojson tree path =
  ...
  ({
     ...
     input_parameters =
       option_of_yojson
         (value_for_key string_with_char_limit2048_of_yojson "InputParameters")
         _list path;
...
let aggregate_conformance_pack_compliance_count_of_yojson tree path =
  ...
  ({
     non_compliant_conformance_pack_count =
       option_of_yojson
         (value_for_key integer__of_yojson "NonCompliantConformancePackCount")
         _list path;
...
let aggregate_conformance_pack_compliance_of_yojson tree path =
  ...
  ({
     total_rule_count =
       option_of_yojson (value_for_key integer__of_yojson "TotalRuleCount") _list path;
     non_compliant_rule_count =
       option_of_yojson (value_for_key integer__of_yojson "NonCompliantRuleCount") _list path;
     compliant_rule_count =
       option_of_yojson (value_for_key integer__of_yojson "CompliantRuleCount") _list path;
     compliance_type =
       option_of_yojson
         (value_for_key conformance_pack_compliance_type_of_yojson "ComplianceType")
         _list path;
