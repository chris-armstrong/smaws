...
type nonrec redirect_action_status_code_enum = HTTP_301 [@ocaml.doc ""] | HTTP_302 [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec advertise_trust_store_ca_names_enum = On [@ocaml.doc ""] | Off [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec mitigation_in_effect_enum = YES [@ocaml.doc ""] | NO [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec anomaly_result_enum = ANOMALOUS [@ocaml.doc ""] | NORMAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec trust_store_association_status_enum = ACTIVE [@ocaml.doc ""] | REMOVED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec enable_prefix_for_ipv6_source_nat_enum = ON [@ocaml.doc ""] | OFF [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec load_balancer_scheme_enum = INTERNET_FACING [@ocaml.doc ""] | INTERNAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec target_group_ip_address_type_enum = IPV4 [@ocaml.doc ""] | IPV6 [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec trust_store_status = ACTIVE [@ocaml.doc ""] | CREATING [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec zonal_capacity_reservation_state = {
  state : capacity_reservation_status option;
