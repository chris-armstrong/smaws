...
let string_set_attribute_value_to_yojson tree =
  list_to_yojson string_attribute_value_to_yojson tree
let number_set_attribute_value_to_yojson tree =
  list_to_yojson number_attribute_value_to_yojson tree
let binary_set_attribute_value_to_yojson tree =
  list_to_yojson binary_attribute_value_to_yojson tree
...
let rec attribute_value_to_yojson (x : attribute_value) =
  ...
  | BOOL arg ->
      assoc_to_yojson
        [("BOOL", (Some (boolean_attribute_value_to_yojson arg)))]
  | NULL arg ->
      assoc_to_yojson [("NULL", (Some (null_attribute_value_to_yojson arg)))]
  | L arg ->
      assoc_to_yojson [("L", (Some (list_attribute_value_to_yojson arg)))]
  | M arg ->
      assoc_to_yojson [("M", (Some (map_attribute_value_to_yojson arg)))]
  | BS arg ->
      assoc_to_yojson
        [("BS", (Some (binary_set_attribute_value_to_yojson arg)))]
  | NS arg ->
      assoc_to_yojson
        [("NS", (Some (number_set_attribute_value_to_yojson arg)))]
  | SS arg ->
      assoc_to_yojson
        [("SS", (Some (string_set_attribute_value_to_yojson arg)))]
  | B arg ->
      assoc_to_yojson [("B", (Some (binary_attribute_value_to_yojson arg)))]
  | N arg ->
      assoc_to_yojson [("N", (Some (number_attribute_value_to_yojson arg)))]
  | S arg ->
      assoc_to_yojson [("S", (Some (string_attribute_value_to_yojson arg)))]
and list_attribute_value_to_yojson tree =
  list_to_yojson attribute_value_to_yojson tree
and map_attribute_value_to_yojson tree =
...
let update_time_to_live_output_to_yojson (x : update_time_to_live_output) =
  assoc_to_yojson
    [("TimeToLiveSpecification",
       (option_to_yojson time_to_live_specification_to_yojson
          x.time_to_live_specification))]
let table_arn_to_yojson = string_to_yojson
let update_time_to_live_input_to_yojson (x : update_time_to_live_input) =
  assoc_to_yojson
    [("TimeToLiveSpecification",
       (Some
          (time_to_live_specification_to_yojson x.time_to_live_specification)));
...
let auto_scaling_policy_description_to_yojson
  (x : auto_scaling_policy_description) =
  assoc_to_yojson
...
let auto_scaling_settings_description_to_yojson
  (x : auto_scaling_settings_description) =
  assoc_to_yojson
    [("ScalingPolicies",
       (option_to_yojson auto_scaling_policy_description_list_to_yojson
          x.scaling_policies));
    ("AutoScalingRoleArn",
...
let replica_auto_scaling_description_to_yojson
  (x : replica_auto_scaling_description) =
  assoc_to_yojson
    [("ReplicaStatus",
    ...
    ("GlobalSecondaryIndexes",
      (option_to_yojson
         replica_global_secondary_index_auto_scaling_description_list_to_yojson
...
let table_auto_scaling_description_to_yojson
  (x : table_auto_scaling_description) =
  assoc_to_yojson
    [("Replicas",
       (option_to_yojson replica_auto_scaling_description_list_to_yojson
          x.replicas));
...
let update_table_replica_auto_scaling_output_to_yojson
  ...
  assoc_to_yojson
    [("TableAutoScalingDescription",
       (option_to_yojson table_auto_scaling_description_to_yojson
          x.table_auto_scaling_description))]
...
let auto_scaling_settings_update_to_yojson (x : auto_scaling_settings_update)
  ...
  assoc_to_yojson
    [("ScalingPolicyUpdate",
       (option_to_yojson auto_scaling_policy_update_to_yojson
          x.scaling_policy_update));
    ("AutoScalingRoleArn",
      (option_to_yojson auto_scaling_role_arn_to_yojson
         x.auto_scaling_role_arn));
    ("AutoScalingDisabled",
      (option_to_yojson boolean_object_to_yojson x.auto_scaling_disabled));
    ("MaximumUnits",
      (option_to_yojson positive_long_object_to_yojson x.maximum_units));
...
let replica_global_secondary_index_auto_scaling_update_list_to_yojson tree =
  list_to_yojson replica_global_secondary_index_auto_scaling_update_to_yojson
    tree
let replica_auto_scaling_update_to_yojson (x : replica_auto_scaling_update) =
  assoc_to_yojson
    ...
    ("ReplicaGlobalSecondaryIndexUpdates",
      (option_to_yojson
         replica_global_secondary_index_auto_scaling_update_list_to_yojson
...
let update_table_replica_auto_scaling_input_to_yojson
  (x : update_table_replica_auto_scaling_input) =
  assoc_to_yojson
    [("ReplicaUpdates",
       (option_to_yojson replica_auto_scaling_update_list_to_yojson
          x.replica_updates));
    ("ProvisionedWriteCapacityAutoScalingUpdate",
      (option_to_yojson auto_scaling_settings_update_to_yojson
         x.provisioned_write_capacity_auto_scaling_update));
    ...
    ("GlobalSecondaryIndexUpdates",
      (option_to_yojson
         global_secondary_index_auto_scaling_update_list_to_yojson
...
let scalar_attribute_type_to_yojson (x : scalar_attribute_type) =
  match x with | B -> `String "B" | N -> `String "N" | S -> `String "S"
...
let attribute_definitions_to_yojson tree =
  list_to_yojson attribute_definition_to_yojson tree
let key_type_to_yojson (x : key_type) =
  match x with | RANGE -> `String "RANGE" | HASH -> `String "HASH"
let key_schema_element_to_yojson (x : key_schema_element) =
  assoc_to_yojson
    [("KeyType", (Some (key_type_to_yojson x.key_type)));
    ("AttributeName",
      (Some (key_schema_attribute_name_to_yojson x.attribute_name)))]
let key_schema_to_yojson tree =
  list_to_yojson key_schema_element_to_yojson tree
...
let provisioned_throughput_description_to_yojson
  (x : provisioned_throughput_description) =
  assoc_to_yojson
    [("WriteCapacityUnits",
       (option_to_yojson non_negative_long_object_to_yojson
          x.write_capacity_units));
    ("ReadCapacityUnits",
      (option_to_yojson non_negative_long_object_to_yojson
         x.read_capacity_units));
    ("NumberOfDecreasesToday",
      (option_to_yojson positive_long_object_to_yojson
         x.number_of_decreases_today));
  ...
  assoc_to_yojson
    [("LastUpdateToPayPerRequestDateTime",
       (option_to_yojson date_to_yojson
          x.last_update_to_pay_per_request_date_time));
...
let projection_to_yojson (x : projection) =
  assoc_to_yojson
    [("NonKeyAttributes",
       (option_to_yojson non_key_attribute_name_list_to_yojson
          x.non_key_attributes));
    ("ProjectionType",
      (option_to_yojson projection_type_to_yojson x.projection_type))]
let local_secondary_index_description_to_yojson
  (x : local_secondary_index_description) =
  assoc_to_yojson
...
let global_secondary_index_description_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ProvisionedThroughput",
      (option_to_yojson provisioned_throughput_description_to_yojson
...
let replica_description_to_yojson (x : replica_description) =
  assoc_to_yojson
    [("ReplicaTableClassSummary",
       (option_to_yojson table_class_summary_to_yojson
          x.replica_table_class_summary));
    ...
    ("ReplicaStatusPercentProgress",
      (option_to_yojson replica_status_percent_progress_to_yojson
         x.replica_status_percent_progress));
    ("ReplicaStatusDescription",
      (option_to_yojson replica_status_description_to_yojson
         x.replica_status_description));
    ("ReplicaStatus",
      (option_to_yojson replica_status_to_yojson x.replica_status));
    ("RegionName", (option_to_yojson region_name_to_yojson x.region_name))]
...
let sse_type_to_yojson (x : sse_type) =
  match x with | KMS -> `String "KMS" | AES256 -> `String "AES256"
...
let table_description_to_yojson (x : table_description) =
  assoc_to_yojson
    ...
    ("LocalSecondaryIndexes",
      (option_to_yojson local_secondary_index_description_list_to_yojson
         x.local_secondary_indexes));
    ("BillingModeSummary",
    ...
    ("AttributeDefinitions",
      (option_to_yojson attribute_definitions_to_yojson
...
let delete_global_secondary_index_action_to_yojson
  (x : delete_global_secondary_index_action) =
  assoc_to_yojson [("IndexName", (Some (index_name_to_yojson x.index_name)))]
let global_secondary_index_update_to_yojson
  (x : global_secondary_index_update) =
  assoc_to_yojson
    [("Delete",
       (option_to_yojson delete_global_secondary_index_action_to_yojson
          x.delete));
    ("Create",
      (option_to_yojson create_global_secondary_index_action_to_yojson
         x.create));
    ("Update",
      (option_to_yojson update_global_secondary_index_action_to_yojson
         x.update))]
...
let replica_global_secondary_index_to_yojson
  (x : replica_global_secondary_index) =
  assoc_to_yojson
    [("OnDemandThroughputOverride",
       (option_to_yojson on_demand_throughput_override_to_yojson
          x.on_demand_throughput_override));
...
let create_replication_group_member_action_to_yojson
  (x : create_replication_group_member_action) =
  assoc_to_yojson
    [("TableClassOverride",
       (option_to_yojson table_class_to_yojson x.table_class_override));
    ("GlobalSecondaryIndexes",
      (option_to_yojson replica_global_secondary_index_list_to_yojson
         x.global_secondary_indexes));
    ("OnDemandThroughputOverride",
      (option_to_yojson on_demand_throughput_override_to_yojson
         x.on_demand_throughput_override));
...
let update_replication_group_member_action_to_yojson
  (x : update_replication_group_member_action) =
  assoc_to_yojson
    [("TableClassOverride",
       (option_to_yojson table_class_to_yojson x.table_class_override));
    ("GlobalSecondaryIndexes",
...
let delete_replication_group_member_action_to_yojson
  (x : delete_replication_group_member_action) =
  assoc_to_yojson
    [("RegionName", (Some (region_name_to_yojson x.region_name)))]
let replication_group_update_to_yojson (x : replication_group_update) =
  assoc_to_yojson
    [("Delete",
       (option_to_yojson delete_replication_group_member_action_to_yojson
          x.delete));
    ("Update",
      (option_to_yojson update_replication_group_member_action_to_yojson
         x.update));
    ("Create",
      (option_to_yojson create_replication_group_member_action_to_yojson
         x.create))]
...
let update_table_input_to_yojson (x : update_table_input) =
  assoc_to_yojson
    ...
    ("TableClass", (option_to_yojson table_class_to_yojson x.table_class));
    ("ReplicaUpdates",
      (option_to_yojson replication_group_update_list_to_yojson
         x.replica_updates));
    ("SSESpecification",
...
let capacity_to_yojson (x : capacity) =
  assoc_to_yojson
    ...
    ("WriteCapacityUnits",
      (option_to_yojson consumed_capacity_units_to_yojson
         x.write_capacity_units));
    ("ReadCapacityUnits",
      (option_to_yojson consumed_capacity_units_to_yojson
         x.read_capacity_units))]
...
let consumed_capacity_to_yojson (x : consumed_capacity) =
  assoc_to_yojson
    [("GlobalSecondaryIndexes",
       (option_to_yojson secondary_indexes_capacity_map_to_yojson
          x.global_secondary_indexes));
    ("LocalSecondaryIndexes",
      (option_to_yojson secondary_indexes_capacity_map_to_yojson
         x.local_secondary_indexes));
...
let item_collection_metrics_to_yojson (x : item_collection_metrics) =
  assoc_to_yojson
    [("SizeEstimateRangeGB",
       (option_to_yojson item_collection_size_estimate_range_to_yojson
          x.size_estimate_range_g_b));
    ("ItemCollectionKey",
      (option_to_yojson item_collection_key_attribute_map_to_yojson
         x.item_collection_key))]
let update_item_output_to_yojson (x : update_item_output) =
  assoc_to_yojson
    [("ItemCollectionMetrics",
       (option_to_yojson item_collection_metrics_to_yojson
          x.item_collection_metrics));
    ("ConsumedCapacity",
...
let attribute_updates_to_yojson tree =
  map_to_yojson attribute_name_to_yojson attribute_value_update_to_yojson
    tree
let comparison_operator_to_yojson (x : comparison_operator) =
  ...
  | NE -> `String "NE"
  | EQ -> `String "EQ"
let attribute_value_list_to_yojson tree =
  list_to_yojson attribute_value_to_yojson tree
let expected_attribute_value_to_yojson (x : expected_attribute_value) =
  assoc_to_yojson
    [("AttributeValueList",
       (option_to_yojson attribute_value_list_to_yojson
...
let expected_attribute_map_to_yojson tree =
  map_to_yojson attribute_name_to_yojson expected_attribute_value_to_yojson
    tree
...
let return_item_collection_metrics_to_yojson
  (x : return_item_collection_metrics) =
  match x with | NONE -> `String "NONE" | SIZE -> `String "SIZE"
...
let expression_attribute_name_map_to_yojson tree =
  map_to_yojson expression_attribute_name_variable_to_yojson
    attribute_name_to_yojson tree
let expression_attribute_value_variable_to_yojson = string_to_yojson
let expression_attribute_value_map_to_yojson tree =
  map_to_yojson expression_attribute_value_variable_to_yojson
    attribute_value_to_yojson tree
let return_values_on_condition_check_failure_to_yojson
  (x : return_values_on_condition_check_failure) =
  match x with | NONE -> `String "NONE" | ALL_OLD -> `String "ALL_OLD"
let update_item_input_to_yojson (x : update_item_input) =
  assoc_to_yojson
    ...
    ("ExpressionAttributeValues",
      (option_to_yojson expression_attribute_value_map_to_yojson
         x.expression_attribute_values));
    ("ExpressionAttributeNames",
      (option_to_yojson expression_attribute_name_map_to_yojson
         x.expression_attribute_names));
    ("ConditionExpression",
    ...
    ("ReturnItemCollectionMetrics",
      (option_to_yojson return_item_collection_metrics_to_yojson
         x.return_item_collection_metrics));
...
let transaction_conflict_exception_to_yojson
  (x : transaction_conflict_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let replica_global_secondary_index_settings_description_to_yojson
  ...
  assoc_to_yojson
    ...
    ("ProvisionedWriteCapacityUnits",
      (option_to_yojson positive_long_object_to_yojson
         x.provisioned_write_capacity_units));
    ("ProvisionedReadCapacityAutoScalingSettings",
      (option_to_yojson auto_scaling_settings_description_to_yojson
         x.provisioned_read_capacity_auto_scaling_settings));
    ("ProvisionedReadCapacityUnits",
      (option_to_yojson positive_long_object_to_yojson
         x.provisioned_read_capacity_units));
    ("IndexStatus", (option_to_yojson index_status_to_yojson x.index_status));
    ("IndexName", (Some (index_name_to_yojson x.index_name)))]
let replica_global_secondary_index_settings_description_list_to_yojson tree =
  list_to_yojson
    replica_global_secondary_index_settings_description_to_yojson tree
let replica_settings_description_to_yojson (x : replica_settings_description)
  ...
  assoc_to_yojson
    ...
    ("ReplicaGlobalSecondaryIndexSettings",
      (option_to_yojson
         replica_global_secondary_index_settings_description_list_to_yojson
    ...
    ("ReplicaBillingModeSummary",
      (option_to_yojson billing_mode_summary_to_yojson
         x.replica_billing_mode_summary));
    ("ReplicaStatus",
      (option_to_yojson replica_status_to_yojson x.replica_status));
    ("RegionName", (Some (region_name_to_yojson x.region_name)))]
...
let update_global_table_settings_output_to_yojson
  (x : update_global_table_settings_output) =
  assoc_to_yojson
    [("ReplicaSettings",
       (option_to_yojson replica_settings_description_list_to_yojson
          x.replica_settings));
    ("GlobalTableName",
...
let global_table_global_secondary_index_settings_update_list_to_yojson tree =
  list_to_yojson
    global_table_global_secondary_index_settings_update_to_yojson tree
...
let replica_global_secondary_index_settings_update_list_to_yojson tree =
  list_to_yojson replica_global_secondary_index_settings_update_to_yojson
    tree
let replica_settings_update_to_yojson (x : replica_settings_update) =
  assoc_to_yojson
    ...
    ("ReplicaGlobalSecondaryIndexSettingsUpdate",
      (option_to_yojson
         replica_global_secondary_index_settings_update_list_to_yojson
         x.replica_global_secondary_index_settings_update));
...
let update_global_table_settings_input_to_yojson
  (x : update_global_table_settings_input) =
  assoc_to_yojson
    [("ReplicaSettingsUpdate",
       (option_to_yojson replica_settings_update_list_to_yojson
          x.replica_settings_update));
    ("GlobalTableGlobalSecondaryIndexSettingsUpdate",
      (option_to_yojson
         global_table_global_secondary_index_settings_update_list_to_yojson
         x.global_table_global_secondary_index_settings_update));
...
let global_table_not_found_exception_to_yojson
  (x : global_table_not_found_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let global_table_description_to_yojson (x : global_table_description) =
  assoc_to_yojson
    ...
    ("ReplicationGroup",
      (option_to_yojson replica_description_list_to_yojson
         x.replication_group))]
let update_global_table_output_to_yojson (x : update_global_table_output) =
  assoc_to_yojson
    [("GlobalTableDescription",
       (option_to_yojson global_table_description_to_yojson
          x.global_table_description))]
...
let replica_update_list_to_yojson tree =
  list_to_yojson replica_update_to_yojson tree
...
let replica_already_exists_exception_to_yojson
  (x : replica_already_exists_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let update_contributor_insights_output_to_yojson
  (x : update_contributor_insights_output) =
  assoc_to_yojson
    [("ContributorInsightsStatus",
       (option_to_yojson contributor_insights_status_to_yojson
          x.contributor_insights_status));
    ("IndexName", (option_to_yojson index_name_to_yojson x.index_name));
    ("TableName", (option_to_yojson table_name_to_yojson x.table_name))]
...
let update_contributor_insights_input_to_yojson
  (x : update_contributor_insights_input) =
  assoc_to_yojson
    [("ContributorInsightsAction",
       (Some
          (contributor_insights_action_to_yojson
             x.contributor_insights_action)));
    ("IndexName", (option_to_yojson index_name_to_yojson x.index_name));
    ("TableName", (Some (table_arn_to_yojson x.table_name)))]
...
let continuous_backups_description_to_yojson
  (x : continuous_backups_description) =
  assoc_to_yojson
...
let update_continuous_backups_output_to_yojson
  (x : update_continuous_backups_output) =
  assoc_to_yojson
    [("ContinuousBackupsDescription",
       (option_to_yojson continuous_backups_description_to_yojson
          x.continuous_backups_description))]
...
let update_continuous_backups_input_to_yojson
  ...
  assoc_to_yojson
    [("PointInTimeRecoverySpecification",
       (Some
          (point_in_time_recovery_specification_to_yojson
             x.point_in_time_recovery_specification)));
    ("TableName", (Some (table_arn_to_yojson x.table_name)))]
...
let tag_key_list_to_yojson tree =
  list_to_yojson tag_key_string_to_yojson tree
...
let transaction_in_progress_exception_to_yojson
  (x : transaction_in_progress_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
...
let cancellation_reason_to_yojson (x : cancellation_reason) =
  assoc_to_yojson
    ...
    ("Item", (option_to_yojson attribute_map_to_yojson x.item))]
let cancellation_reason_list_to_yojson tree =
  list_to_yojson cancellation_reason_to_yojson tree
let transaction_canceled_exception_to_yojson
  (x : transaction_canceled_exception) =
  assoc_to_yojson
    [("CancellationReasons",
       (option_to_yojson cancellation_reason_list_to_yojson
          x.cancellation_reasons));
    ("Message", (option_to_yojson error_message_to_yojson x.message))]
let consumed_capacity_multiple_to_yojson tree =
  list_to_yojson consumed_capacity_to_yojson tree
...
let item_collection_metrics_per_table_to_yojson tree =
  map_to_yojson table_arn_to_yojson
    item_collection_metrics_multiple_to_yojson tree
let transact_write_items_output_to_yojson (x : transact_write_items_output) =
  assoc_to_yojson
    [("ItemCollectionMetrics",
       (option_to_yojson item_collection_metrics_per_table_to_yojson
          x.item_collection_metrics));
    ("ConsumedCapacity",
      (option_to_yojson consumed_capacity_multiple_to_yojson
         x.consumed_capacity))]
...
let transact_write_item_list_to_yojson tree =
  list_to_yojson transact_write_item_to_yojson tree
let client_request_token_to_yojson = string_to_yojson
let transact_write_items_input_to_yojson (x : transact_write_items_input) =
  assoc_to_yojson
    [("ClientRequestToken",
       (option_to_yojson client_request_token_to_yojson
          x.client_request_token));
    ("ReturnItemCollectionMetrics",
      (option_to_yojson return_item_collection_metrics_to_yojson
         x.return_item_collection_metrics));
    ("ReturnConsumedCapacity",
...
let idempotent_parameter_mismatch_exception_to_yojson
  (x : idempotent_parameter_mismatch_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson error_message_to_yojson x.message))]
let item_response_to_yojson (x : item_response) =
  assoc_to_yojson
    [("Item", (option_to_yojson attribute_map_to_yojson x.item))]
let item_response_list_to_yojson tree =
  list_to_yojson item_response_to_yojson tree
...
let get_to_yojson (x : get) =
  assoc_to_yojson
    ...
    ("ProjectionExpression",
      (option_to_yojson projection_expression_to_yojson
         x.projection_expression));
    ("TableName", (Some (table_arn_to_yojson x.table_name)));
    ("Key", (Some (key_to_yojson x.key)))]
let transact_get_item_to_yojson (x : transact_get_item) =
  assoc_to_yojson [("Get", (Some (get_to_yojson x.get)))]
let transact_get_item_list_to_yojson tree =
  list_to_yojson transact_get_item_to_yojson tree
...
let time_to_live_description_to_yojson (x : time_to_live_description) =
  assoc_to_yojson
    [("AttributeName",
       (option_to_yojson time_to_live_attribute_name_to_yojson
          x.attribute_name));
    ("TimeToLiveStatus",
...
let table_creation_parameters_to_yojson (x : table_creation_parameters) =
  assoc_to_yojson
    [("GlobalSecondaryIndexes",
       (option_to_yojson global_secondary_index_list_to_yojson
          x.global_secondary_indexes));
    ("SSESpecification",
      (option_to_yojson sse_specification_to_yojson x.sse_specification));
    ("OnDemandThroughput",
...
let table_already_exists_exception_to_yojson
  (x : table_already_exists_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let source_table_feature_details_to_yojson (x : source_table_feature_details)
  ...
  assoc_to_yojson
    ...
    ("TimeToLiveDescription",
      (option_to_yojson time_to_live_description_to_yojson
         x.time_to_live_description));
    ("StreamDescription",
      (option_to_yojson stream_specification_to_yojson x.stream_description));
    ("GlobalSecondaryIndexes",
      (option_to_yojson global_secondary_indexes_to_yojson
         x.global_secondary_indexes));
    ("LocalSecondaryIndexes",
      (option_to_yojson local_secondary_indexes_to_yojson
         x.local_secondary_indexes))]
...
let scan_output_to_yojson (x : scan_output) =
  assoc_to_yojson
    ...
    ("ScannedCount", (option_to_yojson integer__to_yojson x.scanned_count));
    ("Count", (option_to_yojson integer__to_yojson x.count));
    ("Items", (option_to_yojson item_list_to_yojson x.items))]
let attribute_name_list_to_yojson tree =
  list_to_yojson attribute_name_to_yojson tree
...
let restore_table_to_point_in_time_output_to_yojson
  (x : restore_table_to_point_in_time_output) =
  assoc_to_yojson
    [("TableDescription",
       (option_to_yojson table_description_to_yojson x.table_description))]
let local_secondary_index_to_yojson (x : local_secondary_index) =
  assoc_to_yojson
    ...
    ("KeySchema", (Some (key_schema_to_yojson x.key_schema)));
    ("IndexName", (Some (index_name_to_yojson x.index_name)))]
let local_secondary_index_list_to_yojson tree =
  list_to_yojson local_secondary_index_to_yojson tree
let restore_table_to_point_in_time_input_to_yojson
  (x : restore_table_to_point_in_time_input) =
  assoc_to_yojson
    [("SSESpecificationOverride",
       (option_to_yojson sse_specification_to_yojson
          x.sse_specification_override));
    ("OnDemandThroughputOverride",
      (option_to_yojson on_demand_throughput_to_yojson
         x.on_demand_throughput_override));
    ("ProvisionedThroughputOverride",
    ...
    ("LocalSecondaryIndexOverride",
      (option_to_yojson local_secondary_index_list_to_yojson
         x.local_secondary_index_override));
    ("GlobalSecondaryIndexOverride",
      (option_to_yojson global_secondary_index_list_to_yojson
         x.global_secondary_index_override));
    ("BillingModeOverride",
...
let invalid_restore_time_exception_to_yojson
  (x : invalid_restore_time_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
let restore_table_from_backup_output_to_yojson
  (x : restore_table_from_backup_output) =
  assoc_to_yojson
    [("TableDescription",
       (option_to_yojson table_description_to_yojson x.table_description))]
let restore_table_from_backup_input_to_yojson
  (x : restore_table_from_backup_input) =
  assoc_to_yojson
    [("SSESpecificationOverride",
       (option_to_yojson sse_specification_to_yojson
          x.sse_specification_override));
...
let query_output_to_yojson (x : query_output) =
  assoc_to_yojson
    ...
    ("Count", (option_to_yojson integer__to_yojson x.count));
    ("Items", (option_to_yojson item_list_to_yojson x.items))]
let key_conditions_to_yojson tree =
  map_to_yojson attribute_name_to_yojson condition_to_yojson tree
...
let prepared_statement_parameters_to_yojson tree =
  list_to_yojson attribute_value_to_yojson tree
...
let batch_statement_error_code_enum_to_yojson
  (x : batch_statement_error_code_enum) =
  match x with
...
let parti_ql_batch_response_to_yojson tree =
  list_to_yojson batch_statement_response_to_yojson tree
...
let parti_ql_batch_request_to_yojson tree =
  list_to_yojson batch_statement_request_to_yojson tree
let parameterized_statement_to_yojson (x : parameterized_statement) =
  assoc_to_yojson
    ...
    ("Parameters",
      (option_to_yojson prepared_statement_parameters_to_yojson x.parameters));
    ("Statement", (Some (parti_ql_statement_to_yojson x.statement)))]
let parameterized_statements_to_yojson tree =
  list_to_yojson parameterized_statement_to_yojson tree
...
let import_summary_to_yojson (x : import_summary) =
  assoc_to_yojson
    ...
    ("CloudWatchLogGroupArn",
      (option_to_yojson cloud_watch_log_group_arn_to_yojson
         x.cloud_watch_log_group_arn));
    ("S3BucketSource",
...
let import_summary_list_to_yojson tree =
  list_to_yojson import_summary_to_yojson tree
...
let global_table_to_yojson (x : global_table) =
  assoc_to_yojson
    ...
    ("GlobalTableName",
      (option_to_yojson table_name_to_yojson x.global_table_name))]
let global_table_list_to_yojson tree =
  list_to_yojson global_table_to_yojson tree
let list_global_tables_output_to_yojson (x : list_global_tables_output) =
  assoc_to_yojson
    [("LastEvaluatedGlobalTableName",
       (option_to_yojson table_name_to_yojson
          x.last_evaluated_global_table_name));
    ("GlobalTables",
...
let list_global_tables_input_to_yojson (x : list_global_tables_input) =
  assoc_to_yojson
    ...
    ("ExclusiveStartGlobalTableName",
      (option_to_yojson table_name_to_yojson
         x.exclusive_start_global_table_name))]
...
let export_summaries_to_yojson tree =
  list_to_yojson export_summary_to_yojson tree
...
let list_contributor_insights_output_to_yojson
  (x : list_contributor_insights_output) =
  assoc_to_yojson
    [("NextToken",
       (option_to_yojson next_token_string_to_yojson x.next_token));
    ("ContributorInsightsSummaries",
      (option_to_yojson contributor_insights_summaries_to_yojson
         x.contributor_insights_summaries))]
let list_contributor_insights_limit_to_yojson = int_to_yojson
let list_contributor_insights_input_to_yojson
  (x : list_contributor_insights_input) =
  assoc_to_yojson
    [("MaxResults",
       (option_to_yojson list_contributor_insights_limit_to_yojson
          x.max_results));
    ("NextToken",
      (option_to_yojson next_token_string_to_yojson x.next_token));
    ("TableName", (option_to_yojson table_arn_to_yojson x.table_name))]
...
let backup_summary_to_yojson (x : backup_summary) =
  assoc_to_yojson
    ...
    ("BackupCreationDateTime",
      (option_to_yojson backup_creation_date_time_to_yojson
         x.backup_creation_date_time));
    ...
    ("TableId", (option_to_yojson table_id_to_yojson x.table_id));
    ("TableName", (option_to_yojson table_name_to_yojson x.table_name))]
let backup_summaries_to_yojson tree =
  list_to_yojson backup_summary_to_yojson tree
...
let list_backups_input_to_yojson (x : list_backups_input) =
  assoc_to_yojson
    ...
    ("TimeRangeUpperBound",
      (option_to_yojson time_range_upper_bound_to_yojson
         x.time_range_upper_bound));
    ("TimeRangeLowerBound",
      (option_to_yojson time_range_lower_bound_to_yojson
         x.time_range_lower_bound));
...
let kinesis_streaming_destination_output_to_yojson
  (x : kinesis_streaming_destination_output) =
  assoc_to_yojson
...
let kinesis_streaming_destination_input_to_yojson
  (x : kinesis_streaming_destination_input) =
  assoc_to_yojson
    [("EnableKinesisStreamingConfiguration",
       (option_to_yojson enable_kinesis_streaming_configuration_to_yojson
          x.enable_kinesis_streaming_configuration));
...
let kinesis_data_stream_destination_to_yojson
  (x : kinesis_data_stream_destination) =
  assoc_to_yojson
    [("ApproximateCreationDateTimePrecision",
       (option_to_yojson approximate_creation_date_time_precision_to_yojson
          x.approximate_creation_date_time_precision));
...
let invalid_export_time_exception_to_yojson
  (x : invalid_export_time_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let import_table_description_to_yojson (x : import_table_description) =
  assoc_to_yojson
    ...
    ("TableCreationParameters",
      (option_to_yojson table_creation_parameters_to_yojson
         x.table_creation_parameters));
    ("InputCompressionType",
      (option_to_yojson input_compression_type_to_yojson
         x.input_compression_type));
    ("InputFormatOptions",
...
let import_table_input_to_yojson (x : import_table_input) =
  assoc_to_yojson
    [("TableCreationParameters",
       (Some
          (table_creation_parameters_to_yojson x.table_creation_parameters)));
    ("InputCompressionType",
      (option_to_yojson input_compression_type_to_yojson
         x.input_compression_type));
    ("InputFormatOptions",
...
let global_table_already_exists_exception_to_yojson
  (x : global_table_already_exists_exception) =
  assoc_to_yojson
    [("message", (option_to_yojson error_message_to_yojson x.message))]
...
let failure_exception_to_yojson (x : failure_exception) =
  assoc_to_yojson
    [("ExceptionDescription",
       (option_to_yojson exception_description_to_yojson
          x.exception_description));
    ("ExceptionName",
...
let describe_table_output_to_yojson (x : describe_table_output) =
  assoc_to_yojson
    [("Table", (option_to_yojson table_description_to_yojson x.table))]
...
let describe_limits_output_to_yojson (x : describe_limits_output) =
  assoc_to_yojson
    [("TableMaxWriteCapacityUnits",
       (option_to_yojson positive_long_object_to_yojson
          x.table_max_write_capacity_units));
    ("TableMaxReadCapacityUnits",
      (option_to_yojson positive_long_object_to_yojson
         x.table_max_read_capacity_units));
    ("AccountMaxWriteCapacityUnits",
      (option_to_yojson positive_long_object_to_yojson
         x.account_max_write_capacity_units));
...
let describe_global_table_settings_output_to_yojson
  (x : describe_global_table_settings_output) =
  assoc_to_yojson
    [("ReplicaSettings",
       (option_to_yojson replica_settings_description_list_to_yojson
          x.replica_settings));
...
let describe_global_table_settings_input_to_yojson
  (x : describe_global_table_settings_input) =
  assoc_to_yojson
    [("GlobalTableName", (Some (table_name_to_yojson x.global_table_name)))]
...
let describe_contributor_insights_output_to_yojson
  (x : describe_contributor_insights_output) =
  assoc_to_yojson
    [("FailureException",
       (option_to_yojson failure_exception_to_yojson x.failure_exception));
    ("LastUpdateDateTime",
      (option_to_yojson last_update_date_time_to_yojson
         x.last_update_date_time));
    ("ContributorInsightsStatus",
      (option_to_yojson contributor_insights_status_to_yojson
         x.contributor_insights_status));
    ("ContributorInsightsRuleList",
      (option_to_yojson contributor_insights_rule_list_to_yojson
         x.contributor_insights_rule_list));
    ("IndexName", (option_to_yojson index_name_to_yojson x.index_name));
    ("TableName", (option_to_yojson table_name_to_yojson x.table_name))]
let describe_contributor_insights_input_to_yojson
  (x : describe_contributor_insights_input) =
  assoc_to_yojson
    [("IndexName", (option_to_yojson index_name_to_yojson x.index_name));
    ("TableName", (Some (table_arn_to_yojson x.table_name)))]
let describe_continuous_backups_output_to_yojson
  (x : describe_continuous_backups_output) =
  assoc_to_yojson
    [("ContinuousBackupsDescription",
       (option_to_yojson continuous_backups_description_to_yojson
          x.continuous_backups_description))]
let describe_continuous_backups_input_to_yojson
  (x : describe_continuous_backups_input) =
  assoc_to_yojson [("TableName", (Some (table_arn_to_yojson x.table_name)))]
...
let backup_description_to_yojson (x : backup_description) =
  assoc_to_yojson
    [("SourceTableFeatureDetails",
       (option_to_yojson source_table_feature_details_to_yojson
          x.source_table_feature_details));
    ("SourceTableDetails",
...
let delete_resource_policy_output_to_yojson
  (x : delete_resource_policy_output) =
  assoc_to_yojson
    [("RevisionId",
       (option_to_yojson policy_revision_id_to_yojson x.revision_id))]
  ...
  assoc_to_yojson
    ...
    ("ItemCollectionMetrics",
      (option_to_yojson item_collection_metrics_per_table_to_yojson
         x.item_collection_metrics));
    ("UnprocessedItems",
      (option_to_yojson batch_write_item_request_map_to_yojson
         x.unprocessed_items))]
...
let batch_execute_statement_output_to_yojson
  (x : batch_execute_statement_output) =
  assoc_to_yojson
    [("ConsumedCapacity",
       (option_to_yojson consumed_capacity_multiple_to_yojson
          x.consumed_capacity));
...
let batch_execute_statement_input_to_yojson
  (x : batch_execute_statement_input) =
  assoc_to_yojson
    [("ReturnConsumedCapacity",
       (option_to_yojson return_consumed_capacity_to_yojson
          x.return_consumed_capacity));
