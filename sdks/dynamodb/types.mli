...
type nonrec scalar_attribute_type = B [@ocaml.doc ""] | N [@ocaml.doc ""] | S [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec billing_mode = PAY_PER_REQUEST [@ocaml.doc ""] | PROVISIONED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec table_class = STANDARD_INFREQUENT_ACCESS [@ocaml.doc ""] | STANDARD [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec sse_type = KMS [@ocaml.doc ""] | AES256 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec multi_region_consistency = STRONG [@ocaml.doc ""] | EVENTUAL [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec attribute_action = DELETE [@ocaml.doc ""] | PUT [@ocaml.doc ""] | ADD [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec conditional_operator = OR [@ocaml.doc ""] | AND [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec return_item_collection_metrics = NONE [@ocaml.doc ""] | SIZE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec contributor_insights_action = DISABLE [@ocaml.doc ""] | ENABLE [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec continuous_backups_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec point_in_time_recovery_status = DISABLED [@ocaml.doc ""] | ENABLED [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec s3_sse_algorithm = KMS [@ocaml.doc ""] | AES256 [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec export_type = INCREMENTAL_EXPORT [@ocaml.doc ""] | FULL_EXPORT [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec export_view_type = NEW_AND_OLD_IMAGES [@ocaml.doc ""] | NEW_IMAGE [@ocaml.doc ""]
[@@ocaml.doc ""]
