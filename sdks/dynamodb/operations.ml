  ...
  struct
    ...
    let request context (request : batch_execute_statement_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.BatchExecuteStatement" ~service
        ~context ~input
...
module BatchGetItem =
  struct
    ...
    let request context (request : batch_get_item_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.BatchGetItem" ~service ~context ~input
...
module BatchWriteItem =
  struct
    ...
    let request context (request : batch_write_item_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.BatchWriteItem" ~service ~context
        ~input
...
module CreateBackup =
  struct
    ...
    let request context (request : create_backup_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.CreateBackup" ~service ~context ~input
...
module CreateGlobalTable =
  struct
    ...
    let request context (request : create_global_table_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.CreateGlobalTable" ~service ~context
        ~input
...
module CreateTable =
  struct
    ...
    let request context (request : create_table_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.CreateTable" ~service ~context ~input
...
module DeleteBackup =
  struct
    ...
    let request context (request : delete_backup_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DeleteBackup" ~service ~context ~input
...
module DeleteItem =
  struct
    ...
    let request context (request : delete_item_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DeleteItem" ~service ~context ~input
...
module DeleteResourcePolicy =
  struct
    ...
    let request context (request : delete_resource_policy_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DeleteResourcePolicy" ~service
        ~context ~input
...
module DeleteTable =
  struct
    ...
    let request context (request : delete_table_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DeleteTable" ~service ~context ~input
...
module DescribeBackup =
  struct
    ...
    let request context (request : describe_backup_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeBackup" ~service ~context
        ~input
...
module DescribeContinuousBackups =
  struct
    ...
    let request context (request : describe_continuous_backups_input) =
      let input =
        Json_serializers.describe_continuous_backups_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeContinuousBackups" ~service
        ~context ~input
    ...
    let request context (request : describe_contributor_insights_input) =
      let input =
        Json_serializers.describe_contributor_insights_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeContributorInsights" ~service
        ~context ~input
...
module DescribeEndpoints =
  struct
    ...
    let request context (request : describe_endpoints_request) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeEndpoints" ~service ~context
        ~input
...
module DescribeExport =
  struct
    ...
    let request context (request : describe_export_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeExport" ~service ~context
        ~input
...
module DescribeGlobalTable =
  struct
    ...
    let request context (request : describe_global_table_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeGlobalTable" ~service ~context
        ~input
    ...
    let request context (request : describe_global_table_settings_input) =
      let input =
        Json_serializers.describe_global_table_settings_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeGlobalTableSettings" ~service
        ~context ~input
...
module DescribeImport =
  struct
    ...
    let request context (request : describe_import_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeImport" ~service ~context
        ~input
...
module DescribeLimits =
  struct
    ...
    let request context (request : describe_limits_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeLimits" ~service ~context
        ~input
...
module DescribeTable =
  struct
    ...
    let request context (request : describe_table_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeTable" ~service ~context
        ~input
...
module DescribeTimeToLive =
  struct
    ...
    let request context (request : describe_time_to_live_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.DescribeTimeToLive" ~service ~context
        ~input
...
module ExecuteStatement =
  struct
    ...
    let request context (request : execute_statement_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ExecuteStatement" ~service ~context
        ~input
...
module ExecuteTransaction =
  struct
    ...
    let request context (request : execute_transaction_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ExecuteTransaction" ~service ~context
        ~input
    ...
    let request context (request : export_table_to_point_in_time_input) =
      let input =
        Json_serializers.export_table_to_point_in_time_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ExportTableToPointInTime" ~service
        ~context ~input
...
module GetItem =
  struct
    ...
    let request context (request : get_item_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.GetItem" ~service ~context ~input
...
module GetResourcePolicy =
  struct
    ...
    let request context (request : get_resource_policy_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.GetResourcePolicy" ~service ~context
        ~input
...
module ImportTable =
  struct
    ...
    let request context (request : import_table_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ImportTable" ~service ~context ~input
...
module ListBackups =
  struct
    ...
    let request context (request : list_backups_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ListBackups" ~service ~context ~input
...
module ListContributorInsights =
  struct
    ...
    let request context (request : list_contributor_insights_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ListContributorInsights" ~service
        ~context ~input
...
module ListExports =
  struct
    ...
    let request context (request : list_exports_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ListExports" ~service ~context ~input
...
module ListGlobalTables =
  struct
    ...
    let request context (request : list_global_tables_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ListGlobalTables" ~service ~context
        ~input
...
module ListImports =
  struct
    ...
    let request context (request : list_imports_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ListImports" ~service ~context ~input
...
module ListTables =
  struct
    ...
    let request context (request : list_tables_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ListTables" ~service ~context ~input
...
module ListTagsOfResource =
  struct
    ...
    let request context (request : list_tags_of_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.ListTagsOfResource" ~service ~context
        ~input
...
module PutItem =
  struct
    ...
    let request context (request : put_item_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.PutItem" ~service ~context ~input
...
module PutResourcePolicy =
  struct
    ...
    let request context (request : put_resource_policy_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.PutResourcePolicy" ~service ~context
        ~input
...
module Query =
  struct
    ...
    let request context (request : query_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.Query" ~service ~context ~input
...
module RestoreTableFromBackup =
  struct
    ...
    let request context (request : restore_table_from_backup_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.RestoreTableFromBackup" ~service
        ~context ~input
    ...
    let request context (request : restore_table_to_point_in_time_input) =
      let input =
        Json_serializers.restore_table_to_point_in_time_input_to_yojson
          request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.RestoreTableToPointInTime" ~service
        ~context ~input
...
module Scan =
  struct
    ...
    let request context (request : scan_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.Scan" ~service ~context ~input
...
module TagResource =
  struct
    ...
    let request context (request : tag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.TagResource" ~service ~context ~input
...
module TransactGetItems =
  struct
    ...
    let request context (request : transact_get_items_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.TransactGetItems" ~service ~context
        ~input
...
module TransactWriteItems =
  struct
    ...
    let request context (request : transact_write_items_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.TransactWriteItems" ~service ~context
        ~input
...
module UntagResource =
  struct
    ...
    let request context (request : untag_resource_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.UntagResource" ~service ~context
        ~input
        ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
        ~error_deserializer
  end
module UpdateContinuousBackups =
  struct
    ...
    let request context (request : update_continuous_backups_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.UpdateContinuousBackups" ~service
        ~context ~input
...
module UpdateContributorInsights =
  struct
    ...
    let request context (request : update_contributor_insights_input) =
      let input =
        Json_serializers.update_contributor_insights_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.UpdateContributorInsights" ~service
        ~context ~input
...
module UpdateGlobalTable =
  struct
    ...
    let request context (request : update_global_table_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.UpdateGlobalTable" ~service ~context
        ~input
...
module UpdateGlobalTableSettings =
  struct
    ...
    let request context (request : update_global_table_settings_input) =
      let input =
        Json_serializers.update_global_table_settings_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.UpdateGlobalTableSettings" ~service
        ~context ~input
...
module UpdateItem =
  struct
    ...
    let request context (request : update_item_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.UpdateItem" ~service ~context ~input
...
module UpdateTable =
  struct
    ...
    let request context (request : update_table_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.UpdateTable" ~service ~context ~input
...
module UpdateTimeToLive =
  struct
    ...
    let request context (request : update_time_to_live_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"DynamoDB_20120810.UpdateTimeToLive" ~service ~context
        ~input
