...
let put_request_of_yojson tree path =
  ...
  let _res : put_request =
    {
      item =
        (value_for_key put_item_input_attribute_map_of_yojson "Item" _list
           path)
    } in
  _res
...
let delete_request_of_yojson tree path =
  ...
  let _res : delete_request =
    { key = (value_for_key key_of_yojson "Key" _list path) } in
  _res
  ...
  let _res : write_request =
    {
      delete_request =
        (option_of_yojson
           (value_for_key delete_request_of_yojson "DeleteRequest") _list
           path);
      put_request =
        (option_of_yojson (value_for_key put_request_of_yojson "PutRequest")
           _list path)
    } in
  _res
  ...
  let _res : time_to_live_specification =
    {
      attribute_name =
        (value_for_key time_to_live_attribute_name_of_yojson "AttributeName"
           _list path);
      enabled =
        (value_for_key time_to_live_enabled_of_yojson "Enabled" _list path)
    } in
  _res
  ...
  let _res : update_time_to_live_output =
    {
      time_to_live_specification =
        (option_of_yojson
           (value_for_key time_to_live_specification_of_yojson
              "TimeToLiveSpecification") _list path)
    } in
  _res
...
let auto_scaling_target_tracking_scaling_policy_configuration_description_of_yojson
  tree path =
  let _list = assoc_of_yojson tree path in
  let _res
  ...
  let _res : auto_scaling_policy_description =
    {
      ...
      policy_name =
        (option_of_yojson
           (value_for_key auto_scaling_policy_name_of_yojson "PolicyName")
           _list path)
    } in
  _res
  ...
  let _res : auto_scaling_settings_description =
    {
      scaling_policies =
        (option_of_yojson
           (value_for_key auto_scaling_policy_description_list_of_yojson
              "ScalingPolicies") _list path);
      auto_scaling_role_arn =
        (option_of_yojson
           (value_for_key string__of_yojson "AutoScalingRoleArn") _list path);
      ...
      maximum_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson "MaximumUnits")
           _list path);
      minimum_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson "MinimumUnits")
           _list path)
    } in
  _res
let replica_global_secondary_index_auto_scaling_description_of_yojson tree
  path =
  let _list = assoc_of_yojson tree path in
      ...
      provisioned_write_capacity_auto_scaling_settings =
        (option_of_yojson
           (value_for_key auto_scaling_settings_description_of_yojson
              "ProvisionedWriteCapacityAutoScalingSettings") _list path);
      provisioned_read_capacity_auto_scaling_settings =
        (option_of_yojson
           (value_for_key auto_scaling_settings_description_of_yojson
              "ProvisionedReadCapacityAutoScalingSettings") _list path);
      index_status =
        (option_of_yojson
           (value_for_key index_status_of_yojson "IndexStatus") _list path);
      index_name =
        (option_of_yojson (value_for_key index_name_of_yojson "IndexName")
           _list path)
    } in
  _res
  ...
  let _res : replica_auto_scaling_description =
    {
      replica_status =
        (option_of_yojson
           (value_for_key replica_status_of_yojson "ReplicaStatus") _list
           path);
      replica_provisioned_write_capacity_auto_scaling_settings =
        (option_of_yojson
           (value_for_key auto_scaling_settings_description_of_yojson
              "ReplicaProvisionedWriteCapacityAutoScalingSettings") _list
           path);
      replica_provisioned_read_capacity_auto_scaling_settings =
        (option_of_yojson
           (value_for_key auto_scaling_settings_description_of_yojson
              "ReplicaProvisionedReadCapacityAutoScalingSettings") _list path);
      global_secondary_indexes =
        (option_of_yojson
           (value_for_key
              replica_global_secondary_index_auto_scaling_description_list_of_yojson
  ...
  let _res : table_auto_scaling_description =
    {
      replicas =
        (option_of_yojson
           (value_for_key replica_auto_scaling_description_list_of_yojson
              "Replicas") _list path);
      table_status =
        (option_of_yojson
           (value_for_key table_status_of_yojson "TableStatus") _list path);
      table_name =
  ...
  let _res : update_table_replica_auto_scaling_output =
    {
      table_auto_scaling_description =
        (option_of_yojson
           (value_for_key table_auto_scaling_description_of_yojson
              "TableAutoScalingDescription") _list path)
    } in
  _res
let auto_scaling_role_arn_of_yojson = string_of_yojson
let auto_scaling_target_tracking_scaling_policy_configuration_update_of_yojson
  tree path =
  let _list = assoc_of_yojson tree path in
  ...
  let _res : auto_scaling_settings_update =
    {
      scaling_policy_update =
        (option_of_yojson
           (value_for_key auto_scaling_policy_update_of_yojson
              "ScalingPolicyUpdate") _list path);
      auto_scaling_role_arn =
        (option_of_yojson
           (value_for_key auto_scaling_role_arn_of_yojson
              "AutoScalingRoleArn") _list path);
      auto_scaling_disabled =
        (option_of_yojson
           (value_for_key boolean_object_of_yojson "AutoScalingDisabled")
           _list path);
      ...
      provisioned_write_capacity_auto_scaling_update =
        (option_of_yojson
           (value_for_key auto_scaling_settings_update_of_yojson
              "ProvisionedWriteCapacityAutoScalingUpdate") _list path);
      index_name =
        (option_of_yojson (value_for_key index_name_of_yojson "IndexName")
           _list path)
    } in
...
let global_secondary_index_auto_scaling_update_list_of_yojson tree path =
  list_of_yojson global_secondary_index_auto_scaling_update_of_yojson tree
    path
  ...
  let _res : replica_global_secondary_index_auto_scaling_update =
    {
      provisioned_read_capacity_auto_scaling_update =
        (option_of_yojson
           (value_for_key auto_scaling_settings_update_of_yojson
              "ProvisionedReadCapacityAutoScalingUpdate") _list path);
      index_name =
        (option_of_yojson (value_for_key index_name_of_yojson "IndexName")
           _list path)
    } in
  _res
let replica_global_secondary_index_auto_scaling_update_list_of_yojson tree
  path =
  list_of_yojson replica_global_secondary_index_auto_scaling_update_of_yojson
    tree path
  ...
  let _res : replica_auto_scaling_update =
    {
      replica_provisioned_read_capacity_auto_scaling_update =
        (option_of_yojson
           (value_for_key auto_scaling_settings_update_of_yojson
              "ReplicaProvisionedReadCapacityAutoScalingUpdate") _list path);
      replica_global_secondary_index_updates =
        (option_of_yojson
           (value_for_key
              replica_global_secondary_index_auto_scaling_update_list_of_yojson
              "ReplicaGlobalSecondaryIndexUpdates") _list path);
      region_name =
  ...
  let _res : update_table_replica_auto_scaling_input =
    {
      replica_updates =
        (option_of_yojson
           (value_for_key replica_auto_scaling_update_list_of_yojson
              "ReplicaUpdates") _list path);
      provisioned_write_capacity_auto_scaling_update =
        (option_of_yojson
           (value_for_key auto_scaling_settings_update_of_yojson
              "ProvisionedWriteCapacityAutoScalingUpdate") _list path);
      ...
      global_secondary_index_updates =
        (option_of_yojson
           (value_for_key
              global_secondary_index_auto_scaling_update_list_of_yojson
              "GlobalSecondaryIndexUpdates") _list path)
    } in
  _res
...
let attribute_definition_of_yojson tree path =
  ...
  let _res : attribute_definition =
    {
      attribute_type =
        (value_for_key scalar_attribute_type_of_yojson "AttributeType" _list
           path);
      attribute_name =
  ...
  let _res : provisioned_throughput_description =
    {
      write_capacity_units =
        (option_of_yojson
           (value_for_key non_negative_long_object_of_yojson
              "WriteCapacityUnits") _list path);
      read_capacity_units =
        (option_of_yojson
           (value_for_key non_negative_long_object_of_yojson
              "ReadCapacityUnits") _list path);
      number_of_decreases_today =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "NumberOfDecreasesToday") _list path);
      last_decrease_date_time =
        (option_of_yojson
           (value_for_key date_of_yojson "LastDecreaseDateTime") _list path);
  ...
  let _res : billing_mode_summary =
    {
      ...
      billing_mode =
        (option_of_yojson
           (value_for_key billing_mode_of_yojson "BillingMode") _list path)
    } in
  _res
  ...
  let _res : projection =
    {
      non_key_attributes =
        (option_of_yojson
           (value_for_key non_key_attribute_name_list_of_yojson
              "NonKeyAttributes") _list path);
      projection_type =
        (option_of_yojson
           (value_for_key projection_type_of_yojson "ProjectionType") _list
           path)
    } in
  _res
let local_secondary_index_description_of_yojson tree path =
  ...
  let _res : local_secondary_index_description =
    {
      index_arn =
        (option_of_yojson (value_for_key string__of_yojson "IndexArn") _list
           path);
      item_count =
        (option_of_yojson (value_for_key long_object_of_yojson "ItemCount")
           _list path);
      index_size_bytes =
        (option_of_yojson
           (value_for_key long_object_of_yojson "IndexSizeBytes") _list path);
      projection =
        (option_of_yojson (value_for_key projection_of_yojson "Projection")
           _list path);
      key_schema =
  ...
  let _res : on_demand_throughput =
    {
      max_write_request_units =
        (option_of_yojson
           (value_for_key long_object_of_yojson "MaxWriteRequestUnits") _list
           path);
  ...
  let _res : global_secondary_index_description =
    {
      ...
      provisioned_throughput =
        (option_of_yojson
           (value_for_key provisioned_throughput_description_of_yojson
              "ProvisionedThroughput") _list path);
      backfilling =
        (option_of_yojson (value_for_key backfilling_of_yojson "Backfilling")
           _list path);
      index_status =
        (option_of_yojson
           (value_for_key index_status_of_yojson "IndexStatus") _list path);
  ...
  let _res : stream_specification =
    {
      stream_view_type =
        (option_of_yojson
           ...
           path);
      stream_enabled =
        (value_for_key stream_enabled_of_yojson "StreamEnabled" _list path)
    } in
  _res
      ...
      on_demand_throughput_override =
        (option_of_yojson
           (value_for_key on_demand_throughput_override_of_yojson
              "OnDemandThroughputOverride") _list path);
      provisioned_throughput_override =
        (option_of_yojson
           (value_for_key provisioned_throughput_override_of_yojson
              "ProvisionedThroughputOverride") _list path);
      index_name =
        (option_of_yojson (value_for_key index_name_of_yojson "IndexName")
           _list path)
    } in
  ...
  let _res : table_class_summary =
    {
      last_update_date_time =
        (option_of_yojson (value_for_key date_of_yojson "LastUpdateDateTime")
           _list path);
      table_class =
        (option_of_yojson (value_for_key table_class_of_yojson "TableClass")
           _list path)
    } in
  _res
  ...
  let _res : replica_description =
    {
      replica_table_class_summary =
        (option_of_yojson
           (value_for_key table_class_summary_of_yojson
              "ReplicaTableClassSummary") _list path);
      replica_inaccessible_date_time =
        (option_of_yojson
           (value_for_key date_of_yojson "ReplicaInaccessibleDateTime") _list
           path);
      global_secondary_indexes =
        (option_of_yojson
           (value_for_key
      ...
      kms_master_key_id =
        (option_of_yojson
           (value_for_key kms_master_key_id_of_yojson "KMSMasterKeyId") _list
           path);
      replica_status_percent_progress =
        (option_of_yojson
           (value_for_key replica_status_percent_progress_of_yojson
              "ReplicaStatusPercentProgress") _list path);
      replica_status_description =
        (option_of_yojson
           (value_for_key replica_status_description_of_yojson
              "ReplicaStatusDescription") _list path);
      replica_status =
        (option_of_yojson
           (value_for_key replica_status_of_yojson "ReplicaStatus") _list
           path);
...
let restore_summary_of_yojson tree path =
  ...
  let _res : restore_summary =
    {
      restore_in_progress =
        (value_for_key restore_in_progress_of_yojson "RestoreInProgress"
           _list path);
      restore_date_time =
        (value_for_key date_of_yojson "RestoreDateTime" _list path);
      source_table_arn =
        (option_of_yojson
           (value_for_key table_arn_of_yojson "SourceTableArn") _list path);
      source_backup_arn =
        (option_of_yojson
  ...
  let _res : sse_description =
    {
      inaccessible_encryption_date_time =
        (option_of_yojson
           (value_for_key date_of_yojson "InaccessibleEncryptionDateTime")
           _list path);
      kms_master_key_arn =
        (option_of_yojson
           (value_for_key kms_master_key_arn_of_yojson "KMSMasterKeyArn")
           _list path);
      sse_type =
        (option_of_yojson (value_for_key sse_type_of_yojson "SSEType") _list
           path);
      status =
        (option_of_yojson (value_for_key sse_status_of_yojson "Status") _list
           path)
    } in
  _res
  ...
  let _res : archival_summary =
    {
      archival_backup_arn =
        (option_of_yojson
           (value_for_key backup_arn_of_yojson "ArchivalBackupArn") _list
           path);
      archival_reason =
        (option_of_yojson
           (value_for_key archival_reason_of_yojson "ArchivalReason") _list
           path);
      archival_date_time =
        (option_of_yojson (value_for_key date_of_yojson "ArchivalDateTime")
           _list path)
    } in
  _res
  ...
  let _res : table_description =
    {
      ...
      table_class_summary =
        (option_of_yojson
           (value_for_key table_class_summary_of_yojson "TableClassSummary")
           _list path);
      archival_summary =
        (option_of_yojson
           (value_for_key archival_summary_of_yojson "ArchivalSummary") _list
           path);
      sse_description =
        (option_of_yojson
           (value_for_key sse_description_of_yojson "SSEDescription") _list
           path);
      restore_summary =
        (option_of_yojson
      ...
      replicas =
        (option_of_yojson
           (value_for_key replica_description_list_of_yojson "Replicas")
           _list path);
      global_table_version =
        (option_of_yojson
           (value_for_key string__of_yojson "GlobalTableVersion") _list path);
      latest_stream_arn =
        (option_of_yojson
           (value_for_key stream_arn_of_yojson "LatestStreamArn") _list path);
      latest_stream_label =
        (option_of_yojson
           (value_for_key string__of_yojson "LatestStreamLabel") _list path);
      stream_specification =
        (option_of_yojson
           (value_for_key stream_specification_of_yojson
              "StreamSpecification") _list path);
      global_secondary_indexes =
        (option_of_yojson
           (value_for_key global_secondary_index_description_list_of_yojson
              "GlobalSecondaryIndexes") _list path);
      local_secondary_indexes =
        (option_of_yojson
           (value_for_key local_secondary_index_description_list_of_yojson
              "LocalSecondaryIndexes") _list path);
      billing_mode_summary =
        (option_of_yojson
           (value_for_key billing_mode_summary_of_yojson "BillingModeSummary")
           _list path);
      table_id =
        (option_of_yojson (value_for_key table_id_of_yojson "TableId") _list
           path);
      table_arn =
        (option_of_yojson (value_for_key string__of_yojson "TableArn") _list
           path);
      item_count =
        (option_of_yojson (value_for_key long_object_of_yojson "ItemCount")
           _list path);
      table_size_bytes =
        (option_of_yojson
           (value_for_key long_object_of_yojson "TableSizeBytes") _list path);
      provisioned_throughput =
        (option_of_yojson
           (value_for_key provisioned_throughput_description_of_yojson
              "ProvisionedThroughput") _list path);
      creation_date_time =
        (option_of_yojson (value_for_key date_of_yojson "CreationDateTime")
           _list path);
      table_status =
        (option_of_yojson
           (value_for_key table_status_of_yojson "TableStatus") _list path);
      ...
      attribute_definitions =
        (option_of_yojson
           (value_for_key attribute_definitions_of_yojson
  ...
  let _res : update_table_output =
    {
      table_description =
        (option_of_yojson
           (value_for_key table_description_of_yojson "TableDescription")
           _list path)
    } in
  _res
let provisioned_throughput_of_yojson tree path =
  ...
  let _res : provisioned_throughput =
    {
      write_capacity_units =
        (value_for_key positive_long_object_of_yojson "WriteCapacityUnits"
           _list path);
      read_capacity_units =
        (value_for_key positive_long_object_of_yojson "ReadCapacityUnits"
           _list path)
  ...
  let _res : update_global_secondary_index_action =
    {
      ...
      provisioned_throughput =
        (option_of_yojson
           (value_for_key provisioned_throughput_of_yojson
              "ProvisionedThroughput") _list path);
      index_name =
        (value_for_key index_name_of_yojson "IndexName" _list path)
    } in
  _res
      ...
      provisioned_throughput =
        (option_of_yojson
           (value_for_key provisioned_throughput_of_yojson
              "ProvisionedThroughput") _list path);
      projection =
        (value_for_key projection_of_yojson "Projection" _list path);
      key_schema =
        (value_for_key key_schema_of_yojson "KeySchema" _list path);
      index_name =
        (value_for_key index_name_of_yojson "IndexName" _list path)
    } in
  _res
  ...
  let _res : global_secondary_index_update =
    {
      delete =
        (option_of_yojson
           (value_for_key delete_global_secondary_index_action_of_yojson
              "Delete") _list path);
      create =
        (option_of_yojson
           (value_for_key create_global_secondary_index_action_of_yojson
              "Create") _list path);
      update =
        (option_of_yojson
           (value_for_key update_global_secondary_index_action_of_yojson
              "Update") _list path)
    } in
  _res
  ...
  let _res : sse_specification =
    {
      ...
      sse_type =
        (option_of_yojson (value_for_key sse_type_of_yojson "SSEType") _list
           path);
      enabled =
        (option_of_yojson (value_for_key sse_enabled_of_yojson "Enabled")
           _list path)
    } in
  _res
  ...
  let _res : create_replication_group_member_action =
    {
      table_class_override =
        (option_of_yojson
           (value_for_key table_class_of_yojson "TableClassOverride") _list
           path);
      global_secondary_indexes =
        (option_of_yojson
           (value_for_key replica_global_secondary_index_list_of_yojson
              "GlobalSecondaryIndexes") _list path);
      on_demand_throughput_override =
        (option_of_yojson
           (value_for_key on_demand_throughput_override_of_yojson
  ...
  let _res : replication_group_update =
    {
      delete =
        (option_of_yojson
           (value_for_key delete_replication_group_member_action_of_yojson
              "Delete") _list path);
      update =
        (option_of_yojson
           (value_for_key update_replication_group_member_action_of_yojson
              "Update") _list path);
      create =
        (option_of_yojson
           (value_for_key create_replication_group_member_action_of_yojson
              "Create") _list path)
    } in
  _res
  ...
  let _res : update_table_input =
    {
      ...
      replica_updates =
        (option_of_yojson
           (value_for_key replication_group_update_list_of_yojson
              "ReplicaUpdates") _list path);
      sse_specification =
        (option_of_yojson
           (value_for_key sse_specification_of_yojson "SSESpecification")
           _list path);
      stream_specification =
        (option_of_yojson
           (value_for_key stream_specification_of_yojson
      ...
      global_secondary_index_updates =
        (option_of_yojson
           (value_for_key global_secondary_index_update_list_of_yojson
              "GlobalSecondaryIndexUpdates") _list path);
      provisioned_throughput =
        (option_of_yojson
           (value_for_key provisioned_throughput_of_yojson
      ...
      approximate_creation_date_time_precision =
        (option_of_yojson
           (value_for_key approximate_creation_date_time_precision_of_yojson
              "ApproximateCreationDateTimePrecision") _list path)
    } in
  _res
      ...
      update_kinesis_streaming_configuration =
        (option_of_yojson
           (value_for_key update_kinesis_streaming_configuration_of_yojson
              "UpdateKinesisStreamingConfiguration") _list path);
      destination_status =
        (option_of_yojson
           (value_for_key destination_status_of_yojson "DestinationStatus")
           _list path);
      stream_arn =
  ...
  let _res : capacity =
    {
      capacity_units =
        (option_of_yojson
           (value_for_key consumed_capacity_units_of_yojson "CapacityUnits")
           _list path);
      write_capacity_units =
        (option_of_yojson
           (value_for_key consumed_capacity_units_of_yojson
              "WriteCapacityUnits") _list path);
      read_capacity_units =
        (option_of_yojson
           (value_for_key consumed_capacity_units_of_yojson
  ...
  let _res : consumed_capacity =
    {
      global_secondary_indexes =
        (option_of_yojson
           (value_for_key secondary_indexes_capacity_map_of_yojson
              "GlobalSecondaryIndexes") _list path);
      local_secondary_indexes =
        (option_of_yojson
           (value_for_key secondary_indexes_capacity_map_of_yojson
              "LocalSecondaryIndexes") _list path);
      table =
        (option_of_yojson (value_for_key capacity_of_yojson "Table") _list
           path);
      write_capacity_units =
        (option_of_yojson
           (value_for_key consumed_capacity_units_of_yojson
      ...
      capacity_units =
        (option_of_yojson
           ...
           _list path);
      table_name =
        (option_of_yojson (value_for_key table_arn_of_yojson "TableName")
           _list path)
    } in
  _res
  ...
  let _res : item_collection_metrics =
    {
      size_estimate_range_g_b =
        (option_of_yojson
           (value_for_key item_collection_size_estimate_range_of_yojson
              "SizeEstimateRangeGB") _list path);
      item_collection_key =
        (option_of_yojson
           (value_for_key item_collection_key_attribute_map_of_yojson
              "ItemCollectionKey") _list path)
    } in
  _res
  ...
  let _res : update_item_output =
    {
      item_collection_metrics =
        (option_of_yojson
           (value_for_key item_collection_metrics_of_yojson
              "ItemCollectionMetrics") _list path);
      consumed_capacity =
        (option_of_yojson
           (value_for_key consumed_capacity_of_yojson "ConsumedCapacity")
           _list path);
      attributes =
        (option_of_yojson
           (value_for_key attribute_map_of_yojson "Attributes") _list path)
    } in
  _res
...
let attribute_value_update_of_yojson tree path =
  ...
  let _res : attribute_value_update =
    {
      action =
        (option_of_yojson (value_for_key attribute_action_of_yojson "Action")
           _list path);
      value =
  ...
  let _res : expected_attribute_value =
    {
      ...
      comparison_operator =
        (option_of_yojson
           ...
           _list path);
      exists =
        (option_of_yojson (value_for_key boolean_object_of_yojson "Exists")
           _list path);
      value =
        (option_of_yojson (value_for_key attribute_value_of_yojson "Value")
           _list path)
...
let expression_attribute_name_map_of_yojson tree path =
  map_of_yojson expression_attribute_name_variable_of_yojson
    attribute_name_of_yojson tree path
      ...
      return_values_on_condition_check_failure =
        (option_of_yojson
           (value_for_key return_values_on_condition_check_failure_of_yojson
              "ReturnValuesOnConditionCheckFailure") _list path);
      expression_attribute_values =
        (option_of_yojson
           (value_for_key expression_attribute_value_map_of_yojson
              "ExpressionAttributeValues") _list path);
      expression_attribute_names =
        (option_of_yojson
           (value_for_key expression_attribute_name_map_of_yojson
              "ExpressionAttributeNames") _list path);
      condition_expression =
        (option_of_yojson
           (value_for_key condition_expression_of_yojson
              "ConditionExpression") _list path);
      update_expression =
        (option_of_yojson
           (value_for_key update_expression_of_yojson "UpdateExpression")
           _list path);
      return_item_collection_metrics =
        (option_of_yojson
           (value_for_key return_item_collection_metrics_of_yojson
              "ReturnItemCollectionMetrics") _list path);
      return_consumed_capacity =
        (option_of_yojson
           (value_for_key return_consumed_capacity_of_yojson
              "ReturnConsumedCapacity") _list path);
      return_values =
        (option_of_yojson
           (value_for_key return_value_of_yojson "ReturnValues") _list path);
      conditional_operator =
        (option_of_yojson
           (value_for_key conditional_operator_of_yojson
              "ConditionalOperator") _list path);
      expected =
        (option_of_yojson
           (value_for_key expected_attribute_map_of_yojson "Expected") _list
           path);
      attribute_updates =
        (option_of_yojson
           (value_for_key attribute_updates_of_yojson "AttributeUpdates")
           _list path);
...
let conditional_check_failed_exception_of_yojson tree path =
  ...
  let _res : conditional_check_failed_exception =
    {
      item =
        (option_of_yojson (value_for_key attribute_map_of_yojson "Item")
           _list path);
      message =
        (option_of_yojson (value_for_key error_message_of_yojson "message")
           _list path)
...
let replica_global_secondary_index_settings_description_of_yojson tree path =
  ...
  let _res : replica_global_secondary_index_settings_description =
    {
      ...
      provisioned_write_capacity_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "ProvisionedWriteCapacityUnits") _list path);
      provisioned_read_capacity_auto_scaling_settings =
        (option_of_yojson
           (value_for_key auto_scaling_settings_description_of_yojson
              "ProvisionedReadCapacityAutoScalingSettings") _list path);
      provisioned_read_capacity_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "ProvisionedReadCapacityUnits") _list path);
      index_status =
        (option_of_yojson
           (value_for_key index_status_of_yojson "IndexStatus") _list path);
      index_name =
  ...
  _res
let replica_global_secondary_index_settings_description_list_of_yojson tree
  path =
  list_of_yojson
    replica_global_secondary_index_settings_description_of_yojson tree path
  ...
  let _res : replica_settings_description =
    {
      ...
      replica_global_secondary_index_settings =
        (option_of_yojson
           (value_for_key
              replica_global_secondary_index_settings_description_list_of_yojson
              "ReplicaGlobalSecondaryIndexSettings") _list path);
      replica_provisioned_write_capacity_auto_scaling_settings =
        (option_of_yojson
           (value_for_key auto_scaling_settings_description_of_yojson
              "ReplicaProvisionedWriteCapacityAutoScalingSettings") _list
      ...
      replica_provisioned_write_capacity_units =
        (option_of_yojson
           (value_for_key non_negative_long_object_of_yojson
              "ReplicaProvisionedWriteCapacityUnits") _list path);
      replica_provisioned_read_capacity_auto_scaling_settings =
        (option_of_yojson
           (value_for_key auto_scaling_settings_description_of_yojson
              "ReplicaProvisionedReadCapacityAutoScalingSettings") _list path);
      replica_provisioned_read_capacity_units =
        (option_of_yojson
           (value_for_key non_negative_long_object_of_yojson
              "ReplicaProvisionedReadCapacityUnits") _list path);
      replica_billing_mode_summary =
        (option_of_yojson
           (value_for_key billing_mode_summary_of_yojson
              "ReplicaBillingModeSummary") _list path);
      replica_status =
        (option_of_yojson
           (value_for_key replica_status_of_yojson "ReplicaStatus") _list
           path);
  ...
  let _res : update_global_table_settings_output =
    {
      replica_settings =
        (option_of_yojson
           (value_for_key replica_settings_description_list_of_yojson
              "ReplicaSettings") _list path);
      global_table_name =
        (option_of_yojson
           (value_for_key table_name_of_yojson "GlobalTableName") _list path)
    } in
  _res
let global_table_global_secondary_index_settings_update_of_yojson tree path =
  ...
  let _res : global_table_global_secondary_index_settings_update =
    {
      provisioned_write_capacity_auto_scaling_settings_update =
        (option_of_yojson
           (value_for_key auto_scaling_settings_update_of_yojson
              "ProvisionedWriteCapacityAutoScalingSettingsUpdate") _list path);
      provisioned_write_capacity_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "ProvisionedWriteCapacityUnits") _list path);
  ...
  _res
let global_table_global_secondary_index_settings_update_list_of_yojson tree
  path =
  list_of_yojson
    global_table_global_secondary_index_settings_update_of_yojson tree path
  ...
  let _res : replica_global_secondary_index_settings_update =
    {
      provisioned_read_capacity_auto_scaling_settings_update =
        (option_of_yojson
           (value_for_key auto_scaling_settings_update_of_yojson
              "ProvisionedReadCapacityAutoScalingSettingsUpdate") _list path);
      provisioned_read_capacity_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "ProvisionedReadCapacityUnits") _list path);
...
let replica_global_secondary_index_settings_update_list_of_yojson tree path =
  list_of_yojson replica_global_secondary_index_settings_update_of_yojson
    tree path
  ...
  let _res : replica_settings_update =
    {
      replica_table_class =
        (option_of_yojson
           (value_for_key table_class_of_yojson "ReplicaTableClass") _list
           path);
      replica_global_secondary_index_settings_update =
        (option_of_yojson
           (value_for_key
              replica_global_secondary_index_settings_update_list_of_yojson
              "ReplicaGlobalSecondaryIndexSettingsUpdate") _list path);
  ...
  let _res : update_global_table_settings_input =
    {
      replica_settings_update =
        (option_of_yojson
           (value_for_key replica_settings_update_list_of_yojson
              "ReplicaSettingsUpdate") _list path);
      global_table_global_secondary_index_settings_update =
        (option_of_yojson
           (value_for_key
              global_table_global_secondary_index_settings_update_list_of_yojson
              "GlobalTableGlobalSecondaryIndexSettingsUpdate") _list path);
      ...
      global_table_provisioned_write_capacity_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "GlobalTableProvisionedWriteCapacityUnits") _list path);
      global_table_billing_mode =
        (option_of_yojson
           (value_for_key billing_mode_of_yojson "GlobalTableBillingMode")
           _list path);
      global_table_name =
        (value_for_key table_name_of_yojson "GlobalTableName" _list path)
    } in
  ...
  let _res : global_table_description =
    {
      ...
      global_table_status =
        (option_of_yojson
           (value_for_key global_table_status_of_yojson "GlobalTableStatus")
           _list path);
      creation_date_time =
        (option_of_yojson (value_for_key date_of_yojson "CreationDateTime")
           _list path);
      ...
      replication_group =
        (option_of_yojson
           (value_for_key replica_description_list_of_yojson
              "ReplicationGroup") _list path)
    } in
  _res
  ...
  let _res : update_global_table_output =
    {
      global_table_description =
        (option_of_yojson
           (value_for_key global_table_description_of_yojson
              "GlobalTableDescription") _list path)
    } in
  _res
  ...
  let _res : replica_update =
    {
      delete =
        (option_of_yojson
           (value_for_key delete_replica_action_of_yojson "Delete") _list
           path);
      create =
        (option_of_yojson
           (value_for_key create_replica_action_of_yojson "Create") _list
           path)
    } in
  _res
let replica_update_list_of_yojson tree path =
  list_of_yojson replica_update_of_yojson tree path
let update_global_table_input_of_yojson tree path =
  let _list = assoc_of_yojson tree path in
  let _res : update_global_table_input =
    {
      replica_updates =
        (value_for_key replica_update_list_of_yojson "ReplicaUpdates" _list
           path);
      global_table_name =
        (value_for_key table_name_of_yojson "GlobalTableName" _list path)
    } in
  ...
  let _res : update_contributor_insights_output =
    {
      contributor_insights_status =
        (option_of_yojson
           (value_for_key contributor_insights_status_of_yojson
              "ContributorInsightsStatus") _list path);
      index_name =
        (option_of_yojson (value_for_key index_name_of_yojson "IndexName")
           _list path);
      table_name =
...
let update_contributor_insights_input_of_yojson tree path =
  ...
  let _res : update_contributor_insights_input =
    {
      contributor_insights_action =
        (value_for_key contributor_insights_action_of_yojson
           "ContributorInsightsAction" _list path);
      index_name =
        (option_of_yojson (value_for_key index_name_of_yojson "IndexName")
           _list path);
      table_name = (value_for_key table_arn_of_yojson "TableName" _list path)
  ...
  let _res : point_in_time_recovery_description =
    {
      latest_restorable_date_time =
        (option_of_yojson
           (value_for_key date_of_yojson "LatestRestorableDateTime") _list
           path);
      ...
      point_in_time_recovery_status =
        (option_of_yojson
           (value_for_key point_in_time_recovery_status_of_yojson
              "PointInTimeRecoveryStatus") _list path)
    } in
  _res
      ...
      point_in_time_recovery_description =
        (option_of_yojson
           (value_for_key point_in_time_recovery_description_of_yojson
              "PointInTimeRecoveryDescription") _list path);
      continuous_backups_status =
        (value_for_key continuous_backups_status_of_yojson
           "ContinuousBackupsStatus" _list path)
    } in
  _res
  ...
  let _res : update_continuous_backups_output =
    {
      continuous_backups_description =
        (option_of_yojson
           (value_for_key continuous_backups_description_of_yojson
              "ContinuousBackupsDescription") _list path)
    } in
  _res
  ...
  let _res : update =
    {
      ...
      table_name = (value_for_key table_arn_of_yojson "TableName" _list path);
      update_expression =
        (value_for_key update_expression_of_yojson "UpdateExpression" _list
           path);
      key = (value_for_key key_of_yojson "Key" _list path)
    } in
  _res
...
let tag_key_list_of_yojson tree path =
  list_of_yojson tag_key_string_of_yojson tree path
  ...
  let _res : cancellation_reason =
    {
      message =
        (option_of_yojson (value_for_key error_message_of_yojson "Message")
           _list path);
      code =
        (option_of_yojson (value_for_key code_of_yojson "Code") _list path);
      item =
        (option_of_yojson (value_for_key attribute_map_of_yojson "Item")
           _list path)
    } in
  ...
  let _res : transaction_canceled_exception =
    {
      cancellation_reasons =
        (option_of_yojson
           (value_for_key cancellation_reason_list_of_yojson
              "CancellationReasons") _list path);
      message =
        (option_of_yojson (value_for_key error_message_of_yojson "Message")
           _list path)
    } in
...
let item_collection_metrics_per_table_of_yojson tree path =
  map_of_yojson table_arn_of_yojson
    item_collection_metrics_multiple_of_yojson tree path
  ...
  let _res : transact_write_items_output =
    {
      item_collection_metrics =
        (option_of_yojson
           (value_for_key item_collection_metrics_per_table_of_yojson
              "ItemCollectionMetrics") _list path);
      consumed_capacity =
        (option_of_yojson
           (value_for_key consumed_capacity_multiple_of_yojson
              "ConsumedCapacity") _list path)
    } in
  _res
...
let transact_write_item_of_yojson tree path =
  ...
  let _res : transact_write_item =
    {
      update =
        (option_of_yojson (value_for_key update_of_yojson "Update") _list
           path);
      delete =
        (option_of_yojson (value_for_key delete_of_yojson "Delete") _list
           path);
      put = (option_of_yojson (value_for_key put_of_yojson "Put") _list path);
      condition_check =
        (option_of_yojson
           (value_for_key condition_check_of_yojson "ConditionCheck") _list
           path)
    } in
  _res
      ...
      return_consumed_capacity =
        (option_of_yojson
           (value_for_key return_consumed_capacity_of_yojson
              "ReturnConsumedCapacity") _list path);
      transact_items =
        (value_for_key transact_write_item_list_of_yojson "TransactItems"
           _list path)
    } in
  _res
...
let item_response_of_yojson tree path =
  ...
  _res
let item_response_list_of_yojson tree path =
  list_of_yojson item_response_of_yojson tree path
  ...
  let _res : transact_get_items_output =
    {
      responses =
        (option_of_yojson
           (value_for_key item_response_list_of_yojson "Responses") _list
           path);
      consumed_capacity =
        (option_of_yojson
           (value_for_key consumed_capacity_multiple_of_yojson
  ...
  let _res : get =
    {
      ...
      projection_expression =
        (option_of_yojson
           (value_for_key projection_expression_of_yojson
              "ProjectionExpression") _list path);
      table_name = (value_for_key table_arn_of_yojson "TableName" _list path);
      key = (value_for_key key_of_yojson "Key" _list path)
    } in
  _res
let transact_get_item_of_yojson tree path =
  ...
  let _res : transact_get_item =
    { get = (value_for_key get_of_yojson "Get" _list path) } in
  _res
      ...
      return_consumed_capacity =
        (option_of_yojson
           (value_for_key return_consumed_capacity_of_yojson
              "ReturnConsumedCapacity") _list path);
      transact_items =
        (value_for_key transact_get_item_list_of_yojson "TransactItems" _list
           path)
    } in
  _res
  ...
  let _res : time_to_live_description =
    {
      attribute_name =
        (option_of_yojson
           (value_for_key time_to_live_attribute_name_of_yojson
              "AttributeName") _list path);
      time_to_live_status =
        (option_of_yojson
           (value_for_key time_to_live_status_of_yojson "TimeToLiveStatus")
           _list path)
    } in
  _res
...
let tag_resource_input_of_yojson tree path =
  ...
  _res
let table_name_list_of_yojson tree path =
  list_of_yojson table_name_of_yojson tree path
  ...
  let _res : table_creation_parameters =
    {
      global_secondary_indexes =
        (option_of_yojson
           (value_for_key global_secondary_index_list_of_yojson
              "GlobalSecondaryIndexes") _list path);
      sse_specification =
        (option_of_yojson
           (value_for_key sse_specification_of_yojson "SSESpecification")
      ...
      attribute_definitions =
        (value_for_key attribute_definitions_of_yojson "AttributeDefinitions"
           _list path);
      table_name =
        (value_for_key table_name_of_yojson "TableName" _list path)
    } in
  _res
  ...
  let _res : source_table_feature_details =
    {
      ...
      time_to_live_description =
        (option_of_yojson
           (value_for_key time_to_live_description_of_yojson
              "TimeToLiveDescription") _list path);
      stream_description =
        (option_of_yojson
      ...
      global_secondary_indexes =
        (option_of_yojson
           (value_for_key global_secondary_indexes_of_yojson
              "GlobalSecondaryIndexes") _list path);
      local_secondary_indexes =
        (option_of_yojson
           (value_for_key local_secondary_indexes_of_yojson
              "LocalSecondaryIndexes") _list path)
    } in
  _res
  ...
  let _res : source_table_details =
    {
      billing_mode =
        (option_of_yojson
           (value_for_key billing_mode_of_yojson "BillingMode") _list path);
      item_count =
        (option_of_yojson (value_for_key item_count_of_yojson "ItemCount")
           _list path);
      on_demand_throughput =
        (option_of_yojson
           (value_for_key on_demand_throughput_of_yojson "OnDemandThroughput")
      ...
      table_creation_date_time =
        (value_for_key table_creation_date_time_of_yojson
           "TableCreationDateTime" _list path);
      key_schema =
        (value_for_key key_schema_of_yojson "KeySchema" _list path);
      table_size_bytes =
        (option_of_yojson
           (value_for_key long_object_of_yojson "TableSizeBytes") _list path);
      table_arn =
        (option_of_yojson (value_for_key table_arn_of_yojson "TableArn")
           _list path);
...
let item_list_of_yojson tree path =
  list_of_yojson attribute_map_of_yojson tree path
  ...
  let _res : scan_output =
    {
      consumed_capacity =
        (option_of_yojson
           ...
           _list path);
      last_evaluated_key =
        (option_of_yojson (value_for_key key_of_yojson "LastEvaluatedKey")
           _list path);
      scanned_count =
        (option_of_yojson (value_for_key integer__of_yojson "ScannedCount")
           _list path);
      count =
        (option_of_yojson (value_for_key integer__of_yojson "Count") _list
           path);
      items =
        (option_of_yojson (value_for_key item_list_of_yojson "Items") _list
           path)
    } in
  _res
let attribute_name_list_of_yojson tree path =
  list_of_yojson attribute_name_of_yojson tree path
  ...
  let _res : scan_input =
    {
      consistent_read =
        (option_of_yojson
           (value_for_key consistent_read_of_yojson "ConsistentRead") _list
           path);
      expression_attribute_values =
        (option_of_yojson
           (value_for_key expression_attribute_value_map_of_yojson
      ...
      filter_expression =
        (option_of_yojson
           (value_for_key condition_expression_of_yojson "FilterExpression")
           _list path);
      projection_expression =
        (option_of_yojson
           (value_for_key projection_expression_of_yojson
              "ProjectionExpression") _list path);
      segment =
        (option_of_yojson (value_for_key scan_segment_of_yojson "Segment")
           _list path);
      total_segments =
        (option_of_yojson
           (value_for_key scan_total_segments_of_yojson "TotalSegments")
           _list path);
      return_consumed_capacity =
        (option_of_yojson
           (value_for_key return_consumed_capacity_of_yojson
              "ReturnConsumedCapacity") _list path);
      exclusive_start_key =
        (option_of_yojson (value_for_key key_of_yojson "ExclusiveStartKey")
           _list path);
      conditional_operator =
        (option_of_yojson
           (value_for_key conditional_operator_of_yojson
      ...
      scan_filter =
        (option_of_yojson
           (value_for_key filter_condition_map_of_yojson "ScanFilter") _list
           path);
      select =
        (option_of_yojson (value_for_key select_of_yojson "Select") _list
           path);
      limit =
        (option_of_yojson
      ...
      attributes_to_get =
        (option_of_yojson
           (value_for_key attribute_name_list_of_yojson "AttributesToGet")
           _list path);
      index_name =
        (option_of_yojson (value_for_key index_name_of_yojson "IndexName")
           _list path);
...
let s3_bucket_source_of_yojson tree path =
  ...
  let _res : s3_bucket_source =
    {
      s3_key_prefix =
        (option_of_yojson (value_for_key s3_prefix_of_yojson "S3KeyPrefix")
           _list path);
      s3_bucket = (value_for_key s3_bucket_of_yojson "S3Bucket" _list path);
      s3_bucket_owner =
        (option_of_yojson
           (value_for_key s3_bucket_owner_of_yojson "S3BucketOwner") _list
           path)
    } in
  _res
  ...
  let _res : restore_table_to_point_in_time_input =
    {
      sse_specification_override =
        (option_of_yojson
           (value_for_key sse_specification_of_yojson
              "SSESpecificationOverride") _list path);
      on_demand_throughput_override =
        (option_of_yojson
           (value_for_key on_demand_throughput_of_yojson
              "OnDemandThroughputOverride") _list path);
      provisioned_throughput_override =
        (option_of_yojson
           (value_for_key provisioned_throughput_of_yojson
      ...
      local_secondary_index_override =
        (option_of_yojson
           (value_for_key local_secondary_index_list_of_yojson
              "LocalSecondaryIndexOverride") _list path);
      global_secondary_index_override =
        (option_of_yojson
           (value_for_key global_secondary_index_list_of_yojson
              "GlobalSecondaryIndexOverride") _list path);
      billing_mode_override =
        (option_of_yojson
           (value_for_key billing_mode_of_yojson "BillingModeOverride") _list
           path);
      restore_date_time =
        (option_of_yojson (value_for_key date_of_yojson "RestoreDateTime")
           _list path);
  ...
  let _res : restore_table_from_backup_input =
    {
      ...
      billing_mode_override =
        (option_of_yojson
           ...
           path);
      backup_arn =
        (value_for_key backup_arn_of_yojson "BackupArn" _list path);
      target_table_name =
        (value_for_key table_name_of_yojson "TargetTableName" _list path)
    } in
  _res
...
let replica_of_yojson tree path =
  ...
  _res
let replica_list_of_yojson tree path =
  list_of_yojson replica_of_yojson tree path
  ...
  let _res : query_input =
    {
      ...
      key_condition_expression =
        (option_of_yojson
           (value_for_key key_expression_of_yojson "KeyConditionExpression")
           _list path);
      filter_expression =
        (option_of_yojson
           (value_for_key condition_expression_of_yojson "FilterExpression")
      ...
      scan_index_forward =
        (option_of_yojson
           (value_for_key boolean_object_of_yojson "ScanIndexForward") _list
           path);
      conditional_operator =
        (option_of_yojson
           (value_for_key conditional_operator_of_yojson
      ...
      query_filter =
        (option_of_yojson
           (value_for_key filter_condition_map_of_yojson "QueryFilter") _list
           path);
      key_conditions =
        (option_of_yojson
           (value_for_key key_conditions_of_yojson "KeyConditions") _list
           path);
      consistent_read =
        (option_of_yojson
           (value_for_key consistent_read_of_yojson "ConsistentRead") _list
  ...
  let _res : put_resource_policy_output =
    {
      revision_id =
        (option_of_yojson
           (value_for_key policy_revision_id_of_yojson "RevisionId") _list
           path)
    } in
  _res
      ...
      confirm_remove_self_resource_access =
        (option_of_yojson
           (value_for_key confirm_remove_self_resource_access_of_yojson
              "ConfirmRemoveSelfResourceAccess") _list path);
      expected_revision_id =
        (option_of_yojson
           (value_for_key policy_revision_id_of_yojson "ExpectedRevisionId")
           _list path);
  ...
  let _res : batch_statement_error =
    {
      ...
      code =
        (option_of_yojson
           (value_for_key batch_statement_error_code_enum_of_yojson "Code")
           _list path)
    } in
  _res
  ...
  let _res : batch_statement_response =
    {
      ...
      error =
        (option_of_yojson
           (value_for_key batch_statement_error_of_yojson "Error") _list path)
    } in
  _res
  ...
  let _res : batch_statement_request =
    {
      ...
      parameters =
        (option_of_yojson
           (value_for_key prepared_statement_parameters_of_yojson
              "Parameters") _list path);
      statement =
        (value_for_key parti_ql_statement_of_yojson "Statement" _list path)
    } in
  _res
  ...
  let _res : list_tags_of_resource_output =
    {
      next_token =
        (option_of_yojson
           (value_for_key next_token_string_of_yojson "NextToken") _list path);
      tags =
  ...
  let _res : list_tables_output =
    {
      last_evaluated_table_name =
        (option_of_yojson
           (value_for_key table_name_of_yojson "LastEvaluatedTableName")
           _list path);
      table_names =
        (option_of_yojson
           (value_for_key table_name_list_of_yojson "TableNames") _list path)
    } in
  _res
  ...
  let _res : list_tables_input =
    {
      limit =
        (option_of_yojson
           (value_for_key list_tables_input_limit_of_yojson "Limit") _list
           path);
      exclusive_start_table_name =
        (option_of_yojson
           (value_for_key table_name_of_yojson "ExclusiveStartTableName")
           _list path)
    } in
  _res
...
let import_summary_of_yojson tree path =
  ...
  let _res : import_summary =
    {
      end_time =
        (option_of_yojson (value_for_key import_end_time_of_yojson "EndTime")
           _list path);
      start_time =
        (option_of_yojson
           (value_for_key import_start_time_of_yojson "StartTime") _list path);
      input_format =
        (option_of_yojson
           (value_for_key input_format_of_yojson "InputFormat") _list path);
      cloud_watch_log_group_arn =
        (option_of_yojson
           (value_for_key cloud_watch_log_group_arn_of_yojson
              "CloudWatchLogGroupArn") _list path);
      s3_bucket_source =
        (option_of_yojson
           (value_for_key s3_bucket_source_of_yojson "S3BucketSource") _list
           path);
      table_arn =
        (option_of_yojson (value_for_key table_arn_of_yojson "TableArn")
           _list path);
      import_status =
        (option_of_yojson
           (value_for_key import_status_of_yojson "ImportStatus") _list path);
      import_arn =
        (option_of_yojson (value_for_key import_arn_of_yojson "ImportArn")
           _list path)
    } in
  _res
let import_summary_list_of_yojson tree path =
  list_of_yojson import_summary_of_yojson tree path
  ...
  let _res : list_imports_output =
    {
      next_token =
        (option_of_yojson
           (value_for_key import_next_token_of_yojson "NextToken") _list path);
      import_summary_list =
        (option_of_yojson
           (value_for_key import_summary_list_of_yojson "ImportSummaryList")
           _list path)
    } in
  _res
  ...
  let _res : list_imports_input =
    {
      ...
      page_size =
        (option_of_yojson
           (value_for_key list_imports_max_limit_of_yojson "PageSize") _list
           path);
      table_arn =
        (option_of_yojson (value_for_key table_arn_of_yojson "TableArn")
           _list path)
...
let global_table_of_yojson tree path =
  ...
  let _res : global_table =
    {
      replication_group =
        (option_of_yojson
           (value_for_key replica_list_of_yojson "ReplicationGroup") _list
           path);
      global_table_name =
        (option_of_yojson
           (value_for_key table_name_of_yojson "GlobalTableName") _list path)
  ...
  _res
let global_table_list_of_yojson tree path =
  list_of_yojson global_table_of_yojson tree path
  ...
  let _res : list_global_tables_output =
    {
      ...
      global_tables =
        (option_of_yojson
           (value_for_key global_table_list_of_yojson "GlobalTables") _list
           path)
    } in
  _res
  ...
  let _res : list_global_tables_input =
    {
      ...
      exclusive_start_global_table_name =
        (option_of_yojson
           (value_for_key table_name_of_yojson
              "ExclusiveStartGlobalTableName") _list path)
    } in
  _res
...
let export_summary_of_yojson tree path =
  ...
  let _res : export_summary =
    {
      export_type =
        (option_of_yojson (value_for_key export_type_of_yojson "ExportType")
           _list path);
      export_status =
        (option_of_yojson
           (value_for_key export_status_of_yojson "ExportStatus") _list path);
      export_arn =
        (option_of_yojson (value_for_key export_arn_of_yojson "ExportArn")
           _list path)
    } in
  _res
let export_summaries_of_yojson tree path =
  list_of_yojson export_summary_of_yojson tree path
  ...
  let _res : list_exports_output =
    {
      next_token =
        (option_of_yojson
           (value_for_key export_next_token_of_yojson "NextToken") _list path);
      export_summaries =
        (option_of_yojson
           (value_for_key export_summaries_of_yojson "ExportSummaries") _list
           path)
    } in
  _res
  ...
  let _res : list_exports_input =
    {
      ...
      max_results =
        (option_of_yojson
           (value_for_key list_exports_max_limit_of_yojson "MaxResults")
           _list path);
      table_arn =
        (option_of_yojson (value_for_key table_arn_of_yojson "TableArn")
           _list path)
  ...
  let _res : list_contributor_insights_output =
    {
      ...
      contributor_insights_summaries =
        (option_of_yojson
           (value_for_key contributor_insights_summaries_of_yojson
              "ContributorInsightsSummaries") _list path)
    } in
  _res
  ...
  let _res : list_contributor_insights_input =
    {
      max_results =
        (option_of_yojson
           (value_for_key list_contributor_insights_limit_of_yojson
...
let backup_summary_of_yojson tree path =
  ...
  let _res : backup_summary =
    {
      backup_size_bytes =
        (option_of_yojson
           (value_for_key backup_size_bytes_of_yojson "BackupSizeBytes")
           _list path);
      backup_type =
        (option_of_yojson (value_for_key backup_type_of_yojson "BackupType")
           _list path);
      backup_status =
        (option_of_yojson
           (value_for_key backup_status_of_yojson "BackupStatus") _list path);
      backup_expiry_date_time =
        (option_of_yojson
           (value_for_key date_of_yojson "BackupExpiryDateTime") _list path);
      backup_creation_date_time =
        (option_of_yojson
           (value_for_key backup_creation_date_time_of_yojson
              "BackupCreationDateTime") _list path);
      backup_name =
        (option_of_yojson (value_for_key backup_name_of_yojson "BackupName")
           _list path);
      backup_arn =
        (option_of_yojson (value_for_key backup_arn_of_yojson "BackupArn")
           _list path);
      table_arn =
        (option_of_yojson (value_for_key table_arn_of_yojson "TableArn")
           _list path);
  ...
  _res
let backup_summaries_of_yojson tree path =
  list_of_yojson backup_summary_of_yojson tree path
  ...
  let _res : list_backups_output =
    {
      last_evaluated_backup_arn =
        (option_of_yojson
           (value_for_key backup_arn_of_yojson "LastEvaluatedBackupArn")
           _list path);
      backup_summaries =
        (option_of_yojson
           (value_for_key backup_summaries_of_yojson "BackupSummaries") _list
           path)
    } in
  _res
  ...
  let _res : list_backups_input =
    {
      backup_type =
        (option_of_yojson
           (value_for_key backup_type_filter_of_yojson "BackupType") _list
           path);
      exclusive_start_backup_arn =
        (option_of_yojson
           (value_for_key backup_arn_of_yojson "ExclusiveStartBackupArn")
           _list path);
      time_range_upper_bound =
        (option_of_yojson
           (value_for_key time_range_upper_bound_of_yojson
              "TimeRangeUpperBound") _list path);
      time_range_lower_bound =
        (option_of_yojson
           (value_for_key time_range_lower_bound_of_yojson
              "TimeRangeLowerBound") _list path);
      limit =
        (option_of_yojson
           (value_for_key backups_input_limit_of_yojson "Limit") _list path);
      table_name =
        (option_of_yojson (value_for_key table_arn_of_yojson "TableName")
           _list path)
    } in
      ...
      enable_kinesis_streaming_configuration =
        (option_of_yojson
           (value_for_key enable_kinesis_streaming_configuration_of_yojson
              "EnableKinesisStreamingConfiguration") _list path);
      destination_status =
        (option_of_yojson
           (value_for_key destination_status_of_yojson "DestinationStatus")
           _list path);
  ...
  let _res : kinesis_data_stream_destination =
    {
      ...
      destination_status_description =
        (option_of_yojson
           (value_for_key string__of_yojson "DestinationStatusDescription")
           _list path);
      destination_status =
        (option_of_yojson
           (value_for_key destination_status_of_yojson "DestinationStatus")
...
let csv_header_list_of_yojson tree path =
  list_of_yojson csv_header_of_yojson tree path
  ...
  let _res : csv_options =
    {
      header_list =
        (option_of_yojson
           (value_for_key csv_header_list_of_yojson "HeaderList") _list path);
      delimiter =
        (option_of_yojson (value_for_key csv_delimiter_of_yojson "Delimiter")
           _list path)
    } in
  _res
let input_format_options_of_yojson tree path =
  ...
  let _res : input_format_options =
    {
      csv =
        (option_of_yojson (value_for_key csv_options_of_yojson "Csv") _list
           path)
    } in
  _res
  ...
  let _res : incremental_export_specification =
    {
      export_view_type =
        (option_of_yojson
           (value_for_key export_view_type_of_yojson "ExportViewType") _list
           path);
      export_to_time =
        (option_of_yojson
           (value_for_key export_to_time_of_yojson "ExportToTime") _list path);
      export_from_time =
        (option_of_yojson
           (value_for_key export_from_time_of_yojson "ExportFromTime") _list
           path)
    } in
  _res
  ...
  let _res : import_table_description =
    {
      failure_message =
        (option_of_yojson
           (value_for_key failure_message_of_yojson "FailureMessage") _list
           path);
      failure_code =
        (option_of_yojson
           (value_for_key failure_code_of_yojson "FailureCode") _list path);
      imported_item_count =
        (option_of_yojson
           (value_for_key imported_item_count_of_yojson "ImportedItemCount")
           _list path);
      ...
      processed_size_bytes =
        (option_of_yojson
           (value_for_key long_object_of_yojson "ProcessedSizeBytes") _list
           path);
      end_time =
        (option_of_yojson (value_for_key import_end_time_of_yojson "EndTime")
           _list path);
      ...
      table_creation_parameters =
        (option_of_yojson
           (value_for_key table_creation_parameters_of_yojson
              "TableCreationParameters") _list path);
      input_compression_type =
        (option_of_yojson
           (value_for_key input_compression_type_of_yojson
              "InputCompressionType") _list path);
  ...
  let _res : import_table_output =
    {
      import_table_description =
        (value_for_key import_table_description_of_yojson
           "ImportTableDescription" _list path)
    } in
  _res
  ...
  let _res : import_table_input =
    {
      ...
      input_format =
        (value_for_key input_format_of_yojson "InputFormat" _list path);
      s3_bucket_source =
        (value_for_key s3_bucket_source_of_yojson "S3BucketSource" _list path);
      client_token =
        (option_of_yojson
           (value_for_key client_token_of_yojson "ClientToken") _list path)
    } in
  ...
  let _res : get_resource_policy_output =
    {
      revision_id =
        (option_of_yojson
           ...
           path);
      policy =
        (option_of_yojson (value_for_key resource_policy_of_yojson "Policy")
           _list path)
    } in
  _res
  ...
  let _res : failure_exception =
    {
      exception_description =
        (option_of_yojson
           (value_for_key exception_description_of_yojson
              "ExceptionDescription") _list path);
      exception_name =
        (option_of_yojson
           (value_for_key exception_name_of_yojson "ExceptionName") _list
           path)
    } in
  _res
  ...
  let _res : export_description =
    {
      incremental_export_specification =
        (option_of_yojson
           (value_for_key incremental_export_specification_of_yojson
              "IncrementalExportSpecification") _list path);
      export_type =
        (option_of_yojson (value_for_key export_type_of_yojson "ExportType")
           _list path);
      item_count =
      ...
      billed_size_bytes =
        (option_of_yojson
           (value_for_key billed_size_bytes_of_yojson "BilledSizeBytes")
           _list path);
      export_format =
        (option_of_yojson
           (value_for_key export_format_of_yojson "ExportFormat") _list path);
      failure_message =
        (option_of_yojson
           (value_for_key failure_message_of_yojson "FailureMessage") _list
           path);
      ...
      s3_sse_kms_key_id =
        (option_of_yojson
           (value_for_key s3_sse_kms_key_id_of_yojson "S3SseKmsKeyId") _list
           path);
      s3_sse_algorithm =
        (option_of_yojson
           (value_for_key s3_sse_algorithm_of_yojson "S3SseAlgorithm") _list
           path);
      s3_prefix =
        (option_of_yojson (value_for_key s3_prefix_of_yojson "S3Prefix")
           _list path);
      s3_bucket_owner =
        (option_of_yojson
           (value_for_key s3_bucket_owner_of_yojson "S3BucketOwner") _list
           path);
      s3_bucket =
        (option_of_yojson (value_for_key s3_bucket_of_yojson "S3Bucket")
           _list path);
      client_token =
        (option_of_yojson
           (value_for_key client_token_of_yojson "ClientToken") _list path);
      export_time =
        (option_of_yojson (value_for_key export_time_of_yojson "ExportTime")
           _list path);
      table_id =
        (option_of_yojson (value_for_key table_id_of_yojson "TableId") _list
           path);
      ...
      export_manifest =
        (option_of_yojson
           (value_for_key export_manifest_of_yojson "ExportManifest") _list
           path);
      end_time =
        (option_of_yojson (value_for_key export_end_time_of_yojson "EndTime")
           _list path);
      start_time =
        (option_of_yojson
           (value_for_key export_start_time_of_yojson "StartTime") _list path);
      export_status =
        (option_of_yojson
           (value_for_key export_status_of_yojson "ExportStatus") _list path);
      export_arn =
  ...
  let _res : export_table_to_point_in_time_output =
    {
      export_description =
        (option_of_yojson
           (value_for_key export_description_of_yojson "ExportDescription")
           _list path)
    } in
  _res
  ...
  let _res : execute_transaction_input =
    {
      ...
      client_request_token =
        (option_of_yojson
           ...
           _list path);
      transact_statements =
        (value_for_key parameterized_statements_of_yojson
           "TransactStatements" _list path)
    } in
  _res
  ...
  let _res : execute_statement_output =
    {
      ...
      next_token =
        (option_of_yojson
           (value_for_key parti_ql_next_token_of_yojson "NextToken") _list
           path);
      items =
        (option_of_yojson (value_for_key item_list_of_yojson "Items") _list
           path)
  ...
  let _res : endpoint =
    {
      cache_period_in_minutes =
        (value_for_key long_of_yojson "CachePeriodInMinutes" _list path);
      address = (value_for_key string__of_yojson "Address" _list path)
    } in
  _res
let endpoints_of_yojson tree path =
  list_of_yojson endpoint_of_yojson tree path
...
let describe_table_output_of_yojson tree path =
  ...
  let _res : describe_table_output =
    {
      table =
        (option_of_yojson (value_for_key table_description_of_yojson "Table")
           _list path)
    } in
  _res
  ...
  let _res : describe_limits_output =
    {
      table_max_write_capacity_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "TableMaxWriteCapacityUnits") _list path);
      table_max_read_capacity_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "TableMaxReadCapacityUnits") _list path);
      account_max_write_capacity_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "AccountMaxWriteCapacityUnits") _list path);
      account_max_read_capacity_units =
        (option_of_yojson
           (value_for_key positive_long_object_of_yojson
              "AccountMaxReadCapacityUnits") _list path)
    } in
  _res
  ...
  let _res : describe_kinesis_streaming_destination_output =
    {
      kinesis_data_stream_destinations =
        (option_of_yojson
           (value_for_key kinesis_data_stream_destinations_of_yojson
              "KinesisDataStreamDestinations") _list path);
      table_name =
        (option_of_yojson (value_for_key table_name_of_yojson "TableName")
           _list path)
    } in
...
let describe_import_input_of_yojson tree path =
  ...
  let _res : describe_import_input =
    {
      import_arn =
        (value_for_key import_arn_of_yojson "ImportArn" _list path)
    } in
  _res
...
let describe_export_input_of_yojson tree path =
  ...
  let _res : describe_export_input =
    {
      export_arn =
        (value_for_key export_arn_of_yojson "ExportArn" _list path)
    } in
  _res
  ...
  let _res : describe_contributor_insights_output =
    {
      failure_exception =
        (option_of_yojson
           (value_for_key failure_exception_of_yojson "FailureException")
           _list path);
      last_update_date_time =
        (option_of_yojson
           (value_for_key last_update_date_time_of_yojson
              "LastUpdateDateTime") _list path);
      contributor_insights_status =
        (option_of_yojson
           (value_for_key contributor_insights_status_of_yojson
              "ContributorInsightsStatus") _list path);
      contributor_insights_rule_list =
        (option_of_yojson
           (value_for_key contributor_insights_rule_list_of_yojson
              "ContributorInsightsRuleList") _list path);
      index_name =
        (option_of_yojson (value_for_key index_name_of_yojson "IndexName")
           _list path);
      table_name =
  ...
  let _res : backup_details =
    {
      ...
      backup_creation_date_time =
        (value_for_key backup_creation_date_time_of_yojson
           "BackupCreationDateTime" _list path);
      backup_type =
        (value_for_key backup_type_of_yojson "BackupType" _list path);
      backup_status =
        (value_for_key backup_status_of_yojson "BackupStatus" _list path);
      backup_size_bytes =
        (option_of_yojson
           ...
           _list path);
      backup_name =
        (value_for_key backup_name_of_yojson "BackupName" _list path);
      backup_arn =
        (value_for_key backup_arn_of_yojson "BackupArn" _list path)
    } in
  _res
  ...
  let _res : backup_description =
    {
      source_table_feature_details =
        (option_of_yojson
           (value_for_key source_table_feature_details_of_yojson
              "SourceTableFeatureDetails") _list path);
      ...
      backup_details =
        (option_of_yojson
           (value_for_key backup_details_of_yojson "BackupDetails") _list
           path)
    } in
  _res
  ...
  let _res : describe_backup_output =
    {
      backup_description =
        (option_of_yojson
           (value_for_key backup_description_of_yojson "BackupDescription")
           _list path)
    } in
  _res
...
let create_global_table_input_of_yojson tree path =
  ...
  let _res : create_global_table_input =
    {
      replication_group =
        (value_for_key replica_list_of_yojson "ReplicationGroup" _list path);
      global_table_name =
        (value_for_key table_name_of_yojson "GlobalTableName" _list path)
    } in
  _res
  ...
  let _res : batch_write_item_output =
    {
      ...
      unprocessed_items =
        (option_of_yojson
           (value_for_key batch_write_item_request_map_of_yojson
              "UnprocessedItems") _list path)
    } in
  _res
      ...
      return_consumed_capacity =
        (option_of_yojson
           (value_for_key return_consumed_capacity_of_yojson
              "ReturnConsumedCapacity") _list path);
      request_items =
        (value_for_key batch_write_item_request_map_of_yojson "RequestItems"
           _list path)
    } in
  _res
  ...
  let _res : batch_get_item_output =
    {
      ...
      unprocessed_keys =
        (option_of_yojson
           (value_for_key batch_get_request_map_of_yojson "UnprocessedKeys")
           _list path);
      responses =
        (option_of_yojson
           (value_for_key batch_get_response_map_of_yojson "Responses") _list
           path)
    } in
  _res
      ...
      return_consumed_capacity =
        (option_of_yojson
           (value_for_key return_consumed_capacity_of_yojson
              "ReturnConsumedCapacity") _list path);
      request_items =
        (value_for_key batch_get_request_map_of_yojson "RequestItems" _list
           path)
    } in
  _res
  ...
  let _res : batch_execute_statement_output =
    {
      ...
      responses =
        (option_of_yojson
           (value_for_key parti_ql_batch_response_of_yojson "Responses")
           _list path)
    } in
  _res
