...
let write_request_of_yojson tree path =
  ...
  ({
     delete_request =
       (option_of_yojson
          (value_for_key delete_request_of_yojson "DeleteRequest") _list path);
     put_request =
...
let auto_scaling_settings_description_of_yojson tree path =
  ...
  ({
     ...
     maximum_units =
       (option_of_yojson
          (value_for_key positive_long_object_of_yojson "MaximumUnits") _list
          path);
     minimum_units =
       (option_of_yojson
          (value_for_key positive_long_object_of_yojson "MinimumUnits") _list
          path)
...
let replica_global_secondary_index_auto_scaling_description_of_yojson tree
  ...
  ({
     ...
     index_status =
       (option_of_yojson (value_for_key index_status_of_yojson "IndexStatus")
          _list path);
     index_name =
...
let replica_auto_scaling_description_of_yojson tree path =
  ...
  ({
     replica_status =
       (option_of_yojson
          (value_for_key replica_status_of_yojson "ReplicaStatus") _list path);
     replica_provisioned_write_capacity_auto_scaling_settings =
       (option_of_yojson
          (value_for_key auto_scaling_settings_description_of_yojson
             "ReplicaProvisionedWriteCapacityAutoScalingSettings") _list path);
     ...
     replicas =
       (option_of_yojson
          (value_for_key replica_auto_scaling_description_list_of_yojson
             "Replicas") _list path);
     table_status =
       (option_of_yojson (value_for_key table_status_of_yojson "TableStatus")
          _list path);
     table_name =
  ...
  ({
     last_update_to_pay_per_request_date_time =
       (option_of_yojson
          ...
          _list path);
     billing_mode =
       (option_of_yojson (value_for_key billing_mode_of_yojson "BillingMode")
          _list path)
...
let restore_summary_of_yojson tree path =
  ...
  ({
     restore_in_progress =
       (value_for_key restore_in_progress_of_yojson "RestoreInProgress" _list
          path);
     restore_date_time =
       (value_for_key date_of_yojson "RestoreDateTime" _list path);
     source_table_arn =
       (option_of_yojson (value_for_key table_arn_of_yojson "SourceTableArn")
          _list path);
     source_backup_arn =
       (option_of_yojson
...
let archival_summary_of_yojson tree path =
  ...
  ({
     archival_backup_arn =
       (option_of_yojson
          (value_for_key backup_arn_of_yojson "ArchivalBackupArn") _list path);
     archival_reason =
       (option_of_yojson
  ...
  ({
     ...
     consumed_capacity =
       (option_of_yojson
          ...
          _list path);
     attributes =
       (option_of_yojson (value_for_key attribute_map_of_yojson "Attributes")
          _list path)
   } : update_item_output)
...
let conditional_check_failed_exception_of_yojson tree path =
  ...
  ({
     item =
       (option_of_yojson (value_for_key attribute_map_of_yojson "Item") _list
          path);
     message =
       (option_of_yojson (value_for_key error_message_of_yojson "message")
          _list path)
...
let replica_settings_update_of_yojson tree path =
  ...
  ({
     ...
     replica_provisioned_read_capacity_auto_scaling_settings_update =
       (option_of_yojson
          (value_for_key auto_scaling_settings_update_of_yojson
             "ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate") _list
          path);
     replica_provisioned_read_capacity_units =
       (option_of_yojson
          (value_for_key positive_long_object_of_yojson
...
let replica_update_of_yojson tree path =
  ...
  ({
     delete =
       (option_of_yojson
          (value_for_key delete_replica_action_of_yojson "Delete") _list path);
     create =
       (option_of_yojson
          (value_for_key create_replica_action_of_yojson "Create") _list path)
   } : replica_update)
...
let transact_write_item_of_yojson tree path =
  ...
  ({
     update =
       (option_of_yojson (value_for_key update_of_yojson "Update") _list path);
     delete =
       (option_of_yojson (value_for_key delete_of_yojson "Delete") _list path);
...
let transact_get_items_output_of_yojson tree path =
  ...
  ({
     responses =
       (option_of_yojson
          (value_for_key item_response_list_of_yojson "Responses") _list path);
     consumed_capacity =
       (option_of_yojson
          (value_for_key consumed_capacity_multiple_of_yojson
             "ConsumedCapacity") _list path)
  ...
  ({
     ...
     table_size_bytes =
       (option_of_yojson
          (value_for_key long_object_of_yojson "TableSizeBytes") _list path);
     table_arn =
       (option_of_yojson (value_for_key table_arn_of_yojson "TableArn") _list
          path);
  ...
  ({
     ...
     last_evaluated_key =
       (option_of_yojson (value_for_key key_of_yojson "LastEvaluatedKey")
          _list path);
     scanned_count =
       (option_of_yojson (value_for_key integer_of_yojson "ScannedCount")
          _list path);
     count =
       (option_of_yojson (value_for_key integer_of_yojson "Count") _list path);
     items =
...
let scan_input_of_yojson tree path =
  ...
  ({
     ...
     total_segments =
       (option_of_yojson
          (value_for_key scan_total_segments_of_yojson "TotalSegments") _list
          path);
     return_consumed_capacity =
       (option_of_yojson
          (value_for_key return_consumed_capacity_of_yojson
     ...
     scan_filter =
       (option_of_yojson
          ...
          path);
     select =
       (option_of_yojson (value_for_key select_of_yojson "Select") _list path);
     limit =
       (option_of_yojson
...
let query_input_of_yojson tree path =
  ...
  ({
     ...
     key_conditions =
       (option_of_yojson
          (value_for_key key_conditions_of_yojson "KeyConditions") _list path);
     consistent_read =
       (option_of_yojson
          (value_for_key consistent_read_of_yojson "ConsistentRead") _list
          path);
...
let list_tables_output_of_yojson tree path =
  ...
  ({
     last_evaluated_table_name =
       (option_of_yojson
          (value_for_key table_name_of_yojson "LastEvaluatedTableName") _list
          path);
     table_names =
       (option_of_yojson
...
let import_summary_of_yojson tree path =
  ...
  ({
     ...
     input_format =
       (option_of_yojson (value_for_key input_format_of_yojson "InputFormat")
          _list path);
...
let list_exports_input_of_yojson tree path =
  ...
  ({
     ...
     max_results =
       (option_of_yojson
          (value_for_key list_exports_max_limit_of_yojson "MaxResults") _list
          path);
     table_arn =
       (option_of_yojson (value_for_key table_arn_of_yojson "TableArn") _list
          path)
...
let backup_summary_of_yojson tree path =
  ...
  ({
     backup_size_bytes =
       (option_of_yojson
          (value_for_key backup_size_bytes_of_yojson "BackupSizeBytes") _list
          path);
     backup_type =
...
let list_backups_output_of_yojson tree path =
  ...
  ({
     last_evaluated_backup_arn =
       (option_of_yojson
          (value_for_key backup_arn_of_yojson "LastEvaluatedBackupArn") _list
          path);
     backup_summaries =
       (option_of_yojson
  ...
  ({
     failure_message =
       (option_of_yojson
          ...
          path);
     failure_code =
       (option_of_yojson (value_for_key failure_code_of_yojson "FailureCode")
          _list path);
     imported_item_count =
       (option_of_yojson
...
let failure_exception_of_yojson tree path =
  ...
  ({
     ...
     exception_name =
       (option_of_yojson
          (value_for_key exception_name_of_yojson "ExceptionName") _list path)
   } : failure_exception)
...
let export_description_of_yojson tree path =
  ...
  ({
     ...
     billed_size_bytes =
       (option_of_yojson
          (value_for_key billed_size_bytes_of_yojson "BilledSizeBytes") _list
          path);
     export_format =
       (option_of_yojson
     ...
     s3_sse_algorithm =
       (option_of_yojson
          ...
          path);
     s3_prefix =
       (option_of_yojson (value_for_key s3_prefix_of_yojson "S3Prefix") _list
          path);
     s3_bucket_owner =
       (option_of_yojson
          (value_for_key s3_bucket_owner_of_yojson "S3BucketOwner") _list
          path);
     s3_bucket =
       (option_of_yojson (value_for_key s3_bucket_of_yojson "S3Bucket") _list
          path);
     client_token =
       (option_of_yojson (value_for_key client_token_of_yojson "ClientToken")
          _list path);
  ...
  ({
     ...
     client_request_token =
       (option_of_yojson
          ...
          _list path);
     transact_statements =
       (value_for_key parameterized_statements_of_yojson "TransactStatements"
          _list path)
...
let backup_description_of_yojson tree path =
  ...
  ({
     ...
     backup_details =
       (option_of_yojson
          (value_for_key backup_details_of_yojson "BackupDetails") _list path)
   } : backup_description)
...
let batch_execute_statement_output_of_yojson tree path =
  ...
  ({
     ...
     responses =
       (option_of_yojson
          (value_for_key parti_ql_batch_response_of_yojson "Responses") _list
          path)
