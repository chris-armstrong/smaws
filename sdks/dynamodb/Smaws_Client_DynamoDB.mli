...
sig
  val error_to_string :
    ...
    | `RequestLimitExceeded of request_limit_exceeded ] -> string
  val request :
...
sig
  val error_to_string :
    ...
    | `TableNotFoundException of table_not_found_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
      create_backup_input ->
...
sig
  val error_to_string :
    ...
    | `InvalidEndpointException of invalid_endpoint_exception 
    | `LimitExceededException of limit_exceeded_exception 
    | `ResourceInUseException of resource_in_use_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
      create_table_input ->
        (create_table_output,
...
sig
  val error_to_string :
    ...
    | `InternalServerError of internal_server_error 
    | `InvalidEndpointException of invalid_endpoint_exception 
    | `LimitExceededException of limit_exceeded_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
      delete_backup_input ->
...
sig
  val error_to_string :
    ...
    | `BackupNotFoundException of backup_not_found_exception 
    | `InternalServerError of internal_server_error 
    | `InvalidEndpointException of invalid_endpoint_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `ImportNotFoundException of import_not_found_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
...
sig
  val error_to_string :
    ...
    | `TableInUseException of table_in_use_exception ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
