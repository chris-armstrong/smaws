...
type nonrec key = (string * attribute_value) list
...
type nonrec return_item_collection_metrics =
  | NONE 
  | SIZE 
type nonrec expression_attribute_name_map = (string * string) list
...
type nonrec item_collection_metrics_per_table =
  (string * item_collection_metrics list) list
...
type nonrec condition =
  ...
  attribute_value_list: attribute_value list option }
type nonrec filter_condition_map = (string * condition) list
...
type nonrec query_output =
  ...
  count: int option ;
  items: attribute_map list option }
type nonrec key_conditions = (string * condition) list
...
type nonrec batch_execute_statement_input =
  {
  return_consumed_capacity: return_consumed_capacity option ;
  statements: batch_statement_request list }(** {1:builders Builders} *)
