...
let summary_of_yojson tree path =
  ...
  ({
     ...
     resource_type =
       (option_of_yojson
          (value_for_key amazon_resource_type_of_yojson "ResourceType") _list
          path);
     region =
     ...
     target_id =
       (option_of_yojson (value_for_key target_id_of_yojson "TargetId") _list
          path);
     last_updated =
       (option_of_yojson (value_for_key last_updated_of_yojson "LastUpdated")
          _list path)
   } : summary)
  ...
  ({
     pagination_token =
       (option_of_yojson
          ...
          path);
     summary_list =
       (option_of_yojson (value_for_key summary_list_of_yojson "SummaryList")
          _list path)
...
let get_compliance_summary_input_of_yojson tree path =
  ...
  ({
     ...
     tag_key_filters =
       (option_of_yojson
          (value_for_key tag_key_filter_list_of_yojson "TagKeyFilters") _list
          path);
     resource_type_filters =
       (option_of_yojson
          (value_for_key resource_type_filter_list_of_yojson
