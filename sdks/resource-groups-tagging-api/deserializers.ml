  ...
  let _res : failure_info =
    {
      ...
      error_code =
        (option_of_yojson (value_for_key error_code_of_yojson "ErrorCode")
           _list path);
      status_code =
        (option_of_yojson (value_for_key status_code_of_yojson "StatusCode")
           _list path)
    } in
  _res
...
let tag_key_list_for_untag_of_yojson tree path =
...
let untag_resources_input_of_yojson tree path =
  ...
  let _res : untag_resources_input =
    {
      tag_keys =
        (value_for_key tag_key_list_for_untag_of_yojson "TagKeys" _list path);
      resource_arn_list =
        (value_for_key resource_arn_list_for_tag_untag_of_yojson
           "ResourceARNList" _list path)
    } in
  _res
...
let tag_values_output_list_of_yojson tree path =
  list_of_yojson tag_value_of_yojson tree path
let tag_value_list_of_yojson tree path =
  list_of_yojson tag_value_of_yojson tree path
...
let tag_key_list_of_yojson tree path =
  list_of_yojson tag_key_of_yojson tree path
let tag_key_filter_list_of_yojson tree path =
  list_of_yojson tag_key_of_yojson tree path
let tag_filter_of_yojson tree path =
  ...
  let _res : tag_filter =
    {
      values =
        (option_of_yojson (value_for_key tag_value_list_of_yojson "Values")
           _list path);
      key =
        (option_of_yojson (value_for_key tag_key_of_yojson "Key") _list path)
    } in
  _res
let tag_filter_list_of_yojson tree path =
  list_of_yojson tag_filter_of_yojson tree path
  ...
  let _res : summary =
    {
      non_compliant_resources =
        (option_of_yojson
           (value_for_key non_compliant_resources_of_yojson
              "NonCompliantResources") _list path);
      resource_type =
        (option_of_yojson
           (value_for_key amazon_resource_type_of_yojson "ResourceType")
           _list path);
      region =
        (option_of_yojson (value_for_key region_of_yojson "Region") _list
           path);
      target_id_type =
        (option_of_yojson
           (value_for_key target_id_type_of_yojson "TargetIdType") _list path);
      target_id =
        (option_of_yojson (value_for_key target_id_of_yojson "TargetId")
           _list path);
      last_updated =
        (option_of_yojson
           (value_for_key last_updated_of_yojson "LastUpdated") _list path)
    } in
  _res
let summary_list_of_yojson tree path =
...
let start_report_creation_input_of_yojson tree path =
  ...
  let _res : start_report_creation_input =
    { s3_bucket = (value_for_key s3_bucket_of_yojson "S3Bucket" _list path) } in
  _res
  ...
  let _res : compliance_details =
    {
      compliance_status =
        (option_of_yojson
           (value_for_key compliance_status_of_yojson "ComplianceStatus")
           _list path);
      ...
      noncompliant_keys =
        (option_of_yojson
           (value_for_key tag_key_list_of_yojson "NoncompliantKeys") _list
           path)
    } in
  _res
  ...
  let _res : resource_tag_mapping =
    {
      compliance_details =
        (option_of_yojson
           (value_for_key compliance_details_of_yojson "ComplianceDetails")
           _list path);
      tags =
  ...
  let _res : get_tag_values_output =
    {
      tag_values =
        (option_of_yojson
           (value_for_key tag_values_output_list_of_yojson "TagValues") _list
           path);
      pagination_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "PaginationToken") _list
           path)
    } in
  _res
...
let get_tag_keys_output_of_yojson tree path =
  ...
  let _res : get_tag_keys_output =
    {
      tag_keys =
        (option_of_yojson (value_for_key tag_key_list_of_yojson "TagKeys")
           _list path);
      pagination_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "PaginationToken") _list
  ...
  let _res : get_resources_output =
    {
      resource_tag_mapping_list =
        (option_of_yojson
           (value_for_key resource_tag_mapping_list_of_yojson
              "ResourceTagMappingList") _list path);
      pagination_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "PaginationToken") _list
           path)
...
let resource_arn_list_for_get_of_yojson tree path =
  list_of_yojson resource_ar_n_of_yojson tree path
  ...
  let _res : get_resources_input =
    {
      resource_arn_list =
        (option_of_yojson
           (value_for_key resource_arn_list_for_get_of_yojson
              "ResourceARNList") _list path);
      exclude_compliant_resources =
        (option_of_yojson
           (value_for_key exclude_compliant_resources_of_yojson
              "ExcludeCompliantResources") _list path);
      include_compliance_details =
        (option_of_yojson
           (value_for_key include_compliance_details_of_yojson
              "IncludeComplianceDetails") _list path);
      resource_type_filters =
        (option_of_yojson
           (value_for_key resource_type_filter_list_of_yojson
              "ResourceTypeFilters") _list path);
      tags_per_page =
        (option_of_yojson
           (value_for_key tags_per_page_of_yojson "TagsPerPage") _list path);
      resources_per_page =
        (option_of_yojson
           (value_for_key resources_per_page_of_yojson "ResourcesPerPage")
           _list path);
      tag_filters =
        (option_of_yojson
           (value_for_key tag_filter_list_of_yojson "TagFilters") _list path);
      pagination_token =
        (option_of_yojson
           (value_for_key pagination_token_of_yojson "PaginationToken") _list
           path)
  ...
  let _res : get_compliance_summary_output =
    {
      ...
      summary_list =
        (option_of_yojson
           (value_for_key summary_list_of_yojson "SummaryList") _list path)
    } in
  _res
  ...
  let _res : get_compliance_summary_input =
    {
      ...
      max_results =
        (option_of_yojson
           (value_for_key max_results_get_compliance_summary_of_yojson
              "MaxResults") _list path);
      group_by =
        (option_of_yojson (value_for_key group_by_of_yojson "GroupBy") _list
           path);
      tag_key_filters =
        (option_of_yojson
           (value_for_key tag_key_filter_list_of_yojson "TagKeyFilters")
           _list path);
      resource_type_filters =
        (option_of_yojson
           (value_for_key resource_type_filter_list_of_yojson
      ...
      region_filters =
        (option_of_yojson
           (value_for_key region_filter_list_of_yojson "RegionFilters") _list
           path);
      target_id_filters =
        (option_of_yojson
           (value_for_key target_id_filter_list_of_yojson "TargetIdFilters")
           _list path)
    } in
  _res
  ...
  let _res : describe_report_creation_output =
    {
      error_message =
        (option_of_yojson
           (value_for_key error_message_of_yojson "ErrorMessage") _list path);
      start_date =
        (option_of_yojson (value_for_key start_date_of_yojson "StartDate")
           _list path);
      s3_location =
        (option_of_yojson (value_for_key s3_location_of_yojson "S3Location")
           _list path);
      status =
