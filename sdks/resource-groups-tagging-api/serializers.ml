...
let untag_resources_output_to_yojson (x : untag_resources_output) =
  assoc_to_yojson
    [("FailedResourcesMap",
       (option_to_yojson failed_resources_map_to_yojson
          x.failed_resources_map))]
let resource_arn_list_for_tag_untag_to_yojson tree =
  list_to_yojson resource_ar_n_to_yojson tree
let tag_key_to_yojson = string_to_yojson
let tag_key_list_for_untag_to_yojson tree =
  list_to_yojson tag_key_to_yojson tree
...
let target_id_filter_list_to_yojson tree =
  list_to_yojson target_id_to_yojson tree
let tags_per_page_to_yojson = int_to_yojson
let tag_value_to_yojson = string_to_yojson
let tag_values_output_list_to_yojson tree =
  list_to_yojson tag_value_to_yojson tree
...
let tag_key_filter_list_to_yojson tree =
  list_to_yojson tag_key_to_yojson tree
...
let summary_to_yojson (x : summary) =
  assoc_to_yojson
    [("NonCompliantResources",
       (option_to_yojson non_compliant_resources_to_yojson
          x.non_compliant_resources));
    ("ResourceType",
...
let constraint_violation_exception_to_yojson
  (x : constraint_violation_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let resource_type_filter_list_to_yojson tree =
  list_to_yojson amazon_resource_type_to_yojson tree
...
let compliance_details_to_yojson (x : compliance_details) =
  assoc_to_yojson
    ...
    ("KeysWithNoncompliantValues",
      (option_to_yojson tag_key_list_to_yojson
         x.keys_with_noncompliant_values));
    ("NoncompliantKeys",
...
let resource_tag_mapping_list_to_yojson tree =
  list_to_yojson resource_tag_mapping_to_yojson tree
let pagination_token_expired_exception_to_yojson
  (x : pagination_token_expired_exception) =
  assoc_to_yojson
    [("Message", (option_to_yojson exception_message_to_yojson x.message))]
...
let get_resources_output_to_yojson (x : get_resources_output) =
  assoc_to_yojson
    [("ResourceTagMappingList",
       (option_to_yojson resource_tag_mapping_list_to_yojson
          x.resource_tag_mapping_list));
    ("PaginationToken",
      (option_to_yojson pagination_token_to_yojson x.pagination_token))]
let include_compliance_details_to_yojson = bool_to_yojson
let exclude_compliant_resources_to_yojson = bool_to_yojson
let resource_arn_list_for_get_to_yojson tree =
  list_to_yojson resource_ar_n_to_yojson tree
let get_resources_input_to_yojson (x : get_resources_input) =
  assoc_to_yojson
    [("ResourceARNList",
       (option_to_yojson resource_arn_list_for_get_to_yojson
          x.resource_arn_list));
    ("ExcludeCompliantResources",
      (option_to_yojson exclude_compliant_resources_to_yojson
         x.exclude_compliant_resources));
    ("IncludeComplianceDetails",
      (option_to_yojson include_compliance_details_to_yojson
         x.include_compliance_details));
    ("ResourceTypeFilters",
      (option_to_yojson resource_type_filter_list_to_yojson
         x.resource_type_filters));
    ("TagsPerPage",
...
let get_compliance_summary_output_to_yojson
  (x : get_compliance_summary_output) =
  assoc_to_yojson
    [("PaginationToken",
       (option_to_yojson pagination_token_to_yojson x.pagination_token));
...
let group_by_to_yojson tree =
  list_to_yojson group_by_attribute_to_yojson tree
...
let get_compliance_summary_input_to_yojson (x : get_compliance_summary_input)
  ...
  assoc_to_yojson
    [("PaginationToken",
       (option_to_yojson pagination_token_to_yojson x.pagination_token));
    ("MaxResults",
      (option_to_yojson max_results_get_compliance_summary_to_yojson
         x.max_results));
...
let describe_report_creation_output_to_yojson
  (x : describe_report_creation_output) =
  assoc_to_yojson
    [("ErrorMessage",
       (option_to_yojson error_message_to_yojson x.error_message));
