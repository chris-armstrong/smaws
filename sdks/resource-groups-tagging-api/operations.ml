...
module DescribeReportCreation =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "ConstraintViolationException") ->
            `ConstraintViolationException
              (Json_deserializers.constraint_violation_exception_of_yojson
                 tree path)
        | (_, "InternalServiceException") ->
            `InternalServiceException
              (Json_deserializers.internal_service_exception_of_yojson tree
                 path)
        ...
        | (_, "ThrottledException") ->
            `ThrottledException
              (Json_deserializers.throttled_exception_of_yojson tree path)
    ...
    let request context (request : describe_report_creation_input) =
      let input =
        Json_serializers.describe_report_creation_input_to_yojson request in
...
module GetComplianceSummary =
  struct
    ...
    let request context (request : get_compliance_summary_input) =
      let input =
        Json_serializers.get_compliance_summary_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module GetResources =
  struct
      ...
      let handler handler tree path =
        ...
        | (_, "PaginationTokenExpiredException") ->
            `PaginationTokenExpiredException
              (Json_deserializers.pagination_token_expired_exception_of_yojson
                 tree path)
        | (_, "ThrottledException") ->
            `ThrottledException
              (Json_deserializers.throttled_exception_of_yojson tree path)
    ...
    let request context (request : get_resources_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"ResourceGroupsTaggingAPI_20170126.GetResources" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.get_resources_output_of_yojson
        ~error_deserializer
  end
module GetTagKeys =
  struct
    ...
    let request context (request : get_tag_keys_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"ResourceGroupsTaggingAPI_20170126.GetTagKeys" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.get_tag_keys_output_of_yojson
        ~error_deserializer
  end
module GetTagValues =
  struct
    ...
    let request context (request : get_tag_values_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"ResourceGroupsTaggingAPI_20170126.GetTagValues" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.get_tag_values_output_of_yojson
        ~error_deserializer
  end
module StartReportCreation =
  struct
    ...
    let request context (request : start_report_creation_input) =
      let input =
        Json_serializers.start_report_creation_input_to_yojson request in
      Smaws_Lib.Protocols.AwsJson.request
...
module TagResources =
  struct
    ...
    let request context (request : tag_resources_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ~shape_name:"ResourceGroupsTaggingAPI_20170126.TagResources" ~service
        ~context ~input
        ~output_deserializer:Json_deserializers.tag_resources_output_of_yojson
        ~error_deserializer
  end
  ...
  struct
    ...
    let request context (request : untag_resources_input) =
      ...
      Smaws_Lib.Protocols.AwsJson.request
        ...
        ~service ~context ~input
        ~output_deserializer:Json_deserializers.untag_resources_output_of_yojson
        ~error_deserializer
  end