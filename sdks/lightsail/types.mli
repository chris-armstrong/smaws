...
type nonrec access_direction = Inbound [@ocaml.doc ""] | Outbound [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec status_type = Active [@ocaml.doc ""] | Inactive [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec add_on_type = AutoSnapshot [@ocaml.doc ""] | StopInstanceOnIdle [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec contact_protocol = Email [@ocaml.doc ""] | SMS [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec behavior_enum = DontCacheSetting [@ocaml.doc ""] | CacheSetting [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec instance_platform = LinuxUnix [@ocaml.doc ""] | Windows [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec blueprint_type = Os [@ocaml.doc ""] | App [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec bucket_metric_name = BucketSizeBytes [@ocaml.doc ""] | NumberOfObjects [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec renewal_summary = {
  ...
  updated_at : iso_date option; [@ocaml.doc "The timestamp when the certificate was last updated.\n"]
}
...
type nonrec origin_protocol_policy_enum = HTTPOnly [@ocaml.doc ""] | HTTPSOnly [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec download_default_key_pair_result = {
  public_key_base64 : base64 option;
      [@ocaml.doc "A base64-encoded public key of the [ssh-rsa] type.\n"]
  private_key_base64 : base64 option; [@ocaml.doc "A base64-encoded RSA private key.\n"]
  created_at : iso_date option; [@ocaml.doc "The timestamp when the default key pair was created.\n"]
}
[@@ocaml.doc ""]
...
type nonrec http_protocol_ipv6 = Disabled [@ocaml.doc ""] | Enabled [@ocaml.doc ""]
[@@ocaml.doc ""]

type nonrec http_endpoint = Disabled [@ocaml.doc ""] | Enabled [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec http_tokens = Optional [@ocaml.doc ""] | Required [@ocaml.doc ""] [@@ocaml.doc ""]

type nonrec instance_metadata_state = Pending [@ocaml.doc ""] | Applied [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec port_access_type = Public [@ocaml.doc ""] | Private [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec instance_access_protocol = Ssh [@ocaml.doc ""] | Rdp [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec port_state = Open [@ocaml.doc ""] | Closed [@ocaml.doc ""] [@@ocaml.doc ""]
...
type nonrec load_balancer_protocol = HTTP_HTTPS [@ocaml.doc ""] | HTTP [@ocaml.doc ""]
[@@ocaml.doc ""]
...
type nonrec resource_bucket_access = Allow [@ocaml.doc ""] | Deny [@ocaml.doc ""] [@@ocaml.doc ""]
