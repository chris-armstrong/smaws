...
type nonrec setup_history_resource =
  ...
  name: resource_name option
    [@ocaml.doc "The name of the Lightsail resource.\n"]}[@@ocaml.doc
...
type nonrec setup_execution_details =
  ...
  version: string_ option
    [@ocaml.doc "The current version of the script..\n"];
  standard_output: string_ option
    [@ocaml.doc "The text written by the command to stdout.\n"];
  standard_error: string_ option
  ...
  name: non_empty_string option
    [@ocaml.doc "The name of the target resource.\n"];
  date_time: iso_date option
...
type nonrec relational_database_parameter_list =
  relational_database_parameter list[@@ocaml.doc ""]
...
type nonrec unauthenticated_exception =
  ...
  code: string_ option [@ocaml.doc ""]}[@@ocaml.doc
...
type nonrec domain_entry =
  ...
  id: non_empty_string option
    [@ocaml.doc "The ID of the domain recordset entry.\n"]}[@@ocaml.doc
...
type nonrec input_origin =
  ...
  name: resource_name option
    [@ocaml.doc "The name of the origin resource.\n"]}[@@ocaml.doc
...
type nonrec container_service_deployment =
  ...
  version: integer option
    [@ocaml.doc "The version number of the deployment.\n"]}[@@ocaml.doc
...
type nonrec container_service_public_domains =
  (string_ * container_service_public_domains_list) list[@@ocaml.doc ""]
...
type nonrec relational_database_snapshot =
  ...
  state: non_empty_string option
    [@ocaml.doc "The state of the database snapshot.\n"];
  ...
  name: resource_name option
    [@ocaml.doc "The name of the database snapshot.\n"]}[@@ocaml.doc
                                                          "Describes a database snapshot.\n"]
type nonrec relational_database_snapshot_list =
  relational_database_snapshot list[@@ocaml.doc ""]
...
type nonrec relational_database_hardware =
  ...
  disk_size_in_gb: integer option
...
type nonrec relational_database_endpoint =
  {
  address: non_empty_string option
...
type nonrec pending_maintenance_action =
  ...
  action: non_empty_string option
...
type nonrec relational_database =
  ...
  master_username: non_empty_string option
...
type nonrec availability_zone =
  {
  state: non_empty_string option
    [@ocaml.doc "The state of the Availability Zone.\n"];
...
type nonrec reboot_instance_request =
  {
  instance_name: resource_name
    [@ocaml.doc "The name of the instance to reboot.\n"]}[@@ocaml.doc ""]
...
type nonrec monthly_transfer =
  {
  gb_per_month_allocated: integer option
...
type nonrec load_balancer_tls_policy =
  ...
  name: resource_name option
    [@ocaml.doc "The name of the TLS security policy.\n"]}[@@ocaml.doc
...
type nonrec load_balancer_tls_certificate_summary =
  ...
  name: resource_name option
    [@ocaml.doc "The name of the SSL/TLS certificate.\n"]}[@@ocaml.doc
                                                            "Provides a summary of SSL/TLS certificate metadata.\n"]
type nonrec load_balancer_tls_certificate_summary_list =
  load_balancer_tls_certificate_summary list[@@ocaml.doc ""]
...
type nonrec load_balancer_tls_certificate_domain_validation_option_list =
  load_balancer_tls_certificate_domain_validation_option list[@@ocaml.doc ""]
...
type nonrec load_balancer_tls_certificate_domain_validation_record_list =
  load_balancer_tls_certificate_domain_validation_record list[@@ocaml.doc ""]
...
type nonrec load_balancer_tls_certificate =
  ...
  serial: non_empty_string option
  ...
  not_after: iso_date option
    [@ocaml.doc "The timestamp when the SSL/TLS certificate expires.\n"];
  key_algorithm: non_empty_string option
    [@ocaml.doc
      "The algorithm used to generate the key pair (the public and private key).\n"];
  issuer: non_empty_string option
    [@ocaml.doc "The issuer of the certificate.\n"];
  issued_at: iso_date option
...
type nonrec load_balancer_tls_certificate_list =
  load_balancer_tls_certificate list[@@ocaml.doc ""]
...
type nonrec load_balancer_configuration_options =
  (load_balancer_attribute_name * string_) list[@@ocaml.doc ""]
type nonrec load_balancer =
  ...
  tls_certificate_summaries:
    load_balancer_tls_certificate_summary_list option
    [@ocaml.doc
  ...
  dns_name: non_empty_string option
...
type nonrec key_pair =
  ...
  name: resource_name option
    [@ocaml.doc "The friendly name of the SSH key pair.\n"]}[@@ocaml.doc
...
type nonrec instance =
  ...
  public_ip_address: ip_address option
    [@ocaml.doc "The public IP address of the instance.\n"];
  private_ip_address: ip_address option
...
type nonrec get_instance_access_details_request =
  ...
  instance_name: resource_name
    [@ocaml.doc "The name of the instance to access.\n"]}[@@ocaml.doc ""]
...
type nonrec disk_info =
  ...
  is_system_disk: boolean_ option
    [@ocaml.doc
      "A Boolean value indicating whether this disk is a system disk (has an operating system loaded on it).\n"];
  size_in_gb: integer option
    [@ocaml.doc "The size of the disk in GB ([32]).\n"];
...
type nonrec destination_info =
  {
  service: non_empty_string option
...
type nonrec export_snapshot_record =
  ...
  name: resource_name option
    [@ocaml.doc "The export snapshot record name.\n"]}[@@ocaml.doc
...
type nonrec lightsail_distribution =
  ...
  origin_public_dn_s: string_ option
...
type nonrec container_service_power =
  ...
  cpu_count: float_ option
    [@ocaml.doc "The number of vCPUs included in the power.\n"];
  price: float_ option
    [@ocaml.doc "The monthly price of the power in USD.\n"];
...
type nonrec container_service_deployment_list =
  container_service_deployment list[@@ocaml.doc ""]
...
type nonrec container_service_log_event_list =
  container_service_log_event list[@@ocaml.doc ""]
...
type nonrec container_service_metadata_entry_list =
  container_service_metadata_entry list[@@ocaml.doc ""]
...
type nonrec cloud_formation_stack_record_source_info_list =
  cloud_formation_stack_record_source_info list[@@ocaml.doc ""]
...
type nonrec cloud_formation_stack_record_list =
  cloud_formation_stack_record list[@@ocaml.doc ""]
...
type nonrec bundle =
  ...
  bundle_id: non_empty_string option
    [@ocaml.doc "The bundle ID ([micro_x_x]).\n"];
  disk_size_in_gb: integer option
    [@ocaml.doc "The size of the SSD ([30]).\n"];
  cpu_count: integer option
...
type nonrec bucket_bundle =
  ...
  transfer_per_month_in_gb: integer option
    [@ocaml.doc "The monthly network transfer quota of the bundle.\n"];
  storage_per_month_in_gb: integer option
...
type nonrec get_bucket_bundles_result =
  {
  bundles: bucket_bundle_list option
...
type nonrec access_key =
  ...
  access_key_id: iam_access_key_id option
    [@ocaml.doc "The ID of the access key.\n"]}[@@ocaml.doc
...
type nonrec download_default_key_pair_result =
  ...
  private_key_base64: base64 option
...
type nonrec delete_load_balancer_tls_certificate_request =
  ...
  certificate_name: resource_name
    [@ocaml.doc "The SSL/TLS certificate name.\n"];
...
type nonrec delete_key_pair_request =
  ...
  key_pair_name: resource_name
    [@ocaml.doc "The name of the key pair to delete.\n"]}[@@ocaml.doc ""]
...
type nonrec delete_instance_request =
  ...
  instance_name: resource_name
    [@ocaml.doc "The name of the instance to delete.\n"]}[@@ocaml.doc ""]
...
type nonrec delete_domain_request =
  {
  domain_name: domain_name
    [@ocaml.doc "The specific domain name to delete.\n"]}[@@ocaml.doc ""]
...
type nonrec create_load_balancer_request =
  ...
  load_balancer_name: resource_name
    [@ocaml.doc "The name of your load balancer.\n"]}[@@ocaml.doc ""]
...
type nonrec create_key_pair_request =
  ...
  tags: tag_list option
    [@ocaml.doc
      "The tag keys and optional values to add to the resource during create.\n\n Use the [TagResource] action to tag a resource after it's created.\n "];
  key_pair_name: resource_name
    [@ocaml.doc "The name for your new key pair.\n"]}[@@ocaml.doc ""]
...
type nonrec disk_map =
  {
  new_disk_name: resource_name option
...
type nonrec create_instances_from_snapshot_request =
  ...
  tags: tag_list option
    [@ocaml.doc
      "The tag keys and optional values to add to the resource during create.\n\n Use the [TagResource] action to tag a resource after it's created.\n "];
  key_pair_name: resource_name option
    [@ocaml.doc "The name for your key pair.\n"];
...
type nonrec create_instances_request =
  ...
  tags: tag_list option
    [@ocaml.doc
      "The tag keys and optional values to add to the resource during create.\n\n Use the [TagResource] action to tag a resource after it's created.\n "];
  key_pair_name: resource_name option
    [@ocaml.doc "The name of your key pair.\n"];
  user_data: string_ option
    [@ocaml.doc
...
type nonrec create_distribution_request =
  ...
  origin: input_origin
    [@ocaml.doc
      "An object that describes the origin resource for the distribution, such as a Lightsail instance, bucket, or load balancer.\n\n The distribution pulls, caches, and serves content from the origin.\n "];
  distribution_name: resource_name
    [@ocaml.doc "The name for the distribution.\n"]}[@@ocaml.doc ""]
...
type nonrec create_certificate_request =
  ...
  certificate_name: certificate_name
    [@ocaml.doc "The name for the certificate.\n"]}[@@ocaml.doc ""]
...
type nonrec allocate_static_ip_request =
  {
  static_ip_name: resource_name
    [@ocaml.doc "The name of the static IP address.\n"]}[@@ocaml.doc ""](** {1:builders Builders} *)

val make_setup_request :
  ?certificate_provider:certificate_provider ->
    ?domain_names:setup_domain_name_list ->
      ?instance_name:resource_name -> unit -> setup_request
val make_resource_location :
  ?region_name:region_name ->
    ?availability_zone:string_ -> unit -> resource_location
val make_setup_history_resource :
  ?resource_type:resource_type ->
    ?location:resource_location ->
      ?created_at:iso_date ->
        ?arn:non_empty_string ->
          ?name:resource_name -> unit -> setup_history_resource
              ...
              ?is_terminal:boolean_ ->
                ?location:resource_location ->
                  ?created_at:iso_date ->
                    ?resource_type:resource_type ->
                      ?resource_name:resource_name ->
                        ?id:non_empty_string -> unit -> operation
      ...
      ?forwarded_cookies:cookie_object ->
        ?cached_http_methods:non_empty_string ->
          ?allowed_http_methods:non_empty_string ->
            ?maximum_tt_l:long ->
              ?minimum_tt_l:long ->
                ?default_tt_l:long -> unit -> cache_settings
...
val make_update_distribution_bundle_request :
  ?bundle_id:string_ ->
    ?distribution_name:resource_name ->
      unit -> update_distribution_bundle_request
...
val make_container :
  ?ports:port_map ->
    ?environment:environment ->
      ?command:string_list -> ?image:string_ -> unit -> container
...
val make_container_service_endpoint :
  ?health_check:container_service_health_check_config ->
    ?container_port:integer ->
      ?container_name:string_ -> unit -> container_service_endpoint
    ...
    ?public_endpoint:container_service_endpoint ->
      ?containers:container_map ->
        ?state:container_service_deployment_state ->
          ?version:integer -> unit -> container_service_deployment
val make_container_service_ecr_image_puller_role :
  ?principal_arn:string_ ->
    ?is_active:boolean_ -> unit -> container_service_ecr_image_puller_role
...
val make_container_service_ecr_image_puller_role_request :
  ?is_active:boolean_ ->
    unit -> container_service_ecr_image_puller_role_request
  ...
  ?access_log_config:bucket_access_log_config ->
    ?readonly_access_accounts:partner_id_list ->
      ?versioning:non_empty_string ->
        ?access_rules:access_rules ->
          bucket_name:bucket_name -> unit -> update_bucket_request
val make_update_bucket_bundle_request :
  bundle_id:non_empty_string ->
    bucket_name:bucket_name -> unit -> update_bucket_bundle_request
val make_untag_resource_request :
  ?resource_arn:resource_arn ->
    tag_keys:tag_key_list ->
      resource_name:resource_name -> unit -> untag_resource_request
val make_unpeer_vpc_request : unit -> unit
val make_time_period :
  ?end_:iso_date -> ?start:iso_date -> unit -> time_period
val make_test_alarm_request :
  state:alarm_state -> alarm_name:resource_name -> unit -> test_alarm_request
val make_tag_resource_request :
  ?resource_arn:resource_arn ->
    tags:tag_list ->
      resource_name:resource_name -> unit -> tag_resource_request
...
val make_stop_instance_request :
  ?force:boolean_ ->
    instance_name:resource_name -> unit -> stop_instance_request
val make_stop_instance_on_idle_request :
  ?duration:string_ ->
    ?threshold:string_ -> unit -> stop_instance_on_idle_request
val make_stop_gui_session_request :
  resource_name:resource_name -> unit -> stop_gui_session_request
val make_static_ip :
...
val make_setup_instance_https_request :
  certificate_provider:certificate_provider ->
    domain_names:setup_domain_name_list ->
      email_address:email_address ->
        instance_name:resource_name -> unit -> setup_instance_https_request
val make_set_resource_access_for_bucket_request :
  access:resource_bucket_access ->
    bucket_name:bucket_name ->
      resource_name:resource_name ->
        unit -> set_resource_access_for_bucket_request
...
val make_session :
  ?is_primary:boolean_ ->
    ?url:sensitive_non_empty_string ->
      ?name:non_empty_string -> unit -> session
    ...
    ?currency:currency ->
      ?unit_:double ->
        ?pricing_unit:pricing_unit ->
          ?usage_cost:double -> unit -> estimate_by_time
val make_cost_estimate :
  ?results_by_time:estimates_by_time ->
    ?usage_type:non_empty_string -> unit -> cost_estimate
val make_resource_budget_estimate :
  ?end_time:iso_date ->
    ?start_time:iso_date ->
      ?cost_estimates:cost_estimates ->
        ?resource_type:resource_type ->
          ?resource_name:resource_name -> unit -> resource_budget_estimate
val make_resource_record :
  ?value:string_ ->
    ?type_:string_ -> ?name:string_ -> unit -> resource_record
val make_reset_distribution_cache_request :
  ?distribution_name:resource_name ->
    unit -> reset_distribution_cache_request
  ...
  ?validation_status:certificate_domain_validation_status ->
    ?dns_record_creation_state:dns_record_creation_state ->
      ?resource_record:resource_record ->
        ?domain_name:domain_name -> unit -> domain_validation_record
...
val make_relational_database_hardware :
  ?ram_size_in_gb:float_ ->
    ?disk_size_in_gb:integer ->
      ?cpu_count:integer -> unit -> relational_database_hardware
...
val make_relational_database_endpoint :
  ?address:non_empty_string ->
    ?port:integer -> unit -> relational_database_endpoint
val make_pending_maintenance_action :
  ?current_apply_date:iso_date ->
    ?description:non_empty_string ->
      ?action:non_empty_string -> unit -> pending_maintenance_action
...
val make_relational_database_event :
  ?event_categories:string_list ->
    ?message:string_ ->
      ?created_at:iso_date ->
        ?resource:resource_name -> unit -> relational_database_event
        ...
        ?transfer_per_month_in_gb:integer ->
          ?disk_size_in_gb:integer ->
            ?ram_size_in_gb:float_ ->
              ?price:float_ ->
                ?name:string_ ->
                  ?bundle_id:string_ -> unit -> relational_database_bundle
      ...
      ?engine_description:string_ ->
        ?engine_version:string_ ->
          ?engine:relational_database_engine ->
            ?blueprint_id:string_ -> unit -> relational_database_blueprint
...
val make_container_image :
  ?created_at:iso_date ->
    ?digest:string_ -> ?image:string_ -> unit -> container_image
val make_register_container_image_request :
  digest:string_ ->
    label:container_label ->
      service_name:container_service_name ->
        unit -> register_container_image_request
val make_availability_zone :
  ?state:non_empty_string ->
    ?zone_name:non_empty_string -> unit -> availability_zone
val make_region :
    ...
    ?availability_zones:availability_zone_list ->
      ?name:region_name ->
        ?display_name:string_ ->
          ?description:string_ -> ?continent_code:string_ -> unit -> region
val make_reboot_relational_database_request :
  relational_database_name:resource_name ->
    unit -> reboot_relational_database_request
val make_reboot_instance_request :
  instance_name:resource_name -> unit -> reboot_instance_request
val make_port_info :
  ?cidr_list_aliases:string_list ->
    ?ipv6_cidrs:string_list ->
      ?cidrs:string_list ->
        ?protocol:network_protocol ->
          ?to_port:port -> ?from_port:port -> unit -> port_info
val make_put_instance_public_ports_request :
  instance_name:resource_name ->
    port_infos:port_info_list -> unit -> put_instance_public_ports_request
            ...
            evaluation_periods:integer ->
              threshold:double ->
                comparison_operator:comparison_operator ->
                  monitored_resource_name:resource_name ->
                    metric_name:metric_name ->
                      alarm_name:resource_name -> unit -> put_alarm_request
val make_peer_vpc_request : unit -> unit
val make_password_data :
  ?key_pair_name:resource_name ->
    ?ciphertext:string_ -> unit -> password_data
val make_origin :
  ?response_timeout:integer ->
    ?protocol_policy:origin_protocol_policy_enum ->
      ?region_name:region_name ->
        ?resource_type:resource_type -> ?name:resource_name -> unit -> origin
...
val make_monthly_transfer :
  ?gb_per_month_allocated:integer -> unit -> monthly_transfer
val make_monitored_resource_info :
  ?resource_type:resource_type ->
    ?name:resource_name ->
      ?arn:resource_arn -> unit -> monitored_resource_info
  ...
  ?unit_:metric_unit ->
    ?timestamp:timestamp ->
      ?sum:double ->
        ?sample_count:double ->
          ?minimum:double ->
            ?maximum:double -> ?average:double -> unit -> metric_datapoint
val make_log_event :
  ?message:string_ -> ?created_at:iso_date -> unit -> log_event
val make_load_balancer_tls_policy :
  ?ciphers:string_list ->
    ?protocols:string_list ->
      ?description:string_ ->
        ?is_default:boolean_ ->
          ?name:resource_name -> unit -> load_balancer_tls_policy
val make_load_balancer_tls_certificate_summary :
  ?is_attached:boolean_ ->
    ?name:resource_name -> unit -> load_balancer_tls_certificate_summary
...
val make_instance_health_summary :
  ?instance_health_reason:instance_health_reason ->
    ?instance_health:instance_health_state ->
      ?instance_name:resource_name -> unit -> instance_health_summary
...
val make_import_key_pair_request :
  public_key_base64:base64 ->
    key_pair_name:resource_name -> unit -> import_key_pair_request
val make_get_static_ips_request :
  ?page_token:string_ -> unit -> get_static_ips_request
val make_get_static_ip_request :
  static_ip_name:resource_name -> unit -> get_static_ip_request
val make_get_setup_history_request :
  ?page_token:setup_history_page_token ->
    resource_name:resource_name -> unit -> get_setup_history_request
...
val make_get_relational_database_bundles_request :
  ?include_inactive:boolean_ ->
    ?page_token:string_ -> unit -> get_relational_database_bundles_request
...
val make_get_relational_database_request :
  relational_database_name:resource_name ->
    unit -> get_relational_database_request
val make_get_regions_request :
  ?include_relational_database_availability_zones:boolean_ ->
    ?include_availability_zones:boolean_ -> unit -> get_regions_request
val make_get_operations_for_resource_request :
  ?page_token:string_ ->
    resource_name:resource_name ->
      unit -> get_operations_for_resource_request
val make_get_operations_request :
  ?page_token:string_ -> unit -> get_operations_request
val make_get_operation_request :
  operation_id:non_empty_string -> unit -> get_operation_request
...
val make_get_load_balancers_request :
  ?page_token:string_ -> unit -> get_load_balancers_request
      ...
      ?resource_type:resource_type ->
        ?location:resource_location ->
          ?created_at:iso_date ->
            ?support_code:string_ ->
              ?arn:non_empty_string ->
                ?name:resource_name -> unit -> key_pair
val make_get_key_pairs_request :
  ?include_default_key_pair:boolean_ ->
    ?page_token:string_ -> unit -> get_key_pairs_request
val make_get_key_pair_request :
  key_pair_name:resource_name -> unit -> get_key_pair_request
val make_instance_state :
  ?name:string_ -> ?code:integer -> unit -> instance_state
    ...
    ?threshold:string_ ->
      ?next_snapshot_time_of_day:time_of_day ->
        ?snapshot_time_of_day:time_of_day ->
          ?status:string_ -> ?name:string_ -> unit -> add_on
val make_disk :
...
val make_get_instance_snapshot_request :
  instance_snapshot_name:resource_name ->
    unit -> get_instance_snapshot_request
val make_instance_hardware :
  ?ram_size_in_gb:float_ ->
    ?disks:disk_list -> ?cpu_count:integer -> unit -> instance_hardware
          ...
          ?common_name:string_ ->
            ?access_type:port_access_type ->
              ?access_from:string_ ->
                ?protocol:network_protocol ->
                  ?to_port:port ->
                    ?from_port:port -> unit -> instance_port_info
...
val make_get_instances_request :
  ?page_token:string_ -> unit -> get_instances_request
  ...
  ?cidr_list_aliases:string_list ->
    ?ipv6_cidrs:string_list ->
      ?cidrs:string_list ->
        ?state:port_state ->
          ?protocol:network_protocol ->
            ?to_port:port -> ?from_port:port -> unit -> instance_port_state
      ...
      ?fingerprint_sh_a256:string_ ->
        ?fingerprint_sh_a1:string_ ->
          ?witnessed_at:iso_date ->
            ?public_key:string_ ->
              ?algorithm:string_ -> unit -> host_key_attributes
            ...
            ?password_data:password_data ->
              ?password:string_ ->
                ?ipv6_addresses:ipv6_address_list ->
                  ?ip_address:ip_address ->
                    ?expires_at:iso_date ->
                      ?cert_key:string_ -> unit -> instance_access_details
val make_get_instance_access_details_request :
  ?protocol:instance_access_protocol ->
    instance_name:resource_name ->
      unit -> get_instance_access_details_request
val make_get_instance_request :
  instance_name:resource_name -> unit -> get_instance_request
val make_disk_info :
  ?is_system_disk:boolean_ ->
    ?size_in_gb:integer ->
      ?path:non_empty_string -> ?name:string_ -> unit -> disk_info
val make_instance_snapshot_info :
  ?from_disk_info:disk_info_list ->
    ?from_blueprint_id:non_empty_string ->
      ?from_bundle_id:non_empty_string -> unit -> instance_snapshot_info
val make_disk_snapshot_info :
  ?size_in_gb:integer -> unit -> disk_snapshot_info
...
val make_destination_info :
  ?service:non_empty_string ->
    ?id:non_empty_string -> unit -> destination_info
      ...
      ?state:record_state ->
        ?resource_type:resource_type ->
          ?location:resource_location ->
            ?created_at:iso_date ->
              ?arn:non_empty_string ->
                ?name:resource_name -> unit -> export_snapshot_record
        ...
        ?resource_type:resource_type ->
          ?location:resource_location ->
            ?created_at:iso_date ->
              ?support_code:string_ ->
                ?arn:non_empty_string ->
                  ?name:resource_name -> unit -> domain
val make_get_domains_request :
  ?page_token:string_ -> unit -> get_domains_request
val make_get_domain_request :
  domain_name:domain_name -> unit -> get_domain_request
...
val make_get_distributions_request :
  ?page_token:string_ ->
    ?distribution_name:resource_name -> unit -> get_distributions_request
...
val make_distribution_bundle :
  ?is_active:boolean_ ->
    ?transfer_per_month_in_gb:integer ->
      ?price:float_ ->
        ?name:string_ -> ?bundle_id:string_ -> unit -> distribution_bundle
                    ...
                    ?resource_type:resource_type ->
                      ?location:resource_location ->
                        ?created_at:iso_date ->
                          ?support_code:string_ ->
                            ?arn:non_empty_string ->
                              ?name:resource_name -> unit -> disk_snapshot
val make_get_disk_snapshots_request :
  ?page_token:string_ -> unit -> get_disk_snapshots_request
...
val make_get_disk_request :
  disk_name:resource_name -> unit -> get_disk_request
val make_get_cost_estimate_request :
  end_time:iso_date ->
    start_time:iso_date ->
      resource_name:resource_name -> unit -> get_cost_estimate_request
val make_get_container_services_request :
  ?service_name:container_service_name ->
    unit -> get_container_services_request
  ...
  ?is_active:boolean_ ->
    ?name:string_ ->
      ?ram_size_in_gb:float_ ->
        ?cpu_count:float_ ->
          ?price:float_ ->
            ?power_id:string_ -> unit -> container_service_power
...
val make_get_container_service_deployments_request :
  service_name:container_service_name ->
    unit -> get_container_service_deployments_request
val make_container_service_log_event :
  ?message:string_ ->
    ?created_at:iso_date -> unit -> container_service_log_event
      ...
      ?state:record_state ->
        ?resource_type:resource_type ->
          ?location:resource_location ->
            ?created_at:iso_date ->
              ?arn:non_empty_string ->
                ?name:resource_name -> unit -> cloud_formation_stack_record
...
val make_certificate_summary :
  ?tags:tag_list ->
    ?certificate_detail:certificate ->
      ?domain_name:domain_name ->
        ?certificate_name:certificate_name ->
          ?certificate_arn:non_empty_string -> unit -> certificate_summary
              ...
              ?name:string_ ->
                ?is_active:boolean_ ->
                  ?instance_type:string_ ->
                    ?bundle_id:non_empty_string ->
                      ?disk_size_in_gb:integer ->
                        ?cpu_count:integer -> ?price:float_ -> unit -> bundle
val make_get_bundles_request :
  ?app_category:app_category ->
    ?page_token:string_ ->
      ?include_inactive:boolean_ -> unit -> get_bundles_request
...
val make_get_buckets_request :
  ?include_connected_resources:boolean_ ->
    ?page_token:string_ ->
      ?bucket_name:bucket_name -> unit -> get_buckets_request
  ...
  ?is_active:boolean_ ->
    ?transfer_per_month_in_gb:integer ->
      ?storage_per_month_in_gb:integer ->
        ?price:float_ ->
          ?name:non_empty_string ->
            ?bundle_id:non_empty_string -> unit -> bucket_bundle
...
val make_access_key_last_used :
  ?service_name:string_ ->
    ?region:string_ ->
      ?last_used_date:iso_date -> unit -> access_key_last_used
val make_access_key :
  ?last_used:access_key_last_used ->
    ?created_at:iso_date ->
      ?status:status_type ->
        ?secret_access_key:non_empty_string ->
          ?access_key_id:iam_access_key_id -> unit -> access_key
                  ...
                  ?description:string_ ->
                    ?type_:blueprint_type ->
                      ?group:non_empty_string ->
                        ?name:resource_name ->
                          ?blueprint_id:non_empty_string -> unit -> blueprint
val make_get_blueprints_request :
  ?app_category:app_category ->
    ?page_token:string_ ->
      ?include_inactive:boolean_ -> unit -> get_blueprints_request
val make_attached_disk :
  ?size_in_gb:integer -> ?path:string_ -> unit -> attached_disk
val make_auto_snapshot_details :
  ?from_attached_disks:attached_disk_list ->
    ?status:auto_snapshot_status ->
      ?created_at:iso_date -> ?date:string_ -> unit -> auto_snapshot_details
                              ...
                              ?support_code:string_ ->
                                ?resource_type:resource_type ->
                                  ?location:resource_location ->
                                    ?created_at:iso_date ->
                                      ?arn:non_empty_string ->
                                        ?name:resource_name -> unit -> alarm
val make_get_alarms_request :
  ?monitored_resource_name:resource_name ->
    ?page_token:string_ ->
      ?alarm_name:resource_name -> unit -> get_alarms_request
val make_get_active_names_request :
  ?page_token:string_ -> unit -> get_active_names_request
...
val make_enable_add_on_request :
  add_on_request:add_on_request ->
    resource_name:resource_name -> unit -> enable_add_on_request
...
val make_detach_static_ip_request :
  static_ip_name:resource_name -> unit -> detach_static_ip_request
...
val make_detach_disk_request :
  disk_name:resource_name -> unit -> detach_disk_request
...
val make_delete_key_pair_request :
  ?expected_fingerprint:string_ ->
    key_pair_name:resource_name -> unit -> delete_key_pair_request
val make_delete_instance_snapshot_request :
  instance_snapshot_name:resource_name ->
    unit -> delete_instance_snapshot_request
val make_delete_instance_request :
  ?force_delete_add_ons:boolean_ ->
    instance_name:resource_name -> unit -> delete_instance_request
val make_delete_domain_entry_request :
  domain_entry:domain_entry ->
    domain_name:domain_name -> unit -> delete_domain_entry_request
val make_delete_domain_request :
  domain_name:domain_name -> unit -> delete_domain_request
...
val make_delete_disk_request :
  ?force_delete_add_ons:boolean_ ->
    disk_name:resource_name -> unit -> delete_disk_request
val make_delete_container_service_request :
  service_name:container_service_name ->
    unit -> delete_container_service_request
val make_delete_container_image_request :
  image:string_ ->
    service_name:container_service_name ->
      unit -> delete_container_image_request
...
val make_delete_bucket_access_key_request :
  access_key_id:non_empty_string ->
    bucket_name:bucket_name -> unit -> delete_bucket_access_key_request
val make_delete_bucket_request :
  ?force_delete:boolean_ ->
    bucket_name:bucket_name -> unit -> delete_bucket_request
val make_delete_auto_snapshot_request :
  date:auto_snapshot_date ->
    resource_name:resource_name -> unit -> delete_auto_snapshot_request
val make_delete_alarm_request :
  alarm_name:resource_name -> unit -> delete_alarm_request
...
val make_create_key_pair_request :
  ?tags:tag_list ->
    key_pair_name:resource_name -> unit -> create_key_pair_request
...
val make_disk_map :
  ?new_disk_name:resource_name ->
    ?original_disk_path:non_empty_string -> unit -> disk_map
...
val make_create_gui_session_access_details_request :
  resource_name:resource_name ->
    unit -> create_gui_session_access_details_request
val make_create_domain_entry_request :
  domain_entry:domain_entry ->
    domain_name:domain_name -> unit -> create_domain_entry_request
...
val make_create_disk_snapshot_request :
  ?tags:tag_list ->
    ?instance_name:resource_name ->
      ?disk_name:resource_name ->
        disk_snapshot_name:resource_name ->
          unit -> create_disk_snapshot_request
...
val make_create_disk_request :
  ?add_ons:add_on_request_list ->
    ?tags:tag_list ->
      size_in_gb:integer ->
        availability_zone:non_empty_string ->
          disk_name:resource_name -> unit -> create_disk_request
val make_container_service_registry_login :
  ?registry:string_ ->
    ?expires_at:iso_date ->
      ?password:string_ ->
        ?username:string_ -> unit -> container_service_registry_login
val make_create_container_service_registry_login_request : unit -> unit
val make_endpoint_request :
  ?health_check:container_service_health_check_config ->
    container_port:integer ->
      container_name:string_ -> unit -> endpoint_request
      ...
      ?public_domain_names:container_service_public_domains ->
        ?tags:tag_list ->
          scale:container_service_scale ->
            power:container_service_power_name ->
              service_name:container_service_name ->
                unit -> create_container_service_request
...
val make_instance_entry :
  ?user_data:string_ ->
    availability_zone:string_ ->
      port_info_source:port_info_source_type ->
        instance_type:non_empty_string ->
          source_name:resource_name -> unit -> instance_entry
...
val make_create_certificate_request :
  ?tags:tag_list ->
    ?subject_alternative_names:subject_alternative_name_list ->
      domain_name:domain_name ->
        certificate_name:certificate_name ->
          unit -> create_certificate_request
...
val make_create_bucket_request :
  ?enable_object_versioning:boolean_ ->
    ?tags:tag_list ->
      bundle_id:non_empty_string ->
        bucket_name:bucket_name -> unit -> create_bucket_request
...
val make_attach_static_ip_request :
  instance_name:resource_name ->
    static_ip_name:resource_name -> unit -> attach_static_ip_request
...
val make_attach_disk_request :
  ?auto_mounting:boolean_ ->
    disk_path:non_empty_string ->
      instance_name:resource_name ->
        disk_name:resource_name -> unit -> attach_disk_request
...
val make_allocate_static_ip_request :
  static_ip_name:resource_name -> unit -> allocate_static_ip_request(** {1:operations Operations} *)
