...
let update_instance_metadata_options_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("httpPutResponseHopLimit",
      (option_to_yojson integer_to_yojson x.http_put_response_hop_limit));
    ("httpEndpoint",
...
let input_origin_to_yojson (x : input_origin) =
  assoc_to_yojson
    [("responseTimeout",
       (option_to_yojson integer_to_yojson x.response_timeout));
    ("protocolPolicy",
...
let container_service_health_check_config_to_yojson
  ...
  assoc_to_yojson
    ...
    ("path", (option_to_yojson string__to_yojson x.path));
    ("intervalSeconds",
      (option_to_yojson integer_to_yojson x.interval_seconds));
    ("timeoutSeconds",
      (option_to_yojson integer_to_yojson x.timeout_seconds));
    ("unhealthyThreshold",
      (option_to_yojson integer_to_yojson x.unhealthy_threshold));
    ("healthyThreshold",
      (option_to_yojson integer_to_yojson x.healthy_threshold))]
...
let relational_database_bundle_to_yojson (x : relational_database_bundle) =
  assoc_to_yojson
    ...
    ("transferPerMonthInGb",
      (option_to_yojson integer_to_yojson x.transfer_per_month_in_gb));
    ("diskSizeInGb", (option_to_yojson integer_to_yojson x.disk_size_in_gb));
    ("ramSizeInGb", (option_to_yojson float__to_yojson x.ram_size_in_gb));
...
let put_alarm_request_to_yojson (x : put_alarm_request) =
  assoc_to_yojson
    ...
    ("datapointsToAlarm",
      (option_to_yojson integer_to_yojson x.datapoints_to_alarm));
...
let monthly_transfer_to_yojson (x : monthly_transfer) =
  assoc_to_yojson
    [("gbPerMonthAllocated",
       (option_to_yojson integer_to_yojson x.gb_per_month_allocated))]
...
let get_relational_database_events_request_to_yojson
  ...
  assoc_to_yojson
    [("pageToken", (option_to_yojson string__to_yojson x.page_token));
    ("durationInMinutes",
      (option_to_yojson integer_to_yojson x.duration_in_minutes));
    ("relationalDatabaseName",
      (Some (resource_name_to_yojson x.relational_database_name)))]
...
let bundle_to_yojson (x : bundle) =
  assoc_to_yojson
    [("publicIpv4AddressCount",
       (option_to_yojson integer_to_yojson x.public_ipv4_address_count));
...
let bucket_bundle_to_yojson (x : bucket_bundle) =
  assoc_to_yojson
    ...
    ("transferPerMonthInGb",
      (option_to_yojson integer_to_yojson x.transfer_per_month_in_gb));
    ("storagePerMonthInGb",
      (option_to_yojson integer_to_yojson x.storage_per_month_in_gb));
    ("price", (option_to_yojson float__to_yojson x.price));
    ("name", (option_to_yojson non_empty_string_to_yojson x.name));
    ("bundleId", (option_to_yojson non_empty_string_to_yojson x.bundle_id))]
...
let alarm_to_yojson (x : alarm) =
  assoc_to_yojson
    ...
    ("evaluationPeriods",
      (option_to_yojson integer_to_yojson x.evaluation_periods));
    ("comparisonOperator",
...
let create_gui_session_access_details_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("percentageComplete",
      (option_to_yojson integer_to_yojson x.percentage_complete));
