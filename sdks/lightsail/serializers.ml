...
let setup_domain_name_list_to_yojson tree =
  list_to_yojson setup_domain_name_to_yojson tree
...
let setup_request_to_yojson (x : setup_request) =
  assoc_to_yojson
    [("certificateProvider",
       (option_to_yojson certificate_provider_to_yojson
          x.certificate_provider));
    ("domainNames",
...
let setup_history_to_yojson (x : setup_history) =
  assoc_to_yojson
    [("status", (option_to_yojson setup_status_to_yojson x.status));
    ("executionDetails",
      (option_to_yojson setup_execution_details_list_to_yojson
         x.execution_details));
    ("resource",
...
let setup_history_list_to_yojson tree =
  list_to_yojson setup_history_to_yojson tree
...
let update_relational_database_result_to_yojson
  (x : update_relational_database_result) =
  assoc_to_yojson
...
let update_relational_database_request_to_yojson
  (x : update_relational_database_request) =
  assoc_to_yojson
...
let relational_database_parameter_to_yojson
  (x : relational_database_parameter) =
  assoc_to_yojson
    [("parameterValue",
...
let account_setup_in_progress_exception_to_yojson
  (x : account_setup_in_progress_exception) =
  assoc_to_yojson
    [("tip", (option_to_yojson string__to_yojson x.tip));
    ("message", (option_to_yojson string__to_yojson x.message));
    ("docs", (option_to_yojson string__to_yojson x.docs));
...
let update_load_balancer_attribute_result_to_yojson
  (x : update_load_balancer_attribute_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
...
let update_load_balancer_attribute_request_to_yojson
  (x : update_load_balancer_attribute_request) =
  assoc_to_yojson
...
let update_instance_metadata_options_result_to_yojson
  (x : update_instance_metadata_options_result) =
  assoc_to_yojson
...
let input_origin_to_yojson (x : input_origin) =
  assoc_to_yojson
    ...
    ("protocolPolicy",
      (option_to_yojson origin_protocol_policy_enum_to_yojson
         x.protocol_policy));
    ("regionName", (option_to_yojson region_name_to_yojson x.region_name));
    ("name", (option_to_yojson resource_name_to_yojson x.name))]
...
let header_forward_list_to_yojson tree =
  list_to_yojson header_enum_to_yojson tree
...
let cache_settings_to_yojson (x : cache_settings) =
  assoc_to_yojson
    [("forwardedQueryStrings",
       (option_to_yojson query_string_object_to_yojson
          x.forwarded_query_strings));
    ("forwardedHeaders",
...
let cache_behavior_list_to_yojson tree =
  list_to_yojson cache_behavior_per_path_to_yojson tree
...
let update_distribution_bundle_result_to_yojson
  (x : update_distribution_bundle_result) =
  assoc_to_yojson
    [("operation", (option_to_yojson operation_to_yojson x.operation))]
let update_distribution_bundle_request_to_yojson
  (x : update_distribution_bundle_request) =
  assoc_to_yojson
...
let container_service_state_detail_code_to_yojson
  (x : container_service_state_detail_code) =
  match x with
...
let container_service_state_detail_to_yojson
  (x : container_service_state_detail) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message));
    ("code",
...
let container_service_deployment_state_to_yojson
  (x : container_service_deployment_state) =
  match x with
  | FAILED -> `String "FAILED"
  | INACTIVE -> `String "INACTIVE"
  | ACTIVE -> `String "ACTIVE"
  | ACTIVATING -> `String "ACTIVATING"
let environment_to_yojson tree =
...
let container_map_to_yojson tree =
  map_to_yojson container_name_to_yojson container_to_yojson tree
let container_service_health_check_config_to_yojson
  (x : container_service_health_check_config) =
  assoc_to_yojson
...
let container_service_endpoint_to_yojson (x : container_service_endpoint) =
  assoc_to_yojson
    [("healthCheck",
       (option_to_yojson container_service_health_check_config_to_yojson
          x.health_check));
    ("containerPort", (option_to_yojson integer__to_yojson x.container_port));
...
let container_service_deployment_to_yojson (x : container_service_deployment)
  ...
  assoc_to_yojson
    [("createdAt", (option_to_yojson iso_date_to_yojson x.created_at));
    ("publicEndpoint",
      (option_to_yojson container_service_endpoint_to_yojson
         x.public_endpoint));
    ...
    ("version", (option_to_yojson integer__to_yojson x.version))]
let container_service_public_domains_list_to_yojson tree =
  list_to_yojson string__to_yojson tree
let container_service_public_domains_to_yojson tree =
  map_to_yojson string__to_yojson
    container_service_public_domains_list_to_yojson tree
let container_service_ecr_image_puller_role_to_yojson
  (x : container_service_ecr_image_puller_role) =
  assoc_to_yojson
...
let private_registry_access_to_yojson (x : private_registry_access) =
  assoc_to_yojson
    [("ecrImagePullerRole",
       (option_to_yojson container_service_ecr_image_puller_role_to_yojson
          x.ecr_image_puller_role))]
let container_service_to_yojson (x : container_service) =
  assoc_to_yojson
    [("privateRegistryAccess",
       (option_to_yojson private_registry_access_to_yojson
          x.private_registry_access));
    ("url", (option_to_yojson string__to_yojson x.url));
    ("publicDomainNames",
      (option_to_yojson container_service_public_domains_to_yojson
         x.public_domain_names));
    ("privateDomainName",
      (option_to_yojson string__to_yojson x.private_domain_name));
    ("principalArn", (option_to_yojson string__to_yojson x.principal_arn));
    ("isDisabled", (option_to_yojson boolean__to_yojson x.is_disabled));
    ("nextDeployment",
      (option_to_yojson container_service_deployment_to_yojson
         x.next_deployment));
    ("currentDeployment",
      (option_to_yojson container_service_deployment_to_yojson
         x.current_deployment));
    ("scale", (option_to_yojson container_service_scale_to_yojson x.scale));
    ("stateDetail",
      (option_to_yojson container_service_state_detail_to_yojson
         x.state_detail));
    ...
    ("containerServiceName",
      (option_to_yojson container_service_name_to_yojson
         x.container_service_name))]
let update_container_service_result_to_yojson
  (x : update_container_service_result) =
  assoc_to_yojson
    [("containerService",
...
let private_registry_access_request_to_yojson
  (x : private_registry_access_request) =
  assoc_to_yojson
    [("ecrImagePullerRole",
       (option_to_yojson
          container_service_ecr_image_puller_role_request_to_yojson
          x.ecr_image_puller_role))]
let update_container_service_request_to_yojson
  (x : update_container_service_request) =
  assoc_to_yojson
    [("privateRegistryAccess",
       (option_to_yojson private_registry_access_request_to_yojson
          x.private_registry_access));
    ("publicDomainNames",
      (option_to_yojson container_service_public_domains_to_yojson
         x.public_domain_names));
...
let partner_id_list_to_yojson tree =
  list_to_yojson non_empty_string_to_yojson tree
let resource_receiving_access_to_yojson (x : resource_receiving_access) =
  assoc_to_yojson
    ...
    ("name", (option_to_yojson non_empty_string_to_yojson x.name))]
let access_receiver_list_to_yojson tree =
  list_to_yojson resource_receiving_access_to_yojson tree
...
let bucket_to_yojson (x : bucket) =
  assoc_to_yojson
    [("accessLogConfig",
       (option_to_yojson bucket_access_log_config_to_yojson
          x.access_log_config));
    ("state", (option_to_yojson bucket_state_to_yojson x.state));
    ("resourcesReceivingAccess",
      (option_to_yojson access_receiver_list_to_yojson
         x.resources_receiving_access));
...
let tag_resource_request_to_yojson (x : tag_resource_request) =
  assoc_to_yojson
    ...
    ("resourceArn", (option_to_yojson resource_arn_to_yojson x.resource_arn));
    ("resourceName", (Some (resource_name_to_yojson x.resource_name)))]
let subject_alternative_name_list_to_yojson tree =
  list_to_yojson domain_name_to_yojson tree
let stop_relational_database_result_to_yojson
  (x : stop_relational_database_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let stop_relational_database_request_to_yojson
  (x : stop_relational_database_request) =
  assoc_to_yojson
    [("relationalDatabaseSnapshotName",
       (option_to_yojson resource_name_to_yojson
          x.relational_database_snapshot_name));
    ("relationalDatabaseName",
      (Some (resource_name_to_yojson x.relational_database_name)))]
...
let stop_instance_on_idle_request_to_yojson
  (x : stop_instance_on_idle_request) =
  assoc_to_yojson
...
let start_relational_database_result_to_yojson
  (x : start_relational_database_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let start_relational_database_request_to_yojson
  (x : start_relational_database_request) =
  assoc_to_yojson
    [("relationalDatabaseName",
       (Some (resource_name_to_yojson x.relational_database_name)))]
...
let set_resource_access_for_bucket_result_to_yojson
  (x : set_resource_access_for_bucket_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
...
let set_resource_access_for_bucket_request_to_yojson
  (x : set_resource_access_for_bucket_request) =
  assoc_to_yojson
...
let send_contact_method_verification_result_to_yojson
  (x : send_contact_method_verification_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let contact_method_verification_protocol_to_yojson
  (x : contact_method_verification_protocol) =
...
let estimates_by_time_to_yojson tree =
  list_to_yojson estimate_by_time_to_yojson tree
...
let cost_estimates_to_yojson tree =
  list_to_yojson cost_estimate_to_yojson tree
...
let resource_name_list_to_yojson tree =
  list_to_yojson resource_name_to_yojson tree
let reset_distribution_cache_result_to_yojson
  (x : reset_distribution_cache_result) =
  assoc_to_yojson
    [("operation", (option_to_yojson operation_to_yojson x.operation));
...
let certificate_domain_validation_status_to_yojson
  (x : certificate_domain_validation_status) =
  match x with
...
let domain_validation_record_to_yojson (x : domain_validation_record) =
  assoc_to_yojson
    [("validationStatus",
       (option_to_yojson certificate_domain_validation_status_to_yojson
          x.validation_status));
    ("dnsRecordCreationState",
      (option_to_yojson dns_record_creation_state_to_yojson
...
let renewal_summary_to_yojson (x : renewal_summary) =
  assoc_to_yojson
    ...
    ("renewalStatusReason",
      (option_to_yojson renewal_status_reason_to_yojson
         x.renewal_status_reason));
    ("renewalStatus",
      (option_to_yojson renewal_status_to_yojson x.renewal_status));
    ("domainValidationRecords",
      (option_to_yojson domain_validation_record_list_to_yojson
  ...
  assoc_to_yojson
    [("fromRelationalDatabaseBlueprintId",
       (option_to_yojson string__to_yojson
          x.from_relational_database_blueprint_id));
    ("fromRelationalDatabaseBundleId",
      (option_to_yojson string__to_yojson
         x.from_relational_database_bundle_id));
    ("fromRelationalDatabaseArn",
      (option_to_yojson non_empty_string_to_yojson
         x.from_relational_database_arn));
    ("fromRelationalDatabaseName",
      (option_to_yojson non_empty_string_to_yojson
         x.from_relational_database_name));
    ("state", (option_to_yojson non_empty_string_to_yojson x.state));
    ("sizeInGb", (option_to_yojson integer__to_yojson x.size_in_gb));
    ("engineVersion",
...
let relational_database_password_version_to_yojson
  (x : relational_database_password_version) =
  match x with
  | PENDING -> `String "PENDING"
  | PREVIOUS -> `String "PREVIOUS"
  | CURRENT -> `String "CURRENT"
let relational_database_metric_name_to_yojson
  (x : relational_database_metric_name) =
  match x with
...
let relational_database_hardware_to_yojson (x : relational_database_hardware)
  ...
  assoc_to_yojson
    ...
    ("diskSizeInGb", (option_to_yojson integer__to_yojson x.disk_size_in_gb));
    ("cpuCount", (option_to_yojson integer__to_yojson x.cpu_count))]
...
let relational_database_endpoint_to_yojson (x : relational_database_endpoint)
  ...
  assoc_to_yojson
    ...
    ("port", (option_to_yojson integer__to_yojson x.port))]
...
let relational_database_to_yojson (x : relational_database) =
  assoc_to_yojson
    ...
    ("pendingMaintenanceActions",
      (option_to_yojson pending_maintenance_action_list_to_yojson
         x.pending_maintenance_actions));
    ("masterEndpoint",
      (option_to_yojson relational_database_endpoint_to_yojson
         x.master_endpoint));
    ("publiclyAccessible",
      (option_to_yojson boolean__to_yojson x.publicly_accessible));
    ("preferredMaintenanceWindow",
      (option_to_yojson non_empty_string_to_yojson
         x.preferred_maintenance_window));
    ("preferredBackupWindow",
    ...
    ("relationalDatabaseBundleId",
      (option_to_yojson non_empty_string_to_yojson
         x.relational_database_bundle_id));
    ("relationalDatabaseBlueprintId",
      (option_to_yojson non_empty_string_to_yojson
         x.relational_database_blueprint_id));
    ("tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("resourceType",
      (option_to_yojson resource_type_to_yojson x.resource_type));
    ("location", (option_to_yojson resource_location_to_yojson x.location));
    ...
    ("arn", (option_to_yojson non_empty_string_to_yojson x.arn));
    ("name", (option_to_yojson resource_name_to_yojson x.name))]
let relational_database_list_to_yojson tree =
  list_to_yojson relational_database_to_yojson tree
...
let relational_database_blueprint_to_yojson
  (x : relational_database_blueprint) =
  assoc_to_yojson
    [("isEngineDefault",
...
let name_servers_update_state_code_to_yojson
  (x : name_servers_update_state_code) =
  match x with
  | Started -> `String "STARTED"
  | Failed -> `String "FAILED"
  | Pending -> `String "PENDING"
...
let r53_hosted_zone_deletion_state_code_to_yojson
  (x : r53_hosted_zone_deletion_state_code) =
  match x with
  | Started -> `String "STARTED"
  | Failed -> `String "FAILED"
  | Pending -> `String "PENDING"
...
let r53_hosted_zone_deletion_state_to_yojson
  (x : r53_hosted_zone_deletion_state) =
  assoc_to_yojson
    [("message", (option_to_yojson string__to_yojson x.message));
    ("code",
...
let registered_domain_delegation_info_to_yojson
  ...
  assoc_to_yojson
    [("r53HostedZoneDeletionState",
       (option_to_yojson r53_hosted_zone_deletion_state_to_yojson
          x.r53_hosted_zone_deletion_state));
    ("nameServersUpdateState",
      (option_to_yojson name_servers_update_state_to_yojson
         x.name_servers_update_state))]
...
let register_container_image_result_to_yojson
  (x : register_container_image_result) =
  assoc_to_yojson
    [("containerImage",
...
let register_container_image_request_to_yojson
  (x : register_container_image_request) =
  assoc_to_yojson
...
let availability_zone_list_to_yojson tree =
  list_to_yojson availability_zone_to_yojson tree
let region_to_yojson (x : region) =
  assoc_to_yojson
    [("relationalDatabaseAvailabilityZones",
       (option_to_yojson availability_zone_list_to_yojson
          x.relational_database_availability_zones));
    ("availabilityZones",
...
let reboot_relational_database_result_to_yojson
  (x : reboot_relational_database_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let reboot_relational_database_request_to_yojson
  (x : reboot_relational_database_request) =
  assoc_to_yojson
    [("relationalDatabaseName",
       (Some (resource_name_to_yojson x.relational_database_name)))]
...
let put_instance_public_ports_result_to_yojson
  (x : put_instance_public_ports_result) =
  assoc_to_yojson
    [("operation", (option_to_yojson operation_to_yojson x.operation))]
...
let put_instance_public_ports_request_to_yojson
  (x : put_instance_public_ports_request) =
  assoc_to_yojson
    [("instanceName", (Some (resource_name_to_yojson x.instance_name)));
...
let contact_protocols_list_to_yojson tree =
  list_to_yojson contact_protocol_to_yojson tree
let notification_trigger_list_to_yojson tree =
  list_to_yojson alarm_state_to_yojson tree
let put_alarm_request_to_yojson (x : put_alarm_request) =
  assoc_to_yojson
    [("notificationEnabled",
       (option_to_yojson boolean__to_yojson x.notification_enabled));
    ("notificationTriggers",
      (option_to_yojson notification_trigger_list_to_yojson
         x.notification_triggers));
    ("contactProtocols",
    ...
    ("evaluationPeriods", (Some (integer__to_yojson x.evaluation_periods)));
...
let open_instance_public_ports_result_to_yojson
  (x : open_instance_public_ports_result) =
  assoc_to_yojson
    [("operation", (option_to_yojson operation_to_yojson x.operation))]
let open_instance_public_ports_request_to_yojson
  (x : open_instance_public_ports_request) =
  assoc_to_yojson
    [("instanceName", (Some (resource_name_to_yojson x.instance_name)));
...
let metric_statistic_list_to_yojson tree =
  list_to_yojson metric_statistic_to_yojson tree
...
let metric_datapoint_list_to_yojson tree =
  list_to_yojson metric_datapoint_to_yojson tree
...
let load_balancer_tls_certificate_summary_to_yojson
  (x : load_balancer_tls_certificate_summary) =
  assoc_to_yojson
    [("isAttached", (option_to_yojson boolean__to_yojson x.is_attached));
    ("name", (option_to_yojson resource_name_to_yojson x.name))]
...
let load_balancer_tls_certificate_status_to_yojson
  (x : load_balancer_tls_certificate_status) =
  match x with
...
let load_balancer_tls_certificate_domain_validation_option_to_yojson
  ...
  assoc_to_yojson
    [("validationStatus",
       (option_to_yojson
          load_balancer_tls_certificate_domain_status_to_yojson
          x.validation_status));
    ("domainName", (option_to_yojson domain_name_to_yojson x.domain_name))]
let load_balancer_tls_certificate_domain_validation_option_list_to_yojson
  tree =
  list_to_yojson
    load_balancer_tls_certificate_domain_validation_option_to_yojson tree
let load_balancer_tls_certificate_renewal_summary_to_yojson
  (x : load_balancer_tls_certificate_renewal_summary) =
  assoc_to_yojson
    [("domainValidationOptions",
       (option_to_yojson
          load_balancer_tls_certificate_domain_validation_option_list_to_yojson
          x.domain_validation_options));
    ("renewalStatus",
      (option_to_yojson
         load_balancer_tls_certificate_renewal_status_to_yojson
         x.renewal_status))]
...
let load_balancer_tls_certificate_dns_record_creation_state_to_yojson
  ...
  assoc_to_yojson
    ...
    ("code",
      (option_to_yojson
         load_balancer_tls_certificate_dns_record_creation_state_code_to_yojson
         x.code))]
let load_balancer_tls_certificate_domain_validation_record_to_yojson
  ...
  assoc_to_yojson
    [("dnsRecordCreationState",
       (option_to_yojson
          load_balancer_tls_certificate_dns_record_creation_state_to_yojson
          x.dns_record_creation_state));
    ("domainName", (option_to_yojson domain_name_to_yojson x.domain_name));
    ("validationStatus",
      (option_to_yojson load_balancer_tls_certificate_domain_status_to_yojson
         x.validation_status));
...
let load_balancer_tls_certificate_domain_validation_record_list_to_yojson
  tree =
  list_to_yojson
    load_balancer_tls_certificate_domain_validation_record_to_yojson tree
...
let load_balancer_tls_certificate_to_yojson
  (x : load_balancer_tls_certificate) =
  assoc_to_yojson
    ...
    ("revocationReason",
      (option_to_yojson
         load_balancer_tls_certificate_revocation_reason_to_yojson
         x.revocation_reason));
    ("renewalSummary",
      (option_to_yojson
         load_balancer_tls_certificate_renewal_summary_to_yojson
         x.renewal_summary));
    ...
    ("failureReason",
      (option_to_yojson
         load_balancer_tls_certificate_failure_reason_to_yojson
         x.failure_reason));
    ("domainValidationRecords",
      (option_to_yojson
         load_balancer_tls_certificate_domain_validation_record_list_to_yojson
         x.domain_validation_records));
    ("domainName", (option_to_yojson domain_name_to_yojson x.domain_name));
    ("status",
      (option_to_yojson load_balancer_tls_certificate_status_to_yojson
         x.status));
    ("isAttached", (option_to_yojson boolean__to_yojson x.is_attached));
    ("loadBalancerName",
...
let load_balancer_protocol_to_yojson (x : load_balancer_protocol) =
  match x with | HTTP -> `String "HTTP" | HTTP_HTTPS -> `String "HTTP_HTTPS"
...
let instance_health_summary_to_yojson (x : instance_health_summary) =
  assoc_to_yojson
    [("instanceHealthReason",
       (option_to_yojson instance_health_reason_to_yojson
          x.instance_health_reason));
    ("instanceHealth",
...
let load_balancer_to_yojson (x : load_balancer) =
  assoc_to_yojson
    ...
    ("configurationOptions",
      (option_to_yojson load_balancer_configuration_options_to_yojson
         x.configuration_options));
    ("tlsCertificateSummaries",
      (option_to_yojson load_balancer_tls_certificate_summary_list_to_yojson
         x.tls_certificate_summaries));
    ("instanceHealthSummary",
      (option_to_yojson instance_health_summary_list_to_yojson
         x.instance_health_summary));
    ("instancePort", (option_to_yojson integer__to_yojson x.instance_port));
    ("healthCheckPath",
    ...
    ("arn", (option_to_yojson non_empty_string_to_yojson x.arn));
    ("name", (option_to_yojson resource_name_to_yojson x.name))]
let load_balancer_list_to_yojson tree =
  list_to_yojson load_balancer_to_yojson tree
...
let get_static_ip_result_to_yojson (x : get_static_ip_result) =
  assoc_to_yojson
    [("staticIp", (option_to_yojson static_ip_to_yojson x.static_ip))]
...
let get_relational_database_snapshots_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("relationalDatabaseSnapshots",
      (option_to_yojson relational_database_snapshot_list_to_yojson
         x.relational_database_snapshots))]
...
let get_relational_database_snapshot_result_to_yojson
  (x : get_relational_database_snapshot_result) =
  assoc_to_yojson
    [("relationalDatabaseSnapshot",
       (option_to_yojson relational_database_snapshot_to_yojson
          x.relational_database_snapshot))]
...
let get_relational_databases_result_to_yojson
  (x : get_relational_databases_result) =
  assoc_to_yojson
    [("nextPageToken",
       (option_to_yojson string__to_yojson x.next_page_token));
    ("relationalDatabases",
      (option_to_yojson relational_database_list_to_yojson
         x.relational_databases))]
let get_relational_databases_request_to_yojson
  (x : get_relational_databases_request) =
  assoc_to_yojson
    [("pageToken", (option_to_yojson string__to_yojson x.page_token))]
let get_relational_database_parameters_result_to_yojson
  ...
  assoc_to_yojson
    [("nextPageToken",
       (option_to_yojson string__to_yojson x.next_page_token));
    ("parameters",
      (option_to_yojson relational_database_parameter_list_to_yojson
         x.parameters))]
...
let get_relational_database_metric_data_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("metricName",
      (option_to_yojson relational_database_metric_name_to_yojson
         x.metric_name))]
...
let get_relational_database_master_user_password_request_to_yojson
  ...
  assoc_to_yojson
    [("passwordVersion",
       (option_to_yojson relational_database_password_version_to_yojson
          x.password_version));
    ("relationalDatabaseName",
      (Some (resource_name_to_yojson x.relational_database_name)))]
let get_relational_database_log_streams_result_to_yojson
  ...
  assoc_to_yojson
    [("logStreams", (option_to_yojson string_list_to_yojson x.log_streams))]
...
let get_relational_database_events_result_to_yojson
  (x : get_relational_database_events_result) =
  assoc_to_yojson
    [("nextPageToken",
       (option_to_yojson string__to_yojson x.next_page_token));
    ("relationalDatabaseEvents",
      (option_to_yojson relational_database_event_list_to_yojson
         x.relational_database_events))]
let get_relational_database_events_request_to_yojson
  (x : get_relational_database_events_request) =
  assoc_to_yojson
    [("pageToken", (option_to_yojson string__to_yojson x.page_token));
    ("durationInMinutes",
...
let get_relational_database_bundles_result_to_yojson
  (x : get_relational_database_bundles_result) =
  assoc_to_yojson
    [("nextPageToken",
       (option_to_yojson string__to_yojson x.next_page_token));
    ("bundles",
...
let get_relational_database_bundles_request_to_yojson
  (x : get_relational_database_bundles_request) =
  assoc_to_yojson
    [("includeInactive",
...
let get_relational_database_blueprints_result_to_yojson
  ...
  assoc_to_yojson
    [("nextPageToken",
       (option_to_yojson string__to_yojson x.next_page_token));
    ("blueprints",
      (option_to_yojson relational_database_blueprint_list_to_yojson
         x.blueprints))]
...
let get_operations_for_resource_request_to_yojson
  (x : get_operations_for_resource_request) =
  assoc_to_yojson
    [("pageToken", (option_to_yojson string__to_yojson x.page_token));
    ("resourceName", (Some (resource_name_to_yojson x.resource_name)))]
...
let get_operation_request_to_yojson (x : get_operation_request) =
  assoc_to_yojson
    [("operationId", (Some (non_empty_string_to_yojson x.operation_id)))]
let get_load_balancer_tls_policies_result_to_yojson
  (x : get_load_balancer_tls_policies_result) =
  assoc_to_yojson
    [("nextPageToken",
       (option_to_yojson string__to_yojson x.next_page_token));
    ("tlsPolicies",
      (option_to_yojson load_balancer_tls_policy_list_to_yojson
         x.tls_policies))]
let get_load_balancer_tls_policies_request_to_yojson
  (x : get_load_balancer_tls_policies_request) =
  assoc_to_yojson
    [("pageToken", (option_to_yojson string__to_yojson x.page_token))]
let get_load_balancer_tls_certificates_result_to_yojson
  ...
  assoc_to_yojson
    [("tlsCertificates",
       (option_to_yojson load_balancer_tls_certificate_list_to_yojson
          x.tls_certificates))]
...
let get_load_balancer_metric_data_result_to_yojson
  (x : get_load_balancer_metric_data_result) =
  assoc_to_yojson
    [("metricData",
       (option_to_yojson metric_datapoint_list_to_yojson x.metric_data));
    ("metricName",
...
let get_load_balancer_metric_data_request_to_yojson
  (x : get_load_balancer_metric_data_request) =
  assoc_to_yojson
    [("statistics", (Some (metric_statistic_list_to_yojson x.statistics)));
    ("unit", (Some (metric_unit_to_yojson x.unit_)));
...
let instance_state_to_yojson (x : instance_state) =
  assoc_to_yojson
    [("name", (option_to_yojson string__to_yojson x.name));
    ("code", (option_to_yojson integer__to_yojson x.code))]
...
let disk_to_yojson (x : disk) =
  assoc_to_yojson
    ...
    ("gbInUse", (option_to_yojson integer__to_yojson x.gb_in_use));
    ("attachmentState",
    ...
    ("path", (option_to_yojson string__to_yojson x.path));
    ("iops", (option_to_yojson integer__to_yojson x.iops));
...
let instance_snapshot_to_yojson (x : instance_snapshot) =
  assoc_to_yojson
    ...
    ("arn", (option_to_yojson non_empty_string_to_yojson x.arn));
    ("name", (option_to_yojson resource_name_to_yojson x.name))]
let instance_snapshot_list_to_yojson tree =
  list_to_yojson instance_snapshot_to_yojson tree
let get_instance_snapshots_result_to_yojson
  (x : get_instance_snapshots_result) =
  assoc_to_yojson
    [("nextPageToken",
       (option_to_yojson string__to_yojson x.next_page_token));
    ("instanceSnapshots",
...
let get_instance_snapshots_request_to_yojson
  (x : get_instance_snapshots_request) =
  assoc_to_yojson
    [("pageToken", (option_to_yojson string__to_yojson x.page_token))]
...
let get_instance_snapshot_request_to_yojson
  (x : get_instance_snapshot_request) =
  assoc_to_yojson
    [("instanceSnapshotName",
       (Some (resource_name_to_yojson x.instance_snapshot_name)))]
let ipv6_address_to_yojson = string_to_yojson
let ipv6_address_list_to_yojson tree =
  list_to_yojson ipv6_address_to_yojson tree
...
let instance_port_info_to_yojson (x : instance_port_info) =
  assoc_to_yojson
    ...
    ("toPort", (option_to_yojson port_to_yojson x.to_port));
    ("fromPort", (option_to_yojson port_to_yojson x.from_port))]
let instance_port_info_list_to_yojson tree =
  list_to_yojson instance_port_info_to_yojson tree
...
let instance_metadata_state_to_yojson (x : instance_metadata_state) =
  match x with | Applied -> `String "applied" | Pending -> `String "pending"
...
let instance_to_yojson (x : instance) =
  assoc_to_yojson
    [("metadataOptions",
       (option_to_yojson instance_metadata_options_to_yojson
          x.metadata_options));
...
let instance_port_state_to_yojson (x : instance_port_state) =
  assoc_to_yojson
    ...
    ("toPort", (option_to_yojson port_to_yojson x.to_port));
    ("fromPort", (option_to_yojson port_to_yojson x.from_port))]
let instance_port_state_list_to_yojson tree =
  list_to_yojson instance_port_state_to_yojson tree
let get_instance_port_states_result_to_yojson
  (x : get_instance_port_states_result) =
  assoc_to_yojson
    [("portStates",
       (option_to_yojson instance_port_state_list_to_yojson x.port_states))]
let get_instance_port_states_request_to_yojson
  (x : get_instance_port_states_request) =
  assoc_to_yojson
    [("instanceName", (Some (resource_name_to_yojson x.instance_name)))]
...
let get_instance_metric_data_result_to_yojson
  (x : get_instance_metric_data_result) =
  assoc_to_yojson
    [("metricData",
       (option_to_yojson metric_datapoint_list_to_yojson x.metric_data));
    ("metricName",
...
let get_instance_metric_data_request_to_yojson
  (x : get_instance_metric_data_request) =
  assoc_to_yojson
    [("statistics", (Some (metric_statistic_list_to_yojson x.statistics)));
    ("unit", (Some (metric_unit_to_yojson x.unit_)));
    ("endTime", (Some (timestamp__to_yojson x.end_time)));
...
let instance_access_protocol_to_yojson (x : instance_access_protocol) =
  match x with | Rdp -> `String "rdp" | Ssh -> `String "ssh"
...
let host_keys_list_to_yojson tree =
  list_to_yojson host_key_attributes_to_yojson tree
...
let export_snapshot_record_source_type_to_yojson
  (x : export_snapshot_record_source_type) =
  match x with
  | DiskSnapshot -> `String "DiskSnapshot"
  | InstanceSnapshot -> `String "InstanceSnapshot"
...
let export_snapshot_record_source_info_to_yojson
  (x : export_snapshot_record_source_info) =
  assoc_to_yojson
    [("diskSnapshotInfo",
       (option_to_yojson disk_snapshot_info_to_yojson x.disk_snapshot_info));
    ("instanceSnapshotInfo",
      (option_to_yojson instance_snapshot_info_to_yojson
         x.instance_snapshot_info));
    ("fromResourceArn",
    ...
    ("createdAt", (option_to_yojson iso_date_to_yojson x.created_at));
    ("resourceType",
      (option_to_yojson export_snapshot_record_source_type_to_yojson
         x.resource_type))]
...
let export_snapshot_record_to_yojson (x : export_snapshot_record) =
  assoc_to_yojson
    ...
    ("sourceInfo",
      (option_to_yojson export_snapshot_record_source_info_to_yojson
         x.source_info));
...
let get_export_snapshot_records_result_to_yojson
  (x : get_export_snapshot_records_result) =
  assoc_to_yojson
    [("nextPageToken",
       (option_to_yojson string__to_yojson x.next_page_token));
    ("exportSnapshotRecords",
      (option_to_yojson export_snapshot_record_list_to_yojson
         x.export_snapshot_records))]
let get_export_snapshot_records_request_to_yojson
  (x : get_export_snapshot_records_request) =
  assoc_to_yojson
    [("pageToken", (option_to_yojson string__to_yojson x.page_token))]
let domain_entry_list_to_yojson tree =
  list_to_yojson domain_entry_to_yojson tree
...
let lightsail_distribution_to_yojson (x : lightsail_distribution) =
  assoc_to_yojson
    ...
    ("arn", (option_to_yojson non_empty_string_to_yojson x.arn));
    ("name", (option_to_yojson resource_name_to_yojson x.name))]
let distribution_list_to_yojson tree =
  list_to_yojson lightsail_distribution_to_yojson tree
...
let get_distribution_metric_data_result_to_yojson
  (x : get_distribution_metric_data_result) =
  assoc_to_yojson
    [("metricData",
       (option_to_yojson metric_datapoint_list_to_yojson x.metric_data));
    ("metricName",
...
let get_distribution_metric_data_request_to_yojson
  (x : get_distribution_metric_data_request) =
  assoc_to_yojson
    [("statistics", (Some (metric_statistic_list_to_yojson x.statistics)));
    ("unit", (Some (metric_unit_to_yojson x.unit_)));
    ("period", (Some (metric_period_to_yojson x.period)));
...
let distribution_bundle_to_yojson (x : distribution_bundle) =
  assoc_to_yojson
    ...
    ("name", (option_to_yojson string__to_yojson x.name));
    ("bundleId", (option_to_yojson string__to_yojson x.bundle_id))]
let distribution_bundle_list_to_yojson tree =
  list_to_yojson distribution_bundle_to_yojson tree
let get_distribution_bundles_result_to_yojson
  (x : get_distribution_bundles_result) =
  assoc_to_yojson
    [("bundles",
...
let disk_snapshot_to_yojson (x : disk_snapshot) =
  assoc_to_yojson
    ...
    ("arn", (option_to_yojson non_empty_string_to_yojson x.arn));
    ("name", (option_to_yojson resource_name_to_yojson x.name))]
let disk_snapshot_list_to_yojson tree =
  list_to_yojson disk_snapshot_to_yojson tree
...
let get_cost_estimate_result_to_yojson (x : get_cost_estimate_result) =
  assoc_to_yojson
    [("resourcesBudgetEstimate",
       (option_to_yojson resources_budget_estimate_to_yojson
          x.resources_budget_estimate))]
let get_cost_estimate_request_to_yojson (x : get_cost_estimate_request) =
  assoc_to_yojson
    [("endTime", (Some (iso_date_to_yojson x.end_time)));
    ("startTime", (Some (iso_date_to_yojson x.start_time)));
    ("resourceName", (Some (resource_name_to_yojson x.resource_name)))]
let container_service_list_to_yojson tree =
  list_to_yojson container_service_to_yojson tree
let container_services_list_result_to_yojson
  (x : container_services_list_result) =
  assoc_to_yojson
    [("containerServices",
       (option_to_yojson container_service_list_to_yojson
          x.container_services))]
let get_container_services_request_to_yojson
  (x : get_container_services_request) =
  assoc_to_yojson
    [("serviceName",
...
let get_container_service_powers_result_to_yojson
  (x : get_container_service_powers_result) =
  assoc_to_yojson
    [("powers",
...
let get_container_service_deployments_result_to_yojson
  ...
  assoc_to_yojson
    [("deployments",
       (option_to_yojson container_service_deployment_list_to_yojson
          x.deployments))]
...
let get_container_log_result_to_yojson (x : get_container_log_result) =
  assoc_to_yojson
    [("nextPageToken",
       (option_to_yojson string__to_yojson x.next_page_token));
    ("logEvents",
      (option_to_yojson container_service_log_event_list_to_yojson
         x.log_events))]
let get_container_log_request_to_yojson (x : get_container_log_request) =
  assoc_to_yojson
    ...
    ("serviceName", (Some (container_service_name_to_yojson x.service_name)))]
let container_image_list_to_yojson tree =
  list_to_yojson container_image_to_yojson tree
...
let get_container_api_metadata_result_to_yojson
  (x : get_container_api_metadata_result) =
  assoc_to_yojson
    [("metadata",
...
let contact_methods_list_to_yojson tree =
  list_to_yojson contact_method_to_yojson tree
...
let cloud_formation_stack_record_source_info_to_yojson
  ...
  assoc_to_yojson
    ...
    ("name", (option_to_yojson non_empty_string_to_yojson x.name));
    ("resourceType",
      (option_to_yojson cloud_formation_stack_record_source_type_to_yojson
         x.resource_type))]
...
let cloud_formation_stack_record_to_yojson (x : cloud_formation_stack_record)
  ...
  assoc_to_yojson
    ...
    ("sourceInfo",
      (option_to_yojson
         cloud_formation_stack_record_source_info_list_to_yojson
         x.source_info));
    ("state", (option_to_yojson record_state_to_yojson x.state));
    ("resourceType",
      (option_to_yojson resource_type_to_yojson x.resource_type));
...
let get_cloud_formation_stack_records_result_to_yojson
  ...
  assoc_to_yojson
    ...
    ("cloudFormationStackRecords",
      (option_to_yojson cloud_formation_stack_record_list_to_yojson
         x.cloud_formation_stack_records))]
...
let certificate_to_yojson (x : certificate) =
  assoc_to_yojson
    ...
    ("inUseResourceCount",
      (option_to_yojson in_use_resource_count_to_yojson
         x.in_use_resource_count));
    ("requestFailureReason",
      (option_to_yojson request_failure_reason_to_yojson
         x.request_failure_reason));
    ("domainValidationRecords",
      (option_to_yojson domain_validation_record_list_to_yojson
         x.domain_validation_records));
    ("subjectAlternativeNames",
      (option_to_yojson subject_alternative_name_list_to_yojson
         x.subject_alternative_names));
    ("serialNumber",
...
let certificate_summary_list_to_yojson tree =
  list_to_yojson certificate_summary_to_yojson tree
...
let certificate_status_list_to_yojson tree =
  list_to_yojson certificate_status_to_yojson tree
...
let get_certificates_request_to_yojson (x : get_certificates_request) =
  assoc_to_yojson
    ...
    ("includeCertificateDetails",
      (option_to_yojson include_certificate_details_to_yojson
         x.include_certificate_details));
    ("certificateStatuses",
      (option_to_yojson certificate_status_list_to_yojson
         x.certificate_statuses))]
let instance_platform_to_yojson (x : instance_platform) =
  match x with
  | Windows -> `String "WINDOWS"
  | LinuxUnix -> `String "LINUX_UNIX"
let instance_platform_list_to_yojson tree =
  list_to_yojson instance_platform_to_yojson tree
let app_category_to_yojson (x : app_category) =
  match x with | LfR -> `String "LfR"
let app_category_list_to_yojson tree =
  list_to_yojson app_category_to_yojson tree
let bundle_to_yojson (x : bundle) =
  assoc_to_yojson
    ...
    ("supportedAppCategories",
      (option_to_yojson app_category_list_to_yojson
         x.supported_app_categories));
    ("supportedPlatforms",
      (option_to_yojson instance_platform_list_to_yojson
         x.supported_platforms));
    ("transferPerMonthInGb",
      (option_to_yojson integer__to_yojson x.transfer_per_month_in_gb));
    ("ramSizeInGb", (option_to_yojson float__to_yojson x.ram_size_in_gb));
    ("power", (option_to_yojson integer__to_yojson x.power));
    ("name", (option_to_yojson string__to_yojson x.name));
    ("isActive", (option_to_yojson boolean__to_yojson x.is_active));
...
let account_level_bpa_sync_status_to_yojson
  (x : account_level_bpa_sync_status) =
  match x with
...
let get_buckets_result_to_yojson (x : get_buckets_result) =
  assoc_to_yojson
    [("accountLevelBpaSync",
       (option_to_yojson account_level_bpa_sync_to_yojson
          x.account_level_bpa_sync));
...
let get_bucket_metric_data_result_to_yojson
  (x : get_bucket_metric_data_result) =
  assoc_to_yojson
    [("metricData",
       (option_to_yojson metric_datapoint_list_to_yojson x.metric_data));
    ("metricName",
...
let get_bucket_metric_data_request_to_yojson
  (x : get_bucket_metric_data_request) =
  assoc_to_yojson
    [("unit", (Some (metric_unit_to_yojson x.unit_)));
    ("statistics", (Some (metric_statistic_list_to_yojson x.statistics)));
    ("period", (Some (metric_period_to_yojson x.period)));
...
let bucket_bundle_to_yojson (x : bucket_bundle) =
  assoc_to_yojson
    ...
    ("name", (option_to_yojson non_empty_string_to_yojson x.name));
    ("bundleId", (option_to_yojson non_empty_string_to_yojson x.bundle_id))]
let bucket_bundle_list_to_yojson tree =
  list_to_yojson bucket_bundle_to_yojson tree
let get_bucket_bundles_result_to_yojson (x : get_bucket_bundles_result) =
  assoc_to_yojson
    [("bundles", (option_to_yojson bucket_bundle_list_to_yojson x.bundles))]
...
let blueprint_to_yojson (x : blueprint) =
  assoc_to_yojson
    ...
    ("version", (option_to_yojson string__to_yojson x.version));
    ("minPower", (option_to_yojson integer__to_yojson x.min_power));
    ("isActive", (option_to_yojson boolean__to_yojson x.is_active));
    ("description", (option_to_yojson string__to_yojson x.description));
...
let attached_disk_to_yojson (x : attached_disk) =
  assoc_to_yojson
    [("sizeInGb", (option_to_yojson integer__to_yojson x.size_in_gb));
    ("path", (option_to_yojson string__to_yojson x.path))]
let attached_disk_list_to_yojson tree =
  list_to_yojson attached_disk_to_yojson tree
...
let auto_snapshot_details_list_to_yojson tree =
  list_to_yojson auto_snapshot_details_to_yojson tree
let get_auto_snapshots_result_to_yojson (x : get_auto_snapshots_result) =
  assoc_to_yojson
    [("autoSnapshots",
       (option_to_yojson auto_snapshot_details_list_to_yojson
          x.auto_snapshots));
    ("resourceType",
      (option_to_yojson resource_type_to_yojson x.resource_type));
    ("resourceName",
...
let alarm_to_yojson (x : alarm) =
  assoc_to_yojson
    ...
    ("monitoredResourceInfo",
      (option_to_yojson monitored_resource_info_to_yojson
         x.monitored_resource_info));
    ("supportCode", (option_to_yojson string__to_yojson x.support_code));
    ("resourceType",
      (option_to_yojson resource_type_to_yojson x.resource_type));
    ("location", (option_to_yojson resource_location_to_yojson x.location));
...
let add_on_request_to_yojson (x : add_on_request) =
  assoc_to_yojson
    [("stopInstanceOnIdleRequest",
       (option_to_yojson stop_instance_on_idle_request_to_yojson
          x.stop_instance_on_idle_request));
    ("autoSnapshotAddOnRequest",
      (option_to_yojson auto_snapshot_add_on_request_to_yojson
         x.auto_snapshot_add_on_request));
...
let download_default_key_pair_result_to_yojson
  (x : download_default_key_pair_result) =
  assoc_to_yojson
    [("createdAt", (option_to_yojson iso_date_to_yojson x.created_at));
    ("privateKeyBase64",
...
let delete_relational_database_result_to_yojson
  (x : delete_relational_database_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let delete_relational_database_request_to_yojson
  (x : delete_relational_database_request) =
  assoc_to_yojson
    [("finalRelationalDatabaseSnapshotName",
       (option_to_yojson resource_name_to_yojson
          x.final_relational_database_snapshot_name));
    ("skipFinalSnapshot",
...
let delete_known_host_keys_result_to_yojson
  (x : delete_known_host_keys_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let delete_known_host_keys_request_to_yojson
  (x : delete_known_host_keys_request) =
  assoc_to_yojson
    [("instanceName", (Some (resource_name_to_yojson x.instance_name)))]
...
let delete_instance_snapshot_result_to_yojson
  (x : delete_instance_snapshot_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let delete_instance_snapshot_request_to_yojson
  (x : delete_instance_snapshot_request) =
  assoc_to_yojson
    [("instanceSnapshotName",
       (Some (resource_name_to_yojson x.instance_snapshot_name)))]
...
let delete_contact_method_request_to_yojson
  (x : delete_contact_method_request) =
  assoc_to_yojson
...
let delete_bucket_access_key_result_to_yojson
  (x : delete_bucket_access_key_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let delete_bucket_access_key_request_to_yojson
  (x : delete_bucket_access_key_request) =
  assoc_to_yojson
...
let create_relational_database_from_snapshot_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("sourceRelationalDatabaseName",
      (option_to_yojson resource_name_to_yojson
         x.source_relational_database_name));
    ("relationalDatabaseBundleId",
...
let create_relational_database_result_to_yojson
  (x : create_relational_database_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let create_relational_database_request_to_yojson
  (x : create_relational_database_request) =
  assoc_to_yojson
    [("tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("publiclyAccessible",
      (option_to_yojson boolean__to_yojson x.publicly_accessible));
...
let create_load_balancer_tls_certificate_result_to_yojson
  ...
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let domain_name_list_to_yojson tree =
  list_to_yojson domain_name_to_yojson tree
let create_load_balancer_tls_certificate_request_to_yojson
  ...
  assoc_to_yojson
    ...
    ("certificateAlternativeNames",
      (option_to_yojson domain_name_list_to_yojson
         x.certificate_alternative_names));
...
let create_instance_snapshot_result_to_yojson
  (x : create_instance_snapshot_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let create_instance_snapshot_request_to_yojson
  (x : create_instance_snapshot_request) =
  assoc_to_yojson
    [("tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("instanceName", (Some (resource_name_to_yojson x.instance_name)));
    ("instanceSnapshotName",
...
let create_instances_from_snapshot_result_to_yojson
  (x : create_instances_from_snapshot_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
...
let add_on_request_list_to_yojson tree =
  list_to_yojson add_on_request_to_yojson tree
let create_instances_from_snapshot_request_to_yojson
  (x : create_instances_from_snapshot_request) =
  assoc_to_yojson
    [("useLatestRestorableAutoSnapshot",
       (option_to_yojson boolean__to_yojson
          x.use_latest_restorable_auto_snapshot));
...
let create_disk_from_snapshot_result_to_yojson
  (x : create_disk_from_snapshot_result) =
  assoc_to_yojson
    [("operations", (option_to_yojson operation_list_to_yojson x.operations))]
let create_disk_from_snapshot_request_to_yojson
  (x : create_disk_from_snapshot_request) =
  assoc_to_yojson
    [("useLatestRestorableAutoSnapshot",
       (option_to_yojson boolean__to_yojson
          x.use_latest_restorable_auto_snapshot));
    ...
    ("addOns", (option_to_yojson add_on_request_list_to_yojson x.add_ons));
    ("tags", (option_to_yojson tag_list_to_yojson x.tags));
    ("sizeInGb", (Some (integer__to_yojson x.size_in_gb)));
    ("availabilityZone",
...
let container_service_registry_login_to_yojson
  (x : container_service_registry_login) =
  assoc_to_yojson
...
let endpoint_request_to_yojson (x : endpoint_request) =
  assoc_to_yojson
    [("healthCheck",
       (option_to_yojson container_service_health_check_config_to_yojson
          x.health_check));
    ("containerPort", (Some (integer__to_yojson x.container_port)));
    ("containerName", (Some (string__to_yojson x.container_name)))]
...
let create_container_service_result_to_yojson
  (x : create_container_service_result) =
  assoc_to_yojson
    [("containerService",
       (option_to_yojson container_service_to_yojson x.container_service))]
let container_service_deployment_request_to_yojson
  (x : container_service_deployment_request) =
  assoc_to_yojson
    [("publicEndpoint",
       (option_to_yojson endpoint_request_to_yojson x.public_endpoint));
    ("containers", (option_to_yojson container_map_to_yojson x.containers))]
let create_container_service_request_to_yojson
  (x : create_container_service_request) =
  assoc_to_yojson
    [("privateRegistryAccess",
       (option_to_yojson private_registry_access_request_to_yojson
          x.private_registry_access));
    ("deployment",
      (option_to_yojson container_service_deployment_request_to_yojson
         x.deployment));
    ("publicDomainNames",
      (option_to_yojson container_service_public_domains_to_yojson
         x.public_domain_names));
...
let instance_entry_list_to_yojson tree =
  list_to_yojson instance_entry_to_yojson tree
let create_cloud_formation_stack_request_to_yojson
  (x : create_cloud_formation_stack_request) =
  assoc_to_yojson
    [("instances", (Some (instance_entry_list_to_yojson x.instances)))]
...
let close_instance_public_ports_result_to_yojson
  (x : close_instance_public_ports_result) =
  assoc_to_yojson
    [("operation", (option_to_yojson operation_to_yojson x.operation))]
let close_instance_public_ports_request_to_yojson
  (x : close_instance_public_ports_request) =
  assoc_to_yojson
    [("instanceName", (Some (resource_name_to_yojson x.instance_name)));
    ("portInfo", (Some (port_info_to_yojson x.port_info)))]
