...
let update_instance_metadata_options_request_of_yojson tree path =
  ...
  ({
     ...
     http_put_response_hop_limit =
       option_of_yojson (value_for_key integer__of_yojson "httpPutResponseHopLimit") _list path;
     http_endpoint =
...
let input_origin_of_yojson tree path =
  ...
  ({
     response_timeout =
       option_of_yojson (value_for_key integer__of_yojson "responseTimeout") _list path;
     protocol_policy =
       option_of_yojson
...
let container_service_health_check_config_of_yojson tree path =
  ...
  ({
     ...
     path = option_of_yojson (value_for_key string__of_yojson "path") _list path;
     interval_seconds =
       option_of_yojson (value_for_key integer__of_yojson "intervalSeconds") _list path;
     timeout_seconds =
       option_of_yojson (value_for_key integer__of_yojson "timeoutSeconds") _list path;
     unhealthy_threshold =
       option_of_yojson (value_for_key integer__of_yojson "unhealthyThreshold") _list path;
     healthy_threshold =
       option_of_yojson (value_for_key integer__of_yojson "healthyThreshold") _list path;
   }
...
let relational_database_bundle_of_yojson tree path =
  ...
  ({
     ...
     transfer_per_month_in_gb =
       option_of_yojson (value_for_key integer__of_yojson "transferPerMonthInGb") _list path;
     disk_size_in_gb = option_of_yojson (value_for_key integer__of_yojson "diskSizeInGb") _list path;
     ram_size_in_gb = option_of_yojson (value_for_key float__of_yojson "ramSizeInGb") _list path;
...
let put_alarm_request_of_yojson tree path =
  ...
  ({
     ...
     datapoints_to_alarm =
       option_of_yojson (value_for_key integer__of_yojson "datapointsToAlarm") _list path;
...
let monthly_transfer_of_yojson tree path =
  ...
  ({
     gb_per_month_allocated =
       option_of_yojson (value_for_key integer__of_yojson "gbPerMonthAllocated") _list path;
   }
    : monthly_transfer)
...
let get_relational_database_events_request_of_yojson tree path =
  ...
  ({
     page_token = option_of_yojson (value_for_key string__of_yojson "pageToken") _list path;
     duration_in_minutes =
       option_of_yojson (value_for_key integer__of_yojson "durationInMinutes") _list path;
     relational_database_name =
       value_for_key resource_name_of_yojson "relationalDatabaseName" _list path;
   }
...
let bundle_of_yojson tree path =
  ...
  ({
     public_ipv4_address_count =
       option_of_yojson (value_for_key integer__of_yojson "publicIpv4AddressCount") _list path;
...
let bucket_bundle_of_yojson tree path =
  ...
  ({
     ...
     storage_per_month_in_gb =
       option_of_yojson (value_for_key integer__of_yojson "storagePerMonthInGb") _list path;
     price = option_of_yojson (value_for_key float__of_yojson "price") _list path;
     name = option_of_yojson (value_for_key non_empty_string_of_yojson "name") _list path;
     bundle_id = option_of_yojson (value_for_key non_empty_string_of_yojson "bundleId") _list path;
   }
...
let alarm_of_yojson tree path =
  ...
  ({
     ...
     evaluation_periods =
       option_of_yojson (value_for_key integer__of_yojson "evaluationPeriods") _list path;
     comparison_operator =
       option_of_yojson
...
let create_gui_session_access_details_result_of_yojson tree path =
  ...
  ({
     ...
     percentage_complete =
       option_of_yojson (value_for_key integer__of_yojson "percentageComplete") _list path;
