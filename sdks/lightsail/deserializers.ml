...
let input_origin_of_yojson tree path =
  ...
  ({
     response_timeout =
       (option_of_yojson (value_for_key integer__of_yojson "responseTimeout")
          _list path);
     protocol_policy =
       (option_of_yojson
...
let container_service_health_check_config_of_yojson tree path =
  ...
  ({
     ...
     path =
       (option_of_yojson (value_for_key string__of_yojson "path") _list path);
     interval_seconds =
       (option_of_yojson (value_for_key integer__of_yojson "intervalSeconds")
          _list path);
     timeout_seconds =
...
let monthly_transfer_of_yojson tree path =
  ...
  ({
     gb_per_month_allocated =
       (option_of_yojson
          (value_for_key integer__of_yojson "gbPerMonthAllocated") _list path)
   } : monthly_transfer)
...
let instance_state_of_yojson tree path =
  ...
  ({
     name =
       (option_of_yojson (value_for_key string__of_yojson "name") _list path);
     code =
       (option_of_yojson (value_for_key integer__of_yojson "code") _list path)
   } : instance_state)
...
let disk_of_yojson tree path =
  ...
  ({
     ...
     path =
       (option_of_yojson (value_for_key string__of_yojson "path") _list path);
     iops =
       (option_of_yojson (value_for_key integer__of_yojson "iops") _list path);
     is_system_disk =
...
let bucket_bundle_of_yojson tree path =
  ...
  ({
     ...
     storage_per_month_in_gb =
       (option_of_yojson
          (value_for_key integer__of_yojson "storagePerMonthInGb") _list path);
     price =
       (option_of_yojson (value_for_key float__of_yojson "price") _list path);
     name =
       (option_of_yojson (value_for_key non_empty_string_of_yojson "name")
