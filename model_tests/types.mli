...
type nonrec struct_with_json_name = {
  value: string_ option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec put_with_content_encoding_input =
  ...
  encoding: string_ option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec null_operation_input_output =
  {
  string_: string_ option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type kitchen_sink =
  ...
  blob: string_ option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec complex_nested_error_data = {
  foo: string_ option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec greeting_with_errors_output =
  {
  greeting: string_ option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec host_label_input = {
  label: string_ [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec content_type_parameters_input =
  {
  value: int_ option [@ocaml.doc ""]}[@@ocaml.doc ""]