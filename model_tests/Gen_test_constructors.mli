...
val resolve_shape_by_name :
  (string, Parselib.Ast.Shape.t, Base.String.comparator_witness) Base.Map.t ->
  string ->
  (Parselib.Ast.Shape.shapeDescriptor, constructor_error) result
(** Resolve a shape by name from parsed shapes *)

val generate_value_constructor :
  (string, Parselib.Ast.Shape.t, Base.String.comparator_witness) Base.Map.t ->
  Parselib.Ast.Shape.shapeDescriptor ->
  t ->
  is_required:bool ->
  (string, constructor_error) result
...
val generate_operation_constructors_from_parsed_shapes :
  (string, Parselib.Ast.Shape.t, Base.String.comparator_witness) Base.Map.t ->
  string ->
  (string list, constructor_error) result
