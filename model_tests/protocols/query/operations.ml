...
module DatetimeOffsets =
  struct
    ...
    let request_with_metadata context
      (request : Smaws_Lib.Smithy_api.Types.unit_) =
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"DatetimeOffsets" ~xmlNamespace:"https://example.com/"
  ...
  struct
    ...
    let request context (request : empty_input_and_empty_output_input) =
      ...
      Smaws_Lib.Protocols.AwsQuery.request ~action:"EmptyInputAndEmptyOutput"
        ...
        ~error_deserializer
    let request_with_metadata context
      (request : empty_input_and_empty_output_input) =
      let fields = empty_input_and_empty_output_input_to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"EndpointOperation" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:Smaws_Lib.Smithy_api.Query_deserializers.unit__of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"FlattenedXmlMap" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:flattened_xml_map_output_of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"FractionalSeconds" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:fractional_seconds_output_of_xml
        ~error_deserializer
  end
module GreetingWithErrors =
  struct
    ...
    let error_deserializer (error : Smaws_Lib.Protocols.AwsQuery.Error.t)
      ...
      | "ComplexError" ->
          (match Smaws_Lib.Protocols.AwsQuery.Response.parse_error_struct
                   ~body ~structParser:complex_error_of_xml
           with
           | Ok s -> `ComplexError s
      ...
      | "Customized" ->
          (match Smaws_Lib.Protocols.AwsQuery.Response.parse_error_struct
                   ~body ~structParser:custom_code_error_of_xml
           with
           | Ok s -> `CustomCodeError s
           | Error (Smaws_Lib.Xml.Parse.XmlParseError msg) ->
               `XmlParseError msg)
      | "InvalidGreeting" ->
          (match Smaws_Lib.Protocols.AwsQuery.Response.parse_error_struct
                   ~body ~structParser:invalid_greeting_of_xml
           with
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"GreetingWithErrors" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:greeting_with_errors_output_of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"HostWithPathOperation" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:Smaws_Lib.Smithy_api.Query_deserializers.unit__of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"IgnoresWrappingXmlName" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:ignores_wrapping_xml_name_output_of_xml
        ~error_deserializer
  end
module NestedStructures =
  struct
    ...
    let request_with_metadata context (request : nested_structures_input) =
      let fields = nested_structures_input_to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"NestedStructures" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:Smaws_Lib.Smithy_api.Query_deserializers.unit__of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"NoInputAndNoOutput" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:Smaws_Lib.Smithy_api.Query_deserializers.unit__of_xml
        ~error_deserializer
  end
module NoInputAndOutput =
  struct
    ...
    let request_with_metadata context (request : no_input_and_output_input) =
      let fields = no_input_and_output_input_to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"NoInputAndOutput" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:no_input_and_output_output_of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request context (request : put_with_content_encoding_input) =
      ...
      Smaws_Lib.Protocols.AwsQuery.request ~action:"PutWithContentEncoding"
        ...
        ~error_deserializer
    let request_with_metadata context
      (request : put_with_content_encoding_input) =
      let fields = put_with_content_encoding_input_to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"PutWithContentEncoding" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:Smaws_Lib.Smithy_api.Query_deserializers.unit__of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request context (request : query_idempotency_token_auto_fill_input) =
      ...
      Smaws_Lib.Protocols.AwsQuery.request
        ...
        ~error_deserializer
    let request_with_metadata context
      (request : query_idempotency_token_auto_fill_input) =
      let fields =
        query_idempotency_token_auto_fill_input_to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"QueryIdempotencyTokenAutoFill"
...
module QueryTimestamps =
  struct
    ...
    let request_with_metadata context (request : query_timestamps_input) =
      let fields = query_timestamps_input_to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"QueryTimestamps" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:Smaws_Lib.Smithy_api.Query_deserializers.unit__of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"RecursiveXmlShapes" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:recursive_xml_shapes_output_of_xml
        ~error_deserializer
  end
module SimpleInputParams =
  struct
    ...
    let request_with_metadata context (request : simple_input_params_input) =
      let fields = simple_input_params_input_to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"SimpleInputParams" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:Smaws_Lib.Smithy_api.Query_deserializers.unit__of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"XmlEmptyBlobs" ~xmlNamespace:"https://example.com/" ~service
        ~context ~fields ~output_deserializer:xml_blobs_output_of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"XmlEmptyLists" ~xmlNamespace:"https://example.com/" ~service
        ~context ~fields ~output_deserializer:xml_lists_output_of_xml
        ~error_deserializer
  end
module XmlEmptyMaps =
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"XmlEmptyMaps" ~xmlNamespace:"https://example.com/" ~service
        ~context ~fields ~output_deserializer:xml_maps_output_of_xml
        ~error_deserializer
  end
module XmlEnums =
  struct
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"XmlIntEnums" ~xmlNamespace:"https://example.com/" ~service
        ~context ~fields ~output_deserializer:xml_int_enums_output_of_xml
        ~error_deserializer
  end
module XmlLists =
  struct
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"XmlMapsXmlName" ~xmlNamespace:"https://example.com/"
        ~service ~context ~fields
        ~output_deserializer:xml_maps_xml_name_output_of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"XmlNamespaces" ~xmlNamespace:"https://example.com/" ~service
        ~context ~fields ~output_deserializer:xml_namespaces_output_of_xml
        ~error_deserializer
  end
  ...
  struct
    ...
    let request_with_metadata context
      ...
      let fields =
        Smaws_Lib.Smithy_api.Query_serializers.unit__to_query [] request in
      Smaws_Lib.Protocols.AwsQuery.request_with_metadata
        ~action:"XmlTimestamps" ~xmlNamespace:"https://example.com/" ~service
        ~context ~fields ~output_deserializer:xml_timestamps_output_of_xml
        ~error_deserializer
  end