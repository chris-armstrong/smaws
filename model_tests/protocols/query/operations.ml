...
module GreetingWithErrors = struct
  ...
  let error_deserializer (error : Smaws_Lib.Protocols.AwsQuery.Error.t) =
    ...
    | "ComplexError" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "CustomCodeError" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
    | "InvalidGreeting" -> Smaws_Lib.Protocols.AwsQuery.Errors.default_handler error
...
module IgnoresWrappingXmlName = struct
  let error_to_string = Smaws_Lib.Protocols.AwsQuery.error_to_string
...
module RecursiveXmlShapes = struct
  let error_to_string = Smaws_Lib.Protocols.AwsQuery.error_to_string
...
module SimpleScalarXmlProperties = struct
  let error_to_string = Smaws_Lib.Protocols.AwsQuery.error_to_string
