...
let xml_maps_xml_name_output_map_to_yojson tree =
...
let xml_maps_xml_name_output_to_yojson (x : xml_maps_xml_name_output) =
  assoc_to_yojson
    [("myMap",
       (option_to_yojson xml_maps_xml_name_output_map_to_yojson x.my_map))]
let xml_maps_output_map_to_yojson tree =
  map_to_yojson Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
    Shared.Json_serializers.greeting_struct_to_yojson tree
let xml_maps_output_to_yojson (x : xml_maps_output) =
  assoc_to_yojson
    [("myMap", (option_to_yojson xml_maps_output_map_to_yojson x.my_map))]
  ...
  assoc_to_yojson
    ...
    ("normalFormat",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.timestamp_to_yojson
         x.normal_format))]
let complex_map_to_yojson tree =
  map_to_yojson Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
    Shared.Json_serializers.greeting_struct_to_yojson tree
let map_with_xml_name_to_yojson tree =
  map_to_yojson Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
    Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson tree
let map_of_lists_to_yojson tree =
  map_to_yojson Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
    Shared.Json_serializers.string_list_to_yojson tree
let nested_struct_with_map_to_yojson (x : nested_struct_with_map) =
  assoc_to_yojson
    [("MapArg",
       (option_to_yojson Shared.Json_serializers.string_map_to_yojson
          x.map_arg))]
let query_maps_input_to_yojson (x : query_maps_input) =
  assoc_to_yojson
    [("NestedStructWithMap",
       (option_to_yojson nested_struct_with_map_to_yojson
          x.nested_struct_with_map));
    ("MapOfLists", (option_to_yojson map_of_lists_to_yojson x.map_of_lists));
    ("FlattenedMapWithXmlName",
      (option_to_yojson map_with_xml_name_to_yojson
         x.flattened_map_with_xml_name));
    ("FlattenedMap",
      (option_to_yojson Shared.Json_serializers.string_map_to_yojson
         x.flattened_map));
    ("MapWithXmlMemberName",
      (option_to_yojson map_with_xml_name_to_yojson
         x.map_with_xml_member_name));
    ("ComplexMapArg",
      (option_to_yojson complex_map_to_yojson x.complex_map_arg));
    ("RenamedMapArg",
      (option_to_yojson Shared.Json_serializers.string_map_to_yojson
         x.renamed_map_arg));
    ("MapArg",
...
let no_input_and_output_input_to_yojson = unit_to_yojson
...
let custom_code_error_to_yojson (x : custom_code_error) =
  assoc_to_yojson
    [("Message",
       (option_to_yojson
          Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.message))]
...
let fractional_seconds_output_to_yojson (x : fractional_seconds_output) =
  assoc_to_yojson
    [("datetime",
       (option_to_yojson Shared.Json_serializers.date_time_to_yojson
          x.datetime))]
let flattened_xml_map_with_xml_namespace_output_map_to_yojson tree =
  map_to_yojson Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
    Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson tree
let flattened_xml_map_with_xml_namespace_output_to_yojson
  (x : flattened_xml_map_with_xml_namespace_output) =
  assoc_to_yojson
    [("myMap",
       (option_to_yojson
          flattened_xml_map_with_xml_namespace_output_map_to_yojson x.my_map))]
let flattened_xml_map_with_xml_name_output_map_to_yojson tree =
  map_to_yojson Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
    Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson tree
let flattened_xml_map_with_xml_name_output_to_yojson
  (x : flattened_xml_map_with_xml_name_output) =
  assoc_to_yojson
    [("myMap",
       (option_to_yojson flattened_xml_map_with_xml_name_output_map_to_yojson
          x.my_map))]
let flattened_xml_map_output_to_yojson (x : flattened_xml_map_output) =
  assoc_to_yojson
    [("myMap",
       (option_to_yojson Shared.Json_serializers.foo_enum_map_to_yojson
          x.my_map))]
