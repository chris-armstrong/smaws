...
type nonrec xml_maps_xml_name_output_map =
...
type nonrec xml_maps_xml_name_output =
  ...
  my_map: xml_maps_xml_name_output_map option [@ocaml.doc ""]}[@@ocaml.doc
                                                                ""]
type nonrec xml_maps_output_map =
  (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.greeting_struct) list
[@@ocaml.doc ""]
...
type nonrec list_with_member_namespace =
  Smaws_Lib.Smithy_api.Types.string_ list[@@ocaml.doc ""]
...
[@@ocaml.doc ""]
type nonrec complex_map =
  (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.greeting_struct) list
[@@ocaml.doc ""]
type nonrec map_with_xml_name =
  (Smaws_Lib.Smithy_api.Types.string_ * Smaws_Lib.Smithy_api.Types.string_)
    list[@@ocaml.doc ""]
type nonrec map_of_lists =
...
[@@ocaml.doc ""]
type nonrec no_input_and_output_output = unit[@@ocaml.doc ""]
type nonrec no_input_and_output_input = unit[@@ocaml.doc ""]
