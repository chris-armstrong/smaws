...
let rec recursive_xml_shapes_output_nested2_to_query path (x : recursive_xml_shapes_output_nested2)
    =
  List.concat
    [
      (match x.bar with
...
and recursive_xml_shapes_output_nested1_to_query path (x : recursive_xml_shapes_output_nested1) =
  List.concat
    [
      (match x.foo with
      | None -> []
