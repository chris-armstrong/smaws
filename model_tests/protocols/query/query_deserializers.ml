                      ...
                      Smaws_Lib.Xml.Parse.Read.sequences i "entry"
                        (fun i _ ->
                           ...
                           let v =
                             Smaws_Lib.Xml.Parse.Read.sequence i "value"
                               (fun i _ ->
                                  Shared.Query_deserializers.foo_enum_of_xml
                                    i) () in
                           (k, v)) ()) ()))
       | "fooEnumSet" ->
           r_foo_enum_set :=
...
let map_of_lists_of_xml i =
  Smaws_Lib.Xml.Parse.Read.sequences i "entry"
    (fun i _ ->
       ...
       let v =
         Smaws_Lib.Xml.Parse.Read.sequence i "value"
           (fun i _ -> Shared.Query_deserializers.string_list_of_xml i) () in
       (k, v)) ()
                      ...
                      Smaws_Lib.Xml.Parse.Read.sequences i "entry"
                        (fun i _ ->
                           ...
                           let v =
                             Smaws_Lib.Xml.Parse.Read.sequence i "value"
                               (fun i _ ->
                                  Shared.Query_deserializers.string_list_of_xml
                                    i) () in
                           (k, v)) ()) ()))
       | "Hi" ->
    ...
    (fun tag _ ->
       ...
       | "Hi" ->
           r_flattened_list_arg_with_xml_name :=
             (Some (Smaws_Lib.Xml.Parse.Read.elements i "Hi" ()))
       | "ListArgWithXmlNameMember" ->
       ...
       | "FlattenedListArg" ->
           r_flattened_list_arg :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.elements i "FlattenedListArg" ()))
       | "ComplexListArg" ->
           r_complex_list_arg :=
             (Some
                ...
                (Smaws_Lib.Xml.Parse.Read.sequences i "myMap"
                   (fun i _ ->
                      ...
                      let v =
                        Smaws_Lib.Xml.Parse.Read.sequence i "value"
                          (fun i _ ->
                             Shared.Query_deserializers.foo_enum_of_xml i) () in
                      (k, v)) ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
