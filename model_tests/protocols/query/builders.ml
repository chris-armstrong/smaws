...
let make_xml_lists_output ?structure_list:(structure_list_ : structure_list option)
...
let make_xml_int_enums_output ?int_enum_map:(int_enum_map_ : Shared.Types.integer_enum_map option)
...
let make_xml_enums_output ?foo_enum_map:(foo_enum_map_ : Shared.Types.foo_enum_map option)
...
let make_struct_arg ?recursive_arg:(recursive_arg_ : struct_arg option)
  ...
  ({ recursive_arg = recursive_arg_; other_arg = other_arg_; string_arg = string_arg_ }
    : struct_arg)
...
let make_simple_input_params_input ?integer_enum:(integer_enum_ : Shared.Types.integer_enum option)
...
let make_query_timestamps_input ?epoch_target:(epoch_target_ : Shared.Types.epoch_seconds option)
  ...
  ({ epoch_target = epoch_target_; epoch_member = epoch_member_; normal_format = normal_format_ }
...
let make_query_lists_input ?nested_with_list:(nested_with_list_ : nested_struct_with_list option)
