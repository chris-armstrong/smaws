...
[@@ocaml.doc ""][@@deriving (show, eq)]
type xml_maps_xml_name_output =
  {
  my_map: xml_maps_xml_name_output_map option [@ocaml.doc ""]}[@@ocaml.doc
                                                                ""][@@deriving
                                                                    (show,
                                                                    eq)]
type xml_maps_output_map =
  (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.greeting_struct) list
[@@ocaml.doc ""][@@deriving (show, eq)]
type xml_maps_output = {
...
type map_of_lists =
  (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.string_list) list
[@@ocaml.doc ""][@@deriving (show, eq)]
type nested_struct_with_map =
  {
  map_arg: Shared.Types.string_map option [@ocaml.doc ""]}[@@ocaml.doc ""]
[@@deriving (show, eq)]
type query_maps_input =
  ...
  map_arg: Shared.Types.string_map option [@ocaml.doc ""]}[@@ocaml.doc ""]
[@@deriving (show, eq)]
type list_with_xml_name = Smaws_Lib.Smithy_api.Types.string_ list[@@ocaml.doc
                                                                   ""]
[@@deriving (show, eq)]
type nested_struct_with_list =
  {
...
type nested_structures_input = {
  nested: struct_arg option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                              (show, eq)]
