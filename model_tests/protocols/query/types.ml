...
type xml_namespaces_output = { nested : xml_namespace_nested option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]

type xml_maps_xml_name_output_map =
  (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.greeting_struct) list
[@@ocaml.doc ""] [@@deriving show, eq]

type xml_maps_xml_name_output = { my_map : xml_maps_xml_name_output_map option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]

type xml_maps_output_map = (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.greeting_struct) list
[@@ocaml.doc ""] [@@deriving show, eq]

type xml_maps_output = { my_map : xml_maps_output_map option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]
...
type xml_blobs_output = { data : Smaws_Lib.Smithy_api.Types.blob option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]

type simple_scalar_xml_properties_output = {
  string_value : Smaws_Lib.Smithy_api.Types.string_ option; [@ocaml.doc ""]
  empty_string_value : Smaws_Lib.Smithy_api.Types.string_ option; [@ocaml.doc ""]
...
type simple_input_params_input = {
  foo : Smaws_Lib.Smithy_api.Types.string_ option; [@ocaml.doc ""]
  ...
  integer_enum : Shared.Types.integer_enum option; [@ocaml.doc ""]
}
[@@ocaml.doc ""] [@@deriving show, eq]

type recursive_xml_shapes_output_nested2 = {
  bar : Smaws_Lib.Smithy_api.Types.string_ option; [@ocaml.doc ""]
  recursive_member : recursive_xml_shapes_output_nested1 option; [@ocaml.doc ""]
}
[@@ocaml.doc ""] [@@deriving show, eq]

and recursive_xml_shapes_output_nested1 = {
  foo : Smaws_Lib.Smithy_api.Types.string_ option; [@ocaml.doc ""]
  nested : recursive_xml_shapes_output_nested2 option; [@ocaml.doc ""]
}
[@@ocaml.doc ""] [@@deriving show, eq]

type recursive_xml_shapes_output = {
  nested : recursive_xml_shapes_output_nested1 option; [@ocaml.doc ""]
}
[@@ocaml.doc ""] [@@deriving show, eq]

type query_timestamps_input = {
...
type nested_struct_with_map = { map_arg : Shared.Types.string_map option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]

type map_of_lists = (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.string_list) list
[@@ocaml.doc ""] [@@deriving show, eq]

type map_with_xml_name =
  (Smaws_Lib.Smithy_api.Types.string_ * Smaws_Lib.Smithy_api.Types.string_) list
[@@ocaml.doc ""] [@@deriving show, eq]

type complex_map = (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.greeting_struct) list
[@@ocaml.doc ""] [@@deriving show, eq]

type query_maps_input = {
  map_arg : Shared.Types.string_map option; [@ocaml.doc ""]
  renamed_map_arg : Shared.Types.string_map option; [@ocaml.doc ""]
  complex_map_arg : complex_map option; [@ocaml.doc ""]
  map_with_xml_member_name : map_with_xml_name option; [@ocaml.doc ""]
  flattened_map : Shared.Types.string_map option; [@ocaml.doc ""]
...
type nested_struct_with_list = { list_arg : Shared.Types.string_list option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]

type list_with_xml_name = Smaws_Lib.Smithy_api.Types.string_ list
[@@ocaml.doc ""] [@@deriving show, eq]

type query_lists_input = {
  list_arg : Shared.Types.string_list option; [@ocaml.doc ""]
  complex_list_arg : Shared.Types.greeting_list option; [@ocaml.doc ""]
  flattened_list_arg : Shared.Types.string_list option; [@ocaml.doc ""]
  list_arg_with_xml_name_member : list_with_xml_name option; [@ocaml.doc ""]
  flattened_list_arg_with_xml_name : list_with_xml_name option; [@ocaml.doc ""]
...
type no_input_and_output_input = unit [@@ocaml.doc ""] [@@deriving show, eq]
...
type nested_structures_input = { nested : struct_arg option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]

type ignores_wrapping_xml_name_output = {
  foo : Smaws_Lib.Smithy_api.Types.string_ option; [@ocaml.doc ""]
}
[@@ocaml.doc ""] [@@deriving show, eq]
...
type custom_code_error = { message : Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]
...
type flattened_xml_map_with_xml_name_output_map =
  (Smaws_Lib.Smithy_api.Types.string_ * Smaws_Lib.Smithy_api.Types.string_) list
[@@ocaml.doc ""] [@@deriving show, eq]

type flattened_xml_map_with_xml_name_output = {
  my_map : flattened_xml_map_with_xml_name_output_map option; [@ocaml.doc ""]
}
[@@ocaml.doc ""] [@@deriving show, eq]

type flattened_xml_map_output = { my_map : Shared.Types.foo_enum_map option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]

type host_label_input = { label : Smaws_Lib.Smithy_api.Types.string_ [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]
