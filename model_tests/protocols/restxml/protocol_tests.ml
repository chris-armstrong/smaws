...
let all_query_string_types () =
  (Eio.Switch.run ~name:"AllQueryStringTypes") @@
    (fun sw ->
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.method_testable "expected request method"
                  `GET request.method_ in
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/AllQueryStringTypesInput") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [] request.headers in
              ()
          | Error error ->
              failwith (AllQueryStringTypes.error_to_string error)))
let rest_xml_query_string_map () =
  (Eio.Switch.run ~name:"RestXmlQueryStringMap") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_query_string_escaping () =
  (Eio.Switch.run ~name:"RestXmlQueryStringEscaping") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_na_n_float_query_values () =
  (Eio.Switch.run ~name:"RestXmlSupportsNaNFloatQueryValues") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_infinity_float_query_values () =
  (Eio.Switch.run ~name:"RestXmlSupportsInfinityFloatQueryValues") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_negative_infinity_float_query_values () =
  (Eio.Switch.run ~name:"RestXmlSupportsNegativeInfinityFloatQueryValues") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_zero_and_false_query_values () =
  (Eio.Switch.run ~name:"RestXmlZeroAndFalseQueryValues") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let all_query_string_types_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#AllQueryStringTypes",
    ...
    ("RestXmlSupportsNaNFloatQueryValues", `Quick,
      rest_xml_supports_na_n_float_query_values);
    ("RestXmlSupportsInfinityFloatQueryValues", `Quick,
      rest_xml_supports_infinity_float_query_values);
    ("RestXmlSupportsNegativeInfinityFloatQueryValues", `Quick,
      rest_xml_supports_negative_infinity_float_query_values);
    ("RestXmlZeroAndFalseQueryValues", `Quick,
      rest_xml_zero_and_false_query_values)])
let body_with_xml_name () =
  (Eio.Switch.run ~name:"BodyWithXmlName") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.body_with_xml_name_input_output =
           { nested = (Some { name = (Some "Phreddy") }) } in
         Mock.mock_response
           ?body:(Some "<Ahoy><nested><name>Phreddy</name></nested></Ahoy>")
         ...
         (let response = BodyWithXmlName.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.method_testable "expected request method"
                  `PUT request.method_ in
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/BodyWithXmlName") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = BodyWithXmlName.request ctx { nested = None } in
          ...
          | Ok result ->
              let expected =
                ({ nested = (Some { name = (Some "Phreddy") }) } : Types.body_with_xml_name_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_body_with_xml_name_input_output
...
let constant_and_variable_query_string_missing_one_value () =
  (Eio.Switch.run ~name:"ConstantAndVariableQueryStringMissingOneValue") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.constant_and_variable_query_string_input =
           { maybe_set = None; baz = (Some "bam") } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = ConstantAndVariableQueryString.request ctx input in
          ...
          | Ok resp ->
              ...
              ()
          | Error error ->
              failwith (ConstantAndVariableQueryString.error_to_string error)))
let constant_and_variable_query_string_all_values () =
  (Eio.Switch.run ~name:"ConstantAndVariableQueryStringAllValues") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.constant_and_variable_query_string_input =
           { maybe_set = (Some "yes"); baz = (Some "bam") } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = ConstantAndVariableQueryString.request ctx input in
          match response with
...
let constant_and_variable_query_string_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#ConstantAndVariableQueryString",
    [("ConstantAndVariableQueryStringMissingOneValue", `Quick,
       constant_and_variable_query_string_missing_one_value);
    ("ConstantAndVariableQueryStringAllValues", `Quick,
      constant_and_variable_query_string_all_values)])
let constant_query_string () =
  (Eio.Switch.run ~name:"ConstantQueryString") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = ConstantQueryString.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/ConstantQueryString/hi") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [] request.headers in
              ()
          | Error error ->
              failwith (ConstantQueryString.error_to_string error)))
...
let rest_xml_date_time_with_negative_offset () =
  (Eio.Switch.run ~name:"RestXmlDateTimeWithNegativeOffset") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
              ...
              let expected =
                ({
                   datetime =
                     (Some
                        (Option.get
                           (Smaws_Lib.CoreTypes.Timestamp.of_float_s
                              1576540098.)))
                 } : Types.datetime_offsets_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_datetime_offsets_output
                   Types.equal_datetime_offsets_output) "expected output"
                expected result
          | Error error -> failwith (DatetimeOffsets.error_to_string error)))
let rest_xml_date_time_with_positive_offset () =
  (Eio.Switch.run ~name:"RestXmlDateTimeWithPositiveOffset") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let datetime_offsets_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#DatetimeOffsets",
    [("RestXmlDateTimeWithNegativeOffset", `Quick,
       rest_xml_date_time_with_negative_offset);
    ("RestXmlDateTimeWithPositiveOffset", `Quick,
      rest_xml_date_time_with_positive_offset)])
let empty_input_and_empty_output () =
  (Eio.Switch.run ~name:"EmptyInputAndEmptyOutput") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = EmptyInputAndEmptyOutput.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/EmptyInputAndEmptyOutput") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [] request.headers in
              ()
          | Error error ->
              failwith (EmptyInputAndEmptyOutput.error_to_string error)))
let empty_input_and_empty_output () =
  (Eio.Switch.run ~name:"EmptyInputAndEmptyOutput") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = EmptyInputAndEmptyOutput.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_empty_input_and_empty_output_output
...
let rest_xml_endpoint_trait () =
  (Eio.Switch.run ~name:"RestXmlEndpointTrait") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = EndpointOperation.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/EndpointOperation") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [] request.headers in
              ()
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response =
            EndpointWithHostLabelHeaderOperation.request ctx input in
          match response with
          | Ok resp ->
              let request = Mock.last_request () in
              let () =
              ...
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [("X-Amz-Account-Id", "bar")]
                  request.headers in
              ()
          | Error error ->
              failwith
                (EndpointWithHostLabelHeaderOperation.error_to_string error)))
let endpoint_with_host_label_header_operation_test_suite : unit Alcotest.test
  ...
  ("aws.protocoltests.restxml#EndpointWithHostLabelHeaderOperation",
    [("RestXmlEndpointTraitWithHostLabelAndHttpBinding", `Quick,
       rest_xml_endpoint_trait_with_host_label_and_http_binding)])
let rest_xml_endpoint_trait_with_host_label () =
  (Eio.Switch.run ~name:"RestXmlEndpointTraitWithHostLabel") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.endpoint_with_host_label_operation_request =
           { label = "bar" } in
         Mock.mock_response
           ?body:(Some
...
let endpoint_with_host_label_operation_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#EndpointWithHostLabelOperation",
    [("RestXmlEndpointTraitWithHostLabel", `Quick,
       rest_xml_endpoint_trait_with_host_label)])
let flattened_xml_map () =
  (Eio.Switch.run ~name:"FlattenedXmlMap") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.flattened_xml_map_request =
           { my_map = (Some [("foo", FOO); ("baz", BAZ)]) } in
         Mock.mock_response
           ?body:(Some
         ...
         (let response = FlattenedXmlMap.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/FlattenedXmlMap") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = FlattenedXmlMap.request ctx { my_map = None } in
          ...
          | Ok result ->
              let expected =
                ({ my_map = (Some [("foo", FOO); ("baz", BAZ)]) } : Types.flattened_xml_map_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_flattened_xml_map_response
                   Types.equal_flattened_xml_map_response) "expected output"
                expected result
          | Error error -> failwith (FlattenedXmlMap.error_to_string error)))
...
let flattened_xml_map_with_xml_name () =
  (Eio.Switch.run ~name:"FlattenedXmlMapWithXmlName") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = FlattenedXmlMapWithXmlName.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/FlattenedXmlMapWithXmlName") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (FlattenedXmlMapWithXmlName.error_to_string error)))
let flattened_xml_map_with_xml_name () =
  (Eio.Switch.run ~name:"FlattenedXmlMapWithXmlName") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response
           ...
           ~status:200 ~headers:[("Content-Type", "application/xml")] ();
         (let response =
            FlattenedXmlMapWithXmlName.request ctx { my_map = None } in
          match response with
          | Ok result ->
              let expected =
                ({ my_map = (Some [("a", "A"); ("b", "B")]) } : Types.flattened_xml_map_with_xml_name_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_flattened_xml_map_with_xml_name_response
...
let rest_xml_flattened_xml_map_with_xml_namespace () =
  (Eio.Switch.run ~name:"RestXmlFlattenedXmlMapWithXmlNamespace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = FlattenedXmlMapWithXmlNamespace.request ctx () in
          ...
          | Ok result ->
              let expected =
                ({ my_map = (Some [("a", "A"); ("b", "B")]) } : Types.flattened_xml_map_with_xml_namespace_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_flattened_xml_map_with_xml_namespace_output
                   Types.equal_flattened_xml_map_with_xml_namespace_output)
                "expected output" expected result
          | Error error ->
              failwith
                (FlattenedXmlMapWithXmlNamespace.error_to_string error)))
let flattened_xml_map_with_xml_namespace_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#FlattenedXmlMapWithXmlNamespace",
    [("RestXmlFlattenedXmlMapWithXmlNamespace", `Quick,
       rest_xml_flattened_xml_map_with_xml_namespace)])
let rest_xml_date_time_with_fractional_seconds () =
  (Eio.Switch.run ~name:"RestXmlDateTimeWithFractionalSeconds") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
                     ...
                     (Some
                        (Smaws_Lib.CoreTypes.Timestamp.truncate ~frac_s:6
                           (Option.get
                              (Smaws_Lib.CoreTypes.Timestamp.of_float_s
                                 946845296.123))))
                 } : Types.fractional_seconds_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_fractional_seconds_output
                   Types.equal_fractional_seconds_output) "expected output"
                expected result
...
let fractional_seconds_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#FractionalSeconds",
    [("RestXmlDateTimeWithFractionalSeconds", `Quick,
       rest_xml_date_time_with_fractional_seconds)])
let greeting_with_errors () =
  (Eio.Switch.run ~name:"GreetingWithErrors") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = GreetingWithErrors.request ctx () in
          ...
          | Ok result ->
              let expected =
                ({ greeting = (Some "Hello") } : Types.greeting_with_errors_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_greeting_with_errors_output
                   Types.equal_greeting_with_errors_output) "expected output"
                expected result
          | Error error ->
              failwith (GreetingWithErrors.error_to_string error)))
let complex_error () =
  (Eio.Switch.run ~name:"ComplexError") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
          ...
          | Error (`ComplexError e) ->
              let expected =
                ({
                   ...
                   header = (Some "Header")
                 } : Types.complex_error) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_complex_error
                   Types.equal_complex_error) "expected error" expected e
          | Error other ->
              failwith (GreetingWithErrors.error_to_string other)
          | Ok _ -> failwith "expected an error response, got Ok"))
let invalid_greeting_error () =
  (Eio.Switch.run ~name:"InvalidGreetingError") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = GreetingWithErrors.request ctx () in
          ...
          | Error (`InvalidGreeting e) ->
              let expected =
                ({ message = (Some "Hi") } : Types.invalid_greeting) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_invalid_greeting
                   Types.equal_invalid_greeting) "expected error" expected e
          | Error other ->
              failwith (GreetingWithErrors.error_to_string other)
          | Ok _ -> failwith "expected an error response, got Ok"))
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = HttpEmptyPrefixHeaders.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/HttpEmptyPrefixHeaders") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("hello", "There"); ("x-foo", "Foo")] request.headers in
              ()
          | Error error ->
              failwith (HttpEmptyPrefixHeaders.error_to_string error)))
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response ?body:None ~status:200
           ~headers:[("hello", "There"); ("x-foo", "Foo")] ();
         (let response =
            HttpEmptyPrefixHeaders.request ctx
              { specific_header = None; prefix_headers = None } in
          match response with
          | Ok result ->
              let expected =
                ({
                   specific_header = (Some "There");
                   prefix_headers =
                     (Some [("x-foo", "Foo"); ("hello", "Hello")])
                 } : Types.http_empty_prefix_headers_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_empty_prefix_headers_output
...
let http_empty_prefix_headers_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpEmptyPrefixHeaders",
    [("HttpEmptyPrefixHeadersRequestClient", `Quick,
       http_empty_prefix_headers_request_client);
    ("HttpEmptyPrefixHeadersResponseServer", `Quick,
      http_empty_prefix_headers_response_server)])
let rest_xml_enum_payload_request () =
  (Eio.Switch.run ~name:"RestXmlEnumPayloadRequest") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = HttpEnumPayload.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/EnumPayload") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [("Content-Type", "text/plain")]
                  request.headers in
              ()
          | Error error -> failwith (HttpEnumPayload.error_to_string error)))
let rest_xml_enum_payload_response () =
  (Eio.Switch.run ~name:"RestXmlEnumPayloadResponse") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = HttpEnumPayload.request ctx { payload = None } in
          ...
          | Ok result ->
              let expected =
                ({ payload = (Some V) } : Types.enum_payload_input) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_enum_payload_input
                   Types.equal_enum_payload_input) "expected output" expected
                result
          | Error error -> failwith (HttpEnumPayload.error_to_string error)))
...
let http_payload_traits_with_blob () =
  (Eio.Switch.run ~name:"HttpPayloadTraitsWithBlob") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.http_payload_traits_input_output =
           {
             blob =
               (Some (Smaws_Lib.CoreTypes.Blob.of_string "blobby blob blob"));
             foo = (Some "Foo")
           } in
         ...
         (let response = HttpPayloadTraits.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/HttpPayloadTraits") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [("X-Foo", "Foo")]
                  request.headers in
              ()
          | Error error -> failwith (HttpPayloadTraits.error_to_string error)))
let http_payload_traits_with_no_blob_body () =
  (Eio.Switch.run ~name:"HttpPayloadTraitsWithNoBlobBody") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response ?body:(Some "blobby blob blob") ~status:200
           ~headers:[("X-Foo", "Foo")] ();
         (let response =
            HttpPayloadTraits.request ctx { blob = None; foo = None } in
          match response with
          | Ok result ->
              let expected =
                ({
                   blob =
                     (Some
                        (Smaws_Lib.CoreTypes.Blob.of_string
                           "blobby blob blob"));
                   foo = (Some "Foo")
                 } : Types.http_payload_traits_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_payload_traits_input_output
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response =
          ...
          | Ok result ->
              let expected =
                ({ blob = None; foo = (Some "Foo") } : Types.http_payload_traits_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_payload_traits_input_output
                   Types.equal_http_payload_traits_input_output)
...
let http_payload_traits_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpPayloadTraits",
    ...
    ("HttpPayloadTraitsWithNoBlobBody", `Quick,
      http_payload_traits_with_no_blob_body);
    ("HttpPayloadTraitsWithBlob", `Quick, http_payload_traits_with_blob);
    ("HttpPayloadTraitsWithNoBlobBody", `Quick,
      http_payload_traits_with_no_blob_body)])
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = HttpPayloadTraitsWithMediaType.request ctx input in
          ...
          | Ok resp ->
              ...
              ()
          | Error error ->
              failwith (HttpPayloadTraitsWithMediaType.error_to_string error)))
let http_payload_traits_with_media_type_with_blob () =
  (Eio.Switch.run ~name:"HttpPayloadTraitsWithMediaTypeWithBlob") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response =
            HttpPayloadTraitsWithMediaType.request ctx
              { blob = None; foo = None } in
          match response with
          | Ok result ->
              let expected =
                ({
                   blob =
                     (Some
                        (Smaws_Lib.CoreTypes.Blob.of_string
                           "blobby blob blob"));
                   foo = (Some "Foo")
                 } : Types.http_payload_traits_with_media_type_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_payload_traits_with_media_type_input_output
...
let http_payload_traits_with_media_type_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpPayloadTraitsWithMediaType",
    [("HttpPayloadTraitsWithMediaTypeWithBlob", `Quick,
       http_payload_traits_with_media_type_with_blob);
    ("HttpPayloadTraitsWithMediaTypeWithBlob", `Quick,
      http_payload_traits_with_media_type_with_blob)])
let http_payload_with_member_xml_name () =
  (Eio.Switch.run ~name:"HttpPayloadWithMemberXmlName") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.http_payload_with_member_xml_name_input_output =
           { nested = (Some { name = (Some "Phreddy") }) } in
         Mock.mock_response ?body:(Some "<Hola><name>Phreddy</name></Hola>")
           ~status:200 ~headers:[("Content-Type", "application/json")] ();
         (let response = HttpPayloadWithMemberXmlName.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/HttpPayloadWithMemberXmlName") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (HttpPayloadWithMemberXmlName.error_to_string error)))
let http_payload_with_member_xml_name () =
  (Eio.Switch.run ~name:"HttpPayloadWithMemberXmlName") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response ?body:(Some "<Hola><name>Phreddy</name></Hola>")
           ~status:200 ~headers:[("Content-Type", "application/xml")] ();
         (let response =
            HttpPayloadWithMemberXmlName.request ctx { nested = None } in
          match response with
          | Ok result ->
              let expected =
                ({ nested = (Some { name = (Some "Phreddy") }) } : Types.http_payload_with_member_xml_name_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_payload_with_member_xml_name_input_output
...
let http_payload_with_member_xml_name_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpPayloadWithMemberXmlName",
    [("HttpPayloadWithMemberXmlName", `Quick,
       http_payload_with_member_xml_name);
    ("HttpPayloadWithMemberXmlName", `Quick,
      http_payload_with_member_xml_name)])
let http_payload_with_structure () =
  (Eio.Switch.run ~name:"HttpPayloadWithStructure") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.http_payload_with_structure_input_output =
           {
             nested =
               (Some { name = (Some "Phreddy"); greeting = (Some "hello") })
           } in
         Mock.mock_response
           ?body:(Some
         ...
         (let response = HttpPayloadWithStructure.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/HttpPayloadWithStructure") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (HttpPayloadWithStructure.error_to_string error)))
let http_payload_with_structure () =
  (Eio.Switch.run ~name:"HttpPayloadWithStructure") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response
           ...
           ~status:200 ~headers:[("Content-Type", "application/xml")] ();
         (let response =
            HttpPayloadWithStructure.request ctx { nested = None } in
          match response with
          | Ok result ->
              let expected =
                ({
                   nested =
                     (Some
                        { name = (Some "Phreddy"); greeting = (Some "hello")
                        })
                 } : Types.http_payload_with_structure_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_payload_with_structure_input_output
...
let rest_xml_http_payload_with_union () =
  (Eio.Switch.run ~name:"RestXmlHttpPayloadWithUnion") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.http_payload_with_union_input_output =
           { nested = (Some (Greeting "hello")) } in
         Mock.mock_response
           ?body:(Some
                    "<UnionPayload>\n    <greeting>hello</greeting>\n</UnionPayload>")
           ~status:200 ~headers:[("Content-Type", "application/json")] ();
         (let response = HttpPayloadWithUnion.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/HttpPayloadWithUnion") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (HttpPayloadWithUnion.error_to_string error)))
let rest_xml_http_payload_with_unset_union () =
  (Eio.Switch.run ~name:"RestXmlHttpPayloadWithUnsetUnion") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = HttpPayloadWithUnion.request ctx { nested = None } in
          ...
          | Ok result ->
              let expected =
                ({ nested = (Some (Greeting "hello")) } : Types.http_payload_with_union_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_payload_with_union_input_output
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = HttpPayloadWithUnion.request ctx { nested = None } in
          ...
          | Ok result ->
              let expected =
                ({ nested = None } : Types.http_payload_with_union_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_payload_with_union_input_output
                   Types.equal_http_payload_with_union_input_output)
...
let http_payload_with_union_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpPayloadWithUnion",
    [("RestXmlHttpPayloadWithUnion", `Quick,
       rest_xml_http_payload_with_union);
    ("RestXmlHttpPayloadWithUnsetUnion", `Quick,
      rest_xml_http_payload_with_unset_union);
    ("RestXmlHttpPayloadWithUnion", `Quick, rest_xml_http_payload_with_union);
    ("RestXmlHttpPayloadWithUnsetUnion", `Quick,
      rest_xml_http_payload_with_unset_union)])
let http_payload_with_xml_name () =
  (Eio.Switch.run ~name:"HttpPayloadWithXmlName") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.http_payload_with_xml_name_input_output =
           { nested = (Some { name = (Some "Phreddy") }) } in
         Mock.mock_response
           ?body:(Some "<Hello><name>Phreddy</name></Hello>") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = HttpPayloadWithXmlName.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/HttpPayloadWithXmlName") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (HttpPayloadWithXmlName.error_to_string error)))
let http_payload_with_xml_name () =
  (Eio.Switch.run ~name:"HttpPayloadWithXmlName") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = HttpPayloadWithXmlName.request ctx { nested = None } in
          ...
          | Ok result ->
              let expected =
                ({ nested = (Some { name = (Some "Phreddy") }) } : Types.http_payload_with_xml_name_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_payload_with_xml_name_input_output
...
let http_payload_with_xml_namespace () =
  (Eio.Switch.run ~name:"HttpPayloadWithXmlNamespace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = HttpPayloadWithXmlNamespace.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/HttpPayloadWithXmlNamespace") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (HttpPayloadWithXmlNamespace.error_to_string error)))
let http_payload_with_xml_namespace () =
  (Eio.Switch.run ~name:"HttpPayloadWithXmlNamespace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response
           ...
           ~status:200 ~headers:[("Content-Type", "application/xml")] ();
         (let response =
            HttpPayloadWithXmlNamespace.request ctx { nested = None } in
          match response with
          | Ok result ->
              let expected =
                ({ nested = (Some { name = (Some "Phreddy") }) } : Types.http_payload_with_xml_namespace_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_payload_with_xml_namespace_input_output
...
let http_payload_with_xml_namespace_and_prefix () =
  (Eio.Switch.run ~name:"HttpPayloadWithXmlNamespaceAndPrefix") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         Mock.mock_response
           ...
           ~status:200 ~headers:[("Content-Type", "application/json")] ();
         (let response =
            HttpPayloadWithXmlNamespaceAndPrefix.request ctx input in
          match response with
          | Ok resp ->
              let request = Mock.last_request () in
              let () =
          ...
          | Error error ->
              failwith
                (HttpPayloadWithXmlNamespaceAndPrefix.error_to_string error)))
let http_payload_with_xml_namespace_and_prefix () =
  (Eio.Switch.run ~name:"HttpPayloadWithXmlNamespaceAndPrefix") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response
           ...
           ~status:200 ~headers:[("Content-Type", "application/xml")] ();
         (let response =
            HttpPayloadWithXmlNamespaceAndPrefix.request ctx
              { nested = None } in
          match response with
          | Ok result ->
              let expected =
                ({ nested = (Some { name = (Some "Phreddy") }) } : Types.http_payload_with_xml_namespace_and_prefix_input_output) in
              check
                (Alcotest_http.testable_nan_aware
          ...
          | Error error ->
              failwith
                (HttpPayloadWithXmlNamespaceAndPrefix.error_to_string error)))
let http_payload_with_xml_namespace_and_prefix_test_suite :
  unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpPayloadWithXmlNamespaceAndPrefix",
    [("HttpPayloadWithXmlNamespaceAndPrefix", `Quick,
       http_payload_with_xml_namespace_and_prefix);
    ("HttpPayloadWithXmlNamespaceAndPrefix", `Quick,
      http_payload_with_xml_namespace_and_prefix)])
let http_prefix_headers_are_present () =
  (Eio.Switch.run ~name:"HttpPrefixHeadersArePresent") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.http_prefix_headers_input_output =
           {
             foo_map = (Some [("abc", "Abc value"); ("def", "Def value")]);
             foo = (Some "Foo")
           } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = HttpPrefixHeaders.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/HttpPrefixHeaders") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("x-foo-def", "Def value");
                  ("x-foo-abc", "Abc value");
                  ("x-foo", "Foo")] request.headers in
              ()
          | Error error -> failwith (HttpPrefixHeaders.error_to_string error)))
let http_prefix_headers_are_not_present () =
  (Eio.Switch.run ~name:"HttpPrefixHeadersAreNotPresent") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let http_prefix_empty_headers () =
  (Eio.Switch.run ~name:"HttpPrefixEmptyHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = HttpPrefixHeaders.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [("x-foo-abc", "")]
                  request.headers in
              ()
          | Error error -> failwith (HttpPrefixHeaders.error_to_string error)))
let http_prefix_headers_are_present () =
  (Eio.Switch.run ~name:"HttpPrefixHeadersArePresent") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("x-foo-def", "Def value");
                    ("x-foo-abc", "Abc value");
                    ("x-foo", "Foo")] ();
         (let response =
            HttpPrefixHeaders.request ctx { foo_map = None; foo = None } in
          match response with
          | Ok result ->
              let expected =
                ({
                   foo_map =
                     (Some [("abc", "Abc value"); ("def", "Def value")]);
                   foo = (Some "Foo")
                 } : Types.http_prefix_headers_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_prefix_headers_input_output
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response =
          ...
          | Ok result ->
              let expected =
                ({ foo_map = (Some []); foo = (Some "Foo") } : Types.http_prefix_headers_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_prefix_headers_input_output
                   Types.equal_http_prefix_headers_input_output)
...
let http_prefix_headers_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpPrefixHeaders",
    ...
    ("HttpPrefixHeadersAreNotPresent", `Quick,
      http_prefix_headers_are_not_present);
    ("HttpPrefixEmptyHeaders", `Quick, http_prefix_empty_headers);
    ("HttpPrefixHeadersArePresent", `Quick, http_prefix_headers_are_present);
    ("HttpPrefixHeadersAreNotPresent", `Quick,
      http_prefix_headers_are_not_present)])
let rest_xml_supports_na_n_float_labels () =
  (Eio.Switch.run ~name:"RestXmlSupportsNaNFloatLabels") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.http_request_with_float_labels_input =
           { double = Float.nan; float_ = Float.nan } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = HttpRequestWithFloatLabels.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/FloatHttpLabels/NaN/NaN") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [] request.headers in
              ()
          | Error error ->
              failwith (HttpRequestWithFloatLabels.error_to_string error)))
let rest_xml_supports_infinity_float_labels () =
  (Eio.Switch.run ~name:"RestXmlSupportsInfinityFloatLabels") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.http_request_with_float_labels_input =
           { double = Float.infinity; float_ = Float.infinity } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = HttpRequestWithFloatLabels.request ctx input in
          match response with
...
let rest_xml_supports_negative_infinity_float_labels () =
  (Eio.Switch.run ~name:"RestXmlSupportsNegativeInfinityFloatLabels") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.http_request_with_float_labels_input =
           { double = Float.neg_infinity; float_ = Float.neg_infinity } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = HttpRequestWithFloatLabels.request ctx input in
          match response with
...
let http_request_with_float_labels_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpRequestWithFloatLabels",
    [("RestXmlSupportsNaNFloatLabels", `Quick,
       rest_xml_supports_na_n_float_labels);
    ("RestXmlSupportsInfinityFloatLabels", `Quick,
      rest_xml_supports_infinity_float_labels);
    ("RestXmlSupportsNegativeInfinityFloatLabels", `Quick,
      rest_xml_supports_negative_infinity_float_labels)])
let http_request_with_greedy_label_in_path () =
  (Eio.Switch.run ~name:"HttpRequestWithGreedyLabelInPath") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = HttpRequestWithGreedyLabelInPath.request ctx input in
          ...
          | Error error ->
              failwith
                (HttpRequestWithGreedyLabelInPath.error_to_string error)))
let http_request_with_greedy_label_in_path_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpRequestWithGreedyLabelInPath",
    [("HttpRequestWithGreedyLabelInPath", `Quick,
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         let input : Types.http_request_with_labels_input =
           {
             timestamp =
               (Option.get
                  (Smaws_Lib.CoreTypes.Timestamp.of_float_s 1576540098.));
             boolean_ = true;
             double = 5.1;
             float_ = 4.1;
         ...
         (let response = HttpRequestWithLabels.request ctx input in
          ...
          | Ok resp ->
              ...
              ()
          | Error error ->
              failwith (HttpRequestWithLabels.error_to_string error)))
...
let http_request_with_labels_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpRequestWithLabels",
    [("InputWithHeadersAndAllParams", `Quick,
       input_with_headers_and_all_params);
    ("HttpRequestLabelEscaping", `Quick, http_request_label_escaping)])
let http_request_with_labels_and_timestamp_format () =
  (Eio.Switch.run ~name:"HttpRequestWithLabelsAndTimestampFormat") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input :
           Types.http_request_with_labels_and_timestamp_format_input =
           {
             target_date_time =
               (Option.get
                  (Smaws_Lib.CoreTypes.Timestamp.of_float_s 1576540098.));
         ...
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response =
            HttpRequestWithLabelsAndTimestampFormat.request ctx input in
          match response with
          | Ok resp ->
              let request = Mock.last_request () in
              let () =
          ...
          | Error error ->
              failwith
                (HttpRequestWithLabelsAndTimestampFormat.error_to_string
                   error)))
let http_request_with_labels_and_timestamp_format_test_suite :
  unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpRequestWithLabelsAndTimestampFormat",
    [("HttpRequestWithLabelsAndTimestampFormat", `Quick,
       http_request_with_labels_and_timestamp_format)])
let rest_xml_http_response_code () =
  (Eio.Switch.run ~name:"RestXmlHttpResponseCode") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         Mock.mock_response ?body:(Some "") ~status:201
           ~headers:[("Content-Type", "application/xml")] ();
         (let response = HttpResponseCode.request ctx () in
          match response with
          | Ok result ->
              let expected =
                ({ status = (Some 201) } : Types.http_response_code_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_http_response_code_output
                   Types.equal_http_response_code_output) "expected output"
                expected result
...
let rest_xml_string_payload_request () =
  (Eio.Switch.run ~name:"RestXmlStringPayloadRequest") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.string_payload_input =
           { payload = (Some "rawstring") } in
         ...
         (let response = HttpStringPayload.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/StringPayload") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [("Content-Type", "text/plain")]
                  request.headers in
...
let rest_xml_string_payload_response () =
  (Eio.Switch.run ~name:"RestXmlStringPayloadResponse") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = HttpStringPayload.request ctx { payload = None } in
          ...
          | Ok result ->
              let expected =
                ({ payload = (Some "rawstring") } : Types.string_payload_input) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_string_payload_input
                   Types.equal_string_payload_input) "expected output"
                expected result
          | Error error -> failwith (HttpStringPayload.error_to_string error)))
let http_string_payload_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#HttpStringPayload",
    ...
    ("RestXmlStringPayloadResponse", `Quick,
      rest_xml_string_payload_response)])
let ignore_query_params_in_response () =
  (Eio.Switch.run ~name:"IgnoreQueryParamsInResponse") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = IgnoreQueryParamsInResponse.request ctx () in
          ...
          | Ok result ->
              let expected =
                ({ baz = (Some "bam") } : Types.ignore_query_params_in_response_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_ignore_query_params_in_response_output
                   Types.equal_ignore_query_params_in_response_output)
                "expected output" expected result
          | Error error ->
              failwith (IgnoreQueryParamsInResponse.error_to_string error)))
...
let input_and_output_with_string_headers () =
  (Eio.Switch.run ~name:"InputAndOutputWithStringHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = InputAndOutputWithHeaders.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/InputAndOutputWithHeaders") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("X-StringSet", "a, b, c");
                  ("X-StringList", "a, b, c");
                  ("X-String", "Hello")] request.headers in
              ()
          | Error error ->
              failwith (InputAndOutputWithHeaders.error_to_string error)))
let input_and_output_with_numeric_headers () =
  (Eio.Switch.run ~name:"InputAndOutputWithNumericHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.headers_testable
                  ...
                  ("X-Integer", "123");
                  ("X-Short", "123");
                  ("X-Byte", "1")] request.headers in
              ()
          | Error error ->
              failwith (InputAndOutputWithHeaders.error_to_string error)))
let input_and_output_with_boolean_headers () =
  (Eio.Switch.run ~name:"InputAndOutputWithBooleanHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.headers_testable
                  ...
                  ("X-Boolean2", "false");
                  ("X-Boolean1", "true")] request.headers in
              ()
          | Error error ->
              failwith (InputAndOutputWithHeaders.error_to_string error)))
let input_and_output_with_timestamp_headers () =
  (Eio.Switch.run ~name:"InputAndOutputWithTimestampHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let input_and_output_with_enum_headers () =
  (Eio.Switch.run ~name:"InputAndOutputWithEnumHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_na_n_float_header_inputs () =
  (Eio.Switch.run ~name:"RestXmlSupportsNaNFloatHeaderInputs") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = InputAndOutputWithHeaders.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("X-Double", "NaN"); ("X-Float", "NaN")] request.headers in
              ()
          | Error error ->
              failwith (InputAndOutputWithHeaders.error_to_string error)))
...
let rest_xml_supports_negative_infinity_float_header_inputs () =
  (Eio.Switch.run ~name:"RestXmlSupportsNegativeInfinityFloatHeaderInputs")
    @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
          ...
          | Ok result ->
              let expected =
                ({
                   ...
                   header_byte = None;
                   header_string = (Some "Hello")
                 } : Types.input_and_output_with_headers_i_o) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_input_and_output_with_headers_i_o
          ...
          | Ok result ->
              let expected =
                ({
                   ...
                   header_float = (Some 1.1);
                   header_long =
                     (Some (Smaws_Lib.CoreTypes.Int64.of_int 123));
                   header_integer = (Some 123);
                   header_short = (Some 123);
                   header_byte = (Some 1);
                   header_string = None
  ...
  (Eio.Switch.run ~name:"InputAndOutputWithBooleanHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("X-BooleanList", "true, false, true");
                    ("X-Boolean2", "false");
                    ("X-Boolean1", "true")] ();
         (let response =
            InputAndOutputWithHeaders.request ctx
...
let rest_xml_supports_na_n_float_header_outputs () =
  (Eio.Switch.run ~name:"RestXmlSupportsNaNFloatHeaderOutputs") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_negative_infinity_float_header_outputs () =
  (Eio.Switch.run ~name:"RestXmlSupportsNegativeInfinityFloatHeaderOutputs")
    @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
...
let input_and_output_with_headers_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#InputAndOutputWithHeaders",
    [("InputAndOutputWithStringHeaders", `Quick,
       input_and_output_with_string_headers);
    ("InputAndOutputWithNumericHeaders", `Quick,
      input_and_output_with_numeric_headers);
    ("InputAndOutputWithBooleanHeaders", `Quick,
      input_and_output_with_boolean_headers);
    ("InputAndOutputWithTimestampHeaders", `Quick,
      input_and_output_with_timestamp_headers);
    ("InputAndOutputWithEnumHeaders", `Quick,
      input_and_output_with_enum_headers);
    ("RestXmlSupportsNaNFloatHeaderInputs", `Quick,
      rest_xml_supports_na_n_float_header_inputs);
    ("RestXmlSupportsInfinityFloatHeaderInputs", `Quick,
      rest_xml_supports_infinity_float_header_inputs);
    ("RestXmlSupportsNegativeInfinityFloatHeaderInputs", `Quick,
    ...
    ("InputAndOutputWithEnumHeaders", `Quick,
      input_and_output_with_enum_headers);
    ("RestXmlSupportsNaNFloatHeaderOutputs", `Quick,
      rest_xml_supports_na_n_float_header_outputs);
    ("RestXmlSupportsInfinityFloatHeaderOutputs", `Quick,
      rest_xml_supports_infinity_float_header_outputs);
    ("RestXmlSupportsNegativeInfinityFloatHeaderOutputs", `Quick,
      rest_xml_supports_negative_infinity_float_header_outputs)])
let nested_xml_map_request () =
  (Eio.Switch.run ~name:"NestedXmlMapRequest") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = NestedXmlMaps.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/NestedXmlMaps") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
...
let flat_nested_xml_map_request () =
  (Eio.Switch.run ~name:"FlatNestedXmlMapRequest") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let nested_xml_map_response () =
  (Eio.Switch.run ~name:"NestedXmlMapResponse") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = NestedXmlMaps.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_nested_xml_maps_response
                   Types.equal_nested_xml_maps_response) "expected output"
                expected result
          | Error error -> failwith (NestedXmlMaps.error_to_string error)))
let flat_nested_xml_map_response () =
  (Eio.Switch.run ~name:"FlatNestedXmlMapResponse") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let nested_xml_map_with_xml_name_serializes () =
  (Eio.Switch.run ~name:"NestedXmlMapWithXmlNameSerializes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = NestedXmlMapWithXmlName.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/NestedXmlMapWithXmlName") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (NestedXmlMapWithXmlName.error_to_string error)))
let nested_xml_map_with_xml_name_deserializes () =
  (Eio.Switch.run ~name:"NestedXmlMapWithXmlNameDeserializes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = NestedXmlMapWithXmlName.request ctx () in
          ...
          | Ok result ->
              let expected =
                (() : Types.nested_xml_map_with_xml_name_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_nested_xml_map_with_xml_name_response
...
let nested_xml_map_with_xml_name_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#NestedXmlMapWithXmlName",
    [("NestedXmlMapWithXmlNameSerializes", `Quick,
       nested_xml_map_with_xml_name_serializes);
    ("NestedXmlMapWithXmlNameDeserializes", `Quick,
      nested_xml_map_with_xml_name_deserializes)])
let no_input_and_no_output () =
  (Eio.Switch.run ~name:"NoInputAndNoOutput") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = NoInputAndNoOutput.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/NoInputAndNoOutput") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [] request.headers in
              ()
          | Error error ->
              failwith (NoInputAndNoOutput.error_to_string error)))
let no_input_and_no_output () =
  (Eio.Switch.run ~name:"NoInputAndNoOutput") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
...
let no_input_and_output () =
  (Eio.Switch.run ~name:"NoInputAndOutput") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = NoInputAndOutput.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/NoInputAndOutputOutput") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [] request.headers in
              ()
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = NoInputAndOutput.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_no_input_and_output_output
                   Types.equal_no_input_and_output_output) "expected output"
                expected result
          | Error error -> failwith (NoInputAndOutput.error_to_string error)))
...
let null_and_empty_headers () =
  (Eio.Switch.run ~name:"NullAndEmptyHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.null_and_empty_headers_i_o =
           { c = (Some []); b = (Some ""); a = None } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = NullAndEmptyHeadersClient.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/NullAndEmptyHeadersClient") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [("X-C", ""); ("X-B", "")]
                  request.headers in
              ()
          | Error error ->
              failwith (NullAndEmptyHeadersClient.error_to_string error)))
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("X-C", ""); ("X-B", "")] ();
         (let response =
            NullAndEmptyHeadersServer.request ctx
              { c = None; b = None; a = None } in
          match response with
          | Ok result ->
              let expected =
                ({ c = (Some []); b = (Some ""); a = None } : Types.null_and_empty_headers_i_o) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_null_and_empty_headers_i_o
                   Types.equal_null_and_empty_headers_i_o) "expected output"
                expected result
          | Error error ->
              failwith (NullAndEmptyHeadersServer.error_to_string error)))
...
let rest_xml_omits_null_query () =
  (Eio.Switch.run ~name:"RestXmlOmitsNullQuery") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.omits_null_serializes_empty_string_input =
           { empty_string = None; null_value = None } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = OmitsNullSerializesEmptyString.request ctx input in
          ...
          | Ok resp ->
              ...
              ()
          | Error error ->
              failwith (OmitsNullSerializesEmptyString.error_to_string error)))
let rest_xml_serializes_empty_string () =
  (Eio.Switch.run ~name:"RestXmlSerializesEmptyString") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.omits_null_serializes_empty_string_input =
           { empty_string = (Some ""); null_value = None } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = OmitsNullSerializesEmptyString.request ctx input in
          match response with
...
let omits_null_serializes_empty_string_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#OmitsNullSerializesEmptyString",
    ...
    ("RestXmlSerializesEmptyString", `Quick,
      rest_xml_serializes_empty_string)])
let sdk_applied_content_encoding_rest_xml () =
  (Eio.Switch.run ~name:"SDKAppliedContentEncoding_restXml") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let sdk_appended_gzip_after_provided_encoding_rest_xml () =
  (Eio.Switch.run ~name:"SDKAppendedGzipAfterProvidedEncoding_restXml") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = PutWithContentEncoding.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Encoding", "custom, gzip")] request.headers in
              ()
          | Error error ->
              failwith (PutWithContentEncoding.error_to_string error)))
let put_with_content_encoding_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#PutWithContentEncoding",
    [("SDKAppliedContentEncoding_restXml", `Quick,
       sdk_applied_content_encoding_rest_xml);
    ("SDKAppendedGzipAfterProvidedEncoding_restXml", `Quick,
      sdk_appended_gzip_after_provided_encoding_rest_xml)])
let query_idempotency_token_auto_fill () =
  (Eio.Switch.run ~name:"QueryIdempotencyTokenAutoFill") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response =
            Smaws_Lib.Uuid.with_generator
              ...
              (fun () -> QueryIdempotencyTokenAutoFill.request ctx input) in
          match response with
          | Ok resp ->
              let request = Mock.last_request () in
              let () =
              ...
              ()
          | Error error ->
              failwith (QueryIdempotencyTokenAutoFill.error_to_string error)))
let query_idempotency_token_auto_fill_is_set () =
  (Eio.Switch.run ~name:"QueryIdempotencyTokenAutoFillIsSet") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.query_idempotency_token_auto_fill_input =
           { token = (Some "00000000-0000-4000-8000-000000000000") } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
...
let query_idempotency_token_auto_fill_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#QueryIdempotencyTokenAutoFill",
    [("QueryIdempotencyTokenAutoFill", `Quick,
       query_idempotency_token_auto_fill);
    ("QueryIdempotencyTokenAutoFillIsSet", `Quick,
      query_idempotency_token_auto_fill_is_set)])
let rest_xml_query_params_string_list_map () =
  (Eio.Switch.run ~name:"RestXmlQueryParamsStringListMap") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.query_params_as_string_list_map_input =
           { foo = (Some [("baz", ["bar"; "qux"])]); qux = (Some "named") } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = QueryParamsAsStringListMap.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/StringListMap") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [] request.headers in
              ()
          | Error error ->
              failwith (QueryParamsAsStringListMap.error_to_string error)))
let query_params_as_string_list_map_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#QueryParamsAsStringListMap",
    [("RestXmlQueryParamsStringListMap", `Quick,
       rest_xml_query_params_string_list_map)])
let rest_xml_query_precedence () =
  (Eio.Switch.run ~name:"RestXmlQueryPrecedence") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let input : Types.query_precedence_input =
           {
             baz = (Some [("bar", "fromMap"); ("qux", "alsoFromMap")]);
             foo = (Some "named")
           } in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("Content-Type", "application/json")] ();
         (let response = QueryPrecedence.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/Precedence") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers" [] request.headers in
              ()
...
let recursive_shapes () =
  (Eio.Switch.run ~name:"RecursiveShapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = RecursiveShapes.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/RecursiveShapes") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
          ...
          | Ok result ->
              let expected =
                ({
                 ...
                 } : Types.recursive_shapes_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_recursive_shapes_response
                   Types.equal_recursive_shapes_response) "expected output"
                expected result
          | Error error -> failwith (RecursiveShapes.error_to_string error)))
let recursive_shapes_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#RecursiveShapes",
    [("RecursiveShapes", `Quick, recursive_shapes);
    ("RecursiveShapes", `Quick, recursive_shapes)])
let simple_scalar_properties () =
  (Eio.Switch.run ~name:"SimpleScalarProperties") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = SimpleScalarProperties.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/SimpleScalarProperties") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
...
let simple_scalar_properties_with_escaped_character () =
  (Eio.Switch.run ~name:"SimpleScalarPropertiesWithEscapedCharacter") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let simple_scalar_properties_with_white_space () =
  (Eio.Switch.run ~name:"SimpleScalarPropertiesWithWhiteSpace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let simple_scalar_properties_pure_white_space () =
  (Eio.Switch.run ~name:"SimpleScalarPropertiesPureWhiteSpace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_na_n_float_inputs () =
  (Eio.Switch.run ~name:"RestXmlSupportsNaNFloatInputs") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_infinity_float_inputs () =
  (Eio.Switch.run ~name:"RestXmlSupportsInfinityFloatInputs") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = SimpleScalarProperties.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_simple_scalar_properties_response
...
let simple_scalar_properties_with_xml_preamble () =
  (Eio.Switch.run ~name:"SimpleScalarPropertiesWithXMLPreamble") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_na_n_float_outputs () =
  (Eio.Switch.run ~name:"RestXmlSupportsNaNFloatOutputs") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_infinity_float_outputs () =
  (Eio.Switch.run ~name:"RestXmlSupportsInfinityFloatOutputs") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let rest_xml_supports_negative_infinity_float_outputs () =
  (Eio.Switch.run ~name:"RestXmlSupportsNegativeInfinityFloatOutputs") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let simple_scalar_properties_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#SimpleScalarProperties",
    ...
    ("SimpleScalarPropertiesWithEscapedCharacter", `Quick,
      simple_scalar_properties_with_escaped_character);
    ("SimpleScalarPropertiesWithWhiteSpace", `Quick,
      simple_scalar_properties_with_white_space);
    ("SimpleScalarPropertiesPureWhiteSpace", `Quick,
      simple_scalar_properties_pure_white_space);
    ("RestXmlSupportsNaNFloatInputs", `Quick,
      rest_xml_supports_na_n_float_inputs);
    ("RestXmlSupportsInfinityFloatInputs", `Quick,
      rest_xml_supports_infinity_float_inputs);
    ("RestXmlSupportsNegativeInfinityFloatInputs", `Quick,
      rest_xml_supports_negative_infinity_float_inputs);
    ("SimpleScalarProperties", `Quick, simple_scalar_properties);
    ("SimpleScalarPropertiesWithEscapedCharacter", `Quick,
      simple_scalar_properties_with_escaped_character);
    ("SimpleScalarPropertiesWithXMLPreamble", `Quick,
      simple_scalar_properties_with_xml_preamble);
    ("SimpleScalarPropertiesWithWhiteSpace", `Quick,
      simple_scalar_properties_with_white_space);
    ("SimpleScalarPropertiesPureWhiteSpace", `Quick,
      simple_scalar_properties_pure_white_space);
    ("RestXmlSupportsNaNFloatOutputs", `Quick,
      rest_xml_supports_na_n_float_outputs);
    ("RestXmlSupportsInfinityFloatOutputs", `Quick,
      rest_xml_supports_infinity_float_outputs);
    ("RestXmlSupportsNegativeInfinityFloatOutputs", `Quick,
      rest_xml_supports_negative_infinity_float_outputs)])
let timestamp_format_headers () =
  (Eio.Switch.run ~name:"TimestampFormatHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = TimestampFormatHeaders.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/TimestampFormatHeaders") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  ...
                  ("X-memberEpochSeconds", "1576540098")] request.headers in
              ()
          | Error error ->
              failwith (TimestampFormatHeaders.error_to_string error)))
let timestamp_format_headers () =
  (Eio.Switch.run ~name:"TimestampFormatHeaders") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         Mock.mock_response ?body:(Some "") ~status:200
           ~headers:[("X-targetDateTime", "2019-12-16T23:48:18Z");
                    ("X-targetHttpDate", "Mon, 16 Dec 2019 23:48:18 GMT");
                    ("X-targetEpochSeconds", "1576540098");
                    ("X-defaultFormat", "Mon, 16 Dec 2019 23:48:18 GMT");
                    ("X-memberDateTime", "2019-12-16T23:48:18Z");
                   ...
                   member_epoch_seconds =
                     (Some
                        (Option.get
                           (Smaws_Lib.CoreTypes.Timestamp.of_float_s
                              1576540098.)))
                 } : Types.timestamp_format_headers_i_o) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_timestamp_format_headers_i_o
...
let timestamp_format_headers_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#TimestampFormatHeaders",
    ...
    ("TimestampFormatHeaders", `Quick, timestamp_format_headers)])
let xml_attributes () =
  (Eio.Switch.run ~name:"XmlAttributes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlAttributes.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlAttributes") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlAttributes.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_attributes_response
                   Types.equal_xml_attributes_response) "expected output"
                expected result
          | Error error -> failwith (XmlAttributes.error_to_string error)))
...
let xml_attributes_in_middle () =
  (Eio.Switch.run ~name:"XmlAttributesInMiddle") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlAttributesInMiddle.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlAttributesInMiddle") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (XmlAttributesInMiddle.error_to_string error)))
let xml_attributes_in_middle () =
  (Eio.Switch.run ~name:"XmlAttributesInMiddle") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlAttributesInMiddle.request ctx { payload = None } in
          ...
          | Ok result ->
              let expected =
                ({ payload = (Some ()) } : Types.xml_attributes_in_middle_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_attributes_in_middle_response
...
let xml_attributes_on_payload () =
  (Eio.Switch.run ~name:"XmlAttributesOnPayload") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlAttributesOnPayload.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlAttributesOnPayload") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (XmlAttributesOnPayload.error_to_string error)))
let xml_attributes_on_payload () =
  (Eio.Switch.run ~name:"XmlAttributesOnPayload") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response
           ...
           ~status:200 ~headers:[("Content-Type", "application/xml")] ();
         (let response =
            XmlAttributesOnPayload.request ctx { payload = None } in
          match response with
          | Ok result ->
              let expected =
                ({ payload = (Some ()) } : Types.xml_attributes_on_payload_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_attributes_on_payload_response
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         let input : Types.xml_blobs_request =
           { data = (Some (Smaws_Lib.CoreTypes.Blob.of_string "value")) } in
         Mock.mock_response
           ?body:(Some
                    "<XmlBlobsRequest>\n    <data>dmFsdWU=</data>\n</XmlBlobsRequest>\n")
           ~status:200 ~headers:[("Content-Type", "application/json")] ();
         (let response = XmlBlobs.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlBlobs") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
          ...
          | Ok result ->
              let expected =
                ({ data = (Some (Smaws_Lib.CoreTypes.Blob.of_string "value"))
                 } : Types.xml_blobs_response) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_xml_blobs_response
                   Types.equal_xml_blobs_response) "expected output" expected
                result
          | Error error -> failwith (XmlBlobs.error_to_string error)))
...
let xml_empty_lists () =
  (Eio.Switch.run ~name:"XmlEmptyLists") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlEmptyLists.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlEmptyLists") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
...
let xml_empty_lists_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#XmlEmptyLists",
    [("XmlEmptyLists", `Quick, xml_empty_lists)])
let xml_empty_maps () =
  (Eio.Switch.run ~name:"XmlEmptyMaps") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlEmptyMaps.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlEmptyMaps") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
...
let xml_empty_strings () =
  (Eio.Switch.run ~name:"XmlEmptyStrings") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.xml_empty_strings_request =
           { empty_string = (Some "") } in
         Mock.mock_response
           ?body:(Some
         ...
         (let response = XmlEmptyStrings.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlEmptyStrings") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlEnums.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlEnums") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlEnums.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware Types.pp_xml_enums_response
                   Types.equal_xml_enums_response) "expected output" expected
                result
          | Error error -> failwith (XmlEnums.error_to_string error)))
...
let xml_int_enums () =
  (Eio.Switch.run ~name:"XmlIntEnums") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlIntEnums.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlIntEnums") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlIntEnums.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_int_enums_response
                   Types.equal_xml_int_enums_response) "expected output"
                expected result
          | Error error -> failwith (XmlIntEnums.error_to_string error)))
let xml_int_enums_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#XmlIntEnums",
    [("XmlIntEnums", `Quick, xml_int_enums);
    ("XmlIntEnums", `Quick, xml_int_enums)])
let xml_lists () =
  (Eio.Switch.run ~name:"XmlLists") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlLists.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlLists") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlLists.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware Types.pp_xml_lists_response
                   Types.equal_xml_lists_response) "expected output" expected
                result
          | Error error -> failwith (XmlLists.error_to_string error)))
...
let rest_xml_xml_map_with_xml_namespace () =
  (Eio.Switch.run ~name:"RestXmlXmlMapWithXmlNamespace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlMapWithXmlNamespace.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlMapWithXmlNamespace") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
              ()
          | Error error ->
              failwith (XmlMapWithXmlNamespace.error_to_string error)))
let rest_xml_xml_map_with_xml_namespace () =
  (Eio.Switch.run ~name:"RestXmlXmlMapWithXmlNamespace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlMapWithXmlNamespace.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_map_with_xml_namespace_response
...
let xml_map_with_xml_namespace_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#XmlMapWithXmlNamespace",
    [("RestXmlXmlMapWithXmlNamespace", `Quick,
       rest_xml_xml_map_with_xml_namespace);
    ("RestXmlXmlMapWithXmlNamespace", `Quick,
      rest_xml_xml_map_with_xml_namespace)])
let xml_maps () =
  (Eio.Switch.run ~name:"XmlMaps") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlMaps.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlMaps") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
                ...
                ({
                   my_map =
                     (Some
                        [("foo", { hi = (Some "there") });
                        ("baz", { hi = (Some "bye") })])
                 } : Types.xml_maps_response) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_xml_maps_response
                   Types.equal_xml_maps_response) "expected output" expected
                result
          | Error error -> failwith (XmlMaps.error_to_string error)))
...
let xml_maps_xml_name () =
  (Eio.Switch.run ~name:"XmlMapsXmlName") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlMapsXmlName.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlMapsXmlName") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
                ...
                ({
                   my_map =
                     (Some
                        [("foo", { hi = (Some "there") });
                        ("baz", { hi = (Some "bye") })])
                 } : Types.xml_maps_xml_name_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_maps_xml_name_response
                   Types.equal_xml_maps_xml_name_response) "expected output"
                expected result
          | Error error -> failwith (XmlMapsXmlName.error_to_string error)))
let xml_maps_xml_name_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#XmlMapsXmlName",
    [("XmlMapsXmlName", `Quick, xml_maps_xml_name);
    ("XmlMapsXmlName", `Quick, xml_maps_xml_name)])
let xml_namespaces () =
  (Eio.Switch.run ~name:"XmlNamespaces") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlNamespaces.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlNamespaces") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlNamespaces.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_namespaces_response
                   Types.equal_xml_namespaces_response) "expected output"
                expected result
          | Error error -> failwith (XmlNamespaces.error_to_string error)))
let xml_namespaces_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#XmlNamespaces",
    [("XmlNamespaces", `Quick, xml_namespaces);
    ("XmlNamespaces", `Quick, xml_namespaces)])
let xml_timestamps () =
  (Eio.Switch.run ~name:"XmlTimestamps") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = XmlTimestamps.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlTimestamps") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
...
let xml_timestamps_with_date_time_format () =
  (Eio.Switch.run ~name:"XmlTimestampsWithDateTimeFormat") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let xml_timestamps_with_epoch_seconds_format () =
  (Eio.Switch.run ~name:"XmlTimestampsWithEpochSecondsFormat") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let xml_timestamps_with_epoch_seconds_on_target_format () =
  (Eio.Switch.run ~name:"XmlTimestampsWithEpochSecondsOnTargetFormat") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let xml_timestamps_with_http_date_format () =
  (Eio.Switch.run ~name:"XmlTimestampsWithHttpDateFormat") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let xml_timestamps_with_http_date_on_target_format () =
  (Eio.Switch.run ~name:"XmlTimestampsWithHttpDateOnTargetFormat") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlTimestamps.request ctx () in
          ...
          | Ok result ->
              ...
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_timestamps_response
                   Types.equal_xml_timestamps_response) "expected output"
                expected result
          | Error error -> failwith (XmlTimestamps.error_to_string error)))
let xml_timestamps_with_date_time_format () =
  (Eio.Switch.run ~name:"XmlTimestampsWithDateTimeFormat") @@
...
let xml_timestamps_test_suite : unit Alcotest.test =
  ("aws.protocoltests.restxml#XmlTimestamps",
    ...
    ("XmlTimestampsWithDateTimeFormat", `Quick,
      xml_timestamps_with_date_time_format);
    ("XmlTimestampsWithDateTimeOnTargetFormat", `Quick,
    ...
    ("XmlTimestampsWithEpochSecondsOnTargetFormat", `Quick,
      xml_timestamps_with_epoch_seconds_on_target_format);
    ("XmlTimestampsWithHttpDateFormat", `Quick,
      xml_timestamps_with_http_date_format);
    ("XmlTimestampsWithHttpDateOnTargetFormat", `Quick,
...
let xml_unions_with_struct_member () =
  (Eio.Switch.run ~name:"XmlUnionsWithStructMember") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
                  ...
                  (StructValue
                     {
                       ...
                       long_value =
                         (Some (Smaws_Lib.CoreTypes.Int64.of_int 4));
         ...
         (let response = XmlUnions.request ctx input in
          ...
          | Ok resp ->
              ...
              let () =
                check Alcotest_http.uri_testable "expected request uri"
                  (Uri.of_string "/XmlUnions") request.uri in
              let () =
                check Alcotest_http.headers_testable
                  "expected request headers"
                  [("Content-Type", "application/xml")] request.headers in
...
let xml_unions_with_string_member () =
  (Eio.Switch.run ~name:"XmlUnionsWithStringMember") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.xml_unions_request =
           { union_value = (Some (StringValue "some string")) } in
         Mock.mock_response
           ?body:(Some
...
let xml_unions_with_boolean_member () =
  (Eio.Switch.run ~name:"XmlUnionsWithBooleanMember") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.xml_unions_request =
           { union_value = (Some (BooleanValue true)) } in
         Mock.mock_response
           ?body:(Some
                    "<XmlUnionsRequest>\n   <unionValue>\n      <booleanValue>true</booleanValue>\n   </unionValue>\n</XmlUnionsRequest>\n")
           ~status:200 ~headers:[("Content-Type", "application/json")] ();
...
let xml_unions_with_union_member () =
  (Eio.Switch.run ~name:"XmlUnionsWithUnionMember") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         let input : Types.xml_unions_request =
           { union_value = (Some (UnionValue (BooleanValue true))) } in
         Mock.mock_response
           ?body:(Some
                    "<XmlUnionsRequest>\n   <unionValue>\n      <unionValue>\n         <booleanValue>true</booleanValue>\n      </unionValue>\n   </unionValue>\n</XmlUnionsRequest>\n")
           ~status:200 ~headers:[("Content-Type", "application/json")] ();
          ...
          | Ok result ->
              let expected =
                ({
                 ...
                 } : Types.xml_unions_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_unions_response
                   Types.equal_xml_unions_response) "expected output"
                expected result
          | Error error -> failwith (XmlUnions.error_to_string error)))
let xml_unions_with_string_member () =
  (Eio.Switch.run ~name:"XmlUnionsWithStringMember") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlUnions.request ctx { union_value = None } in
          ...
          | Ok result ->
              let expected =
                ({ union_value = (Some (StringValue "some string")) } : 
                Types.xml_unions_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_unions_response
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlUnions.request ctx { union_value = None } in
          ...
          | Ok result ->
              let expected =
                ({ union_value = (Some (BooleanValue true)) } : Types.xml_unions_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_unions_response
                   Types.equal_xml_unions_response) "expected output"
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = XmlUnions.request ctx { union_value = None } in
          ...
          | Ok result ->
              let expected =
                ({ union_value = (Some (UnionValue (BooleanValue true))) } : 
                Types.xml_unions_response) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_xml_unions_response
