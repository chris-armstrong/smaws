    ...
    (fun tag _ ->
       ...
       | "doubleValue" ->
           r_double_value :=
             (Some
                (float_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "doubleValue" ())))
       | "floatValue" ->
           r_float_value :=
             (Some
                (float_of_string
       ...
       | "booleanValue" ->
           r_boolean_value :=
             (Some
                (bool_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "booleanValue" ())))
       | "stringValue" ->
           r_string_value :=
                                      ...
                                      (match ( ! ) r_byte_value with
                                       ...
                                       | None ->
                                           (match ( ! ) r_boolean_value with
                                            ...
                                            | None ->
                                                (match ( ! ) r_string_value
                                                 with
                                                 | Some v -> StringValue v
                                                 | None ->
                                                     failwith
                                                       "no union member present in xml response")))))))))) : 
  xml_union_shape)
let xml_unions_response_of_xml i =
  let r_union_value = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["unionValue"]
    (fun tag _ ->
       match tag with
       | "unionValue" ->
           r_union_value :=
           ...
           r_epoch_seconds_on_target :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.sequence i "epochSecondsOnTarget"
                   (fun i _ ->
                      Shared.Xml_deserializers.epoch_seconds_of_xml i) ()))
       | "epochSeconds" ->
           r_epoch_seconds :=
             (Some
    ...
    (fun i _ ->
       ...
       let v =
         Smaws_Lib.Xml.Parse.Read.sequence i "Setting"
           (fun i _ -> Shared.Xml_deserializers.greeting_struct_of_xml i) () in
       (k, v)) ()
                      ...
                      Smaws_Lib.Xml.Parse.Read.sequences i "entry"
                        (fun i _ ->
                           ...
                           let v =
                             Smaws_Lib.Xml.Parse.Read.sequence i "Setting"
                               (fun i _ ->
                                  Shared.Xml_deserializers.greeting_struct_of_xml
                                    i) () in
                           (k, v)) ()) ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
                ...
                (Smaws_Lib.Xml.Parse.Read.sequence i "myMap"
                   (fun i _ ->
                      Smaws_Lib.Xml.Parse.Read.sequences i "entry"
                        (fun i _ ->
                           let k =
                             Smaws_Lib.Xml.Parse.Read.element i "key" () in
                           let v =
                             Smaws_Lib.Xml.Parse.Read.sequence i "value"
                               (fun i _ ->
                                  Shared.Xml_deserializers.greeting_struct_of_xml
...
let xml_map_with_xml_namespace_input_output_map_of_xml i =
  Smaws_Lib.Xml.Parse.Read.sequences i "entry"
    (fun i _ ->
       ...
       let v = Smaws_Lib.Xml.Parse.Read.element i "V" () in (k, v)) ()
    ...
    (fun tag _ ->
       ...
       | "flattenedStructureList" ->
           r_flattened_structure_list :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.sequences i
                   "flattenedStructureList"
                   (fun i _ -> structure_list_member_of_xml i) ()))
       | "myStructureList" ->
           r_structure_list :=
       ...
       | "flattenedListWithNamespace" ->
           r_flattened_list_with_namespace :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.elements i
                   "flattenedListWithNamespace" ()))
       | "flattenedListWithMemberNamespace" ->
       ...
       | "customName" ->
           r_flattened_list2 :=
             (Some (Smaws_Lib.Xml.Parse.Read.elements i "customName" ()))
       | "flattenedList" ->
           r_flattened_list :=
             (Some (Smaws_Lib.Xml.Parse.Read.elements i "flattenedList" ()))
       | "renamed" ->
                ...
                (Smaws_Lib.Xml.Parse.Read.sequence i "nestedStringList"
                   (fun i _ ->
                      Smaws_Lib.Xml.Parse.Read.sequences i "member"
                        (fun i _ ->
                           Shared.Xml_deserializers.string_list_of_xml i) ())
                   ()))
       | "intEnumList" ->
           r_int_enum_list :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.sequence i "intEnumList"
                   (fun i _ ->
                      Smaws_Lib.Xml.Parse.Read.sequences i "member"
                        (fun i _ ->
                           Shared.Xml_deserializers.integer_enum_of_xml i) ())
                   ()))
       | "enumList" ->
           r_enum_list :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.sequence i "enumList"
                   (fun i _ ->
                      Smaws_Lib.Xml.Parse.Read.sequences i "member"
                        (fun i _ ->
                           Shared.Xml_deserializers.foo_enum_of_xml i) ()) ()))
       | "timestampList" ->
           r_timestamp_list :=
             (Some
                      ...
                      Smaws_Lib.Xml.Parse.Read.sequences i "entry"
                        (fun i _ ->
                           ...
                           let v =
                             Smaws_Lib.Xml.Parse.Read.sequence i "value"
                               (fun i _ ->
                                  Shared.Xml_deserializers.integer_enum_of_xml
                                    i) () in
                           (k, v)) ()) ()))
       | "intEnumSet" ->
           r_int_enum_set :=
...
let xml_empty_strings_response_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["emptyString"]
    (fun tag _ ->
       match tag with
       | "emptyString" ->
           r_empty_string :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "emptyString" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let xml_attributes_on_payload_response_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["payload"]
    (fun tag _ ->
       match tag with
       | "payload" ->
           r_payload :=
...
let xml_attributes_middle_member_input_output_of_xml i =
  ...
  let r_foo = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["baz"; "test"; "foo"]
    (fun tag _ ->
       match tag with
       | "baz" ->
           r_baz := (Some (Smaws_Lib.Xml.Parse.Read.element i "baz" ()))
       | "test" ->
           r_attr := (Some (Smaws_Lib.Xml.Parse.Read.element i "test" ()))
       | "foo" ->
           r_foo := (Some (Smaws_Lib.Xml.Parse.Read.element i "foo" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let xml_attributes_input_output_of_xml i =
  let r_attr = ref None in
  let r_foo = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["test"; "foo"]
    (fun tag _ ->
       match tag with
       | "test" ->
           r_attr := (Some (Smaws_Lib.Xml.Parse.Read.element i "test" ()))
       ...
       | "payload" ->
           r_payload :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.sequence i "payload"
                   (fun i _ ->
                      xml_attributes_in_middle_payload_response_of_xml i) ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
       ...
       | "payload" ->
           r_payload :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.sequence i "payload"
                   (fun i _ ->
                      xml_attributes_in_middle_payload_request_of_xml i) ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let union_payload_of_xml i =
  ...
  ((match ( ! ) r_greeting with
    | Some v -> Greeting v
    | None -> failwith "no union member present in xml response") : union_payload)
...
let string_payload_input_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["payload"]
    (fun tag _ ->
       ...
       | "payload" ->
           r_payload :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "payload" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let query_precedence_input_of_xml i =
  let r_baz = ref None in
  let r_foo = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["baz"; "foo"]
    (fun tag _ ->
       match tag with
       | "baz" ->
           r_baz :=
                      ...
                      Smaws_Lib.Xml.Parse.Read.sequences i "entry"
                        (fun i _ ->
                           let k =
                             Smaws_Lib.Xml.Parse.Read.element i "key" () in
                           let v =
                             Smaws_Lib.Xml.Parse.Read.element i "value" () in
                           (k, v)) ()) ()))
       | "foo" ->
           r_foo := (Some (Smaws_Lib.Xml.Parse.Read.element i "foo" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let query_params_as_string_list_map_input_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["foo"; "qux"]
    (fun tag _ ->
       match tag with
       | "foo" ->
           r_foo :=
                      ...
                      Smaws_Lib.Xml.Parse.Read.sequences i "entry"
                        (fun i _ ->
                           ...
                           let v =
                             Smaws_Lib.Xml.Parse.Read.sequence i "value"
                               (fun i _ ->
                                  Shared.Xml_deserializers.string_list_of_xml
                                    i) () in
                           (k, v)) ()) ()))
       | "qux" ->
           r_qux := (Some (Smaws_Lib.Xml.Parse.Read.element i "qux" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let omits_null_serializes_empty_string_input_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["emptyString"; "nullValue"]
    (fun tag _ ->
       match tag with
       | "emptyString" ->
           r_empty_string :=
       ...
       | "nullValue" ->
           r_null_value :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "nullValue" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let null_and_empty_headers_i_o_of_xml i =
  ...
  let r_b = ref None in
  let r_a = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["c"; "b"; "a"]
    (fun tag _ ->
       match tag with
       | "c" ->
           r_c :=
    ...
    (fun tag _ ->
       ...
       | "headerFalseBool" ->
           r_header_false_bool :=
             (Some
                (bool_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "headerFalseBool" ())))
       | "headerTrueBool" ->
           r_header_true_bool :=
             (Some
                (bool_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "headerTrueBool" ())))
       | "headerDouble" ->
           r_header_double :=
             (Some
                (float_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "headerDouble" ())))
       | "headerFloat" ->
           r_header_float :=
             (Some
                (float_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "headerFloat" ())))
       | "headerLong" ->
           r_header_long :=
             (Some
                (Smaws_Lib.CoreTypes.Int64.of_string
       ...
       | "headerInteger" ->
           r_header_integer :=
             (Some
                (int_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "headerInteger" ())))
       | "headerShort" ->
           r_header_short :=
             (Some
                (int_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "headerShort" ())))
       | "headerByte" ->
           r_header_byte :=
             (Some
                (int_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "headerByte" ())))
       | "headerString" ->
           r_header_string :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "headerString" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({
...
let ignore_query_params_in_response_output_of_xml i =
  let r_baz = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["baz"]
    (fun tag _ ->
       match tag with
       | "baz" ->
           r_baz := (Some (Smaws_Lib.Xml.Parse.Read.element i "baz" ()))
...
let http_response_code_output_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["Status"]
    (fun tag _ ->
       match tag with
       | "Status" ->
           r_status :=
             (Some
                (int_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "Status" ())))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let http_request_with_labels_and_timestamp_format_input_of_xml i =
  ...
  ({
     target_date_time =
       (Smaws_Lib.Xml.Parse.required "targetDateTime"
          (( ! ) r_target_date_time) i);
     target_http_date =
       (Smaws_Lib.Xml.Parse.required "targetHttpDate"
          (( ! ) r_target_http_date) i);
     target_epoch_seconds =
       (Smaws_Lib.Xml.Parse.required "targetEpochSeconds"
          (( ! ) r_target_epoch_seconds) i);
     default_format =
       (Smaws_Lib.Xml.Parse.required "defaultFormat" (( ! ) r_default_format)
          i);
     member_date_time =
       (Smaws_Lib.Xml.Parse.required "memberDateTime"
          (( ! ) r_member_date_time) i);
     member_http_date =
       (Smaws_Lib.Xml.Parse.required "memberHttpDate"
          (( ! ) r_member_http_date) i);
     member_epoch_seconds =
       (Smaws_Lib.Xml.Parse.required "memberEpochSeconds"
          (( ! ) r_member_epoch_seconds) i)
    ...
    (fun tag _ ->
       ...
       | "boolean" ->
           r_boolean_ :=
             (Some
                (bool_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "boolean" ())))
       | "double" ->
           r_double :=
             (Some
                (float_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "double" ())))
       | "float" ->
           r_float_ :=
             (Some
                (float_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "float" ())))
       | "long" ->
           r_long :=
             (Some
                (Smaws_Lib.CoreTypes.Int64.of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "long" ())))
       | "integer" ->
           r_integer :=
             (Some
                (int_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "integer" ())))
       | "short" ->
           r_short :=
             (Some
                (int_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "short" ())))
       | "string" ->
           r_string_ :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "string" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({
     timestamp =
       (Smaws_Lib.Xml.Parse.required "timestamp" (( ! ) r_timestamp) i);
...
let http_request_with_float_labels_input_of_xml i =
  let r_double = ref None in
  let r_float_ = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["double"; "float"]
    (fun tag _ ->
       match tag with
       | "double" ->
           r_double :=
...
let foo_prefix_headers_of_xml i =
  Smaws_Lib.Xml.Parse.Read.sequences i "entry"
    (fun i _ ->
       let k = Smaws_Lib.Xml.Parse.Read.element i "key" () in
       let v = Smaws_Lib.Xml.Parse.Read.element i "value" () in (k, v)) ()
let http_prefix_headers_input_output_of_xml i =
  let r_foo_map = ref None in
  let r_foo = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["fooMap"; "foo"]
    (fun tag _ ->
       match tag with
       | "fooMap" ->
           r_foo_map :=
...
let payload_with_xml_namespace_and_prefix_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["name"]
    (fun tag _ ->
       match tag with
       | "name" ->
           r_name := (Some (Smaws_Lib.Xml.Parse.Read.element i "name" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
    ...
    (fun tag _ ->
       ...
       | "nested" ->
           r_nested :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.sequence i "nested"
                   (fun i _ -> union_payload_of_xml i) ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({ nested = (( ! ) r_nested) } : http_payload_with_union_input_output)
let nested_payload_of_xml i =
  let r_name = ref None in
  let r_greeting = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["name"; "greeting"]
    (fun tag _ ->
       match tag with
       | "name" ->
           r_name := (Some (Smaws_Lib.Xml.Parse.Read.element i "name" ()))
...
let http_payload_traits_with_media_type_input_output_of_xml i =
  ...
  let r_foo = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["blob"; "foo"]
    (fun tag _ ->
       match tag with
       | "blob" ->
           r_blob :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.sequence i "blob"
                   (fun i _ ->
                      Shared.Xml_deserializers.text_plain_blob_of_xml i) ()))
       | "foo" ->
           r_foo := (Some (Smaws_Lib.Xml.Parse.Read.element i "foo" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
       ...
       | "blob" ->
           r_blob :=
             (Some
                (Bytes.of_string
                   (Base64.decode_exn
                      (Smaws_Lib.Xml.Parse.Read.element i "blob" ()))))
       | "foo" ->
           r_foo := (Some (Smaws_Lib.Xml.Parse.Read.element i "foo" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let http_empty_prefix_headers_output_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i
    ["specificHeader"; "prefixHeaders"]
    (fun tag _ ->
       match tag with
       | "specificHeader" ->
           r_specific_header :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "specificHeader" ()))
       | "prefixHeaders" ->
           r_prefix_headers :=
             (Some
       ...
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({
     specific_header = (( ! ) r_specific_header);
     prefix_headers = (( ! ) r_prefix_headers)
...
let complex_error_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i
    ...
    (fun tag _ ->
       ...
       | "Header" ->
           r_header :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "Header" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({
     nested = (( ! ) r_nested);
                ...
                (Smaws_Lib.Xml.Parse.Read.sequences i "myMap"
                   (fun i _ ->
                      ...
                      let v =
                        Smaws_Lib.Xml.Parse.Read.sequence i "value"
                          (fun i _ ->
                             Shared.Xml_deserializers.foo_enum_of_xml i) () in
                      (k, v)) ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let host_label_header_input_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["accountId"]
    (fun tag _ ->
       match tag with
       | "accountId" ->
           r_account_id :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "accountId" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({
     account_id =
       (Smaws_Lib.Xml.Parse.required "accountId" (( ! ) r_account_id) i)
...
let content_type_parameters_input_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["value"]
    (fun tag _ ->
       match tag with
       | "value" ->
           r_value :=
...
let constant_query_string_input_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["hello"]
    (fun tag _ ->
       match tag with
       | "hello" ->
           r_hello := (Some (Smaws_Lib.Xml.Parse.Read.element i "hello" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({ hello = (Smaws_Lib.Xml.Parse.required "hello" (( ! ) r_hello) i) } : 
  constant_query_string_input)
let constant_and_variable_query_string_input_of_xml i =
  let r_maybe_set = ref None in
  let r_baz = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["maybeSet"; "baz"]
    (fun tag _ ->
       match tag with
       | "maybeSet" ->
           r_maybe_set :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "maybeSet" ()))
       | "baz" ->
           r_baz := (Some (Smaws_Lib.Xml.Parse.Read.element i "baz" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
    ...
    (fun tag _ ->
       ...
       | "queryBoolean" ->
           r_query_boolean :=
             (Some
                (bool_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "queryBoolean" ())))
       | "queryDoubleList" ->
           r_query_double_list :=
             (Some
                (Smaws_Lib.Xml.Parse.Read.sequence i "queryDoubleList"
                   (fun i _ ->
                      List.map (fun s -> float_of_string s)
                        (Smaws_Lib.Xml.Parse.Read.elements i "member" ())) ()))
       | "queryDouble" ->
           r_query_double :=
             (Some
                (float_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "queryDouble" ())))
       | "queryFloat" ->
           r_query_float :=
             (Some
                (float_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "queryFloat" ())))
       | "queryLong" ->
           r_query_long :=
             (Some
                (Smaws_Lib.CoreTypes.Int64.of_string
       ...
       | "queryInteger" ->
           r_query_integer :=
             (Some
                (int_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "queryInteger" ())))
       | "queryShort" ->
           r_query_short :=
             (Some
                (int_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "queryShort" ())))
       | "queryByte" ->
           r_query_byte :=
             (Some
                (int_of_string
                   (Smaws_Lib.Xml.Parse.Read.element i "queryByte" ())))
       | "queryStringSet" ->
           r_query_string_set :=
             (Some
       ...
       | "queryString" ->
           r_query_string :=
             (Some (Smaws_Lib.Xml.Parse.Read.element i "queryString" ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({
...
let nested_map_of_xml i =
  Smaws_Lib.Xml.Parse.Read.sequences i "entry"
    (fun i _ ->
       ...
       let v =
         Smaws_Lib.Xml.Parse.Read.sequence i "value"
           (fun i _ -> Shared.Xml_deserializers.foo_enum_map_of_xml i) () in
       (k, v)) ()
let nested_xml_maps_input_output_of_xml i =
  let r_flat_nested_map = ref None in
  let r_nested_map = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["flatNestedMap"; "nestedMap"]
    (fun tag _ ->
       match tag with
       | "flatNestedMap" ->
           r_flat_nested_map :=
                ...
                (Smaws_Lib.Xml.Parse.Read.sequences i "flatNestedMap"
                   (fun i _ ->
                      ...
                      let v =
                        Smaws_Lib.Xml.Parse.Read.sequence i "value"
                          (fun i _ ->
                             Shared.Xml_deserializers.foo_enum_map_of_xml i)
                          () in
                      (k, v)) ()))
       | "nestedMap" ->
           r_nested_map :=
                      ...
                      Smaws_Lib.Xml.Parse.Read.sequences i "entry"
                        (fun i _ ->
                           ...
                           let v =
                             Smaws_Lib.Xml.Parse.Read.sequence i "value"
                               (fun i _ ->
                                  Shared.Xml_deserializers.foo_enum_map_of_xml
                                    i) () in
                           (k, v)) ()) ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({
     flat_nested_map = (( ! ) r_flat_nested_map);
     nested_map = (( ! ) r_nested_map)
...
let nested_xml_map_with_xml_name_inner_map_of_xml i =
  Smaws_Lib.Xml.Parse.Read.sequences i "entry"
    (fun i _ ->
       ...
       let v = Smaws_Lib.Xml.Parse.Read.element i "InnerValue" () in (k, v))
    ()
let nested_xml_map_with_xml_name_map_of_xml i =
  Smaws_Lib.Xml.Parse.Read.sequences i "entry"
    (fun i _ ->
       ...
       let v =
         Smaws_Lib.Xml.Parse.Read.sequence i "value"
           (fun i _ -> nested_xml_map_with_xml_name_inner_map_of_xml i) () in
       (k, v)) ()
let nested_xml_map_with_xml_name_input_output_of_xml i =
  let r_nested_xml_map_with_xml_name_map = ref None in
  Smaws_Lib.Xml.Parse.Structure.scanSequence i ["nestedXmlMapWithXmlNameMap"]
    (fun tag _ ->
       match tag with
                ...
                (Smaws_Lib.Xml.Parse.Read.sequence i
                   ...
                   (fun i _ ->
                      Smaws_Lib.Xml.Parse.Read.sequences i "entry"
                        (fun i _ ->
                           let k =
                             Smaws_Lib.Xml.Parse.Read.element i "OuterKey" () in
                           let v =
                             Smaws_Lib.Xml.Parse.Read.sequence i "value"
                               (fun i _ ->
                                  nested_xml_map_with_xml_name_inner_map_of_xml
                                    i) () in
                           (k, v)) ()) ()))
       | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
  ({
