...
type xml_namespaced_list = Smaws_Lib.Smithy_api.Types.string_ list[@@ocaml.doc
                                                                    ""]
[@@deriving (show, eq)]
type xml_namespace_nested =
  ...
  foo: Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""]}[@@ocaml.doc
                                                                   ""]
[@@deriving (show, eq)]
type xml_namespaces_input_output =
  {
...
type xml_maps_input_output_map =
  (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.greeting_struct) list
[@@ocaml.doc ""][@@deriving (show, eq)]
type xml_maps_response =
  {
  my_map: xml_maps_input_output_map option [@ocaml.doc ""]}[@@ocaml.doc ""]
[@@deriving (show, eq)]
type xml_maps_request =
  {
  my_map: xml_maps_input_output_map option [@ocaml.doc ""]}[@@ocaml.doc ""]
[@@deriving (show, eq)]
type xml_map_with_xml_namespace_response = unit[@@ocaml.doc ""][@@deriving
                                                                 (show, eq)]
type xml_map_with_xml_namespace_request = unit[@@ocaml.doc ""][@@deriving
                                                                (show, eq)]
...
type renamed_list_members = Smaws_Lib.Smithy_api.Types.string_ list[@@ocaml.doc
                                                                    ""]
[@@deriving (show, eq)]
type list_with_member_namespace = Smaws_Lib.Smithy_api.Types.string_ list
[@@ocaml.doc ""][@@deriving (show, eq)]
type list_with_namespace = Smaws_Lib.Smithy_api.Types.string_ list[@@ocaml.doc
                                                                    ""]
[@@deriving (show, eq)]
...
type xml_empty_strings_request =
  ...
  empty_string: Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""]}
[@@ocaml.doc ""][@@deriving (show, eq)]
type xml_empty_maps_response =
  {
  my_map: xml_maps_input_output_map option [@ocaml.doc ""]}[@@ocaml.doc ""]
[@@deriving (show, eq)]
type xml_empty_maps_request =
  {
  my_map: xml_maps_input_output_map option [@ocaml.doc ""]}[@@ocaml.doc ""]
[@@deriving (show, eq)]
...
type xml_empty_blobs_response =
  {
  data: Smaws_Lib.Smithy_api.Types.blob option [@ocaml.doc ""]}[@@ocaml.doc
                                                                 ""][@@deriving
                                                                    (show,
                                                                    eq)]
type xml_empty_blobs_request =
  {
  data: Smaws_Lib.Smithy_api.Types.blob option [@ocaml.doc ""]}[@@ocaml.doc
                                                                 ""][@@deriving
                                                                    (show,
                                                                    eq)]
type xml_blobs_response =
  {
  data: Smaws_Lib.Smithy_api.Types.blob option [@ocaml.doc ""]}[@@ocaml.doc
                                                                 ""][@@deriving
                                                                    (show,
                                                                    eq)]
type xml_blobs_request =
  {
  data: Smaws_Lib.Smithy_api.Types.blob option [@ocaml.doc ""]}[@@ocaml.doc
                                                                 ""][@@deriving
                                                                    (show,
...
type xml_attributes_payload_response = unit[@@ocaml.doc ""][@@deriving
                                                             (show, eq)]
type xml_attributes_payload_request = unit[@@ocaml.doc ""][@@deriving
                                                            (show, eq)]
type xml_attributes_on_payload_response =
  {
  payload: xml_attributes_payload_response option [@ocaml.doc ""]}[@@ocaml.doc
                                                                    ""]
[@@deriving (show, eq)]
type xml_attributes_on_payload_request =
  {
  payload: xml_attributes_payload_request option [@ocaml.doc ""]}[@@ocaml.doc
                                                                   ""]
[@@deriving (show, eq)]
...
type xml_attributes_input_output =
  ...
  foo: Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""]}[@@ocaml.doc
                                                                   ""]
[@@deriving (show, eq)]
type xml_attributes_in_middle_payload_response = unit[@@ocaml.doc ""]
[@@deriving (show, eq)]
type xml_attributes_in_middle_response =
  {
  payload: xml_attributes_in_middle_payload_response option [@ocaml.doc ""]}
[@@ocaml.doc ""][@@deriving (show, eq)]
type xml_attributes_in_middle_payload_request = unit[@@ocaml.doc ""][@@deriving
                                                                    (show,
                                                                    eq)]
...
type timestamp_format_headers_i_o =
  ...
  member_epoch_seconds: Smaws_Lib.Smithy_api.Types.timestamp option
    [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving (show, eq)]
type string_payload_input =
  {
  payload: Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""]}
[@@ocaml.doc ""][@@deriving (show, eq)]
type string_enum =
  | V [@ocaml.doc ""][@@ocaml.doc ""][@@deriving (show, eq)]
type simple_scalar_properties_response = unit[@@ocaml.doc ""][@@deriving
                                                               (show, eq)]
type simple_scalar_properties_request = unit[@@ocaml.doc ""][@@deriving
                                                              (show, eq)]
...
type nested_xml_map_with_xml_name_response = unit[@@ocaml.doc ""][@@deriving
                                                                   (show, eq)]
type nested_xml_map_with_xml_name_request = unit[@@ocaml.doc ""][@@deriving
                                                                  (show, eq)]
...
type payload_with_xml_namespace_and_prefix =
  {
  name: Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""]}[@@ocaml.doc
                                                                    ""]
[@@deriving (show, eq)]
...
[@@deriving (show, eq)]
type http_payload_with_union_input_output =
  {
...
[@@ocaml.doc ""][@@deriving (show, eq)]
type http_payload_with_structure_input_output =
  {
...
type flattened_xml_map_with_xml_name_request =
  ...
  my_map: flattened_xml_map_with_xml_name_input_output_map option
    [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving (show, eq)]
type flattened_xml_map_response =
  {
  my_map: Shared.Types.foo_enum_map option [@ocaml.doc ""]}[@@ocaml.doc ""]
[@@deriving (show, eq)]
type flattened_xml_map_request =
  {
  my_map: Shared.Types.foo_enum_map option [@ocaml.doc ""]}[@@ocaml.doc ""]
[@@deriving (show, eq)]
...
[@@deriving (show, eq)]
type host_label_header_input =
  {
  account_id: Smaws_Lib.Smithy_api.Types.string_ [@ocaml.doc ""]}[@@ocaml.doc
                                                                   ""]
[@@deriving (show, eq)]
type empty_input_and_empty_output_output = unit[@@ocaml.doc ""][@@deriving
                                                                 (show, eq)]
type empty_input_and_empty_output_input = unit[@@ocaml.doc ""][@@deriving
                                                                (show, eq)]
...
type content_type_parameters_input =
  ...
  value: Smaws_Lib.Smithy_api.Types.integer option [@ocaml.doc ""]}[@@ocaml.doc
                                                                    ""]
[@@deriving (show, eq)]
type constant_query_string_input =
  {
...
type constant_and_variable_query_string_input =
  ...
  baz: Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""]}[@@ocaml.doc
                                                                   ""]
[@@deriving (show, eq)]
type body_with_xml_name_input_output =
  {
  nested: payload_with_xml_name option [@ocaml.doc ""]}[@@ocaml.doc ""]
[@@deriving (show, eq)]
...
[@@ocaml.doc ""][@@deriving (show, eq)]
type nested_map =
  (Smaws_Lib.Smithy_api.Types.string_ * Shared.Types.foo_enum_map) list
[@@ocaml.doc ""][@@deriving (show, eq)]
...
type nested_xml_map_with_xml_name_map =
  (Smaws_Lib.Smithy_api.Types.string_ *
    nested_xml_map_with_xml_name_inner_map) list[@@ocaml.doc ""][@@deriving
                                                                  (show, eq)]
