...
let make_xml_attributes_input_output ?attr:(attr_ : Smaws_Lib.Smithy_api.Types.string_ option)
    ?foo:(foo_ : Smaws_Lib.Smithy_api.Types.string_ option) () =
...
let make_query_params_as_string_list_map_input ?foo:(foo_ : Shared.Types.string_list_map option)
...
let make_omits_null_serializes_empty_string_input
  ...
  ({ empty_string = empty_string_; null_value = null_value_ }
...
let make_http_request_with_float_labels_input ~double:(double_ : Smaws_Lib.Smithy_api.Types.double)
    ~float_:(float__ : Smaws_Lib.Smithy_api.Types.float_) () =
  ({ double = double_; float_ = float__ } : http_request_with_float_labels_input)

let make_http_prefix_headers_input_output ?foo_map:(foo_map_ : foo_prefix_headers option)
    ?foo:(foo_ : Smaws_Lib.Smithy_api.Types.string_ option) () =
...
let make_nested_payload ?name:(name_ : Smaws_Lib.Smithy_api.Types.string_ option)
...
let make_http_payload_traits_input_output ?blob:(blob_ : Smaws_Lib.Smithy_api.Types.blob option)
    ?foo:(foo_ : Smaws_Lib.Smithy_api.Types.string_ option) () =
...
let make_nested_xml_maps_input_output ?flat_nested_map:(flat_nested_map_ : nested_map option)
    ?nested_map:(nested_map_ : nested_map option) () =
  ({ flat_nested_map = flat_nested_map_; nested_map = nested_map_ } : nested_xml_maps_input_output)
