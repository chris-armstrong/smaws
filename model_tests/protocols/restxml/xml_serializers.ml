...
let xml_nested_union_struct_to_xml w (x : xml_nested_union_struct) =
  ignore
    [
      ...
      | Some v ->
          Smaws_Lib.Xml.Write.element w "doubleValue" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.AwsQuery.Serialize.float_to_string v)));
      (match x.float_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "floatValue" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.AwsQuery.Serialize.float_to_string v)));
      (match x.long_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "longValue" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.CoreTypes.Int64.to_string v)));
      (match x.integer_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "integerValue" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
      (match x.short_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "shortValue" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
      (match x.byte_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "byteValue" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
      (match x.boolean_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "booleanValue" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_bool v)));
      (match x.string_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "stringValue" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let xml_timestamps_input_output_to_xml w (x : xml_timestamps_input_output) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "httpDate" (fun w ->
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "epochSeconds" (fun w ->
              Smaws_Lib.Xml.Write.text w
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "dateTime" (fun w ->
              Smaws_Lib.Xml.Write.text w
                (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_iso_to_string v)));
      (match x.normal with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "normal" (fun w ->
              Smaws_Lib.Xml.Write.text w
                (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_iso_to_string v)));
    ]
...
let xml_namespaced_list_to_xml w xs =
  List.iter
    (fun item ->
      Smaws_Lib.Xml.Write.element w "member" (fun w ->
          (fun w v -> Smaws_Lib.Xml.Write.text w v) w item))
    xs
...
let xml_namespace_nested_to_xml w (x : xml_namespace_nested) =
  ignore
    [
      ...
      (match x.foo with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "foo" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let xml_maps_xml_name_input_output_map_to_xml w pairs =
  List.iter
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "Attribute" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "Setting" (fun w ->
              Shared.Xml_serializers.greeting_struct_to_xml w v)))
    pairs
...
let xml_maps_input_output_map_to_xml w pairs =
  List.iter
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "key" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "value" (fun w ->
              Shared.Xml_serializers.greeting_struct_to_xml w v)))
    pairs
...
let xml_map_with_xml_namespace_response_to_xml w _x = Smaws_Lib.Xml.Write.null w
let xml_map_with_xml_namespace_request_to_xml w _x = Smaws_Lib.Xml.Write.null w

let xml_map_with_xml_namespace_input_output_map_to_xml w pairs =
  List.iter
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "K" (fun w -> (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "V" (fun w -> (fun w v -> Smaws_Lib.Xml.Write.text w v) w v)))
    pairs
...
let renamed_list_members_to_xml w xs =
  List.iter
    (fun item ->
      Smaws_Lib.Xml.Write.element w "item" (fun w ->
          (fun w v -> Smaws_Lib.Xml.Write.text w v) w item))
    xs
...
let structure_list_member_to_xml w (x : structure_list_member) =
  ignore
    [
      (match x.b with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "other" (fun w -> Smaws_Lib.Xml.Write.text w v));
      (match x.a with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "value" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]

let structure_list_to_xml w xs =
  List.iter
    (fun item ->
      Smaws_Lib.Xml.Write.element w "item" (fun w -> structure_list_member_to_xml w item))
    xs
...
let xml_lists_input_output_to_xml w (x : xml_lists_input_output) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "flattenedStructureList" (fun w ->
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "flattenedListWithNamespace" (fun w ->
              List.iter (fun item -> (fun w v -> Smaws_Lib.Xml.Write.text w v) w item) v));
      (match x.flattened_list_with_member_namespace with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "flattenedListWithMemberNamespace" (fun w ->
              List.iter (fun item -> (fun w v -> Smaws_Lib.Xml.Write.text w v) w item) v));
      (match x.flattened_list2 with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "customName" (fun w ->
              List.iter (fun item -> (fun w v -> Smaws_Lib.Xml.Write.text w v) w item) v));
      (match x.flattened_list with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "flattenedList" (fun w ->
              List.iter (fun item -> (fun w v -> Smaws_Lib.Xml.Write.text w v) w item) v));
...
let xml_empty_strings_response_to_xml w (x : xml_empty_strings_response) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "emptyString" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let xml_empty_blobs_response_to_xml w (x : xml_empty_blobs_response) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "data" (fun w ->
...
let xml_attributes_middle_member_input_output_to_xml w
  ...
  ignore
    [
      (match x.baz with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "baz" (fun w -> Smaws_Lib.Xml.Write.text w v));
      (match x.attr with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "test" (fun w -> Smaws_Lib.Xml.Write.text w v));
      (match x.foo with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "foo" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let xml_attributes_in_middle_payload_response_to_xml w _x = Smaws_Lib.Xml.Write.null w
...
let xml_attributes_in_middle_payload_request_to_xml w _x = Smaws_Lib.Xml.Write.null w
...
let union_payload_to_xml w (x : union_payload) =
  match x with
  | Greeting v -> Smaws_Lib.Xml.Write.element w "greeting" (fun w -> Smaws_Lib.Xml.Write.text w v)
...
let timestamp_format_headers_i_o_to_xml w (x : timestamp_format_headers_i_o) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "defaultFormat" (fun w ->
              Smaws_Lib.Xml.Write.text w
                (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_iso_to_string v)));
      (match x.member_date_time with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "memberDateTime" (fun w ->
              Smaws_Lib.Xml.Write.text w
                (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_iso_to_string v)));
      (match x.member_http_date with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "memberHttpDate" (fun w ->
              Smaws_Lib.Xml.Write.text w
                (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_httpdate_to_string v)));
      (match x.member_epoch_seconds with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "memberEpochSeconds" (fun w ->
              Smaws_Lib.Xml.Write.text w
                (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_epoch_to_string v)));
    ]
...
let string_payload_input_to_xml w (x : string_payload_input) =
  ignore
    [
      (match x.payload with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "payload" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]

let string_enum_to_xml w (x : string_enum) =
  Smaws_Lib.Xml.Write.text w (match x with V -> "enumvalue")

let simple_scalar_properties_response_to_xml w _x = Smaws_Lib.Xml.Write.null w
...
let simple_scalar_properties_input_output_to_xml w (x : simple_scalar_properties_input_output) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "DoubleDribble" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.AwsQuery.Serialize.float_to_string v)));
      (match x.float_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "falseBooleanValue" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_bool v)));
      (match x.true_boolean_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "trueBooleanValue" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_bool v)));
      (match x.string_value with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
...
and recursive_shapes_input_output_nested2_to_xml w (x : recursive_shapes_input_output_nested2) =
  ignore
    [
      ...
      (match x.bar with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "bar" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let query_params_as_string_list_map_input_to_xml w (x : query_params_as_string_list_map_input) =
  ignore
    [
      ...
      (match x.qux with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "qux" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let query_idempotency_token_auto_fill_input_to_xml w (x : query_idempotency_token_auto_fill_input) =
  ignore
    [
      (match x.token with
      | None ->
          Smaws_Lib.Xml.Write.element w "token" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.Uuid.generate ()))
      | Some v -> Smaws_Lib.Xml.Write.element w "token" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let put_with_content_encoding_input_to_xml w (x : put_with_content_encoding_input) =
  ignore
    [
      (match x.data with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "data" (fun w -> Smaws_Lib.Xml.Write.text w v));
      (match x.encoding with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "encoding" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let omits_null_serializes_empty_string_input_to_xml w (x : omits_null_serializes_empty_string_input)
  ...
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "nullValue" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let null_and_empty_headers_i_o_to_xml w (x : null_and_empty_headers_i_o) =
  ignore
    [
      ...
      (match x.b with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "b" (fun w -> Smaws_Lib.Xml.Write.text w v));
      (match x.a with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "a" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]

let no_input_and_output_output_to_xml w _x = Smaws_Lib.Xml.Write.null w
let nested_xml_map_with_xml_name_response_to_xml w _x = Smaws_Lib.Xml.Write.null w
let nested_xml_map_with_xml_name_request_to_xml w _x = Smaws_Lib.Xml.Write.null w
...
let input_and_output_with_headers_i_o_to_xml w (x : input_and_output_with_headers_i_o) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "headerFalseBool" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_bool v)));
      (match x.header_true_bool with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "headerTrueBool" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_bool v)));
      (match x.header_double with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "headerDouble" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.AwsQuery.Serialize.float_to_string v)));
      (match x.header_float with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "headerFloat" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.AwsQuery.Serialize.float_to_string v)));
      (match x.header_long with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "headerLong" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.CoreTypes.Int64.to_string v)));
      (match x.header_integer with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "headerInteger" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
      (match x.header_short with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "headerShort" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
      (match x.header_byte with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "headerByte" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
      (match x.header_string with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "headerString" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let http_response_code_output_to_xml w (x : http_response_code_output) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "Status" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
    ]
...
let http_request_with_labels_and_timestamp_format_input_to_xml w
  ...
  ignore
    [
      ...
      Smaws_Lib.Xml.Write.element w "defaultFormat" (fun w ->
          Smaws_Lib.Xml.Write.text w
            (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_iso_to_string x.default_format));
      Smaws_Lib.Xml.Write.element w "memberDateTime" (fun w ->
          Smaws_Lib.Xml.Write.text w
            (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_iso_to_string x.member_date_time));
      Smaws_Lib.Xml.Write.element w "memberHttpDate" (fun w ->
          Smaws_Lib.Xml.Write.text w
...
let http_request_with_labels_input_to_xml w (x : http_request_with_labels_input) =
  ignore
    [
      Smaws_Lib.Xml.Write.element w "timestamp" (fun w ->
          Smaws_Lib.Xml.Write.text w
            (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_iso_to_string x.timestamp));
      Smaws_Lib.Xml.Write.element w "boolean" (fun w ->
          Smaws_Lib.Xml.Write.text w (string_of_bool x.boolean_));
      Smaws_Lib.Xml.Write.element w "double" (fun w ->
          Smaws_Lib.Xml.Write.text w
            (Smaws_Lib.Protocols.AwsQuery.Serialize.float_to_string x.double));
      Smaws_Lib.Xml.Write.element w "float" (fun w ->
          Smaws_Lib.Xml.Write.text w
            (Smaws_Lib.Protocols.AwsQuery.Serialize.float_to_string x.float_));
      Smaws_Lib.Xml.Write.element w "long" (fun w ->
          Smaws_Lib.Xml.Write.text w (Smaws_Lib.CoreTypes.Int64.to_string x.long));
      Smaws_Lib.Xml.Write.element w "integer" (fun w ->
          Smaws_Lib.Xml.Write.text w (string_of_int x.integer));
      Smaws_Lib.Xml.Write.element w "short" (fun w ->
          Smaws_Lib.Xml.Write.text w (string_of_int x.short));
      Smaws_Lib.Xml.Write.element w "string" (fun w -> Smaws_Lib.Xml.Write.text w x.string_);
    ]
...
let http_request_with_greedy_label_in_path_input_to_xml w
  ...
  ignore
    [
      Smaws_Lib.Xml.Write.element w "baz" (fun w -> Smaws_Lib.Xml.Write.text w x.baz);
      Smaws_Lib.Xml.Write.element w "foo" (fun w -> Smaws_Lib.Xml.Write.text w x.foo);
    ]
    ...
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "key" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "value" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w v)))
    pairs
...
let payload_with_xml_namespace_and_prefix_to_xml w (x : payload_with_xml_namespace_and_prefix) =
  ignore
    [
      (match x.name with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "name" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let nested_payload_to_xml w (x : nested_payload) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "greeting" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let http_payload_traits_input_output_to_xml w (x : http_payload_traits_input_output) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "blob" (fun w ->
              Smaws_Lib.Xml.Write.text w (Base64.encode_exn (Bytes.to_string v))));
      (match x.foo with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "foo" (fun w -> Smaws_Lib.Xml.Write.text w v));
...
let enum_payload_input_to_xml w (x : enum_payload_input) =
  ignore
    [
      (match x.payload with None -> Smaws_Lib.Xml.Write.null w | Some v -> string_enum_to_xml w v);
    ]
...
let http_empty_prefix_headers_output_to_xml w (x : http_empty_prefix_headers_output) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "specificHeader" (fun w -> Smaws_Lib.Xml.Write.text w v));
...
let invalid_greeting_to_xml w (x : invalid_greeting) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "Message" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let complex_error_to_xml w (x : complex_error) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "TopLevel" (fun w -> Smaws_Lib.Xml.Write.text w v));
      (match x.header with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "Header" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let flattened_xml_map_with_xml_namespace_output_to_xml w
  ...
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "KVP" (fun w ->
              List.iter
                (fun (k, v) ->
                  Smaws_Lib.Xml.Write.element w "K" (fun w ->
                      (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
                  Smaws_Lib.Xml.Write.element w "V" (fun w ->
                      (fun w v -> Smaws_Lib.Xml.Write.text w v) w v))
                v));
    ]
...
let flattened_xml_map_response_to_xml w (x : flattened_xml_map_response) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "myMap" (fun w ->
              List.iter
                (fun (k, v) ->
                  Smaws_Lib.Xml.Write.element w "key" (fun w ->
                      (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
                  Smaws_Lib.Xml.Write.element w "value" (fun w ->
                      Shared.Xml_serializers.foo_enum_to_xml w v))
                v));
    ]
...
let endpoint_with_host_label_operation_request_to_xml w
  ...
  ignore [ Smaws_Lib.Xml.Write.element w "label" (fun w -> Smaws_Lib.Xml.Write.text w x.label) ]

let host_label_header_input_to_xml w (x : host_label_header_input) =
  ignore
    [ Smaws_Lib.Xml.Write.element w "accountId" (fun w -> Smaws_Lib.Xml.Write.text w x.account_id) ]

let empty_input_and_empty_output_output_to_xml w _x = Smaws_Lib.Xml.Write.null w
let empty_input_and_empty_output_input_to_xml w _x = Smaws_Lib.Xml.Write.null w
...
let constant_query_string_input_to_xml w (x : constant_query_string_input) =
  ignore [ Smaws_Lib.Xml.Write.element w "hello" (fun w -> Smaws_Lib.Xml.Write.text w x.hello) ]
...
let constant_and_variable_query_string_input_to_xml w (x : constant_and_variable_query_string_input)
  ...
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "maybeSet" (fun w -> Smaws_Lib.Xml.Write.text w v));
      (match x.baz with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v -> Smaws_Lib.Xml.Write.element w "baz" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
...
let all_query_string_types_input_to_xml w (x : all_query_string_types_input) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "queryTimestamp" (fun w ->
              Smaws_Lib.Xml.Write.text w
                (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_iso_to_string v)));
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "queryBoolean" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_bool v)));
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "queryDouble" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.AwsQuery.Serialize.float_to_string v)));
      (match x.query_float with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "queryFloat" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.AwsQuery.Serialize.float_to_string v)));
      (match x.query_long with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "queryLong" (fun w ->
              Smaws_Lib.Xml.Write.text w (Smaws_Lib.CoreTypes.Int64.to_string v)));
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "queryInteger" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
      (match x.query_short with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "queryShort" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
      (match x.query_byte with
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "queryByte" (fun w ->
              Smaws_Lib.Xml.Write.text w (string_of_int v)));
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "queryString" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]
    ...
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "key" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "value" (fun w ->
              Shared.Xml_serializers.foo_enum_map_to_xml w v)))
    pairs
...
let nested_xml_maps_input_output_to_xml w (x : nested_xml_maps_input_output) =
  ignore
    [
      ...
      | None -> Smaws_Lib.Xml.Write.null w
      | Some v ->
          Smaws_Lib.Xml.Write.element w "flatNestedMap" (fun w ->
              List.iter
                (fun (k, v) ->
                  Smaws_Lib.Xml.Write.element w "key" (fun w ->
                      (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
...
let nested_xml_map_with_xml_name_inner_map_to_xml w pairs =
  List.iter
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "InnerKey" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "InnerValue" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w v)))
    pairs
...
let nested_xml_map_with_xml_name_map_to_xml w pairs =
  List.iter
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "OuterKey" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "value" (fun w ->
              nested_xml_map_with_xml_name_inner_map_to_xml w v)))
    pairs
