            ...
            ?byte_value:Smaws_Lib.Smithy_api.Types.byte ->
              ?boolean_value:Smaws_Lib.Smithy_api.Types.boolean_ ->
                ?string_value:Smaws_Lib.Smithy_api.Types.string_ ->
                  unit -> xml_nested_union_struct
val make_xml_unions_response :
  ?union_value:xml_union_shape -> unit -> xml_unions_response
val make_xml_unions_request :
  ?union_value:xml_union_shape -> unit -> xml_unions_request
          ...
          ?date_time_on_target:Shared.Types.date_time ->
            ?date_time:Smaws_Lib.Smithy_api.Types.timestamp ->
              ?normal:Smaws_Lib.Smithy_api.Types.timestamp ->
                unit -> xml_timestamps_input_output
...
val make_xml_maps_xml_name_request :
  ?my_map:xml_maps_xml_name_input_output_map ->
    unit -> xml_maps_xml_name_request
val make_xml_maps_response :
  ?my_map:xml_maps_input_output_map -> unit -> xml_maps_response
val make_xml_maps_request :
  ?my_map:xml_maps_input_output_map -> unit -> xml_maps_request
        ...
        ?int_enum3:Shared.Types.integer_enum ->
          ?int_enum2:Shared.Types.integer_enum ->
            ?int_enum1:Shared.Types.integer_enum ->
              unit -> xml_int_enums_input_output
...
val make_xml_blobs_response :
  ?data:Smaws_Lib.Smithy_api.Types.blob -> unit -> xml_blobs_response
val make_xml_blobs_request :
  ?data:Smaws_Lib.Smithy_api.Types.blob -> unit -> xml_blobs_request
...
val make_xml_attributes_on_payload_response :
  ?payload:xml_attributes_payload_response ->
    unit -> xml_attributes_on_payload_response
val make_xml_attributes_on_payload_request :
  ?payload:xml_attributes_payload_request ->
    unit -> xml_attributes_on_payload_request
  ...
  ?baz:Smaws_Lib.Smithy_api.Types.string_ ->
    ?attr:Smaws_Lib.Smithy_api.Types.string_ ->
      ?foo:Smaws_Lib.Smithy_api.Types.string_ ->
        unit -> xml_attributes_middle_member_input_output
val make_xml_attributes_input_output :
  ?attr:Smaws_Lib.Smithy_api.Types.string_ ->
    ?foo:Smaws_Lib.Smithy_api.Types.string_ ->
      unit -> xml_attributes_input_output
...
val make_xml_attributes_in_middle_response :
  ?payload:xml_attributes_in_middle_payload_response ->
    unit -> xml_attributes_in_middle_response
val make_xml_attributes_in_middle_payload_request : unit -> unit
val make_xml_attributes_in_middle_request :
  ?payload:xml_attributes_in_middle_payload_request ->
    unit -> xml_attributes_in_middle_request
...
val make_recursive_shapes_response :
  ?nested:recursive_shapes_input_output_nested1 ->
    unit -> recursive_shapes_response
                            ...
                            ?header_short:Smaws_Lib.Smithy_api.Types.short ->
                              ?header_byte:Smaws_Lib.Smithy_api.Types.byte ->
                                ?header_string:Smaws_Lib.Smithy_api.Types.string_
                                  ->
                                  unit -> input_and_output_with_headers_i_o
...
val make_http_prefix_headers_input_output :
  ?foo_map:foo_prefix_headers ->
    ?foo:Smaws_Lib.Smithy_api.Types.string_ ->
      unit -> http_prefix_headers_input_output
val make_payload_with_xml_namespace_and_prefix :
  ?name:Smaws_Lib.Smithy_api.Types.string_ ->
    unit -> payload_with_xml_namespace_and_prefix
val make_http_payload_with_xml_namespace_and_prefix_input_output :
  ?nested:payload_with_xml_namespace_and_prefix ->
    unit -> http_payload_with_xml_namespace_and_prefix_input_output
val make_payload_with_xml_namespace :
  ?name:Smaws_Lib.Smithy_api.Types.string_ ->
    unit -> payload_with_xml_namespace
val make_http_payload_with_xml_namespace_input_output :
  ?nested:payload_with_xml_namespace ->
    unit -> http_payload_with_xml_namespace_input_output
...
val make_http_payload_with_xml_name_input_output :
  ?nested:payload_with_xml_name ->
    unit -> http_payload_with_xml_name_input_output
...
val make_http_payload_with_member_xml_name_input_output :
  ?nested:payload_with_xml_name ->
    unit -> http_payload_with_member_xml_name_input_output
...
val make_endpoint_with_host_label_operation_request :
  label:Smaws_Lib.Smithy_api.Types.string_ ->
    unit -> endpoint_with_host_label_operation_request
val make_host_label_header_input :
  account_id:Smaws_Lib.Smithy_api.Types.string_ ->
    unit -> host_label_header_input
...
val make_nested_xml_maps_input_output :
  ?flat_nested_map:nested_map ->
    ?nested_map:nested_map -> unit -> nested_xml_maps_input_output
val make_nested_xml_map_with_xml_name_input_output :
  ?nested_xml_map_with_xml_name_map:nested_xml_map_with_xml_name_map ->
    unit -> nested_xml_map_with_xml_name_input_output