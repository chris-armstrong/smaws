...
val make_nested_xml_maps_response :
  ?nested_map:nested_map -> ?flat_nested_map:nested_map -> unit -> nested_xml_maps_response

val make_nested_xml_maps_request :
  ?nested_map:nested_map -> ?flat_nested_map:nested_map -> unit -> nested_xml_maps_request

val make_nested_xml_maps_input_output :
  ?nested_map:nested_map -> ?flat_nested_map:nested_map -> unit -> nested_xml_maps_input_output
