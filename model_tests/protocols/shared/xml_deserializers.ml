...
let greeting_struct_of_xml i =
  ...
  Smaws_Lib.Xml.Parse.Structure.scanSequence i [ "hi" ] (fun tag _ ->
      match tag with
      | "hi" -> r_hi := Some (Smaws_Lib.Xml.Parse.Read.element_value i "hi" Fun.id ())
      | _ -> Smaws_Lib.Xml.Parse.Read.skip_element i);
...
let string_set_of_xml i = Smaws_Lib.Xml.Parse.Read.elements_value i "member" Fun.id ()
...
let string_list_of_xml i = Smaws_Lib.Xml.Parse.Read.elements_value i "member" Fun.id ()
...
let sparse_string_list_of_xml i = Smaws_Lib.Xml.Parse.Read.elements_value i "member" Fun.id ()

let sparse_short_list_of_xml i =
  Smaws_Lib.Xml.Parse.Read.elements_value i "member" Smaws_Lib.Xml.Parse.Primitive.int_of_string ()
...
let long_set_of_xml i =
  Smaws_Lib.Xml.Parse.Read.elements_value i "member" Smaws_Lib.Xml.Parse.Primitive.long_of_string ()
...
let http_date_of_xml i =
  Smaws_Lib.Xml.Parse.Primitive.timestamp_httpdate_of_string (Smaws_Lib.Xml.Parse.Read.data i)
...
let float_list_of_xml i =
  Smaws_Lib.Xml.Parse.Read.elements_value i "member" Smaws_Lib.Xml.Parse.Primitive.float_of_string
    ()

let epoch_seconds_of_xml i =
  Smaws_Lib.Xml.Parse.Primitive.timestamp_epoch_of_string (Smaws_Lib.Xml.Parse.Read.data i)

let double_list_of_xml i =
  Smaws_Lib.Xml.Parse.Read.elements_value i "member" Smaws_Lib.Xml.Parse.Primitive.double_of_string
    ()

let date_time_of_xml i =
  Smaws_Lib.Xml.Parse.Primitive.timestamp_iso_of_string (Smaws_Lib.Xml.Parse.Read.data i)
...
let boolean_set_of_xml i =
  Smaws_Lib.Xml.Parse.Read.elements_value i "member" Smaws_Lib.Xml.Parse.Primitive.bool_of_string ()

let boolean_list_of_xml i =
  Smaws_Lib.Xml.Parse.Read.elements_value i "member" Smaws_Lib.Xml.Parse.Primitive.bool_of_string ()

let blob_set_of_xml i =
  Smaws_Lib.Xml.Parse.Read.elements_value i "member" Smaws_Lib.Xml.Parse.Primitive.blob_of_string ()
