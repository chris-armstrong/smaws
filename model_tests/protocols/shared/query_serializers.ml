...
let timestamp_list_to_query path xs =
  Smaws_Lib.Protocols.AwsQuery.Serialize.list_to_query "member"
    (fun p v ->
       Smaws_Lib.Protocols.AwsQuery.Serialize.timestamp_iso_field p v) path
    xs
let text_plain_blob_to_query path v =
  Smaws_Lib.Protocols.AwsQuery.Serialize.blob_field path v
...
let structure_set_to_query path xs =
  Smaws_Lib.Protocols.AwsQuery.Serialize.list_to_query "member"
    greeting_struct_to_query path xs
...
let sparse_short_list_to_query path xs =
  Smaws_Lib.Protocols.AwsQuery.Serialize.list_to_query "member"
    (fun p v -> Smaws_Lib.Protocols.AwsQuery.Serialize.int_field p v) path xs
...
let nested_string_list_to_query path xs =
  Smaws_Lib.Protocols.AwsQuery.Serialize.list_to_query "member"
    string_list_to_query path xs
let long_set_to_query path xs =
  Smaws_Lib.Protocols.AwsQuery.Serialize.list_to_query "member"
    (fun p v -> Smaws_Lib.Protocols.AwsQuery.Serialize.long_field p v) path
    xs
...
let float_list_to_query path xs =
  Smaws_Lib.Protocols.AwsQuery.Serialize.list_to_query "member"
    (fun p v -> Smaws_Lib.Protocols.AwsQuery.Serialize.float_field p v) path
    xs
...
let boolean_set_to_query path xs =
  Smaws_Lib.Protocols.AwsQuery.Serialize.list_to_query "member"
    (fun p v -> Smaws_Lib.Protocols.AwsQuery.Serialize.bool_field p v) path
    xs
...
let blob_set_to_query path xs =
  Smaws_Lib.Protocols.AwsQuery.Serialize.list_to_query "member"
    (fun p v -> Smaws_Lib.Protocols.AwsQuery.Serialize.blob_field p v) path
    xs
