...
let union_set_to_xml w xs =
  List.iter
    (fun item -> Smaws_Lib.Xml.Write.element w "member" (fun w -> foo_union_to_xml w item))
    xs
...
let text_plain_blob_to_xml w v = Smaws_Lib.Xml.Write.text w (Base64.encode_exn (Bytes.to_string v))
...
let greeting_struct_to_xml w (x : greeting_struct) =
  ignore
    [
      ...
      | Some v -> Smaws_Lib.Xml.Write.element w "hi" (fun w -> Smaws_Lib.Xml.Write.text w v));
    ]

let structure_set_to_xml w xs =
  List.iter
    (fun item -> Smaws_Lib.Xml.Write.element w "member" (fun w -> greeting_struct_to_xml w item))
    xs
  ...
  List.iter
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "key" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "value" (fun w -> string_list_to_xml w v)))
    pairs
...
let nested_string_list_to_xml w xs =
  List.iter
    (fun item -> Smaws_Lib.Xml.Write.element w "member" (fun w -> string_list_to_xml w item))
    xs
...
let long_set_to_xml w xs =
  List.iter
    (fun item ->
      Smaws_Lib.Xml.Write.element w "member" (fun w ->
          (fun w v -> Smaws_Lib.Xml.Write.text w (Smaws_Lib.CoreTypes.Int64.to_string v)) w item))
    xs
...
let jpeg_blob_to_xml w v = Smaws_Lib.Xml.Write.text w (Base64.encode_exn (Bytes.to_string v))
...
let integer_enum_set_to_xml w xs =
  List.iter
    (fun item -> Smaws_Lib.Xml.Write.element w "member" (fun w -> integer_enum_to_xml w item))
    xs
  ...
  List.iter
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "key" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "value" (fun w -> integer_enum_to_xml w v)))
    pairs
...
let http_date_to_xml w v =
  Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_httpdate_to_string v)

let http_date_set_to_xml w xs =
  List.iter
    (fun item -> Smaws_Lib.Xml.Write.element w "member" (fun w -> http_date_to_xml w item))
    xs
...
let foo_enum_set_to_xml w xs =
  List.iter
    (fun item -> Smaws_Lib.Xml.Write.element w "member" (fun w -> foo_enum_to_xml w item))
    xs
  ...
  List.iter
    (fun (k, v) ->
      Smaws_Lib.Xml.Write.element w "entry" (fun w ->
          Smaws_Lib.Xml.Write.element w "key" (fun w ->
              (fun w v -> Smaws_Lib.Xml.Write.text w v) w k);
          Smaws_Lib.Xml.Write.element w "value" (fun w -> foo_enum_to_xml w v)))
    pairs
...
let epoch_seconds_to_xml w v =
  Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_epoch_to_string v)
...
let date_time_to_xml w v =
  Smaws_Lib.Xml.Write.text w (Smaws_Lib.Protocols.RestXml.Serialize.timestamp_iso_to_string v)

let date_time_set_to_xml w xs =
  List.iter
    (fun item -> Smaws_Lib.Xml.Write.element w "member" (fun w -> date_time_to_xml w item))
    xs
...
let blob_set_to_xml w xs =
  List.iter
    (fun item ->
      Smaws_Lib.Xml.Write.element w "member" (fun w ->
          (fun w v -> Smaws_Lib.Xml.Write.text w (Base64.encode_exn (Bytes.to_string v))) w item))
    xs
