...
type sparse_string_map =
  (Smaws_Lib.Smithy_api.Types.string_ * Smaws_Lib.Smithy_api.Types.string_
    Smaws_Lib.CoreTypes.Nullable.t) list[@@ocaml.doc ""][@@deriving
                                                          (show, eq)]
type sparse_string_list =
  Smaws_Lib.Smithy_api.Types.string_ Smaws_Lib.CoreTypes.Nullable.t list
[@@ocaml.doc ""][@@deriving (show, eq)]
type sparse_short_list =
  Smaws_Lib.Smithy_api.Types.short Smaws_Lib.CoreTypes.Nullable.t list
[@@ocaml.doc ""][@@deriving (show, eq)]
