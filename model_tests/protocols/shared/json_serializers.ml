...
let timestamp_set_to_yojson tree =
  list_to_yojson Smaws_Lib.Smithy_api.Json_serializers.timestamp_to_yojson
    tree
...
let greeting_struct_to_yojson (x : greeting_struct) =
  assoc_to_yojson
    [("hi",
       (option_to_yojson
          Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.hi))]
let structure_set_to_yojson tree =
  list_to_yojson greeting_struct_to_yojson tree
...
let sparse_short_list_to_yojson tree =
  list_to_yojson
    (nullable_to_yojson Smaws_Lib.Smithy_api.Json_serializers.short_to_yojson)
    tree
...
let short_list_to_yojson tree =
  list_to_yojson Smaws_Lib.Smithy_api.Json_serializers.short_to_yojson tree
let nested_string_list_to_yojson tree =
  list_to_yojson string_list_to_yojson tree
...
let integer_enum_set_to_yojson tree =
  list_to_yojson integer_enum_to_yojson tree
let integer_enum_map_to_yojson tree =
  map_to_yojson Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
    integer_enum_to_yojson tree
let integer_enum_list_to_yojson tree =
  list_to_yojson integer_enum_to_yojson tree
let http_date_to_yojson = timestamp_http_date_to_yojson
let http_date_set_to_yojson tree = list_to_yojson http_date_to_yojson tree
let greeting_list_to_yojson tree =
  list_to_yojson greeting_struct_to_yojson tree
...
let epoch_seconds_to_yojson = timestamp_epoch_seconds_to_yojson
...
let boolean_set_to_yojson tree =
  list_to_yojson Smaws_Lib.Smithy_api.Json_serializers.boolean__to_yojson
    tree
