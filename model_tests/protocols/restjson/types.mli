...
type nonrec top_level = unit[@@ocaml.doc ""]
...
type nonrec streaming_text_plain_blob = bytes[@@ocaml.doc ""]
type nonrec streaming_traits_with_media_type_input_output =
  ...
  foo: Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""]}[@@ocaml.doc
                                                                   ""]
type nonrec finite_streaming_blob = bytes[@@ocaml.doc ""]
...
type nonrec operation_with_nested_structure_input =
  {
  top_level: top_level [@ocaml.doc ""]}[@@ocaml.doc ""]
type nonrec operation_with_defaults_output = unit[@@ocaml.doc ""]
type nonrec defaults = unit[@@ocaml.doc ""]
...
type nonrec operation_with_defaults_input =
  ...
  defaults: defaults option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec media_type_header_output =
  {
  json: json_value option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec malformed_timestamp_body_date_time_input =
  ...
  timestamp: Smaws_Lib.Smithy_api.Types.timestamp [@ocaml.doc ""]}[@@ocaml.doc
                                                                    ""]
type nonrec json_header_string = string[@@ocaml.doc ""]
type nonrec malformed_string_input =
  {
  blob: json_header_string option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec malformed_list_input =
  {
  body_list: simple_list option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec document_type_as_payload_input_output =
  {
  document_value: document option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
[@@ocaml.doc ""]
type nonrec dialog_list = dialog list[@@ocaml.doc ""]
