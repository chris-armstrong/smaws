...
let json_1_1_service_responds_with_no_payload () =
  (Eio.Switch.run ~name:"json_1_1_service_responds_with_no_payload") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let empty_operation_test_suite : unit Alcotest.test =
  ("aws.protocoltests.json#EmptyOperation",
    ...
    ("json_1_1_service_responds_with_no_payload", `Quick,
...
let aws_json11_complex_error () =
  (Eio.Switch.run ~name:"AwsJson11ComplexError") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let aws_json11_empty_complex_error () =
  (Eio.Switch.run ~name:"AwsJson11EmptyComplexError") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = GreetingWithErrors.request ctx () in
          ...
          | Error (`ComplexError e) ->
              let expected =
                ({ nested = None; top_level = None } : Types.complex_error) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_complex_error
                   Types.equal_complex_error) "expected error" expected e
          | Error other ->
...
let aws_json11_foo_error_using_x_amzn_error_type () =
  (Eio.Switch.run ~name:"AwsJson11FooErrorUsingXAmznErrorType") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = GreetingWithErrors.request ctx () in
          ...
          | Error (`FooError e) ->
              ...
              check
                (Alcotest_http.testable_nan_aware Types.pp_foo_error
                   Types.equal_foo_error) "expected error" expected e
          | Error other ->
              failwith (GreetingWithErrors.error_to_string other)
          | Ok _ -> failwith "expected an error response, got Ok"))
let aws_json11_foo_error_using_x_amzn_error_type_with_uri () =
  (Eio.Switch.run ~name:"AwsJson11FooErrorUsingXAmznErrorTypeWithUri") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let aws_json11_foo_error_using_x_amzn_error_type_with_uri_and_namespace () =
  (Eio.Switch.run
     ~name:"AwsJson11FooErrorUsingXAmznErrorTypeWithUriAndNamespace")
    @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
...
let aws_json11_foo_error_using_code () =
  (Eio.Switch.run ~name:"AwsJson11FooErrorUsingCode") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let aws_json11_foo_error_using_code_and_namespace () =
  (Eio.Switch.run ~name:"AwsJson11FooErrorUsingCodeAndNamespace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let aws_json11_foo_error_using_code_uri_and_namespace () =
  (Eio.Switch.run ~name:"AwsJson11FooErrorUsingCodeUriAndNamespace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let aws_json11_foo_error_with_dunder_type () =
  (Eio.Switch.run ~name:"AwsJson11FooErrorWithDunderType") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let aws_json11_foo_error_with_dunder_type_and_namespace () =
  (Eio.Switch.run ~name:"AwsJson11FooErrorWithDunderTypeAndNamespace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let aws_json11_foo_error_with_dunder_type_and_different_namespace () =
  (Eio.Switch.run
     ~name:"AwsJson11FooErrorWithDunderTypeAndDifferentNamespace")
    @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
...
let aws_json11_foo_error_with_dunder_type_uri_and_namespace () =
  (Eio.Switch.run ~name:"AwsJson11FooErrorWithDunderTypeUriAndNamespace") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let aws_json11_invalid_greeting_error () =
  (Eio.Switch.run ~name:"AwsJson11InvalidGreetingError") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let greeting_with_errors_test_suite : unit Alcotest.test =
  ("aws.protocoltests.json#GreetingWithErrors",
    ...
    ("AwsJson11FooErrorUsingXAmznErrorType", `Quick,
      aws_json11_foo_error_using_x_amzn_error_type);
    ("AwsJson11FooErrorUsingXAmznErrorTypeWithUri", `Quick,
      aws_json11_foo_error_using_x_amzn_error_type_with_uri);
    ("AwsJson11FooErrorUsingXAmznErrorTypeWithUriAndNamespace", `Quick,
    ...
    ("AwsJson11FooErrorUsingCodeAndNamespace", `Quick,
      aws_json11_foo_error_using_code_and_namespace);
    ("AwsJson11FooErrorUsingCodeUriAndNamespace", `Quick,
      aws_json11_foo_error_using_code_uri_and_namespace);
    ("AwsJson11FooErrorWithDunderType", `Quick,
      aws_json11_foo_error_with_dunder_type);
    ("AwsJson11FooErrorWithDunderTypeAndNamespace", `Quick,
      aws_json11_foo_error_with_dunder_type_and_namespace);
    ("AwsJson11FooErrorWithDunderTypeAndDifferentNamespace", `Quick,
      aws_json11_foo_error_with_dunder_type_and_different_namespace);
    ("AwsJson11FooErrorWithDunderTypeUriAndNamespace", `Quick,
      aws_json11_foo_error_with_dunder_type_uri_and_namespace);
    ("AwsJson11FooErrorWithNestedTypeProperty", `Quick,
      aws_json11_foo_error_with_nested_type_property);
    ("AwsJson11InvalidGreetingError", `Quick,
      aws_json11_invalid_greeting_error)])
          ...
          | Ok result ->
              let expected =
                ({
                   ...
                   foo_enum2 = (Some ZERO);
                   foo_enum1 = (Some FOO)
                 } : Types.json_enums_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_json_enums_input_output
                   Types.equal_json_enums_input_output) "expected output"
                expected result
          | Error error -> failwith (JsonEnums.error_to_string error)))
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response
           ?body:(Some
                    "{\n    \"intEnum1\": 1,\n    \"intEnum2\": 2,\n    \"intEnum3\": 3,\n    \"intEnumList\": [\n        1,\n        2\n    ],\n    \"intEnumSet\": [\n        1,\n        2\n    ],\n    \"intEnumMap\": {\n        \"a\": 1,\n        \"b\": 2\n    }\n}")
           ~status:200
           ~headers:[("X-Amz-Target", "JsonProtocol.JsonIntEnums");
                    ("Content-Type", "application/x-amz-json-1.1")] ();
         (let response =
          ...
          | Ok result ->
              let expected =
                ({
                   ...
                   int_enum2 = (Some B);
                   int_enum1 = (Some A)
                 } : Types.json_int_enums_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_json_int_enums_input_output
                   Types.equal_json_int_enums_input_output) "expected output"
                expected result
          | Error error -> failwith (JsonIntEnums.error_to_string error)))
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response = JsonUnions.request ctx { contents = None } in
          ...
          | Ok result ->
              let expected =
                ({ contents = (Some (StringValue "foo")) } : Types.union_input_output) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_union_input_output
                   Types.equal_union_input_output) "expected output" expected
                result
          | Error error -> failwith (JsonUnions.error_to_string error)))
let aws_json11_deserialize_boolean_union_value () =
  (Eio.Switch.run ~name:"AwsJson11DeserializeBooleanUnionValue") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = JsonUnions.request ctx { contents = None } in
          ...
          | Ok result ->
              let expected =
                ({ contents = (Some (BooleanValue true)) } : Types.union_input_output) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_union_input_output
                   Types.equal_union_input_output) "expected output" expected
                result
...
let aws_json11_deserialize_number_union_value () =
  (Eio.Switch.run ~name:"AwsJson11DeserializeNumberUnionValue") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = JsonUnions.request ctx { contents = None } in
          ...
          | Ok result ->
              let expected =
                ({ contents = (Some (NumberValue 1)) } : Types.union_input_output) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_union_input_output
                   Types.equal_union_input_output) "expected output" expected
                result
...
let aws_json11_deserialize_blob_union_value () =
  (Eio.Switch.run ~name:"AwsJson11DeserializeBlobUnionValue") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
          ...
          | Ok result ->
              let expected =
                ({
                   contents =
                     (Some
                        (BlobValue (Smaws_Lib.CoreTypes.Blob.of_string "foo")))
                 } : Types.union_input_output) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_union_input_output
                   Types.equal_union_input_output) "expected output" expected
                result
...
let aws_json11_deserialize_timestamp_union_value () =
  (Eio.Switch.run ~name:"AwsJson11DeserializeTimestampUnionValue") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let aws_json11_deserialize_enum_union_value () =
  (Eio.Switch.run ~name:"AwsJson11DeserializeEnumUnionValue") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = JsonUnions.request ctx { contents = None } in
          ...
          | Ok result ->
              let expected =
                ({ contents = (Some (EnumValue FOO)) } : Types.union_input_output) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_union_input_output
                   Types.equal_union_input_output) "expected output" expected
                result
...
let aws_json11_deserialize_list_union_value () =
  (Eio.Switch.run ~name:"AwsJson11DeserializeListUnionValue") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = JsonUnions.request ctx { contents = None } in
          ...
          | Ok result ->
              let expected =
                ({ contents = (Some (ListValue ["foo"; "bar"])) } : Types.union_input_output) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_union_input_output
                   Types.equal_union_input_output) "expected output" expected
                result
...
let aws_json11_deserialize_map_union_value () =
  (Eio.Switch.run ~name:"AwsJson11DeserializeMapUnionValue") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         (let response = JsonUnions.request ctx { contents = None } in
          ...
          | Ok result ->
              let expected =
                ({
                   contents =
                     (Some (MapValue [("foo", "bar"); ("spam", "eggs")]))
                 } : Types.union_input_output) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_union_input_output
                   Types.equal_union_input_output) "expected output" expected
...
let aws_json11_deserialize_structure_union_value () =
  (Eio.Switch.run ~name:"AwsJson11DeserializeStructureUnionValue") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let json_unions_test_suite : unit Alcotest.test =
  ("aws.protocoltests.json#JsonUnions",
    ...
    ("AwsJson11DeserializeStringUnionValue", `Quick,
      aws_json11_deserialize_string_union_value);
    ("AwsJson11DeserializeBooleanUnionValue", `Quick,
      aws_json11_deserialize_boolean_union_value);
    ("AwsJson11DeserializeNumberUnionValue", `Quick,
      aws_json11_deserialize_number_union_value);
    ("AwsJson11DeserializeBlobUnionValue", `Quick,
      aws_json11_deserialize_blob_union_value);
    ("AwsJson11DeserializeTimestampUnionValue", `Quick,
      aws_json11_deserialize_timestamp_union_value);
    ("AwsJson11DeserializeEnumUnionValue", `Quick,
      aws_json11_deserialize_enum_union_value);
    ("AwsJson11DeserializeListUnionValue", `Quick,
      aws_json11_deserialize_list_union_value);
    ("AwsJson11DeserializeMapUnionValue", `Quick,
      aws_json11_deserialize_map_union_value);
    ("AwsJson11DeserializeStructureUnionValue", `Quick,
...
let parses_operations_with_empty_json_bodies () =
  (Eio.Switch.run ~name:"parses_operations_with_empty_json_bodies") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
          ...
          | Ok result ->
              let expected =
                ({
                   ...
                   boolean_ = None;
                   blob = None
                 } : Types.kitchen_sink) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_kitchen_sink
                   Types.equal_kitchen_sink) "expected output" expected
                result
          | Error error ->
              failwith (KitchenSinkOperation.error_to_string error)))
let parses_string_shapes () =
  (Eio.Switch.run ~name:"parses_string_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         Mock.mock_response ?body:(Some "{\"String\":\"string-value\"}")
           ~status:200
           ~headers:[("Content-Type", "application/x-amz-json-1.1")] ();
         (let response =
            KitchenSinkOperation.request ctx
...
let parses_integer_shapes () =
  (Eio.Switch.run ~name:"parses_integer_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_long_shapes () =
  (Eio.Switch.run ~name:"parses_long_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         Mock.mock_response ?body:(Some "{\"Long\":1234567890123456789}")
           ~status:200
           ~headers:[("Content-Type", "application/x-amz-json-1.1")] ();
         (let response =
            KitchenSinkOperation.request ctx
          ...
          | Ok result ->
              let expected =
                ({
                   ...
                   long =
                     (Some
                        (Smaws_Lib.CoreTypes.Int64.of_int 1234567890123456789));
                   list_of_structs = None;
                   list_of_strings = None;
                   list_of_maps_of_strings = None;
                   list_of_lists = None;
...
let parses_float_shapes () =
  (Eio.Switch.run ~name:"parses_float_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_double_shapes () =
  (Eio.Switch.run ~name:"parses_double_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         let config = Config.dummy in
         let ctx = Smaws_Lib.Context.make ~config ~http_type () in
         Mock.mock_response ?body:(Some "{\"Double\":123456789.12345679}")
           ~status:200
           ~headers:[("Content-Type", "application/x-amz-json-1.1")] ();
         (let response =
            KitchenSinkOperation.request ctx
...
let parses_boolean_shapes_true () =
  (Eio.Switch.run ~name:"parses_boolean_shapes_true") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_boolean_false () =
  (Eio.Switch.run ~name:"parses_boolean_false") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_blob_shapes () =
  (Eio.Switch.run ~name:"parses_blob_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
          ...
          | Ok result ->
              let expected =
                ({
                   ...
                   blob =
                     (Some
                        (Smaws_Lib.CoreTypes.Blob.of_string "binary-value"))
                 } : Types.kitchen_sink) in
              check
                (Alcotest_http.testable_nan_aware Types.pp_kitchen_sink
                   Types.equal_kitchen_sink) "expected output" expected
...
let parses_timestamp_shapes () =
  (Eio.Switch.run ~name:"parses_timestamp_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_iso8601_timestamps () =
  (Eio.Switch.run ~name:"parses_iso8601_timestamps") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_httpdate_timestamps () =
  (Eio.Switch.run ~name:"parses_httpdate_timestamps") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_list_shapes () =
  (Eio.Switch.run ~name:"parses_list_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_list_of_map_shapes () =
  (Eio.Switch.run ~name:"parses_list_of_map_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_list_of_list_shapes () =
  (Eio.Switch.run ~name:"parses_list_of_list_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_list_of_structure_shapes () =
  (Eio.Switch.run ~name:"parses_list_of_structure_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_list_of_recursive_structure_shapes () =
  (Eio.Switch.run ~name:"parses_list_of_recursive_structure_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_map_shapes () =
  (Eio.Switch.run ~name:"parses_map_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_map_of_list_shapes () =
  (Eio.Switch.run ~name:"parses_map_of_list_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_map_of_map_shapes () =
  (Eio.Switch.run ~name:"parses_map_of_map_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_map_of_structure_shapes () =
  (Eio.Switch.run ~name:"parses_map_of_structure_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
          ...
          | Ok result ->
              let expected =
                ({
                   ...
                   map_of_structs =
                     (Some
                        [("size", { value = (Some "small") });
                        ("color", { value = (Some "red") })]);
                   map_of_strings = None;
                   map_of_maps = None;
                   map_of_lists_of_strings = None;
                   long = None;
...
let parses_map_of_recursive_structure_shapes () =
  (Eio.Switch.run ~name:"parses_map_of_recursive_structure_shapes") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let parses_the_request_id_from_the_response () =
  (Eio.Switch.run ~name:"parses_the_request_id_from_the_response") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
...
let kitchen_sink_operation_test_suite : unit Alcotest.test =
  ("aws.protocoltests.json#KitchenSinkOperation",
    ...
    ("parses_operations_with_empty_json_bodies", `Quick,
    ...
    ("parses_list_of_structure_shapes", `Quick,
      parses_list_of_structure_shapes);
    ("parses_list_of_recursive_structure_shapes", `Quick,
    ...
    ("parses_map_of_structure_shapes", `Quick,
      parses_map_of_structure_shapes);
    ("parses_map_of_recursive_structure_shapes", `Quick,
      parses_map_of_recursive_structure_shapes);
    ("parses_the_request_id_from_the_response", `Quick,
...
let aws_json11_servers_dont_serialize_null_structure_values () =
  (Eio.Switch.run ~name:"AwsJson11ServersDontSerializeNullStructureValues")
    @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
         ...
         (let response = NullOperation.request ctx { string_ = None } in
          ...
          | Ok result ->
              let expected =
                ({ string_ = None } : Types.null_operation_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_null_operation_input_output
                   Types.equal_null_operation_input_output) "expected output"
                expected result
          | Error error -> failwith (NullOperation.error_to_string error)))
let null_operation_test_suite : unit Alcotest.test =
  ("aws.protocoltests.json#NullOperation",
    ...
    ("AwsJson11ServersDontSerializeNullStructureValues", `Quick,
    ...
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         Mock.mock_response
           ...
           ~headers:[("Content-Type", "application/x-amz-json-1.1")] ();
         (let response =
            PutAndGetInlineDocuments.request ctx { inline_document = None } in
          match response with
          | Ok result ->
              let expected =
                ({
                   inline_document =
                     (Some
                        (Smaws_Lib.CoreTypes.Document.from_string
                           "{ \"foo\": \"bar\" }"))
                 } : Types.put_and_get_inline_documents_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_put_and_get_inline_documents_input_output
       ...
       let module Mock = (val Http_mock.create_http_mock ()) in
         ...
         (let response =
            SimpleScalarProperties.request ctx
              { double_value = None; float_value = None } in
          match response with
          | Ok result ->
              let expected =
                ({
                 ...
                 } : Types.simple_scalar_properties_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_simple_scalar_properties_input_output
...
let aws_json11_sparse_maps_deserialize_null_values () =
  (Eio.Switch.run ~name:"AwsJson11SparseMapsDeserializeNullValues") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
         ...
         Mock.mock_response
           ...
           ~headers:[("Content-Type", "application/x-amz-json-1.1")] ();
         (let response =
            SparseNullsOperation.request ctx
              { sparse_string_map = None; sparse_string_list = None } in
          match response with
          | Ok result ->
              let expected =
                ({
                   sparse_string_map =
                     (Some [("foo", Smaws_Lib.CoreTypes.Nullable.Null)]);
                   sparse_string_list = None
                 } : Types.sparse_nulls_operation_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_sparse_nulls_operation_input_output
                   Types.equal_sparse_nulls_operation_input_output)
                "expected output" expected result
          | Error error ->
              failwith (SparseNullsOperation.error_to_string error)))
let aws_json11_sparse_lists_deserialize_null () =
  (Eio.Switch.run ~name:"AwsJson11SparseListsDeserializeNull") @@
    (fun sw ->
       let module Mock = (val Http_mock.create_http_mock ()) in
         let http_type = ((module
           Mock) : (module Smaws_Lib.Http.Client with type t = Mock.t)) in
          ...
          | Ok result ->
              let expected =
                ({
                   sparse_string_map = None;
                   sparse_string_list =
                     (Some [Smaws_Lib.CoreTypes.Nullable.Null])
                 } : Types.sparse_nulls_operation_input_output) in
              check
                (Alcotest_http.testable_nan_aware
                   Types.pp_sparse_nulls_operation_input_output
