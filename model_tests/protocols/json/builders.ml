...
let make_struct_with_json_name
...
let make_simple_scalar_properties_input_output
  ...
  ({ double_value = double_value_; float_value = float_value_ } : simple_scalar_properties_input_output)
...
let make_null_operation_input_output
...
let make_kitchen_sink
  ...
  ?map_of_lists_of_strings:(map_of_lists_of_strings_ :
                             map_of_lists_of_strings option)
  ...
  ?list_of_maps_of_strings:(list_of_maps_of_strings_ :
                             list_of_maps_of_strings option)
