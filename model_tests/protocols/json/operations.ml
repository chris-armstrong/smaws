    ...
    let request context (request : content_type_parameters_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolContentTypeParameters" ~service
  ...
  struct
    ...
    let request context (request : Smaws_Lib.Smithy_api.Types.unit_) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolDatetimeOffsets" ~service
          ~config:context.config ~http:context.http ~input
    ...
    let request context (request : Smaws_Lib.Smithy_api.Types.unit_) =
      let open Smaws_Lib.Context in
        let input =
          Smaws_Lib.Smithy_api.Json_serializers.unit__to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolEmptyOperation" ~service
          ~config:context.config ~http:context.http ~input
    ...
    let request context (request : Smaws_Lib.Smithy_api.Types.unit_) =
      let open Smaws_Lib.Context in
        let input =
          Smaws_Lib.Smithy_api.Json_serializers.unit__to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolEndpointOperation" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
  ...
  struct
    ...
    let request context (request : host_label_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolEndpointWithHostLabelOperation" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
    ...
    let request context (request : Smaws_Lib.Smithy_api.Types.unit_) =
      let open Smaws_Lib.Context in
        let input =
          Smaws_Lib.Smithy_api.Json_serializers.unit__to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolFractionalSeconds" ~service
          ~config:context.config ~http:context.http ~input
    ...
    let request context (request : Smaws_Lib.Smithy_api.Types.unit_) =
      let open Smaws_Lib.Context in
        let input =
          Smaws_Lib.Smithy_api.Json_serializers.unit__to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolGreetingWithErrors" ~service
          ~config:context.config ~http:context.http ~input
    ...
    let request context (request : Smaws_Lib.Smithy_api.Types.unit_) =
      let open Smaws_Lib.Context in
        let input =
          Smaws_Lib.Smithy_api.Json_serializers.unit__to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolHostWithPathOperation" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
module JsonEnums =
  struct
    ...
    let request context (request : json_enums_input_output) =
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.json_enums_input_output_to_yojson request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolJsonEnums" ~service ~config:context.config
  ...
  struct
    ...
    let request context (request : json_int_enums_input_output) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolJsonIntEnums" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : union_input_output) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolJsonUnions" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : kitchen_sink) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolKitchenSinkOperation" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : null_operation_input_output) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolNullOperation" ~service
          ~config:context.config ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.operation_with_optional_input_output_input_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolOperationWithOptionalInputOutput" ~service
          ~config:context.config ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.put_and_get_inline_documents_input_output_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolPutAndGetInlineDocuments" ~service
          ~config:context.config ~http:context.http ~input
  ...
  struct
    ...
    let request context (request : put_with_content_encoding_input) =
      let open Smaws_Lib.Context in
        ...
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolPutWithContentEncoding" ~service
          ~config:context.config ~http:context.http ~input
          ~output_deserializer:Smaws_Lib.Smithy_api.Json_deserializers.unit__of_yojson
          ~error_deserializer
  end
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.simple_scalar_properties_input_output_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolSimpleScalarProperties" ~service
          ~config:context.config ~http:context.http ~input
      ...
      let open Smaws_Lib.Context in
        let input =
          Json_serializers.sparse_nulls_operation_input_output_to_yojson
            request in
        Smaws_Lib.Protocols.AwsJson.request
          ~shape_name:"JsonProtocolSparseNullsOperation" ~service
          ~config:context.config ~http:context.http ~input
