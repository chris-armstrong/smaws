  ...
  val request :
    'http_type Smaws_Lib.Context.t ->
      Smaws_Lib.Smithy_api.Types.unit_ ->
        (datetime_offsets_output, [> Smaws_Lib.Protocols.AwsJson.error])
          result
end[@@ocaml.doc ""]
...
sig
  ...
  val request :
    'http_type Smaws_Lib.Context.t ->
      Smaws_Lib.Smithy_api.Types.unit_ ->
        (fractional_seconds_output, [> Smaws_Lib.Protocols.AwsJson.error])
          result
end[@@ocaml.doc ""]
module GreetingWithErrors :
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error | `ComplexError of complex_error 
    | `FooError of foo_error  | `InvalidGreeting of invalid_greeting ] ->
      string
  val request :
    'http_type Smaws_Lib.Context.t ->
      Smaws_Lib.Smithy_api.Types.unit_ ->
        (greeting_with_errors_output,
          ...
          | `ComplexError of complex_error  | `FooError of foo_error 
  ...
  val request :
    'http_type Smaws_Lib.Context.t ->
      json_enums_input_output ->
        (json_enums_input_output, [> Smaws_Lib.Protocols.AwsJson.error])
          result
end[@@ocaml.doc
  ...
  val request :
    'http_type Smaws_Lib.Context.t ->
      json_int_enums_input_output ->
        (json_int_enums_input_output, [> Smaws_Lib.Protocols.AwsJson.error])
          result
end[@@ocaml.doc
...
end[@@ocaml.doc "This operation uses unions for inputs and outputs."]
module KitchenSinkOperation :
sig
  val error_to_string :
    [ | Smaws_Lib.Protocols.AwsJson.error
    | `ErrorWithMembers of error_with_members 
    | `ErrorWithoutMembers of error_without_members ] -> string
  val request :
    'http_type Smaws_Lib.Context.t ->
      kitchen_sink ->
        (kitchen_sink,
          [> Smaws_Lib.Protocols.AwsJson.error
          | `ErrorWithMembers of error_with_members 
          | `ErrorWithoutMembers of error_without_members ]) result
end[@@ocaml.doc ""]
  ...
  val request :
    'http_type Smaws_Lib.Context.t ->
      null_operation_input_output ->
        (null_operation_input_output, [> Smaws_Lib.Protocols.AwsJson.error])
          result
end[@@ocaml.doc ""]
  ...
  val request :
    'http_type Smaws_Lib.Context.t ->
      sparse_nulls_operation_input_output ->
        (sparse_nulls_operation_input_output,
          [> Smaws_Lib.Protocols.AwsJson.error]) result
end[@@ocaml.doc ""](** {1:Serialization and Deserialization} *)
