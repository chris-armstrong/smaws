...
let sparse_nulls_operation_input_output_to_yojson
  (x : sparse_nulls_operation_input_output) =
  assoc_to_yojson
    [("sparseStringMap",
...
let put_and_get_inline_documents_input_output_to_yojson
  ...
  assoc_to_yojson
    [("inlineDocument",
       (option_to_yojson document_to_yojson x.inline_document))]
...
let map_of_lists_of_strings_to_yojson tree =
  map_to_yojson Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
    list_of_strings_to_yojson tree
let empty_struct_to_yojson = unit_to_yojson
let json_value_to_yojson = string_to_yojson
let list_of_list_of_strings_to_yojson tree =
  list_to_yojson list_of_strings_to_yojson tree
let list_of_maps_of_strings_to_yojson tree =
  list_to_yojson map_of_strings_to_yojson tree
let list_of_structs_to_yojson tree =
  ...
  assoc_to_yojson
    ...
    ("Timestamp",
      (option_to_yojson
         ...
         x.timestamp));
    ("StructWithJsonName",
      (option_to_yojson struct_with_json_name_to_yojson
         x.struct_with_json_name));
    ("String",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.string_));
    ("SimpleStruct",
      (option_to_yojson simple_struct_to_yojson x.simple_struct));
    ("RecursiveStruct",
      (option_to_yojson kitchen_sink_to_yojson x.recursive_struct));
    ("RecursiveMap",
      (option_to_yojson map_of_kitchen_sinks_to_yojson x.recursive_map));
    ("RecursiveList",
      (option_to_yojson list_of_kitchen_sinks_to_yojson x.recursive_list));
    ("MapOfStructs",
      (option_to_yojson map_of_structs_to_yojson x.map_of_structs));
    ("MapOfStrings",
      (option_to_yojson map_of_strings_to_yojson x.map_of_strings));
    ("MapOfMaps",
      (option_to_yojson map_of_map_of_strings_to_yojson x.map_of_maps));
    ("MapOfListsOfStrings",
      (option_to_yojson map_of_lists_of_strings_to_yojson
         x.map_of_lists_of_strings));
    ("Long",
      (option_to_yojson Smaws_Lib.Smithy_api.Json_serializers.long_to_yojson
         x.long));
    ("ListOfStructs",
      (option_to_yojson list_of_structs_to_yojson x.list_of_structs));
    ("ListOfStrings",
      (option_to_yojson list_of_strings_to_yojson x.list_of_strings));
    ("ListOfMapsOfStrings",
      (option_to_yojson list_of_maps_of_strings_to_yojson
         x.list_of_maps_of_strings));
    ("ListOfLists",
      (option_to_yojson list_of_list_of_strings_to_yojson x.list_of_lists));
    ("JsonValue", (option_to_yojson json_value_to_yojson x.json_value));
    ("Iso8601Timestamp",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.timestamp_iso_8601_to_yojson
         x.iso8601_timestamp));
    ("Integer",
      (option_to_yojson
    ...
    ("HttpdateTimestamp",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.timestamp_http_date_to_yojson
    ...
    ("Blob",
      (option_to_yojson Smaws_Lib.Smithy_api.Json_serializers.blob_to_yojson
         x.blob))]
and list_of_kitchen_sinks_to_yojson tree =
  list_to_yojson kitchen_sink_to_yojson tree
and map_of_kitchen_sinks_to_yojson tree =
  map_to_yojson Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson
    kitchen_sink_to_yojson tree
...
let error_with_members_to_yojson (x : error_with_members) =
  assoc_to_yojson
    ...
    ("Code",
      (option_to_yojson
         Smaws_Lib.Smithy_api.Json_serializers.string__to_yojson x.code))]
