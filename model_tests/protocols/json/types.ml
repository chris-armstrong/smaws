...
type document = Smaws_Lib.CoreTypes.Document.t [@@ocaml.doc ""] [@@deriving show, eq]
...
type map_of_strings = (Smaws_Lib.Smithy_api.Types.string_ * Smaws_Lib.Smithy_api.Types.string_) list
[@@ocaml.doc ""] [@@deriving show, eq]

type list_of_strings = Smaws_Lib.Smithy_api.Types.string_ list
[@@ocaml.doc ""] [@@deriving show, eq]

type struct_with_json_name = { value : Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]

type simple_struct = { value : Smaws_Lib.Smithy_api.Types.string_ option [@ocaml.doc ""] }
[@@ocaml.doc ""] [@@deriving show, eq]

type map_of_structs = (Smaws_Lib.Smithy_api.Types.string_ * simple_struct) list
[@@ocaml.doc ""] [@@deriving show, eq]

type map_of_map_of_strings = (Smaws_Lib.Smithy_api.Types.string_ * map_of_strings) list
[@@ocaml.doc ""] [@@deriving show, eq]

type map_of_lists_of_strings = (Smaws_Lib.Smithy_api.Types.string_ * list_of_strings) list
[@@ocaml.doc ""] [@@deriving show, eq]

type list_of_structs = simple_struct list [@@ocaml.doc ""] [@@deriving show, eq]

type list_of_maps_of_strings = map_of_strings list [@@ocaml.doc ""] [@@deriving show, eq]

type list_of_list_of_strings = list_of_strings list [@@ocaml.doc ""] [@@deriving show, eq]

type json_value = string [@@ocaml.doc ""] [@@deriving show, eq]

type map_of_kitchen_sinks = (Smaws_Lib.Smithy_api.Types.string_ * kitchen_sink) list
[@@ocaml.doc ""] [@@deriving show, eq]

and list_of_kitchen_sinks = kitchen_sink list [@@ocaml.doc ""] [@@deriving show, eq]
...
and kitchen_sink = {
  ...
  httpdate_timestamp : Smaws_Lib.Smithy_api.Types.timestamp option; [@ocaml.doc ""]
  integer : Smaws_Lib.Smithy_api.Types.integer option; [@ocaml.doc ""]
  iso8601_timestamp : Smaws_Lib.Smithy_api.Types.timestamp option; [@ocaml.doc ""]
...
type put_and_get_inline_documents_input_output = {
  inline_document : document option; [@ocaml.doc ""]
}
[@@ocaml.doc ""] [@@deriving show, eq]

type operation_with_optional_input_output_output = {
  value : Smaws_Lib.Smithy_api.Types.string_ option; [@ocaml.doc ""]
}
[@@ocaml.doc ""] [@@deriving show, eq]
...
[@@ocaml.doc "A union with a representative set of types for members."] [@@deriving show, eq]

type union_input_output = { contents : my_union option [@ocaml.doc ""] }
[@@ocaml.doc "A shared structure that contains a single union member."] [@@deriving show, eq]
