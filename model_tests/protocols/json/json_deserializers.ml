...
let put_and_get_inline_documents_input_output_of_yojson tree path =
  ...
  ({
     inline_document =
       (option_of_yojson (value_for_key document_of_yojson "inlineDocument")
          _list path)
...
let map_of_structs_of_yojson tree path =
  map_of_yojson Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
    simple_struct_of_yojson tree path
...
let map_of_map_of_strings_of_yojson tree path =
  map_of_yojson Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
    map_of_strings_of_yojson tree path
...
let map_of_lists_of_strings_of_yojson tree path =
  map_of_yojson Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
    list_of_strings_of_yojson tree path
let empty_struct_of_yojson tree path =
  let _list = assoc_of_yojson tree path in (() : unit)
let json_value_of_yojson = string_of_yojson
let list_of_list_of_strings_of_yojson tree path =
  list_of_yojson list_of_strings_of_yojson tree path
let list_of_maps_of_strings_of_yojson tree path =
  list_of_yojson map_of_strings_of_yojson tree path
let list_of_structs_of_yojson tree path =
  list_of_yojson simple_struct_of_yojson tree path
let rec kitchen_sink_of_yojson tree path =
  ...
  ({
     ...
     simple_struct =
       (option_of_yojson
          (value_for_key simple_struct_of_yojson "SimpleStruct") _list path);
     recursive_struct =
       (option_of_yojson
          (value_for_key kitchen_sink_of_yojson "RecursiveStruct") _list path);
     recursive_map =
       (option_of_yojson
          (value_for_key map_of_kitchen_sinks_of_yojson "RecursiveMap") _list
          path);
     recursive_list =
       (option_of_yojson
          (value_for_key list_of_kitchen_sinks_of_yojson "RecursiveList")
          _list path);
     map_of_structs =
       (option_of_yojson
          (value_for_key map_of_structs_of_yojson "MapOfStructs") _list path);
     map_of_strings =
       (option_of_yojson
          (value_for_key map_of_strings_of_yojson "MapOfStrings") _list path);
     map_of_maps =
       (option_of_yojson
          (value_for_key map_of_map_of_strings_of_yojson "MapOfMaps") _list
          path);
     map_of_lists_of_strings =
       (option_of_yojson
          (value_for_key map_of_lists_of_strings_of_yojson
             "MapOfListsOfStrings") _list path);
     long =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.long_of_yojson "Long")
          _list path);
     list_of_structs =
       (option_of_yojson
          (value_for_key list_of_structs_of_yojson "ListOfStructs") _list
          path);
     list_of_strings =
       (option_of_yojson
          (value_for_key list_of_strings_of_yojson "ListOfStrings") _list
          path);
     list_of_maps_of_strings =
       (option_of_yojson
          (value_for_key list_of_maps_of_strings_of_yojson
             "ListOfMapsOfStrings") _list path);
     list_of_lists =
       (option_of_yojson
          (value_for_key list_of_list_of_strings_of_yojson "ListOfLists")
          _list path);
     json_value =
       (option_of_yojson (value_for_key json_value_of_yojson "JsonValue")
          _list path);
     iso8601_timestamp =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.timestamp_iso_8601_of_yojson
             "Iso8601Timestamp") _list path);
     integer =
       (option_of_yojson
          (value_for_key
     ...
     httpdate_timestamp =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.timestamp_http_date_of_yojson
     ...
     float_ =
       (option_of_yojson
          ...
          _list path);
     empty_struct =
       (option_of_yojson (value_for_key empty_struct_of_yojson "EmptyStruct")
          _list path);
     double =
       (option_of_yojson
          (value_for_key
...
and list_of_kitchen_sinks_of_yojson tree path =
  list_of_yojson kitchen_sink_of_yojson tree path
and map_of_kitchen_sinks_of_yojson tree path =
  map_of_yojson Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson
    kitchen_sink_of_yojson tree path
     ...
     message =
       (option_of_yojson
          (value_for_key
             ...
             "Message") _list path);
     map_field =
       (option_of_yojson (value_for_key map_of_strings_of_yojson "MapField")
          _list path);
     list_field =
       (option_of_yojson
          (value_for_key list_of_strings_of_yojson "ListField") _list path);
     integer_field =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.integer_of_yojson
             "IntegerField") _list path);
     complex_data =
       (option_of_yojson (value_for_key kitchen_sink_of_yojson "ComplexData")
          _list path);
     code =
       (option_of_yojson
          (value_for_key
             Smaws_Lib.Smithy_api.Json_deserializers.string__of_yojson "Code")
          _list path)
   } : error_with_members)
