type nonrec my_string_key = string[@@ocaml.doc ""]
type nonrec missing_key_structure = {
  hi: my_string_key [@ocaml.doc ""]}[@@ocaml.doc ""]
type nonrec structure_set_with_no_key = missing_key_structure list[@@ocaml.doc
                                                                    ""]
type nonrec sensitive_pattern_string = string[@@ocaml.doc ""]
...
type nonrec malformed_required_input =
  ...
  string_: Smaws_Lib.Smithy_api.Types.string_ [@ocaml.doc ""]}[@@ocaml.doc
                                                                ""]
type nonrec range_byte = int[@@ocaml.doc ""]
type nonrec min_byte = int[@@ocaml.doc ""]
type nonrec max_byte = int[@@ocaml.doc ""]
type nonrec range_short = int[@@ocaml.doc ""]
type nonrec min_short = int[@@ocaml.doc ""]
type nonrec max_short = int[@@ocaml.doc ""]
type nonrec range_integer = int[@@ocaml.doc ""]
type nonrec min_integer = int[@@ocaml.doc ""]
type nonrec max_integer = int[@@ocaml.doc ""]
type nonrec range_long = int[@@ocaml.doc ""]
type nonrec min_long = int[@@ocaml.doc ""]
type nonrec max_long = int[@@ocaml.doc ""]
type nonrec range_float = float[@@ocaml.doc ""]
type nonrec min_float = float[@@ocaml.doc ""]
type nonrec max_float = float[@@ocaml.doc ""]
type nonrec malformed_range_override_input =
  ...
  byte: range_byte option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec pattern_union_override =
  ...
  | First of pattern_string [@ocaml.doc ""][@@ocaml.doc ""]
type nonrec malformed_pattern_override_input =
  ...
  string_: pattern_string option [@ocaml.doc ""]}[@@ocaml.doc ""]
type nonrec evil_string = string[@@ocaml.doc ""]
type nonrec pattern_list = pattern_string list[@@ocaml.doc ""]
...
type nonrec malformed_pattern_input =
  ...
  string_: pattern_string option [@ocaml.doc ""]}[@@ocaml.doc ""]
type nonrec length_string = string[@@ocaml.doc ""]
type nonrec malformed_length_query_string_input =
  {
  string_: length_string option [@ocaml.doc ""]}[@@ocaml.doc ""]
type nonrec length_blob = bytes[@@ocaml.doc ""]
type nonrec min_length_string = string[@@ocaml.doc ""]
type nonrec max_length_string = string[@@ocaml.doc ""]
type nonrec length_list = length_string list[@@ocaml.doc ""]
...
type nonrec malformed_length_override_input =
  ...
  blob: length_blob option [@ocaml.doc ""]}[@@ocaml.doc ""]
...
type nonrec enum_list = enum_string list[@@ocaml.doc ""]
