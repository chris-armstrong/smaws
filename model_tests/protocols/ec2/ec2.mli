(** 
    EC2 Protocol client library built on EIO.
...
val make_simple_input_params_input :
  ?uses_xml_name:Smaws_Lib.Smithy_api.Types.string_ ->
    ?has_query_and_xml_name:Smaws_Lib.Smithy_api.Types.string_ ->
      ?has_query_name:Smaws_Lib.Smithy_api.Types.string_ ->
...
val make_query_lists_input :
  ?nested_with_list:nested_struct_with_list ->
    ?list_arg_with_xml_name:list_with_xml_name ->
