...
let make_simple_input_params_input
  ?uses_xml_name:(uses_xml_name_ : Smaws_Lib.Smithy_api.Types.string_ option)
  ?has_query_and_xml_name:(has_query_and_xml_name_ :
                            Smaws_Lib.Smithy_api.Types.string_ option)
  ?has_query_name:(has_query_name_ :
                    Smaws_Lib.Smithy_api.Types.string_ option)
...
let make_query_lists_input
  ...
  ?list_arg_with_xml_name:(list_arg_with_xml_name_ :
