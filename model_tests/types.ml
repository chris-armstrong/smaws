open Smaws_Lib
type nonrec string_map = (string * string) list[@@ocaml.doc ""][@@deriving
                                                                 show]
[@@deriving eq]
...
type nonrec http_malformed_request_test_parameters_definition =
  (string * string list) list[@@ocaml.doc ""][@@deriving show][@@deriving eq]
...
[@@ocaml.doc "An RPC-based protocol that serializes CBOR payloads."][@@deriving
                                                                    show]
[@@deriving eq]
...
[@@ocaml.doc
  "Describes one specific validation failure for an input member."][@@deriving
                                                                    show]
[@@deriving eq]
...
type nonrec request_payer =
  | Requester [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show][@@deriving eq]
type nonrec owner =
  {
  i_d: string option [@ocaml.doc ""];
  display_name: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                show]
[@@deriving eq]
type nonrec object_storage_class =
  ...
  | STANDARD [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show][@@deriving eq]
type nonrec object_ =
  {
  ...
  key: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec encoding_type =
  | Url [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show][@@deriving eq]
type nonrec list_objects_v2_request =
  ...
  bucket: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                    eq]
type nonrec common_prefix = {
  prefix: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec list_objects_v2_output =
  ...
  is_truncated: bool option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec bucket_location_constraint =
  | Us_west_2 [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show][@@deriving eq]
...
type nonrec delete_object_tagging_output =
  {
  version_id: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec resource_not_found_exception =
  ...
  message: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec record = (string * string) list[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec details_attributes =
  | ALGORITHM [@ocaml.doc ""]
  | PREDICTIVE_MODEL_TYPE [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec prediction =
  ...
  predicted_label: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                   show]
[@@deriving eq]
type nonrec predict_output = {
  prediction: prediction option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                  show]
[@@deriving eq]
type nonrec predict_input =
  ...
  ml_model_id: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec upload_multipart_part_output =
  {
  checksum: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec upload_multipart_part_input =
  ...
  account_id: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec service_unavailable_exception =
  {
  message: string option [@ocaml.doc ""];
  code: string option [@ocaml.doc ""];
  type_: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec resource_not_found_exception =
  {
  message: string option [@ocaml.doc ""];
...
type nonrec upload_archive_input =
  ...
  vault_name: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec archive_creation_output =
  {
  archive_id: string option [@ocaml.doc ""];
  checksum: string option [@ocaml.doc ""];
  location: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec api_key_source_type =
  ...
  | HEADER [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show][@@deriving eq]
type nonrec endpoint_type =
  | PRIVATE [@ocaml.doc ""]
  | EDGE [@ocaml.doc ""]
  | REGIONAL [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show][@@deriving eq]
type nonrec endpoint_configuration =
  {
  vpc_endpoint_ids: string list option [@ocaml.doc ""];
  types: endpoint_type list option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
...
type nonrec rest_api =
  ...
  name: string option [@ocaml.doc ""];
  id: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec rest_apis =
  {
  position: string option [@ocaml.doc ""];
  items: rest_api list option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                show]
[@@deriving eq]
type nonrec get_rest_apis_request =
  {
  limit: int option [@ocaml.doc ""];
  position: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec foo_union =
  ...
  | String of string [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec greeting_struct = {
  hi: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec string_map = (string * string) list[@@ocaml.doc ""][@@deriving
                                                                 show]
[@@deriving eq]
...
type nonrec foo_enum_map = (string * foo_enum) list[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
...
type nonrec nested_with_namespace =
  {
  attr_field: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec xml_maps_xml_name_input_output_map =
  (string * greeting_struct) list[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                    eq]
...
type nonrec xml_map_with_xml_namespace_input_output_map =
  (string * string) list[@@ocaml.doc ""][@@deriving show][@@deriving eq]
...
type nonrec structure_list_member =
  ...
  a: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                    eq]
type nonrec xml_lists_input_output =
  ...
  string_list: string list option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
type nonrec xml_int_enums_input_output =
  ...
  int_enum1: integer_enum option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                   show]
[@@deriving eq]
...
type nonrec xml_empty_strings_response =
  {
  empty_string: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                show]
[@@deriving eq]
...
type nonrec xml_attributes_on_payload_response =
  {
  payload: unit option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec union_payload =
  | Greeting of string [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec string_payload_input = {
  payload: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
and recursive_shapes_input_output_nested2 =
  ...
  recursive_member: recursive_shapes_input_output_nested1 option
    [@ocaml.doc ""];
  bar: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec query_params_as_string_list_map_input =
  ...
  qux: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec query_idempotency_token_auto_fill_input =
  {
  token: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec put_with_content_encoding_input =
  {
  data: string option [@ocaml.doc ""];
  encoding: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec omits_null_serializes_empty_string_input =
  {
  empty_string: string option [@ocaml.doc ""];
  null_value: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec ignore_query_params_in_response_output =
  {
  baz: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec http_response_code_output = {
  status: int option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec http_request_with_greedy_label_in_path_input =
  ...
  foo: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                 eq]
...
type nonrec payload_with_xml_namespace_and_prefix =
  {
  name: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec nested_payload =
  {
  name: string option [@ocaml.doc ""];
  greeting: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec flattened_xml_map_response =
  {
  my_map: foo_enum_map option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                show]
[@@deriving eq]
...
type nonrec endpoint_with_host_label_operation_request =
  {
  label: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                   eq]
...
type nonrec content_type_parameters_input =
  {
  value: int option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec constant_query_string_input = {
  hello: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                   eq]
...
type nonrec nested_xml_maps_input_output =
  ...
  nested_map: nested_map option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                  show]
[@@deriving eq]
...
type nonrec missing_key_structure = {
  hi: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving eq]
type nonrec sensitive_validation_input =
  {
  string_: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec malformed_range_override_input =
  ...
  byte: int option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                    eq]
...
type nonrec pattern_union_override =
  ...
  | First of string [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show][@@deriving
                                                                    eq]
type nonrec malformed_pattern_override_input =
  ...
  string_: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec pattern_map = (string * string) list[@@ocaml.doc ""][@@deriving
                                                                  show]
[@@deriving eq]
...
type nonrec malformed_length_query_string_input =
  ...
  string_: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec length_map = (string * string list) list[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
type nonrec malformed_length_override_input =
  ...
  blob: bytes option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
[@@deriving eq]
type nonrec greeting_struct = {
  salutation: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec union_with_json_name =
  | Baz of string [@ocaml.doc ""]
  | Bar of string [@ocaml.doc ""]
  | Foo of string [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show][@@deriving
                                                                    eq]
type nonrec union_payload =
  | Greeting of string [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec timestamp_format_headers_i_o =
  ...
  member_epoch_seconds: CoreTypes.Timestamp.t option [@ocaml.doc ""]}
[@@ocaml.doc ""][@@deriving show][@@deriving eq]
type nonrec test_string_map = (string * string) list[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
type nonrec test_no_payload_input_output =
  {
  test_id: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec payload_config = {
  data: int option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                    eq]
...
type nonrec test_config = {
  timeout: int option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
[@@deriving show][@@deriving eq]
type nonrec sparse_number_map = (string * int) list[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
...
type nonrec simple_union =
  ...
  | Int of int [@ocaml.doc ""][@@ocaml.doc ""][@@deriving show][@@deriving
                                                                 eq]
type nonrec simple_scalar_properties_input_output =
  {
  double_value: base_double option [@ocaml.doc ""];
  ...
  foo: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec simple_map = (string * string) list[@@ocaml.doc ""][@@deriving
                                                                 show]
[@@deriving eq]
type nonrec response_code_required_output =
  {
  response_code: int [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type recursive_shapes_input_output_nested1 =
  {
  nested: recursive_shapes_input_output_nested2 option [@ocaml.doc ""];
...
type nonrec player_action =
  | Quit of unit [@ocaml.doc "Quit the game."][@@ocaml.doc ""][@@deriving
                                                                show]
[@@deriving eq]
...
type nonrec operation_with_nested_structure_input =
  {
  top_level: unit [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                    eq]
type nonrec client_optional_defaults = {
  member: int option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec operation_with_defaults_input =
  ...
  defaults: unit option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec media_type_header_output = {
  json: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec malformed_timestamp_query_http_date_input =
  {
  timestamp_: CoreTypes.Timestamp.t [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
...
type nonrec malformed_string_input = {
  blob: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec malformed_long_input =
  ...
  long_in_body: int option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec malformed_list_input =
  {
  body_list: string list option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                  show]
[@@deriving eq]
type nonrec malformed_integer_input =
  ...
  integer_in_body: int option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                show]
[@@deriving eq]
...
type nonrec malformed_content_type_without_body_empty_input_input =
  {
  header: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec malformed_boolean_input =
  ...
  boolean_in_body: bool option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                 show]
[@@deriving eq]
...
type nonrec dense_struct_map = (string * greeting_struct) list[@@ocaml.doc
                                                                ""][@@deriving
                                                                    show]
[@@deriving eq]
type nonrec dense_number_map = (string * int) list[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
type nonrec dense_boolean_map = (string * bool) list[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
...
type nonrec http_request_with_regex_literal_input =
  {
  str: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show][@@deriving
                                                                 eq]
type nonrec http_request_with_labels_and_timestamp_format_input =
  {
  target_date_time: CoreTypes.Timestamp.t [@ocaml.doc ""];
...
type nonrec farewell = {
  phrase: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec dialog =
  {
  farewell: farewell option [@ocaml.doc ""];
  greeting: string option [@ocaml.doc ""];
  language: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec dialog_map = (string * dialog) list[@@ocaml.doc ""][@@deriving
                                                                 show]
[@@deriving eq]
...
type nonrec defaults_mixin =
  ...
  default_string: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                  show]
[@@deriving eq]
...
type nonrec struct_arg =
  ...
  string_arg: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec nested_struct_with_map =
  {
  map_arg: string_map option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                               show][@@deriving
                                                                    eq]
...
type nonrec nested_struct_with_list =
  {
  list_arg: string list option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving
                                                                 show]
[@@deriving eq]
...
type nonrec required_members_with_defaults_mixin =
  ...
  required_string: string [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec json_unions_output = {
  contents: my_union option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
type nonrec struct_with_json_name = {
  value: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
[@@deriving show][@@deriving eq]
type nonrec map_of_strings = (string * string) list[@@ocaml.doc ""][@@deriving
                                                                    show]
[@@deriving eq]
...
type nonrec error_with_members =
  ...
  code: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
type nonrec json_int_enums_input_output =
  {
  int_enum_map: integer_enum_map option [@ocaml.doc ""];
...
type nonrec checksum_algorithm =
  ...
  | CRC64NVME [@ocaml.doc "CRC64NVME"][@@ocaml.doc ""][@@deriving show]
[@@deriving eq]
...
[@@ocaml.doc
  "Contains HTTP protocol configuration for HTTP-based protocols."][@@deriving
                                                                    show]
[@@deriving eq]
type nonrec sigv4a = {
  name: string option [@ocaml.doc ""]}[@@ocaml.doc ""][@@deriving show]
...
[@@ocaml.doc "Configures an Amazon Cognito User Pools auth scheme."][@@deriving
                                                                    show]
[@@deriving eq]
...
[@@ocaml.doc "Configures endpoint discovery for the service."][@@deriving
                                                                show]
[@@deriving eq]
...
[@@ocaml.doc "Marks a string as containing an ARN."][@@deriving show]
[@@deriving eq]
